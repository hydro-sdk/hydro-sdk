...
void main() {
  ...
  group("", () {
    test("", () async {
      ...
      var getRemainingProjectCreationsResponse =
          await api.getRemainingProjectCreations(
        sessionDto: SessionDto.empty(),
      );

      expect(getRemainingProjectCreationsResponse, isNull);
      ...
      getRemainingProjectCreationsResponse =
          await api.getRemainingProjectCreations(
        sessionDto: loginResponse,
      );

      expect(getRemainingProjectCreationsResponse, isNotNull);
      expect(getRemainingProjectCreationsResponse.remainingProjectCreations, 1);
      ...
      expect(getRemainingProjectCreationsResponse, isNotNull);
      expect(getRemainingProjectCreationsResponse.remainingProjectCreations, 0);

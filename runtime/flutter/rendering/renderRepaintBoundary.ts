...
rendering: {
renderRepaintBoundary: (this: void, renderRepaintBoundary: IRenderRepaintBoundary, props? : {  child? : IRenderBox | undefined,}) => IRenderRepaintBoundary
}
};
export interface IRenderRepaintBoundary
...
toImage: ( props : {  pixelRatio : number,}) => IFuture<IImage>;
getDebugSymmetricPaintCount: () => number;
getDebugAsymmetricPaintCount: () => number;
debugResetMetrics: () => void;
...
getHashCode: () => number;
}export class RenderRepaintBoundary
...
flutter.rendering.renderRepaintBoundary(this, props);}
    private readonly _dart_getIsRepaintBoundary: () => boolean = undefined as any;
    private readonly _dart_toImage: ( props : {  pixelRatio : number,}) => IFuture<IImage> = undefined as any;
    private readonly _dart_getDebugSymmetricPaintCount: () => number = undefined as any;
    private readonly _dart_getDebugAsymmetricPaintCount: () => number = undefined as any;
    private readonly _dart_debugResetMetrics: () => void = undefined as any;
...
public toImage( props : {  pixelRatio? : number,}) : IFuture<IImage> {
    return this._dart_toImage({
...toImageDefaultProps,
...props
});
}
public getDebugSymmetricPaintCount() : number {
    return this._dart_getDebugSymmetricPaintCount();
}
public getDebugAsymmetricPaintCount() : number {
    return this._dart_getDebugAsymmetricPaintCount();
}
public debugResetMetrics() : void {
    return this._dart_debugResetMetrics();
}

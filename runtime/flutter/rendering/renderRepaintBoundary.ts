...
declare const flutter: {
    rendering: {
        renderRepaintBoundary: (
            this: void,
            renderRepaintBoundary: IRenderRepaintBoundary,
            props?: { child?: IRenderBox | undefined }
        ) => IRenderRepaintBoundary;
    };
};
        ...
        >
{
    ...
    private readonly _dart_getIsRepaintBoundary: () => boolean =
        undefined as any;
    private readonly _dart_toImage: (props: {
        pixelRatio: number;
    }) => IFuture<IImage> = undefined as any;
    private readonly _dart_getDebugSymmetricPaintCount: () => number =
        undefined as any;
    private readonly _dart_getDebugAsymmetricPaintCount: () => number =
        undefined as any;

...
rendering: {
renderIntrinsicWidth: (this: void, renderIntrinsicWidth: IRenderIntrinsicWidth, props? : {  child? : IRenderBox | undefined, stepHeight? : number | undefined, stepWidth? : number | undefined,}) => IRenderIntrinsicWidth
}
};
export interface IRenderIntrinsicWidth


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getStepWidth: () => number | undefined;
setStepWidth: (value?: number | undefined) => void;
getStepHeight: () => number | undefined;
setStepHeight: (value?: number | undefined) => void;
...
getHashCode: () => number;
}export class RenderIntrinsicWidth
...
public constructor( props? : {  child? : IRenderBox | undefined, stepHeight? : number | undefined, stepWidth? : number | undefined,}){
flutter.rendering.renderIntrinsicWidth(this, props);}
    private readonly _dart_getStepWidth: () => number | undefined = undefined as any;
    private readonly _dart_setStepWidth: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getStepHeight: () => number | undefined = undefined as any;
    private readonly _dart_setStepHeight: (value?: number | undefined) => void = undefined as any;
...
public getStepWidth() : number | undefined {
    return this._dart_getStepWidth();
}
public setStepWidth(value?: number | undefined) : void {
    return this._dart_setStepWidth(value);
}
public getStepHeight() : number | undefined {
    return this._dart_getStepHeight();
}
public setStepHeight(value?: number | undefined) : void {
    return this._dart_setStepHeight(value);
}

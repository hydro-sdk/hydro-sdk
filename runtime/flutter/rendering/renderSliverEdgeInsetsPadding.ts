...
declare const flutter: {
    rendering: {
        renderSliverEdgeInsetsPadding: (
            this: void,
            renderSliverEdgeInsetsPadding: IRenderSliverEdgeInsetsPadding
        ) => IRenderSliverEdgeInsetsPadding;
    };
};
export interface IRenderSliverEdgeInsetsPadding {
...
export class RenderSliverEdgeInsetsPadding
    implements
        IRenderSliver,
        ...
        >
{
    ...
    public constructor() {
        flutter.rendering.renderSliverEdgeInsetsPadding(this);
    }

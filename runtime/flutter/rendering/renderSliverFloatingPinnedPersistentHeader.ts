...
import { IRenderSliverFloatingPersistentHeader } from "./renderSliverFloatingPersistentHeader";
...
rendering: {
renderSliverFloatingPinnedPersistentHeader: (this: void, renderSliverFloatingPinnedPersistentHeader: IRenderSliverFloatingPinnedPersistentHeader, props? : {  child? : IRenderBox | undefined, showOnScreenConfiguration? : IPersistentHeaderShowOnScreenConfiguration | undefined, snapConfiguration? : IFloatingHeaderSnapConfiguration | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined, vsync? : ITickerProvider | undefined,}) => IRenderSliverFloatingPinnedPersistentHeader
}
};
export interface IRenderSliverFloatingPinnedPersistentHeader
...
getHashCode: () => number;
}export class RenderSliverFloatingPinnedPersistentHeader

 implements IRenderSliverFloatingPersistentHeader, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
flutter.rendering.renderSliverFloatingPinnedPersistentHeader(this, props);}

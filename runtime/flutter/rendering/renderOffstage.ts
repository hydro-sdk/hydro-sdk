...
rendering: {
renderOffstage: (this: void, renderOffstage: IRenderOffstage, props : {  child? : IRenderBox | undefined, offstage : boolean,}) => IRenderOffstage
}
};
export interface IRenderOffstage
...
public constructor( props : {  child? : IRenderBox | undefined, offstage? : boolean,}){
flutter.rendering.renderOffstage(this, {
...renderOffstageDefaultProps,
...props
});}
...
const renderOffstageDefaultProps = {
    offstage: true,
};

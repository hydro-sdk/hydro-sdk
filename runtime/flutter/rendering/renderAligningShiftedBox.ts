...
rendering: {
renderAligningShiftedBox: (this: void, renderAligningShiftedBox: IRenderAligningShiftedBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, textDirection? : TextDirection | undefined,}) => IRenderAligningShiftedBox
}
};
export interface IRenderAligningShiftedBox
...
getHashCode: () => number;
}export class RenderAligningShiftedBox
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderAligningShiftedBox(this, {
...renderAligningShiftedBoxDefaultProps,
...props
});}
...
const renderAligningShiftedBoxDefaultProps = {

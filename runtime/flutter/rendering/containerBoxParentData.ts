...
rendering: {
containerBoxParentData: <ChildType>(this: void, containerBoxParentData: IContainerBoxParentData<ChildType>) => IContainerBoxParentData<ChildType>
}
};
export interface IContainerBoxParentData
<ChildType>
...
toString: () => string;
getHashCode: () => number;
}export class ContainerBoxParentData
<ChildType>

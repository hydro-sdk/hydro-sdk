...
rendering: {
renderRotatedBox: (this: void, renderRotatedBox: IRenderRotatedBox, props : {  child? : IRenderBox | undefined, quarterTurns : number,}) => IRenderRotatedBox
}
};
export interface IRenderRotatedBox


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getQuarterTurns: () => number;
setQuarterTurns: (value: number) => void;
...
getHashCode: () => number;
}export class RenderRotatedBox

 implements IRenderBox, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, quarterTurns : number,}){
flutter.rendering.renderRotatedBox(this, props);}
    private readonly _dart_getQuarterTurns: () => number = undefined as any;
    private readonly _dart_setQuarterTurns: (value: number) => void = undefined as any;
...
public getQuarterTurns() : number {
    return this._dart_getQuarterTurns();
}
public setQuarterTurns(value: number) : void {
    return this._dart_setQuarterTurns(value);
}

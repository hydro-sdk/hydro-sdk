...
rendering: {
_compositeRenderEditablePainter: (this: void, _compositeRenderEditablePainter: I_CompositeRenderEditablePainter, props : {  painters : IList<IRenderEditablePainter>,}) => I_CompositeRenderEditablePainter
}
};

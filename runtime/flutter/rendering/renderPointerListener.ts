...
rendering: {
renderPointerListener: (this: void, renderPointerListener: IRenderPointerListener, props : {  behavior : HitTestBehavior, child? : IRenderBox | undefined, onPointerCancel? : (event: IPointerCancelEvent) => void | undefined, onPointerDown? : (event: IPointerDownEvent) => void | undefined, onPointerHover? : (event: IPointerHoverEvent) => void | undefined, onPointerMove? : (event: IPointerMoveEvent) => void | undefined, onPointerSignal? : (event: IPointerSignalEvent) => void | undefined, onPointerUp? : (event: IPointerUpEvent) => void | undefined,}) => IRenderPointerListener
}
};
export interface IRenderPointerListener
...
getHashCode: () => number;
}export class RenderPointerListener
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IRenderBox | undefined, onPointerCancel? : (event: IPointerCancelEvent) => void | undefined, onPointerDown? : (event: IPointerDownEvent) => void | undefined, onPointerHover? : (event: IPointerHoverEvent) => void | undefined, onPointerMove? : (event: IPointerMoveEvent) => void | undefined, onPointerSignal? : (event: IPointerSignalEvent) => void | undefined, onPointerUp? : (event: IPointerUpEvent) => void | undefined,}){
flutter.rendering.renderPointerListener(this, {
...renderPointerListenerDefaultProps,
...props
});}
...
const renderPointerListenerDefaultProps = {

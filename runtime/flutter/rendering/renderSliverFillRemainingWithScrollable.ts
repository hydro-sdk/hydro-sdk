...
declare const flutter: {
    rendering: {
        renderSliverFillRemainingWithScrollable: (
            this: void,
            renderSliverFillRemainingWithScrollable: IRenderSliverFillRemainingWithScrollable,
            props?: { child?: IRenderBox | undefined }
        ) => IRenderSliverFillRemainingWithScrollable;
    };
};
        ...
        >
{
    ...
    private readonly _dart_setupParentData: (child: any) => void =
        undefined as any;
    private readonly _dart_setChildParentData: (
        child: IRenderObject,
        constraints: ISliverConstraints,
        geometry: ISliverGeometry

...
import { IRenderSliverSingleBoxAdapter } from "./renderSliverSingleBoxAdapter";
...
rendering: {
renderSliverFillRemainingWithScrollable: (this: void, renderSliverFillRemainingWithScrollable: IRenderSliverFillRemainingWithScrollable, props? : {  child? : IRenderBox | undefined,}) => IRenderSliverFillRemainingWithScrollable
}
};
export interface IRenderSliverFillRemainingWithScrollable
...
setChildParentData: (child: IRenderObject, constraints: ISliverConstraints, geometry: ISliverGeometry) => void;
...
getHashCode: () => number;
}export class RenderSliverFillRemainingWithScrollable

 implements Omit<IRenderSliverSingleBoxAdapter, "attach" | "detach" | "hitTestChildren" | "childMainAxisPosition" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props? : {  child? : IRenderBox | undefined,}){
flutter.rendering.renderSliverFillRemainingWithScrollable(this, props);}
    ...
    private readonly _dart_setChildParentData: (child: IRenderObject, constraints: ISliverConstraints, geometry: ISliverGeometry) => void = undefined as any;
...
public setChildParentData(child: IRenderObject, constraints: ISliverConstraints, geometry: ISliverGeometry) : void {
    return this._dart_setChildParentData(child, constraints, geometry);
}

...
import { I_RenderPhysicalModelBase } from "./_renderPhysicalModelBase";
...
import { IPhysicalModelLayer } from "./physicalModelLayer";
...
rendering: {
renderPhysicalModel: (this: void, renderPhysicalModel: IRenderPhysicalModel, props : {  borderRadius? : IBorderRadius | undefined, child? : IRenderBox | undefined, clipBehavior : Clip, elevation : number, shadowColor : IColor, shape : BoxShape, color : IColor,}) => IRenderPhysicalModel
}
};
export interface IRenderPhysicalModel


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getLayer: () => IPhysicalModelLayer | undefined;
getShape: () => BoxShape;
setShape: (value: BoxShape) => void;
getBorderRadius: () => IBorderRadius | undefined;
setBorderRadius: (value?: IBorderRadius | undefined) => void;
...
getShadowColor: () => IColor;
setShadowColor: (value: IColor) => void;
getColor: () => IColor;
...
getClipper: () => ICustomClipper<IRRect> | undefined;
setClipper: (newClipper?: ICustomClipper<IRRect> | undefined) => void;
...
getHashCode: () => number;
}export class RenderPhysicalModel

 implements I_RenderPhysicalModelBase<IRRect>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  borderRadius? : IBorderRadius | undefined, child? : IRenderBox | undefined, clipBehavior? : Clip, elevation? : number, shadowColor? : IColor, shape? : BoxShape, color : IColor,}){
flutter.rendering.renderPhysicalModel(this, {
...renderPhysicalModelDefaultProps,
...props
});}
    private readonly _dart_getLayer: () => IPhysicalModelLayer | undefined = undefined as any;
    private readonly _dart_getShape: () => BoxShape = undefined as any;
    private readonly _dart_setShape: (value: BoxShape) => void = undefined as any;
    private readonly _dart_getBorderRadius: () => IBorderRadius | undefined = undefined as any;
    private readonly _dart_setBorderRadius: (value?: IBorderRadius | undefined) => void = undefined as any;
    ...
    private readonly _dart_getShadowColor: () => IColor = undefined as any;
    private readonly _dart_setShadowColor: (value: IColor) => void = undefined as any;
    ...
    private readonly _dart_getClipper: () => ICustomClipper<IRRect> | undefined = undefined as any;
    private readonly _dart_setClipper: (newClipper?: ICustomClipper<IRRect> | undefined) => void = undefined as any;
...
public getLayer() : IPhysicalModelLayer | undefined {
    return this._dart_getLayer();
}
public getShape() : BoxShape {
    return this._dart_getShape();
}
public setShape(value: BoxShape) : void {
    return this._dart_setShape(value);
}
public getBorderRadius() : IBorderRadius | undefined {
    return this._dart_getBorderRadius();
}
public setBorderRadius(value?: IBorderRadius | undefined) : void {
...
public getShadowColor() : IColor {
    return this._dart_getShadowColor();
}
public setShadowColor(value: IColor) : void {
...
public getClipper() : ICustomClipper<IRRect> | undefined {
    return this._dart_getClipper();
}
public setClipper(newClipper?: ICustomClipper<IRRect> | undefined) : void {
    return this._dart_setClipper(newClipper);
}
...
const renderPhysicalModelDefaultProps = {

...
declare const flutter: {
    rendering: {
        renderExcludeSemantics: (
            this: void,
            renderExcludeSemantics: IRenderExcludeSemantics,
            props: { child?: IRenderBox | undefined; excluding: boolean }
        ) => IRenderExcludeSemantics;
    };
};
        ...
        >
{
    ...
    private readonly _dart_setExcluding: (value: boolean) => void =
        undefined as any;

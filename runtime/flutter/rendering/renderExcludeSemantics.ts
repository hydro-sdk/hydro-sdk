...
rendering: {
renderExcludeSemantics: (this: void, renderExcludeSemantics: IRenderExcludeSemantics, props : {  child? : IRenderBox | undefined, excluding : boolean,}) => IRenderExcludeSemantics
}
};
export interface IRenderExcludeSemantics


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getExcluding: () => boolean;
setExcluding: (value: boolean) => void;
...
getHashCode: () => number;
}export class RenderExcludeSemantics
...
public constructor( props : {  child? : IRenderBox | undefined, excluding? : boolean,}){
flutter.rendering.renderExcludeSemantics(this, {
...renderExcludeSemanticsDefaultProps,
...props
});}
    private readonly _dart_getExcluding: () => boolean = undefined as any;
    private readonly _dart_setExcluding: (value: boolean) => void = undefined as any;
...
public getExcluding() : boolean {
    return this._dart_getExcluding();
}
public setExcluding(value: boolean) : void {
    return this._dart_setExcluding(value);
}
...
const renderExcludeSemanticsDefaultProps = {
    excluding: true,
};

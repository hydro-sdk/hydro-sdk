...
rendering: {
_overflowRegionData: (this: void, _overflowRegionData: I_OverflowRegionData, props : {  label : string, labelOffset : IOffset, rotation : number, rect : IRect, side : _OverflowSide,}) => I_OverflowRegionData
}
};
...
public constructor( props : {  label? : string, labelOffset? : IOffset, rotation? : number, rect : IRect, side : _OverflowSide,}){

...
declare const flutter: {
    rendering: {
        _mouseState: (
            this: void,
            _mouseState: I_MouseState,
            props: { initialEvent: IPointerEvent }
        ) => I_MouseState;
    };
};
export interface I_MouseState {
    ...
    replaceAnnotations: (
        value: ILinkedHashMap<IMouseTrackerAnnotation, IMatrix4>
    ) => ILinkedHashMap<IMouseTrackerAnnotation, IMatrix4>;
...
export class _MouseState {
    ...
    private readonly _dart_getAnnotations: () => ILinkedHashMap<
        IMouseTrackerAnnotation,
        IMatrix4
    > = undefined as any;
    private readonly _dart_replaceAnnotations: (
        value: ILinkedHashMap<IMouseTrackerAnnotation, IMatrix4>
    ) => ILinkedHashMap<IMouseTrackerAnnotation, IMatrix4> = undefined as any;
    private readonly _dart_getLatestEvent: () => IPointerEvent =
        undefined as any;
    private readonly _dart_replaceLatestEvent: (
        value: IPointerEvent

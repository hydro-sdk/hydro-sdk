...
rendering: {
renderViewport: (this: void, renderViewport: IRenderViewport, props : {  anchor : number, axisDirection : AxisDirection, cacheExtent? : number | undefined, cacheExtentStyle : CacheExtentStyle, center? : IRenderSliver | undefined, children? : IList<IRenderSliver> | undefined, clipBehavior : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}) => IRenderViewport
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IRenderViewportBase<ISliverPhysicalContainerParentData>, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IContainerRenderObjectMixin<IRenderSliver,ISliverPhysicalContainerParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public static useTwoPaneSemantics = new SemanticsTag("RenderViewport.twoPane");
    public static excludeFromScrolling = new SemanticsTag("RenderViewport.excludeFromScrolling");
...
public constructor( props : {  anchor? : number, axisDirection? : AxisDirection, cacheExtent? : number | undefined, cacheExtentStyle? : CacheExtentStyle, center? : IRenderSliver | undefined, children? : IList<IRenderSliver> | undefined, clipBehavior? : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}){

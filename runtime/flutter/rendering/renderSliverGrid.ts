...
rendering: {
renderSliverGrid: (this: void, renderSliverGrid: IRenderSliverGrid, props : {  childManager : IRenderSliverBoxChildManager, gridDelegate : ISliverGridDelegate,}) => IRenderSliverGrid
}
};
...
public constructor( props : {  childManager : IRenderSliverBoxChildManager, gridDelegate : ISliverGridDelegate,}){
flutter.rendering.renderSliverGrid(this, props);}
    private readonly _dart_setupParentData: (child: any) => void = undefined as any;
    private readonly _dart_getGridDelegate: () => ISliverGridDelegate = undefined as any;
    private readonly _dart_setGridDelegate: (value: ISliverGridDelegate) => void = undefined as any;

...
declare const flutter: {
    rendering: {
        renderSliverGrid: (
            this: void,
            renderSliverGrid: IRenderSliverGrid,
            props: {
...
export interface IRenderSliverGrid {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    setupParentData: (child: unknown) => void;
    getGridDelegate: () => ISliverGridDelegate;
    setGridDelegate: (value: ISliverGridDelegate) => void;
...
export class RenderSliverGrid
    implements
        Omit<
            IRenderSliverMultiBoxAdaptor,
            | "insert"
            | "move"
            | "remove"
            | "removeAll"
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.rendering.renderSliverGrid(this, props);
    }
    private readonly _dart_setupParentData: (child: any) => void =
        undefined as any;
    private readonly _dart_getGridDelegate: () => ISliverGridDelegate =
        undefined as any;
    private readonly _dart_setGridDelegate: (
        value: ISliverGridDelegate
    ...
    public getGridDelegate(): ISliverGridDelegate {
        return this._dart_getGridDelegate();
    }
    public setGridDelegate(value: ISliverGridDelegate): void {
        return this._dart_setGridDelegate(value);
    }

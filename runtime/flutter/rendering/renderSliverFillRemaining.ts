...
rendering: {
renderSliverFillRemaining: (this: void, renderSliverFillRemaining: IRenderSliverFillRemaining, props? : {  child? : IRenderBox | undefined,}) => IRenderSliverFillRemaining
}
};
export interface IRenderSliverFillRemaining
...
getHashCode: () => number;
}export class RenderSliverFillRemaining
...
flutter.rendering.renderSliverFillRemaining(this, props);}

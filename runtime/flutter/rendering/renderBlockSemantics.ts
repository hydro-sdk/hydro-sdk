...
declare const flutter: {
    rendering: {
        renderBlockSemantics: (
            this: void,
            renderBlockSemantics: IRenderBlockSemantics,
            props: { blocking: boolean; child?: IRenderBox | undefined }
        ) => IRenderBlockSemantics;
    };
};
        ...
        >
{
    ...
    private readonly _dart_setBlocking: (value: boolean) => void =
        undefined as any;

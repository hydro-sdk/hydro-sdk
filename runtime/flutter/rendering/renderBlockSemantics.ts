...
rendering: {
renderBlockSemantics: (this: void, renderBlockSemantics: IRenderBlockSemantics, props : {  blocking : boolean, child? : IRenderBox | undefined,}) => IRenderBlockSemantics
}
};
export interface IRenderBlockSemantics
...
getHashCode: () => number;
}export class RenderBlockSemantics
...
public constructor( props : {  blocking? : boolean, child? : IRenderBox | undefined,}){
flutter.rendering.renderBlockSemantics(this, {
...renderBlockSemanticsDefaultProps,
...props
});}
    private readonly _dart_getBlocking: () => boolean = undefined as any;
    private readonly _dart_setBlocking: (value: boolean) => void = undefined as any;
...
public getBlocking() : boolean {
    return this._dart_getBlocking();
}
public setBlocking(value: boolean) : void {
    return this._dart_setBlocking(value);
}
...
const renderBlockSemanticsDefaultProps = {
    blocking: true,
};

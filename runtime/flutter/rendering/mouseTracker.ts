...
export class MouseTracker implements IChangeNotifier, IListenable {
    public constructor() {
        flutter.rendering.mouseTracker(this);
    }
    private readonly _dart_getMouseIsConnected: () => boolean =
        undefined as any;
    private readonly _dart_updateWithEvent: (
        event: IPointerEvent,
        getResult: () => IHitTestResult
    ) => void = undefined as any;
    private readonly _dart_updateAllDevices: (
        hitTest: (offset: IOffset) => IHitTestResult
    ) => void = undefined as any;

...
import { IDebugOverflowIndicatorMixin } from "./debugOverflowIndicatorMixin";
...
rendering: {
renderFlex: (this: void, renderFlex: IRenderFlex, props : {  children? : IList<IRenderBox> | undefined, clipBehavior : Clip, crossAxisAlignment : CrossAxisAlignment, direction : Axis, mainAxisAlignment : MainAxisAlignment, mainAxisSize : MainAxisSize, textBaseline? : TextBaseline | undefined, textDirection? : TextDirection | undefined, verticalDirection : VerticalDirection,}) => IRenderFlex
}
};
export interface IRenderFlex
...
getDirection: () => Axis;
setDirection: (value: Axis) => void;
getMainAxisAlignment: () => MainAxisAlignment;
setMainAxisAlignment: (value: MainAxisAlignment) => void;
getMainAxisSize: () => MainAxisSize;
setMainAxisSize: (value: MainAxisSize) => void;
getCrossAxisAlignment: () => CrossAxisAlignment;
setCrossAxisAlignment: (value: CrossAxisAlignment) => void;
...
setVerticalDirection: (value: VerticalDirection) => void;
...
paintOverflowIndicator: (context: IPaintingContext, offset: IOffset, containerRect: IRect, childRect: IRect, props? : {  overflowHints? : IList<IDiagnosticsNode> | undefined,}) => void;
reassemble: () => void;
...
getHashCode: () => number;
}export class RenderFlex

 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IFlexParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IFlexParentData>, IDebugOverflowIndicatorMixin, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,IFlexParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, crossAxisAlignment? : CrossAxisAlignment, direction? : Axis, mainAxisAlignment? : MainAxisAlignment, mainAxisSize? : MainAxisSize, textBaseline? : TextBaseline | undefined, textDirection? : TextDirection | undefined, verticalDirection? : VerticalDirection,}){
flutter.rendering.renderFlex(this, {
...renderFlexDefaultProps,
...props
});}
    private readonly _dart_getDirection: () => Axis = undefined as any;
    private readonly _dart_setDirection: (value: Axis) => void = undefined as any;
    private readonly _dart_getMainAxisAlignment: () => MainAxisAlignment = undefined as any;
    private readonly _dart_setMainAxisAlignment: (value: MainAxisAlignment) => void = undefined as any;
    private readonly _dart_getMainAxisSize: () => MainAxisSize = undefined as any;
    private readonly _dart_setMainAxisSize: (value: MainAxisSize) => void = undefined as any;
    private readonly _dart_getCrossAxisAlignment: () => CrossAxisAlignment = undefined as any;
    private readonly _dart_setCrossAxisAlignment: (value: CrossAxisAlignment) => void = undefined as any;
    ...
    private readonly _dart_getVerticalDirection: () => VerticalDirection = undefined as any;
    private readonly _dart_setVerticalDirection: (value: VerticalDirection) => void = undefined as any;
    private readonly _dart_getTextBaseline: () => TextBaseline | undefined = undefined as any;
    private readonly _dart_setTextBaseline: (value?: TextBaseline | undefined) => void = undefined as any;
    ...
    private readonly _dart_paintOverflowIndicator: (context: IPaintingContext, offset: IOffset, containerRect: IRect, childRect: IRect, props? : {  overflowHints? : IList<IDiagnosticsNode> | undefined,}) => void = undefined as any;
...
public getDirection() : Axis {
    return this._dart_getDirection();
}
public setDirection(value: Axis) : void {
    return this._dart_setDirection(value);
}
public getMainAxisAlignment() : MainAxisAlignment {
    return this._dart_getMainAxisAlignment();
}
public setMainAxisAlignment(value: MainAxisAlignment) : void {
    return this._dart_setMainAxisAlignment(value);
}
public getMainAxisSize() : MainAxisSize {
    return this._dart_getMainAxisSize();
}
public setMainAxisSize(value: MainAxisSize) : void {
    return this._dart_setMainAxisSize(value);
}
public getCrossAxisAlignment() : CrossAxisAlignment {
    return this._dart_getCrossAxisAlignment();
}
public setCrossAxisAlignment(value: CrossAxisAlignment) : void {
    return this._dart_setCrossAxisAlignment(value);
}
...
public getVerticalDirection() : VerticalDirection {
    return this._dart_getVerticalDirection();
}
public setVerticalDirection(value: VerticalDirection) : void {
    return this._dart_setVerticalDirection(value);
}
...
public paintOverflowIndicator(context: IPaintingContext, offset: IOffset, containerRect: IRect, childRect: IRect, props? : {  overflowHints? : IList<IDiagnosticsNode> | undefined,}) : void {
    return this._dart_paintOverflowIndicator(context, offset, containerRect, childRect, props);
}

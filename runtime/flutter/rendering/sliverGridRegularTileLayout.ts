...
rendering: {
sliverGridRegularTileLayout: (this: void, sliverGridRegularTileLayout: ISliverGridRegularTileLayout, props : {  childCrossAxisExtent : number, childMainAxisExtent : number, crossAxisCount : number, crossAxisStride : number, mainAxisStride : number, reverseCrossAxis : boolean,}) => ISliverGridRegularTileLayout
}
};
...
toString: () => string;
getHashCode: () => number;
}export class SliverGridRegularTileLayout

 implements ISliverGridLayout
...
public constructor( props : {  childCrossAxisExtent : number, childMainAxisExtent : number, crossAxisCount : number, crossAxisStride : number, mainAxisStride : number, reverseCrossAxis : boolean,}){
flutter.rendering.sliverGridRegularTileLayout(this, props);}
    private readonly _dart_getMinChildIndexForScrollOffset: (scrollOffset: number) => number = undefined as any;
    private readonly _dart_getMaxChildIndexForScrollOffset: (scrollOffset: number) => number = undefined as any;
    private readonly _dart_getGeometryForChildIndex: (index: number) => ISliverGridGeometry = undefined as any;
    private readonly _dart_computeMaxScrollOffset: (childCount: number) => number = undefined as any;

...
rendering: {
flowDelegate: (this: void, flowDelegate: IFlowDelegate, props? : {  repaint? : IListenable | undefined,}) => IFlowDelegate
}
};
...
getConstraintsForChild: (i: number, constraints: IBoxConstraints) => IBoxConstraints;
...
flutter.rendering.flowDelegate(this, props);}
    ...
    private readonly _dart_getConstraintsForChild: (i: number, constraints: IBoxConstraints) => IBoxConstraints = undefined as any;
    private readonly _dart_paintChildren: (context: IFlowPaintingContext) => void = undefined as any;
...
public getConstraintsForChild(i: number, constraints: IBoxConstraints) : IBoxConstraints {

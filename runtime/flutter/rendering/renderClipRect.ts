...
rendering: {
renderClipRect: (this: void, renderClipRect: IRenderClipRect, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, clipper? : ICustomClipper<IRect> | undefined,}) => IRenderClipRect
}
};
export interface IRenderClipRect
...
flutter.rendering.renderClipRect(this, {
...renderClipRectDefaultProps,
...props
});}
...
const renderClipRectDefaultProps = {

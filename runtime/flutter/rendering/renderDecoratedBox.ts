...
declare const flutter: {
    rendering: {
        renderDecoratedBox: (
            this: void,
            renderDecoratedBox: IRenderDecoratedBox,
            props: {
        ...
        >
{
    ...
    private readonly _dart_setDecoration: (value: IDecoration) => void =
        undefined as any;
    private readonly _dart_getPosition: () => DecorationPosition =
        undefined as any;
    private readonly _dart_setPosition: (value: DecorationPosition) => void =
        undefined as any;

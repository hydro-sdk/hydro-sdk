...
rendering: {
renderDecoratedBox: (this: void, renderDecoratedBox: IRenderDecoratedBox, props : {  child? : IRenderBox | undefined, configuration : IImageConfiguration, position : DecorationPosition, decoration : IDecoration,}) => IRenderDecoratedBox
}
};
export interface IRenderDecoratedBox
...
setDecoration: (value: IDecoration) => void;
getPosition: () => DecorationPosition;
setPosition: (value: DecorationPosition) => void;
...
getHashCode: () => number;
}export class RenderDecoratedBox
...
public constructor( props : {  child? : IRenderBox | undefined, configuration? : IImageConfiguration, position? : DecorationPosition, decoration : IDecoration,}){
flutter.rendering.renderDecoratedBox(this, {
...renderDecoratedBoxDefaultProps,
...props
});}
    private readonly _dart_getDecoration: () => IDecoration = undefined as any;
    private readonly _dart_setDecoration: (value: IDecoration) => void = undefined as any;
    private readonly _dart_getPosition: () => DecorationPosition = undefined as any;
    private readonly _dart_setPosition: (value: DecorationPosition) => void = undefined as any;
...
public setDecoration(value: IDecoration) : void {
    return this._dart_setDecoration(value);
}
public getPosition() : DecorationPosition {
    return this._dart_getPosition();
}
public setPosition(value: DecorationPosition) : void {
...
const renderDecoratedBoxDefaultProps = {

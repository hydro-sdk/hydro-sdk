...
rendering: {
renderConstrainedOverflowBox: (this: void, renderConstrainedOverflowBox: IRenderConstrainedOverflowBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, maxHeight? : number | undefined, maxWidth? : number | undefined, minHeight? : number | undefined, minWidth? : number | undefined, textDirection? : TextDirection | undefined,}) => IRenderConstrainedOverflowBox
}
};
export interface IRenderConstrainedOverflowBox
...
getHashCode: () => number;
}export class RenderConstrainedOverflowBox
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, maxHeight? : number | undefined, maxWidth? : number | undefined, minHeight? : number | undefined, minWidth? : number | undefined, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderConstrainedOverflowBox(this, {
...renderConstrainedOverflowBoxDefaultProps,
...props
});}
    private readonly _dart_getMinWidth: () => number | undefined = undefined as any;
    private readonly _dart_setMinWidth: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getMaxWidth: () => number | undefined = undefined as any;
    private readonly _dart_setMaxWidth: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getMinHeight: () => number | undefined = undefined as any;
    private readonly _dart_setMinHeight: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getMaxHeight: () => number | undefined = undefined as any;
    private readonly _dart_setMaxHeight: (value?: number | undefined) => void = undefined as any;
...
public getMinWidth() : number | undefined {
    return this._dart_getMinWidth();
}
public setMinWidth(value?: number | undefined) : void {
    return this._dart_setMinWidth(value);
}
public getMaxWidth() : number | undefined {
    return this._dart_getMaxWidth();
}
public setMaxWidth(value?: number | undefined) : void {
    return this._dart_setMaxWidth(value);
}
public getMinHeight() : number | undefined {
    return this._dart_getMinHeight();
}
public setMinHeight(value?: number | undefined) : void {
    return this._dart_setMinHeight(value);
}
public getMaxHeight() : number | undefined {
    return this._dart_getMaxHeight();
}
public setMaxHeight(value?: number | undefined) : void {
    return this._dart_setMaxHeight(value);
}
...
const renderConstrainedOverflowBoxDefaultProps = {

...
rendering: {
renderPhysicalShape: (this: void, renderPhysicalShape: IRenderPhysicalShape, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, elevation : number, shadowColor : IColor, clipper : ICustomClipper<IPath>, color : IColor,}) => IRenderPhysicalShape
}
};
export interface IRenderPhysicalShape
...
getClipper: () => ICustomClipper<IPath> | undefined;
setClipper: (newClipper?: ICustomClipper<IPath> | undefined) => void;
...
getHashCode: () => number;
}export class RenderPhysicalShape

 implements I_RenderPhysicalModelBase<IPath>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, elevation? : number, shadowColor? : IColor, clipper : ICustomClipper<IPath>, color : IColor,}){
flutter.rendering.renderPhysicalShape(this, {
...renderPhysicalShapeDefaultProps,
...props
});}
    ...
    private readonly _dart_getClipper: () => ICustomClipper<IPath> | undefined = undefined as any;
    private readonly _dart_setClipper: (newClipper?: ICustomClipper<IPath> | undefined) => void = undefined as any;
...
public getClipper() : ICustomClipper<IPath> | undefined {
    return this._dart_getClipper();
}
public setClipper(newClipper?: ICustomClipper<IPath> | undefined) : void {
...
const renderPhysicalShapeDefaultProps = {

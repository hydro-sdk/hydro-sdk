...
declare const flutter: {
    rendering: {
        renderPhysicalShape: (
            this: void,
            renderPhysicalShape: IRenderPhysicalShape,
            props: {
...
export class RenderPhysicalShape
    implements
        I_RenderPhysicalModelBase<IPath>,
        ...
        >
{
    ...
    private readonly _dart_getClipper: () => ICustomClipper<IPath> | undefined =
        undefined as any;
    private readonly _dart_setClipper: (
        newClipper?: ICustomClipper<IPath> | undefined
    ) => void = undefined as any;

...
rendering: {
renderSliverPersistentHeader: (this: void, renderSliverPersistentHeader: IRenderSliverPersistentHeader, props? : {  child? : IRenderBox | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined,}) => IRenderSliverPersistentHeader
}
};
export interface IRenderSliverPersistentHeader
...
getHashCode: () => number;
}export class RenderSliverPersistentHeader

 implements IRenderSliver, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
flutter.rendering.renderSliverPersistentHeader(this, props);}

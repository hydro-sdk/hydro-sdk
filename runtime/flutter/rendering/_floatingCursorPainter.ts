...
rendering: {
_floatingCursorPainter: (this: void, _floatingCursorPainter: I_FloatingCursorPainter, caretPaintCallback : (caretRect: IRect) => void) => I_FloatingCursorPainter
}
};
...
paintRegularCursor: (canvas: ICanvas, renderEditable: IRenderEditable, caretColor: IColor, textPosition: ITextPosition) => void;
...
flutter.rendering._floatingCursorPainter(this, caretPaintCallback);}
    ...
    private readonly _dart_setShouldPaint: (value: boolean) => void = undefined as any;
    private readonly _dart_getCaretColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setCaretColor: (value?: IColor | undefined) => void = undefined as any;
    ...
    private readonly _dart_getFloatingCursorRect: () => IRect | undefined = undefined as any;
    private readonly _dart_setFloatingCursorRect: (value?: IRect | undefined) => void = undefined as any;
    private readonly _dart_paintRegularCursor: (canvas: ICanvas, renderEditable: IRenderEditable, caretColor: IColor, textPosition: ITextPosition) => void = undefined as any;
...
public paintRegularCursor(canvas: ICanvas, renderEditable: IRenderEditable, caretColor: IColor, textPosition: ITextPosition) : void {
    return this._dart_paintRegularCursor(canvas, renderEditable, caretColor, textPosition);
}

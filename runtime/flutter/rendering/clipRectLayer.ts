...
rendering: {
clipRectLayer: (this: void, clipRectLayer: IClipRectLayer, props : {  clipBehavior : Clip, clipRect? : IRect | undefined,}) => IClipRectLayer
}
};
...
public constructor( props : {  clipBehavior? : Clip, clipRect? : IRect | undefined,}){
flutter.rendering.clipRectLayer(this, {
...clipRectLayerDefaultProps,
...props
});}
    private readonly _dart_getClipRect: () => IRect | undefined = undefined as any;
    private readonly _dart_setClipRect: (value?: IRect | undefined) => void = undefined as any;

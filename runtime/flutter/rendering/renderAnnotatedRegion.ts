...
declare const flutter: {
    rendering: {
        renderAnnotatedRegion: <T>(
            this: void,
            renderAnnotatedRegion: IRenderAnnotatedRegion<T>,
            props: { child?: IRenderBox | undefined; sized: boolean; value: T }
        ) => IRenderAnnotatedRegion<T>;
    };
};
export interface IRenderAnnotatedRegion<T> {
...
export class RenderAnnotatedRegion<T>
    implements
        Omit<
            IRenderProxyBox,
            | "attach"
        ...
        >
{
    ...
    private readonly _dart_setSized: (value: boolean) => void =
        undefined as any;

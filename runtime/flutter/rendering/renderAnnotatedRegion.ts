...
rendering: {
renderAnnotatedRegion: <T>(this: void, renderAnnotatedRegion: IRenderAnnotatedRegion<T>, props : {  child? : IRenderBox | undefined, sized : boolean, value : T,}) => IRenderAnnotatedRegion<T>
}
};
export interface IRenderAnnotatedRegion
<T>
...
getHashCode: () => number;
}export class RenderAnnotatedRegion
<T>
...
{    public readonly alwaysNeedsCompositing: boolean = undefined as any;
...
public constructor( props : {  child? : IRenderBox | undefined, sized : boolean, value : T,}){
flutter.rendering.renderAnnotatedRegion(this, props);}
    private readonly _dart_getValue: () => T = undefined as any;
    private readonly _dart_setValue: (newValue: T) => void = undefined as any;
    private readonly _dart_getSized: () => boolean = undefined as any;
    private readonly _dart_setSized: (value: boolean) => void = undefined as any;
...
public getSized() : boolean {
    return this._dart_getSized();
}
public setSized(value: boolean) : void {
    return this._dart_setSized(value);
}

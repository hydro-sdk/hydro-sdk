...
import { I_RenderCustomClip } from "./_renderCustomClip";
...
rendering: {
renderClipRRect: (this: void, renderClipRRect: IRenderClipRRect, props : {  borderRadius : IBorderRadius, child? : IRenderBox | undefined, clipBehavior : Clip, clipper? : ICustomClipper<IRRect> | undefined,}) => IRenderClipRRect
}
};
export interface IRenderClipRRect
...
getHashCode: () => number;
}export class RenderClipRRect

 implements I_RenderCustomClip<IRRect>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  borderRadius? : IBorderRadius, child? : IRenderBox | undefined, clipBehavior? : Clip, clipper? : ICustomClipper<IRRect> | undefined,}){
flutter.rendering.renderClipRRect(this, {
...renderClipRRectDefaultProps,
...props
});}
    private readonly _dart_getBorderRadius: () => IBorderRadius = undefined as any;
    private readonly _dart_setBorderRadius: (value: IBorderRadius) => void = undefined as any;
...
const renderClipRRectDefaultProps = {

...
rendering: {
renderUnconstrainedBox: (this: void, renderUnconstrainedBox: IRenderUnconstrainedBox, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, constrainedAxis? : Axis | undefined, alignment : IAlignmentGeometry, textDirection? : TextDirection | undefined,}) => IRenderUnconstrainedBox
}
};
export interface IRenderUnconstrainedBox
...
setConstraintsTransform: (value : (__: IBoxConstraints) => IBoxConstraints) => void;
...
getHashCode: () => number;
 ...
 implements Omit<IRenderConstraintsTransformBox, "attach" | "detach" | "toStringShort" | "debugFillProperties" | "debugDescribeChildren" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IDebugOverflowIndicatorMixin, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, constrainedAxis? : Axis | undefined, alignment : IAlignmentGeometry, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderUnconstrainedBox(this, {
...renderUnconstrainedBoxDefaultProps,
...props
});}
    private readonly _dart_getConstrainedAxis: () => Axis | undefined = undefined as any;
    private readonly _dart_setConstrainedAxis: (value?: Axis | undefined) => void = undefined as any;
    ...
    private readonly _dart_getConstraintsTransform: () => (__: IBoxConstraints) => IBoxConstraints = undefined as any;
    private readonly _dart_setConstraintsTransform: (value : (__: IBoxConstraints) => IBoxConstraints) => void = undefined as any;
    ...
    private readonly _dart_alignChild: () => void = undefined as any;
...
public getConstrainedAxis() : Axis | undefined {
    return this._dart_getConstrainedAxis();
}
...
public setConstraintsTransform(value : (__: IBoxConstraints) => IBoxConstraints) : void {
...
public alignChild() : void {
    return this._dart_alignChild();
}
...
const renderUnconstrainedBoxDefaultProps = {

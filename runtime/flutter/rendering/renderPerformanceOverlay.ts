...
rendering: {
renderPerformanceOverlay: (this: void, renderPerformanceOverlay: IRenderPerformanceOverlay, props : {  checkerboardOffscreenLayers : boolean, checkerboardRasterCacheImages : boolean, optionsMask : number, rasterizerThreshold : number,}) => IRenderPerformanceOverlay
}
};
export interface IRenderPerformanceOverlay


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getOptionsMask: () => number;
setOptionsMask: (value: number) => void;
getRasterizerThreshold: () => number;
setRasterizerThreshold: (value: number) => void;
getCheckerboardRasterCacheImages: () => boolean;
setCheckerboardRasterCacheImages: (value: boolean) => void;
getCheckerboardOffscreenLayers: () => boolean;
setCheckerboardOffscreenLayers: (value: boolean) => void;
...
getHashCode: () => number;
}export class RenderPerformanceOverlay
...
public constructor( props : {  checkerboardOffscreenLayers? : boolean, checkerboardRasterCacheImages? : boolean, optionsMask? : number, rasterizerThreshold? : number,}){
flutter.rendering.renderPerformanceOverlay(this, {
...renderPerformanceOverlayDefaultProps,
...props
});}
    private readonly _dart_getOptionsMask: () => number = undefined as any;
    private readonly _dart_setOptionsMask: (value: number) => void = undefined as any;
    private readonly _dart_getRasterizerThreshold: () => number = undefined as any;
    private readonly _dart_setRasterizerThreshold: (value: number) => void = undefined as any;
    private readonly _dart_getCheckerboardRasterCacheImages: () => boolean = undefined as any;
    private readonly _dart_setCheckerboardRasterCacheImages: (value: boolean) => void = undefined as any;
    private readonly _dart_getCheckerboardOffscreenLayers: () => boolean = undefined as any;
    private readonly _dart_setCheckerboardOffscreenLayers: (value: boolean) => void = undefined as any;
...
public getOptionsMask() : number {
    return this._dart_getOptionsMask();
}
public setOptionsMask(value: number) : void {
    return this._dart_setOptionsMask(value);
}
public getRasterizerThreshold() : number {
    return this._dart_getRasterizerThreshold();
}
public setRasterizerThreshold(value: number) : void {
    return this._dart_setRasterizerThreshold(value);
}
public getCheckerboardRasterCacheImages() : boolean {
    return this._dart_getCheckerboardRasterCacheImages();
}
public setCheckerboardRasterCacheImages(value: boolean) : void {
    return this._dart_setCheckerboardRasterCacheImages(value);
}
public getCheckerboardOffscreenLayers() : boolean {
    return this._dart_getCheckerboardOffscreenLayers();
}
public setCheckerboardOffscreenLayers(value: boolean) : void {
    return this._dart_setCheckerboardOffscreenLayers(value);
}
...
const renderPerformanceOverlayDefaultProps = {

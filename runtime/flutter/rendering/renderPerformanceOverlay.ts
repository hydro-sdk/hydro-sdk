...
declare const flutter: {
    rendering: {
        renderPerformanceOverlay: (
            this: void,
            renderPerformanceOverlay: IRenderPerformanceOverlay,
            props: {
        ...
        >
{
    ...
    private readonly _dart_setOptionsMask: (value: number) => void =
        undefined as any;
    private readonly _dart_getRasterizerThreshold: () => number =
        undefined as any;
    private readonly _dart_setRasterizerThreshold: (value: number) => void =
        undefined as any;
    private readonly _dart_getCheckerboardRasterCacheImages: () => boolean =
        undefined as any;
    private readonly _dart_setCheckerboardRasterCacheImages: (
        value: boolean
    ) => void = undefined as any;
    private readonly _dart_getCheckerboardOffscreenLayers: () => boolean =
        undefined as any;

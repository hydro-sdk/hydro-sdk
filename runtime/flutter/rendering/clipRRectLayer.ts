...
rendering: {
clipRRectLayer: (this: void, clipRRectLayer: IClipRRectLayer, props : {  clipBehavior : Clip, clipRRect? : IRRect | undefined,}) => IClipRRectLayer
}
};
...
public constructor( props : {  clipBehavior? : Clip, clipRRect? : IRRect | undefined,}){
flutter.rendering.clipRRectLayer(this, {
...clipRRectLayerDefaultProps,
...props
});}
    private readonly _dart_getClipRRect: () => IRRect | undefined = undefined as any;
    private readonly _dart_setClipRRect: (value?: IRRect | undefined) => void = undefined as any;
...
public getClipRRect() : IRRect | undefined {
    return this._dart_getClipRRect();
}
public setClipRRect(value?: IRRect | undefined) : void {
    return this._dart_setClipRRect(value);
}
...
const clipRRectLayerDefaultProps = {

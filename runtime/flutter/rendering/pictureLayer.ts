...
rendering: {
pictureLayer: (this: void, pictureLayer: IPictureLayer, canvasBounds: IRect) => IPictureLayer
}
};
...
flutter.rendering.pictureLayer(this, canvasBounds);}
    private readonly _dart_getPicture: () => IPicture | undefined = undefined as any;
    private readonly _dart_setPicture: (picture?: IPicture | undefined) => void = undefined as any;
    private readonly _dart_getIsComplexHint: () => boolean = undefined as any;
    private readonly _dart_setIsComplexHint: (value: boolean) => void = undefined as any;
    private readonly _dart_getWillChangeHint: () => boolean = undefined as any;
    private readonly _dart_setWillChangeHint: (value: boolean) => void = undefined as any;

...
rendering: {
_fixedViewportOffset: (this: void, _fixedViewportOffset: I_FixedViewportOffset, _pixels: number) => I_FixedViewportOffset
}
};
export interface I_FixedViewportOffset
...
getHashCode: () => number;
}export class _FixedViewportOffset

 implements IViewportOffset, IListenable
{public constructor(_pixels: number){
flutter.rendering._fixedViewportOffset(this, _pixels);}

...
rendering: {
renderListBody: (this: void, renderListBody: IRenderListBody, props : {  axisDirection : AxisDirection, children? : IList<IRenderBox> | undefined,}) => IRenderListBody
}
};
export interface IRenderListBody
...
public constructor( props : {  axisDirection? : AxisDirection, children? : IList<IRenderBox> | undefined,}){
flutter.rendering.renderListBody(this, {
...renderListBodyDefaultProps,
...props
});}
    ...
    private readonly _dart_getMainAxis: () => Axis = undefined as any;
...
public getMainAxis() : Axis {
    return this._dart_getMainAxis();
}
...
const renderListBodyDefaultProps = {

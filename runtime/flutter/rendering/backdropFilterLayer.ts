...
rendering: {
backdropFilterLayer: (this: void, backdropFilterLayer: IBackdropFilterLayer, props : {  blendMode : BlendMode, filter? : IImageFilter | undefined,}) => IBackdropFilterLayer
}
};
...
getAttached: () => boolean;
getHashCode: () => number;
}export class BackdropFilterLayer
...
public constructor( props : {  blendMode? : BlendMode, filter? : IImageFilter | undefined,}){
flutter.rendering.backdropFilterLayer(this, {
...backdropFilterLayerDefaultProps,
...props
});}
    private readonly _dart_getFilter: () => IImageFilter | undefined = undefined as any;
    private readonly _dart_setFilter: (value?: IImageFilter | undefined) => void = undefined as any;
...
public getFilter() : IImageFilter | undefined {

...
declare const flutter: {
    rendering: {
        boxHitTestResult: (
            this: void,
            boxHitTestResult: IBoxHitTestResult
        ) => IBoxHitTestResult;
    };
};
export interface IBoxHitTestResult {
    addWithPaintTransform: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }) => boolean;
    addWithPaintOffset: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        offset?: IOffset | undefined;
        position: IOffset;
    }) => boolean;
    addWithRawTransform: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }) => boolean;
    addWithOutOfBandPosition: (props: {
        paintOffset?: IOffset | undefined;
        paintTransform?: IMatrix4 | undefined;
        rawTransform?: IMatrix4 | undefined;
        hitTest: (result: IBoxHitTestResult) => boolean;
    }) => boolean;
...
export class BoxHitTestResult implements IHitTestResult {
    public constructor() {
        flutter.rendering.boxHitTestResult(this);
    }
    private readonly _dart_addWithPaintTransform: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }) => boolean = undefined as any;
    private readonly _dart_addWithPaintOffset: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        offset?: IOffset | undefined;
        position: IOffset;
    }) => boolean = undefined as any;
    private readonly _dart_addWithRawTransform: (props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }) => boolean = undefined as any;
    private readonly _dart_addWithOutOfBandPosition: (props: {
        paintOffset?: IOffset | undefined;
        paintTransform?: IMatrix4 | undefined;
        rawTransform?: IMatrix4 | undefined;
        hitTest: (result: IBoxHitTestResult) => boolean;
    ...
    public addWithPaintTransform(props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }): boolean {
    ...
    public addWithPaintOffset(props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        offset?: IOffset | undefined;
        position: IOffset;
    }): boolean {
    ...
    public addWithRawTransform(props: {
        hitTest: (result: IBoxHitTestResult, position: IOffset) => boolean;
        position: IOffset;
        transform?: IMatrix4 | undefined;
    }): boolean {
    ...
    public addWithOutOfBandPosition(props: {
        paintOffset?: IOffset | undefined;
        paintTransform?: IMatrix4 | undefined;
        rawTransform?: IMatrix4 | undefined;
        hitTest: (result: IBoxHitTestResult) => boolean;

...
declare const flutter: {
    rendering: {
        _semanticsGeometry: (
            this: void,
            _semanticsGeometry: I_SemanticsGeometry,
            props: {
                ancestors: IList<IRenderObject>;
...
export class _SemanticsGeometry {
    ...
    private readonly _dart_getSemanticsClipRect: () => IRect | undefined =
        undefined as any;
    private readonly _dart_getPaintClipRect: () => IRect | undefined =
        undefined as any;

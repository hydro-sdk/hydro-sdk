...
rendering: {
_interestingSemanticsFragment: (this: void, _interestingSemanticsFragment: I_InterestingSemanticsFragment, props : {  dropsSemanticsOfPreviousSiblings : boolean, owner : IRenderObject,}) => I_InterestingSemanticsFragment
}
};
...
compileChildren: ( props : {  elevationAdjustment : number, parentPaintClipRect? : IRect | undefined, parentSemanticsClipRect? : IRect | undefined, result : IList<ISemanticsNode>,}) => void;
...
toString: () => string;
getHashCode: () => number;
}export class _InterestingSemanticsFragment

 implements I_SemanticsFragment
{    public readonly dropsSemanticsOfPreviousSiblings: boolean = undefined as any;
public constructor( props : {  dropsSemanticsOfPreviousSiblings : boolean, owner : IRenderObject,}){
flutter.rendering._interestingSemanticsFragment(this, props);}
    private readonly _dart_getOwner: () => IRenderObject = undefined as any;
    private readonly _dart_compileChildren: ( props : {  elevationAdjustment : number, parentPaintClipRect? : IRect | undefined, parentSemanticsClipRect? : IRect | undefined, result : IList<ISemanticsNode>,}) => void = undefined as any;
...
public compileChildren( props : {  elevationAdjustment : number, parentPaintClipRect? : IRect | undefined, parentSemanticsClipRect? : IRect | undefined, result : IList<ISemanticsNode>,}) : void {

...
rendering: {
clipPathLayer: (this: void, clipPathLayer: IClipPathLayer, props : {  clipBehavior : Clip, clipPath? : IPath | undefined,}) => IClipPathLayer
}
};
export interface IClipPathLayer
...
public constructor( props : {  clipBehavior? : Clip, clipPath? : IPath | undefined,}){
flutter.rendering.clipPathLayer(this, {
...clipPathLayerDefaultProps,
...props
});}
...
const clipPathLayerDefaultProps = {

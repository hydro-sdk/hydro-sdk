...
import { IFloatingHeaderSnapConfiguration } from "./floatingHeaderSnapConfiguration";
import { IOverScrollHeaderStretchConfiguration } from "./overScrollHeaderStretchConfiguration";
import { ITickerProvider } from "../scheduler/tickerProvider";
import { IPersistentHeaderShowOnScreenConfiguration } from "./persistentHeaderShowOnScreenConfiguration";
import { IRenderSliverPersistentHeader } from "./renderSliverPersistentHeader";
...
rendering: {
renderSliverFloatingPersistentHeader: (this: void, renderSliverFloatingPersistentHeader: IRenderSliverFloatingPersistentHeader, props? : {  child? : IRenderBox | undefined, snapConfiguration? : IFloatingHeaderSnapConfiguration | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined, vsync? : ITickerProvider | undefined, showOnScreenConfiguration? : IPersistentHeaderShowOnScreenConfiguration | undefined,}) => IRenderSliverFloatingPersistentHeader
}
};
export interface IRenderSliverFloatingPersistentHeader
...
getHashCode: () => number;
}export class RenderSliverFloatingPersistentHeader

 implements Omit<IRenderSliverPersistentHeader, "attach" | "detach" | "childMainAxisPosition" | "hitTestChildren" | "applyPaintTransform" | "debugFillProperties" | "debugDescribeChildren" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props? : {  child? : IRenderBox | undefined, snapConfiguration? : IFloatingHeaderSnapConfiguration | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined, vsync? : ITickerProvider | undefined, showOnScreenConfiguration? : IPersistentHeaderShowOnScreenConfiguration | undefined,}){
flutter.rendering.renderSliverFloatingPersistentHeader(this, props);}

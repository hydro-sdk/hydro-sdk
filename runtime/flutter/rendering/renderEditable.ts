...
rendering: {
renderEditable: (this: void, renderEditable: IRenderEditable, props : {  backgroundCursorColor? : IColor | undefined, children? : IList<IRenderBox> | undefined, clipBehavior : Clip, cursorColor? : IColor | undefined, cursorHeight? : number | undefined, cursorOffset : IOffset, cursorRadius? : IRadius | undefined, cursorWidth : number, devicePixelRatio : number, enableInteractiveSelection? : boolean | undefined, expands : boolean, floatingCursorAddedMargin : IEdgeInsets, forceLine : boolean, foregroundPainter? : IRenderEditablePainter | undefined, hasFocus? : boolean | undefined, ignorePointer : boolean, locale? : ILocale | undefined, maxLines? : number | undefined, minLines? : number | undefined, obscureText : boolean, obscuringCharacter : string, onCaretChanged? : (caretRect: IRect) => void | undefined, onSelectionChanged? : (selection: ITextSelection, renderObject: IRenderEditable, cause: SelectionChangedCause) => void | undefined, paintCursorAboveText : boolean, painter? : IRenderEditablePainter | undefined, promptRectColor? : IColor | undefined, promptRectRange? : ITextRange | undefined, readOnly : boolean, selection? : ITextSelection | undefined, selectionColor? : IColor | undefined, selectionHeightStyle : BoxHeightStyle, selectionWidthStyle : BoxWidthStyle, showCursor? : IValueNotifier<boolean> | undefined, strutStyle? : IStrutStyle | undefined, text? : IInlineSpan | undefined, textAlign : TextAlign, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor : number, textWidthBasis : TextWidthBasis, endHandleLayerLink : ILayerLink, offset : IViewportOffset, startHandleLayerLink : ILayerLink, textDirection : TextDirection, textSelectionDelegate : ITextSelectionDelegate,}) => IRenderEditable
}
};
...
setForegroundPainter: (newPainter?: IRenderEditablePainter | undefined) => void;
...
getEndpointsForSelection: (selection: ITextSelection) => IList<ITextSelectionPoint>;
...
selectPositionAt: ( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) => void;
selectWord: ( props : {  cause : SelectionChangedCause,}) => void;
selectWordsInRange: ( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) => void;
...
setFloatingCursor: (state: FloatingCursorDragState, boundedOffset: IOffset, lastTextPosition: ITextPosition, props? : {  resetLerpValue? : number | undefined,}) => void;
...
defaultComputeDistanceToFirstActualBaseline: (baseline: TextBaseline) => number | undefined;
defaultComputeDistanceToHighestActualBaseline: (baseline: TextBaseline) => number | undefined;
defaultHitTestChildren: (result: IBoxHitTestResult, props : {  position : IOffset,}) => boolean;
...
getHashCode: () => number;
 ...
 implements IRenderBox, IRelayoutWhenSystemFontsChangeMixin, IContainerRenderObjectMixin<IRenderBox,ITextParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,ITextParentData>, IDiagnosticableTreeMixin, IDiagnosticable, ITextLayoutMetrics, IContainerRenderObjectMixin<IRenderBox,ITextParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public readonly ignorePointer: boolean = undefined as any;
    public readonly textSelectionDelegate: ITextSelectionDelegate = undefined as any;
...
public constructor( props : {  backgroundCursorColor? : IColor | undefined, children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, cursorColor? : IColor | undefined, cursorHeight? : number | undefined, cursorOffset? : IOffset, cursorRadius? : IRadius | undefined, cursorWidth? : number, devicePixelRatio? : number, enableInteractiveSelection? : boolean | undefined, expands? : boolean, floatingCursorAddedMargin? : IEdgeInsets, forceLine? : boolean, foregroundPainter? : IRenderEditablePainter | undefined, hasFocus? : boolean | undefined, ignorePointer? : boolean, locale? : ILocale | undefined, maxLines? : number | undefined, minLines? : number | undefined, obscureText? : boolean, obscuringCharacter? : string, onCaretChanged? : (caretRect: IRect) => void | undefined, onSelectionChanged? : (selection: ITextSelection, renderObject: IRenderEditable, cause: SelectionChangedCause) => void | undefined, paintCursorAboveText? : boolean, painter? : IRenderEditablePainter | undefined, promptRectColor? : IColor | undefined, promptRectRange? : ITextRange | undefined, readOnly? : boolean, selection? : ITextSelection | undefined, selectionColor? : IColor | undefined, selectionHeightStyle? : BoxHeightStyle, selectionWidthStyle? : BoxWidthStyle, showCursor? : IValueNotifier<boolean> | undefined, strutStyle? : IStrutStyle | undefined, text? : IInlineSpan | undefined, textAlign? : TextAlign, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor? : number, textWidthBasis? : TextWidthBasis, endHandleLayerLink : ILayerLink, offset : IViewportOffset, startHandleLayerLink : ILayerLink, textDirection : TextDirection, textSelectionDelegate : ITextSelectionDelegate,}){
...
...props
    ...
    private readonly _dart_getForegroundPainter: () => IRenderEditablePainter | undefined = undefined as any;
    private readonly _dart_setForegroundPainter: (newPainter?: IRenderEditablePainter | undefined) => void = undefined as any;
    private readonly _dart_getPainter: () => IRenderEditablePainter | undefined = undefined as any;
    private readonly _dart_setPainter: (newPainter?: IRenderEditablePainter | undefined) => void = undefined as any;
    private readonly _dart_debugAssertLayoutUpToDate: () => void = undefined as any;
    ...
    private readonly _dart_setDevicePixelRatio: (value: number) => void = undefined as any;
    private readonly _dart_getObscuringCharacter: () => string = undefined as any;
    private readonly _dart_setObscuringCharacter: (value: string) => void = undefined as any;
    private readonly _dart_getObscureText: () => boolean = undefined as any;
    private readonly _dart_setObscureText: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_getSelectionStartInViewport: () => IValueListenable<boolean> = undefined as any;
    private readonly _dart_getSelectionEndInViewport: () => IValueListenable<boolean> = undefined as any;
    private readonly _dart_getLineAtOffset: (position: ITextPosition) => ITextSelection = undefined as any;
    private readonly _dart_getWordBoundary: (position: ITextPosition) => ITextRange = undefined as any;
    private readonly _dart_getTextPositionAbove: (position: ITextPosition) => ITextPosition = undefined as any;
    private readonly _dart_getTextPositionBelow: (position: ITextPosition) => ITextPosition = undefined as any;
    ...
    private readonly _dart_setTextDirection: (value: TextDirection) => void = undefined as any;
    ...
    private readonly _dart_getCursorColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setCursorColor: (value?: IColor | undefined) => void = undefined as any;
    private readonly _dart_getBackgroundCursorColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setBackgroundCursorColor: (value?: IColor | undefined) => void = undefined as any;
    private readonly _dart_getShowCursor: () => IValueNotifier<boolean> = undefined as any;
    private readonly _dart_setShowCursor: (value: IValueNotifier<boolean>) => void = undefined as any;
    private readonly _dart_getHasFocus: () => boolean = undefined as any;
    private readonly _dart_setHasFocus: (value: boolean) => void = undefined as any;
    private readonly _dart_getForceLine: () => boolean = undefined as any;
    private readonly _dart_setForceLine: (value: boolean) => void = undefined as any;
    private readonly _dart_getReadOnly: () => boolean = undefined as any;
    private readonly _dart_setReadOnly: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_getMinLines: () => number | undefined = undefined as any;
    private readonly _dart_setMinLines: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getExpands: () => boolean = undefined as any;
    private readonly _dart_setExpands: (value: boolean) => void = undefined as any;
    private readonly _dart_getSelectionColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setSelectionColor: (value?: IColor | undefined) => void = undefined as any;
    ...
    private readonly _dart_getSelection: () => ITextSelection | undefined = undefined as any;
    private readonly _dart_setSelection: (value?: ITextSelection | undefined) => void = undefined as any;
    private readonly _dart_getOffset: () => IViewportOffset = undefined as any;
    private readonly _dart_setOffset: (value: IViewportOffset) => void = undefined as any;
    private readonly _dart_getCursorWidth: () => number = undefined as any;
    private readonly _dart_setCursorWidth: (value: number) => void = undefined as any;
    private readonly _dart_getCursorHeight: () => number = undefined as any;
    private readonly _dart_setCursorHeight: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getPaintCursorAboveText: () => boolean = undefined as any;
    private readonly _dart_setPaintCursorAboveText: (value: boolean) => void = undefined as any;
    private readonly _dart_getCursorOffset: () => IOffset = undefined as any;
    private readonly _dart_setCursorOffset: (value: IOffset) => void = undefined as any;
    private readonly _dart_getCursorRadius: () => IRadius | undefined = undefined as any;
    private readonly _dart_setCursorRadius: (value?: IRadius | undefined) => void = undefined as any;
    private readonly _dart_getStartHandleLayerLink: () => ILayerLink = undefined as any;
    private readonly _dart_setStartHandleLayerLink: (value: ILayerLink) => void = undefined as any;
    private readonly _dart_getEndHandleLayerLink: () => ILayerLink = undefined as any;
    private readonly _dart_setEndHandleLayerLink: (value: ILayerLink) => void = undefined as any;
    private readonly _dart_getEnableInteractiveSelection: () => boolean | undefined = undefined as any;
    private readonly _dart_setEnableInteractiveSelection: (value?: boolean | undefined) => void = undefined as any;
    private readonly _dart_getSelectionEnabled: () => boolean = undefined as any;
    private readonly _dart_getPromptRectColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setPromptRectColor: (newValue?: IColor | undefined) => void = undefined as any;
    private readonly _dart_setPromptRectRange: (newRange?: ITextRange | undefined) => void = undefined as any;
    ...
    private readonly _dart_setClipBehavior: (value: Clip) => void = undefined as any;
    ...
    private readonly _dart_getEndpointsForSelection: (selection: ITextSelection) => IList<ITextSelectionPoint> = undefined as any;
    private readonly _dart_getRectForComposingRange: (range: ITextRange) => IRect | undefined = undefined as any;
    private readonly _dart_getPositionForPoint: (globalPosition: IOffset) => ITextPosition = undefined as any;
    private readonly _dart_getLocalRectForCaret: (caretPosition: ITextPosition) => IRect = undefined as any;
    ...
    private readonly _dart_getLastSecondaryTapDownPosition: () => IOffset | undefined = undefined as any;
    private readonly _dart_handleSecondaryTapDown: (details: ITapDownDetails) => void = undefined as any;
    private readonly _dart_handleTapDown: (details: ITapDownDetails) => void = undefined as any;
    ...
    private readonly _dart_selectPosition: ( props : {  cause : SelectionChangedCause,}) => void = undefined as any;
    private readonly _dart_selectPositionAt: ( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) => void = undefined as any;
    private readonly _dart_selectWord: ( props : {  cause : SelectionChangedCause,}) => void = undefined as any;
    private readonly _dart_selectWordsInRange: ( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) => void = undefined as any;
    private readonly _dart_selectWordEdge: ( props : {  cause : SelectionChangedCause,}) => void = undefined as any;
    ...
    private readonly _dart_calculateBoundedFloatingCursorOffset: (rawCursorOffset: IOffset) => IOffset = undefined as any;
    private readonly _dart_setFloatingCursor: (state: FloatingCursorDragState, boundedOffset: IOffset, lastTextPosition: ITextPosition, props? : {  resetLerpValue? : number | undefined,}) => void = undefined as any;
    ...
    private readonly _dart_defaultComputeDistanceToFirstActualBaseline: (baseline: TextBaseline) => number | undefined = undefined as any;
    private readonly _dart_defaultComputeDistanceToHighestActualBaseline: (baseline: TextBaseline) => number | undefined = undefined as any;
    private readonly _dart_defaultHitTestChildren: (result: IBoxHitTestResult, props : {  position : IOffset,}) => boolean = undefined as any;
    private readonly _dart_defaultPaint: (context: IPaintingContext, offset: IOffset) => void = undefined as any;
    private readonly _dart_getChildrenAsList: () => IList<IRenderBox> = undefined as any;
...
public setForegroundPainter(newPainter?: IRenderEditablePainter | undefined) : void {
...
public getEndpointsForSelection(selection: ITextSelection) : IList<ITextSelectionPoint> {
...
public selectPositionAt( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) : void {
...
public selectWordsInRange( props : {  to? : IOffset | undefined, cause : SelectionChangedCause, from : IOffset,}) : void {
...
public calculateBoundedFloatingCursorOffset(rawCursorOffset: IOffset) : IOffset {
    return this._dart_calculateBoundedFloatingCursorOffset(rawCursorOffset);
}
public setFloatingCursor(state: FloatingCursorDragState, boundedOffset: IOffset, lastTextPosition: ITextPosition, props? : {  resetLerpValue? : number | undefined,}) : void {
    return this._dart_setFloatingCursor(state, boundedOffset, lastTextPosition, props);
}
...
public defaultComputeDistanceToFirstActualBaseline(baseline: TextBaseline) : number | undefined {
    return this._dart_defaultComputeDistanceToFirstActualBaseline(baseline);
}
public defaultComputeDistanceToHighestActualBaseline(baseline: TextBaseline) : number | undefined {
    return this._dart_defaultComputeDistanceToHighestActualBaseline(baseline);
}
public defaultHitTestChildren(result: IBoxHitTestResult, props : {  position : IOffset,}) : boolean {

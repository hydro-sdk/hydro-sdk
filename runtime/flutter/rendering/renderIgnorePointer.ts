...
rendering: {
renderIgnorePointer: (this: void, renderIgnorePointer: IRenderIgnorePointer, props : {  child? : IRenderBox | undefined, ignoring : boolean, ignoringSemantics? : boolean | undefined,}) => IRenderIgnorePointer
}
};
export interface IRenderIgnorePointer
...
getHashCode: () => number;
}export class RenderIgnorePointer
...
public constructor( props : {  child? : IRenderBox | undefined, ignoring? : boolean, ignoringSemantics? : boolean | undefined,}){
flutter.rendering.renderIgnorePointer(this, {
...renderIgnorePointerDefaultProps,
...props
});}
...
const renderIgnorePointerDefaultProps = {
    ignoring: true,
};

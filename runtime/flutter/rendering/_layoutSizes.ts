...
rendering: {
_layoutSizes: (this: void, _layoutSizes: I_LayoutSizes, props : {  allocatedSize : number, crossSize : number, mainSize : number,}) => I_LayoutSizes
}
};
...
public constructor( props : {  allocatedSize : number, crossSize : number, mainSize : number,}){

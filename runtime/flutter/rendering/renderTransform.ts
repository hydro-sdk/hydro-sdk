...
rendering: {
renderTransform: (this: void, renderTransform: IRenderTransform, props : {  alignment? : IAlignmentGeometry | undefined, child? : IRenderBox | undefined, filterQuality? : FilterQuality | undefined, origin? : IOffset | undefined, textDirection? : TextDirection | undefined, transformHitTests : boolean, transform : IMatrix4,}) => IRenderTransform
}
};
...
getOrigin: () => IOffset | undefined;
setOrigin: (value?: IOffset | undefined) => void;
getAlignment: () => IAlignmentGeometry | undefined;
...
scale: (x: number, y?: number | undefined, z?: number | undefined) => void;
...
public constructor( props : {  alignment? : IAlignmentGeometry | undefined, child? : IRenderBox | undefined, filterQuality? : FilterQuality | undefined, origin? : IOffset | undefined, textDirection? : TextDirection | undefined, transformHitTests? : boolean, transform : IMatrix4,}){
flutter.rendering.renderTransform(this, {
...renderTransformDefaultProps,
...props
});}
    private readonly _dart_getOrigin: () => IOffset | undefined = undefined as any;
    private readonly _dart_setOrigin: (value?: IOffset | undefined) => void = undefined as any;
    private readonly _dart_getAlignment: () => IAlignmentGeometry | undefined = undefined as any;
    private readonly _dart_setAlignment: (value?: IAlignmentGeometry | undefined) => void = undefined as any;
    ...
    private readonly _dart_setTransform: (value: IMatrix4) => void = undefined as any;
    private readonly _dart_getFilterQuality: () => FilterQuality | undefined = undefined as any;
    private readonly _dart_setFilterQuality: (value?: FilterQuality | undefined) => void = undefined as any;
    private readonly _dart_setIdentity: () => void = undefined as any;
    private readonly _dart_rotateX: (radians: number) => void = undefined as any;
    private readonly _dart_rotateY: (radians: number) => void = undefined as any;
    private readonly _dart_rotateZ: (radians: number) => void = undefined as any;
    private readonly _dart_translate: (x: number, y: number, z: number) => void = undefined as any;
    private readonly _dart_scale: (x: number, y?: number | undefined, z?: number | undefined) => void = undefined as any;
...
public getOrigin() : IOffset | undefined {
    return this._dart_getOrigin();
}
public setOrigin(value?: IOffset | undefined) : void {
    return this._dart_setOrigin(value);
}
public getAlignment() : IAlignmentGeometry | undefined {
    return this._dart_getAlignment();
}
public setAlignment(value?: IAlignmentGeometry | undefined) : void {
...
public rotateX(radians: number) : void {
    return this._dart_rotateX(radians);
}
public rotateY(radians: number) : void {
    return this._dart_rotateY(radians);
}
public rotateZ(radians: number) : void {
    return this._dart_rotateZ(radians);
}
public translate(x: number, y: number = 0.0, z: number = 0.0) : void {
    return this._dart_translate(x, y, z);
}
public scale(x: number, y?: number | undefined, z?: number | undefined) : void {
    return this._dart_scale(x, y, z);
}
...
const renderTransformDefaultProps = {

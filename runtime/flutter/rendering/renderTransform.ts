...
declare const flutter: {
    rendering: {
        renderTransform: (
            this: void,
            renderTransform: IRenderTransform,
            props: {
        ...
        >
{
    ...
    private readonly _dart_getOrigin: () => IOffset | undefined =
        undefined as any;
    private readonly _dart_setOrigin: (value?: IOffset | undefined) => void =
        undefined as any;
    private readonly _dart_getAlignment: () => IAlignmentGeometry | undefined =
        undefined as any;
    private readonly _dart_setAlignment: (
        value?: IAlignmentGeometry | undefined
    ...
    private readonly _dart_rotateX: (radians: number) => void =
        undefined as any;
    private readonly _dart_rotateY: (radians: number) => void =
        undefined as any;
    private readonly _dart_rotateZ: (radians: number) => void =
        undefined as any;

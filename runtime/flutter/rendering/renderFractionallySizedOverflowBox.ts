...
rendering: {
renderFractionallySizedOverflowBox: (this: void, renderFractionallySizedOverflowBox: IRenderFractionallySizedOverflowBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, heightFactor? : number | undefined, textDirection? : TextDirection | undefined, widthFactor? : number | undefined,}) => IRenderFractionallySizedOverflowBox
}
};
export interface IRenderFractionallySizedOverflowBox


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getWidthFactor: () => number | undefined;
setWidthFactor: (value?: number | undefined) => void;
getHeightFactor: () => number | undefined;
setHeightFactor: (value?: number | undefined) => void;
...
getHashCode: () => number;
}export class RenderFractionallySizedOverflowBox
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, heightFactor? : number | undefined, textDirection? : TextDirection | undefined, widthFactor? : number | undefined,}){
flutter.rendering.renderFractionallySizedOverflowBox(this, {
...renderFractionallySizedOverflowBoxDefaultProps,
...props
});}
    private readonly _dart_getWidthFactor: () => number | undefined = undefined as any;
    private readonly _dart_setWidthFactor: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getHeightFactor: () => number | undefined = undefined as any;
    private readonly _dart_setHeightFactor: (value?: number | undefined) => void = undefined as any;
...
public getWidthFactor() : number | undefined {
    return this._dart_getWidthFactor();
}
public setWidthFactor(value?: number | undefined) : void {
    return this._dart_setWidthFactor(value);
}
public getHeightFactor() : number | undefined {
    return this._dart_getHeightFactor();
}
public setHeightFactor(value?: number | undefined) : void {
    return this._dart_setHeightFactor(value);
}
...
const renderFractionallySizedOverflowBoxDefaultProps = {

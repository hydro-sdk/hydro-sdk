...
rendering: {
renderSliver: (this: void, renderSliver: IRenderSliver) => IRenderSliver
}
};
export interface IRenderSliver
...
public constructor(){
flutter.rendering.renderSliver(this);}

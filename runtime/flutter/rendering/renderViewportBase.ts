...
rendering: {
renderViewportBase: <ParentDataClass>(this: void, renderViewportBase: IRenderViewportBase<ParentDataClass>, props : {  axisDirection : AxisDirection, cacheExtent? : number | undefined, cacheExtentStyle : CacheExtentStyle, clipBehavior : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}) => IRenderViewportBase<ParentDataClass>;
renderViewportBaseShowInViewport: ( props : {  curve : ICurve, descendant? : IRenderObject | undefined, duration : IDuration, rect? : IRect | undefined, offset : IViewportOffset, viewport : IRenderAbstractViewport,}) => IRect | undefined
}
};
export interface IRenderViewportBase
<ParentDataClass>
...
getHashCode: () => number;
}export class RenderViewportBase
<ParentDataClass>
 implements IRenderBox, IContainerRenderObjectMixin<IRenderSliver,ParentDataClass>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  axisDirection? : AxisDirection, cacheExtent? : number | undefined, cacheExtentStyle? : CacheExtentStyle, clipBehavior? : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}){
flutter.rendering.renderViewportBase(this, {
...renderViewportBaseDefaultProps,
...props
});}
public static showInViewport( props : {  curve? : ICurve, descendant? : IRenderObject | undefined, duration? : IDuration, rect? : IRect | undefined, offset : IViewportOffset, viewport : IRenderAbstractViewport,}) : IRect | undefined{
return flutter.rendering.renderViewportBaseShowInViewport({
...showInViewportDefaultProps,
...props
});
...
const renderViewportBaseDefaultProps = {
...
const showInViewportDefaultProps = {
    curve: Curves.ease,
    duration: Duration.zero,
};

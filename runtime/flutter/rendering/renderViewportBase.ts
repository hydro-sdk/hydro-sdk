...
declare const flutter: {
    rendering: {
        renderViewportBase: <ParentDataClass>(
            this: void,
            renderViewportBase: IRenderViewportBase<ParentDataClass>,
            props: {
        ...
        renderViewportBaseShowInViewport: (props: {
            curve: ICurve;
            descendant?: IRenderObject | undefined;
            duration: IDuration;
            rect?: IRect | undefined;
            offset: IViewportOffset;
            viewport: IRenderAbstractViewport;
        }) => IRect | undefined;
    };
};
export interface IRenderViewportBase<ParentDataClass> {
...
export class RenderViewportBase<ParentDataClass>
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderSliver, ParentDataClass>,
        ...
        >
{
    ...
    public static showInViewport(props: {
        curve?: ICurve;
        descendant?: IRenderObject | undefined;
        duration?: IDuration;
        rect?: IRect | undefined;

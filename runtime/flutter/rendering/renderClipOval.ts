...
rendering: {
renderClipOval: (this: void, renderClipOval: IRenderClipOval, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, clipper? : ICustomClipper<IRect> | undefined,}) => IRenderClipOval
}
};
export interface IRenderClipOval
...
getClipper: () => ICustomClipper<IRect> | undefined;
setClipper: (newClipper?: ICustomClipper<IRect> | undefined) => void;
...
getHashCode: () => number;
}export class RenderClipOval

 implements I_RenderCustomClip<IRect>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, clipper? : ICustomClipper<IRect> | undefined,}){
flutter.rendering.renderClipOval(this, {
...renderClipOvalDefaultProps,
...props
});}
    ...
    private readonly _dart_getClipper: () => ICustomClipper<IRect> | undefined = undefined as any;
    private readonly _dart_setClipper: (newClipper?: ICustomClipper<IRect> | undefined) => void = undefined as any;
...
public getClipper() : ICustomClipper<IRect> | undefined {
    return this._dart_getClipper();
}
public setClipper(newClipper?: ICustomClipper<IRect> | undefined) : void {
...
const renderClipOvalDefaultProps = {

...
declare const flutter: {
    rendering: {
        renderClipOval: (
            this: void,
            renderClipOval: IRenderClipOval,
            props: {
        ...
        >
{
    ...
    private readonly _dart_describeApproximatePaintClip: (child: any) => IRect =
        undefined as any;
    private readonly _dart_getClipper: () => ICustomClipper<IRect> | undefined =
        undefined as any;
    private readonly _dart_setClipper: (
        newClipper?: ICustomClipper<IRect> | undefined
    ) => void = undefined as any;

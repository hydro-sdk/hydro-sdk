...
rendering: {
renderConstraintsTransformBox: (this: void, renderConstraintsTransformBox: IRenderConstraintsTransformBox, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, alignment : IAlignmentGeometry, constraintsTransform : (__: IBoxConstraints) => IBoxConstraints, textDirection? : TextDirection | undefined,}) => IRenderConstraintsTransformBox
}
};
export interface IRenderConstraintsTransformBox
...
getHashCode: () => number;
}export class RenderConstraintsTransformBox

 implements IRenderAligningShiftedBox, IDebugOverflowIndicatorMixin, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, alignment : IAlignmentGeometry, constraintsTransform : (__: IBoxConstraints) => IBoxConstraints, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderConstraintsTransformBox(this, {
...renderConstraintsTransformBoxDefaultProps,
...props
});}
...
const renderConstraintsTransformBoxDefaultProps = {

...
rendering: {
renderSliverScrollingPersistentHeader: (this: void, renderSliverScrollingPersistentHeader: IRenderSliverScrollingPersistentHeader, props? : {  child? : IRenderBox | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined,}) => IRenderSliverScrollingPersistentHeader
}
};
export interface IRenderSliverScrollingPersistentHeader
...
getHashCode: () => number;
}export class RenderSliverScrollingPersistentHeader
...
flutter.rendering.renderSliverScrollingPersistentHeader(this, props);}

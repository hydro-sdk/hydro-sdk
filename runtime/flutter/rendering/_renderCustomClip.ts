...
rendering: {
_renderCustomClip: <T>(this: void, _renderCustomClip: I_RenderCustomClip<T>, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, clipper? : ICustomClipper<T> | undefined,}) => I_RenderCustomClip<T>
}
};
export interface I_RenderCustomClip
<T>
...
getHashCode: () => number;
}export class _RenderCustomClip
<T>
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, clipper? : ICustomClipper<T> | undefined,}){
flutter.rendering._renderCustomClip(this, {
..._renderCustomClipDefaultProps,
...props
});}
...
const _renderCustomClipDefaultProps = {

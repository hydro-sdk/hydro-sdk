...
rendering: {
renderConstrainedBox: (this: void, renderConstrainedBox: IRenderConstrainedBox, props : {  child? : IRenderBox | undefined, additionalConstraints : IBoxConstraints,}) => IRenderConstrainedBox
}
};
export interface IRenderConstrainedBox
...
getHashCode: () => number;
}export class RenderConstrainedBox
...
public constructor( props : {  child? : IRenderBox | undefined, additionalConstraints : IBoxConstraints,}){
flutter.rendering.renderConstrainedBox(this, props);}
    private readonly _dart_getAdditionalConstraints: () => IBoxConstraints = undefined as any;
    private readonly _dart_setAdditionalConstraints: (value: IBoxConstraints) => void = undefined as any;

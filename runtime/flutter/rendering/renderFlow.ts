...
export class RenderFlow
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, IFlowParentData>,
        IRenderBoxContainerDefaultsMixin<IRenderBox, IFlowParentData>,
        IDiagnosticableTreeMixin,
        IDiagnosticable,
        IFlowPaintingContext,
        IContainerRenderObjectMixin<IRenderBox, IFlowParentData>,
        IHitTestTarget,
        Omit<
            IDiagnosticableTree,
        ...
        >
{
    ...
    private readonly _dart_setDelegate: (newDelegate: IFlowDelegate) => void =
        undefined as any;
    ...
    private readonly _dart_getChildSize: (i: number) => ISize | undefined =
        undefined as any;

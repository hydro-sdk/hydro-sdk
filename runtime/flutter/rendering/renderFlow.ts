...
import { IFlowDelegate } from "./flowDelegate";
...
rendering: {
renderFlow: (this: void, renderFlow: IRenderFlow, props : {  children? : IList<IRenderBox> | undefined, clipBehavior : Clip, delegate : IFlowDelegate,}) => IRenderFlow
}
};
export interface IRenderFlow
...
setDelegate: (newDelegate: IFlowDelegate) => void;
...
paintChild: (i: number, props : {  opacity : number, transform? : IMatrix4 | undefined,}) => void;
...
getHashCode: () => number;
 ...
 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IFlowParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IFlowParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IFlowPaintingContext, IContainerRenderObjectMixin<IRenderBox,IFlowParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, delegate : IFlowDelegate,}){
flutter.rendering.renderFlow(this, {
...renderFlowDefaultProps,
...props
});}
    private readonly _dart_setupParentData: (child: any) => void = undefined as any;
    private readonly _dart_getDelegate: () => IFlowDelegate = undefined as any;
    private readonly _dart_setDelegate: (newDelegate: IFlowDelegate) => void = undefined as any;
    ...
    private readonly _dart_getChildSize: (i: number) => ISize | undefined = undefined as any;
    private readonly _dart_paintChild: (i: number, props : {  opacity : number, transform? : IMatrix4 | undefined,}) => void = undefined as any;
...
public getDelegate() : IFlowDelegate {
    return this._dart_getDelegate();
}
public setDelegate(newDelegate: IFlowDelegate) : void {
    return this._dart_setDelegate(newDelegate);
}
...
public getChildSize(i: number) : ISize | undefined {
    return this._dart_getChildSize(i);
}
public paintChild(i: number, props : {  opacity? : number, transform? : IMatrix4 | undefined,}) : void {
    return this._dart_paintChild(i, {
...paintChildDefaultProps,
...props
});
}
...
const renderFlowDefaultProps = {
    clipBehavior: Clip.hardEdge,
};
const paintChildDefaultProps = {
    opacity: 1.0,
};

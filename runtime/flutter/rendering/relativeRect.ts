...
declare const flutter: {
    rendering: {
        ...
        relativeRectLerp: (
            a: IRelativeRect | undefined,
            b: IRelativeRect | undefined,
            t: number
        ) => IRelativeRect | undefined;
    };
};
...
export class RelativeRect {
    ...
    private readonly _dart_shift: (offset: IOffset) => IRelativeRect =
        undefined as any;
    private readonly _dart_inflate: (delta: number) => IRelativeRect =
        undefined as any;
    private readonly _dart_deflate: (delta: number) => IRelativeRect =
        undefined as any;
    private readonly _dart_intersect: (other: IRelativeRect) => IRelativeRect =
        undefined as any;
    private readonly _dart_toRect: (container: IRect) => IRect =
        undefined as any;
    private readonly _dart_toSize: (container: ISize) => ISize =
        undefined as any;

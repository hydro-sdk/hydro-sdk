...
rendering: {
renderAbstractViewportOf: (object?: IRenderObject | undefined) => IRenderAbstractViewport | undefined
}
};
export interface IRenderAbstractViewport
...
getHashCode: () => number;
}export class RenderAbstractViewport

 implements Omit<IRenderObject, "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "debugFillProperties" | "debugDescribeChildren" | "toDiagnosticsNode">, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public static defaultCacheExtent = 250.0;
...
public static of(object?: IRenderObject | undefined) : IRenderAbstractViewport | undefined{
return flutter.rendering.renderAbstractViewportOf(object);

...
rendering: {
renderParagraph: (this: void, renderParagraph: IRenderParagraph, text: IInlineSpan, props : {  children? : IList<IRenderBox> | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, overflow : TextOverflow, softWrap : boolean, strutStyle? : IStrutStyle | undefined, textAlign : TextAlign, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor : number, textWidthBasis : TextWidthBasis, textDirection : TextDirection,}) => IRenderParagraph
}
};
...
getHashCode: () => number;
 ...
 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,ITextParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,ITextParentData>, IRelayoutWhenSystemFontsChangeMixin, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,ITextParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor(text: IInlineSpan, props : {  children? : IList<IRenderBox> | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, overflow? : TextOverflow, softWrap? : boolean, strutStyle? : IStrutStyle | undefined, textAlign? : TextAlign, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor? : number, textWidthBasis? : TextWidthBasis, textDirection : TextDirection,}){
...
...props
    ...
    private readonly _dart_setText: (value: IInlineSpan) => void = undefined as any;
    ...
    private readonly _dart_setSoftWrap: (value: boolean) => void = undefined as any;
    private readonly _dart_getOverflow: () => TextOverflow = undefined as any;
    private readonly _dart_setOverflow: (value: TextOverflow) => void = undefined as any;
    ...
    private readonly _dart_getFullHeightForCaret: (position: ITextPosition) => number | undefined = undefined as any;

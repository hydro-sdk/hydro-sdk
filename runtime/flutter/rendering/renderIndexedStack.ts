...
import { IRenderStack } from "./renderStack";
...
rendering: {
renderIndexedStack: (this: void, renderIndexedStack: IRenderIndexedStack, props : {  alignment : IAlignmentGeometry, children? : IList<IRenderBox> | undefined, index? : number | undefined, textDirection? : TextDirection | undefined,}) => IRenderIndexedStack
}
};
export interface IRenderIndexedStack
...
getHashCode: () => number;
}export class RenderIndexedStack

 implements Omit<IRenderStack, "debugFillProperties" | "debugDescribeChildren" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IContainerRenderObjectMixin<IRenderBox,IStackParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IStackParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,IStackParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alignment? : IAlignmentGeometry, children? : IList<IRenderBox> | undefined, index? : number | undefined, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderIndexedStack(this, {
...renderIndexedStackDefaultProps,
...props
});}
    private readonly _dart_visitChildrenForSemantics: (visitor : (child: IRenderObject) => void) => void = undefined as any;
    private readonly _dart_getIndex: () => number | undefined = undefined as any;
    private readonly _dart_setIndex: (value?: number | undefined) => void = undefined as any;
...
public setIndex(value?: number | undefined) : void {
...
const renderIndexedStackDefaultProps = {

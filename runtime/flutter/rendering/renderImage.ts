...
rendering: {
renderImage: (this: void, renderImage: IRenderImage, props : {  alignment : IAlignmentGeometry, centerSlice? : IRect | undefined, color? : IColor | undefined, colorBlendMode? : BlendMode | undefined, debugImageLabel? : string | undefined, filterQuality : FilterQuality, fit? : BoxFit | undefined, height? : number | undefined, image? : IImage | undefined, invertColors : boolean, isAntiAlias : boolean, matchTextDirection : boolean, opacity? : IAnimation<number> | undefined, repeat : ImageRepeat, scale : number, textDirection? : TextDirection | undefined, width? : number | undefined,}) => IRenderImage
}
};
...
public constructor( props : {  alignment? : IAlignmentGeometry, centerSlice? : IRect | undefined, color? : IColor | undefined, colorBlendMode? : BlendMode | undefined, debugImageLabel? : string | undefined, filterQuality? : FilterQuality, fit? : BoxFit | undefined, height? : number | undefined, image? : IImage | undefined, invertColors? : boolean, isAntiAlias? : boolean, matchTextDirection? : boolean, opacity? : IAnimation<number> | undefined, repeat? : ImageRepeat, scale? : number, textDirection? : TextDirection | undefined, width? : number | undefined,}){
flutter.rendering.renderImage(this, {
...renderImageDefaultProps,
...props
});}
    private readonly _dart_getImage: () => IImage | undefined = undefined as any;
    private readonly _dart_setImage: (value?: IImage | undefined) => void = undefined as any;
    private readonly _dart_getWidth: () => number | undefined = undefined as any;
    private readonly _dart_setWidth: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getHeight: () => number | undefined = undefined as any;
    private readonly _dart_setHeight: (value?: number | undefined) => void = undefined as any;
    ...
    private readonly _dart_getColor: () => IColor | undefined = undefined as any;
    private readonly _dart_setColor: (value?: IColor | undefined) => void = undefined as any;
    private readonly _dart_getOpacity: () => IAnimation<number> | undefined = undefined as any;
    private readonly _dart_setOpacity: (value?: IAnimation<number> | undefined) => void = undefined as any;
    private readonly _dart_getFilterQuality: () => FilterQuality = undefined as any;
    private readonly _dart_setFilterQuality: (value: FilterQuality) => void = undefined as any;
    private readonly _dart_getColorBlendMode: () => BlendMode | undefined = undefined as any;
    private readonly _dart_setColorBlendMode: (value?: BlendMode | undefined) => void = undefined as any;
    private readonly _dart_getFit: () => BoxFit | undefined = undefined as any;
    private readonly _dart_setFit: (value?: BoxFit | undefined) => void = undefined as any;
    private readonly _dart_getAlignment: () => IAlignmentGeometry = undefined as any;
    private readonly _dart_setAlignment: (value: IAlignmentGeometry) => void = undefined as any;
    private readonly _dart_getRepeat: () => ImageRepeat = undefined as any;
    private readonly _dart_setRepeat: (value: ImageRepeat) => void = undefined as any;
    private readonly _dart_getCenterSlice: () => IRect | undefined = undefined as any;
    private readonly _dart_setCenterSlice: (value?: IRect | undefined) => void = undefined as any;
    private readonly _dart_getInvertColors: () => boolean = undefined as any;
    private readonly _dart_setInvertColors: (value: boolean) => void = undefined as any;
    private readonly _dart_getMatchTextDirection: () => boolean = undefined as any;
    private readonly _dart_setMatchTextDirection: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_setIsAntiAlias: (value: boolean) => void = undefined as any;

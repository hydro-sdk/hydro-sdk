...
rendering: {
renderSliverIgnorePointer: (this: void, renderSliverIgnorePointer: IRenderSliverIgnorePointer, props : {  ignoring : boolean, ignoringSemantics? : boolean | undefined, sliver? : IRenderSliver | undefined,}) => IRenderSliverIgnorePointer
}
};
export interface IRenderSliverIgnorePointer
...
getIgnoring: () => boolean;
setIgnoring: (value: boolean) => void;
getIgnoringSemantics: () => boolean | undefined;
setIgnoringSemantics: (value?: boolean | undefined) => void;
...
getHashCode: () => number;
}export class RenderSliverIgnorePointer

 implements Omit<IRenderProxySliver, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderSliver>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  ignoring? : boolean, ignoringSemantics? : boolean | undefined, sliver? : IRenderSliver | undefined,}){
flutter.rendering.renderSliverIgnorePointer(this, {
...renderSliverIgnorePointerDefaultProps,
...props
});}
    private readonly _dart_getIgnoring: () => boolean = undefined as any;
    private readonly _dart_setIgnoring: (value: boolean) => void = undefined as any;
    private readonly _dart_getIgnoringSemantics: () => boolean | undefined = undefined as any;
    private readonly _dart_setIgnoringSemantics: (value?: boolean | undefined) => void = undefined as any;
...
public getIgnoring() : boolean {
    return this._dart_getIgnoring();
}
public setIgnoring(value: boolean) : void {
    return this._dart_setIgnoring(value);
}
public getIgnoringSemantics() : boolean | undefined {
    return this._dart_getIgnoringSemantics();
}
public setIgnoringSemantics(value?: boolean | undefined) : void {
    return this._dart_setIgnoringSemantics(value);
}
...
const renderSliverIgnorePointerDefaultProps = {
    ignoring: true,
};

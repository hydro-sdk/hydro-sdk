...
rendering: {
_debugSize: (this: void, _debugSize: I_DebugSize, source: ISize, _owner: IRenderBox, _canBeUsedByParent: boolean) => I_DebugSize
}
};
export interface I_DebugSize
...
getIsFinite: () => boolean;
}export class _DebugSize

 implements ISize
{public constructor(source: ISize, _owner: IRenderBox, _canBeUsedByParent: boolean){
flutter.rendering._debugSize(this, source, _owner, _canBeUsedByParent);}
    private readonly _dart_topLeft: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_topCenter: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_topRight: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_centerLeft: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_center: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_centerRight: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_bottomLeft: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_bottomCenter: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_bottomRight: (origin: IOffset) => IOffset = undefined as any;
    private readonly _dart_contains: (offset: IOffset) => boolean = undefined as any;

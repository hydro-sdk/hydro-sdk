...
rendering: {
performanceOverlayLayer: (this: void, performanceOverlayLayer: IPerformanceOverlayLayer, props : {  checkerboardOffscreenLayers : boolean, checkerboardRasterCacheImages : boolean, optionsMask : number, overlayRect : IRect, rasterizerThreshold : number,}) => IPerformanceOverlayLayer
}
};
export interface IPerformanceOverlayLayer
...
getAttached: () => boolean;
getHashCode: () => number;
}export class PerformanceOverlayLayer
...
public constructor( props : {  checkerboardOffscreenLayers : boolean, checkerboardRasterCacheImages : boolean, optionsMask : number, overlayRect : IRect, rasterizerThreshold : number,}){
flutter.rendering.performanceOverlayLayer(this, props);}
    private readonly _dart_getOverlayRect: () => IRect = undefined as any;
    private readonly _dart_setOverlayRect: (value: IRect) => void = undefined as any;
...
public getOverlayRect() : IRect {
    return this._dart_getOverlayRect();
}

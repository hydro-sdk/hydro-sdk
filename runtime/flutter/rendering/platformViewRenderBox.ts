...
rendering: {
platformViewRenderBox: (this: void, platformViewRenderBox: IPlatformViewRenderBox, props : {  controller : IPlatformViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}) => IPlatformViewRenderBox
}
};
export interface IPlatformViewRenderBox
...
getHashCode: () => number;
}export class PlatformViewRenderBox
...
public constructor( props : {  controller : IPlatformViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}){
flutter.rendering.platformViewRenderBox(this, props);}
    private readonly _dart_getController: () => IPlatformViewController = undefined as any;
    private readonly _dart_setController: (controller: IPlatformViewController) => void = undefined as any;

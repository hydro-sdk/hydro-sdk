...
import { IRenderProxySliver } from "./renderProxySliver";
...
import { IRenderAnimatedOpacityMixin } from "./renderAnimatedOpacityMixin";
...
rendering: {
renderSliverAnimatedOpacity: (this: void, renderSliverAnimatedOpacity: IRenderSliverAnimatedOpacity, props : {  alwaysIncludeSemantics : boolean, sliver? : IRenderSliver | undefined, opacity : IAnimation<number>,}) => IRenderSliverAnimatedOpacity
}
};
export interface IRenderSliverAnimatedOpacity
...
getHashCode: () => number;
}export class RenderSliverAnimatedOpacity

 implements Omit<IRenderProxySliver, "paint" | "attach" | "detach" | "debugFillProperties" | "visitChildrenForSemantics" | "alwaysNeedsCompositing" | "debugDescribeChildren" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderAnimatedOpacityMixin<IRenderSliver>, IRenderObjectWithChildMixin<IRenderSliver>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugFillProperties" | "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, sliver? : IRenderSliver | undefined, opacity : IAnimation<number>,}){
flutter.rendering.renderSliverAnimatedOpacity(this, {
...renderSliverAnimatedOpacityDefaultProps,
...props
});}
    ...
    private readonly _dart_getOpacity: () => IAnimation<number> = undefined as any;
    private readonly _dart_setOpacity: (value: IAnimation<number>) => void = undefined as any;
    private readonly _dart_getAlwaysIncludeSemantics: () => boolean = undefined as any;
    private readonly _dart_setAlwaysIncludeSemantics: (value: boolean) => void = undefined as any;
...
public getOpacity() : IAnimation<number> {
    return this._dart_getOpacity();
}
public setOpacity(value: IAnimation<number>) : void {
    return this._dart_setOpacity(value);
}
public getAlwaysIncludeSemantics() : boolean {
    return this._dart_getAlwaysIncludeSemantics();
}
public setAlwaysIncludeSemantics(value: boolean) : void {
    return this._dart_setAlwaysIncludeSemantics(value);
}
...
const renderSliverAnimatedOpacityDefaultProps = {

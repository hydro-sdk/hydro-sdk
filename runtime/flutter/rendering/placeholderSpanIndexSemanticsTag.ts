...
rendering: {
placeholderSpanIndexSemanticsTag: (this: void, placeholderSpanIndexSemanticsTag: IPlaceholderSpanIndexSemanticsTag, index: number) => IPlaceholderSpanIndexSemanticsTag
}
};
...
getHashCode: () => number;
toString: () => string;
}export class PlaceholderSpanIndexSemanticsTag

 implements ISemanticsTag

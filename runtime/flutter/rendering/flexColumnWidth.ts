...
rendering: {
flexColumnWidth: (this: void, flexColumnWidth: IFlexColumnWidth, value: number) => IFlexColumnWidth
}
};
...
flutter.rendering.flexColumnWidth(this, value);}
    ...
    private readonly _dart_flex: (cells: IIterable<IRenderBox>) => number = undefined as any;

...
rendering: {
renderProxyBox: (this: void, renderProxyBox: IRenderProxyBox, child?: IRenderBox | undefined) => IRenderProxyBox
}
};
export interface IRenderProxyBox
...
getHashCode: () => number;
}export class RenderProxyBox

 implements IRenderBox, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor(child?: IRenderBox | undefined){
flutter.rendering.renderProxyBox(this, child);}

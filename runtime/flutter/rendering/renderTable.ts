...
rendering: {
renderTable: (this: void, renderTable: IRenderTable, props : {  border? : ITableBorder | undefined, children? : IList<IList<IRenderBox>> | undefined, columnWidths? : {[index: number]: ITableColumnWidth} | undefined, columns? : number | undefined, configuration : IImageConfiguration, defaultColumnWidth : ITableColumnWidth, defaultVerticalAlignment : TableCellVerticalAlignment, rowDecorations? : IList<IDecoration | undefined> | undefined, rows? : number | undefined, textBaseline? : TextBaseline | undefined, textDirection : TextDirection,}) => IRenderTable
}
};
...
setColumnWidths: (value?: {[index: number]: ITableColumnWidth} | undefined) => void;
...
setRowDecorations: (value?: IList<IDecoration | undefined> | undefined) => void;
...
setFlatChildren: (columns: number, cells: IList<IRenderBox | undefined>) => void;
...
getHashCode: () => number;
 ...
 implements IRenderBox, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  border? : ITableBorder | undefined, children? : IList<IList<IRenderBox>> | undefined, columnWidths? : {[index: number]: ITableColumnWidth} | undefined, columns? : number | undefined, configuration? : IImageConfiguration, defaultColumnWidth? : ITableColumnWidth, defaultVerticalAlignment? : TableCellVerticalAlignment, rowDecorations? : IList<IDecoration | undefined> | undefined, rows? : number | undefined, textBaseline? : TextBaseline | undefined, textDirection : TextDirection,}){
flutter.rendering.renderTable(this, {
...renderTableDefaultProps,
...props
});}
    private readonly _dart_getColumns: () => number = undefined as any;
    private readonly _dart_setColumns: (value: number) => void = undefined as any;
    private readonly _dart_getRows: () => number = undefined as any;
    private readonly _dart_setRows: (value: number) => void = undefined as any;
    private readonly _dart_getColumnWidths: () => {[index: number]: ITableColumnWidth} | undefined = undefined as any;
    private readonly _dart_setColumnWidths: (value?: {[index: number]: ITableColumnWidth} | undefined) => void = undefined as any;
    private readonly _dart_setColumnWidth: (column: number, value: ITableColumnWidth) => void = undefined as any;
    private readonly _dart_getDefaultColumnWidth: () => ITableColumnWidth = undefined as any;
    private readonly _dart_setDefaultColumnWidth: (value: ITableColumnWidth) => void = undefined as any;
    ...
    private readonly _dart_getBorder: () => ITableBorder | undefined = undefined as any;
    private readonly _dart_setBorder: (value?: ITableBorder | undefined) => void = undefined as any;
    private readonly _dart_getRowDecorations: () => IList<IDecoration> = undefined as any;
    private readonly _dart_setRowDecorations: (value?: IList<IDecoration | undefined> | undefined) => void = undefined as any;
    private readonly _dart_getConfiguration: () => IImageConfiguration = undefined as any;
    private readonly _dart_setConfiguration: (value: IImageConfiguration) => void = undefined as any;
    private readonly _dart_getDefaultVerticalAlignment: () => TableCellVerticalAlignment = undefined as any;
    private readonly _dart_setDefaultVerticalAlignment: (value: TableCellVerticalAlignment) => void = undefined as any;
    ...
    private readonly _dart_setFlatChildren: (columns: number, cells: IList<IRenderBox | undefined>) => void = undefined as any;
    private readonly _dart_setChildren: (cells?: IList<IList<IRenderBox>> | undefined) => void = undefined as any;
    private readonly _dart_addRow: (cells: IList<IRenderBox | undefined>) => void = undefined as any;
    private readonly _dart_setChild: (x: number, y: number, value?: IRenderBox | undefined) => void = undefined as any;
    ...
    private readonly _dart_column: (x: number) => IIterable<IRenderBox> = undefined as any;
    private readonly _dart_row: (y: number) => IIterable<IRenderBox> = undefined as any;
...
public getColumnWidths() : {[index: number]: ITableColumnWidth} | undefined {
    return this._dart_getColumnWidths();
}
public setColumnWidths(value?: {[index: number]: ITableColumnWidth} | undefined) : void {
...
public setRowDecorations(value?: IList<IDecoration | undefined> | undefined) : void {
...
public setDefaultVerticalAlignment(value: TableCellVerticalAlignment) : void {
...
public setFlatChildren(columns: number, cells: IList<IRenderBox | undefined>) : void {
...
public setChild(x: number, y: number, value?: IRenderBox | undefined) : void {

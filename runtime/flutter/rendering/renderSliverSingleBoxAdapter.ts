...
rendering: {
renderSliverSingleBoxAdapter: (this: void, renderSliverSingleBoxAdapter: IRenderSliverSingleBoxAdapter, props? : {  child? : IRenderBox | undefined,}) => IRenderSliverSingleBoxAdapter
}
};
export interface IRenderSliverSingleBoxAdapter
...
getHashCode: () => number;
}export class RenderSliverSingleBoxAdapter
...
flutter.rendering.renderSliverSingleBoxAdapter(this, props);}

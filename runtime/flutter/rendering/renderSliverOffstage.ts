...
rendering: {
renderSliverOffstage: (this: void, renderSliverOffstage: IRenderSliverOffstage, props : {  offstage : boolean, sliver? : IRenderSliver | undefined,}) => IRenderSliverOffstage
}
};
export interface IRenderSliverOffstage
...
getHashCode: () => number;
}export class RenderSliverOffstage
...
public constructor( props : {  offstage? : boolean, sliver? : IRenderSliver | undefined,}){
flutter.rendering.renderSliverOffstage(this, {
...renderSliverOffstageDefaultProps,
...props
});}
...
const renderSliverOffstageDefaultProps = {
    offstage: true,
};

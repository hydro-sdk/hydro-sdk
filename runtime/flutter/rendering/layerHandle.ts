...
rendering: {
layerHandle: <T>(this: void, layerHandle: ILayerHandle<T>, _layer?: T | undefined) => ILayerHandle<T>
}
};
...
flutter.rendering.layerHandle(this, _layer);}
    ...
    private readonly _dart_setLayer: (layer?: T | undefined) => void = undefined as any;

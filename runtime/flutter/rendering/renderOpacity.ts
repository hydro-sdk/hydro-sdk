...
rendering: {
renderOpacity: (this: void, renderOpacity: IRenderOpacity, props : {  alwaysIncludeSemantics : boolean, child? : IRenderBox | undefined, opacity : number,}) => IRenderOpacity
}
};
export interface IRenderOpacity
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, child? : IRenderBox | undefined, opacity? : number,}){
flutter.rendering.renderOpacity(this, {
...renderOpacityDefaultProps,
...props
});}
...
const renderOpacityDefaultProps = {

...
rendering: {
renderFractionalTranslation: (this: void, renderFractionalTranslation: IRenderFractionalTranslation, props : {  child? : IRenderBox | undefined, transformHitTests : boolean, translation : IOffset,}) => IRenderFractionalTranslation
}
};
export interface IRenderFractionalTranslation
...
getTranslation: () => IOffset;
setTranslation: (value: IOffset) => void;
...
getHashCode: () => number;
}export class RenderFractionalTranslation
...
public constructor( props : {  child? : IRenderBox | undefined, transformHitTests? : boolean, translation : IOffset,}){
flutter.rendering.renderFractionalTranslation(this, {
...renderFractionalTranslationDefaultProps,
...props
});}
    private readonly _dart_getTranslation: () => IOffset = undefined as any;
    private readonly _dart_setTranslation: (value: IOffset) => void = undefined as any;
...
public getTranslation() : IOffset {
    return this._dart_getTranslation();
}
public setTranslation(value: IOffset) : void {
    return this._dart_setTranslation(value);
}
...
const renderFractionalTranslationDefaultProps = {

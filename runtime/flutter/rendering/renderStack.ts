...
rendering: {
renderStack: (this: void, renderStack: IRenderStack, props : {  alignment : IAlignmentGeometry, children? : IList<IRenderBox> | undefined, clipBehavior : Clip, fit : StackFit, textDirection? : TextDirection | undefined,}) => IRenderStack;
renderStackGetIntrinsicDimension: (firstChild: IRenderBox | undefined, mainChildSizeGetter : (child: IRenderBox) => number) => number;
renderStackLayoutPositionedChild: (child: IRenderBox, childParentData: IStackParentData, size: ISize, alignment: IAlignment) => boolean
}
};
...
getHashCode: () => number;
 ...
 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IStackParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IStackParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,IStackParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alignment? : IAlignmentGeometry, children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, fit? : StackFit, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderStack(this, {
...renderStackDefaultProps,
...props
});}
public static getIntrinsicDimension(firstChild: IRenderBox | undefined, mainChildSizeGetter : (child: IRenderBox) => number) : number{
return flutter.rendering.renderStackGetIntrinsicDimension(firstChild, mainChildSizeGetter);
}public static layoutPositionedChild(child: IRenderBox, childParentData: IStackParentData, size: ISize, alignment: IAlignment) : boolean{
return flutter.rendering.renderStackLayoutPositionedChild(child, childParentData, size, alignment);
    ...
    private readonly _dart_paintStack: (context: IPaintingContext, offset: IOffset) => void = undefined as any;

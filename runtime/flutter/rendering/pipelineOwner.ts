...
declare const flutter: {
    rendering: {
        pipelineOwner: (
            this: void,
            pipelineOwner: IPipelineOwner,
            props?: {
                onNeedVisualUpdate?: () => void | undefined;
                onSemanticsOwnerCreated?: () => void | undefined;
                onSemanticsOwnerDisposed?: () => void | undefined;
            }
        ) => IPipelineOwner;
    };
};
...
export class PipelineOwner {
    ...
    private readonly _dart_getRootNode: () => IAbstractNode | undefined =
        undefined as any;
    private readonly _dart_setRootNode: (
        value?: IAbstractNode | undefined
    ) => void = undefined as any;
    private readonly _dart_getDebugDoingLayout: () => boolean =
        undefined as any;
    ...
    private readonly _dart_getSemanticsOwner: () =>
        | ISemanticsOwner
        | undefined = undefined as any;
    private readonly _dart_getDebugOutstandingSemanticsHandles: () => number =
        undefined as any;
    private readonly _dart_ensureSemantics: (props?: {
        listener?: () => void | undefined;
    }) => ISemanticsHandle = undefined as any;

...
import { IListWheelChildManager } from "./listWheelChildManager";
...
rendering: {
renderListWheelViewport: (this: void, renderListWheelViewport: IRenderListWheelViewport, props : {  children? : IList<IRenderBox> | undefined, clipBehavior : Clip, diameterRatio : number, magnification : number, offAxisFraction : number, overAndUnderCenterOpacity : number, perspective : number, renderChildrenOutsideViewport : boolean, squeeze : number, useMagnifier : boolean, childManager : IListWheelChildManager, itemExtent : number, offset : IViewportOffset,}) => IRenderListWheelViewport
}
};
export interface IRenderListWheelViewport


{
childManager: IListWheelChildManager;
...
setDiameterRatio: (value: number) => void;
getPerspective: () => number;
setPerspective: (value: number) => void;
getOffAxisFraction: () => number;
setOffAxisFraction: (value: number) => void;
getUseMagnifier: () => boolean;
setUseMagnifier: (value: boolean) => void;
getMagnification: () => number;
setMagnification: (value: number) => void;
getOverAndUnderCenterOpacity: () => number;
setOverAndUnderCenterOpacity: (value: number) => void;
getItemExtent: () => number;
setItemExtent: (value: number) => void;
getSqueeze: () => number;
setSqueeze: (value: number) => void;
getRenderChildrenOutsideViewport: () => boolean;
setRenderChildrenOutsideViewport: (value: boolean) => void;
...
scrollOffsetToIndex: (scrollOffset: number) => number;
...
getHashCode: () => number;
}export class RenderListWheelViewport

 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IListWheelParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public static defaultDiameterRatio = 2.0;
    public static defaultPerspective = 0.003;
    public static diameterRatioZeroMessage = "You can't set a diameterRatio of 0 or of a negative number. It would imply a cylinder of 0 in diameter in which case nothing will be drawn.";
    public static perspectiveTooHighMessage = "A perspective too high will be clipped in the z-axis and therefore not renderable. Value must be between 0 and 0.01.";
    public static clipBehaviorAndRenderChildrenOutsideViewportConflict = "Cannot renderChildrenOutsideViewport and clip since children rendered outside will be clipped anyway.";
    public readonly childManager: IListWheelChildManager = undefined as any;
...
public constructor( props : {  children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, diameterRatio? : number, magnification? : number, offAxisFraction? : number, overAndUnderCenterOpacity? : number, perspective? : number, renderChildrenOutsideViewport? : boolean, squeeze? : number, useMagnifier? : boolean, childManager : IListWheelChildManager, itemExtent : number, offset : IViewportOffset,}){
flutter.rendering.renderListWheelViewport(this, {
...renderListWheelViewportDefaultProps,
...props
});}
    ...
    private readonly _dart_getDiameterRatio: () => number = undefined as any;
    private readonly _dart_setDiameterRatio: (value: number) => void = undefined as any;
    private readonly _dart_getPerspective: () => number = undefined as any;
    private readonly _dart_setPerspective: (value: number) => void = undefined as any;
    private readonly _dart_getOffAxisFraction: () => number = undefined as any;
    private readonly _dart_setOffAxisFraction: (value: number) => void = undefined as any;
    private readonly _dart_getUseMagnifier: () => boolean = undefined as any;
    private readonly _dart_setUseMagnifier: (value: boolean) => void = undefined as any;
    private readonly _dart_getMagnification: () => number = undefined as any;
    private readonly _dart_setMagnification: (value: number) => void = undefined as any;
    private readonly _dart_getOverAndUnderCenterOpacity: () => number = undefined as any;
    private readonly _dart_setOverAndUnderCenterOpacity: (value: number) => void = undefined as any;
    private readonly _dart_getItemExtent: () => number = undefined as any;
    private readonly _dart_setItemExtent: (value: number) => void = undefined as any;
    private readonly _dart_getSqueeze: () => number = undefined as any;
    private readonly _dart_setSqueeze: (value: number) => void = undefined as any;
    private readonly _dart_getRenderChildrenOutsideViewport: () => boolean = undefined as any;
    private readonly _dart_setRenderChildrenOutsideViewport: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_scrollOffsetToIndex: (scrollOffset: number) => number = undefined as any;
    private readonly _dart_indexToScrollOffset: (index: number) => number = undefined as any;
...
public getDiameterRatio() : number {
    return this._dart_getDiameterRatio();
}
public setDiameterRatio(value: number) : void {
    return this._dart_setDiameterRatio(value);
}
public getPerspective() : number {
    return this._dart_getPerspective();
}
public setPerspective(value: number) : void {
    return this._dart_setPerspective(value);
}
public getOffAxisFraction() : number {
    return this._dart_getOffAxisFraction();
}
public setOffAxisFraction(value: number) : void {
    return this._dart_setOffAxisFraction(value);
}
public getUseMagnifier() : boolean {
    return this._dart_getUseMagnifier();
}
public setUseMagnifier(value: boolean) : void {
    return this._dart_setUseMagnifier(value);
}
public getMagnification() : number {
    return this._dart_getMagnification();
}
public setMagnification(value: number) : void {
    return this._dart_setMagnification(value);
}
public getOverAndUnderCenterOpacity() : number {
    return this._dart_getOverAndUnderCenterOpacity();
}
public setOverAndUnderCenterOpacity(value: number) : void {
    return this._dart_setOverAndUnderCenterOpacity(value);
}
public getItemExtent() : number {
    return this._dart_getItemExtent();
}
public setItemExtent(value: number) : void {
    return this._dart_setItemExtent(value);
}
public getSqueeze() : number {
    return this._dart_getSqueeze();
}
public setSqueeze(value: number) : void {
    return this._dart_setSqueeze(value);
}
public getRenderChildrenOutsideViewport() : boolean {
    return this._dart_getRenderChildrenOutsideViewport();
}
public setRenderChildrenOutsideViewport(value: boolean) : void {
    return this._dart_setRenderChildrenOutsideViewport(value);
}
...
public scrollOffsetToIndex(scrollOffset: number) : number {
    return this._dart_scrollOffsetToIndex(scrollOffset);
}
public indexToScrollOffset(index: number) : number {
    return this._dart_indexToScrollOffset(index);
}
...
const renderListWheelViewportDefaultProps = {

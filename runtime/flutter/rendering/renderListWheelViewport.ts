...
declare const flutter: {
    rendering: {
        renderListWheelViewport: (
            this: void,
            renderListWheelViewport: IRenderListWheelViewport,
            props: {
...
export class RenderListWheelViewport
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, IListWheelParentData>,
        ...
        >
{
    ...
    public static diameterRatioZeroMessage =
    ...
    public static perspectiveTooHighMessage =
        "A perspective too high will be clipped in the z-axis and therefore not renderable. Value must be between 0 and 0.01.";
    public static clipBehaviorAndRenderChildrenOutsideViewportConflict =
        "Cannot renderChildrenOutsideViewport and clip since children rendered outside will be clipped anyway.";
    ...
    private readonly _dart_setDiameterRatio: (value: number) => void =
        undefined as any;
    private readonly _dart_getPerspective: () => number = undefined as any;
    private readonly _dart_setPerspective: (value: number) => void =
        undefined as any;
    private readonly _dart_getOffAxisFraction: () => number = undefined as any;
    private readonly _dart_setOffAxisFraction: (value: number) => void =
        undefined as any;
    private readonly _dart_getUseMagnifier: () => boolean = undefined as any;
    private readonly _dart_setUseMagnifier: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getMagnification: () => number = undefined as any;
    private readonly _dart_setMagnification: (value: number) => void =
        undefined as any;
    private readonly _dart_getOverAndUnderCenterOpacity: () => number =
        undefined as any;
    private readonly _dart_setOverAndUnderCenterOpacity: (
        value: number
    ) => void = undefined as any;
    private readonly _dart_getItemExtent: () => number = undefined as any;
    private readonly _dart_setItemExtent: (value: number) => void =
        undefined as any;
    private readonly _dart_getSqueeze: () => number = undefined as any;
    private readonly _dart_setSqueeze: (value: number) => void =
        undefined as any;
    private readonly _dart_getRenderChildrenOutsideViewport: () => boolean =
        undefined as any;
    private readonly _dart_setRenderChildrenOutsideViewport: (
        value: boolean
    ) => void = undefined as any;
    ...
    private readonly _dart_indexOf: (child: IRenderBox) => number =
        undefined as any;
    private readonly _dart_scrollOffsetToIndex: (
        scrollOffset: number
    ) => number = undefined as any;
    private readonly _dart_indexToScrollOffset: (index: number) => number =
        undefined as any;

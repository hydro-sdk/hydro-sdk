...
import { IRenderShiftedBox } from "./renderShiftedBox";
...
rendering: {
renderBaseline: (this: void, renderBaseline: IRenderBaseline, props : {  child? : IRenderBox | undefined, baseline : number, baselineType : TextBaseline,}) => IRenderBaseline
}
};
export interface IRenderBaseline
...
getBaselineType: () => TextBaseline;
setBaselineType: (value: TextBaseline) => void;
...
getHashCode: () => number;
}export class RenderBaseline

 implements Omit<IRenderShiftedBox, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, baseline : number, baselineType : TextBaseline,}){
flutter.rendering.renderBaseline(this, props);}
    private readonly _dart_getBaseline: () => number = undefined as any;
    private readonly _dart_setBaseline: (value: number) => void = undefined as any;
    private readonly _dart_getBaselineType: () => TextBaseline = undefined as any;
    private readonly _dart_setBaselineType: (value: TextBaseline) => void = undefined as any;
...
public getBaseline() : number {
    return this._dart_getBaseline();
}
public setBaseline(value: number) : void {
    return this._dart_setBaseline(value);
}
public getBaselineType() : TextBaseline {
    return this._dart_getBaselineType();
}
public setBaselineType(value: TextBaseline) : void {
    return this._dart_setBaselineType(value);
}

...
declare const flutter: {
    rendering: {
        renderBaseline: (
            this: void,
            renderBaseline: IRenderBaseline,
            props: {
        ...
        >
{
    ...
    private readonly _dart_setBaseline: (value: number) => void =
        undefined as any;
    private readonly _dart_getBaselineType: () => TextBaseline =
        undefined as any;
    private readonly _dart_setBaselineType: (value: TextBaseline) => void =
        undefined as any;

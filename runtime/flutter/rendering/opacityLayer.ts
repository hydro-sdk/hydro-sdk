...
rendering: {
opacityLayer: (this: void, opacityLayer: IOpacityLayer, props : {  alpha? : number | undefined, offset : IOffset,}) => IOpacityLayer
}
};
...
getHashCode: () => number;
 ...
 implements IOffsetLayer, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public readonly debugCreator: Object | undefined = undefined as any;
public constructor( props : {  alpha? : number | undefined, offset? : IOffset,}){
flutter.rendering.opacityLayer(this, {
...opacityLayerDefaultProps,
...props
});}
    private readonly _dart_getAlpha: () => number | undefined = undefined as any;
    private readonly _dart_setAlpha: (value?: number | undefined) => void = undefined as any;
    ...
    private readonly _dart_toImage: (bounds: IRect, props : {  pixelRatio : number,}) => IFuture<IImage> = undefined as any;
...
public toImage(bounds: IRect, props : {  pixelRatio? : number,}) : IFuture<IImage> {

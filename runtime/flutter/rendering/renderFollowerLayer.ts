...
declare const flutter: {
    rendering: {
        renderFollowerLayer: (
            this: void,
            renderFollowerLayer: IRenderFollowerLayer,
            props: {
                child?: IRenderBox | undefined;
                followerAnchor: IAlignment;
                leaderAnchor: IAlignment;
                offset: IOffset;
                showWhenUnlinked: boolean;
                link: ILayerLink;
            }
        ) => IRenderFollowerLayer;
    };
};
        ...
        >
{
    ...
    private readonly _dart_setLink: (value: ILayerLink) => void =
        undefined as any;
    private readonly _dart_getShowWhenUnlinked: () => boolean =
        undefined as any;
    private readonly _dart_setShowWhenUnlinked: (value: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_setLeaderAnchor: (value: IAlignment) => void =
        undefined as any;
    private readonly _dart_getFollowerAnchor: () => IAlignment =
        undefined as any;
    private readonly _dart_setFollowerAnchor: (value: IAlignment) => void =
        undefined as any;
    private readonly _dart_detach: () => void = undefined as any;
    private readonly _dart_getAlwaysNeedsCompositing: () => boolean =
        undefined as any;
    private readonly _dart_getLayer: () => IFollowerLayer | undefined =
        undefined as any;
    private readonly _dart_getCurrentTransform: () => IMatrix4 =
        undefined as any;

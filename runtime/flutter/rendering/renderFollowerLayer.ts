...
import { IAlignment,Alignment } from "../painting/alignment";
...
import { IFollowerLayer } from "./followerLayer";
...
rendering: {
renderFollowerLayer: (this: void, renderFollowerLayer: IRenderFollowerLayer, props : {  child? : IRenderBox | undefined, followerAnchor : IAlignment, leaderAnchor : IAlignment, offset : IOffset, showWhenUnlinked : boolean, link : ILayerLink,}) => IRenderFollowerLayer
}
};
export interface IRenderFollowerLayer
...
getShowWhenUnlinked: () => boolean;
setShowWhenUnlinked: (value: boolean) => void;
getOffset: () => IOffset;
setOffset: (value: IOffset) => void;
getLeaderAnchor: () => IAlignment;
setLeaderAnchor: (value: IAlignment) => void;
getFollowerAnchor: () => IAlignment;
setFollowerAnchor: (value: IAlignment) => void;
detach: () => void;
getAlwaysNeedsCompositing: () => boolean;
getLayer: () => IFollowerLayer | undefined;
getCurrentTransform: () => IMatrix4;
...
getHashCode: () => number;
}export class RenderFollowerLayer
...
public constructor( props : {  child? : IRenderBox | undefined, followerAnchor? : IAlignment, leaderAnchor? : IAlignment, offset? : IOffset, showWhenUnlinked? : boolean, link : ILayerLink,}){
flutter.rendering.renderFollowerLayer(this, {
...renderFollowerLayerDefaultProps,
...props
});}
    private readonly _dart_getLink: () => ILayerLink = undefined as any;
    private readonly _dart_setLink: (value: ILayerLink) => void = undefined as any;
    private readonly _dart_getShowWhenUnlinked: () => boolean = undefined as any;
    private readonly _dart_setShowWhenUnlinked: (value: boolean) => void = undefined as any;
    private readonly _dart_getOffset: () => IOffset = undefined as any;
    private readonly _dart_setOffset: (value: IOffset) => void = undefined as any;
    private readonly _dart_getLeaderAnchor: () => IAlignment = undefined as any;
    private readonly _dart_setLeaderAnchor: (value: IAlignment) => void = undefined as any;
    private readonly _dart_getFollowerAnchor: () => IAlignment = undefined as any;
    private readonly _dart_setFollowerAnchor: (value: IAlignment) => void = undefined as any;
    ...
    private readonly _dart_getLayer: () => IFollowerLayer | undefined = undefined as any;
    private readonly _dart_getCurrentTransform: () => IMatrix4 = undefined as any;
...
public getLink() : ILayerLink {
    return this._dart_getLink();
}
public setLink(value: ILayerLink) : void {
    return this._dart_setLink(value);
}
public getShowWhenUnlinked() : boolean {
    return this._dart_getShowWhenUnlinked();
}
public setShowWhenUnlinked(value: boolean) : void {
    return this._dart_setShowWhenUnlinked(value);
}
...
public getLeaderAnchor() : IAlignment {
    return this._dart_getLeaderAnchor();
}
public setLeaderAnchor(value: IAlignment) : void {
    return this._dart_setLeaderAnchor(value);
}
public getFollowerAnchor() : IAlignment {
    return this._dart_getFollowerAnchor();
}
public setFollowerAnchor(value: IAlignment) : void {
    return this._dart_setFollowerAnchor(value);
}
public detach() : void {
...
public getLayer() : IFollowerLayer | undefined {
    return this._dart_getLayer();
}
public getCurrentTransform() : IMatrix4 {
    return this._dart_getCurrentTransform();
}
...
const renderFollowerLayerDefaultProps = {

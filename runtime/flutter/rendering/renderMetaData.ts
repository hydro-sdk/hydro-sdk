...
rendering: {
renderMetaData: (this: void, renderMetaData: IRenderMetaData, props : {  behavior : HitTestBehavior, child? : IRenderBox | undefined, metaData : any,}) => IRenderMetaData
}
};
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IRenderBox | undefined, metaData : any,}){
flutter.rendering.renderMetaData(this, {
...renderMetaDataDefaultProps,
...props
});}
...
const renderMetaDataDefaultProps = {

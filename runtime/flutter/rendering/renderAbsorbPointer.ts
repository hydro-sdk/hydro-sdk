...
rendering: {
renderAbsorbPointer: (this: void, renderAbsorbPointer: IRenderAbsorbPointer, props : {  absorbing : boolean, child? : IRenderBox | undefined, ignoringSemantics? : boolean | undefined,}) => IRenderAbsorbPointer
}
};
export interface IRenderAbsorbPointer


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getAbsorbing: () => boolean;
setAbsorbing: (value: boolean) => void;
...
getHashCode: () => number;
}export class RenderAbsorbPointer
...
public constructor( props : {  absorbing? : boolean, child? : IRenderBox | undefined, ignoringSemantics? : boolean | undefined,}){
flutter.rendering.renderAbsorbPointer(this, {
...renderAbsorbPointerDefaultProps,
...props
});}
    private readonly _dart_getAbsorbing: () => boolean = undefined as any;
    private readonly _dart_setAbsorbing: (value: boolean) => void = undefined as any;
...
public getAbsorbing() : boolean {
    return this._dart_getAbsorbing();
}
public setAbsorbing(value: boolean) : void {
    return this._dart_setAbsorbing(value);
}
...
const renderAbsorbPointerDefaultProps = {
    absorbing: true,
};

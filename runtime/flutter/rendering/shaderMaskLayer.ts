...
rendering: {
shaderMaskLayer: (this: void, shaderMaskLayer: IShaderMaskLayer, props? : {  blendMode? : BlendMode | undefined, maskRect? : IRect | undefined, shader? : IShader | undefined,}) => IShaderMaskLayer
}
};
...
public constructor( props? : {  blendMode? : BlendMode | undefined, maskRect? : IRect | undefined, shader? : IShader | undefined,}){
flutter.rendering.shaderMaskLayer(this, props);}
    private readonly _dart_getShader: () => IShader | undefined = undefined as any;
    private readonly _dart_setShader: (value?: IShader | undefined) => void = undefined as any;
    private readonly _dart_getMaskRect: () => IRect | undefined = undefined as any;
    private readonly _dart_setMaskRect: (value?: IRect | undefined) => void = undefined as any;
    private readonly _dart_getBlendMode: () => BlendMode | undefined = undefined as any;
    private readonly _dart_setBlendMode: (value?: BlendMode | undefined) => void = undefined as any;
...
public getMaskRect() : IRect | undefined {
    return this._dart_getMaskRect();
}
public setMaskRect(value?: IRect | undefined) : void {
    return this._dart_setMaskRect(value);
}
public getBlendMode() : BlendMode | undefined {

...
rendering: {
renderMergeSemantics: (this: void, renderMergeSemantics: IRenderMergeSemantics, props? : {  child? : IRenderBox | undefined,}) => IRenderMergeSemantics
}
};
export interface IRenderMergeSemantics
...
getHashCode: () => number;
}export class RenderMergeSemantics
...
flutter.rendering.renderMergeSemantics(this, props);}

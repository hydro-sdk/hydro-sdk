...
rendering: {
renderSizedOverflowBox: (this: void, renderSizedOverflowBox: IRenderSizedOverflowBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, textDirection? : TextDirection | undefined, requestedSize : ISize,}) => IRenderSizedOverflowBox
}
};
export interface IRenderSizedOverflowBox


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getRequestedSize: () => ISize;
setRequestedSize: (value: ISize) => void;
...
getHashCode: () => number;
}export class RenderSizedOverflowBox
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, textDirection? : TextDirection | undefined, requestedSize : ISize,}){
flutter.rendering.renderSizedOverflowBox(this, {
...renderSizedOverflowBoxDefaultProps,
...props
});}
    private readonly _dart_getRequestedSize: () => ISize = undefined as any;
    private readonly _dart_setRequestedSize: (value: ISize) => void = undefined as any;
...
public getRequestedSize() : ISize {
    return this._dart_getRequestedSize();
}
public setRequestedSize(value: ISize) : void {
    return this._dart_setRequestedSize(value);
}
...
const renderSizedOverflowBoxDefaultProps = {

...
rendering: {
_rootSemanticsFragment: (this: void, _rootSemanticsFragment: I_RootSemanticsFragment, props : {  dropsSemanticsOfPreviousSiblings : boolean, owner : IRenderObject,}) => I_RootSemanticsFragment
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _RootSemanticsFragment

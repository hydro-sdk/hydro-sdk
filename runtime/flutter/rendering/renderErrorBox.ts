...
rendering: {
renderErrorBox: (this: void, renderErrorBox: IRenderErrorBox, message: string) => IRenderErrorBox
}
};
export interface IRenderErrorBox
...
flutter.rendering.renderErrorBox(this, message);}

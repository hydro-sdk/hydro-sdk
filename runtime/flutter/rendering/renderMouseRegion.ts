...
rendering: {
renderMouseRegion: (this: void, renderMouseRegion: IRenderMouseRegion, props : {  child? : IRenderBox | undefined, cursor : IMouseCursor, onEnter? : (event: IPointerEnterEvent) => void | undefined, onExit? : (event: IPointerExitEvent) => void | undefined, onHover? : (event: IPointerHoverEvent) => void | undefined, opaque : boolean, validForMouseTracker : boolean,}) => IRenderMouseRegion
}
};
export interface IRenderMouseRegion
...
setCursor: (value: IMouseCursor) => void;
...
getHashCode: () => number;
}export class RenderMouseRegion

 implements Omit<IRenderProxyBox, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IMouseTrackerAnnotation, "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, cursor? : IMouseCursor, onEnter? : (event: IPointerEnterEvent) => void | undefined, onExit? : (event: IPointerExitEvent) => void | undefined, onHover? : (event: IPointerHoverEvent) => void | undefined, opaque? : boolean, validForMouseTracker? : boolean,}){
flutter.rendering.renderMouseRegion(this, {
...renderMouseRegionDefaultProps,
...props
});}
    ...
    private readonly _dart_setCursor: (value: IMouseCursor) => void = undefined as any;
...
public setCursor(value: IMouseCursor) : void {
    return this._dart_setCursor(value);
}
...
const renderMouseRegionDefaultProps = {

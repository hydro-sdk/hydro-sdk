...
declare const flutter: {
    rendering: {
        renderCustomSingleChildLayoutBox: (
            this: void,
            renderCustomSingleChildLayoutBox: IRenderCustomSingleChildLayoutBox,
            props: {
                child?: IRenderBox | undefined;
                delegate: ISingleChildLayoutDelegate;
            }
        ) => IRenderCustomSingleChildLayoutBox;
    };
};
        ...
        >
{
    ...
    private readonly _dart_getDelegate: () => ISingleChildLayoutDelegate =
        undefined as any;
    private readonly _dart_setDelegate: (
        newDelegate: ISingleChildLayoutDelegate

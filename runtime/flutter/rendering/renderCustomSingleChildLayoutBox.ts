...
import { ISingleChildLayoutDelegate } from "./singleChildLayoutDelegate";
...
rendering: {
renderCustomSingleChildLayoutBox: (this: void, renderCustomSingleChildLayoutBox: IRenderCustomSingleChildLayoutBox, props : {  child? : IRenderBox | undefined, delegate : ISingleChildLayoutDelegate,}) => IRenderCustomSingleChildLayoutBox
}
};
export interface IRenderCustomSingleChildLayoutBox


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getDelegate: () => ISingleChildLayoutDelegate;
setDelegate: (newDelegate: ISingleChildLayoutDelegate) => void;
...
getHashCode: () => number;
}export class RenderCustomSingleChildLayoutBox
...
public constructor( props : {  child? : IRenderBox | undefined, delegate : ISingleChildLayoutDelegate,}){
flutter.rendering.renderCustomSingleChildLayoutBox(this, props);}
    private readonly _dart_getDelegate: () => ISingleChildLayoutDelegate = undefined as any;
    private readonly _dart_setDelegate: (newDelegate: ISingleChildLayoutDelegate) => void = undefined as any;
...
public getDelegate() : ISingleChildLayoutDelegate {
    return this._dart_getDelegate();
}
public setDelegate(newDelegate: ISingleChildLayoutDelegate) : void {

...
rendering: {
annotatedRegionLayer: <T>(this: void, annotatedRegionLayer: IAnnotatedRegionLayer<T>, value: T, props : {  offset? : IOffset | undefined, opaque : boolean, size? : ISize | undefined,}) => IAnnotatedRegionLayer<T>
}
};
export interface IAnnotatedRegionLayer
<T>
...
getAttached: () => boolean;
getHashCode: () => number;
}export class AnnotatedRegionLayer
<T>
...
public constructor(value: T, props : {  offset? : IOffset | undefined, opaque? : boolean, size? : ISize | undefined,}){
flutter.rendering.annotatedRegionLayer(this, value, {
...annotatedRegionLayerDefaultProps,
...props
});}
...
const annotatedRegionLayerDefaultProps = {
    opaque: false,
};

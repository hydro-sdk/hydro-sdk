...
rendering: {
renderSliverFixedExtentList: (this: void, renderSliverFixedExtentList: IRenderSliverFixedExtentList, props : {  childManager : IRenderSliverBoxChildManager, itemExtent : number,}) => IRenderSliverFixedExtentList
}
};
...
public constructor( props : {  childManager : IRenderSliverBoxChildManager, itemExtent : number,}){

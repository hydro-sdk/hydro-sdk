...
import { IRenderSliverFixedExtentBoxAdaptor } from "./renderSliverFixedExtentBoxAdaptor";
...
declare const flutter: {
    rendering: {
        renderSliverFixedExtentList: (
            this: void,
            renderSliverFixedExtentList: IRenderSliverFixedExtentList,
            props: {
                childManager: IRenderSliverBoxChildManager;
                itemExtent: number;
            }
        ) => IRenderSliverFixedExtentList;
    };
};
export interface IRenderSliverFixedExtentList {
...
export class RenderSliverFixedExtentList
    implements
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.rendering.renderSliverFixedExtentList(this, props);
    }

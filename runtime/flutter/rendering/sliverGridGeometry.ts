...
rendering: {
sliverGridGeometry: (this: void, sliverGridGeometry: ISliverGridGeometry, props : {  crossAxisExtent : number, crossAxisOffset : number, mainAxisExtent : number, scrollOffset : number,}) => ISliverGridGeometry
}
};
...
public constructor( props : {  crossAxisExtent : number, crossAxisOffset : number, mainAxisExtent : number, scrollOffset : number,}){
flutter.rendering.sliverGridGeometry(this, props);}
    private readonly _dart_getTrailingScrollOffset: () => number = undefined as any;
    private readonly _dart_getBoxConstraints: (constraints: ISliverConstraints) => IBoxConstraints = undefined as any;

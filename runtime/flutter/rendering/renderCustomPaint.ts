...
import { ICustomPainter } from "./customPainter";
...
rendering: {
renderCustomPaint: (this: void, renderCustomPaint: IRenderCustomPaint, props : {  child? : IRenderBox | undefined, foregroundPainter? : ICustomPainter | undefined, isComplex : boolean, painter? : ICustomPainter | undefined, preferredSize : ISize, willChange : boolean,}) => IRenderCustomPaint
}
};
export interface IRenderCustomPaint
...
getPainter: () => ICustomPainter | undefined;
setPainter: (value?: ICustomPainter | undefined) => void;
getForegroundPainter: () => ICustomPainter | undefined;
setForegroundPainter: (value?: ICustomPainter | undefined) => void;
getPreferredSize: () => ISize;
setPreferredSize: (value: ISize) => void;
...
public constructor( props : {  child? : IRenderBox | undefined, foregroundPainter? : ICustomPainter | undefined, isComplex? : boolean, painter? : ICustomPainter | undefined, preferredSize? : ISize, willChange? : boolean,}){
flutter.rendering.renderCustomPaint(this, {
...renderCustomPaintDefaultProps,
...props
});}
    private readonly _dart_getPainter: () => ICustomPainter | undefined = undefined as any;
    private readonly _dart_setPainter: (value?: ICustomPainter | undefined) => void = undefined as any;
    private readonly _dart_getForegroundPainter: () => ICustomPainter | undefined = undefined as any;
    private readonly _dart_setForegroundPainter: (value?: ICustomPainter | undefined) => void = undefined as any;
    private readonly _dart_getPreferredSize: () => ISize = undefined as any;
    private readonly _dart_setPreferredSize: (value: ISize) => void = undefined as any;
...
public getPainter() : ICustomPainter | undefined {
    return this._dart_getPainter();
}
public setPainter(value?: ICustomPainter | undefined) : void {
    return this._dart_setPainter(value);
}
public getForegroundPainter() : ICustomPainter | undefined {
    return this._dart_getForegroundPainter();
}
public setForegroundPainter(value?: ICustomPainter | undefined) : void {
    return this._dart_setForegroundPainter(value);
}
public getPreferredSize() : ISize {
    return this._dart_getPreferredSize();
}
public setPreferredSize(value: ISize) : void {
    return this._dart_setPreferredSize(value);
}
...
const renderCustomPaintDefaultProps = {
    isComplex: false,

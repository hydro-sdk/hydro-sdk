...
rendering: {
sliverHitTestResult: (this: void, sliverHitTestResult: ISliverHitTestResult) => ISliverHitTestResult
}
};
...
{
addWithAxisOffset: ( props : {  crossAxisOffset : number, crossAxisPosition : number, hitTest : (result: ISliverHitTestResult, props : {  crossAxisPosition : number, mainAxisPosition : number,}) => boolean, mainAxisOffset : number, mainAxisPosition : number, paintOffset? : IOffset | undefined,}) => boolean;
...
getHashCode: () => number;
}export class SliverHitTestResult

 implements IHitTestResult
{public constructor(){
flutter.rendering.sliverHitTestResult(this);}
    private readonly _dart_addWithAxisOffset: ( props : {  crossAxisOffset : number, crossAxisPosition : number, hitTest : (result: ISliverHitTestResult, props : {  crossAxisPosition : number, mainAxisPosition : number,}) => boolean, mainAxisOffset : number, mainAxisPosition : number, paintOffset? : IOffset | undefined,}) => boolean = undefined as any;
...
public addWithAxisOffset( props : {  crossAxisOffset : number, crossAxisPosition : number, hitTest : (result: ISliverHitTestResult, props : {  crossAxisPosition : number, mainAxisPosition : number,}) => boolean, mainAxisOffset : number, mainAxisPosition : number, paintOffset? : IOffset | undefined,}) : boolean {

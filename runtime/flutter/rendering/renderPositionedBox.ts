...
rendering: {
renderPositionedBox: (this: void, renderPositionedBox: IRenderPositionedBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, heightFactor? : number | undefined, textDirection? : TextDirection | undefined, widthFactor? : number | undefined,}) => IRenderPositionedBox
}
};
export interface IRenderPositionedBox
...
getHashCode: () => number;
}export class RenderPositionedBox
...
flutter.rendering.renderPositionedBox(this, {
...renderPositionedBoxDefaultProps,
...props
});}
...
const renderPositionedBoxDefaultProps = {

...
rendering: {
renderIntrinsicHeight: (this: void, renderIntrinsicHeight: IRenderIntrinsicHeight, props? : {  child? : IRenderBox | undefined,}) => IRenderIntrinsicHeight
}
};
export interface IRenderIntrinsicHeight
...
getHashCode: () => number;
}export class RenderIntrinsicHeight
...
flutter.rendering.renderIntrinsicHeight(this, props);}

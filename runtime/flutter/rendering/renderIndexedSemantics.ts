...
rendering: {
renderIndexedSemantics: (this: void, renderIndexedSemantics: IRenderIndexedSemantics, props : {  child? : IRenderBox | undefined, index : number,}) => IRenderIndexedSemantics
}
};
export interface IRenderIndexedSemantics
...
getHashCode: () => number;
}export class RenderIndexedSemantics
...
public constructor( props : {  child? : IRenderBox | undefined, index : number,}){
flutter.rendering.renderIndexedSemantics(this, props);}

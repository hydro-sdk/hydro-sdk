...
declare const flutter: {
    rendering: {
        sliverLogicalContainerParentData: (
            this: void,
            sliverLogicalContainerParentData: ISliverLogicalContainerParentData
...
export class SliverLogicalContainerParentData
    implements
        ...
        IContainerParentDataMixin<IRenderSliver>
{
    public readonly previousSibling: IRenderSliver | undefined =
        undefined as any;

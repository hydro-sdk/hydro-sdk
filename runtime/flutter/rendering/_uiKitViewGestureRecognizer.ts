...
rendering: {
_uiKitViewGestureRecognizer: (this: void, _uiKitViewGestureRecognizer: I_UiKitViewGestureRecognizer, controller: IUiKitViewController, gestureRecognizerFactories: ISet<IFactory<IOneSequenceGestureRecognizer>>, props? : {  supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => I_UiKitViewGestureRecognizer
}
};
...
public constructor(controller: IUiKitViewController, gestureRecognizerFactories: ISet<IFactory<IOneSequenceGestureRecognizer>>, props? : {  supportedDevices? : ISet<PointerDeviceKind> | undefined,}){
flutter.rendering._uiKitViewGestureRecognizer(this, controller, gestureRecognizerFactories, props);}

...
declare const flutter: {
    rendering: {
        _renderPhysicalModelBase: <T>(
            this: void,
            _renderPhysicalModelBase: I_RenderPhysicalModelBase<T>,
            props: {
                clipBehavior: Clip;
                clipper?: ICustomClipper<T> | undefined;
                child?: IRenderBox | undefined;
                color: IColor;
                elevation: number;
                shadowColor: IColor;
            }
        ) => I_RenderPhysicalModelBase<T>;
    };
};
export interface I_RenderPhysicalModelBase<T> {
...
export class _RenderPhysicalModelBase<T>
    implements
        I_RenderCustomClip<T>,
        ...
        >
{
    ...
    private readonly _dart_getClipper: () => ICustomClipper<T> | undefined =
        undefined as any;
    private readonly _dart_setClipper: (
        newClipper?: ICustomClipper<T> | undefined
    ) => void = undefined as any;

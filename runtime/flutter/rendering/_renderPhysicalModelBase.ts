...
rendering: {
_renderPhysicalModelBase: <T>(this: void, _renderPhysicalModelBase: I_RenderPhysicalModelBase<T>, props : {  clipBehavior : Clip, clipper? : ICustomClipper<T> | undefined, child? : IRenderBox | undefined, color : IColor, elevation : number, shadowColor : IColor,}) => I_RenderPhysicalModelBase<T>
}
};
export interface I_RenderPhysicalModelBase
<T>
...
getClipper: () => ICustomClipper<T> | undefined;
setClipper: (newClipper?: ICustomClipper<T> | undefined) => void;
...
getHashCode: () => number;
}export class _RenderPhysicalModelBase
<T>
 implements I_RenderCustomClip<T>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  clipBehavior? : Clip, clipper? : ICustomClipper<T> | undefined, child? : IRenderBox | undefined, color : IColor, elevation : number, shadowColor : IColor,}){
flutter.rendering._renderPhysicalModelBase(this, {
..._renderPhysicalModelBaseDefaultProps,
...props
});}
    ...
    private readonly _dart_getClipper: () => ICustomClipper<T> | undefined = undefined as any;
    private readonly _dart_setClipper: (newClipper?: ICustomClipper<T> | undefined) => void = undefined as any;
...
public getClipper() : ICustomClipper<T> | undefined {
    return this._dart_getClipper();
}
public setClipper(newClipper?: ICustomClipper<T> | undefined) : void {
...
const _renderPhysicalModelBaseDefaultProps = {

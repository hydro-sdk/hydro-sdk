...
rendering: {
renderFittedBox: (this: void, renderFittedBox: IRenderFittedBox, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, clipBehavior : Clip, fit : BoxFit, textDirection? : TextDirection | undefined,}) => IRenderFittedBox
}
};
export interface IRenderFittedBox
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, clipBehavior? : Clip, fit? : BoxFit, textDirection? : TextDirection | undefined,}){
flutter.rendering.renderFittedBox(this, {
...renderFittedBoxDefaultProps,
...props
});}
    private readonly _dart_getFit: () => BoxFit = undefined as any;
    private readonly _dart_setFit: (value: BoxFit) => void = undefined as any;
...
public getFit() : BoxFit {
    return this._dart_getFit();
}
public setFit(value: BoxFit) : void {
...
const renderFittedBoxDefaultProps = {

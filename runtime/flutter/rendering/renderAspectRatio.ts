...
rendering: {
renderAspectRatio: (this: void, renderAspectRatio: IRenderAspectRatio, props : {  child? : IRenderBox | undefined, aspectRatio : number,}) => IRenderAspectRatio
}
};
export interface IRenderAspectRatio
...
getHashCode: () => number;
}export class RenderAspectRatio
...
public constructor( props : {  child? : IRenderBox | undefined, aspectRatio : number,}){
flutter.rendering.renderAspectRatio(this, props);}
    private readonly _dart_getAspectRatio: () => number = undefined as any;
    private readonly _dart_setAspectRatio: (value: number) => void = undefined as any;
...
public setAspectRatio(value: number) : void {
    return this._dart_setAspectRatio(value);
}

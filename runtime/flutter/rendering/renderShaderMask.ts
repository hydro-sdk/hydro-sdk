...
declare const flutter: {
    rendering: {
        renderShaderMask: (
            this: void,
            renderShaderMask: IRenderShaderMask,
            props: {
                blendMode: BlendMode;
                child?: IRenderBox | undefined;
                shaderCallback: (bounds: IRect) => IShader;
            }
        ) => IRenderShaderMask;
    };
};
        ...
        >
{
    ...
    private readonly _dart_getLayer: () => IShaderMaskLayer | undefined =
        undefined as any;
    private readonly _dart_getShaderCallback: () => (bounds: IRect) => IShader =
        undefined as any;
    private readonly _dart_setShaderCallback: (
        value: (bounds: IRect) => IShader

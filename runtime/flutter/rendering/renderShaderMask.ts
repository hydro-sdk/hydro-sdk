...
import { IShaderMaskLayer } from "./shaderMaskLayer";
...
rendering: {
renderShaderMask: (this: void, renderShaderMask: IRenderShaderMask, props : {  blendMode : BlendMode, child? : IRenderBox | undefined, shaderCallback : (bounds: IRect) => IShader,}) => IRenderShaderMask
}
};
export interface IRenderShaderMask


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getLayer: () => IShaderMaskLayer | undefined;
getShaderCallback: () => (bounds: IRect) => IShader;
setShaderCallback: (value : (bounds: IRect) => IShader) => void;
...
public constructor( props : {  blendMode? : BlendMode, child? : IRenderBox | undefined, shaderCallback : (bounds: IRect) => IShader,}){
flutter.rendering.renderShaderMask(this, {
...renderShaderMaskDefaultProps,
...props
});}
    private readonly _dart_getLayer: () => IShaderMaskLayer | undefined = undefined as any;
    private readonly _dart_getShaderCallback: () => (bounds: IRect) => IShader = undefined as any;
    private readonly _dart_setShaderCallback: (value : (bounds: IRect) => IShader) => void = undefined as any;
    private readonly _dart_getBlendMode: () => BlendMode = undefined as any;
    private readonly _dart_setBlendMode: (value: BlendMode) => void = undefined as any;
...
public getLayer() : IShaderMaskLayer | undefined {
    return this._dart_getLayer();
}
public getShaderCallback() : (bounds: IRect) => IShader {
    return this._dart_getShaderCallback();
}
public setShaderCallback(value : (bounds: IRect) => IShader) : void {
    return this._dart_setShaderCallback(value);
}
...
const renderShaderMaskDefaultProps = {

...
rendering: {
renderLimitedBox: (this: void, renderLimitedBox: IRenderLimitedBox, props : {  child? : IRenderBox | undefined, maxHeight : number, maxWidth : number,}) => IRenderLimitedBox
}
};
export interface IRenderLimitedBox
...
public constructor( props : {  child? : IRenderBox | undefined, maxHeight? : number, maxWidth? : number,}){
flutter.rendering.renderLimitedBox(this, {
...renderLimitedBoxDefaultProps,
...props
});}
    private readonly _dart_getMaxWidth: () => number = undefined as any;
    private readonly _dart_setMaxWidth: (value: number) => void = undefined as any;
    private readonly _dart_getMaxHeight: () => number = undefined as any;
    private readonly _dart_setMaxHeight: (value: number) => void = undefined as any;
...
const renderLimitedBoxDefaultProps = {

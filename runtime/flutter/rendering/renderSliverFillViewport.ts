...
declare const flutter: {
    rendering: {
        renderSliverFillViewport: (
            this: void,
            renderSliverFillViewport: IRenderSliverFillViewport,
            props: {
                viewportFraction: number;
                childManager: IRenderSliverBoxChildManager;
            }
        ) => IRenderSliverFillViewport;
    };
};
export interface IRenderSliverFillViewport {
...
export class RenderSliverFillViewport
    implements
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.rendering.renderSliverFillViewport(this, {
            ...renderSliverFillViewportDefaultProps,
            ...props,
        });
    }
    ...
    private readonly _dart_setViewportFraction: (value: number) => void =
        undefined as any;
...
const renderSliverFillViewportDefaultProps = {

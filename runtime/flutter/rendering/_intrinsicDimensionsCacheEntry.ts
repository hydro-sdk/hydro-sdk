...
rendering: {
_intrinsicDimensionsCacheEntry: (this: void, _intrinsicDimensionsCacheEntry: I_IntrinsicDimensionsCacheEntry, dimension: _IntrinsicDimension, argument: number) => I_IntrinsicDimensionsCacheEntry
}
};
...
flutter.rendering._intrinsicDimensionsCacheEntry(this, dimension, argument);}

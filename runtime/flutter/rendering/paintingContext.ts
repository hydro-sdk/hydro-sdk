...
export class PaintingContext implements IClipContext {
    public readonly estimatedBounds: IRect = undefined as any;
    public constructor(
        _containerLayer: IContainerLayer,
        estimatedBounds: IRect
    ) {
        flutter.rendering.paintingContext(
            this,
            _containerLayer,
            estimatedBounds
        );
    }
    public static repaintCompositedChild(
        child: IRenderObject,
        props: { debugAlsoPaintedParent?: boolean }
    ): void {
    ...
    public static debugInstrumentRepaintCompositedChild(
        child: IRenderObject,
        props: {
            debugAlsoPaintedParent?: boolean;
            customContext: IPaintingContext;
        ...
        return flutter.rendering.paintingContextDebugInstrumentRepaintCompositedChild(
            child,
            {

...
rendering: {
renderSliverToBoxAdapter: (this: void, renderSliverToBoxAdapter: IRenderSliverToBoxAdapter, props? : {  child? : IRenderBox | undefined,}) => IRenderSliverToBoxAdapter
}
};
export interface IRenderSliverToBoxAdapter
...
getHashCode: () => number;
}export class RenderSliverToBoxAdapter
...
flutter.rendering.renderSliverToBoxAdapter(this, props);}

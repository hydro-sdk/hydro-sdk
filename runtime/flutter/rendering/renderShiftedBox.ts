...
rendering: {
renderShiftedBox: (this: void, renderShiftedBox: IRenderShiftedBox, child?: IRenderBox | undefined) => IRenderShiftedBox
}
};
export interface IRenderShiftedBox
...
flutter.rendering.renderShiftedBox(this, child);}

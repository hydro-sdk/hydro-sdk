...
rendering: {
renderAnimatedOpacity: (this: void, renderAnimatedOpacity: IRenderAnimatedOpacity, props : {  alwaysIncludeSemantics : boolean, child? : IRenderBox | undefined, opacity : IAnimation<number>,}) => IRenderAnimatedOpacity
}
};
export interface IRenderAnimatedOpacity
...
getHashCode: () => number;
}export class RenderAnimatedOpacity

 implements Omit<IRenderProxyBox, "attach" | "detach" | "debugFillProperties" | "visitChildrenForSemantics" | "alwaysNeedsCompositing" | "debugDescribeChildren" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderProxyBoxMixin<IRenderBox>, IRenderAnimatedOpacityMixin<IRenderBox>, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugFillProperties" | "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, child? : IRenderBox | undefined, opacity : IAnimation<number>,}){
flutter.rendering.renderAnimatedOpacity(this, {
...renderAnimatedOpacityDefaultProps,
...props
});}
...
const renderAnimatedOpacityDefaultProps = {

...
rendering: {
renderSliverOpacity: (this: void, renderSliverOpacity: IRenderSliverOpacity, props : {  alwaysIncludeSemantics : boolean, opacity : number, sliver? : IRenderSliver | undefined,}) => IRenderSliverOpacity
}
};
export interface IRenderSliverOpacity
...
getHashCode: () => number;
}export class RenderSliverOpacity
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, opacity? : number, sliver? : IRenderSliver | undefined,}){
flutter.rendering.renderSliverOpacity(this, {
...renderSliverOpacityDefaultProps,
...props
});}
    ...
    private readonly _dart_setOpacity: (value: number) => void = undefined as any;
...
const renderSliverOpacityDefaultProps = {

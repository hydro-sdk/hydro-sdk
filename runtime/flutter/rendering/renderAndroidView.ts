...
rendering: {
renderAndroidView: (this: void, renderAndroidView: IRenderAndroidView, props : {  clipBehavior : Clip, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior, viewController : IAndroidViewController,}) => IRenderAndroidView
}
};
export interface IRenderAndroidView
...
updateGestureRecognizers: (gestureRecognizers: ISet<IFactory<IOneSequenceGestureRecognizer>>) => void;
...
getHashCode: () => number;
}export class RenderAndroidView

 implements IRenderBox, I_PlatformViewGestureMixin, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IMouseTrackerAnnotation, "debugFillProperties" | "onEnter" | "onExit" | "cursor" | "validForMouseTracker" | "toStringShort" | "toDiagnosticsNode">, IHitTestTarget, Omit<IDiagnosticableTree, "debugFillProperties" | "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  clipBehavior? : Clip, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior, viewController : IAndroidViewController,}){
flutter.rendering.renderAndroidView(this, {
...renderAndroidViewDefaultProps,
...props
});}
    private readonly _dart_getViewController: () => IAndroidViewController = undefined as any;
    private readonly _dart_setViewController: (viewController: IAndroidViewController) => void = undefined as any;
    ...
    private readonly _dart_updateGestureRecognizers: (gestureRecognizers: ISet<IFactory<IOneSequenceGestureRecognizer>>) => void = undefined as any;
    ...
    private readonly _dart_setHitTestBehavior: (value: PlatformViewHitTestBehavior) => void = undefined as any;
    private readonly _dart_getOnEnter: () => (event: IPointerEnterEvent) => void | undefined = undefined as any;
    private readonly _dart_getOnExit: () => (event: IPointerExitEvent) => void | undefined = undefined as any;
...
public updateGestureRecognizers(gestureRecognizers: ISet<IFactory<IOneSequenceGestureRecognizer>>) : void {
    return this._dart_updateGestureRecognizers(gestureRecognizers);
}
...
public setHitTestBehavior(value: PlatformViewHitTestBehavior) : void {
    return this._dart_setHitTestBehavior(value);
}
public getOnEnter() : (event: IPointerEnterEvent) => void | undefined {
    return this._dart_getOnEnter();
}
public getOnExit() : (event: IPointerExitEvent) => void | undefined {
    return this._dart_getOnExit();
}
...
const renderAndroidViewDefaultProps = {

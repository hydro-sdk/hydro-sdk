...
declare const flutter: {
    rendering: {
        renderAndroidView: (
            this: void,
            renderAndroidView: IRenderAndroidView,
            props: {
                clipBehavior: Clip;
                gestureRecognizers: ISet<
        ...
        >
{
    ...
    public readonly onEnter: (event: IPointerEnterEvent) => void | undefined =
        undefined as any;
    public readonly onExit: (event: IPointerExitEvent) => void | undefined =
        undefined as any;
    ...
    private readonly _dart_setClipBehavior: (value: Clip) => void =
        undefined as any;
    private readonly _dart_updateGestureRecognizers: (
        gestureRecognizers: ISet<IFactory<IOneSequenceGestureRecognizer>>
    ) => void = undefined as any;
    ...
    private readonly _dart_setHitTestBehavior: (
        value: PlatformViewHitTestBehavior
    ) => void = undefined as any;
    private readonly _dart_getOnEnter: () => (
        event: IPointerEnterEvent
    ) => void | undefined = undefined as any;
    private readonly _dart_getOnExit: () => (
        event: IPointerExitEvent
    ) => void | undefined = undefined as any;
    private readonly _dart_getCursor: () => IMouseCursor = undefined as any;
    private readonly _dart_getValidForMouseTracker: () => boolean =
        undefined as any;
    ...
    public updateGestureRecognizers(
        gestureRecognizers: ISet<IFactory<IOneSequenceGestureRecognizer>>
    ): void {

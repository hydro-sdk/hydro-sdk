...
rendering: {
alignmentTween: (this: void, alignmentTween: IAlignmentTween, props? : {  begin? : IAlignment | undefined, end? : IAlignment | undefined,}) => IAlignmentTween
}
};
...
getHashCode: () => number;
}export class AlignmentTween

 implements ITween<IAlignment>
{    public readonly begin: IAlignment | undefined = undefined as any;
    public readonly end: IAlignment | undefined = undefined as any;
public constructor( props? : {  begin? : IAlignment | undefined, end? : IAlignment | undefined,}){
flutter.rendering.alignmentTween(this, props);}
    private readonly _dart_lerp: (t: number) => IAlignment = undefined as any;
    private readonly _dart_transform: (t: number) => IAlignment = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IAlignment = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IAlignment> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IAlignment> = undefined as any;

...
import { IRenderSliverEdgeInsetsPadding } from "./renderSliverEdgeInsetsPadding";
...
rendering: {
renderSliverPadding: (this: void, renderSliverPadding: IRenderSliverPadding, props : {  child? : IRenderSliver | undefined, textDirection? : TextDirection | undefined, padding : IEdgeInsetsGeometry,}) => IRenderSliverPadding
}
};
export interface IRenderSliverPadding
...
setPadding: (value: IEdgeInsetsGeometry) => void;
...
getHashCode: () => number;
}export class RenderSliverPadding
...
public constructor( props : {  child? : IRenderSliver | undefined, textDirection? : TextDirection | undefined, padding : IEdgeInsetsGeometry,}){
flutter.rendering.renderSliverPadding(this, props);}
    ...
    private readonly _dart_setPadding: (value: IEdgeInsetsGeometry) => void = undefined as any;
...
public setPadding(value: IEdgeInsetsGeometry) : void {

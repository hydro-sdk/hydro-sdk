...
export class RenderWrap
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, IWrapParentData>,
        IRenderBoxContainerDefaultsMixin<IRenderBox, IWrapParentData>,
        ...
        >
{
    ...
    private readonly _dart_setAlignment: (value: WrapAlignment) => void =
        undefined as any;
    private readonly _dart_getSpacing: () => number = undefined as any;
    private readonly _dart_setSpacing: (value: number) => void =
        undefined as any;
    private readonly _dart_getRunAlignment: () => WrapAlignment =
        undefined as any;
    private readonly _dart_setRunAlignment: (value: WrapAlignment) => void =
        undefined as any;
    private readonly _dart_getRunSpacing: () => number = undefined as any;
    private readonly _dart_setRunSpacing: (value: number) => void =
        undefined as any;
    private readonly _dart_getCrossAxisAlignment: () => WrapCrossAlignment =
        undefined as any;
    private readonly _dart_setCrossAxisAlignment: (

...
import { WrapAlignment } from "./wrapAlignment";
import { IList } from "../../dart/core/list";
import { IRenderBox } from "./renderBox";
import { Clip } from "../../dart/ui/clip";
import { WrapCrossAlignment } from "./wrapCrossAlignment";
...
rendering: {
renderWrap: (this: void, renderWrap: IRenderWrap, props : {  alignment : WrapAlignment, children? : IList<IRenderBox> | undefined, clipBehavior : Clip, crossAxisAlignment : WrapCrossAlignment, direction : Axis, runAlignment : WrapAlignment, runSpacing : number, spacing : number, textDirection? : TextDirection | undefined, verticalDirection : VerticalDirection,}) => IRenderWrap
}
};
export interface IRenderWrap
...
setAlignment: (value: WrapAlignment) => void;
getSpacing: () => number;
setSpacing: (value: number) => void;
getRunAlignment: () => WrapAlignment;
setRunAlignment: (value: WrapAlignment) => void;
getRunSpacing: () => number;
setRunSpacing: (value: number) => void;
getCrossAxisAlignment: () => WrapCrossAlignment;
setCrossAxisAlignment: (value: WrapCrossAlignment) => void;
...
getHashCode: () => number;
 ...
 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IWrapParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IWrapParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,IWrapParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alignment? : WrapAlignment, children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, crossAxisAlignment? : WrapCrossAlignment, direction? : Axis, runAlignment? : WrapAlignment, runSpacing? : number, spacing? : number, textDirection? : TextDirection | undefined, verticalDirection? : VerticalDirection,}){
flutter.rendering.renderWrap(this, {
...renderWrapDefaultProps,
...props
});}
    ...
    private readonly _dart_getAlignment: () => WrapAlignment = undefined as any;
    private readonly _dart_setAlignment: (value: WrapAlignment) => void = undefined as any;
    private readonly _dart_getSpacing: () => number = undefined as any;
    private readonly _dart_setSpacing: (value: number) => void = undefined as any;
    private readonly _dart_getRunAlignment: () => WrapAlignment = undefined as any;
    private readonly _dart_setRunAlignment: (value: WrapAlignment) => void = undefined as any;
    private readonly _dart_getRunSpacing: () => number = undefined as any;
    private readonly _dart_setRunSpacing: (value: number) => void = undefined as any;
    private readonly _dart_getCrossAxisAlignment: () => WrapCrossAlignment = undefined as any;
    private readonly _dart_setCrossAxisAlignment: (value: WrapCrossAlignment) => void = undefined as any;
...
public getAlignment() : WrapAlignment {
    return this._dart_getAlignment();
}
public setAlignment(value: WrapAlignment) : void {
    return this._dart_setAlignment(value);
}
public getSpacing() : number {
    return this._dart_getSpacing();
}
public setSpacing(value: number) : void {
    return this._dart_setSpacing(value);
}
public getRunAlignment() : WrapAlignment {
    return this._dart_getRunAlignment();
}
public setRunAlignment(value: WrapAlignment) : void {
    return this._dart_setRunAlignment(value);
}
public getRunSpacing() : number {
    return this._dart_getRunSpacing();
}
public setRunSpacing(value: number) : void {
    return this._dart_setRunSpacing(value);
}
public getCrossAxisAlignment() : WrapCrossAlignment {
    return this._dart_getCrossAxisAlignment();
}
public setCrossAxisAlignment(value: WrapCrossAlignment) : void {

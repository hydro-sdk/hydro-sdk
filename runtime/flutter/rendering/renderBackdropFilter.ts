...
import { IBackdropFilterLayer } from "./backdropFilterLayer";
...
rendering: {
renderBackdropFilter: (this: void, renderBackdropFilter: IRenderBackdropFilter, props : {  blendMode : BlendMode, child? : IRenderBox | undefined, filter : IImageFilter,}) => IRenderBackdropFilter
}
};
export interface IRenderBackdropFilter
...
getHashCode: () => number;
}export class RenderBackdropFilter
...
public constructor( props : {  blendMode? : BlendMode, child? : IRenderBox | undefined, filter : IImageFilter,}){
flutter.rendering.renderBackdropFilter(this, {
...renderBackdropFilterDefaultProps,
...props
});}
    private readonly _dart_getLayer: () => IBackdropFilterLayer | undefined = undefined as any;
    private readonly _dart_getFilter: () => IImageFilter = undefined as any;
    private readonly _dart_setFilter: (value: IImageFilter) => void = undefined as any;
...
public getLayer() : IBackdropFilterLayer | undefined {
    return this._dart_getLayer();
}
public getFilter() : IImageFilter {
    return this._dart_getFilter();
}

...
declare const flutter: {
    rendering: {
        fractionalOffsetTween: (
            this: void,
            fractionalOffsetTween: IFractionalOffsetTween,
            props?: {
                begin?: IFractionalOffset | undefined;
                end?: IFractionalOffset | undefined;
            }
        ) => IFractionalOffsetTween;
    };
};
export interface IFractionalOffsetTween {
    ...
    ) => IAnimation<IFractionalOffset | undefined>;
    chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IFractionalOffset | undefined>;
    getHashCode: () => number;
}
export class FractionalOffsetTween implements ITween<?IFractionalOffset> {
    ...
    private readonly _dart_lerp: (t: number) => IFractionalOffset | undefined =
        undefined as any;
    private readonly _dart_transform: (
        t: number
    ) => IFractionalOffset | undefined = undefined as any;
    ...
    private readonly _dart_animate: (
        parent: IAnimation<number>
    ) => IAnimation<IFractionalOffset | undefined> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IFractionalOffset | undefined> = undefined as any;

...
rendering: {
renderingFlutterBinding: (this: void, renderingFlutterBinding: IRenderingFlutterBinding, props? : {  root? : IRenderBox | undefined,}) => IRenderingFlutterBinding
}
};
...
getHashCode: () => number;
 ...
 implements IBindingBase, IGestureBinding, ISchedulerBinding, IServicesBinding, ISemanticsBinding, IPaintingBinding, IRendererBinding, IHitTestable, IHitTestDispatcher, IHitTestTarget

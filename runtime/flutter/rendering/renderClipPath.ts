...
rendering: {
renderClipPath: (this: void, renderClipPath: IRenderClipPath, props : {  child? : IRenderBox | undefined, clipBehavior : Clip, clipper? : ICustomClipper<IPath> | undefined,}) => IRenderClipPath
}
};
export interface IRenderClipPath
...
getHashCode: () => number;
}export class RenderClipPath

 implements I_RenderCustomClip<IPath>, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  child? : IRenderBox | undefined, clipBehavior? : Clip, clipper? : ICustomClipper<IPath> | undefined,}){
flutter.rendering.renderClipPath(this, {
...renderClipPathDefaultProps,
...props
});}
...
const renderClipPathDefaultProps = {

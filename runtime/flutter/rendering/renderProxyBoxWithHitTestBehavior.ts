...
rendering: {
renderProxyBoxWithHitTestBehavior: (this: void, renderProxyBoxWithHitTestBehavior: IRenderProxyBoxWithHitTestBehavior, props : {  behavior : HitTestBehavior, child? : IRenderBox | undefined,}) => IRenderProxyBoxWithHitTestBehavior
}
};
export interface IRenderProxyBoxWithHitTestBehavior
...
getHashCode: () => number;
}export class RenderProxyBoxWithHitTestBehavior
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IRenderBox | undefined,}){
flutter.rendering.renderProxyBoxWithHitTestBehavior(this, {
...renderProxyBoxWithHitTestBehaviorDefaultProps,
...props
});}
...
const renderProxyBoxWithHitTestBehaviorDefaultProps = {

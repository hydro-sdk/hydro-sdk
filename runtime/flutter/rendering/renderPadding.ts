...
rendering: {
renderPadding: (this: void, renderPadding: IRenderPadding, props : {  child? : IRenderBox | undefined, textDirection? : TextDirection | undefined, padding : IEdgeInsetsGeometry,}) => IRenderPadding
}
};
export interface IRenderPadding
...
public constructor( props : {  child? : IRenderBox | undefined, textDirection? : TextDirection | undefined, padding : IEdgeInsetsGeometry,}){
flutter.rendering.renderPadding(this, props);}

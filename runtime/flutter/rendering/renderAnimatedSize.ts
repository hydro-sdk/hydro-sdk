...
import { RenderAnimatedSizeState } from "./renderAnimatedSizeState";
...
rendering: {
renderAnimatedSize: (this: void, renderAnimatedSize: IRenderAnimatedSize, props : {  alignment : IAlignmentGeometry, child? : IRenderBox | undefined, clipBehavior : Clip, curve : ICurve, reverseDuration? : IDuration | undefined, textDirection? : TextDirection | undefined, duration : IDuration, vsync : ITickerProvider,}) => IRenderAnimatedSize
}
};
export interface IRenderAnimatedSize
...
setDuration: (value: IDuration) => void;
getReverseDuration: () => IDuration | undefined;
setReverseDuration: (value?: IDuration | undefined) => void;
getCurve: () => ICurve;
setCurve: (value: ICurve) => void;
getClipBehavior: () => Clip;
setClipBehavior: (value: Clip) => void;
getIsAnimating: () => boolean;
getVsync: () => ITickerProvider;
setVsync: (value: ITickerProvider) => void;
detach: () => void;
performLayout: () => void;
...
getHashCode: () => number;
}export class RenderAnimatedSize

 implements IRenderAligningShiftedBox, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IRenderBox | undefined, clipBehavior? : Clip, curve? : ICurve, reverseDuration? : IDuration | undefined, textDirection? : TextDirection | undefined, duration : IDuration, vsync : ITickerProvider,}){
flutter.rendering.renderAnimatedSize(this, {
...renderAnimatedSizeDefaultProps,
...props
});}
    private readonly _dart_getDuration: () => IDuration = undefined as any;
    private readonly _dart_setDuration: (value: IDuration) => void = undefined as any;
    private readonly _dart_getReverseDuration: () => IDuration | undefined = undefined as any;
    private readonly _dart_setReverseDuration: (value?: IDuration | undefined) => void = undefined as any;
    private readonly _dart_getCurve: () => ICurve = undefined as any;
    private readonly _dart_setCurve: (value: ICurve) => void = undefined as any;
    ...
    private readonly _dart_setVsync: (value: ITickerProvider) => void = undefined as any;
...
public setDuration(value: IDuration) : void {
    return this._dart_setDuration(value);
}
public getReverseDuration() : IDuration | undefined {
    return this._dart_getReverseDuration();
}
public setReverseDuration(value?: IDuration | undefined) : void {
    return this._dart_setReverseDuration(value);
}
public getCurve() : ICurve {
    return this._dart_getCurve();
}
public setCurve(value: ICurve) : void {
    return this._dart_setCurve(value);
}
...
public setVsync(value: ITickerProvider) : void {
...
const renderAnimatedSizeDefaultProps = {

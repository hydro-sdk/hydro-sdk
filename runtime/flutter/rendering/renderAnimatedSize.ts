...
declare const flutter: {
    rendering: {
        renderAnimatedSize: (
            this: void,
            renderAnimatedSize: IRenderAnimatedSize,
            props: {
        ...
        >
{
    ...
    private readonly _dart_setDuration: (value: IDuration) => void =
        undefined as any;
    private readonly _dart_getReverseDuration: () => IDuration | undefined =
        undefined as any;
    private readonly _dart_setReverseDuration: (
    ...
    private readonly _dart_setVsync: (value: ITickerProvider) => void =
        undefined as any;

...
declare const flutter: {
    rendering: {
        renderCustomMultiChildLayoutBox: (
            this: void,
            renderCustomMultiChildLayoutBox: IRenderCustomMultiChildLayoutBox,
            props: {
                children?: IList<IRenderBox> | undefined;
                delegate: IMultiChildLayoutDelegate;
            }
        ) => IRenderCustomMultiChildLayoutBox;
    };
};
        ...
        >
{
    ...
    private readonly _dart_setupParentData: (child: any) => void =
        undefined as any;
    private readonly _dart_getDelegate: () => IMultiChildLayoutDelegate =
        undefined as any;
    private readonly _dart_setDelegate: (
        newDelegate: IMultiChildLayoutDelegate

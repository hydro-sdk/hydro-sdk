...
import { IMultiChildLayoutDelegate } from "./multiChildLayoutDelegate";
...
rendering: {
renderCustomMultiChildLayoutBox: (this: void, renderCustomMultiChildLayoutBox: IRenderCustomMultiChildLayoutBox, props : {  children? : IList<IRenderBox> | undefined, delegate : IMultiChildLayoutDelegate,}) => IRenderCustomMultiChildLayoutBox
}
};
export interface IRenderCustomMultiChildLayoutBox
...
getDelegate: () => IMultiChildLayoutDelegate;
setDelegate: (newDelegate: IMultiChildLayoutDelegate) => void;
...
getHashCode: () => number;
}export class RenderCustomMultiChildLayoutBox

 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IMultiChildLayoutParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,IMultiChildLayoutParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,IMultiChildLayoutParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  children? : IList<IRenderBox> | undefined, delegate : IMultiChildLayoutDelegate,}){
flutter.rendering.renderCustomMultiChildLayoutBox(this, props);}
    private readonly _dart_setupParentData: (child: any) => void = undefined as any;
    private readonly _dart_getDelegate: () => IMultiChildLayoutDelegate = undefined as any;
    private readonly _dart_setDelegate: (newDelegate: IMultiChildLayoutDelegate) => void = undefined as any;
...
public getDelegate() : IMultiChildLayoutDelegate {
    return this._dart_getDelegate();
}
public setDelegate(newDelegate: IMultiChildLayoutDelegate) : void {

...
rendering: {
textureLayer: (this: void, textureLayer: ITextureLayer, props : {  filterQuality : FilterQuality, freeze : boolean, rect : IRect, textureId : number,}) => ITextureLayer
}
};
...
public constructor( props : {  filterQuality? : FilterQuality, freeze? : boolean, rect : IRect, textureId : number,}){
flutter.rendering.textureLayer(this, {
...textureLayerDefaultProps,
...props
});}

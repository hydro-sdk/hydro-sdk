...
export interface IRenderSemanticsGestureHandler {
    ...
    setOnHorizontalDragUpdate: (
        value?: (details: IDragUpdateDetails) => void
    ) => void;
        ...
        >
{
    ...
    private readonly _dart_getValidActions: () =>
        | ISet<ISemanticsAction>
        | undefined = undefined as any;
    private readonly _dart_setValidActions: (
        value?: ISet<ISemanticsAction> | undefined
    ...
    private readonly _dart_setOnLongPress: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnHorizontalDragUpdate: () => (
        details: IDragUpdateDetails
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnHorizontalDragUpdate: (
        value?: (details: IDragUpdateDetails) => void
    ) => void = undefined as any;
    private readonly _dart_getOnVerticalDragUpdate: () => (
        details: IDragUpdateDetails
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnVerticalDragUpdate: (
        value?: (details: IDragUpdateDetails) => void
    ) => void = undefined as any;

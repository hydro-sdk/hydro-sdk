...
rendering: {
renderSemanticsGestureHandler: (this: void, renderSemanticsGestureHandler: IRenderSemanticsGestureHandler, props : {  behavior : HitTestBehavior, child? : IRenderBox | undefined, onHorizontalDragUpdate? : (details: IDragUpdateDetails) => void | undefined, onLongPress? : () => void | undefined, onTap? : () => void | undefined, onVerticalDragUpdate? : (details: IDragUpdateDetails) => void | undefined, scrollFactor : number,}) => IRenderSemanticsGestureHandler
}
};
...
setValidActions: (value?: ISet<ISemanticsAction> | undefined) => void;
getOnTap: () => () => void | undefined;
setOnTap: (value? : () => void) => void;
getOnLongPress: () => () => void | undefined;
setOnLongPress: (value? : () => void) => void;
getOnHorizontalDragUpdate: () => (details: IDragUpdateDetails) => void | undefined;
setOnHorizontalDragUpdate: (value? : (details: IDragUpdateDetails) => void) => void;
getOnVerticalDragUpdate: () => (details: IDragUpdateDetails) => void | undefined;
setOnVerticalDragUpdate: (value? : (details: IDragUpdateDetails) => void) => void;
...
getHashCode: () => number;
 ...
 implements IRenderProxyBoxWithHitTestBehavior, IRenderObjectWithChildMixin<IRenderBox>, IRenderProxyBoxMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IRenderBox | undefined, onHorizontalDragUpdate? : (details: IDragUpdateDetails) => void | undefined, onLongPress? : () => void | undefined, onTap? : () => void | undefined, onVerticalDragUpdate? : (details: IDragUpdateDetails) => void | undefined, scrollFactor? : number,}){
flutter.rendering.renderSemanticsGestureHandler(this, {
...renderSemanticsGestureHandlerDefaultProps,
...props
});}
    private readonly _dart_getValidActions: () => ISet<ISemanticsAction> | undefined = undefined as any;
    private readonly _dart_setValidActions: (value?: ISet<ISemanticsAction> | undefined) => void = undefined as any;
    ...
    private readonly _dart_getOnHorizontalDragUpdate: () => (details: IDragUpdateDetails) => void | undefined = undefined as any;
    private readonly _dart_setOnHorizontalDragUpdate: (value? : (details: IDragUpdateDetails) => void) => void = undefined as any;
    private readonly _dart_getOnVerticalDragUpdate: () => (details: IDragUpdateDetails) => void | undefined = undefined as any;
    private readonly _dart_setOnVerticalDragUpdate: (value? : (details: IDragUpdateDetails) => void) => void = undefined as any;
...
public getValidActions() : ISet<ISemanticsAction> | undefined {
    return this._dart_getValidActions();
}
public setValidActions(value?: ISet<ISemanticsAction> | undefined) : void {
    return this._dart_setValidActions(value);
}
...
public getOnHorizontalDragUpdate() : (details: IDragUpdateDetails) => void | undefined {
    return this._dart_getOnHorizontalDragUpdate();
}
public setOnHorizontalDragUpdate(value? : (details: IDragUpdateDetails) => void) : void {
    return this._dart_setOnHorizontalDragUpdate(value);
}
public getOnVerticalDragUpdate() : (details: IDragUpdateDetails) => void | undefined {
    return this._dart_getOnVerticalDragUpdate();
}
public setOnVerticalDragUpdate(value? : (details: IDragUpdateDetails) => void) : void {
    return this._dart_setOnVerticalDragUpdate(value);
}

...
declare const flutter: {
    rendering: {
        renderSliverMultiBoxAdaptor: (
            this: void,
            renderSliverMultiBoxAdaptor: IRenderSliverMultiBoxAdaptor,
            props: { childManager: IRenderSliverBoxChildManager }
        ) => IRenderSliverMultiBoxAdaptor;
    };
};
export interface IRenderSliverMultiBoxAdaptor {
...
export class RenderSliverMultiBoxAdaptor
    implements
        IRenderSliver,
        ...
        >
{
    ...
    public constructor(props: { childManager: IRenderSliverBoxChildManager }) {
        flutter.rendering.renderSliverMultiBoxAdaptor(this, props);
    }

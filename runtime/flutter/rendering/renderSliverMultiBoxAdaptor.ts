...
rendering: {
renderSliverMultiBoxAdaptor: (this: void, renderSliverMultiBoxAdaptor: IRenderSliverMultiBoxAdaptor, props : {  childManager : IRenderSliverBoxChildManager,}) => IRenderSliverMultiBoxAdaptor
}
};

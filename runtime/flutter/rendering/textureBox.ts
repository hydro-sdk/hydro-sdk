...
rendering: {
textureBox: (this: void, textureBox: ITextureBox, props : {  filterQuality : FilterQuality, freeze : boolean, textureId : number,}) => ITextureBox
}
};
export interface ITextureBox
...
public constructor( props : {  filterQuality? : FilterQuality, freeze? : boolean, textureId : number,}){
flutter.rendering.textureBox(this, {
...textureBoxDefaultProps,
...props
});}
    private readonly _dart_getTextureId: () => number = undefined as any;
    private readonly _dart_setTextureId: (value: number) => void = undefined as any;
    private readonly _dart_getFreeze: () => boolean = undefined as any;
    private readonly _dart_setFreeze: (value: boolean) => void = undefined as any;

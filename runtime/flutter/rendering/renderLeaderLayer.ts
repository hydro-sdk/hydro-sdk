...
rendering: {
renderLeaderLayer: (this: void, renderLeaderLayer: IRenderLeaderLayer, props : {  child? : IRenderBox | undefined, link : ILayerLink,}) => IRenderLeaderLayer
}
};
export interface IRenderLeaderLayer
...
getHashCode: () => number;
}export class RenderLeaderLayer
...
public constructor( props : {  child? : IRenderBox | undefined, link : ILayerLink,}){
flutter.rendering.renderLeaderLayer(this, props);}

...
export interface IRenderUiKitView {
    ...
    hitTest: (
        ...
        props?: { position?: IOffset | undefined }
    ) => boolean;
        ...
        >
{
    ...
    private readonly _dart_getViewController: () => IUiKitViewController =
        undefined as any;

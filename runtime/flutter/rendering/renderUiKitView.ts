...
rendering: {
renderUiKitView: (this: void, renderUiKitView: IRenderUiKitView, props : {  gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior, viewController : IUiKitViewController,}) => IRenderUiKitView
}
};
export interface IRenderUiKitView
...
getViewController: () => IUiKitViewController;
setViewController: (viewController: IUiKitViewController) => void;
...
hitTest: (result: IBoxHitTestResult, props? : {  position? : IOffset | undefined,}) => boolean;
...
public constructor( props : {  gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior, viewController : IUiKitViewController,}){
flutter.rendering.renderUiKitView(this, props);}
    private readonly _dart_getViewController: () => IUiKitViewController = undefined as any;
    private readonly _dart_setViewController: (viewController: IUiKitViewController) => void = undefined as any;
    ...
    private readonly _dart_hitTest: (result: IBoxHitTestResult, props? : {  position? : IOffset | undefined,}) => boolean = undefined as any;
...
public getViewController() : IUiKitViewController {
    return this._dart_getViewController();
}
public setViewController(viewController: IUiKitViewController) : void {
...
public hitTest(result: IBoxHitTestResult, props? : {  position? : IOffset | undefined,}) : boolean {

...
rendering: {
_containerSemanticsFragment: (this: void, _containerSemanticsFragment: I_ContainerSemanticsFragment, props : {  dropsSemanticsOfPreviousSiblings : boolean,}) => I_ContainerSemanticsFragment
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _ContainerSemanticsFragment

 implements I_SemanticsFragment
{    public readonly interestingFragments: IList<I_InterestingSemanticsFragment> = undefined as any;

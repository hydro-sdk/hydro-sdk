...
import { ISliverLogicalContainerParentData } from "./sliverLogicalContainerParentData";
...
rendering: {
renderShrinkWrappingViewport: (this: void, renderShrinkWrappingViewport: IRenderShrinkWrappingViewport, props : {  axisDirection : AxisDirection, children? : IList<IRenderSliver> | undefined, clipBehavior : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}) => IRenderShrinkWrappingViewport
}
};
export interface IRenderShrinkWrappingViewport
...
getHashCode: () => number;
}export class RenderShrinkWrappingViewport

 implements Omit<IRenderViewportBase<ISliverLogicalContainerParentData>, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IContainerRenderObjectMixin<IRenderSliver,ISliverLogicalContainerParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  axisDirection? : AxisDirection, children? : IList<IRenderSliver> | undefined, clipBehavior? : Clip, crossAxisDirection : AxisDirection, offset : IViewportOffset,}){
flutter.rendering.renderShrinkWrappingViewport(this, {
...renderShrinkWrappingViewportDefaultProps,
...props
});}
...
const renderShrinkWrappingViewportDefaultProps = {

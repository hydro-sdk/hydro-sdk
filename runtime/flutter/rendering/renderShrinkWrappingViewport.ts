...
declare const flutter: {
    rendering: {
        renderShrinkWrappingViewport: (
            this: void,
            renderShrinkWrappingViewport: IRenderShrinkWrappingViewport,
            props: {
...
export class RenderShrinkWrappingViewport
    implements
        Omit<
            IRenderViewportBase<ISliverLogicalContainerParentData>,
            | "attach"
            | "detach"
        ...
        IContainerRenderObjectMixin<
            IRenderSliver,
            ISliverLogicalContainerParentData
        >,

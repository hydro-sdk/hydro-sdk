...
rendering: {
_platformViewGestureRecognizer: (this: void, _platformViewGestureRecognizer: I_PlatformViewGestureRecognizer, handlePointerEvent : (event: IPointerEvent) => IFuture<void>, gestureRecognizerFactories: ISet<IFactory<IOneSequenceGestureRecognizer>>, props? : {  supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => I_PlatformViewGestureRecognizer
}
};
export interface I_PlatformViewGestureRecognizer


{
cachedEvents: {[index: number]: IList<IPointerEvent>};
...
getHashCode: () => number;
}export class _PlatformViewGestureRecognizer
...
{    public readonly cachedEvents: {[index: number]: IList<IPointerEvent>} = undefined as any;
    public readonly forwardedPointers: ISet<number> = undefined as any;
    public readonly gestureRecognizerFactories: ISet<IFactory<IOneSequenceGestureRecognizer>> = undefined as any;
...
public constructor(handlePointerEvent : (event: IPointerEvent) => IFuture<void>, gestureRecognizerFactories: ISet<IFactory<IOneSequenceGestureRecognizer>>, props? : {  supportedDevices? : ISet<PointerDeviceKind> | undefined,}){
flutter.rendering._platformViewGestureRecognizer(this, handlePointerEvent, gestureRecognizerFactories, props);}

...
declare const flutter: {
    rendering: {
        boxConstraints: (
            this: void,
            boxConstraints: IBoxConstraints,
            props: {
                maxHeight: number;
                maxWidth: number;
                minHeight: number;
        ...
        boxConstraintsLerp: (
            a: IBoxConstraints | undefined,
            b: IBoxConstraints | undefined,
            t: number
        ) => IBoxConstraints | undefined;
    };
};
...
export class BoxConstraints implements IConstraints {

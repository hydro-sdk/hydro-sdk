...
rendering: {
_renderEditableCustomPaint: (this: void, _renderEditableCustomPaint: I_RenderEditableCustomPaint, props? : {  painter? : IRenderEditablePainter | undefined,}) => I_RenderEditableCustomPaint
}
};
export interface I_RenderEditableCustomPaint


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getParent: () => IRenderEditable | undefined;
getIsRepaintBoundary: () => boolean;
getSizedByParent: () => boolean;
getPainter: () => IRenderEditablePainter | undefined;
setPainter: (newValue?: IRenderEditablePainter | undefined) => void;
...
getAttached: () => boolean;
getHashCode: () => number;
}export class _RenderEditableCustomPaint
...
public constructor( props? : {  painter? : IRenderEditablePainter | undefined,}){
flutter.rendering._renderEditableCustomPaint(this, props);}
    private readonly _dart_getParent: () => IRenderEditable | undefined = undefined as any;
    ...
    private readonly _dart_setPainter: (newValue?: IRenderEditablePainter | undefined) => void = undefined as any;
...
public getParent() : IRenderEditable | undefined {
...
public setPainter(newValue?: IRenderEditablePainter | undefined) : void {
    return this._dart_setPainter(newValue);
}

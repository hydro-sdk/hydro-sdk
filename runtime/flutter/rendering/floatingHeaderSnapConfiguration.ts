...
rendering: {
floatingHeaderSnapConfiguration: (this: void, floatingHeaderSnapConfiguration: IFloatingHeaderSnapConfiguration, props : {  curve : ICurve, duration : IDuration,}) => IFloatingHeaderSnapConfiguration
}
};

...
declare const flutter: {
    rendering: {
        alignmentGeometryTween: (
            this: void,
            alignmentGeometryTween: IAlignmentGeometryTween,
            props?: {
                begin?: IAlignmentGeometry | undefined;
                end?: IAlignmentGeometry | undefined;
            }
        ) => IAlignmentGeometryTween;
    };
};
export interface IAlignmentGeometryTween {
    ...
    ) => IAnimation<IAlignmentGeometry | undefined>;
    chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IAlignmentGeometry | undefined>;
    getHashCode: () => number;
}
export class AlignmentGeometryTween implements ITween<?IAlignmentGeometry> {
    ...
    private readonly _dart_lerp: (t: number) => IAlignmentGeometry | undefined =
        undefined as any;
    private readonly _dart_transform: (
        t: number
    ) => IAlignmentGeometry | undefined = undefined as any;
    ...
    private readonly _dart_animate: (
        parent: IAnimation<number>
    ) => IAnimation<IAlignmentGeometry | undefined> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IAlignmentGeometry | undefined> = undefined as any;

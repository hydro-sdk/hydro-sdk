...
declare const flutter: {
    material: {
        timePickerTheme: (
            this: void,
            timePickerTheme: ITimePickerTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: ITimePickerThemeData;
            }
        ) => ITimePickerTheme;
        timePickerThemeOf: (context: IBuildContext) => ITimePickerThemeData;
    };
};
export interface ITimePickerTheme {
    data: ITimePickerThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class TimePickerTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: ITimePickerThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.timePickerTheme(this, props);
    }
    public static of(context: IBuildContext): ITimePickerThemeData {
        return flutter.material.timePickerThemeOf(context);
    }

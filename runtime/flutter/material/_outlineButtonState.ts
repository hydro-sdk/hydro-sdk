...
import { I_OutlineButton } from "./_outlineButton";
declare const flutter: {
    material: {
        _outlineButtonState: (
            this: void,
            _outlineButtonState: I_OutlineButtonState
        ) => I_OutlineButtonState;
    };
};
export interface I_OutlineButtonState {
    initState: () => void;
...
export class _OutlineButtonState
    implements
        Omit<
            IState<I_OutlineButton>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<I_OutlineButton>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._outlineButtonState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_OutlineButton = undefined as any;
    ...
    public getWidget(): I_OutlineButton {

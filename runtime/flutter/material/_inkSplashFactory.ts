...
declare const flutter: {
    material: {
        _inkSplashFactory: (
            this: void,
            _inkSplashFactory: I_InkSplashFactory
        ) => I_InkSplashFactory;
    };
};
export interface I_InkSplashFactory {
    create: (props: {
...
export class _InkSplashFactory implements IInteractiveInkFeatureFactory {
    public constructor() {
        flutter.material._inkSplashFactory(this);
    }

...
export class RaisedButton implements IMaterialButton, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.raisedButton(this, {
    ...
    public static icon(props: {
        ...
        return flutter.material.raisedButtonIcon(props);
    }
...
const raisedButtonDefaultProps = {
    autofocus: false,

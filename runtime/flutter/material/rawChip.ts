...
export interface IRawChip {
    ...
    tapEnabled: boolean;
    key: IKey | undefined;
    getDeleteIcon: () => IWidget;
    createState: () => IState<IRawChip>;
        ...
        ITappableChipAttributes
{
    ...
    public readonly tapEnabled: boolean = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.rawChip(this, {
            ...rawChipDefaultProps,
            ...props,
        });
    }
    private readonly _dart_getDeleteIcon: () => IWidget = undefined as any;
    private readonly _dart_createState: () => IState<IRawChip> =
        undefined as any;
    ...
    private readonly _dart_getOnPressed: () => () => void | undefined =
        undefined as any;
    public getDeleteIcon(): IWidget {
        return this._dart_getDeleteIcon();
    }
    public createState(): IState<IRawChip> {

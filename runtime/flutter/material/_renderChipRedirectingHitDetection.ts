...
declare const flutter: {
    material: {
        _renderChipRedirectingHitDetection: (
            this: void,
            _renderChipRedirectingHitDetection: I_RenderChipRedirectingHitDetection,
            additionalConstraints: IBoxConstraints
        ) => I_RenderChipRedirectingHitDetection;
    };
};
export interface I_RenderChipRedirectingHitDetection {
...
export class _RenderChipRedirectingHitDetection
    implements
        ...
        >
{
    ...
    public constructor(additionalConstraints: IBoxConstraints) {
        flutter.material._renderChipRedirectingHitDetection(
            this,

...
import { ILinearProgressIndicator } from "./linearProgressIndicator";
declare const flutter: {
    material: {
        _linearProgressIndicatorState: (
            this: void,
            _linearProgressIndicatorState: I_LinearProgressIndicatorState
        ) => I_LinearProgressIndicatorState;
    };
};
export interface I_LinearProgressIndicatorState {
    initState: () => void;
    ...
    deactivate: () => void;
    activate: () => void;
    getWidget: () => ILinearProgressIndicator;
...
export class _LinearProgressIndicatorState
    implements
        Omit<
            IState<ILinearProgressIndicator>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<ILinearProgressIndicator>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._linearProgressIndicatorState(this);
    }
    ...
    private readonly _dart_getWidget: () => ILinearProgressIndicator =
        undefined as any;
    ...
    public getWidget(): ILinearProgressIndicator {

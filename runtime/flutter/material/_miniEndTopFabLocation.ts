...
declare const flutter: {
    material: {
        _miniEndTopFabLocation: (
            this: void,
            _miniEndTopFabLocation: I_MiniEndTopFabLocation
        ) => I_MiniEndTopFabLocation;
    };
};
export interface I_MiniEndTopFabLocation {
    toString: () => string;
    isMini: () => boolean;
    getOffsetX: (
...
export class _MiniEndTopFabLocation
    implements
...
{
    public constructor() {
        flutter.material._miniEndTopFabLocation(this);
    }

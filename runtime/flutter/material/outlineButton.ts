...
export class OutlineButton implements IMaterialButton, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.outlineButton(this, {
            ...outlineButtonDefaultProps,
            ...props,
        });
    }
    public static icon(props: {
        ...
        return flutter.material.outlineButtonIcon(props);
    }
...
const outlineButtonDefaultProps = {
    autofocus: false,

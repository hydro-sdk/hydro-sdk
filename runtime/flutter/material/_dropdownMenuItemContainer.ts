...
declare const flutter: {
    material: {
        _dropdownMenuItemContainer: (
            this: void,
            _dropdownMenuItemContainer: I_DropdownMenuItemContainer,
            props: {
                alignment: IAlignmentGeometry;
                key?: IKey | undefined;
                child: IWidget;
            }
        ) => I_DropdownMenuItemContainer;
    };
};
export interface I_DropdownMenuItemContainer {
    child: IWidget;
    alignment: IAlignmentGeometry;
    key: IKey | undefined;
...
export class _DropdownMenuItemContainer
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._dropdownMenuItemContainer(this, {
            ..._dropdownMenuItemContainerDefaultProps,
            ...props,
        });
    }
...
const _dropdownMenuItemContainerDefaultProps = {

...
declare const flutter: {
    material: {
        _navigationIndicator: (
            this: void,
            _navigationIndicator: I_NavigationIndicator,
            props: {
                color?: IColor | undefined;
                key?: IKey | undefined;
                animation: IAnimation<number>;
            }
        ) => I_NavigationIndicator;
    };
};
export interface I_NavigationIndicator {
    animation: IAnimation<number>;
    color: IColor | undefined;
    key: IKey | undefined;
...
export class _NavigationIndicator implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._navigationIndicator(this, props);
    }

...
import { INavigationRail } from "./navigationRail";
declare const flutter: {
    material: {
        _navigationRailState: (
            this: void,
            _navigationRailState: I_NavigationRailState
        ) => I_NavigationRailState;
    };
};
export interface I_NavigationRailState {
    initState: () => void;
    dispose: () => void;
...
export class _NavigationRailState
    implements
        Omit<
            IState<INavigationRail>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<INavigationRail>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._navigationRailState(this);
    }
    ...
    private readonly _dart_getWidget: () => INavigationRail = undefined as any;
    ...
    public getWidget(): INavigationRail {

...
declare const flutter: {
    material: {
        _scaffoldScope: (
            this: void,
            _scaffoldScope: I_ScaffoldScope,
            props: {
                key?: IKey | undefined;
                child: IWidget;
...
export interface I_ScaffoldScope {
    hasDrawer: boolean;
    geometryNotifier: I_ScaffoldGeometryNotifier;
    child: IWidget;
    key: IKey | undefined;
...
export class _ScaffoldScope implements IInheritedWidget, IDiagnosticable {
    public readonly hasDrawer: boolean = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._scaffoldScope(this, props);
    }

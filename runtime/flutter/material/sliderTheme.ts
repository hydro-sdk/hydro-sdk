    ...
    material: {
        sliderTheme: (
            ...
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: ISliderThemeData;
            }
        ) => ISliderTheme;
        sliderThemeOf: (context: IBuildContext) => ISliderThemeData;
    };
};
...
export class SliderTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: ISliderThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.sliderTheme(this, props);
    }
    public static of(context: IBuildContext): ISliderThemeData {
        return flutter.material.sliderThemeOf(context);
    }

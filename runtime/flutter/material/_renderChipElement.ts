...
import { I_ChipRenderWidget } from "./_chipRenderWidget";
...
declare const flutter: {
    material: {
        _renderChipElement: (
            this: void,
            _renderChipElement: I_RenderChipElement,
            chip: I_ChipRenderWidget
        ) => I_RenderChipElement;
    };
};
export interface I_RenderChipElement {
    slotToChild: IMap<_ChipSlot, IElement>;
    getWidget: () => I_ChipRenderWidget;
    getRenderObject: () => I_RenderChip;
...
export class _RenderChipElement
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    public readonly slotToChild: IMap<_ChipSlot, IElement> = undefined as any;
    public constructor(chip: I_ChipRenderWidget) {
        flutter.material._renderChipElement(this, chip);
    }
    private readonly _dart_getWidget: () => I_ChipRenderWidget =
        undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderChip =
        undefined as any;
    ...
    public getWidget(): I_ChipRenderWidget {
        return this._dart_getWidget();
    }
    public getRenderObject(): I_RenderChip {

...
declare const flutter: {
    material: {
        _bottomNavigationBarState: (
            this: void,
            _bottomNavigationBarState: I_BottomNavigationBarState
        ) => I_BottomNavigationBarState;
    };
};
export interface I_BottomNavigationBarState {
    initState: () => void;
    dispose: () => void;
    ...
    deactivate: () => void;
    activate: () => void;
    getWidget: () => IBottomNavigationBar;
...
export class _BottomNavigationBarState
    implements
        Omit<
            IState<IBottomNavigationBar>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IBottomNavigationBar>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._bottomNavigationBarState(this);
    }
    ...
    private readonly _dart_getWidget: () => IBottomNavigationBar =
        undefined as any;
    ...
    public getWidget(): IBottomNavigationBar {

...
import { I_ListTile } from "./_listTile";
...
declare const flutter: {
    material: {
        _listTileElement: (
            this: void,
            _listTileElement: I_ListTileElement,
            widget: I_ListTile
        ) => I_ListTileElement;
    };
};
export interface I_ListTileElement {
    slotToChild: IMap<_ListTileSlot, IElement>;
    getWidget: () => I_ListTile;
    getRenderObject: () => I_RenderListTile;
...
export class _ListTileElement
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    public readonly slotToChild: IMap<_ListTileSlot, IElement> =
        undefined as any;
    public constructor(widget: I_ListTile) {
        flutter.material._listTileElement(this, widget);
    }
    private readonly _dart_getWidget: () => I_ListTile = undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderListTile =
        undefined as any;
    ...
    public getWidget(): I_ListTile {
        return this._dart_getWidget();
    }
    public getRenderObject(): I_RenderListTile {

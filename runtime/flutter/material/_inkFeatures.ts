...
import { I_RenderInkFeatures } from "./_renderInkFeatures";
declare const flutter: {
    material: {
        _inkFeatures: (
            this: void,
            _inkFeatures: I_InkFeatures,
            props: {
...
export interface I_InkFeatures {
    color: IColor | undefined;
    vsync: ITickerProvider;
    absorbHitTest: boolean;
    child: IWidget | undefined;
    key: IKey | undefined;
    createRenderObject: (context: IBuildContext) => I_RenderInkFeatures;
    ...
    implements ISingleChildRenderObjectWidget, IDiagnosticable
{
    ...
    public readonly absorbHitTest: boolean = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._inkFeatures(this, props);
    }
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => I_RenderInkFeatures = undefined as any;
    ...
    public createRenderObject(context: IBuildContext): I_RenderInkFeatures {

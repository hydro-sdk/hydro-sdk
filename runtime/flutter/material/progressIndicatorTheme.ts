...
declare const flutter: {
    material: {
        progressIndicatorTheme: (
            this: void,
            progressIndicatorTheme: IProgressIndicatorTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IProgressIndicatorThemeData;
            }
        ) => IProgressIndicatorTheme;
        progressIndicatorThemeOf: (
            context: IBuildContext
        ) => IProgressIndicatorThemeData;
    };
};
export interface IProgressIndicatorTheme {
    data: IProgressIndicatorThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class ProgressIndicatorTheme
    implements IInheritedTheme, IDiagnosticable
{
    public readonly data: IProgressIndicatorThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.progressIndicatorTheme(this, props);
    }
    public static of(context: IBuildContext): IProgressIndicatorThemeData {
        return flutter.material.progressIndicatorThemeOf(context);
    }

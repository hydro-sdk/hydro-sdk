...
declare const flutter: {
    material: {
        textSelectionToolbar: (
            this: void,
            textSelectionToolbar: ITextSelectionToolbar,
            props: {
                key?: IKey | undefined;
                toolbarBuilder: (
        ...
        ) => ITextSelectionToolbar;
    };
};
export interface ITextSelectionToolbar {
    anchorAbove: IOffset;
    anchorBelow: IOffset;
    children: IList<IWidget>;
    key: IKey | undefined;
...
export class TextSelectionToolbar implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.textSelectionToolbar(this, props);
    }

...
declare const flutter: {
    material: {
        refreshProgressIndicator: (
            this: void,
            refreshProgressIndicator: IRefreshProgressIndicator,
            props: {
        ...
        ) => IRefreshProgressIndicator;
    };
};
export interface IRefreshProgressIndicator {
    strokeWidth: number;
    value: number | undefined;
    backgroundColor: IColor | undefined;
    color: IColor | undefined;
...
export class RefreshProgressIndicator
    implements ICircularProgressIndicator, IDiagnosticable
{
    public static defaultStrokeWidth = 2.5;
    ...
    public constructor(props: {
        ...
        flutter.material.refreshProgressIndicator(this, {
            ...refreshProgressIndicatorDefaultProps,
            ...props,
        });
    }
...
const refreshProgressIndicatorDefaultProps = {

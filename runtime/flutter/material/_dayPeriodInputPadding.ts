...
import { I_RenderInputPadding } from "./_renderInputPadding";
declare const flutter: {
    material: {
        _dayPeriodInputPadding: (
            this: void,
            _dayPeriodInputPadding: I_DayPeriodInputPadding,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                minSize: ISize;
        ...
        ) => I_DayPeriodInputPadding;
    };
};
export interface I_DayPeriodInputPadding {
    minSize: ISize;
    orientation: Orientation;
...
export class _DayPeriodInputPadding
    implements ISingleChildRenderObjectWidget, IDiagnosticable
{
    public readonly minSize: ISize = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._dayPeriodInputPadding(this, props);
    }

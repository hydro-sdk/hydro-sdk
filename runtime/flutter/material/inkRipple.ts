...
export class InkRipple implements IInteractiveInkFeature {
    ...
    public constructor(props: {
        ...
        flutter.material.inkRipple(this, {
            ...inkRippleDefaultProps,
            ...props,
        });
    }

...
declare const flutter: {
    material: {
        _inheritedTheme: (
            this: void,
            _inheritedTheme: I_InheritedTheme,
            props: { key?: IKey | undefined; child: IWidget; theme: ITheme }
        ) => I_InheritedTheme;
    };
};
export interface I_InheritedTheme {
    theme: ITheme;
    child: IWidget;
    key: IKey | undefined;
...
export class _InheritedTheme implements IInheritedTheme, IDiagnosticable {
    public readonly theme: ITheme = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._inheritedTheme(this, props);
    }

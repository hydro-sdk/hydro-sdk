...
import { IDebugOverflowIndicatorMixin } from "../rendering/debugOverflowIndicatorMixin";
...
declare const flutter: {
    material: {
        _renderButtonBarRow: (
            this: void,
            _renderButtonBarRow: I_RenderButtonBarRow,
            props: {
        ...
        ) => I_RenderButtonBarRow;
    };
};
export interface I_RenderButtonBarRow {
    overflowButtonSpacing: number | undefined;
...
export class _RenderButtonBarRow
    implements
        Omit<
            IRenderFlex,
            | "toStringShort"
            ...
            | "toDiagnosticsNode"
        >,
        IContainerRenderObjectMixin<IRenderBox, IFlexParentData>,
        IRenderBoxContainerDefaultsMixin<IRenderBox, IFlexParentData>,
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.material._renderButtonBarRow(this, {
            ..._renderButtonBarRowDefaultProps,
            ...props,
        });
    }
    ...
    private readonly _dart_setDirection: (value: Axis) => void =
        undefined as any;
    private readonly _dart_getMainAxisAlignment: () => MainAxisAlignment =
        undefined as any;
    private readonly _dart_setMainAxisAlignment: (
        value: MainAxisAlignment
    ) => void = undefined as any;
    private readonly _dart_getMainAxisSize: () => MainAxisSize =
        undefined as any;
    private readonly _dart_setMainAxisSize: (value: MainAxisSize) => void =
        undefined as any;
    private readonly _dart_getCrossAxisAlignment: () => CrossAxisAlignment =
        undefined as any;
    ...
    public paintOverflowIndicator(
        ...
        return this._dart_paintOverflowIndicator(
            context,
            offset,
            containerRect,
            childRect,
...
const _renderButtonBarRowDefaultProps = {

...
declare const flutter: {
    material: {
        _popupMenuRoute: <T>(
            this: void,
            _popupMenuRoute: I_PopupMenuRoute<T>,
            props: {
                ...
                items: IList<IPopupMenuEntry<T>>;
                position: IRelativeRect;
            }
        ) => I_PopupMenuRoute<T>;
    };
};
export interface I_PopupMenuRoute<T> {
    position: IRelativeRect;
    items: IList<IPopupMenuEntry<T>>;
    ...
    implements IPopupRoute<T>, ILocalHistoryRoute<T>
{
    ...
    public constructor(props: {
        ...
        flutter.material._popupMenuRoute(this, props);
    }

...
declare const flutter: {
    material: {
        _textSelectionToolbarItemsLayoutElement: (
            this: void,
            _textSelectionToolbarItemsLayoutElement: I_TextSelectionToolbarItemsLayoutElement,
            widget: IMultiChildRenderObjectWidget
        ) => I_TextSelectionToolbarItemsLayoutElement;
    };
};
export interface I_TextSelectionToolbarItemsLayoutElement {
    ...
    getRenderObject: () => IContainerRenderObjectMixin<
        IRenderObject,
...
export class _TextSelectionToolbarItemsLayoutElement
    implements IMultiChildRenderObjectElement, IDiagnosticable, IBuildContext
{
    public constructor(widget: IMultiChildRenderObjectWidget) {
        flutter.material._textSelectionToolbarItemsLayoutElement(this, widget);
    }
    ...
    private readonly _dart_getWidget: () => IMultiChildRenderObjectWidget =
        undefined as any;
    private readonly _dart_getRenderObject: () => IContainerRenderObjectMixin<
        IRenderObject,
        IContainerParentDataMixin<IRenderObject>
    > = undefined as any;
    ...
    public getRenderObject(): IContainerRenderObjectMixin<
        IRenderObject,
        IContainerParentDataMixin<IRenderObject>
    > {

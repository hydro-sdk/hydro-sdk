...
declare const flutter: {
    material: {
        bottomNavigationBarTheme: (
            this: void,
            bottomNavigationBarTheme: IBottomNavigationBarTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IBottomNavigationBarThemeData;
            }
        ) => IBottomNavigationBarTheme;
        bottomNavigationBarThemeOf: (
            context: IBuildContext
        ) => IBottomNavigationBarThemeData;
    };
};
export interface IBottomNavigationBarTheme {
    data: IBottomNavigationBarThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class BottomNavigationBarTheme
    implements IInheritedWidget, IDiagnosticable
{
    public readonly data: IBottomNavigationBarThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.bottomNavigationBarTheme(this, props);
    }
    public static of(context: IBuildContext): IBottomNavigationBarThemeData {
        return flutter.material.bottomNavigationBarThemeOf(context);
    }

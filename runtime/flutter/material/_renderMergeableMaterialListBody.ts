...
declare const flutter: {
    material: {
        _renderMergeableMaterialListBody: (
            this: void,
            _renderMergeableMaterialListBody: I_RenderMergeableMaterialListBody,
            props: {
                axisDirection: AxisDirection;
                children?: IList<IRenderBox> | undefined;
                elevation: number;
            }
        ) => I_RenderMergeableMaterialListBody;
    };
};
export interface I_RenderMergeableMaterialListBody {
...
export class _RenderMergeableMaterialListBody
    implements
        Omit<
            IRenderListBody,
            | "debugFillProperties"
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.material._renderMergeableMaterialListBody(this, {
            ..._renderMergeableMaterialListBodyDefaultProps,
            ...props,
        });
    }
...
const _renderMergeableMaterialListBodyDefaultProps = {

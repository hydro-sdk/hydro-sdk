...
declare const flutter: {
    material: {
        dataTableTheme: (
            this: void,
            dataTableTheme: IDataTableTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IDataTableThemeData;
            }
        ) => IDataTableTheme;
        dataTableThemeOf: (context: IBuildContext) => IDataTableThemeData;
    };
};
...
export class DataTableTheme implements IInheritedWidget, IDiagnosticable {
    public readonly data: IDataTableThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.dataTableTheme(this, props);
    }
    public static of(context: IBuildContext): IDataTableThemeData {
        return flutter.material.dataTableThemeOf(context);
    }

...
declare const flutter: {
    material: {
        _textButtonWithIconChild: (
            this: void,
            _textButtonWithIconChild: I_TextButtonWithIconChild,
            props: { key?: IKey | undefined; icon: IWidget; label: IWidget }
        ) => I_TextButtonWithIconChild;
    };
};
export interface I_TextButtonWithIconChild {
    label: IWidget;
    icon: IWidget;
    key: IKey | undefined;
...
export class _TextButtonWithIconChild
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._textButtonWithIconChild(this, props);
    }

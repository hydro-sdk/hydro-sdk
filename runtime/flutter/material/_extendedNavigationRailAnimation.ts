...
declare const flutter: {
    material: {
        _extendedNavigationRailAnimation: (
            this: void,
            _extendedNavigationRailAnimation: I_ExtendedNavigationRailAnimation,
            props: {
                key?: IKey | undefined;
                animation: IAnimation<number>;
                child: IWidget;
            }
        ) => I_ExtendedNavigationRailAnimation;
    };
};
export interface I_ExtendedNavigationRailAnimation {
    animation: IAnimation<number>;
    child: IWidget;
    key: IKey | undefined;
...
export class _ExtendedNavigationRailAnimation
    implements IInheritedWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._extendedNavigationRailAnimation(this, props);
    }

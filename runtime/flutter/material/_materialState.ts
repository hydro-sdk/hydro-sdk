...
declare const flutter: {
    material: {
        _materialState: (
            this: void,
            _materialState: I_MaterialState
        ) => I_MaterialState;
    };
};
export interface I_MaterialState {
...
export class _MaterialState
    implements
        Omit<
            IState<IMaterial>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IMaterial>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._materialState(this);
    }
    ...
    private readonly _dart_getWidget: () => IMaterial = undefined as any;

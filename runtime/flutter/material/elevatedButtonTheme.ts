...
declare const flutter: {
    material: {
        elevatedButtonTheme: (
            this: void,
            elevatedButtonTheme: IElevatedButtonTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IElevatedButtonThemeData;
            }
        ) => IElevatedButtonTheme;
        elevatedButtonThemeOf: (
            context: IBuildContext
        ) => IElevatedButtonThemeData;
    };
};
export interface IElevatedButtonTheme {
    data: IElevatedButtonThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class ElevatedButtonTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: IElevatedButtonThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.elevatedButtonTheme(this, props);
    }
    public static of(context: IBuildContext): IElevatedButtonThemeData {
        return flutter.material.elevatedButtonThemeOf(context);
    }

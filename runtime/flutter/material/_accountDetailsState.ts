...
import { I_AccountDetails } from "./_accountDetails";
declare const flutter: {
    material: {
        _accountDetailsState: (
            this: void,
            _accountDetailsState: I_AccountDetailsState
        ) => I_AccountDetailsState;
    };
};
export interface I_AccountDetailsState {
    initState: () => void;
    dispose: () => void;
...
export class _AccountDetailsState
    implements
        Omit<
            IState<I_AccountDetails>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<I_AccountDetails>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._accountDetailsState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_AccountDetails = undefined as any;
    ...
    public getWidget(): I_AccountDetails {

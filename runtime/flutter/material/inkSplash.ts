...
export class InkSplash implements IInteractiveInkFeature {
    ...
    public constructor(props: {
        ...
        flutter.material.inkSplash(this, {
            ...inkSplashDefaultProps,
            ...props,
        });
    }

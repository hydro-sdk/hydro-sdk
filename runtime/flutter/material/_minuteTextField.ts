...
declare const flutter: {
    material: {
        _minuteTextField: (
            this: void,
            _minuteTextField: I_MinuteTextField,
            props: {
                key?: IKey | undefined;
...
export interface I_MinuteTextField {
    selectedTime: ITimeOfDay;
    style: ITextStyle;
    autofocus: boolean | undefined;
    minuteLabelText: string | undefined;
...
export class _MinuteTextField implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._minuteTextField(this, props);
    }

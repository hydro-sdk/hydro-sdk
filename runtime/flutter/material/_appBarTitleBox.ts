...
import { I_RenderAppBarTitleBox } from "./_renderAppBarTitleBox";
declare const flutter: {
    material: {
        _appBarTitleBox: (
            this: void,
            _appBarTitleBox: I_AppBarTitleBox,
            props: { key?: IKey | undefined; child: IWidget }
        ) => I_AppBarTitleBox;
    };
};
export interface I_AppBarTitleBox {
    child: IWidget | undefined;
    key: IKey | undefined;
    createRenderObject: (context: IBuildContext) => I_RenderAppBarTitleBox;
    ...
    implements ISingleChildRenderObjectWidget, IDiagnosticable
{
    ...
    public constructor(props: { key?: IKey | undefined; child: IWidget }) {
        flutter.material._appBarTitleBox(this, props);
    }
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => I_RenderAppBarTitleBox = undefined as any;
    ...
    public createRenderObject(context: IBuildContext): I_RenderAppBarTitleBox {

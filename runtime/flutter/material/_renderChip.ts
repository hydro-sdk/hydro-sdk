...
import { _ChipSlot } from "./_chipSlot";
declare const flutter: {
    material: {
        _renderChip: (
            this: void,
            _renderChip: I_RenderChip,
            props: {
...
export interface I_RenderChip {
    children: IMap<_ChipSlot, IRenderBox>;
    value: boolean | undefined;
    isEnabled: boolean | undefined;
    checkmarkAnimation: IAnimation<number>;
    avatarDrawerAnimation: IAnimation<number>;
    ...
    getAvatar: () => IRenderBox | undefined;
    setAvatar: (value?: IRenderBox | undefined) => void;
    getDeleteIcon: () => IRenderBox | undefined;
    setDeleteIcon: (value?: IRenderBox | undefined) => void;
    getLabel: () => IRenderBox | undefined;
    setLabel: (value?: IRenderBox | undefined) => void;
    getTheme: () => I_ChipRenderTheme;
    setTheme: (value: I_ChipRenderTheme) => void;
    getTextDirection: () => TextDirection | undefined;
    setTextDirection: (value?: TextDirection | undefined) => void;
    getIsDrawingCheckmark: () => boolean;
    getDeleteIconShowing: () => boolean;
...
export class _RenderChip
    implements
        ...
        >
{
    public static _debugShowTapTargetOutlines = false;
    public readonly children: IMap<_ChipSlot, IRenderBox> = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._renderChip(this, props);
    }
    private readonly _dart_getAvatar: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setAvatar: (value?: IRenderBox | undefined) => void =
        undefined as any;
    private readonly _dart_getDeleteIcon: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setDeleteIcon: (
    ...
    private readonly _dart_setLabel: (value?: IRenderBox | undefined) => void =
        undefined as any;
    private readonly _dart_getTheme: () => I_ChipRenderTheme = undefined as any;
    private readonly _dart_setTheme: (value: I_ChipRenderTheme) => void =
        undefined as any;
    ...
    private readonly _dart_getIsDrawingCheckmark: () => boolean =
        undefined as any;
    private readonly _dart_getDeleteIconShowing: () => boolean =
        undefined as any;
    ...
    public getAvatar(): IRenderBox | undefined {
        return this._dart_getAvatar();
    }
    public setAvatar(value?: IRenderBox | undefined): void {
        return this._dart_setAvatar(value);
    }
    public getDeleteIcon(): IRenderBox | undefined {
        return this._dart_getDeleteIcon();
    }
    public setDeleteIcon(value?: IRenderBox | undefined): void {
        return this._dart_setDeleteIcon(value);
    }
    ...
    public getTheme(): I_ChipRenderTheme {
        return this._dart_getTheme();
    }
    public setTheme(value: I_ChipRenderTheme): void {
    ...
    public getIsDrawingCheckmark(): boolean {
        return this._dart_getIsDrawingCheckmark();
    }
    public getDeleteIconShowing(): boolean {
        return this._dart_getDeleteIconShowing();
    }

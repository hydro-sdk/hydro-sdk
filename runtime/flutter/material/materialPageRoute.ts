...
declare const flutter: {
    material: {
        materialPageRoute: <T>(
            this: void,
            materialPageRoute: IMaterialPageRoute<T>,
            props: {
        ...
        ) => IMaterialPageRoute<T>;
    };
};
export interface IMaterialPageRoute<T> {
    maintainState: boolean;
    fullscreenDialog: boolean;
...
export class MaterialPageRoute<T>
    implements
        IPageRoute<T>,
        ...
        ILocalHistoryRoute<T>
{
    ...
    public constructor(props: {
        ...
        flutter.material.materialPageRoute(this, {
            ...materialPageRouteDefaultProps,
            ...props,
        });
    }
...
const materialPageRouteDefaultProps = {

...
declare const flutter: {
    material: {
        _changeAnimation: (
            this: void,
            _changeAnimation: I_ChangeAnimation,
            controller: ITabController
        ) => I_ChangeAnimation;
    };
};
export interface I_ChangeAnimation {
    controller: ITabController;
        ...
        IValueListenable<number>
{
    ...
    public constructor(controller: ITabController) {
        flutter.material._changeAnimation(this, controller);
    }

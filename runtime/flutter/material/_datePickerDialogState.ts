...
import { NextFocusIntent } from "../widgets/nextFocusIntent";
import { IRestorableProperty } from "../widgets/restorableProperty";
import { IRestorationMixin } from "../widgets/restorationMixin";
import { SingleActivator } from "../widgets/singleActivator";
import { IState } from "../widgets/state";
import { IWidget } from "../widgets/widget";
import { IDatePickerDialog } from "./datePickerDialog";
declare const flutter: {
    material: {
        _datePickerDialogState: (
            this: void,
            _datePickerDialogState: I_DatePickerDialogState
        ) => I_DatePickerDialogState;
    };
};
export interface I_DatePickerDialogState {
...
export class _DatePickerDialogState
    implements
        Omit<
            IState<IDatePickerDialog>,
            | "didUpdateWidget"
            | "dispose"
            | "didChangeDependencies"
            | "debugFillProperties"
        >,
        IRestorationMixin<IDatePickerDialog>,
        IDiagnosticable
{
    public static _formShortcutMap = Map.fromEntries(
    ...
    public constructor() {
        flutter.material._datePickerDialogState(this);
    }
    ...
    private readonly _dart_getWidget: () => IDatePickerDialog =
        undefined as any;
    ...
    public getWidget(): IDatePickerDialog {

...
declare const flutter: {
    material: {
        _buttonStyleState: (
            this: void,
            _buttonStyleState: I_ButtonStyleState
        ) => I_ButtonStyleState;
    };
};
export interface I_ButtonStyleState {
...
export class _ButtonStyleState
    implements
        Omit<
            IState<IButtonStyleButton>,
            "debugFillProperties" | "dispose" | "didChangeDependencies"
        >,
        IMaterialStateMixin<IButtonStyleButton>,
        ITickerProviderStateMixin<IButtonStyleButton>,
        IDiagnosticable,
        ITickerProvider
{
    public readonly materialStates: ISet<MaterialState> = undefined as any;
    public constructor() {
        flutter.material._buttonStyleState(this);
    }
    ...
    private readonly _dart_getWidget: () => IButtonStyleButton =
        undefined as any;
    ...
    public getWidget(): IButtonStyleButton {

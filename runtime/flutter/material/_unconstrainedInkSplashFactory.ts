...
declare const flutter: {
    material: {
        _unconstrainedInkSplashFactory: (
            this: void,
            _unconstrainedInkSplashFactory: I_UnconstrainedInkSplashFactory,
            parentFactory: IInteractiveInkFeatureFactory
        ) => I_UnconstrainedInkSplashFactory;
    };
};
export interface I_UnconstrainedInkSplashFactory {
    parentFactory: IInteractiveInkFeatureFactory;
    create: (props: {
...
export class _UnconstrainedInkSplashFactory
    implements IInteractiveInkFeatureFactory
{
    public readonly parentFactory: IInteractiveInkFeatureFactory =
        undefined as any;
    public constructor(parentFactory: IInteractiveInkFeatureFactory) {
        flutter.material._unconstrainedInkSplashFactory(this, parentFactory);
    }

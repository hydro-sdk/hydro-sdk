...
import { IMergeableMaterial } from "./mergeableMaterial";
declare const flutter: {
    material: {
        _mergeableMaterialState: (
            this: void,
            _mergeableMaterialState: I_MergeableMaterialState
        ) => I_MergeableMaterialState;
    };
};
export interface I_MergeableMaterialState {
    initState: () => void;
    dispose: () => void;
...
export class _MergeableMaterialState
    implements
        Omit<
            IState<IMergeableMaterial>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IMergeableMaterial>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._mergeableMaterialState(this);
    }
    ...
    private readonly _dart_getWidget: () => IMergeableMaterial =
        undefined as any;
    ...
    public getWidget(): IMergeableMaterial {

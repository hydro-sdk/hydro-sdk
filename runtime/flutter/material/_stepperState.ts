...
declare const flutter: {
    material: {
        _stepperState: (
            this: void,
            _stepperState: I_StepperState
        ) => I_StepperState;
    };
};
export interface I_StepperState {
    initState: () => void;
...
export class _StepperState
    implements
        Omit<
            IState<IStepper>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IStepper>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._stepperState(this);
    }
    ...
    private readonly _dart_getWidget: () => IStepper = undefined as any;

...
declare const flutter: {
    material: {
        materialStateTextStyle: (
            this: void,
            materialStateTextStyle: IMaterialStateTextStyle
        ) => IMaterialStateTextStyle;
        materialStateTextStyleResolveWith: (
            callback: (states: ISet<MaterialState>) => ITextStyle
        ) => IMaterialStateTextStyle;
    };
};
export interface IMaterialStateTextStyle {
    inherit: boolean;
...
export class MaterialStateTextStyle
    implements
        Omit<ITextStyle, "toStringShort" | "debugFillProperties">,
        IDiagnosticable,
        IMaterialStateProperty<ITextStyle>
{
    ...
    public constructor() {
        flutter.material.materialStateTextStyle(this);
    }
    public static resolveWith(
        callback: (states: ISet<MaterialState>) => ITextStyle
    ): IMaterialStateTextStyle {
        return flutter.material.materialStateTextStyleResolveWith(callback);
    }

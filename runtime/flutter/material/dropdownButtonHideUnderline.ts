...
declare const flutter: {
    material: {
        dropdownButtonHideUnderline: (
            this: void,
            dropdownButtonHideUnderline: IDropdownButtonHideUnderline,
            props: { key?: IKey | undefined; child: IWidget }
        ) => IDropdownButtonHideUnderline;
        dropdownButtonHideUnderlineAt: (context: IBuildContext) => boolean;
    };
};
export interface IDropdownButtonHideUnderline {
    child: IWidget;
    key: IKey | undefined;
...
export class DropdownButtonHideUnderline
    implements IInheritedWidget, IDiagnosticable
{
    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
    public constructor(props: { key?: IKey | undefined; child: IWidget }) {
        flutter.material.dropdownButtonHideUnderline(this, props);
    }
    public static at(context: IBuildContext): boolean {
        return flutter.material.dropdownButtonHideUnderlineAt(context);
    }

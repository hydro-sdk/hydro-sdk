...
declare const flutter: {
    material: {
        _tabLabelBarRenderer: (
            this: void,
            _tabLabelBarRenderer: I_TabLabelBarRenderer,
            props: {
        ...
        ) => I_TabLabelBarRenderer;
    };
};
export interface I_TabLabelBarRenderer {
...
export class _TabLabelBarRenderer
    implements
        Omit<
            IRenderFlex,
            | "toStringShort"
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.material._tabLabelBarRenderer(this, props);
    }

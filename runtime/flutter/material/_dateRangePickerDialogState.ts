...
import { IDateRangePickerDialog } from "./dateRangePickerDialog";
declare const flutter: {
    material: {
        _dateRangePickerDialogState: (
            this: void,
            _dateRangePickerDialogState: I_DateRangePickerDialogState
        ) => I_DateRangePickerDialogState;
    };
};
export interface I_DateRangePickerDialogState {
    ...
    getWidget: () => IDateRangePickerDialog;
...
export class _DateRangePickerDialogState
    implements
        Omit<
            IState<IDateRangePickerDialog>,
            | "didUpdateWidget"
            | "dispose"
            | "didChangeDependencies"
            | "debugFillProperties"
        >,
        IRestorationMixin<IDateRangePickerDialog>,
        IDiagnosticable
{
    public constructor() {
        flutter.material._dateRangePickerDialogState(this);
    }
    ...
    private readonly _dart_getWidget: () => IDateRangePickerDialog =
        undefined as any;
    ...
    public getWidget(): IDateRangePickerDialog {

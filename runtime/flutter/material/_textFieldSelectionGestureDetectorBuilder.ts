...
import { I_TextFieldState } from "./_textFieldState";
declare const flutter: {
    material: {
        _textFieldSelectionGestureDetectorBuilder: (
            this: void,
            _textFieldSelectionGestureDetectorBuilder: I_TextFieldSelectionGestureDetectorBuilder,
            props: { state: I_TextFieldState }
        ) => I_TextFieldSelectionGestureDetectorBuilder;
    };
};
export interface I_TextFieldSelectionGestureDetectorBuilder {
...
export class _TextFieldSelectionGestureDetectorBuilder
    implements ITextSelectionGestureDetectorBuilder
{
    public readonly delegate: ITextSelectionGestureDetectorBuilderDelegate =
        undefined as any;
    public constructor(props: { state: I_TextFieldState }) {
        flutter.material._textFieldSelectionGestureDetectorBuilder(this, props);
    }

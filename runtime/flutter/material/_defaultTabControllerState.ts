...
import { IDefaultTabController } from "./defaultTabController";
declare const flutter: {
    material: {
        _defaultTabControllerState: (
            this: void,
            _defaultTabControllerState: I_DefaultTabControllerState
        ) => I_DefaultTabControllerState;
    };
};
export interface I_DefaultTabControllerState {
    initState: () => void;
    dispose: () => void;
    ...
    deactivate: () => void;
    activate: () => void;
    getWidget: () => IDefaultTabController;
...
export class _DefaultTabControllerState
    implements
        Omit<
            IState<IDefaultTabController>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IDefaultTabController>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._defaultTabControllerState(this);
    }
    ...
    private readonly _dart_getWidget: () => IDefaultTabController =
        undefined as any;
    ...
    public getWidget(): IDefaultTabController {

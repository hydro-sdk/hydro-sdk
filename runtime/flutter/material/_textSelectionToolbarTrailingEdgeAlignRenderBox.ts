...
declare const flutter: {
    material: {
        _textSelectionToolbarTrailingEdgeAlignRenderBox: (
            this: void,
            _textSelectionToolbarTrailingEdgeAlignRenderBox: I_TextSelectionToolbarTrailingEdgeAlignRenderBox,
            props: { overflowOpen: boolean; textDirection: TextDirection }
        ) => I_TextSelectionToolbarTrailingEdgeAlignRenderBox;
    };
};
export interface I_TextSelectionToolbarTrailingEdgeAlignRenderBox {
...
export class _TextSelectionToolbarTrailingEdgeAlignRenderBox
    implements
        Omit<
            IRenderProxyBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.material._textSelectionToolbarTrailingEdgeAlignRenderBox(
            this,
            props
        );
    }

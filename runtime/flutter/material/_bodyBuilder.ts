...
export interface I_BodyBuilder {
    body: IWidget;
    extendBody: boolean;
    extendBodyBehindAppBar: boolean;
    key: IKey | undefined;
...
export class _BodyBuilder implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._bodyBuilder(this, props);
    }

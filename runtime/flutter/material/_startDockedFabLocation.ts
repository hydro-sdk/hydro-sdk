...
declare const flutter: {
    material: {
        _startDockedFabLocation: (
            this: void,
            _startDockedFabLocation: I_StartDockedFabLocation
        ) => I_StartDockedFabLocation;
    };
};
export interface I_StartDockedFabLocation {
    toString: () => string;
    getOffsetX: (
...
export class _StartDockedFabLocation
    implements IStandardFabLocation, IFabStartOffsetX, IFabDockedOffsetY
{
    public constructor() {
        flutter.material._startDockedFabLocation(this);
    }

...
import { IDrawerController } from "./drawerController";
declare const flutter: {
    material: {
        drawerControllerState: (
            this: void,
            drawerControllerState: IDrawerControllerState
...
export class DrawerControllerState
    implements
        Omit<
            IState<IDrawerController>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IDrawerController>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material.drawerControllerState(this);
    }
    ...
    private readonly _dart_didUpdateWidget: (oldWidget: any) => void =
        undefined as any;
    private readonly _dart_open: () => void = undefined as any;
    ...
    private readonly _dart_getWidget: () => IDrawerController =
        undefined as any;
    ...
    public getWidget(): IDrawerController {

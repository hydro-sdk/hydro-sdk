...
declare const flutter: {
    material: {
        _timePickerHeader: (
            this: void,
            _timePickerHeader: I_TimePickerHeader,
            props: {
                ...
                onModeChanged: (value: _TimePickerMode) => void;
...
export interface I_TimePickerHeader {
    selectedTime: ITimeOfDay;
    mode: _TimePickerMode;
    orientation: Orientation;
    use24HourDials: boolean;
...
export class _TimePickerHeader implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._timePickerHeader(this, props);
    }

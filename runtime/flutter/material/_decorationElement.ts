...
import { I_Decorator } from "./_decorator";
import { I_RenderDecoration } from "./_renderDecoration";
declare const flutter: {
    material: {
        _decorationElement: (
            this: void,
            _decorationElement: I_DecorationElement,
            widget: I_Decorator
        ) => I_DecorationElement;
    };
};
export interface I_DecorationElement {
    slotToChild: IMap<_DecorationSlot, IElement>;
    getWidget: () => I_Decorator;
    getRenderObject: () => I_RenderDecoration;
...
export class _DecorationElement
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    public readonly slotToChild: IMap<_DecorationSlot, IElement> =
        undefined as any;
    public constructor(widget: I_Decorator) {
        flutter.material._decorationElement(this, widget);
    }
    private readonly _dart_getWidget: () => I_Decorator = undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderDecoration =
        undefined as any;
    ...
    public getWidget(): I_Decorator {
        return this._dart_getWidget();
    }
    public getRenderObject(): I_RenderDecoration {

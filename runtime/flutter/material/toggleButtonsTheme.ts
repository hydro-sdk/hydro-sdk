...
declare const flutter: {
    material: {
        toggleButtonsTheme: (
            this: void,
            toggleButtonsTheme: IToggleButtonsTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IToggleButtonsThemeData;
            }
        ) => IToggleButtonsTheme;
        toggleButtonsThemeOf: (
            context: IBuildContext
        ) => IToggleButtonsThemeData;
    };
};
export interface IToggleButtonsTheme {
    data: IToggleButtonsThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class ToggleButtonsTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: IToggleButtonsThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.toggleButtonsTheme(this, props);
    }
    public static of(context: IBuildContext): IToggleButtonsThemeData {
        return flutter.material.toggleButtonsThemeOf(context);
    }

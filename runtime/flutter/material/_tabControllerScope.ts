...
declare const flutter: {
    material: {
        _tabControllerScope: (
            this: void,
            _tabControllerScope: I_TabControllerScope,
            props: {
                key?: IKey | undefined;
                child: IWidget;
        ...
        ) => I_TabControllerScope;
    };
};
export interface I_TabControllerScope {
    controller: ITabController;
    enabled: boolean;
    child: IWidget;
    key: IKey | undefined;
...
export class _TabControllerScope implements IInheritedWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._tabControllerScope(this, props);
    }

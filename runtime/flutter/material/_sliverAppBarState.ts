...
import { ISliverAppBar } from "./sliverAppBar";
declare const flutter: {
    material: {
        _sliverAppBarState: (
            this: void,
            _sliverAppBarState: I_SliverAppBarState
        ) => I_SliverAppBarState;
    };
};
export interface I_SliverAppBarState {
    initState: () => void;
...
export class _SliverAppBarState
    implements
        Omit<
            IState<ISliverAppBar>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ISliverAppBar>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._sliverAppBarState(this);
    }
    ...
    private readonly _dart_getWidget: () => ISliverAppBar = undefined as any;
    ...
    public getWidget(): ISliverAppBar {

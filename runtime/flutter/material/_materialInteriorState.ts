...
import { I_MaterialInterior } from "./_materialInterior";
declare const flutter: {
    material: {
        _materialInteriorState: (
            this: void,
            _materialInteriorState: I_MaterialInteriorState
        ) => I_MaterialInteriorState;
    };
};
export interface I_MaterialInteriorState {
    forEachTween: (
        visitor: (
...
export class _MaterialInteriorState
    implements
        IAnimatedWidgetBaseState<I_MaterialInterior>,
        ISingleTickerProviderStateMixin<I_MaterialInterior>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._materialInteriorState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_MaterialInterior =
        undefined as any;
    ...
    public getWidget(): I_MaterialInterior {

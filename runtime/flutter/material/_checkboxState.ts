...
declare const flutter: {
    material: {
        _checkboxState: (
            this: void,
            _checkboxState: I_CheckboxState
        ) => I_CheckboxState;
    };
};
export interface I_CheckboxState {
    initState: () => void;
...
export class _CheckboxState
    implements
        Omit<
            ...
            | "initState"
        >,
        ITickerProviderStateMixin<ICheckbox>,
        IToggleableStateMixin<ICheckbox>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._checkboxState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICheckbox = undefined as any;

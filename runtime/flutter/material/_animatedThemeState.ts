...
import { IAnimatedTheme } from "./animatedTheme";
declare const flutter: {
    material: {
        _animatedThemeState: (
            this: void,
            _animatedThemeState: I_AnimatedThemeState
        ) => I_AnimatedThemeState;
    };
};
export interface I_AnimatedThemeState {
    forEachTween: (
        visitor: (
...
export class _AnimatedThemeState
    implements
        IAnimatedWidgetBaseState<IAnimatedTheme>,
        ISingleTickerProviderStateMixin<IAnimatedTheme>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.material._animatedThemeState(this);
    }
    ...
    private readonly _dart_getWidget: () => IAnimatedTheme = undefined as any;
    ...
    public getWidget(): IAnimatedTheme {

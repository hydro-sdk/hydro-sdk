...
declare const flutter: {
    material: {
        _elevatedButtonWithIconChild: (
            this: void,
            _elevatedButtonWithIconChild: I_ElevatedButtonWithIconChild,
            props: { key?: IKey | undefined; icon: IWidget; label: IWidget }
        ) => I_ElevatedButtonWithIconChild;
    };
};
export interface I_ElevatedButtonWithIconChild {
    label: IWidget;
    icon: IWidget;
    key: IKey | undefined;
...
export class _ElevatedButtonWithIconChild
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._elevatedButtonWithIconChild(this, props);
    }

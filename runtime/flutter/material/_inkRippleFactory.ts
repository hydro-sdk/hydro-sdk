...
declare const flutter: {
    material: {
        _inkRippleFactory: (
            this: void,
            _inkRippleFactory: I_InkRippleFactory
        ) => I_InkRippleFactory;
    };
};
export interface I_InkRippleFactory {
    create: (props: {
...
export class _InkRippleFactory implements IInteractiveInkFeatureFactory {
    public constructor() {
        flutter.material._inkRippleFactory(this);
    }

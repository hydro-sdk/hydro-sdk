...
export class FlatButton implements IMaterialButton, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.flatButton(this, {
    ...
    public static icon(props: {
        ...
        return flutter.material.flatButtonIcon(props);
    }

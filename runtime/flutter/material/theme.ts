...
declare const flutter: {
    material: {
        theme: (
            this: void,
            theme: ITheme,
            props: { key?: IKey | undefined; child: IWidget; data: IThemeData }
        ) => ITheme;
        themeOf: (context: IBuildContext) => IThemeData;
    };
};
...
export class Theme implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.theme(this, props);
    }
    public static of(context: IBuildContext): IThemeData {

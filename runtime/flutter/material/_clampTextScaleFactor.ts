...
declare const flutter: {
    material: {
        _clampTextScaleFactor: (
            this: void,
            _clampTextScaleFactor: I_ClampTextScaleFactor,
            props: {
                key?: IKey | undefined;
                lowerLimit: number;
                upperLimit: number;
        ...
        ) => I_ClampTextScaleFactor;
    };
};
export interface I_ClampTextScaleFactor {
    lowerLimit: number;
    upperLimit: number;
    child: IWidget;
    key: IKey | undefined;
...
export class _ClampTextScaleFactor
    implements IStatelessWidget, IDiagnosticable
{
    public readonly lowerLimit: number = undefined as any;
    public readonly upperLimit: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._clampTextScaleFactor(this, {
            ..._clampTextScaleFactorDefaultProps,
            ...props,
        });
    }
...
const _clampTextScaleFactorDefaultProps = {
    lowerLimit: 0,

...
declare const flutter: {
    material: {
        _elevatedButtonDefaultForeground: (
            this: void,
            _elevatedButtonDefaultForeground: I_ElevatedButtonDefaultForeground,
            onPrimary?: IColor | undefined,
            onSurface?: IColor | undefined
        ) => I_ElevatedButtonDefaultForeground;
    };
};
export interface I_ElevatedButtonDefaultForeground {
    onPrimary: IColor | undefined;
    onSurface: IColor | undefined;
...
export class _ElevatedButtonDefaultForeground
    implements IMaterialStateProperty<?IColor>, IDiagnosticable
{
    public readonly onPrimary: IColor | undefined = undefined as any;
    public readonly onSurface: IColor | undefined = undefined as any;
    public constructor(
        onPrimary?: IColor | undefined,
        onSurface?: IColor | undefined
    ) {
        flutter.material._elevatedButtonDefaultForeground(
            this,
            onPrimary,
            onSurface
        );

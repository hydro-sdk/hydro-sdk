...
declare const flutter: {
    material: {
        _selectToggleButtonRenderObject: (
            this: void,
            _selectToggleButtonRenderObject: I_SelectToggleButtonRenderObject,
            _leadingBorderSide: IBorderSide,
            _borderSide: IBorderSide,
            _trailingBorderSide: IBorderSide,
            _borderRadius: IBorderRadius,
            _isFirstButton: boolean,
            _isLastButton: boolean,
            _direction: Axis,
...
export interface I_SelectToggleButtonRenderObject {
    ...
    getLeadingBorderSide: () => IBorderSide;
    setLeadingBorderSide: (value: IBorderSide) => void;
    getBorderSide: () => IBorderSide;
    setBorderSide: (value: IBorderSide) => void;
    getTrailingBorderSide: () => IBorderSide;
    setTrailingBorderSide: (value: IBorderSide) => void;
    getBorderRadius: () => IBorderRadius;
    setBorderRadius: (value: IBorderRadius) => void;
    getIsFirstButton: () => boolean;
    setIsFirstButton: (value: boolean) => void;
    getIsLastButton: () => boolean;
    setIsLastButton: (value: boolean) => void;
...
export class _SelectToggleButtonRenderObject
    implements
        Omit<
            IRenderShiftedBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(
        ...
        flutter.material._selectToggleButtonRenderObject(
            this,
            _leadingBorderSide,
            _borderSide,
            _trailingBorderSide,
    ...
    private readonly _dart_setDirection: (value: Axis) => void =
        undefined as any;
    private readonly _dart_getVerticalDirection: () => VerticalDirection =
        undefined as any;
    private readonly _dart_setVerticalDirection: (
        value: VerticalDirection
    ) => void = undefined as any;
    private readonly _dart_getLeadingBorderSide: () => IBorderSide =
        undefined as any;
    private readonly _dart_setLeadingBorderSide: (value: IBorderSide) => void =
        undefined as any;
    private readonly _dart_getBorderSide: () => IBorderSide = undefined as any;
    private readonly _dart_setBorderSide: (value: IBorderSide) => void =
        undefined as any;
    private readonly _dart_getTrailingBorderSide: () => IBorderSide =
        undefined as any;
    private readonly _dart_setTrailingBorderSide: (value: IBorderSide) => void =
        undefined as any;
    private readonly _dart_getBorderRadius: () => IBorderRadius =
        undefined as any;
    private readonly _dart_setBorderRadius: (value: IBorderRadius) => void =
        undefined as any;
    private readonly _dart_getIsFirstButton: () => boolean = undefined as any;
    private readonly _dart_setIsFirstButton: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsLastButton: () => boolean = undefined as any;
    private readonly _dart_setIsLastButton: (value: boolean) => void =
        undefined as any;
    ...
    public getLeadingBorderSide(): IBorderSide {
        return this._dart_getLeadingBorderSide();
    }
    public setLeadingBorderSide(value: IBorderSide): void {
        return this._dart_setLeadingBorderSide(value);
    }
    public getBorderSide(): IBorderSide {
        return this._dart_getBorderSide();
    }
    public setBorderSide(value: IBorderSide): void {
        return this._dart_setBorderSide(value);
    }
    public getTrailingBorderSide(): IBorderSide {
        return this._dart_getTrailingBorderSide();
    }
    public setTrailingBorderSide(value: IBorderSide): void {
        return this._dart_setTrailingBorderSide(value);
    }
    public getBorderRadius(): IBorderRadius {
        return this._dart_getBorderRadius();
    }
    public setBorderRadius(value: IBorderRadius): void {
        return this._dart_setBorderRadius(value);
    }
    public getIsFirstButton(): boolean {
        return this._dart_getIsFirstButton();
    }
    public setIsFirstButton(value: boolean): void {
        return this._dart_setIsFirstButton(value);
    }
    public getIsLastButton(): boolean {
        return this._dart_getIsLastButton();
    }
    public setIsLastButton(value: boolean): void {
        return this._dart_setIsLastButton(value);
    }

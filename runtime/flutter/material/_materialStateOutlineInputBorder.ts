...
import { IMaterialStateOutlineInputBorder } from "./materialStateOutlineInputBorder";
...
declare const flutter: {
    material: {
        _materialStateOutlineInputBorder: (
            this: void,
            _materialStateOutlineInputBorder: I_MaterialStateOutlineInputBorder,
            _resolve: (states: ISet<MaterialState>) => IInputBorder
        ) => I_MaterialStateOutlineInputBorder;
    };
};
export interface I_MaterialStateOutlineInputBorder {
    gapPadding: number;
...
export class _MaterialStateOutlineInputBorder
    implements
        ...
        IMaterialStateProperty<IInputBorder>
{
    ...
    public constructor(
        ...
        flutter.material._materialStateOutlineInputBorder(this, _resolve);
    }

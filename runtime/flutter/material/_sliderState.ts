...
export class _SliderState
    implements
        Omit<
            IState<ISlider>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ISlider>,
        IDiagnosticable,
        ITickerProvider
{
    ...
    public readonly positionController: IAnimationController = undefined as any;
    ...
    public constructor() {
        flutter.material._sliderState(this);
    }
    ...
    private readonly _dart_getWidget: () => ISlider = undefined as any;

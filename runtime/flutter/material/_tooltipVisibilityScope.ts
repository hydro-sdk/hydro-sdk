...
declare const flutter: {
    material: {
        _tooltipVisibilityScope: (
            this: void,
            _tooltipVisibilityScope: I_TooltipVisibilityScope,
            props: { key?: IKey | undefined; child: IWidget; visible: boolean }
        ) => I_TooltipVisibilityScope;
    };
};
export interface I_TooltipVisibilityScope {
    visible: boolean;
    child: IWidget;
    key: IKey | undefined;
...
export class _TooltipVisibilityScope
    implements IInheritedWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._tooltipVisibilityScope(this, props);
    }

...
declare const flutter: {
    material: {
        _textSelectionToolbarContainer: (
            this: void,
            _textSelectionToolbarContainer: I_TextSelectionToolbarContainer,
            props: { key?: IKey | undefined; child: IWidget }
        ) => I_TextSelectionToolbarContainer;
    };
};
export interface I_TextSelectionToolbarContainer {
    child: IWidget;
    key: IKey | undefined;

...
declare const flutter: {
    material: {
        _autocompleteOptions: <T>(
            this: void,
            _autocompleteOptions: I_AutocompleteOptions<T>,
            props: {
                key?: IKey | undefined;
        ...
        ) => I_AutocompleteOptions<T>;
    };
};
export interface I_AutocompleteOptions<T> {
    options: IIterable<T>;
    maxOptionsHeight: number;
    key: IKey | undefined;
...
export class _AutocompleteOptions<T>
    implements IStatelessWidget, IDiagnosticable
{
    public readonly options: IIterable<T> = undefined as any;
    public readonly maxOptionsHeight: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._autocompleteOptions(this, props);
    }

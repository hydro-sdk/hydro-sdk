...
declare const flutter: {
    material: {
        scrollbarTheme: (
            this: void,
            scrollbarTheme: IScrollbarTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IScrollbarThemeData;
            }
        ) => IScrollbarTheme;
        scrollbarThemeOf: (context: IBuildContext) => IScrollbarThemeData;
    };
};
...
export class ScrollbarTheme implements IInheritedWidget, IDiagnosticable {
    public readonly data: IScrollbarThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.scrollbarTheme(this, props);
    }
    public static of(context: IBuildContext): IScrollbarThemeData {
        return flutter.material.scrollbarThemeOf(context);
    }

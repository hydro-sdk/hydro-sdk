...
declare const flutter: {
    material: {
        _hourTextField: (
            this: void,
            _hourTextField: I_HourTextField,
            props: {
                key?: IKey | undefined;
...
export interface I_HourTextField {
    selectedTime: ITimeOfDay;
    style: ITextStyle;
    autofocus: boolean | undefined;
    hourLabelText: string | undefined;
...
export class _HourTextField implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._hourTextField(this, props);
    }

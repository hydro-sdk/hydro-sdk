...
declare const flutter: {
    material: {
        materialScrollBehavior: (
            this: void,
            materialScrollBehavior: IMaterialScrollBehavior,
            props?: {
                androidOverscrollIndicator?:
                    | AndroidOverscrollIndicator
                    | undefined;
            }
        ) => IMaterialScrollBehavior;
    };
};
export interface IMaterialScrollBehavior {
...
export class MaterialScrollBehavior implements IScrollBehavior {
    public constructor(props?: {
        androidOverscrollIndicator?: AndroidOverscrollIndicator | undefined;
    }) {
        flutter.material.materialScrollBehavior(this, props);
    }

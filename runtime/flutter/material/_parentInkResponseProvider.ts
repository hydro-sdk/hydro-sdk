...
declare const flutter: {
    material: {
        _parentInkResponseProvider: (
            this: void,
            _parentInkResponseProvider: I_ParentInkResponseProvider,
            props: { child: IWidget; state: I_ParentInkResponseState }
        ) => I_ParentInkResponseProvider;
        _parentInkResponseProviderOf: (
            context: IBuildContext
        ) => I_ParentInkResponseState | undefined;
    };
};
export interface I_ParentInkResponseProvider {
    state: I_ParentInkResponseState;
    child: IWidget;
    key: IKey | undefined;
...
export class _ParentInkResponseProvider
    implements IInheritedWidget, IDiagnosticable
{
    public readonly state: I_ParentInkResponseState = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._parentInkResponseProvider(this, props);
    }
    public static of(
        context: IBuildContext
    ): I_ParentInkResponseState | undefined {
        return flutter.material._parentInkResponseProviderOf(context);
    }

...
declare const flutter: {
    material: {
        _renderTextSelectionToolbarItemsLayout: (
            this: void,
            _renderTextSelectionToolbarItemsLayout: I_RenderTextSelectionToolbarItemsLayout,
            props: { isAbove: boolean; overflowOpen: boolean }
        ) => I_RenderTextSelectionToolbarItemsLayout;
    };
};
export interface I_RenderTextSelectionToolbarItemsLayout {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getIsAbove: () => boolean;
    setIsAbove: (value: boolean) => void;
    getOverflowOpen: () => boolean;
    setOverflowOpen: (value: boolean) => void;
    performLayout: () => void;
...
export class _RenderTextSelectionToolbarItemsLayout
    implements
        IRenderBox,
        ...
        >
{
    ...
    public constructor(props: { isAbove: boolean; overflowOpen: boolean }) {
        flutter.material._renderTextSelectionToolbarItemsLayout(this, props);
    }
    private readonly _dart_getIsAbove: () => boolean = undefined as any;
    private readonly _dart_setIsAbove: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getOverflowOpen: () => boolean = undefined as any;
    private readonly _dart_setOverflowOpen: (value: boolean) => void =
        undefined as any;
    ...
    public getIsAbove(): boolean {
        return this._dart_getIsAbove();
    }
    public setIsAbove(value: boolean): void {
        return this._dart_setIsAbove(value);
    }
    public getOverflowOpen(): boolean {
        return this._dart_getOverflowOpen();
    }
    public setOverflowOpen(value: boolean): void {
        return this._dart_setOverflowOpen(value);
    }

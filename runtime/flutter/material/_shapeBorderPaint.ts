...
declare const flutter: {
    material: {
        _shapeBorderPaint: (
            this: void,
            _shapeBorderPaint: I_ShapeBorderPaint,
            props: {
...
export interface I_ShapeBorderPaint {
    child: IWidget;
    shape: IShapeBorder;
    borderOnForeground: boolean;
    key: IKey | undefined;
...
export class _ShapeBorderPaint implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._shapeBorderPaint(this, {
            ..._shapeBorderPaintDefaultProps,
            ...props,
        });
    }
...
const _shapeBorderPaintDefaultProps = {

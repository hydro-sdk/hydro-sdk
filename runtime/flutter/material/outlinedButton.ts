...
export class OutlinedButton implements IButtonStyleButton, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.outlinedButton(this, {
            ...outlinedButtonDefaultProps,
            ...props,
        });
    }
    public static icon(props: {
        ...
        return flutter.material.outlinedButtonIcon(props);
    }
    public static styleFrom(props?: {
        ...
        return flutter.material.outlinedButtonStyleFrom(props);
    }
...
const outlinedButtonDefaultProps = {
    autofocus: false,

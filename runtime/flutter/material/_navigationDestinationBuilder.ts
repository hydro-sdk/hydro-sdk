...
declare const flutter: {
    material: {
        _navigationDestinationBuilder: (
            this: void,
            _navigationDestinationBuilder: I_NavigationDestinationBuilder,
            props: {
                key?: IKey | undefined;
                tooltip?: string | undefined;
                buildIcon: (context: IBuildContext) => IWidget;
                buildLabel: (context: IBuildContext) => IWidget;
                label: string;
            }
        ) => I_NavigationDestinationBuilder;
    };
};
export interface I_NavigationDestinationBuilder {
    label: string;
    tooltip: string | undefined;
    key: IKey | undefined;
...
export class _NavigationDestinationBuilder
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._navigationDestinationBuilder(this, props);
    }

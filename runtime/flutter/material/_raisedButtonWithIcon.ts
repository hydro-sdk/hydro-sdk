...
import { IRaisedButton } from "./raisedButton";
import { IVisualDensity } from "./visualDensity";
declare const flutter: {
    material: {
        _raisedButtonWithIcon: (
            this: void,
            _raisedButtonWithIcon: I_RaisedButtonWithIcon,
            props: {
        ...
        ) => I_RaisedButtonWithIcon;
    };
};
export interface I_RaisedButtonWithIcon {
    onPressed: () => void | undefined;
    onLongPress: () => void | undefined;
    onHighlightChanged: (value: boolean) => void | undefined;
    mouseCursor: IMouseCursor | undefined;
...
export class _RaisedButtonWithIcon
    implements IRaisedButton, IMaterialButtonWithIconMixin, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._raisedButtonWithIcon(this, {
            ..._raisedButtonWithIconDefaultProps,
            ...props,
        });
    }
...
const _raisedButtonWithIconDefaultProps = {
    autofocus: false,

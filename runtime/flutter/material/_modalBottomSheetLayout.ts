...
declare const flutter: {
    material: {
        _modalBottomSheetLayout: (
            this: void,
            _modalBottomSheetLayout: I_ModalBottomSheetLayout,
            progress: number,
            isScrollControlled: boolean
        ) => I_ModalBottomSheetLayout;
    };
};
export interface I_ModalBottomSheetLayout {
    progress: number;
    isScrollControlled: boolean;
...
export class _ModalBottomSheetLayout implements ISingleChildLayoutDelegate {
    ...
    public constructor(progress: number, isScrollControlled: boolean) {
        flutter.material._modalBottomSheetLayout(
            this,
            progress,
            isScrollControlled
        );

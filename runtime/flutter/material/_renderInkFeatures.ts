...
declare const flutter: {
    material: {
        _renderInkFeatures: (
            this: void,
            _renderInkFeatures: I_RenderInkFeatures,
            props: {
...
export interface I_RenderInkFeatures {
    vsync: ITickerProvider;
    color: IColor | undefined;
    absorbHitTest: boolean;
...
export class _RenderInkFeatures
    implements
        Omit<
            IRenderProxyBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.material._renderInkFeatures(this, props);
    }
    private readonly _dart_addInkFeature: (feature: IInkFeature) => void =
        undefined as any;
    ...
    public addInkFeature(feature: IInkFeature): void {
        return this._dart_addInkFeature(feature);
    }

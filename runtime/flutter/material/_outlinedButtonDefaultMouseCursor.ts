...
declare const flutter: {
    material: {
        _outlinedButtonDefaultMouseCursor: (
            this: void,
            _outlinedButtonDefaultMouseCursor: I_OutlinedButtonDefaultMouseCursor,
            enabledCursor: IMouseCursor,
            disabledCursor: IMouseCursor
        ) => I_OutlinedButtonDefaultMouseCursor;
    };
};
export interface I_OutlinedButtonDefaultMouseCursor {
    enabledCursor: IMouseCursor;
    disabledCursor: IMouseCursor;
...
export class _OutlinedButtonDefaultMouseCursor
    implements IMaterialStateProperty<IMouseCursor>, IDiagnosticable
{
    ...
    public constructor(
        ...
        flutter.material._outlinedButtonDefaultMouseCursor(
            this,
            enabledCursor,
            disabledCursor
        );

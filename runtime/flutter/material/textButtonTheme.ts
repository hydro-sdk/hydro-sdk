...
declare const flutter: {
    material: {
        textButtonTheme: (
            this: void,
            textButtonTheme: ITextButtonTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: ITextButtonThemeData;
            }
        ) => ITextButtonTheme;
        textButtonThemeOf: (context: IBuildContext) => ITextButtonThemeData;
    };
};
export interface ITextButtonTheme {
    data: ITextButtonThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class TextButtonTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: ITextButtonThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.textButtonTheme(this, props);
    }
    public static of(context: IBuildContext): ITextButtonThemeData {
        return flutter.material.textButtonThemeOf(context);
    }

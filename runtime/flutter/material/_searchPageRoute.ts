...
import { ISearchDelegate } from "./searchDelegate";
declare const flutter: {
    material: {
        _searchPageRoute: <T>(
            this: void,
            _searchPageRoute: I_SearchPageRoute<T>,
            props: { delegate: ISearchDelegate<T> }
        ) => I_SearchPageRoute<T>;
    };
};
export interface I_SearchPageRoute<T> {
    delegate: ISearchDelegate<T>;
...
export class _SearchPageRoute<T>
    implements IPageRoute<T>, ILocalHistoryRoute<T>
{
    public readonly delegate: ISearchDelegate<T> = undefined as any;
    ...
    public constructor(props: { delegate: ISearchDelegate<T> }) {
        flutter.material._searchPageRoute(this, props);
    }

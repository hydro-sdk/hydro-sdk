...
declare const flutter: {
    material: {
        materialBannerTheme: (
            this: void,
            materialBannerTheme: IMaterialBannerTheme,
            props: {
                data?: IMaterialBannerThemeData | undefined;
                key?: IKey | undefined;
                child: IWidget;
            }
        ) => IMaterialBannerTheme;
        materialBannerThemeOf: (
            context: IBuildContext
        ) => IMaterialBannerThemeData;
    };
};
export interface IMaterialBannerTheme {
    data: IMaterialBannerThemeData | undefined;
    child: IWidget;
    key: IKey | undefined;
...
export class MaterialBannerTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: IMaterialBannerThemeData | undefined =
        undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.materialBannerTheme(this, props);
    }
    public static of(context: IBuildContext): IMaterialBannerThemeData {
        return flutter.material.materialBannerThemeOf(context);
    }

...
declare const flutter: {
    material: {
        _dayPeriodControl: (
            this: void,
            _dayPeriodControl: I_DayPeriodControl,
            props: {
...
export interface I_DayPeriodControl {
    selectedTime: ITimeOfDay;
    orientation: Orientation;
    key: IKey | undefined;
...
export class _DayPeriodControl implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._dayPeriodControl(this, props);
    }

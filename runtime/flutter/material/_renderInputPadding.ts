...
declare const flutter: {
    material: {
        _renderInputPadding: (
            this: void,
            _renderInputPadding: I_RenderInputPadding,
            _minSize: ISize,
            child?: IRenderBox | undefined
        ) => I_RenderInputPadding;
    };
};
export interface I_RenderInputPadding {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getMinSize: () => ISize;
    setMinSize: (value: ISize) => void;
...
export class _RenderInputPadding
    implements
        Omit<
            IRenderShiftedBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(_minSize: ISize, child?: IRenderBox | undefined) {
        flutter.material._renderInputPadding(this, _minSize, child);
    }
    private readonly _dart_getMinSize: () => ISize = undefined as any;
    private readonly _dart_setMinSize: (value: ISize) => void =
        undefined as any;
    ...
    public getMinSize(): ISize {
        return this._dart_getMinSize();
    }
    public setMinSize(value: ISize): void {
        return this._dart_setMinSize(value);
    }

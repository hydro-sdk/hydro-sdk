...
declare const flutter: {
    material: {
        _dayHeaders: (this: void, _dayHeaders: I_DayHeaders) => I_DayHeaders;
    };
};
export interface I_DayHeaders {
    key: IKey | undefined;
...
export class _DayHeaders implements IStatelessWidget, IDiagnosticable {
    public readonly key: IKey | undefined = undefined as any;
    public constructor() {
        flutter.material._dayHeaders(this);
    }

...
import { I_CircularProgressIndicatorPainter } from "./_circularProgressIndicatorPainter";
declare const flutter: {
    material: {
        _refreshProgressIndicatorPainter: (
            this: void,
            _refreshProgressIndicatorPainter: I_RefreshProgressIndicatorPainter,
            props: {
        ...
        ) => I_RefreshProgressIndicatorPainter;
    };
};
export interface I_RefreshProgressIndicatorPainter {
    arrowheadScale: number;
    ...
    arcStart: number;
    arcSweep: number;
    paintArrowhead: (canvas: ICanvas, size: ISize) => void;
...
export class _RefreshProgressIndicatorPainter
    implements I_CircularProgressIndicatorPainter
{
    public readonly arrowheadScale: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._refreshProgressIndicatorPainter(this, props);
    }
    private readonly _dart_paintArrowhead: (
        canvas: ICanvas,
        size: ISize
    ...
    public paintArrowhead(canvas: ICanvas, size: ISize): void {
        return this._dart_paintArrowhead(canvas, size);
    }

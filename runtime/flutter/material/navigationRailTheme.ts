...
declare const flutter: {
    material: {
        navigationRailTheme: (
            this: void,
            navigationRailTheme: INavigationRailTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: INavigationRailThemeData;
            }
        ) => INavigationRailTheme;
        navigationRailThemeOf: (
            context: IBuildContext
        ) => INavigationRailThemeData;
    };
};
export interface INavigationRailTheme {
    data: INavigationRailThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class NavigationRailTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: INavigationRailThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.navigationRailTheme(this, props);
    }
    public static of(context: IBuildContext): INavigationRailThemeData {
        return flutter.material.navigationRailThemeOf(context);
    }

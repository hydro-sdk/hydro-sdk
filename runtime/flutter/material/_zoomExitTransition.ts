...
declare const flutter: {
    material: {
        _zoomExitTransition: (
            this: void,
            _zoomExitTransition: I_ZoomExitTransition,
            props: {
        ...
        ) => I_ZoomExitTransition;
    };
};
export interface I_ZoomExitTransition {
    animation: IAnimation<number>;
    reverse: boolean;
    child: IWidget | undefined;
    key: IKey | undefined;
...
export class _ZoomExitTransition implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._zoomExitTransition(this, {
            ..._zoomExitTransitionDefaultProps,
            ...props,
        });
    }
...
const _zoomExitTransitionDefaultProps = {
    reverse: false,
};

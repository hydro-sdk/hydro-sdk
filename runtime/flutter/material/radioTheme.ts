    ...
    material: {
        radioTheme: (
            ...
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IRadioThemeData;
            }
        ) => IRadioTheme;
        radioThemeOf: (context: IBuildContext) => IRadioThemeData;
    };
};
...
export class RadioTheme implements IInheritedWidget, IDiagnosticable {
    public readonly data: IRadioThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.radioTheme(this, props);
    }
    public static of(context: IBuildContext): IRadioThemeData {
        return flutter.material.radioThemeOf(context);
    }

...
export interface ITabBarView {
    controller: ITabController | undefined;
    children: IList<IWidget>;
    physics: IScrollPhysics | undefined;
    dragStartBehavior: DragStartBehavior;
    key: IKey | undefined;
    createState: () => IState<ITabBarView>;
...
export class TabBarView implements IStatefulWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material.tabBarView(this, {
            ...tabBarViewDefaultProps,
            ...props,
        });
    }
    private readonly _dart_createState: () => IState<ITabBarView> =
        undefined as any;
    ...
    public createState(): IState<ITabBarView> {

...
import { I_DropdownMenuItemContainer } from "./_dropdownMenuItemContainer";
declare const flutter: {
    material: {
        dropdownMenuItem: <T>(
            this: void,
            dropdownMenuItem: IDropdownMenuItem<T>,
            props: {
...
export class DropdownMenuItem<T>
    implements I_DropdownMenuItemContainer, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material.dropdownMenuItem(this, {
...
const dropdownMenuItemDefaultProps = {

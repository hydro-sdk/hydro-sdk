...
import { IRestorableTimeOfDay } from "./restorableTimeOfDay";
import { ITimePickerDialog } from "./timePickerDialog";
declare const flutter: {
    material: {
        _timePickerDialogState: (
            this: void,
            _timePickerDialogState: I_TimePickerDialogState
        ) => I_TimePickerDialogState;
    };
};
export interface I_TimePickerDialogState {
    ...
    getSelectedTime: () => IRestorableTimeOfDay;
...
export class _TimePickerDialogState
    implements
        Omit<
            IState<ITimePickerDialog>,
            | "didUpdateWidget"
            | "dispose"
            | "didChangeDependencies"
            | "debugFillProperties"
        >,
        IRestorationMixin<ITimePickerDialog>,
        IDiagnosticable
{
    public readonly localizations: IMaterialLocalizations = undefined as any;
    public constructor() {
        flutter.material._timePickerDialogState(this);
    }
    ...
    private readonly _dart_getSelectedTime: () => IRestorableTimeOfDay =
        undefined as any;
    ...
    private readonly _dart_getWidget: () => ITimePickerDialog =
        undefined as any;
    ...
    public getSelectedTime(): IRestorableTimeOfDay {
        return this._dart_getSelectedTime();
    }
    ...
    public getWidget(): ITimePickerDialog {

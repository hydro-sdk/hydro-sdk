...
declare const flutter: {
    material: {
        _outlinedButtonWithIconChild: (
            this: void,
            _outlinedButtonWithIconChild: I_OutlinedButtonWithIconChild,
            props: { key?: IKey | undefined; icon: IWidget; label: IWidget }
        ) => I_OutlinedButtonWithIconChild;
    };
};
export interface I_OutlinedButtonWithIconChild {
    label: IWidget;
    icon: IWidget;
    key: IKey | undefined;
...
export class _OutlinedButtonWithIconChild
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.material._outlinedButtonWithIconChild(this, props);
    }

...
declare const flutter: {
    material: {
        _outlinedButtonDefaultForeground: (
            this: void,
            _outlinedButtonDefaultForeground: I_OutlinedButtonDefaultForeground,
            primary?: IColor | undefined,
            onSurface?: IColor | undefined
        ) => I_OutlinedButtonDefaultForeground;
    };
};
export interface I_OutlinedButtonDefaultForeground {
    primary: IColor | undefined;
    onSurface: IColor | undefined;
...
export class _OutlinedButtonDefaultForeground
    implements IMaterialStateProperty<?IColor>, IDiagnosticable
{
    ...
    public constructor(
        ...
        flutter.material._outlinedButtonDefaultForeground(
            this,
            primary,
            onSurface
        );

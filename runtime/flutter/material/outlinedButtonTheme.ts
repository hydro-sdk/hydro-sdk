...
declare const flutter: {
    material: {
        outlinedButtonTheme: (
            this: void,
            outlinedButtonTheme: IOutlinedButtonTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IOutlinedButtonThemeData;
            }
        ) => IOutlinedButtonTheme;
        outlinedButtonThemeOf: (
            context: IBuildContext
        ) => IOutlinedButtonThemeData;
    };
};
export interface IOutlinedButtonTheme {
    data: IOutlinedButtonThemeData;
    child: IWidget;
    key: IKey | undefined;
...
export class OutlinedButtonTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: IOutlinedButtonThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.outlinedButtonTheme(this, props);
    }
    public static of(context: IBuildContext): IOutlinedButtonThemeData {
        return flutter.material.outlinedButtonThemeOf(context);
    }

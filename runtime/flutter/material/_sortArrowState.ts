...
import { I_SortArrow } from "./_sortArrow";
declare const flutter: {
    material: {
        _sortArrowState: (
            this: void,
            _sortArrowState: I_SortArrowState
        ) => I_SortArrowState;
    };
};
export interface I_SortArrowState {
    initState: () => void;
...
export class _SortArrowState
    implements
        Omit<
            IState<I_SortArrow>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<I_SortArrow>,
        IDiagnosticable,
        ITickerProvider
{
    public static _arrowIconBaselineOffset = -1.5;
    public static _arrowIconSize = 16.0;
    public constructor() {
        flutter.material._sortArrowState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_SortArrow = undefined as any;

...
declare const flutter: {
    material: {
        _tooltipPositionDelegate: (
            this: void,
            _tooltipPositionDelegate: I_TooltipPositionDelegate,
            props: {
                preferBelow: boolean;
                target: IOffset;
                verticalOffset: number;
            }
        ) => I_TooltipPositionDelegate;
    };
};
export interface I_TooltipPositionDelegate {
    target: IOffset;
    verticalOffset: number;
    preferBelow: boolean;
...
export class _TooltipPositionDelegate implements ISingleChildLayoutDelegate {
    ...
    public constructor(props: {
        ...
        flutter.material._tooltipPositionDelegate(this, props);
    }

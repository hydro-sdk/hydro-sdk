...
declare const flutter: {
    material: {
        _hourMinuteControl: (
            this: void,
            _hourMinuteControl: I_HourMinuteControl,
            props: {
                isSelected: boolean;
                onDoubleTap: () => void;
                onTap: () => void;
...
export interface I_HourMinuteControl {
    text: string;
    isSelected: boolean;
    key: IKey | undefined;
...
export class _HourMinuteControl implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.material._hourMinuteControl(this, props);
    }

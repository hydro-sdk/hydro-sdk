...
declare const flutter: {
    material: {
        _focusedDate: (
            this: void,
            _focusedDate: I_FocusedDate,
            props: {
                date?: IDateTime | undefined;
                key?: IKey | undefined;
                child: IWidget;
            }
        ) => I_FocusedDate;
        _focusedDateOf: (context: IBuildContext) => IDateTime | undefined;
    };
};
export interface I_FocusedDate {
    date: IDateTime | undefined;
    child: IWidget;
    key: IKey | undefined;
...
export class _FocusedDate implements IInheritedWidget, IDiagnosticable {
    public readonly date: IDateTime | undefined = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material._focusedDate(this, props);
    }
    public static of(context: IBuildContext): IDateTime | undefined {
        return flutter.material._focusedDateOf(context);
    }

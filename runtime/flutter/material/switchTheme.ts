    ...
    material: {
        switchTheme: (
            ...
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: ISwitchThemeData;
            }
        ) => ISwitchTheme;
        switchThemeOf: (context: IBuildContext) => ISwitchThemeData;
    };
};
...
export class SwitchTheme implements IInheritedWidget, IDiagnosticable {
    public readonly data: ISwitchThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.switchTheme(this, props);
    }
    public static of(context: IBuildContext): ISwitchThemeData {
        return flutter.material.switchThemeOf(context);
    }

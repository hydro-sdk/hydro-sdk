...
import { IMaterialPage } from "./materialPage";
import { IMaterialRouteTransitionMixin } from "./materialRouteTransitionMixin";
declare const flutter: {
    material: {
        _pageBasedMaterialPageRoute: <T>(
            this: void,
            _pageBasedMaterialPageRoute: I_PageBasedMaterialPageRoute<T>,
            props: { page: IMaterialPage<T> }
        ) => I_PageBasedMaterialPageRoute<T>;
    };
};
export interface I_PageBasedMaterialPageRoute<T> {
...
export class _PageBasedMaterialPageRoute<T>
    implements
        IPageRoute<T>,
        IMaterialRouteTransitionMixin<T>,
        ILocalHistoryRoute<T>
{
    ...
    public constructor(props: { page: IMaterialPage<T> }) {
        flutter.material._pageBasedMaterialPageRoute(this, props);
    }

...
declare const flutter: {
    material: {
        _desktopTextSelectionControls: (
            this: void,
            _desktopTextSelectionControls: I_DesktopTextSelectionControls
        ) => I_DesktopTextSelectionControls;
    };
};
export interface I_DesktopTextSelectionControls {
...
export class _DesktopTextSelectionControls implements ITextSelectionControls {
    public constructor() {
        flutter.material._desktopTextSelectionControls(this);
    }

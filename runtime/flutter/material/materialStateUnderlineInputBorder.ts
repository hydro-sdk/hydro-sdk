...
declare const flutter: {
    material: {
        materialStateUnderlineInputBorder: (
            this: void,
            materialStateUnderlineInputBorder: IMaterialStateUnderlineInputBorder
        ) => IMaterialStateUnderlineInputBorder;
        materialStateUnderlineInputBorderResolveWith: (
            callback: (states: ISet<MaterialState>) => IInputBorder
        ) => IMaterialStateUnderlineInputBorder;
    };
};
export interface IMaterialStateUnderlineInputBorder {
...
export class MaterialStateUnderlineInputBorder
    implements IUnderlineInputBorder, IMaterialStateProperty<IInputBorder>
{
    public readonly borderRadius: IBorderRadius = undefined as any;
    public readonly borderSide: IBorderSide = undefined as any;
    public constructor() {
        flutter.material.materialStateUnderlineInputBorder(this);
    }
    public static resolveWith(
        callback: (states: ISet<MaterialState>) => IInputBorder
    ): IMaterialStateUnderlineInputBorder {
        return flutter.material.materialStateUnderlineInputBorderResolveWith(
            callback
        );
    }

...
import { I_CircularProgressIndicatorState } from "./_circularProgressIndicatorState";
import { ICircularProgressIndicator } from "./circularProgressIndicator";
declare const flutter: {
    material: {
        _refreshProgressIndicatorState: (
            this: void,
            _refreshProgressIndicatorState: I_RefreshProgressIndicatorState
        ) => I_RefreshProgressIndicatorState;
    };
};
export interface I_RefreshProgressIndicatorState {
...
export class _RefreshProgressIndicatorState
    implements
        Omit<
            I_CircularProgressIndicatorState,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<ICircularProgressIndicator>,
        IDiagnosticable,
        ITickerProvider
{
    public static _indicatorSize = 41.0;
    public static _strokeHeadInterval = 0.33;
    public constructor() {
        flutter.material._refreshProgressIndicatorState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICircularProgressIndicator =
        undefined as any;

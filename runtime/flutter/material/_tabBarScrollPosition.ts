...
import { IScrollActivity } from "../widgets/scrollActivity";
import { IScrollActivityDelegate } from "../widgets/scrollActivityDelegate";
import { IScrollContext } from "../widgets/scrollContext";
import { IScrollHoldController } from "../widgets/scrollHoldController";
import { IScrollMetrics } from "../widgets/scrollMetrics";
import { IScrollPhysics } from "../widgets/scrollPhysics";
import { IScrollPosition } from "../widgets/scrollPosition";
import { ScrollPositionAlignmentPolicy } from "../widgets/scrollPositionAlignmentPolicy";
import { IScrollPositionWithSingleContext } from "../widgets/scrollPositionWithSingleContext";
import { I_TabBarState } from "./_tabBarState";
declare const flutter: {
    material: {
        _tabBarScrollPosition: (
            this: void,
            _tabBarScrollPosition: I_TabBarScrollPosition,
            props: {
        ...
        ) => I_TabBarScrollPosition;
    };
};
export interface I_TabBarScrollPosition {
    tabBar: I_TabBarState;
    physics: IScrollPhysics;
    context: IScrollContext;
...
export class _TabBarScrollPosition
    implements
        ...
        IListenable
{
    ...
    public constructor(props: {
        ...
        flutter.material._tabBarScrollPosition(this, props);
    }

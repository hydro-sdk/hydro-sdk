...
declare const flutter: {
    material: {
        tabPageSelector: (
            this: void,
            tabPageSelector: ITabPageSelector,
            props: {
...
export interface ITabPageSelector {
    controller: ITabController | undefined;
    indicatorSize: number;
    color: IColor | undefined;
    selectedColor: IColor | undefined;
...
export class TabPageSelector implements IStatelessWidget, IDiagnosticable {
    public readonly controller: ITabController | undefined = undefined as any;
    public readonly indicatorSize: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.tabPageSelector(this, {
            ...tabPageSelectorDefaultProps,
            ...props,
        });
    }
...
const tabPageSelectorDefaultProps = {
    indicatorSize: 12.0,
};

...
declare const flutter: {
    material: {
        _packageLicensePageTitle: (
            this: void,
            _packageLicensePageTitle: I_PackageLicensePageTitle,
            title: string,
            subtitle: string,
            theme: ITextTheme,
            props?: { key?: IKey | undefined }
        ) => I_PackageLicensePageTitle;
    };
};
export interface I_PackageLicensePageTitle {
    title: string;
    subtitle: string;
    theme: ITextTheme;
    key: IKey | undefined;
...
export class _PackageLicensePageTitle
    implements IStatelessWidget, IDiagnosticable
{
    public readonly title: string = undefined as any;
    public readonly subtitle: string = undefined as any;
    public readonly theme: ITextTheme = undefined as any;
    ...
    public constructor(
        ...
        flutter.material._packageLicensePageTitle(
            this,
            title,
            subtitle,
            theme,

...
import { I_BorderContainer } from "./_borderContainer";
declare const flutter: {
    material: {
        _borderContainerState: (
            this: void,
            _borderContainerState: I_BorderContainerState
        ) => I_BorderContainerState;
    };
};
export interface I_BorderContainerState {
    initState: () => void;
    dispose: () => void;
...
export class _BorderContainerState
    implements
        Omit<
            IState<I_BorderContainer>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<I_BorderContainer>,
        IDiagnosticable,
        ITickerProvider
{
    public static _kHoverDuration = new Duration({ milliseconds: 15 });
    public constructor() {
        flutter.material._borderContainerState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_BorderContainer =
        undefined as any;
    ...
    public getWidget(): I_BorderContainer {

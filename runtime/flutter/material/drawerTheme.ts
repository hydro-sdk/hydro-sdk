...
declare const flutter: {
    material: {
        drawerTheme: (
            this: void,
            drawerTheme: IDrawerTheme,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                data: IDrawerThemeData;
            }
        ) => IDrawerTheme;
        drawerThemeOf: (context: IBuildContext) => IDrawerThemeData;
    };
};
...
export class DrawerTheme implements IInheritedTheme, IDiagnosticable {
    public readonly data: IDrawerThemeData = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.material.drawerTheme(this, props);
    }
    public static of(context: IBuildContext): IDrawerThemeData {
        return flutter.material.drawerThemeOf(context);
    }

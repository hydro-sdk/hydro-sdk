...
declare const flutter: {
    material: {
        _navigationBarDestinationSemantics: (
            this: void,
            _navigationBarDestinationSemantics: I_NavigationBarDestinationSemantics,
            props: { key?: IKey | undefined; child: IWidget }
        ) => I_NavigationBarDestinationSemantics;
    };
};
export interface I_NavigationBarDestinationSemantics {
    child: IWidget;
    key: IKey | undefined;

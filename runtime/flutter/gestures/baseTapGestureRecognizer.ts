...
gestures: {
baseTapGestureRecognizer: (this: void, baseTapGestureRecognizer: IBaseTapGestureRecognizer, props? : {  debugOwner? : Object | undefined,}) => IBaseTapGestureRecognizer
}
};
export interface IBaseTapGestureRecognizer
...
getHashCode: () => number;
}export class BaseTapGestureRecognizer
...
flutter.gestures.baseTapGestureRecognizer(this, props);}

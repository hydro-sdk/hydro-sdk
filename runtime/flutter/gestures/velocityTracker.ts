...
gestures: {
velocityTracker: (this: void, velocityTracker: IVelocityTracker, kind: PointerDeviceKind) => IVelocityTracker
}
};
...
flutter.gestures.velocityTracker(this, kind);}
    ...
    private readonly _dart_getVelocityEstimate: () => IVelocityEstimate | undefined = undefined as any;

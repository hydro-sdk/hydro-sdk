...
declare const flutter: {
    gestures: {
        ...
        pointerEventTransformDeltaViaPositions: (props: {
            transformedEndPosition?: IOffset | undefined;
            transform?: IMatrix4 | undefined;
            untransformedDelta: IOffset;
            untransformedEndPosition: IOffset;
        }) => IOffset;
...
export class PointerEvent implements IDiagnosticable {
    ...
    public static transformPosition(
        transform: IMatrix4 | undefined,
        position: IOffset
    ): IOffset {
        return flutter.gestures.pointerEventTransformPosition(
            transform,
            position
        );
    }
    public static transformDeltaViaPositions(props: {
        transformedEndPosition?: IOffset | undefined;
        transform?: IMatrix4 | undefined;
        untransformedDelta: IOffset;
        untransformedEndPosition: IOffset;
    ...
    public static removePerspectiveTransform(transform: IMatrix4): IMatrix4 {
        return flutter.gestures.pointerEventRemovePerspectiveTransform(
            transform
        );
    }

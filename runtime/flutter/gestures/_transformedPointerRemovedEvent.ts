...
gestures: {
_transformedPointerRemovedEvent: (this: void, _transformedPointerRemovedEvent: I_TransformedPointerRemovedEvent, original: IPointerRemovedEvent, transform: IMatrix4) => I_TransformedPointerRemovedEvent
}
};
...
getLocalDelta: () => IOffset;
 ...
 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerRemovedEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerRemovedEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
...
flutter.gestures._transformedPointerRemovedEvent(this, original, transform);}

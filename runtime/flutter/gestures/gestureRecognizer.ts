...
gestures: {
gestureRecognizer: (this: void, gestureRecognizer: IGestureRecognizer, props? : {  debugOwner? : Object | undefined, kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => IGestureRecognizer
}
};
...
getHashCode: () => number;
 ...
 implements IGestureArenaMember, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
flutter.gestures.gestureRecognizer(this, props);}

...
declare const flutter: {
    gestures: {
        verticalDragGestureRecognizer: (
            this: void,
            verticalDragGestureRecognizer: IVerticalDragGestureRecognizer,
            props?: {
                debugOwner?: Object | undefined;
                kind?: PointerDeviceKind | undefined;
                supportedDevices?: ISet<PointerDeviceKind> | undefined;
            }
        ) => IVerticalDragGestureRecognizer;
    };
};
export interface IVerticalDragGestureRecognizer {
...
export class VerticalDragGestureRecognizer
    implements
        ...
        >
{
    ...
    public readonly onDown: (details: IDragDownDetails) => void | undefined =
        undefined as any;
    public readonly onStart: (details: IDragStartDetails) => void | undefined =
        undefined as any;
    public readonly onUpdate: (
        details: IDragUpdateDetails
    ) => void | undefined = undefined as any;
    public readonly onEnd: (details: IDragEndDetails) => void | undefined =
        undefined as any;
    ...
    public readonly velocityTrackerBuilder: (
        event: IPointerEvent
    ) => IVelocityTracker = undefined as any;
    ...
    public constructor(props?: {
        ...
        flutter.gestures.verticalDragGestureRecognizer(this, props);
    }
    private readonly _dart_isFlingGesture: (
        estimate: IVelocityEstimate,
        kind: PointerDeviceKind
    ) => boolean = undefined as any;
    private readonly _dart_getDebugDescription: () => string = undefined as any;
    private readonly _dart_isPointerAllowed: (event: IPointerEvent) => boolean =
        undefined as any;

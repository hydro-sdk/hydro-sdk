...
gestures: {
forcePressDetails: (this: void, forcePressDetails: IForcePressDetails, props : {  localPosition? : IOffset | undefined, globalPosition : IOffset, pressure : number,}) => IForcePressDetails
}
};
...
public constructor( props : {  localPosition? : IOffset | undefined, globalPosition : IOffset, pressure : number,}){

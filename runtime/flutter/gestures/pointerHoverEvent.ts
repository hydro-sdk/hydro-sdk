...
import { I_CopyPointerHoverEvent } from "./_copyPointerHoverEvent";
...
gestures: {
pointerHoverEvent: (this: void, pointerHoverEvent: IPointerHoverEvent, props : {  buttons : number, delta : IOffset, device : number, distance : number, distanceMax : number, embedderId : number, kind : PointerDeviceKind, obscured : boolean, orientation : number, pointer : number, position : IOffset, pressureMax : number, pressureMin : number, radiusMajor : number, radiusMax : number, radiusMin : number, radiusMinor : number, size : number, synthesized : boolean, tilt : number, timeStamp : IDuration,}) => IPointerHoverEvent
}
};
export interface IPointerHoverEvent
...
getHashCode: () => number;
 ...
 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerHoverEvent, IDiagnosticable
...
public constructor( props : {  buttons? : number, delta? : IOffset, device? : number, distance? : number, distanceMax? : number, embedderId? : number, kind? : PointerDeviceKind, obscured? : boolean, orientation? : number, pointer? : number, position? : IOffset, pressureMax? : number, pressureMin? : number, radiusMajor? : number, radiusMax? : number, radiusMin? : number, radiusMinor? : number, size? : number, synthesized? : boolean, tilt? : number, timeStamp? : IDuration,}){
flutter.gestures.pointerHoverEvent(this, {
...pointerHoverEventDefaultProps,
...props
});}
    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerHoverEvent = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_toStringFull: () => string = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerHoverEvent = undefined as any;
...
public transformed(transform?: IMatrix4 | undefined) : IPointerHoverEvent {
...
const pointerHoverEventDefaultProps = {
    buttons: 0,
    delta: Offset.zero,
    device: 0,
    distance: 0.0,

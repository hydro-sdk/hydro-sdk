...
gestures: {
velocity: (this: void, velocity: IVelocity, props : {  pixelsPerSecond : IOffset,}) => IVelocity
}
};
...
flutter.gestures.velocity(this, props);}
    private readonly _dart_clampMagnitude: (minValue: number, maxValue: number) => IVelocity = undefined as any;

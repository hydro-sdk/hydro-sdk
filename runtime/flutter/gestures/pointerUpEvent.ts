...
import { I_CopyPointerUpEvent } from "./_copyPointerUpEvent";
...
gestures: {
pointerUpEvent: (this: void, pointerUpEvent: IPointerUpEvent, props : {  buttons : number, device : number, distance : number, distanceMax : number, embedderId : number, kind : PointerDeviceKind, obscured : boolean, orientation : number, pointer : number, position : IOffset, pressure : number, pressureMax : number, pressureMin : number, radiusMajor : number, radiusMax : number, radiusMin : number, radiusMinor : number, size : number, tilt : number, timeStamp : IDuration,}) => IPointerUpEvent
}
};
export interface IPointerUpEvent
...
getHashCode: () => number;
 ...
 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerUpEvent, IDiagnosticable
...
flutter.gestures.pointerUpEvent(this, {
...pointerUpEventDefaultProps,
...props
});}
    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerUpEvent = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_toStringFull: () => string = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, localPosition? : IOffset | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerUpEvent = undefined as any;
...
public transformed(transform?: IMatrix4 | undefined) : IPointerUpEvent {
...
const pointerUpEventDefaultProps = {
    buttons: 0,
    device: 0,
    distance: 0.0,
    distanceMax: 0.0,

...
gestures: {
pointerExitEvent: (this: void, pointerExitEvent: IPointerExitEvent, props : {  buttons : number, delta : IOffset, device : number, distance : number, distanceMax : number, down : boolean, embedderId : number, kind : PointerDeviceKind, obscured : boolean, orientation : number, pointer : number, position : IOffset, pressureMax : number, pressureMin : number, radiusMajor : number, radiusMax : number, radiusMin : number, radiusMinor : number, size : number, synthesized : boolean, tilt : number, timeStamp : IDuration,}) => IPointerExitEvent;
pointerExitEventFromMouseEvent: (event: IPointerEvent) => IPointerExitEvent
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerExitEvent, IDiagnosticable

...
gestures: {
doubleTapGestureRecognizer: (this: void, doubleTapGestureRecognizer: IDoubleTapGestureRecognizer, props? : {  debugOwner? : Object | undefined, kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => IDoubleTapGestureRecognizer
}
};
export interface IDoubleTapGestureRecognizer
...
getHashCode: () => number;
}export class DoubleTapGestureRecognizer
...
flutter.gestures.doubleTapGestureRecognizer(this, props);}

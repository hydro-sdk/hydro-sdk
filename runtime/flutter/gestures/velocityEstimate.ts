...
gestures: {
velocityEstimate: (this: void, velocityEstimate: IVelocityEstimate, props : {  confidence : number, duration : IDuration, offset : IOffset, pixelsPerSecond : IOffset,}) => IVelocityEstimate
}
};
...
public constructor( props : {  confidence : number, duration : IDuration, offset : IOffset, pixelsPerSecond : IOffset,}){

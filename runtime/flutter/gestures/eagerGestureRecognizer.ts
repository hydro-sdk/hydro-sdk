...
gestures: {
eagerGestureRecognizer: (this: void, eagerGestureRecognizer: IEagerGestureRecognizer, props? : {  kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => IEagerGestureRecognizer
}
};
export interface IEagerGestureRecognizer
...
getHashCode: () => number;
}export class EagerGestureRecognizer
...
public constructor( props? : {  kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}){
flutter.gestures.eagerGestureRecognizer(this, props);}

...
import { IPointerHoverEvent } from "./pointerHoverEvent";
...
gestures: {
_transformedPointerHoverEvent: (this: void, _transformedPointerHoverEvent: I_TransformedPointerHoverEvent, original: IPointerHoverEvent, transform: IMatrix4) => I_TransformedPointerHoverEvent
}
};
export interface I_TransformedPointerHoverEvent


{
original: IPointerHoverEvent;
transform: IMatrix4;
...
}export class _TransformedPointerHoverEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerHoverEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerHoverEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerHoverEvent = undefined as any;
...
public constructor(original: IPointerHoverEvent, transform: IMatrix4){
flutter.gestures._transformedPointerHoverEvent(this, original, transform);}

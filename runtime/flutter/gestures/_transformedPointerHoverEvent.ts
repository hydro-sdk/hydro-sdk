...
declare const flutter: {
    gestures: {
        _transformedPointerHoverEvent: (
            this: void,
            _transformedPointerHoverEvent: I_TransformedPointerHoverEvent,
            original: IPointerHoverEvent,
            transform: IMatrix4
        ) => I_TransformedPointerHoverEvent;
    };
};
...
export class _TransformedPointerHoverEvent
    implements
        ...
        I_CopyPointerHoverEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerHoverEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerHoverEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerHoverEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerHoverEvent = undefined as any;

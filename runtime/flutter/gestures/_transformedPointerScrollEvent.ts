...
declare const flutter: {
    gestures: {
        _transformedPointerScrollEvent: (
            this: void,
            _transformedPointerScrollEvent: I_TransformedPointerScrollEvent,
            original: IPointerScrollEvent,
            transform: IMatrix4
        ) => I_TransformedPointerScrollEvent;
    };
};
...
export class _TransformedPointerScrollEvent
    implements
        ...
        Omit<IPointerScrollEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerScrollEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerScrollEvent(
            this,
            original,
            transform
        );

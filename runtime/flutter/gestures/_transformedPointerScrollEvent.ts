...
gestures: {
_transformedPointerScrollEvent: (this: void, _transformedPointerScrollEvent: I_TransformedPointerScrollEvent, original: IPointerScrollEvent, transform: IMatrix4) => I_TransformedPointerScrollEvent
}
};
export interface I_TransformedPointerScrollEvent


{
original: IPointerScrollEvent;
transform: IMatrix4;
...
}export class _TransformedPointerScrollEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerScrollEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerScrollEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerScrollEvent = undefined as any;
...
public constructor(original: IPointerScrollEvent, transform: IMatrix4){
flutter.gestures._transformedPointerScrollEvent(this, original, transform);}
    private readonly _dart_getScrollDelta: () => IOffset = undefined as any;
    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerScrollEvent = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerScrollEvent = undefined as any;

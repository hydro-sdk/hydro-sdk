...
gestures: {
longPressStartDetails: (this: void, longPressStartDetails: ILongPressStartDetails, props : {  globalPosition : IOffset, localPosition? : IOffset | undefined,}) => ILongPressStartDetails
}
};
...
public constructor( props : {  globalPosition? : IOffset, localPosition? : IOffset | undefined,}){

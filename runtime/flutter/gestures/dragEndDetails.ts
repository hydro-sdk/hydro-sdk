...
gestures: {
dragEndDetails: (this: void, dragEndDetails: IDragEndDetails, props : {  primaryVelocity? : number | undefined, velocity : IVelocity,}) => IDragEndDetails
}
};
...
public constructor( props : {  primaryVelocity? : number | undefined, velocity? : IVelocity,}){

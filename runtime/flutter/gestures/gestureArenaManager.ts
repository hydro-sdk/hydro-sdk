...
declare const flutter: {
    gestures: {
        gestureArenaManager: (
            this: void,
            gestureArenaManager: IGestureArenaManager
        ) => IGestureArenaManager;
    };
};
...
export class GestureArenaManager {
    ...
    private readonly _dart_add: (
        pointer: number,
        member: IGestureArenaMember
    ) => IGestureArenaEntry = undefined as any;
    ...
    private readonly _dart_release: (pointer: number) => void =
        undefined as any;
    public add(
        pointer: number,
        member: IGestureArenaMember

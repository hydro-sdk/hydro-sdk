...
declare const flutter: {
    gestures: {
        _transformedPointerDownEvent: (
            this: void,
            _transformedPointerDownEvent: I_TransformedPointerDownEvent,
            original: IPointerDownEvent,
            transform: IMatrix4
        ) => I_TransformedPointerDownEvent;
    };
};
...
export class _TransformedPointerDownEvent
    implements
        ...
        I_CopyPointerDownEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerDownEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerDownEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerDownEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerDownEvent = undefined as any;

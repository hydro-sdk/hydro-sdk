...
gestures: {
_transformedPointerDownEvent: (this: void, _transformedPointerDownEvent: I_TransformedPointerDownEvent, original: IPointerDownEvent, transform: IMatrix4) => I_TransformedPointerDownEvent
}
};
export interface I_TransformedPointerDownEvent


{
original: IPointerDownEvent;
transform: IMatrix4;
...
}export class _TransformedPointerDownEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerDownEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerDownEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerDownEvent = undefined as any;
...
public constructor(original: IPointerDownEvent, transform: IMatrix4){
flutter.gestures._transformedPointerDownEvent(this, original, transform);}

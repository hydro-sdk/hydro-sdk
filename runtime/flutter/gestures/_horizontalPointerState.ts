...
export class _HorizontalPointerState implements IMultiDragPointerState {
    ...
    public constructor(
        ...
        flutter.gestures._horizontalPointerState(
            this,
            initialPosition,
            kind,

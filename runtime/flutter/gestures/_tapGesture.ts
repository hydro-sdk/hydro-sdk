...
export class _TapGesture implements I_TapTracker {
    public readonly gestureRecognizer: IMultiTapGestureRecognizer =
        undefined as any;
    ...
    private readonly _dart_handleEvent: (event: IPointerEvent) => void =
        undefined as any;
    private readonly _dart_stopTrackingPointer: (
        route: (event: IPointerEvent) => void
    ...
    private readonly _dart_isWithinGlobalTolerance: (
        event: IPointerEvent,
        tolerance: number
    ) => boolean = undefined as any;
    private readonly _dart_hasElapsedMinTime: () => boolean = undefined as any;
    private readonly _dart_hasSameButton: (
    ...
    public isWithinGlobalTolerance(
        event: IPointerEvent,
        tolerance: number
    ): boolean {

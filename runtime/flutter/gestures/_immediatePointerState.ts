...
export class _ImmediatePointerState implements IMultiDragPointerState {
    ...
    public constructor(
        ...
        flutter.gestures._immediatePointerState(
            this,
            initialPosition,
            kind,

...
gestures: {
_immediatePointerState: (this: void, _immediatePointerState: I_ImmediatePointerState, initialPosition: IOffset, kind: PointerDeviceKind, deviceGestureSettings?: IDeviceGestureSettings | undefined) => I_ImmediatePointerState
}
};
export interface I_ImmediatePointerState
...
toString: () => string;
getHashCode: () => number;
}export class _ImmediatePointerState
...
flutter.gestures._immediatePointerState(this, initialPosition, kind, deviceGestureSettings);}

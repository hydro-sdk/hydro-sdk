...
gestures: {
horizontalMultiDragGestureRecognizer: (this: void, horizontalMultiDragGestureRecognizer: IHorizontalMultiDragGestureRecognizer, props? : {  debugOwner? : Object | undefined, kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => IHorizontalMultiDragGestureRecognizer
}
};
export interface IHorizontalMultiDragGestureRecognizer
...
getHashCode: () => number;
}export class HorizontalMultiDragGestureRecognizer

 implements IMultiDragGestureRecognizer, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public readonly onStart: (position: IOffset) => IDrag | undefined | undefined = undefined as any;
...
flutter.gestures.horizontalMultiDragGestureRecognizer(this, props);}
    private readonly _dart_createNewPointerState: (event: IPointerDownEvent) => IMultiDragPointerState = undefined as any;
...
public createNewPointerState(event: IPointerDownEvent) : IMultiDragPointerState {

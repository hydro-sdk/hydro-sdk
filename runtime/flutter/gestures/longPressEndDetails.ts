...
gestures: {
longPressEndDetails: (this: void, longPressEndDetails: ILongPressEndDetails, props : {  globalPosition : IOffset, localPosition? : IOffset | undefined, velocity : IVelocity,}) => ILongPressEndDetails
}
};
...
public constructor( props : {  globalPosition? : IOffset, localPosition? : IOffset | undefined, velocity? : IVelocity,}){

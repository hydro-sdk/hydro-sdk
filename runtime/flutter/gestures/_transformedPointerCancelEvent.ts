...
gestures: {
_transformedPointerCancelEvent: (this: void, _transformedPointerCancelEvent: I_TransformedPointerCancelEvent, original: IPointerCancelEvent, transform: IMatrix4) => I_TransformedPointerCancelEvent
}
};
export interface I_TransformedPointerCancelEvent


{
original: IPointerCancelEvent;
transform: IMatrix4;
...
}export class _TransformedPointerCancelEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerCancelEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerCancelEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerCancelEvent = undefined as any;
...
public constructor(original: IPointerCancelEvent, transform: IMatrix4){
flutter.gestures._transformedPointerCancelEvent(this, original, transform);}

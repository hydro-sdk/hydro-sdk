...
declare const flutter: {
    gestures: {
        _transformedPointerCancelEvent: (
            this: void,
            _transformedPointerCancelEvent: I_TransformedPointerCancelEvent,
            original: IPointerCancelEvent,
            transform: IMatrix4
        ) => I_TransformedPointerCancelEvent;
    };
};
...
export class _TransformedPointerCancelEvent
    implements
        ...
        I_CopyPointerCancelEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerCancelEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerCancelEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerCancelEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerCancelEvent = undefined as any;

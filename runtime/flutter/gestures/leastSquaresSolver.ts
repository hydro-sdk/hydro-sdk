...
gestures: {
leastSquaresSolver: (this: void, leastSquaresSolver: ILeastSquaresSolver, x: IList<number>, y: IList<number>, w: IList<number>) => ILeastSquaresSolver
}
};
...
flutter.gestures.leastSquaresSolver(this, x, y, w);}
    private readonly _dart_solve: (degree: number) => IPolynomialFit | undefined = undefined as any;

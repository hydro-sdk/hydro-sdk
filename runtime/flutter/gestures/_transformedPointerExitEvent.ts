...
declare const flutter: {
    gestures: {
        _transformedPointerExitEvent: (
            this: void,
            _transformedPointerExitEvent: I_TransformedPointerExitEvent,
            original: IPointerExitEvent,
            transform: IMatrix4
        ) => I_TransformedPointerExitEvent;
    };
};
...
export class _TransformedPointerExitEvent
    implements
        ...
        Omit<IPointerExitEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerExitEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerExitEvent(
            this,
            original,
            transform
        );

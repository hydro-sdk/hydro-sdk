...
import { IPointerExitEvent } from "./pointerExitEvent";
...
gestures: {
_transformedPointerExitEvent: (this: void, _transformedPointerExitEvent: I_TransformedPointerExitEvent, original: IPointerExitEvent, transform: IMatrix4) => I_TransformedPointerExitEvent
}
};
export interface I_TransformedPointerExitEvent


{
original: IPointerExitEvent;
transform: IMatrix4;
...
}export class _TransformedPointerExitEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerExitEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerExitEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerExitEvent = undefined as any;
...
public constructor(original: IPointerExitEvent, transform: IMatrix4){
flutter.gestures._transformedPointerExitEvent(this, original, transform);}
    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerExitEvent = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerExitEvent = undefined as any;

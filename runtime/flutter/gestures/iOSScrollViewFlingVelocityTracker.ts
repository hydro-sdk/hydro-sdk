...
declare const flutter: {
    gestures: {
        iOSScrollViewFlingVelocityTracker: (
            this: void,
            iOSScrollViewFlingVelocityTracker: IIOSScrollViewFlingVelocityTracker,
            kind: PointerDeviceKind
        ) => IIOSScrollViewFlingVelocityTracker;
    };
};
...
export class IOSScrollViewFlingVelocityTracker implements IVelocityTracker {
    ...
    private readonly _dart_getVelocityEstimate: () => IVelocityEstimate =
        undefined as any;

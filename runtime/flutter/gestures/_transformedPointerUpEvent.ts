...
gestures: {
_transformedPointerUpEvent: (this: void, _transformedPointerUpEvent: I_TransformedPointerUpEvent, original: IPointerUpEvent, transform: IMatrix4) => I_TransformedPointerUpEvent
}
};
export interface I_TransformedPointerUpEvent


{
original: IPointerUpEvent;
transform: IMatrix4;
...
}export class _TransformedPointerUpEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerUpEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerUpEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerUpEvent = undefined as any;
...
public constructor(original: IPointerUpEvent, transform: IMatrix4){
flutter.gestures._transformedPointerUpEvent(this, original, transform);}

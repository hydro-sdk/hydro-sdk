...
declare const flutter: {
    gestures: {
        _transformedPointerUpEvent: (
            this: void,
            _transformedPointerUpEvent: I_TransformedPointerUpEvent,
            original: IPointerUpEvent,
            transform: IMatrix4
        ) => I_TransformedPointerUpEvent;
    };
};
...
export class _TransformedPointerUpEvent
    implements
        ...
        I_CopyPointerUpEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerUpEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    ) => IPointerUpEvent = undefined as any;

...
gestures: {
serialTapUpDetails: (this: void, serialTapUpDetails: ISerialTapUpDetails, props : {  count : number, globalPosition : IOffset, kind? : PointerDeviceKind | undefined, localPosition? : IOffset | undefined,}) => ISerialTapUpDetails
}
};
...
public constructor( props : {  count? : number, globalPosition? : IOffset, kind? : PointerDeviceKind | undefined, localPosition? : IOffset | undefined,}){

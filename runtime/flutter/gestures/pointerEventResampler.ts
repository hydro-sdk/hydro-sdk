...
gestures: {
pointerEventResampler: (this: void, pointerEventResampler: IPointerEventResampler) => IPointerEventResampler
}
};
...
sample: (sampleTime: IDuration, nextSampleTime: IDuration, callback : (event: IPointerEvent) => void) => void;
...
flutter.gestures.pointerEventResampler(this);}
    private readonly _dart_addEvent: (event: IPointerEvent) => void = undefined as any;
    private readonly _dart_sample: (sampleTime: IDuration, nextSampleTime: IDuration, callback : (event: IPointerEvent) => void) => void = undefined as any;
    private readonly _dart_stop: (callback : (event: IPointerEvent) => void) => void = undefined as any;
    private readonly _dart_getHasPendingEvents: () => boolean = undefined as any;
...
public sample(sampleTime: IDuration, nextSampleTime: IDuration, callback : (event: IPointerEvent) => void) : void {

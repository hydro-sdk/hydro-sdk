...
gestures: {
_verticalPointerState: (this: void, _verticalPointerState: I_VerticalPointerState, initialPosition: IOffset, kind: PointerDeviceKind, deviceGestureSettings?: IDeviceGestureSettings | undefined) => I_VerticalPointerState
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _VerticalPointerState
...
flutter.gestures._verticalPointerState(this, initialPosition, kind, deviceGestureSettings);}

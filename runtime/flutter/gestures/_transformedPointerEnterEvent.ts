...
import { IPointerEnterEvent } from "./pointerEnterEvent";
...
gestures: {
_transformedPointerEnterEvent: (this: void, _transformedPointerEnterEvent: I_TransformedPointerEnterEvent, original: IPointerEnterEvent, transform: IMatrix4) => I_TransformedPointerEnterEvent
}
};
export interface I_TransformedPointerEnterEvent


{
original: IPointerEnterEvent;
transform: IMatrix4;
...
}export class _TransformedPointerEnterEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerEnterEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerEnterEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerEnterEvent = undefined as any;
...
public constructor(original: IPointerEnterEvent, transform: IMatrix4){
flutter.gestures._transformedPointerEnterEvent(this, original, transform);}

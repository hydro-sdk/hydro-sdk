...
declare const flutter: {
    gestures: {
        _transformedPointerEnterEvent: (
            this: void,
            _transformedPointerEnterEvent: I_TransformedPointerEnterEvent,
            original: IPointerEnterEvent,
            transform: IMatrix4
        ) => I_TransformedPointerEnterEvent;
    };
};
...
export class _TransformedPointerEnterEvent
    implements
        ...
        I_CopyPointerEnterEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerEnterEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerEnterEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerEnterEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerEnterEvent = undefined as any;

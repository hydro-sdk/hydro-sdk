...
gestures: {
dragGestureRecognizer: (this: void, dragGestureRecognizer: IDragGestureRecognizer, props : {  debugOwner? : Object | undefined, dragStartBehavior : DragStartBehavior, kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined, velocityTrackerBuilder : (event: IPointerEvent) => IVelocityTracker,}) => IDragGestureRecognizer
}
};
...
public constructor( props : {  debugOwner? : Object | undefined, dragStartBehavior? : DragStartBehavior, kind? : PointerDeviceKind | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined, velocityTrackerBuilder : (event: IPointerEvent) => IVelocityTracker,}){
flutter.gestures.dragGestureRecognizer(this, {
...dragGestureRecognizerDefaultProps,
...props
});}
...
const dragGestureRecognizerDefaultProps = {

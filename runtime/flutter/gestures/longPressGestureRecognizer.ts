...
import { IPrimaryPointerGestureRecognizer } from "./primaryPointerGestureRecognizer";
...
gestures: {
longPressGestureRecognizer: (this: void, longPressGestureRecognizer: ILongPressGestureRecognizer, props? : {  debugOwner? : Object | undefined, duration? : IDuration | undefined, kind? : PointerDeviceKind | undefined, postAcceptSlopTolerance? : number | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}) => ILongPressGestureRecognizer
}
};
export interface ILongPressGestureRecognizer
...
getHashCode: () => number;
}export class LongPressGestureRecognizer

 implements IPrimaryPointerGestureRecognizer, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props? : {  debugOwner? : Object | undefined, duration? : IDuration | undefined, kind? : PointerDeviceKind | undefined, postAcceptSlopTolerance? : number | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined,}){
flutter.gestures.longPressGestureRecognizer(this, props);}

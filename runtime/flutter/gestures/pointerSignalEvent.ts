...
gestures: {
pointerSignalEvent: (this: void, pointerSignalEvent: IPointerSignalEvent, props : {  device : number, embedderId : number, kind : PointerDeviceKind, pointer : number, position : IOffset, timeStamp : IDuration,}) => IPointerSignalEvent
}
};
...
public constructor( props : {  device? : number, embedderId? : number, kind? : PointerDeviceKind, pointer? : number, position? : IOffset, timeStamp? : IDuration,}){

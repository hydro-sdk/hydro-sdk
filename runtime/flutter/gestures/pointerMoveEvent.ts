...
gestures: {
pointerMoveEvent: (this: void, pointerMoveEvent: IPointerMoveEvent, props : {  buttons : number, delta : IOffset, device : number, distanceMax : number, embedderId : number, kind : PointerDeviceKind, obscured : boolean, orientation : number, platformData : number, pointer : number, position : IOffset, pressure : number, pressureMax : number, pressureMin : number, radiusMajor : number, radiusMax : number, radiusMin : number, radiusMinor : number, size : number, synthesized : boolean, tilt : number, timeStamp : IDuration,}) => IPointerMoveEvent
}
};
export interface IPointerMoveEvent
...
getHashCode: () => number;
 ...
 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerMoveEvent, IDiagnosticable
...
public constructor( props : {  buttons : number, delta? : IOffset, device? : number, distanceMax? : number, embedderId? : number, kind? : PointerDeviceKind, obscured? : boolean, orientation? : number, platformData? : number, pointer? : number, position? : IOffset, pressure? : number, pressureMax? : number, pressureMin? : number, radiusMajor? : number, radiusMax? : number, radiusMin? : number, radiusMinor? : number, size? : number, synthesized? : boolean, tilt? : number, timeStamp? : IDuration,}){
flutter.gestures.pointerMoveEvent(this, {
...pointerMoveEventDefaultProps,
...props
});}
...
const pointerMoveEventDefaultProps = {
    delta: Offset.zero,
    device: 0,
    distanceMax: 0.0,
    embedderId: 0,

...
gestures: {
deviceGestureSettings: (this: void, deviceGestureSettings: IDeviceGestureSettings, props? : {  touchSlop? : number | undefined,}) => IDeviceGestureSettings;
deviceGestureSettingsFromWindow: (window: ISingletonFlutterWindow) => IDeviceGestureSettings
}
};
...
public static fromWindow(window: ISingletonFlutterWindow) : IDeviceGestureSettings{
return flutter.gestures.deviceGestureSettingsFromWindow(window);
}    private readonly _dart_getPanSlop: () => number | undefined = undefined as any;

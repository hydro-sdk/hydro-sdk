...
gestures: {
_combiningGestureArenaEntry: (this: void, _combiningGestureArenaEntry: I_CombiningGestureArenaEntry, _combiner: I_CombiningGestureArenaMember, _member: IGestureArenaMember) => I_CombiningGestureArenaEntry
}
};
...
}export class _CombiningGestureArenaEntry

 implements IGestureArenaEntry
{public constructor(_combiner: I_CombiningGestureArenaMember, _member: IGestureArenaMember){

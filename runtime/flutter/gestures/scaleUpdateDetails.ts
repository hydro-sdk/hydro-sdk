...
gestures: {
scaleUpdateDetails: (this: void, scaleUpdateDetails: IScaleUpdateDetails, props : {  focalPoint : IOffset, focalPointDelta : IOffset, horizontalScale : number, localFocalPoint? : IOffset | undefined, pointerCount : number, rotation : number, scale : number, verticalScale : number,}) => IScaleUpdateDetails
}
};
...
public constructor( props : {  focalPoint? : IOffset, focalPointDelta? : IOffset, horizontalScale? : number, localFocalPoint? : IOffset | undefined, pointerCount? : number, rotation? : number, scale? : number, verticalScale? : number,}){

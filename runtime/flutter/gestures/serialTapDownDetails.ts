...
gestures: {
serialTapDownDetails: (this: void, serialTapDownDetails: ISerialTapDownDetails, props : {  buttons : number, count : number, globalPosition : IOffset, localPosition? : IOffset | undefined, kind : PointerDeviceKind,}) => ISerialTapDownDetails
}
};
...
public constructor( props : {  buttons? : number, count? : number, globalPosition? : IOffset, localPosition? : IOffset | undefined, kind : PointerDeviceKind,}){

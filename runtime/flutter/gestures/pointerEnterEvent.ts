...
import { I_CopyPointerEnterEvent } from "./_copyPointerEnterEvent";
...
gestures: {
pointerEnterEvent: (this: void, pointerEnterEvent: IPointerEnterEvent, props : {  buttons : number, delta : IOffset, device : number, distance : number, distanceMax : number, down : boolean, embedderId : number, kind : PointerDeviceKind, obscured : boolean, orientation : number, pointer : number, position : IOffset, pressureMax : number, pressureMin : number, radiusMajor : number, radiusMax : number, radiusMin : number, radiusMinor : number, size : number, synthesized : boolean, tilt : number, timeStamp : IDuration,}) => IPointerEnterEvent;
pointerEnterEventFromMouseEvent: (event: IPointerEvent) => IPointerEnterEvent
}
};
export interface IPointerEnterEvent
...
getHashCode: () => number;
 ...
 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerEnterEvent, IDiagnosticable
...
public constructor( props : {  buttons? : number, delta? : IOffset, device? : number, distance? : number, distanceMax? : number, down? : boolean, embedderId? : number, kind? : PointerDeviceKind, obscured? : boolean, orientation? : number, pointer? : number, position? : IOffset, pressureMax? : number, pressureMin? : number, radiusMajor? : number, radiusMax? : number, radiusMin? : number, radiusMinor? : number, size? : number, synthesized? : boolean, tilt? : number, timeStamp? : IDuration,}){
flutter.gestures.pointerEnterEvent(this, {
...pointerEnterEventDefaultProps,
...props
});}
public static fromMouseEvent(event: IPointerEvent) : IPointerEnterEvent{
return flutter.gestures.pointerEnterEventFromMouseEvent(event);
}    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerEnterEvent = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_toStringFull: () => string = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerEnterEvent = undefined as any;
...
public transformed(transform?: IMatrix4 | undefined) : IPointerEnterEvent {
...
const pointerEnterEventDefaultProps = {
    buttons: 0,
    delta: Offset.zero,
    device: 0,
    distance: 0.0,

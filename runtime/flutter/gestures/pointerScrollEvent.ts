...
gestures: {
pointerScrollEvent: (this: void, pointerScrollEvent: IPointerScrollEvent, props : {  device : number, embedderId : number, kind : PointerDeviceKind, position : IOffset, scrollDelta : IOffset, timeStamp : IDuration,}) => IPointerScrollEvent
}
};
...
getHashCode: () => number;
 ...
 implements IPointerSignalEvent, I_PointerEventDescription, I_CopyPointerScrollEvent, IDiagnosticable
...
public constructor( props : {  device? : number, embedderId? : number, kind? : PointerDeviceKind, position? : IOffset, scrollDelta? : IOffset, timeStamp? : IDuration,}){

...
export class _DelayedPointerState implements IMultiDragPointerState {
    ...
    public constructor(
        ...
        flutter.gestures._delayedPointerState(
            this,
            initialPosition,
            delay,
            kind,

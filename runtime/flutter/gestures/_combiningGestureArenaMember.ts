...
declare const flutter: {
    gestures: {
        _combiningGestureArenaMember: (
            this: void,
            _combiningGestureArenaMember: I_CombiningGestureArenaMember,
            _owner: IGestureArenaTeam,
            _pointer: number
        ) => I_CombiningGestureArenaMember;
    };
};
...
export class _CombiningGestureArenaMember implements IGestureArenaMember {

...
gestures: {
pointerRemovedEvent: (this: void, pointerRemovedEvent: IPointerRemovedEvent, props : {  device : number, distanceMax : number, embedderId : number, kind : PointerDeviceKind, obscured : boolean, original? : IPointerRemovedEvent | undefined, pointer : number, position : IOffset, pressureMax : number, pressureMin : number, radiusMax : number, radiusMin : number, timeStamp : IDuration,}) => IPointerRemovedEvent
}
};
export interface IPointerRemovedEvent
...
getHashCode: () => number;
}export class PointerRemovedEvent

 implements Omit<IPointerEvent, "debugFillProperties" | "copyWith">, I_PointerEventDescription, I_CopyPointerRemovedEvent, IDiagnosticable
...
public constructor( props : {  device? : number, distanceMax? : number, embedderId? : number, kind? : PointerDeviceKind, obscured? : boolean, original? : IPointerRemovedEvent | undefined, pointer? : number, position? : IOffset, pressureMax? : number, pressureMin? : number, radiusMax? : number, radiusMin? : number, timeStamp? : IDuration,}){
flutter.gestures.pointerRemovedEvent(this, {
...pointerRemovedEventDefaultProps,
...props
});}
    private readonly _dart_transformed: (transform?: IMatrix4 | undefined) => IPointerRemovedEvent = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_toStringFull: () => string = undefined as any;
    private readonly _dart_copyWith: ( props? : {  buttons? : number | undefined, delta? : IOffset | undefined, device? : number | undefined, distance? : number | undefined, distanceMax? : number | undefined, embedderId? : number | undefined, kind? : PointerDeviceKind | undefined, obscured? : boolean | undefined, orientation? : number | undefined, pointer? : number | undefined, position? : IOffset | undefined, pressure? : number | undefined, pressureMax? : number | undefined, pressureMin? : number | undefined, radiusMajor? : number | undefined, radiusMax? : number | undefined, radiusMin? : number | undefined, radiusMinor? : number | undefined, size? : number | undefined, synthesized? : boolean | undefined, tilt? : number | undefined, timeStamp? : IDuration | undefined,}) => IPointerRemovedEvent = undefined as any;
...
const pointerRemovedEventDefaultProps = {
    device: 0,
    distanceMax: 0.0,
    embedderId: 0,

...
declare const flutter: {
    gestures: {
        _transformedPointerAddedEvent: (
            this: void,
            _transformedPointerAddedEvent: I_TransformedPointerAddedEvent,
            original: IPointerAddedEvent,
            transform: IMatrix4
        ) => I_TransformedPointerAddedEvent;
    };
};
...
export class _TransformedPointerAddedEvent
    implements
        ...
        I_CopyPointerAddedEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerAddedEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerAddedEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerAddedEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerAddedEvent = undefined as any;

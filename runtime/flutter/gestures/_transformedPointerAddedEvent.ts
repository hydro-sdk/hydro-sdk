...
import { IPointerAddedEvent } from "./pointerAddedEvent";
...
gestures: {
_transformedPointerAddedEvent: (this: void, _transformedPointerAddedEvent: I_TransformedPointerAddedEvent, original: IPointerAddedEvent, transform: IMatrix4) => I_TransformedPointerAddedEvent
}
};
export interface I_TransformedPointerAddedEvent


{
original: IPointerAddedEvent;
transform: IMatrix4;
...
}export class _TransformedPointerAddedEvent

 implements Omit<I_TransformedPointerEvent, "copyWith" | "debugFillProperties">, I_CopyPointerAddedEvent, IDiagnosticable, I_PointerEventDescription, Omit<IPointerAddedEvent, "debugFillProperties">, Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{    public readonly original: IPointerAddedEvent = undefined as any;
...
public constructor(original: IPointerAddedEvent, transform: IMatrix4){
flutter.gestures._transformedPointerAddedEvent(this, original, transform);}

...
declare const flutter: {
    gestures: {
        _transformedPointerMoveEvent: (
            this: void,
            _transformedPointerMoveEvent: I_TransformedPointerMoveEvent,
            original: IPointerMoveEvent,
            transform: IMatrix4
        ) => I_TransformedPointerMoveEvent;
    };
};
...
export class _TransformedPointerMoveEvent
    implements
        ...
        I_CopyPointerMoveEvent,
        IDiagnosticable,
        I_PointerEventDescription,
        Omit<IPointerMoveEvent, "debugFillProperties">,
        Omit<IPointerEvent, "copyWith" | "debugFillProperties">
{
    ...
    public constructor(original: IPointerMoveEvent, transform: IMatrix4) {
        flutter.gestures._transformedPointerMoveEvent(
            this,
            original,
            transform
        );
    ...
    ) => IPointerMoveEvent = undefined as any;

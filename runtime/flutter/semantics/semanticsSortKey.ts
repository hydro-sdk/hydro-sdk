...
semantics: {
semanticsSortKey: (this: void, semanticsSortKey: ISemanticsSortKey, props? : {  name? : string | undefined,}) => ISemanticsSortKey
}
};
...
flutter.semantics.semanticsSortKey(this, props);}
    private readonly _dart_compareTo: (other: ISemanticsSortKey) => number = undefined as any;

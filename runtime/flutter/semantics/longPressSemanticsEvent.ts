...
declare const flutter: {
    semantics: {
        longPressSemanticsEvent: (
            this: void,
            longPressSemanticsEvent: ILongPressSemanticsEvent
        ) => ILongPressSemanticsEvent;
    };
};
export interface ILongPressSemanticsEvent {
    type: string;
...
export class LongPressSemanticsEvent implements ISemanticsEvent {
    public readonly type: string = undefined as any;
    public constructor() {
        flutter.semantics.longPressSemanticsEvent(this);
    }

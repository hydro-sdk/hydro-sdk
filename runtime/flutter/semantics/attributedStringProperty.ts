...
declare const flutter: {
    semantics: {
        attributedStringProperty: (
            this: void,
            attributedStringProperty: IAttributedStringProperty,
            name: string,
        ...
        ) => IAttributedStringProperty;
    };
};
export interface IAttributedStringProperty {
    showWhenEmpty: boolean;
    ...
    getValue: () => IAttributedString | undefined;
...
export class AttributedStringProperty
    implements IDiagnosticsProperty<IAttributedString>
{
    public readonly showWhenEmpty: boolean = undefined as any;
    ...
    public constructor(
        ...
        flutter.semantics.attributedStringProperty(this, name, value, {
            ...attributedStringPropertyDefaultProps,
            ...props,
        });
    }
    ...
    private readonly _dart_getValue: () => IAttributedString | undefined =
        undefined as any;
    ...
    public getValue(): IAttributedString | undefined {
...
const attributedStringPropertyDefaultProps = {

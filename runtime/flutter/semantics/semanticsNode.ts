...
declare const flutter: {
    semantics: {
        semanticsNode: (
            this: void,
            semanticsNode: ISemanticsNode,
            props?: {
                key?: IKey | undefined;
                showOnScreen?: () => void | undefined;
            }
        ) => ISemanticsNode;
    };
};
export interface ISemanticsNode {
    ...
    updateWith: (props?: {
        childrenInInversePaintOrder?: IList<ISemanticsNode> | undefined;
        config?: ISemanticsConfiguration | undefined;
    }) => void;
    ...
    debugDescribeChildren: (props: {
        childOrder: DebugSemanticsDumpOrder;
    }) => IList<IDiagnosticsNode>;
    debugListChildrenInOrder: (
        childOrder: DebugSemanticsDumpOrder
    ) => IList<ISemanticsNode>;
        ...
        >
{
    ...
    private readonly _dart_getIsMergedIntoParent: () => boolean =
        undefined as any;
    private readonly _dart_setIsMergedIntoParent: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsPartOfNodeMerging: () => boolean =
        undefined as any;
    private readonly _dart_getMergeAllDescendantsIntoThisNode: () => boolean =
        undefined as any;
    ...
    private readonly _dart_visitChildren: (
        visitor: (node: ISemanticsNode) => boolean
    ) => void = undefined as any;
    private readonly _dart_getOwner: () => ISemanticsOwner | undefined =
        undefined as any;
    private readonly _dart_getParent: () => ISemanticsNode | undefined =
        undefined as any;
    ...
    private readonly _dart_isTagged: (tag: ISemanticsTag) => boolean =
        undefined as any;
    ...
    private readonly _dart_getTextSelection: () => ITextSelection | undefined =
        undefined as any;
    private readonly _dart_getIsMultiline: () => boolean | undefined =
        undefined as any;
    ...
    private readonly _dart_getCurrentValueLength: () => number | undefined =
        undefined as any;
    private readonly _dart_updateWith: (props?: {
        childrenInInversePaintOrder?: IList<ISemanticsNode> | undefined;
        config?: ISemanticsConfiguration | undefined;
    }) => void = undefined as any;
    private readonly _dart_getSemanticsData: () => ISemanticsData =
        undefined as any;
    private readonly _dart_sendEvent: (event: ISemanticsEvent) => void =
        undefined as any;
    ...
    private readonly _dart_debugDescribeChildren: (props: {
        childOrder: DebugSemanticsDumpOrder;
    }) => IList<IDiagnosticsNode> = undefined as any;
    private readonly _dart_debugListChildrenInOrder: (
        childOrder: DebugSemanticsDumpOrder
    ) => IList<ISemanticsNode> = undefined as any;
    ...
    public debugDescribeChildren(props: {
        childOrder?: DebugSemanticsDumpOrder;
    }): IList<IDiagnosticsNode> {
    ...
    public debugListChildrenInOrder(
        childOrder: DebugSemanticsDumpOrder
    ): IList<ISemanticsNode> {

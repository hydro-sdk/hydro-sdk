...
semantics: {
semanticsData: (this: void, semanticsData: ISemanticsData, props : {  customSemanticsActionIds? : IList<number> | undefined, tags? : ISet<ISemanticsTag> | undefined, transform? : IMatrix4 | undefined, actions : number, attributedDecreasedValue : IAttributedString, attributedHint : IAttributedString, attributedIncreasedValue : IAttributedString, attributedLabel : IAttributedString, attributedValue : IAttributedString, currentValueLength? : number | undefined, elevation : number, flags : number, maxValueLength? : number | undefined, platformViewId? : number | undefined, rect : IRect, scrollChildCount? : number | undefined, scrollExtentMax? : number | undefined, scrollExtentMin? : number | undefined, scrollIndex? : number | undefined, scrollPosition? : number | undefined, textDirection? : TextDirection | undefined, textSelection? : ITextSelection | undefined, thickness : number,}) => ISemanticsData
}
};
...
{    public readonly flags: number = undefined as any;
    ...
    public readonly attributedIncreasedValue: IAttributedString = undefined as any;
    public readonly attributedDecreasedValue: IAttributedString = undefined as any;
    ...
    public readonly textSelection: ITextSelection | undefined = undefined as any;
    ...
    public readonly customSemanticsActionIds: IList<number> | undefined = undefined as any;
public constructor( props : {  customSemanticsActionIds? : IList<number> | undefined, tags? : ISet<ISemanticsTag> | undefined, transform? : IMatrix4 | undefined, actions : number, attributedDecreasedValue : IAttributedString, attributedHint : IAttributedString, attributedIncreasedValue : IAttributedString, attributedLabel : IAttributedString, attributedValue : IAttributedString, currentValueLength? : number | undefined, elevation : number, flags : number, maxValueLength? : number | undefined, platformViewId? : number | undefined, rect : IRect, scrollChildCount? : number | undefined, scrollExtentMax? : number | undefined, scrollExtentMin? : number | undefined, scrollIndex? : number | undefined, scrollPosition? : number | undefined, textDirection? : TextDirection | undefined, textSelection? : ITextSelection | undefined, thickness : number,}){
flutter.semantics.semanticsData(this, props);}
    ...
    private readonly _dart_hasAction: (action: ISemanticsAction) => boolean = undefined as any;

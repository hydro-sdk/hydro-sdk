...
declare const flutter: {
    semantics: {
        semanticsConfiguration: (
            this: void,
            semanticsConfiguration: ISemanticsConfiguration
...
export interface ISemanticsConfiguration {
    ...
    setOnMoveCursorForwardByCharacter: (
        value?: (extendSelection: boolean) => void
    ) => void;
    ...
    setCustomSemanticsActions: (
        value: IMap<ICustomSemanticsAction, () => void>
    ) => void;
    getLabel: () => string;
...
export class SemanticsConfiguration {
    ...
    public readonly isBlockingSemanticsOfPreviouslyPaintedNodes: boolean =
        undefined as any;
    public constructor() {
        flutter.semantics.semanticsConfiguration(this);
    }
    private readonly _dart_getIsSemanticBoundary: () => boolean =
        undefined as any;
    private readonly _dart_setIsSemanticBoundary: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getHasBeenAnnotated: () => boolean =
        undefined as any;
    private readonly _dart_getOnTap: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnTap: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnLongPress: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnLongPress: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnScrollLeft: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnScrollLeft: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnDismiss: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnDismiss: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnScrollRight: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnScrollRight: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnScrollUp: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnScrollUp: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnScrollDown: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnScrollDown: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnIncrease: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnIncrease: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnDecrease: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnDecrease: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnCopy: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnCopy: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnCut: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnCut: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnPaste: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnPaste: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnShowOnScreen: () => () => void | undefined =
        undefined as any;
    private readonly _dart_setOnShowOnScreen: (value?: () => void) => void =
        undefined as any;
    private readonly _dart_getOnMoveCursorForwardByCharacter: () => (
        extendSelection: boolean
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnMoveCursorForwardByCharacter: (
        value?: (extendSelection: boolean) => void
    ) => void = undefined as any;
    private readonly _dart_getOnMoveCursorBackwardByCharacter: () => (
        extendSelection: boolean
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnMoveCursorBackwardByCharacter: (
        value?: (extendSelection: boolean) => void
    ) => void = undefined as any;
    private readonly _dart_getOnMoveCursorForwardByWord: () => (
        extendSelection: boolean
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnMoveCursorForwardByWord: (
        value?: (extendSelection: boolean) => void
    ) => void = undefined as any;
    private readonly _dart_getOnMoveCursorBackwardByWord: () => (
        extendSelection: boolean
    ) => void | undefined = undefined as any;
    private readonly _dart_setOnMoveCursorBackwardByWord: (
        value?: (extendSelection: boolean) => void
    ) => void = undefined as any;
    private readonly _dart_getOnSetSelection: () => (
    ...
    private readonly _dart_setOnDidGainAccessibilityFocus: (
        value?: () => void
    ) => void = undefined as any;
    private readonly _dart_getOnDidLoseAccessibilityFocus: () => () =>
        | void
        | undefined = undefined as any;
    private readonly _dart_setOnDidLoseAccessibilityFocus: (
        value?: () => void
    ) => void = undefined as any;
    ...
    private readonly _dart_setSortKey: (
        value?: ISemanticsSortKey | undefined
    ) => void = undefined as any;
    private readonly _dart_getIndexInParent: () => number | undefined =
        undefined as any;
    private readonly _dart_setIndexInParent: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getScrollChildCount: () => number | undefined =
        undefined as any;
    private readonly _dart_setScrollChildCount: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getScrollIndex: () => number | undefined =
        undefined as any;
    private readonly _dart_setScrollIndex: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getPlatformViewId: () => number | undefined =
        undefined as any;
    private readonly _dart_setPlatformViewId: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getMaxValueLength: () => number | undefined =
        undefined as any;
    private readonly _dart_setMaxValueLength: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getCurrentValueLength: () => number | undefined =
        undefined as any;
    private readonly _dart_setCurrentValueLength: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getIsMergingSemanticsOfDescendants: () => boolean =
        undefined as any;
    private readonly _dart_setIsMergingSemanticsOfDescendants: (
        value: boolean
    ) => void = undefined as any;
    private readonly _dart_getCustomSemanticsActions: () => IMap<
        ICustomSemanticsAction,
        () => void
    > = undefined as any;
    private readonly _dart_setCustomSemanticsActions: (
        value: IMap<ICustomSemanticsAction, () => void>
    ) => void = undefined as any;
    ...
    private readonly _dart_getHintOverrides: () =>
        ...
        | undefined = undefined as any;
    private readonly _dart_setHintOverrides: (
        value?: ISemanticsHintOverrides | undefined
    ) => void = undefined as any;
    private readonly _dart_getElevation: () => number = undefined as any;
    private readonly _dart_setElevation: (value: number) => void =
        undefined as any;
    private readonly _dart_getThickness: () => number = undefined as any;
    private readonly _dart_setThickness: (value: number) => void =
        undefined as any;
    private readonly _dart_getScopesRoute: () => boolean = undefined as any;
    private readonly _dart_setScopesRoute: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getNamesRoute: () => boolean = undefined as any;
    private readonly _dart_setNamesRoute: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsImage: () => boolean = undefined as any;
    private readonly _dart_setIsImage: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getLiveRegion: () => boolean = undefined as any;
    private readonly _dart_setLiveRegion: (value: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_setIsSelected: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsEnabled: () => boolean | undefined =
        undefined as any;
    private readonly _dart_setIsEnabled: (value?: boolean | undefined) => void =
        undefined as any;
    private readonly _dart_getIsChecked: () => boolean | undefined =
        undefined as any;
    private readonly _dart_setIsChecked: (value?: boolean | undefined) => void =
        undefined as any;
    private readonly _dart_getIsToggled: () => boolean | undefined =
        undefined as any;
    private readonly _dart_setIsToggled: (value?: boolean | undefined) => void =
        undefined as any;
    private readonly _dart_getIsInMutuallyExclusiveGroup: () => boolean =
        undefined as any;
    private readonly _dart_setIsInMutuallyExclusiveGroup: (
        value: boolean
    ) => void = undefined as any;
    private readonly _dart_getIsFocusable: () => boolean = undefined as any;
    private readonly _dart_setIsFocusable: (value: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_setIsButton: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsLink: () => boolean = undefined as any;
    private readonly _dart_setIsLink: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsHeader: () => boolean = undefined as any;
    private readonly _dart_setIsHeader: (value: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_setIsTextField: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsReadOnly: () => boolean = undefined as any;
    private readonly _dart_setIsReadOnly: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsObscured: () => boolean = undefined as any;
    private readonly _dart_setIsObscured: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getIsMultiline: () => boolean = undefined as any;
    private readonly _dart_setIsMultiline: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getHasImplicitScrolling: () => boolean =
        undefined as any;
    private readonly _dart_setHasImplicitScrolling: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getTextSelection: () => ITextSelection | undefined =
        undefined as any;
    private readonly _dart_setTextSelection: (
        value?: ITextSelection | undefined
    ) => void = undefined as any;
    private readonly _dart_getScrollPosition: () => number | undefined =
        undefined as any;
    private readonly _dart_setScrollPosition: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getScrollExtentMax: () => number | undefined =
        undefined as any;
    private readonly _dart_setScrollExtentMax: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getScrollExtentMin: () => number | undefined =
        undefined as any;
    private readonly _dart_setScrollExtentMin: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getTagsForChildren: () =>
        | IIterable<ISemanticsTag>
        | undefined = undefined as any;
    private readonly _dart_addTagForChildren: (tag: ISemanticsTag) => void =
        undefined as any;
    private readonly _dart_isCompatibleWith: (
        other?: ISemanticsConfiguration | undefined
    ) => boolean = undefined as any;
    private readonly _dart_absorb: (child: ISemanticsConfiguration) => void =
        undefined as any;
    private readonly _dart_copy: () => ISemanticsConfiguration =
        undefined as any;
    ...
    public getCustomSemanticsActions(): IMap<
        ICustomSemanticsAction,
        () => void
    > {
        return this._dart_getCustomSemanticsActions();
    }
    public setCustomSemanticsActions(
        value: IMap<ICustomSemanticsAction, () => void>
    ): void {

...
semantics: {
semanticsOwner: (this: void, semanticsOwner: ISemanticsOwner) => ISemanticsOwner
}
};
...
performAction: (id: number, action: ISemanticsAction, args?: Object | undefined) => void;
performActionAt: (position: IOffset, action: ISemanticsAction, args?: Object | undefined) => void;
toString: () => string;
addListener: (listener : () => void) => void;
removeListener: (listener : () => void) => void;
getHasListeners: () => boolean;
getHashCode: () => number;
}export class SemanticsOwner

 implements IChangeNotifier, IListenable
{public constructor(){
flutter.semantics.semanticsOwner(this);}
    private readonly _dart_getRootSemanticsNode: () => ISemanticsNode | undefined = undefined as any;
    private readonly _dart_dispose: () => void = undefined as any;
    private readonly _dart_sendSemanticsUpdate: () => void = undefined as any;
    private readonly _dart_performAction: (id: number, action: ISemanticsAction, args?: Object | undefined) => void = undefined as any;
    private readonly _dart_performActionAt: (position: IOffset, action: ISemanticsAction, args?: Object | undefined) => void = undefined as any;
...
public performAction(id: number, action: ISemanticsAction, args?: Object | undefined) : void {
    return this._dart_performAction(id, action, args);
}
public performActionAt(position: IOffset, action: ISemanticsAction, args?: Object | undefined) : void {

...
declare const flutter: {
    widgets: {
        sliverChildBuilderDelegate: (
            this: void,
            sliverChildBuilderDelegate: ISliverChildBuilderDelegate,
            builder: (
...
export class SliverChildBuilderDelegate implements ISliverChildDelegate {

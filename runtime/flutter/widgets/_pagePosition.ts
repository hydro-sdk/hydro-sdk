        ...
        IListenable
{
    ...
    private readonly _dart_setViewportFraction: (value: number) => void =
        undefined as any;
    private readonly _dart_getPageFromPixels: (
        pixels: number,
        viewportDimension: number
    ) => number = undefined as any;
    private readonly _dart_getPixelsFromPage: (page: number) => number =
        undefined as any;

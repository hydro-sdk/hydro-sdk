...
widgets: {
_navigatorPushObservation: (this: void, _navigatorPushObservation: I_NavigatorPushObservation, primaryRoute: IRoute<any>, secondaryRoute?: IRoute<any> | undefined) => I_NavigatorPushObservation
}
};
export interface I_NavigatorPushObservation
...
toString: () => string;
getHashCode: () => number;
}export class _NavigatorPushObservation
...
flutter.widgets._navigatorPushObservation(this, primaryRoute, secondaryRoute);}

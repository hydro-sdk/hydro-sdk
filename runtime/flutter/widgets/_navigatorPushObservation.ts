...
declare const flutter: {
    widgets: {
        _navigatorPushObservation: (
            this: void,
            _navigatorPushObservation: I_NavigatorPushObservation,
            primaryRoute: IRoute<any>,
            secondaryRoute?: IRoute<any> | undefined
        ) => I_NavigatorPushObservation;
    };
};
...
export class _NavigatorPushObservation implements I_NavigatorObservation {
    ...
    public constructor(
        ...
        flutter.widgets._navigatorPushObservation(
            this,
            primaryRoute,
            secondaryRoute
        );

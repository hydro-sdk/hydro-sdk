...
import { IPopupRoute } from "./popupRoute";
...
widgets: {
rawDialogRoute: <T>(this: void, rawDialogRoute: IRawDialogRoute<T>, props : {  barrierColor? : IColor | undefined, barrierDismissible : boolean, barrierLabel? : string | undefined, settings? : IRouteSettings | undefined, transitionBuilder? : (context: IBuildContext, animation: IAnimation<number>, secondaryAnimation: IAnimation<number>, child: IWidget) => IWidget | undefined, transitionDuration : IDuration, pageBuilder : (context: IBuildContext, animation: IAnimation<number>, secondaryAnimation: IAnimation<number>) => IWidget,}) => IRawDialogRoute<T>
}
};
export interface IRawDialogRoute
<T>
...
public constructor( props : {  barrierColor? : IColor | undefined, barrierDismissible? : boolean, barrierLabel? : string | undefined, settings? : IRouteSettings | undefined, transitionBuilder? : (context: IBuildContext, animation: IAnimation<number>, secondaryAnimation: IAnimation<number>, child: IWidget) => IWidget | undefined, transitionDuration? : IDuration, pageBuilder : (context: IBuildContext, animation: IAnimation<number>, secondaryAnimation: IAnimation<number>) => IWidget,}){
flutter.widgets.rawDialogRoute(this, {
...rawDialogRouteDefaultProps,
...props
});}
...
const rawDialogRouteDefaultProps = {
    barrierColor: new Color(0x80000000),

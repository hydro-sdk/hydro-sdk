...
widgets: {
_sliverPersistentHeaderElement: (this: void, _sliverPersistentHeaderElement: I_SliverPersistentHeaderElement, widget: I_SliverPersistentHeaderRenderObjectWidget, props : {  floating : boolean,}) => I_SliverPersistentHeaderElement
}
};
...
public constructor(widget: I_SliverPersistentHeaderRenderObjectWidget, props : {  floating? : boolean,}){
flutter.widgets._sliverPersistentHeaderElement(this, widget, {
..._sliverPersistentHeaderElementDefaultProps,
...props
});}
    private readonly _dart_getWidget: () => I_SliverPersistentHeaderRenderObjectWidget = undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderSliverPersistentHeaderForWidgetsMixin = undefined as any;

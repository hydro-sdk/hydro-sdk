...
declare const flutter: {
    widgets: {
        fixedExtentScrollPhysics: (
            this: void,
            fixedExtentScrollPhysics: IFixedExtentScrollPhysics,
            props?: { parent?: IScrollPhysics | undefined }
        ) => IFixedExtentScrollPhysics;
    };
};
...
export class FixedExtentScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => IFixedExtentScrollPhysics = undefined as any;

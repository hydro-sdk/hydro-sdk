...
widgets: {
fixedExtentScrollPhysics: (this: void, fixedExtentScrollPhysics: IFixedExtentScrollPhysics, props? : {  parent? : IScrollPhysics | undefined,}) => IFixedExtentScrollPhysics
}
};
export interface IFixedExtentScrollPhysics


{
parent: IScrollPhysics | undefined;
applyTo: (ancestor?: IScrollPhysics | undefined) => IFixedExtentScrollPhysics;
...
getHashCode: () => number;
}export class FixedExtentScrollPhysics
...
flutter.widgets.fixedExtentScrollPhysics(this, props);}
    private readonly _dart_applyTo: (ancestor?: IScrollPhysics | undefined) => IFixedExtentScrollPhysics = undefined as any;
...
public applyTo(ancestor?: IScrollPhysics | undefined) : IFixedExtentScrollPhysics {

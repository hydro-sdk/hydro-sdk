...
declare const flutter: {
    widgets: {
        fixedExtentScrollController: (
            this: void,
            fixedExtentScrollController: IFixedExtentScrollController,
            props: { initialItem: number }
        ) => IFixedExtentScrollController;
    };
};
    ...
    implements IScrollController, IListenable
{
    ...
    private readonly _dart_animateToItem: (
        itemIndex: number,
        props: { curve: ICurve; duration: IDuration }
    ) => IFuture<void> = undefined as any;
    private readonly _dart_jumpToItem: (itemIndex: number) => void =
        undefined as any;

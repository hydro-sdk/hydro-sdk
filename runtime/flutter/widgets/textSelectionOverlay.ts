...
declare const flutter: {
    widgets: {
        textSelectionOverlay: (
            this: void,
            textSelectionOverlay: ITextSelectionOverlay,
            props: {
...
export class TextSelectionOverlay {
    ...
    public readonly selectionControls: ITextSelectionControls | undefined =
        undefined as any;
    public readonly selectionDelegate: ITextSelectionDelegate | undefined =
        undefined as any;
    ...
    private readonly _dart_setHandlesVisible: (visible: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_update: (newValue: ITextEditingValue) => void =
        undefined as any;
    private readonly _dart_updateForScroll: () => void = undefined as any;
    private readonly _dart_getHandlesAreVisible: () => boolean =
        undefined as any;
    private readonly _dart_getToolbarIsVisible: () => boolean =
        undefined as any;

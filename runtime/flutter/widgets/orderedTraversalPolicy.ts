...
widgets: {
orderedTraversalPolicy: (this: void, orderedTraversalPolicy: IOrderedTraversalPolicy, props? : {  secondary? : IFocusTraversalPolicy | undefined,}) => IOrderedTraversalPolicy
}
};
export interface IOrderedTraversalPolicy


{
secondary: IFocusTraversalPolicy | undefined;
...
getHashCode: () => number;
}export class OrderedTraversalPolicy
...
{    public readonly secondary: IFocusTraversalPolicy | undefined = undefined as any;
public constructor( props? : {  secondary? : IFocusTraversalPolicy | undefined,}){
flutter.widgets.orderedTraversalPolicy(this, props);}

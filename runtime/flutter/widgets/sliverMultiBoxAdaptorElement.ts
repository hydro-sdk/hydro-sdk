...
widgets: {
sliverMultiBoxAdaptorElement: (this: void, sliverMultiBoxAdaptorElement: ISliverMultiBoxAdaptorElement, widget: ISliverMultiBoxAdaptorWidget, props : {  replaceMovedChildren : boolean,}) => ISliverMultiBoxAdaptorElement
}
};
...
toString: ( props : {  minLevel : DiagnosticLevel,}) => string;
 ...
 implements IRenderObjectElement, IDiagnosticable, IRenderSliverBoxChildManager, IBuildContext
{public constructor(widget: ISliverMultiBoxAdaptorWidget, props : {  replaceMovedChildren? : boolean,}){
flutter.widgets.sliverMultiBoxAdaptorElement(this, widget, {
...sliverMultiBoxAdaptorElementDefaultProps,
...props
});}
    private readonly _dart_getWidget: () => ISliverMultiBoxAdaptorWidget = undefined as any;
    private readonly _dart_getRenderObject: () => IRenderSliverMultiBoxAdaptor = undefined as any;

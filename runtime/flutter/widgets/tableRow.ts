...
widgets: {
tableRow: (this: void, tableRow: ITableRow, props? : {  children? : IList<IWidget> | undefined, decoration? : IDecoration | undefined, key? : ILocalKey | undefined,}) => ITableRow
}
};
...
public constructor( props? : {  children? : IList<IWidget> | undefined, decoration? : IDecoration | undefined, key? : ILocalKey | undefined,}){

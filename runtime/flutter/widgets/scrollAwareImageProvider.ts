...
declare const flutter: {
    widgets: {
        scrollAwareImageProvider: <T>(
            this: void,
            scrollAwareImageProvider: IScrollAwareImageProvider<T>,
            props: {
                context: IDisposableBuildContext<IState<IStatefulWidget>>;
                imageProvider: IImageProvider<T>;
            }
        ) => IScrollAwareImageProvider<T>;
    };
};
export interface IScrollAwareImageProvider<T> {
    context: IDisposableBuildContext<IState<IStatefulWidget>>;
    imageProvider: IImageProvider<T>;
    resolveStreamForKey: (
...
export class ScrollAwareImageProvider<T> implements IImageProvider<T> {
    public readonly context: IDisposableBuildContext<IState<IStatefulWidget>> =
        undefined as any;

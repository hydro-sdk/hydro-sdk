...
widgets: {
restorableListenable: <T>(this: void, restorableListenable: IRestorableListenable<T>) => IRestorableListenable<T>
}
};
export interface IRestorableListenable
<T>
...
toString: () => string;
getHashCode: () => number;
}export class RestorableListenable
<T>

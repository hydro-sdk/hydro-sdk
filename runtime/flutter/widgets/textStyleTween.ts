...
widgets: {
textStyleTween: (this: void, textStyleTween: ITextStyleTween, props? : {  begin? : ITextStyle | undefined, end? : ITextStyle | undefined,}) => ITextStyleTween
}
};
...
getHashCode: () => number;
}export class TextStyleTween

 implements ITween<ITextStyle>
{    public readonly begin: ITextStyle | undefined = undefined as any;
    public readonly end: ITextStyle | undefined = undefined as any;
public constructor( props? : {  begin? : ITextStyle | undefined, end? : ITextStyle | undefined,}){
flutter.widgets.textStyleTween(this, props);}
    private readonly _dart_lerp: (t: number) => ITextStyle = undefined as any;
    private readonly _dart_transform: (t: number) => ITextStyle = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => ITextStyle = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<ITextStyle> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<ITextStyle> = undefined as any;

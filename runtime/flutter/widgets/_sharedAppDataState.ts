...
widgets: {
_sharedAppDataState: (this: void, _sharedAppDataState: I_SharedAppDataState) => I_SharedAppDataState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<ISharedAppData>, "debugFillProperties">, IDiagnosticable
...
flutter.widgets._sharedAppDataState(this);}
    ...
    private readonly _dart_getValue: <K, V>(key: K, init : () => V) => V = undefined as any;
    private readonly _dart_setValue: <K, V>(key: K, value: V) => void = undefined as any;

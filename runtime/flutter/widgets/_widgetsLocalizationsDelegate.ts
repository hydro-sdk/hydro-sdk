...
widgets: {
_widgetsLocalizationsDelegate: (this: void, _widgetsLocalizationsDelegate: I_WidgetsLocalizationsDelegate) => I_WidgetsLocalizationsDelegate
}
};
...
flutter.widgets._widgetsLocalizationsDelegate(this);}
    ...
    private readonly _dart_load: (locale: ILocale) => IFuture<IWidgetsLocalizations> = undefined as any;

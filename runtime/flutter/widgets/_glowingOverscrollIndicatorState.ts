...
declare const flutter: {
    widgets: {
        _glowingOverscrollIndicatorState: (
            this: void,
            _glowingOverscrollIndicatorState: I_GlowingOverscrollIndicatorState
        ) => I_GlowingOverscrollIndicatorState;
    };
};
...
export class _GlowingOverscrollIndicatorState
    implements
        Omit<
            IState<IGlowingOverscrollIndicator>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IGlowingOverscrollIndicator>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IGlowingOverscrollIndicator =
        undefined as any;

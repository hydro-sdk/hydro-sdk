...
widgets: {
scaleTransition: (this: void, scaleTransition: IScaleTransition, props : {  alignment : IAlignment, child? : IWidget | undefined, filterQuality? : FilterQuality | undefined, key? : IKey | undefined, scale : IAnimation<number>,}) => IScaleTransition
}
};
...
public constructor( props : {  alignment? : IAlignment, child? : IWidget | undefined, filterQuality? : FilterQuality | undefined, key? : IKey | undefined, scale : IAnimation<number>,}){
flutter.widgets.scaleTransition(this, {
...scaleTransitionDefaultProps,
...props
});}
    private readonly _dart_getScale: () => IAnimation<number> = undefined as any;

...
declare const flutter: {
    widgets: {
        alwaysScrollableScrollPhysics: (
            this: void,
            alwaysScrollableScrollPhysics: IAlwaysScrollableScrollPhysics,
            props?: { parent?: IScrollPhysics | undefined }
        ) => IAlwaysScrollableScrollPhysics;
    };
};
...
export class AlwaysScrollableScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => IAlwaysScrollableScrollPhysics = undefined as any;

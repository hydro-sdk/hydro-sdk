...
widgets: {
_inheritedNestedScrollView: (this: void, _inheritedNestedScrollView: I_InheritedNestedScrollView, props : {  key? : IKey | undefined, child : IWidget, state : INestedScrollViewState,}) => I_InheritedNestedScrollView
}
};
export interface I_InheritedNestedScrollView


{
state: INestedScrollViewState;
child: IWidget;
key: IKey | undefined;
...
}export class _InheritedNestedScrollView

 implements IInheritedWidget, IDiagnosticable
{    public readonly state: INestedScrollViewState = undefined as any;
    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, child : IWidget, state : INestedScrollViewState,}){
flutter.widgets._inheritedNestedScrollView(this, props);}

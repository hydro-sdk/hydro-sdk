...
declare const flutter: {
    widgets: {
        _nestedOuterBallisticScrollActivity: (
            this: void,
            _nestedOuterBallisticScrollActivity: I_NestedOuterBallisticScrollActivity,
        ...
        ) => I_NestedOuterBallisticScrollActivity;
    };
};
    ...
    implements IBallisticScrollActivity
{
    ...
    public constructor(
        ...
        flutter.widgets._nestedOuterBallisticScrollActivity(
            this,
            coordinator,
            position,
            metrics,

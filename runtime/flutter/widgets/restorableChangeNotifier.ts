...
widgets: {
restorableChangeNotifier: <T>(this: void, restorableChangeNotifier: IRestorableChangeNotifier<T>) => IRestorableChangeNotifier<T>
}
};
export interface IRestorableChangeNotifier
<T>
...
toString: () => string;
getHashCode: () => number;
}export class RestorableChangeNotifier
<T>

...
widgets: {
nestedScrollView: (this: void, nestedScrollView: INestedScrollView, props : {  clipBehavior : Clip, controller? : IScrollController | undefined, dragStartBehavior : DragStartBehavior, floatHeaderSlivers : boolean, key? : IKey | undefined, physics? : IScrollPhysics | undefined, restorationId? : string | undefined, reverse : boolean, scrollBehavior? : IScrollBehavior | undefined, scrollDirection : Axis, body : IWidget, headerSliverBuilder : (context: IBuildContext, innerBoxIsScrolled: boolean) => IList<IWidget>,}) => INestedScrollView;
nestedScrollViewSliverOverlapAbsorberHandleFor: (context: IBuildContext) => ISliverOverlapAbsorberHandle
}
};
...
public constructor( props : {  clipBehavior? : Clip, controller? : IScrollController | undefined, dragStartBehavior? : DragStartBehavior, floatHeaderSlivers? : boolean, key? : IKey | undefined, physics? : IScrollPhysics | undefined, restorationId? : string | undefined, reverse? : boolean, scrollBehavior? : IScrollBehavior | undefined, scrollDirection? : Axis, body : IWidget, headerSliverBuilder : (context: IBuildContext, innerBoxIsScrolled: boolean) => IList<IWidget>,}){
flutter.widgets.nestedScrollView(this, {
...nestedScrollViewDefaultProps,
...props
});}
public static sliverOverlapAbsorberHandleFor(context: IBuildContext) : ISliverOverlapAbsorberHandle{
return flutter.widgets.nestedScrollViewSliverOverlapAbsorberHandleFor(context);
}    private readonly _dart_createState: () => INestedScrollViewState = undefined as any;

...
widgets: {
richText: (this: void, richText: IRichText, props : {  key? : IKey | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, overflow : TextOverflow, softWrap : boolean, strutStyle? : IStrutStyle | undefined, textAlign : TextAlign, textDirection? : TextDirection | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor : number, textWidthBasis : TextWidthBasis, text : IInlineSpan,}) => IRichText
}
};
...
public constructor( props : {  key? : IKey | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, overflow? : TextOverflow, softWrap? : boolean, strutStyle? : IStrutStyle | undefined, textAlign? : TextAlign, textDirection? : TextDirection | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, textScaleFactor? : number, textWidthBasis? : TextWidthBasis, text : IInlineSpan,}){
flutter.widgets.richText(this, {
...richTextDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderParagraph = undefined as any;

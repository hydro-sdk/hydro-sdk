...
widgets: {
_reorderableItemState: (this: void, _reorderableItemState: I_ReorderableItemState) => I_ReorderableItemState
}
};
...
deactivate: () => void;
getOffset: () => IOffset;
updateForGap: (gapIndex: number, gapExtent: number, animate: boolean, reverse: boolean) => void;
resetGap: () => void;
...
getHashCode: () => number;
 ...
 implements Omit<IState<I_ReorderableItem>, "debugFillProperties">, IDiagnosticable
{public constructor(){
flutter.widgets._reorderableItemState(this);}
    ...
    private readonly _dart_setDragging: (dragging: boolean) => void = undefined as any;
    ...
    private readonly _dart_updateForGap: (gapIndex: number, gapExtent: number, animate: boolean, reverse: boolean) => void = undefined as any;
    ...
    private readonly _dart_getWidget: () => I_ReorderableItem = undefined as any;
...
public updateForGap(gapIndex: number, gapExtent: number, animate: boolean, reverse: boolean) : void {

...
widgets: {
focusTraversalOrder: (this: void, focusTraversalOrder: IFocusTraversalOrder, props : {  key? : IKey | undefined, child : IWidget, order : IFocusOrder,}) => IFocusTraversalOrder;
focusTraversalOrderOf: (context: IBuildContext) => IFocusOrder;
focusTraversalOrderMaybeOf: (context: IBuildContext) => IFocusOrder | undefined
}
};

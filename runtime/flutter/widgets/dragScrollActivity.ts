...
widgets: {
dragScrollActivity: (this: void, dragScrollActivity: IDragScrollActivity, delegate: IScrollActivityDelegate, controller: IScrollDragController) => IDragScrollActivity
}
};
...
getHashCode: () => number;
}export class DragScrollActivity

 implements IScrollActivity
{public constructor(delegate: IScrollActivityDelegate, controller: IScrollDragController){

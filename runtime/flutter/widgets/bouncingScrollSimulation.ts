...
widgets: {
bouncingScrollSimulation: (this: void, bouncingScrollSimulation: IBouncingScrollSimulation, props : {  tolerance : ITolerance, leadingExtent : number, position : number, spring : ISpringDescription, trailingExtent : number, velocity : number,}) => IBouncingScrollSimulation
}
};
...
toString: () => string;
getHashCode: () => number;
}export class BouncingScrollSimulation
...
public constructor( props : {  tolerance? : ITolerance, leadingExtent : number, position : number, spring : ISpringDescription, trailingExtent : number, velocity : number,}){

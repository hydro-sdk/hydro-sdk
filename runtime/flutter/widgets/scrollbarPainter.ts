...
{
    public readonly fadeoutOpacityAnimation: IAnimation<number> =
        undefined as any;
    ...
    private readonly _dart_setTrackBorderColor: (value: IColor) => void =
        undefined as any;
    ...
    private readonly _dart_setMainAxisMargin: (value: number) => void =
        undefined as any;
    private readonly _dart_getCrossAxisMargin: () => number = undefined as any;
    private readonly _dart_setCrossAxisMargin: (value: number) => void =
        undefined as any;
    private readonly _dart_getRadius: () => IRadius | undefined =
        undefined as any;
    private readonly _dart_setRadius: (value?: IRadius | undefined) => void =
        undefined as any;
    private readonly _dart_getShape: () => IOutlinedBorder | undefined =
        undefined as any;
    private readonly _dart_setShape: (
        value?: IOutlinedBorder | undefined
    ) => void = undefined as any;
    private readonly _dart_getPadding: () => IEdgeInsets = undefined as any;
    private readonly _dart_setPadding: (value: IEdgeInsets) => void =
        undefined as any;
    private readonly _dart_getMinLength: () => number = undefined as any;
    private readonly _dart_setMinLength: (value: number) => void =
        undefined as any;
    private readonly _dart_getMinOverscrollLength: () => number =
        undefined as any;
    private readonly _dart_setMinOverscrollLength: (value: number) => void =
        undefined as any;
    private readonly _dart_getScrollbarOrientation: () =>
        | ScrollbarOrientation
        | undefined = undefined as any;
    private readonly _dart_setScrollbarOrientation: (
        value?: ScrollbarOrientation | undefined
    ) => void = undefined as any;
    private readonly _dart_update: (
        metrics: IScrollMetrics,
        axisDirection: AxisDirection
    ) => void = undefined as any;
    private readonly _dart_updateThickness: (
        nextThickness: number,
        nextRadius: IRadius
    ) => void = undefined as any;
    private readonly _dart_dispose: () => void = undefined as any;
    private readonly _dart_getTrackToScroll: (
        thumbOffsetLocal: number
    ) => number = undefined as any;
    private readonly _dart_paint: (canvas: ICanvas, size: ISize) => void =
        undefined as any;
    private readonly _dart_hitTestInteractive: (
        position: IOffset,
        kind: PointerDeviceKind,
        props: { forHover: boolean }
    ) => boolean = undefined as any;
    private readonly _dart_hitTestOnlyThumbInteractive: (
        position: IOffset,
        kind: PointerDeviceKind
    ) => boolean = undefined as any;
    private readonly _dart_hitTest: (
        position?: IOffset | undefined
    ) => boolean | undefined = undefined as any;
    ...
    public setScrollbarOrientation(
        value?: ScrollbarOrientation | undefined
    ): void {
    ...
    public hitTestOnlyThumbInteractive(
        position: IOffset,
        kind: PointerDeviceKind
    ): boolean {

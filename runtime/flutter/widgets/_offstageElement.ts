...
import { IOffstage } from "./offstage";
...
widgets: {
_offstageElement: (this: void, _offstageElement: I_OffstageElement, widget: IOffstage) => I_OffstageElement
}
};
export interface I_OffstageElement
...
}export class _OffstageElement

 implements ISingleChildRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: IOffstage){
flutter.widgets._offstageElement(this, widget);}
    private readonly _dart_getWidget: () => IOffstage = undefined as any;

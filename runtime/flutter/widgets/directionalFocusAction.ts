...
declare const flutter: {
    widgets: {
        directionalFocusAction: (
            this: void,
            directionalFocusAction: IDirectionalFocusAction
        ) => IDirectionalFocusAction;
    };
};
    ...
    implements Omit<IAction<IDirectionalFocusIntent>>, IDiagnosticable
{
    ...
    private readonly _dart_invoke: (intent: IDirectionalFocusIntent) => void =
        undefined as any;
    private readonly _dart_isEnabled: (
        intent: IDirectionalFocusIntent
    ...
    private readonly _dart_getCallingAction: () =>
        | IAction<IDirectionalFocusIntent>

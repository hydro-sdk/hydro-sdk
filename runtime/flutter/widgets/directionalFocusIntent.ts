...
declare const flutter: {
    widgets: {
        directionalFocusIntent: (
            this: void,
            directionalFocusIntent: IDirectionalFocusIntent,
            direction: TraversalDirection,
            props: { ignoreTextFields: boolean }
        ) => IDirectionalFocusIntent;
    };
};
...
export class DirectionalFocusIntent implements Omit<IIntent>, IDiagnosticable {

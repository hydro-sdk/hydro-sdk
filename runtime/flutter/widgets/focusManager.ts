...
export interface IFocusManager {
    ...
    addHighlightModeListener: (
        listener: (value: FocusHighlightMode) => void
    ) => void;
        ...
        IListenable
{
    ...
    private readonly _dart_registerGlobalHandlers: () => void =
        undefined as any;
    private readonly _dart_dispose: () => void = undefined as any;
    private readonly _dart_getHighlightStrategy: () => FocusHighlightStrategy =
        undefined as any;
    private readonly _dart_setHighlightStrategy: (
        highlightStrategy: FocusHighlightStrategy
    ) => void = undefined as any;
    private readonly _dart_getHighlightMode: () => FocusHighlightMode =
        undefined as any;
    private readonly _dart_addHighlightModeListener: (
        listener: (value: FocusHighlightMode) => void
    ) => void = undefined as any;
    private readonly _dart_removeHighlightModeListener: (
        listener: (value: FocusHighlightMode) => void
    ) => void = undefined as any;
    private readonly _dart_getPrimaryFocus: () => IFocusNode | undefined =
        undefined as any;
    ...
    public addHighlightModeListener(
        listener: (value: FocusHighlightMode) => void
    ): void {
        return this._dart_addHighlightModeListener(listener);
    }
    public removeHighlightModeListener(
        listener: (value: FocusHighlightMode) => void
    ): void {

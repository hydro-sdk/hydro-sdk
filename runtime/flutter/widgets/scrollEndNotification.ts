...
widgets: {
scrollEndNotification: (this: void, scrollEndNotification: IScrollEndNotification, props : {  dragDetails? : IDragEndDetails | undefined, context : IBuildContext, metrics : IScrollMetrics,}) => IScrollEndNotification
}
};
...
public constructor( props : {  dragDetails? : IDragEndDetails | undefined, context : IBuildContext, metrics : IScrollMetrics,}){

...
widgets: {
buildOwner: (this: void, buildOwner: IBuildOwner, props? : {  focusManager? : IFocusManager | undefined, onBuildScheduled? : () => void | undefined,}) => IBuildOwner
}
};
...
finalizeTree: () => void;
reassemble: (root: IElement, reassembleConfig?: IDebugReassembleConfig | undefined) => void;
}export class BuildOwner


{    public readonly focusManager: IFocusManager = undefined as any;
public constructor( props? : {  focusManager? : IFocusManager | undefined, onBuildScheduled? : () => void | undefined,}){
flutter.widgets.buildOwner(this, props);}
    private readonly _dart_scheduleBuildFor: (element: IElement) => void = undefined as any;
    private readonly _dart_getDebugBuilding: () => boolean = undefined as any;
    private readonly _dart_lockState: (callback : () => void) => void = undefined as any;
    private readonly _dart_buildScope: (context: IElement, callback? : () => void) => void = undefined as any;
    ...
    private readonly _dart_reassemble: (root: IElement, reassembleConfig?: IDebugReassembleConfig | undefined) => void = undefined as any;
...
public reassemble(root: IElement, reassembleConfig?: IDebugReassembleConfig | undefined) : void {

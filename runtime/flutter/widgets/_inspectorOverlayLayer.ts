...
import { IAnnotationResult } from "../rendering/annotationResult";
...
widgets: {
_inspectorOverlayLayer: (this: void, _inspectorOverlayLayer: I_InspectorOverlayLayer, props : {  overlayRect : IRect, rootRenderObject? : IRenderObject | undefined, selection : IInspectorSelection,}) => I_InspectorOverlayLayer
}
};
export interface I_InspectorOverlayLayer


{
selection: IInspectorSelection;
overlayRect: IRect;
rootRenderObject: IRenderObject | undefined;
debugCreator: Object | undefined;
addToScene: (builder: ISceneBuilder) => void;
findAnnotations: <S>(result: IAnnotationResult<S>, localPosition: IOffset, props? : {  onlyFirst? : boolean | undefined,}) => boolean;
...
getAttached: () => boolean;
getHashCode: () => number;
}export class _InspectorOverlayLayer
...
{    public readonly selection: IInspectorSelection = undefined as any;
    ...
    public readonly rootRenderObject: IRenderObject | undefined = undefined as any;
    public readonly debugCreator: Object | undefined = undefined as any;
public constructor( props : {  overlayRect : IRect, rootRenderObject? : IRenderObject | undefined, selection : IInspectorSelection,}){
flutter.widgets._inspectorOverlayLayer(this, props);}
    private readonly _dart_addToScene: (builder: ISceneBuilder) => void = undefined as any;
    private readonly _dart_findAnnotations: <S>(result: IAnnotationResult<S>, localPosition: IOffset, props? : {  onlyFirst? : boolean | undefined,}) => boolean = undefined as any;
...
public findAnnotations<S>(result: IAnnotationResult<S>, localPosition: IOffset, props? : {  onlyFirst? : boolean | undefined,}) : boolean {

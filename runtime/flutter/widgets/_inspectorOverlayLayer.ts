...
declare const flutter: {
    widgets: {
        _inspectorOverlayLayer: (
            this: void,
            _inspectorOverlayLayer: I_InspectorOverlayLayer,
            props: {
                overlayRect: IRect;
                rootRenderObject?: IRenderObject | undefined;
                selection: IInspectorSelection;
            }
        ) => I_InspectorOverlayLayer;
    };
};
export interface I_InspectorOverlayLayer {
    ...
    findAnnotations: <S>(
        ...
        props?: { onlyFirst?: boolean | undefined }
    ) => boolean;
        ...
        >
{
    ...
    public readonly rootRenderObject: IRenderObject | undefined =
        undefined as any;

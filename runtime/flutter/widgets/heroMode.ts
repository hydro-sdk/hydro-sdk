...
widgets: {
heroMode: (this: void, heroMode: IHeroMode, props : {  enabled : boolean, key? : IKey | undefined, child : IWidget,}) => IHeroMode
}
};
export interface IHeroMode
...
public constructor( props : {  enabled? : boolean, key? : IKey | undefined, child : IWidget,}){
flutter.widgets.heroMode(this, {
...heroModeDefaultProps,
...props
});}

    ...
    implements IChangeNotifier, IDiagnosticable, IListenable
{
    ...
    private readonly _dart_getShortcuts: () => IMap<
        IShortcutActivator,
        IIntent
    > = undefined as any;
    private readonly _dart_setShortcuts: (
        value: IMap<IShortcutActivator, IIntent>
    ) => void = undefined as any;
    private readonly _dart_handleKeypress: (
        context: IBuildContext,
        event: IRawKeyEvent
    ) => KeyEventResult = undefined as any;

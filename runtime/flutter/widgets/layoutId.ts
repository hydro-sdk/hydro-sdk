...
widgets: {
layoutId: (this: void, layoutId: ILayoutId, props : {  key? : IKey | undefined, child : IWidget, id : Object,}) => ILayoutId
}
};
...
public constructor( props : {  key? : IKey | undefined, child : IWidget, id : Object,}){
flutter.widgets.layoutId(this, props);}
    ...
    private readonly _dart_createElement: () => IParentDataElement<IMultiChildLayoutParentData> = undefined as any;

...
widgets: {
inheritedModelElement: <T>(this: void, inheritedModelElement: IInheritedModelElement<T>, widget: IInheritedModel<T>) => IInheritedModelElement<T>
}
};
export interface IInheritedModelElement
<T>

{
getWidget: () => IInheritedModel<T>;
...
}export class InheritedModelElement
<T>
 implements IInheritedElement, IDiagnosticable, IBuildContext
{public constructor(widget: IInheritedModel<T>){
flutter.widgets.inheritedModelElement(this, widget);}
    private readonly _dart_getWidget: () => IInheritedModel<T> = undefined as any;
...
public getWidget() : IInheritedModel<T> {

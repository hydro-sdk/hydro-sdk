...
declare const flutter: {
    widgets: {
        inheritedModelElement: <T>(
            this: void,
            inheritedModelElement: IInheritedModelElement<T>,
            widget: IInheritedModel<T>
        ) => IInheritedModelElement<T>;
    };
};
export interface IInheritedModelElement<T> {
...
export class InheritedModelElement<T>
    implements IInheritedElement, IDiagnosticable, IBuildContext
{
    ...
    private readonly _dart_getWidget: () => IInheritedModel<T> =
        undefined as any;

...
import { I_RenderSliverFloatingPersistentHeaderForWidgets } from "./_renderSliverFloatingPersistentHeaderForWidgets";
...
widgets: {
_sliverFloatingPersistentHeader: (this: void, _sliverFloatingPersistentHeader: I_SliverFloatingPersistentHeader, props : {  key? : IKey | undefined, delegate : ISliverPersistentHeaderDelegate,}) => I_SliverFloatingPersistentHeader
}
};
export interface I_SliverFloatingPersistentHeader
...
}export class _SliverFloatingPersistentHeader
...
flutter.widgets._sliverFloatingPersistentHeader(this, props);}

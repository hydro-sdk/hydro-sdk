...
widgets: {
parentDataElement: <T>(this: void, parentDataElement: IParentDataElement<T>, widget: IParentDataWidget<T>) => IParentDataElement<T>
}
};
export interface IParentDataElement
<T>
...
flutter.widgets.parentDataElement(this, widget);}
    private readonly _dart_getWidget: () => IParentDataWidget<T> = undefined as any;
    private readonly _dart_applyWidgetOutOfTurn: (newWidget: IParentDataWidget<T>) => void = undefined as any;

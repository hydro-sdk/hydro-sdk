...
import { IRenderIntrinsicHeight } from "../rendering/renderIntrinsicHeight";
...
widgets: {
intrinsicHeight: (this: void, intrinsicHeight: IIntrinsicHeight, props? : {  child? : IWidget | undefined, key? : IKey | undefined,}) => IIntrinsicHeight
}
};
export interface IIntrinsicHeight


{
child: IWidget | undefined;
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderIntrinsicHeight;
...
flutter.widgets.intrinsicHeight(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderIntrinsicHeight = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderIntrinsicHeight {

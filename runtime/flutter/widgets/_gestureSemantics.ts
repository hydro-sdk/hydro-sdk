...
widgets: {
_gestureSemantics: (this: void, _gestureSemantics: I_GestureSemantics, props : {  child? : IWidget | undefined, key? : IKey | undefined, assignSemantics : (__: IRenderSemanticsGestureHandler) => void, behavior : HitTestBehavior,}) => I_GestureSemantics
}
};
export interface I_GestureSemantics
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSemanticsGestureHandler;
...
}export class _GestureSemantics
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, assignSemantics : (__: IRenderSemanticsGestureHandler) => void, behavior : HitTestBehavior,}){
flutter.widgets._gestureSemantics(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSemanticsGestureHandler = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSemanticsGestureHandler {

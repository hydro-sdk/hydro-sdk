...
declare const flutter: {
    widgets: {
        interactiveViewer: (
            this: void,
            interactiveViewer: IInteractiveViewer,
            props: {
...
export class InteractiveViewer implements IStatefulWidget, IDiagnosticable {
    ...
    public readonly transformationController:
        | ITransformationController
    ...
    public constructor(props: {
        ...
        maxScale?: number;
        minScale?: number;
        onInteractionEnd?: (details: IScaleEndDetails) => void | undefined;
        onInteractionStart?: (details: IScaleStartDetails) => void | undefined;
        onInteractionUpdate?: (
            details: IScaleUpdateDetails
        ) => void | undefined;
        panEnabled?: boolean;
    ...
    public static getNearestPointOnLine(
        point: IVector3,
        l1: IVector3,
        l2: IVector3
    ): IVector3 {
        return flutter.widgets.interactiveViewerGetNearestPointOnLine(
            point,
            l1,
            l2
        );
    ...
    public static getNearestPointInside(
        point: IVector3,
        quad: IQuad
    ): IVector3 {
        return flutter.widgets.interactiveViewerGetNearestPointInside(
            point,
            quad
        );
    }
    private readonly _dart_createState: () => IState<IInteractiveViewer> =
        undefined as any;

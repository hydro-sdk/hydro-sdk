...
widgets: {
focusTraversalGroup: (this: void, focusTraversalGroup: IFocusTraversalGroup, props : {  descendantsAreFocusable : boolean, key? : IKey | undefined, policy? : IFocusTraversalPolicy | undefined, child : IWidget,}) => IFocusTraversalGroup;
focusTraversalGroupOf: (context: IBuildContext) => IFocusTraversalPolicy;
focusTraversalGroupMaybeOf: (context: IBuildContext) => IFocusTraversalPolicy | undefined
}
};
...
}export class FocusTraversalGroup
...
public constructor( props : {  descendantsAreFocusable? : boolean, key? : IKey | undefined, policy? : IFocusTraversalPolicy | undefined, child : IWidget,}){
...
}public static maybeOf(context: IBuildContext) : IFocusTraversalPolicy | undefined{
return flutter.widgets.focusTraversalGroupMaybeOf(context);
}    private readonly _dart_createState: () => IState<IFocusTraversalGroup> = undefined as any;

...
widgets: {
keepAliveNotification: (this: void, keepAliveNotification: IKeepAliveNotification, handle: IListenable) => IKeepAliveNotification
}
};
...
getHashCode: () => number;
}export class KeepAliveNotification

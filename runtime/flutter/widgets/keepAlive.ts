...
widgets: {
keepAlive: (this: void, keepAlive: IKeepAlive, props : {  key? : IKey | undefined, child : IWidget, keepAlive : boolean,}) => IKeepAlive
}
};
...
public constructor( props : {  key? : IKey | undefined, child : IWidget, keepAlive : boolean,}){
flutter.widgets.keepAlive(this, props);}
    ...
    private readonly _dart_createElement: () => IParentDataElement<IKeepAliveParentDataMixin> = undefined as any;

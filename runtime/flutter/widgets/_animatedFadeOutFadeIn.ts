...
declare const flutter: {
    widgets: {
        _animatedFadeOutFadeIn: (
            this: void,
            _animatedFadeOutFadeIn: I_AnimatedFadeOutFadeIn,
            props: {
                key?: IKey | undefined;
                fadeInCurve: ICurve;
    ...
    implements IImplicitlyAnimatedWidget, IDiagnosticable
{
    ...
    public readonly placeholderProxyAnimation: IProxyAnimation =
        undefined as any;
    ...
    private readonly _dart_createState: () => I_AnimatedFadeOutFadeInState =
        undefined as any;

...
widgets: {
column: (this: void, column: IColumn, props : {  children : IList<IWidget>, crossAxisAlignment : CrossAxisAlignment, key? : IKey | undefined, mainAxisAlignment : MainAxisAlignment, mainAxisSize : MainAxisSize, textBaseline? : TextBaseline | undefined, textDirection? : TextDirection | undefined, verticalDirection : VerticalDirection,}) => IColumn
}
};

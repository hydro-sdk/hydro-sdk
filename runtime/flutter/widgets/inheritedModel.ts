...
declare const flutter: {
    widgets: {
        inheritedModel: <T>(
            this: void,
            inheritedModel: IInheritedModel<T>,
            props: { key?: IKey | undefined; child: IWidget }
        ) => IInheritedModel<T>;
        inheritedModelInheritFrom: <T>(
            context: IBuildContext,
            props?: { aspect?: Object | undefined }
        ) => T | undefined;
    };
};
export interface IInheritedModel<T> {
    child: IWidget;
    key: IKey | undefined;
...
export class InheritedModel<T> implements IInheritedWidget, IDiagnosticable {
    ...
    public updateShouldNotifyDependent(
        oldWidget: any,
        dependencies: ISet<T>
    ): boolean {

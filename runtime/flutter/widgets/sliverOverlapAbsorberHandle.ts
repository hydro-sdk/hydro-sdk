...
widgets: {
sliverOverlapAbsorberHandle: (this: void, sliverOverlapAbsorberHandle: ISliverOverlapAbsorberHandle) => ISliverOverlapAbsorberHandle
}
};
...
flutter.widgets.sliverOverlapAbsorberHandle(this);}
    private readonly _dart_getLayoutExtent: () => number | undefined = undefined as any;
    private readonly _dart_getScrollExtent: () => number | undefined = undefined as any;

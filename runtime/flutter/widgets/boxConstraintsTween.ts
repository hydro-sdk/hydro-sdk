...
widgets: {
boxConstraintsTween: (this: void, boxConstraintsTween: IBoxConstraintsTween, props? : {  begin? : IBoxConstraints | undefined, end? : IBoxConstraints | undefined,}) => IBoxConstraintsTween
}
};
...
getHashCode: () => number;
}export class BoxConstraintsTween

 implements ITween<IBoxConstraints>
...
public constructor( props? : {  begin? : IBoxConstraints | undefined, end? : IBoxConstraints | undefined,}){
flutter.widgets.boxConstraintsTween(this, props);}
    private readonly _dart_lerp: (t: number) => IBoxConstraints = undefined as any;
    private readonly _dart_transform: (t: number) => IBoxConstraints = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IBoxConstraints = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IBoxConstraints> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IBoxConstraints> = undefined as any;

...
declare const flutter: {
    widgets: {
        rawAutocomplete: <T>(
            this: void,
            rawAutocomplete: IRawAutocomplete<T>,
            props: {
...
export class RawAutocomplete<T> implements IStatefulWidget, IDiagnosticable {
    public readonly focusNode: IFocusNode | undefined = undefined as any;
    public readonly textEditingController: ITextEditingController | undefined =
        undefined as any;
    ...
    public static onFieldSubmitted<T>(
        key: IGlobalKey<IState<IStatefulWidget>>
    ): void {
    ...
    private readonly _dart_createState: () => IState<IRawAutocomplete<T>> =
        undefined as any;

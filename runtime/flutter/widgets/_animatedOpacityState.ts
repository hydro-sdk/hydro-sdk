...
import { IAnimatedOpacity } from "./animatedOpacity";
...
widgets: {
_animatedOpacityState: (this: void, _animatedOpacityState: I_AnimatedOpacityState) => I_AnimatedOpacityState
}
};
export interface I_AnimatedOpacityState
...
getHashCode: () => number;
}export class _AnimatedOpacityState

 implements Omit<IImplicitlyAnimatedWidgetState<IAnimatedOpacity>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<IAnimatedOpacity>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedOpacityState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedOpacity = undefined as any;
...
public getWidget() : IAnimatedOpacity {

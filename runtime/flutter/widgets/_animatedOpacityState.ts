...
declare const flutter: {
    widgets: {
        _animatedOpacityState: (
            this: void,
            _animatedOpacityState: I_AnimatedOpacityState
        ) => I_AnimatedOpacityState;
    };
};
...
export class _AnimatedOpacityState
    implements
        Omit<
            IImplicitlyAnimatedWidgetState<IAnimatedOpacity>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IAnimatedOpacity>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {

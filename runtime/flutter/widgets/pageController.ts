...
widgets: {
pageController: (this: void, pageController: IPageController, props : {  initialPage : number, keepPage : boolean, viewportFraction : number,}) => IPageController
}
};
...
animateToPage: (page: number, props : {  curve : ICurve, duration : IDuration,}) => IFuture<void>;
jumpToPage: (page: number) => void;
nextPage: ( props : {  curve : ICurve, duration : IDuration,}) => IFuture<void>;
previousPage: ( props : {  curve : ICurve, duration : IDuration,}) => IFuture<void>;
...
public constructor( props : {  initialPage? : number, keepPage? : boolean, viewportFraction? : number,}){
...
...props
    ...
    private readonly _dart_animateToPage: (page: number, props : {  curve : ICurve, duration : IDuration,}) => IFuture<void> = undefined as any;
    private readonly _dart_jumpToPage: (page: number) => void = undefined as any;
    private readonly _dart_nextPage: ( props : {  curve : ICurve, duration : IDuration,}) => IFuture<void> = undefined as any;
    private readonly _dart_previousPage: ( props : {  curve : ICurve, duration : IDuration,}) => IFuture<void> = undefined as any;
...
public animateToPage(page: number, props : {  curve : ICurve, duration : IDuration,}) : IFuture<void> {
    return this._dart_animateToPage(page, props);
}
public jumpToPage(page: number) : void {
    return this._dart_jumpToPage(page);
}
public nextPage( props : {  curve : ICurve, duration : IDuration,}) : IFuture<void> {
    return this._dart_nextPage(props);
}
public previousPage( props : {  curve : ICurve, duration : IDuration,}) : IFuture<void> {

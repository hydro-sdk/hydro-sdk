...
widgets: {
textSelectionGestureDetectorBuilder: (this: void, textSelectionGestureDetectorBuilder: ITextSelectionGestureDetectorBuilder, props : {  delegate : ITextSelectionGestureDetectorBuilderDelegate,}) => ITextSelectionGestureDetectorBuilder
}
};
...
onDragSelectionUpdate: (startDetails: IDragStartDetails, updateDetails: IDragUpdateDetails) => void;
onDragSelectionEnd: (details: IDragEndDetails) => void;
buildGestureDetector: ( props : {  behavior? : HitTestBehavior | undefined, key? : IKey | undefined, child : IWidget,}) => IWidget;
}export class TextSelectionGestureDetectorBuilder


{    public readonly delegate: ITextSelectionGestureDetectorBuilderDelegate = undefined as any;
public constructor( props : {  delegate : ITextSelectionGestureDetectorBuilderDelegate,}){
flutter.widgets.textSelectionGestureDetectorBuilder(this, props);}
    private readonly _dart_getShouldShowSelectionToolbar: () => boolean = undefined as any;
    private readonly _dart_getEditableText: () => IEditableTextState = undefined as any;
    private readonly _dart_getRenderEditable: () => IRenderEditable = undefined as any;
    private readonly _dart_onTapDown: (details: ITapDownDetails) => void = undefined as any;
    private readonly _dart_onForcePressStart: (details: IForcePressDetails) => void = undefined as any;
    private readonly _dart_onForcePressEnd: (details: IForcePressDetails) => void = undefined as any;
    private readonly _dart_onSingleTapUp: (details: ITapUpDetails) => void = undefined as any;
    private readonly _dart_onSingleTapCancel: () => void = undefined as any;
    private readonly _dart_onSingleLongTapStart: (details: ILongPressStartDetails) => void = undefined as any;
    private readonly _dart_onSingleLongTapMoveUpdate: (details: ILongPressMoveUpdateDetails) => void = undefined as any;
    private readonly _dart_onSingleLongTapEnd: (details: ILongPressEndDetails) => void = undefined as any;
    private readonly _dart_onSecondaryTap: () => void = undefined as any;
    private readonly _dart_onSecondaryTapDown: (details: ITapDownDetails) => void = undefined as any;
    private readonly _dart_onDoubleTapDown: (details: ITapDownDetails) => void = undefined as any;
    private readonly _dart_onDragSelectionStart: (details: IDragStartDetails) => void = undefined as any;
    private readonly _dart_onDragSelectionUpdate: (startDetails: IDragStartDetails, updateDetails: IDragUpdateDetails) => void = undefined as any;
    private readonly _dart_onDragSelectionEnd: (details: IDragEndDetails) => void = undefined as any;
    private readonly _dart_buildGestureDetector: ( props : {  behavior? : HitTestBehavior | undefined, key? : IKey | undefined, child : IWidget,}) => IWidget = undefined as any;
...
public onSingleLongTapMoveUpdate(details: ILongPressMoveUpdateDetails) : void {
...
public onDragSelectionUpdate(startDetails: IDragStartDetails, updateDetails: IDragUpdateDetails) : void {
...
public buildGestureDetector( props : {  behavior? : HitTestBehavior | undefined, key? : IKey | undefined, child : IWidget,}) : IWidget {

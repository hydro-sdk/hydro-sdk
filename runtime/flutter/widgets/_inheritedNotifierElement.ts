...
widgets: {
_inheritedNotifierElement: <T>(this: void, _inheritedNotifierElement: I_InheritedNotifierElement<T>, widget: IInheritedNotifier<T>) => I_InheritedNotifierElement<T>
}
};
export interface I_InheritedNotifierElement
<T>

{
getWidget: () => IInheritedNotifier<T>;
update: (newWidget: unknown) => void;
build: () => IWidget;
notifyClients: (oldWidget: unknown) => void;
unmount: () => void;
debugDeactivated: () => void;
getDependencies: (dependent: IElement) => Object | undefined;
setDependencies: (dependent: IElement, value?: Object | undefined) => void;
updateDependencies: (dependent: IElement, aspect?: Object | undefined) => void;
notifyDependent: (oldWidget: unknown, dependent: IElement) => void;
...
}export class _InheritedNotifierElement
<T>
 implements IInheritedElement, IDiagnosticable, IBuildContext
{public constructor(widget: IInheritedNotifier<T>){
flutter.widgets._inheritedNotifierElement(this, widget);}
    private readonly _dart_getWidget: () => IInheritedNotifier<T> = undefined as any;
    private readonly _dart_update: (newWidget: any) => void = undefined as any;
    private readonly _dart_build: () => IWidget = undefined as any;
    private readonly _dart_notifyClients: (oldWidget: any) => void = undefined as any;
    private readonly _dart_unmount: () => void = undefined as any;
    private readonly _dart_debugDeactivated: () => void = undefined as any;
    private readonly _dart_getDependencies: (dependent: IElement) => Object | undefined = undefined as any;
    private readonly _dart_setDependencies: (dependent: IElement, value?: Object | undefined) => void = undefined as any;
    private readonly _dart_updateDependencies: (dependent: IElement, aspect?: Object | undefined) => void = undefined as any;
    private readonly _dart_notifyDependent: (oldWidget: any, dependent: IElement) => void = undefined as any;
...
public getWidget() : IInheritedNotifier<T> {
...
public getDependencies(dependent: IElement) : Object | undefined {
    return this._dart_getDependencies(dependent);
}
public setDependencies(dependent: IElement, value?: Object | undefined) : void {
    return this._dart_setDependencies(dependent, value);
}
public updateDependencies(dependent: IElement, aspect?: Object | undefined) : void {
    return this._dart_updateDependencies(dependent, aspect);
}
public notifyDependent(oldWidget: any, dependent: IElement) : void {
    return this._dart_notifyDependent(oldWidget, dependent);
}

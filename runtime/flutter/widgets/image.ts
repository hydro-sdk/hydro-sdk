...
widgets: {
image: (this: void, image: IImage, props : {  alignment : IAlignmentGeometry, centerSlice? : IRect | undefined, color? : IColor | undefined, colorBlendMode? : BlendMode | undefined, errorBuilder? : (context: IBuildContext, error: Object, stackTrace?: IStackTrace | undefined) => IWidget | undefined, excludeFromSemantics : boolean, filterQuality : FilterQuality, fit? : BoxFit | undefined, frameBuilder? : (context: IBuildContext, child: IWidget, frame: number | undefined, wasSynchronouslyLoaded: boolean) => IWidget | undefined, gaplessPlayback : boolean, height? : number | undefined, isAntiAlias : boolean, key? : IKey | undefined, loadingBuilder? : (context: IBuildContext, child: IWidget, loadingProgress?: IImageChunkEvent | undefined) => IWidget | undefined, matchTextDirection : boolean, opacity? : IAnimation<number> | undefined, repeat : ImageRepeat, semanticLabel? : string | undefined, width? : number | undefined, image : IImageProvider<Object>,}) => IImage
}
};

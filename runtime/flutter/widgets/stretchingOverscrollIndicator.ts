...
declare const flutter: {
    widgets: {
        stretchingOverscrollIndicator: (
            this: void,
            stretchingOverscrollIndicator: IStretchingOverscrollIndicator,
            props: {
        ...
        ) => IStretchingOverscrollIndicator;
    };
};
    ...
    implements IStatefulWidget, IDiagnosticable
{
    ...
    private readonly _dart_createState: () => IState<IStretchingOverscrollIndicator> =
        undefined as any;

...
import { IRenderSliver } from "../rendering/renderSliver";
...
import { GrowthDirection } from "../rendering/growthDirection";
import { ISliverGeometry } from "../rendering/sliverGeometry";
import { IOffset } from "../../dart/ui/offset";
import { IMatrix4 } from "../../vector_math/matrix4";
import { IDiagnosticPropertiesBuilder } from "../foundation/diagnosticPropertiesBuilder";
import { IIterable } from "../../dart/core/iterable";
import { IRenderAbstractViewport } from "../rendering/renderAbstractViewport";
...
import { IRevealedOffset } from "../rendering/revealedOffset";
...
widgets: {
renderNestedScrollViewViewport: (this: void, renderNestedScrollViewViewport: IRenderNestedScrollViewViewport, props : {  anchor : number, axisDirection : AxisDirection, center? : IRenderSliver | undefined, children? : IList<IRenderSliver> | undefined, clipBehavior : Clip, crossAxisDirection : AxisDirection, handle : ISliverOverlapAbsorberHandle, offset : IViewportOffset,}) => IRenderNestedScrollViewViewport
}
};
export interface IRenderNestedScrollViewViewport


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getHandle: () => ISliverOverlapAbsorberHandle;
setHandle: (value: ISliverOverlapAbsorberHandle) => void;
markNeedsLayout: () => void;
debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void;
setupParentData: (child: unknown) => void;
computeDryLayout: (constraints: IBoxConstraints) => ISize;
performLayout: () => void;
updateOutOfBandData: (growthDirection: GrowthDirection, childLayoutGeometry: ISliverGeometry) => void;
updateChildLayoutOffset: (child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) => void;
paintOffsetOf: (child: IRenderSliver) => IOffset;
scrollOffsetOf: (child: IRenderSliver, scrollOffsetWithinChild: number) => number;
maxScrollObstructionExtentBefore: (child: IRenderSliver) => number;
applyPaintTransform: (child: unknown, transform: IMatrix4) => void;
computeChildMainAxisPosition: (child: IRenderSliver, parentMainAxisPosition: number) => number;
...
layoutChildSequence: ( props : {  advance : (child: IRenderSliver) => IRenderSliver | undefined, cacheOrigin : number, child? : IRenderSliver | undefined, crossAxisExtent : number, growthDirection : GrowthDirection, layoutOffset : number, mainAxisExtent : number, overlap : number, remainingCacheExtent : number, remainingPaintExtent : number, scrollOffset : number,}) => number;
...
getOffsetToReveal: (target: IRenderObject, alignment: number, props? : {  rect? : IRect | undefined,}) => IRevealedOffset;
computeAbsolutePaintOffset: (child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) => IOffset;
...
insert: (child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) => void;
add: (child: IRenderSliver) => void;
addAll: (children?: IList<IRenderSliver> | undefined) => void;
remove: (child: IRenderSliver) => void;
removeAll: () => void;
move: (child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) => void;
...
getHashCode: () => number;
}export class RenderNestedScrollViewViewport

 implements IRenderViewport, IContainerRenderObjectMixin<IRenderSliver,ISliverPhysicalContainerParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  anchor? : number, axisDirection? : AxisDirection, center? : IRenderSliver | undefined, children? : IList<IRenderSliver> | undefined, clipBehavior? : Clip, crossAxisDirection : AxisDirection, handle : ISliverOverlapAbsorberHandle, offset : IViewportOffset,}){
flutter.widgets.renderNestedScrollViewViewport(this, {
...renderNestedScrollViewViewportDefaultProps,
...props
});}
    private readonly _dart_getHandle: () => ISliverOverlapAbsorberHandle = undefined as any;
    private readonly _dart_setHandle: (value: ISliverOverlapAbsorberHandle) => void = undefined as any;
    ...
    private readonly _dart_updateOutOfBandData: (growthDirection: GrowthDirection, childLayoutGeometry: ISliverGeometry) => void = undefined as any;
    private readonly _dart_updateChildLayoutOffset: (child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) => void = undefined as any;
    private readonly _dart_paintOffsetOf: (child: IRenderSliver) => IOffset = undefined as any;
    private readonly _dart_scrollOffsetOf: (child: IRenderSliver, scrollOffsetWithinChild: number) => number = undefined as any;
    private readonly _dart_maxScrollObstructionExtentBefore: (child: IRenderSliver) => number = undefined as any;
    private readonly _dart_applyPaintTransform: (child: any, transform: IMatrix4) => void = undefined as any;
    private readonly _dart_computeChildMainAxisPosition: (child: IRenderSliver, parentMainAxisPosition: number) => number = undefined as any;
    private readonly _dart_labelForChild: (index: number) => string = undefined as any;
    private readonly _dart_getAnchor: () => number = undefined as any;
    private readonly _dart_setAnchor: (value: number) => void = undefined as any;
    private readonly _dart_getCenter: () => IRenderSliver | undefined = undefined as any;
    private readonly _dart_setCenter: (value?: IRenderSliver | undefined) => void = undefined as any;
    private readonly _dart_getSizedByParent: () => boolean = undefined as any;
    private readonly _dart_getHasVisualOverflow: () => boolean = undefined as any;
    private readonly _dart_getIndexOfFirstChild: () => number = undefined as any;
    private readonly _dart_getChildrenInPaintOrder: () => IIterable<IRenderSliver> = undefined as any;
    private readonly _dart_getChildrenInHitTestOrder: () => IIterable<IRenderSliver> = undefined as any;
    ...
    private readonly _dart_debugThrowIfNotCheckingIntrinsics: () => boolean = undefined as any;
    ...
    private readonly _dart_layoutChildSequence: ( props : {  advance : (child: IRenderSliver) => IRenderSliver | undefined, cacheOrigin : number, child? : IRenderSliver | undefined, crossAxisExtent : number, growthDirection : GrowthDirection, layoutOffset : number, mainAxisExtent : number, overlap : number, remainingCacheExtent : number, remainingPaintExtent : number, scrollOffset : number,}) => number = undefined as any;
    private readonly _dart_describeApproximatePaintClip: (child: any) => IRect = undefined as any;
    private readonly _dart_describeSemanticsClip: (child: any) => IRect = undefined as any;
    ...
    private readonly _dart_getOffsetToReveal: (target: IRenderObject, alignment: number, props? : {  rect? : IRect | undefined,}) => IRevealedOffset = undefined as any;
    private readonly _dart_computeAbsolutePaintOffset: (child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) => IOffset = undefined as any;
    ...
    private readonly _dart_setAxisDirection: (value: AxisDirection) => void = undefined as any;
    private readonly _dart_getCrossAxisDirection: () => AxisDirection = undefined as any;
    private readonly _dart_setCrossAxisDirection: (value: AxisDirection) => void = undefined as any;
    ...
    private readonly _dart_getCacheExtent: () => number | undefined = undefined as any;
    private readonly _dart_setCacheExtent: (value?: number | undefined) => void = undefined as any;
    private readonly _dart_getCacheExtentStyle: () => CacheExtentStyle = undefined as any;
    private readonly _dart_setCacheExtentStyle: (value: CacheExtentStyle) => void = undefined as any;
    ...
    private readonly _dart_insert: (child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) => void = undefined as any;
    private readonly _dart_add: (child: IRenderSliver) => void = undefined as any;
    private readonly _dart_addAll: (children?: IList<IRenderSliver> | undefined) => void = undefined as any;
    private readonly _dart_remove: (child: IRenderSliver) => void = undefined as any;
    private readonly _dart_removeAll: () => void = undefined as any;
    private readonly _dart_move: (child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) => void = undefined as any;
    ...
    private readonly _dart_childBefore: (child: IRenderSliver) => IRenderSliver | undefined = undefined as any;
    private readonly _dart_childAfter: (child: IRenderSliver) => IRenderSliver | undefined = undefined as any;
    private readonly _dart_getChildCount: () => number = undefined as any;
    private readonly _dart_getFirstChild: () => IRenderSliver | undefined = undefined as any;
    private readonly _dart_getLastChild: () => IRenderSliver | undefined = undefined as any;
...
public getHandle() : ISliverOverlapAbsorberHandle {
    return this._dart_getHandle();
}
public setHandle(value: ISliverOverlapAbsorberHandle) : void {
    return this._dart_setHandle(value);
}
...
public updateOutOfBandData(growthDirection: GrowthDirection, childLayoutGeometry: ISliverGeometry) : void {
    return this._dart_updateOutOfBandData(growthDirection, childLayoutGeometry);
}
public updateChildLayoutOffset(child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) : void {
    return this._dart_updateChildLayoutOffset(child, layoutOffset, growthDirection);
}
public paintOffsetOf(child: IRenderSliver) : IOffset {
    return this._dart_paintOffsetOf(child);
}
public scrollOffsetOf(child: IRenderSliver, scrollOffsetWithinChild: number) : number {
...
public computeChildMainAxisPosition(child: IRenderSliver, parentMainAxisPosition: number) : number {
    return this._dart_computeChildMainAxisPosition(child, parentMainAxisPosition);
}
...
public layoutChildSequence( props : {  advance : (child: IRenderSliver) => IRenderSliver | undefined, cacheOrigin : number, child? : IRenderSliver | undefined, crossAxisExtent : number, growthDirection : GrowthDirection, layoutOffset : number, mainAxisExtent : number, overlap : number, remainingCacheExtent : number, remainingPaintExtent : number, scrollOffset : number,}) : number {
...
public getOffsetToReveal(target: IRenderObject, alignment: number, props? : {  rect? : IRect | undefined,}) : IRevealedOffset {
    return this._dart_getOffsetToReveal(target, alignment, props);
}
public computeAbsolutePaintOffset(child: IRenderSliver, layoutOffset: number, growthDirection: GrowthDirection) : IOffset {
    return this._dart_computeAbsolutePaintOffset(child, layoutOffset, growthDirection);
}
...
public insert(child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) : void {
...
public move(child: IRenderSliver, props? : {  after? : IRenderSliver | undefined,}) : void {
...
const renderNestedScrollViewViewportDefaultProps = {
    anchor: 0.0,

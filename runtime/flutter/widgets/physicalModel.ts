...
import { IRenderPhysicalModel } from "../rendering/renderPhysicalModel";
...
widgets: {
physicalModel: (this: void, physicalModel: IPhysicalModel, props : {  borderRadius? : IBorderRadius | undefined, child? : IWidget | undefined, clipBehavior : Clip, elevation : number, key? : IKey | undefined, shadowColor : IColor, shape : BoxShape, color : IColor,}) => IPhysicalModel
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderPhysicalModel;
...
public constructor( props : {  borderRadius? : IBorderRadius | undefined, child? : IWidget | undefined, clipBehavior? : Clip, elevation? : number, key? : IKey | undefined, shadowColor? : IColor, shape? : BoxShape, color : IColor,}){
flutter.widgets.physicalModel(this, {
...physicalModelDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderPhysicalModel = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderPhysicalModel {
...
const physicalModelDefaultProps = {

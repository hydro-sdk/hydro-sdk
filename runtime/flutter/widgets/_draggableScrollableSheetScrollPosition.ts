...
declare const flutter: {
    widgets: {
        _draggableScrollableSheetScrollPosition: (
            this: void,
            _draggableScrollableSheetScrollPosition: I_DraggableScrollableSheetScrollPosition,
            props: {
        ...
        ) => I_DraggableScrollableSheetScrollPosition;
    };
};
        ...
        IListenable
{
    ...
    private readonly _dart_getListShouldScroll: () => boolean =
        undefined as any;
    private readonly _dart_getExtent: () => I_DraggableSheetExtent =
        undefined as any;

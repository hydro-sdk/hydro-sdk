...
widgets: {
_draggableScrollableSheetScrollPosition: (this: void, _draggableScrollableSheetScrollPosition: I_DraggableScrollableSheetScrollPosition, props : {  debugLabel? : string | undefined, initialPixels : number, keepScrollOffset : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, getExtent : () => I_DraggableSheetExtent, physics : IScrollPhysics,}) => I_DraggableScrollableSheetScrollPosition
}
};
export interface I_DraggableScrollableSheetScrollPosition
...
getListShouldScroll: () => boolean;
getExtent: () => I_DraggableSheetExtent;
beginActivity: (newActivity?: IScrollActivity | undefined) => void;
applyContentDimensions: (minScrollSize: number, maxScrollSize: number) => boolean;
...
getHashCode: () => number;
}export class _DraggableScrollableSheetScrollPosition

 implements IScrollPositionWithSingleContext, IScrollMetrics, IScrollActivityDelegate, IListenable
...
public constructor( props : {  debugLabel? : string | undefined, initialPixels? : number, keepScrollOffset? : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, getExtent : () => I_DraggableSheetExtent, physics : IScrollPhysics,}){
flutter.widgets._draggableScrollableSheetScrollPosition(this, {
..._draggableScrollableSheetScrollPositionDefaultProps,
...props
});}
    private readonly _dart_getListShouldScroll: () => boolean = undefined as any;
    private readonly _dart_getExtent: () => I_DraggableSheetExtent = undefined as any;
    private readonly _dart_beginActivity: (newActivity?: IScrollActivity | undefined) => void = undefined as any;
    private readonly _dart_applyContentDimensions: (minScrollSize: number, maxScrollSize: number) => boolean = undefined as any;
...
public getListShouldScroll() : boolean {
    return this._dart_getListShouldScroll();
}
public getExtent() : I_DraggableSheetExtent {
...
public applyContentDimensions(minScrollSize: number, maxScrollSize: number) : boolean {
    return this._dart_applyContentDimensions(minScrollSize, maxScrollSize);
}
...
const _draggableScrollableSheetScrollPositionDefaultProps = {
    initialPixels: 0.0,

...
widgets: {
singleActivator: (this: void, singleActivator: ISingleActivator, trigger: ILogicalKeyboardKey, props : {  alt : boolean, control : boolean, meta : boolean, shift : boolean,}) => ISingleActivator
}
};
...
public constructor(trigger: ILogicalKeyboardKey, props : {  alt? : boolean, control? : boolean, meta? : boolean, shift? : boolean,}){

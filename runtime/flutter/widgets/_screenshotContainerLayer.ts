...
widgets: {
_screenshotContainerLayer: (this: void, _screenshotContainerLayer: I_ScreenshotContainerLayer) => I_ScreenshotContainerLayer
}
};
export interface I_ScreenshotContainerLayer
...
getAttached: () => boolean;
getHashCode: () => number;
}export class _ScreenshotContainerLayer
...
public constructor(){
flutter.widgets._screenshotContainerLayer(this);}

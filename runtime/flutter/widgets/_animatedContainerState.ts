...
import { IAnimatedContainer } from "./animatedContainer";
...
widgets: {
_animatedContainerState: (this: void, _animatedContainerState: I_AnimatedContainerState) => I_AnimatedContainerState
}
};
export interface I_AnimatedContainerState
...
getHashCode: () => number;
}export class _AnimatedContainerState

 implements IAnimatedWidgetBaseState<IAnimatedContainer>, ISingleTickerProviderStateMixin<IAnimatedContainer>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedContainerState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedContainer = undefined as any;
...
public getWidget() : IAnimatedContainer {

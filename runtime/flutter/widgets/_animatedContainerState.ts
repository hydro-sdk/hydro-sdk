...
declare const flutter: {
    widgets: {
        _animatedContainerState: (
            this: void,
            _animatedContainerState: I_AnimatedContainerState
        ) => I_AnimatedContainerState;
    };
};
...
export class _AnimatedContainerState
    implements
        IAnimatedWidgetBaseState<IAnimatedContainer>,
        ISingleTickerProviderStateMixin<IAnimatedContainer>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedContainer =
        undefined as any;

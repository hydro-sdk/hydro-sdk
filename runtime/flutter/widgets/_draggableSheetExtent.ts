...
widgets: {
_draggableSheetExtent: (this: void, _draggableSheetExtent: I_DraggableSheetExtent, props : {  currentSize? : IValueNotifier<number> | undefined, hasChanged? : boolean | undefined, initialSize : number, maxSize : number, minSize : number, onSizeChanged : () => void, snap : boolean, snapSizes : IList<number>,}) => I_DraggableSheetExtent
}
};
...
dispose: () => void;
copyWith: ( props : {  initialSize : number, maxSize : number, minSize : number, onSizeChanged : () => void, snap : boolean, snapSizes : IList<number>,}) => I_DraggableSheetExtent;
...
public constructor( props : {  currentSize? : IValueNotifier<number> | undefined, hasChanged? : boolean | undefined, initialSize : number, maxSize : number, minSize : number, onSizeChanged : () => void, snap : boolean, snapSizes : IList<number>,}){
flutter.widgets._draggableSheetExtent(this, props);}
    ...
    private readonly _dart_setCurrentSize: (value: number) => void = undefined as any;
    ...
    private readonly _dart_getAdditionalMinSize: () => number = undefined as any;
    private readonly _dart_getAdditionalMaxSize: () => number = undefined as any;
    private readonly _dart_getPixelSnapSizes: () => IList<number> = undefined as any;
    private readonly _dart_addPixelDelta: (delta: number, context: IBuildContext) => void = undefined as any;
    private readonly _dart_updateSize: (newSize: number, context: IBuildContext) => void = undefined as any;
    private readonly _dart_pixelsToSize: (pixels: number) => number = undefined as any;
    private readonly _dart_sizeToPixels: (extent: number) => number = undefined as any;
    private readonly _dart_dispose: () => void = undefined as any;
    private readonly _dart_copyWith: ( props : {  initialSize : number, maxSize : number, minSize : number, onSizeChanged : () => void, snap : boolean, snapSizes : IList<number>,}) => I_DraggableSheetExtent = undefined as any;
...
public copyWith( props : {  initialSize : number, maxSize : number, minSize : number, onSizeChanged : () => void, snap : boolean, snapSizes : IList<number>,}) : I_DraggableSheetExtent {

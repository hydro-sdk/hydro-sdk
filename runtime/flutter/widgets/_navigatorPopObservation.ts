...
declare const flutter: {
    widgets: {
        _navigatorPopObservation: (
            this: void,
            _navigatorPopObservation: I_NavigatorPopObservation,
            primaryRoute: IRoute<any>,
            secondaryRoute?: IRoute<any> | undefined
        ) => I_NavigatorPopObservation;
    };
};
...
export class _NavigatorPopObservation implements I_NavigatorObservation {
    ...
    public constructor(
        ...
        flutter.widgets._navigatorPopObservation(
            this,
            primaryRoute,
            secondaryRoute
        );

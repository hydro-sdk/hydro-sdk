...
import { I_RenderScrollSemantics } from "./_renderScrollSemantics";
...
widgets: {
_scrollSemantics: (this: void, _scrollSemantics: I_ScrollSemantics, props : {  child? : IWidget | undefined, key? : IKey | undefined, allowImplicitScrolling : boolean, position : IScrollPosition, semanticChildCount? : number | undefined,}) => I_ScrollSemantics
}
};
export interface I_ScrollSemantics
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => I_RenderScrollSemantics;
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, allowImplicitScrolling : boolean, position : IScrollPosition, semanticChildCount? : number | undefined,}){
flutter.widgets._scrollSemantics(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => I_RenderScrollSemantics = undefined as any;
...
public createRenderObject(context: IBuildContext) : I_RenderScrollSemantics {

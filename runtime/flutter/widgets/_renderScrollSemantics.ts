...
widgets: {
_renderScrollSemantics: (this: void, _renderScrollSemantics: I_RenderScrollSemantics, props : {  child? : IRenderBox | undefined, allowImplicitScrolling : boolean, position : IScrollPosition, semanticChildCount? : number | undefined,}) => I_RenderScrollSemantics
}
};
export interface I_RenderScrollSemantics
...
setPosition: (value: IScrollPosition) => void;
getAllowImplicitScrolling: () => boolean;
setAllowImplicitScrolling: (value: boolean) => void;
getSemanticChildCount: () => number | undefined;
setSemanticChildCount: (value?: number | undefined) => void;
...
getHashCode: () => number;
}export class _RenderScrollSemantics
...
public constructor( props : {  child? : IRenderBox | undefined, allowImplicitScrolling : boolean, position : IScrollPosition, semanticChildCount? : number | undefined,}){
flutter.widgets._renderScrollSemantics(this, props);}
    private readonly _dart_getPosition: () => IScrollPosition = undefined as any;
    private readonly _dart_setPosition: (value: IScrollPosition) => void = undefined as any;
    private readonly _dart_getAllowImplicitScrolling: () => boolean = undefined as any;
    private readonly _dart_setAllowImplicitScrolling: (value: boolean) => void = undefined as any;
    private readonly _dart_getSemanticChildCount: () => number | undefined = undefined as any;
    private readonly _dart_setSemanticChildCount: (value?: number | undefined) => void = undefined as any;
...
public setPosition(value: IScrollPosition) : void {
    return this._dart_setPosition(value);
}
public getAllowImplicitScrolling() : boolean {
    return this._dart_getAllowImplicitScrolling();
}
public setAllowImplicitScrolling(value: boolean) : void {
    return this._dart_setAllowImplicitScrolling(value);
}
public getSemanticChildCount() : number | undefined {
    return this._dart_getSemanticChildCount();
}
public setSemanticChildCount(value?: number | undefined) : void {
    return this._dart_setSemanticChildCount(value);
}

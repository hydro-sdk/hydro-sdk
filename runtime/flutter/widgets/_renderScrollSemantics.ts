...
declare const flutter: {
    widgets: {
        _renderScrollSemantics: (
            this: void,
            _renderScrollSemantics: I_RenderScrollSemantics,
            props: {
        ...
        >
{
    ...
    private readonly _dart_getPosition: () => IScrollPosition =
        undefined as any;
    private readonly _dart_setPosition: (value: IScrollPosition) => void =
        undefined as any;
    private readonly _dart_getAllowImplicitScrolling: () => boolean =
        undefined as any;
    private readonly _dart_setAllowImplicitScrolling: (value: boolean) => void =
        undefined as any;
    private readonly _dart_getSemanticChildCount: () => number | undefined =
        undefined as any;
    private readonly _dart_setSemanticChildCount: (

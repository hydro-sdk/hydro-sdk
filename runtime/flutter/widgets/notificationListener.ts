...
declare const flutter: {
    widgets: {
        notificationListener: <T>(
            this: void,
            notificationListener: INotificationListener<T>,
            props: {
                key?: IKey | undefined;
                onNotification?: (notification: T) => boolean | undefined;
                child: IWidget;
            }
        ) => INotificationListener<T>;
    };
};
export interface INotificationListener<T> {
    child: IWidget;
    key: IKey | undefined;
...
export class NotificationListener<T>
    implements IStatelessWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.widgets.notificationListener(this, props);
    }

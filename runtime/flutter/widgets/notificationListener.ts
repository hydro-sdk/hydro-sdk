...
widgets: {
notificationListener: <T>(this: void, notificationListener: INotificationListener<T>, props : {  key? : IKey | undefined, onNotification? : (notification: T) => boolean | undefined, child : IWidget,}) => INotificationListener<T>
}
};
...
public constructor( props : {  key? : IKey | undefined, onNotification? : (notification: T) => boolean | undefined, child : IWidget,}){

...
widgets: {
sliverGrid: (this: void, sliverGrid: ISliverGrid, props : {  key? : IKey | undefined, delegate : ISliverChildDelegate, gridDelegate : ISliverGridDelegate,}) => ISliverGrid
}
};
...
estimateMaxScrollOffset: (constraints: ISliverConstraints | undefined, firstIndex: number, lastIndex: number, leadingScrollOffset: number, trailingScrollOffset: number) => number;
...
public constructor( props : {  key? : IKey | undefined, delegate : ISliverChildDelegate, gridDelegate : ISliverGridDelegate,}){
flutter.widgets.sliverGrid(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverGrid = undefined as any;
    private readonly _dart_updateRenderObject: (context: IBuildContext, renderObject: any) => void = undefined as any;
    private readonly _dart_estimateMaxScrollOffset: (constraints: ISliverConstraints | undefined, firstIndex: number, lastIndex: number, leadingScrollOffset: number, trailingScrollOffset: number) => number = undefined as any;
...
public estimateMaxScrollOffset(constraints: ISliverConstraints | undefined, firstIndex: number, lastIndex: number, leadingScrollOffset: number, trailingScrollOffset: number) : number {

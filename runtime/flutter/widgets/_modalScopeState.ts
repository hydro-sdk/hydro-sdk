...
widgets: {
_modalScopeState: <T>(this: void, _modalScopeState: I_ModalScopeState<T>) => I_ModalScopeState<T>
}
};
export interface I_ModalScopeState
<T>
...
getHashCode: () => number;
}export class _ModalScopeState
<T>
 implements Omit<IState<I_ModalScope<T>>, "debugFillProperties">, IDiagnosticable
{    public readonly focusScopeNode: IFocusScopeNode = undefined as any;
    public readonly primaryScrollController: IScrollController = undefined as any;
public constructor(){

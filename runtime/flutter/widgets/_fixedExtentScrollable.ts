...
widgets: {
_fixedExtentScrollable: (this: void, _fixedExtentScrollable: I_FixedExtentScrollable, props : {  axisDirection : AxisDirection, controller? : IScrollController | undefined, key? : IKey | undefined, physics? : IScrollPhysics | undefined, restorationId? : string | undefined, scrollBehavior? : IScrollBehavior | undefined, itemExtent : number, viewportBuilder : (context: IBuildContext, position: IViewportOffset) => IWidget,}) => I_FixedExtentScrollable
}
};
...
viewportBuilder: (context: IBuildContext, position: IViewportOffset) => IWidget;
incrementCalculator: (details: IScrollIncrementDetails) => number | undefined;
...
}export class _FixedExtentScrollable

 implements IScrollable, IDiagnosticable
{    public readonly itemExtent: number = undefined as any;
    ...
    public readonly viewportBuilder: (context: IBuildContext, position: IViewportOffset) => IWidget = undefined as any;
    public readonly incrementCalculator: (details: IScrollIncrementDetails) => number | undefined = undefined as any;
...
...props
    ...
    private readonly _dart_createState: () => I_FixedExtentScrollableState = undefined as any;

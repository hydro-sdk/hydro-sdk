...
widgets: {
_directionalPolicyDataEntry: (this: void, _directionalPolicyDataEntry: I_DirectionalPolicyDataEntry, props : {  direction : TraversalDirection, node : IFocusNode,}) => I_DirectionalPolicyDataEntry
}
};
...
public constructor( props : {  direction : TraversalDirection, node : IFocusNode,}){

...
declare const flutter: {
    widgets: {
        constrainedLayoutBuilder: <ConstraintType>(
            this: void,
            constrainedLayoutBuilder: IConstrainedLayoutBuilder<ConstraintType>,
            props: {
                key?: IKey | undefined;
                builder: (__: ConstraintType) => IWidget;
            }
        ) => IConstrainedLayoutBuilder<ConstraintType>;
    };
};
export interface IConstrainedLayoutBuilder<ConstraintType> {
    key: IKey | undefined;
...
export class ConstrainedLayoutBuilder<ConstraintType>

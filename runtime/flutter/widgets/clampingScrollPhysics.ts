...
declare const flutter: {
    widgets: {
        clampingScrollPhysics: (
            this: void,
            clampingScrollPhysics: IClampingScrollPhysics,
            props?: { parent?: IScrollPhysics | undefined }
        ) => IClampingScrollPhysics;
    };
};
...
export class ClampingScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => IClampingScrollPhysics = undefined as any;

...
widgets: {
scrollNotification: (this: void, scrollNotification: IScrollNotification, props : {  context? : IBuildContext | undefined, metrics : IScrollMetrics,}) => IScrollNotification
}
};
...
public constructor( props : {  context? : IBuildContext | undefined, metrics : IScrollMetrics,}){

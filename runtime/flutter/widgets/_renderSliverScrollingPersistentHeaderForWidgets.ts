...
import { IRenderSliverScrollingPersistentHeader } from "../rendering/renderSliverScrollingPersistentHeader";
...
widgets: {
_renderSliverScrollingPersistentHeaderForWidgets: (this: void, _renderSliverScrollingPersistentHeaderForWidgets: I_RenderSliverScrollingPersistentHeaderForWidgets, props? : {  child? : IRenderBox | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined,}) => I_RenderSliverScrollingPersistentHeaderForWidgets
}
};
export interface I_RenderSliverScrollingPersistentHeaderForWidgets
...
getHashCode: () => number;
}export class _RenderSliverScrollingPersistentHeaderForWidgets

 implements IRenderSliverScrollingPersistentHeader, I_RenderSliverPersistentHeaderForWidgetsMixin, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props? : {  child? : IRenderBox | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined,}){
flutter.widgets._renderSliverScrollingPersistentHeaderForWidgets(this, props);}

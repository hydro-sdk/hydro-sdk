...
widgets: {
_dragItemProxy: (this: void, _dragItemProxy: I_DragItemProxy, props : {  key? : IKey | undefined, animation : IAnimationController, child : IWidget, index : number, listState : ISliverReorderableListState, position : IOffset, proxyDecorator? : (child: IWidget, index: number, animation: IAnimation<number>) => IWidget | undefined, size : ISize,}) => I_DragItemProxy
}
};
export interface I_DragItemProxy
...
{    public readonly listState: ISliverReorderableListState = undefined as any;
    ...
    public readonly animation: IAnimationController = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, animation : IAnimationController, child : IWidget, index : number, listState : ISliverReorderableListState, position : IOffset, proxyDecorator? : (child: IWidget, index: number, animation: IAnimation<number>) => IWidget | undefined, size : ISize,}){
flutter.widgets._dragItemProxy(this, props);}

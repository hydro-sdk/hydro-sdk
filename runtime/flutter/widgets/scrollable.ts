...
export class Scrollable implements IStatefulWidget, IDiagnosticable {
    ...
    public static recommendDeferredLoadingForContext(
        context: IBuildContext
    ): boolean {
        return flutter.widgets.scrollableRecommendDeferredLoadingForContext(
            context
        );
    }
    ...
    private readonly _dart_createState: () => IScrollableState =
        undefined as any;

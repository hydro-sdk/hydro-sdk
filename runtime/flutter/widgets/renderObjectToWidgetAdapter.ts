...
declare const flutter: {
    widgets: {
        renderObjectToWidgetAdapter: <T>(
            this: void,
            renderObjectToWidgetAdapter: IRenderObjectToWidgetAdapter<T>,
            props: {
                child?: IWidget | undefined;
                debugShortDescription?: string | undefined;
                container: IRenderObjectWithChildMixin<T>;
            }
        ) => IRenderObjectToWidgetAdapter<T>;
    };
};
export interface IRenderObjectToWidgetAdapter<T> {
    child: IWidget | undefined;
    container: IRenderObjectWithChildMixin<T>;
    debugShortDescription: string | undefined;
    key: IKey | undefined;
    ...
    ) => IRenderObjectWithChildMixin<T>;
    updateRenderObject: (context: IBuildContext, renderObject: unknown) => void;
    attachToRenderTree: (
        owner: IBuildOwner,
        element?: IRenderObjectToWidgetElement<T> | undefined
...
export class RenderObjectToWidgetAdapter<T>
    implements IRenderObjectWidget, IDiagnosticable
{
    public readonly child: IWidget | undefined = undefined as any;
    public readonly container: IRenderObjectWithChildMixin<T> =
        undefined as any;
    public readonly debugShortDescription: string | undefined =
        undefined as any;
    ...
    private readonly _dart_createElement: () => IRenderObjectToWidgetElement<T> =
        undefined as any;
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => IRenderObjectWithChildMixin<T> = undefined as any;
    private readonly _dart_updateRenderObject: (
        context: IBuildContext,
        renderObject: any
    ) => void = undefined as any;
    private readonly _dart_attachToRenderTree: (
        owner: IBuildOwner,
        element?: IRenderObjectToWidgetElement<T> | undefined
    ) => IRenderObjectToWidgetElement<T> = undefined as any;

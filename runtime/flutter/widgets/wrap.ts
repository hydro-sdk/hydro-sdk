...
widgets: {
wrap: (this: void, wrap: IWrap, props : {  alignment : WrapAlignment, children : IList<IWidget>, clipBehavior : Clip, crossAxisAlignment : WrapCrossAlignment, direction : Axis, key? : IKey | undefined, runAlignment : WrapAlignment, runSpacing : number, spacing : number, textDirection? : TextDirection | undefined, verticalDirection : VerticalDirection,}) => IWrap
}
};
...
public constructor( props : {  alignment? : WrapAlignment, children? : IList<IWidget>, clipBehavior? : Clip, crossAxisAlignment? : WrapCrossAlignment, direction? : Axis, key? : IKey | undefined, runAlignment? : WrapAlignment, runSpacing? : number, spacing? : number, textDirection? : TextDirection | undefined, verticalDirection? : VerticalDirection,}){
flutter.widgets.wrap(this, {
...wrapDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderWrap = undefined as any;

...
widgets: {
rawGestureDetectorState: (this: void, rawGestureDetectorState: IRawGestureDetectorState) => IRawGestureDetectorState
}
};
...
replaceGestureRecognizers: (gestures: IMap<Type, IGestureRecognizerFactory<IGestureRecognizer>>) => void;
...
getHashCode: () => number;
 ...
 implements Omit<IState<IRawGestureDetector>, "debugFillProperties">, IDiagnosticable
{public constructor(){
flutter.widgets.rawGestureDetectorState(this);}
    ...
    private readonly _dart_replaceGestureRecognizers: (gestures: IMap<Type, IGestureRecognizerFactory<IGestureRecognizer>>) => void = undefined as any;
    private readonly _dart_replaceSemanticsActions: (actions: ISet<ISemanticsAction>) => void = undefined as any;
    ...
    private readonly _dart_getWidget: () => IRawGestureDetector = undefined as any;
...
public replaceGestureRecognizers(gestures: IMap<Type, IGestureRecognizerFactory<IGestureRecognizer>>) : void {

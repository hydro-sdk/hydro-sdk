...
widgets: {
rawScrollbarState: <T>(this: void, rawScrollbarState: IRawScrollbarState<T>) => IRawScrollbarState<T>
}
};
export interface IRawScrollbarState
<T>
...
isPointerOverScrollbar: (position: IOffset, kind: PointerDeviceKind, props : {  forHover : boolean,}) => boolean;
...
getHashCode: () => number;
}export class RawScrollbarState
<T>
 implements Omit<IState<T>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ITickerProviderStateMixin<T>, IDiagnosticable, ITickerProvider
...
flutter.widgets.rawScrollbarState(this);}
    ...
    private readonly _dart_updateScrollbarPainter: () => void = undefined as any;
    private readonly _dart_didUpdateWidget: (oldWidget: any) => void = undefined as any;
    private readonly _dart_getScrollbarDirection: () => Axis | undefined = undefined as any;
    private readonly _dart_handleThumbPress: () => void = undefined as any;
    private readonly _dart_handleThumbPressStart: (localPosition: IOffset) => void = undefined as any;
    private readonly _dart_handleThumbPressUpdate: (localPosition: IOffset) => void = undefined as any;
    private readonly _dart_handleThumbPressEnd: (localPosition: IOffset, velocity: IVelocity) => void = undefined as any;
    private readonly _dart_isPointerOverTrack: (position: IOffset, kind: PointerDeviceKind) => boolean = undefined as any;
    private readonly _dart_isPointerOverThumb: (position: IOffset, kind: PointerDeviceKind) => boolean = undefined as any;
    private readonly _dart_isPointerOverScrollbar: (position: IOffset, kind: PointerDeviceKind, props : {  forHover : boolean,}) => boolean = undefined as any;
    private readonly _dart_handleHover: (event: IPointerHoverEvent) => void = undefined as any;
    private readonly _dart_handleHoverExit: (event: IPointerExitEvent) => void = undefined as any;
...
public handleThumbPressEnd(localPosition: IOffset, velocity: IVelocity) : void {
    return this._dart_handleThumbPressEnd(localPosition, velocity);
}
public isPointerOverTrack(position: IOffset, kind: PointerDeviceKind) : boolean {
    return this._dart_isPointerOverTrack(position, kind);
}
public isPointerOverThumb(position: IOffset, kind: PointerDeviceKind) : boolean {
    return this._dart_isPointerOverThumb(position, kind);
}
public isPointerOverScrollbar(position: IOffset, kind: PointerDeviceKind, props : {  forHover? : boolean,}) : boolean {

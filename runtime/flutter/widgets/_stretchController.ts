...
declare const flutter: {
    widgets: {
        _stretchController: (
            this: void,
            _stretchController: I_StretchController,
            props: { vsync: ITickerProvider }
        ) => I_StretchController;
    };
};
...
export class _StretchController implements IChangeNotifier, IListenable {
    ...
    private readonly _dart_absorbImpact: (velocity: number) => void =
        undefined as any;
    private readonly _dart_pull: (normalizedOverscroll: number) => void =
        undefined as any;

...
declare const flutter: {
    widgets: {
        callbackShortcuts: (
            this: void,
            callbackShortcuts: ICallbackShortcuts,
            props: {
                key?: IKey | undefined;
...
export class CallbackShortcuts implements IStatelessWidget, IDiagnosticable {
    public readonly bindings: IMap<IShortcutActivator, () => void> =
        undefined as any;

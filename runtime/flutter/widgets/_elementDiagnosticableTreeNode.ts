...
widgets: {
_elementDiagnosticableTreeNode: (this: void, _elementDiagnosticableTreeNode: I_ElementDiagnosticableTreeNode, props : {  name? : string | undefined, stateful : boolean, style? : DiagnosticsTreeStyle | undefined, value : IElement,}) => I_ElementDiagnosticableTreeNode
}
};
...
getHashCode: () => number;
}export class _ElementDiagnosticableTreeNode

 implements IDiagnosticableTreeNode
...
public constructor( props : {  name? : string | undefined, stateful? : boolean, style? : DiagnosticsTreeStyle | undefined, value : IElement,}){

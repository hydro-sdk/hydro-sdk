...
declare const flutter: {
    widgets: {
        _focusWithExternalFocusNode: (
            this: void,
            _focusWithExternalFocusNode: I_FocusWithExternalFocusNode,
            props: {
                autofocus: boolean;
...
export class _FocusWithExternalFocusNode implements IFocus, IDiagnosticable {

...
export interface IOverlayState {
    ...
    insert: (
        entry: IOverlayEntry,
        props?: {
            above?: IOverlayEntry | undefined;
            below?: IOverlayEntry | undefined;
        }
    ) => void;
    insertAll: (
        entries: IIterable<IOverlayEntry>,
        props?: {
            above?: IOverlayEntry | undefined;
            below?: IOverlayEntry | undefined;
        }
    ...
    rearrange: (
        newEntries: IIterable<IOverlayEntry>,
        props?: {
            above?: IOverlayEntry | undefined;
            below?: IOverlayEntry | undefined;
        }
...
export class OverlayState
    implements
        ...
        >,
        ITickerProviderStateMixin<IOverlay>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_rearrange: (
        newEntries: IIterable<IOverlayEntry>,
        props?: {
            above?: IOverlayEntry | undefined;
            below?: IOverlayEntry | undefined;
    ...
    private readonly _dart_debugIsVisible: (entry: IOverlayEntry) => boolean =
        undefined as any;

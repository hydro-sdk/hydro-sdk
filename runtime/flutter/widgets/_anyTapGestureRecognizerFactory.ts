...
declare const flutter: {
    widgets: {
        _anyTapGestureRecognizerFactory: (
            this: void,
            _anyTapGestureRecognizerFactory: I_AnyTapGestureRecognizerFactory,
            props?: { onAnyTapUp?: () => void | undefined }
        ) => I_AnyTapGestureRecognizerFactory;
    };
};
    ...
    implements IGestureRecognizerFactory<I_AnyTapGestureRecognizer>
{
    ...
    private readonly _dart_constructor: () => I_AnyTapGestureRecognizer =
        undefined as any;
    private readonly _dart_initializer: (
        instance: I_AnyTapGestureRecognizer

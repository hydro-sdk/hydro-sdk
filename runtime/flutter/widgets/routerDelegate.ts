...
export interface IRouterDelegate<T> {
...
export class RouterDelegate<T> implements IListenable {
    public constructor() {
        flutter.widgets.routerDelegate(this);
    }
    private readonly _dart_setInitialRoutePath: (
        configuration: T
    ) => IFuture<void> = undefined as any;
    private readonly _dart_setRestoredRoutePath: (
        configuration: T
    ) => IFuture<void> = undefined as any;
    private readonly _dart_setNewRoutePath: (
        configuration: T
    ) => IFuture<void> = undefined as any;
    private readonly _dart_popRoute: () => IFuture<boolean> = undefined as any;
    private readonly _dart_getCurrentConfiguration: () => T | undefined =
        undefined as any;

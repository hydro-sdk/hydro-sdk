...
widgets: {
coloredBox: (this: void, coloredBox: IColoredBox, props : {  child? : IWidget | undefined, key? : IKey | undefined, color : IColor,}) => IColoredBox
}
};
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, color : IColor,}){
flutter.widgets.coloredBox(this, props);}

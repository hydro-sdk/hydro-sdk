...
widgets: {
scrollableDetails: (this: void, scrollableDetails: IScrollableDetails, props : {  controller : IScrollController, direction : AxisDirection,}) => IScrollableDetails
}
};
...
public constructor( props : {  controller : IScrollController, direction : AxisDirection,}){

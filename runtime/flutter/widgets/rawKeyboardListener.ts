...
widgets: {
rawKeyboardListener: (this: void, rawKeyboardListener: IRawKeyboardListener, props : {  autofocus : boolean, includeSemantics : boolean, key? : IKey | undefined, onKey? : (value: IRawKeyEvent) => void | undefined, child : IWidget, focusNode : IFocusNode,}) => IRawKeyboardListener
}
};
...
}export class RawKeyboardListener
...
public constructor( props : {  autofocus? : boolean, includeSemantics? : boolean, key? : IKey | undefined, onKey? : (value: IRawKeyEvent) => void | undefined, child : IWidget, focusNode : IFocusNode,}){
flutter.widgets.rawKeyboardListener(this, {
...rawKeyboardListenerDefaultProps,
...props
});}
    private readonly _dart_createState: () => IState<IRawKeyboardListener> = undefined as any;

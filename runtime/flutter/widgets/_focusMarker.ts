...
widgets: {
_focusMarker: (this: void, _focusMarker: I_FocusMarker, props : {  key? : IKey | undefined, child : IWidget, node : IFocusNode,}) => I_FocusMarker
}
};
export interface I_FocusMarker


{
notifier: IFocusNode | undefined;
child: IWidget;
key: IKey | undefined;
...
}export class _FocusMarker

 implements IInheritedNotifier<IFocusNode>, IDiagnosticable
{    public readonly notifier: IFocusNode | undefined = undefined as any;
    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, child : IWidget, node : IFocusNode,}){
flutter.widgets._focusMarker(this, props);}

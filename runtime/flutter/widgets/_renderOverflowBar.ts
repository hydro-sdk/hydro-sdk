...
import { IRenderBoxContainerDefaultsMixin } from "../rendering/renderBoxContainerDefaultsMixin";
...
widgets: {
_renderOverflowBar: (this: void, _renderOverflowBar: I_RenderOverflowBar, props : {  alignment? : MainAxisAlignment | undefined, children? : IList<IRenderBox> | undefined, clipBehavior : Clip, overflowAlignment : OverflowBarAlignment, overflowDirection : VerticalDirection, overflowSpacing : number, spacing : number, textDirection : TextDirection,}) => I_RenderOverflowBar
}
};
export interface I_RenderOverflowBar
...
getAlignment: () => MainAxisAlignment | undefined;
setAlignment: (value?: MainAxisAlignment | undefined) => void;
getOverflowSpacing: () => number;
setOverflowSpacing: (value: number) => void;
getOverflowAlignment: () => OverflowBarAlignment;
setOverflowAlignment: (value: OverflowBarAlignment) => void;
getOverflowDirection: () => VerticalDirection;
setOverflowDirection: (value: VerticalDirection) => void;
...
getHashCode: () => number;
}export class _RenderOverflowBar

 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,I_OverflowBarParentData>, IRenderBoxContainerDefaultsMixin<IRenderBox,I_OverflowBarParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IContainerRenderObjectMixin<IRenderBox,I_OverflowBarParentData>, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  alignment? : MainAxisAlignment | undefined, children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, overflowAlignment? : OverflowBarAlignment, overflowDirection? : VerticalDirection, overflowSpacing? : number, spacing? : number, textDirection : TextDirection,}){
flutter.widgets._renderOverflowBar(this, {
..._renderOverflowBarDefaultProps,
...props
});}
    ...
    private readonly _dart_getAlignment: () => MainAxisAlignment | undefined = undefined as any;
    private readonly _dart_setAlignment: (value?: MainAxisAlignment | undefined) => void = undefined as any;
    private readonly _dart_getOverflowSpacing: () => number = undefined as any;
    private readonly _dart_setOverflowSpacing: (value: number) => void = undefined as any;
    private readonly _dart_getOverflowAlignment: () => OverflowBarAlignment = undefined as any;
    private readonly _dart_setOverflowAlignment: (value: OverflowBarAlignment) => void = undefined as any;
    private readonly _dart_getOverflowDirection: () => VerticalDirection = undefined as any;
    private readonly _dart_setOverflowDirection: (value: VerticalDirection) => void = undefined as any;
...
public getAlignment() : MainAxisAlignment | undefined {
    return this._dart_getAlignment();
}
public setAlignment(value?: MainAxisAlignment | undefined) : void {
    return this._dart_setAlignment(value);
}
public getOverflowSpacing() : number {
    return this._dart_getOverflowSpacing();
}
public setOverflowSpacing(value: number) : void {
    return this._dart_setOverflowSpacing(value);
}
public getOverflowAlignment() : OverflowBarAlignment {
    return this._dart_getOverflowAlignment();
}
public setOverflowAlignment(value: OverflowBarAlignment) : void {
    return this._dart_setOverflowAlignment(value);
}
public getOverflowDirection() : VerticalDirection {
    return this._dart_getOverflowDirection();
}
public setOverflowDirection(value: VerticalDirection) : void {
    return this._dart_setOverflowDirection(value);
}
...
const _renderOverflowBarDefaultProps = {

...
declare const flutter: {
    widgets: {
        _renderOverflowBar: (
            this: void,
            _renderOverflowBar: I_RenderOverflowBar,
            props: {
...
export class _RenderOverflowBar
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, I_OverflowBarParentData>,
        IRenderBoxContainerDefaultsMixin<IRenderBox, I_OverflowBarParentData>,
        ...
        >
{
    ...
    private readonly _dart_setSpacing: (value: number) => void =
        undefined as any;
    private readonly _dart_getAlignment: () => MainAxisAlignment | undefined =
        undefined as any;
    private readonly _dart_setAlignment: (
        value?: MainAxisAlignment | undefined
    ) => void = undefined as any;
    private readonly _dart_getOverflowSpacing: () => number = undefined as any;
    private readonly _dart_setOverflowSpacing: (value: number) => void =
        undefined as any;
    private readonly _dart_getOverflowAlignment: () => OverflowBarAlignment =
        undefined as any;
    private readonly _dart_setOverflowAlignment: (
        value: OverflowBarAlignment
    ) => void = undefined as any;
    private readonly _dart_getOverflowDirection: () => VerticalDirection =
        undefined as any;
    private readonly _dart_setOverflowDirection: (

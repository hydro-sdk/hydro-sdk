...
declare const flutter: {
    widgets: {
        listWheelElement: (
            this: void,
            listWheelElement: IListWheelElement,
            widget: IListWheelViewport
        ) => IListWheelElement;
    };
};
        ...
        IBuildContext
{
    ...
    private readonly _dart_getWidget: () => IListWheelViewport =
        undefined as any;
    private readonly _dart_getRenderObject: () => IRenderListWheelViewport =
        undefined as any;
    private readonly _dart_update: (newWidget: any) => void = undefined as any;
    private readonly _dart_getChildCount: () => number | undefined =
        undefined as any;
    private readonly _dart_performRebuild: () => void = undefined as any;
    private readonly _dart_retrieveWidget: (
        index: number
    ) => IWidget | undefined = undefined as any;
    private readonly _dart_childExistsAt: (index: number) => boolean =
        undefined as any;

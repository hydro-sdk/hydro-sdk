...
import { IListWheelViewport } from "./listWheelViewport";
...
import { IListWheelChildManager } from "../rendering/listWheelChildManager";
import { IBuildContext } from "./buildContext";
import { IDiagnosticable } from "../foundation/diagnosticable";
import { IRenderListWheelViewport } from "../rendering/renderListWheelViewport";
...
widgets: {
listWheelElement: (this: void, listWheelElement: IListWheelElement, widget: IListWheelViewport) => IListWheelElement
}
};
export interface IListWheelElement


{
getWidget: () => IListWheelViewport;
getRenderObject: () => IRenderListWheelViewport;
update: (newWidget: unknown) => void;
getChildCount: () => number | undefined;
performRebuild: () => void;
retrieveWidget: (index: number) => IWidget | undefined;
...
}export class ListWheelElement

 implements IRenderObjectElement, IDiagnosticable, IListWheelChildManager, IBuildContext
{public constructor(widget: IListWheelViewport){
flutter.widgets.listWheelElement(this, widget);}
    private readonly _dart_getWidget: () => IListWheelViewport = undefined as any;
    private readonly _dart_getRenderObject: () => IRenderListWheelViewport = undefined as any;
    private readonly _dart_update: (newWidget: any) => void = undefined as any;
    private readonly _dart_getChildCount: () => number | undefined = undefined as any;
    private readonly _dart_performRebuild: () => void = undefined as any;
    private readonly _dart_retrieveWidget: (index: number) => IWidget | undefined = undefined as any;
    private readonly _dart_childExistsAt: (index: number) => boolean = undefined as any;
...
public getWidget() : IListWheelViewport {
    return this._dart_getWidget();
}
public getRenderObject() : IRenderListWheelViewport {
...
public retrieveWidget(index: number) : IWidget | undefined {
    return this._dart_retrieveWidget(index);
}
public childExistsAt(index: number) : boolean {
    return this._dart_childExistsAt(index);
}

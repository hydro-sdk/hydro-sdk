...
import { IRequestFocusIntent } from "./requestFocusIntent";
...
widgets: {
requestFocusAction: (this: void, requestFocusAction: IRequestFocusAction) => IRequestFocusAction
}
};
export interface IRequestFocusAction


{
invoke: (intent: IRequestFocusIntent) => void;
isEnabled: (intent: IRequestFocusIntent) => boolean;
consumesKey: (intent: IRequestFocusIntent) => boolean;
...
getCallingAction: () => IAction<IRequestFocusIntent> | undefined;
getIntentType: () => Type;
...
getHashCode: () => number;
}export class RequestFocusAction

 implements Omit<IAction<IRequestFocusIntent>, >, IDiagnosticable
{public constructor(){
flutter.widgets.requestFocusAction(this);}
    private readonly _dart_invoke: (intent: IRequestFocusIntent) => void = undefined as any;
    private readonly _dart_isEnabled: (intent: IRequestFocusIntent) => boolean = undefined as any;
    private readonly _dart_consumesKey: (intent: IRequestFocusIntent) => boolean = undefined as any;
    ...
    private readonly _dart_getCallingAction: () => IAction<IRequestFocusIntent> | undefined = undefined as any;
...
public invoke(intent: IRequestFocusIntent) : void {
    return this._dart_invoke(intent);
}
public isEnabled(intent: IRequestFocusIntent) : boolean {
    return this._dart_isEnabled(intent);
}
public consumesKey(intent: IRequestFocusIntent) : boolean {
...
public getCallingAction() : IAction<IRequestFocusIntent> | undefined {

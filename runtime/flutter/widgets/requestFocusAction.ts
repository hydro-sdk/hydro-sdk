...
declare const flutter: {
    widgets: {
        requestFocusAction: (
            this: void,
            requestFocusAction: IRequestFocusAction
        ) => IRequestFocusAction;
    };
};
    ...
    implements Omit<IAction<IRequestFocusIntent>>, IDiagnosticable
{
    ...
    private readonly _dart_invoke: (intent: IRequestFocusIntent) => void =
        undefined as any;
    private readonly _dart_isEnabled: (intent: IRequestFocusIntent) => boolean =
        undefined as any;
    private readonly _dart_consumesKey: (
        intent: IRequestFocusIntent

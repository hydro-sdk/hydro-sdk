...
widgets: {
restorableDouble: (this: void, restorableDouble: IRestorableDouble, defaultValue: number) => IRestorableDouble
}
};
export interface IRestorableDouble
...
toString: () => string;
getHashCode: () => number;
}export class RestorableDouble

 implements IRestorableNum<number>, IListenable
{public constructor(defaultValue: number){
flutter.widgets.restorableDouble(this, defaultValue);}
    private readonly _dart_fromPrimitives: (serialized?: Object | undefined) => number = undefined as any;
    ...
    private readonly _dart_initWithValue: (value: number) => void = undefined as any;

...
widgets: {
singleChildRenderObjectElement: (this: void, singleChildRenderObjectElement: ISingleChildRenderObjectElement, widget: ISingleChildRenderObjectWidget) => ISingleChildRenderObjectElement
}
};
export interface ISingleChildRenderObjectElement
...
}export class SingleChildRenderObjectElement

 implements IRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: ISingleChildRenderObjectWidget){
flutter.widgets.singleChildRenderObjectElement(this, widget);}
    private readonly _dart_getWidget: () => ISingleChildRenderObjectWidget = undefined as any;
...
public getWidget() : ISingleChildRenderObjectWidget {

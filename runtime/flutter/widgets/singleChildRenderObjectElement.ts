...
declare const flutter: {
    widgets: {
        singleChildRenderObjectElement: (
            this: void,
            singleChildRenderObjectElement: ISingleChildRenderObjectElement,
            widget: ISingleChildRenderObjectWidget
        ) => ISingleChildRenderObjectElement;
    };
};
    ...
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    ...
    private readonly _dart_getWidget: () => ISingleChildRenderObjectWidget =
        undefined as any;

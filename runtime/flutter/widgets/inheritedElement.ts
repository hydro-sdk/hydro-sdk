...
widgets: {
inheritedElement: (this: void, inheritedElement: IInheritedElement, widget: IInheritedWidget) => IInheritedElement
}
};
export interface IInheritedElement


{
getWidget: () => IInheritedWidget;
...
}export class InheritedElement

 implements IProxyElement, IDiagnosticable, IBuildContext
{public constructor(widget: IInheritedWidget){
flutter.widgets.inheritedElement(this, widget);}
    private readonly _dart_getWidget: () => IInheritedWidget = undefined as any;
...
public getWidget() : IInheritedWidget {

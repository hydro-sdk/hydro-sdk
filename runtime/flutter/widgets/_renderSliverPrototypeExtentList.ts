...
import { IRenderSliverFixedExtentBoxAdaptor } from "../rendering/renderSliverFixedExtentBoxAdaptor";
...
import { I_SliverPrototypeExtentListElement } from "./_sliverPrototypeExtentListElement";
declare const flutter: {
    widgets: {
        _renderSliverPrototypeExtentList: (
            this: void,
            _renderSliverPrototypeExtentList: I_RenderSliverPrototypeExtentList,
            props: { childManager: I_SliverPrototypeExtentListElement }
        ) => I_RenderSliverPrototypeExtentList;
    };
};
export interface I_RenderSliverPrototypeExtentList {
    ...
    addInitialChild: (props: {
        index: number;
        layoutOffset: number;
    }) => boolean;
    insertAndLayoutLeadingChild: (
        childConstraints: IBoxConstraints,
        props: { parentUsesSize: boolean }
    ) => IRenderBox | undefined;
    insertAndLayoutChild: (
        childConstraints: IBoxConstraints,
        props: { parentUsesSize: boolean; after?: IRenderBox | undefined }
    ) => IRenderBox | undefined;
...
export class _RenderSliverPrototypeExtentList
    implements
        IRenderSliverFixedExtentBoxAdaptor,
        IContainerRenderObjectMixin<
            IRenderBox,
            ISliverMultiBoxAdaptorParentData
        >,
        ...
        >
{
    ...
    public constructor(props: {
        childManager: I_SliverPrototypeExtentListElement;
    }) {
        flutter.widgets._renderSliverPrototypeExtentList(this, props);
    }
    ...
    private readonly _dart_indexToLayoutOffset: (
        itemExtent: number,
        index: number
    ...
    private readonly _dart_addInitialChild: (props: {
        index: number;
        layoutOffset: number;
    }) => boolean = undefined as any;
    private readonly _dart_insertAndLayoutLeadingChild: (
        childConstraints: IBoxConstraints,
        props: { parentUsesSize: boolean }
    ) => IRenderBox | undefined = undefined as any;
    private readonly _dart_insertAndLayoutChild: (
        childConstraints: IBoxConstraints,
        props: { parentUsesSize: boolean; after?: IRenderBox | undefined }
    ) => IRenderBox | undefined = undefined as any;
    private readonly _dart_collectGarbage: (
        leadingGarbage: number,
        trailingGarbage: number
    ) => void = undefined as any;
    private readonly _dart_indexOf: (child: IRenderBox) => number =
        undefined as any;
    private readonly _dart_paintExtentOf: (child: IRenderBox) => number =
        undefined as any;
    ...
    private readonly _dart_debugAssertChildListIsNonEmptyAndContiguous: () => boolean =
        undefined as any;
    private readonly _dart_debugDescribeChildren: () => IList<IDiagnosticsNode> =
        undefined as any;
    private readonly _dart_getChildManager: () => IRenderSliverBoxChildManager =
        undefined as any;
    private readonly _dart_getDebugChildIntegrityEnabled: () => boolean =
        undefined as any;
    private readonly _dart_setDebugChildIntegrityEnabled: (
        enabled: boolean
    ) => void = undefined as any;
    ...
    public getMinChildIndexForScrollOffset(
        scrollOffset: number,
        itemExtent: number
    ): number {
        return this._dart_getMinChildIndexForScrollOffset(
            scrollOffset,
            itemExtent
        );
    }
    public getMaxChildIndexForScrollOffset(
        scrollOffset: number,
        itemExtent: number
    ): number {
        return this._dart_getMaxChildIndexForScrollOffset(
            scrollOffset,
            itemExtent
        );
    }
    ...
    public insertAndLayoutLeadingChild(
        childConstraints: IBoxConstraints,
        props: { parentUsesSize?: boolean }
    ): IRenderBox | undefined {

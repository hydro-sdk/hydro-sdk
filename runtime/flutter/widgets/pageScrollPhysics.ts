...
widgets: {
pageScrollPhysics: (this: void, pageScrollPhysics: IPageScrollPhysics, props? : {  parent? : IScrollPhysics | undefined,}) => IPageScrollPhysics
}
};
export interface IPageScrollPhysics


{
parent: IScrollPhysics | undefined;
applyTo: (ancestor?: IScrollPhysics | undefined) => IPageScrollPhysics;
...
flutter.widgets.pageScrollPhysics(this, props);}
    private readonly _dart_applyTo: (ancestor?: IScrollPhysics | undefined) => IPageScrollPhysics = undefined as any;
...
public applyTo(ancestor?: IScrollPhysics | undefined) : IPageScrollPhysics {

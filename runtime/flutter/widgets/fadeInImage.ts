...
widgets: {
fadeInImage: (this: void, fadeInImage: IFadeInImage, props : {  alignment : IAlignmentGeometry, excludeFromSemantics : boolean, fadeInCurve : ICurve, fadeInDuration : IDuration, fadeOutCurve : ICurve, fadeOutDuration : IDuration, fit? : BoxFit | undefined, height? : number | undefined, imageErrorBuilder? : (context: IBuildContext, error: Object, stackTrace?: IStackTrace | undefined) => IWidget | undefined, imageSemanticLabel? : string | undefined, key? : IKey | undefined, matchTextDirection : boolean, placeholderErrorBuilder? : (context: IBuildContext, error: Object, stackTrace?: IStackTrace | undefined) => IWidget | undefined, placeholderFit? : BoxFit | undefined, repeat : ImageRepeat, width? : number | undefined, image : IImageProvider<Object>, placeholder : IImageProvider<Object>,}) => IFadeInImage
}
};
...
public constructor( props : {  alignment? : IAlignmentGeometry, excludeFromSemantics? : boolean, fadeInCurve? : ICurve, fadeInDuration? : IDuration, fadeOutCurve? : ICurve, fadeOutDuration? : IDuration, fit? : BoxFit | undefined, height? : number | undefined, imageErrorBuilder? : (context: IBuildContext, error: Object, stackTrace?: IStackTrace | undefined) => IWidget | undefined, imageSemanticLabel? : string | undefined, key? : IKey | undefined, matchTextDirection? : boolean, placeholderErrorBuilder? : (context: IBuildContext, error: Object, stackTrace?: IStackTrace | undefined) => IWidget | undefined, placeholderFit? : BoxFit | undefined, repeat? : ImageRepeat, width? : number | undefined, image : IImageProvider<Object>, placeholder : IImageProvider<Object>,}){
flutter.widgets.fadeInImage(this, {
...fadeInImageDefaultProps,
...props
});}
    private readonly _dart_createState: () => IState<IFadeInImage> = undefined as any;

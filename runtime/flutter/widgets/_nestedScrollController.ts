...
widgets: {
_nestedScrollController: (this: void, _nestedScrollController: I_NestedScrollController, coordinator: I_NestedScrollCoordinator, props : {  debugLabel? : string | undefined, initialScrollOffset : number,}) => I_NestedScrollController
}
};
...
getHashCode: () => number;
}export class _NestedScrollController
...
public constructor(coordinator: I_NestedScrollCoordinator, props : {  debugLabel? : string | undefined, initialScrollOffset? : number,}){
...
...props
    ...
    private readonly _dart_getNestedPositions: () => IIterable<I_NestedScrollPosition> = undefined as any;

...
declare const flutter: {
    widgets: {
        positionedTransition: (
            this: void,
            positionedTransition: IPositionedTransition,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                rect: IAnimation<IRelativeRect>;
            }
        ) => IPositionedTransition;
    };
};
...
export class PositionedTransition implements IAnimatedWidget, IDiagnosticable {
    ...
    private readonly _dart_getRect: () => IAnimation<IRelativeRect> =
        undefined as any;

...
declare const flutter: {
    widgets: {
        characterActivator: (
            this: void,
            characterActivator: ICharacterActivator,
            character: string
        ) => ICharacterActivator;
    };
};
...
export class CharacterActivator implements IDiagnosticable, IShortcutActivator {
    ...
    private readonly _dart_getTriggers: () =>
        | IIterable<ILogicalKeyboardKey>

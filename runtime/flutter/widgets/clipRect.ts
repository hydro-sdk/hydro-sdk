...
import { IRenderClipRect } from "../rendering/renderClipRect";
...
widgets: {
clipRect: (this: void, clipRect: IClipRect, props : {  child? : IWidget | undefined, clipBehavior : Clip, clipper? : ICustomClipper<IRect> | undefined, key? : IKey | undefined,}) => IClipRect
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderClipRect;
...
flutter.widgets.clipRect(this, {
...clipRectDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderClipRect = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderClipRect {

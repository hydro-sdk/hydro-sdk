...
import { IRenderLimitedBox } from "../rendering/renderLimitedBox";
...
widgets: {
limitedBox: (this: void, limitedBox: ILimitedBox, props : {  child? : IWidget | undefined, key? : IKey | undefined, maxHeight : number, maxWidth : number,}) => ILimitedBox
}
};
export interface ILimitedBox
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderLimitedBox;
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, maxHeight? : number, maxWidth? : number,}){
flutter.widgets.limitedBox(this, {
...limitedBoxDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderLimitedBox = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderLimitedBox {

...
declare const flutter: {
    widgets: {
        _draggableScrollableSheetScrollController: (
            this: void,
            _draggableScrollableSheetScrollController: I_DraggableScrollableSheetScrollController,
            props: {
                debugLabel?: string | undefined;
                initialScrollOffset: number;
                extent: I_DraggableSheetExtent;
            }
        ) => I_DraggableScrollableSheetScrollController;
    };
};
    ...
    implements IScrollController, IListenable
{
    ...
    private readonly _dart_createScrollPosition: (
        ...
        context: IScrollContext,
        oldPosition?: IScrollPosition | undefined
    ) => I_DraggableScrollableSheetScrollPosition = undefined as any;
    private readonly _dart_debugFillDescription: (
        description: IList<string>
    ) => void = undefined as any;
    private readonly _dart_getPosition: () => I_DraggableScrollableSheetScrollPosition =
        undefined as any;

...
import { ISliverOffstage } from "./sliverOffstage";
...
widgets: {
_sliverOffstageElement: (this: void, _sliverOffstageElement: I_SliverOffstageElement, widget: ISliverOffstage) => I_SliverOffstageElement
}
};
export interface I_SliverOffstageElement


{
getWidget: () => ISliverOffstage;
...
}export class _SliverOffstageElement

 implements ISingleChildRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: ISliverOffstage){
flutter.widgets._sliverOffstageElement(this, widget);}
    private readonly _dart_getWidget: () => ISliverOffstage = undefined as any;
    ...
    private readonly _dart_getRenderObject: () => IRenderObject = undefined as any;
...
public getWidget() : ISliverOffstage {

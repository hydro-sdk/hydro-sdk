...
widgets: {
_renderFocusTrapArea: (this: void, _renderFocusTrapArea: I_RenderFocusTrapArea, focusNode: IFocusNode) => I_RenderFocusTrapArea
}
};
export interface I_RenderFocusTrapArea
...
getHashCode: () => number;
}export class _RenderFocusTrapArea
...
public constructor(focusNode: IFocusNode){
flutter.widgets._renderFocusTrapArea(this, focusNode);}

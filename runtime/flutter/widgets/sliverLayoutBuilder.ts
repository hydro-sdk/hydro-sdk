...
widgets: {
sliverLayoutBuilder: (this: void, sliverLayoutBuilder: ISliverLayoutBuilder, props : {  key? : IKey | undefined, builder : (context: IBuildContext, constraints: ISliverConstraints) => IWidget,}) => ISliverLayoutBuilder
}
};
...
key: IKey | undefined;
getBuilder: () => (context: IBuildContext, constraints: ISliverConstraints) => IWidget;
...
{    public readonly builder: (__: ISliverConstraints) => IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, builder : (context: IBuildContext, constraints: ISliverConstraints) => IWidget,}){
flutter.widgets.sliverLayoutBuilder(this, props);}
    private readonly _dart_getBuilder: () => (context: IBuildContext, constraints: ISliverConstraints) => IWidget = undefined as any;
...
public getBuilder() : (context: IBuildContext, constraints: ISliverConstraints) => IWidget {

...
import { IRenderSliverFloatingPinnedPersistentHeader } from "../rendering/renderSliverFloatingPinnedPersistentHeader";
...
import { IRenderSliverHelpers } from "../rendering/renderSliverHelpers";
...
import { ISliverHitTestResult } from "../rendering/sliverHitTestResult";
...
import { ISliverHitTestEntry } from "../rendering/sliverHitTestEntry";
...
widgets: {
_renderSliverFloatingPinnedPersistentHeaderForWidgets: (this: void, _renderSliverFloatingPinnedPersistentHeaderForWidgets: I_RenderSliverFloatingPinnedPersistentHeaderForWidgets, props? : {  child? : IRenderBox | undefined, showOnScreenConfiguration? : IPersistentHeaderShowOnScreenConfiguration | undefined, snapConfiguration? : IFloatingHeaderSnapConfiguration | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined, vsync? : ITickerProvider | undefined,}) => I_RenderSliverFloatingPinnedPersistentHeaderForWidgets
}
};
export interface I_RenderSliverFloatingPinnedPersistentHeaderForWidgets


{
snapConfiguration: IFloatingHeaderSnapConfiguration | undefined;
showOnScreenConfiguration: IPersistentHeaderShowOnScreenConfiguration | undefined;
...
layoutChild: (scrollOffset: number, maxExtent: number, props : {  overlapsContent : boolean,}) => void;
...
getHashCode: () => number;
}export class _RenderSliverFloatingPinnedPersistentHeaderForWidgets

 implements IRenderSliverFloatingPinnedPersistentHeader, I_RenderSliverPersistentHeaderForWidgetsMixin, IRenderObjectWithChildMixin<IRenderBox>, IRenderSliverHelpers, IDiagnosticableTreeMixin, IDiagnosticable, IRenderSliver, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "debugFillProperties" | "toStringShallow" | "toStringDeep" | "toStringShort" | "toDiagnosticsNode">
{    public readonly snapConfiguration: IFloatingHeaderSnapConfiguration | undefined = undefined as any;
    public readonly showOnScreenConfiguration: IPersistentHeaderShowOnScreenConfiguration | undefined = undefined as any;
    public readonly stretchConfiguration: IOverScrollHeaderStretchConfiguration | undefined = undefined as any;
...
public constructor( props? : {  child? : IRenderBox | undefined, showOnScreenConfiguration? : IPersistentHeaderShowOnScreenConfiguration | undefined, snapConfiguration? : IFloatingHeaderSnapConfiguration | undefined, stretchConfiguration? : IOverScrollHeaderStretchConfiguration | undefined, vsync? : ITickerProvider | undefined,}){
flutter.widgets._renderSliverFloatingPinnedPersistentHeaderForWidgets(this, props);}
    private readonly _dart_updateChild: (shrinkOffset: number, overlapsContent: boolean) => void = undefined as any;
    private readonly _dart_triggerRebuild: () => void = undefined as any;
    ...
    private readonly _dart_updateScrollStartDirection: (direction: ScrollDirection) => void = undefined as any;
    private readonly _dart_maybeStartSnapAnimation: (direction: ScrollDirection) => void = undefined as any;
    private readonly _dart_maybeStopSnapAnimation: (direction: ScrollDirection) => void = undefined as any;
    ...
    private readonly _dart_setVsync: (value?: ITickerProvider | undefined) => void = undefined as any;
    private readonly _dart_markNeedsLayout: () => void = undefined as any;
    private readonly _dart_layoutChild: (scrollOffset: number, maxExtent: number, props : {  overlapsContent : boolean,}) => void = undefined as any;
    ...
    private readonly _dart_getChildExtent: () => number = undefined as any;
...
public updateChild(shrinkOffset: number, overlapsContent: boolean) : void {
    return this._dart_updateChild(shrinkOffset, overlapsContent);
}
public triggerRebuild() : void {
    return this._dart_triggerRebuild();
}
...
public maybeStopSnapAnimation(direction: ScrollDirection) : void {
    return this._dart_maybeStopSnapAnimation(direction);
}
...
public setVsync(value?: ITickerProvider | undefined) : void {
    return this._dart_setVsync(value);
}
public markNeedsLayout() : void {
    return this._dart_markNeedsLayout();
}
public layoutChild(scrollOffset: number, maxExtent: number, props : {  overlapsContent? : boolean,}) : void {
    return this._dart_layoutChild(scrollOffset, maxExtent, {
...layoutChildDefaultProps,
...props
});
}
...
public getChildExtent() : number {
    return this._dart_getChildExtent();
}

...
declare const flutter: {
    widgets: {
        rawGestureDetector: (
            this: void,
            rawGestureDetector: IRawGestureDetector,
            props: {
                ...
                gestures: IMap<
                    Type,
                    IGestureRecognizerFactory<IGestureRecognizer>
                >;
                key?: IKey | undefined;
...
export class RawGestureDetector implements IStatefulWidget, IDiagnosticable {
    public readonly child: IWidget | undefined = undefined as any;
    public readonly gestures: IMap<
        Type,
        IGestureRecognizerFactory<IGestureRecognizer>
    > = undefined as any;
    ...
    public readonly semantics: ISemanticsGestureDelegate | undefined =
        undefined as any;
    ...
    private readonly _dart_createState: () => IRawGestureDetectorState =
        undefined as any;
...
const rawGestureDetectorDefaultProps = {
    ...
    gestures: Map.fromEntries(
        <
            IIterable<
                IMapEntry<Type, IGestureRecognizerFactory<GestureRecognizer>>
            >

...
widgets: {
_navigatorReplaceObservation: (this: void, _navigatorReplaceObservation: I_NavigatorReplaceObservation, primaryRoute: IRoute<any>, secondaryRoute?: IRoute<any> | undefined) => I_NavigatorReplaceObservation
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _NavigatorReplaceObservation
...
flutter.widgets._navigatorReplaceObservation(this, primaryRoute, secondaryRoute);}

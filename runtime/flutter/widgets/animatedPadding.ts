...
declare const flutter: {
    widgets: {
        animatedPadding: (
            this: void,
            animatedPadding: IAnimatedPadding,
            props: {
...
export interface IAnimatedPadding {
    padding: IEdgeInsetsGeometry;
    child: IWidget | undefined;
    curve: ICurve;
    duration: IDuration;
    onEnd: () => void | undefined;
    key: IKey | undefined;
    createState: () => IAnimatedWidgetBaseState<IAnimatedPadding>;
    ...
    implements IImplicitlyAnimatedWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.widgets.animatedPadding(this, {
            ...animatedPaddingDefaultProps,
            ...props,
        });
    }
    private readonly _dart_createState: () => IAnimatedWidgetBaseState<IAnimatedPadding> =
        undefined as any;
    ...
    public createState(): IAnimatedWidgetBaseState<IAnimatedPadding> {
...
const animatedPaddingDefaultProps = {
    curve: Curves.linear,
};

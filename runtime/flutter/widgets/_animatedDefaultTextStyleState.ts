...
import { IAnimatedDefaultTextStyle } from "./animatedDefaultTextStyle";
...
widgets: {
_animatedDefaultTextStyleState: (this: void, _animatedDefaultTextStyleState: I_AnimatedDefaultTextStyleState) => I_AnimatedDefaultTextStyleState
}
};
export interface I_AnimatedDefaultTextStyleState
...
deactivate: () => void;
activate: () => void;
getWidget: () => IAnimatedDefaultTextStyle;
...
getHashCode: () => number;
}export class _AnimatedDefaultTextStyleState

 implements IAnimatedWidgetBaseState<IAnimatedDefaultTextStyle>, ISingleTickerProviderStateMixin<IAnimatedDefaultTextStyle>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedDefaultTextStyleState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedDefaultTextStyle = undefined as any;
...
public getWidget() : IAnimatedDefaultTextStyle {

...
declare const flutter: {
    widgets: {
        _animatedDefaultTextStyleState: (
            this: void,
            _animatedDefaultTextStyleState: I_AnimatedDefaultTextStyleState
        ) => I_AnimatedDefaultTextStyleState;
    };
};
...
export class _AnimatedDefaultTextStyleState
    implements
        IAnimatedWidgetBaseState<IAnimatedDefaultTextStyle>,
        ISingleTickerProviderStateMixin<IAnimatedDefaultTextStyle>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedDefaultTextStyle =
        undefined as any;

...
widgets: {
proxyElement: (this: void, proxyElement: IProxyElement, widget: IProxyWidget) => IProxyElement
}
};
export interface IProxyElement


{
getWidget: () => IProxyWidget;
build: () => IWidget;
...
{public constructor(widget: IProxyWidget){
flutter.widgets.proxyElement(this, widget);}
    private readonly _dart_getWidget: () => IProxyWidget = undefined as any;

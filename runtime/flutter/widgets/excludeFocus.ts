...
widgets: {
excludeFocus: (this: void, excludeFocus: IExcludeFocus, props : {  excluding : boolean, key? : IKey | undefined, child : IWidget,}) => IExcludeFocus
}
};
export interface IExcludeFocus
...
public constructor( props : {  excluding? : boolean, key? : IKey | undefined, child : IWidget,}){
flutter.widgets.excludeFocus(this, {
...excludeFocusDefaultProps,
...props
});}
...
const excludeFocusDefaultProps = {
    excluding: true,
};

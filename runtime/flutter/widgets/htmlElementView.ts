...
widgets: {
htmlElementView: (this: void, htmlElementView: IHtmlElementView, props : {  key? : IKey | undefined, onPlatformViewCreated? : (id: number) => void | undefined, viewType : string,}) => IHtmlElementView
}
};
export interface IHtmlElementView
...
public constructor( props : {  key? : IKey | undefined, onPlatformViewCreated? : (id: number) => void | undefined, viewType : string,}){
flutter.widgets.htmlElementView(this, props);}

...
widgets: {
sliverFadeTransition: (this: void, sliverFadeTransition: ISliverFadeTransition, props : {  alwaysIncludeSemantics : boolean, key? : IKey | undefined, sliver? : IWidget | undefined, opacity : IAnimation<number>,}) => ISliverFadeTransition
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverAnimatedOpacity;
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, key? : IKey | undefined, sliver? : IWidget | undefined, opacity : IAnimation<number>,}){
flutter.widgets.sliverFadeTransition(this, {
...sliverFadeTransitionDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverAnimatedOpacity = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverAnimatedOpacity {

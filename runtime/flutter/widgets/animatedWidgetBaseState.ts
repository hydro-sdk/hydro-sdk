...
declare const flutter: {
    widgets: {
        animatedWidgetBaseState: <T>(
            this: void,
            animatedWidgetBaseState: IAnimatedWidgetBaseState<T>
        ) => IAnimatedWidgetBaseState<T>;
    };
};
export interface IAnimatedWidgetBaseState<T> {
    initState: () => void;
...
export class AnimatedWidgetBaseState<T>
    implements
        Omit<

...
widgets: {
animatedWidgetBaseState: <T>(this: void, animatedWidgetBaseState: IAnimatedWidgetBaseState<T>) => IAnimatedWidgetBaseState<T>
}
};
export interface IAnimatedWidgetBaseState
<T>
...
getHashCode: () => number;
}export class AnimatedWidgetBaseState
<T>
 implements Omit<IImplicitlyAnimatedWidgetState<T>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<T>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets.animatedWidgetBaseState(this);}

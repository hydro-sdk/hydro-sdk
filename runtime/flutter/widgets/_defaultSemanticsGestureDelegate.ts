...
widgets: {
_defaultSemanticsGestureDelegate: (this: void, _defaultSemanticsGestureDelegate: I_DefaultSemanticsGestureDelegate, detectorState: IRawGestureDetectorState) => I_DefaultSemanticsGestureDelegate
}
};

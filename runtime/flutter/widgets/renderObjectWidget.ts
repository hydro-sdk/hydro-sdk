...
widgets: {
renderObjectWidget: (this: void, renderObjectWidget: IRenderObjectWidget, props? : {  key? : IKey | undefined,}) => IRenderObjectWidget
}
};
export interface IRenderObjectWidget

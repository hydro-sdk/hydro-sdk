...
declare const flutter: {
    widgets: {
        edgeInsetsTween: (
            this: void,
            edgeInsetsTween: IEdgeInsetsTween,
            props?: {
...
export class EdgeInsetsTween implements ITween<IEdgeInsets> {
    ...
    private readonly _dart_transform: (t: number) => IEdgeInsets =
        undefined as any;
    ...
    ) => IAnimation<IEdgeInsets> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IEdgeInsets> = undefined as any;

...
widgets: {
_anonymousRestorationInformation: (this: void, _anonymousRestorationInformation: I_AnonymousRestorationInformation, props : {  arguments? : Object | undefined, restorationScopeId : number, routeBuilder : (context: IBuildContext, arguments?: Object | undefined) => IRoute<any>,}) => I_AnonymousRestorationInformation;
_anonymousRestorationInformationFromSerializableData: (data: IList<Object | undefined>) => I_AnonymousRestorationInformation
}
};
...
public constructor( props : {  arguments? : Object | undefined, restorationScopeId : number, routeBuilder : (context: IBuildContext, arguments?: Object | undefined) => IRoute<any>,}){
flutter.widgets._anonymousRestorationInformation(this, props);}
public static fromSerializableData(data: IList<Object | undefined>) : I_AnonymousRestorationInformation{
return flutter.widgets._anonymousRestorationInformationFromSerializableData(data);

...
widgets: {
_snappingSimulation: (this: void, _snappingSimulation: I_SnappingSimulation, props : {  tolerance : ITolerance, initialVelocity : number, pixelSnapSize : IList<number>, position : number,}) => I_SnappingSimulation
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _SnappingSimulation
...
public constructor( props : {  tolerance? : ITolerance, initialVelocity : number, pixelSnapSize : IList<number>, position : number,}){

...
declare const flutter: {
    widgets: {
        widgetsFlutterBinding: (
            this: void,
            widgetsFlutterBinding: IWidgetsFlutterBinding
        ) => IWidgetsFlutterBinding;
...
export interface IWidgetsFlutterBinding {
    ...
    schedulingStrategy: (props: {
        priority: number;
        scheduler: ISchedulerBinding;
    }) => boolean;
    ...
    registerSignalServiceExtension: (props: {
        callback: () => IFuture<void>;
        name: string;
    }) => void;
    registerBoolServiceExtension: (props: {
        getter: () => IFuture<boolean>;
        name: string;
        setter: (value: boolean) => IFuture<void>;
    }) => void;
    registerNumericServiceExtension: (props: {
        getter: () => IFuture<number>;
        name: string;
        setter: (value: number) => IFuture<void>;
    }) => void;
    postEvent: (eventKind: string, eventData: { [index: string]: any }) => void;
    registerStringServiceExtension: (props: {
        getter: () => IFuture<string>;
        name: string;
        setter: (value: string) => IFuture<void>;
    }) => void;
        ...
        IHitTestTarget
{
    ...
    private readonly _dart_cancelPointer: (pointer: number) => void =
        undefined as any;
    private readonly _dart_handlePointerEvent: (event: IPointerEvent) => void =
        undefined as any;
    private readonly _dart_hitTest: (
        result: IHitTestResult,
        position: IOffset
    ) => void = undefined as any;
    private readonly _dart_dispatchEvent: (
        event: IPointerEvent,
        hitTestResult?: IHitTestResult | undefined
    ) => void = undefined as any;
    ...
    private readonly _dart_removeTimingsCallback: (
        callback: (timings: IList<IFrameTiming>) => void
    ) => void = undefined as any;
    private readonly _dart_initServiceExtensions: () => void = undefined as any;
    private readonly _dart_handleAppLifecycleStateChanged: (
        state: AppLifecycleState
    ) => void = undefined as any;
    private readonly _dart_scheduleTask: <T>(
        task: () => T,
        priority: IPriority,
        props?: { debugLabel?: string | undefined; flow?: IFlow | undefined }
    ) => IFuture<T> = undefined as any;
    private readonly _dart_scheduleFrameCallback: (
        callback: (timeStamp: IDuration) => void,
        props: { rescheduling: boolean }
    ) => number = undefined as any;
    private readonly _dart_cancelFrameCallbackWithId: (id: number) => void =
        undefined as any;
    private readonly _dart_debugAssertNoTransientCallbacks: (
        reason: string
    ) => boolean = undefined as any;
    private readonly _dart_addPersistentFrameCallback: (
        callback: (timeStamp: IDuration) => void
    ) => void = undefined as any;
    private readonly _dart_addPostFrameCallback: (
        callback: (timeStamp: IDuration) => void
    ) => void = undefined as any;
    private readonly _dart_ensureFrameCallbacksRegistered: () => void =
        undefined as any;
    ...
    private readonly _dart_handleBeginFrame: (
        rawTimeStamp?: IDuration | undefined
    ) => void = undefined as any;
    private readonly _dart_handleDrawFrame: () => void = undefined as any;
    private readonly _dart_getLifecycleState: () =>
        | AppLifecycleState
        | undefined = undefined as any;
    private readonly _dart_getTransientCallbackCount: () => number =
        undefined as any;
    private readonly _dart_getEndOfFrame: () => IFuture<void> =
        undefined as any;
    private readonly _dart_getHasScheduledFrame: () => boolean =
        undefined as any;
    private readonly _dart_getSchedulerPhase: () => SchedulerPhase =
        undefined as any;
    private readonly _dart_getFramesEnabled: () => boolean = undefined as any;
    private readonly _dart_getCurrentFrameTimeStamp: () => IDuration =
        undefined as any;
    private readonly _dart_getCurrentSystemFrameTimeStamp: () => IDuration =
        undefined as any;
    private readonly _dart_createBinaryMessenger: () => IBinaryMessenger =
        undefined as any;
    private readonly _dart_handleMemoryPressure: () => void = undefined as any;
    private readonly _dart_handleSystemMessage: (
    ...
    private readonly _dart_readInitialLifecycleStateFromNativeWindow: () => void =
        undefined as any;
    ...
    private readonly _dart_getRestorationManager: () => IRestorationManager =
        undefined as any;
    private readonly _dart_createImageCache: () => IImageCache =
        undefined as any;
    private readonly _dart_instantiateImageCodec: (
        bytes: IUint8List,
        props: {
            allowUpscaling: boolean;
            cacheHeight?: number | undefined;
    ...
    private readonly _dart_getImageCache: () => IImageCache | undefined =
        undefined as any;
    private readonly _dart_getSystemFonts: () => IListenable = undefined as any;
    private readonly _dart_handleAccessibilityFeaturesChanged: () => void =
        undefined as any;
    private readonly _dart_createSemanticsUpdateBuilder: () => ISemanticsUpdateBuilder =
        undefined as any;
    ...
    private readonly _dart_handleTextScaleFactorChanged: () => void =
        undefined as any;
    private readonly _dart_handlePlatformBrightnessChanged: () => void =
        undefined as any;
    private readonly _dart_createViewConfiguration: () => IViewConfiguration =
        undefined as any;
    private readonly _dart_setSemanticsEnabled: (enabled: boolean) => void =
        undefined as any;
    ...
    private readonly _dart_performReassemble: () => IFuture<void> =
        undefined as any;
    private readonly _dart_getMouseTracker: () => IMouseTracker =
        undefined as any;
    private readonly _dart_getPipelineOwner: () => IPipelineOwner =
        undefined as any;
    private readonly _dart_getRenderView: () => IRenderView = undefined as any;
    private readonly _dart_setRenderView: (value: IRenderView) => void =
        undefined as any;
    private readonly _dart_getSendFramesToEngine: () => boolean =
        undefined as any;
    private readonly _dart_addObserver: (
        observer: IWidgetsBindingObserver
    ) => void = undefined as any;
    private readonly _dart_removeObserver: (
        observer: IWidgetsBindingObserver
    ) => boolean = undefined as any;
    private readonly _dart_handleLocaleChanged: () => void = undefined as any;
    private readonly _dart_dispatchLocalesChanged: (
        locales?: IList<ILocale> | undefined
    ) => void = undefined as any;
    private readonly _dart_dispatchAccessibilityFeaturesChanged: () => void =
        undefined as any;
    private readonly _dart_handlePopRoute: () => IFuture<void> =
        undefined as any;
    private readonly _dart_handlePushRoute: (route: string) => IFuture<void> =
        undefined as any;
    private readonly _dart_scheduleAttachRootWidget: (
        rootWidget: IWidget
    ) => void = undefined as any;
    private readonly _dart_attachRootWidget: (rootWidget: IWidget) => void =
        undefined as any;
    private readonly _dart_computePlatformResolvedLocale: (
        supportedLocales: IList<ILocale>
    ) => ILocale | undefined = undefined as any;
    private readonly _dart_getBuildOwner: () => IBuildOwner | undefined =
        undefined as any;
    private readonly _dart_getFocusManager: () => IFocusManager =
        undefined as any;
    private readonly _dart_getFirstFrameRasterized: () => boolean =
        undefined as any;
    private readonly _dart_getWaitUntilFirstFrameRasterized: () => IFuture<void> =
        undefined as any;
    private readonly _dart_getDebugDidSendFirstFrameEvent: () => boolean =
        undefined as any;
    private readonly _dart_getRenderViewElement: () => IElement | undefined =
        undefined as any;
    private readonly _dart_getIsRootWidgetAttached: () => boolean =
        undefined as any;
    private readonly _dart_lockEvents: (
        callback: () => IFuture<void>
    ) => IFuture<void> = undefined as any;
    private readonly _dart_reassembleApplication: () => IFuture<void> =
        undefined as any;
    private readonly _dart_registerSignalServiceExtension: (props: {
        callback: () => IFuture<void>;
        name: string;
    }) => void = undefined as any;
    private readonly _dart_registerBoolServiceExtension: (props: {
        getter: () => IFuture<boolean>;
        name: string;
        setter: (value: boolean) => IFuture<void>;
    }) => void = undefined as any;
    private readonly _dart_registerNumericServiceExtension: (props: {
        getter: () => IFuture<number>;
        name: string;
        setter: (value: number) => IFuture<void>;
    }) => void = undefined as any;
    private readonly _dart_postEvent: (
        eventKind: string,
        eventData: { [index: string]: any }
    ) => void = undefined as any;
    private readonly _dart_registerStringServiceExtension: (props: {
        getter: () => IFuture<string>;
        name: string;
        setter: (value: string) => IFuture<void>;
    }) => void = undefined as any;
    private readonly _dart_registerServiceExtension: (props: {
        callback: (parameters: {
            [index: string]: string;
        }) => IFuture<{ [index: string]: any }>;
        name: string;
    ...
    private readonly _dart_getWindow: () => ISingletonFlutterWindow =
        undefined as any;
    ...
    public addPersistentFrameCallback(
        callback: (timeStamp: IDuration) => void
    ): void {
        return this._dart_addPersistentFrameCallback(callback);
    }
    public addPostFrameCallback(
        callback: (timeStamp: IDuration) => void
    ): void {
    ...
    public registerSignalServiceExtension(props: {
        callback: () => IFuture<void>;
        name: string;
    }): void {
        return this._dart_registerSignalServiceExtension(props);
    }
    public registerBoolServiceExtension(props: {
        getter: () => IFuture<boolean>;
        name: string;
        setter: (value: boolean) => IFuture<void>;
    }): void {
    ...
    public registerNumericServiceExtension(props: {
        getter: () => IFuture<number>;
        name: string;
        setter: (value: number) => IFuture<void>;
    }): void {
    ...
    public registerStringServiceExtension(props: {
        getter: () => IFuture<string>;
        name: string;
        setter: (value: string) => IFuture<void>;
    }): void {
    ...
    public registerServiceExtension(props: {
        callback: (parameters: {
            [index: string]: string;
        }) => IFuture<{ [index: string]: any }>;
        name: string;

...
declare const flutter: {
    widgets: {
        doNothingAction: (
            this: void,
            doNothingAction: IDoNothingAction,
            props: { consumesKey: boolean }
        ) => IDoNothingAction;
    };
};
    ...
    implements Omit<IAction<IIntent>>, IDiagnosticable
{
    ...
    private readonly _dart_consumesKey: (intent: IIntent) => boolean =
        undefined as any;
    private readonly _dart_invoke: (intent: IIntent) => void = undefined as any;
    private readonly _dart_isEnabled: (intent: IIntent) => boolean =
        undefined as any;

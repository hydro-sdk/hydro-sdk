...
widgets: {
_renderSliverLayoutBuilder: (this: void, _renderSliverLayoutBuilder: I_RenderSliverLayoutBuilder) => I_RenderSliverLayoutBuilder
}
};
export interface I_RenderSliverLayoutBuilder
...
updateCallback: (value? : (constraints: ISliverConstraints) => void) => void;
markNeedsBuild: () => void;
...
getHashCode: () => number;
}export class _RenderSliverLayoutBuilder

 implements IRenderSliver, IRenderObjectWithChildMixin<IRenderSliver>, IRenderConstrainedLayoutBuilder<ISliverConstraints,IRenderSliver>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor(){
flutter.widgets._renderSliverLayoutBuilder(this);}
    ...
    private readonly _dart_updateCallback: (value? : (constraints: ISliverConstraints) => void) => void = undefined as any;
    private readonly _dart_markNeedsBuild: () => void = undefined as any;
    private readonly _dart_rebuildIfNecessary: () => void = undefined as any;
...
public updateCallback(value? : (constraints: ISliverConstraints) => void) : void {
    return this._dart_updateCallback(value);
}
public markNeedsBuild() : void {
    return this._dart_markNeedsBuild();
}
public rebuildIfNecessary() : void {
    return this._dart_rebuildIfNecessary();
}

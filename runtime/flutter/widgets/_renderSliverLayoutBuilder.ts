...
declare const flutter: {
    widgets: {
        _renderSliverLayoutBuilder: (
            this: void,
            _renderSliverLayoutBuilder: I_RenderSliverLayoutBuilder
        ) => I_RenderSliverLayoutBuilder;
    };
};
...
export class _RenderSliverLayoutBuilder
    implements
        ...
        IRenderConstrainedLayoutBuilder<ISliverConstraints, IRenderSliver>,
        ...
        >
{
    ...
    private readonly _dart_updateCallback: (
        value?: (constraints: ISliverConstraints) => void
    ) => void = undefined as any;

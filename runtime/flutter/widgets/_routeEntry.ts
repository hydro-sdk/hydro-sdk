...
widgets: {
_routeEntry: (this: void, _routeEntry: I_RouteEntry, route: IRoute<any>, props : {  restorationInformation? : I_RestorationInformation | undefined, initialState : _RouteLifecycle,}) => I_RouteEntry;
_routeEntryIsPresentPredicate: (entry: I_RouteEntry) => boolean;
_routeEntrySuitableForTransitionAnimationPredicate: (entry: I_RouteEntry) => boolean;
_routeEntryWillBePresentPredicate: (entry: I_RouteEntry) => boolean;
_routeEntryIsRoutePredicate: (route: IRoute<any>) => (entry: I_RouteEntry) => boolean
}
};
...
handleAdd: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void;
handlePush: ( props : {  isNewFirst : boolean, navigator : INavigatorState, previous? : IRoute<any> | undefined, previousPresent? : IRoute<any> | undefined,}) => void;
handleDidPopNext: (poppedRoute: IRoute<any>) => void;
handlePop: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void;
handleRemoval: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void;
didAdd: ( props : {  isNewFirst : boolean, navigator : INavigatorState,}) => void;
...
shouldAnnounceChangeToNext: (nextRoute?: IRoute<any> | undefined) => boolean;
...
toString: () => string;
getHashCode: () => number;
}export class _RouteEntry

 implements IRouteTransitionRecord
{    public readonly route: IRoute<any> = undefined as any;
    public readonly restorationInformation: I_RestorationInformation | undefined = undefined as any;
    public readonly currentState: _RouteLifecycle = undefined as any;
    public readonly lastAnnouncedPreviousRoute: IRoute<any> | undefined = undefined as any;
    public readonly lastAnnouncedPoppedNextRoute: IRoute<any> = undefined as any;
    public readonly lastAnnouncedNextRoute: IRoute<any> | undefined = undefined as any;
    public readonly doingPop: boolean = undefined as any;
public constructor(route: IRoute<any>, props : {  restorationInformation? : I_RestorationInformation | undefined, initialState : _RouteLifecycle,}){
...
}public static suitableForTransitionAnimationPredicate(entry: I_RouteEntry) : boolean{
return flutter.widgets._routeEntrySuitableForTransitionAnimationPredicate(entry);
...
}public static isRoutePredicate(route: IRoute<any>) : (entry: I_RouteEntry) => boolean{
return flutter.widgets._routeEntryIsRoutePredicate(route);
    ...
    private readonly _dart_canUpdateFrom: (page: IPage<any>) => boolean = undefined as any;
    private readonly _dart_handleAdd: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void = undefined as any;
    private readonly _dart_handlePush: ( props : {  isNewFirst : boolean, navigator : INavigatorState, previous? : IRoute<any> | undefined, previousPresent? : IRoute<any> | undefined,}) => void = undefined as any;
    private readonly _dart_handleDidPopNext: (poppedRoute: IRoute<any>) => void = undefined as any;
    private readonly _dart_handlePop: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void = undefined as any;
    private readonly _dart_handleRemoval: ( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) => void = undefined as any;
    private readonly _dart_didAdd: ( props : {  isNewFirst : boolean, navigator : INavigatorState,}) => void = undefined as any;
    private readonly _dart_pop: <T>(result?: T | undefined) => void = undefined as any;
    private readonly _dart_remove: ( props : {  isReplaced : boolean,}) => void = undefined as any;
    private readonly _dart_complete: <T>(result: T, props : {  isReplaced : boolean,}) => void = undefined as any;
    ...
    private readonly _dart_getIsPresentForRestoration: () => boolean = undefined as any;
    private readonly _dart_getSuitableForAnnouncement: () => boolean = undefined as any;
    private readonly _dart_getSuitableForTransitionAnimation: () => boolean = undefined as any;
    private readonly _dart_shouldAnnounceChangeToNext: (nextRoute?: IRoute<any> | undefined) => boolean = undefined as any;
    private readonly _dart_getIsWaitingForEnteringDecision: () => boolean = undefined as any;
    private readonly _dart_getIsWaitingForExitingDecision: () => boolean = undefined as any;
    private readonly _dart_markNeedsExitingDecision: () => void = undefined as any;
    ...
    private readonly _dart_markForComplete: (result: any) => void = undefined as any;
    private readonly _dart_markForRemove: () => void = undefined as any;
    private readonly _dart_getRestorationEnabled: () => boolean = undefined as any;
    private readonly _dart_setRestorationEnabled: (value: boolean) => void = undefined as any;
...
public handleAdd( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) : void {
    return this._dart_handleAdd(props);
}
public handlePush( props : {  isNewFirst : boolean, navigator : INavigatorState, previous? : IRoute<any> | undefined, previousPresent? : IRoute<any> | undefined,}) : void {
...
public handlePop( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) : void {
    return this._dart_handlePop(props);
}
public handleRemoval( props : {  navigator : INavigatorState, previousPresent? : IRoute<any> | undefined,}) : void {
    return this._dart_handleRemoval(props);
}
public didAdd( props : {  isNewFirst : boolean, navigator : INavigatorState,}) : void {
...
public shouldAnnounceChangeToNext(nextRoute?: IRoute<any> | undefined) : boolean {

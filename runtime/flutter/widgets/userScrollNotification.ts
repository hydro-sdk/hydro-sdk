...
widgets: {
userScrollNotification: (this: void, userScrollNotification: IUserScrollNotification, props : {  context : IBuildContext, direction : ScrollDirection, metrics : IScrollMetrics,}) => IUserScrollNotification
}
};
...
public constructor( props : {  context : IBuildContext, direction : ScrollDirection, metrics : IScrollMetrics,}){

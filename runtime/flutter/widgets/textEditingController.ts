...
widgets: {
textEditingController: (this: void, textEditingController: ITextEditingController, props? : {  text? : string | undefined,}) => ITextEditingController
}
};
...
buildTextSpan: ( props : {  style? : ITextStyle | undefined, context : IBuildContext, withComposing : boolean,}) => ITextSpan;
...
getHashCode: () => number;
 ...
 implements IValueNotifier<ITextEditingValue>, IValueListenable<ITextEditingValue>, IListenable
...
flutter.widgets.textEditingController(this, props);}
    ...
    private readonly _dart_setText: (newText: string) => void = undefined as any;
    private readonly _dart_setValue: (newValue: ITextEditingValue) => void = undefined as any;
    private readonly _dart_buildTextSpan: ( props : {  style? : ITextStyle | undefined, context : IBuildContext, withComposing : boolean,}) => ITextSpan = undefined as any;
    private readonly _dart_getSelection: () => ITextSelection = undefined as any;
    private readonly _dart_setSelection: (newSelection: ITextSelection) => void = undefined as any;
    private readonly _dart_clear: () => void = undefined as any;
    private readonly _dart_clearComposing: () => void = undefined as any;
    private readonly _dart_isSelectionWithinTextBounds: (selection: ITextSelection) => boolean = undefined as any;
...
public buildTextSpan( props : {  style? : ITextStyle | undefined, context : IBuildContext, withComposing : boolean,}) : ITextSpan {

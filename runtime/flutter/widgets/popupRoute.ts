...
widgets: {
popupRoute: <T>(this: void, popupRoute: IPopupRoute<T>, props? : {  filter? : IImageFilter | undefined, settings? : IRouteSettings | undefined,}) => IPopupRoute<T>
}
};
export interface IPopupRoute
<T>
...
public constructor( props? : {  filter? : IImageFilter | undefined, settings? : IRouteSettings | undefined,}){
flutter.widgets.popupRoute(this, props);}

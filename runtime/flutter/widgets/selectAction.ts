...
widgets: {
selectAction: (this: void, selectAction: ISelectAction) => ISelectAction
}
};
...
flutter.widgets.selectAction(this);}
    private readonly _dart_isEnabled: (intent: ISelectIntent) => boolean = undefined as any;
    private readonly _dart_consumesKey: (intent: ISelectIntent) => boolean = undefined as any;
    private readonly _dart_invoke: (intent: ISelectIntent) => Object | undefined = undefined as any;
    ...
    private readonly _dart_getCallingAction: () => IAction<ISelectIntent> | undefined = undefined as any;

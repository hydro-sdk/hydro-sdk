...
declare const flutter: {
    widgets: {
        _backButtonListenerState: (
            this: void,
            _backButtonListenerState: I_BackButtonListenerState
        ) => I_BackButtonListenerState;
    };
};
...
export class _BackButtonListenerState
    implements
        Omit<IState<IBackButtonListener>, "debugFillProperties">,
        IDiagnosticable
{
    public readonly dispatcher: IBackButtonDispatcher | undefined =
        undefined as any;
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IBackButtonListener =
        undefined as any;

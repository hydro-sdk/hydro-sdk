...
widgets: {
animatedListState: (this: void, animatedListState: IAnimatedListState) => IAnimatedListState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<IAnimatedList>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ITickerProviderStateMixin<IAnimatedList>, IDiagnosticable, ITickerProvider
{public constructor(){

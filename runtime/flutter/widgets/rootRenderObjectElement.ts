...
widgets: {
rootRenderObjectElement: (this: void, rootRenderObjectElement: IRootRenderObjectElement, widget: IRenderObjectWidget) => IRootRenderObjectElement
}
};
export interface IRootRenderObjectElement
...
flutter.widgets.rootRenderObjectElement(this, widget);}
    ...
    private readonly _dart_getWidget: () => IRenderObjectWidget = undefined as any;

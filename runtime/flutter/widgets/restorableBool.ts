...
widgets: {
restorableBool: (this: void, restorableBool: IRestorableBool, defaultValue: boolean) => IRestorableBool
}
};
...
flutter.widgets.restorableBool(this, defaultValue);}
    private readonly _dart_fromPrimitives: (serialized?: Object | undefined) => boolean = undefined as any;
    private readonly _dart_toPrimitives: () => Object = undefined as any;
    private readonly _dart_setValue: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_initWithValue: (value: boolean) => void = undefined as any;

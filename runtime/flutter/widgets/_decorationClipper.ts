...
widgets: {
_decorationClipper: (this: void, _decorationClipper: I_DecorationClipper, props : {  textDirection? : TextDirection | undefined, decoration : IDecoration,}) => I_DecorationClipper
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _DecorationClipper
...
public constructor( props : {  textDirection? : TextDirection | undefined, decoration : IDecoration,}){

...
declare const flutter: {
    widgets: {
        sliverReorderableListState: (
            this: void,
            sliverReorderableListState: ISliverReorderableListState
...
export class SliverReorderableListState
    implements
        Omit<
            IState<ISliverReorderableList>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ISliverReorderableList>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => ISliverReorderableList =
        undefined as any;

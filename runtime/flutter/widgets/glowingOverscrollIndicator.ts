...
declare const flutter: {
    widgets: {
        glowingOverscrollIndicator: (
            this: void,
            glowingOverscrollIndicator: IGlowingOverscrollIndicator,
            props: {
    ...
    implements IStatefulWidget, IDiagnosticable
{
    ...
    private readonly _dart_createState: () => IState<IGlowingOverscrollIndicator> =
        undefined as any;

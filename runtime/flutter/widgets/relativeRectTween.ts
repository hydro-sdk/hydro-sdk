...
widgets: {
relativeRectTween: (this: void, relativeRectTween: IRelativeRectTween, props? : {  begin? : IRelativeRect | undefined, end? : IRelativeRect | undefined,}) => IRelativeRectTween
}
};
...
getHashCode: () => number;
}export class RelativeRectTween

 implements ITween<IRelativeRect>
...
public constructor( props? : {  begin? : IRelativeRect | undefined, end? : IRelativeRect | undefined,}){
flutter.widgets.relativeRectTween(this, props);}
    private readonly _dart_lerp: (t: number) => IRelativeRect = undefined as any;
    private readonly _dart_transform: (t: number) => IRelativeRect = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IRelativeRect = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IRelativeRect> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IRelativeRect> = undefined as any;

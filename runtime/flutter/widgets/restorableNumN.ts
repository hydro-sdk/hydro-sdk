...
widgets: {
restorableNumN: <T>(this: void, restorableNumN: IRestorableNumN<T>, defaultValue: T) => IRestorableNumN<T>
}
};
export interface IRestorableNumN
<T>

...
widgets: {
sizeTransition: (this: void, sizeTransition: ISizeTransition, props : {  axis : Axis, axisAlignment : number, child? : IWidget | undefined, key? : IKey | undefined, sizeFactor : IAnimation<number>,}) => ISizeTransition
}
};
...
public constructor( props : {  axis? : Axis, axisAlignment? : number, child? : IWidget | undefined, key? : IKey | undefined, sizeFactor : IAnimation<number>,}){
flutter.widgets.sizeTransition(this, {
...sizeTransitionDefaultProps,
...props
});}
    private readonly _dart_getSizeFactor: () => IAnimation<number> = undefined as any;

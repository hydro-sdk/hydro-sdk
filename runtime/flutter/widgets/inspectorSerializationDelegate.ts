...
declare const flutter: {
    widgets: {
        inspectorSerializationDelegate: (
            this: void,
            inspectorSerializationDelegate: IInspectorSerializationDelegate,
            props: {
                addAdditionalPropertiesCallback?: (
                    __: IInspectorSerializationDelegate
                ) => { [index: string]: Object } | undefined | undefined;
        ...
        ) => IInspectorSerializationDelegate;
    };
};

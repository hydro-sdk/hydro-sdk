...
declare const flutter: {
    widgets: {
        renderObjectToWidgetElement: <T>(
            this: void,
            renderObjectToWidgetElement: IRenderObjectToWidgetElement<T>,
            widget: IRenderObjectToWidgetAdapter<T>
        ) => IRenderObjectToWidgetElement<T>;
    };
};
export interface IRenderObjectToWidgetElement<T> {
...
export class RenderObjectToWidgetElement<T>
    implements IRootRenderObjectElement, IDiagnosticable, IBuildContext
{
    ...
    private readonly _dart_getWidget: () => IRenderObjectToWidgetAdapter<T> =
        undefined as any;
    ...
    private readonly _dart_getRenderObject: () => IRenderObjectWithChildMixin<T> =
        undefined as any;
    ...
    private readonly _dart_assignOwner: (owner: IBuildOwner) => void =
        undefined as any;

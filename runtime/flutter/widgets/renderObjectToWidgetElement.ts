...
import { IRenderObjectToWidgetAdapter } from "./renderObjectToWidgetAdapter";
import { IRootRenderObjectElement } from "./rootRenderObjectElement";
...
widgets: {
renderObjectToWidgetElement: <T>(this: void, renderObjectToWidgetElement: IRenderObjectToWidgetElement<T>, widget: IRenderObjectToWidgetAdapter<T>) => IRenderObjectToWidgetElement<T>
}
};
export interface IRenderObjectToWidgetElement
<T>

{
getWidget: () => IRenderObjectToWidgetAdapter<T>;
...
performRebuild: () => void;
getRenderObject: () => IRenderObjectWithChildMixin<T>;
...
assignOwner: (owner: IBuildOwner) => void;
...
}export class RenderObjectToWidgetElement
<T>
 implements IRootRenderObjectElement, IDiagnosticable, IBuildContext
{    public static _rootChildSlot = new Object();
public constructor(widget: IRenderObjectToWidgetAdapter<T>){
flutter.widgets.renderObjectToWidgetElement(this, widget);}
    private readonly _dart_getWidget: () => IRenderObjectToWidgetAdapter<T> = undefined as any;
    ...
    private readonly _dart_getRenderObject: () => IRenderObjectWithChildMixin<T> = undefined as any;
    ...
    private readonly _dart_assignOwner: (owner: IBuildOwner) => void = undefined as any;
...
public getWidget() : IRenderObjectToWidgetAdapter<T> {
...
public getRenderObject() : IRenderObjectWithChildMixin<T> {
...
public assignOwner(owner: IBuildOwner) : void {
    return this._dart_assignOwner(owner);
}

...
widgets: {
_focusTraversalGroupMarker: (this: void, _focusTraversalGroupMarker: I_FocusTraversalGroupMarker, props : {  child : IWidget, focusNode : IFocusNode, policy : IFocusTraversalPolicy,}) => I_FocusTraversalGroupMarker
}
};
...
public constructor( props : {  child : IWidget, focusNode : IFocusNode, policy : IFocusTraversalPolicy,}){

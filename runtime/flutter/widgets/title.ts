...
widgets: {
title: (this: void, title: ITitle, props : {  key? : IKey | undefined, title : string, child : IWidget, color : IColor,}) => ITitle
}
};
...
public constructor( props : {  key? : IKey | undefined, title? : string, child : IWidget, color : IColor,}){
flutter.widgets.title(this, {
...titleDefaultProps,
...props
});}

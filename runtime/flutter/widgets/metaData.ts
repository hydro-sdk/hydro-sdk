...
import { IRenderMetaData } from "../rendering/renderMetaData";
...
widgets: {
metaData: (this: void, metaData: IMetaData, props : {  behavior : HitTestBehavior, child? : IWidget | undefined, key? : IKey | undefined, metaData : any,}) => IMetaData
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderMetaData;
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IWidget | undefined, key? : IKey | undefined, metaData : any,}){
flutter.widgets.metaData(this, {
...metaDataDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderMetaData = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderMetaData {

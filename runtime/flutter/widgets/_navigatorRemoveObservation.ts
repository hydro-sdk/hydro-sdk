...
declare const flutter: {
    widgets: {
        _navigatorRemoveObservation: (
            this: void,
            _navigatorRemoveObservation: I_NavigatorRemoveObservation,
            primaryRoute: IRoute<any>,
            secondaryRoute?: IRoute<any> | undefined
        ) => I_NavigatorRemoveObservation;
    };
};
...
export class _NavigatorRemoveObservation implements I_NavigatorObservation {
    ...
    public constructor(
        ...
        flutter.widgets._navigatorRemoveObservation(
            this,
            primaryRoute,
            secondaryRoute
        );

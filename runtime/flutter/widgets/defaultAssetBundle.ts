...
widgets: {
defaultAssetBundle: (this: void, defaultAssetBundle: IDefaultAssetBundle, props : {  key? : IKey | undefined, bundle : IAssetBundle, child : IWidget,}) => IDefaultAssetBundle;

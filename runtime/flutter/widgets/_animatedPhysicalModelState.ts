...
declare const flutter: {
    widgets: {
        _animatedPhysicalModelState: (
            this: void,
            _animatedPhysicalModelState: I_AnimatedPhysicalModelState
        ) => I_AnimatedPhysicalModelState;
    };
};
...
export class _AnimatedPhysicalModelState
    implements
        IAnimatedWidgetBaseState<IAnimatedPhysicalModel>,
        ISingleTickerProviderStateMixin<IAnimatedPhysicalModel>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedPhysicalModel =
        undefined as any;

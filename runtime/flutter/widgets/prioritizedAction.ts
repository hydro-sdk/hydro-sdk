...
widgets: {
prioritizedAction: (this: void, prioritizedAction: IPrioritizedAction) => IPrioritizedAction
}
};
...
flutter.widgets.prioritizedAction(this);}
    private readonly _dart_isEnabled: (intent: IPrioritizedIntents) => boolean = undefined as any;
    private readonly _dart_invoke: (intent: IPrioritizedIntents) => Object | undefined = undefined as any;
    private readonly _dart_consumesKey: (intent: IPrioritizedIntents) => boolean = undefined as any;
    ...
    private readonly _dart_getCallingAction: () => IAction<IPrioritizedIntents> | undefined = undefined as any;

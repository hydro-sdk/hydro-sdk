...
declare const flutter: {
    widgets: {
        _dragInfo: (
            this: void,
            _dragInfo: I_DragInfo,
            props: {
                initialPosition: IOffset;
                onCancel?: (item: I_DragInfo) => void | undefined;
                onDropCompleted?: () => void | undefined;
                onEnd?: (item: I_DragInfo) => void | undefined;
                onUpdate?: (
                    item: I_DragInfo,
                    position: IOffset,
                    delta: IOffset
...
export class _DragInfo implements IDrag {
    ...
    private readonly _dart_createProxy: (context: IBuildContext) => IWidget =
        undefined as any;

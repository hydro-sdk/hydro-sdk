...
import { IRenderSliverPadding } from "../rendering/renderSliverPadding";
...
widgets: {
sliverPadding: (this: void, sliverPadding: ISliverPadding, props : {  key? : IKey | undefined, sliver? : IWidget | undefined, padding : IEdgeInsetsGeometry,}) => ISliverPadding
}
};
export interface ISliverPadding
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverPadding;
...
public constructor( props : {  key? : IKey | undefined, sliver? : IWidget | undefined, padding : IEdgeInsetsGeometry,}){
flutter.widgets.sliverPadding(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverPadding = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverPadding {

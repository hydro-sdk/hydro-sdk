...
widgets: {
restorableIntN: (this: void, restorableIntN: IRestorableIntN, defaultValue?: number | undefined) => IRestorableIntN
}
};
export interface IRestorableIntN
...
flutter.widgets.restorableIntN(this, defaultValue);}
    ...
    private readonly _dart_fromPrimitives: (serialized?: Object | undefined) => number | undefined = undefined as any;

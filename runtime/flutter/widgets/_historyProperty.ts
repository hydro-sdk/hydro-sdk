...
declare const flutter: {
    widgets: {
        _historyProperty: (
            this: void,
            _historyProperty: I_HistoryProperty
        ) => I_HistoryProperty;
    };
};
export interface I_HistoryProperty {
    ...
    restoreEntriesForPage: (
        page: I_RouteEntry | undefined,
        navigator: INavigatorState
    ) => IList<I_RouteEntry>;
    createDefaultValue: () =>
        | { [index: string | undefined]: IList<Object> }
        | undefined;
    fromPrimitives: (
        data?: Object | undefined
    ) => { [index: string | undefined]: IList<Object> } | undefined;
    initWithValue: (
        value?: { [index: string | undefined]: IList<Object> } | undefined
    ) => void;
    ...
    implements IRestorableProperty<?IMap<?string, IList<Object>>>, IListenable
{
    ...
    private readonly _dart_update: (history: IList<I_RouteEntry>) => void =
        undefined as any;
    private readonly _dart_clear: () => void = undefined as any;
    private readonly _dart_getHasData: () => boolean = undefined as any;
    private readonly _dart_restoreEntriesForPage: (
        page: I_RouteEntry | undefined,
        navigator: INavigatorState
    ) => IList<I_RouteEntry> = undefined as any;

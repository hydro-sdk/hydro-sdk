...
declare const flutter: {
    widgets: {
        _nestedScrollPosition: (
            this: void,
            _nestedScrollPosition: I_NestedScrollPosition,
            props: {
...
export interface I_NestedScrollPosition {
    ...
    createBallisticScrollActivity: (
        ...
        props: {
            metrics?: I_NestedScrollMetrics | undefined;
            mode: _NestedBallisticScrollActivityMode;
        }
    ) => IScrollActivity;
    animateTo: (
        to: number,
        ...
        IListenable
{
    ...
    private readonly _dart_applyClampedDragUpdate: (delta: number) => number =
        undefined as any;
    private readonly _dart_applyFullDragUpdate: (delta: number) => number =
        undefined as any;
    private readonly _dart_applyClampedPointerSignalUpdate: (
        delta: number
    ) => number = undefined as any;
    private readonly _dart_getUserScrollDirection: () => ScrollDirection =
        undefined as any;
    private readonly _dart_createDrivenScrollActivity: (
        to: number,
        duration: IDuration,
        curve: ICurve
    ) => IDrivenScrollActivity = undefined as any;
    private readonly _dart_applyUserOffset: (delta: number) => number =
        undefined as any;
    private readonly _dart_goIdle: () => void = undefined as any;
    private readonly _dart_goBallistic: (velocity: number) => void =
        undefined as any;
    private readonly _dart_createBallisticScrollActivity: (
        simulation?: ISimulation | undefined,
        props: {
            metrics?: I_NestedScrollMetrics | undefined;
            mode: _NestedBallisticScrollActivityMode;
    ...
    private readonly _dart_jumpToWithoutSettling: (value: number) => void =
        undefined as any;
    private readonly _dart_localJumpTo: (value: number) => void =
        undefined as any;
    private readonly _dart_applyNewDimensions: () => void = undefined as any;
    private readonly _dart_updateCanDrag: (totalExtent: number) => void =
        undefined as any;
    ...
    public createDrivenScrollActivity(
        to: number,
        duration: IDuration,
        curve: ICurve
    ): IDrivenScrollActivity {
    ...
    public createBallisticScrollActivity(
        simulation?: ISimulation | undefined,
        props: {
            metrics?: I_NestedScrollMetrics | undefined;
            mode: _NestedBallisticScrollActivityMode;

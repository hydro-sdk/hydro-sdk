...
declare const flutter: {
    widgets: {
        _actionsMarker: (
            this: void,
            _actionsMarker: I_ActionsMarker,
            props: {
                key?: IKey | undefined;
...
export class _ActionsMarker implements IInheritedWidget, IDiagnosticable {
    public readonly dispatcher: IActionDispatcher | undefined =
        undefined as any;

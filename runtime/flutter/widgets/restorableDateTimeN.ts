...
declare const flutter: {
    widgets: {
        restorableDateTimeN: (
            this: void,
            restorableDateTimeN: IRestorableDateTimeN,
            defaultValue?: IDateTime | undefined
        ) => IRestorableDateTimeN;
    };
};
    ...
    implements IRestorableValue<?IDateTime>, IListenable
{
    ...
    private readonly _dart_createDefaultValue: () => IDateTime | undefined =
        undefined as any;
    ...
    private readonly _dart_getValue: () => IDateTime | undefined =
        undefined as any;
    private readonly _dart_setValue: (
        newValue?: IDateTime | undefined
    ) => void = undefined as any;

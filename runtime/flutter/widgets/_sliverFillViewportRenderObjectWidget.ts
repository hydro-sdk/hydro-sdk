...
declare const flutter: {
    widgets: {
        _sliverFillViewportRenderObjectWidget: (
            this: void,
            _sliverFillViewportRenderObjectWidget: I_SliverFillViewportRenderObjectWidget,
            props: {
                key?: IKey | undefined;
                viewportFraction: number;
                delegate: ISliverChildDelegate;
            }
        ) => I_SliverFillViewportRenderObjectWidget;
    };
};
    ...
    implements ISliverMultiBoxAdaptorWidget, IDiagnosticable
{
    ...
    ) => IRenderSliverFillViewport = undefined as any;

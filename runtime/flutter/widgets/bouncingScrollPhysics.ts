...
declare const flutter: {
    widgets: {
        bouncingScrollPhysics: (
            this: void,
            bouncingScrollPhysics: IBouncingScrollPhysics,
            props?: { parent?: IScrollPhysics | undefined }
        ) => IBouncingScrollPhysics;
    };
};
...
export class BouncingScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => IBouncingScrollPhysics = undefined as any;
    private readonly _dart_frictionFactor: (
    ...
    private readonly _dart_getDragStartDistanceMotionThreshold: () => number =
        undefined as any;

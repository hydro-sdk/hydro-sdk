...
declare const flutter: {
    widgets: {
        transformationController: (
            this: void,
            transformationController: ITransformationController,
...
export class TransformationController
    implements
        IValueNotifier<IMatrix4>,
        IValueListenable<IMatrix4>,
        IListenable
{
    public constructor(value?: IMatrix4 | undefined) {
        flutter.widgets.transformationController(this, value);
    }
    private readonly _dart_toScene: (viewportPoint: IOffset) => IOffset =
        undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_getValue: () => IMatrix4 = undefined as any;
    private readonly _dart_setValue: (newValue: IMatrix4) => void =
        undefined as any;

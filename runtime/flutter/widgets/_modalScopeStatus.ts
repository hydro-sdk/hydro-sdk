...
widgets: {
_modalScopeStatus: (this: void, _modalScopeStatus: I_ModalScopeStatus, props : {  key? : IKey | undefined, canPop : boolean, child : IWidget, isCurrent : boolean, route : IRoute<any>,}) => I_ModalScopeStatus
}
};
export interface I_ModalScopeStatus
...
}export class _ModalScopeStatus

 implements IInheritedWidget, IDiagnosticable
{    public readonly isCurrent: boolean = undefined as any;
    public readonly canPop: boolean = undefined as any;
    public readonly route: IRoute<any> = undefined as any;
    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, canPop : boolean, child : IWidget, isCurrent : boolean, route : IRoute<any>,}){
flutter.widgets._modalScopeStatus(this, props);}

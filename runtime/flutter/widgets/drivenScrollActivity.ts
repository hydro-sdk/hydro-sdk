...
widgets: {
drivenScrollActivity: (this: void, drivenScrollActivity: IDrivenScrollActivity, delegate: IScrollActivityDelegate, props : {  curve : ICurve, duration : IDuration, from : number, to : number, vsync : ITickerProvider,}) => IDrivenScrollActivity
}
};
...
getHashCode: () => number;
}export class DrivenScrollActivity

 implements IScrollActivity
{public constructor(delegate: IScrollActivityDelegate, props : {  curve : ICurve, duration : IDuration, from : number, to : number, vsync : ITickerProvider,}){

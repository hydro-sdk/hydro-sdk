...
widgets: {
listener: (this: void, listener: IListener, props : {  behavior : HitTestBehavior, child? : IWidget | undefined, key? : IKey | undefined, onPointerCancel? : (event: IPointerCancelEvent) => void | undefined, onPointerDown? : (event: IPointerDownEvent) => void | undefined, onPointerHover? : (event: IPointerHoverEvent) => void | undefined, onPointerMove? : (event: IPointerMoveEvent) => void | undefined, onPointerSignal? : (event: IPointerSignalEvent) => void | undefined, onPointerUp? : (event: IPointerUpEvent) => void | undefined,}) => IListener
}
};
...
public constructor( props : {  behavior? : HitTestBehavior, child? : IWidget | undefined, key? : IKey | undefined, onPointerCancel? : (event: IPointerCancelEvent) => void | undefined, onPointerDown? : (event: IPointerDownEvent) => void | undefined, onPointerHover? : (event: IPointerHoverEvent) => void | undefined, onPointerMove? : (event: IPointerMoveEvent) => void | undefined, onPointerSignal? : (event: IPointerSignalEvent) => void | undefined, onPointerUp? : (event: IPointerUpEvent) => void | undefined,}){
flutter.widgets.listener(this, {
...listenerDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderPointerListener = undefined as any;

...
widgets: {
animatedAlign: (this: void, animatedAlign: IAnimatedAlign, props : {  child? : IWidget | undefined, curve : ICurve, heightFactor? : number | undefined, key? : IKey | undefined, onEnd? : () => void | undefined, widthFactor? : number | undefined, alignment : IAlignmentGeometry, duration : IDuration,}) => IAnimatedAlign
}
};
...
public constructor( props : {  child? : IWidget | undefined, curve? : ICurve, heightFactor? : number | undefined, key? : IKey | undefined, onEnd? : () => void | undefined, widthFactor? : number | undefined, alignment : IAlignmentGeometry, duration : IDuration,}){
flutter.widgets.animatedAlign(this, {
...animatedAlignDefaultProps,
...props
});}
    private readonly _dart_createState: () => IAnimatedWidgetBaseState<IAnimatedAlign> = undefined as any;

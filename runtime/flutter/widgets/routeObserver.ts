...
declare const flutter: {
    widgets: {
        routeObserver: <R>(
            this: void,
            routeObserver: IRouteObserver<R>
        ) => IRouteObserver<R>;
    };
};
export interface IRouteObserver<R> {
...
export class RouteObserver<R> implements INavigatorObserver {
    public constructor() {
        flutter.widgets.routeObserver(this);
    }
    private readonly _dart_subscribe: (
        routeAware: IRouteAware,
        route: R
    ) => void = undefined as any;
    private readonly _dart_unsubscribe: (routeAware: IRouteAware) => void =
        undefined as any;
    private readonly _dart_didPop: (
        route: IRoute<any>,
        previousRoute?: IRoute<any> | undefined
    ) => void = undefined as any;
    private readonly _dart_didPush: (
        route: IRoute<any>,
        previousRoute?: IRoute<any> | undefined
    ) => void = undefined as any;
    private readonly _dart_didRemove: (
        route: IRoute<any>,
        previousRoute?: IRoute<any> | undefined
    ) => void = undefined as any;
    private readonly _dart_didReplace: (props?: {
        newRoute?: IRoute<any> | undefined;
        oldRoute?: IRoute<any> | undefined;
    }) => void = undefined as any;
    private readonly _dart_didStartUserGesture: (
        route: IRoute<any>,
        previousRoute?: IRoute<any> | undefined
    ) => void = undefined as any;
    ...
    public didReplace(props?: {
        newRoute?: IRoute<any> | undefined;
        oldRoute?: IRoute<any> | undefined;
    }): void {
        return this._dart_didReplace(props);
    }
    public didStartUserGesture(
        route: IRoute<any>,
        previousRoute?: IRoute<any> | undefined
    ): void {

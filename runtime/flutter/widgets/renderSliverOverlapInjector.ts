...
widgets: {
renderSliverOverlapInjector: (this: void, renderSliverOverlapInjector: IRenderSliverOverlapInjector, props : {  handle : ISliverOverlapAbsorberHandle,}) => IRenderSliverOverlapInjector
}
};
export interface IRenderSliverOverlapInjector
...
getHashCode: () => number;
}export class RenderSliverOverlapInjector

 implements IRenderSliver, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  handle : ISliverOverlapAbsorberHandle,}){
flutter.widgets.renderSliverOverlapInjector(this, props);}

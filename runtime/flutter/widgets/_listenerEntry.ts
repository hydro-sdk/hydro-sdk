...
declare const flutter: {
    widgets: {
        _listenerEntry: (
            this: void,
            _listenerEntry: I_ListenerEntry,
...
export class _ListenerEntry implements ILinkedListEntry<I_ListenerEntry> {
    ...
    private readonly _dart_insertAfter: (entry: I_ListenerEntry) => void =
        undefined as any;
    private readonly _dart_insertBefore: (entry: I_ListenerEntry) => void =
        undefined as any;
    private readonly _dart_getList: () =>
        | ILinkedList<I_ListenerEntry>
        | undefined = undefined as any;
    private readonly _dart_getNext: () => I_ListenerEntry | undefined =
        undefined as any;
    private readonly _dart_getPrevious: () => I_ListenerEntry | undefined =
        undefined as any;

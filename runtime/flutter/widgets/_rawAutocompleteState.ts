...
widgets: {
_rawAutocompleteState: <T>(this: void, _rawAutocompleteState: I_RawAutocompleteState<T>) => I_RawAutocompleteState<T>
}
};
export interface I_RawAutocompleteState
<T>
...
getHashCode: () => number;
}export class _RawAutocompleteState
<T>
 implements Omit<IState<IRawAutocomplete<T>>, "debugFillProperties">, IDiagnosticable
{    public static _shortcuts =  Map.fromEntries(<IIterable<IMapEntry<IShortcutActivator,IIntent>>><unknown>List.fromArray([ new MapEntry(new SingleActivator(LogicalKeyboardKey.arrowUp) , new AutocompletePreviousOptionIntent()),  new MapEntry(new SingleActivator(LogicalKeyboardKey.arrowDown) , new AutocompleteNextOptionIntent())]));
public constructor(){
flutter.widgets._rawAutocompleteState(this);}
    ...
    private readonly _dart_getWidget: () => IRawAutocomplete<T> = undefined as any;

...
import { IRenderSliverList } from "../rendering/renderSliverList";
...
widgets: {
sliverList: (this: void, sliverList: ISliverList, props : {  key? : IKey | undefined, delegate : ISliverChildDelegate,}) => ISliverList
}
};
export interface ISliverList
...
createRenderObject: (context: IBuildContext) => IRenderSliverList;
...
flutter.widgets.sliverList(this, props);}
    private readonly _dart_createElement: () => ISliverMultiBoxAdaptorElement = undefined as any;
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverList = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverList {

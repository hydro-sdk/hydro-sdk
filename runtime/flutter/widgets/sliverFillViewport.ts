...
widgets: {
sliverFillViewport: (this: void, sliverFillViewport: ISliverFillViewport, props : {  key? : IKey | undefined, padEnds : boolean, viewportFraction : number, delegate : ISliverChildDelegate,}) => ISliverFillViewport
}
};
export interface ISliverFillViewport
...
}export class SliverFillViewport
...
public constructor( props : {  key? : IKey | undefined, padEnds? : boolean, viewportFraction? : number, delegate : ISliverChildDelegate,}){
flutter.widgets.sliverFillViewport(this, {
...sliverFillViewportDefaultProps,
...props
});}
...
const sliverFillViewportDefaultProps = {
    padEnds: true,

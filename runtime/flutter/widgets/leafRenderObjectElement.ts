...
widgets: {
leafRenderObjectElement: (this: void, leafRenderObjectElement: ILeafRenderObjectElement, widget: ILeafRenderObjectWidget) => ILeafRenderObjectElement
}
};
export interface ILeafRenderObjectElement
...
}export class LeafRenderObjectElement

 implements IRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: ILeafRenderObjectWidget){
flutter.widgets.leafRenderObjectElement(this, widget);}

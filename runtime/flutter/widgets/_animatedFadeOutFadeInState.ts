...
widgets: {
_animatedFadeOutFadeInState: (this: void, _animatedFadeOutFadeInState: I_AnimatedFadeOutFadeInState) => I_AnimatedFadeOutFadeInState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IImplicitlyAnimatedWidgetState<I_AnimatedFadeOutFadeIn>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<I_AnimatedFadeOutFadeIn>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedFadeOutFadeInState(this);}
    ...
    private readonly _dart_getWidget: () => I_AnimatedFadeOutFadeIn = undefined as any;

...
declare const flutter: {
    widgets: {
        _sliverFillRemainingAndOverscroll: (
            this: void,
            _sliverFillRemainingAndOverscroll: I_SliverFillRemainingAndOverscroll,
            props?: { child?: IWidget | undefined; key?: IKey | undefined }
        ) => I_SliverFillRemainingAndOverscroll;
    };
};
    ...
    implements ISingleChildRenderObjectWidget, IDiagnosticable
{
    ...
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => IRenderSliverFillRemainingAndOverscroll = undefined as any;

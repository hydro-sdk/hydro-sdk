...
elementDescribeElements: (name: string, elements: IIterable<IElement>) => IDiagnosticsNode
}
};
...
getDebugDoingBuild: () => boolean;
 ...
 implements Omit<IDiagnosticableTree, "toStringShort" | "toDiagnosticsNode">, IDiagnosticable, IBuildContext
{public constructor(widget: IWidget){
flutter.widgets.element(this, widget);}
public static describeElements(name: string, elements: IIterable<IElement>) : IDiagnosticsNode{

...
widgets: {
_editable: (this: void, _editable: I_Editable, props : {  backgroundCursorColor? : IColor | undefined, cursorColor? : IColor | undefined, cursorHeight? : number | undefined, cursorRadius? : IRadius | undefined, enableInteractiveSelection : boolean, key? : IKey | undefined, locale? : ILocale | undefined, minLines? : number | undefined, onCaretChanged? : (caretRect: IRect) => void | undefined, promptRectColor? : IColor | undefined, promptRectRange? : ITextRange | undefined, rendererIgnoresPointer : boolean, selectionColor? : IColor | undefined, selectionHeightStyle : BoxHeightStyle, selectionWidthStyle : BoxWidthStyle, strutStyle? : IStrutStyle | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, autocorrect : boolean, clipBehavior : Clip, cursorOffset : IOffset, cursorWidth : number, devicePixelRatio : number, enableSuggestions : boolean, endHandleLayerLink : ILayerLink, expands : boolean, forceLine : boolean, hasFocus : boolean, inlineSpan : IInlineSpan, maxLines? : number | undefined, obscureText : boolean, obscuringCharacter : string, offset : IViewportOffset, paintCursorAboveText : boolean, readOnly : boolean, showCursor : IValueNotifier<boolean>, smartDashesType : SmartDashesType, smartQuotesType : SmartQuotesType, startHandleLayerLink : ILayerLink, textAlign : TextAlign, textDirection : TextDirection, textScaleFactor : number, textSelectionDelegate : ITextSelectionDelegate, textWidthBasis : TextWidthBasis, value : ITextEditingValue,}) => I_Editable
}
};
...
{    public readonly inlineSpan: IInlineSpan = undefined as any;
    ...
    public readonly backgroundCursorColor: IColor | undefined = undefined as any;
...
public constructor( props : {  backgroundCursorColor? : IColor | undefined, cursorColor? : IColor | undefined, cursorHeight? : number | undefined, cursorRadius? : IRadius | undefined, enableInteractiveSelection? : boolean, key? : IKey | undefined, locale? : ILocale | undefined, minLines? : number | undefined, onCaretChanged? : (caretRect: IRect) => void | undefined, promptRectColor? : IColor | undefined, promptRectRange? : ITextRange | undefined, rendererIgnoresPointer? : boolean, selectionColor? : IColor | undefined, selectionHeightStyle? : BoxHeightStyle, selectionWidthStyle? : BoxWidthStyle, strutStyle? : IStrutStyle | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, autocorrect : boolean, clipBehavior : Clip, cursorOffset : IOffset, cursorWidth : number, devicePixelRatio : number, enableSuggestions : boolean, endHandleLayerLink : ILayerLink, expands : boolean, forceLine : boolean, hasFocus : boolean, inlineSpan : IInlineSpan, maxLines? : number | undefined, obscureText : boolean, obscuringCharacter : string, offset : IViewportOffset, paintCursorAboveText : boolean, readOnly : boolean, showCursor : IValueNotifier<boolean>, smartDashesType : SmartDashesType, smartQuotesType : SmartQuotesType, startHandleLayerLink : ILayerLink, textAlign : TextAlign, textDirection : TextDirection, textScaleFactor : number, textSelectionDelegate : ITextSelectionDelegate, textWidthBasis : TextWidthBasis, value : ITextEditingValue,}){
flutter.widgets._editable(this, {
..._editableDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderEditable = undefined as any;

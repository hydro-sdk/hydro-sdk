...
import { IRenderDecoratedBox } from "../rendering/renderDecoratedBox";
...
widgets: {
decoratedBox: (this: void, decoratedBox: IDecoratedBox, props : {  child? : IWidget | undefined, key? : IKey | undefined, position : DecorationPosition, decoration : IDecoration,}) => IDecoratedBox
}
};
export interface IDecoratedBox
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderDecoratedBox;
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, position? : DecorationPosition, decoration : IDecoration,}){
flutter.widgets.decoratedBox(this, {
...decoratedBoxDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderDecoratedBox = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderDecoratedBox {
...
const decoratedBoxDefaultProps = {

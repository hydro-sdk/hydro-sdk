...
widgets: {
expanded: (this: void, expanded: IExpanded, props : {  flex : number, key? : IKey | undefined, child : IWidget,}) => IExpanded
}
};
...
...props
    ...
    private readonly _dart_createElement: () => IParentDataElement<IFlexParentData> = undefined as any;

...
widgets: {
disposableBuildContext: <T>(this: void, disposableBuildContext: IDisposableBuildContext<T>, _state: T) => IDisposableBuildContext<T>
}
};
export interface IDisposableBuildContext
<T>

{
getContext: () => IBuildContext | undefined;
dispose: () => void;
}export class DisposableBuildContext
<T>

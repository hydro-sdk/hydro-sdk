...
widgets: {
orientationBuilder: (this: void, orientationBuilder: IOrientationBuilder, props : {  key? : IKey | undefined, builder : (context: IBuildContext, orientation: Orientation) => IWidget,}) => IOrientationBuilder
}
};
...
}export class OrientationBuilder

 implements IStatelessWidget, IDiagnosticable
{    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, builder : (context: IBuildContext, orientation: Orientation) => IWidget,}){
flutter.widgets.orientationBuilder(this, props);}

...
declare const flutter: {
    widgets: {
        _widgetInspectorState: (
            this: void,
            _widgetInspectorState: I_WidgetInspectorState
        ) => I_WidgetInspectorState;
    };
};
...
export class _WidgetInspectorState
    implements
        Omit<IState<IWidgetInspector>, "toString" | "debugFillProperties">,
        ...
        IDiagnosticable
{
    ...
    private readonly _dart_hitTest: (
        position: IOffset,
        root: IRenderObject
    ) => IList<IRenderObject> = undefined as any;

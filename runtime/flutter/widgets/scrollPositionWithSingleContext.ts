...
widgets: {
scrollPositionWithSingleContext: (this: void, scrollPositionWithSingleContext: IScrollPositionWithSingleContext, props : {  debugLabel? : string | undefined, initialPixels? : number | undefined, keepScrollOffset : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, physics : IScrollPhysics,}) => IScrollPositionWithSingleContext
}
};
export interface IScrollPositionWithSingleContext
...
getHashCode: () => number;
}export class ScrollPositionWithSingleContext
...
public constructor( props : {  debugLabel? : string | undefined, initialPixels? : number | undefined, keepScrollOffset? : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, physics : IScrollPhysics,}){
flutter.widgets.scrollPositionWithSingleContext(this, {
...scrollPositionWithSingleContextDefaultProps,
...props
});}
...
const scrollPositionWithSingleContextDefaultProps = {
    initialPixels: 0.0,

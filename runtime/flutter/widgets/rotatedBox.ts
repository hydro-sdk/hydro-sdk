...
import { IRenderRotatedBox } from "../rendering/renderRotatedBox";
...
export interface IRotatedBox {
    quarterTurns: number;
    child: IWidget | undefined;
    key: IKey | undefined;
    createRenderObject: (context: IBuildContext) => IRenderRotatedBox;
...
{
    public readonly quarterTurns: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.widgets.rotatedBox(this, props);
    }
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => IRenderRotatedBox = undefined as any;
    ...
    public createRenderObject(context: IBuildContext): IRenderRotatedBox {

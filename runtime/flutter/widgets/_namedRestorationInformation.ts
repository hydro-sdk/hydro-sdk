...
declare const flutter: {
    widgets: {
        _namedRestorationInformation: (
            this: void,
            _namedRestorationInformation: I_NamedRestorationInformation,
            props: {
                arguments?: Object | undefined;
                name: string;
                restorationScopeId: number;
            }
        ) => I_NamedRestorationInformation;
        _namedRestorationInformationFromSerializableData: (
...
export class _NamedRestorationInformation implements I_RestorationInformation {
    ...
    public static fromSerializableData(
        ...
        return flutter.widgets._namedRestorationInformationFromSerializableData(
            data
        );
    }

...
declare const flutter: {
    widgets: {
        _animatedSlideState: (
            this: void,
            _animatedSlideState: I_AnimatedSlideState
        ) => I_AnimatedSlideState;
    };
};
...
export class _AnimatedSlideState
    implements
        Omit<
            IImplicitlyAnimatedWidgetState<IAnimatedSlide>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IAnimatedSlide>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {

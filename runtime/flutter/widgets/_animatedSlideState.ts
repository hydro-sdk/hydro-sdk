...
import { IAnimatedSlide } from "./animatedSlide";
...
widgets: {
_animatedSlideState: (this: void, _animatedSlideState: I_AnimatedSlideState) => I_AnimatedSlideState
}
};
export interface I_AnimatedSlideState
...
getHashCode: () => number;
}export class _AnimatedSlideState

 implements Omit<IImplicitlyAnimatedWidgetState<IAnimatedSlide>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<IAnimatedSlide>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedSlideState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedSlide = undefined as any;
...
public getWidget() : IAnimatedSlide {

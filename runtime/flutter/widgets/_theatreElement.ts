...
import { I_Theatre } from "./_theatre";
...
widgets: {
_theatreElement: (this: void, _theatreElement: I_TheatreElement, widget: I_Theatre) => I_TheatreElement
}
};
export interface I_TheatreElement


{
getWidget: () => I_Theatre;
getRenderObject: () => I_RenderTheatre;
...
}export class _TheatreElement

 implements IMultiChildRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: I_Theatre){
flutter.widgets._theatreElement(this, widget);}
    private readonly _dart_getWidget: () => I_Theatre = undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderTheatre = undefined as any;
...
public getWidget() : I_Theatre {
    return this._dart_getWidget();
}
public getRenderObject() : I_RenderTheatre {

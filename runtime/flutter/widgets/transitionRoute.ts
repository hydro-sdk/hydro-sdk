...
widgets: {
transitionRoute: <T>(this: void, transitionRoute: ITransitionRoute<T>, props? : {  settings? : IRouteSettings | undefined,}) => ITransitionRoute<T>
}
};
export interface ITransitionRoute
<T>
...
getIsActive: () => boolean;
getHashCode: () => number;
}export class TransitionRoute
<T>
 implements IOverlayRoute<T>

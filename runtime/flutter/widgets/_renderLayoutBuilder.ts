...
declare const flutter: {
    widgets: {
        _renderLayoutBuilder: (
            this: void,
            _renderLayoutBuilder: I_RenderLayoutBuilder
        ) => I_RenderLayoutBuilder;
    };
};
...
export class _RenderLayoutBuilder
    implements
        ...
        IRenderConstrainedLayoutBuilder<IBoxConstraints, IRenderBox>,
        ...
        >
{
    ...
    private readonly _dart_updateCallback: (
        value?: (constraints: IBoxConstraints) => void
    ) => void = undefined as any;

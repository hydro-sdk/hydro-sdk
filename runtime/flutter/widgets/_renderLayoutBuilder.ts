...
widgets: {
_renderLayoutBuilder: (this: void, _renderLayoutBuilder: I_RenderLayoutBuilder) => I_RenderLayoutBuilder
}
};
export interface I_RenderLayoutBuilder
...
updateCallback: (value? : (constraints: IBoxConstraints) => void) => void;
markNeedsBuild: () => void;
...
getHashCode: () => number;
}export class _RenderLayoutBuilder

 implements IRenderBox, IRenderObjectWithChildMixin<IRenderBox>, IRenderConstrainedLayoutBuilder<IBoxConstraints,IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor(){
flutter.widgets._renderLayoutBuilder(this);}
    ...
    private readonly _dart_updateCallback: (value? : (constraints: IBoxConstraints) => void) => void = undefined as any;
...
public updateCallback(value? : (constraints: IBoxConstraints) => void) : void {

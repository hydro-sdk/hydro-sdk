    ...
    widgets: {
        pageView: (
            ...
            props: {
                ...
                clipBehavior: Clip;
                controller?: IPageController | undefined;
...
export class PageView implements IStatefulWidget, IDiagnosticable {
    ...
    private readonly _dart_createState: () => IState<IPageView> =
        undefined as any;

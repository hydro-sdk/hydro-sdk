...
import { IRenderUiKitView } from "../rendering/renderUiKitView";
...
widgets: {
_uiKitPlatformView: (this: void, _uiKitPlatformView: I_UiKitPlatformView, props : {  key? : IKey | undefined, controller : IUiKitViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}) => I_UiKitPlatformView
}
};
export interface I_UiKitPlatformView
...
}export class _UiKitPlatformView
...
public constructor( props : {  key? : IKey | undefined, controller : IUiKitViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}){
flutter.widgets._uiKitPlatformView(this, props);}

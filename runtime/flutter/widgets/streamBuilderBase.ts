...
declare const flutter: {
    widgets: {
        streamBuilderBase: <T, S>(
            this: void,
            streamBuilderBase: IStreamBuilderBase<T, S>,
            props?: { key?: IKey | undefined; stream?: IStream<T> | undefined }
        ) => IStreamBuilderBase<T, S>;
    };
};
export interface IStreamBuilderBase<T, S> {
...
export class StreamBuilderBase<T, S>
    implements IStatefulWidget, IDiagnosticable
{
    ...
    private readonly _dart_afterData: (current: S, data: T) => S =
        undefined as any;
    ...
    private readonly _dart_afterDisconnected: (current: S) => S =
        undefined as any;
    private readonly _dart_build: (
        context: IBuildContext,
        currentSummary: S
    ) => IWidget = undefined as any;
    private readonly _dart_createState: () => IState<IStreamBuilderBase<T, S>> =
        undefined as any;

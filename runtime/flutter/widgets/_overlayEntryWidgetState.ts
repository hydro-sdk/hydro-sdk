...
declare const flutter: {
    widgets: {
        _overlayEntryWidgetState: (
            this: void,
            _overlayEntryWidgetState: I_OverlayEntryWidgetState
        ) => I_OverlayEntryWidgetState;
    };
};
...
export class _OverlayEntryWidgetState
    implements
        Omit<IState<I_OverlayEntryWidget>, "debugFillProperties">,
        IDiagnosticable
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => I_OverlayEntryWidget =
        undefined as any;

...
widgets: {
_nestedScrollCoordinator: (this: void, _nestedScrollCoordinator: I_NestedScrollCoordinator, _state: INestedScrollViewState, _parent: IScrollController | undefined, _onHasScrolledBodyChanged : () => void, _floatHeaderSlivers: boolean) => I_NestedScrollCoordinator
}
};
...
beginActivity: (newOuterActivity: IScrollActivity, innerActivityGetter : (position: I_NestedScrollPosition) => IScrollActivity) => void;
...
createInnerBallisticScrollActivity: (position: I_NestedScrollPosition, velocity: number) => IScrollActivity;
...
{public constructor(_state: INestedScrollViewState, _parent: IScrollController | undefined, _onHasScrolledBodyChanged : () => void, _floatHeaderSlivers: boolean){
flutter.widgets._nestedScrollCoordinator(this, _state, _parent, _onHasScrolledBodyChanged, _floatHeaderSlivers);}
    ...
    private readonly _dart_beginActivity: (newOuterActivity: IScrollActivity, innerActivityGetter : (position: I_NestedScrollPosition) => IScrollActivity) => void = undefined as any;
    ...
    private readonly _dart_createOuterBallisticScrollActivity: (velocity: number) => IScrollActivity = undefined as any;
    private readonly _dart_createInnerBallisticScrollActivity: (position: I_NestedScrollPosition, velocity: number) => IScrollActivity = undefined as any;
    private readonly _dart_unnestOffset: (value: number, source: I_NestedScrollPosition) => number = undefined as any;
    private readonly _dart_nestOffset: (value: number, target: I_NestedScrollPosition) => number = undefined as any;
...
public beginActivity(newOuterActivity: IScrollActivity, innerActivityGetter : (position: I_NestedScrollPosition) => IScrollActivity) : void {
...
public createOuterBallisticScrollActivity(velocity: number) : IScrollActivity {
    return this._dart_createOuterBallisticScrollActivity(velocity);
}
public createInnerBallisticScrollActivity(position: I_NestedScrollPosition, velocity: number) : IScrollActivity {
    return this._dart_createInnerBallisticScrollActivity(position, velocity);
}

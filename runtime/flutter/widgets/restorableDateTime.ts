...
widgets: {
restorableDateTime: (this: void, restorableDateTime: IRestorableDateTime, defaultValue: IDateTime) => IRestorableDateTime
}
};
...
flutter.widgets.restorableDateTime(this, defaultValue);}
    private readonly _dart_createDefaultValue: () => IDateTime = undefined as any;
    private readonly _dart_didUpdateValue: (oldValue?: IDateTime | undefined) => void = undefined as any;
    private readonly _dart_fromPrimitives: (data?: Object | undefined) => IDateTime = undefined as any;
    private readonly _dart_toPrimitives: () => Object | undefined = undefined as any;
    private readonly _dart_initWithValue: (value: IDateTime) => void = undefined as any;
    private readonly _dart_getValue: () => IDateTime = undefined as any;
    private readonly _dart_setValue: (newValue: IDateTime) => void = undefined as any;

...
widgets: {
_thumbPressGestureRecognizer: (this: void, _thumbPressGestureRecognizer: I_ThumbPressGestureRecognizer, props : {  postAcceptSlopTolerance? : number | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined, customPaintKey : IGlobalKey<IState<IStatefulWidget>>, debugOwner : Object, pressDuration : IDuration,}) => I_ThumbPressGestureRecognizer
}
};
...
onLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined;
onLongPressUp: () => void | undefined;
onLongPressEnd: (details: ILongPressEndDetails) => void | undefined;
onSecondaryLongPressDown: (details: ILongPressDownDetails) => void | undefined;
onSecondaryLongPressCancel: () => void | undefined;
onSecondaryLongPress: () => void | undefined;
onSecondaryLongPressStart: (details: ILongPressStartDetails) => void | undefined;
onSecondaryLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined;
onSecondaryLongPressUp: () => void | undefined;
onSecondaryLongPressEnd: (details: ILongPressEndDetails) => void | undefined;
onTertiaryLongPressDown: (details: ILongPressDownDetails) => void | undefined;
onTertiaryLongPressCancel: () => void | undefined;
onTertiaryLongPress: () => void | undefined;
onTertiaryLongPressStart: (details: ILongPressStartDetails) => void | undefined;
onTertiaryLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined;
...
getHashCode: () => number;
 ...
 implements ILongPressGestureRecognizer, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public readonly onLongPressDown: (details: ILongPressDownDetails) => void | undefined = undefined as any;
    public readonly onLongPressCancel: () => void | undefined = undefined as any;
    public readonly onLongPress: () => void | undefined = undefined as any;
    public readonly onLongPressStart: (details: ILongPressStartDetails) => void | undefined = undefined as any;
    public readonly onLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined = undefined as any;
    public readonly onLongPressUp: () => void | undefined = undefined as any;
    public readonly onLongPressEnd: (details: ILongPressEndDetails) => void | undefined = undefined as any;
    public readonly onSecondaryLongPressDown: (details: ILongPressDownDetails) => void | undefined = undefined as any;
    public readonly onSecondaryLongPressCancel: () => void | undefined = undefined as any;
    public readonly onSecondaryLongPress: () => void | undefined = undefined as any;
    public readonly onSecondaryLongPressStart: (details: ILongPressStartDetails) => void | undefined = undefined as any;
    public readonly onSecondaryLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined = undefined as any;
    public readonly onSecondaryLongPressUp: () => void | undefined = undefined as any;
    public readonly onSecondaryLongPressEnd: (details: ILongPressEndDetails) => void | undefined = undefined as any;
    public readonly onTertiaryLongPressDown: (details: ILongPressDownDetails) => void | undefined = undefined as any;
    public readonly onTertiaryLongPressCancel: () => void | undefined = undefined as any;
    public readonly onTertiaryLongPress: () => void | undefined = undefined as any;
    public readonly onTertiaryLongPressStart: (details: ILongPressStartDetails) => void | undefined = undefined as any;
    public readonly onTertiaryLongPressMoveUpdate: (details: ILongPressMoveUpdateDetails) => void | undefined = undefined as any;
    public readonly onTertiaryLongPressUp: () => void | undefined = undefined as any;
    public readonly onTertiaryLongPressEnd: (details: ILongPressEndDetails) => void | undefined = undefined as any;
...
public constructor( props : {  postAcceptSlopTolerance? : number | undefined, supportedDevices? : ISet<PointerDeviceKind> | undefined, customPaintKey : IGlobalKey<IState<IStatefulWidget>>, debugOwner : Object, pressDuration : IDuration,}){

...
widgets: {
_widgetsAppState: (this: void, _widgetsAppState: I_WidgetsAppState) => I_WidgetsAppState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<IWidgetsApp>, "toString" | "debugFillProperties">, IWidgetsBindingObserver, IDiagnosticable
{public constructor(){

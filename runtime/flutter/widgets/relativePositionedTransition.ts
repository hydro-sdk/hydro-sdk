...
declare const flutter: {
    widgets: {
        relativePositionedTransition: (
            this: void,
            relativePositionedTransition: IRelativePositionedTransition,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                rect: IAnimation<IRect | undefined>;
                size: ISize;
            }
        ) => IRelativePositionedTransition;
    };
};
    ...
    implements IAnimatedWidget, IDiagnosticable
{
    ...
    private readonly _dart_getRect: () => IAnimation<IRect | undefined> =
        undefined as any;

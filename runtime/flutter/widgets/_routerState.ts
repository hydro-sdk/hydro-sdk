...
widgets: {
_routerState: <T>(this: void, _routerState: I_RouterState<T>) => I_RouterState<T>
}
};
export interface I_RouterState
<T>
...
getHashCode: () => number;
}export class _RouterState
<T>
 implements Omit<IState<IRouter<T>>, "didUpdateWidget" | "dispose" | "didChangeDependencies" | "debugFillProperties">, IRestorationMixin<IRouter<T>>, IDiagnosticable
{public constructor(){

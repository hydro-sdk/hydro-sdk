...
import { IRenderSizedOverflowBox } from "../rendering/renderSizedOverflowBox";
...
widgets: {
sizedOverflowBox: (this: void, sizedOverflowBox: ISizedOverflowBox, props : {  alignment : IAlignmentGeometry, child? : IWidget | undefined, key? : IKey | undefined, size : ISize,}) => ISizedOverflowBox
}
};
export interface ISizedOverflowBox
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSizedOverflowBox;
...
public constructor( props : {  alignment? : IAlignmentGeometry, child? : IWidget | undefined, key? : IKey | undefined, size : ISize,}){
flutter.widgets.sizedOverflowBox(this, {
...sizedOverflowBoxDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSizedOverflowBox = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSizedOverflowBox {
...
const sizedOverflowBoxDefaultProps = {

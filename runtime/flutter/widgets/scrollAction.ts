    ...
    implements Omit<IAction<IScrollIntent>>, IDiagnosticable
{
    ...
    private readonly _dart_isEnabled: (intent: IScrollIntent) => boolean =
        undefined as any;
    private readonly _dart_invoke: (intent: IScrollIntent) => void =
        undefined as any;
    private readonly _dart_consumesKey: (intent: IScrollIntent) => boolean =
        undefined as any;

...
declare const flutter: {
    widgets: {
        _animatedRotationState: (
            this: void,
            _animatedRotationState: I_AnimatedRotationState
        ) => I_AnimatedRotationState;
    };
};
...
export class _AnimatedRotationState
    implements
        Omit<
            IImplicitlyAnimatedWidgetState<IAnimatedRotation>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IAnimatedRotation>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedRotation =
        undefined as any;

...
import { IAnimatedRotation } from "./animatedRotation";
...
widgets: {
_animatedRotationState: (this: void, _animatedRotationState: I_AnimatedRotationState) => I_AnimatedRotationState
}
};
export interface I_AnimatedRotationState
...
getHashCode: () => number;
}export class _AnimatedRotationState

 implements Omit<IImplicitlyAnimatedWidgetState<IAnimatedRotation>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<IAnimatedRotation>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedRotationState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedRotation = undefined as any;
...
public getWidget() : IAnimatedRotation {

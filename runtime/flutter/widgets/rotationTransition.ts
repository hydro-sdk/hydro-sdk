...
widgets: {
rotationTransition: (this: void, rotationTransition: IRotationTransition, props : {  alignment : IAlignment, child? : IWidget | undefined, filterQuality? : FilterQuality | undefined, key? : IKey | undefined, turns : IAnimation<number>,}) => IRotationTransition
}
};
...
}export class RotationTransition
...
public constructor( props : {  alignment? : IAlignment, child? : IWidget | undefined, filterQuality? : FilterQuality | undefined, key? : IKey | undefined, turns : IAnimation<number>,}){
flutter.widgets.rotationTransition(this, {
...rotationTransitionDefaultProps,
...props
});}
    private readonly _dart_getTurns: () => IAnimation<number> = undefined as any;

...
declare const flutter: {
    widgets: {
        _restorablePrimitiveValueN: <T>(
            this: void,
            _restorablePrimitiveValueN: I_RestorablePrimitiveValueN<T>,
            _defaultValue: T
        ) => I_RestorablePrimitiveValueN<T>;
    };
};
export interface I_RestorablePrimitiveValueN<T> {
...
export class _RestorablePrimitiveValueN<T>

...
widgets: {
_restorablePrimitiveValueN: <T>(this: void, _restorablePrimitiveValueN: I_RestorablePrimitiveValueN<T>, _defaultValue: T) => I_RestorablePrimitiveValueN<T>
}
};
export interface I_RestorablePrimitiveValueN
<T>
...
toString: () => string;
getHashCode: () => number;
}export class _RestorablePrimitiveValueN
<T>
 implements IRestorableValue<T>, IListenable
{public constructor(_defaultValue: T){
flutter.widgets._restorablePrimitiveValueN(this, _defaultValue);}

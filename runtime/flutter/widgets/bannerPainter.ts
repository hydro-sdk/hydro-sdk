...
widgets: {
bannerPainter: (this: void, bannerPainter: IBannerPainter, props : {  color : IColor, textStyle : ITextStyle, layoutDirection : TextDirection, location : BannerLocation, message : string, textDirection : TextDirection,}) => IBannerPainter
}
};
...
public constructor( props : {  color? : IColor, textStyle? : ITextStyle, layoutDirection : TextDirection, location : BannerLocation, message : string, textDirection : TextDirection,}){

...
widgets: {
_fixedExtentScrollPosition: (this: void, _fixedExtentScrollPosition: I_FixedExtentScrollPosition, props : {  debugLabel? : string | undefined, keepScrollOffset : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, initialItem : number, physics : IScrollPhysics,}) => I_FixedExtentScrollPosition
}
};
...
getHashCode: () => number;
 ...
 implements IScrollPositionWithSingleContext, IScrollMetrics, IFixedExtentMetrics, IScrollActivityDelegate, IListenable
...
public constructor( props : {  debugLabel? : string | undefined, keepScrollOffset? : boolean, oldPosition? : IScrollPosition | undefined, context : IScrollContext, initialItem : number, physics : IScrollPhysics,}){

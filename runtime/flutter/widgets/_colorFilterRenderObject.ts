...
widgets: {
_colorFilterRenderObject: (this: void, _colorFilterRenderObject: I_ColorFilterRenderObject, _colorFilter: IColorFilter) => I_ColorFilterRenderObject
}
};
export interface I_ColorFilterRenderObject
...
setColorFilter: (value: IColorFilter) => void;
...
getHashCode: () => number;
}export class _ColorFilterRenderObject
...
public constructor(_colorFilter: IColorFilter){
flutter.widgets._colorFilterRenderObject(this, _colorFilter);}
    private readonly _dart_getColorFilter: () => IColorFilter = undefined as any;
    private readonly _dart_setColorFilter: (value: IColorFilter) => void = undefined as any;
...
public getColorFilter() : IColorFilter {
    return this._dart_getColorFilter();
}
public setColorFilter(value: IColorFilter) : void {

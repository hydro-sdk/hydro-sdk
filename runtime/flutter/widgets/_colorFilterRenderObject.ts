...
declare const flutter: {
    widgets: {
        _colorFilterRenderObject: (
            this: void,
            _colorFilterRenderObject: I_ColorFilterRenderObject,
            _colorFilter: IColorFilter
        ) => I_ColorFilterRenderObject;
    };
};
        ...
        >
{
    ...
    private readonly _dart_getColorFilter: () => IColorFilter =
        undefined as any;
    private readonly _dart_setColorFilter: (value: IColorFilter) => void =
        undefined as any;

...
widgets: {
decorationTween: (this: void, decorationTween: IDecorationTween, props? : {  begin? : IDecoration | undefined, end? : IDecoration | undefined,}) => IDecorationTween
}
};
...
getHashCode: () => number;
}export class DecorationTween

 implements ITween<IDecoration>
{    public readonly begin: IDecoration | undefined = undefined as any;
    public readonly end: IDecoration | undefined = undefined as any;
public constructor( props? : {  begin? : IDecoration | undefined, end? : IDecoration | undefined,}){
flutter.widgets.decorationTween(this, props);}
    private readonly _dart_lerp: (t: number) => IDecoration = undefined as any;
    private readonly _dart_transform: (t: number) => IDecoration = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IDecoration = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IDecoration> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IDecoration> = undefined as any;

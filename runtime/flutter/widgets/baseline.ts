...
import { IRenderBaseline } from "../rendering/renderBaseline";
...
widgets: {
baseline: (this: void, baseline: IBaseline, props : {  child? : IWidget | undefined, key? : IKey | undefined, baseline : number, baselineType : TextBaseline,}) => IBaseline
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderBaseline;
...
{    public readonly baseline: number = undefined as any;
    public readonly baselineType: TextBaseline = undefined as any;
    public readonly child: IWidget | undefined = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, baseline : number, baselineType : TextBaseline,}){
flutter.widgets.baseline(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderBaseline = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderBaseline {

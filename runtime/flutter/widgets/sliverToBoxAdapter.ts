...
import { IRenderSliverToBoxAdapter } from "../rendering/renderSliverToBoxAdapter";
...
widgets: {
sliverToBoxAdapter: (this: void, sliverToBoxAdapter: ISliverToBoxAdapter, props? : {  child? : IWidget | undefined, key? : IKey | undefined,}) => ISliverToBoxAdapter
}
};
export interface ISliverToBoxAdapter


{
child: IWidget | undefined;
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverToBoxAdapter;
...
flutter.widgets.sliverToBoxAdapter(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverToBoxAdapter = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverToBoxAdapter {

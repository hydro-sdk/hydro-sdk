...
export class KeyedSubtree implements IStatelessWidget, IDiagnosticable {
    ...
    public static ensureUniqueKeysForList(
        items: IList<IWidget>,
        props: { baseIndex?: number }
    ): IList<IWidget> {

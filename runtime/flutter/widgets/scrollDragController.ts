...
widgets: {
scrollDragController: (this: void, scrollDragController: IScrollDragController, props : {  carriedVelocity? : number | undefined, motionStartDistanceThreshold? : number | undefined, onDragCanceled? : () => void | undefined, delegate : IScrollActivityDelegate, details : IDragStartDetails,}) => IScrollDragController
}
};
...
toString: () => string;
 ...
 implements IDrag
{    public static momentumRetainStationaryDurationThreshold = new Duration({ milliseconds: 20 });
    public static momentumRetainVelocityThresholdFactor = 0.5;
    public static motionStoppedDurationThreshold = new Duration({ milliseconds: 50 });
    public static _bigThresholdBreakDistance = 24.0;
    public readonly carriedVelocity: number | undefined = undefined as any;
    public readonly motionStartDistanceThreshold: number | undefined = undefined as any;
public constructor( props : {  carriedVelocity? : number | undefined, motionStartDistanceThreshold? : number | undefined, onDragCanceled? : () => void | undefined, delegate : IScrollActivityDelegate, details : IDragStartDetails,}){

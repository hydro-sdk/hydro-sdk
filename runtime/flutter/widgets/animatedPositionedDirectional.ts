...
declare const flutter: {
    widgets: {
        animatedPositionedDirectional: (
            this: void,
            animatedPositionedDirectional: IAnimatedPositionedDirectional,
            props: {
        ...
        ) => IAnimatedPositionedDirectional;
    };
};
    ...
    implements IImplicitlyAnimatedWidget, IDiagnosticable
{
    ...
    private readonly _dart_createState: () => IAnimatedWidgetBaseState<IAnimatedPositionedDirectional> =
        undefined as any;

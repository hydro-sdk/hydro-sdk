...
widgets: {
_textSelectionHandleOverlay: (this: void, _textSelectionHandleOverlay: I_TextSelectionHandleOverlay, props : {  dragStartBehavior : DragStartBehavior, key? : IKey | undefined, endHandleLayerLink : ILayerLink, onSelectionHandleChanged : (value: ITextSelection) => void, onSelectionHandleTapped? : () => void | undefined, position : _TextSelectionHandlePosition, renderObject : IRenderEditable, selection : ITextSelection, selectionControls : ITextSelectionControls, selectionDelegate : ITextSelectionDelegate, startHandleLayerLink : ILayerLink,}) => I_TextSelectionHandleOverlay
}
};
...
{    public readonly selection: ITextSelection = undefined as any;
    ...
    public readonly selectionControls: ITextSelectionControls = undefined as any;
    public readonly dragStartBehavior: DragStartBehavior = undefined as any;
    public readonly selectionDelegate: ITextSelectionDelegate = undefined as any;
...
...props
    ...
    private readonly _dart_createState: () => I_TextSelectionHandleOverlayState = undefined as any;

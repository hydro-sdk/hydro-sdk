...
import { IAnimatedSize } from "./animatedSize";
...
widgets: {
_animatedSizeState: (this: void, _animatedSizeState: I_AnimatedSizeState) => I_AnimatedSizeState
}
};
export interface I_AnimatedSizeState
...
getHashCode: () => number;
}export class _AnimatedSizeState

 implements Omit<IState<IAnimatedSize>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<IAnimatedSize>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedSizeState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedSize = undefined as any;
...
public getWidget() : IAnimatedSize {

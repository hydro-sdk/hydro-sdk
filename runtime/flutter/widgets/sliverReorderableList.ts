...
declare const flutter: {
    widgets: {
        sliverReorderableList: (
            this: void,
            sliverReorderableList: ISliverReorderableList,
            props: {
        ...
        ) => ISliverReorderableList;
        sliverReorderableListOf: (
            context: IBuildContext
        ) => ISliverReorderableListState;
        sliverReorderableListMaybeOf: (
            context: IBuildContext
        ) => ISliverReorderableListState | undefined;
    };
};
...
export class SliverReorderableList implements IStatefulWidget, IDiagnosticable {
    ...
    private readonly _dart_createState: () => ISliverReorderableListState =
        undefined as any;

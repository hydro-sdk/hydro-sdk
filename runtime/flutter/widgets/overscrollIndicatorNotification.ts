...
widgets: {
overscrollIndicatorNotification: (this: void, overscrollIndicatorNotification: IOverscrollIndicatorNotification, props : {  leading : boolean,}) => IOverscrollIndicatorNotification
}
};

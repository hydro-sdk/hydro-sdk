...
import { IPlatformViewSurface } from "./platformViewSurface";
...
widgets: {
androidViewSurface: (this: void, androidViewSurface: IAndroidViewSurface, props : {  key? : IKey | undefined, controller : IAndroidViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}) => IAndroidViewSurface
}
};
export interface IAndroidViewSurface
...
}export class AndroidViewSurface

 implements IPlatformViewSurface, IDiagnosticable
...
public constructor( props : {  key? : IKey | undefined, controller : IAndroidViewController, gestureRecognizers : ISet<IFactory<IOneSequenceGestureRecognizer>>, hitTestBehavior : PlatformViewHitTestBehavior,}){
flutter.widgets.androidViewSurface(this, props);}

...
widgets: {
_sliverFillRemainingWithoutScrollable: (this: void, _sliverFillRemainingWithoutScrollable: I_SliverFillRemainingWithoutScrollable, props? : {  child? : IWidget | undefined, key? : IKey | undefined,}) => I_SliverFillRemainingWithoutScrollable
}
};
...
flutter.widgets._sliverFillRemainingWithoutScrollable(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverFillRemaining = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverFillRemaining {

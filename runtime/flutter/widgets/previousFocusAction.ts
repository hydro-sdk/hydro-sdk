...
widgets: {
previousFocusAction: (this: void, previousFocusAction: IPreviousFocusAction) => IPreviousFocusAction
}
};
...
flutter.widgets.previousFocusAction(this);}
    private readonly _dart_invoke: (intent: IPreviousFocusIntent) => void = undefined as any;
    private readonly _dart_isEnabled: (intent: IPreviousFocusIntent) => boolean = undefined as any;
    private readonly _dart_consumesKey: (intent: IPreviousFocusIntent) => boolean = undefined as any;
    ...
    private readonly _dart_getCallingAction: () => IAction<IPreviousFocusIntent> | undefined = undefined as any;

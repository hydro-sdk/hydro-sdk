...
widgets: {
_imageFilterRenderObject: (this: void, _imageFilterRenderObject: I_ImageFilterRenderObject, _imageFilter: IImageFilter) => I_ImageFilterRenderObject
}
};
export interface I_ImageFilterRenderObject


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getImageFilter: () => IImageFilter;
setImageFilter: (value: IImageFilter) => void;
...
getHashCode: () => number;
}export class _ImageFilterRenderObject
...
public constructor(_imageFilter: IImageFilter){
flutter.widgets._imageFilterRenderObject(this, _imageFilter);}
    private readonly _dart_getImageFilter: () => IImageFilter = undefined as any;
    private readonly _dart_setImageFilter: (value: IImageFilter) => void = undefined as any;
...
public getImageFilter() : IImageFilter {
    return this._dart_getImageFilter();
}
public setImageFilter(value: IImageFilter) : void {

...
declare const flutter: {
    widgets: {
        _imageFilterRenderObject: (
            this: void,
            _imageFilterRenderObject: I_ImageFilterRenderObject,
            _imageFilter: IImageFilter
        ) => I_ImageFilterRenderObject;
    };
};
        ...
        >
{
    ...
    private readonly _dart_getImageFilter: () => IImageFilter =
        undefined as any;
    private readonly _dart_setImageFilter: (value: IImageFilter) => void =
        undefined as any;

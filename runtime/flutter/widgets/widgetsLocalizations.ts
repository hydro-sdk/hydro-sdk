...
widgets: {
widgetsLocalizations: (this: void, widgetsLocalizations: IWidgetsLocalizations) => IWidgetsLocalizations;
widgetsLocalizationsOf: (context: IBuildContext) => IWidgetsLocalizations
}
};

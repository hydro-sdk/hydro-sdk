...
import { ISliverPrototypeExtentList } from "./sliverPrototypeExtentList";
...
import { I_RenderSliverPrototypeExtentList } from "./_renderSliverPrototypeExtentList";
...
widgets: {
_sliverPrototypeExtentListElement: (this: void, _sliverPrototypeExtentListElement: I_SliverPrototypeExtentListElement, widget: ISliverPrototypeExtentList) => I_SliverPrototypeExtentListElement
}
};
export interface I_SliverPrototypeExtentListElement


{
getWidget: () => ISliverPrototypeExtentList;
getRenderObject: () => I_RenderSliverPrototypeExtentList;
...
performRebuild: () => void;
createChild: (index: number, props? : {  after? : IRenderBox | undefined,}) => void;
...
estimateMaxScrollOffset: (constraints?: ISliverConstraints | undefined, props? : {  firstIndex? : number | undefined, lastIndex? : number | undefined, leadingScrollOffset? : number | undefined, trailingScrollOffset? : number | undefined,}) => number;
didStartLayout: () => void;
...
}export class _SliverPrototypeExtentListElement

 implements ISliverMultiBoxAdaptorElement, IDiagnosticable, IRenderSliverBoxChildManager, IBuildContext
{public constructor(widget: ISliverPrototypeExtentList){
flutter.widgets._sliverPrototypeExtentListElement(this, widget);}
    private readonly _dart_getWidget: () => ISliverPrototypeExtentList = undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderSliverPrototypeExtentList = undefined as any;
    private readonly _dart_insertRenderObjectChild: (child: any, slot: any) => void = undefined as any;
    private readonly _dart_didAdoptChild: (child: IRenderBox) => void = undefined as any;
    ...
    private readonly _dart_createChild: (index: number, props? : {  after? : IRenderBox | undefined,}) => void = undefined as any;
    ...
    private readonly _dart_removeChild: (child: IRenderBox) => void = undefined as any;
    private readonly _dart_estimateMaxScrollOffset: (constraints?: ISliverConstraints | undefined, props? : {  firstIndex? : number | undefined, lastIndex? : number | undefined, leadingScrollOffset? : number | undefined, trailingScrollOffset? : number | undefined,}) => number = undefined as any;
    private readonly _dart_didStartLayout: () => void = undefined as any;
    private readonly _dart_didFinishLayout: () => void = undefined as any;
    private readonly _dart_debugAssertChildListLocked: () => boolean = undefined as any;
    private readonly _dart_setDidUnderflow: (value: boolean) => void = undefined as any;
...
public getWidget() : ISliverPrototypeExtentList {
    return this._dart_getWidget();
}
public getRenderObject() : I_RenderSliverPrototypeExtentList {
...
public createChild(index: number, props? : {  after? : IRenderBox | undefined,}) : void {
...
public estimateMaxScrollOffset(constraints?: ISliverConstraints | undefined, props? : {  firstIndex? : number | undefined, lastIndex? : number | undefined, leadingScrollOffset? : number | undefined, trailingScrollOffset? : number | undefined,}) : number {

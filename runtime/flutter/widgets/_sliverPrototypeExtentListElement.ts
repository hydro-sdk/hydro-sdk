...
declare const flutter: {
    widgets: {
        _sliverPrototypeExtentListElement: (
            this: void,
            _sliverPrototypeExtentListElement: I_SliverPrototypeExtentListElement,
            widget: ISliverPrototypeExtentList
        ) => I_SliverPrototypeExtentListElement;
    };
};
        ...
        IBuildContext
{
    ...
    private readonly _dart_getWidget: () => ISliverPrototypeExtentList =
        undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderSliverPrototypeExtentList =
        undefined as any;

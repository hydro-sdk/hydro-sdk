...
widgets: {
activateAction: (this: void, activateAction: IActivateAction) => IActivateAction
}
};
...
flutter.widgets.activateAction(this);}
    private readonly _dart_isEnabled: (intent: IActivateIntent) => boolean = undefined as any;
    private readonly _dart_consumesKey: (intent: IActivateIntent) => boolean = undefined as any;
    private readonly _dart_invoke: (intent: IActivateIntent) => Object | undefined = undefined as any;
    ...
    private readonly _dart_getCallingAction: () => IAction<IActivateIntent> | undefined = undefined as any;

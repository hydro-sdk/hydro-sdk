...
declare const flutter: {
    widgets: {
        dismissible: (
            this: void,
            dismissible: IDismissible,
            props: {
                background?: IWidget | undefined;
                behavior: HitTestBehavior;
                confirmDismiss?: (
                    direction: DismissDirection
                ) => IFuture<boolean | undefined> | undefined;
                crossAxisEndOffset: number;
                direction: DismissDirection;
                dismissThresholds: IMap<DismissDirection, number>;
                dragStartBehavior: DragStartBehavior;
                movementDuration: IDuration;
                onDismissed?: (direction: DismissDirection) => void | undefined;
                onResize?: () => void | undefined;
                onUpdate?: (details: IDismissUpdateDetails) => void | undefined;
...
export class Dismissible implements IStatefulWidget, IDiagnosticable {
    ...
    public readonly dismissThresholds: IMap<DismissDirection, number> =
        undefined as any;
    ...
    private readonly _dart_createState: () => IState<IDismissible> =
        undefined as any;
...
const dismissibleDefaultProps = {
    ...
    dismissThresholds: Map.fromEntries(
        <IIterable<IMapEntry<DismissDirection, number>>>(

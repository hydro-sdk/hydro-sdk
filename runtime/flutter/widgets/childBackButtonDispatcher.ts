...
widgets: {
childBackButtonDispatcher: (this: void, childBackButtonDispatcher: IChildBackButtonDispatcher, parent: IBackButtonDispatcher) => IChildBackButtonDispatcher
}
};
...
toString: () => string;
getHashCode: () => number;
}export class ChildBackButtonDispatcher

 implements IBackButtonDispatcher
...
flutter.widgets.childBackButtonDispatcher(this, parent);}
    private readonly _dart_notifiedByParent: (defaultValue: IFuture<boolean>) => IFuture<boolean> = undefined as any;
    private readonly _dart_takePriority: () => void = undefined as any;
    private readonly _dart_deferTo: (child: IChildBackButtonDispatcher) => void = undefined as any;
    private readonly _dart_removeCallback: (callback : () => IFuture<boolean>) => void = undefined as any;
    private readonly _dart_invokeCallback: (defaultValue: IFuture<boolean>) => IFuture<boolean> = undefined as any;
    private readonly _dart_createChildBackButtonDispatcher: () => IChildBackButtonDispatcher = undefined as any;
    private readonly _dart_forget: (child: IChildBackButtonDispatcher) => void = undefined as any;
    private readonly _dart_getHasCallbacks: () => boolean = undefined as any;
    private readonly _dart_addCallback: (callback : () => IFuture<boolean>) => void = undefined as any;

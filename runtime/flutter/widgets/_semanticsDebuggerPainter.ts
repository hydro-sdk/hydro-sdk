...
widgets: {
_semanticsDebuggerPainter: (this: void, _semanticsDebuggerPainter: I_SemanticsDebuggerPainter, owner: IPipelineOwner, generation: number, pointerPosition: IOffset | undefined, devicePixelRatio: number, labelStyle: ITextStyle) => I_SemanticsDebuggerPainter
}
};
...
getHashCode: () => number;
}export class _SemanticsDebuggerPainter
...
public constructor(owner: IPipelineOwner, generation: number, pointerPosition: IOffset | undefined, devicePixelRatio: number, labelStyle: ITextStyle){
flutter.widgets._semanticsDebuggerPainter(this, owner, generation, pointerPosition, devicePixelRatio, labelStyle);}

...
import { IBaseTapGestureRecognizer } from "../gestures/baseTapGestureRecognizer";
...
widgets: {
_anyTapGestureRecognizer: (this: void, _anyTapGestureRecognizer: I_AnyTapGestureRecognizer, props? : {  debugOwner? : Object | undefined,}) => I_AnyTapGestureRecognizer
}
};
export interface I_AnyTapGestureRecognizer
...
handleTapDown: ( props? : {  down? : IPointerDownEvent | undefined,}) => void;
handleTapUp: ( props? : {  down? : IPointerDownEvent | undefined, up? : IPointerUpEvent | undefined,}) => void;
handleTapCancel: ( props? : {  cancel? : IPointerCancelEvent | undefined, down? : IPointerDownEvent | undefined, reason? : string | undefined,}) => void;
...
getHashCode: () => number;
}export class _AnyTapGestureRecognizer
...
flutter.widgets._anyTapGestureRecognizer(this, props);}
    private readonly _dart_isPointerAllowed: (event: IPointerDownEvent) => boolean = undefined as any;
    private readonly _dart_handleTapDown: ( props? : {  down? : IPointerDownEvent | undefined,}) => void = undefined as any;
    private readonly _dart_handleTapUp: ( props? : {  down? : IPointerDownEvent | undefined, up? : IPointerUpEvent | undefined,}) => void = undefined as any;
    private readonly _dart_handleTapCancel: ( props? : {  cancel? : IPointerCancelEvent | undefined, down? : IPointerDownEvent | undefined, reason? : string | undefined,}) => void = undefined as any;
...
public handleTapDown( props? : {  down? : IPointerDownEvent | undefined,}) : void {
    return this._dart_handleTapDown(props);
}
public handleTapUp( props? : {  down? : IPointerDownEvent | undefined, up? : IPointerUpEvent | undefined,}) : void {
    return this._dart_handleTapUp(props);
}
public handleTapCancel( props? : {  cancel? : IPointerCancelEvent | undefined, down? : IPointerDownEvent | undefined, reason? : string | undefined,}) : void {

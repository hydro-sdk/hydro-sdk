...
widgets: {
_mediaQueryFromWindowState: (this: void, _mediaQueryFromWindowState: I_MediaQueryFromWindowState) => I_MediaQueryFromWindowState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<I_MediaQueryFromWindow>, "toString" | "debugFillProperties">, IWidgetsBindingObserver, IDiagnosticable
{public constructor(){
flutter.widgets._mediaQueryFromWindowState(this);}
    ...
    private readonly _dart_getWidget: () => I_MediaQueryFromWindow = undefined as any;

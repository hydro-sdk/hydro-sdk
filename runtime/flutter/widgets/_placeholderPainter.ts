...
declare const flutter: {
    widgets: {
        _placeholderPainter: (
            this: void,
            _placeholderPainter: I_PlaceholderPainter,
            props: { color: IColor; strokeWidth: number }
        ) => I_PlaceholderPainter;
    };
};
...
export class _PlaceholderPainter implements ICustomPainter {

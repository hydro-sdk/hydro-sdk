...
widgets: {
dismissAction: (this: void, dismissAction: IDismissAction) => IDismissAction
}
};
...
flutter.widgets.dismissAction(this);}
    ...
    private readonly _dart_invoke: (intent: IDismissIntent) => Object | undefined = undefined as any;

...
export interface IDismissAction {
    ...
    invoke: (intent: IDismissIntent) => Object | undefined;
...
export class DismissAction
    implements Omit<IAction<IDismissIntent>>, IDiagnosticable
{
    public constructor() {
        flutter.widgets.dismissAction(this);
    }
    private readonly _dart_isEnabled: (intent: IDismissIntent) => boolean =
        undefined as any;
    private readonly _dart_consumesKey: (intent: IDismissIntent) => boolean =
        undefined as any;
    private readonly _dart_invoke: (
        intent: IDismissIntent
    ...
    public invoke(intent: IDismissIntent): Object | undefined {

...
widgets: {
_location: (this: void, _location: I_Location, props : {  name? : string | undefined, column : number, file : string, line : number,}) => I_Location
}
};
...
public constructor( props : {  name? : string | undefined, column : number, file : string, line : number,}){
flutter.widgets._location(this, props);}
    private readonly _dart_toJsonMap: () => {[index: string]: Object | undefined} = undefined as any;

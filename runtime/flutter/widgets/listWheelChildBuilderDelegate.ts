...
declare const flutter: {
    widgets: {
        listWheelChildBuilderDelegate: (
            this: void,
            listWheelChildBuilderDelegate: IListWheelChildBuilderDelegate,
            props: {
        ...
        ) => IListWheelChildBuilderDelegate;
    };
};
...
export class ListWheelChildBuilderDelegate implements IListWheelChildDelegate {
    public readonly childCount: number | undefined = undefined as any;
    public constructor(props: {
        childCount?: number | undefined;
        builder: (context: IBuildContext, index: number) => IWidget | undefined;
    }) {

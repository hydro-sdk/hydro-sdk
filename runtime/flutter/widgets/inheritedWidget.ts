...
widgets: {
inheritedWidget: (this: void, inheritedWidget: IInheritedWidget, props : {  key? : IKey | undefined, child : IWidget,}) => IInheritedWidget
}
};
export interface IInheritedWidget

...
declare const flutter: {
    widgets: {
        longPressDraggable: <T>(
            this: void,
            longPressDraggable: ILongPressDraggable<T>,
            props: {
                axis?: Axis | undefined;
        ...
        ) => ILongPressDraggable<T>;
    };
};
export interface ILongPressDraggable<T> {
    hapticFeedbackOnStart: boolean;
    delay: IDuration;
    data: T | undefined;
    axis: Axis | undefined;
    ...
    key: IKey | undefined;
    createRecognizer: (
        onStart: (position: IOffset) => IDrag | undefined
...
export class LongPressDraggable<T> implements IDraggable<T>, IDiagnosticable {
    ...
    public readonly dragAnchorStrategy: (
        draggable: IDraggable<Object>,
        context: IBuildContext,
        position: IOffset
    ) => IOffset | undefined = undefined as any;
    ...
    public readonly onDragUpdate: (
        details: IDragUpdateDetails
    ) => void | undefined = undefined as any;
    public readonly onDraggableCanceled: (
        velocity: IVelocity,
        offset: IOffset
    ) => void | undefined = undefined as any;
    public readonly onDragCompleted: () => void | undefined = undefined as any;
    public readonly onDragEnd: (
        details: IDraggableDetails
    ) => void | undefined = undefined as any;
    ...
    private readonly _dart_createRecognizer: (
        onStart: (position: IOffset) => IDrag | undefined
    ) => IDelayedMultiDragGestureRecognizer = undefined as any;
    private readonly _dart_createState: () => IState<IDraggable<T>> =
        undefined as any;

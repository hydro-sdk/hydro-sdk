...
import { IRenderProxyBoxWithHitTestBehavior } from "../rendering/renderProxyBoxWithHitTestBehavior";
...
import { IExpando } from "../../dart/core/expando";
import { IParentData } from "../rendering/parentData";
import { Curves } from "../animation/curves";
declare const flutter: {
widgets: {
_renderFocusTrap: (this: void, _renderFocusTrap: I_RenderFocusTrap, _focusScopeNode: IFocusScopeNode) => I_RenderFocusTrap
}
};
export interface I_RenderFocusTrap


{
currentFocusRect: IRect | undefined;
cachedResults: IExpando<IBoxHitTestResult>;
behavior: HitTestBehavior;
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getFocusScopeNode: () => IFocusScopeNode;
setFocusScopeNode: (value: IFocusScopeNode) => void;
...
{    public readonly currentFocusRect: IRect | undefined = undefined as any;
    public readonly cachedResults: IExpando<IBoxHitTestResult> = undefined as any;
...
public constructor(_focusScopeNode: IFocusScopeNode){
flutter.widgets._renderFocusTrap(this, _focusScopeNode);}
    private readonly _dart_getFocusScopeNode: () => IFocusScopeNode = undefined as any;
    private readonly _dart_setFocusScopeNode: (value: IFocusScopeNode) => void = undefined as any;
...
public getFocusScopeNode() : IFocusScopeNode {
    return this._dart_getFocusScopeNode();
}
public setFocusScopeNode(value: IFocusScopeNode) : void {
    return this._dart_setFocusScopeNode(value);
}

...
declare const flutter: {
    widgets: {
        _renderFocusTrap: (
            this: void,
            _renderFocusTrap: I_RenderFocusTrap,
            _focusScopeNode: IFocusScopeNode
        ) => I_RenderFocusTrap;
    };
};
        ...
        >
{
    ...
    public readonly cachedResults: IExpando<IBoxHitTestResult> =
        undefined as any;
    ...
    private readonly _dart_getFocusScopeNode: () => IFocusScopeNode =
        undefined as any;
    private readonly _dart_setFocusScopeNode: (value: IFocusScopeNode) => void =
        undefined as any;

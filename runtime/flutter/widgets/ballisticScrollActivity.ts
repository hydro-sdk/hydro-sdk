...
declare const flutter: {
    widgets: {
        ballisticScrollActivity: (
            this: void,
            ballisticScrollActivity: IBallisticScrollActivity,
            delegate: IScrollActivityDelegate,
            simulation: ISimulation,
            vsync: ITickerProvider
        ) => IBallisticScrollActivity;
    };
};
...
export class BallisticScrollActivity implements IScrollActivity {
    public constructor(
        delegate: IScrollActivityDelegate,
        simulation: ISimulation,
        vsync: ITickerProvider
    ) {
        flutter.widgets.ballisticScrollActivity(
            this,
            delegate,
            simulation,
            vsync

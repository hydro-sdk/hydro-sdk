...
widgets: {
_inspectorOverlayRenderState: (this: void, _inspectorOverlayRenderState: I_InspectorOverlayRenderState, props : {  candidates : IList<I_TransformedRect>, overlayRect : IRect, selected : I_TransformedRect, textDirection : TextDirection, tooltip : string,}) => I_InspectorOverlayRenderState
}
};
...
public constructor( props : {  candidates : IList<I_TransformedRect>, overlayRect : IRect, selected : I_TransformedRect, textDirection : TextDirection, tooltip : string,}){

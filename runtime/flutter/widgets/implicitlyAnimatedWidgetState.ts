...
widgets: {
implicitlyAnimatedWidgetState: <T>(this: void, implicitlyAnimatedWidgetState: IImplicitlyAnimatedWidgetState<T>) => IImplicitlyAnimatedWidgetState<T>
}
};
export interface IImplicitlyAnimatedWidgetState
<T>
...
<T>
 implements Omit<IState<T>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<T>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets.implicitlyAnimatedWidgetState(this);}

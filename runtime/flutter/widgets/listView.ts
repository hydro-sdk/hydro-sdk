...
widgets: {
listView: (this: void, listView: IListView, props : {  addAutomaticKeepAlives : boolean, addRepaintBoundaries : boolean, addSemanticIndexes : boolean, cacheExtent? : number | undefined, children : IList<IWidget>, clipBehavior : Clip, controller? : IScrollController | undefined, dragStartBehavior : DragStartBehavior, itemExtent? : number | undefined, key? : IKey | undefined, keyboardDismissBehavior : ScrollViewKeyboardDismissBehavior, padding? : IEdgeInsetsGeometry | undefined, physics? : IScrollPhysics | undefined, primary? : boolean | undefined, prototypeItem? : IWidget | undefined, restorationId? : string | undefined, reverse : boolean, scrollDirection : Axis, semanticChildCount? : number | undefined, shrinkWrap : boolean,}) => IListView
}
};

...
widgets: {
restorableProperty: <T>(this: void, restorableProperty: IRestorableProperty<T>) => IRestorableProperty<T>
}
};
export interface IRestorableProperty
<T>
...
toString: () => string;
getHashCode: () => number;
}export class RestorableProperty
<T>

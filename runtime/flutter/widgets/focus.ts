...
widgets: {
focus: (this: void, focus: IFocus, props : {  autofocus : boolean, canRequestFocus? : boolean | undefined, debugLabel? : string | undefined, descendantsAreFocusable? : boolean | undefined, focusNode? : IFocusNode | undefined, includeSemantics : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal? : boolean | undefined, child : IWidget,}) => IFocus;
focusWithExternalFocusNode: ( props : {  autofocus : boolean, includeSemantics : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, child : IWidget, focusNode : IFocusNode,}) => IFocus;
focusOf: (context: IBuildContext, props : {  scopeOk : boolean,}) => IFocusNode;
focusMaybeOf: (context: IBuildContext, props : {  scopeOk : boolean,}) => IFocusNode | undefined;
...
public constructor( props : {  autofocus? : boolean, canRequestFocus? : boolean | undefined, debugLabel? : string | undefined, descendantsAreFocusable? : boolean | undefined, focusNode? : IFocusNode | undefined, includeSemantics? : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal? : boolean | undefined, child : IWidget,}){
flutter.widgets.focus(this, {
...focusDefaultProps,
...props
});}
public static withExternalFocusNode( props : {  autofocus : boolean, includeSemantics : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, child : IWidget, focusNode : IFocusNode,}) : IFocus{
return flutter.widgets.focusWithExternalFocusNode(props);
}public static of(context: IBuildContext, props : {  scopeOk? : boolean,}) : IFocusNode{
return flutter.widgets.focusOf(context, {
...ofDefaultProps,
...props
});
}public static maybeOf(context: IBuildContext, props : {  scopeOk? : boolean,}) : IFocusNode | undefined{

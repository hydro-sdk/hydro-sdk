...
widgets: {
animatedList: (this: void, animatedList: IAnimatedList, props : {  clipBehavior : Clip, controller? : IScrollController | undefined, initialItemCount : number, key? : IKey | undefined, padding? : IEdgeInsetsGeometry | undefined, physics? : IScrollPhysics | undefined, primary? : boolean | undefined, reverse : boolean, scrollDirection : Axis, shrinkWrap : boolean, itemBuilder : (context: IBuildContext, index: number, animation: IAnimation<number>) => IWidget,}) => IAnimatedList;
animatedListOf: (context: IBuildContext) => IAnimatedListState;
animatedListMaybeOf: (context: IBuildContext) => IAnimatedListState | undefined
}
};
...
public constructor( props : {  clipBehavior? : Clip, controller? : IScrollController | undefined, initialItemCount? : number, key? : IKey | undefined, padding? : IEdgeInsetsGeometry | undefined, physics? : IScrollPhysics | undefined, primary? : boolean | undefined, reverse? : boolean, scrollDirection? : Axis, shrinkWrap? : boolean, itemBuilder : (context: IBuildContext, index: number, animation: IAnimation<number>) => IWidget,}){
...
}public static maybeOf(context: IBuildContext) : IAnimatedListState | undefined{
return flutter.widgets.animatedListMaybeOf(context);
}    private readonly _dart_createState: () => IAnimatedListState = undefined as any;

...
declare const flutter: {
    widgets: {
        alignTransition: (
            this: void,
            alignTransition: IAlignTransition,
            props: {
                heightFactor?: number | undefined;
                key?: IKey | undefined;
                widthFactor?: number | undefined;
                alignment: IAnimation<IAlignmentGeometry>;
                child: IWidget;
            }
        ) => IAlignTransition;
    };
...
export class AlignTransition implements IAnimatedWidget, IDiagnosticable {
    ...
    private readonly _dart_getAlignment: () => IAnimation<IAlignmentGeometry> =
        undefined as any;

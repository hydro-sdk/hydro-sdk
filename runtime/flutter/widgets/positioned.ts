...
widgets: {
positioned: (this: void, positioned: IPositioned, props : {  bottom? : number | undefined, height? : number | undefined, key? : IKey | undefined, left? : number | undefined, right? : number | undefined, top? : number | undefined, width? : number | undefined, child : IWidget,}) => IPositioned;
positionedDirectional: ( props : {  bottom? : number | undefined, end? : number | undefined, height? : number | undefined, key? : IKey | undefined, start? : number | undefined, top? : number | undefined, width? : number | undefined, child : IWidget, textDirection : TextDirection,}) => IPositioned
}
};
...
public constructor( props : {  bottom? : number | undefined, height? : number | undefined, key? : IKey | undefined, left? : number | undefined, right? : number | undefined, top? : number | undefined, width? : number | undefined, child : IWidget,}){
flutter.widgets.positioned(this, props);}
public static directional( props : {  bottom? : number | undefined, end? : number | undefined, height? : number | undefined, key? : IKey | undefined, start? : number | undefined, top? : number | undefined, width? : number | undefined, child : IWidget, textDirection : TextDirection,}) : IPositioned{
return flutter.widgets.positionedDirectional(props);
}    private readonly _dart_applyParentData: (renderObject: IRenderObject) => void = undefined as any;
    private readonly _dart_getDebugTypicalAncestorWidgetClass: () => Type = undefined as any;
    private readonly _dart_debugFillProperties: (properties: IDiagnosticPropertiesBuilder) => void = undefined as any;
    private readonly _dart_createElement: () => IParentDataElement<IStackParentData> = undefined as any;
    private readonly _dart_debugIsValidRenderObject: (renderObject: IRenderObject) => boolean = undefined as any;
    private readonly _dart_debugCanApplyOutOfTurn: () => boolean = undefined as any;

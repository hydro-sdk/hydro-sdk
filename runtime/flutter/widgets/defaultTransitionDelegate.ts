...
declare const flutter: {
    widgets: {
        defaultTransitionDelegate: <T>(
            this: void,
            defaultTransitionDelegate: IDefaultTransitionDelegate<T>
        ) => IDefaultTransitionDelegate<T>;
    };
};
export interface IDefaultTransitionDelegate<T> {
    resolve: (props: {
...
export class DefaultTransitionDelegate<T> implements ITransitionDelegate<T> {
    public constructor() {
        flutter.widgets.defaultTransitionDelegate(this);
    }
    private readonly _dart_resolve: (props: {
        locationToExitingPageRoute: IMap<
            IRouteTransitionRecord | undefined,
            IRouteTransitionRecord
        >;
        ...
        pageRouteToPagelessRoutes: IMap<
            ...
            IList<IRouteTransitionRecord>
        >;
    }) => IIterable<IRouteTransitionRecord> = undefined as any;

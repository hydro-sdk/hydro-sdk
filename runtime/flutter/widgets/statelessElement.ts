...
widgets: {
statelessElement: (this: void, statelessElement: IStatelessElement, widget: IStatelessWidget) => IStatelessElement
}
};
export interface IStatelessElement


{
getWidget: () => IStatelessWidget;
build: () => IWidget;
...
}export class StatelessElement

 implements IComponentElement, IDiagnosticable, IBuildContext
{public constructor(widget: IStatelessWidget){
flutter.widgets.statelessElement(this, widget);}
    private readonly _dart_getWidget: () => IStatelessWidget = undefined as any;
...
public getWidget() : IStatelessWidget {

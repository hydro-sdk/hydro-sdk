...
declare const flutter: {
    widgets: {
        _screenshotData: (
            this: void,
            _screenshotData: I_ScreenshotData,
            props: { target: IRenderObject }
        ) => I_ScreenshotData;
    };
};
...
export class _ScreenshotData {
    ...
    private readonly _dart_getScreenshotOffset: () => IOffset =
        undefined as any;
    private readonly _dart_setScreenshotOffset: (offset: IOffset) => void =
        undefined as any;

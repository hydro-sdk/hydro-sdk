...
declare const flutter: {
    widgets: {
        _interactiveViewerBuilt: (
            this: void,
            _interactiveViewerBuilt: I_InteractiveViewerBuilt,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                childKey: IGlobalKey<IState<IStatefulWidget>>;
                clipBehavior: Clip;
                constrained: boolean;
                matrix: IMatrix4;
            }
        ) => I_InteractiveViewerBuilt;
    };
};
export interface I_InteractiveViewerBuilt {
    child: IWidget;
    childKey: IGlobalKey<IState<IStatefulWidget>>;
    clipBehavior: Clip;
    constrained: boolean;
...
export class _InteractiveViewerBuilt
    implements IStatelessWidget, IDiagnosticable
{
    public readonly child: IWidget = undefined as any;
    public readonly childKey: IGlobalKey<IState<IStatefulWidget>> =
        undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.widgets._interactiveViewerBuilt(this, props);
    }

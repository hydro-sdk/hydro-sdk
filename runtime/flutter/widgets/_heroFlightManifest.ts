...
declare const flutter: {
    widgets: {
        _heroFlightManifest: (
            this: void,
            _heroFlightManifest: I_HeroFlightManifest,
            props: {
                createRectTween?: (
...
export interface I_HeroFlightManifest {
    ...
    createHeroRectTween: (props?: {
        begin?: IRect | undefined;
        end?: IRect | undefined;
    }) => ITween<IRect | undefined>;
    toString: () => string;
}
export class _HeroFlightManifest {
    ...
    private readonly _dart_getAnimation: () => IAnimation<number> =
        undefined as any;
    private readonly _dart_createHeroRectTween: (props?: {
        begin?: IRect | undefined;
        end?: IRect | undefined;
    }) => ITween<IRect | undefined> = undefined as any;
    ...
    public createHeroRectTween(props?: {
        begin?: IRect | undefined;
        end?: IRect | undefined;
    }): ITween<IRect | undefined> {

...
widgets: {
restorableRouteFuture: <T>(this: void, restorableRouteFuture: IRestorableRouteFuture<T>, props : {  navigatorFinder : (context: IBuildContext) => INavigatorState, onComplete? : (result: T) => void | undefined, onPresent : (navigator: INavigatorState, arguments?: Object | undefined) => string,}) => IRestorableRouteFuture<T>
}
};
export interface IRestorableRouteFuture
<T>
...
toString: () => string;
getHashCode: () => number;
}export class RestorableRouteFuture
<T>
 implements IRestorableProperty<string?>, IListenable
{public constructor( props : {  navigatorFinder : (context: IBuildContext) => INavigatorState, onComplete? : (result: T) => void | undefined, onPresent : (navigator: INavigatorState, arguments?: Object | undefined) => string,}){
flutter.widgets.restorableRouteFuture(this, props);}
    private readonly _dart_present: (arguments?: Object | undefined) => void = undefined as any;
    private readonly _dart_getIsPresent: () => boolean = undefined as any;
    private readonly _dart_getRoute: () => IRoute<T> | undefined = undefined as any;
    private readonly _dart_createDefaultValue: () => string | undefined = undefined as any;
    private readonly _dart_initWithValue: (value?: string | undefined) => void = undefined as any;
    private readonly _dart_toPrimitives: () => Object | undefined = undefined as any;
    private readonly _dart_fromPrimitives: (data?: Object | undefined) => string = undefined as any;

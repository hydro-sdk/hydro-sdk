...
declare const flutter: {
    widgets: {
        _overridableContextAction: <T>(
            this: void,
            _overridableContextAction: I_OverridableContextAction<T>,
            props: {
                defaultAction: IContextAction<T>;
                lookupContext: IBuildContext;
            }
        ) => I_OverridableContextAction<T>;
    };
};
export interface I_OverridableContextAction<T> {
    defaultAction: IContextAction<T>;
    lookupContext: IBuildContext;
...
export class _OverridableContextAction<T>
    implements IContextAction<T>, I_OverridableActionMixin<T>, IDiagnosticable
{
    public readonly defaultAction: IContextAction<T> = undefined as any;
    ...
    public readonly debugAssertIsActionEnabledMutuallyRecursive: boolean =
        undefined as any;
    public readonly debugAssertIsEnabledMutuallyRecursive: boolean =
        undefined as any;
    public readonly debugAssertConsumeKeyMutuallyRecursive: boolean =
        undefined as any;
    public constructor(props: {
        defaultAction: IContextAction<T>;
        lookupContext: IBuildContext;
    }) {
        flutter.widgets._overridableContextAction(this, props);
    }
    private readonly _dart_invokeDefaultAction: (
        intent: T,
        fromAction?: IAction<T> | undefined,
        context?: IBuildContext | undefined
    ) => Object | undefined = undefined as any;
    private readonly _dart_getOverrideAction: (props: {
        declareDependency: boolean;
    }) => IAction<T> | undefined = undefined as any;
    private readonly _dart_invoke: (
        intent: T,
        context?: IBuildContext | undefined
    ) => Object | undefined = undefined as any;
    private readonly _dart_isOverrideActionEnabled: (
        overrideAction: IAction<T>
    ...
    private readonly _dart_getDefaultAction: () => IAction<T> =
        undefined as any;
    private readonly _dart_getLookupContext: () => IBuildContext =
        undefined as any;
    ...
    public getOverrideAction(props: {
        declareDependency?: boolean;
    }): IAction<T> | undefined {

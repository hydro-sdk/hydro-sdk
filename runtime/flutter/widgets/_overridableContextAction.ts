...
widgets: {
_overridableContextAction: <T>(this: void, _overridableContextAction: I_OverridableContextAction<T>, props : {  defaultAction : IContextAction<T>, lookupContext : IBuildContext,}) => I_OverridableContextAction<T>
}
};
export interface I_OverridableContextAction
<T>
...
getHashCode: () => number;
}export class _OverridableContextAction
<T>
...
public constructor( props : {  defaultAction : IContextAction<T>, lookupContext : IBuildContext,}){

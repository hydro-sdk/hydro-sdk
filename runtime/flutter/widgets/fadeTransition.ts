...
import { IRenderAnimatedOpacity } from "../rendering/renderAnimatedOpacity";
...
widgets: {
fadeTransition: (this: void, fadeTransition: IFadeTransition, props : {  alwaysIncludeSemantics : boolean, child? : IWidget | undefined, key? : IKey | undefined, opacity : IAnimation<number>,}) => IFadeTransition
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderAnimatedOpacity;
...
public constructor( props : {  alwaysIncludeSemantics? : boolean, child? : IWidget | undefined, key? : IKey | undefined, opacity : IAnimation<number>,}){
flutter.widgets.fadeTransition(this, {
...fadeTransitionDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderAnimatedOpacity = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderAnimatedOpacity {

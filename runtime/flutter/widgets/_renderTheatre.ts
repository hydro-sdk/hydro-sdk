...
widgets: {
_renderTheatre: (this: void, _renderTheatre: I_RenderTheatre, props : {  children? : IList<IRenderBox> | undefined, clipBehavior : Clip, skipCount : number, textDirection : TextDirection,}) => I_RenderTheatre
}
};
export interface I_RenderTheatre
...
getHashCode: () => number;
}export class _RenderTheatre

 implements IRenderBox, IContainerRenderObjectMixin<IRenderBox,IStackParentData>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  children? : IList<IRenderBox> | undefined, clipBehavior? : Clip, skipCount? : number, textDirection : TextDirection,}){
flutter.widgets._renderTheatre(this, {
..._renderTheatreDefaultProps,
...props
});}
    ...
    private readonly _dart_getSkipCount: () => number = undefined as any;
    private readonly _dart_setSkipCount: (value: number) => void = undefined as any;
...
public getSkipCount() : number {
    return this._dart_getSkipCount();
}
public setSkipCount(value: number) : void {
    return this._dart_setSkipCount(value);
}
...
const _renderTheatreDefaultProps = {

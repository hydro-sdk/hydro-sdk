...
widgets: {
_glowController: (this: void, _glowController: I_GlowController, props : {  axis : Axis, color : IColor, vsync : ITickerProvider,}) => I_GlowController
}
};
...
pull: (overscroll: number, extent: number, crossAxisOffset: number, crossExtent: number) => void;
scrollEnd: () => void;
...
public constructor( props : {  axis : Axis, color : IColor, vsync : ITickerProvider,}){
flutter.widgets._glowController(this, props);}
    ...
    private readonly _dart_pull: (overscroll: number, extent: number, crossAxisOffset: number, crossExtent: number) => void = undefined as any;
...
public pull(overscroll: number, extent: number, crossAxisOffset: number, crossExtent: number) : void {
    return this._dart_pull(overscroll, extent, crossAxisOffset, crossExtent);
}

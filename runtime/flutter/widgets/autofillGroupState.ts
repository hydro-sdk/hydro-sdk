...
declare const flutter: {
    widgets: {
        autofillGroupState: (
            this: void,
            autofillGroupState: IAutofillGroupState
        ) => IAutofillGroupState;
    };
};
...
export class AutofillGroupState
    implements
        Omit<IState<IAutofillGroup>, "debugFillProperties">,
        IAutofillScopeMixin,
        IDiagnosticable,
        IAutofillScope
{
    ...
    private readonly _dart_getAutofillClient: (
        autofillId: string
    ) => IAutofillClient | undefined = undefined as any;
    private readonly _dart_getAutofillClients: () => IIterable<IAutofillClient> =
        undefined as any;
    private readonly _dart_register: (client: IAutofillClient) => void =
        undefined as any;
    private readonly _dart_unregister: (autofillId: string) => void =
        undefined as any;
    ...
    private readonly _dart_attach: (
        trigger: ITextInputClient,
        configuration: ITextInputConfiguration
    ) => ITextInputConnection = undefined as any;

...
declare const flutter: {
    widgets: {
        _forceImplicitScrollPhysics: (
            this: void,
            _forceImplicitScrollPhysics: I_ForceImplicitScrollPhysics,
            props: {
                parent?: IScrollPhysics | undefined;
                allowImplicitScrolling: boolean;
            }
        ) => I_ForceImplicitScrollPhysics;
    };
};
...
export class _ForceImplicitScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => I_ForceImplicitScrollPhysics = undefined as any;

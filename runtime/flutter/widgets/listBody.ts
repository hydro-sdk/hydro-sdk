...
widgets: {
listBody: (this: void, listBody: IListBody, props : {  children : IList<IWidget>, key? : IKey | undefined, mainAxis : Axis, reverse : boolean,}) => IListBody
}
};
...
public constructor( props : {  children? : IList<IWidget>, key? : IKey | undefined, mainAxis? : Axis, reverse? : boolean,}){
flutter.widgets.listBody(this, {
...listBodyDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderListBody = undefined as any;

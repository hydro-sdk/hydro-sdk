...
declare const flutter: {
    widgets: {
        slideTransition: (
            this: void,
            slideTransition: ISlideTransition,
            props: {
                child?: IWidget | undefined;
                key?: IKey | undefined;
                textDirection?: TextDirection | undefined;
                transformHitTests: boolean;
                position: IAnimation<IOffset>;
            }
        ) => ISlideTransition;
    };
};
...
export class SlideTransition implements IAnimatedWidget, IDiagnosticable {
    ...
    private readonly _dart_getPosition: () => IAnimation<IOffset> =
        undefined as any;

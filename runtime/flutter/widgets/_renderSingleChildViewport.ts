...
import { IRenderAbstractViewport,RenderAbstractViewport } from "../rendering/renderAbstractViewport";
...
widgets: {
_renderSingleChildViewport: (this: void, _renderSingleChildViewport: I_RenderSingleChildViewport, props : {  axisDirection : AxisDirection, cacheExtent : number, child? : IRenderBox | undefined, clipBehavior : Clip, offset : IViewportOffset,}) => I_RenderSingleChildViewport
}
};
export interface I_RenderSingleChildViewport
...
getCacheExtent: () => number;
setCacheExtent: (value: number) => void;
...
getHashCode: () => number;
}export class _RenderSingleChildViewport

 implements IRenderBox, IRenderObjectWithChildMixin<IRenderBox>, IDiagnosticableTreeMixin, IDiagnosticable, IRenderAbstractViewport, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  axisDirection? : AxisDirection, cacheExtent? : number, child? : IRenderBox | undefined, clipBehavior : Clip, offset : IViewportOffset,}){
flutter.widgets._renderSingleChildViewport(this, {
..._renderSingleChildViewportDefaultProps,
...props
});}
    ...
    private readonly _dart_getCacheExtent: () => number = undefined as any;
    private readonly _dart_setCacheExtent: (value: number) => void = undefined as any;
...
public getCacheExtent() : number {
    return this._dart_getCacheExtent();
}
public setCacheExtent(value: number) : void {
...
const _renderSingleChildViewportDefaultProps = {

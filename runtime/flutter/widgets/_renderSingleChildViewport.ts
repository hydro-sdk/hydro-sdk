...
} from "../rendering/renderAbstractViewport";
...
declare const flutter: {
    widgets: {
        _renderSingleChildViewport: (
            this: void,
            _renderSingleChildViewport: I_RenderSingleChildViewport,
            props: {
        ...
        >
{
    ...
    private readonly _dart_setCacheExtent: (value: number) => void =
        undefined as any;

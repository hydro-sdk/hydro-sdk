...
widgets: {
parentDataWidget: <T>(this: void, parentDataWidget: IParentDataWidget<T>, props : {  key? : IKey | undefined, child : IWidget,}) => IParentDataWidget<T>
}
};
export interface IParentDataWidget
<T>
...
}export class ParentDataWidget
<T>
 implements IProxyWidget, IDiagnosticable
{    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, child : IWidget,}){
flutter.widgets.parentDataWidget(this, props);}
    private readonly _dart_createElement: () => IParentDataElement<T> = undefined as any;

...
import { IAnimatedPositionedDirectional } from "./animatedPositionedDirectional";
...
widgets: {
_animatedPositionedDirectionalState: (this: void, _animatedPositionedDirectionalState: I_AnimatedPositionedDirectionalState) => I_AnimatedPositionedDirectionalState
}
};
export interface I_AnimatedPositionedDirectionalState
...
deactivate: () => void;
activate: () => void;
getWidget: () => IAnimatedPositionedDirectional;
...
getHashCode: () => number;
}export class _AnimatedPositionedDirectionalState

 implements IAnimatedWidgetBaseState<IAnimatedPositionedDirectional>, ISingleTickerProviderStateMixin<IAnimatedPositionedDirectional>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedPositionedDirectionalState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedPositionedDirectional = undefined as any;
...
public getWidget() : IAnimatedPositionedDirectional {

...
declare const flutter: {
    widgets: {
        _animatedPositionedDirectionalState: (
            this: void,
            _animatedPositionedDirectionalState: I_AnimatedPositionedDirectionalState
        ) => I_AnimatedPositionedDirectionalState;
    };
};
...
export class _AnimatedPositionedDirectionalState
    implements
        IAnimatedWidgetBaseState<IAnimatedPositionedDirectional>,
        ISingleTickerProviderStateMixin<IAnimatedPositionedDirectional>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedPositionedDirectional =
        undefined as any;

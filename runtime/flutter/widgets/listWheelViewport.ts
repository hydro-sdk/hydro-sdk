...
import { IRenderListWheelViewport,RenderListWheelViewport } from "../rendering/renderListWheelViewport";
...
widgets: {
listWheelViewport: (this: void, listWheelViewport: IListWheelViewport, props : {  clipBehavior : Clip, diameterRatio : number, key? : IKey | undefined, magnification : number, offAxisFraction : number, overAndUnderCenterOpacity : number, perspective : number, renderChildrenOutsideViewport : boolean, squeeze : number, useMagnifier : boolean, childDelegate : IListWheelChildDelegate, itemExtent : number, offset : IViewportOffset,}) => IListWheelViewport
}
};
...
}export class ListWheelViewport
...
public constructor( props : {  clipBehavior? : Clip, diameterRatio? : number, key? : IKey | undefined, magnification? : number, offAxisFraction? : number, overAndUnderCenterOpacity? : number, perspective? : number, renderChildrenOutsideViewport? : boolean, squeeze? : number, useMagnifier? : boolean, childDelegate : IListWheelChildDelegate, itemExtent : number, offset : IViewportOffset,}){
flutter.widgets.listWheelViewport(this, {
...listWheelViewportDefaultProps,
...props
});}
    private readonly _dart_createElement: () => IListWheelElement = undefined as any;
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderListWheelViewport = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderListWheelViewport {

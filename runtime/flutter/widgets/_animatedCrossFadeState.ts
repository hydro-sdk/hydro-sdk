...
declare const flutter: {
    widgets: {
        _animatedCrossFadeState: (
            this: void,
            _animatedCrossFadeState: I_AnimatedCrossFadeState
        ) => I_AnimatedCrossFadeState;
    };
};
...
export class _AnimatedCrossFadeState
    implements
        Omit<
            IState<IAnimatedCrossFade>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IAnimatedCrossFade>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedCrossFade =
        undefined as any;

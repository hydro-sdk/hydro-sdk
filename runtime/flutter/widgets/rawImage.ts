...
widgets: {
rawImage: (this: void, rawImage: IRawImage, props : {  alignment : IAlignmentGeometry, centerSlice? : IRect | undefined, color? : IColor | undefined, colorBlendMode? : BlendMode | undefined, debugImageLabel? : string | undefined, filterQuality : FilterQuality, fit? : BoxFit | undefined, height? : number | undefined, image? : IImage | undefined, invertColors : boolean, isAntiAlias : boolean, key? : IKey | undefined, matchTextDirection : boolean, opacity? : IAnimation<number> | undefined, repeat : ImageRepeat, scale : number, width? : number | undefined,}) => IRawImage
}
};
...
public constructor( props : {  alignment? : IAlignmentGeometry, centerSlice? : IRect | undefined, color? : IColor | undefined, colorBlendMode? : BlendMode | undefined, debugImageLabel? : string | undefined, filterQuality? : FilterQuality, fit? : BoxFit | undefined, height? : number | undefined, image? : IImage | undefined, invertColors? : boolean, isAntiAlias? : boolean, key? : IKey | undefined, matchTextDirection? : boolean, opacity? : IAnimation<number> | undefined, repeat? : ImageRepeat, scale? : number, width? : number | undefined,}){
flutter.widgets.rawImage(this, {
...rawImageDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderImage = undefined as any;

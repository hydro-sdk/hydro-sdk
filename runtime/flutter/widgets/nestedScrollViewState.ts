...
widgets: {
nestedScrollViewState: (this: void, nestedScrollViewState: INestedScrollViewState) => INestedScrollViewState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<INestedScrollView>, "debugFillProperties">, IDiagnosticable
{public constructor(){
flutter.widgets.nestedScrollViewState(this);}
    private readonly _dart_getInnerController: () => IScrollController = undefined as any;
    private readonly _dart_getOuterController: () => IScrollController = undefined as any;
    ...
    private readonly _dart_getWidget: () => INestedScrollView = undefined as any;

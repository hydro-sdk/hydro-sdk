...
declare const flutter: {
    widgets: {
        matrix4Tween: (
            this: void,
            matrix4Tween: IMatrix4Tween,
            props?: { begin?: IMatrix4 | undefined; end?: IMatrix4 | undefined }
        ) => IMatrix4Tween;
    };
};
...
export class Matrix4Tween implements ITween<IMatrix4> {
    ...
    private readonly _dart_transform: (t: number) => IMatrix4 =
        undefined as any;
    ...
    ) => IAnimation<IMatrix4> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IMatrix4> = undefined as any;

...
widgets: {
streamBuilder: <T>(this: void, streamBuilder: IStreamBuilder<T>, props : {  initialData? : T | undefined, key? : IKey | undefined, stream? : IStream<T> | undefined, builder : (context: IBuildContext, snapshot: IAsyncSnapshot<T>) => IWidget,}) => IStreamBuilder<T>
}
};
...
afterError: (current: IAsyncSnapshot<T>, error: Object, stackTrace: IStackTrace) => IAsyncSnapshot<T>;
afterDone: (current: IAsyncSnapshot<T>) => IAsyncSnapshot<T>;
afterDisconnected: (current: IAsyncSnapshot<T>) => IAsyncSnapshot<T>;
build: (context: IBuildContext, currentSummary: IAsyncSnapshot<T>) => IWidget;
...
public constructor( props : {  initialData? : T | undefined, key? : IKey | undefined, stream? : IStream<T> | undefined, builder : (context: IBuildContext, snapshot: IAsyncSnapshot<T>) => IWidget,}){
flutter.widgets.streamBuilder(this, props);}
    private readonly _dart_initial: () => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_afterConnected: (current: IAsyncSnapshot<T>) => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_afterData: (current: IAsyncSnapshot<T>, data: T) => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_afterError: (current: IAsyncSnapshot<T>, error: Object, stackTrace: IStackTrace) => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_afterDone: (current: IAsyncSnapshot<T>) => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_afterDisconnected: (current: IAsyncSnapshot<T>) => IAsyncSnapshot<T> = undefined as any;
    private readonly _dart_build: (context: IBuildContext, currentSummary: IAsyncSnapshot<T>) => IWidget = undefined as any;
    private readonly _dart_createState: () => IState<IStreamBuilderBase<T, IAsyncSnapshot<T>>> = undefined as any;
...
public afterError(current: IAsyncSnapshot<T>, error: Object, stackTrace: IStackTrace) : IAsyncSnapshot<T> {
...
public build(context: IBuildContext, currentSummary: IAsyncSnapshot<T>) : IWidget {

...
import { I_TableSlot } from "./_tableSlot";
...
widgets: {
_tableElement: (this: void, _tableElement: I_TableElement, widget: ITable) => I_TableElement
}
};
export interface I_TableElement


{
getWidget: () => ITable;
getRenderObject: () => IRenderTable;
...
forgetChild: (child: IElement) => boolean;
performRebuild: () => void;
...
}export class _TableElement

 implements IRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: ITable){
flutter.widgets._tableElement(this, widget);}
    private readonly _dart_getWidget: () => ITable = undefined as any;
    private readonly _dart_getRenderObject: () => IRenderTable = undefined as any;
    ...
    private readonly _dart_forgetChild: (child: IElement) => boolean = undefined as any;
...
public getWidget() : ITable {
    return this._dart_getWidget();
}
public getRenderObject() : IRenderTable {
...
public forgetChild(child: IElement) : boolean {

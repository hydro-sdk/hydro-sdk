...
widgets: {
focusTrapArea: (this: void, focusTrapArea: IFocusTrapArea, props : {  child? : IWidget | undefined, key? : IKey | undefined, focusNode : IFocusNode,}) => IFocusTrapArea
}
};
export interface IFocusTrapArea
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, focusNode : IFocusNode,}){
flutter.widgets.focusTrapArea(this, props);}

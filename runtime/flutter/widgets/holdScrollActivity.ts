...
widgets: {
holdScrollActivity: (this: void, holdScrollActivity: IHoldScrollActivity, props : {  onHoldCanceled? : () => void | undefined, delegate : IScrollActivityDelegate,}) => IHoldScrollActivity
}
};
...
{public constructor( props : {  onHoldCanceled? : () => void | undefined, delegate : IScrollActivityDelegate,}){

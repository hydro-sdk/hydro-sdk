...
widgets: {
listWheelScrollView: (this: void, listWheelScrollView: IListWheelScrollView, props : {  clipBehavior : Clip, controller? : IScrollController | undefined, diameterRatio : number, key? : IKey | undefined, magnification : number, offAxisFraction : number, onSelectedItemChanged? : (value: number) => void | undefined, overAndUnderCenterOpacity : number, perspective : number, physics? : IScrollPhysics | undefined, renderChildrenOutsideViewport : boolean, restorationId? : string | undefined, scrollBehavior? : IScrollBehavior | undefined, squeeze : number, useMagnifier : boolean, children : IList<IWidget>, itemExtent : number,}) => IListWheelScrollView
}
};
...
}export class ListWheelScrollView
...
...props
    ...
    private readonly _dart_createState: () => IState<IListWheelScrollView> = undefined as any;

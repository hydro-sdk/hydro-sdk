...
widgets: {
_dragAvatar: <T>(this: void, _dragAvatar: I_DragAvatar<T>, props : {  axis? : Axis | undefined, data? : T | undefined, dragStartPoint : IOffset, feedback? : IWidget | undefined, feedbackOffset : IOffset, onDragEnd? : (velocity: IVelocity, offset: IOffset, wasAccepted: boolean) => void | undefined, onDragUpdate? : (details: IDragUpdateDetails) => void | undefined, ignoringFeedbackSemantics : boolean, initialPosition : IOffset, overlayState : IOverlayState,}) => I_DragAvatar<T>
}
};
export interface I_DragAvatar
<T>
...
finishDrag: (endKind: _DragEndKind, velocity?: IVelocity | undefined) => void;
toString: () => string;
getHashCode: () => number;
}export class _DragAvatar
<T>
 implements IDrag
...
public constructor( props : {  axis? : Axis | undefined, data? : T | undefined, dragStartPoint? : IOffset, feedback? : IWidget | undefined, feedbackOffset? : IOffset, onDragEnd? : (velocity: IVelocity, offset: IOffset, wasAccepted: boolean) => void | undefined, onDragUpdate? : (details: IDragUpdateDetails) => void | undefined, ignoringFeedbackSemantics : boolean, initialPosition : IOffset, overlayState : IOverlayState,}){
...
...props
    ...
    private readonly _dart_updateDrag: (globalPosition: IOffset) => void = undefined as any;
    private readonly _dart_finishDrag: (endKind: _DragEndKind, velocity?: IVelocity | undefined) => void = undefined as any;
...
public finishDrag(endKind: _DragEndKind, velocity?: IVelocity | undefined) : void {

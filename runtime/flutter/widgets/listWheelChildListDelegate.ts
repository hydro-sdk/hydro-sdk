...
declare const flutter: {
    widgets: {
        listWheelChildListDelegate: (
            this: void,
            listWheelChildListDelegate: IListWheelChildListDelegate,
            props: { children: IList<IWidget> }
        ) => IListWheelChildListDelegate;
    };
};
...
export class ListWheelChildListDelegate implements IListWheelChildDelegate {
    ...
    private readonly _dart_getEstimatedChildCount: () => number =
        undefined as any;

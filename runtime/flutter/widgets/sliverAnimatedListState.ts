...
declare const flutter: {
    widgets: {
        sliverAnimatedListState: (
            this: void,
            sliverAnimatedListState: ISliverAnimatedListState
...
export class SliverAnimatedListState
    implements
        Omit<
            IState<ISliverAnimatedList>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ISliverAnimatedList>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => ISliverAnimatedList =
        undefined as any;

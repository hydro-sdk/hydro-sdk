...
import { IAnimatedAlign } from "./animatedAlign";
...
widgets: {
_animatedAlignState: (this: void, _animatedAlignState: I_AnimatedAlignState) => I_AnimatedAlignState
}
};
export interface I_AnimatedAlignState
...
getHashCode: () => number;
}export class _AnimatedAlignState

 implements IAnimatedWidgetBaseState<IAnimatedAlign>, ISingleTickerProviderStateMixin<IAnimatedAlign>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedAlignState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedAlign = undefined as any;
...
public getWidget() : IAnimatedAlign {

...
export class Table implements IRenderObjectWidget, IDiagnosticable {
    public readonly children: IList<ITableRow> = undefined as any;
    public readonly columnWidths:
        | { [index: number]: ITableColumnWidth }
    ...
    public readonly defaultVerticalAlignment: TableCellVerticalAlignment =
        undefined as any;

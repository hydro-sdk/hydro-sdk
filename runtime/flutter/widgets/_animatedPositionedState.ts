...
widgets: {
_animatedPositionedState: (this: void, _animatedPositionedState: I_AnimatedPositionedState) => I_AnimatedPositionedState
}
};
...
getHashCode: () => number;
 ...
 implements IAnimatedWidgetBaseState<IAnimatedPositioned>, ISingleTickerProviderStateMixin<IAnimatedPositioned>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedPositionedState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedPositioned = undefined as any;

...
declare const flutter: {
    widgets: {
        draggableScrollableSheet: (
            this: void,
            draggableScrollableSheet: IDraggableScrollableSheet,
            props: {
                expand: boolean;
                ...
                builder: (
                    ...
                    scrollController: IScrollController
                ) => IWidget;
            }
        ) => IDraggableScrollableSheet;
    };
};
    ...
    implements IStatefulWidget, IDiagnosticable
{
    ...
    private readonly _dart_createState: () => IState<IDraggableScrollableSheet> =
        undefined as any;

...
widgets: {
focusTrap: (this: void, focusTrap: IFocusTrap, props : {  key? : IKey | undefined, child : IWidget, focusScopeNode : IFocusScopeNode,}) => IFocusTrap
}
};
...
public constructor( props : {  key? : IKey | undefined, child : IWidget, focusScopeNode : IFocusScopeNode,}){
flutter.widgets.focusTrap(this, props);}

...
widgets: {
align: (this: void, align: IAlign, props : {  alignment : IAlignmentGeometry, child? : IWidget | undefined, heightFactor? : number | undefined, key? : IKey | undefined, widthFactor? : number | undefined,}) => IAlign
}
};
...
...props
    ...
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderPositionedBox = undefined as any;

...
widgets: {
_tweenAnimationBuilderState: <T>(this: void, _tweenAnimationBuilderState: I_TweenAnimationBuilderState<T>) => I_TweenAnimationBuilderState<T>
}
};
export interface I_TweenAnimationBuilderState
<T>
...
getHashCode: () => number;
}export class _TweenAnimationBuilderState
<T>
 implements IAnimatedWidgetBaseState<ITweenAnimationBuilder<T>>, ISingleTickerProviderStateMixin<ITweenAnimationBuilder<T>>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._tweenAnimationBuilderState(this);}
    ...
    private readonly _dart_getWidget: () => ITweenAnimationBuilder<T> = undefined as any;

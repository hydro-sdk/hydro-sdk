...
widgets: {
labeledGlobalKey: <T>(this: void, labeledGlobalKey: ILabeledGlobalKey<T>, _debugLabel?: string | undefined) => ILabeledGlobalKey<T>
}
};
export interface ILabeledGlobalKey
<T>
...
getHashCode: () => number;
}export class LabeledGlobalKey
<T>
 implements IGlobalKey<T>
...
flutter.widgets.labeledGlobalKey(this, _debugLabel);}
    ...
    private readonly _dart_getCurrentState: () => T | undefined = undefined as any;

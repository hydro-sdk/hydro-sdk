...
import { ISliverAnimatedOpacity } from "./sliverAnimatedOpacity";
...
widgets: {
_sliverAnimatedOpacityState: (this: void, _sliverAnimatedOpacityState: I_SliverAnimatedOpacityState) => I_SliverAnimatedOpacityState
}
};
export interface I_SliverAnimatedOpacityState
...
deactivate: () => void;
activate: () => void;
getWidget: () => ISliverAnimatedOpacity;
...
getHashCode: () => number;
}export class _SliverAnimatedOpacityState

 implements Omit<IImplicitlyAnimatedWidgetState<ISliverAnimatedOpacity>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<ISliverAnimatedOpacity>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._sliverAnimatedOpacityState(this);}
    ...
    private readonly _dart_getWidget: () => ISliverAnimatedOpacity = undefined as any;
...
public getWidget() : ISliverAnimatedOpacity {

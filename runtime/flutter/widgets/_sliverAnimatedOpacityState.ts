...
declare const flutter: {
    widgets: {
        _sliverAnimatedOpacityState: (
            this: void,
            _sliverAnimatedOpacityState: I_SliverAnimatedOpacityState
        ) => I_SliverAnimatedOpacityState;
    };
};
...
export class _SliverAnimatedOpacityState
    implements
        Omit<
            IImplicitlyAnimatedWidgetState<ISliverAnimatedOpacity>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<ISliverAnimatedOpacity>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => ISliverAnimatedOpacity =
        undefined as any;

...
widgets: {
_inactiveElements: (this: void, _inactiveElements: I_InactiveElements) => I_InactiveElements
}
};
...
flutter.widgets._inactiveElements(this);}
    ...
    private readonly _dart_remove: (element: IElement) => void = undefined as any;
    private readonly _dart_debugContains: (element: IElement) => boolean = undefined as any;

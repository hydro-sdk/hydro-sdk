...
import { IAutomaticKeepAlive } from "./automaticKeepAlive";
...
widgets: {
_automaticKeepAliveState: (this: void, _automaticKeepAliveState: I_AutomaticKeepAliveState) => I_AutomaticKeepAliveState
}
};
export interface I_AutomaticKeepAliveState
...
getHashCode: () => number;
}export class _AutomaticKeepAliveState

 implements Omit<IState<IAutomaticKeepAlive>, "debugFillProperties">, IDiagnosticable
{public constructor(){
flutter.widgets._automaticKeepAliveState(this);}
    ...
    private readonly _dart_getWidget: () => IAutomaticKeepAlive = undefined as any;
...
public getWidget() : IAutomaticKeepAlive {

...
widgets: {
formFieldState: <T>(this: void, formFieldState: IFormFieldState<T>) => IFormFieldState<T>
}
};
...
<T>
 implements Omit<IState<IFormField<T>>, "didUpdateWidget" | "dispose" | "didChangeDependencies" | "debugFillProperties">, IRestorationMixin<IFormField<T>>, IDiagnosticable
{public constructor(){
flutter.widgets.formFieldState(this);}
    private readonly _dart_getValue: () => T | undefined = undefined as any;
    private readonly _dart_getErrorText: () => string | undefined = undefined as any;
    ...
    private readonly _dart_didChange: (value?: T | undefined) => void = undefined as any;
    private readonly _dart_setValue: (value?: T | undefined) => void = undefined as any;

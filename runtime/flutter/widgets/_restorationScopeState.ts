...
declare const flutter: {
    widgets: {
        _restorationScopeState: (
            this: void,
            _restorationScopeState: I_RestorationScopeState
        ) => I_RestorationScopeState;
    };
};
...
export class _RestorationScopeState
    implements
        Omit<
            IState<IRestorationScope>,
            | "didUpdateWidget"
            | "dispose"
            | "didChangeDependencies"
            | "debugFillProperties"
        >,
        IRestorationMixin<IRestorationScope>,
        IDiagnosticable
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IRestorationScope =
        undefined as any;

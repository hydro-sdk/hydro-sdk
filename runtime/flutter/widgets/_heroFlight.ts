...
declare const flutter: {
    widgets: {
        _heroFlight: (
            this: void,
            _heroFlight: I_HeroFlight,
            onFlightEnded: (flight: I_HeroFlight) => void
        ) => I_HeroFlight;
    };
};
...
export class _HeroFlight {
    ...
    private readonly _dart_start: (
        initialManifest: I_HeroFlightManifest
    ) => void = undefined as any;
    private readonly _dart_divert: (newManifest: I_HeroFlightManifest) => void =
        undefined as any;

...
declare const flutter: {
    widgets: {
        defaultTextStyleTransition: (
            this: void,
            defaultTextStyleTransition: IDefaultTextStyleTransition,
            props: {
                key?: IKey | undefined;
                ...
                child: IWidget;
                style: IAnimation<ITextStyle>;
            }
        ) => IDefaultTextStyleTransition;
    };
};
    ...
    implements IAnimatedWidget, IDiagnosticable
{
    ...
    private readonly _dart_getStyle: () => IAnimation<ITextStyle> =
        undefined as any;

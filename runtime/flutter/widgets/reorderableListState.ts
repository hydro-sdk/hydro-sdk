...
widgets: {
reorderableListState: (this: void, reorderableListState: IReorderableListState) => IReorderableListState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IState<IReorderableList>, "debugFillProperties">, IDiagnosticable
{public constructor(){

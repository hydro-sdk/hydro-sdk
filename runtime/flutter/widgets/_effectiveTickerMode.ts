...
widgets: {
_effectiveTickerMode: (this: void, _effectiveTickerMode: I_EffectiveTickerMode, props : {  key? : IKey | undefined, child : IWidget, enabled : boolean,}) => I_EffectiveTickerMode
}
};
export interface I_EffectiveTickerMode
...
}export class _EffectiveTickerMode
...
flutter.widgets._effectiveTickerMode(this, props);}

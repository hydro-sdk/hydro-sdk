...
widgets: {
_contextActionToActionAdapter: <T>(this: void, _contextActionToActionAdapter: I_ContextActionToActionAdapter<T>, props : {  action : IContextAction<T>, invokeContext : IBuildContext,}) => I_ContextActionToActionAdapter<T>
}
};
export interface I_ContextActionToActionAdapter
<T>
...
getHashCode: () => number;
}export class _ContextActionToActionAdapter
<T>
...
public constructor( props : {  action : IContextAction<T>, invokeContext : IBuildContext,}){

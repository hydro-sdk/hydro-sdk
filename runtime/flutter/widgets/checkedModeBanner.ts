...
widgets: {
checkedModeBanner: (this: void, checkedModeBanner: ICheckedModeBanner, props : {  key? : IKey | undefined, child : IWidget,}) => ICheckedModeBanner
}
};
export interface ICheckedModeBanner

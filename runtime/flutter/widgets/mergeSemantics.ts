...
import { IRenderMergeSemantics } from "../rendering/renderMergeSemantics";
...
widgets: {
mergeSemantics: (this: void, mergeSemantics: IMergeSemantics, props? : {  child? : IWidget | undefined, key? : IKey | undefined,}) => IMergeSemantics
}
};
export interface IMergeSemantics


{
child: IWidget | undefined;
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderMergeSemantics;
...
flutter.widgets.mergeSemantics(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderMergeSemantics = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderMergeSemantics {

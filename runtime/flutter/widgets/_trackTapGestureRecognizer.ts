...
declare const flutter: {
    widgets: {
        _trackTapGestureRecognizer: (
            this: void,
            _trackTapGestureRecognizer: I_TrackTapGestureRecognizer,
            props: {
                customPaintKey: IGlobalKey<IState<IStatefulWidget>>;
                debugOwner: Object;
            }
        ) => I_TrackTapGestureRecognizer;
    };
};
export interface I_TrackTapGestureRecognizer {
    ...
    handleTapUp: (props: {
        down: IPointerDownEvent;
        up: IPointerUpEvent;
    }) => void;
    handleTapCancel: (props: {
        cancel?: IPointerCancelEvent | undefined;
        down: IPointerDownEvent;
        reason: string;
    }) => void;
        ...
        >
{
    public readonly onTapDown: (details: ITapDownDetails) => void | undefined =
        undefined as any;
    public readonly onTapUp: (details: ITapUpDetails) => void | undefined =
        undefined as any;
    ...
    public readonly onSecondaryTapDown: (
        details: ITapDownDetails
    ) => void | undefined = undefined as any;
    public readonly onSecondaryTapUp: (
        details: ITapUpDetails
    ) => void | undefined = undefined as any;
    public readonly onSecondaryTapCancel: () => void | undefined =
        undefined as any;
    public readonly onTertiaryTapDown: (
        details: ITapDownDetails
    ) => void | undefined = undefined as any;
    public readonly onTertiaryTapUp: (
        details: ITapUpDetails
    ) => void | undefined = undefined as any;
    public readonly onTertiaryTapCancel: () => void | undefined =
        undefined as any;
    ...
    private readonly _dart_handleTapDown: (props: {
        down: IPointerDownEvent;
    }) => void = undefined as any;
    private readonly _dart_handleTapUp: (props: {
        down: IPointerDownEvent;
        up: IPointerUpEvent;
    }) => void = undefined as any;
    private readonly _dart_handleTapCancel: (props: {
        cancel?: IPointerCancelEvent | undefined;
        down: IPointerDownEvent;
        reason: string;
    }) => void = undefined as any;
    ...
    public handleTapUp(props: {
        down: IPointerDownEvent;
        up: IPointerUpEvent;
    }): void {
        return this._dart_handleTapUp(props);
    }
    public handleTapCancel(props: {
        cancel?: IPointerCancelEvent | undefined;
        down: IPointerDownEvent;
        reason: string;
    }): void {

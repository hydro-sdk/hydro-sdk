...
widgets: {
_trackTapGestureRecognizer: (this: void, _trackTapGestureRecognizer: I_TrackTapGestureRecognizer, props : {  customPaintKey : IGlobalKey<IState<IStatefulWidget>>, debugOwner : Object,}) => I_TrackTapGestureRecognizer
}
};
export interface I_TrackTapGestureRecognizer
...
getHashCode: () => number;
}export class _TrackTapGestureRecognizer

 implements ITapGestureRecognizer, IDiagnosticableTreeMixin, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
{    public readonly onTapDown: (details: ITapDownDetails) => void | undefined = undefined as any;
    public readonly onTapUp: (details: ITapUpDetails) => void | undefined = undefined as any;
    public readonly onTap: () => void | undefined = undefined as any;
    public readonly onTapCancel: () => void | undefined = undefined as any;
    public readonly onSecondaryTap: () => void | undefined = undefined as any;
    public readonly onSecondaryTapDown: (details: ITapDownDetails) => void | undefined = undefined as any;
    public readonly onSecondaryTapUp: (details: ITapUpDetails) => void | undefined = undefined as any;
    public readonly onSecondaryTapCancel: () => void | undefined = undefined as any;
    public readonly onTertiaryTapDown: (details: ITapDownDetails) => void | undefined = undefined as any;
    public readonly onTertiaryTapUp: (details: ITapUpDetails) => void | undefined = undefined as any;
    public readonly onTertiaryTapCancel: () => void | undefined = undefined as any;
...
public constructor( props : {  customPaintKey : IGlobalKey<IState<IStatefulWidget>>, debugOwner : Object,}){
flutter.widgets._trackTapGestureRecognizer(this, props);}

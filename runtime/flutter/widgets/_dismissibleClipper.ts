...
widgets: {
_dismissibleClipper: (this: void, _dismissibleClipper: I_DismissibleClipper, props : {  axis : Axis, moveAnimation : IAnimation<IOffset>,}) => I_DismissibleClipper
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _DismissibleClipper

 implements ICustomClipper<IRect>
{    public readonly axis: Axis = undefined as any;
    public readonly moveAnimation: IAnimation<IOffset> = undefined as any;
public constructor( props : {  axis : Axis, moveAnimation : IAnimation<IOffset>,}){

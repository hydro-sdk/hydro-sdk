...
widgets: {
scrollIntent: (this: void, scrollIntent: IScrollIntent, props : {  type : ScrollIncrementType, direction : AxisDirection,}) => IScrollIntent
}
};
...
public constructor( props : {  type? : ScrollIncrementType, direction : AxisDirection,}){

...
widgets: {
scrollPhysics: (this: void, scrollPhysics: IScrollPhysics, props? : {  parent? : IScrollPhysics | undefined,}) => IScrollPhysics
}
};
...
flutter.widgets.scrollPhysics(this, props);}
    ...
    private readonly _dart_applyTo: (ancestor?: IScrollPhysics | undefined) => IScrollPhysics = undefined as any;

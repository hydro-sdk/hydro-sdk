...
widgets: {
_reorderableItemGlobalKey: (this: void, _reorderableItemGlobalKey: I_ReorderableItemGlobalKey, subKey: IKey, index: number, state: ISliverReorderableListState) => I_ReorderableItemGlobalKey
}
};
...
public constructor(subKey: IKey, index: number, state: ISliverReorderableListState){
flutter.widgets._reorderableItemGlobalKey(this, subKey, index, state);}
    private readonly _dart_getHashCode: () => number = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_getCurrentContext: () => IBuildContext | undefined = undefined as any;
    private readonly _dart_getCurrentWidget: () => IWidget | undefined = undefined as any;
    private readonly _dart_getCurrentState: () => IState<IStatefulWidget> | undefined = undefined as any;

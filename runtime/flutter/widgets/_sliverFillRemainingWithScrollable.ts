...
declare const flutter: {
    widgets: {
        _sliverFillRemainingWithScrollable: (
            this: void,
            _sliverFillRemainingWithScrollable: I_SliverFillRemainingWithScrollable,
            props?: { child?: IWidget | undefined; key?: IKey | undefined }
        ) => I_SliverFillRemainingWithScrollable;
    };
};
    ...
    implements ISingleChildRenderObjectWidget, IDiagnosticable
{
    ...
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => IRenderSliverFillRemainingWithScrollable = undefined as any;

...
declare const flutter: {
    widgets: {
        _restorationInformation: (
            this: void,
            _restorationInformation: I_RestorationInformation,
            type: _RouteRestorationType
        ) => I_RestorationInformation;
        _restorationInformationNamed: (props: {
            arguments?: Object | undefined;
            name: string;
            restorationScopeId: number;
        }) => I_RestorationInformation;
        _restorationInformationAnonymous: (props: {
            arguments?: Object | undefined;
            restorationScopeId: number;
            routeBuilder: (
        ...
        _restorationInformationFromSerializableData: (
            data: Object
        ) => I_RestorationInformation;
    };
};
...
export class _RestorationInformation {
    ...
    public static fromSerializableData(data: Object): I_RestorationInformation {
        return flutter.widgets._restorationInformationFromSerializableData(
            data
        );
    }

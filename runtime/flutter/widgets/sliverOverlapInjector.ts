...
import { IRenderSliverOverlapInjector } from "./renderSliverOverlapInjector";
...
widgets: {
sliverOverlapInjector: (this: void, sliverOverlapInjector: ISliverOverlapInjector, props : {  key? : IKey | undefined, sliver? : IWidget | undefined, handle : ISliverOverlapAbsorberHandle,}) => ISliverOverlapInjector
}
};
export interface ISliverOverlapInjector
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverOverlapInjector;
...
}export class SliverOverlapInjector
...
public constructor( props : {  key? : IKey | undefined, sliver? : IWidget | undefined, handle : ISliverOverlapAbsorberHandle,}){
flutter.widgets.sliverOverlapInjector(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverOverlapInjector = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverOverlapInjector {

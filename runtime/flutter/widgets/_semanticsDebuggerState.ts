...
declare const flutter: {
    widgets: {
        _semanticsDebuggerState: (
            this: void,
            _semanticsDebuggerState: I_SemanticsDebuggerState
        ) => I_SemanticsDebuggerState;
    };
};
...
export class _SemanticsDebuggerState
    implements
        Omit<IState<ISemanticsDebugger>, "toString" | "debugFillProperties">,
        ...
        IDiagnosticable
{
    ...
    private readonly _dart_getWidget: () => ISemanticsDebugger =
        undefined as any;

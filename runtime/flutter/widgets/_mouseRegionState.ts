...
declare const flutter: {
    widgets: {
        _mouseRegionState: (
            this: void,
            _mouseRegionState: I_MouseRegionState
        ) => I_MouseRegionState;
    };
};
...
export class _MouseRegionState
    implements
        Omit<IState<IMouseRegion>, "debugFillProperties">,
        IDiagnosticable
{
    public constructor() {
        flutter.widgets._mouseRegionState(this);
    }
    private readonly _dart_handleExit: (event: IPointerExitEvent) => void =
        undefined as any;
    private readonly _dart_getHandleExit: () => (

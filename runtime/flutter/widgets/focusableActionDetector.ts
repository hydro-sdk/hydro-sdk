...
widgets: {
focusableActionDetector: (this: void, focusableActionDetector: IFocusableActionDetector, props : {  actions? : IMap<Type, IAction<IIntent>> | undefined, autofocus : boolean, descendantsAreFocusable : boolean, enabled : boolean, focusNode? : IFocusNode | undefined, key? : IKey | undefined, mouseCursor : IMouseCursor, onFocusChange? : (value: boolean) => void | undefined, onShowFocusHighlight? : (value: boolean) => void | undefined, onShowHoverHighlight? : (value: boolean) => void | undefined, shortcuts? : IMap<IShortcutActivator, IIntent> | undefined, child : IWidget,}) => IFocusableActionDetector
}
};
...
public constructor( props : {  actions? : IMap<Type, IAction<IIntent>> | undefined, autofocus? : boolean, descendantsAreFocusable? : boolean, enabled? : boolean, focusNode? : IFocusNode | undefined, key? : IKey | undefined, mouseCursor? : IMouseCursor, onFocusChange? : (value: boolean) => void | undefined, onShowFocusHighlight? : (value: boolean) => void | undefined, onShowHoverHighlight? : (value: boolean) => void | undefined, shortcuts? : IMap<IShortcutActivator, IIntent> | undefined, child : IWidget,}){
flutter.widgets.focusableActionDetector(this, {
...focusableActionDetectorDefaultProps,
...props
});}
    private readonly _dart_createState: () => IState<IFocusableActionDetector> = undefined as any;

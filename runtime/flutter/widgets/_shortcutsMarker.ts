...
widgets: {
_shortcutsMarker: (this: void, _shortcutsMarker: I_ShortcutsMarker, props : {  child : IWidget, manager : IShortcutManager,}) => I_ShortcutsMarker
}
};
export interface I_ShortcutsMarker


{
notifier: IShortcutManager | undefined;
child: IWidget;
key: IKey | undefined;
...
}export class _ShortcutsMarker

 implements IInheritedNotifier<IShortcutManager>, IDiagnosticable
{    public readonly notifier: IShortcutManager | undefined = undefined as any;
    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  child : IWidget, manager : IShortcutManager,}){
flutter.widgets._shortcutsMarker(this, props);}

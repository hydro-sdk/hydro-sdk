...
widgets: {
focusScope: (this: void, focusScope: IFocusScope, props : {  autofocus : boolean, canRequestFocus? : boolean | undefined, debugLabel? : string | undefined, key? : IKey | undefined, node? : IFocusScopeNode | undefined, onFocusChange? : (value: boolean) => void | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal? : boolean | undefined, child : IWidget,}) => IFocusScope;
focusScopeWithExternalFocusNode: ( props : {  autofocus : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, child : IWidget, focusScopeNode : IFocusScopeNode,}) => IFocusScope;
...
public constructor( props : {  autofocus? : boolean, canRequestFocus? : boolean | undefined, debugLabel? : string | undefined, key? : IKey | undefined, node? : IFocusScopeNode | undefined, onFocusChange? : (value: boolean) => void | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal? : boolean | undefined, child : IWidget,}){
flutter.widgets.focusScope(this, {
...focusScopeDefaultProps,
...props
});}
public static withExternalFocusNode( props : {  autofocus : boolean, key? : IKey | undefined, onFocusChange? : (value: boolean) => void | undefined, child : IWidget, focusScopeNode : IFocusScopeNode,}) : IFocusScope{

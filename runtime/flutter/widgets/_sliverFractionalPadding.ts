...
import { I_RenderSliverFractionalPadding } from "./_renderSliverFractionalPadding";
...
widgets: {
_sliverFractionalPadding: (this: void, _sliverFractionalPadding: I_SliverFractionalPadding, props : {  sliver? : IWidget | undefined, viewportFraction : number,}) => I_SliverFractionalPadding
}
};
export interface I_SliverFractionalPadding
...
}export class _SliverFractionalPadding
...
public constructor( props : {  sliver? : IWidget | undefined, viewportFraction? : number,}){
flutter.widgets._sliverFractionalPadding(this, {
..._sliverFractionalPaddingDefaultProps,
...props
});}
...
const _sliverFractionalPaddingDefaultProps = {
    viewportFraction: 0,
};

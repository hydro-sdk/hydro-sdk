...
widgets: {
borderTween: (this: void, borderTween: IBorderTween, props? : {  begin? : IBorder | undefined, end? : IBorder | undefined,}) => IBorderTween
}
};
...
getHashCode: () => number;
}export class BorderTween

 implements ITween<IBorder?>
{    public readonly begin: IBorder | undefined = undefined as any;
    public readonly end: IBorder | undefined = undefined as any;
public constructor( props? : {  begin? : IBorder | undefined, end? : IBorder | undefined,}){
flutter.widgets.borderTween(this, props);}
    private readonly _dart_lerp: (t: number) => IBorder | undefined = undefined as any;
    private readonly _dart_transform: (t: number) => IBorder | undefined = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IBorder | undefined = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IBorder | undefined> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IBorder | undefined> = undefined as any;
...
public animate(parent: IAnimation<number>) : IAnimation<IBorder | undefined> {
    return this._dart_animate(parent);
}
public chain(parent: IAnimatable<number>) : IAnimatable<IBorder | undefined> {

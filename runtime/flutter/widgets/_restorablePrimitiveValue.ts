...
widgets: {
_restorablePrimitiveValue: <T>(this: void, _restorablePrimitiveValue: I_RestorablePrimitiveValue<T>, _defaultValue: T) => I_RestorablePrimitiveValue<T>
}
};
export interface I_RestorablePrimitiveValue
<T>
...
toString: () => string;
getHashCode: () => number;
}export class _RestorablePrimitiveValue
<T>

...
declare const flutter: {
    widgets: {
        _directionalPolicyData: (
            this: void,
            _directionalPolicyData: I_DirectionalPolicyData,
            props: { history: IList<I_DirectionalPolicyDataEntry> }
        ) => I_DirectionalPolicyData;
    };
};
...
export class _DirectionalPolicyData {
    public readonly history: IList<I_DirectionalPolicyDataEntry> =
        undefined as any;

...
declare const flutter: {
    widgets: {
        neverScrollableScrollPhysics: (
            this: void,
            neverScrollableScrollPhysics: INeverScrollableScrollPhysics,
            props?: { parent?: IScrollPhysics | undefined }
        ) => INeverScrollableScrollPhysics;
    };
};
...
export class NeverScrollableScrollPhysics implements IScrollPhysics {
    ...
    private readonly _dart_applyTo: (
        ancestor?: IScrollPhysics | undefined
    ) => INeverScrollableScrollPhysics = undefined as any;

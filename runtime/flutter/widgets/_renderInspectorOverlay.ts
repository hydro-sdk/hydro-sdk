...
declare const flutter: {
    widgets: {
        _renderInspectorOverlay: (
            this: void,
            _renderInspectorOverlay: I_RenderInspectorOverlay,
            props: { selection: IInspectorSelection }
        ...
        >
{
    ...
    private readonly _dart_getSelection: () => IInspectorSelection =
        undefined as any;
    private readonly _dart_setSelection: (value: IInspectorSelection) => void =
        undefined as any;

...
widgets: {
_renderInspectorOverlay: (this: void, _renderInspectorOverlay: I_RenderInspectorOverlay, props : {  selection : IInspectorSelection,}) => I_RenderInspectorOverlay
}
};
export interface I_RenderInspectorOverlay


{
parentData: IParentData | undefined;
debugCreator: Object | undefined;
getSelection: () => IInspectorSelection;
setSelection: (value: IInspectorSelection) => void;
...
getHashCode: () => number;
}export class _RenderInspectorOverlay
...
public constructor( props : {  selection : IInspectorSelection,}){
flutter.widgets._renderInspectorOverlay(this, props);}
    private readonly _dart_getSelection: () => IInspectorSelection = undefined as any;
    private readonly _dart_setSelection: (value: IInspectorSelection) => void = undefined as any;
...
public getSelection() : IInspectorSelection {
    return this._dart_getSelection();
}
public setSelection(value: IInspectorSelection) : void {

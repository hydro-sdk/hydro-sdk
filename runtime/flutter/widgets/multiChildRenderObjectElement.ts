...
widgets: {
multiChildRenderObjectElement: (this: void, multiChildRenderObjectElement: IMultiChildRenderObjectElement, widget: IMultiChildRenderObjectWidget) => IMultiChildRenderObjectElement
}
};
export interface IMultiChildRenderObjectElement


{
getWidget: () => IMultiChildRenderObjectWidget;
getRenderObject: () => IContainerRenderObjectMixin<IRenderObject, IContainerParentDataMixin<IRenderObject>>;
...
}export class MultiChildRenderObjectElement

 implements IRenderObjectElement, IDiagnosticable, IBuildContext
{public constructor(widget: IMultiChildRenderObjectWidget){
flutter.widgets.multiChildRenderObjectElement(this, widget);}
    private readonly _dart_getWidget: () => IMultiChildRenderObjectWidget = undefined as any;
    private readonly _dart_getRenderObject: () => IContainerRenderObjectMixin<IRenderObject, IContainerParentDataMixin<IRenderObject>> = undefined as any;
    private readonly _dart_getChildren: () => IIterable<IElement> = undefined as any;
...
public getWidget() : IMultiChildRenderObjectWidget {
    return this._dart_getWidget();
}
public getRenderObject() : IContainerRenderObjectMixin<IRenderObject, IContainerParentDataMixin<IRenderObject>> {

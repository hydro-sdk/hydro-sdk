...
declare const flutter: {
    widgets: {
        _localizationsState: (
            this: void,
            _localizationsState: I_LocalizationsState
        ) => I_LocalizationsState;
    };
};
...
export class _LocalizationsState
    implements
        Omit<IState<ILocalizations>, "debugFillProperties">,
        IDiagnosticable
{
    public constructor() {
    ...
    private readonly _dart_resourcesFor: <T>(type: Type) => T =
        undefined as any;

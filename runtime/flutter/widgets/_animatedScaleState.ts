...
import { IAnimatedScale } from "./animatedScale";
...
widgets: {
_animatedScaleState: (this: void, _animatedScaleState: I_AnimatedScaleState) => I_AnimatedScaleState
}
};
export interface I_AnimatedScaleState
...
getHashCode: () => number;
}export class _AnimatedScaleState

 implements Omit<IImplicitlyAnimatedWidgetState<IAnimatedScale>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ISingleTickerProviderStateMixin<IAnimatedScale>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedScaleState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedScale = undefined as any;
...
public getWidget() : IAnimatedScale {

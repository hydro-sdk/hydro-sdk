...
declare const flutter: {
    widgets: {
        _animatedScaleState: (
            this: void,
            _animatedScaleState: I_AnimatedScaleState
        ) => I_AnimatedScaleState;
    };
};
...
export class _AnimatedScaleState
    implements
        Omit<
            IImplicitlyAnimatedWidgetState<IAnimatedScale>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ISingleTickerProviderStateMixin<IAnimatedScale>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {

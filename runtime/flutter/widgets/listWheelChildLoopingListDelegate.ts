...
widgets: {
listWheelChildLoopingListDelegate: (this: void, listWheelChildLoopingListDelegate: IListWheelChildLoopingListDelegate, props : {  children : IList<IWidget>,}) => IListWheelChildLoopingListDelegate
}
};

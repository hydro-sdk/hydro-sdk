...
widgets: {
iconDataProperty: (this: void, iconDataProperty: IIconDataProperty, name: string, value?: IIconData | undefined, props : {  ifNull? : string | undefined, level : DiagnosticLevel, showName : boolean, style : DiagnosticsTreeStyle,}) => IIconDataProperty
}
};
export interface IIconDataProperty
...
getHashCode: () => number;
}export class IconDataProperty

 implements IDiagnosticsProperty<IIconData>
...
public constructor(name: string, value?: IIconData | undefined, props : {  ifNull? : string | undefined, level? : DiagnosticLevel, showName? : boolean, style? : DiagnosticsTreeStyle,}){
flutter.widgets.iconDataProperty(this, name, value, {
...iconDataPropertyDefaultProps,
...props
});}
    ...
    private readonly _dart_getValue: () => IIconData | undefined = undefined as any;
...
public getValue() : IIconData | undefined {
...
const iconDataPropertyDefaultProps = {

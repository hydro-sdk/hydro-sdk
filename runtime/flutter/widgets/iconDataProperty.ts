...
declare const flutter: {
    widgets: {
        iconDataProperty: (
            this: void,
            iconDataProperty: IIconDataProperty,
            name: string,
            value?: IIconData | undefined,
            props: {
...
export class IconDataProperty implements IDiagnosticsProperty<IIconData> {
    ...
    private readonly _dart_getValue: () => IIconData | undefined =
        undefined as any;

...
import { IRenderSliverOverlapAbsorber } from "./renderSliverOverlapAbsorber";
...
widgets: {
sliverOverlapAbsorber: (this: void, sliverOverlapAbsorber: ISliverOverlapAbsorber, props : {  key? : IKey | undefined, sliver? : IWidget | undefined, handle : ISliverOverlapAbsorberHandle,}) => ISliverOverlapAbsorber
}
};
export interface ISliverOverlapAbsorber
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverOverlapAbsorber;
...
}export class SliverOverlapAbsorber
...
flutter.widgets.sliverOverlapAbsorber(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverOverlapAbsorber = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverOverlapAbsorber {

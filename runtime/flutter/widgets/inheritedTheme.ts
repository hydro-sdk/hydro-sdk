...
declare const flutter: {
    widgets: {
        inheritedTheme: (
            this: void,
            inheritedTheme: IInheritedTheme,
            props: { key?: IKey | undefined; child: IWidget }
        ) => IInheritedTheme;
        inheritedThemeCaptureAll: (
            context: IBuildContext,
            child: IWidget,
            props?: { to?: IBuildContext | undefined }
        ) => IWidget;
        inheritedThemeCapture: (props: {
            from: IBuildContext;
            to?: IBuildContext | undefined;
        }) => ICapturedThemes;
    };
};

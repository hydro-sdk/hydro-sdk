...
import { IRenderSliverFixedExtentList } from "../rendering/renderSliverFixedExtentList";
...
widgets: {
sliverFixedExtentList: (this: void, sliverFixedExtentList: ISliverFixedExtentList, props : {  key? : IKey | undefined, delegate : ISliverChildDelegate, itemExtent : number,}) => ISliverFixedExtentList
}
};
export interface ISliverFixedExtentList
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderSliverFixedExtentList;
...
}export class SliverFixedExtentList
...
public constructor( props : {  key? : IKey | undefined, delegate : ISliverChildDelegate, itemExtent : number,}){
flutter.widgets.sliverFixedExtentList(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderSliverFixedExtentList = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderSliverFixedExtentList {

...
widgets: {
_renderColoredBox: (this: void, _renderColoredBox: I_RenderColoredBox, props : {  color : IColor,}) => I_RenderColoredBox
}
};
export interface I_RenderColoredBox
...
getHashCode: () => number;
}export class _RenderColoredBox
...
flutter.widgets._renderColoredBox(this, props);}

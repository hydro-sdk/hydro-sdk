...
widgets: {
_widgetTicker: (this: void, _widgetTicker: I_WidgetTicker, onTick : (elapsed: IDuration) => void, _creator: ITickerProviderStateMixin<IStatefulWidget>, props? : {  debugLabel? : string | undefined,}) => I_WidgetTicker
}
};
...
getHashCode: () => number;
}export class _WidgetTicker

 implements ITicker
{    public readonly debugLabel: string | undefined = undefined as any;
public constructor(onTick : (elapsed: IDuration) => void, _creator: ITickerProviderStateMixin<IStatefulWidget>, props? : {  debugLabel? : string | undefined,}){
flutter.widgets._widgetTicker(this, onTick, _creator, props);}
    ...
    private readonly _dart_describeForError: (name: string) => IDiagnosticsNode = undefined as any;
    private readonly _dart_stop: ( props : {  canceled : boolean,}) => void = undefined as any;
    private readonly _dart_scheduleTick: ( props : {  rescheduling : boolean,}) => void = undefined as any;
    private readonly _dart_unscheduleTick: () => void = undefined as any;
    private readonly _dart_absorbTicker: (originalTicker: ITicker) => void = undefined as any;
    private readonly _dart_toString: ( props : {  debugIncludeStack : boolean,}) => string = undefined as any;
    private readonly _dart_getMuted: () => boolean = undefined as any;
    private readonly _dart_setMuted: (value: boolean) => void = undefined as any;
    ...
    private readonly _dart_getShouldScheduleTick: () => boolean = undefined as any;

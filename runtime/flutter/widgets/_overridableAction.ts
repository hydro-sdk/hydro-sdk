...
declare const flutter: {
    widgets: {
        _overridableAction: <T>(
            this: void,
            _overridableAction: I_OverridableAction<T>,
            props: { defaultAction: IAction<T>; lookupContext: IBuildContext }
        ) => I_OverridableAction<T>;
    };
};
export interface I_OverridableAction<T> {
...
export class _OverridableAction<T>

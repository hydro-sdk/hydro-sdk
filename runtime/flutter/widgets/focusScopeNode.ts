...
widgets: {
focusScopeNode: (this: void, focusScopeNode: IFocusScopeNode, props : {  canRequestFocus : boolean, debugLabel? : string | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal : boolean,}) => IFocusScopeNode
}
};
...
{
onKey: (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined;
onKeyEvent: (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined;
...
getHashCode: () => number;
 ...
 implements Omit<IFocusNode, "debugFillProperties" | "debugDescribeChildren" | "toStringShort" | "dispose" | "toString" | "toDiagnosticsNode">, IDiagnosticableTreeMixin, IChangeNotifier, IDiagnosticable, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toString" | "toStringShort" | "toDiagnosticsNode">, IListenable
{    public readonly onKey: (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined = undefined as any;
    public readonly onKeyEvent: (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined = undefined as any;
public constructor( props : {  canRequestFocus? : boolean, debugLabel? : string | undefined, onKey? : (node: IFocusNode, event: IRawKeyEvent) => KeyEventResult | undefined, onKeyEvent? : (node: IFocusNode, event: IKeyEvent) => KeyEventResult | undefined, skipTraversal? : boolean,}){
flutter.widgets.focusScopeNode(this, {
...focusScopeNodeDefaultProps,
...props
});}
    private readonly _dart_getNearestScope: () => IFocusScopeNode = undefined as any;
    private readonly _dart_getIsFirstFocus: () => boolean = undefined as any;
    private readonly _dart_getFocusedChild: () => IFocusNode | undefined = undefined as any;
    private readonly _dart_setFirstFocus: (scope: IFocusScopeNode) => void = undefined as any;
    private readonly _dart_autofocus: (node: IFocusNode) => void = undefined as any;

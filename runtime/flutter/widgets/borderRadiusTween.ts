...
declare const flutter: {
    widgets: {
        borderRadiusTween: (
            this: void,
            borderRadiusTween: IBorderRadiusTween,
            props?: {
...
export interface IBorderRadiusTween {
    ...
    ) => IAnimation<IBorderRadius | undefined>;
    chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IBorderRadius | undefined>;
    getHashCode: () => number;
}
export class BorderRadiusTween implements ITween<?IBorderRadius> {
    ...
    private readonly _dart_lerp: (t: number) => IBorderRadius | undefined =
        undefined as any;
    private readonly _dart_transform: (t: number) => IBorderRadius | undefined =
        undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (
        animation: IAnimation<number>
    ) => IBorderRadius | undefined = undefined as any;
    private readonly _dart_animate: (
        parent: IAnimation<number>
    ) => IAnimation<IBorderRadius | undefined> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IBorderRadius | undefined> = undefined as any;

...
widgets: {
clipboardStatusNotifier: (this: void, clipboardStatusNotifier: IClipboardStatusNotifier, props : {  value : ClipboardStatus,}) => IClipboardStatusNotifier
}
};
...
getHashCode: () => number;
 ...
 implements IValueNotifier<IClipboardStatus>, IWidgetsBindingObserver, IValueListenable<IClipboardStatus>, IListenable
...
...props
    ...
    private readonly _dart_setValue: (newValue: ClipboardStatus) => void = undefined as any;

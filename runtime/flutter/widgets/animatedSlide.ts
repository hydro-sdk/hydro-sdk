...
widgets: {
animatedSlide: (this: void, animatedSlide: IAnimatedSlide, props : {  child? : IWidget | undefined, curve : ICurve, key? : IKey | undefined, onEnd? : () => void | undefined, duration : IDuration, offset : IOffset,}) => IAnimatedSlide
}
};
...
public constructor( props : {  child? : IWidget | undefined, curve? : ICurve, key? : IKey | undefined, onEnd? : () => void | undefined, duration : IDuration, offset : IOffset,}){
flutter.widgets.animatedSlide(this, {
...animatedSlideDefaultProps,
...props
});}
    private readonly _dart_createState: () => IImplicitlyAnimatedWidgetState<IAnimatedSlide> = undefined as any;

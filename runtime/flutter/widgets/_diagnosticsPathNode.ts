...
widgets: {
_diagnosticsPathNode: (this: void, _diagnosticsPathNode: I_DiagnosticsPathNode, props : {  childIndex? : number | undefined, children : IList<IDiagnosticsNode>, node : IDiagnosticsNode,}) => I_DiagnosticsPathNode
}
};
...
public constructor( props : {  childIndex? : number | undefined, children : IList<IDiagnosticsNode>, node : IDiagnosticsNode,}){

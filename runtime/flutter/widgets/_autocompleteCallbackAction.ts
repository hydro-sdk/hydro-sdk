...
widgets: {
_autocompleteCallbackAction: <T>(this: void, _autocompleteCallbackAction: I_AutocompleteCallbackAction<T>, props : {  enabled : boolean, onInvoke : (intent: T) => Object | undefined,}) => I_AutocompleteCallbackAction<T>
}
};
export interface I_AutocompleteCallbackAction
<T>
...
getHashCode: () => number;
}export class _AutocompleteCallbackAction
<T>
 implements ICallbackAction<T>, IDiagnosticable
{    public readonly enabled: boolean = undefined as any;
    public readonly onInvoke: (intent: T) => Object | undefined = undefined as any;
public constructor( props : {  enabled? : boolean, onInvoke : (intent: T) => Object | undefined,}){
flutter.widgets._autocompleteCallbackAction(this, {
..._autocompleteCallbackActionDefaultProps,
...props
});}
    private readonly _dart_isEnabled: (intent: any) => boolean = undefined as any;
    private readonly _dart_consumesKey: (intent: any) => boolean = undefined as any;

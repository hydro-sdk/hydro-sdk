...
import { IRenderPadding } from "../rendering/renderPadding";
...
widgets: {
padding: (this: void, padding: IPadding, props : {  child? : IWidget | undefined, key? : IKey | undefined, padding : IEdgeInsetsGeometry,}) => IPadding
}
};
...
key: IKey | undefined;
createRenderObject: (context: IBuildContext) => IRenderPadding;
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, padding : IEdgeInsetsGeometry,}){
flutter.widgets.padding(this, props);}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderPadding = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderPadding {

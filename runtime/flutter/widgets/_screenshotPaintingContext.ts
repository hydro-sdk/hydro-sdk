...
widgets: {
_screenshotPaintingContext: (this: void, _screenshotPaintingContext: I_ScreenshotPaintingContext, props : {  containerLayer : IContainerLayer, estimatedBounds : IRect, screenshotData : I_ScreenshotData,}) => I_ScreenshotPaintingContext;
_screenshotPaintingContextToImage: (renderObject: IRenderObject, renderBounds: IRect, props : {  debugPaint : boolean, pixelRatio : number,}) => IFuture<IImage>
}
};
...
getHashCode: () => number;
}export class _ScreenshotPaintingContext

 implements IPaintingContext
{    public readonly estimatedBounds: IRect = undefined as any;
public constructor( props : {  containerLayer : IContainerLayer, estimatedBounds : IRect, screenshotData : I_ScreenshotData,}){
flutter.widgets._screenshotPaintingContext(this, props);}
public static toImage(renderObject: IRenderObject, renderBounds: IRect, props : {  debugPaint? : boolean, pixelRatio? : number,}) : IFuture<IImage>{
return flutter.widgets._screenshotPaintingContextToImage(renderObject, renderBounds, {
...toImageDefaultProps,
...props
});

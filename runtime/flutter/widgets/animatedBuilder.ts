...
widgets: {
animatedBuilder: (this: void, animatedBuilder: IAnimatedBuilder, props : {  child? : IWidget | undefined, key? : IKey | undefined, animation : IListenable, builder : (context: IBuildContext, child?: IWidget | undefined) => IWidget,}) => IAnimatedBuilder
}
};
export interface IAnimatedBuilder
...
public constructor( props : {  child? : IWidget | undefined, key? : IKey | undefined, animation : IListenable, builder : (context: IBuildContext, child?: IWidget | undefined) => IWidget,}){
flutter.widgets.animatedBuilder(this, props);}

...
declare const flutter: {
    widgets: {
        spacer: (
            this: void,
            spacer: ISpacer,
            props: { flex: number; key?: IKey | undefined }
        ) => ISpacer;
    };
};
...
export class Spacer implements IStatelessWidget, IDiagnosticable {
    public readonly flex: number = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
    public constructor(props: { flex?: number; key?: IKey | undefined }) {
        flutter.widgets.spacer(this, {
            ...spacerDefaultProps,
            ...props,
        });
    }

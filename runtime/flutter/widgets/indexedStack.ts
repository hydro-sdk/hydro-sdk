...
widgets: {
indexedStack: (this: void, indexedStack: IIndexedStack, props : {  alignment : IAlignmentGeometry, children : IList<IWidget>, index? : number | undefined, key? : IKey | undefined, sizing : StackFit, textDirection? : TextDirection | undefined,}) => IIndexedStack
}
};
...
}export class IndexedStack

 implements IStack, IDiagnosticable
...
public constructor( props : {  alignment? : IAlignmentGeometry, children? : IList<IWidget>, index? : number | undefined, key? : IKey | undefined, sizing? : StackFit, textDirection? : TextDirection | undefined,}){
flutter.widgets.indexedStack(this, {
...indexedStackDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderIndexedStack = undefined as any;

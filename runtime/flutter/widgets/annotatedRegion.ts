...
import { IRenderAnnotatedRegion } from "../rendering/renderAnnotatedRegion";
...
widgets: {
annotatedRegion: <T>(this: void, annotatedRegion: IAnnotatedRegion<T>, props : {  key? : IKey | undefined, sized : boolean, child : IWidget, value : T,}) => IAnnotatedRegion<T>
}
};
export interface IAnnotatedRegion
<T>
...
{    public readonly sized: boolean = undefined as any;
    public readonly child: IWidget | undefined = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, sized? : boolean, child : IWidget, value : T,}){
flutter.widgets.annotatedRegion(this, {
...annotatedRegionDefaultProps,
...props
});}
...
const annotatedRegionDefaultProps = {
    sized: true,
};

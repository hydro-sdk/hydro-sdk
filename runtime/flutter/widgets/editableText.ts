...
widgets: {
editableText: (this: void, editableText: IEditableText, props : {  autocorrect : boolean, autocorrectionTextRectColor? : IColor | undefined, autofillClient? : IAutofillClient | undefined, autofillHints? : IIterable<string> | undefined, autofocus : boolean, clipBehavior : Clip, cursorHeight? : number | undefined, cursorOffset? : IOffset | undefined, cursorOpacityAnimates : boolean, cursorRadius? : IRadius | undefined, cursorWidth : number, dragStartBehavior : DragStartBehavior, enableIMEPersonalizedLearning : boolean, enableInteractiveSelection : boolean, enableSuggestions : boolean, expands : boolean, forceLine : boolean, inputFormatters? : IList<ITextInputFormatter> | undefined, key? : IKey | undefined, keyboardAppearance : Brightness, keyboardType? : ITextInputType | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, minLines? : number | undefined, mouseCursor? : IMouseCursor | undefined, obscureText : boolean, obscuringCharacter : string, onAppPrivateCommand? : (__: {[index: string]: any}) => void | undefined, onChanged? : (value: string) => void | undefined, onEditingComplete? : () => void | undefined, onSelectionChanged? : (selection: ITextSelection, cause?: SelectionChangedCause | undefined) => void | undefined, onSelectionHandleTapped? : () => void | undefined, onSubmitted? : (value: string) => void | undefined, paintCursorAboveText : boolean, readOnly : boolean, rendererIgnoresPointer : boolean, restorationId? : string | undefined, scrollBehavior? : IScrollBehavior | undefined, scrollController? : IScrollController | undefined, scrollPadding : IEdgeInsets, scrollPhysics? : IScrollPhysics | undefined, selectionColor? : IColor | undefined, selectionControls? : ITextSelectionControls | undefined, selectionHeightStyle : BoxHeightStyle, selectionWidthStyle : BoxWidthStyle, showCursor? : boolean | undefined, showSelectionHandles : boolean, smartDashesType? : SmartDashesType | undefined, smartQuotesType? : SmartQuotesType | undefined, strutStyle? : IStrutStyle | undefined, textAlign : TextAlign, textCapitalization : TextCapitalization, textDirection? : TextDirection | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, textInputAction? : TextInputAction | undefined, textScaleFactor? : number | undefined, textWidthBasis : TextWidthBasis, toolbarOptions : IToolbarOptions, backgroundCursorColor : IColor, controller : ITextEditingController, cursorColor : IColor, focusNode : IFocusNode, style : ITextStyle,}) => IEditableText
}
};
...
{    public readonly controller: ITextEditingController = undefined as any;
    ...
    public readonly autocorrectionTextRectColor: IColor | undefined = undefined as any;
    ...
    public readonly textInputAction: TextInputAction | undefined = undefined as any;
    public readonly inputFormatters: IList<ITextInputFormatter> | undefined = undefined as any;
    ...
    public readonly scrollController: IScrollController | undefined = undefined as any;
    public readonly scrollPhysics: IScrollPhysics | undefined = undefined as any;
    public readonly autofillHints: IIterable<string> | undefined = undefined as any;
    public readonly autofillClient: IAutofillClient | undefined = undefined as any;
...
public constructor( props : {  autocorrect? : boolean, autocorrectionTextRectColor? : IColor | undefined, autofillClient? : IAutofillClient | undefined, autofillHints? : IIterable<string> | undefined, autofocus? : boolean, clipBehavior? : Clip, cursorHeight? : number | undefined, cursorOffset? : IOffset | undefined, cursorOpacityAnimates? : boolean, cursorRadius? : IRadius | undefined, cursorWidth? : number, dragStartBehavior? : DragStartBehavior, enableIMEPersonalizedLearning? : boolean, enableInteractiveSelection? : boolean, enableSuggestions? : boolean, expands? : boolean, forceLine? : boolean, inputFormatters? : IList<ITextInputFormatter> | undefined, key? : IKey | undefined, keyboardAppearance? : Brightness, keyboardType? : ITextInputType | undefined, locale? : ILocale | undefined, maxLines? : number | undefined, minLines? : number | undefined, mouseCursor? : IMouseCursor | undefined, obscureText? : boolean, obscuringCharacter? : string, onAppPrivateCommand? : (__: {[index: string]: any}) => void | undefined, onChanged? : (value: string) => void | undefined, onEditingComplete? : () => void | undefined, onSelectionChanged? : (selection: ITextSelection, cause?: SelectionChangedCause | undefined) => void | undefined, onSelectionHandleTapped? : () => void | undefined, onSubmitted? : (value: string) => void | undefined, paintCursorAboveText? : boolean, readOnly? : boolean, rendererIgnoresPointer? : boolean, restorationId? : string | undefined, scrollBehavior? : IScrollBehavior | undefined, scrollController? : IScrollController | undefined, scrollPadding? : IEdgeInsets, scrollPhysics? : IScrollPhysics | undefined, selectionColor? : IColor | undefined, selectionControls? : ITextSelectionControls | undefined, selectionHeightStyle? : BoxHeightStyle, selectionWidthStyle? : BoxWidthStyle, showCursor? : boolean | undefined, showSelectionHandles? : boolean, smartDashesType? : SmartDashesType | undefined, smartQuotesType? : SmartQuotesType | undefined, strutStyle? : IStrutStyle | undefined, textAlign? : TextAlign, textCapitalization? : TextCapitalization, textDirection? : TextDirection | undefined, textHeightBehavior? : ITextHeightBehavior | undefined, textInputAction? : TextInputAction | undefined, textScaleFactor? : number | undefined, textWidthBasis? : TextWidthBasis, toolbarOptions? : IToolbarOptions, backgroundCursorColor : IColor, controller : ITextEditingController, cursorColor : IColor, focusNode : IFocusNode, style : ITextStyle,}){
...
...props
    ...
    private readonly _dart_createState: () => IEditableTextState = undefined as any;
...
const editableTextDefaultProps = {
    ...
    toolbarOptions: new ToolbarOptions({ copy: true, cut: true, paste: true, selectAll: true }),
};

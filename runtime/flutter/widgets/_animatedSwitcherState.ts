...
declare const flutter: {
    widgets: {
        _animatedSwitcherState: (
            this: void,
            _animatedSwitcherState: I_AnimatedSwitcherState
        ) => I_AnimatedSwitcherState;
    };
};
...
export class _AnimatedSwitcherState
    implements
        Omit<
            IState<IAnimatedSwitcher>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IAnimatedSwitcher>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
    ...
    private readonly _dart_getWidget: () => IAnimatedSwitcher =
        undefined as any;

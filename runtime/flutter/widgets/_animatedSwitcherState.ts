...
import { IAnimatedSwitcher } from "./animatedSwitcher";
...
widgets: {
_animatedSwitcherState: (this: void, _animatedSwitcherState: I_AnimatedSwitcherState) => I_AnimatedSwitcherState
}
};
export interface I_AnimatedSwitcherState
...
getHashCode: () => number;
}export class _AnimatedSwitcherState

 implements Omit<IState<IAnimatedSwitcher>, "dispose" | "didChangeDependencies" | "debugFillProperties">, ITickerProviderStateMixin<IAnimatedSwitcher>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedSwitcherState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedSwitcher = undefined as any;
...
public getWidget() : IAnimatedSwitcher {

...
declare const flutter: {
    widgets: {
        _nestedInnerBallisticScrollActivity: (
            this: void,
            _nestedInnerBallisticScrollActivity: I_NestedInnerBallisticScrollActivity,
            coordinator: I_NestedScrollCoordinator,
            position: I_NestedScrollPosition,
            simulation: ISimulation,
            vsync: ITickerProvider
        ) => I_NestedInnerBallisticScrollActivity;
    };
};
    ...
    implements IBallisticScrollActivity
{
    ...
    public constructor(
        ...
        flutter.widgets._nestedInnerBallisticScrollActivity(
            this,
            coordinator,
            position,
            simulation,
    ...
    private readonly _dart_getDelegate: () => I_NestedScrollPosition =
        undefined as any;
    ...
    private readonly _dart_applyMoveTo: (value: number) => boolean =
        undefined as any;

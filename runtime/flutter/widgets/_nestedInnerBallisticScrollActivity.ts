...
widgets: {
_nestedInnerBallisticScrollActivity: (this: void, _nestedInnerBallisticScrollActivity: I_NestedInnerBallisticScrollActivity, coordinator: I_NestedScrollCoordinator, position: I_NestedScrollPosition, simulation: ISimulation, vsync: ITickerProvider) => I_NestedInnerBallisticScrollActivity
}
};
export interface I_NestedInnerBallisticScrollActivity
...
getHashCode: () => number;
}export class _NestedInnerBallisticScrollActivity

 implements IBallisticScrollActivity
{    public readonly coordinator: I_NestedScrollCoordinator = undefined as any;
public constructor(coordinator: I_NestedScrollCoordinator, position: I_NestedScrollPosition, simulation: ISimulation, vsync: ITickerProvider){
flutter.widgets._nestedInnerBallisticScrollActivity(this, coordinator, position, simulation, vsync);}

...
declare const flutter: {
    widgets: {
        _animatedPaddingState: (
            this: void,
            _animatedPaddingState: I_AnimatedPaddingState
        ) => I_AnimatedPaddingState;
    };
};
...
export class _AnimatedPaddingState
    implements
        IAnimatedWidgetBaseState<IAnimatedPadding>,
        ISingleTickerProviderStateMixin<IAnimatedPadding>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {

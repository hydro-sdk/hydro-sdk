...
import { IAnimatedPadding } from "./animatedPadding";
...
widgets: {
_animatedPaddingState: (this: void, _animatedPaddingState: I_AnimatedPaddingState) => I_AnimatedPaddingState
}
};
export interface I_AnimatedPaddingState
...
getHashCode: () => number;
}export class _AnimatedPaddingState

 implements IAnimatedWidgetBaseState<IAnimatedPadding>, ISingleTickerProviderStateMixin<IAnimatedPadding>, IDiagnosticable, ITickerProvider
{public constructor(){
flutter.widgets._animatedPaddingState(this);}
    ...
    private readonly _dart_getWidget: () => IAnimatedPadding = undefined as any;
...
public getWidget() : IAnimatedPadding {

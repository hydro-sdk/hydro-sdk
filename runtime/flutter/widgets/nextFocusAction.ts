...
declare const flutter: {
    widgets: {
        nextFocusAction: (
            this: void,
            nextFocusAction: INextFocusAction
        ) => INextFocusAction;
    };
};
    ...
    implements Omit<IAction<INextFocusIntent>>, IDiagnosticable
{
    ...
    private readonly _dart_invoke: (intent: INextFocusIntent) => void =
        undefined as any;
    private readonly _dart_isEnabled: (intent: INextFocusIntent) => boolean =
        undefined as any;
    private readonly _dart_consumesKey: (intent: INextFocusIntent) => boolean =
        undefined as any;

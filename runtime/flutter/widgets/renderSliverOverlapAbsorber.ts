...
widgets: {
renderSliverOverlapAbsorber: (this: void, renderSliverOverlapAbsorber: IRenderSliverOverlapAbsorber, props : {  sliver? : IRenderSliver | undefined, handle : ISliverOverlapAbsorberHandle,}) => IRenderSliverOverlapAbsorber
}
};
export interface IRenderSliverOverlapAbsorber
...
getHashCode: () => number;
}export class RenderSliverOverlapAbsorber
...
public constructor( props : {  sliver? : IRenderSliver | undefined, handle : ISliverOverlapAbsorberHandle,}){
flutter.widgets.renderSliverOverlapAbsorber(this, props);}

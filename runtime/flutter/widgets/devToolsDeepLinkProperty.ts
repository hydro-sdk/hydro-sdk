...
widgets: {
devToolsDeepLinkProperty: (this: void, devToolsDeepLinkProperty: IDevToolsDeepLinkProperty, description: string, url: string) => IDevToolsDeepLinkProperty
}
};
export interface IDevToolsDeepLinkProperty
...
getHashCode: () => number;
}export class DevToolsDeepLinkProperty
...
flutter.widgets.devToolsDeepLinkProperty(this, description, url);}

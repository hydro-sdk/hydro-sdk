...
declare const flutter: {
    widgets: {
        devToolsDeepLinkProperty: (
            this: void,
            devToolsDeepLinkProperty: IDevToolsDeepLinkProperty,
            description: string,
            url: string
        ) => IDevToolsDeepLinkProperty;
    };
};
...
export class DevToolsDeepLinkProperty implements IDiagnosticsProperty<string> {

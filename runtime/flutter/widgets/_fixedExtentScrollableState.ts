...
widgets: {
_fixedExtentScrollableState: (this: void, _fixedExtentScrollableState: I_FixedExtentScrollableState) => I_FixedExtentScrollableState
}
};
...
getHashCode: () => number;
 ...
 implements Omit<IScrollableState, "didChangeDependencies" | "dispose" | "debugFillProperties" | "restoreState" | "didUpdateWidget" | "restorationId">, ITickerProviderStateMixin<IScrollable>, IRestorationMixin<IScrollable>, IDiagnosticable, IScrollContext, ITickerProvider
{public constructor(){

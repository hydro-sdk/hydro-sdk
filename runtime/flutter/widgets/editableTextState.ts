...
widgets: {
editableTextState: (this: void, editableTextState: IEditableTextState) => IEditableTextState
}
};
...
setSelection: (nextSelection: ITextSelection, cause: SelectionChangedCause) => void;
...
performPrivateCommand: (action: string, data: {[index: string]: any}) => void;
...
userUpdateTextEditingValue: (value: ITextEditingValue, cause?: SelectionChangedCause | undefined) => void;
...
deleteByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void;
deleteByLine: (cause: SelectionChangedCause) => void;
deleteForward: (cause: SelectionChangedCause) => void;
deleteForwardByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void;
...
extendSelectionLeftByWord: (cause: SelectionChangedCause, includeWhitespace: boolean, stopAtReversal: boolean) => void;
extendSelectionRightByWord: (cause: SelectionChangedCause, includeWhitespace: boolean, stopAtReversal: boolean) => void;
...
moveSelectionLeftByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void;
moveSelectionRight: (cause: SelectionChangedCause) => void;
moveSelectionRightByLine: (cause: SelectionChangedCause) => void;
moveSelectionRightByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void;
...
getHashCode: () => number;
 ...
 implements Omit<IState<IEditableText>, "initState" | "deactivate" | "build" | "toString" | "dispose" | "didChangeDependencies" | "debugFillProperties">, IAutomaticKeepAliveClientMixin<IEditableText>, IWidgetsBindingObserver, ITickerProviderStateMixin<IEditableText>, ITextSelectionDelegate, ITextEditingActionTarget, IDiagnosticable, ITextInputClient, IAutofillClient, ITickerProvider
{    public static _fadeDuration = new Duration({ milliseconds: 250 });
    public static _floatingCursorResetTime = new Duration({ milliseconds: 125 });
...
flutter.widgets.editableTextState(this);}
    private readonly _dart_getCurrentAutofillScope: () => IAutofillScope | undefined = undefined as any;
    ...
    private readonly _dart_getSelectAllEnabled: () => boolean = undefined as any;
    private readonly _dart_getTextLayoutMetrics: () => ITextLayoutMetrics = undefined as any;
    ...
    private readonly _dart_setSelection: (nextSelection: ITextSelection, cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_setTextEditingValue: (newValue: ITextEditingValue, cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_copySelection: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_cutSelection: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_pasteText: (cause: SelectionChangedCause) => IFuture<void> = undefined as any;
    private readonly _dart_selectAll: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_initState: () => void = undefined as any;
    private readonly _dart_didChangeDependencies: () => void = undefined as any;
    private readonly _dart_didUpdateWidget: (oldWidget: any) => void = undefined as any;
    private readonly _dart_dispose: () => void = undefined as any;
    private readonly _dart_getCurrentTextEditingValue: () => ITextEditingValue = undefined as any;
    private readonly _dart_updateEditingValue: (value: ITextEditingValue) => void = undefined as any;
    private readonly _dart_performAction: (action: TextInputAction) => void = undefined as any;
    private readonly _dart_performPrivateCommand: (action: string, data: {[index: string]: any}) => void = undefined as any;
    private readonly _dart_updateFloatingCursor: (point: IRawFloatingCursorPoint) => void = undefined as any;
    ...
    private readonly _dart_getRenderEditable: () => IRenderEditable = undefined as any;
    private readonly _dart_getTextEditingValue: () => ITextEditingValue = undefined as any;
    private readonly _dart_userUpdateTextEditingValue: (value: ITextEditingValue, cause?: SelectionChangedCause | undefined) => void = undefined as any;
    private readonly _dart_bringIntoView: (position: ITextPosition) => void = undefined as any;
    private readonly _dart_showToolbar: () => boolean = undefined as any;
    private readonly _dart_hideToolbar: (hideHandles: boolean) => void = undefined as any;
    private readonly _dart_toggleToolbar: () => void = undefined as any;
    private readonly _dart_getAutofillId: () => string = undefined as any;
    private readonly _dart_getTextInputConfiguration: () => ITextInputConfiguration = undefined as any;
    private readonly _dart_autofill: (value: ITextEditingValue) => void = undefined as any;
    private readonly _dart_showAutocorrectionPromptRect: (start: number, end: number) => void = undefined as any;
    ...
    private readonly _dart_setTextEditingValue: (value: ITextEditingValue) => void = undefined as any;
    private readonly _dart_delete: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_deleteByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void = undefined as any;
    private readonly _dart_deleteByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_deleteForward: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_deleteForwardByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void = undefined as any;
    private readonly _dart_deleteForwardByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_deleteToEnd: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_deleteToStart: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_expandSelectionToEnd: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_expandSelectionToStart: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_expandSelectionLeftByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_expandSelectionRightByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionDown: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionLeft: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionLeftByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionRight: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionRightByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_extendSelectionLeftByWord: (cause: SelectionChangedCause, includeWhitespace: boolean, stopAtReversal: boolean) => void = undefined as any;
    private readonly _dart_extendSelectionRightByWord: (cause: SelectionChangedCause, includeWhitespace: boolean, stopAtReversal: boolean) => void = undefined as any;
    private readonly _dart_extendSelectionUp: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionLeftByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionDown: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionLeft: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionLeftByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void = undefined as any;
    private readonly _dart_moveSelectionRight: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionRightByLine: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionRightByWord: (cause: SelectionChangedCause, includeWhitespace: boolean) => void = undefined as any;
    private readonly _dart_moveSelectionToEnd: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionToStart: (cause: SelectionChangedCause) => void = undefined as any;
    private readonly _dart_moveSelectionUp: (cause: SelectionChangedCause) => void = undefined as any;
...
public setSelection(nextSelection: ITextSelection, cause: SelectionChangedCause) : void {
    return this._dart_setSelection(nextSelection, cause);
}
public setTextEditingValue(newValue: ITextEditingValue, cause: SelectionChangedCause) : void {
...
public performPrivateCommand(action: string, data: {[index: string]: any}) : void {
...
public userUpdateTextEditingValue(value: ITextEditingValue, cause?: SelectionChangedCause | undefined) : void {
...
public deleteByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true) : void {
...
public deleteForwardByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true) : void {
...
public extendSelectionLeftByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true, stopAtReversal: boolean = false) : void {
    return this._dart_extendSelectionLeftByWord(cause, includeWhitespace, stopAtReversal);
}
public extendSelectionRightByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true, stopAtReversal: boolean = false) : void {
    return this._dart_extendSelectionRightByWord(cause, includeWhitespace, stopAtReversal);
}
...
public moveSelectionLeftByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true) : void {
...
public moveSelectionRightByWord(cause: SelectionChangedCause, includeWhitespace: boolean = true) : void {

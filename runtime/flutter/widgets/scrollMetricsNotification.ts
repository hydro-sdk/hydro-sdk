...
widgets: {
scrollMetricsNotification: (this: void, scrollMetricsNotification: IScrollMetricsNotification, props : {  context : IBuildContext, metrics : IScrollMetrics,}) => IScrollMetricsNotification
}
};
...
public constructor( props : {  context : IBuildContext, metrics : IScrollMetrics,}){

...
declare const flutter: {
    widgets: {
        inheritedNotifier: <T>(
            this: void,
            inheritedNotifier: IInheritedNotifier<T>,
            props: {
                key?: IKey | undefined;
                notifier?: T | undefined;
                child: IWidget;
            }
        ) => IInheritedNotifier<T>;
    };
};
export interface IInheritedNotifier<T> {
    child: IWidget;
    key: IKey | undefined;
...
export class InheritedNotifier<T> implements IInheritedWidget, IDiagnosticable {

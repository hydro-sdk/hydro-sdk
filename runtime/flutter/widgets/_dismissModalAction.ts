...
declare const flutter: {
    widgets: {
        _dismissModalAction: (
            this: void,
            _dismissModalAction: I_DismissModalAction,
            context: IBuildContext
        ) => I_DismissModalAction;
    };
};
...
export class _DismissModalAction implements IDismissAction, IDiagnosticable {
    ...
    private readonly _dart_isEnabled: (intent: IDismissIntent) => boolean =
        undefined as any;
    private readonly _dart_invoke: (intent: IDismissIntent) => Object =
        undefined as any;

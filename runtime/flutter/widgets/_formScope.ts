...
widgets: {
_formScope: (this: void, _formScope: I_FormScope, props : {  key? : IKey | undefined, child : IWidget, formState : IFormState, generation : number,}) => I_FormScope
}
};
export interface I_FormScope
...
}export class _FormScope

 implements IInheritedWidget, IDiagnosticable
{    public readonly child: IWidget = undefined as any;
    public readonly key: IKey | undefined = undefined as any;
public constructor( props : {  key? : IKey | undefined, child : IWidget, formState : IFormState, generation : number,}){
flutter.widgets._formScope(this, props);}
    private readonly _dart_getForm: () => IForm = undefined as any;

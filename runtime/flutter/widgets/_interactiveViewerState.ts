...
declare const flutter: {
    widgets: {
        _interactiveViewerState: (
            this: void,
            _interactiveViewerState: I_InteractiveViewerState
        ) => I_InteractiveViewerState;
    };
};
...
export class _InteractiveViewerState
    implements
        Omit<
            IState<IInteractiveViewer>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<IInteractiveViewer>,
        IDiagnosticable,
        ITickerProvider
{
    ...
    private readonly _dart_getWidget: () => IInteractiveViewer =
        undefined as any;

...
declare const flutter: {
    widgets: {
        _htmlElementViewController: (
            this: void,
            _htmlElementViewController: I_HtmlElementViewController,
            viewId: number,
            viewType: string
        ) => I_HtmlElementViewController;
    };
};
...
export class _HtmlElementViewController implements IPlatformViewController {

...
declare const flutter: {
    widgets: {
        heroControllerScope: (
            this: void,
            heroControllerScope: IHeroControllerScope,
            props: {
                key?: IKey | undefined;
                child: IWidget;
                controller: IHeroController;
            }
        ) => IHeroControllerScope;
        heroControllerScopeOf: (
            context: IBuildContext
        ) => IHeroController | undefined;
    };
};
...
export class HeroControllerScope implements IInheritedWidget, IDiagnosticable {

...
widgets: {
navigationToolbar: (this: void, navigationToolbar: INavigationToolbar, props : {  centerMiddle : boolean, key? : IKey | undefined, leading? : IWidget | undefined, middle? : IWidget | undefined, middleSpacing : number, trailing? : IWidget | undefined,}) => INavigationToolbar
}
};
...
{    public static kMiddleSpacing = 16.0;
...
public constructor( props : {  centerMiddle? : boolean, key? : IKey | undefined, leading? : IWidget | undefined, middle? : IWidget | undefined, middleSpacing? : number, trailing? : IWidget | undefined,}){
flutter.widgets.navigationToolbar(this, {
...navigationToolbarDefaultProps,
...props
});}
...
const navigationToolbarDefaultProps = {
    centerMiddle: true,

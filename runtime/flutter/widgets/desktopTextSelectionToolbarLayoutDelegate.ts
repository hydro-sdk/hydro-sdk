...
widgets: {
desktopTextSelectionToolbarLayoutDelegate: (this: void, desktopTextSelectionToolbarLayoutDelegate: IDesktopTextSelectionToolbarLayoutDelegate, props : {  anchor : IOffset,}) => IDesktopTextSelectionToolbarLayoutDelegate
}
};

...
declare const flutter: {
    widgets: {
        inspectorSelection: (
            this: void,
            inspectorSelection: IInspectorSelection
        ) => IInspectorSelection;
    };
};
...
export class InspectorSelection {
    ...
    private readonly _dart_getCandidates: () => IList<IRenderObject> =
        undefined as any;
    private readonly _dart_setCandidates: (
        value: IList<IRenderObject>
    ...
    private readonly _dart_getCurrent: () => IRenderObject | undefined =
        undefined as any;
    private readonly _dart_setCurrent: (
        value?: IRenderObject | undefined
    ) => void = undefined as any;
    private readonly _dart_getCurrentElement: () => IElement | undefined =
        undefined as any;
    private readonly _dart_setCurrentElement: (

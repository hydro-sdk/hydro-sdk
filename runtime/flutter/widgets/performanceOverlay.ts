...
widgets: {
performanceOverlay: (this: void, performanceOverlay: IPerformanceOverlay, props : {  checkerboardOffscreenLayers : boolean, checkerboardRasterCacheImages : boolean, key? : IKey | undefined, optionsMask : number, rasterizerThreshold : number,}) => IPerformanceOverlay
}
};
...
public constructor( props : {  checkerboardOffscreenLayers? : boolean, checkerboardRasterCacheImages? : boolean, key? : IKey | undefined, optionsMask? : number, rasterizerThreshold? : number,}){
flutter.widgets.performanceOverlay(this, {
...performanceOverlayDefaultProps,
...props
});}
    private readonly _dart_createRenderObject: (context: IBuildContext) => IRenderPerformanceOverlay = undefined as any;
...
public createRenderObject(context: IBuildContext) : IRenderPerformanceOverlay {

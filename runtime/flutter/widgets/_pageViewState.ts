...
import { IPageView } from "./pageView";
...
widgets: {
_pageViewState: (this: void, _pageViewState: I_PageViewState) => I_PageViewState
}
};
export interface I_PageViewState
...
getHashCode: () => number;
}export class _PageViewState

 implements Omit<IState<IPageView>, "debugFillProperties">, IDiagnosticable
{public constructor(){
flutter.widgets._pageViewState(this);}
    ...
    private readonly _dart_getWidget: () => IPageView = undefined as any;

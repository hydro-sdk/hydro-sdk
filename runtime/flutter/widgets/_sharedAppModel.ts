...
widgets: {
_sharedAppModel: (this: void, _sharedAppModel: I_SharedAppModel, props : {  key? : IKey | undefined, child : IWidget, sharedAppDataState : I_SharedAppDataState,}) => I_SharedAppModel
}
};
...
public constructor( props : {  key? : IKey | undefined, child : IWidget, sharedAppDataState : I_SharedAppDataState,}){
flutter.widgets._sharedAppModel(this, props);}
    private readonly _dart_updateShouldNotify: (old: any) => boolean = undefined as any;
    private readonly _dart_updateShouldNotifyDependent: (old: any, keys: ISet<Object>) => boolean = undefined as any;
    private readonly _dart_createElement: () => IInheritedModelElement<Object> = undefined as any;

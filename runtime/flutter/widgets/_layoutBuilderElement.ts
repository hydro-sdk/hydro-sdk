...
declare const flutter: {
    widgets: {
        _layoutBuilderElement: <ConstraintType>(
            this: void,
            _layoutBuilderElement: I_LayoutBuilderElement<ConstraintType>,
            widget: IConstrainedLayoutBuilder<ConstraintType>
        ) => I_LayoutBuilderElement<ConstraintType>;
    };
};
export interface I_LayoutBuilderElement<ConstraintType> {
    getWidget: () => IConstrainedLayoutBuilder<ConstraintType>;
    getRenderObject: () => IRenderConstrainedLayoutBuilder<
        ConstraintType,
        IRenderObject
    >;
...
export class _LayoutBuilderElement<ConstraintType>
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    ...
    private readonly _dart_getWidget: () => IConstrainedLayoutBuilder<ConstraintType> =
        undefined as any;
    private readonly _dart_getRenderObject: () => IRenderConstrainedLayoutBuilder<
        ConstraintType,
        IRenderObject
    > = undefined as any;
    ...
    public getRenderObject(): IRenderConstrainedLayoutBuilder<
        ConstraintType,
        IRenderObject
    > {

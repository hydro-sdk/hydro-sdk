...
declare const flutter: {
    widgets: {
        sliverAnimatedOpacity: (
            this: void,
            sliverAnimatedOpacity: ISliverAnimatedOpacity,
            props: {
    ...
    implements IImplicitlyAnimatedWidget, IDiagnosticable
{
    ...
    private readonly _dart_createState: () => IImplicitlyAnimatedWidgetState<ISliverAnimatedOpacity> =
        undefined as any;

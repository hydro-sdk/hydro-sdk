...
widgets: {
_proxyLayer: (this: void, _proxyLayer: I_ProxyLayer, _layer: ILayer) => I_ProxyLayer
}
};
export interface I_ProxyLayer
...
public constructor(_layer: ILayer){
flutter.widgets._proxyLayer(this, _layer);}

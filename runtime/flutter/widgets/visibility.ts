...
widgets: {
visibility: (this: void, visibility: IVisibility, props : {  key? : IKey | undefined, maintainAnimation : boolean, maintainInteractivity : boolean, maintainSemantics : boolean, maintainSize : boolean, maintainState : boolean, replacement : IWidget, visible : boolean, child : IWidget,}) => IVisibility
}
};
...
public constructor( props : {  key? : IKey | undefined, maintainAnimation? : boolean, maintainInteractivity? : boolean, maintainSemantics? : boolean, maintainSize? : boolean, maintainState? : boolean, replacement? : IWidget, visible? : boolean, child : IWidget,}){

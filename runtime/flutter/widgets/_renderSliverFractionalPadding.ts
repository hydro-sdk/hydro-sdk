...
import { IRenderSliverEdgeInsetsPadding } from "../rendering/renderSliverEdgeInsetsPadding";
...
widgets: {
_renderSliverFractionalPadding: (this: void, _renderSliverFractionalPadding: I_RenderSliverFractionalPadding, props : {  viewportFraction : number,}) => I_RenderSliverFractionalPadding
}
};
export interface I_RenderSliverFractionalPadding
...
setViewportFraction: (newValue: number) => void;
getResolvedPadding: () => IEdgeInsets | undefined;
performLayout: () => void;
...
getBeforePadding: () => number;
getAfterPadding: () => number;
getMainAxisPadding: () => number;
getCrossAxisPadding: () => number;
...
getHashCode: () => number;
}export class _RenderSliverFractionalPadding

 implements Omit<IRenderSliverEdgeInsetsPadding, "attach" | "detach" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toString" | "toStringDeep" | "toStringShallow" | "toDiagnosticsNode">, IRenderObjectWithChildMixin<IRenderSliver>, IDiagnosticableTreeMixin, IDiagnosticable, IHitTestTarget, Omit<IDiagnosticableTree, "debugDescribeChildren" | "toStringShallow" | "toStringDeep" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
public constructor( props : {  viewportFraction? : number,}){
flutter.widgets._renderSliverFractionalPadding(this, {
..._renderSliverFractionalPaddingDefaultProps,
...props
});}
    private readonly _dart_getViewportFraction: () => number = undefined as any;
    private readonly _dart_setViewportFraction: (newValue: number) => void = undefined as any;
    private readonly _dart_getResolvedPadding: () => IEdgeInsets | undefined = undefined as any;
    ...
    private readonly _dart_getBeforePadding: () => number = undefined as any;
    private readonly _dart_getAfterPadding: () => number = undefined as any;
    private readonly _dart_getMainAxisPadding: () => number = undefined as any;
    private readonly _dart_getCrossAxisPadding: () => number = undefined as any;
...
public setViewportFraction(newValue: number) : void {
    return this._dart_setViewportFraction(newValue);
}
public getResolvedPadding() : IEdgeInsets | undefined {
    return this._dart_getResolvedPadding();
}
...
public getBeforePadding() : number {
    return this._dart_getBeforePadding();
}
public getAfterPadding() : number {
    return this._dart_getAfterPadding();
}
public getMainAxisPadding() : number {
    return this._dart_getMainAxisPadding();
}
public getCrossAxisPadding() : number {
    return this._dart_getCrossAxisPadding();
}
...
const _renderSliverFractionalPaddingDefaultProps = {
    viewportFraction: 0,
};

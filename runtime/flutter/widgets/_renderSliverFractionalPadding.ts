...
declare const flutter: {
    widgets: {
        _renderSliverFractionalPadding: (
            this: void,
            _renderSliverFractionalPadding: I_RenderSliverFractionalPadding,
            props: { viewportFraction: number }
        ) => I_RenderSliverFractionalPadding;
    };
};
...
export class _RenderSliverFractionalPadding
    implements
        Omit<
            IRenderSliverEdgeInsetsPadding,
            | "attach"
            | "detach"
            ...
            | "toDiagnosticsNode"
        >,
        IRenderObjectWithChildMixin<IRenderSliver>,
        ...
        >
{
    ...
    private readonly _dart_setViewportFraction: (newValue: number) => void =
        undefined as any;
    private readonly _dart_getResolvedPadding: () => IEdgeInsets | undefined =
        undefined as any;
    ...
    private readonly _dart_debugDescribeChildren: () => IList<IDiagnosticsNode> =
        undefined as any;
    private readonly _dart_getChild: () => IRenderSliver | undefined =
        undefined as any;

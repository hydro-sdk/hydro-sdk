...
declare const flutter: {
    services: {
        rawKeyEventDataMacOs: (
            this: void,
            rawKeyEventDataMacOs: IRawKeyEventDataMacOs,
            props: {
                characters: string;
        ...
        ) => IRawKeyEventDataMacOs;
    };
};
export interface IRawKeyEventDataMacOs {
    characters: string;
    charactersIgnoringModifiers: string;
    keyCode: number;
    modifiers: number;
...
export class RawKeyEventDataMacOs
    implements Omit<IRawKeyEventData>, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.services.rawKeyEventDataMacOs(this, {
            ...rawKeyEventDataMacOsDefaultProps,
            ...props,
        });
    }
...
const rawKeyEventDataMacOsDefaultProps = {
    characters: "",

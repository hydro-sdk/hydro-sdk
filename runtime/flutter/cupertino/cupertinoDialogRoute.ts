...
import { IRawDialogRoute } from "../widgets/rawDialogRoute";
...
declare const flutter: {
    cupertino: {
        cupertinoDialogRoute: <T>(
            this: void,
            cupertinoDialogRoute: ICupertinoDialogRoute<T>,
            props: {
        ...
        ) => ICupertinoDialogRoute<T>;
    };
};
export interface ICupertinoDialogRoute<T> {
...
export class CupertinoDialogRoute<T>
    implements IRawDialogRoute<T>, ILocalHistoryRoute<T>
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino.cupertinoDialogRoute(this, {
            ...cupertinoDialogRouteDefaultProps,
            ...props,
        });
    }
...
const cupertinoDialogRouteDefaultProps = {
    barrierDismissible: true,
    transitionDuration: new Duration({ milliseconds: 250 }),
};

...
import { IBuildOwner } from "../widgets/buildOwner";
import { IElement } from "../widgets/element";
import { IIndexedSlot } from "../widgets/indexedSlot";
...
import { I_CupertinoTextSelectionToolbarItems } from "./_cupertinoTextSelectionToolbarItems";
...
declare const flutter: {
    cupertino: {
        _cupertinoTextSelectionToolbarItemsElement: (
            this: void,
            _cupertinoTextSelectionToolbarItemsElement: I_CupertinoTextSelectionToolbarItemsElement,
            widget: I_CupertinoTextSelectionToolbarItems
        ) => I_CupertinoTextSelectionToolbarItemsElement;
    };
};
export interface I_CupertinoTextSelectionToolbarItemsElement {
    slotToChild: IMap<_CupertinoTextSelectionToolbarItemsSlot, IElement>;
    getWidget: () => I_CupertinoTextSelectionToolbarItems;
    getRenderObject: () => I_RenderCupertinoTextSelectionToolbarItems;
...
export class _CupertinoTextSelectionToolbarItemsElement
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    public readonly slotToChild: IMap<
        _CupertinoTextSelectionToolbarItemsSlot,
        IElement
    > = undefined as any;
    public constructor(widget: I_CupertinoTextSelectionToolbarItems) {
        flutter.cupertino._cupertinoTextSelectionToolbarItemsElement(
            this,
            widget
        );
    }
    private readonly _dart_getWidget: () => I_CupertinoTextSelectionToolbarItems =
        undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderCupertinoTextSelectionToolbarItems =
        undefined as any;
    ...
    public getWidget(): I_CupertinoTextSelectionToolbarItems {
        return this._dart_getWidget();
    }
    public getRenderObject(): I_RenderCupertinoTextSelectionToolbarItems {

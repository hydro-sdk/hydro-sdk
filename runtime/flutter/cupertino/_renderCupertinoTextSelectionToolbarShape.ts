...
declare const flutter: {
    cupertino: {
        _renderCupertinoTextSelectionToolbarShape: (
            this: void,
            _renderCupertinoTextSelectionToolbarShape: I_RenderCupertinoTextSelectionToolbarShape,
            _anchor: IOffset,
            _isAbove: boolean,
...
export class _RenderCupertinoTextSelectionToolbarShape
    implements
        Omit<
            IRenderShiftedBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(
        ...
        flutter.cupertino._renderCupertinoTextSelectionToolbarShape(
            this,
            _anchor,
            _isAbove,
            child
    ...
    private readonly _dart_getIsRepaintBoundary: () => boolean =
        undefined as any;
    private readonly _dart_getAnchor: () => IOffset = undefined as any;
    private readonly _dart_setAnchor: (value: IOffset) => void =
        undefined as any;
    ...
    public getAnchor(): IOffset {
        return this._dart_getAnchor();
    }
    public setAnchor(value: IOffset): void {

...
declare const flutter: {
    cupertino: {
        cupertinoLocalizations: (
            this: void,
            cupertinoLocalizations: ICupertinoLocalizations
        ) => ICupertinoLocalizations;
        cupertinoLocalizationsOf: (
            context: IBuildContext
        ) => ICupertinoLocalizations;
    };
};
export interface ICupertinoLocalizations {
    ...
    datePickerHourSemanticsLabel: (hour: number) => string | undefined;
    datePickerMinute: (minute: number) => string;
    datePickerMinuteSemanticsLabel: (minute: number) => string | undefined;
    ...
    timerPickerHourLabel: (hour: number) => string | undefined;
    getTimerPickerHourLabels: () => IList<string>;
    timerPickerMinuteLabel: (minute: number) => string | undefined;
    getTimerPickerMinuteLabels: () => IList<string>;
    timerPickerSecondLabel: (second: number) => string | undefined;
...
export class CupertinoLocalizations {
    public constructor() {
        flutter.cupertino.cupertinoLocalizations(this);
    }
    public static of(context: IBuildContext): ICupertinoLocalizations {
        return flutter.cupertino.cupertinoLocalizationsOf(context);
    }
    ...
    private readonly _dart_timerPickerSecond: (second: number) => string =
        undefined as any;
    private readonly _dart_timerPickerHourLabel: (
        hour: number
    ) => string | undefined = undefined as any;
    private readonly _dart_getTimerPickerHourLabels: () => IList<string> =
        undefined as any;
    private readonly _dart_timerPickerMinuteLabel: (
        minute: number
    ) => string | undefined = undefined as any;
    private readonly _dart_getTimerPickerMinuteLabels: () => IList<string> =
        undefined as any;
    private readonly _dart_timerPickerSecondLabel: (
        second: number
    ) => string | undefined = undefined as any;
    ...
    public datePickerHourSemanticsLabel(hour: number): string | undefined {
    ...
    public datePickerMinuteSemanticsLabel(minute: number): string | undefined {
    ...
    public timerPickerHourLabel(hour: number): string | undefined {
    ...
    public timerPickerMinuteLabel(minute: number): string | undefined {
    ...
    public timerPickerSecondLabel(second: number): string | undefined {

...
import { I_RenderSegmentedControl } from "./_renderSegmentedControl";
import { I_SegmentedControlState } from "./_segmentedControlState";
declare const flutter: {
    cupertino: {
        _segmentedControlRenderWidget: <T>(
            this: void,
            _segmentedControlRenderWidget: I_SegmentedControlRenderWidget<T>,
            props: {
        ...
        ) => I_SegmentedControlRenderWidget<T>;
    };
};
export interface I_SegmentedControlRenderWidget<T> {
    highlightedIndex: number | undefined;
    thumbColor: IColor;
    thumbScale: number;
    state: I_SegmentedControlState<T>;
...
export class _SegmentedControlRenderWidget<T>
    implements IMultiChildRenderObjectWidget, IDiagnosticable
{
    public readonly highlightedIndex: number | undefined = undefined as any;
    public readonly thumbColor: IColor = undefined as any;
    public readonly thumbScale: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.cupertino._segmentedControlRenderWidget(this, {
            ..._segmentedControlRenderWidgetDefaultProps,
            ...props,
        });
    }
...
const _segmentedControlRenderWidgetDefaultProps = {

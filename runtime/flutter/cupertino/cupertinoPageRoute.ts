...
declare const flutter: {
    cupertino: {
        cupertinoPageRoute: <T>(
            this: void,
            cupertinoPageRoute: ICupertinoPageRoute<T>,
            props: {
        ...
        ) => ICupertinoPageRoute<T>;
    };
};
export interface ICupertinoPageRoute<T> {
    title: string | undefined;
    maintainState: boolean;
    fullscreenDialog: boolean;
...
export class CupertinoPageRoute<T>
    implements
        IPageRoute<T>,
        ...
        ILocalHistoryRoute<T>
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino.cupertinoPageRoute(this, {
            ...cupertinoPageRouteDefaultProps,
            ...props,
        });
    }
...
const cupertinoPageRouteDefaultProps = {

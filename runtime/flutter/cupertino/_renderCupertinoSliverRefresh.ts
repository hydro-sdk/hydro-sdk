...
declare const flutter: {
    cupertino: {
        _renderCupertinoSliverRefresh: (
            this: void,
            _renderCupertinoSliverRefresh: I_RenderCupertinoSliverRefresh,
            props: {
...
export interface I_RenderCupertinoSliverRefresh {
    layoutExtentOffsetCompensation: number;
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getRefreshIndicatorLayoutExtent: () => number;
    setRefreshIndicatorLayoutExtent: (value: number) => void;
    getHasLayoutExtent: () => boolean;
    setHasLayoutExtent: (value: boolean) => void;
    performLayout: () => void;
    paint: (paintContext: IPaintingContext, offset: IOffset) => void;
...
export class _RenderCupertinoSliverRefresh
    implements
        IRenderSliver,
        ...
        >
{
    public readonly layoutExtentOffsetCompensation: number = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderCupertinoSliverRefresh(this, props);
    }
    private readonly _dart_getRefreshIndicatorLayoutExtent: () => number =
        undefined as any;
    private readonly _dart_setRefreshIndicatorLayoutExtent: (
        value: number
    ) => void = undefined as any;
    private readonly _dart_getHasLayoutExtent: () => boolean = undefined as any;
    private readonly _dart_setHasLayoutExtent: (value: boolean) => void =
        undefined as any;
    private readonly _dart_performLayout: () => void = undefined as any;
    private readonly _dart_paint: (
        paintContext: IPaintingContext,
        offset: IOffset
    ) => void = undefined as any;
    ...
    public getRefreshIndicatorLayoutExtent(): number {
        return this._dart_getRefreshIndicatorLayoutExtent();
    }
    public setRefreshIndicatorLayoutExtent(value: number): void {
        return this._dart_setRefreshIndicatorLayoutExtent(value);
    }
    public getHasLayoutExtent(): boolean {
        return this._dart_getHasLayoutExtent();
    }
    public setHasLayoutExtent(value: boolean): void {
        return this._dart_setHasLayoutExtent(value);
    }
    public performLayout(): void {
        return this._dart_performLayout();
    }
    public paint(paintContext: IPaintingContext, offset: IOffset): void {
        return this._dart_paint(paintContext, offset);
    }

...
import { ICupertinoContextMenu } from "./cupertinoContextMenu";
declare const flutter: {
    cupertino: {
        _cupertinoContextMenuState: (
            this: void,
            _cupertinoContextMenuState: I_CupertinoContextMenuState
        ) => I_CupertinoContextMenuState;
    };
};
export interface I_CupertinoContextMenuState {
    initState: () => void;
    ...
    deactivate: () => void;
    activate: () => void;
    getWidget: () => ICupertinoContextMenu;
...
export class _CupertinoContextMenuState
    implements
        Omit<
            IState<ICupertinoContextMenu>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ICupertinoContextMenu>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.cupertino._cupertinoContextMenuState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICupertinoContextMenu =
        undefined as any;
    ...
    public getWidget(): ICupertinoContextMenu {

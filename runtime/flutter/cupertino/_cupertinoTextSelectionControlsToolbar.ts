...
import { I_CupertinoTextSelectionControlsToolbarState } from "./_cupertinoTextSelectionControlsToolbarState";
declare const flutter: {
    cupertino: {
        _cupertinoTextSelectionControlsToolbar: (
            this: void,
            _cupertinoTextSelectionControlsToolbar: I_CupertinoTextSelectionControlsToolbar,
            props: {
                key?: IKey | undefined;
        ...
        ) => I_CupertinoTextSelectionControlsToolbar;
    };
};
export interface I_CupertinoTextSelectionControlsToolbar {
    clipboardStatus: IClipboardStatusNotifier | undefined;
    endpoints: IList<ITextSelectionPoint>;
    globalEditableRegion: IRect;
    selectionMidpoint: IOffset;
    textLineHeight: number;
    key: IKey | undefined;
    createState: () => I_CupertinoTextSelectionControlsToolbarState;
...
export class _CupertinoTextSelectionControlsToolbar
    implements IStatefulWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._cupertinoTextSelectionControlsToolbar(this, props);
    }
    private readonly _dart_createState: () => I_CupertinoTextSelectionControlsToolbarState =
        undefined as any;
    ...
    public createState(): I_CupertinoTextSelectionControlsToolbarState {

...
import { I_RenderCupertinoSwitch } from "./_renderCupertinoSwitch";
declare const flutter: {
    cupertino: {
        _cupertinoSwitchRenderObjectWidget: (
            this: void,
            _cupertinoSwitchRenderObjectWidget: I_CupertinoSwitchRenderObjectWidget,
            props: {
                key?: IKey | undefined;
                activeColor: IColor;
        ...
        ) => I_CupertinoSwitchRenderObjectWidget;
    };
};
export interface I_CupertinoSwitchRenderObjectWidget {
    value: boolean;
    activeColor: IColor;
    trackColor: IColor;
    thumbColor: IColor;
    ...
    textDirection: TextDirection;
    key: IKey | undefined;
    createRenderObject: (context: IBuildContext) => I_RenderCupertinoSwitch;
...
export class _CupertinoSwitchRenderObjectWidget
    implements ILeafRenderObjectWidget, IDiagnosticable
{
    ...
    public readonly trackColor: IColor = undefined as any;
    public readonly thumbColor: IColor = undefined as any;
    public readonly state: I_CupertinoSwitchState = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.cupertino._cupertinoSwitchRenderObjectWidget(this, props);
    }
    private readonly _dart_createRenderObject: (
        context: IBuildContext
    ) => I_RenderCupertinoSwitch = undefined as any;
    ...
    public createRenderObject(context: IBuildContext): I_RenderCupertinoSwitch {

...
import { I_SegmentSeparator } from "./_segmentSeparator";
declare const flutter: {
    cupertino: {
        _segmentSeparatorState: (
            this: void,
            _segmentSeparatorState: I_SegmentSeparatorState
        ) => I_SegmentSeparatorState;
    };
};
export interface I_SegmentSeparatorState {
    separatorOpacityController: IAnimationController;
    initState: () => void;
...
export class _SegmentSeparatorState
    implements
        Omit<
            IState<I_SegmentSeparator>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<I_SegmentSeparator>,
        IDiagnosticable,
        ITickerProvider
{
    public readonly separatorOpacityController: IAnimationController =
        undefined as any;
    public constructor() {
        flutter.cupertino._segmentSeparatorState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_SegmentSeparator =
        undefined as any;
    ...
    public getWidget(): I_SegmentSeparator {

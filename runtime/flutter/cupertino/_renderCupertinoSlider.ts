...
declare const flutter: {
    cupertino: {
        _renderCupertinoSlider: (
            this: void,
            _renderCupertinoSlider: I_RenderCupertinoSlider,
            props: {
        ...
        ) => I_RenderCupertinoSlider;
    };
};
export interface I_RenderCupertinoSlider {
    ...
    getOnChanged: () => (value: number) => void | undefined;
    setOnChanged: (value?: (value: number) => void) => void;
...
export class _RenderCupertinoSlider
    implements
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderCupertinoSlider(this, props);
    }
    private readonly _dart_getValue: () => number = undefined as any;
    private readonly _dart_setValue: (newValue: number) => void =
        undefined as any;
    ...
    public getOnChanged(): (value: number) => void | undefined {
        return this._dart_getOnChanged();
    }
    public setOnChanged(value?: (value: number) => void): void {

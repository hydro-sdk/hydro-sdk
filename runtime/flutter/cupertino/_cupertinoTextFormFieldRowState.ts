...
import { ICupertinoTextFormFieldRow } from "./cupertinoTextFormFieldRow";
declare const flutter: {
    cupertino: {
        _cupertinoTextFormFieldRowState: (
            this: void,
            _cupertinoTextFormFieldRowState: I_CupertinoTextFormFieldRowState
        ) => I_CupertinoTextFormFieldRowState;
    };
};
export interface I_CupertinoTextFormFieldRowState {
    getWidget: () => ICupertinoTextFormFieldRow;
    initState: () => void;
...
export class _CupertinoTextFormFieldRowState
    implements
        Omit<
...
{
    public constructor() {
        flutter.cupertino._cupertinoTextFormFieldRowState(this);
    }
    private readonly _dart_getWidget: () => ICupertinoTextFormFieldRow =
        undefined as any;
    ...
    public getWidget(): ICupertinoTextFormFieldRow {

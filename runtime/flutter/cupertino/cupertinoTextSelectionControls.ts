...
declare const flutter: {
    cupertino: {
        cupertinoTextSelectionControls: (
            this: void,
            cupertinoTextSelectionControls: ICupertinoTextSelectionControls
        ) => ICupertinoTextSelectionControls;
    };
};
export interface ICupertinoTextSelectionControls {
...
export class CupertinoTextSelectionControls implements ITextSelectionControls {
    public constructor() {
        flutter.cupertino.cupertinoTextSelectionControls(this);
    }

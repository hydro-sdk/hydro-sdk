...
import { I_CupertinoSwitchState } from "./_cupertinoSwitchState";
declare const flutter: {
    cupertino: {
        _renderCupertinoSwitch: (
            this: void,
            _renderCupertinoSwitch: I_RenderCupertinoSwitch,
            props: {
                onChanged?: (value: boolean) => void | undefined;
                activeColor: IColor;
                state: I_CupertinoSwitchState;
                textDirection: TextDirection;
                thumbColor: IColor;
                trackColor: IColor;
                value: boolean;
            }
        ) => I_RenderCupertinoSwitch;
    };
};
export interface I_RenderCupertinoSwitch {
    ...
    getOnChanged: () => (value: boolean) => void | undefined;
    setOnChanged: (value?: (value: boolean) => void) => void;
    ...
    getAdditionalConstraints: () => IBoxConstraints;
    setAdditionalConstraints: (value: IBoxConstraints) => void;
...
export class _RenderCupertinoSwitch
    implements
        IRenderConstrainedBox,
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderCupertinoSwitch(this, props);
    }
    ...
    private readonly _dart_setTrackColor: (value: IColor) => void =
        undefined as any;
    ...
    private readonly _dart_getAdditionalConstraints: () => IBoxConstraints =
        undefined as any;
    private readonly _dart_setAdditionalConstraints: (
        value: IBoxConstraints
    ) => void = undefined as any;
    ...
    public getOnChanged(): (value: boolean) => void | undefined {
        return this._dart_getOnChanged();
    }
    public setOnChanged(value?: (value: boolean) => void): void {
    ...
    public getAdditionalConstraints(): IBoxConstraints {
        return this._dart_getAdditionalConstraints();
    }
    public setAdditionalConstraints(value: IBoxConstraints): void {
        return this._dart_setAdditionalConstraints(value);
    }

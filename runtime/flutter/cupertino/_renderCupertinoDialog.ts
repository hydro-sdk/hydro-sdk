...
import { I_AlertDialogSizes } from "./_alertDialogSizes";
declare const flutter: {
    cupertino: {
        _renderCupertinoDialog: (
            this: void,
            _renderCupertinoDialog: I_RenderCupertinoDialog,
            props: {
                actionsSection?: IRenderBox | undefined;
                contentSection?: IRenderBox | undefined;
                dividerThickness: number;
                isActionSheet: boolean;
                isInAccessibilityMode: boolean;
                dividerColor: IColor;
            }
        ) => I_RenderCupertinoDialog;
    };
};
export interface I_RenderCupertinoDialog {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getContentSection: () => IRenderBox | undefined;
    setContentSection: (newContentSection?: IRenderBox | undefined) => void;
    getActionsSection: () => IRenderBox | undefined;
    setActionsSection: (newActionsSection?: IRenderBox | undefined) => void;
    getIsInAccessibilityMode: () => boolean;
    setIsInAccessibilityMode: (newValue: boolean) => void;
    getIsActionSheet: () => boolean;
    setIsActionSheet: (newValue: boolean) => void;
    getDividerColor: () => IColor;
    setDividerColor: (newValue: IColor) => void;
    ...
    performLayout: () => void;
    performRegularLayout: (props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }) => I_AlertDialogSizes;
    performAccessibilityLayout: (props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }) => I_AlertDialogSizes;
...
export class _RenderCupertinoDialog
    implements
        IRenderBox,
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderCupertinoDialog(this, {
            ..._renderCupertinoDialogDefaultProps,
            ...props,
        });
    }
    private readonly _dart_getContentSection: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setContentSection: (
        newContentSection?: IRenderBox | undefined
    ) => void = undefined as any;
    private readonly _dart_getActionsSection: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setActionsSection: (
        newActionsSection?: IRenderBox | undefined
    ) => void = undefined as any;
    private readonly _dart_getIsInAccessibilityMode: () => boolean =
        undefined as any;
    private readonly _dart_setIsInAccessibilityMode: (
        newValue: boolean
    ) => void = undefined as any;
    private readonly _dart_getIsActionSheet: () => boolean = undefined as any;
    private readonly _dart_setIsActionSheet: (newValue: boolean) => void =
        undefined as any;
    private readonly _dart_getDividerColor: () => IColor = undefined as any;
    private readonly _dart_setDividerColor: (newValue: IColor) => void =
        undefined as any;
    ...
    private readonly _dart_performRegularLayout: (props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }) => I_AlertDialogSizes = undefined as any;
    private readonly _dart_performAccessibilityLayout: (props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }) => I_AlertDialogSizes = undefined as any;
    ...
    public getContentSection(): IRenderBox | undefined {
        return this._dart_getContentSection();
    }
    public setContentSection(newContentSection?: IRenderBox | undefined): void {
        return this._dart_setContentSection(newContentSection);
    }
    public getActionsSection(): IRenderBox | undefined {
        return this._dart_getActionsSection();
    }
    public setActionsSection(newActionsSection?: IRenderBox | undefined): void {
        return this._dart_setActionsSection(newActionsSection);
    }
    public getIsInAccessibilityMode(): boolean {
        return this._dart_getIsInAccessibilityMode();
    }
    public setIsInAccessibilityMode(newValue: boolean): void {
        return this._dart_setIsInAccessibilityMode(newValue);
    }
    public getIsActionSheet(): boolean {
        return this._dart_getIsActionSheet();
    }
    public setIsActionSheet(newValue: boolean): void {
        return this._dart_setIsActionSheet(newValue);
    }
    public getDividerColor(): IColor {
        return this._dart_getDividerColor();
    }
    public setDividerColor(newValue: IColor): void {
        return this._dart_setDividerColor(newValue);
    }
    ...
    public performRegularLayout(props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }): I_AlertDialogSizes {
        return this._dart_performRegularLayout(props);
    }
    public performAccessibilityLayout(props: {
        constraints: IBoxConstraints;
        layoutChild: (child: IRenderBox, constraints: IBoxConstraints) => ISize;
    }): I_AlertDialogSizes {
        return this._dart_performAccessibilityLayout(props);
    }
...
const _renderCupertinoDialogDefaultProps = {

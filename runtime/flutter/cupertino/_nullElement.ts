...
declare const flutter: {
    cupertino: {
        _nullElement: (
            this: void,
            _nullElement: I_NullElement
        ) => I_NullElement;
    };
};
export interface I_NullElement {
...
export class _NullElement implements IElement, IDiagnosticable, IBuildContext {
    public constructor() {
        flutter.cupertino._nullElement(this);
    }

...
import { ICupertinoSwitch } from "./cupertinoSwitch";
declare const flutter: {
    cupertino: {
        _cupertinoSwitchState: (
            this: void,
            _cupertinoSwitchState: I_CupertinoSwitchState
        ) => I_CupertinoSwitchState;
    };
};
export interface I_CupertinoSwitchState {
    position: ICurvedAnimation;
...
export class _CupertinoSwitchState
    implements
        Omit<
            IState<ICupertinoSwitch>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ICupertinoSwitch>,
        IDiagnosticable,
        ITickerProvider
{
    public readonly position: ICurvedAnimation = undefined as any;
    public readonly needsPositionAnimation: boolean = undefined as any;
    public constructor() {
        flutter.cupertino._cupertinoSwitchState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICupertinoSwitch = undefined as any;
    ...
    public getWidget(): ICupertinoSwitch {

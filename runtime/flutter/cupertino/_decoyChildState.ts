...
import { I_DecoyChild } from "./_decoyChild";
declare const flutter: {
    cupertino: {
        _decoyChildState: (
            this: void,
            _decoyChildState: I_DecoyChildState
        ) => I_DecoyChildState;
    };
};
export interface I_DecoyChildState {
    initState: () => void;
    dispose: () => void;
...
export class _DecoyChildState
    implements
        Omit<
            IState<I_DecoyChild>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<I_DecoyChild>,
        IDiagnosticable,
        ITickerProvider
{
    public static _lightModeMaskColor = new Color(0xff888888);
    public static _masklessColor = new Color(0xffffffff);
    public constructor() {
        flutter.cupertino._decoyChildState(this);
    }
    ...
    private readonly _dart_getWidget: () => I_DecoyChild = undefined as any;

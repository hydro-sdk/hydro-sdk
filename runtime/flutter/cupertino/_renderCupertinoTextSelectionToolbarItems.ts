...
import { _CupertinoTextSelectionToolbarItemsSlot } from "./_cupertinoTextSelectionToolbarItemsSlot";
declare const flutter: {
    cupertino: {
        _renderCupertinoTextSelectionToolbarItems: (
            this: void,
            _renderCupertinoTextSelectionToolbarItems: I_RenderCupertinoTextSelectionToolbarItems,
            props: { dividerWidth: number; page: number }
        ) => I_RenderCupertinoTextSelectionToolbarItems;
        _renderCupertinoTextSelectionToolbarItemsHitTestChild: (
...
export interface I_RenderCupertinoTextSelectionToolbarItems {
    slottedChildren: IMap<_CupertinoTextSelectionToolbarItemsSlot, IRenderBox>;
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getPage: () => number;
    setPage: (value: number) => void;
    getDividerWidth: () => number;
    setDividerWidth: (value: number) => void;
    getBackButton: () => IRenderBox | undefined;
    setBackButton: (value?: IRenderBox | undefined) => void;
    getNextButton: () => IRenderBox | undefined;
    setNextButton: (value?: IRenderBox | undefined) => void;
    getNextButtonDisabled: () => IRenderBox | undefined;
    setNextButtonDisabled: (value?: IRenderBox | undefined) => void;
    performLayout: () => void;
...
export class _RenderCupertinoTextSelectionToolbarItems
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, IToolbarItemsParentData>,
        IRenderBoxContainerDefaultsMixin<IRenderBox, IToolbarItemsParentData>,
        ...
        >
{
    public readonly slottedChildren: IMap<
    ...
    public constructor(props: { dividerWidth: number; page: number }) {
        flutter.cupertino._renderCupertinoTextSelectionToolbarItems(
            this,
            props
        );
    }
    public static hitTestChild(
        child: IRenderBox | undefined,
        result: IBoxHitTestResult,
        props: { position: IOffset }
    ): boolean {
        return flutter.cupertino._renderCupertinoTextSelectionToolbarItemsHitTestChild(
            child,
            result,
            props
        );
    }
    private readonly _dart_getPage: () => number = undefined as any;
    private readonly _dart_setPage: (value: number) => void = undefined as any;
    private readonly _dart_getDividerWidth: () => number = undefined as any;
    private readonly _dart_setDividerWidth: (value: number) => void =
        undefined as any;
    private readonly _dart_getBackButton: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setBackButton: (
        value?: IRenderBox | undefined
    ) => void = undefined as any;
    private readonly _dart_getNextButton: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setNextButton: (
        value?: IRenderBox | undefined
    ) => void = undefined as any;
    private readonly _dart_getNextButtonDisabled: () => IRenderBox | undefined =
        undefined as any;
    private readonly _dart_setNextButtonDisabled: (
        value?: IRenderBox | undefined
    ) => void = undefined as any;
    ...
    public setPage(value: number): void {
        return this._dart_setPage(value);
    }
    public getDividerWidth(): number {
        return this._dart_getDividerWidth();
    }
    public setDividerWidth(value: number): void {
        return this._dart_setDividerWidth(value);
    }
    public getBackButton(): IRenderBox | undefined {
        return this._dart_getBackButton();
    }
    public setBackButton(value?: IRenderBox | undefined): void {
        return this._dart_setBackButton(value);
    }
    public getNextButton(): IRenderBox | undefined {
        return this._dart_getNextButton();
    }
    public setNextButton(value?: IRenderBox | undefined): void {
        return this._dart_setNextButton(value);
    }
    public getNextButtonDisabled(): IRenderBox | undefined {
        return this._dart_getNextButtonDisabled();
    }
    public setNextButtonDisabled(value?: IRenderBox | undefined): void {
        return this._dart_setNextButtonDisabled(value);
    }

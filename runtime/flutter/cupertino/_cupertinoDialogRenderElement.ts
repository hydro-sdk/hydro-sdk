...
import { _AlertDialogSections } from "./_alertDialogSections";
import { I_CupertinoDialogRenderWidget } from "./_cupertinoDialogRenderWidget";
import { I_RenderCupertinoDialog } from "./_renderCupertinoDialog";
declare const flutter: {
    cupertino: {
        _cupertinoDialogRenderElement: (
            this: void,
            _cupertinoDialogRenderElement: I_CupertinoDialogRenderElement,
            widget: I_CupertinoDialogRenderWidget,
            props: { allowMoveRenderObjectChild: boolean }
        ) => I_CupertinoDialogRenderElement;
    };
};
export interface I_CupertinoDialogRenderElement {
    allowMoveRenderObjectChild: boolean;
    getWidget: () => I_CupertinoDialogRenderWidget;
    getRenderObject: () => I_RenderCupertinoDialog;
...
export class _CupertinoDialogRenderElement
    implements IRenderObjectElement, IDiagnosticable, IBuildContext
{
    public readonly allowMoveRenderObjectChild: boolean = undefined as any;
    public constructor(
        widget: I_CupertinoDialogRenderWidget,
        props: { allowMoveRenderObjectChild?: boolean }
    ) {
        flutter.cupertino._cupertinoDialogRenderElement(this, widget, {
            ..._cupertinoDialogRenderElementDefaultProps,
            ...props,
        });
    }
    private readonly _dart_getWidget: () => I_CupertinoDialogRenderWidget =
        undefined as any;
    private readonly _dart_getRenderObject: () => I_RenderCupertinoDialog =
        undefined as any;
    ...
    public getWidget(): I_CupertinoDialogRenderWidget {
        return this._dart_getWidget();
    }
    public getRenderObject(): I_RenderCupertinoDialog {
...
const _cupertinoDialogRenderElementDefaultProps = {
    allowMoveRenderObjectChild: false,
};

...
import { ICupertinoScrollbar } from "./cupertinoScrollbar";
declare const flutter: {
    cupertino: {
        _cupertinoScrollbarState: (
            this: void,
            _cupertinoScrollbarState: I_CupertinoScrollbarState
        ) => I_CupertinoScrollbarState;
    };
};
export interface I_CupertinoScrollbarState {
...
export class _CupertinoScrollbarState
    implements
        Omit<
            IRawScrollbarState<ICupertinoScrollbar>,
            "didChangeDependencies" | "dispose" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ICupertinoScrollbar>,
        IDiagnosticable,
        ITickerProvider
{
    public readonly scrollbarPainter: IScrollbarPainter = undefined as any;
    public constructor() {
        flutter.cupertino._cupertinoScrollbarState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICupertinoScrollbar =
        undefined as any;
    ...
    public getWidget(): ICupertinoScrollbar {

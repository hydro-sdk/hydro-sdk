...
import { IBorderTween } from "../widgets/borderTween";
...
declare const flutter: {
    cupertino: {
        _navigationBarTransition: (
            this: void,
            _navigationBarTransition: I_NavigationBarTransition,
            props: {
                animation: IAnimation<number>;
                bottomNavBar: I_TransitionableNavigationBar;
                topNavBar: I_TransitionableNavigationBar;
            }
        ) => I_NavigationBarTransition;
    };
};
export interface I_NavigationBarTransition {
    animation: IAnimation<number>;
    topNavBar: I_TransitionableNavigationBar;
    bottomNavBar: I_TransitionableNavigationBar;
    heightTween: ITween<number>;
    backgroundTween: IColorTween;
...
export class _NavigationBarTransition
    implements IStatelessWidget, IDiagnosticable
{
    public readonly animation: IAnimation<number> = undefined as any;
    public readonly topNavBar: I_TransitionableNavigationBar = undefined as any;
    public readonly bottomNavBar: I_TransitionableNavigationBar =
        undefined as any;
    public readonly heightTween: ITween<number> = undefined as any;
    public readonly backgroundTween: IColorTween = undefined as any;
    public readonly borderTween: IBorderTween = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.cupertino._navigationBarTransition(this, props);
    }

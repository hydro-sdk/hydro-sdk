...
declare const flutter: {
    cupertino: {
        _renderCupertinoPickerSemantics: (
            this: void,
            _renderCupertinoPickerSemantics: I_RenderCupertinoPickerSemantics,
            controller: IFixedExtentScrollController,
            _textDirection: TextDirection
        ) => I_RenderCupertinoPickerSemantics;
    };
};
export interface I_RenderCupertinoPickerSemantics {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getController: () => IFixedExtentScrollController;
    setController: (value: IFixedExtentScrollController) => void;
...
export class _RenderCupertinoPickerSemantics
    implements
        Omit<
            IRenderProxyBox,
            | "attach"
        ...
        >
{
    ...
    public constructor(
        ...
        flutter.cupertino._renderCupertinoPickerSemantics(
            this,
            controller,
            _textDirection
        );
    }
    private readonly _dart_getController: () => IFixedExtentScrollController =
        undefined as any;
    private readonly _dart_setController: (
        value: IFixedExtentScrollController
    ...
    public getController(): IFixedExtentScrollController {
        return this._dart_getController();
    }
    public setController(value: IFixedExtentScrollController): void {
        return this._dart_setController(value);
    }

...
declare const flutter: {
    cupertino: {
        _cupertinoDesktopTextSelectionControls: (
            this: void,
            _cupertinoDesktopTextSelectionControls: I_CupertinoDesktopTextSelectionControls
        ) => I_CupertinoDesktopTextSelectionControls;
    };
};
export interface I_CupertinoDesktopTextSelectionControls {
...
export class _CupertinoDesktopTextSelectionControls
    implements ITextSelectionControls
{
    public constructor() {
        flutter.cupertino._cupertinoDesktopTextSelectionControls(this);
    }

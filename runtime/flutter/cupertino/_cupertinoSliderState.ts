...
import { ICupertinoSlider } from "./cupertinoSlider";
declare const flutter: {
    cupertino: {
        _cupertinoSliderState: (
            this: void,
            _cupertinoSliderState: I_CupertinoSliderState
        ) => I_CupertinoSliderState;
    };
};
export interface I_CupertinoSliderState {
...
export class _CupertinoSliderState
    implements
        Omit<
            IState<ICupertinoSlider>,
            "dispose" | "didChangeDependencies" | "debugFillProperties"
        >,
        ITickerProviderStateMixin<ICupertinoSlider>,
        IDiagnosticable,
        ITickerProvider
{
    public constructor() {
        flutter.cupertino._cupertinoSliderState(this);
    }
    ...
    private readonly _dart_getWidget: () => ICupertinoSlider = undefined as any;
    ...
    public getWidget(): ICupertinoSlider {

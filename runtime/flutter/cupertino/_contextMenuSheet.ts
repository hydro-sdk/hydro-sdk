...
declare const flutter: {
    cupertino: {
        _contextMenuSheet: (
            this: void,
            _contextMenuSheet: I_ContextMenuSheet,
            props: {
                key?: IKey | undefined;
...
export interface I_ContextMenuSheet {
    actions: IList<IWidget>;
    key: IKey | undefined;
    getChildren: () => IList<IWidget>;
...
export class _ContextMenuSheet implements IStatelessWidget, IDiagnosticable {
    ...
    public constructor(props: {
        ...
        flutter.cupertino._contextMenuSheet(this, props);
    }
    private readonly _dart_getChildren: () => IList<IWidget> = undefined as any;
    ...
    public getChildren(): IList<IWidget> {

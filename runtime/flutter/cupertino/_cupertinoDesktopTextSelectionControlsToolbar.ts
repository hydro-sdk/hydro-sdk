...
import { I_CupertinoDesktopTextSelectionControlsToolbarState } from "./_cupertinoDesktopTextSelectionControlsToolbarState";
declare const flutter: {
    cupertino: {
        _cupertinoDesktopTextSelectionControlsToolbar: (
            this: void,
            _cupertinoDesktopTextSelectionControlsToolbar: I_CupertinoDesktopTextSelectionControlsToolbar,
            props: {
                key?: IKey | undefined;
        ...
        ) => I_CupertinoDesktopTextSelectionControlsToolbar;
    };
};
export interface I_CupertinoDesktopTextSelectionControlsToolbar {
    clipboardStatus: IClipboardStatusNotifier | undefined;
    endpoints: IList<ITextSelectionPoint>;
    globalEditableRegion: IRect;
    lastSecondaryTapDownPosition: IOffset | undefined;
    ...
    textLineHeight: number;
    key: IKey | undefined;
    createState: () => I_CupertinoDesktopTextSelectionControlsToolbarState;
...
export class _CupertinoDesktopTextSelectionControlsToolbar
    implements IStatefulWidget, IDiagnosticable
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._cupertinoDesktopTextSelectionControlsToolbar(
            this,
            props
        );
    }
    private readonly _dart_createState: () => I_CupertinoDesktopTextSelectionControlsToolbarState =
        undefined as any;
    ...
    public createState(): I_CupertinoDesktopTextSelectionControlsToolbarState {

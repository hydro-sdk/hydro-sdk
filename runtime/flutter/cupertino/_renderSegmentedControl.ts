...
import { I_SegmentedControlState } from "./_segmentedControlState";
declare const flutter: {
    cupertino: {
        _renderSegmentedControl: <T>(
            this: void,
            _renderSegmentedControl: I_RenderSegmentedControl<T>,
            props: {
                highlightedIndex?: number | undefined;
                state: I_SegmentedControlState<T>;
                thumbColor: IColor;
                thumbScale: number;
            }
        ) => I_RenderSegmentedControl<T>;
    };
};
export interface I_RenderSegmentedControl<T> {
    state: I_SegmentedControlState<T>;
    currentThumbRect: IRect | undefined;
    separatorPaint: IPaint;
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    attach: (owner: unknown) => void;
    detach: () => void;
    getThumbScale: () => number;
    setThumbScale: (value: number) => void;
    getHighlightedIndex: () => number | undefined;
    setHighlightedIndex: (value?: number | undefined) => void;
    getThumbColor: () => IColor;
    setThumbColor: (value: IColor) => void;
    handleEvent: (event: IPointerEvent, entry: unknown) => void;
    getTotalSeparatorWidth: () => number;
    nonSeparatorChildAfter: (child: IRenderBox) => IRenderBox | undefined;
    ...
    moveThumbRectInBound: (
        thumbRect: IRect | undefined,
        children: IList<IRenderBox>
    ) => IRect | undefined;
...
export class _RenderSegmentedControl<T>
    implements
        IRenderBox,
        ...
        >
{
    public readonly state: I_SegmentedControlState<T> = undefined as any;
    public readonly currentThumbRect: IRect | undefined = undefined as any;
    public readonly separatorPaint: IPaint = undefined as any;
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderSegmentedControl(this, props);
    }
    private readonly _dart_attach: (owner: any) => void = undefined as any;
    private readonly _dart_detach: () => void = undefined as any;
    private readonly _dart_getThumbScale: () => number = undefined as any;
    private readonly _dart_setThumbScale: (value: number) => void =
        undefined as any;
    private readonly _dart_getHighlightedIndex: () => number | undefined =
        undefined as any;
    private readonly _dart_setHighlightedIndex: (
        value?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getThumbColor: () => IColor = undefined as any;
    private readonly _dart_setThumbColor: (value: IColor) => void =
        undefined as any;
    private readonly _dart_handleEvent: (
        event: IPointerEvent,
        entry: any
    ) => void = undefined as any;
    private readonly _dart_getTotalSeparatorWidth: () => number =
        undefined as any;
    private readonly _dart_nonSeparatorChildAfter: (
        child: IRenderBox
    ...
    private readonly _dart_moveThumbRectInBound: (
        thumbRect: IRect | undefined,
        children: IList<IRenderBox>
    ...
    public getThumbScale(): number {
        return this._dart_getThumbScale();
    }
    public setThumbScale(value: number): void {
        return this._dart_setThumbScale(value);
    }
    public getHighlightedIndex(): number | undefined {
        return this._dart_getHighlightedIndex();
    }
    public setHighlightedIndex(value?: number | undefined): void {
        return this._dart_setHighlightedIndex(value);
    }
    public getThumbColor(): IColor {
        return this._dart_getThumbColor();
    }
    public setThumbColor(value: IColor): void {
        return this._dart_setThumbColor(value);
    }
    public handleEvent(event: IPointerEvent, entry: any): void {
        return this._dart_handleEvent(event, entry);
    }
    public getTotalSeparatorWidth(): number {
        return this._dart_getTotalSeparatorWidth();
    }
    public nonSeparatorChildAfter(child: IRenderBox): IRenderBox | undefined {
        return this._dart_nonSeparatorChildAfter(child);
    }
    ...
    public moveThumbRectInBound(
        thumbRect: IRect | undefined,
        children: IList<IRenderBox>
    ): IRect | undefined {
        return this._dart_moveThumbRectInBound(thumbRect, children);
    }

...
import { IAlignmentDirectional } from "../painting/alignmentDirectional";
...
declare const flutter: {
    cupertino: {
        _contextMenuRoute: <T>(
            this: void,
            _contextMenuRoute: I_ContextMenuRoute<T>,
            props: {
                ...
                previousChildRect: IRect;
            }
        ) => I_ContextMenuRoute<T>;
        _contextMenuRouteGetSheetAlignment: (
            contextMenuLocation: _ContextMenuLocation
        ) => IAlignmentDirectional;
    };
};
export interface I_ContextMenuRoute<T> {
    barrierLabel: string | undefined;
    filter: IImageFilter | undefined;
...
export class _ContextMenuRoute<T>
    implements IPopupRoute<T>, ILocalHistoryRoute<T>
{
    public static _kModalBarrierColor = new Color(0x6604040f);
    public static _kModalPopupTransitionDuration = new Duration({
        milliseconds: 335,
    });
    ...
    public constructor(props: {
        ...
        flutter.cupertino._contextMenuRoute(this, props);
    }
    public static getSheetAlignment(
        contextMenuLocation: _ContextMenuLocation
    ): IAlignmentDirectional {
        return flutter.cupertino._contextMenuRouteGetSheetAlignment(
            contextMenuLocation
        );
    }

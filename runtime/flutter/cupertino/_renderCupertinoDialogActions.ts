...
declare const flutter: {
    cupertino: {
        _renderCupertinoDialogActions: (
            this: void,
            _renderCupertinoDialogActions: I_RenderCupertinoDialogActions,
            props: {
                ...
                dialogColor: IColor;
                dialogPressedColor: IColor;
                dividerColor: IColor;
            }
        ) => I_RenderCupertinoDialogActions;
    };
};
export interface I_RenderCupertinoDialogActions {
    parentData: IParentData | undefined;
    debugCreator: Object | undefined;
    getDialogWidth: () => number | undefined;
    setDialogWidth: (newWidth?: number | undefined) => void;
    getDividerThickness: () => number;
    setDividerThickness: (newValue: number) => void;
    getHasCancelButton: () => boolean;
    setHasCancelButton: (newValue: boolean) => void;
    getDialogColor: () => IColor;
    setDialogColor: (value: IColor) => void;
    getDialogPressedColor: () => IColor;
    setDialogPressedColor: (value: IColor) => void;
    getDividerColor: () => IColor;
    setDividerColor: (value: IColor) => void;
    getIsActionSheet: () => boolean;
    setIsActionSheet: (value: boolean) => void;
...
export class _RenderCupertinoDialogActions
    implements
        IRenderBox,
        IContainerRenderObjectMixin<IRenderBox, IMultiChildLayoutParentData>,
        IRenderBoxContainerDefaultsMixin<
            IRenderBox,
        ...
        >
{
    ...
    public constructor(props: {
        ...
        flutter.cupertino._renderCupertinoDialogActions(this, {
            ..._renderCupertinoDialogActionsDefaultProps,
            ...props,
        });
    }
    private readonly _dart_getDialogWidth: () => number | undefined =
        undefined as any;
    private readonly _dart_setDialogWidth: (
        newWidth?: number | undefined
    ) => void = undefined as any;
    private readonly _dart_getDividerThickness: () => number = undefined as any;
    private readonly _dart_setDividerThickness: (newValue: number) => void =
        undefined as any;
    private readonly _dart_getHasCancelButton: () => boolean = undefined as any;
    private readonly _dart_setHasCancelButton: (newValue: boolean) => void =
        undefined as any;
    private readonly _dart_getDialogColor: () => IColor = undefined as any;
    private readonly _dart_setDialogColor: (value: IColor) => void =
        undefined as any;
    private readonly _dart_getDialogPressedColor: () => IColor =
        undefined as any;
    private readonly _dart_setDialogPressedColor: (value: IColor) => void =
        undefined as any;
    private readonly _dart_getDividerColor: () => IColor = undefined as any;
    private readonly _dart_setDividerColor: (value: IColor) => void =
        undefined as any;
    private readonly _dart_getIsActionSheet: () => boolean = undefined as any;
    private readonly _dart_setIsActionSheet: (value: boolean) => void =
        undefined as any;
    ...
    public getDialogWidth(): number | undefined {
        return this._dart_getDialogWidth();
    }
    public setDialogWidth(newWidth?: number | undefined): void {
        return this._dart_setDialogWidth(newWidth);
    }
    public getDividerThickness(): number {
        return this._dart_getDividerThickness();
    }
    public setDividerThickness(newValue: number): void {
        return this._dart_setDividerThickness(newValue);
    }
    public getHasCancelButton(): boolean {
        return this._dart_getHasCancelButton();
    }
    public setHasCancelButton(newValue: boolean): void {
        return this._dart_setHasCancelButton(newValue);
    }
    public getDialogColor(): IColor {
        return this._dart_getDialogColor();
    }
    public setDialogColor(value: IColor): void {
        return this._dart_setDialogColor(value);
    }
    public getDialogPressedColor(): IColor {
        return this._dart_getDialogPressedColor();
    }
    public setDialogPressedColor(value: IColor): void {
        return this._dart_setDialogPressedColor(value);
    }
    public getDividerColor(): IColor {
        return this._dart_getDividerColor();
    }
    public setDividerColor(value: IColor): void {
        return this._dart_setDividerColor(value);
    }
    public getIsActionSheet(): boolean {
        return this._dart_getIsActionSheet();
    }
    public setIsActionSheet(value: boolean): void {
        return this._dart_setIsActionSheet(value);
    }
...
const _renderCupertinoDialogActionsDefaultProps = {

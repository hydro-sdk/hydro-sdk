...
declare const flutter: {
    painting: {
        imageStreamListener: (
            this: void,
            imageStreamListener: IImageStreamListener,
            onImage: (image: IImageInfo, synchronousCall: boolean) => void,
            props?: {
                onChunk?: (event: IImageChunkEvent) => void | undefined;
                onError?: (
                    exception: Object,
                    stackTrace?: IStackTrace | undefined
                ) => void | undefined;
            }
        ) => IImageStreamListener;
    };
};

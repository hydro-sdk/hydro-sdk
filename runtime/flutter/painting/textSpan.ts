...
export interface ITextSpan {
    ...
    computeSemanticsInformation: (
        ...
        props: {
            inheritedLocale?: ILocale | undefined;
            inheritedSpellOut: boolean;
        }
    ) => void;
    codeUnitAtVisitor: (
        index: number,
...
export class TextSpan
    implements
        ...
        IDiagnosticable,
        IHitTestTarget,
        Omit<IMouseTrackerAnnotation, "debugFillProperties">
{
    ...
    public readonly recognizer: IGestureRecognizer | undefined =
        undefined as any;

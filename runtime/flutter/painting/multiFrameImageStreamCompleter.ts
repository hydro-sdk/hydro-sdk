...
declare const flutter: {
    painting: {
        multiFrameImageStreamCompleter: (
            this: void,
            multiFrameImageStreamCompleter: IMultiFrameImageStreamCompleter,
            props: {
                chunkEvents?: IStream<IImageChunkEvent> | undefined;
                debugLabel?: string | undefined;
                informationCollector?: () =>
                    | IIterable<IDiagnosticsNode>
                    | undefined;
                codec: IFuture<ICodec>;
                scale: number;
            }
        ) => IMultiFrameImageStreamCompleter;
    };
};

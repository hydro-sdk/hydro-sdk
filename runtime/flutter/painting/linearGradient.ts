...
painting: {
linearGradient: (this: void, linearGradient: ILinearGradient, props : {  begin : IAlignmentGeometry, end : IAlignmentGeometry, stops? : IList<number> | undefined, tileMode : TileMode, transform? : IGradientTransform | undefined, colors : IList<IColor>,}) => ILinearGradient;
linearGradientLerp: (a: ILinearGradient | undefined, b: ILinearGradient | undefined, t: number) => ILinearGradient | undefined
}
};
...
public constructor( props : {  begin? : IAlignmentGeometry, end? : IAlignmentGeometry, stops? : IList<number> | undefined, tileMode? : TileMode, transform? : IGradientTransform | undefined, colors : IList<IColor>,}){
flutter.painting.linearGradient(this, {
...linearGradientDefaultProps,
...props
});}
public static lerp(a: ILinearGradient | undefined, b: ILinearGradient | undefined, t: number) : ILinearGradient | undefined{
return flutter.painting.linearGradientLerp(a, b, t);
    ...
    private readonly _dart_scale: (factor: number) => ILinearGradient = undefined as any;

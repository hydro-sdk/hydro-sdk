...
painting: {
_boxDecorationPainter: (this: void, _boxDecorationPainter: I_BoxDecorationPainter, _decoration: IBoxDecoration, onChanged? : () => void) => I_BoxDecorationPainter
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _BoxDecorationPainter

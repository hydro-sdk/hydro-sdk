...
declare const flutter: {
    painting: {
        borderDirectional: (
            this: void,
            borderDirectional: IBorderDirectional,
            props: {
                bottom: IBorderSide;
                end: IBorderSide;
                start: IBorderSide;
        ...
        borderDirectionalMerge: (
            a: IBorderDirectional,
            b: IBorderDirectional
        ) => IBorderDirectional;
        borderDirectionalLerp: (
            a: IBorderDirectional | undefined,
            b: IBorderDirectional | undefined,
            t: number
        ) => IBorderDirectional | undefined;
    };
};
...
export class BorderDirectional implements IBoxBorder {
    ...
    private readonly _dart_add: (
        other: IShapeBorder,
        props: { reversed: boolean }
    ) => IBoxBorder | undefined = undefined as any;
    private readonly _dart_scale: (t: number) => IBorderDirectional =
        undefined as any;

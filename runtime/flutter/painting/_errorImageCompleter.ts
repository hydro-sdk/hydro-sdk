...
declare const flutter: {
    painting: {
        _errorImageCompleter: (
            this: void,
            _errorImageCompleter: I_ErrorImageCompleter
        ) => I_ErrorImageCompleter;
    };
};
export interface I_ErrorImageCompleter {
...
export class _ErrorImageCompleter
    implements
        Omit<IImageStreamCompleter, "debugFillProperties">,
        IDiagnosticable
{
    public readonly debugLabel: string | undefined = undefined as any;
    public constructor() {
        flutter.painting._errorImageCompleter(this);
    }

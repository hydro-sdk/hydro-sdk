...
declare const flutter: {
    painting: {
        _stadiumToCircleBorder: (
            this: void,
            _stadiumToCircleBorder: I_StadiumToCircleBorder,
            props: { circleness: number; side: IBorderSide }
        ) => I_StadiumToCircleBorder;
    };
};
...
export class _StadiumToCircleBorder implements IOutlinedBorder {
    ...
    private readonly _dart_copyWith: (props?: {
        circleness?: number | undefined;
        side?: IBorderSide | undefined;
    }) => I_StadiumToCircleBorder = undefined as any;

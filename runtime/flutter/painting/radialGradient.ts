...
painting: {
radialGradient: (this: void, radialGradient: IRadialGradient, props : {  center : IAlignmentGeometry, focal? : IAlignmentGeometry | undefined, focalRadius : number, radius : number, stops? : IList<number> | undefined, tileMode : TileMode, transform? : IGradientTransform | undefined, colors : IList<IColor>,}) => IRadialGradient;
radialGradientLerp: (a: IRadialGradient | undefined, b: IRadialGradient | undefined, t: number) => IRadialGradient | undefined
}
};
...
public constructor( props : {  center? : IAlignmentGeometry, focal? : IAlignmentGeometry | undefined, focalRadius? : number, radius? : number, stops? : IList<number> | undefined, tileMode? : TileMode, transform? : IGradientTransform | undefined, colors : IList<IColor>,}){
flutter.painting.radialGradient(this, {
...radialGradientDefaultProps,
...props
});}
public static lerp(a: IRadialGradient | undefined, b: IRadialGradient | undefined, t: number) : IRadialGradient | undefined{
return flutter.painting.radialGradientLerp(a, b, t);
    ...
    private readonly _dart_scale: (factor: number) => IRadialGradient = undefined as any;

...
painting: {
_pendingImage: (this: void, _pendingImage: I_PendingImage, completer: IImageStreamCompleter, listener: IImageStreamListener) => I_PendingImage
}
};
...
public constructor(completer: IImageStreamCompleter, listener: IImageStreamListener){

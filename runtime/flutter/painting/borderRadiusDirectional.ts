...
declare const flutter: {
    painting: {
        borderRadiusDirectionalLerp: (
            a: IBorderRadiusDirectional | undefined,
            b: IBorderRadiusDirectional | undefined,
            t: number
        ) => IBorderRadiusDirectional | undefined;
    };
};
...
export class BorderRadiusDirectional implements IBorderRadiusGeometry {

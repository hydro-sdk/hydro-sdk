...
declare const flutter: {
    painting: {
        inlineSpanSemanticsInformation: (
            this: void,
            inlineSpanSemanticsInformation: IInlineSpanSemanticsInformation,
            text: string,
            props: {
        ...
        ) => IInlineSpanSemanticsInformation;
    };
};
...
export class InlineSpanSemanticsInformation {
    public static placeholder = new InlineSpanSemanticsInformation("￼", {
        isPlaceholder: true,
    });
    ...
    public readonly stringAttributes: IList<IStringAttribute> =
        undefined as any;
    public constructor(
        text: string,
        props: {

...
declare const flutter: {
    painting: {
        fractionalOffset: (
            this: void,
            fractionalOffset: IFractionalOffset,
            dx: number,
            dy: number
        ) => IFractionalOffset;
        ...
        fractionalOffsetLerp: (
            a: IFractionalOffset | undefined,
            b: IFractionalOffset | undefined,
            t: number
...
export class FractionalOffset implements IAlignment {
    ...
    private readonly _dart_alongOffset: (other: IOffset) => IOffset =
        undefined as any;
    private readonly _dart_alongSize: (other: ISize) => IOffset =
        undefined as any;
    private readonly _dart_withinRect: (rect: IRect) => IOffset =
        undefined as any;
    private readonly _dart_inscribe: (size: ISize, rect: IRect) => IRect =
        undefined as any;

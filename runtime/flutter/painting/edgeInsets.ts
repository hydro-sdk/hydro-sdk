...
declare const flutter: {
    painting: {
        edgeInsetsLerp: (
            a: IEdgeInsets | undefined,
            b: IEdgeInsets | undefined,
            t: number
        ) => IEdgeInsets | undefined;
    };
};
...
export class EdgeInsets implements IEdgeInsetsGeometry {
    ...
    private readonly _dart_inflateRect: (rect: IRect) => IRect =
        undefined as any;
    private readonly _dart_deflateRect: (rect: IRect) => IRect =
        undefined as any;

...
painting: {
border: (this: void, border: IBorder, props : {  bottom : IBorderSide, left : IBorderSide, right : IBorderSide, top : IBorderSide,}) => IBorder;
borderAll: ( props : {  color : IColor, style : BorderStyle, width : number,}) => IBorder;
borderMerge: (a: IBorder, b: IBorder) => IBorder;
borderLerp: (a: IBorder | undefined, b: IBorder | undefined, t: number) => IBorder | undefined
}
};
...
add: (other: IShapeBorder, props : {  reversed : boolean,}) => IBorder | undefined;
...
public constructor( props : {  bottom? : IBorderSide, left? : IBorderSide, right? : IBorderSide, top? : IBorderSide,}){
flutter.painting.border(this, {
...borderDefaultProps,
...props
});}
public static all( props : {  color? : IColor, style? : BorderStyle, width? : number,}) : IBorder{
...
}public static lerp(a: IBorder | undefined, b: IBorder | undefined, t: number) : IBorder | undefined{
return flutter.painting.borderLerp(a, b, t);
    ...
    private readonly _dart_add: (other: IShapeBorder, props : {  reversed : boolean,}) => IBorder | undefined = undefined as any;
...
public add(other: IShapeBorder, props : {  reversed? : boolean,}) : IBorder | undefined {

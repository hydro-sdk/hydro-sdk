...
declare const flutter: {
    painting: {
        circularNotchedRectangle: (
            this: void,
            circularNotchedRectangle: ICircularNotchedRectangle
        ) => ICircularNotchedRectangle;
    };
};
...
export class CircularNotchedRectangle implements INotchedShape {
    public constructor() {
        flutter.painting.circularNotchedRectangle(this);
    }
    private readonly _dart_getOuterPath: (
        host: IRect,
        guest?: IRect | undefined

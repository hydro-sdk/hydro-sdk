...
painting: {
_caretMetrics: (this: void, _caretMetrics: I_CaretMetrics, props : {  fullHeight? : number | undefined, offset : IOffset,}) => I_CaretMetrics
}
};
...
public constructor( props : {  fullHeight? : number | undefined, offset : IOffset,}){

...
hSVColorLerp: (a: IHSVColor | undefined, b: IHSVColor | undefined, t: number) => IHSVColor | undefined
}
};
...
}public static lerp(a: IHSVColor | undefined, b: IHSVColor | undefined, t: number) : IHSVColor | undefined{
return flutter.painting.hSVColorLerp(a, b, t);
}    private readonly _dart_withAlpha: (alpha: number) => IHSVColor = undefined as any;
    private readonly _dart_withHue: (hue: number) => IHSVColor = undefined as any;
    private readonly _dart_withSaturation: (saturation: number) => IHSVColor = undefined as any;
    private readonly _dart_withValue: (value: number) => IHSVColor = undefined as any;

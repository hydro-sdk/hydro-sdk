...
import { IEdgeInsets,EdgeInsets } from "./edgeInsets";
...
painting: {
flutterLogoDecoration: (this: void, flutterLogoDecoration: IFlutterLogoDecoration, props : {  margin : IEdgeInsets, style : FlutterLogoStyle, textColor : IColor,}) => IFlutterLogoDecoration;
flutterLogoDecorationLerp: (a: IFlutterLogoDecoration | undefined, b: IFlutterLogoDecoration | undefined, t: number) => IFlutterLogoDecoration | undefined
}
};
...
lerpFrom: (a: IDecoration | undefined, t: number) => IFlutterLogoDecoration | undefined;
lerpTo: (b: IDecoration | undefined, t: number) => IFlutterLogoDecoration | undefined;
...
public constructor( props : {  margin? : IEdgeInsets, style? : FlutterLogoStyle, textColor? : IColor,}){
flutter.painting.flutterLogoDecoration(this, {
...flutterLogoDecorationDefaultProps,
...props
});}
public static lerp(a: IFlutterLogoDecoration | undefined, b: IFlutterLogoDecoration | undefined, t: number) : IFlutterLogoDecoration | undefined{
return flutter.painting.flutterLogoDecorationLerp(a, b, t);
    ...
    private readonly _dart_lerpFrom: (a: IDecoration | undefined, t: number) => IFlutterLogoDecoration | undefined = undefined as any;
    private readonly _dart_lerpTo: (b: IDecoration | undefined, t: number) => IFlutterLogoDecoration | undefined = undefined as any;
...
public lerpFrom(a: IDecoration | undefined, t: number) : IFlutterLogoDecoration | undefined {
    return this._dart_lerpFrom(a, t);
}
public lerpTo(b: IDecoration | undefined, t: number) : IFlutterLogoDecoration | undefined {

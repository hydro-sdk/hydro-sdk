...
painting: {
networkImageLoadException: (this: void, networkImageLoadException: INetworkImageLoadException, props : {  statusCode : number, uri : IUri,}) => INetworkImageLoadException
}
};
...
uri: IUri;
toString: () => string;
}export class NetworkImageLoadException

...
export interface IImageCache {
    ...
    ) => IImageStreamCompleter | undefined;
...
export class ImageCache {
    ...
    private readonly _dart_setMaximumSize: (value: number) => void =
        undefined as any;
    ...
    private readonly _dart_setMaximumSizeBytes: (value: number) => void =
        undefined as any;
    private readonly _dart_getCurrentSizeBytes: () => number = undefined as any;
    private readonly _dart_clear: () => void = undefined as any;
    private readonly _dart_evict: (
        key: Object,
        props: { includeLive: boolean }
    ) => boolean = undefined as any;
    private readonly _dart_putIfAbsent: (
        key: Object,
        loader: () => IImageStreamCompleter,
        props?: {
            onError?: (
    ...
    ) => IImageStreamCompleter | undefined = undefined as any;
    private readonly _dart_statusForKey: (key: Object) => IImageCacheStatus =
        undefined as any;
    private readonly _dart_containsKey: (key: Object) => boolean =
        undefined as any;
    private readonly _dart_getLiveImageCount: () => number = undefined as any;
    private readonly _dart_getPendingImageCount: () => number =
        undefined as any;

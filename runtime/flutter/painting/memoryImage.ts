...
painting: {
memoryImage: (this: void, memoryImage: IMemoryImage, bytes: IUint8List, props : {  scale : number,}) => IMemoryImage
}
};
...
resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: IMemoryImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void;
evict: ( props : {  cache? : IImageCache | undefined, configuration : IImageConfiguration,}) => IFuture<boolean>;
}export class MemoryImage

 implements IImageProvider<IMemoryImage>
...
...props
    ...
    private readonly _dart_obtainKey: (configuration: IImageConfiguration) => IFuture<IMemoryImage> = undefined as any;
    ...
    private readonly _dart_resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: IMemoryImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void = undefined as any;
...
public obtainKey(configuration: IImageConfiguration) : IFuture<IMemoryImage> {
...
public resolveStreamForKey(configuration: IImageConfiguration, stream: IImageStream, key: IMemoryImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) : void {

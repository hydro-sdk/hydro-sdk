...
declare const flutter: {
    painting: {
        transformProperty: (
            this: void,
            transformProperty: ITransformProperty,
            name: string,
...
export class TransformProperty implements IDiagnosticsProperty<IMatrix4> {
    ...
    private readonly _dart_getValue: () => IMatrix4 | undefined =
        undefined as any;

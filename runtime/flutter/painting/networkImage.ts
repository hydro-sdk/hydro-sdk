...
painting: {
networkImage: (this: void, networkImage: INetworkImage, url: string, props : {  headers? : {[index: string]: string} | undefined, scale : number,}) => INetworkImage
}
};
...
resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: INetworkImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void;
...
getHashCode: () => number;
 ...
 implements IImageProvider<INetworkImage>
{public constructor(url: string, props : {  headers? : {[index: string]: string} | undefined, scale : number,}){
flutter.painting.networkImage(this, url, props);}
    ...
    private readonly _dart_getHeaders: () => {[index: string]: string} | undefined = undefined as any;
    ...
    private readonly _dart_resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: INetworkImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void = undefined as any;
    ...
    private readonly _dart_obtainKey: (configuration: IImageConfiguration) => IFuture<INetworkImage> = undefined as any;
...
public resolveStreamForKey(configuration: IImageConfiguration, stream: IImageStream, key: INetworkImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) : void {
...
public obtainKey(configuration: IImageConfiguration) : IFuture<INetworkImage> {

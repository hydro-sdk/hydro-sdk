...
painting: {
exactAssetImage: (this: void, exactAssetImage: IExactAssetImage, assetName: string, props : {  bundle? : IAssetBundle | undefined, package? : string | undefined, scale : number,}) => IExactAssetImage
}
};
...
public constructor(assetName: string, props : {  bundle? : IAssetBundle | undefined, package? : string | undefined, scale? : number,}){

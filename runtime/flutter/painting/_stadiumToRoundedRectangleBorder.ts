...
import { IBorderRadius,BorderRadius } from "./borderRadius";
...
painting: {
_stadiumToRoundedRectangleBorder: (this: void, _stadiumToRoundedRectangleBorder: I_StadiumToRoundedRectangleBorder, props : {  borderRadius : IBorderRadius, rectness : number, side : IBorderSide,}) => I_StadiumToRoundedRectangleBorder
}
};
...
copyWith: ( props? : {  borderRadius? : IBorderRadius | undefined, rectness? : number | undefined, side? : IBorderSide | undefined,}) => I_StadiumToRoundedRectangleBorder;
...
}export class _StadiumToRoundedRectangleBorder
...
public constructor( props : {  borderRadius? : IBorderRadius, rectness? : number, side? : IBorderSide,}){
...
...props
    ...
    private readonly _dart_copyWith: ( props? : {  borderRadius? : IBorderRadius | undefined, rectness? : number | undefined, side? : IBorderSide | undefined,}) => I_StadiumToRoundedRectangleBorder = undefined as any;
...
public copyWith( props? : {  borderRadius? : IBorderRadius | undefined, rectness? : number | undefined, side? : IBorderSide | undefined,}) : I_StadiumToRoundedRectangleBorder {

...
painting: {
automaticNotchedShape: (this: void, automaticNotchedShape: IAutomaticNotchedShape, host: IShapeBorder, guest?: IShapeBorder | undefined) => IAutomaticNotchedShape
}
};
...
toString: () => string;
getHashCode: () => number;
}export class AutomaticNotchedShape
...
flutter.painting.automaticNotchedShape(this, host, guest);}
    private readonly _dart_getOuterPath: (hostRect: IRect, guestRect?: IRect | undefined) => IPath = undefined as any;

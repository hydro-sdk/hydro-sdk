...
painting: {
imageInfo: (this: void, imageInfo: IImageInfo, props : {  debugLabel? : string | undefined, scale : number, image : IImage,}) => IImageInfo
}
};
...
public constructor( props : {  debugLabel? : string | undefined, scale? : number, image : IImage,}){
flutter.painting.imageInfo(this, {
...imageInfoDefaultProps,
...props
});}
    private readonly _dart_clone: () => IImageInfo = undefined as any;
    private readonly _dart_isCloneOf: (other: IImageInfo) => boolean = undefined as any;

...
painting: {
_cachedImageBase: (this: void, _cachedImageBase: I_CachedImageBase, completer: IImageStreamCompleter, props? : {  sizeBytes? : number | undefined,}) => I_CachedImageBase
}
};
...
public constructor(completer: IImageStreamCompleter, props? : {  sizeBytes? : number | undefined,}){

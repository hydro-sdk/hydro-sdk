...
declare const flutter: {
    painting: {
        shapeDecoration: (
            this: void,
            shapeDecoration: IShapeDecoration,
            props: {
        ...
        shapeDecorationFromBoxDecoration: (
            source: IBoxDecoration
        ) => IShapeDecoration;
        shapeDecorationLerp: (
            a: IShapeDecoration | undefined,
            b: IShapeDecoration | undefined,
            t: number
        ) => IShapeDecoration | undefined;
    };
};
    ...
    implements Omit<IDecoration, "toStringShort">, IDiagnosticable
{
    ...
    private readonly _dart_lerpFrom: (
        a: IDecoration | undefined,
        t: number
    ) => IShapeDecoration | undefined = undefined as any;

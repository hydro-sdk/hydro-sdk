...
painting: {
circleBorder: (this: void, circleBorder: ICircleBorder, props : {  side : IBorderSide,}) => ICircleBorder
}
};
...
...props
    ...
    private readonly _dart_copyWith: ( props? : {  side? : IBorderSide | undefined,}) => ICircleBorder = undefined as any;

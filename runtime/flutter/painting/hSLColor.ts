...
declare const flutter: {
    painting: {
        ...
        hSLColorLerp: (
            a: IHSLColor | undefined,
            b: IHSLColor | undefined,
            t: number
        ) => IHSLColor | undefined;
    };
};
...
export class HSLColor {
    ...
    private readonly _dart_withAlpha: (alpha: number) => IHSLColor =
        undefined as any;
    private readonly _dart_withHue: (hue: number) => IHSLColor =
        undefined as any;
    private readonly _dart_withSaturation: (saturation: number) => IHSLColor =
        undefined as any;
    private readonly _dart_withLightness: (lightness: number) => IHSLColor =
        undefined as any;

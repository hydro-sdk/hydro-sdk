...
declare const flutter: {
    painting: {
        _mixedBorderRadius: (
            this: void,
            _mixedBorderRadius: I_MixedBorderRadius,
            _topLeft: IRadius,
            _topRight: IRadius,
            _bottomLeft: IRadius,
            _bottomRight: IRadius,
            _topStart: IRadius,
            _topEnd: IRadius,
            _bottomStart: IRadius,
            _bottomEnd: IRadius
        ) => I_MixedBorderRadius;
    };
};
...
export class _MixedBorderRadius implements IBorderRadiusGeometry {
    public constructor(
        _topLeft: IRadius,
        _topRight: IRadius,
        _bottomLeft: IRadius,
        ...
        flutter.painting._mixedBorderRadius(
            this,
            _topLeft,
            _topRight,
            _bottomLeft,

...
declare const flutter: {
    painting: {
        _shapeDecorationPainter: (
            this: void,
            _shapeDecorationPainter: I_ShapeDecorationPainter,
            _decoration: IShapeDecoration,
            onChanged: () => void
        ) => I_ShapeDecorationPainter;
    };
};
...
export class _ShapeDecorationPainter implements IBoxPainter {

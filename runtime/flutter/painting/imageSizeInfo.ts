...
painting: {
imageSizeInfo: (this: void, imageSizeInfo: IImageSizeInfo, props : {  source? : string | undefined, displaySize : ISize, imageSize : ISize,}) => IImageSizeInfo
}
};
...
public constructor( props : {  source? : string | undefined, displaySize : ISize, imageSize : ISize,}){
flutter.painting.imageSizeInfo(this, props);}
    private readonly _dart_getDisplaySizeInBytes: () => number = undefined as any;
    private readonly _dart_getDecodedSizeInBytes: () => number = undefined as any;
    private readonly _dart_toJson: () => {[index: string]: Object | undefined} = undefined as any;

...
painting: {
colorProperty: (this: void, colorProperty: IColorProperty, name: string, value?: IColor | undefined, props : {  defaultValue? : Object | undefined, level : DiagnosticLevel, showName : boolean, style : DiagnosticsTreeStyle,}) => IColorProperty
}
};
...
getHashCode: () => number;
 ...
 implements IDiagnosticsProperty<IColor>
...
public constructor(name: string, value?: IColor | undefined, props : {  defaultValue? : Object | undefined, level? : DiagnosticLevel, showName? : boolean, style? : DiagnosticsTreeStyle,}){
flutter.painting.colorProperty(this, name, value, {
...colorPropertyDefaultProps,
...props
});}
    ...
    private readonly _dart_getValue: () => IColor | undefined = undefined as any;
...
public getValue() : IColor | undefined {
...
const colorPropertyDefaultProps = {

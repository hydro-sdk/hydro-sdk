...
declare const flutter: {
    painting: {
        ...
        matrixUtilsMatrixEquals: (
            a?: IMatrix4 | undefined,
            b?: IMatrix4 | undefined
        ) => boolean;
        ...
        matrixUtilsCreateCylindricalProjectionTransform: (props: {
            orientation: Axis;
            perspective: number;
            angle: number;
            radius: number;
...
export class MatrixUtils {
    ...
    public static inverseTransformRect(
        transform: IMatrix4,
        rect: IRect
    ): IRect {
        return flutter.painting.matrixUtilsInverseTransformRect(
            transform,
            rect
        );
    }
    public static createCylindricalProjectionTransform(props: {
        orientation?: Axis;
        perspective?: number;
        angle: number;
        radius: number;

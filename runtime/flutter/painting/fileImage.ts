...
painting: {
fileImage: (this: void, fileImage: IFileImage, file: IFile, props : {  scale : number,}) => IFileImage
}
};
...
resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: IFileImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void;
evict: ( props : {  cache? : IImageCache | undefined, configuration : IImageConfiguration,}) => IFuture<boolean>;
}export class FileImage

 implements IImageProvider<IFileImage>
...
...props
    ...
    private readonly _dart_obtainKey: (configuration: IImageConfiguration) => IFuture<IFileImage> = undefined as any;
    ...
    private readonly _dart_resolveStreamForKey: (configuration: IImageConfiguration, stream: IImageStream, key: IFileImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) => void = undefined as any;
...
public resolveStreamForKey(configuration: IImageConfiguration, stream: IImageStream, key: IFileImage, handleError : (exception: Object, stackTrace?: IStackTrace | undefined) => void) : void {

...
declare const flutter: {
    painting: {
        ...
        sweepGradientLerp: (
            a: ISweepGradient | undefined,
            b: ISweepGradient | undefined,
            t: number
        ) => ISweepGradient | undefined;
    };
};
...
export class SweepGradient implements IGradient {
    ...
    private readonly _dart_scale: (factor: number) => ISweepGradient =
        undefined as any;

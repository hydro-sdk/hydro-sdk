...
painting: {
_flutterLogoPainter: (this: void, _flutterLogoPainter: I_FlutterLogoPainter, _config: IFlutterLogoDecoration) => I_FlutterLogoPainter
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _FlutterLogoPainter

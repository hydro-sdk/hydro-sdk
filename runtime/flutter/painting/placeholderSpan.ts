...
painting: {
placeholderSpan: (this: void, placeholderSpan: IPlaceholderSpan, props : {  alignment : PlaceholderAlignment, baseline? : TextBaseline | undefined, style? : ITextStyle | undefined,}) => IPlaceholderSpan
}
};
...
}export class PlaceholderSpan

 implements IInlineSpan, IDiagnosticable
...
public constructor( props : {  alignment? : PlaceholderAlignment, baseline? : TextBaseline | undefined, style? : ITextStyle | undefined,}){

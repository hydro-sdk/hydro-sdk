...
export interface ITextPainter {
    ...
    setPlaceholderDimensions: (
        value?: IList<IPlaceholderDimensions> | undefined
    ) => void;
...
export class TextPainter {
    ...
    private readonly _dart_setTextScaleFactor: (value: number) => void =
        undefined as any;
    private readonly _dart_getEllipsis: () => string | undefined =
        undefined as any;
    private readonly _dart_setEllipsis: (value?: string | undefined) => void =
        undefined as any;
    ...
    private readonly _dart_getInlinePlaceholderBoxes: () =>
        | IList<ITextBox>
        | undefined = undefined as any;
    private readonly _dart_getInlinePlaceholderScales: () =>
        | IList<number>
        | undefined = undefined as any;
    private readonly _dart_setPlaceholderDimensions: (
        value?: IList<IPlaceholderDimensions> | undefined
    ) => void = undefined as any;
    ...
    private readonly _dart_getDidExceedMaxLines: () => boolean =
        undefined as any;
    private readonly _dart_layout: (props: {
        maxWidth: number;
        minWidth: number;
    }) => void = undefined as any;
    private readonly _dart_paint: (canvas: ICanvas, offset: IOffset) => void =
        undefined as any;
    private readonly _dart_getOffsetAfter: (
        offset: number
    ) => number | undefined = undefined as any;
    private readonly _dart_getOffsetBefore: (
        offset: number
    ) => number | undefined = undefined as any;
    ...
    public setPlaceholderDimensions(
        value?: IList<IPlaceholderDimensions> | undefined
    ): void {

...
declare const flutter: {
    painting: {
        ...
        resizeImageResizeIfNeeded: (
            ...
            provider: IImageProvider<Object>
...
export class ResizeImage implements IImageProvider<IResizeImageKey> {
    ...
    public static resizeIfNeeded(
        ...
        return flutter.painting.resizeImageResizeIfNeeded(
            cacheWidth,
            cacheHeight,
            provider
        );
    ...
    private readonly _dart_obtainKey: (
        configuration: IImageConfiguration
    ) => IFuture<IResizeImageKey> = undefined as any;

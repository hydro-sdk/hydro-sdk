...
painting: {
boxShadow: (this: void, boxShadow: IBoxShadow, props : {  blurRadius : number, blurStyle : BlurStyle, color : IColor, offset : IOffset, spreadRadius : number,}) => IBoxShadow;
boxShadowLerp: (a: IBoxShadow | undefined, b: IBoxShadow | undefined, t: number) => IBoxShadow | undefined;
boxShadowLerpList: (a: IList<IBoxShadow> | undefined, b: IList<IBoxShadow> | undefined, t: number) => IList<IBoxShadow> | undefined
}
};
...
public constructor( props : {  blurRadius? : number, blurStyle? : BlurStyle, color? : IColor, offset? : IOffset, spreadRadius? : number,}){
flutter.painting.boxShadow(this, {
...boxShadowDefaultProps,
...props
});}
public static lerp(a: IBoxShadow | undefined, b: IBoxShadow | undefined, t: number) : IBoxShadow | undefined{
return flutter.painting.boxShadowLerp(a, b, t);
}public static lerpList(a: IList<IBoxShadow> | undefined, b: IList<IBoxShadow> | undefined, t: number) : IList<IBoxShadow> | undefined{
return flutter.painting.boxShadowLerpList(a, b, t);
}    private readonly _dart_toPaint: () => IPaint = undefined as any;
    private readonly _dart_scale: (factor: number) => IBoxShadow = undefined as any;

...
declare const flutter: {
    animation: {
        catmullRomCurve: (
            this: void,
            catmullRomCurve: ICatmullRomCurve,
            controlPoints: IList<IOffset>,
            props: { tension: number }
        ) => ICatmullRomCurve;
        catmullRomCurveValidateControlPoints: (
            controlPoints?: IList<IOffset> | undefined,
            props: { reasons?: IList<string> | undefined; tension: number }
        ) => boolean;
    };
};
...
export class CatmullRomCurve implements ICurve {
    ...
    public static validateControlPoints(
        controlPoints?: IList<IOffset> | undefined,
        props: { reasons?: IList<string> | undefined; tension?: number }
    ): boolean {
        return flutter.animation.catmullRomCurveValidateControlPoints(
            controlPoints,
            {

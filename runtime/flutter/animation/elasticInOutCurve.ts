...
animation: {
elasticInOutCurve: (this: void, elasticInOutCurve: IElasticInOutCurve, period: number) => IElasticInOutCurve
}
};
export interface IElasticInOutCurve

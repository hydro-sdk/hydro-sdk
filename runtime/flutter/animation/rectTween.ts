...
animation: {
rectTween: (this: void, rectTween: IRectTween, props? : {  begin? : IRect | undefined, end? : IRect | undefined,}) => IRectTween
}
};
...
getHashCode: () => number;
 ...
 implements ITween<IRect?>
{    public readonly begin: IRect | undefined = undefined as any;
    public readonly end: IRect | undefined = undefined as any;
public constructor( props? : {  begin? : IRect | undefined, end? : IRect | undefined,}){
flutter.animation.rectTween(this, props);}
    private readonly _dart_lerp: (t: number) => IRect | undefined = undefined as any;
    private readonly _dart_transform: (t: number) => IRect | undefined = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (animation: IAnimation<number>) => IRect | undefined = undefined as any;
    private readonly _dart_animate: (parent: IAnimation<number>) => IAnimation<IRect | undefined> = undefined as any;
    private readonly _dart_chain: (parent: IAnimatable<number>) => IAnimatable<IRect | undefined> = undefined as any;

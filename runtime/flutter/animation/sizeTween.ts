...
declare const flutter: {
    animation: {
        sizeTween: (
            this: void,
            sizeTween: ISizeTween,
            props?: { begin?: ISize | undefined; end?: ISize | undefined }
        ) => ISizeTween;
    };
};
...
export class SizeTween implements ITween<?ISize> {
    ...
    private readonly _dart_lerp: (t: number) => ISize | undefined =
        undefined as any;
    private readonly _dart_transform: (t: number) => ISize | undefined =
        undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_evaluate: (
        animation: IAnimation<number>
    ) => ISize | undefined = undefined as any;
    private readonly _dart_animate: (
        parent: IAnimation<number>
    ) => IAnimation<ISize | undefined> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<ISize | undefined> = undefined as any;

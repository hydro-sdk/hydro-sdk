...
animation: {
compoundAnimation: <T>(this: void, compoundAnimation: ICompoundAnimation<T>, props : {  first : IAnimation<T>, next : IAnimation<T>,}) => ICompoundAnimation<T>
}
};
export interface ICompoundAnimation
<T>
...
<T>
 implements IAnimation<T>, IAnimationLazyListenerMixin, IAnimationLocalListenersMixin, IAnimationLocalStatusListenersMixin, IValueListenable<T>

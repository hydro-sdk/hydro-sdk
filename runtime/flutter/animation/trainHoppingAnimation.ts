...
animation: {
trainHoppingAnimation: (this: void, trainHoppingAnimation: ITrainHoppingAnimation, _currentTrain: IAnimation<number>, _nextTrain?: IAnimation<number> | undefined, props? : {  onSwitchedTrain? : () => void | undefined,}) => ITrainHoppingAnimation
}
};
...
{public constructor(_currentTrain: IAnimation<number>, _nextTrain?: IAnimation<number> | undefined, props? : {  onSwitchedTrain? : () => void | undefined,}){
flutter.animation.trainHoppingAnimation(this, _currentTrain, _nextTrain, props);}
    private readonly _dart_getCurrentTrain: () => IAnimation<number> | undefined = undefined as any;

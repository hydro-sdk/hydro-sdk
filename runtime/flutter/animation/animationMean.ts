...
animation: {
animationMean: (this: void, animationMean: IAnimationMean, props : {  left : IAnimation<number>, right : IAnimation<number>,}) => IAnimationMean
}
};
export interface IAnimationMean


{
first: IAnimation<number>;
next: IAnimation<number>;
getValue: () => number;
...
getHashCode: () => number;
}export class AnimationMean

 implements Omit<ICompoundAnimation<number>, "didStartListening" | "didStopListening" | "didRegisterListener" | "didUnregisterListener">, IAnimationLazyListenerMixin, IAnimationLocalListenersMixin, IAnimationLocalStatusListenersMixin, IValueListenable<number>
{    public readonly first: IAnimation<number> = undefined as any;
    public readonly next: IAnimation<number> = undefined as any;
public constructor( props : {  left : IAnimation<number>, right : IAnimation<number>,}){
flutter.animation.animationMean(this, props);}

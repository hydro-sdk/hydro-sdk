...
declare const flutter: {
    animation: {
        animationMean: (
            this: void,
            animationMean: IAnimationMean,
            props: { left: IAnimation<number>; right: IAnimation<number> }
        ) => IAnimationMean;
    };
};
        ...
        IValueListenable<number>
{
    ...
    public constructor(props: {
        left: IAnimation<number>;
        right: IAnimation<number>;
    }) {

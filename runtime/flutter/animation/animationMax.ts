...
animation: {
animationMax: <T>(this: void, animationMax: IAnimationMax<T>, first: IAnimation<T>, next: IAnimation<T>) => IAnimationMax<T>
}
};
export interface IAnimationMax
<T>
...
flutter.animation.animationMax(this, first, next);}

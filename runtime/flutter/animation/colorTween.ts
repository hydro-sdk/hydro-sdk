...
declare const flutter: {
    animation: {
        colorTween: (
            this: void,
            colorTween: IColorTween,
            props?: { begin?: IColor | undefined; end?: IColor | undefined }
        ) => IColorTween;
    };
};
...
export class ColorTween implements ITween<?IColor> {
    ...
    private readonly _dart_lerp: (t: number) => IColor | undefined =
        undefined as any;
    private readonly _dart_transform: (t: number) => IColor | undefined =
        undefined as any;
    ...
    ) => IAnimation<IColor | undefined> = undefined as any;
    private readonly _dart_chain: (
        parent: IAnimatable<number>
    ) => IAnimatable<IColor | undefined> = undefined as any;

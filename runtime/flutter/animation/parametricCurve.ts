...
animation: {
parametricCurve: <T>(this: void, parametricCurve: IParametricCurve<T>) => IParametricCurve<T>
}
};
export interface IParametricCurve
<T>
...
flutter.animation.parametricCurve(this);}
    ...
    private readonly _dart_transformInternal: (t: number) => T = undefined as any;

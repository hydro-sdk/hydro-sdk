...
declare const flutter: {
    animation: {
        _repeatingSimulation: (
            this: void,
            _repeatingSimulation: I_RepeatingSimulation,
            initialValue: number,
            min: number,
            max: number,
            reverse: boolean,
            period: IDuration,
            directionSetter: (direction: _AnimationDirection) => void
        ) => I_RepeatingSimulation;
    };
};
...
export class _RepeatingSimulation implements ISimulation {
    ...
    public constructor(
        ...
        flutter.animation._repeatingSimulation(
            this,
            initialValue,
            min,
            max,
    ...
    private readonly _dart_x: (timeInSeconds: number) => number =
        undefined as any;
    private readonly _dart_dx: (timeInSeconds: number) => number =
        undefined as any;
    private readonly _dart_isDone: (timeInSeconds: number) => boolean =
        undefined as any;

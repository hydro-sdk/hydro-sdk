...
animation: {
proxyAnimation: (this: void, proxyAnimation: IProxyAnimation, animation?: IAnimation<number> | undefined) => IProxyAnimation
}
};
...
getHashCode: () => number;
 ...
 implements IAnimation<number>, IAnimationLazyListenerMixin, IAnimationLocalListenersMixin, IAnimationLocalStatusListenersMixin, IValueListenable<number>
{public constructor(animation?: IAnimation<number> | undefined){
flutter.animation.proxyAnimation(this, animation);}
    private readonly _dart_getParent: () => IAnimation<number> | undefined = undefined as any;
    private readonly _dart_setParent: (value?: IAnimation<number> | undefined) => void = undefined as any;

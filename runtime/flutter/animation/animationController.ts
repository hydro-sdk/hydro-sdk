...
export interface IAnimationController {
    ...
    animateTo: (
        target: number,
        props: { curve: ICurve; duration?: IDuration | undefined }
    ) => ITickerFuture;
    animateBack: (
        target: number,
        props: { curve: ICurve; duration?: IDuration | undefined }
    ...
    repeat: (props: {
        ...
        period?: IDuration | undefined;
        reverse: boolean;
    }) => ITickerFuture;
    fling: (props: {
        animationBehavior?: AnimationBehavior | undefined;
        springDescription?: ISpringDescription | undefined;
        velocity: number;
    }) => ITickerFuture;
        ...
        IValueListenable<number>
{
    ...
    private readonly _dart_resync: (vsync: ITickerProvider) => void =
        undefined as any;
    ...
    private readonly _dart_getLastElapsedDuration: () => IDuration | undefined =
        undefined as any;
    ...
    private readonly _dart_forward: (props?: {
        from?: number | undefined;
    }) => ITickerFuture = undefined as any;
    private readonly _dart_reverse: (props?: {
        from?: number | undefined;
    }) => ITickerFuture = undefined as any;
    ...
    private readonly _dart_animateBack: (
        target: number,
        props: { curve: ICurve; duration?: IDuration | undefined }
    ) => ITickerFuture = undefined as any;
    private readonly _dart_repeat: (props: {
        max?: number | undefined;
        min?: number | undefined;
        period?: IDuration | undefined;
        reverse: boolean;
    }) => ITickerFuture = undefined as any;
    private readonly _dart_fling: (props: {
        animationBehavior?: AnimationBehavior | undefined;
        springDescription?: ISpringDescription | undefined;
        velocity: number;
    }) => ITickerFuture = undefined as any;
    private readonly _dart_animateWith: (

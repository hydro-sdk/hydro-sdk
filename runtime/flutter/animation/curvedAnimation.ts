...
animation: {
curvedAnimation: (this: void, curvedAnimation: ICurvedAnimation, props : {  reverseCurve? : ICurve | undefined, curve : ICurve, parent : IAnimation<number>,}) => ICurvedAnimation
}
};
...
getHashCode: () => number;
 ...
 implements IAnimation<number>, IAnimationWithParentMixin<number>, IValueListenable<number>
...
public constructor( props : {  reverseCurve? : ICurve | undefined, curve : ICurve, parent : IAnimation<number>,}){

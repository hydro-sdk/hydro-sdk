...
declare const flutter: {
    animation: {
        _interpolationSimulation: (
            this: void,
            _interpolationSimulation: I_InterpolationSimulation,
            _begin: number,
            _end: number,
            duration: IDuration,
            _curve: ICurve,
            scale: number
        ) => I_InterpolationSimulation;
    };
};
...
export class _InterpolationSimulation implements ISimulation {
    ...
    public constructor(
        ...
        flutter.animation._interpolationSimulation(
            this,
            _begin,
            _end,
            duration,

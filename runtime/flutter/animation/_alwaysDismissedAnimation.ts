...
animation: {
_alwaysDismissedAnimation: (this: void, _alwaysDismissedAnimation: I_AlwaysDismissedAnimation) => I_AlwaysDismissedAnimation
}
};
export interface I_AlwaysDismissedAnimation
...
getHashCode: () => number;
}export class _AlwaysDismissedAnimation

 implements IAnimation<number>, IValueListenable<number>
{public constructor(){
flutter.animation._alwaysDismissedAnimation(this);}

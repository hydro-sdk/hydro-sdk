...
animation: {
_chainedEvaluation: <T>(this: void, _chainedEvaluation: I_ChainedEvaluation<T>, _parent: IAnimatable<number>, _evaluatable: IAnimatable<T>) => I_ChainedEvaluation<T>
}
};
export interface I_ChainedEvaluation
<T>
...
getHashCode: () => number;
}export class _ChainedEvaluation
<T>
 implements IAnimatable<T>
{public constructor(_parent: IAnimatable<number>, _evaluatable: IAnimatable<T>){

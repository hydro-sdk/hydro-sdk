...
declare const flutter: {
    animation: {
        flippedTweenSequence: (
            this: void,
            flippedTweenSequence: IFlippedTweenSequence,
            items: IList<ITweenSequenceItem<number>>
        ) => IFlippedTweenSequence;
    };
};
...
export class FlippedTweenSequence implements ITweenSequence<number> {

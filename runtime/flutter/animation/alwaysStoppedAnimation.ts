...
animation: {
alwaysStoppedAnimation: <T>(this: void, alwaysStoppedAnimation: IAlwaysStoppedAnimation<T>, value: T) => IAlwaysStoppedAnimation<T>
}
};
export interface IAlwaysStoppedAnimation
<T>
...
getHashCode: () => number;
}export class AlwaysStoppedAnimation
<T>

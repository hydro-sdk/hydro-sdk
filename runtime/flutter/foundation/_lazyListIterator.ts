...
declare const flutter: {
    foundation: {
        _lazyListIterator: <E>(
            this: void,
            _lazyListIterator: I_LazyListIterator<E>,
            _owner: ICachingIterable<E>
        ) => I_LazyListIterator<E>;
    };
};
export interface I_LazyListIterator<E> {
    getCurrent: () => E;
    moveNext: () => boolean;
}
export class _LazyListIterator<E> implements IIterator<E> {

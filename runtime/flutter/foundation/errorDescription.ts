...
import { I_ErrorDiagnostic } from "./_errorDiagnostic";
...
foundation: {
errorDescription: (this: void, errorDescription: IErrorDescription, message: string) => IErrorDescription
}
};
...
flutter.foundation.errorDescription(this, message);}

...
declare const flutter: {
    foundation: {
        cachingIterable: <E>(
            this: void,
            cachingIterable: ICachingIterable<E>,
            _prefillIterator: IIterator<E>
        ) => ICachingIterable<E>;
    };
};
export interface ICachingIterable<E> {
...
export class CachingIterable<E> implements IIterableBase<E> {
    ...
    private readonly _dart_map: <T>(toElement: (e: E) => T) => IIterable<T> =
        undefined as any;
    private readonly _dart_where: (
        test: (element: E) => boolean
    ) => IIterable<E> = undefined as any;
    private readonly _dart_expand: <T>(
        toElements: (element: E) => IIterable<T>

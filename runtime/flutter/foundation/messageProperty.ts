...
foundation: {
messageProperty: (this: void, messageProperty: IMessageProperty, name: string, message: string, props : {  level : DiagnosticLevel, style : DiagnosticsTreeStyle,}) => IMessageProperty
}
};
...
getHashCode: () => number;
 ...
 implements IDiagnosticsProperty
...
public constructor(name: string, message: string, props : {  level? : DiagnosticLevel, style? : DiagnosticsTreeStyle,}){
flutter.foundation.messageProperty(this, name, message, {
...messagePropertyDefaultProps,
...props
});}
    ...
    private readonly _dart_getValue: () => void = undefined as any;
...
const messagePropertyDefaultProps = {

...
foundation: {
diagnosticableNode: <T>(this: void, diagnosticableNode: IDiagnosticableNode<T>, props : {  name? : string | undefined, style? : DiagnosticsTreeStyle | undefined, value : T,}) => IDiagnosticableNode<T>
}
};
export interface IDiagnosticableNode
<T>
...
getHashCode: () => number;
}export class DiagnosticableNode
<T>
...
public constructor( props : {  name? : string | undefined, style? : DiagnosticsTreeStyle | undefined, value : T,}){

...
export interface IFlagsSummary<T> {
...
export class FlagsSummary<T> implements IDiagnosticsProperty<IMap<string, ?T>> {
    ...
    private readonly _dart_getValue: () => { [index: string]: T | undefined } =
        undefined as any;

...
foundation: {
diagnosticPropertiesBuilder: (this: void, diagnosticPropertiesBuilder: IDiagnosticPropertiesBuilder) => IDiagnosticPropertiesBuilder
}
};
...
flutter.foundation.diagnosticPropertiesBuilder(this);}
    private readonly _dart_add: (property: IDiagnosticsNode) => void = undefined as any;

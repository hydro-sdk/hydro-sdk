...
declare const flutter: {
    foundation: {
        errorSpacer: (this: void, errorSpacer: IErrorSpacer) => IErrorSpacer;
    };
};
export interface IErrorSpacer {
...
export class ErrorSpacer implements IDiagnosticsProperty {
    ...
    public constructor() {
        flutter.foundation.errorSpacer(this);
    }

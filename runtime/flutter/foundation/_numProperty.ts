...
foundation: {
_numProperty: <T>(this: void, _numProperty: I_NumProperty<T>, name: string, value?: T | undefined, props : {  defaultValue? : Object | undefined, ifNull? : string | undefined, level : DiagnosticLevel, showName : boolean, style : DiagnosticsTreeStyle, tooltip? : string | undefined, unit? : string | undefined,}) => I_NumProperty<T>
}
};
export interface I_NumProperty
<T>
...
public constructor(name: string, value?: T | undefined, props : {  defaultValue? : Object | undefined, ifNull? : string | undefined, level? : DiagnosticLevel, showName? : boolean, style? : DiagnosticsTreeStyle, tooltip? : string | undefined, unit? : string | undefined,}){
flutter.foundation._numProperty(this, name, value, {
..._numPropertyDefaultProps,
...props
});}
...
const _numPropertyDefaultProps = {

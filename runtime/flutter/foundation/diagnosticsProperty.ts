...
foundation: {
diagnosticsProperty: <T>(this: void, diagnosticsProperty: IDiagnosticsProperty<T>, name?: string | undefined, value?: T | undefined, props : {  allowNameWrap : boolean, allowWrap : boolean, defaultValue? : Object | undefined, description? : string | undefined, expandableValue : boolean, ifEmpty? : string | undefined, ifNull? : string | undefined, level : DiagnosticLevel, linePrefix? : string | undefined, missingIfNull : boolean, showName : boolean, showSeparator : boolean, style : DiagnosticsTreeStyle, tooltip? : string | undefined,}) => IDiagnosticsProperty<T>
}
};
export interface IDiagnosticsProperty
<T>
...
getHashCode: () => number;
}export class DiagnosticsProperty
<T>

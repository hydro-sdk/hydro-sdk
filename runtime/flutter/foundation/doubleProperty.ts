...
import { I_NumProperty } from "./_numProperty";
...
foundation: {
doubleProperty: (this: void, doubleProperty: IDoubleProperty, name: string, value?: number | undefined, props : {  defaultValue? : Object | undefined, ifNull? : string | undefined, level : DiagnosticLevel, showName : boolean, style : DiagnosticsTreeStyle, tooltip? : string | undefined, unit? : string | undefined,}) => IDoubleProperty
}
};
export interface IDoubleProperty
...
getHashCode: () => number;
}export class DoubleProperty

 implements I_NumProperty<number>
{    public readonly unit: string | undefined = undefined as any;
...
public constructor(name: string, value?: number | undefined, props : {  defaultValue? : Object | undefined, ifNull? : string | undefined, level? : DiagnosticLevel, showName? : boolean, style? : DiagnosticsTreeStyle, tooltip? : string | undefined, unit? : string | undefined,}){
flutter.foundation.doubleProperty(this, name, value, {
...doublePropertyDefaultProps,
...props
});}
    private readonly _dart_numberToString: () => string = undefined as any;
...
public numberToString() : string {
    return this._dart_numberToString();
}
...
const doublePropertyDefaultProps = {

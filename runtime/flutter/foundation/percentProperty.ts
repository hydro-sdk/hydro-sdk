...
import { IDoubleProperty } from "./doubleProperty";
...
foundation: {
percentProperty: (this: void, percentProperty: IPercentProperty, name: string, fraction?: number | undefined, props : {  ifNull? : string | undefined, level : DiagnosticLevel, showName : boolean, tooltip? : string | undefined, unit? : string | undefined,}) => IPercentProperty
}
};
export interface IPercentProperty
...
public constructor(name: string, fraction?: number | undefined, props : {  ifNull? : string | undefined, level? : DiagnosticLevel, showName? : boolean, tooltip? : string | undefined, unit? : string | undefined,}){
flutter.foundation.percentProperty(this, name, fraction, {
...percentPropertyDefaultProps,
...props
});}
...
const percentPropertyDefaultProps = {

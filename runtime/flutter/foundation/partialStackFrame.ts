...
foundation: {
partialStackFrame: (this: void, partialStackFrame: IPartialStackFrame, props : {  className : string, method : string, package : IPattern,}) => IPartialStackFrame
}
};
...
{    public static asynchronousSuspension = new PartialStackFrame({ package: "", className: "", method: "asynchronous suspension" });
...
public constructor( props : {  className : string, method : string, package : IPattern,}){
flutter.foundation.partialStackFrame(this, props);}
    private readonly _dart_matches: (stackFrame: IStackFrame) => boolean = undefined as any;

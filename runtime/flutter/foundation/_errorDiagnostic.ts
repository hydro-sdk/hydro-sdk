...
foundation: {
_errorDiagnostic: (this: void, _errorDiagnostic: I_ErrorDiagnostic, message: string, props : {  level : DiagnosticLevel, style : DiagnosticsTreeStyle,}) => I_ErrorDiagnostic
}
};
export interface I_ErrorDiagnostic
...
getHashCode: () => number;
 ...
 implements IDiagnosticsProperty<IList<Object>>
...
public constructor(message: string, props : {  level? : DiagnosticLevel, style? : DiagnosticsTreeStyle,}){
flutter.foundation._errorDiagnostic(this, message, {
..._errorDiagnosticDefaultProps,
...props
});}
    private readonly _dart_getValue: () => IList<Object> = undefined as any;
...
const _errorDiagnosticDefaultProps = {

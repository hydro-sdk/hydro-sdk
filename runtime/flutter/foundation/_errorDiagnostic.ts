...
declare const flutter: {
    foundation: {
        _errorDiagnostic: (
            this: void,
            _errorDiagnostic: I_ErrorDiagnostic,
            message: string,
            props: { level: DiagnosticLevel; style: DiagnosticsTreeStyle }
        ) => I_ErrorDiagnostic;
    };
};
...
export class _ErrorDiagnostic implements IDiagnosticsProperty<IList<Object>> {

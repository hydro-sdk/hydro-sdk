...
declare const flutter: {
    foundation: {
        licenseEntryWithLineBreaks: (
            this: void,
            licenseEntryWithLineBreaks: ILicenseEntryWithLineBreaks,
            packages: IList<string>,
            text: string
        ) => ILicenseEntryWithLineBreaks;
    };
};
...
export class LicenseEntryWithLineBreaks implements ILicenseEntry {
    ...
    private readonly _dart_getParagraphs: () => IIterable<ILicenseParagraph> =
        undefined as any;

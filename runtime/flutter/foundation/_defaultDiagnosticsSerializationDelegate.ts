...
foundation: {
_defaultDiagnosticsSerializationDelegate: (this: void, _defaultDiagnosticsSerializationDelegate: I_DefaultDiagnosticsSerializationDelegate, props : {  includeProperties : boolean, subtreeDepth : number,}) => I_DefaultDiagnosticsSerializationDelegate
}
};
...
public constructor( props : {  includeProperties? : boolean, subtreeDepth? : number,}){

...
foundation: {
objectFlagProperty: <T>(this: void, objectFlagProperty: IObjectFlagProperty<T>, name: string, value?: T | undefined, props : {  ifNull? : string | undefined, ifPresent? : string | undefined, level : DiagnosticLevel, showName : boolean,}) => IObjectFlagProperty<T>
}
};
export interface IObjectFlagProperty
<T>

{
ifPresent: string | undefined;
...
getHashCode: () => number;
}export class ObjectFlagProperty
<T>
 implements IDiagnosticsProperty<T>
{    public readonly ifPresent: string | undefined = undefined as any;
...
public constructor(name: string, value?: T | undefined, props : {  ifNull? : string | undefined, ifPresent? : string | undefined, level? : DiagnosticLevel, showName? : boolean,}){
flutter.foundation.objectFlagProperty(this, name, value, {
...objectFlagPropertyDefaultProps,
...props
});}
...
const objectFlagPropertyDefaultProps = {

...
declare const flutter: {
    foundation: {
        objectFlagProperty: <T>(
            this: void,
            objectFlagProperty: IObjectFlagProperty<T>,
            name: string,
            value?: T | undefined,
            props: {
        ...
        ) => IObjectFlagProperty<T>;
    };
};
export interface IObjectFlagProperty<T> {
    ifPresent: string | undefined;
...
export class ObjectFlagProperty<T> implements IDiagnosticsProperty<T> {

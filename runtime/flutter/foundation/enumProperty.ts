...
declare const flutter: {
    foundation: {
        enumProperty: <T>(
            this: void,
            enumProperty: IEnumProperty<T>,
            name: string,
            value?: T | undefined,
            props: { defaultValue?: Object | undefined; level: DiagnosticLevel }
        ) => IEnumProperty<T>;
    };
};
export interface IEnumProperty<T> {
...
export class EnumProperty<T> implements IDiagnosticsProperty<T> {

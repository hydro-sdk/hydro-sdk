...
foundation: {
diagnosticsStackTrace: (this: void, diagnosticsStackTrace: IDiagnosticsStackTrace, name: string, stack?: IStackTrace | undefined, props : {  showSeparator : boolean, stackFilter? : (input: IIterable<string>) => IIterable<string> | undefined,}) => IDiagnosticsStackTrace
}
};
...
public constructor(name: string, stack?: IStackTrace | undefined, props : {  showSeparator? : boolean, stackFilter? : (input: IIterable<string>) => IIterable<string> | undefined,}){

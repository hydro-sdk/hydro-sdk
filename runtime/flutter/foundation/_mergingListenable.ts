...
foundation: {
_mergingListenable: (this: void, _mergingListenable: I_MergingListenable, _children: IList<IListenable | undefined>) => I_MergingListenable
}
};
...
toString: () => string;
getHashCode: () => number;
}export class _MergingListenable

...
foundation: {
flutterError: (this: void, flutterError: IFlutterError, message: string) => IFlutterError;
flutterErrorResetErrorCount: () => void;
flutterErrorDumpErrorToConsole: (details: IFlutterErrorDetails, props : {  forceReport : boolean,}) => void;
flutterErrorAddDefaultStackFilter: (filter: IStackFilter) => void;
flutterErrorDefaultStackFilter: (frames: IIterable<string>) => IIterable<string>;
...
getHashCode: () => number;
 ...
 implements IError, IDiagnosticableTreeMixin, IDiagnosticable, IAssertionError, Omit<IDiagnosticableTree, "toStringShallow" | "toStringDeep" | "debugDescribeChildren" | "debugFillProperties" | "toStringShort" | "toDiagnosticsNode">
...
}public static dumpErrorToConsole(details: IFlutterErrorDetails, props : {  forceReport? : boolean,}) : void{
...
}public static defaultStackFilter(frames: IIterable<string>) : IIterable<string>{
...
return flutter.foundation.flutterErrorReportError(details);
    ...
    private readonly _dart_getStackTrace: () => IStackTrace | undefined = undefined as any;

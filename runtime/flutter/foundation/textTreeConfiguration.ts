...
foundation: {
textTreeConfiguration: (this: void, textTreeConfiguration: ITextTreeConfiguration, props : {  addBlankLineIfNoChildren : boolean, afterDescription : string, afterDescriptionIfBody : string, afterName : string, afterProperties : string, beforeName : string, beforeProperties : string, bodyIndent : string, footer : string, isBlankLineBetweenPropertiesAndChildren : boolean, isNameOnOwnLine : boolean, lineBreak : string, lineBreakProperties : boolean, mandatoryAfterProperties : string, mandatoryFooter : string, propertySeparator : string, showChildren : boolean, suffixLineOne : string, linkCharacter : string, prefixLastChildLineOne : string, prefixLineOne : string, prefixOtherLines : string, prefixOtherLinesRootNode : string, propertyPrefixIfChildren : string, propertyPrefixNoChildren : string,}) => ITextTreeConfiguration
}
};

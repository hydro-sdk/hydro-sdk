...
declare const flutter: {
    foundation: {
        iterableProperty: <T>(
            this: void,
            iterableProperty: IIterableProperty<T>,
            name: string,
            value?: IIterable<T> | undefined,
            props: {
...
export interface IIterableProperty<T> {
...
export class IterableProperty<T> implements IDiagnosticsProperty<IIterable<T>> {
    ...
    private readonly _dart_getValue: () => IIterable<T> | undefined =
        undefined as any;

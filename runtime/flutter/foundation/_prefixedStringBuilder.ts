declare const flutter: {
    foundation: {
        _prefixedStringBuilder: (
            this: void,
            _prefixedStringBuilder: I_PrefixedStringBuilder,
            props: {
                wrapWidth?: number | undefined;
                prefixLineOne: string;
                prefixOtherLines?: string | undefined;
            }
        ) => I_PrefixedStringBuilder;
    };
};
export interface I_PrefixedStringBuilder {
    ...
    incrementPrefixOtherLines: (
        suffix: string,
        props: { updateCurrentLine: boolean }
    ) => void;
...
export class _PrefixedStringBuilder {
    ...
    private readonly _dart_getPrefixOtherLines: () => string | undefined =
        undefined as any;
    private readonly _dart_setPrefixOtherLines: (
        prefix?: string | undefined
    ) => void = undefined as any;
    private readonly _dart_incrementPrefixOtherLines: (
        suffix: string,
        props: { updateCurrentLine: boolean }
    ) => void = undefined as any;
    private readonly _dart_getRequiresMultipleLines: () => boolean =
        undefined as any;
    private readonly _dart_getIsCurrentLineEmpty: () => boolean =
        undefined as any;
    private readonly _dart_write: (
        s: string,
        props: { allowWrap: boolean }
    ) => void = undefined as any;
    private readonly _dart_writeRawLines: (lines: string) => void =
        undefined as any;
    private readonly _dart_writeStretched: (
        text: string,
    ...
    public incrementPrefixOtherLines(
        suffix: string,
        props: { updateCurrentLine: boolean }
    ): void {

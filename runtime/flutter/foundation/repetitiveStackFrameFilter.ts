...
foundation: {
repetitiveStackFrameFilter: (this: void, repetitiveStackFrameFilter: IRepetitiveStackFrameFilter, props : {  frames : IList<IPartialStackFrame>, replacement : string,}) => IRepetitiveStackFrameFilter
}
};
...
toString: () => string;
getHashCode: () => number;
}export class RepetitiveStackFrameFilter
...
public constructor( props : {  frames : IList<IPartialStackFrame>, replacement : string,}){
flutter.foundation.repetitiveStackFrameFilter(this, props);}
    private readonly _dart_getNumFrames: () => number = undefined as any;
    private readonly _dart_filter: (stackFrames: IList<IStackFrame>, reasons: IList<string | undefined>) => void = undefined as any;
    private readonly _dart_toString: () => string = undefined as any;
    private readonly _dart_getHashCode: () => number = undefined as any;
public getNumFrames() : number {
    return this._dart_getNumFrames();
}
public filter(stackFrames: IList<IStackFrame>, reasons: IList<string | undefined>) : void {

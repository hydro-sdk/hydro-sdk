...
foundation: {
diagnosticsNode: (this: void, diagnosticsNode: IDiagnosticsNode, props : {  linePrefix? : string | undefined, showName : boolean, showSeparator : boolean, style? : DiagnosticsTreeStyle | undefined, name? : string | undefined,}) => IDiagnosticsNode;
diagnosticsNodeMessage: (message: string, props : {  allowWrap : boolean, level : DiagnosticLevel, style : DiagnosticsTreeStyle,}) => IDiagnosticsNode;
diagnosticsNodeToJsonList: (nodes: IList<IDiagnosticsNode> | undefined, parent: IDiagnosticsNode | undefined, delegate: IDiagnosticsSerializationDelegate) => IList<{[index: string]: Object | undefined}>
}
};
...
toDescription: ( props? : {  parentConfiguration? : ITextTreeConfiguration | undefined,}) => string | undefined;
...
public constructor( props : {  linePrefix? : string | undefined, showName? : boolean, showSeparator? : boolean, style? : DiagnosticsTreeStyle | undefined, name? : string | undefined,}){
...
}public static toJsonList(nodes: IList<IDiagnosticsNode> | undefined, parent: IDiagnosticsNode | undefined, delegate: IDiagnosticsSerializationDelegate) : IList<{[index: string]: Object | undefined}>{
return flutter.foundation.diagnosticsNodeToJsonList(nodes, parent, delegate);
}    private readonly _dart_toDescription: ( props? : {  parentConfiguration? : ITextTreeConfiguration | undefined,}) => string | undefined = undefined as any;
    ...
    private readonly _dart_getValue: () => Object | undefined = undefined as any;
...
public toDescription( props? : {  parentConfiguration? : ITextTreeConfiguration | undefined,}) : string | undefined {

...
declare const dart: {
ui: {
shadow: (this: void, shadow: IShadow, props : { blurRadius : number, color : IColor, offset : IOffset, }) => IShadow;
shadowConvertRadiusToSigma: (radius: number) => number;
shadowLerp: (a: IShadow | undefined, b: IShadow | undefined, t: number) => IShadow | undefined;
shadowLerpList: (a: IList<IShadow> | undefined, b: IList<IShadow> | undefined, t: number) => IList<IShadow> | undefined
}
};
const shadowDefaultProps = {
    blurRadius: 0.0,
    color: const Color(_kColorDefault),
    offset: Offset.zero
};
...
public constructor( props : { blurRadius? : number, color? : IColor, offset? : IOffset, }){
dart.ui.shadow(this, {
...shadowDefaultProps,
...props
});}
...
}public static lerp(a: IShadow | undefined, b: IShadow | undefined, t: number) : IShadow | undefined{
return dart.ui.shadowLerp(a, b, t);
}public static lerpList(a: IList<IShadow> | undefined, b: IList<IShadow> | undefined, t: number) : IList<IShadow> | undefined{
return dart.ui.shadowLerpList(a, b, t);
    ...
    private readonly _dart_scale: (factor: number) => IShadow = undefined as any;

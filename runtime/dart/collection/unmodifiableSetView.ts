...
import { ISetBase } from "./setBase";
import { ISetMixin } from "./setMixin";
declare const dart: {
    collection: {
        unmodifiableSetView: <E>(
            this: void,
            unmodifiableSetView: IUnmodifiableSetView<E>,
            source: ISet<E>
        ) => IUnmodifiableSetView<E>;
    };
};
export interface IUnmodifiableSetView<E> {
...
export class UnmodifiableSetView<E>
    implements
        Omit<
            ISetBase<E>,
            | "add"
        ...
        ISet<E>
{
    public constructor(source: ISet<E>) {
        dart.collection.unmodifiableSetView(this, source);
    }

...
declare const dart: {
    collection: {
        ...
        hashSetIdentity: <E>() => IHashSet<E>;
        hashSetFrom: <E>(elements: IIterable<any>) => IHashSet<E>;
        hashSetOf: <E>(elements: IIterable<E>) => IHashSet<E>;
    };
};
export interface IHashSet<E> {
...
export class HashSet<E> implements IEfficientLengthIterable<E>, ISet<E> {
    public constructor(props?: {
        ...
        dart.collection.hashSet(this, props);
    }
    public static identity<E>(): IHashSet<E> {
        return dart.collection.hashSetIdentity();
    }
    public static from<E>(elements: IIterable<any>): IHashSet<E> {
        return dart.collection.hashSetFrom(elements);
    }
    public static of<E>(elements: IIterable<E>): IHashSet<E> {
        return dart.collection.hashSetOf(elements);
    }

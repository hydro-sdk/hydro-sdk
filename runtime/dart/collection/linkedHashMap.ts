...
declare const dart: {
    collection: {
        ...
        linkedHashMapIdentity: <K, V>() => ILinkedHashMap<K, V>;
        linkedHashMapFrom: <K, V>(
            other: IMap<any, any>
        ) => ILinkedHashMap<K, V>;
        ...
        linkedHashMapFromIterables: <K, V>(
            keys: IIterable<K>,
            values: IIterable<V>
        ) => ILinkedHashMap<K, V>;
        linkedHashMapFromEntries: <K, V>(
...
export class LinkedHashMap<K, V> implements IMap<K, V> {
    public constructor(props?: {
        ...
        dart.collection.linkedHashMap(this, props);
    }
    public static identity<K, V>(): ILinkedHashMap<K, V> {
        return dart.collection.linkedHashMapIdentity();
    }
    public static from<K, V>(other: IMap<any, any>): ILinkedHashMap<K, V> {
        return dart.collection.linkedHashMapFrom(other);
    }
    public static of<K, V>(other: IMap<K, V>): ILinkedHashMap<K, V> {
        return dart.collection.linkedHashMapOf(other);
    }
    public static fromIterable<K, V>(
        ...
        return dart.collection.linkedHashMapFromIterable(iterable, props);
    }
    public static fromIterables<K, V>(
        keys: IIterable<K>,
        values: IIterable<V>
    ): ILinkedHashMap<K, V> {
        return dart.collection.linkedHashMapFromIterables(keys, values);
    }
    public static fromEntries<K, V>(
        entries: IIterable<IMapEntry<K, V>>
    ): ILinkedHashMap<K, V> {
        return dart.collection.linkedHashMapFromEntries(entries);
    }

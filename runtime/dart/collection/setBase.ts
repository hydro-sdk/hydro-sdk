...
declare const dart: {
    collection: {
        setBaseSetToString: (set: ISet<any>) => string;
    };
};
export interface ISetBase<E> {
    add: (value: E) => boolean;
...
export class SetBase<E> implements ISetMixin<E>, ISet<E> {
    public static setToString(set: ISet<any>): string {
        return dart.collection.setBaseSetToString(set);
    }

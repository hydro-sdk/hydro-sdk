...
declare const dart: {
    typed_data: {
        int32List: (
            this: void,
            int32List: IInt32List,
            length: number
        ) => IInt32List;
        int32ListFromList: (elements: IList<number>) => IInt32List;
        int32ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IInt32List;
        int32ListSublistView: (
            data: ITypedData,
            start: number,
...
export class Int32List implements IList<number>, I_TypedIntList {
    ...
    public static fromList(elements: IList<number>): IInt32List {
        return dart.typed_data.int32ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.int32ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.int32ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IInt32List {

...
declare const dart: {
    typed_data: {
        unmodifiableUint64ListView: (
            this: void,
            unmodifiableUint64ListView: IUnmodifiableUint64ListView,
            list: IUint64List
...
export class UnmodifiableUint64ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IUint64List, IUint64List>,
...
{
    public constructor(list: IUint64List) {
        dart.typed_data.unmodifiableUint64ListView(this, list);
    }

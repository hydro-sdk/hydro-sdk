...
declare const dart: {
    typed_data: {
        int16List: (
            this: void,
            int16List: IInt16List,
            length: number
        ) => IInt16List;
        int16ListFromList: (elements: IList<number>) => IInt16List;
        int16ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IInt16List;
        int16ListSublistView: (
            data: ITypedData,
            start: number,
...
export class Int16List implements IList<number>, I_TypedIntList {
    public static bytesPerElement = 2;
    public constructor(length: number) {
        dart.typed_data.int16List(this, length);
    }
    public static fromList(elements: IList<number>): IInt16List {
        return dart.typed_data.int16ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.int16ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.int16ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IInt16List {

...
declare const dart: {
    typed_data: {
        unmodifiableFloat32ListView: (
            this: void,
            unmodifiableFloat32ListView: IUnmodifiableFloat32ListView,
            list: IFloat32List
        ) => IUnmodifiableFloat32ListView;
    };
};
export interface IUnmodifiableFloat32ListView {
    lastIndexOf: (
...
{
    public constructor(list: IFloat32List) {
        dart.typed_data.unmodifiableFloat32ListView(this, list);
    }

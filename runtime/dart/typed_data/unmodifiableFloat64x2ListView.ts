...
declare const dart: {
    typed_data: {
        unmodifiableFloat64x2ListView: (
            this: void,
            unmodifiableFloat64x2ListView: IUnmodifiableFloat64x2ListView,
            list: IFloat64x2List
        ) => IUnmodifiableFloat64x2ListView;
    };
};
...
export class UnmodifiableFloat64x2ListView
    implements
        ...
        IList<IFloat64x2>,
        ITypedData,
        IEfficientLengthIterable<IFloat64x2>
{
    public constructor(list: IFloat64x2List) {
        dart.typed_data.unmodifiableFloat64x2ListView(this, list);
    }

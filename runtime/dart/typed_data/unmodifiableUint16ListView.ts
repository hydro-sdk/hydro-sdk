...
declare const dart: {
    typed_data: {
        unmodifiableUint16ListView: (
            this: void,
            unmodifiableUint16ListView: IUnmodifiableUint16ListView,
            list: IUint16List
        ) => IUnmodifiableUint16ListView;
    };
};
export interface IUnmodifiableUint16ListView {
    lastIndexOf: (
...
export class UnmodifiableUint16ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IUint16List, IUint16List>,
...
{
    public constructor(list: IUint16List) {
        dart.typed_data.unmodifiableUint16ListView(this, list);
    }

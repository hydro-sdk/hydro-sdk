...
declare const dart: {
    typed_data: {
        float32x4: (
            this: void,
            float32x4: IFloat32x4,
            x: number,
            y: number,
            z: number,
            w: number
        ) => IFloat32x4;
        float32x4Splat: (v: number) => IFloat32x4;
        float32x4Zero: () => IFloat32x4;
        float32x4FromInt32x4Bits: (x: IInt32x4) => IFloat32x4;
        float32x4FromFloat64x2: (v: IFloat64x2) => IFloat32x4;
    };
};
export interface IFloat32x4 {
...
export class Float32x4 {
    ...
    public constructor(x: number, y: number, z: number, w: number) {
        dart.typed_data.float32x4(this, x, y, z, w);
    }
    public static splat(v: number): IFloat32x4 {
        return dart.typed_data.float32x4Splat(v);
    }
    public static zero(): IFloat32x4 {
        return dart.typed_data.float32x4Zero();
    }
    public static fromInt32x4Bits(x: IInt32x4): IFloat32x4 {
        return dart.typed_data.float32x4FromInt32x4Bits(x);
    }
    ...
    private readonly _dart_clamp: (
        lowerLimit: IFloat32x4,
        upperLimit: IFloat32x4
    ...
    private readonly _dart_withX: (x: number) => IFloat32x4 = undefined as any;
    ...
    public lessThan(other: IFloat32x4): IInt32x4 {
        return this._dart_lessThan(other);
    }
    public lessThanOrEqual(other: IFloat32x4): IInt32x4 {
        return this._dart_lessThanOrEqual(other);
    }
    public greaterThan(other: IFloat32x4): IInt32x4 {
        return this._dart_greaterThan(other);
    }
    public greaterThanOrEqual(other: IFloat32x4): IInt32x4 {
        return this._dart_greaterThanOrEqual(other);
    }
    public equal(other: IFloat32x4): IInt32x4 {
        return this._dart_equal(other);
    }
    public notEqual(other: IFloat32x4): IInt32x4 {
        return this._dart_notEqual(other);
    }
    public scale(s: number): IFloat32x4 {
        return this._dart_scale(s);
    }
    public abs(): IFloat32x4 {
        return this._dart_abs();
    }
    public clamp(lowerLimit: IFloat32x4, upperLimit: IFloat32x4): IFloat32x4 {
    ...
    public shuffle(mask: number): IFloat32x4 {
        return this._dart_shuffle(mask);
    }
    public shuffleMix(other: IFloat32x4, mask: number): IFloat32x4 {
        return this._dart_shuffleMix(other, mask);
    }
    public withX(x: number): IFloat32x4 {
        return this._dart_withX(x);
    }
    public withY(y: number): IFloat32x4 {
        return this._dart_withY(y);
    }
    public withZ(z: number): IFloat32x4 {
        return this._dart_withZ(z);
    }
    public withW(w: number): IFloat32x4 {
        return this._dart_withW(w);
    }
    public min(other: IFloat32x4): IFloat32x4 {
        return this._dart_min(other);
    }
    public max(other: IFloat32x4): IFloat32x4 {
        return this._dart_max(other);
    }
    public sqrt(): IFloat32x4 {
        return this._dart_sqrt();
    }
    public reciprocal(): IFloat32x4 {
        return this._dart_reciprocal();
    }
    public reciprocalSqrt(): IFloat32x4 {
        return this._dart_reciprocalSqrt();
    }
}

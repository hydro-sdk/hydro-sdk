...
declare const dart: {
    typed_data: {
        uint64List: (
            this: void,
            uint64List: IUint64List,
            length: number
        ) => IUint64List;
        uint64ListFromList: (elements: IList<number>) => IUint64List;
        uint64ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IUint64List;
        uint64ListSublistView: (
            data: ITypedData,
            start: number,
...
export class Uint64List implements IList<number>, I_TypedIntList {
    public static bytesPerElement = 8;
    public constructor(length: number) {
        dart.typed_data.uint64List(this, length);
    }
    public static fromList(elements: IList<number>): IUint64List {
        return dart.typed_data.uint64ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.uint64ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.uint64ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IUint64List {

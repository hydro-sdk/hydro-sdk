...
declare const dart: {
    typed_data: {
        uint8ClampedList: (
            this: void,
            uint8ClampedList: IUint8ClampedList,
            length: number
        ) => IUint8ClampedList;
        uint8ClampedListFromList: (
            elements: IList<number>
        ) => IUint8ClampedList;
...
export class Uint8ClampedList implements IList<number>, I_TypedIntList {
    public static bytesPerElement = 1;
    public constructor(length: number) {
        dart.typed_data.uint8ClampedList(this, length);
    }
    public static fromList(elements: IList<number>): IUint8ClampedList {
        return dart.typed_data.uint8ClampedListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.uint8ClampedListView(
            buffer,
            offsetInBytes,
            length
        );
    ...
    public static sublistView(
        ...
        return dart.typed_data.uint8ClampedListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IUint8ClampedList {

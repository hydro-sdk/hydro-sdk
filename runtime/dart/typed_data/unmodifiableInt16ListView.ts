...
declare const dart: {
    typed_data: {
        unmodifiableInt16ListView: (
            this: void,
            unmodifiableInt16ListView: IUnmodifiableInt16ListView,
            list: IInt16List
        ) => IUnmodifiableInt16ListView;
    };
};
...
export class UnmodifiableInt16ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IInt16List, IInt16List>,
...
{
    public constructor(list: IInt16List) {
        dart.typed_data.unmodifiableInt16ListView(this, list);
    }

...
declare const dart: {
    typed_data: {
        unmodifiableInt64ListView: (
            this: void,
            unmodifiableInt64ListView: IUnmodifiableInt64ListView,
            list: IInt64List
        ) => IUnmodifiableInt64ListView;
    };
};
export interface IUnmodifiableInt64ListView {
    lastIndexOf: (
...
export class UnmodifiableInt64ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IInt64List, IInt64List>,
...
{
    public constructor(list: IInt64List) {
        dart.typed_data.unmodifiableInt64ListView(this, list);
    }

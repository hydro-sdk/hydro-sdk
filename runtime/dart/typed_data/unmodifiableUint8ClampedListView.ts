...
declare const dart: {
    typed_data: {
        unmodifiableUint8ClampedListView: (
            this: void,
            unmodifiableUint8ClampedListView: IUnmodifiableUint8ClampedListView,
            list: IUint8ClampedList
        ) => IUnmodifiableUint8ClampedListView;
    };
};
export interface IUnmodifiableUint8ClampedListView {
    lastIndexOf: (
...
export class UnmodifiableUint8ClampedListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IUint8ClampedList, IUint8ClampedList>,
...
{
    public constructor(list: IUint8ClampedList) {
        dart.typed_data.unmodifiableUint8ClampedListView(this, list);
    }

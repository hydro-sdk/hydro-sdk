...
declare const dart: {
    typed_data: {
        uint32List: (
            this: void,
            uint32List: IUint32List,
            length: number
        ) => IUint32List;
        uint32ListFromList: (elements: IList<number>) => IUint32List;
        uint32ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IUint32List;
        uint32ListSublistView: (
            data: ITypedData,
            start: number,
...
export class Uint32List implements IList<int>, I_TypedIntList {
    public static bytesPerElement = 4;
    public constructor(length: number) {
        dart.typed_data.uint32List(this, length);
    }
    public static fromList(elements: IList<number>): IUint32List {
        return dart.typed_data.uint32ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.uint32ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.uint32ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IUint32List {

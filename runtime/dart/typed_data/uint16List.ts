...
declare const dart: {
    typed_data: {
        uint16List: (
            this: void,
            uint16List: IUint16List,
            length: number
        ) => IUint16List;
        uint16ListFromList: (elements: IList<number>) => IUint16List;
        uint16ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IUint16List;
        uint16ListSublistView: (
            data: ITypedData,
            start: number,
...
export interface IUint16List {
    sublist: (start: number, end?: number | undefined) => IUint16List;
    cast: <R>() => IList<R>;
...
export class Uint16List implements IList<number>, I_TypedIntList {
    ...
    public static fromList(elements: IList<number>): IUint16List {
        return dart.typed_data.uint16ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.uint16ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.uint16ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IUint16List {

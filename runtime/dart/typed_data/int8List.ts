...
declare const dart: {
    typed_data: {
        ...
        int8ListFromList: (elements: IList<number>) => IInt8List;
        int8ListView: (
            buffer: IByteBuffer,
...
export class Int8List implements IList<number>, I_TypedIntList {
    ...
    public static fromList(elements: IList<number>): IInt8List {
        return dart.typed_data.int8ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.int8ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.int8ListSublistView(data, start, end);
    }

...
declare const dart: {
    typed_data: {
        float32List: (
            this: void,
            float32List: IFloat32List,
            length: number
        ) => IFloat32List;
        float32ListFromList: (elements: IList<number>) => IFloat32List;
        float32ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IFloat32List;
        float32ListSublistView: (
            data: ITypedData,
            start: number,
...
export interface IFloat32List {
    sublist: (start: number, end?: number | undefined) => IFloat32List;
    cast: <R>() => IList<R>;
...
export class Float32List implements IList<number>, I_TypedFloatList {
    ...
    public static fromList(elements: IList<number>): IFloat32List {
        return dart.typed_data.float32ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.float32ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.float32ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IFloat32List {

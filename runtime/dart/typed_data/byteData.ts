...
export class ByteData implements ITypedData {
    public constructor(length: number) {
        dart.typed_data.byteData(this, length);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.byteDataView(buffer, offsetInBytes, length);
    }

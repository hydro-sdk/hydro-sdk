...
declare const dart: {
    typed_data: {
        unmodifiableUint8ListView: (
            this: void,
            unmodifiableUint8ListView: IUnmodifiableUint8ListView,
            list: IUint8List
        ) => IUnmodifiableUint8ListView;
    };
};
export interface IUnmodifiableUint8ListView {
    lastIndexOf: (
...
export class UnmodifiableUint8ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IUint8List, IUint8List>,
...
{
    public constructor(list: IUint8List) {
        dart.typed_data.unmodifiableUint8ListView(this, list);
    }

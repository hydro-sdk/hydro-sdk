...
declare const dart: {
    typed_data: {
        unmodifiableUint32ListView: (
            this: void,
            unmodifiableUint32ListView: IUnmodifiableUint32ListView,
            list: IUint32List
        ) => IUnmodifiableUint32ListView;
    };
};
export interface IUnmodifiableUint32ListView {
    lastIndexOf: (
...
export class UnmodifiableUint32ListView
    implements
        Omit<
            ...
            | "isNotEmpty"
        >,
        I_UnmodifiableListMixin<number, IUint32List, IUint32List>,
...
{
    public constructor(list: IUint32List) {
        dart.typed_data.unmodifiableUint32ListView(this, list);
    }

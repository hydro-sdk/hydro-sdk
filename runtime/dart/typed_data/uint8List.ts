...
declare const dart: {
    typed_data: {
        uint8List: (
            this: void,
            uint8List: IUint8List,
            length: number
        ) => IUint8List;
        uint8ListFromList: (elements: IList<number>) => IUint8List;
        uint8ListView: (
            buffer: IByteBuffer,
            offsetInBytes: number,
            length?: number | undefined
        ) => IUint8List;
        uint8ListSublistView: (
            data: ITypedData,
            start: number,
...
export interface IUint8List {
    sublist: (start: number, end?: number | undefined) => IUint8List;
    cast: <R>() => IList<R>;
...
export class Uint8List implements IList<number>, I_TypedIntList {
    public static bytesPerElement = 1;
    public constructor(length: number) {
        dart.typed_data.uint8List(this, length);
    }
    public static fromList(elements: IList<number>): IUint8List {
        return dart.typed_data.uint8ListFromList(elements);
    }
    public static view(
        buffer: IByteBuffer,
        ...
        return dart.typed_data.uint8ListView(buffer, offsetInBytes, length);
    }
    public static sublistView(
        ...
        return dart.typed_data.uint8ListSublistView(data, start, end);
    }
    ...
    public sublist(start: number, end?: number | undefined): IUint8List {

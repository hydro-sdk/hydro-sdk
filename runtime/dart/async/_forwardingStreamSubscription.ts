...
declare const dart: {
    async: {
        _forwardingStreamSubscription: <S, T>(
            this: void,
            _forwardingStreamSubscription: I_ForwardingStreamSubscription<S, T>,
            _stream: I_ForwardingStream<S, T>,
            onData: (data: T) => void,
            onError: IFunction | undefined,
            onDone: () => void,
            cancelOnError: boolean
        ) => I_ForwardingStreamSubscription<S, T>;
    };
};
export interface I_ForwardingStreamSubscription<S, T> {
...
export class _ForwardingStreamSubscription<S, T>
    implements

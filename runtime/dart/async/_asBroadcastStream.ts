...
declare const dart: {
    async: {
        _asBroadcastStream: <T>(
            this: void,
            _asBroadcastStream: I_AsBroadcastStream<T>,
            _source: IStream<T>,
            onListenHandler?: (subscription: IStreamSubscription<T>) => void,
            onCancelHandler?: (subscription: IStreamSubscription<T>) => void
        ) => I_AsBroadcastStream<T>;
    };
};
export interface I_AsBroadcastStream<T> {
...
export class _AsBroadcastStream<T> implements IStream<T> {
    public constructor(
        _source: IStream<T>,
        onListenHandler?: (subscription: IStreamSubscription<T>) => void,
        onCancelHandler?: (subscription: IStreamSubscription<T>) => void
    ) {
        dart.async._asBroadcastStream(
            this,
            _source,
            onListenHandler,
            onCancelHandler

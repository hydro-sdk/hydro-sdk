...
export class _MapStream<S, T> implements I_ForwardingStream<S, T> {
    public constructor(source: IStream<S>, transform: (event: S) => T) {
        dart.async._mapStream(this, source, transform);
    }

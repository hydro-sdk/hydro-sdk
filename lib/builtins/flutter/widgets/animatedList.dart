  ...
  table["animatedList"] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      AnimatedList(
        ...
        initialItemCount:
            maybeUnwrapAndBuildArgument(args[0]["initialItemCount"],parentState: luaState),
        itemBuilder: (BuildContext context, int num, Animation anim) {
          ...
          return maybeUnwrapAndBuildArgument(
              closure.dispatch([null, context, num, anim],parentState: luaState)[0],parentState: luaState);
        },
      )
    ];
  });

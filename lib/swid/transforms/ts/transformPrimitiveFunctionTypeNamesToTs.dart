...
SwidFunctionType transformPrimitiveFunctionTypeNamesToTs(
    ...
    SwidFunctionType.clone(
        ...
        normalParameterTypes: swidFunctionType.normalParameterTypes != null
            ? List.from(
                swidFunctionType.normalParameterTypes.map((x) => cloneSwidType(
        ...
        namedParameterTypes: swidFunctionType.namedParameterTypes != null
            ? Map.from(
                swidFunctionType.namedParameterTypes.map((k, x) => MapEntry(
                    k,
                    cloneSwidType(
                        swidType: transformPrimitiveNamesToTs(
                      swidType: x,
            ...
            : null,
        returnType:
            transformPrimitiveNamesToTs(swidType: swidFunctionType.returnType));

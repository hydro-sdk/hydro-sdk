...
class SwidFunctionType
  ...
  factory SwidFunctionType({
    ...
    required final HashableList<String> normalParameterNames,
    required final HashableList<SwidType> normalParameterTypes,
    required final HashableList<String> optionalParameterNames,
    required final HashableList<SwidType> optionalParameterTypes,
  ...
  factory SwidFunctionType.clone({
    ...
    final HashableList<String>? normalParameterNames,
    final HashableList<SwidType>? normalParameterTypes,
    final HashableList<String>? optionalParameterNames,
    final HashableList<SwidType>? optionalParameterTypes,

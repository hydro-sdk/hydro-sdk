...
/// @nodoc
const $TsClassPostamble = _$TsClassPostambleTearOff();

/// @nodoc
mixin _$TsClassPostamble {
  SwidClass get swidClass => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $TsClassPostambleCopyWith<TsClassPostamble> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TsClassPostambleCopyWith<$Res> {
  factory $TsClassPostambleCopyWith(
          TsClassPostamble value, $Res Function(TsClassPostamble) then) =
      _$TsClassPostambleCopyWithImpl<$Res>;
...
/// @nodoc
class _$TsClassPostambleCopyWithImpl<$Res>
    implements $TsClassPostambleCopyWith<$Res> {
  _$TsClassPostambleCopyWithImpl(this._value, this._then);

  final TsClassPostamble _value;
  // ignore: unused_field
  final $Res Function(TsClassPostamble) _then;
...
class _$_$TsClassPostamble extends _$TsClassPostamble {
  ...
  @override
  String toString() {
    return 'TsClassPostamble(swidClass: $swidClass)';
  }

...
class VMManagedGridView extends _36c2.VMManagedBox<_2b56.GridView> {VMManagedGridView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'gridDelegate'
] = _36c2.maybeBoxObject<_a3c0.SliverGridDelegate>(object: vmObject.gridDelegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'childrenDelegate'
...
final _2b56.GridView vmObject;

 }

class RTManagedGridView extends _2b56.GridView implements _36c2.Box<_2b56.GridView> {RTManagedGridView({required _fac9.bool addAutomaticKeepAlives, required _fac9.bool addRepaintBoundaries, required _fac9.bool addSemanticIndexes, _fac9.double? cacheExtent, required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, _9585.ScrollController? controller, required _02d2.DragStartBehavior dragStartBehavior, _ab4a.Key? key, required _2b56.ScrollViewKeyboardDismissBehavior keyboardDismissBehavior, _96d1.EdgeInsetsGeometry? padding, _dbad.ScrollPhysics? physics, _fac9.bool? primary, _fac9.String? restorationId, required _fac9.bool reverse, required _487f.Axis scrollDirection, _fac9.int? semanticChildCount, required _fac9.bool shrinkWrap, required _a3c0.SliverGridDelegate gridDelegate, required this.table, required this.hydroState}) : super(addAutomaticKeepAlives: addAutomaticKeepAlives,addRepaintBoundaries: addRepaintBoundaries,addSemanticIndexes: addSemanticIndexes,cacheExtent: cacheExtent,children: children,clipBehavior: clipBehavior,controller: controller,dragStartBehavior: dragStartBehavior,key: key,keyboardDismissBehavior: keyboardDismissBehavior,padding: padding,physics: physics,primary: primary,restorationId: restorationId,reverse: reverse,scrollDirection: scrollDirection,semanticChildCount: semanticChildCount,shrinkWrap: shrinkWrap,gridDelegate: gridDelegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'gridDelegate'
] = _36c2.maybeBoxObject(object: this.gridDelegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'childrenDelegate'
...
_2b56.GridView unwrap() => this;
_2b56.GridView get vmObject => this;
...
void loadGridView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'gridView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedGridView(table: luaCallerArguments  [
0
...
'shrinkWrap'
] : null, gridDelegate: _36c2.maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'gridDelegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_2b56.GridView>(boxer: ({required _2b56.GridView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGridView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

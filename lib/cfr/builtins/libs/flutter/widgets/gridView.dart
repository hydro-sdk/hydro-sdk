...
class VMManagedGridView extends _36c2.VMManagedBox<_2b56.GridView> {
  VMManagedGridView(
    ...
    table['gridDelegate'] = _36c2.maybeBoxObject<_a3c0.SliverGridDelegate>(
        object: vmObject.gridDelegate,
        hydroState: hydroState,
    ...
    table['center'] = _36c2.maybeBoxObject<_ab4a.Key?>(
        object: vmObject.center,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['anchor'] = vmObject.anchor;
    table['cacheExtent'] = vmObject.cacheExtent;
    table['semanticChildCount'] = vmObject.semanticChildCount;
    ...
    table['key'] = _36c2.maybeBoxObject<_ab4a.Key?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['buildChildLayout'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e2dc.Widget>(
            object: vmObject.buildChildLayout(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
    ...
    table['buildSlivers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(
            object: vmObject
                .buildSlivers(_36c2.maybeUnBoxAndBuildArgument<
                        _e2dc.BuildContext,
...
class RTManagedGridView extends _2b56.GridView
    implements _36c2.Box<_2b56.GridView> {
  RTManagedGridView(
      ...
      _fac9.int? semanticChildCount,
      required _fac9.bool shrinkWrap,
      required _a3c0.SliverGridDelegate gridDelegate,
      required this.table,
    ...
    table['gridDelegate'] = _36c2.maybeBoxObject(
        object: this.gridDelegate,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['center'] = _36c2.maybeBoxObject(
        object: center, hydroState: hydroState, table: _36c2.HydroTable());
    table['anchor'] = _36c2.maybeBoxObject(
        object: anchor, hydroState: hydroState, table: _36c2.HydroTable());
    table['cacheExtent'] = _36c2.maybeBoxObject(
        object: this.cacheExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['semanticChildCount'] = _36c2.maybeBoxObject(
        object: this.semanticChildCount,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['dragStartBehavior'] = _02d2.DragStartBehavior.values.indexWhere((x) {
    ...
    table['_dart_buildChildLayout'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.buildChildLayout(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
    ...
    table['_dart_buildSlivers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.buildSlivers(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
    ...
    table['_dart_buildViewport'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _e2dc.Widget buildChildLayout(context) {
  ...
  @_fac9.override
  _fac9.List<_e2dc.Widget> buildSlivers(context) {
  ...
  @_fac9.override
  _487f.AxisDirection getDirection(context) {
  ...
  @_fac9.override
  _e2dc.Widget buildViewport(context, offset, axisDirection, slivers) {
...
void loadGridView(
  ...
  table['gridView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGridView(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          addAutomaticKeepAlives: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['addAutomaticKeepAlives']
              : null,
          addRepaintBoundaries: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['addRepaintBoundaries']
              : null,
          addSemanticIndexes: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['addSemanticIndexes']
              : null,
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          controller:
              _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['controller'] : null,
                  parentState: hydroState),
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          keyboardDismissBehavior: _36c2.maybeUnBoxEnum(values: _2b56.ScrollViewKeyboardDismissBehavior.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['keyboardDismissBehavior'] : null),
          ...
          semanticChildCount: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['semanticChildCount'] : null,
          shrinkWrap: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shrinkWrap'] : null,
          gridDelegate: _36c2.maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['gridDelegate'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_2b56.GridView>(boxer: (
      {required _2b56.GridView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGridView(

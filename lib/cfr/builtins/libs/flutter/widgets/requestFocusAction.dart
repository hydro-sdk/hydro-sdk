...
class VMManagedRequestFocusAction
    extends _36c2.VMManagedBox<_65d3.RequestFocusAction> {
  VMManagedRequestFocusAction(
    ...
    table['invoke'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.RequestFocusIntent,
    ...
    table['isEnabled'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['consumesKey'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.consumesKey(_36c2.maybeUnBoxAndBuildArgument<
            _65d3.RequestFocusIntent,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
      ];
    });
...
class RTManagedRequestFocusAction extends _65d3.RequestFocusAction
    implements _36c2.Box<_65d3.RequestFocusAction> {
  RTManagedRequestFocusAction({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_invoke'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.RequestFocusIntent,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _c0f4.Action<_65d3.RequestFocusIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c0f4.Action<_65d3.RequestFocusIntent>?, _65d3.RequestFocusIntent>(
...
void loadRequestFocusAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['requestFocusAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRequestFocusAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_65d3.RequestFocusAction>(boxer: (
      {required _65d3.RequestFocusAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRequestFocusAction(

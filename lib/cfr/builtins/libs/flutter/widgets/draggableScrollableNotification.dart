...
class VMManagedDraggableScrollableNotification
    extends _36c2.VMManagedBox<_90c0.DraggableScrollableNotification> {
  VMManagedDraggableScrollableNotification(
    ...
    table['extent'] = vmObject.extent;
    table['minExtent'] = vmObject.minExtent;
    table['maxExtent'] = vmObject.maxExtent;
    table['initialExtent'] = vmObject.initialExtent;
...
class RTManagedDraggableScrollableNotification
    extends _90c0.DraggableScrollableNotification
    implements _36c2.Box<_90c0.DraggableScrollableNotification> {
  RTManagedDraggableScrollableNotification(
      {required _e2dc.BuildContext context,
      required _fac9.double extent,
      required _fac9.double initialExtent,
      required _fac9.double maxExtent,
      required _fac9.double minExtent,
      required this.table,
    ...
    table['extent'] = _36c2.maybeBoxObject(
        object: this.extent, hydroState: hydroState, table: _36c2.HydroTable());
    table['minExtent'] = _36c2.maybeBoxObject(
        object: this.minExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['maxExtent'] = _36c2.maybeBoxObject(
        object: this.maxExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['initialExtent'] = _36c2.maybeBoxObject(
        object: this.initialExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadDraggableScrollableNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['draggableScrollableNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDraggableScrollableNotification(
          ...
          context: _36c2
              .maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          extent: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['extent']
              : null?.toDouble(),
          initialExtent: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['initialExtent']
              : null?.toDouble(),
  ...
  _36c2.registerBoxer<_90c0.DraggableScrollableNotification>(boxer: (
      {required _90c0.DraggableScrollableNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDraggableScrollableNotification(

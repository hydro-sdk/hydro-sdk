...
import 'package:flutter/src/widgets/image_filter.dart' as _6b37;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedImageFiltered extends _36c2.VMManagedBox<_6b37.ImageFiltered> {VMManagedImageFiltered({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'imageFilter'
] = _36c2.maybeBoxObject<_a643.ImageFilter>(object: vmObject.imageFilter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _6b37.ImageFiltered vmObject;

 }

class RTManagedImageFiltered extends _6b37.ImageFiltered implements _36c2.Box<_6b37.ImageFiltered> {RTManagedImageFiltered({_e2dc.Widget? child, _ab4a.Key? key, required _a643.ImageFilter imageFilter, required this.table, required this.hydroState}) : super(child: child,key: key,imageFilter: imageFilter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'imageFilter'
] = _36c2.maybeBoxObject(object: this.imageFilter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_6b37.ImageFiltered unwrap() => this;
_6b37.ImageFiltered get vmObject => this;
...
void loadImageFiltered({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'imageFiltered'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedImageFiltered(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), imageFilter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'imageFilter'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_6b37.ImageFiltered>(boxer: ({required _6b37.ImageFiltered vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImageFiltered(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

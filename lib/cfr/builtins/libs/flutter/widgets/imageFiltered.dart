...
class VMManagedImageFiltered extends _36c2.VMManagedBox<_6b37.ImageFiltered> {
  VMManagedImageFiltered(
    ...
    table['imageFilter'] = _36c2.maybeBoxObject<_a643.ImageFilter>(
...
class RTManagedImageFiltered extends _6b37.ImageFiltered
    implements _36c2.Box<_6b37.ImageFiltered> {
  RTManagedImageFiltered(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _a643.ImageFilter imageFilter,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, imageFilter: imageFilter) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['imageFilter'] = _36c2.maybeBoxObject(
        object: this.imageFilter,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadImageFiltered(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['imageFiltered'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImageFiltered(
  ...
  _36c2.registerBoxer<_6b37.ImageFiltered>(boxer: (
      {required _6b37.ImageFiltered vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImageFiltered(

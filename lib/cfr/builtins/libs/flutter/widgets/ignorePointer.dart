...
class VMManagedIgnorePointer extends _36c2.VMManagedBox<_3960.IgnorePointer> {VMManagedIgnorePointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderIgnorePointer>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIgnorePointer, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.IgnorePointer vmObject;

 }

class RTManagedIgnorePointer extends _3960.IgnorePointer implements _36c2.Box<_3960.IgnorePointer> {RTManagedIgnorePointer({_e2dc.Widget? child, required _fac9.bool ignoring, _fac9.bool? ignoringSemantics, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,ignoring: ignoring,ignoringSemantics: ignoringSemantics,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIgnorePointer,
...
_3960.IgnorePointer unwrap() => this;
_3960.IgnorePointer get vmObject => this;
@_fac9.override _bf98.RenderIgnorePointer createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIgnorePointer, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIgnorePointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'ignorePointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedIgnorePointer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.IgnorePointer>(boxer: ({required _3960.IgnorePointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIgnorePointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

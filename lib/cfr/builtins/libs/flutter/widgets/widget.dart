...
class VMManagedWidget extends _36c2.VMManagedBox<_e2dc.Widget> {VMManagedWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedWidget extends _e2dc.Widget implements _36c2.Box<_e2dc.Widget> {RTManagedWidget({_ab4a.Key? key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _e2dc.Element createElement() { 
...
void loadWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'widget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedWidget(table: luaCallerArguments  [
0
...
return [_e2dc.Widget.canUpdate(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState)),]; } );
_36c2.registerBoxer<_e2dc.Widget>(boxer: ({required _e2dc.Widget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

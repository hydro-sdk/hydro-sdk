...
class VMManagedAlignTransition extends _36c2.VMManagedBox<_d7ad.AlignTransition> {VMManagedAlignTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'widthFactor'
] = vmObject.widthFactor;
table  [
'heightFactor'
] = vmObject.heightFactor;
table  [
'child'
] = _36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.child, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'listenable'
] = _36c2.maybeBoxObject<_e644.Listenable>(object: vmObject.listenable, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
] = _36c2.maybeBoxObject<_ab4a.Key?>(object: vmObject.key, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.alignment, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.AlignTransition vmObject;

 }

class RTManagedAlignTransition extends _d7ad.AlignTransition implements _36c2.Box<_d7ad.AlignTransition> {RTManagedAlignTransition({_fac9.double? heightFactor, _ab4a.Key? key, _fac9.double? widthFactor, required _86ca.Animation<_ca85.AlignmentGeometry> alignment, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(heightFactor: heightFactor,key: key,widthFactor: widthFactor,alignment: alignment,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'widthFactor'
] = _36c2.maybeBoxObject(object: this.widthFactor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'heightFactor'
] = _36c2.maybeBoxObject(object: this.heightFactor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
] = _36c2.maybeBoxObject(object: this.child, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'listenable'
] = _36c2.maybeBoxObject(object: listenable, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_d7ad.AlignTransition unwrap() => this;
_d7ad.AlignTransition get vmObject => this;
@_fac9.override _86ca.Animation<_ca85.AlignmentGeometry> get alignment { 
_36c2.Closure closure = table["getAlignment"];
return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_ca85.AlignmentGeometry>, _ca85.AlignmentGeometry>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
@_fac9.override _e2dc.State<_d7ad.AnimatedWidget> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_d7ad.AnimatedWidget>, _d7ad.AnimatedWidget>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAlignTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'alignTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAlignTransition(table: luaCallerArguments  [
0
], hydroState: hydroState, heightFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'heightFactor'
...
'key'
] : null, parentState: hydroState), widthFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'widthFactor'
] : null?.toDouble(), alignment: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_ca85.AlignmentGeometry>, _ca85.AlignmentGeometry>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alignment'
...
_36c2.registerBoxer<_d7ad.AlignTransition>(boxer: ({required _d7ad.AlignTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAlignTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

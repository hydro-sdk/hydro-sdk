...
class VMManagedAbsorbPointer extends _36c2.VMManagedBox<_3960.AbsorbPointer> {
  VMManagedAbsorbPointer(
    ...
    table['absorbing'] = vmObject.absorbing;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderAbsorbPointer>(
...
class RTManagedAbsorbPointer extends _3960.AbsorbPointer
    implements _36c2.Box<_3960.AbsorbPointer> {
  RTManagedAbsorbPointer(
    ...
    table['absorbing'] = _36c2.maybeBoxObject(
        object: this.absorbing,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderAbsorbPointer createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderAbsorbPointer, _fac9.dynamic>(
...
void loadAbsorbPointer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['absorbPointer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAbsorbPointer(
  ...
  _36c2.registerBoxer<_3960.AbsorbPointer>(boxer: (
      {required _3960.AbsorbPointer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAbsorbPointer(

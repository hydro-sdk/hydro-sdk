...
class VMManagedAbsorbPointer extends _36c2.VMManagedBox<_3960.AbsorbPointer> {VMManagedAbsorbPointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderAbsorbPointer>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAbsorbPointer, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.AbsorbPointer vmObject;

 }

class RTManagedAbsorbPointer extends _3960.AbsorbPointer implements _36c2.Box<_3960.AbsorbPointer> {RTManagedAbsorbPointer({required _fac9.bool absorbing, _e2dc.Widget? child, _fac9.bool? ignoringSemantics, _ab4a.Key? key, required this.table, required this.hydroState}) : super(absorbing: absorbing,child: child,ignoringSemantics: ignoringSemantics,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'absorbing'
] = _36c2.maybeBoxObject(object: this.absorbing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'ignoringSemantics'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAbsorbPointer,
...
_3960.AbsorbPointer unwrap() => this;
_3960.AbsorbPointer get vmObject => this;
@_fac9.override _bf98.RenderAbsorbPointer createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAbsorbPointer, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAbsorbPointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'absorbPointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedAbsorbPointer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.AbsorbPointer>(boxer: ({required _3960.AbsorbPointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAbsorbPointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

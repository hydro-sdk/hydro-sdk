...
class VMManagedHeroMode extends _36c2.VMManagedBox<_1b22.HeroMode> {VMManagedHeroMode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _1b22.HeroMode vmObject;

 }

class RTManagedHeroMode extends _1b22.HeroMode implements _36c2.Box<_1b22.HeroMode> {RTManagedHeroMode({required _fac9.bool enabled, _ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(enabled: enabled,key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_1b22.HeroMode unwrap() => this;
_1b22.HeroMode get vmObject => this;
...
void loadHeroMode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'heroMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedHeroMode(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_1b22.HeroMode>(boxer: ({required _1b22.HeroMode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHeroMode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

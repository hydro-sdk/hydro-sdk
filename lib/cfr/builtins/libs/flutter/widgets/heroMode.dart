...
class VMManagedHeroMode extends _36c2.VMManagedBox<_1b22.HeroMode> {
  VMManagedHeroMode(
...
class RTManagedHeroMode extends _1b22.HeroMode
    implements _36c2.Box<_1b22.HeroMode> {
  RTManagedHeroMode(
      ...
      : super(enabled: enabled, key: key, child: child) {
...
void loadHeroMode(
  ...
  table['heroMode'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedHeroMode(
  ...
  _36c2.registerBoxer<_1b22.HeroMode>(boxer: (
      {required _1b22.HeroMode vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedHeroMode(

...
class VMManagedMultiChildRenderObjectWidget extends _36c2.VMManagedBox<_e2dc.MultiChildRenderObjectWidget> {VMManagedMultiChildRenderObjectWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.MultiChildRenderObjectWidget vmObject;

 }

class RTManagedMultiChildRenderObjectWidget extends _e2dc.MultiChildRenderObjectWidget implements _36c2.Box<_e2dc.MultiChildRenderObjectWidget> {RTManagedMultiChildRenderObjectWidget({required _fac9.List<_e2dc.Widget> children, _ab4a.Key? key, required this.table, required this.hydroState}) : super(children: children,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.MultiChildRenderObjectWidget unwrap() => this;
_e2dc.MultiChildRenderObjectWidget get vmObject => this;
...
void loadMultiChildRenderObjectWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'multiChildRenderObjectWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedMultiChildRenderObjectWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.MultiChildRenderObjectWidget>(boxer: ({required _e2dc.MultiChildRenderObjectWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMultiChildRenderObjectWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

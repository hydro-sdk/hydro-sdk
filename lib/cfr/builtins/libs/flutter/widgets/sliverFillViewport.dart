...
class VMManagedSliverFillViewport extends _36c2.VMManagedBox<_3ce7.SliverFillViewport> {VMManagedSliverFillViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3ce7.SliverFillViewport vmObject;

 }

class RTManagedSliverFillViewport extends _3ce7.SliverFillViewport implements _36c2.Box<_3ce7.SliverFillViewport> {RTManagedSliverFillViewport({_ab4a.Key? key, required _fac9.bool padEnds, required _fac9.double viewportFraction, required _a8eb.SliverChildDelegate delegate, required this.table, required this.hydroState}) : super(key: key,padEnds: padEnds,viewportFraction: viewportFraction,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3ce7.SliverFillViewport unwrap() => this;
_3ce7.SliverFillViewport get vmObject => this;
...
void loadSliverFillViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverFillViewport'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSliverFillViewport(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), padEnds: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'padEnds'
...
'viewportFraction'
] : null?.toDouble(), delegate: _36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverChildDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_3ce7.SliverFillViewport>(boxer: ({required _3ce7.SliverFillViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverFillViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

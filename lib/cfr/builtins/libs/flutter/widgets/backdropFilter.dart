...
class VMManagedBackdropFilter extends _36c2.VMManagedBox<_3960.BackdropFilter> {
  VMManagedBackdropFilter(
    ...
    table['blendMode'] = _a643.BlendMode.values.indexWhere((x) {
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderBackdropFilter>(
...
class RTManagedBackdropFilter extends _3960.BackdropFilter
    implements _36c2.Box<_3960.BackdropFilter> {
  RTManagedBackdropFilter(
      ...
      : super(blendMode: blendMode, child: child, key: key, filter: filter) {
  ...
  @_fac9.override
  _bf98.RenderBackdropFilter createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderBackdropFilter, _fac9.dynamic>(
...
void loadBackdropFilter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['backdropFilter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBackdropFilter(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          filter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['filter'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3960.BackdropFilter>(boxer: (
      {required _3960.BackdropFilter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBackdropFilter(

...
class VMManagedBackdropFilter extends _36c2.VMManagedBox<_3960.BackdropFilter> {VMManagedBackdropFilter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'blendMode'
] = _a643.BlendMode.values.indexWhere((x) { return x == vmObject.blendMode; } );
table  [
'child'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderBackdropFilter>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBackdropFilter, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.BackdropFilter vmObject;

 }

class RTManagedBackdropFilter extends _3960.BackdropFilter implements _36c2.Box<_3960.BackdropFilter> {RTManagedBackdropFilter({required _a643.BlendMode blendMode, _e2dc.Widget? child, _ab4a.Key? key, required _a643.ImageFilter filter, required this.table, required this.hydroState}) : super(blendMode: blendMode,child: child,key: key,filter: filter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'blendMode'
] = _a643.BlendMode.values.indexWhere((x) { return x == this.blendMode; } );
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBackdropFilter,
...
_3960.BackdropFilter unwrap() => this;
_3960.BackdropFilter get vmObject => this;
@_fac9.override _bf98.RenderBackdropFilter createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBackdropFilter, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadBackdropFilter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'backdropFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedBackdropFilter(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.BackdropFilter>(boxer: ({required _3960.BackdropFilter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBackdropFilter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedImageIcon extends _36c2.VMManagedBox<_b290.ImageIcon> {
  VMManagedImageIcon(
...
class RTManagedImageIcon extends _b290.ImageIcon
    implements _36c2.Box<_b290.ImageIcon> {
  RTManagedImageIcon(_61fa.ImageProvider<_fac9.Object>? image$,
      {_a643.Color? color,
      _ab4a.Key? key,
      ...
      : super(image$,
            color: color, key: key, semanticLabel: semanticLabel, size: size) {
...
void loadImageIcon(
  ...
  table['imageIcon'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImageIcon(
          ...
          color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 3
                  ? luaCallerArguments[2]['color']
                  : null,
              parentState: hydroState),
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 3 ? luaCallerArguments[2]['key'] : null,
              parentState: hydroState),
          semanticLabel: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['semanticLabel'] : null,
          size: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['size'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_b290.ImageIcon>(boxer: (
      {required _b290.ImageIcon vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImageIcon(

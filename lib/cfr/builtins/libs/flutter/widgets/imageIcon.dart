...
import 'package:flutter/src/widgets/image_icon.dart' as _b290;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedImageIcon extends _36c2.VMManagedBox<_b290.ImageIcon> {VMManagedImageIcon({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _b290.ImageIcon vmObject;

 }

class RTManagedImageIcon extends _b290.ImageIcon implements _36c2.Box<_b290.ImageIcon> {RTManagedImageIcon(_61fa.ImageProvider<_fac9.Object>? image$, {_a643.Color? color, _ab4a.Key? key, _fac9.String? semanticLabel, _fac9.double? size, required this.table, required this.hydroState}) : super(image$,color: color,key: key,semanticLabel: semanticLabel,size: size) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_b290.ImageIcon unwrap() => this;
_b290.ImageIcon get vmObject => this;
...
void loadImageIcon({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'imageIcon'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedImageIcon(_36c2.maybeUnBoxAndBuildArgument<_61fa.ImageProvider<_fac9.Object>?, _fac9.Object>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_b290.ImageIcon>(boxer: ({required _b290.ImageIcon vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImageIcon(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

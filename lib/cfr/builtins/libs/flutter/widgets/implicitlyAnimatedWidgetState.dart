...
class VMManagedImplicitlyAnimatedWidgetState extends _36c2.VMManagedBox<
    _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>> {
  VMManagedImplicitlyAnimatedWidgetState(
  ...
  final _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>
      vmObject;
}

class RTManagedImplicitlyAnimatedWidgetState
    extends _da7c.ImplicitlyAnimatedWidgetState
    implements _36c2.Box<_da7c.ImplicitlyAnimatedWidgetState> {
  RTManagedImplicitlyAnimatedWidgetState(
    ...
    table['_dart_forEachTween'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_didUpdateTweens'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _da7c.ImplicitlyAnimatedWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidget,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadImplicitlyAnimatedWidgetState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['implicitlyAnimatedWidgetState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImplicitlyAnimatedWidgetState(
  ...
  _36c2.registerBoxer<_da7c.ImplicitlyAnimatedWidgetState>(boxer: (
      {required _da7c.ImplicitlyAnimatedWidgetState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImplicitlyAnimatedWidgetState(

...
class VMManagedImplicitlyAnimatedWidgetState extends _36c2.VMManagedBox<_da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>> {VMManagedImplicitlyAnimatedWidgetState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget> vmObject;

 }

class RTManagedImplicitlyAnimatedWidgetState extends _da7c.ImplicitlyAnimatedWidgetState implements _36c2.Box<_da7c.ImplicitlyAnimatedWidgetState> {RTManagedImplicitlyAnimatedWidgetState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.ImplicitlyAnimatedWidgetState unwrap() => this;
_da7c.ImplicitlyAnimatedWidgetState get vmObject => this;
...
void loadImplicitlyAnimatedWidgetState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'implicitlyAnimatedWidgetState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedImplicitlyAnimatedWidgetState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_da7c.ImplicitlyAnimatedWidgetState>(boxer: ({required _da7c.ImplicitlyAnimatedWidgetState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImplicitlyAnimatedWidgetState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

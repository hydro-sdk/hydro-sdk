...
class VMManagedRestorableNum extends _36c2.VMManagedBox<_28c9.RestorableNum<_fac9.num>> {VMManagedRestorableNum({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableNum<_fac9.num> vmObject;

 }

class RTManagedRestorableNum extends _28c9.RestorableNum implements _36c2.Box<_28c9.RestorableNum> {RTManagedRestorableNum(_fac9.num defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableNum unwrap() => this;
_28c9.RestorableNum get vmObject => this;
...
void loadRestorableNum({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableNum'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableNum(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableNum>(boxer: ({required _28c9.RestorableNum vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableNum(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

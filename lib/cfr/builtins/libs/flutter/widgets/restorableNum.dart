...
class VMManagedRestorableNum
    extends _36c2.VMManagedBox<_28c9.RestorableNum<_fac9.num>> {
  VMManagedRestorableNum(
...
class RTManagedRestorableNum extends _28c9.RestorableNum
    implements _36c2.Box<_28c9.RestorableNum> {
  RTManagedRestorableNum(_fac9.num defaultValue,
  ...
  @_fac9.override
  _fac9.num fromPrimitives(serialized) {
...
void loadRestorableNum(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableNum'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableNum(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableNum>(boxer: (
      {required _28c9.RestorableNum vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableNum(

...
class VMManagedHero extends _36c2.VMManagedBox<_1b22.Hero> {VMManagedHero({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'tag'
] = _36c2.maybeBoxObject<_fac9.Object>(object: vmObject.tag, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
] = _36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.child, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'transitionOnUserGestures'
] = vmObject.transitionOnUserGestures;
table  [
'key'
...
class RTManagedHero extends _1b22.Hero implements _36c2.Box<_1b22.Hero> {RTManagedHero({_e83e.Tween<_a643.Rect?> Function(_a643.Rect? begin, _a643.Rect? end)? createRectTween, _e2dc.Widget Function(_e2dc.BuildContext flightContext, _86ca.Animation<_fac9.double> animation, _1b22.HeroFlightDirection flightDirection, _e2dc.BuildContext fromHeroContext, _e2dc.BuildContext toHeroContext)? flightShuttleBuilder, _ab4a.Key? key, _e2dc.Widget Function(_e2dc.BuildContext context, _a643.Size heroSize, _e2dc.Widget child)? placeholderBuilder, required _fac9.bool transitionOnUserGestures, required _e2dc.Widget child, required _fac9.Object tag, required this.table, required this.hydroState}) : super(createRectTween: createRectTween,flightShuttleBuilder: flightShuttleBuilder,key: key,placeholderBuilder: placeholderBuilder,transitionOnUserGestures: transitionOnUserGestures,child: child,tag: tag) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'tag'
] = _36c2.maybeBoxObject(object: this.tag, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
] = _36c2.maybeBoxObject(object: this.child, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'transitionOnUserGestures'
] = _36c2.maybeBoxObject(object: this.transitionOnUserGestures, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
@_fac9.override _e2dc.State<_1b22.Hero> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_1b22.Hero>, _1b22.Hero>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadHero({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'hero'
...
_36c2.Closure? unpackedflightShuttleBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'flightShuttleBuilder'
] : null;

_36c2.Closure? unpackedplaceholderBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'placeholderBuilder'
] : null;
...
return  [RTManagedHero(table: luaCallerArguments  [
0
], hydroState: hydroState, createRectTween: unpackedcreateRectTween != null ? (begin, end) => _36c2.maybeUnBoxAndBuildArgument<_e83e.Tween<_a643.Rect?>, _a643.Rect?>(unpackedcreateRectTween.dispatch([luaCallerArguments[0],begin,end],parentState:hydroState,)[0], parentState: hydroState) : null , flightShuttleBuilder: unpackedflightShuttleBuilder != null ? (flightContext, animation, flightDirection, fromHeroContext, toHeroContext) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedflightShuttleBuilder.dispatch([luaCallerArguments[0],flightContext,animation,flightDirection,fromHeroContext,toHeroContext],parentState:hydroState,)[0], parentState: hydroState) : null , key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null, parentState: hydroState), placeholderBuilder: unpackedplaceholderBuilder != null ? (context, heroSize, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedplaceholderBuilder.dispatch([luaCallerArguments[0],context,heroSize,child],parentState:hydroState,)[0], parentState: hydroState) : null , transitionOnUserGestures: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transitionOnUserGestures'
...
'child'
] : null, parentState: hydroState), tag: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'tag'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_1b22.Hero>(boxer: ({required _1b22.Hero vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHero(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

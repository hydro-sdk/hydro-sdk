...
class VMManagedSliverAnimatedOpacity extends _36c2.VMManagedBox<_da7c.SliverAnimatedOpacity> {VMManagedSliverAnimatedOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.SliverAnimatedOpacity vmObject;

 }

class RTManagedSliverAnimatedOpacity extends _da7c.SliverAnimatedOpacity implements _36c2.Box<_da7c.SliverAnimatedOpacity> {RTManagedSliverAnimatedOpacity({required _fac9.bool alwaysIncludeSemantics, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, _e2dc.Widget? sliver, required _fac9.Duration duration, required _fac9.double opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,curve: curve,key: key,onEnd: onEnd,sliver: sliver,duration: duration,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.SliverAnimatedOpacity unwrap() => this;
_da7c.SliverAnimatedOpacity get vmObject => this;
@_fac9.override _da7c.ImplicitlyAnimatedWidgetState<_da7c.SliverAnimatedOpacity> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidgetState<_da7c.SliverAnimatedOpacity>, _da7c.SliverAnimatedOpacity>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverAnimatedOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedSliverAnimatedOpacity(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , sliver: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sliver'
...
_36c2.registerBoxer<_da7c.SliverAnimatedOpacity>(boxer: ({required _da7c.SliverAnimatedOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverAnimatedOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

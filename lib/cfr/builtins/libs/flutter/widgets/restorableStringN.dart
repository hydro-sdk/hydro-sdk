...
class VMManagedRestorableStringN extends _36c2.VMManagedBox<_28c9.RestorableStringN> {VMManagedRestorableStringN({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableStringN vmObject;

 }

class RTManagedRestorableStringN extends _28c9.RestorableStringN implements _36c2.Box<_28c9.RestorableStringN> {RTManagedRestorableStringN(_fac9.String? defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableStringN unwrap() => this;
_28c9.RestorableStringN get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.String? fromPrimitives(serialized) { 
...
void loadRestorableStringN({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableStringN'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableStringN(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableStringN>(boxer: ({required _28c9.RestorableStringN vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableStringN(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

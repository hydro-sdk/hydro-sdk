...
class VMManagedRestorableStringN
    extends _36c2.VMManagedBox<_28c9.RestorableStringN> {
  VMManagedRestorableStringN(
...
class RTManagedRestorableStringN extends _28c9.RestorableStringN
    implements _36c2.Box<_28c9.RestorableStringN> {
  RTManagedRestorableStringN(_fac9.String? defaultValue,
  ...
  @_fac9.override
  _fac9.String? fromPrimitives(serialized) {
...
void loadRestorableStringN(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableStringN'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableStringN(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableStringN>(boxer: (
      {required _28c9.RestorableStringN vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableStringN(

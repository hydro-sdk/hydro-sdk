...
class VMManagedAnimatedListState
    extends _36c2.VMManagedBox<_cd40.AnimatedListState> {
  VMManagedAnimatedListState(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_cd40.AnimatedList>(
...
class RTManagedAnimatedListState extends _cd40.AnimatedListState
  ...
  RTManagedAnimatedListState({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _cd40.AnimatedList get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_cd40.AnimatedList, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadAnimatedListState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedListState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_cd40.AnimatedListState>(boxer: (
      {required _cd40.AnimatedListState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedListState(

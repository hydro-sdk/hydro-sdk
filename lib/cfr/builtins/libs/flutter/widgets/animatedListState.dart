...
class VMManagedAnimatedListState extends _36c2.VMManagedBox<_cd40.AnimatedListState> {VMManagedAnimatedListState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_cd40.AnimatedList>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
final _cd40.AnimatedListState vmObject;

 }

class RTManagedAnimatedListState extends _cd40.AnimatedListState implements _36c2.Box<_cd40.AnimatedListState> {RTManagedAnimatedListState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_didUpdateWidget'] =
  ...
  super.didUpdateWidget(
      _36c2.maybeUnBoxAndBuildArgument<_cd40.AnimatedList, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _cd40.AnimatedList get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_cd40.AnimatedList, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedListState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedListState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAnimatedListState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_cd40.AnimatedListState>(boxer: ({required _cd40.AnimatedListState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedListState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

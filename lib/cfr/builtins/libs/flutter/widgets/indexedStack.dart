...
class VMManagedIndexedStack extends _36c2.VMManagedBox<_3960.IndexedStack> {VMManagedIndexedStack({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'fit'
] = _b1b6.StackFit.values.indexWhere((x) { return x == vmObject.fit; } );
table  [
'overflow'
] = _b1b6.Overflow.values.indexWhere((x) { return x == vmObject.overflow; } );
table  [
'clipBehavior'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b1b6.RenderIndexedStack>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderIndexedStack, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.IndexedStack vmObject;

 }

class RTManagedIndexedStack extends _3960.IndexedStack implements _36c2.Box<_3960.IndexedStack> {RTManagedIndexedStack({required _ca85.AlignmentGeometry alignment, required _fac9.List<_e2dc.Widget> children, _fac9.int? index, _ab4a.Key? key, required _b1b6.StackFit sizing, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,index: index,key: key,sizing: sizing,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'fit'
] = _b1b6.StackFit.values.indexWhere((x) { return x == fit; } );
table  [
'overflow'
] = _b1b6.Overflow.values.indexWhere((x) { return x == overflow; } );
table  [
'clipBehavior'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderIndexedStack, _fac9.dynamic>(
...
_3960.IndexedStack unwrap() => this;
_3960.IndexedStack get vmObject => this;
@_fac9.override _b1b6.RenderIndexedStack createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderIndexedStack, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIndexedStack({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'indexedStack'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedIndexedStack(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), sizing: _36c2.maybeUnBoxEnum(values: _b1b6.StackFit.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sizing'
...
_36c2.registerBoxer<_3960.IndexedStack>(boxer: ({required _3960.IndexedStack vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIndexedStack(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

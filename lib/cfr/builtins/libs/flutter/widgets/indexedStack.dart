...
class VMManagedIndexedStack extends _36c2.VMManagedBox<_3960.IndexedStack> {
  VMManagedIndexedStack(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_b1b6.RenderIndexedStack>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderIndexedStack,
...
class RTManagedIndexedStack extends _3960.IndexedStack
    implements _36c2.Box<_3960.IndexedStack> {
  RTManagedIndexedStack(
      {required _ca85.AlignmentGeometry alignment,
      required _fac9.List<_e2dc.Widget> children,
      _fac9.int? index,
      _ab4a.Key? key,
      required _b1b6.StackFit sizing,
  ...
  @_fac9.override
  _b1b6.RenderIndexedStack createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_b1b6.RenderIndexedStack, _fac9.dynamic>(
...
void loadIndexedStack(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['indexedStack'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIndexedStack(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          sizing: _36c2.maybeUnBoxEnum(values: _b1b6.StackFit.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['sizing'] : null),
  ...
  _36c2.registerBoxer<_3960.IndexedStack>(boxer: (
      {required _3960.IndexedStack vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIndexedStack(

...
class VMManagedBouncingScrollPhysics
    extends _36c2.VMManagedBox<_dbad.BouncingScrollPhysics> {
  VMManagedBouncingScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_dbad.BouncingScrollPhysics>(
    ...
    table['frictionFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.frictionFactor(luaCallerArguments[1]?.toDouble()),
      ];
    });
    ...
    table['getDragStartDistanceMotionThreshold'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.dragStartDistanceMotionThreshold,
      ];
    });
...
class RTManagedBouncingScrollPhysics extends _dbad.BouncingScrollPhysics
    implements _36c2.Box<_dbad.BouncingScrollPhysics> {
  RTManagedBouncingScrollPhysics(
    ...
    table['_dart_frictionFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _dbad.BouncingScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_dbad.BouncingScrollPhysics, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _fac9.double frictionFactor(overscrollFraction) {
...
void loadBouncingScrollPhysics(
  ...
  table['bouncingScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBouncingScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.BouncingScrollPhysics>(boxer: (
      {required _dbad.BouncingScrollPhysics vmObject,

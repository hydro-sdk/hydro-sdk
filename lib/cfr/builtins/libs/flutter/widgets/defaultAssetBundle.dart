...
class VMManagedDefaultAssetBundle extends _36c2.VMManagedBox<_3960.DefaultAssetBundle> {VMManagedDefaultAssetBundle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_3960.DefaultAssetBundle, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.DefaultAssetBundle vmObject;

 }

class RTManagedDefaultAssetBundle extends _3960.DefaultAssetBundle implements _36c2.Box<_3960.DefaultAssetBundle> {RTManagedDefaultAssetBundle({_ab4a.Key? key, required _136d.AssetBundle bundle, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,bundle: bundle,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.DefaultAssetBundle unwrap() => this;
_3960.DefaultAssetBundle get vmObject => this;
...
void loadDefaultAssetBundle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'defaultAssetBundle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDefaultAssetBundle(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), bundle: _36c2.maybeUnBoxAndBuildArgument<_136d.AssetBundle, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bundle'
...
table  [
'defaultAssetBundleOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_136d.AssetBundle>(object: _3960.DefaultAssetBundle.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_3960.DefaultAssetBundle>(boxer: ({required _3960.DefaultAssetBundle vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDefaultAssetBundle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

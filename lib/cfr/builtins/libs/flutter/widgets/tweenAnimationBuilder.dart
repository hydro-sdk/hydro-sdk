...
class VMManagedTweenAnimationBuilder
    extends _36c2.VMManagedBox<_d7e7.TweenAnimationBuilder<_fac9.Object?>> {
  VMManagedTweenAnimationBuilder(
    ...
    table['tween'] = _36c2.maybeBoxObject<_e83e.Tween>(
        object: vmObject.tween,
        hydroState: hydroState,
...
class RTManagedTweenAnimationBuilder extends _d7e7.TweenAnimationBuilder
  ...
  RTManagedTweenAnimationBuilder(
    ...
    table['tween'] = _36c2.maybeBoxObject(
        object: this.tween, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>
      createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>,
            _da7c.ImplicitlyAnimatedWidget>(
...
void loadTweenAnimationBuilder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tweenAnimationBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedTweenAnimationBuilder(
          ...
          onEnd: unpackedonEnd != null
              ...
              : null,
          builder: (context, value, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
          ...
          tween: _36c2.maybeUnBoxAndBuildArgument<_e83e.Tween<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['tween'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7e7.TweenAnimationBuilder>(boxer: (
      {required _d7e7.TweenAnimationBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTweenAnimationBuilder(

...
import 'package:flutter/src/widgets/tween_animation_builder.dart' as _d7e7;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedTweenAnimationBuilder extends _36c2.VMManagedBox<_d7e7.TweenAnimationBuilder<_fac9.Object?>> {VMManagedTweenAnimationBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'tween'
] = _36c2.maybeBoxObject<_e83e.Tween>(object: vmObject.tween, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _d7e7.TweenAnimationBuilder<_fac9.Object?> vmObject;

 }

class RTManagedTweenAnimationBuilder extends _d7e7.TweenAnimationBuilder implements _36c2.Box<_d7e7.TweenAnimationBuilder> {RTManagedTweenAnimationBuilder({_e2dc.Widget? child, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _e2dc.Widget Function(_e2dc.BuildContext context, _fac9.Object? value, _e2dc.Widget? child) builder, required _fac9.Duration duration, required _e83e.Tween<_fac9.Object?> tween, required this.table, required this.hydroState}) : super(child: child,curve: curve,key: key,onEnd: onEnd,builder: builder,duration: duration,tween: tween) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidgetState<_da7c.ImplicitlyAnimatedWidget>, _da7c.ImplicitlyAnimatedWidget>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadTweenAnimationBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedTweenAnimationBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , builder: (context, value, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,value,child],parentState:hydroState,)[0], parentState: hydroState), duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'duration'
] : null, parentState: hydroState), tween: _36c2.maybeUnBoxAndBuildArgument<_e83e.Tween<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'tween'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7e7.TweenAnimationBuilder>(boxer: ({required _d7e7.TweenAnimationBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTweenAnimationBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

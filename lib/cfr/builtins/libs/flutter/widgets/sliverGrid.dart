...
class VMManagedSliverGrid extends _36c2.VMManagedBox<_a8eb.SliverGrid> {VMManagedSliverGrid({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a3c0.RenderSliverGrid>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a3c0.RenderSliverGrid, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a8eb.SliverGrid vmObject;

 }

class RTManagedSliverGrid extends _a8eb.SliverGrid implements _36c2.Box<_a8eb.SliverGrid> {RTManagedSliverGrid({_ab4a.Key? key, required _a8eb.SliverChildDelegate delegate, required _a3c0.SliverGridDelegate gridDelegate, required this.table, required this.hydroState}) : super(key: key,delegate: delegate,gridDelegate: gridDelegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a3c0.RenderSliverGrid, _fac9.dynamic>(
...
_a8eb.SliverGrid unwrap() => this;
_a8eb.SliverGrid get vmObject => this;
@_fac9.override _a3c0.RenderSliverGrid createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a3c0.RenderSliverGrid, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverGrid({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverGrid'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverGrid(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a8eb.SliverGrid>(boxer: ({required _a8eb.SliverGrid vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverGrid(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

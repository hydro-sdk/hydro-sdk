...
class VMManagedRestorableChangeNotifier extends _36c2.VMManagedBox<_28c9.RestorableChangeNotifier<_e644.ChangeNotifier>> {VMManagedRestorableChangeNotifier({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableChangeNotifier<_e644.ChangeNotifier> vmObject;

 }

class RTManagedRestorableChangeNotifier extends _28c9.RestorableChangeNotifier implements _36c2.Box<_28c9.RestorableChangeNotifier> {RTManagedRestorableChangeNotifier({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableChangeNotifier unwrap() => this;
_28c9.RestorableChangeNotifier get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e644.ChangeNotifier get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxAndBuildArgument<_e644.ChangeNotifier, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e644.ChangeNotifier createDefaultValue() { 
_36c2.Closure closure = table["createDefaultValue"];
return _36c2.maybeUnBoxAndBuildArgument<_e644.ChangeNotifier, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e644.ChangeNotifier fromPrimitives(data) { 
...
void loadRestorableChangeNotifier({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableChangeNotifier'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableChangeNotifier(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableChangeNotifier>(boxer: ({required _28c9.RestorableChangeNotifier vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableChangeNotifier(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

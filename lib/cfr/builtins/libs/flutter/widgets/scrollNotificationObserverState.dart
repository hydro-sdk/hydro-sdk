...
class VMManagedScrollNotificationObserverState
    extends _36c2.VMManagedBox<_b166.ScrollNotificationObserverState> {
  VMManagedScrollNotificationObserverState(
    ...
    table['addListener'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.addListener((notification) => unpackedlistener.dispatch(
    ...
    table['removeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
      vmObject.removeListener((notification) => unpackedlistener.dispatch(
            [luaCallerArguments[0], notification],
            parentState: hydroState,
          ));
      return [];
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_b166.ScrollNotificationObserver>(
...
class RTManagedScrollNotificationObserverState
    extends _b166.ScrollNotificationObserverState
    implements _36c2.Box<_b166.ScrollNotificationObserverState> {
  RTManagedScrollNotificationObserverState(
  ...
  @_fac9.override
  _b166.ScrollNotificationObserver get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_b166.ScrollNotificationObserver,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadScrollNotificationObserverState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollNotificationObserverState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollNotificationObserverState(
  ...
  _36c2.registerBoxer<_b166.ScrollNotificationObserverState>(boxer: (
      {required _b166.ScrollNotificationObserverState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollNotificationObserverState(

...
class VMManagedScrollNotificationObserverState extends _36c2.VMManagedBox<_b166.ScrollNotificationObserverState> {VMManagedScrollNotificationObserverState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
1
];vmObject.addListener((notification) => unpackedlistener.dispatch([luaCallerArguments[0],notification],parentState:hydroState,));
return []; } );
table  [
'removeListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedlistener=luaCallerArguments  [
1
];vmObject.removeListener((notification) => unpackedlistener.dispatch([luaCallerArguments[0],notification],parentState:hydroState,));
return []; } );
table  [
'build'
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b166.ScrollNotificationObserver>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
final _b166.ScrollNotificationObserverState vmObject;

 }

class RTManagedScrollNotificationObserverState extends _b166.ScrollNotificationObserverState implements _36c2.Box<_b166.ScrollNotificationObserverState> {RTManagedScrollNotificationObserverState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_addListener'] =
  ...
  super.addListener((notification) => unpackedlistener.dispatch(
...
table['_dart_removeListener'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  _36c2.Closure unpackedlistener = luaCallerArguments[1];
  super.removeListener((notification) => unpackedlistener.dispatch(
        [luaCallerArguments[0], notification],
        parentState: hydroState,
      ));
  return [];
...
table['_dart_didUpdateWidget'] =
  ...
  super.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<
      _b166.ScrollNotificationObserver,
...
_b166.ScrollNotificationObserverState unwrap() => this;
_b166.ScrollNotificationObserverState get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _b166.ScrollNotificationObserver get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_b166.ScrollNotificationObserver, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadScrollNotificationObserverState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollNotificationObserverState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedScrollNotificationObserverState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_b166.ScrollNotificationObserverState>(boxer: ({required _b166.ScrollNotificationObserverState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollNotificationObserverState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

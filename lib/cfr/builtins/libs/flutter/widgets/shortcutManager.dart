...
class VMManagedShortcutManager extends _36c2.VMManagedBox<_1710.ShortcutManager> {VMManagedShortcutManager({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getShortcuts'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Map>(object: vmObject.shortcuts, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setShortcuts'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.shortcuts=(_36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_1710.ShortcutActivator,_c0f4.Intent>, _1710.ShortcutActivator>(luaCallerArguments  [
1
...
class RTManagedShortcutManager extends _1710.ShortcutManager implements _36c2.Box<_1710.ShortcutManager> {RTManagedShortcutManager({required _fac9.bool modal, required _fac9.Map<_1710.ShortcutActivator,_c0f4.Intent> shortcuts, required this.table, required this.hydroState}) : super(modal: modal,shortcuts: shortcuts) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'modal'
] = _36c2.maybeBoxObject(object: this.modal, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_getShortcuts'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.shortcuts];
});
table['_dart_setShortcuts'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.shortcuts = (_36c2.maybeUnBoxAndBuildArgument<
      _fac9.Map<_1710.ShortcutActivator, _c0f4.Intent>,
      _1710.ShortcutActivator>(luaCallerArguments[1], parentState: hydroState));
  return [];
});
table['_dart_handleKeypress'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
      ...
      return x ==
          super.handleKeypress(
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext,
                  ...
                  parentState: hydroState),
              _36c2
                  .maybeUnBoxAndBuildArgument<_94e8.RawKeyEvent, _fac9.dynamic>(
...
@_fac9.override _fac9.Map<_1710.ShortcutActivator,_c0f4.Intent> get shortcuts { 
...
@_fac9.override void set shortcuts(value) { 
_36c2.Closure closure = table["setShortcuts"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _b485.KeyEventResult handleKeypress(context, event) { 
_36c2.Closure closure = table["handleKeypress"];
return _36c2.maybeUnBoxEnum(values: _b485.KeyEventResult.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
...
void loadShortcutManager({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shortcutManager'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedShortcutManager(table: luaCallerArguments  [
0
], hydroState: hydroState, modal: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'modal'
] : null, shortcuts: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_1710.ShortcutActivator,_c0f4.Intent>, _1710.ShortcutActivator>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shortcuts'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_1710.ShortcutManager>(boxer: ({required _1710.ShortcutManager vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShortcutManager(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

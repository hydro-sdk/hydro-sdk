...
class VMManagedPrioritizedAction extends _36c2.VMManagedBox<_c0f4.PrioritizedAction> {VMManagedPrioritizedAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'isEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<_c0f4.PrioritizedIntents, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'invoke'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_c0f4.PrioritizedIntents, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'consumesKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.consumesKey(_36c2.maybeUnBoxAndBuildArgument<_c0f4.PrioritizedIntents, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'addActionListener'
...
final _c0f4.PrioritizedAction vmObject;

 }

class RTManagedPrioritizedAction extends _c0f4.PrioritizedAction implements _36c2.Box<_c0f4.PrioritizedAction> {RTManagedPrioritizedAction({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_invoke'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.invoke(_36c2.maybeUnBoxAndBuildArgument<
            _c0f4.PrioritizedIntents,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
        hydroState: hydroState,
        table: _36c2.HydroTable())
...
_c0f4.PrioritizedAction unwrap() => this;
_c0f4.PrioritizedAction get vmObject => this;
@_fac9.override _fac9.bool isEnabled(intent) { 
_36c2.Closure closure = table["isEnabled"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Object? invoke(intent) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _c0f4.Action<_c0f4.PrioritizedIntents>? get callingAction { 
_36c2.Closure closure = table["getCallingAction"];
return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.PrioritizedIntents>?, _c0f4.PrioritizedIntents>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPrioritizedAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'prioritizedAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPrioritizedAction(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.PrioritizedAction>(boxer: ({required _c0f4.PrioritizedAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPrioritizedAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

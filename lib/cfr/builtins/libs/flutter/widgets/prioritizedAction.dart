...
class VMManagedPrioritizedAction
    extends _36c2.VMManagedBox<_c0f4.PrioritizedAction> {
  VMManagedPrioritizedAction(
    ...
    table['invoke'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<
          _c0f4.PrioritizedIntents,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      if (returnValue != null) {
        return [
...
class RTManagedPrioritizedAction extends _c0f4.PrioritizedAction
    implements _36c2.Box<_c0f4.PrioritizedAction> {
  RTManagedPrioritizedAction({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _c0f4.Action<_c0f4.PrioritizedIntents>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c0f4.Action<_c0f4.PrioritizedIntents>?, _c0f4.PrioritizedIntents>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadPrioritizedAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['prioritizedAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPrioritizedAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_c0f4.PrioritizedAction>(boxer: (
      {required _c0f4.PrioritizedAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPrioritizedAction(

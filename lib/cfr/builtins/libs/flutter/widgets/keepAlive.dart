...
class VMManagedKeepAlive extends _36c2.VMManagedBox<_a8eb.KeepAlive> {VMManagedKeepAlive({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugCanApplyOutOfTurn(),]; } );
table  [
...
final _a8eb.KeepAlive vmObject;

 }

class RTManagedKeepAlive extends _a8eb.KeepAlive implements _36c2.Box<_a8eb.KeepAlive> {RTManagedKeepAlive({_ab4a.Key? key, required _e2dc.Widget child, required _fac9.bool keepAlive, required this.table, required this.hydroState}) : super(key: key,child: child,keepAlive: keepAlive) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'keepAlive'
] = _36c2.maybeBoxObject(object: this.keepAlive, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_a8eb.KeepAlive unwrap() => this;
_a8eb.KeepAlive get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.ParentDataElement<_35be.KeepAliveParentDataMixin> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataElement<_35be.KeepAliveParentDataMixin>, _35be.KeepAliveParentDataMixin>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadKeepAlive({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keepAlive'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedKeepAlive(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), keepAlive: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'keepAlive'
] : null)]; } );
_36c2.registerBoxer<_a8eb.KeepAlive>(boxer: ({required _a8eb.KeepAlive vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeepAlive(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

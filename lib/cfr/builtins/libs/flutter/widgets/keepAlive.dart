...
class VMManagedKeepAlive extends _36c2.VMManagedBox<_a8eb.KeepAlive> {
  VMManagedKeepAlive(
    ...
    table['debugCanApplyOutOfTurn'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.debugCanApplyOutOfTurn(),
      ];
    });
...
class RTManagedKeepAlive extends _a8eb.KeepAlive
    implements _36c2.Box<_a8eb.KeepAlive> {
  RTManagedKeepAlive(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _fac9.bool keepAlive,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, keepAlive: keepAlive) {
  ...
  @_fac9.override
  _e2dc.ParentDataElement<_35be.KeepAliveParentDataMixin> createElement() {
    _36c2.Closure closure = table["createElement"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.ParentDataElement<_35be.KeepAliveParentDataMixin>,
            _35be.KeepAliveParentDataMixin>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
      ...
      RTManagedKeepAlive(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          keepAlive: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['keepAlive']
              : null)
    ];
  });
  _36c2.registerBoxer<_a8eb.KeepAlive>(boxer: (
      {required _a8eb.KeepAlive vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedKeepAlive(

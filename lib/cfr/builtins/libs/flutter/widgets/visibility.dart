...
class VMManagedVisibility extends _36c2.VMManagedBox<_4424.Visibility> {VMManagedVisibility({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'replacement'
] = _36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.replacement, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'visible'
] = vmObject.visible;
table  [
...
final _4424.Visibility vmObject;

 }

class RTManagedVisibility extends _4424.Visibility implements _36c2.Box<_4424.Visibility> {RTManagedVisibility({_ab4a.Key? key, required _fac9.bool maintainAnimation, required _fac9.bool maintainInteractivity, required _fac9.bool maintainSemantics, required _fac9.bool maintainSize, required _fac9.bool maintainState, required _e2dc.Widget replacement, required _fac9.bool visible, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,maintainAnimation: maintainAnimation,maintainInteractivity: maintainInteractivity,maintainSemantics: maintainSemantics,maintainSize: maintainSize,maintainState: maintainState,replacement: replacement,visible: visible,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'replacement'
] = _36c2.maybeBoxObject(object: this.replacement, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'visible'
...
_4424.Visibility unwrap() => this;
_4424.Visibility get vmObject => this;
...
void loadVisibility({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'visibility'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedVisibility(table: luaCallerArguments  [
0
...
'maintainState'
] : null, replacement: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'replacement'
...
_36c2.registerBoxer<_4424.Visibility>(boxer: ({required _4424.Visibility vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedVisibility(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

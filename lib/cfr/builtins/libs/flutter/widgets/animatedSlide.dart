...
class VMManagedAnimatedSlide extends _36c2.VMManagedBox<_da7c.AnimatedSlide> {
  VMManagedAnimatedSlide(
...
class RTManagedAnimatedSlide extends _da7c.AnimatedSlide
    implements _36c2.Box<_da7c.AnimatedSlide> {
  RTManagedAnimatedSlide(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedSlide> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedSlide>,
            _da7c.AnimatedSlide>(
...
void loadAnimatedSlide(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedSlide'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_da7c.AnimatedSlide>(boxer: (
      {required _da7c.AnimatedSlide vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedSlide(

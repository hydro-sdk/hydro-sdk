...
class VMManagedAnimatedSlide extends _36c2.VMManagedBox<_da7c.AnimatedSlide> {VMManagedAnimatedSlide({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.AnimatedSlide vmObject;

 }

class RTManagedAnimatedSlide extends _da7c.AnimatedSlide implements _36c2.Box<_da7c.AnimatedSlide> {RTManagedAnimatedSlide({_e2dc.Widget? child, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _fac9.Duration duration, required _a643.Offset offset, required this.table, required this.hydroState}) : super(child: child,curve: curve,key: key,onEnd: onEnd,duration: duration,offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.AnimatedSlide unwrap() => this;
_da7c.AnimatedSlide get vmObject => this;
@_fac9.override _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedSlide> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedSlide>, _da7c.AnimatedSlide>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedSlide({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedSlide'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedSlide(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_da7c.AnimatedSlide>(boxer: ({required _da7c.AnimatedSlide vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedSlide(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverReorderableListState extends _36c2.VMManagedBox<_acd7.SliverReorderableListState> {VMManagedSliverReorderableListState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'didUpdateWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<_acd7.SliverReorderableList, _fac9.dynamic>(luaCallerArguments  [
1
...
vmObject.startItemDragReorder(event: _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerDownEvent, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'event'
...
'index'
] : null, recognizer: _36c2.maybeUnBoxAndBuildArgument<_d5f6.MultiDragGestureRecognizer, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'recognizer'
...
table  [
'cancelReorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.cancelReorder();
return []; } );
table  [
'build'
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_acd7.SliverReorderableList>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedSliverReorderableListState extends _acd7.SliverReorderableListState implements _36c2.Box<_acd7.SliverReorderableListState> {RTManagedSliverReorderableListState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_startItemDragReorder'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.startItemDragReorder(
      ...
      index: _36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
          ...
          parentState: hydroState),
      recognizer:
          _36c2.maybeUnBoxAndBuildArgument<_d5f6.MultiDragGestureRecognizer, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['recognizer'] : null,
              parentState: hydroState));
  return [];
});
table['_dart_cancelReorder'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.cancelReorder();
  return [];
});
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void startItemDragReorder({required _0e77.PointerDownEvent event, required _fac9.int index, required _d5f6.MultiDragGestureRecognizer recognizer}) { 
_36c2.Closure closure = table["startItemDragReorder"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void cancelReorder() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _acd7.SliverReorderableList get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_acd7.SliverReorderableList, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverReorderableListState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverReorderableListState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSliverReorderableListState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_acd7.SliverReorderableListState>(boxer: ({required _acd7.SliverReorderableListState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverReorderableListState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedInheritedTheme extends _36c2.VMManagedBox<_ac47.InheritedTheme> {
  VMManagedInheritedTheme(
...
class RTManagedInheritedTheme extends _ac47.InheritedTheme
    implements _36c2.Box<_ac47.InheritedTheme> {
  RTManagedInheritedTheme(
      {_ab4a.Key? key,
...
void loadInheritedTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['inheritedTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedInheritedTheme(
  ...
  table['inheritedThemeCaptureAll'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_e2dc.Widget>(
          object: _ac47.InheritedTheme.captureAll(
              ...
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  luaCallerArguments[2],
                  parentState: hydroState),
              to: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext?,
                      _fac9.dynamic>(
                  luaCallerArguments.length >= 4 ? luaCallerArguments[3]['to'] : null,
                  parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  table['inheritedThemeCapture'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_ac47.CapturedThemes>(
          object: _ac47.InheritedTheme.capture(
              from: _36c2
  ...
  _36c2.registerBoxer<_ac47.InheritedTheme>(boxer: (
      {required _ac47.InheritedTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInheritedTheme(

...
class VMManagedInheritedTheme extends _36c2.VMManagedBox<_ac47.InheritedTheme> {VMManagedInheritedTheme({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _ac47.InheritedTheme vmObject;

 }

class RTManagedInheritedTheme extends _ac47.InheritedTheme implements _36c2.Box<_ac47.InheritedTheme> {RTManagedInheritedTheme({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateShouldNotify'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
...
_ac47.InheritedTheme unwrap() => this;
_ac47.InheritedTheme get vmObject => this;
...
void loadInheritedTheme({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedTheme'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedInheritedTheme(table: luaCallerArguments  [
0
...
table  [
'inheritedThemeCaptureAll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return [_36c2.maybeBoxObject<_e2dc.Widget>(object: _ac47.InheritedTheme.captureAll(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), to: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext?, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'to'
] : null, parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'inheritedThemeCapture'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_ac47.CapturedThemes>(object: _ac47.InheritedTheme.capture(from: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'from'
] : null, parentState: hydroState), to: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'to'
] : null, parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_ac47.InheritedTheme>(boxer: ({required _ac47.InheritedTheme vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedTheme(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

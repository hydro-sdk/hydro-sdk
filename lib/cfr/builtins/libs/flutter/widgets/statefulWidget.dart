...
class VMManagedStatefulWidget extends VMManagedBox<StatefulWidget> {
  VMManagedStatefulWidget(
    ...
    table['createElement'] =
      ...
      return [
        maybeBoxObject<StatefulElement>(
  ...
  final StatefulWidget vmObject;
}

class RTManagedStatefulWidget extends StatefulWidget
    implements Box<StatefulWidget> {
  RTManagedStatefulWidget(
    ...
    table['_dart_createState'] =
      ...
      return [
        maybeBoxObject<State>(
            object: createState(), hydroState: hydroState, table: HydroTable())
      ];
    });
  ...
  StatefulWidget unwrap() => this;
  StatefulWidget get vmObject => this;
  @override
  StatefulElement createElement() {
    Closure closure = table["createElement"];
    return maybeUnBoxAndBuildArgument<StatefulElement, dynamic>(
  ...
  State<StatefulWidget> createState() {
    Closure closure = table["createState"];
...
void loadStatefulWidget(
  ...
  registerBoxer<StatefulWidget>(boxer: (
      {required StatefulWidget vmObject,

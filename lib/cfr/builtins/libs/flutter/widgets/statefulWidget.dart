...
class VMManagedStatefulWidget extends _36c2.VMManagedBox<_e2dc.StatefulWidget> {
...
class RTManagedStatefulWidget extends _e2dc.StatefulWidget
    implements _36c2.Box<_e2dc.StatefulWidget> {
...
void loadStatefulWidget(
  ...
  table['statefulWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStatefulWidget(
  ...
  _36c2.registerBoxer<_e2dc.StatefulWidget>(boxer: (
      {required _e2dc.StatefulWidget vmObject,

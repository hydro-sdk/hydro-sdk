...
class VMManagedStatefulWidget extends _36c2.VMManagedBox<_e2dc.StatefulWidget> {VMManagedStatefulWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.StatefulWidget vmObject;

 }

class RTManagedStatefulWidget extends _e2dc.StatefulWidget implements _36c2.Box<_e2dc.StatefulWidget> {RTManagedStatefulWidget({_ab4a.Key? key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.StatefulWidget unwrap() => this;
_e2dc.StatefulWidget get vmObject => this;
...
void loadStatefulWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statefulWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedStatefulWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.StatefulWidget>(boxer: ({required _e2dc.StatefulWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatefulWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

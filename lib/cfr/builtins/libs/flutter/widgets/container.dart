...
class VMManagedContainer extends _36c2.VMManagedBox<_7716.Container> {
  VMManagedContainer(
...
class RTManagedContainer extends _7716.Container
    implements _36c2.Box<_7716.Container> {
  RTManagedContainer(
...
void loadContainer(
  ...
  table['container'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedContainer(
  ...
  _36c2.registerBoxer<_7716.Container>(boxer: (
      {required _7716.Container vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedContainer(

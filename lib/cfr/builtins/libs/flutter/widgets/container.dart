...
class VMManagedContainer extends _36c2.VMManagedBox<_7716.Container> {VMManagedContainer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7716.Container vmObject;

 }

class RTManagedContainer extends _7716.Container implements _36c2.Box<_7716.Container> {RTManagedContainer({_ca85.AlignmentGeometry? alignment, _e2dc.Widget? child, required _a643.Clip clipBehavior, _a643.Color? color, _be2e.BoxConstraints? constraints, _13a5.Decoration? decoration, _13a5.Decoration? foregroundDecoration, _fac9.double? height, _ab4a.Key? key, _96d1.EdgeInsetsGeometry? margin, _96d1.EdgeInsetsGeometry? padding, _db98.Matrix4? transform, _ca85.AlignmentGeometry? transformAlignment, _fac9.double? width, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,color: color,constraints: constraints,decoration: decoration,foregroundDecoration: foregroundDecoration,height: height,key: key,margin: margin,padding: padding,transform: transform,transformAlignment: transformAlignment,width: width) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7716.Container unwrap() => this;
_7716.Container get vmObject => this;
...
void loadContainer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'container'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedContainer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7716.Container>(boxer: ({required _7716.Container vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedContainer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedBlockSemantics extends _36c2.VMManagedBox<_3960.BlockSemantics> {
  VMManagedBlockSemantics(
    ...
    table['blocking'] = vmObject.blocking;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderBlockSemantics>(
...
class RTManagedBlockSemantics extends _3960.BlockSemantics
    implements _36c2.Box<_3960.BlockSemantics> {
  RTManagedBlockSemantics(
      {required _fac9.bool blocking,
      _e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
      required this.hydroState})
      : super(blocking: blocking, child: child, key: key) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['blocking'] = _36c2.maybeBoxObject(
        object: this.blocking,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderBlockSemantics createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderBlockSemantics, _fac9.dynamic>(
...
void loadBlockSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['blockSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBlockSemantics(
  ...
  _36c2.registerBoxer<_3960.BlockSemantics>(boxer: (
      {required _3960.BlockSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBlockSemantics(

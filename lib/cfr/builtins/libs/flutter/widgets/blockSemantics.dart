...
class VMManagedBlockSemantics extends _36c2.VMManagedBox<_3960.BlockSemantics> {VMManagedBlockSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderBlockSemantics>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBlockSemantics, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.BlockSemantics vmObject;

 }

class RTManagedBlockSemantics extends _3960.BlockSemantics implements _36c2.Box<_3960.BlockSemantics> {RTManagedBlockSemantics({required _fac9.bool blocking, _e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(blocking: blocking,child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'blocking'
] = _36c2.maybeBoxObject(object: this.blocking, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBlockSemantics,
...
_3960.BlockSemantics unwrap() => this;
_3960.BlockSemantics get vmObject => this;
@_fac9.override _bf98.RenderBlockSemantics createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderBlockSemantics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadBlockSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'blockSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedBlockSemantics(table: luaCallerArguments  [
0
], hydroState: hydroState, blocking: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'blocking'
...
_36c2.registerBoxer<_3960.BlockSemantics>(boxer: ({required _3960.BlockSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBlockSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

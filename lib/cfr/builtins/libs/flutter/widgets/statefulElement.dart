...
class VMManagedStatefulElement
    extends _36c2.VMManagedBox<_e2dc.StatefulElement> {
...
class RTManagedStatefulElement extends _e2dc.StatefulElement
    implements _36c2.Box<_e2dc.StatefulElement> {
  RTManagedStatefulElement(_e2dc.StatefulWidget widget$,
...
void loadStatefulElement(
  ...
  table['statefulElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.StatefulElement>(boxer: (
      {required _e2dc.StatefulElement vmObject,

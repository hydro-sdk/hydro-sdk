...
class VMManagedStatefulElement extends _36c2.VMManagedBox<_e2dc.StatefulElement> {VMManagedStatefulElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.State>(object: vmObject.state, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'reassemble'
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatefulWidget, _fac9.dynamic>(luaCallerArguments  [
1
...
return [_36c2.maybeBoxObject<_e2dc.InheritedWidget>(object: vmObject.dependOnInheritedElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(luaCallerArguments  [
1
...
final _e2dc.StatefulElement vmObject;

 }

class RTManagedStatefulElement extends _e2dc.StatefulElement implements _36c2.Box<_e2dc.StatefulElement> {RTManagedStatefulElement(_e2dc.StatefulWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_update'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.update(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.StatefulWidget, _fac9.dynamic>(
...
_e2dc.StatefulElement unwrap() => this;
_e2dc.StatefulElement get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Widget get widget { 
...
void loadStatefulElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statefulElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedStatefulElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatefulWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.StatefulElement>(boxer: ({required _e2dc.StatefulElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatefulElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

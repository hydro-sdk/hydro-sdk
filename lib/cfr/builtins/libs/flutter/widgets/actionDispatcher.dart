...
class VMManagedActionDispatcher extends _36c2.VMManagedBox<_c0f4.ActionDispatcher> {VMManagedActionDispatcher({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final returnValue = vmObject.invokeAction(_36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.Intent>, _c0f4.Intent>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_c0f4.Intent, _fac9.dynamic>(luaCallerArguments  [
2
...
class RTManagedActionDispatcher extends _c0f4.ActionDispatcher implements _36c2.Box<_c0f4.ActionDispatcher> {RTManagedActionDispatcher({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_invokeAction'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
@_fac9.override _fac9.Object? invokeAction(action, intent, [_e2dc.BuildContext? context]) { 
...
void loadActionDispatcher({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'actionDispatcher'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedActionDispatcher(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.ActionDispatcher>(boxer: ({required _c0f4.ActionDispatcher vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedActionDispatcher(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

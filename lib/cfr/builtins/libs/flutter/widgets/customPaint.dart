...
class VMManagedCustomPaint extends _36c2.VMManagedBox<_3960.CustomPaint> {
  VMManagedCustomPaint(
    ...
    table['painter'] = _36c2.maybeBoxObject<_93cf.CustomPainter?>(
        object: vmObject.painter,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['foregroundPainter'] = _36c2.maybeBoxObject<_93cf.CustomPainter?>(
        object: vmObject.foregroundPainter,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_93cf.RenderCustomPaint>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint,
              _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState));
      return [];
    });
    table['didUnmountRenderObject'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<
          _93cf.RenderCustomPaint,
...
class RTManagedCustomPaint extends _3960.CustomPaint
    implements _36c2.Box<_3960.CustomPaint> {
  RTManagedCustomPaint(
      {_e2dc.Widget? child,
    ...
    table['painter'] = _36c2.maybeBoxObject(
        object: this.painter,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['foregroundPainter'] = _36c2.maybeBoxObject(
        object: this.foregroundPainter,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_didUnmountRenderObject'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<
          _93cf.RenderCustomPaint,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _93cf.RenderCustomPaint createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint, _fac9.dynamic>(
...
void loadCustomPaint(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['customPaint'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCustomPaint(
  ...
  _36c2.registerBoxer<_3960.CustomPaint>(boxer: (
      {required _3960.CustomPaint vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCustomPaint(

...
class VMManagedCustomPaint extends _36c2.VMManagedBox<_3960.CustomPaint> {VMManagedCustomPaint({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'painter'
] = _36c2.maybeBoxObject<_93cf.CustomPainter?>(object: vmObject.painter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'foregroundPainter'
] = _36c2.maybeBoxObject<_93cf.CustomPainter?>(object: vmObject.foregroundPainter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'size'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_93cf.RenderCustomPaint>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
'didUnmountRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _3960.CustomPaint vmObject;

 }

class RTManagedCustomPaint extends _3960.CustomPaint implements _36c2.Box<_3960.CustomPaint> {RTManagedCustomPaint({_e2dc.Widget? child, _93cf.CustomPainter? foregroundPainter, required _fac9.bool isComplex, _ab4a.Key? key, _93cf.CustomPainter? painter, required _a643.Size size, required _fac9.bool willChange, required this.table, required this.hydroState}) : super(child: child,foregroundPainter: foregroundPainter,isComplex: isComplex,key: key,painter: painter,size: size,willChange: willChange) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'painter'
] = _36c2.maybeBoxObject(object: this.painter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'foregroundPainter'
] = _36c2.maybeBoxObject(object: this.foregroundPainter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'size'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint, _fac9.dynamic>(
...
_3960.CustomPaint unwrap() => this;
_3960.CustomPaint get vmObject => this;
@_fac9.override _93cf.RenderCustomPaint createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_93cf.RenderCustomPaint, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCustomPaint({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'customPaint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCustomPaint(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), painter: _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'painter'
] : null, parentState: hydroState), size: _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'size'
...
_36c2.registerBoxer<_3960.CustomPaint>(boxer: ({required _3960.CustomPaint vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCustomPaint(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

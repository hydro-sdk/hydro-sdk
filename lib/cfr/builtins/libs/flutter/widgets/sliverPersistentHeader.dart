...
class VMManagedSliverPersistentHeader
    extends _36c2.VMManagedBox<_be51.SliverPersistentHeader> {
  VMManagedSliverPersistentHeader(
    ...
    table['delegate'] =
        _36c2.maybeBoxObject<_be51.SliverPersistentHeaderDelegate>(
...
class RTManagedSliverPersistentHeader extends _be51.SliverPersistentHeader
    implements _36c2.Box<_be51.SliverPersistentHeader> {
  RTManagedSliverPersistentHeader(
      {required _fac9.bool floating,
      _ab4a.Key? key,
      required _fac9.bool pinned,
      required _be51.SliverPersistentHeaderDelegate delegate,
      required this.table,
      required this.hydroState})
      : super(
            floating: floating, key: key, pinned: pinned, delegate: delegate) {
...
void loadSliverPersistentHeader(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverPersistentHeader'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverPersistentHeader(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          floating: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['floating']
              : null,
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          pinned: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['pinned']
              : null,
          delegate: _36c2.maybeUnBoxAndBuildArgument<
                  _be51.SliverPersistentHeaderDelegate, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_be51.SliverPersistentHeader>(boxer: (
      {required _be51.SliverPersistentHeader vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverPersistentHeader(

...
class VMManagedSliverPersistentHeader extends _36c2.VMManagedBox<_be51.SliverPersistentHeader> {VMManagedSliverPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'delegate'
] = _36c2.maybeBoxObject<_be51.SliverPersistentHeaderDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pinned'
] = vmObject.pinned;
table  [
...
final _be51.SliverPersistentHeader vmObject;

 }

class RTManagedSliverPersistentHeader extends _be51.SliverPersistentHeader implements _36c2.Box<_be51.SliverPersistentHeader> {RTManagedSliverPersistentHeader({required _fac9.bool floating, _ab4a.Key? key, required _fac9.bool pinned, required _be51.SliverPersistentHeaderDelegate delegate, required this.table, required this.hydroState}) : super(floating: floating,key: key,pinned: pinned,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'pinned'
] = _36c2.maybeBoxObject(object: this.pinned, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'floating'
] = _36c2.maybeBoxObject(object: this.floating, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_be51.SliverPersistentHeader unwrap() => this;
_be51.SliverPersistentHeader get vmObject => this;
...
void loadSliverPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverPersistentHeader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSliverPersistentHeader(table: luaCallerArguments  [
0
], hydroState: hydroState, floating: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'floating'
...
'key'
] : null, parentState: hydroState), pinned: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pinned'
] : null, delegate: _36c2.maybeUnBoxAndBuildArgument<_be51.SliverPersistentHeaderDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_be51.SliverPersistentHeader>(boxer: ({required _be51.SliverPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedState
    extends _36c2.VMManagedBox<_e2dc.State<_e2dc.StatefulWidget>> {
  VMManagedState(
...
class RTManagedState extends _e2dc.State implements _36c2.Box<_e2dc.State> {
  ...
  @_fac9.override
  _e2dc.StatefulWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e2dc.StatefulWidget, _fac9.dynamic>(
...
void loadState(
  ...
  table['state'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedState(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e2dc.State>(boxer: (
      {required _e2dc.State vmObject,

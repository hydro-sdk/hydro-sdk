...
class VMManagedMediaQueryData extends _36c2.VMManagedBox<_e0b9.MediaQueryData> {
  VMManagedMediaQueryData(
    ...
    table['platformBrightness'] = _a643.Brightness.values.indexWhere((x) {
      return x == vmObject.platformBrightness;
    });
    table['viewInsets'] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(
    ...
    table['padding'] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['viewPadding'] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(
        object: vmObject.viewPadding,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['systemGestureInsets'] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(
        object: vmObject.systemGestureInsets,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['alwaysUse24HourFormat'] = vmObject.alwaysUse24HourFormat;
    table['accessibleNavigation'] = vmObject.accessibleNavigation;
    table['invertColors'] = vmObject.invertColors;
    table['highContrast'] = vmObject.highContrast;
    table['disableAnimations'] = vmObject.disableAnimations;
    table['boldText'] = vmObject.boldText;
    table['navigationMode'] = _e0b9.NavigationMode.values.indexWhere((x) {
      return x == vmObject.navigationMode;
    });
    table['gestureSettings'] =
        _36c2.maybeBoxObject<_352d.DeviceGestureSettings>(
            ...
            hydroState: hydroState,
            table: _36c2.HydroTable());
    table['getOrientation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _e0b9.Orientation.values.indexWhere((x) {
          return x == vmObject.orientation;
        }),
      ];
    });
      ...
      return [
        _36c2.maybeBoxObject<_e0b9.MediaQueryData>(
            object: vmObject.copyWith(
                accessibleNavigation: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['accessibleNavigation']
                    : null,
                alwaysUse24HourFormat: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['alwaysUse24HourFormat']
                    : null,
                boldText: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['boldText']
                    : null,
                devicePixelRatio: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['devicePixelRatio']
                    : null?.toDouble(),
                disableAnimations: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['disableAnimations']
                    : null,
                gestureSettings: _36c2.maybeUnBoxAndBuildArgument<_352d.DeviceGestureSettings?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['gestureSettings'] : null,
                    parentState: hydroState),
                highContrast: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['highContrast']
                    : null,
                invertColors: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['invertColors']
                    : null,
                navigationMode: _36c2.maybeUnBoxEnum(
                    values: _e0b9.NavigationMode.values,
                    boxedEnum: luaCallerArguments.length >= 2
                        ? luaCallerArguments[1]['navigationMode']
                        : null),
                padding: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsets?, _fac9.dynamic>(
    ...
    table['removePadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e0b9.MediaQueryData>(
            object: vmObject.removePadding(
    ...
    table['removeViewInsets'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e0b9.MediaQueryData>(
            object: vmObject.removeViewInsets(
                removeBottom: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['removeBottom']
                    : null,
                removeLeft: luaCallerArguments.length >= 2
    ...
    table['removeViewPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e0b9.MediaQueryData>(
            object: vmObject.removeViewPadding(
                removeBottom: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['removeBottom']
                    : null,
                removeLeft: luaCallerArguments.length >= 2
...
class RTManagedMediaQueryData extends _e0b9.MediaQueryData
    implements _36c2.Box<_e0b9.MediaQueryData> {
  RTManagedMediaQueryData(
      {required _fac9.bool accessibleNavigation,
      required _fac9.bool alwaysUse24HourFormat,
      required _fac9.bool boldText,
      required _fac9.double devicePixelRatio,
      required _fac9.bool disableAnimations,
      required _352d.DeviceGestureSettings gestureSettings,
      required _fac9.bool highContrast,
      required _fac9.bool invertColors,
      required _e0b9.NavigationMode navigationMode,
      required _96d1.EdgeInsets padding,
      required _a643.Brightness platformBrightness,
      required _a643.Size size,
      required _96d1.EdgeInsets systemGestureInsets,
      required _fac9.double textScaleFactor,
      required _96d1.EdgeInsets viewInsets,
      required _96d1.EdgeInsets viewPadding,
      required this.table,
    ...
    table['devicePixelRatio'] = _36c2.maybeBoxObject(
        object: this.devicePixelRatio,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['textScaleFactor'] = _36c2.maybeBoxObject(
        ...
        table: _36c2.HydroTable());
    table['platformBrightness'] = _a643.Brightness.values.indexWhere((x) {
      return x == this.platformBrightness;
    });
    table['viewInsets'] = _36c2.maybeBoxObject(
        object: this.viewInsets,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['padding'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['viewPadding'] = _36c2.maybeBoxObject(
        object: this.viewPadding,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['systemGestureInsets'] = _36c2.maybeBoxObject(
        object: this.systemGestureInsets,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['alwaysUse24HourFormat'] = _36c2.maybeBoxObject(
        object: this.alwaysUse24HourFormat,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['accessibleNavigation'] = _36c2.maybeBoxObject(
        object: this.accessibleNavigation,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['invertColors'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highContrast'] = _36c2.maybeBoxObject(
        object: this.highContrast,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['disableAnimations'] = _36c2.maybeBoxObject(
        object: this.disableAnimations,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['boldText'] = _36c2.maybeBoxObject(
        object: this.boldText,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['navigationMode'] = _e0b9.NavigationMode.values.indexWhere((x) {
      return x == this.navigationMode;
    });
    table['gestureSettings'] = _36c2.maybeBoxObject(
        object: this.gestureSettings,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getOrientation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_removePadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_removeViewInsets'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_removeViewPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _e0b9.Orientation get orientation {
    _36c2.Closure closure = table["getOrientation"];
    return _36c2.maybeUnBoxEnum(
        values: _e0b9.Orientation.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }

  @_fac9.override
  _e0b9.MediaQueryData copyWith(
      {_fac9.bool? accessibleNavigation,
      _fac9.bool? alwaysUse24HourFormat,
      _fac9.bool? boldText,
      _fac9.double? devicePixelRatio,
      _fac9.bool? disableAnimations,
      _352d.DeviceGestureSettings? gestureSettings,
      _fac9.bool? highContrast,
      _fac9.bool? invertColors,
      _e0b9.NavigationMode? navigationMode,
      _96d1.EdgeInsets? padding,
      _a643.Brightness? platformBrightness,
      _a643.Size? size,
      _96d1.EdgeInsets? systemGestureInsets,
      _fac9.double? textScaleFactor,
      _96d1.EdgeInsets? viewInsets,
      _96d1.EdgeInsets? viewPadding}) {
    _36c2.Closure closure = table["copyWith"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e0b9.MediaQueryData, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _e0b9.MediaQueryData removePadding(
      {_fac9.bool removeBottom = false,
      _fac9.bool removeLeft = false,
      _fac9.bool removeRight = false,
      _fac9.bool removeTop = false}) {
  ...
  @_fac9.override
  _e0b9.MediaQueryData removeViewInsets(
      {_fac9.bool removeBottom = false,
      _fac9.bool removeLeft = false,
      _fac9.bool removeRight = false,
      _fac9.bool removeTop = false}) {
  ...
  @_fac9.override
  _e0b9.MediaQueryData removeViewPadding(
      {_fac9.bool removeBottom = false,
      _fac9.bool removeLeft = false,
      _fac9.bool removeRight = false,
      _fac9.bool removeTop = false}) {
...
void loadMediaQueryData(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['mediaQueryData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMediaQueryData(
          ...
          disableAnimations: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['disableAnimations']
              : null,
          gestureSettings: _36c2
              .maybeUnBoxAndBuildArgument<_352d.DeviceGestureSettings, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['gestureSettings']
                      : null,
                  parentState: hydroState),
          highContrast: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['highContrast']
  ...
  _36c2.registerBoxer<_e0b9.MediaQueryData>(boxer: (
      {required _e0b9.MediaQueryData vmObject,

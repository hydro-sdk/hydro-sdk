...
class VMManagedPlatformViewSurface
    extends _36c2.VMManagedBox<_172d.PlatformViewSurface> {
  VMManagedPlatformViewSurface(
    ...
    table['controller'] = _36c2.maybeBoxObject<_40e3.PlatformViewController>(
...
class RTManagedPlatformViewSurface extends _172d.PlatformViewSurface
    implements _36c2.Box<_172d.PlatformViewSurface> {
  RTManagedPlatformViewSurface(
      {_ab4a.Key? key,
  ...
  @_fac9.override
  _9742.RenderObject createRenderObject(context) {
...
void loadPlatformViewSurface(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['platformViewSurface'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlatformViewSurface(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          controller: _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_172d.PlatformViewSurface>(boxer: (
      {required _172d.PlatformViewSurface vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPlatformViewSurface(

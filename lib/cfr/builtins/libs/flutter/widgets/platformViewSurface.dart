...
class VMManagedPlatformViewSurface extends _36c2.VMManagedBox<_172d.PlatformViewSurface> {VMManagedPlatformViewSurface({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'controller'
] = _36c2.maybeBoxObject<_40e3.PlatformViewController>(object: vmObject.controller, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'gestureRecognizers'
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_6ecd.PlatformViewRenderBox, _fac9.dynamic>(luaCallerArguments  [
2
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_6ecd.PlatformViewRenderBox,
...
_172d.PlatformViewSurface unwrap() => this;
_172d.PlatformViewSurface get vmObject => this;
...
void loadPlatformViewSurface({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'platformViewSurface'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedPlatformViewSurface(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), controller: _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
...
_36c2.registerBoxer<_172d.PlatformViewSurface>(boxer: ({required _172d.PlatformViewSurface vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformViewSurface(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

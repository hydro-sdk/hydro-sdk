...
class VMManagedParentDataElement
    extends _36c2.VMManagedBox<_e2dc.ParentDataElement<_9742.ParentData>> {
  VMManagedParentDataElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_e2dc.ParentDataWidget>(
...
class RTManagedParentDataElement extends _e2dc.ParentDataElement
    implements _36c2.Box<_e2dc.ParentDataElement> {
  RTManagedParentDataElement(_e2dc.ParentDataWidget<_9742.ParentData> widget$,
    ...
    table['_dart_applyWidgetOutOfTurn'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _e2dc.ParentDataWidget<_9742.ParentData> get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.ParentDataWidget<_9742.ParentData>, _9742.ParentData>(
...
void loadParentDataElement(
  ...
  table['parentDataElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.ParentDataElement>(boxer: (
      {required _e2dc.ParentDataElement vmObject,

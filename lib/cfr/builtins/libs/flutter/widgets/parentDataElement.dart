...
class VMManagedParentDataElement extends _36c2.VMManagedBox<_e2dc.ParentDataElement<_9742.ParentData>> {VMManagedParentDataElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.ParentDataWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'applyWidgetOutOfTurn'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.applyWidgetOutOfTurn(_36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataWidget<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'notifyClients'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.notifyClients(_36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataWidget<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _e2dc.ParentDataElement<_9742.ParentData> vmObject;

 }

class RTManagedParentDataElement extends _e2dc.ParentDataElement implements _36c2.Box<_e2dc.ParentDataElement> {RTManagedParentDataElement(_e2dc.ParentDataWidget<_9742.ParentData> widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_applyWidgetOutOfTurn'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.applyWidgetOutOfTurn(_36c2.maybeUnBoxAndBuildArgument<
...
_e2dc.ParentDataElement unwrap() => this;
_e2dc.ParentDataElement get vmObject => this;
@_fac9.override _e2dc.ParentDataWidget<_9742.ParentData> get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataWidget<_9742.ParentData>, _9742.ParentData>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void applyWidgetOutOfTurn(newWidget) { 
_36c2.Closure closure = table["applyWidgetOutOfTurn"];
...
void loadParentDataElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'parentDataElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedParentDataElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataWidget<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.ParentDataElement>(boxer: ({required _e2dc.ParentDataElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedParentDataElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

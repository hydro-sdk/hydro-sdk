...
class VMManagedParentDataElement
    extends VMManagedBox<ParentDataElement<ParentData>> {
  VMManagedParentDataElement(
    ...
    table['getWidget'] =
      ...
      return [
        maybeBoxObject<ParentDataWidget>(
            object: vmObject.widget,
            hydroState: hydroState,
            table: HydroTable()),
      ];
    });
    table['applyWidgetOutOfTurn'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.applyWidgetOutOfTurn(
          maybeUnBoxAndBuildArgument<ParentDataWidget<dynamic>, dynamic>(
  ...
  final ParentDataElement<ParentData> vmObject;
}

class RTManagedParentDataElement extends ParentDataElement
    implements Box<ParentDataElement> {
  RTManagedParentDataElement(ParentDataWidget<ParentData> widget$,
    ...
    table['_dart_updated'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.updated(maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  ParentDataElement unwrap() => this;
  ParentDataElement get vmObject => this;
  @override
  ParentDataWidget<ParentData> get widget {
    Closure closure = table["getWidget"];
    return maybeUnBoxAndBuildArgument<ParentDataWidget<ParentData>, ParentData>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void applyWidgetOutOfTurn(ParentDataWidget newWidget) {
    Closure closure = table["applyWidgetOutOfTurn"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void notifyClients(ParentDataWidget oldWidget) {
...
void loadParentDataElement(
    {required HydroState hydroState, required HydroTable table}) {
  table['parentDataElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedParentDataElement(
          maybeUnBoxAndBuildArgument<ParentDataWidget<dynamic>, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<ParentDataElement>(boxer: (
      {required ParentDataElement vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedParentDataElement(

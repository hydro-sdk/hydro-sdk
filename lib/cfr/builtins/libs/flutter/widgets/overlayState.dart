...
class VMManagedOverlayState extends _36c2.VMManagedBox<_0049.OverlayState> {
  VMManagedOverlayState(
    ...
    table['insert'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.insert(
          ...
          above: _36c2
              .maybeUnBoxAndBuildArgument<_0049.OverlayEntry?, _fac9.dynamic>(
    ...
    table['insertAll'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.insertAll(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_0049.OverlayEntry>,
                  _0049.OverlayEntry>(luaCallerArguments[1],
              parentState: hydroState),
          above:
              _36c2.maybeUnBoxAndBuildArgument<_0049.OverlayEntry?, _fac9.dynamic>(
                  luaCallerArguments.length >= 3
    ...
    table['rearrange'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rearrange(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_0049.OverlayEntry>,
                  _0049.OverlayEntry>(luaCallerArguments[1],
    ...
    table['debugIsVisible'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.debugIsVisible(
            _36c2.maybeUnBoxAndBuildArgument<_0049.OverlayEntry, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
      ];
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_0049.Overlay>(
...
class RTManagedOverlayState extends _0049.OverlayState
    implements _36c2.Box<_0049.OverlayState> {
  RTManagedOverlayState({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_insertAll'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.insertAll(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_0049.OverlayEntry>,
                  _0049.OverlayEntry>(luaCallerArguments[1],
    ...
    table['_dart_rearrange'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.rearrange(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_0049.OverlayEntry>,
                  _0049.OverlayEntry>(luaCallerArguments[1],
    ...
    table['_dart_debugIsVisible'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.debugIsVisible(_36c2.maybeUnBoxAndBuildArgument<
                _0049.OverlayEntry,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  void insert(entry, {_0049.OverlayEntry? above, _0049.OverlayEntry? below}) {
    _36c2.Closure closure = table["insert"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void insertAll(entries,
      {_0049.OverlayEntry? above, _0049.OverlayEntry? below}) {
    _36c2.Closure closure = table["insertAll"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void rearrange(newEntries,
      {_0049.OverlayEntry? above, _0049.OverlayEntry? below}) {
  ...
  @_fac9.override
  _fac9.bool debugIsVisible(entry) {
  ...
  @_fac9.override
  _0049.Overlay get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_0049.Overlay, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadOverlayState(
  ...
  table['overlayState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOverlayState(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_0049.OverlayState>(boxer: (
      {required _0049.OverlayState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOverlayState(

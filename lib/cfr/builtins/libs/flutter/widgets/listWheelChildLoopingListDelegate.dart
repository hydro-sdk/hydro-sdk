...
class VMManagedListWheelChildLoopingListDelegate extends _36c2.VMManagedBox<_7b25.ListWheelChildLoopingListDelegate> {VMManagedListWheelChildLoopingListDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRebuild(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelChildLoopingListDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedListWheelChildLoopingListDelegate extends _7b25.ListWheelChildLoopingListDelegate implements _36c2.Box<_7b25.ListWheelChildLoopingListDelegate> {RTManagedListWheelChildLoopingListDelegate({required _fac9.List<_e2dc.Widget> children, required this.table, required this.hydroState}) : super(children: children) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadListWheelChildLoopingListDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listWheelChildLoopingListDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedListWheelChildLoopingListDelegate(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7b25.ListWheelChildLoopingListDelegate>(boxer: ({required _7b25.ListWheelChildLoopingListDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListWheelChildLoopingListDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

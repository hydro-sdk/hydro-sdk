...
class VMManagedCustomSingleChildLayout extends _36c2.VMManagedBox<_3960.CustomSingleChildLayout> {VMManagedCustomSingleChildLayout({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'delegate'
] = _36c2.maybeBoxObject<_a9e4.SingleChildLayoutDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderCustomSingleChildLayoutBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderCustomSingleChildLayoutBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.CustomSingleChildLayout vmObject;

 }

class RTManagedCustomSingleChildLayout extends _3960.CustomSingleChildLayout implements _36c2.Box<_3960.CustomSingleChildLayout> {RTManagedCustomSingleChildLayout({_e2dc.Widget? child, _ab4a.Key? key, required _a9e4.SingleChildLayoutDelegate delegate, required this.table, required this.hydroState}) : super(child: child,key: key,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderCustomSingleChildLayoutBox,
...
_3960.CustomSingleChildLayout unwrap() => this;
_3960.CustomSingleChildLayout get vmObject => this;
@_fac9.override _a9e4.RenderCustomSingleChildLayoutBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderCustomSingleChildLayoutBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCustomSingleChildLayout({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'customSingleChildLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCustomSingleChildLayout(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.CustomSingleChildLayout>(boxer: ({required _3960.CustomSingleChildLayout vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCustomSingleChildLayout(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCustomSingleChildLayout
    extends _36c2.VMManagedBox<_3960.CustomSingleChildLayout> {
  VMManagedCustomSingleChildLayout(
    ...
    table['delegate'] = _36c2.maybeBoxObject<_a9e4.SingleChildLayoutDelegate>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_a9e4.RenderCustomSingleChildLayoutBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          ...
          _36c2.maybeUnBoxAndBuildArgument<
              _a9e4.RenderCustomSingleChildLayoutBox,
...
class RTManagedCustomSingleChildLayout extends _3960.CustomSingleChildLayout
    implements _36c2.Box<_3960.CustomSingleChildLayout> {
  RTManagedCustomSingleChildLayout(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _a9e4.SingleChildLayoutDelegate delegate,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, delegate: delegate) {
  ...
  @_fac9.override
  _a9e4.RenderCustomSingleChildLayoutBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _a9e4.RenderCustomSingleChildLayoutBox, _fac9.dynamic>(
...
void loadCustomSingleChildLayout(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['customSingleChildLayout'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCustomSingleChildLayout(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          delegate: _36c2.maybeUnBoxAndBuildArgument<_a9e4.SingleChildLayoutDelegate, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_3960.CustomSingleChildLayout>(boxer: (
      {required _3960.CustomSingleChildLayout vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCustomSingleChildLayout(

...
class VMManagedScrollView extends _36c2.VMManagedBox<_2b56.ScrollView> {
  VMManagedScrollView(
  ...
  final _2b56.ScrollView vmObject;
}

class RTManagedScrollView extends _2b56.ScrollView
    implements _36c2.Box<_2b56.ScrollView> {
  RTManagedScrollView(
    ...
    table['_dart_buildSlivers'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: buildSlivers(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  _2b56.ScrollView unwrap() => this;
  _2b56.ScrollView get vmObject => this;
  @_fac9.override
...
void loadScrollView(
  ...
  table['scrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollView(
  ...
  _36c2.registerBoxer<_2b56.ScrollView>(boxer: (
      {required _2b56.ScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollView(

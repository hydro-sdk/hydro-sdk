...
class VMManagedScrollView extends _36c2.VMManagedBox<_2b56.ScrollView> {VMManagedScrollView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadScrollView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedScrollView(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2b56.ScrollView>(boxer: ({required _2b56.ScrollView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

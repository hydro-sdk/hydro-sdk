...
class VMManagedRestorableValue
    extends _36c2.VMManagedBox<_28c9.RestorableValue<_fac9.dynamic>> {
  VMManagedRestorableValue(
...
class RTManagedRestorableValue extends _28c9.RestorableValue
    implements _36c2.Box<_28c9.RestorableValue> {
  RTManagedRestorableValue({required this.table, required this.hydroState})
      : super() {
...
void loadRestorableValue(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableValue'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableValue(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableValue>(boxer: (
      {required _28c9.RestorableValue vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableValue(

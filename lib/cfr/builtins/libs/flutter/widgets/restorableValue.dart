...
class VMManagedRestorableValue extends _36c2.VMManagedBox<_28c9.RestorableValue<_fac9.dynamic>> {VMManagedRestorableValue({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableValue<_fac9.dynamic> vmObject;

 }

class RTManagedRestorableValue extends _28c9.RestorableValue implements _36c2.Box<_28c9.RestorableValue> {RTManagedRestorableValue({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_didUpdateValue'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  didUpdateValue(luaCallerArguments[1]);
  return [];
});
...
_28c9.RestorableValue unwrap() => this;
_28c9.RestorableValue get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.dynamic createDefaultValue() { 
_36c2.Closure closure = table["createDefaultValue"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.dynamic fromPrimitives(data) { 
...
void loadRestorableValue({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableValue(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableValue>(boxer: ({required _28c9.RestorableValue vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableValue(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedPageController extends _36c2.VMManagedBox<_4ea2.PageController> {
  VMManagedPageController(
    ...
    table['initialPage'] = vmObject.initialPage;
    table['keepPage'] = vmObject.keepPage;
    table['viewportFraction'] = vmObject.viewportFraction;
    table['keepScrollOffset'] = vmObject.keepScrollOffset;
    table['debugLabel'] = vmObject.debugLabel;
    table['getPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.page;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['animateToPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.animateToPage(luaCallerArguments[1],
                curve:
    ...
    table['jumpToPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.jumpToPage(luaCallerArguments[1]);
      return [];
    });
    table['nextPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.nextPage(
                curve: _36c2
                    .maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
    ...
    table['previousPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.previousPage(
                curve: _36c2
                    .maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
                        luaCallerArguments.length >= 2
                            ? luaCallerArguments[1]['curve']
...
class RTManagedPageController extends _4ea2.PageController
    implements _36c2.Box<_4ea2.PageController> {
  RTManagedPageController(
      {required _fac9.int initialPage,
      required _fac9.bool keepPage,
      required _fac9.double viewportFraction,
      required this.table,
    ...
    table['initialPage'] = _36c2.maybeBoxObject(
        object: this.initialPage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['keepPage'] = _36c2.maybeBoxObject(
        object: this.keepPage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['viewportFraction'] = _36c2.maybeBoxObject(
        object: this.viewportFraction,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['keepScrollOffset'] = _36c2.maybeBoxObject(
        object: keepScrollOffset,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['debugLabel'] = _36c2.maybeBoxObject(
        object: debugLabel, hydroState: hydroState, table: _36c2.HydroTable());
    table['_dart_getPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.page];
    });
    table['_dart_animateToPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_jumpToPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.jumpToPage(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_nextPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_previousPage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _fac9.double? get page {
    _36c2.Closure closure = table["getPage"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @_fac9.override
  _7de1.Future<void> animateToPage(page,
  ...
  @_fac9.override
  _7de1.Future<void> previousPage(
      {required _8c47.Curve curve, required _fac9.Duration duration}) {
...
void loadPageController(
  ...
  table['pageController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPageController(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          initialPage: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['initialPage']
              : null,
          keepPage: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['keepPage']
              : null,
          viewportFraction: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['viewportFraction']
              : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_4ea2.PageController>(boxer: (
      {required _4ea2.PageController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPageController(

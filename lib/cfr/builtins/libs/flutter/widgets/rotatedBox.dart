...
class VMManagedRotatedBox extends _36c2.VMManagedBox<_3960.RotatedBox> {VMManagedRotatedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'quarterTurns'
] = vmObject.quarterTurns;
table  [
'child'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9789.RenderRotatedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_9789.RenderRotatedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.RotatedBox vmObject;

 }

class RTManagedRotatedBox extends _3960.RotatedBox implements _36c2.Box<_3960.RotatedBox> {RTManagedRotatedBox({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.int quarterTurns, required this.table, required this.hydroState}) : super(child: child,key: key,quarterTurns: quarterTurns) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'quarterTurns'
] = _36c2.maybeBoxObject(object: this.quarterTurns, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_9789.RenderRotatedBox, _fac9.dynamic>(
...
_3960.RotatedBox unwrap() => this;
_3960.RotatedBox get vmObject => this;
@_fac9.override _9789.RenderRotatedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_9789.RenderRotatedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRotatedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rotatedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRotatedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.RotatedBox>(boxer: ({required _3960.RotatedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRotatedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

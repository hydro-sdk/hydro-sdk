...
class VMManagedRotatedBox extends _36c2.VMManagedBox<_3960.RotatedBox> {
  VMManagedRotatedBox(
    ...
    table['quarterTurns'] = vmObject.quarterTurns;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_9789.RenderRotatedBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_9789.RenderRotatedBox,
...
class RTManagedRotatedBox extends _3960.RotatedBox
    implements _36c2.Box<_3960.RotatedBox> {
  RTManagedRotatedBox(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(child: child, key: key, quarterTurns: quarterTurns) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['quarterTurns'] = _36c2.maybeBoxObject(
        object: this.quarterTurns,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _9789.RenderRotatedBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_9789.RenderRotatedBox, _fac9.dynamic>(
...
void loadRotatedBox(
  ...
  table['rotatedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRotatedBox(
  ...
  _36c2.registerBoxer<_3960.RotatedBox>(boxer: (
      {required _3960.RotatedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRotatedBox(

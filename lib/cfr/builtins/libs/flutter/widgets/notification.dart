...
class VMManagedNotification extends _36c2.VMManagedBox<_c8d8.Notification> {
  VMManagedNotification(
...
class RTManagedNotification extends _c8d8.Notification
    implements _36c2.Box<_c8d8.Notification> {
  RTManagedNotification({required this.table, required this.hydroState})
      : super() {
...
void loadNotification(
  ...
  table['notification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNotification(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_c8d8.Notification>(boxer: (
      {required _c8d8.Notification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNotification(

...
class VMManagedDefaultTextHeightBehavior extends _36c2.VMManagedBox<_0eb7.DefaultTextHeightBehavior> {VMManagedDefaultTextHeightBehavior({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_0eb7.DefaultTextHeightBehavior, _fac9.dynamic>(luaCallerArguments  [
1
...
final _0eb7.DefaultTextHeightBehavior vmObject;

 }

class RTManagedDefaultTextHeightBehavior extends _0eb7.DefaultTextHeightBehavior implements _36c2.Box<_0eb7.DefaultTextHeightBehavior> {RTManagedDefaultTextHeightBehavior({_ab4a.Key? key, required _e2dc.Widget child, required _a643.TextHeightBehavior textHeightBehavior, required this.table, required this.hydroState}) : super(key: key,child: child,textHeightBehavior: textHeightBehavior) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
            _0eb7.DefaultTextHeightBehavior,
...
_0eb7.DefaultTextHeightBehavior unwrap() => this;
_0eb7.DefaultTextHeightBehavior get vmObject => this;
...
void loadDefaultTextHeightBehavior({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'defaultTextHeightBehavior'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDefaultTextHeightBehavior(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), textHeightBehavior: _36c2.maybeUnBoxAndBuildArgument<_a643.TextHeightBehavior, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textHeightBehavior'
] : null, parentState: hydroState))]; } );
table  [
'defaultTextHeightBehaviorOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _0eb7.DefaultTextHeightBehavior.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.TextHeightBehavior?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_0eb7.DefaultTextHeightBehavior>(boxer: ({required _0eb7.DefaultTextHeightBehavior vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDefaultTextHeightBehavior(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

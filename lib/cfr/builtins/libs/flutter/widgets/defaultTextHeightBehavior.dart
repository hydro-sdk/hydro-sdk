...
class VMManagedDefaultTextHeightBehavior
    extends _36c2.VMManagedBox<_0eb7.DefaultTextHeightBehavior> {
  VMManagedDefaultTextHeightBehavior(
...
class RTManagedDefaultTextHeightBehavior extends _0eb7.DefaultTextHeightBehavior
    implements _36c2.Box<_0eb7.DefaultTextHeightBehavior> {
  RTManagedDefaultTextHeightBehavior(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _a643.TextHeightBehavior textHeightBehavior,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, textHeightBehavior: textHeightBehavior) {
...
void loadDefaultTextHeightBehavior(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultTextHeightBehavior'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultTextHeightBehavior(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          textHeightBehavior: _36c2.maybeUnBoxAndBuildArgument<_a643.TextHeightBehavior, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['defaultTextHeightBehaviorOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _0eb7.DefaultTextHeightBehavior.of(
  ...
  _36c2.registerBoxer<_0eb7.DefaultTextHeightBehavior>(boxer: (
      {required _0eb7.DefaultTextHeightBehavior vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultTextHeightBehavior(

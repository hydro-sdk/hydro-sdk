...
class VMManagedRestorableIntN extends _36c2.VMManagedBox<_28c9.RestorableIntN> {VMManagedRestorableIntN({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableIntN vmObject;

 }

class RTManagedRestorableIntN extends _28c9.RestorableIntN implements _36c2.Box<_28c9.RestorableIntN> {RTManagedRestorableIntN(_fac9.int? defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setValue'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.value = (_36c2.maybeUnBoxAndBuildArgument<_fac9.int?, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_28c9.RestorableIntN unwrap() => this;
_28c9.RestorableIntN get vmObject => this;
@_fac9.override _fac9.int? createDefaultValue() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int? fromPrimitives(serialized) { 
...
void loadRestorableIntN({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableIntN'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableIntN(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableIntN>(boxer: ({required _28c9.RestorableIntN vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableIntN(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

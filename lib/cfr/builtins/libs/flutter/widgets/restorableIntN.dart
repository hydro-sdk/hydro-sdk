...
class VMManagedRestorableIntN extends _36c2.VMManagedBox<_28c9.RestorableIntN> {
  VMManagedRestorableIntN(
...
class RTManagedRestorableIntN extends _28c9.RestorableIntN
    implements _36c2.Box<_28c9.RestorableIntN> {
  RTManagedRestorableIntN(_fac9.int? defaultValue,
...
void loadRestorableIntN(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableIntN'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableIntN(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableIntN>(boxer: (
      {required _28c9.RestorableIntN vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableIntN(

...
class VMManagedBannerPainter extends _36c2.VMManagedBox<_7c3a.BannerPainter> {VMManagedBannerPainter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'location'
] = _7c3a.BannerLocation.values.indexWhere((x) { return x == vmObject.location; } );
table  [
'layoutDirection'
...
table  [
'shouldRepaint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRepaint(_36c2.maybeUnBoxAndBuildArgument<_7c3a.BannerPainter, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'hitTest'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hitTest(_36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'addListener'
...
class RTManagedBannerPainter extends _7c3a.BannerPainter implements _36c2.Box<_7c3a.BannerPainter> {RTManagedBannerPainter({required _a643.Color color, required _74d0.TextStyle textStyle, required _a643.TextDirection layoutDirection, required _7c3a.BannerLocation location, required _fac9.String message, required _a643.TextDirection textDirection, required this.table, required this.hydroState}) : super(color: color,textStyle: textStyle,layoutDirection: layoutDirection,location: location,message: message,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'location'
] = _7c3a.BannerLocation.values.indexWhere((x) { return x == this.location; } );
table  [
'layoutDirection'
...
void loadBannerPainter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'bannerPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedBannerPainter(table: luaCallerArguments  [
0
...
'layoutDirection'
] : null), location: _36c2.maybeUnBoxEnum(values: _7c3a.BannerLocation.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'location'
...
_36c2.registerBoxer<_7c3a.BannerPainter>(boxer: ({required _7c3a.BannerPainter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBannerPainter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

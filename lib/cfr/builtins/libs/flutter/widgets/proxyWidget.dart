...
class VMManagedProxyWidget extends _36c2.VMManagedBox<_e2dc.ProxyWidget> {VMManagedProxyWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.ProxyWidget vmObject;

 }

class RTManagedProxyWidget extends _e2dc.ProxyWidget implements _36c2.Box<_e2dc.ProxyWidget> {RTManagedProxyWidget({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.ProxyWidget unwrap() => this;
_e2dc.ProxyWidget get vmObject => this;
...
void loadProxyWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'proxyWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedProxyWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.ProxyWidget>(boxer: ({required _e2dc.ProxyWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedProxyWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedProxyWidget extends VMManagedBox<ProxyWidget> {
  ...
  final ProxyWidget vmObject;
}

class RTManagedProxyWidget extends ProxyWidget implements Box<ProxyWidget> {
  ...
  ProxyWidget unwrap() => this;
  ProxyWidget get vmObject => this;
  @override
...
void loadProxyWidget(
  ...
  registerBoxer<ProxyWidget>(boxer: (
      {required ProxyWidget vmObject,

...
class VMManagedRichText extends _36c2.VMManagedBox<_3960.RichText> {
  VMManagedRichText(
    ...
    table['text'] = _36c2.maybeBoxObject<_b761.InlineSpan>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_105e.RenderParagraph>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_105e.RenderParagraph,
...
class RTManagedRichText extends _3960.RichText
    implements _36c2.Box<_3960.RichText> {
  RTManagedRichText(
      {_ab4a.Key? key,
      _a643.Locale? locale,
      _fac9.int? maxLines,
      ...
      required _b761.InlineSpan text,
      required this.table,
  ...
  @_fac9.override
  _105e.RenderParagraph createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_105e.RenderParagraph, _fac9.dynamic>(
...
void loadRichText(
  ...
  table['richText'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRichText(
          ...
          overflow: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          softWrap: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['softWrap'] : null,
  ...
  _36c2.registerBoxer<_3960.RichText>(boxer: (
      {required _3960.RichText vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRichText(

...
class VMManagedExcludeSemantics
    extends _36c2.VMManagedBox<_3960.ExcludeSemantics> {
  VMManagedExcludeSemantics(
    ...
    table['excluding'] = vmObject.excluding;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderExcludeSemantics>(
...
class RTManagedExcludeSemantics extends _3960.ExcludeSemantics
    implements _36c2.Box<_3960.ExcludeSemantics> {
  RTManagedExcludeSemantics(
      {_e2dc.Widget? child,
      required _fac9.bool excluding,
      _ab4a.Key? key,
      required this.table,
      required this.hydroState})
      : super(child: child, excluding: excluding, key: key) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['excluding'] = _36c2.maybeBoxObject(
        object: this.excluding,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderExcludeSemantics createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderExcludeSemantics,
            _fac9.dynamic>(
...
void loadExcludeSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['excludeSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedExcludeSemantics(
  ...
  _36c2.registerBoxer<_3960.ExcludeSemantics>(boxer: (
      {required _3960.ExcludeSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedExcludeSemantics(

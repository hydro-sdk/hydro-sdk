...
class VMManagedExcludeSemantics extends _36c2.VMManagedBox<_3960.ExcludeSemantics> {VMManagedExcludeSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderExcludeSemantics>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderExcludeSemantics, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.ExcludeSemantics vmObject;

 }

class RTManagedExcludeSemantics extends _3960.ExcludeSemantics implements _36c2.Box<_3960.ExcludeSemantics> {RTManagedExcludeSemantics({_e2dc.Widget? child, required _fac9.bool excluding, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,excluding: excluding,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'excluding'
] = _36c2.maybeBoxObject(object: this.excluding, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderExcludeSemantics,
...
_3960.ExcludeSemantics unwrap() => this;
_3960.ExcludeSemantics get vmObject => this;
@_fac9.override _bf98.RenderExcludeSemantics createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderExcludeSemantics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadExcludeSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'excludeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedExcludeSemantics(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), excluding: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'excluding'
...
_36c2.registerBoxer<_3960.ExcludeSemantics>(boxer: ({required _3960.ExcludeSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedExcludeSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

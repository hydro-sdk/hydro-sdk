...
class VMManagedSizeTransition extends _36c2.VMManagedBox<_d7ad.SizeTransition> {VMManagedSizeTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getSizeFactor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.sizeFactor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.SizeTransition vmObject;

 }

class RTManagedSizeTransition extends _d7ad.SizeTransition implements _36c2.Box<_d7ad.SizeTransition> {RTManagedSizeTransition({required _487f.Axis axis, required _fac9.double axisAlignment, _e2dc.Widget? child, _ab4a.Key? key, required _86ca.Animation<_fac9.double> sizeFactor, required this.table, required this.hydroState}) : super(axis: axis,axisAlignment: axisAlignment,child: child,key: key,sizeFactor: sizeFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'axisAlignment'
] = _36c2.maybeBoxObject(object: this.axisAlignment, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_getSizeFactor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.sizeFactor];
});
table['_dart_build'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
_d7ad.SizeTransition unwrap() => this;
_d7ad.SizeTransition get vmObject => this;
@_fac9.override _86ca.Animation<_fac9.double> get sizeFactor { 
_36c2.Closure closure = table["getSizeFactor"];
...
void loadSizeTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sizeTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSizeTransition(table: luaCallerArguments  [
0
...
'axis'
] : null), axisAlignment: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'axisAlignment'
...
'key'
] : null, parentState: hydroState), sizeFactor: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sizeFactor'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.SizeTransition>(boxer: ({required _d7ad.SizeTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSizeTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSizeTransition extends _36c2.VMManagedBox<_d7ad.SizeTransition> {
  VMManagedSizeTransition(
    ...
    table['axisAlignment'] = vmObject.axisAlignment;
    ...
    table['key'] = _36c2.maybeBoxObject<_ab4a.Key?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getSizeFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_86ca.Animation>(
            object: vmObject.sizeFactor,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
...
class RTManagedSizeTransition extends _d7ad.SizeTransition
    implements _36c2.Box<_d7ad.SizeTransition> {
  RTManagedSizeTransition(
      {required _487f.Axis axis,
      required _fac9.double axisAlignment,
      _e2dc.Widget? child,
      _ab4a.Key? key,
      required _86ca.Animation<_fac9.double> sizeFactor,
      required this.table,
    ...
    table['axisAlignment'] = _36c2.maybeBoxObject(
        object: this.axisAlignment,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getSizeFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _86ca.Animation<_fac9.double> get sizeFactor {
...
void loadSizeTransition(
  ...
  table['sizeTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSizeTransition(
          ...
          axis: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          axisAlignment: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['axisAlignment']
              : null?.toDouble(),
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          sizeFactor: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['sizeFactor'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.SizeTransition>(boxer: (
      {required _d7ad.SizeTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSizeTransition(

...
class VMManagedFlow extends _36c2.VMManagedBox<_3960.Flow> {VMManagedFlow({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'delegate'
] = _36c2.maybeBoxObject<_43b9.FlowDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_43b9.RenderFlow>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_43b9.RenderFlow, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Flow vmObject;

 }

class RTManagedFlow extends _3960.Flow implements _36c2.Box<_3960.Flow> {RTManagedFlow({required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, _ab4a.Key? key, required _43b9.FlowDelegate delegate, required this.table, required this.hydroState}) : super(children: children,clipBehavior: clipBehavior,key: key,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_43b9.RenderFlow, _fac9.dynamic>(
...
_3960.Flow unwrap() => this;
_3960.Flow get vmObject => this;
@_fac9.override _43b9.RenderFlow createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_43b9.RenderFlow, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFlow({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFlow(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), delegate: _36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_3960.Flow>(boxer: ({required _3960.Flow vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlow(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

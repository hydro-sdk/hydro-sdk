...
class VMManagedFlow extends _36c2.VMManagedBox<_3960.Flow> {
  VMManagedFlow(
    ...
    table['delegate'] = _36c2.maybeBoxObject<_43b9.FlowDelegate>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_43b9.RenderFlow>(
...
class RTManagedFlow extends _3960.Flow implements _36c2.Box<_3960.Flow> {
  RTManagedFlow(
  ...
  @_fac9.override
  _43b9.RenderFlow createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_43b9.RenderFlow, _fac9.dynamic>(
...
void loadFlow(
  ...
  table['flow'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFlow(
          ...
          key: _36c2
              .maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
                  parentState: hydroState),
          delegate: _36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['delegate'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3960.Flow>(boxer: (
      {required _3960.Flow vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFlow(

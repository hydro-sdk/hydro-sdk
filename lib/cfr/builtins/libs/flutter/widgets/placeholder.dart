...
import 'package:flutter/src/widgets/placeholder.dart' as _b213;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedPlaceholder extends _36c2.VMManagedBox<_b213.Placeholder> {VMManagedPlaceholder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'fallbackWidth'
] = vmObject.fallbackWidth;
table  [
'fallbackHeight'
] = vmObject.fallbackHeight;
table  [
'key'
...
final _b213.Placeholder vmObject;

 }

class RTManagedPlaceholder extends _b213.Placeholder implements _36c2.Box<_b213.Placeholder> {RTManagedPlaceholder({required _a643.Color color, required _fac9.double fallbackHeight, required _fac9.double fallbackWidth, _ab4a.Key? key, required _fac9.double strokeWidth, required this.table, required this.hydroState}) : super(color: color,fallbackHeight: fallbackHeight,fallbackWidth: fallbackWidth,key: key,strokeWidth: strokeWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'strokeWidth'
] = _36c2.maybeBoxObject(object: this.strokeWidth, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fallbackWidth'
] = _36c2.maybeBoxObject(object: this.fallbackWidth, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fallbackHeight'
] = _36c2.maybeBoxObject(object: this.fallbackHeight, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_b213.Placeholder unwrap() => this;
_b213.Placeholder get vmObject => this;
...
void loadPlaceholder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'placeholder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPlaceholder(table: luaCallerArguments  [
0
...
'color'
] : null, parentState: hydroState), fallbackHeight: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fallbackHeight'
] : null?.toDouble(), fallbackWidth: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fallbackWidth'
...
'key'
] : null, parentState: hydroState), strokeWidth: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'strokeWidth'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_b213.Placeholder>(boxer: ({required _b213.Placeholder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlaceholder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

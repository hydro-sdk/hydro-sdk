...
class VMManagedSliverFixedExtentList extends _36c2.VMManagedBox<_a8eb.SliverFixedExtentList> {VMManagedSliverFixedExtentList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_f4e0.RenderSliverFixedExtentList>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_f4e0.RenderSliverFixedExtentList, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a8eb.SliverFixedExtentList vmObject;

 }

class RTManagedSliverFixedExtentList extends _a8eb.SliverFixedExtentList implements _36c2.Box<_a8eb.SliverFixedExtentList> {RTManagedSliverFixedExtentList({_ab4a.Key? key, required _a8eb.SliverChildDelegate delegate, required _fac9.double itemExtent, required this.table, required this.hydroState}) : super(key: key,delegate: delegate,itemExtent: itemExtent) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_f4e0.RenderSliverFixedExtentList,
...
_a8eb.SliverFixedExtentList unwrap() => this;
_a8eb.SliverFixedExtentList get vmObject => this;
@_fac9.override _f4e0.RenderSliverFixedExtentList createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_f4e0.RenderSliverFixedExtentList, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverFixedExtentList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverFixedExtentList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverFixedExtentList(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a8eb.SliverFixedExtentList>(boxer: ({required _a8eb.SliverFixedExtentList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverFixedExtentList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

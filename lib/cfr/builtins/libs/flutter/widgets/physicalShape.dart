...
class VMManagedPhysicalShape extends _36c2.VMManagedBox<_3960.PhysicalShape> {VMManagedPhysicalShape({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'clipper'
] = _36c2.maybeBoxObject<_bf98.CustomClipper>(object: vmObject.clipper, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderPhysicalShape>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalShape, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.PhysicalShape vmObject;

 }

class RTManagedPhysicalShape extends _3960.PhysicalShape implements _36c2.Box<_3960.PhysicalShape> {RTManagedPhysicalShape({_e2dc.Widget? child, required _a643.Clip clipBehavior, required _fac9.double elevation, _ab4a.Key? key, required _a643.Color shadowColor, required _bf98.CustomClipper<_a643.Path> clipper, required _a643.Color color, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,elevation: elevation,key: key,shadowColor: shadowColor,clipper: clipper,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'clipper'
] = _36c2.maybeBoxObject(object: this.clipper, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalShape,
...
_3960.PhysicalShape unwrap() => this;
_3960.PhysicalShape get vmObject => this;
@_fac9.override _bf98.RenderPhysicalShape createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalShape, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPhysicalShape({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'physicalShape'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPhysicalShape(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), shadowColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shadowColor'
...
_36c2.registerBoxer<_3960.PhysicalShape>(boxer: ({required _3960.PhysicalShape vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPhysicalShape(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

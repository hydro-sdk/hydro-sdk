...
class VMManagedPhysicalShape extends _36c2.VMManagedBox<_3960.PhysicalShape> {
  VMManagedPhysicalShape(
    ...
    table['clipper'] = _36c2.maybeBoxObject<_bf98.CustomClipper>(
        object: vmObject.clipper,
        hydroState: hydroState,
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderPhysicalShape>(
...
class RTManagedPhysicalShape extends _3960.PhysicalShape
    implements _36c2.Box<_3960.PhysicalShape> {
  RTManagedPhysicalShape(
      {_e2dc.Widget? child,
    ...
    table['clipper'] = _36c2.maybeBoxObject(
        object: this.clipper,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['clipBehavior'] = _a643.Clip.values.indexWhere((x) {
  ...
  @_fac9.override
  _bf98.RenderPhysicalShape createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalShape, _fac9.dynamic>(
...
void loadPhysicalShape(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['physicalShape'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPhysicalShape(
          ...
          shadowColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>, _a643.Path>(
  ...
  _36c2.registerBoxer<_3960.PhysicalShape>(boxer: (
      {required _3960.PhysicalShape vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPhysicalShape(

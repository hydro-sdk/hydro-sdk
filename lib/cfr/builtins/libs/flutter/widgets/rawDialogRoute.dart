...
class VMManagedRawDialogRoute extends _36c2.VMManagedBox<_8c2a.RawDialogRoute<_fac9.dynamic>> {VMManagedRawDialogRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c2a.RawDialogRoute<_fac9.dynamic> vmObject;

 }

class RTManagedRawDialogRoute extends _8c2a.RawDialogRoute implements _36c2.Box<_8c2a.RawDialogRoute> {RTManagedRawDialogRoute({_a643.Color? barrierColor, required _fac9.bool barrierDismissible, _fac9.String? barrierLabel, _a37d.RouteSettings? settings, _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _86ca.Animation<_fac9.double> secondaryAnimation, _e2dc.Widget child)? transitionBuilder, required _fac9.Duration transitionDuration, required _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _86ca.Animation<_fac9.double> secondaryAnimation) pageBuilder, required this.table, required this.hydroState}) : super(barrierColor: barrierColor,barrierDismissible: barrierDismissible,barrierLabel: barrierLabel,settings: settings,transitionBuilder: transitionBuilder,transitionDuration: transitionDuration,pageBuilder: pageBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c2a.RawDialogRoute unwrap() => this;
_8c2a.RawDialogRoute get vmObject => this;
...
void loadRawDialogRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawDialogRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



_36c2.Closure? unpackedtransitionBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transitionBuilder'
] : null;
...
return  [RTManagedRawDialogRoute(table: luaCallerArguments  [
0
...
'settings'
] : null, parentState: hydroState), transitionBuilder: unpackedtransitionBuilder != null ? (context, animation, secondaryAnimation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedtransitionBuilder.dispatch([luaCallerArguments[0],context,animation,secondaryAnimation,child],parentState:hydroState,)[0], parentState: hydroState) : null , transitionDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transitionDuration'
] : null, parentState: hydroState), pageBuilder: (context, animation, secondaryAnimation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedpageBuilder.dispatch([luaCallerArguments[0],context,animation,secondaryAnimation],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_8c2a.RawDialogRoute>(boxer: ({required _8c2a.RawDialogRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawDialogRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

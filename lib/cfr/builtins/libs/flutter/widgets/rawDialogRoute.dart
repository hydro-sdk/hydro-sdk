...
class VMManagedRawDialogRoute
    extends _36c2.VMManagedBox<_8c2a.RawDialogRoute<_fac9.dynamic>> {
  VMManagedRawDialogRoute(
...
class RTManagedRawDialogRoute extends _8c2a.RawDialogRoute
    implements _36c2.Box<_8c2a.RawDialogRoute> {
  RTManagedRawDialogRoute(
...
void loadRawDialogRoute(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawDialogRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedRawDialogRoute(
          ...
          hydroState: hydroState,
          barrierColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
          ...
          barrierLabel: luaCallerArguments.length >= 2
              ...
              : null,
          settings:
              _36c2.maybeUnBoxAndBuildArgument<_a37d.RouteSettings?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['settings'] : null,
                  parentState: hydroState),
          transitionBuilder: unpackedtransitionBuilder != null
          ...
          transitionDuration:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['transitionDuration'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_8c2a.RawDialogRoute>(boxer: (
      {required _8c2a.RawDialogRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawDialogRoute(

...
class VMManagedImage extends _36c2.VMManagedBox<_2059.Image> {
  VMManagedImage(
    ...
    table['gaplessPlayback'] = vmObject.gaplessPlayback;
...
class RTManagedImage extends _2059.Image implements _36c2.Box<_2059.Image> {
  RTManagedImage(
      ...
      _e2dc.Widget Function(_e2dc.BuildContext context, _e2dc.Widget child,
              _fac9.int? frame, _fac9.bool wasSynchronouslyLoaded)?
          frameBuilder,
      required _fac9.bool gaplessPlayback,
      _fac9.double? height,
      required _fac9.bool isAntiAlias,
      _ab4a.Key? key,
      _e2dc.Widget Function(_e2dc.BuildContext context, _e2dc.Widget child,
              _f25c.ImageChunkEvent? loadingProgress)?
          loadingBuilder,
    ...
    table['matchTextDirection'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['gaplessPlayback'] = _36c2.maybeBoxObject(
        object: this.gaplessPlayback,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _e2dc.State<_2059.Image> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e2dc.State<_2059.Image>, _2059.Image>(
...
void loadImage(
  ...
  table['image'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackederrorBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['errorBuilder']
        : null;

    _36c2.Closure? unpackedframeBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['frameBuilder']
        : null;

    _36c2.Closure? unpackedloadingBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['loadingBuilder']
        : null;
    ...
    return [
      RTManagedImage(
          ...
          frameBuilder: unpackedframeBuilder != null
              ? (context, child, frame, wasSynchronouslyLoaded) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedframeBuilder.dispatch(
                    [
                  ...
                  parentState: hydroState)
              : null,
          gaplessPlayback: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['gaplessPlayback'] : null,
          ...
          loadingBuilder: unpackedloadingBuilder != null
              ? (context, child, loadingProgress) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedloadingBuilder.dispatch(
                    [luaCallerArguments[0], context, child, loadingProgress],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState)
              : null,
  ...
  _36c2.registerBoxer<_2059.Image>(boxer: (
      {required _2059.Image vmObject,

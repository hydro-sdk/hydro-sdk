...
class VMManagedAnimatedPositioned extends _36c2.VMManagedBox<_da7c.AnimatedPositioned> {VMManagedAnimatedPositioned({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAnimatedPositioned extends _da7c.AnimatedPositioned implements _36c2.Box<_da7c.AnimatedPositioned> {RTManagedAnimatedPositioned({_fac9.double? bottom, required _8c47.Curve curve, _fac9.double? height, _ab4a.Key? key, _fac9.double? left, void Function()? onEnd, _fac9.double? right, _fac9.double? top, _fac9.double? width, required _e2dc.Widget child, required _fac9.Duration duration, required this.table, required this.hydroState}) : super(bottom: bottom,curve: curve,height: height,key: key,left: left,onEnd: onEnd,right: right,top: top,width: width,child: child,duration: duration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _da7c.AnimatedWidgetBaseState<_da7c.AnimatedPositioned> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.AnimatedWidgetBaseState<_da7c.AnimatedPositioned>, _da7c.AnimatedPositioned>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedPositioned({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedPositioned'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedPositioned(table: luaCallerArguments  [
0
], hydroState: hydroState, bottom: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bottom'
] : null?.toDouble(), curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'curve'
...
'left'
] : null?.toDouble(), onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , right: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'right'
...
_36c2.registerBoxer<_da7c.AnimatedPositioned>(boxer: ({required _da7c.AnimatedPositioned vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedPositioned(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

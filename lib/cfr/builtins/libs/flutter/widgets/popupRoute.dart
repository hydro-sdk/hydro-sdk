...
class VMManagedPopupRoute extends _36c2.VMManagedBox<_8c2a.PopupRoute<_fac9.dynamic>> {VMManagedPopupRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c2a.PopupRoute<_fac9.dynamic> vmObject;

 }

class RTManagedPopupRoute extends _8c2a.PopupRoute implements _36c2.Box<_8c2a.PopupRoute> {RTManagedPopupRoute({_a643.ImageFilter? filter, _a37d.RouteSettings? settings, required this.table, required this.hydroState}) : super(filter: filter,settings: settings) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c2a.PopupRoute unwrap() => this;
_8c2a.PopupRoute get vmObject => this;
...
void loadPopupRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'popupRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedPopupRoute(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_8c2a.PopupRoute>(boxer: ({required _8c2a.PopupRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPopupRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

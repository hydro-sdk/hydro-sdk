...
class VMManagedLeafRenderObjectWidget
    extends VMManagedBox<LeafRenderObjectWidget> {
  ...
  final LeafRenderObjectWidget vmObject;
}

class RTManagedLeafRenderObjectWidget extends LeafRenderObjectWidget
    implements Box<LeafRenderObjectWidget> {
  ...
  LeafRenderObjectWidget unwrap() => this;
  LeafRenderObjectWidget get vmObject => this;
  @override
...
void loadLeafRenderObjectWidget(
  ...
  registerBoxer<LeafRenderObjectWidget>(boxer: (
      {required LeafRenderObjectWidget vmObject,

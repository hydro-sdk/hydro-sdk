...
class VMManagedLeafRenderObjectWidget extends _36c2.VMManagedBox<_e2dc.LeafRenderObjectWidget> {VMManagedLeafRenderObjectWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.LeafRenderObjectWidget vmObject;

 }

class RTManagedLeafRenderObjectWidget extends _e2dc.LeafRenderObjectWidget implements _36c2.Box<_e2dc.LeafRenderObjectWidget> {RTManagedLeafRenderObjectWidget({_ab4a.Key? key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.LeafRenderObjectWidget unwrap() => this;
_e2dc.LeafRenderObjectWidget get vmObject => this;
...
void loadLeafRenderObjectWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'leafRenderObjectWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLeafRenderObjectWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.LeafRenderObjectWidget>(boxer: ({required _e2dc.LeafRenderObjectWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLeafRenderObjectWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

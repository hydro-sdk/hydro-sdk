...
class VMManagedLeafRenderObjectWidget
    extends _36c2.VMManagedBox<_e2dc.LeafRenderObjectWidget> {
  VMManagedLeafRenderObjectWidget(
...
class RTManagedLeafRenderObjectWidget extends _e2dc.LeafRenderObjectWidget
    implements _36c2.Box<_e2dc.LeafRenderObjectWidget> {
  RTManagedLeafRenderObjectWidget(
...
void loadLeafRenderObjectWidget(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['leafRenderObjectWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLeafRenderObjectWidget(
  ...
  _36c2.registerBoxer<_e2dc.LeafRenderObjectWidget>(boxer: (
      {required _e2dc.LeafRenderObjectWidget vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLeafRenderObjectWidget(

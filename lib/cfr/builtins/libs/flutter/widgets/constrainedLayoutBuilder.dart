...
class VMManagedConstrainedLayoutBuilder extends _36c2.VMManagedBox<_d69f.ConstrainedLayoutBuilder<_9742.Constraints>> {VMManagedConstrainedLayoutBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d69f.ConstrainedLayoutBuilder<_9742.Constraints> vmObject;

 }

class RTManagedConstrainedLayoutBuilder extends _d69f.ConstrainedLayoutBuilder implements _36c2.Box<_d69f.ConstrainedLayoutBuilder> {RTManagedConstrainedLayoutBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext , _9742.Constraints ) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d69f.ConstrainedLayoutBuilder unwrap() => this;
_d69f.ConstrainedLayoutBuilder get vmObject => this;
...
void loadConstrainedLayoutBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedConstrainedLayoutBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), builder: (_, __) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],_,__],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_d69f.ConstrainedLayoutBuilder>(boxer: ({required _d69f.ConstrainedLayoutBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedConstrainedLayoutBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFocusTrapArea extends _36c2.VMManagedBox<_8c2a.FocusTrapArea> {
  VMManagedFocusTrapArea(
...
class RTManagedFocusTrapArea extends _8c2a.FocusTrapArea
    implements _36c2.Box<_8c2a.FocusTrapArea> {
  RTManagedFocusTrapArea(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _b485.FocusNode focusNode,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, focusNode: focusNode) {
...
void loadFocusTrapArea(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['focusTrapArea'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFocusTrapArea(
  ...
  _36c2.registerBoxer<_8c2a.FocusTrapArea>(boxer: (
      {required _8c2a.FocusTrapArea vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusTrapArea(

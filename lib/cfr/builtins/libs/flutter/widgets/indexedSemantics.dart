...
class VMManagedIndexedSemantics
    extends _36c2.VMManagedBox<_3960.IndexedSemantics> {
  VMManagedIndexedSemantics(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderIndexedSemantics>(
...
class RTManagedIndexedSemantics extends _3960.IndexedSemantics
    implements _36c2.Box<_3960.IndexedSemantics> {
  RTManagedIndexedSemantics(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _fac9.int index,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, index: index) {
  ...
  @_fac9.override
  _bf98.RenderIndexedSemantics createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIndexedSemantics,
            _fac9.dynamic>(
...
void loadIndexedSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['indexedSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIndexedSemantics(
  ...
  _36c2.registerBoxer<_3960.IndexedSemantics>(boxer: (
      {required _3960.IndexedSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIndexedSemantics(

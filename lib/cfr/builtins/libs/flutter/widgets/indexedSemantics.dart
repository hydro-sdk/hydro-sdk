...
class VMManagedIndexedSemantics extends _36c2.VMManagedBox<_3960.IndexedSemantics> {VMManagedIndexedSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderIndexedSemantics>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIndexedSemantics, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.IndexedSemantics vmObject;

 }

class RTManagedIndexedSemantics extends _3960.IndexedSemantics implements _36c2.Box<_3960.IndexedSemantics> {RTManagedIndexedSemantics({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.int index, required this.table, required this.hydroState}) : super(child: child,key: key,index: index) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIndexedSemantics,
...
_3960.IndexedSemantics unwrap() => this;
_3960.IndexedSemantics get vmObject => this;
@_fac9.override _bf98.RenderIndexedSemantics createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIndexedSemantics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIndexedSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'indexedSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedIndexedSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.IndexedSemantics>(boxer: ({required _3960.IndexedSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIndexedSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

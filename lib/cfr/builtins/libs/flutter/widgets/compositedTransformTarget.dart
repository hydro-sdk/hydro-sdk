...
class VMManagedCompositedTransformTarget
    extends _36c2.VMManagedBox<_3960.CompositedTransformTarget> {
  VMManagedCompositedTransformTarget(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderLeaderLayer>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLeaderLayer,
...
class RTManagedCompositedTransformTarget extends _3960.CompositedTransformTarget
    implements _36c2.Box<_3960.CompositedTransformTarget> {
  RTManagedCompositedTransformTarget(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _7d70.LayerLink link,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, link: link) {
  ...
  @_fac9.override
  _bf98.RenderLeaderLayer createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderLeaderLayer, _fac9.dynamic>(
...
void loadCompositedTransformTarget(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['compositedTransformTarget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCompositedTransformTarget(
  ...
  _36c2.registerBoxer<_3960.CompositedTransformTarget>(boxer: (
      {required _3960.CompositedTransformTarget vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCompositedTransformTarget(

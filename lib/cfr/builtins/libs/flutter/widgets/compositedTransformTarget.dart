...
class VMManagedCompositedTransformTarget extends _36c2.VMManagedBox<_3960.CompositedTransformTarget> {VMManagedCompositedTransformTarget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderLeaderLayer>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLeaderLayer, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.CompositedTransformTarget vmObject;

 }

class RTManagedCompositedTransformTarget extends _3960.CompositedTransformTarget implements _36c2.Box<_3960.CompositedTransformTarget> {RTManagedCompositedTransformTarget({_e2dc.Widget? child, _ab4a.Key? key, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(child: child,key: key,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLeaderLayer, _fac9.dynamic>(
...
_3960.CompositedTransformTarget unwrap() => this;
_3960.CompositedTransformTarget get vmObject => this;
@_fac9.override _bf98.RenderLeaderLayer createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLeaderLayer, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCompositedTransformTarget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'compositedTransformTarget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCompositedTransformTarget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.CompositedTransformTarget>(boxer: ({required _3960.CompositedTransformTarget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCompositedTransformTarget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

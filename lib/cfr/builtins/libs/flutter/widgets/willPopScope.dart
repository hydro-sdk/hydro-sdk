...
import 'package:flutter/src/widgets/will_pop_scope.dart' as _7991;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedWillPopScope extends _36c2.VMManagedBox<_7991.WillPopScope> {VMManagedWillPopScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7991.WillPopScope vmObject;

 }

class RTManagedWillPopScope extends _7991.WillPopScope implements _36c2.Box<_7991.WillPopScope> {RTManagedWillPopScope({_ab4a.Key? key, required _e2dc.Widget child, _7de1.Future<_fac9.bool> Function()? onWillPop, required this.table, required this.hydroState}) : super(key: key,child: child,onWillPop: onWillPop) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7991.WillPopScope unwrap() => this;
_7991.WillPopScope get vmObject => this;
@_fac9.override _e2dc.State<_7991.WillPopScope> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_7991.WillPopScope>, _7991.WillPopScope>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadWillPopScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'willPopScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedWillPopScope(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), onWillPop: unpackedonWillPop != null ? () => _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.bool>, _fac9.bool>(unpackedonWillPop.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState) : null )]; } );
_36c2.registerBoxer<_7991.WillPopScope>(boxer: ({required _7991.WillPopScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWillPopScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

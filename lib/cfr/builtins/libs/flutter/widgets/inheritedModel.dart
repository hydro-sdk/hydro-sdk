...
class VMManagedInheritedModel extends _36c2.VMManagedBox<_57c1.InheritedModel<_fac9.dynamic>> {VMManagedInheritedModel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_57c1.InheritedModelElement>(object: vmObject.createElement(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toStringShort'
...
final _57c1.InheritedModel<_fac9.dynamic> vmObject;

 }

class RTManagedInheritedModel extends _57c1.InheritedModel implements _36c2.Box<_57c1.InheritedModel> {RTManagedInheritedModel({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateShouldNotifyDependent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: updateShouldNotifyDependent(
            _36c2.maybeUnBoxAndBuildArgument<
                _57c1.InheritedModel<_fac9.dynamic>,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
            _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_fac9.dynamic>,
                _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState)),
        hydroState: hydroState,
        table: _36c2.HydroTable())
  ];
});
table['_dart_isSupportedAspect'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.isSupportedAspect(
...
_57c1.InheritedModel unwrap() => this;
_57c1.InheritedModel get vmObject => this;
@_fac9.override _57c1.InheritedModelElement<_fac9.dynamic> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_57c1.InheritedModelElement<_fac9.dynamic>, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool updateShouldNotifyDependent(oldWidget, dependencies) { 
_36c2.Closure closure = table["updateShouldNotifyDependent"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool isSupportedAspect(aspect) { 
_36c2.Closure closure = table["isSupportedAspect"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadInheritedModel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedModel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedInheritedModel(table: luaCallerArguments  [
0
...
table  [
'inheritedModelInheritFrom'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
final returnValue = _57c1.InheritedModel.inheritFrom(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_57c1.InheritedModel>(boxer: ({required _57c1.InheritedModel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedModel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

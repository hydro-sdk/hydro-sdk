...
class VMManagedToolbarItemsParentData
    extends _36c2.VMManagedBox<_578c.ToolbarItemsParentData> {
  VMManagedToolbarItemsParentData(
    ...
    table['shouldPaint'] = vmObject.shouldPaint;
...
class RTManagedToolbarItemsParentData extends _578c.ToolbarItemsParentData
    implements _36c2.Box<_578c.ToolbarItemsParentData> {
  RTManagedToolbarItemsParentData(
    ...
    table['shouldPaint'] = _36c2.maybeBoxObject(
        object: shouldPaint, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadToolbarItemsParentData(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['toolbarItemsParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedToolbarItemsParentData(
  ...
  _36c2.registerBoxer<_578c.ToolbarItemsParentData>(boxer: (
      {required _578c.ToolbarItemsParentData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedToolbarItemsParentData(

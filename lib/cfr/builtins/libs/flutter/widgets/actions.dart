...
class VMManagedActions extends _36c2.VMManagedBox<_c0f4.Actions> {VMManagedActions({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'dispatcher'
] = _36c2.maybeBoxObject<_c0f4.ActionDispatcher?>(object: vmObject.dispatcher, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'actions'
...
final _c0f4.Actions vmObject;

 }

class RTManagedActions extends _c0f4.Actions implements _36c2.Box<_c0f4.Actions> {RTManagedActions({_c0f4.ActionDispatcher? dispatcher, _ab4a.Key? key, required _fac9.Map<_fac9.Type,_c0f4.Action<_c0f4.Intent>> actions, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(dispatcher: dispatcher,key: key,actions: actions,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'dispatcher'
] = _36c2.maybeBoxObject(object: this.dispatcher, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'actions'
...
_c0f4.Actions unwrap() => this;
_c0f4.Actions get vmObject => this;
@_fac9.override _e2dc.State<_c0f4.Actions> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_c0f4.Actions>, _c0f4.Actions>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadActions({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'actions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedActions(table: luaCallerArguments  [
0
], hydroState: hydroState, dispatcher: _36c2.maybeUnBoxAndBuildArgument<_c0f4.ActionDispatcher?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dispatcher'
...
'key'
] : null, parentState: hydroState), actions: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.Type,_c0f4.Action<_c0f4.Intent>>, _fac9.Type>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'actions'
...
return [_36c2.maybeBoxObject<_c0f4.Action>(object: _c0f4.Actions.find(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), intent: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'intent'
] : null), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'actionsOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_c0f4.ActionDispatcher>(object: _c0f4.Actions.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_c0f4.Actions>(boxer: ({required _c0f4.Actions vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedActions(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

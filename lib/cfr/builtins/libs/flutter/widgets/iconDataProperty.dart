...
class VMManagedIconDataProperty
    extends _36c2.VMManagedBox<_003a.IconDataProperty> {
  VMManagedIconDataProperty(
    ...
    table['getValue'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_003a.IconData?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
...
class RTManagedIconDataProperty extends _003a.IconDataProperty
    implements _36c2.Box<_003a.IconDataProperty> {
  RTManagedIconDataProperty(_fac9.String name$, _003a.IconData? value$,
      {_fac9.String? ifNull,
      ...
      : super(name$, value$,
            ifNull: ifNull, level: level, showName: showName, style: style) {
  ...
  @_fac9.override
  _003a.IconData? get value {
    _36c2.Closure closure = table["getValue"];
    return _36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadIconDataProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['iconDataProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIconDataProperty(
  ...
  _36c2.registerBoxer<_003a.IconDataProperty>(boxer: (
      {required _003a.IconDataProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIconDataProperty(

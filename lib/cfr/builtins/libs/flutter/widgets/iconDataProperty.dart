...
class VMManagedIconDataProperty extends _36c2.VMManagedBox<_003a.IconDataProperty> {VMManagedIconDataProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.value;if(returnValue!= null){return [_36c2.maybeBoxObject<_003a.IconData?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getException'
...
final _003a.IconDataProperty vmObject;

 }

class RTManagedIconDataProperty extends _003a.IconDataProperty implements _36c2.Box<_003a.IconDataProperty> {RTManagedIconDataProperty(_fac9.String name$, _003a.IconData? value$, {_fac9.String? ifNull, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _eaf3.DiagnosticsTreeStyle style, required this.table, required this.hydroState}) : super(name$,value$,ifNull: ifNull,level: level,showName: showName,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'defaultValue'
] = _36c2.maybeBoxObject(object: defaultValue, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'name'
...
_003a.IconDataProperty unwrap() => this;
_003a.IconDataProperty get vmObject => this;
...
@_fac9.override _003a.IconData? get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIconDataProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'iconDataProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedIconDataProperty(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, ifNull: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'ifNull'
...
_36c2.registerBoxer<_003a.IconDataProperty>(boxer: ({required _003a.IconDataProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIconDataProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedForm extends _36c2.VMManagedBox<_5dd5.Form> {
  VMManagedForm(
    ...
    table['createState'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_5dd5.FormState>(
...
class RTManagedForm extends _5dd5.Form implements _36c2.Box<_5dd5.Form> {
  RTManagedForm(
  ...
  @_fac9.override
  _5dd5.FormState createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_5dd5.FormState, _fac9.dynamic>(
...
void loadForm(
  ...
  table['form'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  table['formOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _5dd5.Form.of(
  ...
  _36c2.registerBoxer<_5dd5.Form>(boxer: (
      {required _5dd5.Form vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedForm(

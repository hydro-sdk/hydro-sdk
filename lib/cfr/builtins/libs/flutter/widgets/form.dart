...
class VMManagedForm extends _36c2.VMManagedBox<_5dd5.Form> {VMManagedForm({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_5dd5.FormState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _5dd5.Form vmObject;

 }

class RTManagedForm extends _5dd5.Form implements _36c2.Box<_5dd5.Form> {RTManagedForm({_5dd5.AutovalidateMode? autovalidateMode, _ab4a.Key? key, void Function()? onChanged, _7de1.Future<_fac9.bool> Function()? onWillPop, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(autovalidateMode: autovalidateMode,key: key,onChanged: onChanged,onWillPop: onWillPop,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_5dd5.Form unwrap() => this;
_5dd5.Form get vmObject => this;
@_fac9.override _5dd5.FormState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_5dd5.FormState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadForm({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'form'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonWillPop=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onWillPop'
] : null;

return  [RTManagedForm(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onChanged: unpackedonChanged != null ? () => unpackedonChanged.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , onWillPop: unpackedonWillPop != null ? () => _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.bool>, _fac9.bool>(unpackedonWillPop.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState) : null , child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
...
table  [
'formOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _5dd5.Form.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_5dd5.FormState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_5dd5.Form>(boxer: ({required _5dd5.Form vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedForm(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverPadding extends _36c2.VMManagedBox<_3960.SliverPadding> {VMManagedSliverPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fb1e.RenderSliverPadding>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fb1e.RenderSliverPadding, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.SliverPadding vmObject;

 }

class RTManagedSliverPadding extends _3960.SliverPadding implements _36c2.Box<_3960.SliverPadding> {RTManagedSliverPadding({_ab4a.Key? key, _e2dc.Widget? sliver, required _96d1.EdgeInsetsGeometry padding, required this.table, required this.hydroState}) : super(key: key,sliver: sliver,padding: padding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_fb1e.RenderSliverPadding,
...
_3960.SliverPadding unwrap() => this;
_3960.SliverPadding get vmObject => this;
@_fac9.override _fb1e.RenderSliverPadding createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_fb1e.RenderSliverPadding, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverPadding(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.SliverPadding>(boxer: ({required _3960.SliverPadding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

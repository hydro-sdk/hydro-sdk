...
class VMManagedSliverPadding extends _36c2.VMManagedBox<_3960.SliverPadding> {
  VMManagedSliverPadding(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_fb1e.RenderSliverPadding>(
...
class RTManagedSliverPadding extends _3960.SliverPadding
    implements _36c2.Box<_3960.SliverPadding> {
  RTManagedSliverPadding(
      {_ab4a.Key? key,
      _e2dc.Widget? sliver,
      required _96d1.EdgeInsetsGeometry padding,
      required this.table,
      required this.hydroState})
      : super(key: key, sliver: sliver, padding: padding) {
  ...
  @_fac9.override
  _fb1e.RenderSliverPadding createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_fb1e.RenderSliverPadding, _fac9.dynamic>(
...
void loadSliverPadding(
  ...
  table['sliverPadding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverPadding(
  ...
  _36c2.registerBoxer<_3960.SliverPadding>(boxer: (
      {required _3960.SliverPadding vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverPadding(

...
class VMManagedPage extends _36c2.VMManagedBox<_a37d.Page<_fac9.dynamic>> {
  VMManagedPage(
...
class RTManagedPage extends _a37d.Page implements _36c2.Box<_a37d.Page> {
  RTManagedPage(
    ...
    table['_dart_createRoute'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: createRoute(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
...
void loadPage(
  ...
  table['page'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPage(
  ...
  _36c2.registerBoxer<_a37d.Page>(boxer: (
      {required _a37d.Page vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPage(

...
class VMManagedNeverScrollableScrollPhysics
    extends _36c2.VMManagedBox<_dbad.NeverScrollableScrollPhysics> {
  VMManagedNeverScrollableScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_dbad.NeverScrollableScrollPhysics>(
...
class RTManagedNeverScrollableScrollPhysics
    extends _dbad.NeverScrollableScrollPhysics
    implements _36c2.Box<_dbad.NeverScrollableScrollPhysics> {
  RTManagedNeverScrollableScrollPhysics(
  ...
  @_fac9.override
  _dbad.NeverScrollableScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2.maybeUnBoxAndBuildArgument<_dbad.NeverScrollableScrollPhysics,
            _fac9.dynamic>(
...
void loadNeverScrollableScrollPhysics(
  ...
  table['neverScrollableScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNeverScrollableScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.NeverScrollableScrollPhysics>(boxer: (
      {required _dbad.NeverScrollableScrollPhysics vmObject,

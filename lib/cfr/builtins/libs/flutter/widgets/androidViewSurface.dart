...
class VMManagedAndroidViewSurface
    extends _36c2.VMManagedBox<_172d.AndroidViewSurface> {
  VMManagedAndroidViewSurface(
...
class RTManagedAndroidViewSurface extends _172d.AndroidViewSurface
    implements _36c2.Box<_172d.AndroidViewSurface> {
  RTManagedAndroidViewSurface(
      {_ab4a.Key? key,
      required _40e3.AndroidViewController controller,
...
void loadAndroidViewSurface(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['androidViewSurface'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAndroidViewSurface(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          controller: _36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_172d.AndroidViewSurface>(boxer: (
      {required _172d.AndroidViewSurface vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAndroidViewSurface(

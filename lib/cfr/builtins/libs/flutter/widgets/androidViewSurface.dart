...
class VMManagedAndroidViewSurface extends _36c2.VMManagedBox<_172d.AndroidViewSurface> {VMManagedAndroidViewSurface({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
_172d.AndroidViewSurface unwrap() => this;
_172d.AndroidViewSurface get vmObject => this;
...
void loadAndroidViewSurface({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'androidViewSurface'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedAndroidViewSurface(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), controller: _36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
...
_36c2.registerBoxer<_172d.AndroidViewSurface>(boxer: ({required _172d.AndroidViewSurface vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAndroidViewSurface(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

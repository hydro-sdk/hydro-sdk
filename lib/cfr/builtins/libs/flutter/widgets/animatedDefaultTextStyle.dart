...
class VMManagedAnimatedDefaultTextStyle extends _36c2.VMManagedBox<_da7c.AnimatedDefaultTextStyle> {VMManagedAnimatedDefaultTextStyle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAnimatedDefaultTextStyle extends _da7c.AnimatedDefaultTextStyle implements _36c2.Box<_da7c.AnimatedDefaultTextStyle> {RTManagedAnimatedDefaultTextStyle({required _8c47.Curve curve, _ab4a.Key? key, _fac9.int? maxLines, void Function()? onEnd, required _fe5a.TextOverflow overflow, required _fac9.bool softWrap, _a643.TextAlign? textAlign, _a643.TextHeightBehavior? textHeightBehavior, required _fe5a.TextWidthBasis textWidthBasis, required _e2dc.Widget child, required _fac9.Duration duration, required _74d0.TextStyle style, required this.table, required this.hydroState}) : super(curve: curve,key: key,maxLines: maxLines,onEnd: onEnd,overflow: overflow,softWrap: softWrap,textAlign: textAlign,textHeightBehavior: textHeightBehavior,textWidthBasis: textWidthBasis,child: child,duration: duration,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _da7c.AnimatedWidgetBaseState<_da7c.AnimatedDefaultTextStyle> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.AnimatedWidgetBaseState<_da7c.AnimatedDefaultTextStyle>, _da7c.AnimatedDefaultTextStyle>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedDefaultTextStyle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedAnimatedDefaultTextStyle(table: luaCallerArguments  [
0
], hydroState: hydroState, curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'curve'
...
'maxLines'
] : null, onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , overflow: _36c2.maybeUnBoxEnum(values: _fe5a.TextOverflow.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'overflow'
...
_36c2.registerBoxer<_da7c.AnimatedDefaultTextStyle>(boxer: ({required _da7c.AnimatedDefaultTextStyle vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedDefaultTextStyle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
import 'package:flutter/src/widgets/animated_size.dart' as _8fb6;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedAnimatedSize extends _36c2.VMManagedBox<_8fb6.AnimatedSize> {VMManagedAnimatedSize({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8fb6.AnimatedSize vmObject;

 }

class RTManagedAnimatedSize extends _8fb6.AnimatedSize implements _36c2.Box<_8fb6.AnimatedSize> {RTManagedAnimatedSize({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, required _a643.Clip clipBehavior, required _8c47.Curve curve, _ab4a.Key? key, _fac9.Duration? reverseDuration, _e067.TickerProvider? vsync, required _fac9.Duration duration, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,curve: curve,key: key,reverseDuration: reverseDuration,vsync: vsync,duration: duration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8fb6.AnimatedSize unwrap() => this;
_8fb6.AnimatedSize get vmObject => this;
@_fac9.override _e2dc.State<_8fb6.AnimatedSize> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_8fb6.AnimatedSize>, _8fb6.AnimatedSize>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedSize({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedSize(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_8fb6.AnimatedSize>(boxer: ({required _8fb6.AnimatedSize vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedSize(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

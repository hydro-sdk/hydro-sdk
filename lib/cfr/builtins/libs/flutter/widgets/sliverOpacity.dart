...
class VMManagedSliverOpacity extends _36c2.VMManagedBox<_a8eb.SliverOpacity> {VMManagedSliverOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_26cc.RenderSliverOpacity>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOpacity, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a8eb.SliverOpacity vmObject;

 }

class RTManagedSliverOpacity extends _a8eb.SliverOpacity implements _36c2.Box<_a8eb.SliverOpacity> {RTManagedSliverOpacity({required _fac9.bool alwaysIncludeSemantics, _ab4a.Key? key, _e2dc.Widget? sliver, required _fac9.double opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,key: key,sliver: sliver,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOpacity,
...
_a8eb.SliverOpacity unwrap() => this;
_a8eb.SliverOpacity get vmObject => this;
@_fac9.override _26cc.RenderSliverOpacity createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOpacity, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSliverOpacity(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a8eb.SliverOpacity>(boxer: ({required _a8eb.SliverOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

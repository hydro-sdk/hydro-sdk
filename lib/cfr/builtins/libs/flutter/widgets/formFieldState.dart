...
class VMManagedFormFieldState extends _36c2.VMManagedBox<_5dd5.FormFieldState<_fac9.dynamic>> {VMManagedFormFieldState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getErrorText'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.errorText;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getHasError'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasError,]; } );
table  [
'getIsValid'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isValid,]; } );
table  [
'save'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.save();
return []; } );
table  [
'reset'
...
table  [
'validate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.validate(),]; } );
table  [
'didChange'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didChange(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'didUpdateWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<_5dd5.FormField<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_5dd5.FormField>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedFormFieldState extends _5dd5.FormFieldState implements _36c2.Box<_5dd5.FormFieldState> {RTManagedFormFieldState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getErrorText'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.errorText];
});
table['_dart_getHasError'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _5dd5.FormField<_fac9.dynamic> get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_5dd5.FormField<_fac9.dynamic>, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFormFieldState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'formFieldState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFormFieldState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_5dd5.FormFieldState>(boxer: ({required _5dd5.FormFieldState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFormFieldState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

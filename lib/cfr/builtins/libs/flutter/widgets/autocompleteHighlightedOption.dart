...
import 'package:flutter/src/widgets/inherited_notifier.dart' as _25f9;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedAutocompleteHighlightedOption extends _36c2.VMManagedBox<_2a05.AutocompleteHighlightedOption> {VMManagedAutocompleteHighlightedOption({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'notifier'
] = _36c2.maybeBoxObject<_e644.ValueNotifier?>(object: vmObject.notifier, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_25f9.InheritedNotifier<_e644.ValueNotifier<_fac9.int>>, _e644.ValueNotifier<_fac9.int>>(luaCallerArguments  [
1
...
final _2a05.AutocompleteHighlightedOption vmObject;

 }

class RTManagedAutocompleteHighlightedOption extends _2a05.AutocompleteHighlightedOption implements _36c2.Box<_2a05.AutocompleteHighlightedOption> {RTManagedAutocompleteHighlightedOption({_ab4a.Key? key, required _e2dc.Widget child, required _e644.ValueNotifier<_fac9.int> highlightIndexNotifier, required this.table, required this.hydroState}) : super(key: key,child: child,highlightIndexNotifier: highlightIndexNotifier) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'notifier'
] = _36c2.maybeBoxObject(object: notifier, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
                _25f9.InheritedNotifier<_e644.ValueNotifier<_fac9.int>>,
                _e644.ValueNotifier<_fac9.int>>(luaCallerArguments[1],
            parentState: hydroState)),
        hydroState: hydroState,
...
_2a05.AutocompleteHighlightedOption unwrap() => this;
_2a05.AutocompleteHighlightedOption get vmObject => this;
...
void loadAutocompleteHighlightedOption({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'autocompleteHighlightedOption'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedAutocompleteHighlightedOption(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), highlightIndexNotifier: _36c2.maybeUnBoxAndBuildArgument<_e644.ValueNotifier<_fac9.int>, _fac9.int>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'highlightIndexNotifier'
] : null, parentState: hydroState))]; } );
table  [
'autocompleteHighlightedOptionOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_2a05.AutocompleteHighlightedOption.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
_36c2.registerBoxer<_2a05.AutocompleteHighlightedOption>(boxer: ({required _2a05.AutocompleteHighlightedOption vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutocompleteHighlightedOption(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedProxyElement extends VMManagedBox<ProxyElement> {
  VMManagedProxyElement(
  ...
  final ProxyElement vmObject;
}

class RTManagedProxyElement extends ProxyElement implements Box<ProxyElement> {
  RTManagedProxyElement(ProxyWidget widget$,
    ...
    table['_dart_notifyClients'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      notifyClients(maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  ProxyElement unwrap() => this;
  ProxyElement get vmObject => this;
  @override
  ProxyWidget get widget {
    Closure closure = table["getWidget"];
    return maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
...
void loadProxyElement(
    {required HydroState hydroState, required HydroTable table}) {
  table['proxyElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedProxyElement(
          maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<ProxyElement>(boxer: (
      {required ProxyElement vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedProxyElement(

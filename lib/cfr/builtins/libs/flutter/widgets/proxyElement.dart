...
class VMManagedProxyElement extends _36c2.VMManagedBox<_e2dc.ProxyElement> {
  VMManagedProxyElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_e2dc.ProxyWidget>(
...
class RTManagedProxyElement extends _e2dc.ProxyElement
    implements _36c2.Box<_e2dc.ProxyElement> {
  RTManagedProxyElement(_e2dc.ProxyWidget widget$,
  ...
  @_fac9.override
  _e2dc.ProxyWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ProxyWidget, _fac9.dynamic>(
...
void loadProxyElement(
  ...
  table['proxyElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.ProxyElement>(boxer: (
      {required _e2dc.ProxyElement vmObject,

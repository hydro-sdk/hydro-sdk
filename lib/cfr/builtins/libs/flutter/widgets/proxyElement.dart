...
class VMManagedProxyElement extends _36c2.VMManagedBox<_e2dc.ProxyElement> {VMManagedProxyElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.ProxyWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _e2dc.ProxyElement vmObject;

 }

class RTManagedProxyElement extends _e2dc.ProxyElement implements _36c2.Box<_e2dc.ProxyElement> {RTManagedProxyElement(_e2dc.ProxyWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.ProxyElement unwrap() => this;
_e2dc.ProxyElement get vmObject => this;
@_fac9.override _e2dc.ProxyWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ProxyWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadProxyElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'proxyElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedProxyElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.ProxyWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.ProxyElement>(boxer: ({required _e2dc.ProxyElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedProxyElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedDragTarget
    extends _36c2.VMManagedBox<_0705.DragTarget<_fac9.Object>> {
  VMManagedDragTarget(
...
class RTManagedDragTarget extends _0705.DragTarget
  ...
  RTManagedDragTarget(
      ...
      _ab4a.Key? key,
      void Function(_fac9.Object data)? onAccept,
      void Function(_0705.DragTargetDetails<_fac9.Object> details)?
          onAcceptWithDetails,
      void Function(_fac9.Object? data)? onLeave,
      void Function(_0705.DragTargetDetails<_fac9.Object> details)? onMove,
      _fac9.bool Function(_fac9.Object? data)? onWillAccept,
  ...
  @_fac9.override
  _e2dc.State<_0705.DragTarget<_fac9.Object>> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_0705.DragTarget<_fac9.Object>>,
            _0705.DragTarget<_fac9.Object>>(
...
void loadDragTarget(
  ...
  table['dragTarget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonAccept = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onAccept']
        : null;
    _36c2.Closure? unpackedonAcceptWithDetails = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onAcceptWithDetails']
        : null;
    _36c2.Closure? unpackedonLeave = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onLeave']
        : null;
    _36c2.Closure? unpackedonMove =
        luaCallerArguments.length >= 2 ? luaCallerArguments[1]['onMove'] : null;
    _36c2.Closure? unpackedonWillAccept = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onWillAccept']
        : null;
      ...
      RTManagedDragTarget(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          onAccept: unpackedonAccept != null
              ? (data) => unpackedonAccept.dispatch(
                    [luaCallerArguments[0], data],
                    parentState: hydroState,
                  )
              : null,
          onAcceptWithDetails: unpackedonAcceptWithDetails != null
              ? (details) => unpackedonAcceptWithDetails.dispatch(
                    [luaCallerArguments[0], details],
                    parentState: hydroState,
                  )
              : null,
          onLeave: unpackedonLeave != null
              ? (data) => unpackedonLeave.dispatch(
                    [luaCallerArguments[0], data],
                    parentState: hydroState,
                  )
              : null,
          onMove: unpackedonMove != null
              ? (details) => unpackedonMove.dispatch(
                    [luaCallerArguments[0], details],
                    parentState: hydroState,
                  )
              : null,
          onWillAccept: unpackedonWillAccept != null
              ? (data) => unpackedonWillAccept.dispatch(
                    [luaCallerArguments[0], data],
                    parentState: hydroState,
                  )[0]
              : null,
  ...
  _36c2.registerBoxer<_0705.DragTarget>(boxer: (
      {required _0705.DragTarget vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDragTarget(

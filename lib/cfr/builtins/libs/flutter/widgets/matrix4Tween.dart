...
class VMManagedMatrix4Tween extends _36c2.VMManagedBox<_da7c.Matrix4Tween> {
  VMManagedMatrix4Tween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_db98.Matrix4?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_db98.Matrix4?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedMatrix4Tween extends _da7c.Matrix4Tween
    implements _36c2.Box<_da7c.Matrix4Tween> {
  RTManagedMatrix4Tween(
      {_db98.Matrix4? begin,
      _db98.Matrix4? end,
      required this.table,
  ...
  @_fac9.override
  _db98.Matrix4 evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_db98.Matrix4> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_db98.Matrix4>,
            _db98.Matrix4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _e83e.Animatable<_db98.Matrix4> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<_e83e.Animatable<_db98.Matrix4>,
            _db98.Matrix4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadMatrix4Tween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['matrix4Tween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMatrix4Tween(
          ...
          begin:
              _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          end: _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_da7c.Matrix4Tween>(boxer: (
      {required _da7c.Matrix4Tween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMatrix4Tween(

...
class VMManagedRenderObjectToWidgetAdapter extends _36c2.VMManagedBox<_3e19.RenderObjectToWidgetAdapter<_9742.RenderObject>> {VMManagedRenderObjectToWidgetAdapter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'container'
] = _36c2.maybeBoxObject<_9742.RenderObjectWithChildMixin>(object: vmObject.container, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugShortDescription'
] = vmObject.debugShortDescription;
table  [
'key'
] = _36c2.maybeBoxObject<_ab4a.Key?>(object: vmObject.key, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'createElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_3e19.RenderObjectToWidgetElement>(object: vmObject.createElement(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9742.RenderObjectWithChildMixin>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
return [_36c2.maybeBoxObject<_3e19.RenderObjectToWidgetElement>(object: vmObject.attachToRenderTree(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildOwner, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetElement<_fac9.dynamic>?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toStringShort'
...
final _3e19.RenderObjectToWidgetAdapter<_9742.RenderObject> vmObject;

 }

class RTManagedRenderObjectToWidgetAdapter extends _3e19.RenderObjectToWidgetAdapter implements _36c2.Box<_3e19.RenderObjectToWidgetAdapter> {RTManagedRenderObjectToWidgetAdapter({_e2dc.Widget? child, _fac9.String? debugShortDescription, required _9742.RenderObjectWithChildMixin<_9742.RenderObject> container, required this.table, required this.hydroState}) : super(child: child,debugShortDescription: debugShortDescription,container: container) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'debugShortDescription'
] = _36c2.maybeBoxObject(object: this.debugShortDescription, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
table['_dart_attachToRenderTree'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.attachToRenderTree(
...
_3e19.RenderObjectToWidgetAdapter unwrap() => this;
_3e19.RenderObjectToWidgetAdapter get vmObject => this;
@_fac9.override _3e19.RenderObjectToWidgetElement<_9742.RenderObject> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetElement<_9742.RenderObject>, _9742.RenderObject>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _9742.RenderObjectWithChildMixin<_9742.RenderObject> createRenderObject(context) { 
...
@_fac9.override _3e19.RenderObjectToWidgetElement<_9742.RenderObject> attachToRenderTree(owner, [_3e19.RenderObjectToWidgetElement? element]) { 
_36c2.Closure closure = table["attachToRenderTree"];
return _36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetElement<_9742.RenderObject>, _9742.RenderObject>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderObjectToWidgetAdapter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderObjectToWidgetAdapter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderObjectToWidgetAdapter(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), debugShortDescription: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugShortDescription'
] : null, container: _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObjectWithChildMixin<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'container'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_3e19.RenderObjectToWidgetAdapter>(boxer: ({required _3e19.RenderObjectToWidgetAdapter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderObjectToWidgetAdapter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedKeepAliveHandle
    extends _36c2.VMManagedBox<_78f9.KeepAliveHandle> {
  VMManagedKeepAliveHandle(
...
class RTManagedKeepAliveHandle extends _78f9.KeepAliveHandle
    implements _36c2.Box<_78f9.KeepAliveHandle> {
  RTManagedKeepAliveHandle({required this.table, required this.hydroState})
      : super() {
...
void loadKeepAliveHandle(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['keepAliveHandle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedKeepAliveHandle(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_78f9.KeepAliveHandle>(boxer: (
      {required _78f9.KeepAliveHandle vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedKeepAliveHandle(

...
class VMManagedFlex extends _36c2.VMManagedBox<_3960.Flex> {VMManagedFlex({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'direction'
] = _487f.Axis.values.indexWhere((x) { return x == vmObject.direction; } );
table  [
'mainAxisAlignment'
] = _7374.MainAxisAlignment.values.indexWhere((x) { return x == vmObject.mainAxisAlignment; } );
table  [
'mainAxisSize'
] = _7374.MainAxisSize.values.indexWhere((x) { return x == vmObject.mainAxisSize; } );
table  [
'crossAxisAlignment'
] = _7374.CrossAxisAlignment.values.indexWhere((x) { return x == vmObject.crossAxisAlignment; } );
table  [
'textDirection'
] = _a643.TextDirection.values.indexWhere((x) { return x == vmObject.textDirection; } );
table  [
'verticalDirection'
] = _487f.VerticalDirection.values.indexWhere((x) { return x == vmObject.verticalDirection; } );
table  [
'textBaseline'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7374.RenderFlex>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_7374.RenderFlex, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Flex vmObject;

 }

class RTManagedFlex extends _3960.Flex implements _36c2.Box<_3960.Flex> {RTManagedFlex({required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, required _7374.CrossAxisAlignment crossAxisAlignment, _ab4a.Key? key, required _7374.MainAxisAlignment mainAxisAlignment, required _7374.MainAxisSize mainAxisSize, _a643.TextBaseline? textBaseline, _a643.TextDirection? textDirection, required _487f.VerticalDirection verticalDirection, required _487f.Axis direction, required this.table, required this.hydroState}) : super(children: children,clipBehavior: clipBehavior,crossAxisAlignment: crossAxisAlignment,key: key,mainAxisAlignment: mainAxisAlignment,mainAxisSize: mainAxisSize,textBaseline: textBaseline,textDirection: textDirection,verticalDirection: verticalDirection,direction: direction) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'direction'
] = _487f.Axis.values.indexWhere((x) { return x == this.direction; } );
table  [
'mainAxisAlignment'
] = _7374.MainAxisAlignment.values.indexWhere((x) { return x == this.mainAxisAlignment; } );
table  [
'mainAxisSize'
] = _7374.MainAxisSize.values.indexWhere((x) { return x == this.mainAxisSize; } );
table  [
'crossAxisAlignment'
] = _7374.CrossAxisAlignment.values.indexWhere((x) { return x == this.crossAxisAlignment; } );
table  [
'textDirection'
] = _a643.TextDirection.values.indexWhere((x) { return x == this.textDirection; } );
table  [
'verticalDirection'
] = _487f.VerticalDirection.values.indexWhere((x) { return x == this.verticalDirection; } );
table  [
'textBaseline'
...
table['_dart_getEffectiveTextDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
_3960.Flex unwrap() => this;
_3960.Flex get vmObject => this;
@_fac9.override _a643.TextDirection? getEffectiveTextDirection(context) { 
...
@_fac9.override _7374.RenderFlex createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_7374.RenderFlex, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFlex({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flex'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFlex(table: luaCallerArguments  [
0
], hydroState: hydroState, children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
'key'
] : null, parentState: hydroState), mainAxisAlignment: _36c2.maybeUnBoxEnum(values: _7374.MainAxisAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'mainAxisAlignment'
...
_36c2.registerBoxer<_3960.Flex>(boxer: ({required _3960.Flex vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlex(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

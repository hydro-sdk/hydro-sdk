...
class VMManagedHeroController extends _36c2.VMManagedBox<_1b22.HeroController> {
  VMManagedHeroController(
...
class RTManagedHeroController extends _1b22.HeroController
    implements _36c2.Box<_1b22.HeroController> {
  RTManagedHeroController(
...
void loadHeroController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['heroController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_1b22.HeroController>(boxer: (
      {required _1b22.HeroController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedHeroController(

...
class VMManagedPositionedDirectional extends _36c2.VMManagedBox<_3960.PositionedDirectional> {VMManagedPositionedDirectional({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.PositionedDirectional vmObject;

 }

class RTManagedPositionedDirectional extends _3960.PositionedDirectional implements _36c2.Box<_3960.PositionedDirectional> {RTManagedPositionedDirectional({_fac9.double? bottom, _fac9.double? end, _fac9.double? height, _ab4a.Key? key, _fac9.double? start, _fac9.double? top, _fac9.double? width, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(bottom: bottom,end: end,height: height,key: key,start: start,top: top,width: width,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.PositionedDirectional unwrap() => this;
_3960.PositionedDirectional get vmObject => this;
...
void loadPositionedDirectional({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedPositionedDirectional(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.PositionedDirectional>(boxer: ({required _3960.PositionedDirectional vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPositionedDirectional(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

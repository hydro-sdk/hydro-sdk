...
class VMManagedLayoutId extends _36c2.VMManagedBox<_3960.LayoutId> {VMManagedLayoutId({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'id'
] = _36c2.maybeBoxObject<_fac9.Object>(object: vmObject.id, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _3960.LayoutId vmObject;

 }

class RTManagedLayoutId extends _3960.LayoutId implements _36c2.Box<_3960.LayoutId> {RTManagedLayoutId({_ab4a.Key? key, required _e2dc.Widget child, required _fac9.Object id, required this.table, required this.hydroState}) : super(key: key,child: child,id: id) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.LayoutId unwrap() => this;
_3960.LayoutId get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.ParentDataElement<_2325.MultiChildLayoutParentData> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataElement<_2325.MultiChildLayoutParentData>, _2325.MultiChildLayoutParentData>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadLayoutId({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'layoutId'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedLayoutId(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), id: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'id'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_3960.LayoutId>(boxer: ({required _3960.LayoutId vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLayoutId(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

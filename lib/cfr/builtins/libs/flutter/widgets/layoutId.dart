...
class VMManagedLayoutId extends _36c2.VMManagedBox<_3960.LayoutId> {
  VMManagedLayoutId(
...
class RTManagedLayoutId extends _3960.LayoutId
    implements _36c2.Box<_3960.LayoutId> {
  RTManagedLayoutId(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _fac9.Object id,
      required this.table,
  ...
  @_fac9.override
  _e2dc.ParentDataElement<_2325.MultiChildLayoutParentData> createElement() {
    _36c2.Closure closure = table["createElement"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.ParentDataElement<_2325.MultiChildLayoutParentData>,
            _2325.MultiChildLayoutParentData>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadLayoutId(
  ...
  table['layoutId'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLayoutId(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          id: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_3960.LayoutId>(boxer: (
      {required _3960.LayoutId vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLayoutId(

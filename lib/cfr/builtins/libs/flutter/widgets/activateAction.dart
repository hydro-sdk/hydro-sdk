...
class VMManagedActivateAction extends _36c2.VMManagedBox<_c0f4.ActivateAction> {
  VMManagedActivateAction(
...
class RTManagedActivateAction extends _c0f4.ActivateAction
    implements _36c2.Box<_c0f4.ActivateAction> {
  RTManagedActivateAction({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_invoke'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: invoke(_36c2.maybeUnBoxAndBuildArgument<
                _c0f4.ActivateIntent,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  _c0f4.Action<_c0f4.ActivateIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.ActivateIntent>?,
            _c0f4.ActivateIntent>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadActivateAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['activateAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedActivateAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_c0f4.ActivateAction>(boxer: (
      {required _c0f4.ActivateAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedActivateAction(

...
class VMManagedCutSelectionTextIntent extends _36c2.VMManagedBox<_380d.CutSelectionTextIntent> {VMManagedCutSelectionTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.CutSelectionTextIntent vmObject;

 }

class RTManagedCutSelectionTextIntent extends _380d.CutSelectionTextIntent implements _36c2.Box<_380d.CutSelectionTextIntent> {RTManagedCutSelectionTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.CutSelectionTextIntent unwrap() => this;
_380d.CutSelectionTextIntent get vmObject => this;
...
void loadCutSelectionTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cutSelectionTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedCutSelectionTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.CutSelectionTextIntent>(boxer: ({required _380d.CutSelectionTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCutSelectionTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

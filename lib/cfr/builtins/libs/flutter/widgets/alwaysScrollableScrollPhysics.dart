...
class VMManagedAlwaysScrollableScrollPhysics
    extends _36c2.VMManagedBox<_dbad.AlwaysScrollableScrollPhysics> {
  VMManagedAlwaysScrollableScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_dbad.AlwaysScrollableScrollPhysics>(
...
class RTManagedAlwaysScrollableScrollPhysics
    extends _dbad.AlwaysScrollableScrollPhysics
    implements _36c2.Box<_dbad.AlwaysScrollableScrollPhysics> {
  RTManagedAlwaysScrollableScrollPhysics(
  ...
  @_fac9.override
  _dbad.AlwaysScrollableScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2.maybeUnBoxAndBuildArgument<_dbad.AlwaysScrollableScrollPhysics,
            _fac9.dynamic>(
...
void loadAlwaysScrollableScrollPhysics(
  ...
  table['alwaysScrollableScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAlwaysScrollableScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.AlwaysScrollableScrollPhysics>(boxer: (
      {required _dbad.AlwaysScrollableScrollPhysics vmObject,

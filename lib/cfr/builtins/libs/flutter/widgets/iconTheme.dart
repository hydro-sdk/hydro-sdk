...
import 'package:flutter/src/widgets/icon_theme.dart' as _a6fe;
...
class VMManagedIconTheme extends _36c2.VMManagedBox<_a6fe.IconTheme> {VMManagedIconTheme({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'data'
] = _36c2.maybeBoxObject<_05d1.IconThemeData>(object: vmObject.data, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_a6fe.IconTheme, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a6fe.IconTheme vmObject;

 }

class RTManagedIconTheme extends _a6fe.IconTheme implements _36c2.Box<_a6fe.IconTheme> {RTManagedIconTheme({_ab4a.Key? key, required _e2dc.Widget child, required _05d1.IconThemeData data, required this.table, required this.hydroState}) : super(key: key,child: child,data: data) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_a6fe.IconTheme, _fac9.dynamic>(
...
_a6fe.IconTheme unwrap() => this;
_a6fe.IconTheme get vmObject => this;
...
void loadIconTheme({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'iconTheme'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedIconTheme(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), data: _36c2.maybeUnBoxAndBuildArgument<_05d1.IconThemeData, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'data'
...
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: _a6fe.IconTheme.merge(key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null, parentState: hydroState), child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
table  [
'iconThemeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_05d1.IconThemeData>(object: _a6fe.IconTheme.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_a6fe.IconTheme>(boxer: ({required _a6fe.IconTheme vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIconTheme(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

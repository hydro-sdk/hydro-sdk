...
class VMManagedIconTheme extends _36c2.VMManagedBox<_a6fe.IconTheme> {
  VMManagedIconTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_05d1.IconThemeData>(
...
class RTManagedIconTheme extends _a6fe.IconTheme
    implements _36c2.Box<_a6fe.IconTheme> {
  RTManagedIconTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _05d1.IconThemeData data,
      required this.table,
...
void loadIconTheme(
  ...
  table['iconTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIconTheme(
  ...
  table['iconThemeMerge'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_e2dc.Widget>(
          object: _a6fe.IconTheme.merge(
              key: _36c2
              ...
              child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
              data: _36c2.maybeUnBoxAndBuildArgument<_05d1.IconThemeData, _fac9.dynamic>(
  ...
  table['iconThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_05d1.IconThemeData>(
          object: _a6fe.IconTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_a6fe.IconTheme>(boxer: (
      {required _a6fe.IconTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIconTheme(

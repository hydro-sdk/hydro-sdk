...
class VMManagedSliverList extends _36c2.VMManagedBox<_a8eb.SliverList> {
  VMManagedSliverList(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_13cd.RenderSliverList>(
...
class RTManagedSliverList extends _a8eb.SliverList
    implements _36c2.Box<_a8eb.SliverList> {
  RTManagedSliverList(
      {_ab4a.Key? key,
  ...
  @_fac9.override
  _13cd.RenderSliverList createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_13cd.RenderSliverList, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadSliverList(
  ...
  table['sliverList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverList(
  ...
  _36c2.registerBoxer<_a8eb.SliverList>(boxer: (
      {required _a8eb.SliverList vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverList(

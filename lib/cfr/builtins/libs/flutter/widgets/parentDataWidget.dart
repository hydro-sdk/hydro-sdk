...
class VMManagedParentDataWidget extends _36c2.VMManagedBox<_e2dc.ParentDataWidget<_9742.ParentData>> {VMManagedParentDataWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.ParentDataWidget<_9742.ParentData> vmObject;

 }

class RTManagedParentDataWidget extends _e2dc.ParentDataWidget implements _36c2.Box<_e2dc.ParentDataWidget> {RTManagedParentDataWidget({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.ParentDataWidget unwrap() => this;
_e2dc.ParentDataWidget get vmObject => this;
@_fac9.override _e2dc.ParentDataElement<_9742.ParentData> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataElement<_9742.ParentData>, _9742.ParentData>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadParentDataWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'parentDataWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedParentDataWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.ParentDataWidget>(boxer: ({required _e2dc.ParentDataWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedParentDataWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

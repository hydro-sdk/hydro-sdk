...
class VMManagedMergeSemantics extends _36c2.VMManagedBox<_3960.MergeSemantics> {VMManagedMergeSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderMergeSemantics>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.MergeSemantics vmObject;

 }

class RTManagedMergeSemantics extends _3960.MergeSemantics implements _36c2.Box<_3960.MergeSemantics> {RTManagedMergeSemantics({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.MergeSemantics unwrap() => this;
_3960.MergeSemantics get vmObject => this;
@_fac9.override _bf98.RenderMergeSemantics createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderMergeSemantics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMergeSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'mergeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedMergeSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.MergeSemantics>(boxer: ({required _3960.MergeSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMergeSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

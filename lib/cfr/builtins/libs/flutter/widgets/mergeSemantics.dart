...
class VMManagedMergeSemantics extends _36c2.VMManagedBox<_3960.MergeSemantics> {
  VMManagedMergeSemantics(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderMergeSemantics>(
...
class RTManagedMergeSemantics extends _3960.MergeSemantics
    implements _36c2.Box<_3960.MergeSemantics> {
  RTManagedMergeSemantics(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
  ...
  @_fac9.override
  _bf98.RenderMergeSemantics createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderMergeSemantics, _fac9.dynamic>(
...
void loadMergeSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['mergeSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMergeSemantics(
  ...
  _36c2.registerBoxer<_3960.MergeSemantics>(boxer: (
      {required _3960.MergeSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMergeSemantics(

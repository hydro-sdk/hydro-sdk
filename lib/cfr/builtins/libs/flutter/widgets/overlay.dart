...
class VMManagedOverlay extends _36c2.VMManagedBox<_0049.Overlay> {VMManagedOverlay({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'initialEntries'
] = _36c2.maybeBoxObject<_fac9.List<_0049.OverlayEntry>>(object: vmObject.initialEntries, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_0049.OverlayState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _0049.Overlay vmObject;

 }

class RTManagedOverlay extends _0049.Overlay implements _36c2.Box<_0049.Overlay> {RTManagedOverlay({required _a643.Clip clipBehavior, required _fac9.List<_0049.OverlayEntry> initialEntries, _ab4a.Key? key, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,initialEntries: initialEntries,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'initialEntries'
] = _36c2.maybeBoxObject(object: this.initialEntries, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
_0049.Overlay unwrap() => this;
_0049.Overlay get vmObject => this;
@_fac9.override _0049.OverlayState createState() { 
...
void loadOverlay({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'overlay'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedOverlay(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), initialEntries: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_0049.OverlayEntry>, _0049.OverlayEntry>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialEntries'
...
final returnValue = _0049.Overlay.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), debugRequiredFor: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'debugRequiredFor'
] : null, parentState: hydroState), rootOverlay: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'rootOverlay'
] : null);if(returnValue!= null){return [_36c2.maybeBoxObject<_0049.OverlayState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_0049.Overlay>(boxer: ({required _0049.Overlay vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOverlay(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

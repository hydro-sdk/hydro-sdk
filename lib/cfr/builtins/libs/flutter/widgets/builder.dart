...
class VMManagedBuilder extends _36c2.VMManagedBox<_3960.Builder> {
  VMManagedBuilder(
...
class RTManagedBuilder extends _3960.Builder
    implements _36c2.Box<_3960.Builder> {
  RTManagedBuilder(
      {_ab4a.Key? key,
...
void loadBuilder(
  ...
  table['builder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_3960.Builder>(boxer: (
      {required _3960.Builder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBuilder(

...
class VMManagedBuilder extends _36c2.VMManagedBox<_3960.Builder> {VMManagedBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.Builder vmObject;

 }

class RTManagedBuilder extends _3960.Builder implements _36c2.Box<_3960.Builder> {RTManagedBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.Builder unwrap() => this;
_3960.Builder get vmObject => this;
...
void loadBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'builder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedBuilder(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Builder>(boxer: ({required _3960.Builder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

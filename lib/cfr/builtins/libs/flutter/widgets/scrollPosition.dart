...
class VMManagedScrollPosition extends _36c2.VMManagedBox<_6c49.ScrollPosition> {
  VMManagedScrollPosition(
...
class RTManagedScrollPosition extends _6c49.ScrollPosition
    implements _36c2.Box<_6c49.ScrollPosition> {
  RTManagedScrollPosition(
...
void loadScrollPosition(
  ...
  table['scrollPosition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollPosition(
  ...
  _36c2.registerBoxer<_6c49.ScrollPosition>(boxer: (
      {required _6c49.ScrollPosition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollPosition(

...
class VMManagedScrollPosition extends _36c2.VMManagedBox<_6c49.ScrollPosition> {VMManagedScrollPosition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _6c49.ScrollPosition vmObject;

 }

class RTManagedScrollPosition extends _6c49.ScrollPosition implements _36c2.Box<_6c49.ScrollPosition> {RTManagedScrollPosition({_fac9.String? debugLabel, required _fac9.bool keepScrollOffset, _6c49.ScrollPosition? oldPosition, required _3c93.ScrollContext context, required _dbad.ScrollPhysics physics, required this.table, required this.hydroState}) : super(debugLabel: debugLabel,keepScrollOffset: keepScrollOffset,oldPosition: oldPosition,context: context,physics: physics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_pointerScroll'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  pointerScroll(_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_6c49.ScrollPosition unwrap() => this;
_6c49.ScrollPosition get vmObject => this;
...
void loadScrollPosition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedScrollPosition(table: luaCallerArguments  [
0
], hydroState: hydroState, debugLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugLabel'
] : null, keepScrollOffset: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'keepScrollOffset'
...
_36c2.registerBoxer<_6c49.ScrollPosition>(boxer: ({required _6c49.ScrollPosition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollPosition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

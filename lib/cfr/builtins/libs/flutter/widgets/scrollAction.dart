...
class VMManagedScrollAction extends _36c2.VMManagedBox<_538d.ScrollAction> {VMManagedScrollAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'isEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<_538d.ScrollIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'invoke'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_538d.ScrollIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'consumesKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.consumesKey(_36c2.maybeUnBoxAndBuildArgument<_538d.ScrollIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'addActionListener'
...
final _538d.ScrollAction vmObject;

 }

class RTManagedScrollAction extends _538d.ScrollAction implements _36c2.Box<_538d.ScrollAction> {RTManagedScrollAction({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.isEnabled(
            _36c2.maybeUnBoxAndBuildArgument<_538d.ScrollIntent, _fac9.dynamic>(
...
_538d.ScrollAction unwrap() => this;
_538d.ScrollAction get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _c0f4.Action<_538d.ScrollIntent>? get callingAction { 
_36c2.Closure closure = table["getCallingAction"];
return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_538d.ScrollIntent>?, _538d.ScrollIntent>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadScrollAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedScrollAction(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_538d.ScrollAction>(boxer: ({required _538d.ScrollAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollAction extends _36c2.VMManagedBox<_538d.ScrollAction> {
  VMManagedScrollAction(
...
class RTManagedScrollAction extends _538d.ScrollAction
    implements _36c2.Box<_538d.ScrollAction> {
  RTManagedScrollAction({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _c0f4.Action<_538d.ScrollIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_538d.ScrollIntent>?,
            _538d.ScrollIntent>(
...
void loadScrollAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_538d.ScrollAction>(boxer: (
      {required _538d.ScrollAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollAction(

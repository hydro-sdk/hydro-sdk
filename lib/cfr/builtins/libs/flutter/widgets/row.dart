...
class VMManagedRow extends _36c2.VMManagedBox<_3960.Row> {VMManagedRow({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadRow({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'row'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRow(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Row>(boxer: ({required _3960.Row vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRow(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedDecoratedBoxTransition extends _36c2.VMManagedBox<_d7ad.DecoratedBoxTransition> {VMManagedDecoratedBoxTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'decoration'
] = _36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.decoration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'position'
] = _bf98.DecorationPosition.values.indexWhere((x) { return x == vmObject.position; } );
table  [
'child'
...
final _d7ad.DecoratedBoxTransition vmObject;

 }

class RTManagedDecoratedBoxTransition extends _d7ad.DecoratedBoxTransition implements _36c2.Box<_d7ad.DecoratedBoxTransition> {RTManagedDecoratedBoxTransition({_ab4a.Key? key, required _bf98.DecorationPosition position, required _e2dc.Widget child, required _86ca.Animation<_13a5.Decoration> decoration, required this.table, required this.hydroState}) : super(key: key,position: position,child: child,decoration: decoration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'position'
] = _bf98.DecorationPosition.values.indexWhere((x) { return x == this.position; } );
table  [
'child'
...
_d7ad.DecoratedBoxTransition unwrap() => this;
_d7ad.DecoratedBoxTransition get vmObject => this;
...
void loadDecoratedBoxTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'decoratedBoxTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedDecoratedBoxTransition(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), decoration: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_13a5.Decoration>, _13a5.Decoration>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decoration'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.DecoratedBoxTransition>(boxer: ({required _d7ad.DecoratedBoxTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDecoratedBoxTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

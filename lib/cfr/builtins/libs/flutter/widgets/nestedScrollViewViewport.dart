...
class VMManagedNestedScrollViewViewport
    extends _36c2.VMManagedBox<_c812.NestedScrollViewViewport> {
  VMManagedNestedScrollViewViewport(
    ...
    table['handle'] = _36c2.maybeBoxObject<_c812.SliverOverlapAbsorberHandle>(
    ...
    table['cacheExtentStyle'] = _01f8.CacheExtentStyle.values.indexWhere((x) {
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_c812.RenderNestedScrollViewViewport>(
...
class RTManagedNestedScrollViewViewport extends _c812.NestedScrollViewViewport
    implements _36c2.Box<_c812.NestedScrollViewViewport> {
  RTManagedNestedScrollViewViewport(
    ...
    table['handle'] = _36c2.maybeBoxObject(
        object: this.handle, hydroState: hydroState, table: _36c2.HydroTable());
    table['axisDirection'] = _487f.AxisDirection.values.indexWhere((x) {
    ...
    table['cacheExtent'] = _36c2.maybeBoxObject(
        object: cacheExtent, hydroState: hydroState, table: _36c2.HydroTable());
    table['cacheExtentStyle'] = _01f8.CacheExtentStyle.values.indexWhere((x) {
      return x == cacheExtentStyle;
    });
    table['clipBehavior'] = _a643.Clip.values.indexWhere((x) {
      return x == this.clipBehavior;
    });
    table['children'] = _36c2.maybeBoxObject(
        object: children, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _c812.RenderNestedScrollViewViewport createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c812.RenderNestedScrollViewViewport, _fac9.dynamic>(
...
void loadNestedScrollViewViewport(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['nestedScrollViewViewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNestedScrollViewViewport(
          ...
          axisDirection: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          center: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          slivers:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['slivers'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_c812.NestedScrollViewViewport>(boxer: (
      {required _c812.NestedScrollViewViewport vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNestedScrollViewViewport(

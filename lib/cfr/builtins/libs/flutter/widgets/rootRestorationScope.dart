...
class VMManagedRootRestorationScope extends _36c2.VMManagedBox<_487b.RootRestorationScope> {VMManagedRootRestorationScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _487b.RootRestorationScope vmObject;

 }

class RTManagedRootRestorationScope extends _487b.RootRestorationScope implements _36c2.Box<_487b.RootRestorationScope> {RTManagedRootRestorationScope({_ab4a.Key? key, required _e2dc.Widget child, _fac9.String? restorationId, required this.table, required this.hydroState}) : super(key: key,child: child,restorationId: restorationId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_487b.RootRestorationScope unwrap() => this;
_487b.RootRestorationScope get vmObject => this;
@_fac9.override _e2dc.State<_487b.RootRestorationScope> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_487b.RootRestorationScope>, _487b.RootRestorationScope>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRootRestorationScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rootRestorationScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRootRestorationScope(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_487b.RootRestorationScope>(boxer: ({required _487b.RootRestorationScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRootRestorationScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedHoldScrollActivity extends _36c2.VMManagedBox<_ca8b.HoldScrollActivity> {VMManagedHoldScrollActivity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedHoldScrollActivity extends _ca8b.HoldScrollActivity implements _36c2.Box<_ca8b.HoldScrollActivity> {RTManagedHoldScrollActivity({void Function()? onHoldCanceled, required _ca8b.ScrollActivityDelegate delegate, required this.table, required this.hydroState}) : super(onHoldCanceled: onHoldCanceled,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadHoldScrollActivity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'holdScrollActivity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure? unpackedonHoldCanceled=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onHoldCanceled'
] : null;

return  [RTManagedHoldScrollActivity(table: luaCallerArguments  [
0
], hydroState: hydroState, onHoldCanceled: unpackedonHoldCanceled != null ? () => unpackedonHoldCanceled.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , delegate: _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivityDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_ca8b.HoldScrollActivity>(boxer: ({required _ca8b.HoldScrollActivity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHoldScrollActivity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

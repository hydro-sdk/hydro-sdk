...
class VMManagedStatelessWidget extends _36c2.VMManagedBox<_e2dc.StatelessWidget> {VMManagedStatelessWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.StatelessWidget vmObject;

 }

class RTManagedStatelessWidget extends _e2dc.StatelessWidget implements _36c2.Box<_e2dc.StatelessWidget> {RTManagedStatelessWidget({_ab4a.Key? key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.StatelessWidget unwrap() => this;
_e2dc.StatelessWidget get vmObject => this;
...
void loadStatelessWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statelessWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedStatelessWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.StatelessWidget>(boxer: ({required _e2dc.StatelessWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatelessWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

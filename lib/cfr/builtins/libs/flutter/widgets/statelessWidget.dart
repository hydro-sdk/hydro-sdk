...
class VMManagedStatelessWidget
    extends _36c2.VMManagedBox<_e2dc.StatelessWidget> {
...
class RTManagedStatelessWidget extends _e2dc.StatelessWidget
    implements _36c2.Box<_e2dc.StatelessWidget> {
...
void loadStatelessWidget(
  ...
  table['statelessWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStatelessWidget(
  ...
  _36c2.registerBoxer<_e2dc.StatelessWidget>(boxer: (
      {required _e2dc.StatelessWidget vmObject,

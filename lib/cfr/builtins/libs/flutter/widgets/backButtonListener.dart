...
class VMManagedBackButtonListener
    extends _36c2.VMManagedBox<_f6ef.BackButtonListener> {
  VMManagedBackButtonListener(
...
class RTManagedBackButtonListener extends _f6ef.BackButtonListener
    implements _36c2.Box<_f6ef.BackButtonListener> {
  RTManagedBackButtonListener(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _7de1.Future<_fac9.bool> Function() onBackButtonPressed,
      required this.table,
  ...
  @_fac9.override
  _e2dc.State<_f6ef.BackButtonListener> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_f6ef.BackButtonListener>, _f6ef.BackButtonListener>(
...
void loadBackButtonListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['backButtonListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedonBackButtonPressed = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onBackButtonPressed']
        : null;
    return [
      RTManagedBackButtonListener(
  ...
  _36c2.registerBoxer<_f6ef.BackButtonListener>(boxer: (
      {required _f6ef.BackButtonListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBackButtonListener(

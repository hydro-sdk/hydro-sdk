...
class VMManagedScrollBehavior extends _36c2.VMManagedBox<_b028.ScrollBehavior> {
  VMManagedScrollBehavior(
...
class RTManagedScrollBehavior extends _b028.ScrollBehavior
    implements _36c2.Box<_b028.ScrollBehavior> {
  RTManagedScrollBehavior(
...
void loadScrollBehavior(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollBehavior'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollBehavior(
  ...
  _36c2.registerBoxer<_b028.ScrollBehavior>(boxer: (
      {required _b028.ScrollBehavior vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollBehavior(

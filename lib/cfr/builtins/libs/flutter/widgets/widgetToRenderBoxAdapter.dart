...
class VMManagedWidgetToRenderBoxAdapter
    extends _36c2.VMManagedBox<_3960.WidgetToRenderBoxAdapter> {
  VMManagedWidgetToRenderBoxAdapter(
    ...
    table['renderBox'] = _36c2.maybeBoxObject<_be2e.RenderBox>(
        object: vmObject.renderBox,
        hydroState: hydroState,
...
class RTManagedWidgetToRenderBoxAdapter extends _3960.WidgetToRenderBoxAdapter
    implements _36c2.Box<_3960.WidgetToRenderBoxAdapter> {
  RTManagedWidgetToRenderBoxAdapter(
      {void Function()? onBuild,
      void Function()? onUnmount,
      required _be2e.RenderBox renderBox,
      required this.table,
      required this.hydroState})
      : super(onBuild: onBuild, onUnmount: onUnmount, renderBox: renderBox) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['renderBox'] = _36c2.maybeBoxObject(
        object: this.renderBox,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _be2e.RenderBox createRenderObject(context) {
...
void loadWidgetToRenderBoxAdapter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['widgetToRenderBoxAdapter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonBuild = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onBuild']
        : null;
    _36c2.Closure? unpackedonUnmount = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onUnmount']
        : null;
    ...
    return [
      RTManagedWidgetToRenderBoxAdapter(
          ...
          renderBox:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['renderBox']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3960.WidgetToRenderBoxAdapter>(boxer: (
      {required _3960.WidgetToRenderBoxAdapter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedWidgetToRenderBoxAdapter(

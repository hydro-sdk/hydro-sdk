...
class VMManagedGlobalKey extends _36c2.VMManagedBox<_e2dc.GlobalKey<_e2dc.State<_e2dc.StatefulWidget>>> {VMManagedGlobalKey({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadGlobalKey({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'globalKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [_36c2.maybeBoxObject<_e2dc.GlobalKey>(object: _e2dc.GlobalKey(debugLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugLabel'
...
_36c2.registerBoxer<_e2dc.GlobalKey>(boxer: ({required _e2dc.GlobalKey vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGlobalKey(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

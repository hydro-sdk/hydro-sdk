...
class VMManagedRawImage extends _36c2.VMManagedBox<_3960.RawImage> {VMManagedRawImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_3e84.RenderImage>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_3e84.RenderImage, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
'didUnmountRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<_3e84.RenderImage, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
class RTManagedRawImage extends _3960.RawImage implements _36c2.Box<_3960.RawImage> {RTManagedRawImage({required _ca85.AlignmentGeometry alignment, _a643.Rect? centerSlice, _a643.Color? color, _a643.BlendMode? colorBlendMode, _fac9.String? debugImageLabel, required _a643.FilterQuality filterQuality, _fb77.BoxFit? fit, _fac9.double? height, _a643.Image? image, required _fac9.bool invertColors, required _fac9.bool isAntiAlias, _ab4a.Key? key, required _fac9.bool matchTextDirection, _86ca.Animation<_fac9.double>? opacity, required _48c4.ImageRepeat repeat, required _fac9.double scale, _fac9.double? width, required this.table, required this.hydroState}) : super(alignment: alignment,centerSlice: centerSlice,color: color,colorBlendMode: colorBlendMode,debugImageLabel: debugImageLabel,filterQuality: filterQuality,fit: fit,height: height,image: image,invertColors: invertColors,isAntiAlias: isAntiAlias,key: key,matchTextDirection: matchTextDirection,opacity: opacity,repeat: repeat,scale: scale,width: width) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _3e84.RenderImage createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_3e84.RenderImage, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRawImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRawImage(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.RawImage>(boxer: ({required _3960.RawImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

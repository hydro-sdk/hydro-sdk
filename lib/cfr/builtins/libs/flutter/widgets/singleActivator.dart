...
class VMManagedSingleActivator extends _36c2.VMManagedBox<_1710.SingleActivator> {VMManagedSingleActivator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'trigger'
] = _36c2.maybeBoxObject<_e468.LogicalKeyboardKey>(object: vmObject.trigger, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'control'
] = vmObject.control;
table  [
...
class RTManagedSingleActivator extends _1710.SingleActivator implements _36c2.Box<_1710.SingleActivator> {RTManagedSingleActivator(_e468.LogicalKeyboardKey trigger$, {required _fac9.bool alt, required _fac9.bool control, required _fac9.bool meta, required _fac9.bool shift, required this.table, required this.hydroState}) : super(trigger$,alt: alt,control: control,meta: meta,shift: shift) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'trigger'
] = _36c2.maybeBoxObject(object: this.trigger, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'control'
] = _36c2.maybeBoxObject(object: this.control, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shift'
] = _36c2.maybeBoxObject(object: this.shift, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'alt'
] = _36c2.maybeBoxObject(object: this.alt, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'meta'
] = _36c2.maybeBoxObject(object: this.meta, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadSingleActivator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'singleActivator'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSingleActivator(_36c2.maybeUnBoxAndBuildArgument<_e468.LogicalKeyboardKey, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, alt: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'alt'
] : null, control: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'control'
] : null, meta: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'meta'
] : null, shift: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'shift'
] : null)]; } );
_36c2.registerBoxer<_1710.SingleActivator>(boxer: ({required _1710.SingleActivator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSingleActivator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

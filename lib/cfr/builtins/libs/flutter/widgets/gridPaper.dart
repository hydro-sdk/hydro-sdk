...
import 'package:flutter/src/widgets/grid_paper.dart' as _c76e;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedGridPaper extends _36c2.VMManagedBox<_c76e.GridPaper> {VMManagedGridPaper({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c76e.GridPaper vmObject;

 }

class RTManagedGridPaper extends _c76e.GridPaper implements _36c2.Box<_c76e.GridPaper> {RTManagedGridPaper({_e2dc.Widget? child, required _a643.Color color, required _fac9.int divisions, required _fac9.double interval, _ab4a.Key? key, required _fac9.int subdivisions, required this.table, required this.hydroState}) : super(child: child,color: color,divisions: divisions,interval: interval,key: key,subdivisions: subdivisions) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'interval'
] = _36c2.maybeBoxObject(object: this.interval, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'divisions'
] = _36c2.maybeBoxObject(object: this.divisions, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'subdivisions'
] = _36c2.maybeBoxObject(object: this.subdivisions, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_c76e.GridPaper unwrap() => this;
_c76e.GridPaper get vmObject => this;
...
void loadGridPaper({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'gridPaper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedGridPaper(table: luaCallerArguments  [
0
...
'divisions'
] : null, interval: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'interval'
...
'key'
] : null, parentState: hydroState), subdivisions: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'subdivisions'
] : null)]; } );
_36c2.registerBoxer<_c76e.GridPaper>(boxer: ({required _c76e.GridPaper vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGridPaper(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

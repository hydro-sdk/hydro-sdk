...
class VMManagedGridPaper extends _36c2.VMManagedBox<_c76e.GridPaper> {
  VMManagedGridPaper(
    ...
    table['interval'] = vmObject.interval;
    table['divisions'] = vmObject.divisions;
    table['subdivisions'] = vmObject.subdivisions;
...
class RTManagedGridPaper extends _c76e.GridPaper
    implements _36c2.Box<_c76e.GridPaper> {
  RTManagedGridPaper(
      {_e2dc.Widget? child,
      required _a643.Color color,
      required _fac9.int divisions,
      required _fac9.double interval,
      _ab4a.Key? key,
      required _fac9.int subdivisions,
      required this.table,
    ...
    table['interval'] = _36c2.maybeBoxObject(
    ...
    table['divisions'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['subdivisions'] = _36c2.maybeBoxObject(
        object: this.subdivisions,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadGridPaper(
  ...
  table['gridPaper'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGridPaper(
          ...
          divisions: luaCallerArguments.length >= 2
              ...
              : null,
          interval: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['interval']
              : null?.toDouble(),
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          subdivisions: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['subdivisions'] : null)
    ];
  });
  _36c2.registerBoxer<_c76e.GridPaper>(boxer: (
      {required _c76e.GridPaper vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGridPaper(

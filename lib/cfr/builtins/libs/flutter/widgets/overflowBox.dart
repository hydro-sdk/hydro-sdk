...
class VMManagedOverflowBox extends _36c2.VMManagedBox<_3960.OverflowBox> {VMManagedOverflowBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderConstrainedOverflowBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderConstrainedOverflowBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.OverflowBox vmObject;

 }

class RTManagedOverflowBox extends _3960.OverflowBox implements _36c2.Box<_3960.OverflowBox> {RTManagedOverflowBox({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, _ab4a.Key? key, _fac9.double? maxHeight, _fac9.double? maxWidth, _fac9.double? minHeight, _fac9.double? minWidth, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,key: key,maxHeight: maxHeight,maxWidth: maxWidth,minHeight: minHeight,minWidth: minWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderConstrainedOverflowBox,
...
_3960.OverflowBox unwrap() => this;
_3960.OverflowBox get vmObject => this;
@_fac9.override _a9e4.RenderConstrainedOverflowBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderConstrainedOverflowBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadOverflowBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'overflowBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedOverflowBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.OverflowBox>(boxer: ({required _3960.OverflowBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOverflowBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

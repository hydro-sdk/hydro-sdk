...
class VMManagedOverflowBox extends _36c2.VMManagedBox<_3960.OverflowBox> {
  VMManagedOverflowBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_a9e4.RenderConstrainedOverflowBox>(
...
class RTManagedOverflowBox extends _3960.OverflowBox
    implements _36c2.Box<_3960.OverflowBox> {
  RTManagedOverflowBox(
  ...
  @_fac9.override
  _a9e4.RenderConstrainedOverflowBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderConstrainedOverflowBox,
            _fac9.dynamic>(
...
void loadOverflowBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['overflowBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOverflowBox(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          maxHeight: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['maxHeight'] : null?.toDouble(),
          maxWidth: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['maxWidth'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_3960.OverflowBox>(boxer: (
      {required _3960.OverflowBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOverflowBox(

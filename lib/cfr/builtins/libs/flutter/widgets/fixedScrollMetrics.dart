...
class VMManagedFixedScrollMetrics extends _36c2.VMManagedBox<_96ae.FixedScrollMetrics> {VMManagedFixedScrollMetrics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedFixedScrollMetrics extends _96ae.FixedScrollMetrics implements _36c2.Box<_96ae.FixedScrollMetrics> {RTManagedFixedScrollMetrics({required _487f.AxisDirection axisDirection, _fac9.double? maxScrollExtent, _fac9.double? minScrollExtent, _fac9.double? pixels, _fac9.double? viewportDimension, required this.table, required this.hydroState}) : super(axisDirection: axisDirection,maxScrollExtent: maxScrollExtent,minScrollExtent: minScrollExtent,pixels: pixels,viewportDimension: viewportDimension) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadFixedScrollMetrics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fixedScrollMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFixedScrollMetrics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_96ae.FixedScrollMetrics>(boxer: ({required _96ae.FixedScrollMetrics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFixedScrollMetrics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedWidgetOrderTraversalPolicy
    extends _36c2.VMManagedBox<_65d3.WidgetOrderTraversalPolicy> {
  VMManagedWidgetOrderTraversalPolicy(
...
class RTManagedWidgetOrderTraversalPolicy
    extends _65d3.WidgetOrderTraversalPolicy
    implements _36c2.Box<_65d3.WidgetOrderTraversalPolicy> {
  RTManagedWidgetOrderTraversalPolicy(
...
void loadWidgetOrderTraversalPolicy(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['widgetOrderTraversalPolicy'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedWidgetOrderTraversalPolicy(
  ...
  _36c2.registerBoxer<_65d3.WidgetOrderTraversalPolicy>(boxer: (
      {required _65d3.WidgetOrderTraversalPolicy vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedWidgetOrderTraversalPolicy(

...
class VMManagedPasteTextIntent extends _36c2.VMManagedBox<_380d.PasteTextIntent> {VMManagedPasteTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.PasteTextIntent vmObject;

 }

class RTManagedPasteTextIntent extends _380d.PasteTextIntent implements _36c2.Box<_380d.PasteTextIntent> {RTManagedPasteTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.PasteTextIntent unwrap() => this;
_380d.PasteTextIntent get vmObject => this;
...
void loadPasteTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pasteTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPasteTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.PasteTextIntent>(boxer: ({required _380d.PasteTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPasteTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

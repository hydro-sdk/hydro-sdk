...
class VMManagedAnimatedScale extends _36c2.VMManagedBox<_da7c.AnimatedScale> {VMManagedAnimatedScale({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.AnimatedScale vmObject;

 }

class RTManagedAnimatedScale extends _da7c.AnimatedScale implements _36c2.Box<_da7c.AnimatedScale> {RTManagedAnimatedScale({required _ca85.Alignment alignment, _e2dc.Widget? child, required _8c47.Curve curve, _a643.FilterQuality? filterQuality, _ab4a.Key? key, void Function()? onEnd, required _fac9.Duration duration, required _fac9.double scale, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,curve: curve,filterQuality: filterQuality,key: key,onEnd: onEnd,duration: duration,scale: scale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.AnimatedScale unwrap() => this;
_da7c.AnimatedScale get vmObject => this;
@_fac9.override _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedScale> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedScale>, _da7c.AnimatedScale>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedScale({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedScale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedScale(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_da7c.AnimatedScale>(boxer: ({required _da7c.AnimatedScale vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedScale(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

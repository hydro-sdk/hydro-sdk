...
class VMManagedRestorableRouteFuture extends _36c2.VMManagedBox<_a37d.RestorableRouteFuture<_fac9.dynamic>> {VMManagedRestorableRouteFuture({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'present'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.present(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getIsPresent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isPresent,]; } );
table  [
'getRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.route;if(returnValue!= null){return [_36c2.maybeBoxObject<_a37d.Route?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'createDefaultValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.createDefaultValue();if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'initWithValue'
...
class RTManagedRestorableRouteFuture extends _a37d.RestorableRouteFuture implements _36c2.Box<_a37d.RestorableRouteFuture> {RTManagedRestorableRouteFuture({required _a37d.NavigatorState Function(_e2dc.BuildContext context) navigatorFinder, void Function(_fac9.dynamic result)? onComplete, required _fac9.String Function(_a37d.NavigatorState navigator, _fac9.Object? arguments) onPresent, required this.table, required this.hydroState}) : super(navigatorFinder: navigatorFinder,onComplete: onComplete,onPresent: onPresent) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_present'] =
  ...
  super.present(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_getIsPresent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.isPresent];
});
table['_dart_getRoute'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.route];
});
...
@_fac9.override void present([_fac9.Object? arguments]) { 
_36c2.Closure closure = table["present"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isPresent { 
_36c2.Closure closure = table["getIsPresent"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a37d.Route<_fac9.dynamic>? get route { 
...
@_fac9.override _fac9.String? createDefaultValue() { 
_36c2.Closure closure = table["createDefaultValue"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void initWithValue(value) { 
...
@_fac9.override _fac9.String fromPrimitives(data) { 
...
void loadRestorableRouteFuture({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableRouteFuture'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackednavigatorFinder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'navigatorFinder'
] : null;
_36c2.Closure? unpackedonComplete=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onComplete'
] : null;
_36c2.Closure unpackedonPresent=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPresent'
] : null;
return  [RTManagedRestorableRouteFuture(table: luaCallerArguments  [
0
], hydroState: hydroState, navigatorFinder: (context) => _36c2.maybeUnBoxAndBuildArgument<_a37d.NavigatorState, _fac9.dynamic>(unpackednavigatorFinder.dispatch([luaCallerArguments[0],context],parentState:hydroState,)[0], parentState: hydroState), onComplete: unpackedonComplete != null ? (result) => unpackedonComplete.dispatch([luaCallerArguments[0],result],parentState:hydroState,) : null , onPresent: (navigator, arguments) => unpackedonPresent.dispatch([luaCallerArguments[0],navigator,arguments],parentState:hydroState,)[0])]; } );
_36c2.registerBoxer<_a37d.RestorableRouteFuture>(boxer: ({required _a37d.RestorableRouteFuture vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableRouteFuture(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

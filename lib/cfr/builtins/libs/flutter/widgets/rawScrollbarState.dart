...
class VMManagedRawScrollbarState extends _36c2.VMManagedBox<_1c5f.RawScrollbarState<_1c5f.RawScrollbar>> {VMManagedRawScrollbarState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'scrollbarPainter'
] = _36c2.maybeBoxObject<_1c5f.ScrollbarPainter>(object: vmObject.scrollbarPainter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'initState'
...
class RTManagedRawScrollbarState extends _1c5f.RawScrollbarState implements _36c2.Box<_1c5f.RawScrollbarState> {RTManagedRawScrollbarState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'scrollbarPainter'
] = _36c2.maybeBoxObject(object: scrollbarPainter, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_getShowScrollbar'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.showScrollbar];
});
table['_dart_getEnableGestures'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_updateScrollbarPainter'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getScrollbarDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
table['_dart_handleThumbPress'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.handleThumbPress();
  return [];
});
table['_dart_handleThumbPressStart'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_handleThumbPressUpdate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_handleThumbPressEnd'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_isPointerOverTrack'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
table['_dart_isPointerOverThumb'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_isPointerOverScrollbar'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_handleHover'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.handleHover(
      _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerHoverEvent, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_handleHoverExit'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.handleHoverExit(
      _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerExitEvent, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
...
@_fac9.override _fac9.bool get showScrollbar { 
_36c2.Closure closure = table["getShowScrollbar"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get enableGestures { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateScrollbarPainter() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _487f.Axis? getScrollbarDirection() { 
...
@_fac9.override void handleThumbPress() { super.handleThumbPress();
_36c2.Closure closure = table["handleThumbPress"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void handleThumbPressStart(localPosition) { super.handleThumbPressStart(localPosition);
_36c2.Closure closure = table["handleThumbPressStart"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void handleThumbPressUpdate(localPosition) { super.handleThumbPressUpdate(localPosition);
_36c2.Closure closure = table["handleThumbPressUpdate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void handleThumbPressEnd(localPosition, velocity) { super.handleThumbPressEnd(localPosition, velocity);
_36c2.Closure closure = table["handleThumbPressEnd"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool isPointerOverTrack(position, kind) { 
_36c2.Closure closure = table["isPointerOverTrack"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool isPointerOverThumb(position, kind) { 
_36c2.Closure closure = table["isPointerOverThumb"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool isPointerOverScrollbar(position, kind, {_fac9.bool forHover = false}) { 
_36c2.Closure closure = table["isPointerOverScrollbar"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void handleHover(event) { super.handleHover(event);
_36c2.Closure closure = table["handleHover"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void handleHoverExit(event) { super.handleHoverExit(event);
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _1c5f.RawScrollbar get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_1c5f.RawScrollbar, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRawScrollbarState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawScrollbarState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRawScrollbarState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_1c5f.RawScrollbarState>(boxer: ({required _1c5f.RawScrollbarState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawScrollbarState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

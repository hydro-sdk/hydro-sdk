...
class VMManagedFixedExtentScrollController extends _36c2.VMManagedBox<_7b25.FixedExtentScrollController> {VMManagedFixedExtentScrollController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'initialItem'
] = vmObject.initialItem;
table  [
'keepScrollOffset'
...
table  [
'getSelectedItem'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.selectedItem,]; } );
table  [
'animateToItem'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.animateToItem(luaCallerArguments  [
1
...
table  [
'jumpToItem'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.jumpToItem(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _7b25.FixedExtentScrollController vmObject;

 }

class RTManagedFixedExtentScrollController extends _7b25.FixedExtentScrollController implements _36c2.Box<_7b25.FixedExtentScrollController> {RTManagedFixedExtentScrollController({required _fac9.int initialItem, required this.table, required this.hydroState}) : super(initialItem: initialItem) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'initialItem'
] = _36c2.maybeBoxObject(object: this.initialItem, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'keepScrollOffset'
...
table['_dart_getSelectedItem'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.selectedItem];
});
table['_dart_animateToItem'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.animateToItem(
...
table['_dart_jumpToItem'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.jumpToItem(_36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_7b25.FixedExtentScrollController unwrap() => this;
_7b25.FixedExtentScrollController get vmObject => this;
@_fac9.override _fac9.int get selectedItem { 
_36c2.Closure closure = table["getSelectedItem"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7de1.Future<void> animateToItem(itemIndex, {required _8c47.Curve curve, required _fac9.Duration duration}) { 
_36c2.Closure closure = table["animateToItem"];
...
@_fac9.override void jumpToItem(itemIndex) { 
_36c2.Closure closure = table["jumpToItem"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadFixedExtentScrollController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fixedExtentScrollController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFixedExtentScrollController(table: luaCallerArguments  [
0
], hydroState: hydroState, initialItem: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialItem'
] : null)]; } );
_36c2.registerBoxer<_7b25.FixedExtentScrollController>(boxer: ({required _7b25.FixedExtentScrollController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFixedExtentScrollController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedElement extends VMManagedBox<Element> {
  VMManagedElement(
  ...
  final Element vmObject;
}

class RTManagedElement extends Element implements Box<Element> {
  RTManagedElement(Widget widget$,
...
void loadElement({required HydroState hydroState, required HydroTable table}) {
  table['element'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedElement(
  ...
  table['elementDescribeElements'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<DiagnosticsNode>(
          object: Element.describeElements(
              luaCallerArguments[1],
              maybeUnBoxAndBuildArgument<Iterable<Element>, Element>(
                  luaCallerArguments[2],
                  parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable()),
  ...
  registerBoxer<Element>(boxer: (
      {required Element vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedElement(

...
class VMManagedElement extends _36c2.VMManagedBox<_e2dc.Element> {
  VMManagedElement(
...
class RTManagedElement extends _e2dc.Element
    implements _36c2.Box<_e2dc.Element> {
  RTManagedElement(_e2dc.Widget widget$,
...
void loadElement(
  ...
  table['element'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
  ...
  table['elementDescribeElements'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_eaf3.DiagnosticsNode>(
          object: _e2dc.Element.describeElements(
              luaCallerArguments[1],
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_e2dc.Element>,
                      _e2dc.Element>(luaCallerArguments[2],
                  parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  _36c2.registerBoxer<_e2dc.Element>(boxer: (
      {required _e2dc.Element vmObject,

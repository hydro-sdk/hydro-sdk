...
class VMManagedBaseline extends _36c2.VMManagedBox<_3960.Baseline> {
  VMManagedBaseline(
    ...
    table['baselineType'] = _a643.TextBaseline.values.indexWhere((x) {
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_a9e4.RenderBaseline>(
...
class RTManagedBaseline extends _3960.Baseline
    implements _36c2.Box<_3960.Baseline> {
  RTManagedBaseline(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
    ...
    table['baseline'] = _36c2.maybeBoxObject(
        object: this.baseline,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['baselineType'] = _a643.TextBaseline.values.indexWhere((x) {
      return x == this.baselineType;
    });
  ...
  @_fac9.override
  _a9e4.RenderBaseline createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_a9e4.RenderBaseline, _fac9.dynamic>(
...
void loadBaseline(
  ...
  table['baseline'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBaseline(
  ...
  _36c2.registerBoxer<_3960.Baseline>(boxer: (
      {required _3960.Baseline vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBaseline(

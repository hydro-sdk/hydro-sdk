...
class VMManagedBaseline extends _36c2.VMManagedBox<_3960.Baseline> {VMManagedBaseline({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'baselineType'
] = _a643.TextBaseline.values.indexWhere((x) { return x == vmObject.baselineType; } );
table  [
'child'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderBaseline>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderBaseline, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Baseline vmObject;

 }

class RTManagedBaseline extends _3960.Baseline implements _36c2.Box<_3960.Baseline> {RTManagedBaseline({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.double baseline, required _a643.TextBaseline baselineType, required this.table, required this.hydroState}) : super(child: child,key: key,baseline: baseline,baselineType: baselineType) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'baseline'
] = _36c2.maybeBoxObject(object: this.baseline, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'baselineType'
] = _a643.TextBaseline.values.indexWhere((x) { return x == this.baselineType; } );
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderBaseline, _fac9.dynamic>(
...
_3960.Baseline unwrap() => this;
_3960.Baseline get vmObject => this;
@_fac9.override _a9e4.RenderBaseline createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderBaseline, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadBaseline({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'baseline'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedBaseline(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Baseline>(boxer: ({required _3960.Baseline vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBaseline(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

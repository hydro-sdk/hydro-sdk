...
class VMManagedButtonActivateIntent extends _36c2.VMManagedBox<_c0f4.ButtonActivateIntent> {VMManagedButtonActivateIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c0f4.ButtonActivateIntent vmObject;

 }

class RTManagedButtonActivateIntent extends _c0f4.ButtonActivateIntent implements _36c2.Box<_c0f4.ButtonActivateIntent> {RTManagedButtonActivateIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.ButtonActivateIntent unwrap() => this;
_c0f4.ButtonActivateIntent get vmObject => this;
...
void loadButtonActivateIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'buttonActivateIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedButtonActivateIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.ButtonActivateIntent>(boxer: ({required _c0f4.ButtonActivateIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedButtonActivateIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

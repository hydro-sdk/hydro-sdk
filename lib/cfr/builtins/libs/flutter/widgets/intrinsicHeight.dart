...
class VMManagedIntrinsicHeight extends _36c2.VMManagedBox<_3960.IntrinsicHeight> {VMManagedIntrinsicHeight({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderIntrinsicHeight>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.IntrinsicHeight vmObject;

 }

class RTManagedIntrinsicHeight extends _3960.IntrinsicHeight implements _36c2.Box<_3960.IntrinsicHeight> {RTManagedIntrinsicHeight({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.IntrinsicHeight unwrap() => this;
_3960.IntrinsicHeight get vmObject => this;
@_fac9.override _bf98.RenderIntrinsicHeight createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicHeight, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIntrinsicHeight({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intrinsicHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedIntrinsicHeight(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.IntrinsicHeight>(boxer: ({required _3960.IntrinsicHeight vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntrinsicHeight(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedIntrinsicHeight
    extends _36c2.VMManagedBox<_3960.IntrinsicHeight> {
  VMManagedIntrinsicHeight(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderIntrinsicHeight>(
...
class RTManagedIntrinsicHeight extends _3960.IntrinsicHeight
    implements _36c2.Box<_3960.IntrinsicHeight> {
  RTManagedIntrinsicHeight(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
  ...
  @_fac9.override
  _bf98.RenderIntrinsicHeight createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicHeight, _fac9.dynamic>(
...
void loadIntrinsicHeight(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['intrinsicHeight'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIntrinsicHeight(
  ...
  _36c2.registerBoxer<_3960.IntrinsicHeight>(boxer: (
      {required _3960.IntrinsicHeight vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIntrinsicHeight(

...
class VMManagedUnconstrainedBox
    extends _36c2.VMManagedBox<_3960.UnconstrainedBox> {
  VMManagedUnconstrainedBox(
    ...
    table['constrainedAxis'] = _487f.Axis.values.indexWhere((x) {
      return x == vmObject.constrainedAxis;
    });
...
class RTManagedUnconstrainedBox extends _3960.UnconstrainedBox
    implements _36c2.Box<_3960.UnconstrainedBox> {
  RTManagedUnconstrainedBox(
...
void loadUnconstrainedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['unconstrainedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedUnconstrainedBox(
  ...
  _36c2.registerBoxer<_3960.UnconstrainedBox>(boxer: (
      {required _3960.UnconstrainedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedUnconstrainedBox(

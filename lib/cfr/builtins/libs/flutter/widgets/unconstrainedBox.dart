...
class VMManagedUnconstrainedBox extends _36c2.VMManagedBox<_3960.UnconstrainedBox> {VMManagedUnconstrainedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'constrainedAxis'
] = _487f.Axis.values.indexWhere((x) { return x == vmObject.constrainedAxis; } );
table  [
'clipBehavior'
...
final _3960.UnconstrainedBox vmObject;

 }

class RTManagedUnconstrainedBox extends _3960.UnconstrainedBox implements _36c2.Box<_3960.UnconstrainedBox> {RTManagedUnconstrainedBox({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, required _a643.Clip clipBehavior, _487f.Axis? constrainedAxis, _ab4a.Key? key, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,constrainedAxis: constrainedAxis,key: key,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'constrainedAxis'
] = _487f.Axis.values.indexWhere((x) { return x == this.constrainedAxis; } );
table  [
'clipBehavior'
...
_3960.UnconstrainedBox unwrap() => this;
_3960.UnconstrainedBox get vmObject => this;
...
void loadUnconstrainedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'unconstrainedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedUnconstrainedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.UnconstrainedBox>(boxer: ({required _3960.UnconstrainedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedUnconstrainedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

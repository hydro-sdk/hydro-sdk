...
class VMManagedListWheelScrollView
    extends _36c2.VMManagedBox<_7b25.ListWheelScrollView> {
  VMManagedListWheelScrollView(
...
class RTManagedListWheelScrollView extends _7b25.ListWheelScrollView
  ...
  @_fac9.override
  _e2dc.State<_7b25.ListWheelScrollView> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_7b25.ListWheelScrollView>, _7b25.ListWheelScrollView>(
...
void loadListWheelScrollView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['listWheelScrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedListWheelScrollView(
          ...
          overAndUnderCenterOpacity: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          perspective: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['perspective'] : null?.toDouble(),
          ...
          renderChildrenOutsideViewport: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['renderChildrenOutsideViewport'] : null,
  ...
  _36c2.registerBoxer<_7b25.ListWheelScrollView>(boxer: (
      {required _7b25.ListWheelScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedListWheelScrollView(

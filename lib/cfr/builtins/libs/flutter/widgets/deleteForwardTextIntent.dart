...
class VMManagedDeleteForwardTextIntent extends _36c2.VMManagedBox<_380d.DeleteForwardTextIntent> {VMManagedDeleteForwardTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.DeleteForwardTextIntent vmObject;

 }

class RTManagedDeleteForwardTextIntent extends _380d.DeleteForwardTextIntent implements _36c2.Box<_380d.DeleteForwardTextIntent> {RTManagedDeleteForwardTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.DeleteForwardTextIntent unwrap() => this;
_380d.DeleteForwardTextIntent get vmObject => this;
...
void loadDeleteForwardTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'deleteForwardTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDeleteForwardTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.DeleteForwardTextIntent>(boxer: ({required _380d.DeleteForwardTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDeleteForwardTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

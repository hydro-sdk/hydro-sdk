...
class VMManagedNotificationListener extends _36c2.VMManagedBox<_c8d8.NotificationListener<_c8d8.Notification>> {VMManagedNotificationListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c8d8.NotificationListener<_c8d8.Notification> vmObject;

 }

class RTManagedNotificationListener extends _c8d8.NotificationListener implements _36c2.Box<_c8d8.NotificationListener> {RTManagedNotificationListener({_ab4a.Key? key, _fac9.bool Function(_c8d8.Notification notification)? onNotification, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,onNotification: onNotification,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c8d8.NotificationListener unwrap() => this;
_c8d8.NotificationListener get vmObject => this;
...
void loadNotificationListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'notificationListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure? unpackedonNotification=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onNotification'
] : null;

return  [RTManagedNotificationListener(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onNotification: unpackedonNotification != null ? (notification) => unpackedonNotification.dispatch([luaCallerArguments[0],notification],parentState:hydroState,)[0] : null , child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_c8d8.NotificationListener>(boxer: ({required _c8d8.NotificationListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedNotificationListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

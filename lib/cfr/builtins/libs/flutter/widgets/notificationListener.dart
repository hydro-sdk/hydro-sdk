...
class VMManagedNotificationListener
    extends _36c2.VMManagedBox<_c8d8.NotificationListener<_c8d8.Notification>> {
  VMManagedNotificationListener(
...
class RTManagedNotificationListener extends _c8d8.NotificationListener
    implements _36c2.Box<_c8d8.NotificationListener> {
  RTManagedNotificationListener(
      {_ab4a.Key? key,
      _fac9.bool Function(_c8d8.Notification notification)? onNotification,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(key: key, onNotification: onNotification, child: child) {
...
void loadNotificationListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['notificationListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonNotification = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onNotification']
        : null;
      ...
      RTManagedNotificationListener(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          onNotification: unpackedonNotification != null
              ? (notification) => unpackedonNotification.dispatch(
  ...
  _36c2.registerBoxer<_c8d8.NotificationListener>(boxer: (
      {required _c8d8.NotificationListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNotificationListener(

...
class VMManagedScrollUpdateNotification extends _36c2.VMManagedBox<_593c.ScrollUpdateNotification> {VMManagedScrollUpdateNotification({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedScrollUpdateNotification extends _593c.ScrollUpdateNotification implements _36c2.Box<_593c.ScrollUpdateNotification> {RTManagedScrollUpdateNotification({_fac9.int? depth, _4bc7.DragUpdateDetails? dragDetails, _fac9.double? scrollDelta, required _e2dc.BuildContext context, required _96ae.ScrollMetrics metrics, required this.table, required this.hydroState}) : super(depth: depth,dragDetails: dragDetails,scrollDelta: scrollDelta,context: context,metrics: metrics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadScrollUpdateNotification({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedScrollUpdateNotification(table: luaCallerArguments  [
0
], hydroState: hydroState, depth: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'depth'
] : null, dragDetails: _36c2.maybeUnBoxAndBuildArgument<_4bc7.DragUpdateDetails?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dragDetails'
] : null, parentState: hydroState), scrollDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollDelta'
...
_36c2.registerBoxer<_593c.ScrollUpdateNotification>(boxer: ({required _593c.ScrollUpdateNotification vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollUpdateNotification(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

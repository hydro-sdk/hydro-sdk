...
import 'package:flutter/src/widgets/sliver_prototype_extent_list.dart' as _a896;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSliverPrototypeExtentList extends _36c2.VMManagedBox<_a896.SliverPrototypeExtentList> {VMManagedSliverPrototypeExtentList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_35be.RenderSliverMultiBoxAdaptor>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a896.SliverPrototypeExtentList vmObject;

 }

class RTManagedSliverPrototypeExtentList extends _a896.SliverPrototypeExtentList implements _36c2.Box<_a896.SliverPrototypeExtentList> {RTManagedSliverPrototypeExtentList({_ab4a.Key? key, required _a8eb.SliverChildDelegate delegate, required _e2dc.Widget prototypeItem, required this.table, required this.hydroState}) : super(key: key,delegate: delegate,prototypeItem: prototypeItem) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a896.SliverPrototypeExtentList unwrap() => this;
_a896.SliverPrototypeExtentList get vmObject => this;
@_fac9.override _35be.RenderSliverMultiBoxAdaptor createRenderObject(context) { 
...
void loadSliverPrototypeExtentList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverPrototypeExtentList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverPrototypeExtentList(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a896.SliverPrototypeExtentList>(boxer: ({required _a896.SliverPrototypeExtentList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverPrototypeExtentList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverPrototypeExtentList
    extends _36c2.VMManagedBox<_a896.SliverPrototypeExtentList> {
  VMManagedSliverPrototypeExtentList(
    ...
    table['delegate'] = _36c2.maybeBoxObject<_a8eb.SliverChildDelegate>(
    ...
    table['createElement'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a8eb.SliverMultiBoxAdaptorElement>(
...
class RTManagedSliverPrototypeExtentList extends _a896.SliverPrototypeExtentList
    implements _36c2.Box<_a896.SliverPrototypeExtentList> {
  RTManagedSliverPrototypeExtentList(
      {_ab4a.Key? key,
      required _a8eb.SliverChildDelegate delegate,
      required _e2dc.Widget prototypeItem,
      required this.table,
      required this.hydroState})
      : super(key: key, delegate: delegate, prototypeItem: prototypeItem) {
  ...
  @_fac9.override
  _35be.RenderSliverMultiBoxAdaptor createRenderObject(context) {
  ...
  @_fac9.override
  _a8eb.SliverMultiBoxAdaptorElement createElement() {
    _36c2.Closure closure = table["createElement"];
    return _36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverMultiBoxAdaptorElement,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _fac9.double? estimateMaxScrollOffset(constraints, firstIndex, lastIndex,
...
void loadSliverPrototypeExtentList(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverPrototypeExtentList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverPrototypeExtentList(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          delegate: _36c2
              .maybeUnBoxAndBuildArgument<_a8eb.SliverChildDelegate, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
          ...
          prototypeItem:
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['prototypeItem'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_a896.SliverPrototypeExtentList>(boxer: (
      {required _a896.SliverPrototypeExtentList vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverPrototypeExtentList(

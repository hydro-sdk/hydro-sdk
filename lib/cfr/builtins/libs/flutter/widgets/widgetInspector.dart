...
class VMManagedWidgetInspector extends _36c2.VMManagedBox<_8c83.WidgetInspector> {VMManagedWidgetInspector({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c83.WidgetInspector vmObject;

 }

class RTManagedWidgetInspector extends _8c83.WidgetInspector implements _36c2.Box<_8c83.WidgetInspector> {RTManagedWidgetInspector({_ab4a.Key? key, required _e2dc.Widget child, _e2dc.Widget Function(_e2dc.BuildContext context, void Function() onPressed)? selectButtonBuilder, required this.table, required this.hydroState}) : super(key: key,child: child,selectButtonBuilder: selectButtonBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c83.WidgetInspector unwrap() => this;
_8c83.WidgetInspector get vmObject => this;
@_fac9.override _e2dc.State<_8c83.WidgetInspector> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_8c83.WidgetInspector>, _8c83.WidgetInspector>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadWidgetInspector({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'widgetInspector'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

_36c2.Closure? unpackedselectButtonBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'selectButtonBuilder'
] : null;
return  [RTManagedWidgetInspector(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), selectButtonBuilder: unpackedselectButtonBuilder != null ? (context, onPressed) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedselectButtonBuilder.dispatch([luaCallerArguments[0],context,onPressed],parentState:hydroState,)[0], parentState: hydroState) : null )]; } );
_36c2.registerBoxer<_8c83.WidgetInspector>(boxer: ({required _8c83.WidgetInspector vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWidgetInspector(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

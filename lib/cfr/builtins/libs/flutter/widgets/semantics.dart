...
class VMManagedSemantics extends _36c2.VMManagedBox<_3960.Semantics> {
  VMManagedSemantics(
    ...
    table['container'] = vmObject.container;
    table['explicitChildNodes'] = vmObject.explicitChildNodes;
    table['excludeSemantics'] = vmObject.excludeSemantics;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderSemanticsAnnotations>(
...
class RTManagedSemantics extends _3960.Semantics
    implements _36c2.Box<_3960.Semantics> {
  RTManagedSemantics(
    ...
    table['container'] = _36c2.maybeBoxObject(
        object: this.container,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['explicitChildNodes'] = _36c2.maybeBoxObject(
        object: this.explicitChildNodes,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['excludeSemantics'] = _36c2.maybeBoxObject(
        object: this.excludeSemantics,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderSemanticsAnnotations createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderSemanticsAnnotations,
            _fac9.dynamic>(
...
void loadSemantics(
  ...
  table['semantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedSemantics(
          ...
          onLongPress: unpackedonLongPress != null
              ...
              : null,
          onLongPressHint: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['onLongPressHint'] : null,
          ...
          onTap: unpackedonTap != null
              ...
              : null,
          onTapHint: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['onTapHint'] : null,
  ...
  _36c2.registerBoxer<_3960.Semantics>(boxer: (
      {required _3960.Semantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSemantics(

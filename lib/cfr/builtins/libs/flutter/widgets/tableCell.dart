...
class VMManagedTableCell extends _36c2.VMManagedBox<_0e67.TableCell> {
  VMManagedTableCell(
...
class RTManagedTableCell extends _0e67.TableCell
    implements _36c2.Box<_0e67.TableCell> {
  RTManagedTableCell(
      {_ab4a.Key? key,
      _31d2.TableCellVerticalAlignment? verticalAlignment,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(key: key, verticalAlignment: verticalAlignment, child: child) {
    ...
    table['verticalAlignment'] =
        _31d2.TableCellVerticalAlignment.values.indexWhere((x) {
      return x == this.verticalAlignment;
    });
  ...
  @_fac9.override
  _e2dc.ParentDataElement<_31d2.TableCellParentData> createElement() {
    _36c2.Closure closure = table["createElement"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.ParentDataElement<_31d2.TableCellParentData>,
            _31d2.TableCellParentData>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadTableCell(
  ...
  table['tableCell'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTableCell(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          verticalAlignment: _36c2.maybeUnBoxEnum(
              values: _31d2.TableCellVerticalAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['verticalAlignment']
                  : null),
  ...
  _36c2.registerBoxer<_0e67.TableCell>(boxer: (
      {required _0e67.TableCell vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTableCell(

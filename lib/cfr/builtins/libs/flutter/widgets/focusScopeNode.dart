...
class VMManagedFocusScopeNode extends _36c2.VMManagedBox<_b485.FocusScopeNode> {VMManagedFocusScopeNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getNearestScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b485.FocusScopeNode>(object: vmObject.nearestScope, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getIsFirstFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isFirstFocus,]; } );
table  [
'getFocusedChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.focusedChild;if(returnValue!= null){return [_36c2.maybeBoxObject<_b485.FocusNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setFirstFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.setFirstFocus(_36c2.maybeUnBoxAndBuildArgument<_b485.FocusScopeNode, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'autofocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.autofocus(_36c2.maybeUnBoxAndBuildArgument<_b485.FocusNode, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'unfocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.unfocus(disposition: _36c2.maybeUnBoxEnum(values: _b485.UnfocusDisposition.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'disposition'
] : null));
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.consumeKeyboardToken(),]; } );
table  [
'attach'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure? unpackedonKey=luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'onKey'
] : null;
_36c2.Closure? unpackedonKeyEvent=luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'onKeyEvent'
] : null;return [_36c2.maybeBoxObject<_b485.FocusAttachment>(object: vmObject.attach(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), onKey: unpackedonKey != null ? (node, event) => _36c2.maybeUnBoxEnum(values: _b485.KeyEventResult.values, boxedEnum: unpackedonKey.dispatch([luaCallerArguments[0],node,event],parentState:hydroState,)[0]) : null , onKeyEvent: unpackedonKeyEvent != null ? (node, event) => _36c2.maybeUnBoxEnum(values: _b485.KeyEventResult.values, boxedEnum: unpackedonKeyEvent.dispatch([luaCallerArguments[0],node,event],parentState:hydroState,)[0]) : null ), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'dispose'
...
table  [
'requestFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.requestFocus(_36c2.maybeUnBoxAndBuildArgument<_b485.FocusNode?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'nextFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.nextFocus(),]; } );
table  [
'previousFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.previousFocus(),]; } );
table  [
'focusInDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.focusInDirection(_36c2.maybeUnBoxEnum(values: _65d3.TraversalDirection.values, boxedEnum: luaCallerArguments  [
1
])),]; } );
table  [
...
table  [
'setSkipTraversal'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.skipTraversal=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'setCanRequestFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.canRequestFocus=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'setDescendantsAreFocusable'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.descendantsAreFocusable=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'getParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.parent;if(returnValue!= null){return [_36c2.maybeBoxObject<_b485.FocusNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Iterable>(object: vmObject.children, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getTraversalChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Iterable>(object: vmObject.traversalChildren, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getDebugLabel'
...
table  [
'setDebugLabel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.debugLabel=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getDescendants'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Iterable>(object: vmObject.descendants, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getTraversalDescendants'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Iterable>(object: vmObject.traversalDescendants, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getAncestors'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Iterable>(object: vmObject.ancestors, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getHasFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasFocus,]; } );
table  [
'getHasPrimaryFocus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasPrimaryFocus,]; } );
table  [
'getHighlightMode'
...
table  [
'getEnclosingScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.enclosingScope;if(returnValue!= null){return [_36c2.maybeBoxObject<_b485.FocusScopeNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getSize'
...
class RTManagedFocusScopeNode extends _b485.FocusScopeNode implements _36c2.Box<_b485.FocusScopeNode> {RTManagedFocusScopeNode({required _fac9.bool canRequestFocus, _fac9.String? debugLabel, _b485.KeyEventResult Function(_b485.FocusNode node, _94e8.RawKeyEvent event)? onKey, _b485.KeyEventResult Function(_b485.FocusNode node, _9e29.KeyEvent event)? onKeyEvent, required _fac9.bool skipTraversal, required this.table, required this.hydroState}) : super(canRequestFocus: canRequestFocus,debugLabel: debugLabel,onKey: onKey,onKeyEvent: onKeyEvent,skipTraversal: skipTraversal) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getNearestScope'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.nearestScope];
});
table['_dart_getIsFirstFocus'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.isFirstFocus];
});
table['_dart_getFocusedChild'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.focusedChild];
});
table['_dart_setFirstFocus'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.setFirstFocus(
...
table['_dart_consumeKeyboardToken'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
table['_dart_attach'] =
  ...
  _36c2.Closure? unpackedonKey =
      luaCallerArguments.length >= 3 ? luaCallerArguments[2]['onKey'] : null;
...
table['_dart_setCanRequestFocus'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_setDescendantsAreFocusable'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getTraversalChildren'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getDescendants'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.descendants];
});
table['_dart_getTraversalDescendants'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.traversalDescendants];
});
table['_dart_getAncestors'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getHasPrimaryFocus'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override _b485.FocusScopeNode get nearestScope { 
_36c2.Closure closure = table["getNearestScope"];
return _36c2.maybeUnBoxAndBuildArgument<_b485.FocusScopeNode, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool get isFirstFocus { 
_36c2.Closure closure = table["getIsFirstFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _b485.FocusNode? get focusedChild { 
...
@_fac9.override void setFirstFocus(scope) { 
_36c2.Closure closure = table["setFirstFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void autofocus(node) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void unfocus({_b485.UnfocusDisposition disposition = _b485.UnfocusDisposition.scope}) { 
_36c2.Closure closure = table["unfocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool consumeKeyboardToken() { 
_36c2.Closure closure = table["consumeKeyboardToken"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _b485.FocusAttachment attach(context, {_b485.KeyEventResult Function(_b485.FocusNode node, _94e8.RawKeyEvent event)? onKey, _b485.KeyEventResult Function(_b485.FocusNode node, _9e29.KeyEvent event)? onKeyEvent}) { super.attach(context, onKey: onKey, onKeyEvent: onKeyEvent);
_36c2.Closure closure = table["attach"];
return _36c2.maybeUnBoxAndBuildArgument<_b485.FocusAttachment, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void dispose() { super.dispose();
_36c2.Closure closure = table["dispose"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void requestFocus([_b485.FocusNode? node]) { 
_36c2.Closure closure = table["requestFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool nextFocus() { 
_36c2.Closure closure = table["nextFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool previousFocus() { 
_36c2.Closure closure = table["previousFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool focusInDirection(direction) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set skipTraversal(value) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set canRequestFocus(value) { super.canRequestFocus = value;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set descendantsAreFocusable(value) { super.descendantsAreFocusable = value;
...
@_fac9.override _b485.FocusNode? get parent { 
_36c2.Closure closure = table["getParent"];
return _36c2.maybeUnBoxAndBuildArgument<_b485.FocusNode?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.Iterable<_b485.FocusNode> get children { 
_36c2.Closure closure = table["getChildren"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_b485.FocusNode>, _b485.FocusNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.Iterable<_b485.FocusNode> get traversalChildren { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set debugLabel(value) { 
_36c2.Closure closure = table["setDebugLabel"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Iterable<_b485.FocusNode> get descendants { 
_36c2.Closure closure = table["getDescendants"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_b485.FocusNode>, _b485.FocusNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.Iterable<_b485.FocusNode> get traversalDescendants { 
_36c2.Closure closure = table["getTraversalDescendants"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_b485.FocusNode>, _b485.FocusNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.Iterable<_b485.FocusNode> get ancestors { 
_36c2.Closure closure = table["getAncestors"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_b485.FocusNode>, _b485.FocusNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool get hasFocus { 
_36c2.Closure closure = table["getHasFocus"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get hasPrimaryFocus { 
...
@_fac9.override _b485.FocusScopeNode? get enclosingScope { 
...
void loadFocusScopeNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusScopeNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFocusScopeNode(table: luaCallerArguments  [
0
], hydroState: hydroState, canRequestFocus: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'canRequestFocus'
...
'debugLabel'
] : null, onKey: unpackedonKey != null ? (node, event) => _36c2.maybeUnBoxEnum(values: _b485.KeyEventResult.values, boxedEnum: unpackedonKey.dispatch([luaCallerArguments[0],node,event],parentState:hydroState,)[0]) : null , onKeyEvent: unpackedonKeyEvent != null ? (node, event) => _36c2.maybeUnBoxEnum(values: _b485.KeyEventResult.values, boxedEnum: unpackedonKeyEvent.dispatch([luaCallerArguments[0],node,event],parentState:hydroState,)[0]) : null , skipTraversal: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'skipTraversal'
] : null)]; } );
_36c2.registerBoxer<_b485.FocusScopeNode>(boxer: ({required _b485.FocusScopeNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusScopeNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

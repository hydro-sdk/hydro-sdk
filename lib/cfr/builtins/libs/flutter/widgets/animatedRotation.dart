...
class VMManagedAnimatedRotation
    extends _36c2.VMManagedBox<_da7c.AnimatedRotation> {
  VMManagedAnimatedRotation(
...
class RTManagedAnimatedRotation extends _da7c.AnimatedRotation
    implements _36c2.Box<_da7c.AnimatedRotation> {
  RTManagedAnimatedRotation(
    ...
    table['turns'] = _36c2.maybeBoxObject(
        object: this.turns, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedRotation> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedRotation>,
            _da7c.AnimatedRotation>(
...
void loadAnimatedRotation(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedRotation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedAnimatedRotation(
          ...
          turns: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['turns'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_da7c.AnimatedRotation>(boxer: (
      {required _da7c.AnimatedRotation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedRotation(

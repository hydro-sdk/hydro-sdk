...
class VMManagedRenderSliverOverlapAbsorber
    extends _36c2.VMManagedBox<_c812.RenderSliverOverlapAbsorber> {
  VMManagedRenderSliverOverlapAbsorber(
...
class RTManagedRenderSliverOverlapAbsorber
    extends _c812.RenderSliverOverlapAbsorber
    implements _36c2.Box<_c812.RenderSliverOverlapAbsorber> {
  RTManagedRenderSliverOverlapAbsorber(
      {_021d.RenderSliver? sliver,
      required _c812.SliverOverlapAbsorberHandle handle,
      required this.table,
      required this.hydroState})
      : super(sliver: sliver, handle: handle) {
...
void loadRenderSliverOverlapAbsorber(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverOverlapAbsorber'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverOverlapAbsorber(
          ...
          sliver: _36c2
              .maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          handle: _36c2.maybeUnBoxAndBuildArgument<
                  _c812.SliverOverlapAbsorberHandle, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['handle']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_c812.RenderSliverOverlapAbsorber>(boxer: (
      {required _c812.RenderSliverOverlapAbsorber vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverOverlapAbsorber(

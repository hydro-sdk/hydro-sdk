...
class VMManagedRenderSliverOverlapAbsorber extends _36c2.VMManagedBox<_c812.RenderSliverOverlapAbsorber> {VMManagedRenderSliverOverlapAbsorber({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getHandle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_c812.SliverOverlapAbsorberHandle>(object: vmObject.handle, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setHandle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.handle=(_36c2.maybeUnBoxAndBuildArgument<_c812.SliverOverlapAbsorberHandle, _fac9.dynamic>(luaCallerArguments  [
1
...
final _c812.RenderSliverOverlapAbsorber vmObject;

 }

class RTManagedRenderSliverOverlapAbsorber extends _c812.RenderSliverOverlapAbsorber implements _36c2.Box<_c812.RenderSliverOverlapAbsorber> {RTManagedRenderSliverOverlapAbsorber({_021d.RenderSliver? sliver, required _c812.SliverOverlapAbsorberHandle handle, required this.table, required this.hydroState}) : super(sliver: sliver,handle: handle) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getHandle'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.handle];
});
table['_dart_setHandle'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
_c812.RenderSliverOverlapAbsorber unwrap() => this;
_c812.RenderSliverOverlapAbsorber get vmObject => this;
@_fac9.override _c812.SliverOverlapAbsorberHandle get handle { 
_36c2.Closure closure = table["getHandle"];
return _36c2.maybeUnBoxAndBuildArgument<_c812.SliverOverlapAbsorberHandle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set handle(value) { 
...
void loadRenderSliverOverlapAbsorber({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverOverlapAbsorber'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverOverlapAbsorber(table: luaCallerArguments  [
0
], hydroState: hydroState, sliver: _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sliver'
...
_36c2.registerBoxer<_c812.RenderSliverOverlapAbsorber>(boxer: ({required _c812.RenderSliverOverlapAbsorber vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverOverlapAbsorber(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

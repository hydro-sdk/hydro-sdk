...
import 'package:flutter/src/widgets/container.dart' as _7716;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedDecoratedBox extends _36c2.VMManagedBox<_7716.DecoratedBox> {VMManagedDecoratedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderDecoratedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderDecoratedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _7716.DecoratedBox vmObject;

 }

class RTManagedDecoratedBox extends _7716.DecoratedBox implements _36c2.Box<_7716.DecoratedBox> {RTManagedDecoratedBox({_e2dc.Widget? child, _ab4a.Key? key, required _bf98.DecorationPosition position, required _13a5.Decoration decoration, required this.table, required this.hydroState}) : super(child: child,key: key,position: position,decoration: decoration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderDecoratedBox, _fac9.dynamic>(
...
_7716.DecoratedBox unwrap() => this;
_7716.DecoratedBox get vmObject => this;
@_fac9.override _bf98.RenderDecoratedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderDecoratedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDecoratedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'decoratedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedDecoratedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7716.DecoratedBox>(boxer: ({required _7716.DecoratedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDecoratedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

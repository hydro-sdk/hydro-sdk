...
class VMManagedDecoratedBox extends _36c2.VMManagedBox<_7716.DecoratedBox> {
  VMManagedDecoratedBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderDecoratedBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderDecoratedBox,
...
class RTManagedDecoratedBox extends _7716.DecoratedBox
    implements _36c2.Box<_7716.DecoratedBox> {
  RTManagedDecoratedBox(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
  ...
  @_fac9.override
  _bf98.RenderDecoratedBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderDecoratedBox, _fac9.dynamic>(
...
void loadDecoratedBox(
  ...
  table['decoratedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDecoratedBox(
  ...
  _36c2.registerBoxer<_7716.DecoratedBox>(boxer: (
      {required _7716.DecoratedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDecoratedBox(

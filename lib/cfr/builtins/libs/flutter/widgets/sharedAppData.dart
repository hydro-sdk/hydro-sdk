...
import 'package:flutter/src/widgets/shared_app_data.dart' as _610a;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSharedAppData extends _36c2.VMManagedBox<_610a.SharedAppData> {VMManagedSharedAppData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _610a.SharedAppData vmObject;

 }

class RTManagedSharedAppData extends _610a.SharedAppData implements _36c2.Box<_610a.SharedAppData> {RTManagedSharedAppData({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_610a.SharedAppData unwrap() => this;
_610a.SharedAppData get vmObject => this;
...
void loadSharedAppData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sharedAppData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSharedAppData(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_610a.SharedAppData>(boxer: ({required _610a.SharedAppData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSharedAppData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

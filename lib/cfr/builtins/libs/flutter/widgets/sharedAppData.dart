...
class VMManagedSharedAppData extends _36c2.VMManagedBox<_610a.SharedAppData> {
  VMManagedSharedAppData(
...
class RTManagedSharedAppData extends _610a.SharedAppData
    implements _36c2.Box<_610a.SharedAppData> {
  RTManagedSharedAppData(
      {_ab4a.Key? key,
...
void loadSharedAppData(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sharedAppData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSharedAppData(
  ...
  _36c2.registerBoxer<_610a.SharedAppData>(boxer: (
      {required _610a.SharedAppData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSharedAppData(

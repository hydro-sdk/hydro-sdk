...
class VMManagedSafeArea extends _36c2.VMManagedBox<_a11a.SafeArea> {
  VMManagedSafeArea(
    ...
    table['maintainBottomViewPadding'] = vmObject.maintainBottomViewPadding;
...
class RTManagedSafeArea extends _a11a.SafeArea
    implements _36c2.Box<_a11a.SafeArea> {
  RTManagedSafeArea(
      {required _fac9.bool bottom,
      _ab4a.Key? key,
      required _fac9.bool left,
      required _fac9.bool maintainBottomViewPadding,
    ...
    table['minimum'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['maintainBottomViewPadding'] = _36c2.maybeBoxObject(
        object: this.maintainBottomViewPadding,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadSafeArea(
  ...
  table['safeArea'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSafeArea(
          ...
          left: luaCallerArguments.length >= 2
              ...
              : null,
          maintainBottomViewPadding: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['maintainBottomViewPadding']
              : null,
          minimum: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsets, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_a11a.SafeArea>(boxer: (
      {required _a11a.SafeArea vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSafeArea(

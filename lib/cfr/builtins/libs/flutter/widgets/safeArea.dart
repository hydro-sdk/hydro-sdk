...
class VMManagedSafeArea extends _36c2.VMManagedBox<_a11a.SafeArea> {VMManagedSafeArea({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = vmObject.maintainBottomViewPadding;
table  [
'child'
...
final _a11a.SafeArea vmObject;

 }

class RTManagedSafeArea extends _a11a.SafeArea implements _36c2.Box<_a11a.SafeArea> {RTManagedSafeArea({required _fac9.bool bottom, _ab4a.Key? key, required _fac9.bool left, required _fac9.bool maintainBottomViewPadding, required _96d1.EdgeInsets minimum, required _fac9.bool right, required _fac9.bool top, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(bottom: bottom,key: key,left: left,maintainBottomViewPadding: maintainBottomViewPadding,minimum: minimum,right: right,top: top,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'maintainBottomViewPadding'
] = _36c2.maybeBoxObject(object: this.maintainBottomViewPadding, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_a11a.SafeArea unwrap() => this;
_a11a.SafeArea get vmObject => this;
...
void loadSafeArea({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'safeArea'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSafeArea(table: luaCallerArguments  [
0
...
'left'
] : null, maintainBottomViewPadding: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainBottomViewPadding'
...
_36c2.registerBoxer<_a11a.SafeArea>(boxer: ({required _a11a.SafeArea vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSafeArea(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

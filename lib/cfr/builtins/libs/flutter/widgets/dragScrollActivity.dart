...
class VMManagedDragScrollActivity
    extends _36c2.VMManagedBox<_ca8b.DragScrollActivity> {
  VMManagedDragScrollActivity(
...
class RTManagedDragScrollActivity extends _ca8b.DragScrollActivity
    implements _36c2.Box<_ca8b.DragScrollActivity> {
  RTManagedDragScrollActivity(_ca8b.ScrollActivityDelegate delegate$,
      _ca8b.ScrollDragController controller,
...
void loadDragScrollActivity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dragScrollActivity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDragScrollActivity(
          _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivityDelegate,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollDragController,
              _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_ca8b.DragScrollActivity>(boxer: (
      {required _ca8b.DragScrollActivity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDragScrollActivity(

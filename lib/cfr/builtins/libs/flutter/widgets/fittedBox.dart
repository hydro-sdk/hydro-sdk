...
class VMManagedFittedBox extends _36c2.VMManagedBox<_3960.FittedBox> {VMManagedFittedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderFittedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFittedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.FittedBox vmObject;

 }

class RTManagedFittedBox extends _3960.FittedBox implements _36c2.Box<_3960.FittedBox> {RTManagedFittedBox({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, required _a643.Clip clipBehavior, required _fb77.BoxFit fit, _ab4a.Key? key, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,fit: fit,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFittedBox, _fac9.dynamic>(
...
_3960.FittedBox unwrap() => this;
_3960.FittedBox get vmObject => this;
@_fac9.override _bf98.RenderFittedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFittedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFittedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fittedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFittedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.FittedBox>(boxer: ({required _3960.FittedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFittedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

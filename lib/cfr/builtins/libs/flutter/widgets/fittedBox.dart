...
class VMManagedFittedBox extends _36c2.VMManagedBox<_3960.FittedBox> {
  VMManagedFittedBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderFittedBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFittedBox,
...
class RTManagedFittedBox extends _3960.FittedBox
    implements _36c2.Box<_3960.FittedBox> {
  RTManagedFittedBox(
  ...
  @_fac9.override
  _bf98.RenderFittedBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderFittedBox, _fac9.dynamic>(
...
void loadFittedBox(
  ...
  table['fittedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFittedBox(
          ...
          hydroState: hydroState,
          alignment: _36c2
              .maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['alignment'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_3960.FittedBox>(boxer: (
      {required _3960.FittedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFittedBox(

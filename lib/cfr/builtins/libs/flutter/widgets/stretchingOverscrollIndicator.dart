...
class VMManagedStretchingOverscrollIndicator extends _36c2.VMManagedBox<_a0c8.StretchingOverscrollIndicator> {VMManagedStretchingOverscrollIndicator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a0c8.StretchingOverscrollIndicator vmObject;

 }

class RTManagedStretchingOverscrollIndicator extends _a0c8.StretchingOverscrollIndicator implements _36c2.Box<_a0c8.StretchingOverscrollIndicator> {RTManagedStretchingOverscrollIndicator({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.bool Function(_593c.ScrollNotification notification) notificationPredicate, required _487f.AxisDirection axisDirection, required this.table, required this.hydroState}) : super(child: child,key: key,notificationPredicate: notificationPredicate,axisDirection: axisDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a0c8.StretchingOverscrollIndicator unwrap() => this;
_a0c8.StretchingOverscrollIndicator get vmObject => this;
...
@_fac9.override _e2dc.State<_a0c8.StretchingOverscrollIndicator> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_a0c8.StretchingOverscrollIndicator>, _a0c8.StretchingOverscrollIndicator>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadStretchingOverscrollIndicator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedStretchingOverscrollIndicator(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), notificationPredicate: (notification) => unpackednotificationPredicate.dispatch([luaCallerArguments[0],notification],parentState:hydroState,)[0], axisDirection: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'axisDirection'
] : null))]; } );
_36c2.registerBoxer<_a0c8.StretchingOverscrollIndicator>(boxer: ({required _a0c8.StretchingOverscrollIndicator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStretchingOverscrollIndicator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

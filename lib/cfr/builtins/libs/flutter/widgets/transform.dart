...
class VMManagedTransform extends _36c2.VMManagedBox<_3960.Transform> {VMManagedTransform({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'origin'
] = _36c2.maybeBoxObject<_a643.Offset?>(object: vmObject.origin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'alignment'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderTransform>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderTransform, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Transform vmObject;

 }

class RTManagedTransform extends _3960.Transform implements _36c2.Box<_3960.Transform> {RTManagedTransform({_ca85.AlignmentGeometry? alignment, _e2dc.Widget? child, _a643.FilterQuality? filterQuality, _ab4a.Key? key, _a643.Offset? origin, required _fac9.bool transformHitTests, required _db98.Matrix4 transform, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,filterQuality: filterQuality,key: key,origin: origin,transformHitTests: transformHitTests,transform: transform) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'origin'
] = _36c2.maybeBoxObject(object: this.origin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'alignment'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderTransform, _fac9.dynamic>(
...
_3960.Transform unwrap() => this;
_3960.Transform get vmObject => this;
@_fac9.override _bf98.RenderTransform createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderTransform, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadTransform({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'transform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedTransform(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), origin: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'origin'
] : null, parentState: hydroState), transformHitTests: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transformHitTests'
...
_36c2.registerBoxer<_3960.Transform>(boxer: ({required _3960.Transform vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTransform(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

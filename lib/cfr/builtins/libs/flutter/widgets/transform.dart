...
class VMManagedTransform extends _36c2.VMManagedBox<_3960.Transform> {
  VMManagedTransform(
    ...
    table['origin'] = _36c2.maybeBoxObject<_a643.Offset?>(
        object: vmObject.origin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderTransform>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderTransform,
...
class RTManagedTransform extends _3960.Transform
    implements _36c2.Box<_3960.Transform> {
  RTManagedTransform(
    ...
    table['transform'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['origin'] = _36c2.maybeBoxObject(
        object: this.origin, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderTransform createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderTransform, _fac9.dynamic>(
...
void loadTransform(
    ...
    return [
      RTManagedTransform(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          origin: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['origin'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_3960.Transform>(boxer: (
      {required _3960.Transform vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTransform(

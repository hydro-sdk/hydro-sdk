...
import 'package:flutter/src/widgets/dual_transition_builder.dart' as _6d8b;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedDualTransitionBuilder extends _36c2.VMManagedBox<_6d8b.DualTransitionBuilder> {VMManagedDualTransitionBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'animation'
] = _36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.animation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _6d8b.DualTransitionBuilder vmObject;

 }

class RTManagedDualTransitionBuilder extends _6d8b.DualTransitionBuilder implements _36c2.Box<_6d8b.DualTransitionBuilder> {RTManagedDualTransitionBuilder({_e2dc.Widget? child, _ab4a.Key? key, required _86ca.Animation<_fac9.double> animation, required _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _e2dc.Widget? child) forwardBuilder, required _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _e2dc.Widget? child) reverseBuilder, required this.table, required this.hydroState}) : super(child: child,key: key,animation: animation,forwardBuilder: forwardBuilder,reverseBuilder: reverseBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'animation'
] = _36c2.maybeBoxObject(object: this.animation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_6d8b.DualTransitionBuilder unwrap() => this;
_6d8b.DualTransitionBuilder get vmObject => this;
@_fac9.override _e2dc.State<_6d8b.DualTransitionBuilder> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_6d8b.DualTransitionBuilder>, _6d8b.DualTransitionBuilder>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDualTransitionBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'dualTransitionBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


_36c2.Closure unpackedforwardBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'forwardBuilder'
] : null;
_36c2.Closure unpackedreverseBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverseBuilder'
] : null;
return  [RTManagedDualTransitionBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), animation: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animation'
] : null, parentState: hydroState), forwardBuilder: (context, animation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedforwardBuilder.dispatch([luaCallerArguments[0],context,animation,child],parentState:hydroState,)[0], parentState: hydroState), reverseBuilder: (context, animation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedreverseBuilder.dispatch([luaCallerArguments[0],context,animation,child],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_6d8b.DualTransitionBuilder>(boxer: ({required _6d8b.DualTransitionBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDualTransitionBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

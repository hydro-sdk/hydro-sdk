...
class VMManagedColoredBox extends _36c2.VMManagedBox<_3960.ColoredBox> {
  VMManagedColoredBox(
...
class RTManagedColoredBox extends _3960.ColoredBox
    implements _36c2.Box<_3960.ColoredBox> {
  RTManagedColoredBox(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(child: child, key: key, color: color) {
...
void loadColoredBox(
  ...
  table['coloredBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColoredBox(
  ...
  _36c2.registerBoxer<_3960.ColoredBox>(boxer: (
      {required _3960.ColoredBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColoredBox(

...
class VMManagedColoredBox extends _36c2.VMManagedBox<_3960.ColoredBox> {VMManagedColoredBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.ColoredBox vmObject;

 }

class RTManagedColoredBox extends _3960.ColoredBox implements _36c2.Box<_3960.ColoredBox> {RTManagedColoredBox({_e2dc.Widget? child, _ab4a.Key? key, required _a643.Color color, required this.table, required this.hydroState}) : super(child: child,key: key,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.ColoredBox unwrap() => this;
_3960.ColoredBox get vmObject => this;
...
void loadColoredBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'coloredBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedColoredBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.ColoredBox>(boxer: ({required _3960.ColoredBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedColoredBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

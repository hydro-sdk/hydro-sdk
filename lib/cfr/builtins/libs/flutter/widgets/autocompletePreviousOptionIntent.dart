...
class VMManagedAutocompletePreviousOptionIntent extends _36c2.VMManagedBox<_2a05.AutocompletePreviousOptionIntent> {VMManagedAutocompletePreviousOptionIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2a05.AutocompletePreviousOptionIntent vmObject;

 }

class RTManagedAutocompletePreviousOptionIntent extends _2a05.AutocompletePreviousOptionIntent implements _36c2.Box<_2a05.AutocompletePreviousOptionIntent> {RTManagedAutocompletePreviousOptionIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2a05.AutocompletePreviousOptionIntent unwrap() => this;
_2a05.AutocompletePreviousOptionIntent get vmObject => this;
...
void loadAutocompletePreviousOptionIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'autocompletePreviousOptionIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAutocompletePreviousOptionIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_2a05.AutocompletePreviousOptionIntent>(boxer: ({required _2a05.AutocompletePreviousOptionIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutocompletePreviousOptionIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

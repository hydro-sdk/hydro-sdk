...
class VMManagedFocusNode extends _36c2.VMManagedBox<_b485.FocusNode> {
  VMManagedFocusNode(
    ...
    table['getNearestScope'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.nearestScope;
      if (returnValue != null) {
        return [
...
void loadFocusNode(
  ...
  table['focusNode'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_b485.FocusNode>(boxer: (
      {required _b485.FocusNode vmObject,

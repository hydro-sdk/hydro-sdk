...
class VMManagedFocusNode extends _36c2.VMManagedBox<_b485.FocusNode> {VMManagedFocusNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getNearestScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.nearestScope;if(returnValue!= null){return [_36c2.maybeBoxObject<_b485.FocusScopeNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getEnclosingScope'
...
final _b485.FocusNode vmObject;

 }

class RTManagedFocusNode extends _b485.FocusNode implements _36c2.Box<_b485.FocusNode> {RTManagedFocusNode({required _fac9.bool canRequestFocus, _fac9.String? debugLabel, required _fac9.bool descendantsAreFocusable, _b485.KeyEventResult Function(_b485.FocusNode node, _94e8.RawKeyEvent event)? onKey, _b485.KeyEventResult Function(_b485.FocusNode node, _9e29.KeyEvent event)? onKeyEvent, required _fac9.bool skipTraversal, required this.table, required this.hydroState}) : super(canRequestFocus: canRequestFocus,debugLabel: debugLabel,descendantsAreFocusable: descendantsAreFocusable,onKey: onKey,onKeyEvent: onKeyEvent,skipTraversal: skipTraversal) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadFocusNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFocusNode(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_b485.FocusNode>(boxer: ({required _b485.FocusNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

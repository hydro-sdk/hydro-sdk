...
class VMManagedPadding extends _36c2.VMManagedBox<_3960.Padding> {
  VMManagedPadding(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_a9e4.RenderPadding>(
...
class RTManagedPadding extends _3960.Padding
    implements _36c2.Box<_3960.Padding> {
  RTManagedPadding(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(child: child, key: key, padding: padding) {
  ...
  @_fac9.override
  _a9e4.RenderPadding createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPadding, _fac9.dynamic>(
...
void loadPadding(
  ...
  table['padding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPadding(
  ...
  _36c2.registerBoxer<_3960.Padding>(boxer: (
      {required _3960.Padding vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPadding(

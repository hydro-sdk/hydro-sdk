...
class VMManagedPadding extends _36c2.VMManagedBox<_3960.Padding> {VMManagedPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderPadding>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPadding, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Padding vmObject;

 }

class RTManagedPadding extends _3960.Padding implements _36c2.Box<_3960.Padding> {RTManagedPadding({_e2dc.Widget? child, _ab4a.Key? key, required _96d1.EdgeInsetsGeometry padding, required this.table, required this.hydroState}) : super(child: child,key: key,padding: padding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPadding, _fac9.dynamic>(
...
_3960.Padding unwrap() => this;
_3960.Padding get vmObject => this;
@_fac9.override _a9e4.RenderPadding createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPadding, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'padding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPadding(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Padding>(boxer: ({required _3960.Padding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverIgnorePointer extends _36c2.VMManagedBox<_a8eb.SliverIgnorePointer> {VMManagedSliverIgnorePointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_26cc.RenderSliverIgnorePointer>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverIgnorePointer, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a8eb.SliverIgnorePointer vmObject;

 }

class RTManagedSliverIgnorePointer extends _a8eb.SliverIgnorePointer implements _36c2.Box<_a8eb.SliverIgnorePointer> {RTManagedSliverIgnorePointer({required _fac9.bool ignoring, _fac9.bool? ignoringSemantics, _ab4a.Key? key, _e2dc.Widget? sliver, required this.table, required this.hydroState}) : super(ignoring: ignoring,ignoringSemantics: ignoringSemantics,key: key,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'ignoring'
] = _36c2.maybeBoxObject(object: this.ignoring, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'ignoringSemantics'
] = _36c2.maybeBoxObject(object: this.ignoringSemantics, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverIgnorePointer,
...
_a8eb.SliverIgnorePointer unwrap() => this;
_a8eb.SliverIgnorePointer get vmObject => this;
@_fac9.override _26cc.RenderSliverIgnorePointer createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverIgnorePointer, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverIgnorePointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverIgnorePointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSliverIgnorePointer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a8eb.SliverIgnorePointer>(boxer: ({required _a8eb.SliverIgnorePointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverIgnorePointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

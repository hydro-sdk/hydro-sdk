...
class VMManagedSliverIgnorePointer
    extends _36c2.VMManagedBox<_a8eb.SliverIgnorePointer> {
  VMManagedSliverIgnorePointer(
    ...
    table['ignoring'] = vmObject.ignoring;
    table['ignoringSemantics'] = vmObject.ignoringSemantics;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_26cc.RenderSliverIgnorePointer>(
...
class RTManagedSliverIgnorePointer extends _a8eb.SliverIgnorePointer
    implements _36c2.Box<_a8eb.SliverIgnorePointer> {
  RTManagedSliverIgnorePointer(
    ...
    table['ignoring'] = _36c2.maybeBoxObject(
        object: this.ignoring,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['ignoringSemantics'] = _36c2.maybeBoxObject(
        object: this.ignoringSemantics,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _26cc.RenderSliverIgnorePointer createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverIgnorePointer,
            _fac9.dynamic>(
...
void loadSliverIgnorePointer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverIgnorePointer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverIgnorePointer(
  ...
  _36c2.registerBoxer<_a8eb.SliverIgnorePointer>(boxer: (
      {required _a8eb.SliverIgnorePointer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverIgnorePointer(

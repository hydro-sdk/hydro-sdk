...
class VMManagedCharacterActivator
    extends _36c2.VMManagedBox<_1710.CharacterActivator> {
  VMManagedCharacterActivator(
    ...
    table['getTriggers'] = _36c2.makeLuaDartFunc(
      ...
      final returnValue = vmObject.triggers;
      if (returnValue != null) {
        return [
...
class RTManagedCharacterActivator extends _1710.CharacterActivator
    implements _36c2.Box<_1710.CharacterActivator> {
  RTManagedCharacterActivator(_fac9.String character$,
  ...
  _fac9.Iterable<_e468.LogicalKeyboardKey>? get triggers {
    ...
    return _36c2.maybeUnBoxAndBuildArgument<
            _fac9.Iterable<_e468.LogicalKeyboardKey>?,
...
void loadCharacterActivator(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['characterActivator'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCharacterActivator(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_1710.CharacterActivator>(boxer: (
      {required _1710.CharacterActivator vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCharacterActivator(

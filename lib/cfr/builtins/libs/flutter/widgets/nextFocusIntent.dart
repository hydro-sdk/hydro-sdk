...
class VMManagedNextFocusIntent extends _36c2.VMManagedBox<_65d3.NextFocusIntent> {VMManagedNextFocusIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _65d3.NextFocusIntent vmObject;

 }

class RTManagedNextFocusIntent extends _65d3.NextFocusIntent implements _36c2.Box<_65d3.NextFocusIntent> {RTManagedNextFocusIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_65d3.NextFocusIntent unwrap() => this;
_65d3.NextFocusIntent get vmObject => this;
...
void loadNextFocusIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'nextFocusIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedNextFocusIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_65d3.NextFocusIntent>(boxer: ({required _65d3.NextFocusIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedNextFocusIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

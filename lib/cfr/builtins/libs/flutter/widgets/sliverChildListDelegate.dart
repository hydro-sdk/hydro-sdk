...
class VMManagedSliverChildListDelegate extends _36c2.VMManagedBox<_a8eb.SliverChildListDelegate> {VMManagedSliverChildListDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRebuild(_36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverChildListDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedSliverChildListDelegate extends _a8eb.SliverChildListDelegate implements _36c2.Box<_a8eb.SliverChildListDelegate> {RTManagedSliverChildListDelegate(_fac9.List<_e2dc.Widget> children$, {required _fac9.bool addAutomaticKeepAlives, required _fac9.bool addRepaintBoundaries, required _fac9.bool addSemanticIndexes, required _fac9.int? Function(_e2dc.Widget widget, _fac9.int localIndex) semanticIndexCallback, required _fac9.int semanticIndexOffset, required this.table, required this.hydroState}) : super(children$,addAutomaticKeepAlives: addAutomaticKeepAlives,addRepaintBoundaries: addRepaintBoundaries,addSemanticIndexes: addSemanticIndexes,semanticIndexCallback: semanticIndexCallback,semanticIndexOffset: semanticIndexOffset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadSliverChildListDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedSliverChildListDelegate(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments  [
1
...
'addSemanticIndexes'
] : null, semanticIndexCallback: (widget, localIndex) => ((final _fac9.List<_fac9.dynamic>? val,) => val != null && val.length >= 1 ?val[0] : null)(unpackedsemanticIndexCallback.dispatch([luaCallerArguments[0],widget,localIndex],parentState:hydroState,),), semanticIndexOffset: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'semanticIndexOffset'
] : null)]; } );
_36c2.registerBoxer<_a8eb.SliverChildListDelegate>(boxer: ({required _a8eb.SliverChildListDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverChildListDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

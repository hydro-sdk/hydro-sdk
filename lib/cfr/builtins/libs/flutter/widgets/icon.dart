...
class VMManagedIcon extends _36c2.VMManagedBox<_3567.Icon> {
  VMManagedIcon(
    ...
    table['icon'] = _36c2.maybeBoxObject<_003a.IconData?>(
...
class RTManagedIcon extends _3567.Icon implements _36c2.Box<_3567.Icon> {
  RTManagedIcon(_003a.IconData? icon$,
      {_a643.Color? color,
      _ab4a.Key? key,
...
void loadIcon(
  ...
  table['icon'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIcon(_36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          ...
          color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 3
                  ...
                  : null,
              parentState: hydroState),
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments[2]['key'] : null,
              parentState: hydroState),
          semanticLabel: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['semanticLabel']
              : null,
          size: luaCallerArguments.length >= 3
  ...
  _36c2.registerBoxer<_3567.Icon>(boxer: (
      {required _3567.Icon vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIcon(

...
class VMManagedIcon extends _36c2.VMManagedBox<_3567.Icon> {VMManagedIcon({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'icon'
] = _36c2.maybeBoxObject<_003a.IconData?>(object: vmObject.icon, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'size'
] = vmObject.size;
table  [
...
final _3567.Icon vmObject;

 }

class RTManagedIcon extends _3567.Icon implements _36c2.Box<_3567.Icon> {RTManagedIcon(_003a.IconData? icon$, {_a643.Color? color, _ab4a.Key? key, _fac9.String? semanticLabel, _fac9.double? size, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(icon$,color: color,key: key,semanticLabel: semanticLabel,size: size,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3567.Icon unwrap() => this;
_3567.Icon get vmObject => this;
...
void loadIcon({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'icon'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedIcon(_36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'color'
] : null, parentState: hydroState), key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'key'
] : null, parentState: hydroState), semanticLabel: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'semanticLabel'
] : null, size: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'size'
] : null?.toDouble(), textDirection: _36c2.maybeUnBoxEnum(values: _a643.TextDirection.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'textDirection'
] : null))]; } );
_36c2.registerBoxer<_3567.Icon>(boxer: ({required _3567.Icon vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIcon(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

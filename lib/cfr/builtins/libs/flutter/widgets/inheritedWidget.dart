...
class VMManagedInheritedWidget extends _36c2.VMManagedBox<_e2dc.InheritedWidget> {VMManagedInheritedWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.InheritedWidget vmObject;

 }

class RTManagedInheritedWidget extends _e2dc.InheritedWidget implements _36c2.Box<_e2dc.InheritedWidget> {RTManagedInheritedWidget({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.InheritedWidget unwrap() => this;
_e2dc.InheritedWidget get vmObject => this;
...
void loadInheritedWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedInheritedWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.InheritedWidget>(boxer: ({required _e2dc.InheritedWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedInheritedWidget
    extends _36c2.VMManagedBox<_e2dc.InheritedWidget> {
...
class RTManagedInheritedWidget extends _e2dc.InheritedWidget
    implements _36c2.Box<_e2dc.InheritedWidget> {
...
void loadInheritedWidget(
  ...
  table['inheritedWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedInheritedWidget(
  ...
  _36c2.registerBoxer<_e2dc.InheritedWidget>(boxer: (
      {required _e2dc.InheritedWidget vmObject,

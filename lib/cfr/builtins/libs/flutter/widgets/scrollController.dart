...
class VMManagedScrollController extends _36c2.VMManagedBox<_9585.ScrollController> {VMManagedScrollController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedScrollController extends _9585.ScrollController implements _36c2.Box<_9585.ScrollController> {RTManagedScrollController({_fac9.String? debugLabel, required _fac9.double initialScrollOffset, required _fac9.bool keepScrollOffset, required this.table, required this.hydroState}) : super(debugLabel: debugLabel,initialScrollOffset: initialScrollOffset,keepScrollOffset: keepScrollOffset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadScrollController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedScrollController(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_9585.ScrollController>(boxer: ({required _9585.ScrollController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

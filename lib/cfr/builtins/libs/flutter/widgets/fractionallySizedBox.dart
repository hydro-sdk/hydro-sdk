...
class VMManagedFractionallySizedBox extends _36c2.VMManagedBox<_3960.FractionallySizedBox> {VMManagedFractionallySizedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderFractionallySizedOverflowBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderFractionallySizedOverflowBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.FractionallySizedBox vmObject;

 }

class RTManagedFractionallySizedBox extends _3960.FractionallySizedBox implements _36c2.Box<_3960.FractionallySizedBox> {RTManagedFractionallySizedBox({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, _fac9.double? heightFactor, _ab4a.Key? key, _fac9.double? widthFactor, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,heightFactor: heightFactor,key: key,widthFactor: widthFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderFractionallySizedOverflowBox,
...
_3960.FractionallySizedBox unwrap() => this;
_3960.FractionallySizedBox get vmObject => this;
@_fac9.override _a9e4.RenderFractionallySizedOverflowBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderFractionallySizedOverflowBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFractionallySizedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedFractionallySizedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.FractionallySizedBox>(boxer: ({required _3960.FractionallySizedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFractionallySizedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

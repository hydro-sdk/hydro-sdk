...
class VMManagedMoveSelectionToEndTextIntent extends _36c2.VMManagedBox<_380d.MoveSelectionToEndTextIntent> {VMManagedMoveSelectionToEndTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedMoveSelectionToEndTextIntent extends _380d.MoveSelectionToEndTextIntent implements _36c2.Box<_380d.MoveSelectionToEndTextIntent> {RTManagedMoveSelectionToEndTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadMoveSelectionToEndTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'moveSelectionToEndTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMoveSelectionToEndTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.MoveSelectionToEndTextIntent>(boxer: ({required _380d.MoveSelectionToEndTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMoveSelectionToEndTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverToBoxAdapter
    extends _36c2.VMManagedBox<_3960.SliverToBoxAdapter> {
  VMManagedSliverToBoxAdapter(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_021d.RenderSliverToBoxAdapter>(
...
class RTManagedSliverToBoxAdapter extends _3960.SliverToBoxAdapter
    implements _36c2.Box<_3960.SliverToBoxAdapter> {
  RTManagedSliverToBoxAdapter(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
  ...
  @_fac9.override
  _021d.RenderSliverToBoxAdapter createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliverToBoxAdapter,
            _fac9.dynamic>(
...
void loadSliverToBoxAdapter(
  ...
  table['sliverToBoxAdapter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverToBoxAdapter(
  ...
  _36c2.registerBoxer<_3960.SliverToBoxAdapter>(boxer: (
      {required _3960.SliverToBoxAdapter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverToBoxAdapter(

...
class VMManagedSliverToBoxAdapter extends _36c2.VMManagedBox<_3960.SliverToBoxAdapter> {VMManagedSliverToBoxAdapter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_021d.RenderSliverToBoxAdapter>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.SliverToBoxAdapter vmObject;

 }

class RTManagedSliverToBoxAdapter extends _3960.SliverToBoxAdapter implements _36c2.Box<_3960.SliverToBoxAdapter> {RTManagedSliverToBoxAdapter({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.SliverToBoxAdapter unwrap() => this;
_3960.SliverToBoxAdapter get vmObject => this;
@_fac9.override _021d.RenderSliverToBoxAdapter createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliverToBoxAdapter, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverToBoxAdapter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverToBoxAdapter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSliverToBoxAdapter(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.SliverToBoxAdapter>(boxer: ({required _3960.SliverToBoxAdapter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverToBoxAdapter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

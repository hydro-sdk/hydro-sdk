...
class VMManagedCustomScrollView
    extends _36c2.VMManagedBox<_2b56.CustomScrollView> {
  VMManagedCustomScrollView(
    ...
    table['slivers'] = _36c2.maybeBoxObject<_fac9.List<_e2dc.Widget>>(
        object: vmObject.slivers,
        hydroState: hydroState,
...
class RTManagedCustomScrollView extends _2b56.CustomScrollView
    implements _36c2.Box<_2b56.CustomScrollView> {
  RTManagedCustomScrollView(
      ...
      required _fac9.List<_e2dc.Widget> slivers,
      required this.table,
    ...
    table['slivers'] = _36c2.maybeBoxObject(
        object: this.slivers,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['scrollDirection'] = _487f.Axis.values.indexWhere((x) {
...
void loadCustomScrollView(
  ...
  table['customScrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCustomScrollView(
          ...
          cacheExtent: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          center: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['center'] : null,
              parentState: hydroState),
          ...
          keyboardDismissBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['keyboardDismissBehavior'] : null),
          ...
          slivers: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['slivers'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_2b56.CustomScrollView>(boxer: (
      {required _2b56.CustomScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCustomScrollView(

...
class VMManagedTextSelectionControls
    extends _36c2.VMManagedBox<_578c.TextSelectionControls> {
  VMManagedTextSelectionControls(
...
class RTManagedTextSelectionControls extends _578c.TextSelectionControls
    implements _36c2.Box<_578c.TextSelectionControls> {
  RTManagedTextSelectionControls(
...
void loadTextSelectionControls(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['textSelectionControls'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTextSelectionControls(
  ...
  _36c2.registerBoxer<_578c.TextSelectionControls>(boxer: (
      {required _578c.TextSelectionControls vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTextSelectionControls(

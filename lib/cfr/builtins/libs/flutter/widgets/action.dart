...
class VMManagedAction extends _36c2.VMManagedBox<_c0f4.Action<_c0f4.Intent>> {VMManagedAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAction extends _c0f4.Action implements _36c2.Box<_c0f4.Action> {RTManagedAction({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'action'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAction(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'actionOverridable'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_c0f4.Action>(object: _c0f4.Action.overridable(context: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'context'
] : null, parentState: hydroState), defaultAction: _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'defaultAction'
] : null, parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_c0f4.Action>(boxer: ({required _c0f4.Action vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

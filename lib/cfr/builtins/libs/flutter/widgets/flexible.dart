...
class VMManagedFlexible extends _36c2.VMManagedBox<_3960.Flexible> {VMManagedFlexible({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.Flexible vmObject;

 }

class RTManagedFlexible extends _3960.Flexible implements _36c2.Box<_3960.Flexible> {RTManagedFlexible({required _7374.FlexFit fit, required _fac9.int flex, _ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(fit: fit,flex: flex,key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'flex'
] = _36c2.maybeBoxObject(object: this.flex, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fit'
] = _7374.FlexFit.values.indexWhere((x) { return x == this.fit; } );
table  [
'child'
...
_3960.Flexible unwrap() => this;
_3960.Flexible get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.ParentDataElement<_7374.FlexParentData> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataElement<_7374.FlexParentData>, _7374.FlexParentData>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFlexible({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flexible'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFlexible(table: luaCallerArguments  [
0
], hydroState: hydroState, fit: _36c2.maybeUnBoxEnum(values: _7374.FlexFit.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fit'
] : null), flex: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'flex'
...
_36c2.registerBoxer<_3960.Flexible>(boxer: ({required _3960.Flexible vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlexible(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedIconThemeData extends _36c2.VMManagedBox<_05d1.IconThemeData> {VMManagedIconThemeData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_05d1.IconThemeData>(object: vmObject.copyWith(color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'color'
...
class RTManagedIconThemeData extends _05d1.IconThemeData implements _36c2.Box<_05d1.IconThemeData> {RTManagedIconThemeData({_a643.Color? color, _fac9.double? opacity, _fac9.double? size, required this.table, required this.hydroState}) : super(color: color,opacity: opacity,size: size) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _05d1.IconThemeData copyWith({_a643.Color? color, _fac9.double? opacity, _fac9.double? size}) { 
...
void loadIconThemeData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'iconThemeData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedIconThemeData(table: luaCallerArguments  [
0
...
return [_36c2.maybeBoxObject<_05d1.IconThemeData>(object: _05d1.IconThemeData.lerp(_36c2.maybeUnBoxAndBuildArgument<_05d1.IconThemeData?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_05d1.IconThemeData?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_05d1.IconThemeData>(boxer: ({required _05d1.IconThemeData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIconThemeData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAnimatedPhysicalModel extends _36c2.VMManagedBox<_da7c.AnimatedPhysicalModel> {VMManagedAnimatedPhysicalModel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'animateColor'
] = vmObject.animateColor;
table  [
'shadowColor'
] = _36c2.maybeBoxObject<_a643.Color>(object: vmObject.shadowColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'animateShadowColor'
] = vmObject.animateShadowColor;
table  [
'curve'
...
final _da7c.AnimatedPhysicalModel vmObject;

 }

class RTManagedAnimatedPhysicalModel extends _da7c.AnimatedPhysicalModel implements _36c2.Box<_da7c.AnimatedPhysicalModel> {RTManagedAnimatedPhysicalModel({required _fac9.bool animateColor, required _fac9.bool animateShadowColor, required _9d8a.BorderRadius borderRadius, required _a643.Clip clipBehavior, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _e2dc.Widget child, required _a643.Color color, required _fac9.Duration duration, required _fac9.double elevation, required _a643.Color shadowColor, required _250a.BoxShape shape, required this.table, required this.hydroState}) : super(animateColor: animateColor,animateShadowColor: animateShadowColor,borderRadius: borderRadius,clipBehavior: clipBehavior,curve: curve,key: key,onEnd: onEnd,child: child,color: color,duration: duration,elevation: elevation,shadowColor: shadowColor,shape: shape) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'animateColor'
] = _36c2.maybeBoxObject(object: this.animateColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shadowColor'
] = _36c2.maybeBoxObject(object: this.shadowColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'animateShadowColor'
] = _36c2.maybeBoxObject(object: this.animateShadowColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'curve'
...
_da7c.AnimatedPhysicalModel unwrap() => this;
_da7c.AnimatedPhysicalModel get vmObject => this;
@_fac9.override _da7c.AnimatedWidgetBaseState<_da7c.AnimatedPhysicalModel> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.AnimatedWidgetBaseState<_da7c.AnimatedPhysicalModel>, _da7c.AnimatedPhysicalModel>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedPhysicalModel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedAnimatedPhysicalModel(table: luaCallerArguments  [
0
], hydroState: hydroState, animateColor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animateColor'
] : null, animateShadowColor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animateShadowColor'
] : null, borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderRadius'
...
'key'
] : null, parentState: hydroState), onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
...
_36c2.registerBoxer<_da7c.AnimatedPhysicalModel>(boxer: ({required _da7c.AnimatedPhysicalModel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedPhysicalModel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

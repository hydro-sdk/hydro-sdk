...
class VMManagedPageRouteBuilder extends _36c2.VMManagedBox<_18d3.PageRouteBuilder<_fac9.dynamic>> {VMManagedPageRouteBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'transitionDuration'
] = _36c2.maybeBoxObject<_fac9.Duration>(object: vmObject.transitionDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'reverseTransitionDuration'
] = _36c2.maybeBoxObject<_fac9.Duration>(object: vmObject.reverseTransitionDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'opaque'
] = vmObject.opaque;
table  [
...
table  [
'barrierColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.barrierColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'barrierLabel'
] = vmObject.barrierLabel;
table  [
'maintainState'
] = vmObject.maintainState;
table  [
'fullscreenDialog'
] = vmObject.fullscreenDialog;
table  [
'filter'
] = _36c2.maybeBoxObject<_a643.ImageFilter?>(object: vmObject.filter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
...
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.buildPage(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
3
...
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.buildTransitions(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
...
table  [
'getBarrierDismissible'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.barrierDismissible,]; } );
table  [
'install'
...
1
];vmObject.addScopedWillPopCallback(() => _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.bool>, _fac9.bool>(unpackedcallback.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState));
return []; } );
table  [
'removeScopedWillPopCallback'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedcallback=luaCallerArguments  [
1
];vmObject.removeScopedWillPopCallback(() => _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.bool>, _fac9.bool>(unpackedcallback.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState));
return []; } );
table  [
'didChangePrevious'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didChangePrevious(_36c2.maybeUnBoxAndBuildArgument<_a37d.Route<_fac9.dynamic>?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'changedInternalState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.changedInternalState();
return []; } );
table  [
'changedExternalState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.changedExternalState();
return []; } );
table  [
...
table  [
'getSemanticsDismissible'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.semanticsDismissible,]; } );
table  [
'getBarrierColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.barrierColor;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Color?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getBarrierLabel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.barrierLabel;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getBarrierCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_8c47.Curve>(object: vmObject.barrierCurve, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getMaintainState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.maintainState,]; } );
table  [
'getOffstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.offstage,]; } );
table  [
'setOffstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.offstage=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getSubtreeContext'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.subtreeContext;if(returnValue!= null){return [_36c2.maybeBoxObject<_e2dc.BuildContext?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getAnimation'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.addLocalHistoryEntry(_36c2.maybeUnBoxAndBuildArgument<_8c2a.LocalHistoryEntry, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'removeLocalHistoryEntry'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.removeLocalHistoryEntry(_36c2.maybeUnBoxAndBuildArgument<_8c2a.LocalHistoryEntry, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _18d3.PageRouteBuilder<_fac9.dynamic> vmObject;

 }

class RTManagedPageRouteBuilder extends _18d3.PageRouteBuilder implements _36c2.Box<_18d3.PageRouteBuilder> {RTManagedPageRouteBuilder({_a643.Color? barrierColor, required _fac9.bool barrierDismissible, _fac9.String? barrierLabel, required _fac9.bool fullscreenDialog, required _fac9.bool maintainState, required _fac9.bool opaque, required _fac9.Duration reverseTransitionDuration, _a37d.RouteSettings? settings, required _fac9.Duration transitionDuration, required _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _86ca.Animation<_fac9.double> secondaryAnimation, _e2dc.Widget child) transitionsBuilder, required _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _86ca.Animation<_fac9.double> secondaryAnimation) pageBuilder, required this.table, required this.hydroState}) : super(barrierColor: barrierColor,barrierDismissible: barrierDismissible,barrierLabel: barrierLabel,fullscreenDialog: fullscreenDialog,maintainState: maintainState,opaque: opaque,reverseTransitionDuration: reverseTransitionDuration,settings: settings,transitionDuration: transitionDuration,transitionsBuilder: transitionsBuilder,pageBuilder: pageBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'transitionDuration'
] = _36c2.maybeBoxObject(object: this.transitionDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'reverseTransitionDuration'
] = _36c2.maybeBoxObject(object: this.reverseTransitionDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'opaque'
] = _36c2.maybeBoxObject(object: this.opaque, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'barrierDismissible'
] = _36c2.maybeBoxObject(object: this.barrierDismissible, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'barrierColor'
] = _36c2.maybeBoxObject(object: this.barrierColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'barrierLabel'
] = _36c2.maybeBoxObject(object: this.barrierLabel, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maintainState'
] = _36c2.maybeBoxObject(object: this.maintainState, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fullscreenDialog'
] = _36c2.maybeBoxObject(object: this.fullscreenDialog, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'filter'
] = _36c2.maybeBoxObject(object: filter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'willDisposeAnimationController'
] = _36c2.maybeBoxObject(object: willDisposeAnimationController, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_buildPage'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
table['_dart_getBarrierDismissible'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_addScopedWillPopCallback'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_removeScopedWillPopCallback'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  _36c2.Closure unpackedcallback = luaCallerArguments[1];
...
table['_dart_getSemanticsDismissible'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.semanticsDismissible];
});
table['_dart_getBarrierColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [barrierColor];
});
table['_dart_getBarrierLabel'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [barrierLabel];
});
table['_dart_getBarrierCurve'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.barrierCurve];
});
table['_dart_getMaintainState'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [maintainState];
});
table['_dart_getOffstage'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.offstage];
});
table['_dart_setOffstage'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.offstage = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_getSubtreeContext'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getHasScopedWillPopCallback'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.hasScopedWillPopCallback];
});
table['_dart_getCanPop'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.canPop];
});
table['_dart_addLocalHistoryEntry'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.addLocalHistoryEntry(
      _36c2.maybeUnBoxAndBuildArgument<_8c2a.LocalHistoryEntry, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_removeLocalHistoryEntry'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.removeLocalHistoryEntry(
      _36c2.maybeUnBoxAndBuildArgument<_8c2a.LocalHistoryEntry, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
...
_18d3.PageRouteBuilder unwrap() => this;
_18d3.PageRouteBuilder get vmObject => this;
@_fac9.override _e2dc.Widget buildPage(context, animation, secondaryAnimation) { 
...
@_fac9.override _e2dc.Widget buildTransitions(context, animation, secondaryAnimation, child) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get barrierDismissible { 
...
@_fac9.override void addScopedWillPopCallback(callback) { 
_36c2.Closure closure = table["addScopedWillPopCallback"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeScopedWillPopCallback(callback) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get semanticsDismissible { 
_36c2.Closure closure = table["getSemanticsDismissible"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Color? get barrierColor { 
...
@_fac9.override _fac9.String? get barrierLabel { 
_36c2.Closure closure = table["getBarrierLabel"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _8c47.Curve get barrierCurve { 
...
@_fac9.override _fac9.bool get maintainState { 
_36c2.Closure closure = table["getMaintainState"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get offstage { 
_36c2.Closure closure = table["getOffstage"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set offstage(value) { 
_36c2.Closure closure = table["setOffstage"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.BuildContext? get subtreeContext { 
...
return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>?, _fac9.double>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool get hasScopedWillPopCallback { 
_36c2.Closure closure = table["getHasScopedWillPopCallback"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get canPop { 
_36c2.Closure closure = table["getCanPop"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void addLocalHistoryEntry(entry) { 
_36c2.Closure closure = table["addLocalHistoryEntry"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeLocalHistoryEntry(entry) { 
...
void loadPageRouteBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pageRouteBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure unpackedtransitionsBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transitionsBuilder'
] : null;
_36c2.Closure unpackedpageBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pageBuilder'
] : null;
return  [RTManagedPageRouteBuilder(table: luaCallerArguments  [
0
], hydroState: hydroState, barrierColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'barrierColor'
] : null, parentState: hydroState), barrierDismissible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'barrierDismissible'
] : null, barrierLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'barrierLabel'
] : null, fullscreenDialog: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fullscreenDialog'
] : null, maintainState: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainState'
] : null, opaque: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'opaque'
] : null, reverseTransitionDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverseTransitionDuration'
] : null, parentState: hydroState), settings: _36c2.maybeUnBoxAndBuildArgument<_a37d.RouteSettings?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'settings'
] : null, parentState: hydroState), transitionDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transitionDuration'
] : null, parentState: hydroState), transitionsBuilder: (context, animation, secondaryAnimation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedtransitionsBuilder.dispatch([luaCallerArguments[0],context,animation,secondaryAnimation,child],parentState:hydroState,)[0], parentState: hydroState), pageBuilder: (context, animation, secondaryAnimation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedpageBuilder.dispatch([luaCallerArguments[0],context,animation,secondaryAnimation],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_18d3.PageRouteBuilder>(boxer: ({required _18d3.PageRouteBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPageRouteBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

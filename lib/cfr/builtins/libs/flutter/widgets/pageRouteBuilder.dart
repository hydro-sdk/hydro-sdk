...
class VMManagedPageRouteBuilder
    extends _36c2.VMManagedBox<_18d3.PageRouteBuilder<_fac9.dynamic>> {
  VMManagedPageRouteBuilder(
    ...
    table['transitionDuration'] = _36c2.maybeBoxObject<_fac9.Duration>(
        object: vmObject.transitionDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['reverseTransitionDuration'] = _36c2.maybeBoxObject<_fac9.Duration>(
        object: vmObject.reverseTransitionDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['opaque'] = vmObject.opaque;
    table['barrierDismissible'] = vmObject.barrierDismissible;
    table['barrierColor'] = _36c2.maybeBoxObject<_a643.Color?>(
        object: vmObject.barrierColor,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['barrierLabel'] = vmObject.barrierLabel;
...
class RTManagedPageRouteBuilder extends _18d3.PageRouteBuilder
  ...
  RTManagedPageRouteBuilder(
      {_a643.Color? barrierColor,
      required _fac9.bool barrierDismissible,
      _fac9.String? barrierLabel,
      required _fac9.bool fullscreenDialog,
      required _fac9.bool maintainState,
      required _fac9.bool opaque,
      required _fac9.Duration reverseTransitionDuration,
      _a37d.RouteSettings? settings,
      required _fac9.Duration transitionDuration,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context,
              _86ca.Animation<_fac9.double> animation,
              _86ca.Animation<_fac9.double> secondaryAnimation,
              _e2dc.Widget child)
          transitionsBuilder,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context,
    ...
    table['transitionDuration'] = _36c2.maybeBoxObject(
        object: this.transitionDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['reverseTransitionDuration'] = _36c2.maybeBoxObject(
        object: this.reverseTransitionDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['opaque'] = _36c2.maybeBoxObject(
        object: this.opaque, hydroState: hydroState, table: _36c2.HydroTable());
    table['barrierDismissible'] = _36c2.maybeBoxObject(
        object: this.barrierDismissible,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['barrierColor'] = _36c2.maybeBoxObject(
        object: this.barrierColor,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['barrierLabel'] = _36c2.maybeBoxObject(
        object: this.barrierLabel,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadPageRouteBuilder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pageRouteBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedtransitionsBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['transitionsBuilder']
        : null;
    _36c2.Closure unpackedpageBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['pageBuilder']
        : null;
    return [
      RTManagedPageRouteBuilder(
          ...
          hydroState: hydroState,
          barrierColor:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['barrierColor'] : null,
                  parentState: hydroState),
          barrierDismissible: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['barrierDismissible']
              : null,
          barrierLabel: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['barrierLabel']
              : null,
          ...
          reverseTransitionDuration:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['reverseTransitionDuration']
                      : null,
                  parentState: hydroState),
          settings: _36c2.maybeUnBoxAndBuildArgument<_a37d.RouteSettings?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['settings'] : null,
              parentState: hydroState),
          transitionDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['transitionDuration'] : null, parentState: hydroState),
          transitionsBuilder: (context, animation, secondaryAnimation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              unpackedtransitionsBuilder.dispatch(
                [
                  luaCallerArguments[0],
                  context,
                  animation,
              ...
              parentState: hydroState),
          pageBuilder: (context, animation, secondaryAnimation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              unpackedpageBuilder.dispatch(
                [luaCallerArguments[0], context, animation, secondaryAnimation],
                parentState: hydroState,
              )[0],
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_18d3.PageRouteBuilder>(boxer: (
      {required _18d3.PageRouteBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPageRouteBuilder(

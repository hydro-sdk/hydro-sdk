...
class VMManagedBorderTween extends _36c2.VMManagedBox<_da7c.BorderTween> {
  VMManagedBorderTween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_250a.Border?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_250a.Border?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedBorderTween extends _da7c.BorderTween
    implements _36c2.Box<_da7c.BorderTween> {
  RTManagedBorderTween(
      {_250a.Border? begin,
      _250a.Border? end,
      required this.table,
  ...
  @_fac9.override
  _250a.Border? evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_250a.Border?> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_250a.Border?>,
            _250a.Border?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _e83e.Animatable<_250a.Border?> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<_e83e.Animatable<_250a.Border?>,
            _250a.Border?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadBorderTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['borderTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBorderTween(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          begin: _36c2.maybeUnBoxAndBuildArgument<_250a.Border?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['begin']
                  : null,
              parentState: hydroState),
          end: _36c2.maybeUnBoxAndBuildArgument<_250a.Border?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_da7c.BorderTween>(boxer: (
      {required _da7c.BorderTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBorderTween(

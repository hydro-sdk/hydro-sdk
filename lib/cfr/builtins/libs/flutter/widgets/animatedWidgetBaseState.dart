...
class VMManagedAnimatedWidgetBaseState extends _36c2.VMManagedBox<
    _da7c.AnimatedWidgetBaseState<_da7c.ImplicitlyAnimatedWidget>> {
  VMManagedAnimatedWidgetBaseState(
...
class RTManagedAnimatedWidgetBaseState extends _da7c.AnimatedWidgetBaseState
    implements _36c2.Box<_da7c.AnimatedWidgetBaseState> {
  RTManagedAnimatedWidgetBaseState(
...
void loadAnimatedWidgetBaseState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedWidgetBaseState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnimatedWidgetBaseState(
  ...
  _36c2.registerBoxer<_da7c.AnimatedWidgetBaseState>(boxer: (
      {required _da7c.AnimatedWidgetBaseState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedWidgetBaseState(

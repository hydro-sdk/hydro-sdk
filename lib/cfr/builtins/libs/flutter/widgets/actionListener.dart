...
class VMManagedActionListener extends _36c2.VMManagedBox<_c0f4.ActionListener> {VMManagedActionListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'action'
] = _36c2.maybeBoxObject<_c0f4.Action>(object: vmObject.action, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _c0f4.ActionListener vmObject;

 }

class RTManagedActionListener extends _c0f4.ActionListener implements _36c2.Box<_c0f4.ActionListener> {RTManagedActionListener({_ab4a.Key? key, required _c0f4.Action<_c0f4.Intent> action, required _e2dc.Widget child, required void Function(_c0f4.Action<_c0f4.Intent> action) listener, required this.table, required this.hydroState}) : super(key: key,action: action,child: child,listener: listener) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.ActionListener unwrap() => this;
_c0f4.ActionListener get vmObject => this;
@_fac9.override _e2dc.State<_c0f4.ActionListener> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_c0f4.ActionListener>, _c0f4.ActionListener>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadActionListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'actionListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


_36c2.Closure unpackedlistener=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'listener'
] : null;
return  [RTManagedActionListener(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), action: _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.Intent>, _c0f4.Intent>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'action'
...
'child'
] : null, parentState: hydroState), listener: (action) => unpackedlistener.dispatch([luaCallerArguments[0],action],parentState:hydroState,))]; } );
_36c2.registerBoxer<_c0f4.ActionListener>(boxer: ({required _c0f4.ActionListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedActionListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

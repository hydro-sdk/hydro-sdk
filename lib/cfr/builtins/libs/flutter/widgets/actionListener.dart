...
class VMManagedActionListener extends _36c2.VMManagedBox<_c0f4.ActionListener> {
  VMManagedActionListener(
    ...
    table['action'] = _36c2.maybeBoxObject<_c0f4.Action>(
...
class RTManagedActionListener extends _c0f4.ActionListener
    implements _36c2.Box<_c0f4.ActionListener> {
  RTManagedActionListener(
      {_ab4a.Key? key,
      required _c0f4.Action<_c0f4.Intent> action,
      required _e2dc.Widget child,
      required void Function(_c0f4.Action<_c0f4.Intent> action) listener,
      required this.table,
      required this.hydroState})
      : super(key: key, action: action, child: child, listener: listener) {
  ...
  @_fac9.override
  _e2dc.State<_c0f4.ActionListener> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_c0f4.ActionListener>,
            _c0f4.ActionListener>(
...
void loadActionListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['actionListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedActionListener(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              ...
              parentState: hydroState),
          listener: (action) => unpackedlistener.dispatch(
                [luaCallerArguments[0], action],
                parentState: hydroState,
              ))
    ];
  });
  _36c2.registerBoxer<_c0f4.ActionListener>(boxer: (
      {required _c0f4.ActionListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedActionListener(

...
class VMManagedSliverPersistentHeaderDelegate
    extends _36c2.VMManagedBox<_be51.SliverPersistentHeaderDelegate> {
  VMManagedSliverPersistentHeaderDelegate(
    ...
    table['getSnapConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.snapConfiguration;
      if (returnValue != null) {
        return [
    ...
    table['getStretchConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.stretchConfiguration;
      if (returnValue != null) {
        return [
    ...
    table['getShowOnScreenConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.showOnScreenConfiguration;
      if (returnValue != null) {
        return [
          _36c2
              .maybeBoxObject<_2805.PersistentHeaderShowOnScreenConfiguration?>(
                  object: returnValue,
                  hydroState: hydroState,
                  table: _36c2.HydroTable()),
        ];
...
class RTManagedSliverPersistentHeaderDelegate
    extends _be51.SliverPersistentHeaderDelegate
    implements _36c2.Box<_be51.SliverPersistentHeaderDelegate> {
  RTManagedSliverPersistentHeaderDelegate(
    ...
    table['_dart_getSnapConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.snapConfiguration];
    });
    table['_dart_getStretchConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.stretchConfiguration];
    });
    table['_dart_getShowOnScreenConfiguration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _e2dc.Widget build(context, shrinkOffset, overlapsContent) {
  ...
  @_fac9.override
  _2805.FloatingHeaderSnapConfiguration? get snapConfiguration {
    _36c2.Closure closure = table["getSnapConfiguration"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _2805.FloatingHeaderSnapConfiguration?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  _2805.OverScrollHeaderStretchConfiguration? get stretchConfiguration {
    _36c2.Closure closure = table["getStretchConfiguration"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _2805.OverScrollHeaderStretchConfiguration?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  _2805.PersistentHeaderShowOnScreenConfiguration?
    ...
    return _36c2.maybeUnBoxAndBuildArgument<
            _2805.PersistentHeaderShowOnScreenConfiguration?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadSliverPersistentHeaderDelegate(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverPersistentHeaderDelegate'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverPersistentHeaderDelegate(
  ...
  _36c2.registerBoxer<_be51.SliverPersistentHeaderDelegate>(boxer: (
      {required _be51.SliverPersistentHeaderDelegate vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverPersistentHeaderDelegate(

...
class VMManagedPageStorage extends _36c2.VMManagedBox<_c05c.PageStorage> {VMManagedPageStorage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'bucket'
] = _36c2.maybeBoxObject<_c05c.PageStorageBucket>(object: vmObject.bucket, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _c05c.PageStorage vmObject;

 }

class RTManagedPageStorage extends _c05c.PageStorage implements _36c2.Box<_c05c.PageStorage> {RTManagedPageStorage({_ab4a.Key? key, required _c05c.PageStorageBucket bucket, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,bucket: bucket,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c05c.PageStorage unwrap() => this;
_c05c.PageStorage get vmObject => this;
...
void loadPageStorage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pageStorage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPageStorage(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), bucket: _36c2.maybeUnBoxAndBuildArgument<_c05c.PageStorageBucket, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bucket'
...
table  [
'pageStorageOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _c05c.PageStorage.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_c05c.PageStorageBucket?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_c05c.PageStorage>(boxer: ({required _c05c.PageStorage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPageStorage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedBanner extends _36c2.VMManagedBox<_7c3a.Banner> {VMManagedBanner({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7c3a.Banner vmObject;

 }

class RTManagedBanner extends _7c3a.Banner implements _36c2.Box<_7c3a.Banner> {RTManagedBanner({_e2dc.Widget? child, required _a643.Color color, _ab4a.Key? key, _a643.TextDirection? layoutDirection, _a643.TextDirection? textDirection, required _74d0.TextStyle textStyle, required _7c3a.BannerLocation location, required _fac9.String message, required this.table, required this.hydroState}) : super(child: child,color: color,key: key,layoutDirection: layoutDirection,textDirection: textDirection,textStyle: textStyle,location: location,message: message) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7c3a.Banner unwrap() => this;
_7c3a.Banner get vmObject => this;
...
void loadBanner({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'banner'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedBanner(table: luaCallerArguments  [
0
...
'textDirection'
] : null), textStyle: _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textStyle'
] : null, parentState: hydroState), location: _36c2.maybeUnBoxEnum(values: _7c3a.BannerLocation.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'location'
...
_36c2.registerBoxer<_7c3a.Banner>(boxer: ({required _7c3a.Banner vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBanner(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedBanner extends _36c2.VMManagedBox<_7c3a.Banner> {
  VMManagedBanner(
...
class RTManagedBanner extends _7c3a.Banner implements _36c2.Box<_7c3a.Banner> {
  RTManagedBanner(
      {_e2dc.Widget? child,
...
void loadBanner(
  ...
  table['banner'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBanner(
          ...
          layoutDirection: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['layoutDirection'] : null),
          ...
          location: _36c2.maybeUnBoxEnum(values: _7c3a.BannerLocation.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['location'] : null),
          message: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['message'] : null)
    ];
  });
  _36c2.registerBoxer<_7c3a.Banner>(boxer: (
      {required _7c3a.Banner vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBanner(

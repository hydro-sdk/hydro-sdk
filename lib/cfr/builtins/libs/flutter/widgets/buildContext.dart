...
class VMManagedBuildContext extends _36c2.VMManagedBox<_e2dc.BuildContext> {
...
void loadBuildContext(
  ...
  _36c2.registerBoxer<_e2dc.BuildContext>(boxer: (
      {required _e2dc.BuildContext vmObject,

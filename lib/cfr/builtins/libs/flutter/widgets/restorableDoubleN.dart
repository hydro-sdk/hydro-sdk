...
class VMManagedRestorableDoubleN extends _36c2.VMManagedBox<_28c9.RestorableDoubleN> {VMManagedRestorableDoubleN({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRestorableDoubleN extends _28c9.RestorableDoubleN implements _36c2.Box<_28c9.RestorableDoubleN> {RTManagedRestorableDoubleN(_fac9.double? defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRestorableDoubleN({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableDoubleN'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableDoubleN(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableDoubleN>(boxer: ({required _28c9.RestorableDoubleN vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableDoubleN(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

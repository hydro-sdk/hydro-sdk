...
class VMManagedAnimatedList extends _36c2.VMManagedBox<_cd40.AnimatedList> {
  VMManagedAnimatedList(
    ...
    table['createState'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_cd40.AnimatedListState>(
...
class RTManagedAnimatedList extends _cd40.AnimatedList
  ...
  @_fac9.override
  _cd40.AnimatedListState createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_cd40.AnimatedListState, _fac9.dynamic>(
...
void loadAnimatedList(
  ...
  table['animatedList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedAnimatedList(
          ...
          itemBuilder: (context, index, animation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
  ...
  table['animatedListOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_cd40.AnimatedListState>(
          object: _cd40.AnimatedList.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  table['animatedListMaybeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _cd40.AnimatedList.maybeOf(
  ...
  _36c2.registerBoxer<_cd40.AnimatedList>(boxer: (
      {required _cd40.AnimatedList vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedList(

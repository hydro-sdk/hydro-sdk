...
class VMManagedIdleScrollActivity
    extends _36c2.VMManagedBox<_ca8b.IdleScrollActivity> {
  VMManagedIdleScrollActivity(
...
class RTManagedIdleScrollActivity extends _ca8b.IdleScrollActivity
    implements _36c2.Box<_ca8b.IdleScrollActivity> {
  RTManagedIdleScrollActivity(_ca8b.ScrollActivityDelegate delegate$,
...
void loadIdleScrollActivity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['idleScrollActivity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIdleScrollActivity(
  ...
  _36c2.registerBoxer<_ca8b.IdleScrollActivity>(boxer: (
      {required _ca8b.IdleScrollActivity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIdleScrollActivity(

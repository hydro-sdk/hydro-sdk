...
class VMManagedIdleScrollActivity extends _36c2.VMManagedBox<_ca8b.IdleScrollActivity> {VMManagedIdleScrollActivity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _ca8b.IdleScrollActivity vmObject;

 }

class RTManagedIdleScrollActivity extends _ca8b.IdleScrollActivity implements _36c2.Box<_ca8b.IdleScrollActivity> {RTManagedIdleScrollActivity(_ca8b.ScrollActivityDelegate delegate$, {required this.table, required this.hydroState}) : super(delegate$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_ca8b.IdleScrollActivity unwrap() => this;
_ca8b.IdleScrollActivity get vmObject => this;
...
void loadIdleScrollActivity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'idleScrollActivity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedIdleScrollActivity(_36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivityDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_ca8b.IdleScrollActivity>(boxer: ({required _ca8b.IdleScrollActivity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIdleScrollActivity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

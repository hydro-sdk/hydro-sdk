...
class VMManagedDirectionalFocusAction
    extends _36c2.VMManagedBox<_65d3.DirectionalFocusAction> {
  VMManagedDirectionalFocusAction(
...
class RTManagedDirectionalFocusAction extends _65d3.DirectionalFocusAction
    implements _36c2.Box<_65d3.DirectionalFocusAction> {
  RTManagedDirectionalFocusAction(
    ...
    table['_dart_invoke'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.invoke(_36c2.maybeUnBoxAndBuildArgument<
          _65d3.DirectionalFocusIntent,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _c0f4.Action<_65d3.DirectionalFocusIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c0f4.Action<_65d3.DirectionalFocusIntent>?,
            _65d3.DirectionalFocusIntent>(
...
void loadDirectionalFocusAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['directionalFocusAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDirectionalFocusAction(
  ...
  _36c2.registerBoxer<_65d3.DirectionalFocusAction>(boxer: (
      {required _65d3.DirectionalFocusAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDirectionalFocusAction(

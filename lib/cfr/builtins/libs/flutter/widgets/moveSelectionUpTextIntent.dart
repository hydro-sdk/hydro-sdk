...
class VMManagedMoveSelectionUpTextIntent extends _36c2.VMManagedBox<_380d.MoveSelectionUpTextIntent> {VMManagedMoveSelectionUpTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.MoveSelectionUpTextIntent vmObject;

 }

class RTManagedMoveSelectionUpTextIntent extends _380d.MoveSelectionUpTextIntent implements _36c2.Box<_380d.MoveSelectionUpTextIntent> {RTManagedMoveSelectionUpTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.MoveSelectionUpTextIntent unwrap() => this;
_380d.MoveSelectionUpTextIntent get vmObject => this;
...
void loadMoveSelectionUpTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'moveSelectionUpTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMoveSelectionUpTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.MoveSelectionUpTextIntent>(boxer: ({required _380d.MoveSelectionUpTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMoveSelectionUpTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

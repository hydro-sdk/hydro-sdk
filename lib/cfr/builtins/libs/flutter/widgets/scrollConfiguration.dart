...
class VMManagedScrollConfiguration extends _36c2.VMManagedBox<_b028.ScrollConfiguration> {VMManagedScrollConfiguration({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'behavior'
] = _36c2.maybeBoxObject<_b028.ScrollBehavior>(object: vmObject.behavior, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_b028.ScrollConfiguration, _fac9.dynamic>(luaCallerArguments  [
1
...
final _b028.ScrollConfiguration vmObject;

 }

class RTManagedScrollConfiguration extends _b028.ScrollConfiguration implements _36c2.Box<_b028.ScrollConfiguration> {RTManagedScrollConfiguration({_ab4a.Key? key, required _b028.ScrollBehavior behavior, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,behavior: behavior,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'behavior'
] = _36c2.maybeBoxObject(object: this.behavior, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_b028.ScrollConfiguration unwrap() => this;
_b028.ScrollConfiguration get vmObject => this;
...
void loadScrollConfiguration({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollConfiguration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedScrollConfiguration(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), behavior: _36c2.maybeUnBoxAndBuildArgument<_b028.ScrollBehavior, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'behavior'
...
table  [
'scrollConfigurationOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b028.ScrollBehavior>(object: _b028.ScrollConfiguration.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_b028.ScrollConfiguration>(boxer: ({required _b028.ScrollConfiguration vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollConfiguration(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

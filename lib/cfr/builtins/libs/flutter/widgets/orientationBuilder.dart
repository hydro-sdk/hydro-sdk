...
class VMManagedOrientationBuilder
    extends _36c2.VMManagedBox<_c3bf.OrientationBuilder> {
  VMManagedOrientationBuilder(
...
class RTManagedOrientationBuilder extends _c3bf.OrientationBuilder
    implements _36c2.Box<_c3bf.OrientationBuilder> {
  RTManagedOrientationBuilder(
      {_ab4a.Key? key,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context, _e0b9.Orientation orientation)
          builder,
      required this.table,
...
void loadOrientationBuilder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['orientationBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
          ...
          builder: (context, orientation) =>
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedbuilder.dispatch(
                    [luaCallerArguments[0], context, orientation],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_c3bf.OrientationBuilder>(boxer: (
      {required _c3bf.OrientationBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOrientationBuilder(

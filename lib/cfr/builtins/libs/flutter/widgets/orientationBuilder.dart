...
import 'package:flutter/src/widgets/orientation_builder.dart' as _c3bf;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedOrientationBuilder extends _36c2.VMManagedBox<_c3bf.OrientationBuilder> {VMManagedOrientationBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c3bf.OrientationBuilder vmObject;

 }

class RTManagedOrientationBuilder extends _c3bf.OrientationBuilder implements _36c2.Box<_c3bf.OrientationBuilder> {RTManagedOrientationBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _e0b9.Orientation orientation) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c3bf.OrientationBuilder unwrap() => this;
_c3bf.OrientationBuilder get vmObject => this;
...
void loadOrientationBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'orientationBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedOrientationBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), builder: (context, orientation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,orientation],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_c3bf.OrientationBuilder>(boxer: ({required _c3bf.OrientationBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOrientationBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

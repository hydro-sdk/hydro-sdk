...
class VMManagedOverlayRoute extends _36c2.VMManagedBox<_8c2a.OverlayRoute<_fac9.dynamic>> {VMManagedOverlayRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedOverlayRoute extends _8c2a.OverlayRoute implements _36c2.Box<_8c2a.OverlayRoute> {RTManagedOverlayRoute({_a37d.RouteSettings? settings, required this.table, required this.hydroState}) : super(settings: settings) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadOverlayRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'overlayRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedOverlayRoute(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_8c2a.OverlayRoute>(boxer: ({required _8c2a.OverlayRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOverlayRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

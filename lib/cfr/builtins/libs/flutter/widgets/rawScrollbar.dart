...
class VMManagedRawScrollbar extends _36c2.VMManagedBox<_1c5f.RawScrollbar> {
  VMManagedRawScrollbar(
...
class RTManagedRawScrollbar extends _1c5f.RawScrollbar
    implements _36c2.Box<_1c5f.RawScrollbar> {
  RTManagedRawScrollbar(
  ...
  @_fac9.override
  _1c5f.RawScrollbarState<_1c5f.RawScrollbar> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _1c5f.RawScrollbarState<_1c5f.RawScrollbar>, _1c5f.RawScrollbar>(
...
void loadRawScrollbar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawScrollbar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedRawScrollbar(
          ...
          crossAxisMargin: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          fadeDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['fadeDuration']
                  : null,
              parentState: hydroState),
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          mainAxisMargin: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['mainAxisMargin'] : null?.toDouble(),
          minOverscrollLength: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['minOverscrollLength'] : null?.toDouble(),
          minThumbLength: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['minThumbLength'] : null?.toDouble(),
          notificationPredicate: (notification) => unpackednotificationPredicate.dispatch(
                [luaCallerArguments[0], notification],
                parentState: hydroState,
              )[0],
          pressDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['pressDuration'] : null, parentState: hydroState),
          ...
          timeToFade: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['timeToFade'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_1c5f.RawScrollbar>(boxer: (
      {required _1c5f.RawScrollbar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawScrollbar(

...
class VMManagedAnimatedPadding extends _36c2.VMManagedBox<_da7c.AnimatedPadding> {VMManagedAnimatedPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.AnimatedPadding vmObject;

 }

class RTManagedAnimatedPadding extends _da7c.AnimatedPadding implements _36c2.Box<_da7c.AnimatedPadding> {RTManagedAnimatedPadding({_e2dc.Widget? child, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _fac9.Duration duration, required _96d1.EdgeInsetsGeometry padding, required this.table, required this.hydroState}) : super(child: child,curve: curve,key: key,onEnd: onEnd,duration: duration,padding: padding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.AnimatedPadding unwrap() => this;
_da7c.AnimatedPadding get vmObject => this;
@_fac9.override _da7c.AnimatedWidgetBaseState<_da7c.AnimatedPadding> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.AnimatedWidgetBaseState<_da7c.AnimatedPadding>, _da7c.AnimatedPadding>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedPadding(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_da7c.AnimatedPadding>(boxer: ({required _da7c.AnimatedPadding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

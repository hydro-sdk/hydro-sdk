...
class VMManagedRootBackButtonDispatcher
    extends _36c2.VMManagedBox<_f6ef.RootBackButtonDispatcher> {
  VMManagedRootBackButtonDispatcher(
...
class RTManagedRootBackButtonDispatcher extends _f6ef.RootBackButtonDispatcher
    implements _36c2.Box<_f6ef.RootBackButtonDispatcher> {
  RTManagedRootBackButtonDispatcher(
...
void loadRootBackButtonDispatcher(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rootBackButtonDispatcher'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRootBackButtonDispatcher(
  ...
  _36c2.registerBoxer<_f6ef.RootBackButtonDispatcher>(boxer: (
      {required _f6ef.RootBackButtonDispatcher vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRootBackButtonDispatcher(

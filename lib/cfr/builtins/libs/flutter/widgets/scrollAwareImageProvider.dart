...
class VMManagedScrollAwareImageProvider
    extends _36c2.VMManagedBox<_879d.ScrollAwareImageProvider<_fac9.Object>> {
  VMManagedScrollAwareImageProvider(
    ...
    table['context'] = _36c2.maybeBoxObject<_4544.DisposableBuildContext>(
    ...
    table['imageProvider'] = _36c2.maybeBoxObject<_61fa.ImageProvider>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['resolveStreamForKey'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedhandleError = luaCallerArguments[4];
      vmObject.resolveStreamForKey(
...
class RTManagedScrollAwareImageProvider extends _879d.ScrollAwareImageProvider
    implements _36c2.Box<_879d.ScrollAwareImageProvider> {
  RTManagedScrollAwareImageProvider(
      {required _4544.DisposableBuildContext<_e2dc.State<_e2dc.StatefulWidget>>
          context,
      required _61fa.ImageProvider<_fac9.Object> imageProvider,
      required this.table,
      required this.hydroState})
      : super(context: context, imageProvider: imageProvider) {
...
void loadScrollAwareImageProvider(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollAwareImageProvider'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollAwareImageProvider(
          ...
          context:
              _36c2.maybeUnBoxAndBuildArgument<
                      _4544.DisposableBuildContext<
                          _e2dc.State<_e2dc.StatefulWidget>>,
                      _e2dc.State<_e2dc.StatefulWidget>>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['context']
                      : null,
                  parentState: hydroState),
          imageProvider: _36c2.maybeUnBoxAndBuildArgument<
                  _61fa.ImageProvider<_fac9.dynamic>, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['imageProvider']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_879d.ScrollAwareImageProvider>(boxer: (
      {required _879d.ScrollAwareImageProvider vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollAwareImageProvider(

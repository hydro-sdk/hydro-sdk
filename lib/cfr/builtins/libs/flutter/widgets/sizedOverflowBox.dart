...
class VMManagedSizedOverflowBox extends _36c2.VMManagedBox<_3960.SizedOverflowBox> {VMManagedSizedOverflowBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderSizedOverflowBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderSizedOverflowBox, _fac9.dynamic>(luaCallerArguments  [
2
...
class RTManagedSizedOverflowBox extends _3960.SizedOverflowBox implements _36c2.Box<_3960.SizedOverflowBox> {RTManagedSizedOverflowBox({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, _ab4a.Key? key, required _a643.Size size, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,key: key,size: size) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _a9e4.RenderSizedOverflowBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderSizedOverflowBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSizedOverflowBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sizedOverflowBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSizedOverflowBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.SizedOverflowBox>(boxer: ({required _3960.SizedOverflowBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSizedOverflowBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

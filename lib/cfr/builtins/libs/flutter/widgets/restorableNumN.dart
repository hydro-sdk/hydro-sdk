...
class VMManagedRestorableNumN
    extends _36c2.VMManagedBox<_28c9.RestorableNumN<_fac9.num?>> {
  VMManagedRestorableNumN(
...
class RTManagedRestorableNumN extends _28c9.RestorableNumN
    implements _36c2.Box<_28c9.RestorableNumN> {
  RTManagedRestorableNumN(_fac9.num? defaultValue,
...
void loadRestorableNumN(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableNumN'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableNumN(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableNumN>(boxer: (
      {required _28c9.RestorableNumN vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableNumN(

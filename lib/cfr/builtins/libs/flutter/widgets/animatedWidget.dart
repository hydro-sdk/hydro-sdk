...
class VMManagedAnimatedWidget extends _36c2.VMManagedBox<_d7ad.AnimatedWidget> {VMManagedAnimatedWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d7ad.AnimatedWidget vmObject;

 }

class RTManagedAnimatedWidget extends _d7ad.AnimatedWidget implements _36c2.Box<_d7ad.AnimatedWidget> {RTManagedAnimatedWidget({_ab4a.Key? key, required _e644.Listenable listenable, required this.table, required this.hydroState}) : super(key: key,listenable: listenable) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'listenable'
] = _36c2.maybeBoxObject(object: this.listenable, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_d7ad.AnimatedWidget unwrap() => this;
_d7ad.AnimatedWidget get vmObject => this;
...
void loadAnimatedWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAnimatedWidget(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), listenable: _36c2.maybeUnBoxAndBuildArgument<_e644.Listenable, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'listenable'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.AnimatedWidget>(boxer: ({required _d7ad.AnimatedWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

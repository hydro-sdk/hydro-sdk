...
class VMManagedClampingScrollPhysics
    extends _36c2.VMManagedBox<_dbad.ClampingScrollPhysics> {
  VMManagedClampingScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_dbad.ClampingScrollPhysics>(
...
class RTManagedClampingScrollPhysics extends _dbad.ClampingScrollPhysics
    implements _36c2.Box<_dbad.ClampingScrollPhysics> {
  RTManagedClampingScrollPhysics(
  ...
  @_fac9.override
  _dbad.ClampingScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_dbad.ClampingScrollPhysics, _fac9.dynamic>(
...
void loadClampingScrollPhysics(
  ...
  table['clampingScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClampingScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.ClampingScrollPhysics>(boxer: (
      {required _dbad.ClampingScrollPhysics vmObject,

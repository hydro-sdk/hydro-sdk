...
class VMManagedLongPressDraggable
    extends _36c2.VMManagedBox<_0705.LongPressDraggable<_fac9.Object>> {
  VMManagedLongPressDraggable(
    ...
    table['hapticFeedbackOnStart'] = vmObject.hapticFeedbackOnStart;
    table['delay'] = _36c2.maybeBoxObject<_fac9.Duration>(
        object: vmObject.delay,
        hydroState: hydroState,
    ...
    table['key'] = _36c2.maybeBoxObject<_ab4a.Key?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['createRecognizer'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedonStart = luaCallerArguments[1];
      return [
        _36c2.maybeBoxObject<_d5f6.DelayedMultiDragGestureRecognizer>(
            object: vmObject.createRecognizer((position) =>
...
class RTManagedLongPressDraggable extends _0705.LongPressDraggable
    implements _36c2.Box<_0705.LongPressDraggable> {
  RTManagedLongPressDraggable(
      {_487f.Axis? axis,
      _e2dc.Widget? childWhenDragging,
      _fac9.Object? data,
      required _fac9.Duration delay,
      ...
      required _fac9.bool hapticFeedbackOnStart,
    ...
    table['hapticFeedbackOnStart'] = _36c2.maybeBoxObject(
        object: this.hapticFeedbackOnStart,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['delay'] = _36c2.maybeBoxObject(
        object: this.delay, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['rootOverlay'] = _36c2.maybeBoxObject(
        object: rootOverlay, hydroState: hydroState, table: _36c2.HydroTable());
    table['hitTestBehavior'] = _bf98.HitTestBehavior.values.indexWhere((x) {
      return x == hitTestBehavior;
    });
  ...
  @_fac9.override
  _d5f6.DelayedMultiDragGestureRecognizer createRecognizer(onStart) {
    _36c2.Closure closure = table["createRecognizer"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _d5f6.DelayedMultiDragGestureRecognizer, _fac9.dynamic>(
...
void loadLongPressDraggable(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['longPressDraggable'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedLongPressDraggable(
          ...
          data: luaCallerArguments.length >= 2
              ...
              : null,
          delay: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['delay']
                  : null,
              parentState: hydroState),
          dragAnchor: _36c2.maybeUnBoxEnum(
              values: _0705.DragAnchor.values,
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['dragAnchor'] : null),
          dragAnchorStrategy: unpackeddragAnchorStrategy != null
              ? (draggable, context, position) => _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                  ...
                  parentState: hydroState)
              : null,
          feedbackOffset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['feedbackOffset'] : null, parentState: hydroState),
          hapticFeedbackOnStart: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['hapticFeedbackOnStart'] : null,
  ...
  _36c2.registerBoxer<_0705.LongPressDraggable>(boxer: (
      {required _0705.LongPressDraggable vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLongPressDraggable(

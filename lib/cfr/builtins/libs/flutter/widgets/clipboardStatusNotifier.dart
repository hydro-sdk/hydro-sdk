...
class VMManagedClipboardStatusNotifier extends _36c2.VMManagedBox<_578c.ClipboardStatusNotifier> {VMManagedClipboardStatusNotifier({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getDisposed'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.disposed,]; } );
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.update(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'addListener'
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_578c.ClipboardStatus.values.indexWhere((x) { return x == vmObject.value; } ),]; } );
table  [
'setValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.value=(_36c2.maybeUnBoxEnum(values: _578c.ClipboardStatus.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
class RTManagedClipboardStatusNotifier extends _578c.ClipboardStatusNotifier implements _36c2.Box<_578c.ClipboardStatusNotifier> {RTManagedClipboardStatusNotifier({required _578c.ClipboardStatus value, required this.table, required this.hydroState}) : super(value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_getDisposed'] =
...
table['_dart_setValue'] =
  ...
  super.value = (_36c2.maybeUnBoxEnum(
      values: _578c.ClipboardStatus.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
@_fac9.override _fac9.bool get disposed { 
_36c2.Closure closure = table["getDisposed"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7de1.Future<void> update() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _578c.ClipboardStatus get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxEnum(values: _578c.ClipboardStatus.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
...
void loadClipboardStatusNotifier({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipboardStatusNotifier'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedClipboardStatusNotifier(table: luaCallerArguments  [
0
], hydroState: hydroState, value: _36c2.maybeUnBoxEnum(values: _578c.ClipboardStatus.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null))]; } );
_36c2.registerBoxer<_578c.ClipboardStatusNotifier>(boxer: ({required _578c.ClipboardStatusNotifier vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipboardStatusNotifier(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollPhysics extends _36c2.VMManagedBox<_dbad.ScrollPhysics> {
  VMManagedScrollPhysics(
...
class RTManagedScrollPhysics extends _dbad.ScrollPhysics
    implements _36c2.Box<_dbad.ScrollPhysics> {
  RTManagedScrollPhysics(
  ...
  @_fac9.override
  _dbad.ScrollPhysics applyTo(ancestor) {
...
void loadScrollPhysics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.ScrollPhysics>(boxer: (
      {required _dbad.ScrollPhysics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollPhysics(

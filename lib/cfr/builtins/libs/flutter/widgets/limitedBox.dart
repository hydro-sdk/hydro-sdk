...
class VMManagedLimitedBox extends _36c2.VMManagedBox<_3960.LimitedBox> {VMManagedLimitedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderLimitedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLimitedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.LimitedBox vmObject;

 }

class RTManagedLimitedBox extends _3960.LimitedBox implements _36c2.Box<_3960.LimitedBox> {RTManagedLimitedBox({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.double maxHeight, required _fac9.double maxWidth, required this.table, required this.hydroState}) : super(child: child,key: key,maxHeight: maxHeight,maxWidth: maxWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLimitedBox, _fac9.dynamic>(
...
_3960.LimitedBox unwrap() => this;
_3960.LimitedBox get vmObject => this;
@_fac9.override _bf98.RenderLimitedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLimitedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadLimitedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'limitedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedLimitedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.LimitedBox>(boxer: ({required _3960.LimitedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLimitedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

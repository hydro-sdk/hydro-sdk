...
class VMManagedLimitedBox extends _36c2.VMManagedBox<_3960.LimitedBox> {
  VMManagedLimitedBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderLimitedBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderLimitedBox,
...
class RTManagedLimitedBox extends _3960.LimitedBox
    implements _36c2.Box<_3960.LimitedBox> {
  RTManagedLimitedBox(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(
            child: child, key: key, maxHeight: maxHeight, maxWidth: maxWidth) {
  ...
  @_fac9.override
  _bf98.RenderLimitedBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderLimitedBox, _fac9.dynamic>(
...
void loadLimitedBox(
  ...
  table['limitedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLimitedBox(
  ...
  _36c2.registerBoxer<_3960.LimitedBox>(boxer: (
      {required _3960.LimitedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLimitedBox(

...
class VMManagedRestorableTextEditingController
    extends _36c2.VMManagedBox<_28c9.RestorableTextEditingController> {
  VMManagedRestorableTextEditingController(
...
void loadRestorableTextEditingController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableTextEditingController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_28c9.RestorableTextEditingController>(
          object: _28c9.RestorableTextEditingController(
  ...
  _36c2.registerBoxer<_28c9.RestorableTextEditingController>(boxer: (
      {required _28c9.RestorableTextEditingController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableTextEditingController(

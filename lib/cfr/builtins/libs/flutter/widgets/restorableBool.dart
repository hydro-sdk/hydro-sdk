...
class VMManagedRestorableBool extends _36c2.VMManagedBox<_28c9.RestorableBool> {VMManagedRestorableBool({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRestorableBool extends _28c9.RestorableBool implements _36c2.Box<_28c9.RestorableBool> {RTManagedRestorableBool(_fac9.bool defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRestorableBool({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableBool'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableBool(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableBool>(boxer: ({required _28c9.RestorableBool vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableBool(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

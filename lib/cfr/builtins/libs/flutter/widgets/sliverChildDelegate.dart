...
class VMManagedSliverChildDelegate extends _36c2.VMManagedBox<_a8eb.SliverChildDelegate> {VMManagedSliverChildDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRebuild(_36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverChildDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a8eb.SliverChildDelegate vmObject;

 }

class RTManagedSliverChildDelegate extends _a8eb.SliverChildDelegate implements _36c2.Box<_a8eb.SliverChildDelegate> {RTManagedSliverChildDelegate({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a8eb.SliverChildDelegate unwrap() => this;
_a8eb.SliverChildDelegate get vmObject => this;
...
void loadSliverChildDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverChildDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSliverChildDelegate(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_a8eb.SliverChildDelegate>(boxer: ({required _a8eb.SliverChildDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverChildDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

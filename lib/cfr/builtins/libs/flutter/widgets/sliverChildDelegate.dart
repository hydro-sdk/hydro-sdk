...
class VMManagedSliverChildDelegate
    extends _36c2.VMManagedBox<_a8eb.SliverChildDelegate> {
  VMManagedSliverChildDelegate(
...
class RTManagedSliverChildDelegate extends _a8eb.SliverChildDelegate
    implements _36c2.Box<_a8eb.SliverChildDelegate> {
  RTManagedSliverChildDelegate({required this.table, required this.hydroState})
      : super() {
...
void loadSliverChildDelegate(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverChildDelegate'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverChildDelegate(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_a8eb.SliverChildDelegate>(boxer: (
      {required _a8eb.SliverChildDelegate vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverChildDelegate(

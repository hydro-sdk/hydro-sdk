...
class VMManagedNextFocusAction
    extends _36c2.VMManagedBox<_65d3.NextFocusAction> {
  VMManagedNextFocusAction(
    ...
    table['invoke'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.NextFocusIntent,
...
class RTManagedNextFocusAction extends _65d3.NextFocusAction
    implements _36c2.Box<_65d3.NextFocusAction> {
  RTManagedNextFocusAction({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_invoke'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.NextFocusIntent,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _c0f4.Action<_65d3.NextFocusIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c0f4.Action<_65d3.NextFocusIntent>?, _65d3.NextFocusIntent>(
...
void loadNextFocusAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['nextFocusAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNextFocusAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_65d3.NextFocusAction>(boxer: (
      {required _65d3.NextFocusAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNextFocusAction(

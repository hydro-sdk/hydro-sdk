...
class VMManagedCallbackAction extends _36c2.VMManagedBox<_c0f4.CallbackAction<_c0f4.Intent>> {VMManagedCallbackAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'invoke'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.invoke(luaCallerArguments  [
1
]);if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Object?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'isEnabled'
...
final _c0f4.CallbackAction<_c0f4.Intent> vmObject;

 }

class RTManagedCallbackAction extends _c0f4.CallbackAction implements _36c2.Box<_c0f4.CallbackAction> {RTManagedCallbackAction({required _fac9.Object? Function(_c0f4.Intent intent) onInvoke, required this.table, required this.hydroState}) : super(onInvoke: onInvoke) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_invoke'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.invoke(luaCallerArguments[1]),
        hydroState: hydroState,
...
_c0f4.CallbackAction unwrap() => this;
_c0f4.CallbackAction get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _c0f4.Action<_c0f4.Intent>? get callingAction { 
_36c2.Closure closure = table["getCallingAction"];
return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.Intent>?, _c0f4.Intent>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCallbackAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'callbackAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedonInvoke=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onInvoke'
] : null;
return  [RTManagedCallbackAction(table: luaCallerArguments  [
0
], hydroState: hydroState, onInvoke: (intent) => _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(((final _fac9.List<_fac9.dynamic>? val,) => val != null && val.length >= 1 ?val[0] : null)(unpackedonInvoke.dispatch([luaCallerArguments[0],intent],parentState:hydroState,),), parentState: hydroState))]; } );
_36c2.registerBoxer<_c0f4.CallbackAction>(boxer: ({required _c0f4.CallbackAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCallbackAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

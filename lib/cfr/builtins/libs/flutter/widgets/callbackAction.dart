...
class VMManagedCallbackAction
    extends _36c2.VMManagedBox<_c0f4.CallbackAction<_c0f4.Intent>> {
  VMManagedCallbackAction(
    ...
    table['invoke'] = _36c2.makeLuaDartFunc(
      ...
      final returnValue = vmObject.invoke(luaCallerArguments[1]);
      if (returnValue != null) {
        return [
...
class RTManagedCallbackAction extends _c0f4.CallbackAction
    implements _36c2.Box<_c0f4.CallbackAction> {
  RTManagedCallbackAction(
      {required _fac9.Object? Function(_c0f4.Intent intent) onInvoke,
      required this.table,
...
void loadCallbackAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['callbackAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedonInvoke = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onInvoke']
        : null;
    return [
      RTManagedCallbackAction(
          ...
          onInvoke: (intent) =>
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
                  ((
                    ...
                    unpackedonInvoke.dispatch(
                      [luaCallerArguments[0], intent],
                      parentState: hydroState,
                    ),
                  ),
                  parentState: hydroState))
  ...
  _36c2.registerBoxer<_c0f4.CallbackAction>(boxer: (
      {required _c0f4.CallbackAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCallbackAction(

...
class VMManagedPreviousFocusAction
    extends _36c2.VMManagedBox<_65d3.PreviousFocusAction> {
  VMManagedPreviousFocusAction(
    ...
    table['invoke'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedPreviousFocusAction extends _65d3.PreviousFocusAction
    implements _36c2.Box<_65d3.PreviousFocusAction> {
  RTManagedPreviousFocusAction({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _c0f4.Action<_65d3.PreviousFocusIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _c0f4.Action<_65d3.PreviousFocusIntent>?,
            _65d3.PreviousFocusIntent>(
...
void loadPreviousFocusAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['previousFocusAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPreviousFocusAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_65d3.PreviousFocusAction>(boxer: (
      {required _65d3.PreviousFocusAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPreviousFocusAction(

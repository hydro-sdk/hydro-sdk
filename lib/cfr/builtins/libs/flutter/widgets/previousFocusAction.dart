...
class VMManagedPreviousFocusAction extends _36c2.VMManagedBox<_65d3.PreviousFocusAction> {VMManagedPreviousFocusAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'invoke'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.PreviousFocusIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'isEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<_65d3.PreviousFocusIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'consumesKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.consumesKey(_36c2.maybeUnBoxAndBuildArgument<_65d3.PreviousFocusIntent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'addActionListener'
...
final _65d3.PreviousFocusAction vmObject;

 }

class RTManagedPreviousFocusAction extends _65d3.PreviousFocusAction implements _36c2.Box<_65d3.PreviousFocusAction> {RTManagedPreviousFocusAction({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_invoke'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.invoke(_36c2.maybeUnBoxAndBuildArgument<_65d3.PreviousFocusIntent,
...
_65d3.PreviousFocusAction unwrap() => this;
_65d3.PreviousFocusAction get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _c0f4.Action<_65d3.PreviousFocusIntent>? get callingAction { 
_36c2.Closure closure = table["getCallingAction"];
return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_65d3.PreviousFocusIntent>?, _65d3.PreviousFocusIntent>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPreviousFocusAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'previousFocusAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPreviousFocusAction(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_65d3.PreviousFocusAction>(boxer: ({required _65d3.PreviousFocusAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPreviousFocusAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

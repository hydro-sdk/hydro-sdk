...
class VMManagedPreviousFocusIntent extends _36c2.VMManagedBox<_65d3.PreviousFocusIntent> {VMManagedPreviousFocusIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _65d3.PreviousFocusIntent vmObject;

 }

class RTManagedPreviousFocusIntent extends _65d3.PreviousFocusIntent implements _36c2.Box<_65d3.PreviousFocusIntent> {RTManagedPreviousFocusIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_65d3.PreviousFocusIntent unwrap() => this;
_65d3.PreviousFocusIntent get vmObject => this;
...
void loadPreviousFocusIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'previousFocusIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPreviousFocusIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_65d3.PreviousFocusIntent>(boxer: ({required _65d3.PreviousFocusIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPreviousFocusIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

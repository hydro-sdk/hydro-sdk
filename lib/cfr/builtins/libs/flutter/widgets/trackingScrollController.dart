...
class VMManagedTrackingScrollController extends _36c2.VMManagedBox<_9585.TrackingScrollController> {VMManagedTrackingScrollController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getMostRecentlyUpdatedPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.mostRecentlyUpdatedPosition;if(returnValue!= null){return [_36c2.maybeBoxObject<_6c49.ScrollPosition?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
...
final _9585.TrackingScrollController vmObject;

 }

class RTManagedTrackingScrollController extends _9585.TrackingScrollController implements _36c2.Box<_9585.TrackingScrollController> {RTManagedTrackingScrollController({_fac9.String? debugLabel, required _fac9.double initialScrollOffset, required _fac9.bool keepScrollOffset, required this.table, required this.hydroState}) : super(debugLabel: debugLabel,initialScrollOffset: initialScrollOffset,keepScrollOffset: keepScrollOffset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getMostRecentlyUpdatedPosition'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
_9585.TrackingScrollController unwrap() => this;
_9585.TrackingScrollController get vmObject => this;
@_fac9.override _6c49.ScrollPosition? get mostRecentlyUpdatedPosition { 
_36c2.Closure closure = table["getMostRecentlyUpdatedPosition"];
...
void loadTrackingScrollController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'trackingScrollController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTrackingScrollController(table: luaCallerArguments  [
0
], hydroState: hydroState, debugLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugLabel'
] : null, initialScrollOffset: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialScrollOffset'
...
_36c2.registerBoxer<_9585.TrackingScrollController>(boxer: ({required _9585.TrackingScrollController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTrackingScrollController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

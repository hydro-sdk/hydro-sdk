...
class VMManagedTrackingScrollController
    extends _36c2.VMManagedBox<_9585.TrackingScrollController> {
  VMManagedTrackingScrollController(
    ...
    table['getMostRecentlyUpdatedPosition'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.mostRecentlyUpdatedPosition;
      if (returnValue != null) {
        return [
...
class RTManagedTrackingScrollController extends _9585.TrackingScrollController
    implements _36c2.Box<_9585.TrackingScrollController> {
  RTManagedTrackingScrollController(
    ...
    table['debugLabel'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getMostRecentlyUpdatedPosition'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _6c49.ScrollPosition? get mostRecentlyUpdatedPosition {
...
void loadTrackingScrollController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['trackingScrollController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTrackingScrollController(
  ...
  _36c2.registerBoxer<_9585.TrackingScrollController>(boxer: (
      {required _9585.TrackingScrollController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTrackingScrollController(

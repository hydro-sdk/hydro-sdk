...
class VMManagedIndexedSlot
    extends _36c2.VMManagedBox<_e2dc.IndexedSlot<_e2dc.Element?>> {
...
void loadIndexedSlot(
  ...
  table['indexedSlot'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.IndexedSlot>(boxer: (
      {required _e2dc.IndexedSlot vmObject,

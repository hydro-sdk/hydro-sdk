...
class VMManagedFocusScope extends _36c2.VMManagedBox<_c024.FocusScope> {
  VMManagedFocusScope(
...
class RTManagedFocusScope extends _c024.FocusScope
    implements _36c2.Box<_c024.FocusScope> {
  RTManagedFocusScope(
      {required _fac9.bool autofocus,
      _fac9.bool? canRequestFocus,
      _fac9.String? debugLabel,
      _ab4a.Key? key,
      _b485.FocusScopeNode? node,
...
void loadFocusScope(
  ...
  table['focusScope'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  table['focusScopeWithExternalFocusNode'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonFocusChange = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onFocusChange']
        : null;
    ...
    return [
      _36c2.maybeBoxObject<_c024.FocusScope>(
          object: _c024.FocusScope.withExternalFocusNode(
              autofocus: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['autofocus']
                  : null,
              ...
              child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
              focusScopeNode: _36c2.maybeUnBoxAndBuildArgument<_b485.FocusScopeNode, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['focusScopeNode'] : null,
                  parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  table['focusScopeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_b485.FocusScopeNode>(
          object: _c024.FocusScope.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_c024.FocusScope>(boxer: (
      {required _c024.FocusScope vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusScope(

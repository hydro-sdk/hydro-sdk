...
class VMManagedRestorableString
    extends _36c2.VMManagedBox<_28c9.RestorableString> {
  VMManagedRestorableString(
...
class RTManagedRestorableString extends _28c9.RestorableString
    implements _36c2.Box<_28c9.RestorableString> {
  RTManagedRestorableString(_fac9.String defaultValue,
...
void loadRestorableString(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableString'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableString(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableString>(boxer: (
      {required _28c9.RestorableString vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableString(

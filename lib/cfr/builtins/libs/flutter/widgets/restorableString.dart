...
class VMManagedRestorableString extends _36c2.VMManagedBox<_28c9.RestorableString> {VMManagedRestorableString({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableString vmObject;

 }

class RTManagedRestorableString extends _28c9.RestorableString implements _36c2.Box<_28c9.RestorableString> {RTManagedRestorableString(_fac9.String defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableString unwrap() => this;
_28c9.RestorableString get vmObject => this;
...
void loadRestorableString({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableString'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableString(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableString>(boxer: ({required _28c9.RestorableString vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableString(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

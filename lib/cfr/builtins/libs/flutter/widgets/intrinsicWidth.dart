...
class VMManagedIntrinsicWidth extends _36c2.VMManagedBox<_3960.IntrinsicWidth> {
  VMManagedIntrinsicWidth(
    ...
    table['stepWidth'] = vmObject.stepWidth;
    table['stepHeight'] = vmObject.stepHeight;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderIntrinsicWidth>(
...
class RTManagedIntrinsicWidth extends _3960.IntrinsicWidth
    implements _36c2.Box<_3960.IntrinsicWidth> {
  RTManagedIntrinsicWidth(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
    ...
    table['stepWidth'] = _36c2.maybeBoxObject(
        object: this.stepWidth,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['stepHeight'] = _36c2.maybeBoxObject(
        object: this.stepHeight,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _bf98.RenderIntrinsicWidth createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicWidth, _fac9.dynamic>(
...
void loadIntrinsicWidth(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['intrinsicWidth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIntrinsicWidth(
  ...
  _36c2.registerBoxer<_3960.IntrinsicWidth>(boxer: (
      {required _3960.IntrinsicWidth vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIntrinsicWidth(

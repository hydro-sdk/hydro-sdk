...
class VMManagedIntrinsicWidth extends _36c2.VMManagedBox<_3960.IntrinsicWidth> {VMManagedIntrinsicWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderIntrinsicWidth>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicWidth, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.IntrinsicWidth vmObject;

 }

class RTManagedIntrinsicWidth extends _3960.IntrinsicWidth implements _36c2.Box<_3960.IntrinsicWidth> {RTManagedIntrinsicWidth({_e2dc.Widget? child, _ab4a.Key? key, _fac9.double? stepHeight, _fac9.double? stepWidth, required this.table, required this.hydroState}) : super(child: child,key: key,stepHeight: stepHeight,stepWidth: stepWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'stepWidth'
] = _36c2.maybeBoxObject(object: this.stepWidth, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'stepHeight'
] = _36c2.maybeBoxObject(object: this.stepHeight, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicWidth,
...
_3960.IntrinsicWidth unwrap() => this;
_3960.IntrinsicWidth get vmObject => this;
@_fac9.override _bf98.RenderIntrinsicWidth createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderIntrinsicWidth, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadIntrinsicWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intrinsicWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedIntrinsicWidth(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.IntrinsicWidth>(boxer: ({required _3960.IntrinsicWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntrinsicWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

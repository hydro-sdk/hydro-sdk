...
class VMManagedImplicitlyAnimatedWidget extends _36c2.VMManagedBox<_da7c.ImplicitlyAnimatedWidget> {VMManagedImplicitlyAnimatedWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.ImplicitlyAnimatedWidget vmObject;

 }

class RTManagedImplicitlyAnimatedWidget extends _da7c.ImplicitlyAnimatedWidget implements _36c2.Box<_da7c.ImplicitlyAnimatedWidget> {RTManagedImplicitlyAnimatedWidget({required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _fac9.Duration duration, required this.table, required this.hydroState}) : super(curve: curve,key: key,onEnd: onEnd,duration: duration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.ImplicitlyAnimatedWidget unwrap() => this;
_da7c.ImplicitlyAnimatedWidget get vmObject => this;
...
void loadImplicitlyAnimatedWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedImplicitlyAnimatedWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_da7c.ImplicitlyAnimatedWidget>(boxer: ({required _da7c.ImplicitlyAnimatedWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImplicitlyAnimatedWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

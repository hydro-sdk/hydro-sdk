...
class VMManagedImplicitlyAnimatedWidget
    extends _36c2.VMManagedBox<_da7c.ImplicitlyAnimatedWidget> {
  VMManagedImplicitlyAnimatedWidget(
...
class RTManagedImplicitlyAnimatedWidget extends _da7c.ImplicitlyAnimatedWidget
    implements _36c2.Box<_da7c.ImplicitlyAnimatedWidget> {
  RTManagedImplicitlyAnimatedWidget(
      ...
      : super(curve: curve, key: key, onEnd: onEnd, duration: duration) {
...
void loadImplicitlyAnimatedWidget(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['implicitlyAnimatedWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_da7c.ImplicitlyAnimatedWidget>(boxer: (
      {required _da7c.ImplicitlyAnimatedWidget vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImplicitlyAnimatedWidget(

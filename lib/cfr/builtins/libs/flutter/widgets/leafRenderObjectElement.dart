...
class VMManagedLeafRenderObjectElement
    extends _36c2.VMManagedBox<_e2dc.LeafRenderObjectElement> {
  VMManagedLeafRenderObjectElement(
...
class RTManagedLeafRenderObjectElement extends _e2dc.LeafRenderObjectElement
    implements _36c2.Box<_e2dc.LeafRenderObjectElement> {
  RTManagedLeafRenderObjectElement(_e2dc.LeafRenderObjectWidget widget$,
...
void loadLeafRenderObjectElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['leafRenderObjectElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLeafRenderObjectElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.LeafRenderObjectWidget,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e2dc.LeafRenderObjectElement>(boxer: (
      {required _e2dc.LeafRenderObjectElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLeafRenderObjectElement(

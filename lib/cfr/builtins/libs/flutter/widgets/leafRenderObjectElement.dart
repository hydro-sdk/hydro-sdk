...
class VMManagedLeafRenderObjectElement
    extends VMManagedBox<LeafRenderObjectElement> {
  ...
  final LeafRenderObjectElement vmObject;
}

class RTManagedLeafRenderObjectElement extends LeafRenderObjectElement
    implements Box<LeafRenderObjectElement> {
  RTManagedLeafRenderObjectElement(LeafRenderObjectWidget widget$,
  ...
  LeafRenderObjectElement unwrap() => this;
  LeafRenderObjectElement get vmObject => this;
  @override
...
void loadLeafRenderObjectElement(
  ...
  table['leafRenderObjectElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedLeafRenderObjectElement(
          maybeUnBoxAndBuildArgument<LeafRenderObjectWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<LeafRenderObjectElement>(boxer: (
      {required LeafRenderObjectElement vmObject,

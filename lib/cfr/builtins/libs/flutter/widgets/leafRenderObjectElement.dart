...
class VMManagedLeafRenderObjectElement extends _36c2.VMManagedBox<_e2dc.LeafRenderObjectElement> {VMManagedLeafRenderObjectElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.RenderObjectWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getRenderObject'
...
final _e2dc.LeafRenderObjectElement vmObject;

 }

class RTManagedLeafRenderObjectElement extends _e2dc.LeafRenderObjectElement implements _36c2.Box<_e2dc.LeafRenderObjectElement> {RTManagedLeafRenderObjectElement(_e2dc.LeafRenderObjectWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_update'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.update(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
...
_e2dc.LeafRenderObjectElement unwrap() => this;
_e2dc.LeafRenderObjectElement get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.RenderObjectWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadLeafRenderObjectElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'leafRenderObjectElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLeafRenderObjectElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.LeafRenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.LeafRenderObjectElement>(boxer: ({required _e2dc.LeafRenderObjectElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLeafRenderObjectElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

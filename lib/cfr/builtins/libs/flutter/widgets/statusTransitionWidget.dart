...
import 'package:flutter/src/widgets/status_transitions.dart' as _5804;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedStatusTransitionWidget extends _36c2.VMManagedBox<_5804.StatusTransitionWidget> {VMManagedStatusTransitionWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _5804.StatusTransitionWidget vmObject;

 }

class RTManagedStatusTransitionWidget extends _5804.StatusTransitionWidget implements _36c2.Box<_5804.StatusTransitionWidget> {RTManagedStatusTransitionWidget({_ab4a.Key? key, required _86ca.Animation<_fac9.double> animation, required this.table, required this.hydroState}) : super(key: key,animation: animation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_5804.StatusTransitionWidget unwrap() => this;
_5804.StatusTransitionWidget get vmObject => this;
...
@_fac9.override _e2dc.State<_5804.StatusTransitionWidget> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_5804.StatusTransitionWidget>, _5804.StatusTransitionWidget>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadStatusTransitionWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statusTransitionWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedStatusTransitionWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_5804.StatusTransitionWidget>(boxer: ({required _5804.StatusTransitionWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatusTransitionWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedStatusTransitionWidget
    extends _36c2.VMManagedBox<_5804.StatusTransitionWidget> {
  VMManagedStatusTransitionWidget(
...
class RTManagedStatusTransitionWidget extends _5804.StatusTransitionWidget
    implements _36c2.Box<_5804.StatusTransitionWidget> {
  RTManagedStatusTransitionWidget(
      {_ab4a.Key? key,
  ...
  @_fac9.override
  _e2dc.State<_5804.StatusTransitionWidget> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_5804.StatusTransitionWidget>,
            _5804.StatusTransitionWidget>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadStatusTransitionWidget(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['statusTransitionWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStatusTransitionWidget(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          animation: _36c2.maybeUnBoxAndBuildArgument<
  ...
  _36c2.registerBoxer<_5804.StatusTransitionWidget>(boxer: (
      {required _5804.StatusTransitionWidget vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedStatusTransitionWidget(

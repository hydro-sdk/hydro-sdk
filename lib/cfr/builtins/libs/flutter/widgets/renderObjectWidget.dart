...
class VMManagedRenderObjectWidget extends VMManagedBox<RenderObjectWidget> {
  VMManagedRenderObjectWidget(
    ...
    table['createElement'] =
      ...
      return [
        maybeBoxObject<RenderObjectElement>(
  ...
  final RenderObjectWidget vmObject;
}

class RTManagedRenderObjectWidget extends RenderObjectWidget
    implements Box<RenderObjectWidget> {
  ...
  RenderObjectWidget unwrap() => this;
  RenderObjectWidget get vmObject => this;
  @override
  RenderObjectElement createElement() {
    Closure closure = table["createElement"];
    return maybeUnBoxAndBuildArgument<RenderObjectElement, dynamic>(
...
void loadRenderObjectWidget(
  ...
  registerBoxer<RenderObjectWidget>(boxer: (
      {required RenderObjectWidget vmObject,

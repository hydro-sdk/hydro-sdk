...
class VMManagedRenderObjectWidget extends _36c2.VMManagedBox<_e2dc.RenderObjectWidget> {VMManagedRenderObjectWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.RenderObjectWidget vmObject;

 }

class RTManagedRenderObjectWidget extends _e2dc.RenderObjectWidget implements _36c2.Box<_e2dc.RenderObjectWidget> {RTManagedRenderObjectWidget({_ab4a.Key? key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.RenderObjectWidget unwrap() => this;
_e2dc.RenderObjectWidget get vmObject => this;
...
void loadRenderObjectWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderObjectWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderObjectWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.RenderObjectWidget>(boxer: ({required _e2dc.RenderObjectWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderObjectWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

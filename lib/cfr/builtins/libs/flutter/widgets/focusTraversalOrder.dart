...
class VMManagedFocusTraversalOrder extends _36c2.VMManagedBox<_65d3.FocusTraversalOrder> {VMManagedFocusTraversalOrder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'order'
] = _36c2.maybeBoxObject<_65d3.FocusOrder>(object: vmObject.order, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(luaCallerArguments  [
1
...
final _65d3.FocusTraversalOrder vmObject;

 }

class RTManagedFocusTraversalOrder extends _65d3.FocusTraversalOrder implements _36c2.Box<_65d3.FocusTraversalOrder> {RTManagedFocusTraversalOrder({_ab4a.Key? key, required _e2dc.Widget child, required _65d3.FocusOrder order, required this.table, required this.hydroState}) : super(key: key,child: child,order: order) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'order'
] = _36c2.maybeBoxObject(object: this.order, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_65d3.FocusTraversalOrder unwrap() => this;
_65d3.FocusTraversalOrder get vmObject => this;
...
void loadFocusTraversalOrder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusTraversalOrder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedFocusTraversalOrder(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), order: _36c2.maybeUnBoxAndBuildArgument<_65d3.FocusOrder, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'order'
] : null, parentState: hydroState))]; } );
table  [
'focusTraversalOrderOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_65d3.FocusOrder>(object: _65d3.FocusTraversalOrder.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'focusTraversalOrderMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _65d3.FocusTraversalOrder.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_65d3.FocusOrder?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_65d3.FocusTraversalOrder>(boxer: ({required _65d3.FocusTraversalOrder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusTraversalOrder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

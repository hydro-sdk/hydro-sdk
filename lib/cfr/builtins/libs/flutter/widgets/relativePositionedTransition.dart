...
class VMManagedRelativePositionedTransition
    extends _36c2.VMManagedBox<_d7ad.RelativePositionedTransition> {
  VMManagedRelativePositionedTransition(
...
class RTManagedRelativePositionedTransition
    extends _d7ad.RelativePositionedTransition
    implements _36c2.Box<_d7ad.RelativePositionedTransition> {
  RTManagedRelativePositionedTransition(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _86ca.Animation<_a643.Rect?> rect,
      required _a643.Size size,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, rect: rect, size: size) {
  ...
  @_fac9.override
  _86ca.Animation<_a643.Rect?> get rect {
...
void loadRelativePositionedTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['relativePositionedTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRelativePositionedTransition(
  ...
  _36c2.registerBoxer<_d7ad.RelativePositionedTransition>(boxer: (
      {required _d7ad.RelativePositionedTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRelativePositionedTransition(

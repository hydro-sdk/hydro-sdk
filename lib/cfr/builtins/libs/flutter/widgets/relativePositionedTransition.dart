...
class VMManagedRelativePositionedTransition extends _36c2.VMManagedBox<_d7ad.RelativePositionedTransition> {VMManagedRelativePositionedTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.rect, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.RelativePositionedTransition vmObject;

 }

class RTManagedRelativePositionedTransition extends _d7ad.RelativePositionedTransition implements _36c2.Box<_d7ad.RelativePositionedTransition> {RTManagedRelativePositionedTransition({_ab4a.Key? key, required _e2dc.Widget child, required _86ca.Animation<_a643.Rect?> rect, required _a643.Size size, required this.table, required this.hydroState}) : super(key: key,child: child,rect: rect,size: size) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.RelativePositionedTransition unwrap() => this;
_d7ad.RelativePositionedTransition get vmObject => this;
@_fac9.override _86ca.Animation<_a643.Rect?> get rect { 
_36c2.Closure closure = table["getRect"];
return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Rect?>, _a643.Rect?>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRelativePositionedTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'relativePositionedTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRelativePositionedTransition(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), rect: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Rect?>, _a643.Rect?>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rect'
...
_36c2.registerBoxer<_d7ad.RelativePositionedTransition>(boxer: ({required _d7ad.RelativePositionedTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRelativePositionedTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

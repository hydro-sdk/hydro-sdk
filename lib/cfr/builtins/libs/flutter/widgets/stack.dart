...
class VMManagedStack extends _36c2.VMManagedBox<_3960.Stack> {VMManagedStack({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b1b6.RenderStack>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderStack, _fac9.dynamic>(luaCallerArguments  [
2
...
class RTManagedStack extends _3960.Stack implements _36c2.Box<_3960.Stack> {RTManagedStack({required _ca85.AlignmentGeometry alignment, required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, required _b1b6.StackFit fit, _ab4a.Key? key, required _b1b6.Overflow overflow, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,clipBehavior: clipBehavior,fit: fit,key: key,overflow: overflow,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'fit'
] = _b1b6.StackFit.values.indexWhere((x) { return x == this.fit; } );
table  [
'overflow'
] = _b1b6.Overflow.values.indexWhere((x) { return x == this.overflow; } );
table  [
'clipBehavior'
...
@_fac9.override _b1b6.RenderStack createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_b1b6.RenderStack, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadStack({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'stack'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedStack(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), overflow: _36c2.maybeUnBoxEnum(values: _b1b6.Overflow.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'overflow'
...
_36c2.registerBoxer<_3960.Stack>(boxer: ({required _3960.Stack vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStack(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedStatelessElement extends _36c2.VMManagedBox<_e2dc.StatelessElement> {VMManagedStatelessElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.StatelessWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget, _fac9.dynamic>(luaCallerArguments  [
1
...
final _e2dc.StatelessElement vmObject;

 }

class RTManagedStatelessElement extends _e2dc.StatelessElement implements _36c2.Box<_e2dc.StatelessElement> {RTManagedStatelessElement(_e2dc.StatelessWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_update'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.update(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget, _fac9.dynamic>(
...
_e2dc.StatelessElement unwrap() => this;
_e2dc.StatelessElement get vmObject => this;
@_fac9.override _e2dc.StatelessWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadStatelessElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statelessElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedStatelessElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.StatelessElement>(boxer: ({required _e2dc.StatelessElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatelessElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

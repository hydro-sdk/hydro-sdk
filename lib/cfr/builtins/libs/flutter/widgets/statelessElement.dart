...
class VMManagedStatelessElement
    extends _36c2.VMManagedBox<_e2dc.StatelessElement> {
  VMManagedStatelessElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_e2dc.StatelessWidget>(
    ...
    table['update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget,
...
class RTManagedStatelessElement extends _e2dc.StatelessElement
    implements _36c2.Box<_e2dc.StatelessElement> {
  RTManagedStatelessElement(_e2dc.StatelessWidget widget$,
    ...
    table['_dart_update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _e2dc.StatelessWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget, _fac9.dynamic>(
...
void loadStatelessElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['statelessElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStatelessElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.StatelessWidget,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e2dc.StatelessElement>(boxer: (
      {required _e2dc.StatelessElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedStatelessElement(

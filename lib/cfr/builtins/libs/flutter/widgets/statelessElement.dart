...
class VMManagedStatelessElement extends VMManagedBox<StatelessElement> {
  VMManagedStatelessElement(
    ...
    table['getWidget'] =
      ...
      return [
        maybeBoxObject<StatelessWidget>(
    ...
    table['update'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.update(maybeUnBoxAndBuildArgument<StatelessWidget, dynamic>(
  ...
  final StatelessElement vmObject;
}

class RTManagedStatelessElement extends StatelessElement
    implements Box<StatelessElement> {
  RTManagedStatelessElement(StatelessWidget widget$,
    ...
    table['_dart_update'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.update(maybeUnBoxAndBuildArgument<StatelessWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  StatelessElement unwrap() => this;
  StatelessElement get vmObject => this;
  @override
  StatelessWidget get widget {
    Closure closure = table["getWidget"];
    return maybeUnBoxAndBuildArgument<StatelessWidget, dynamic>(
...
void loadStatelessElement(
  ...
  table['statelessElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedStatelessElement(
          maybeUnBoxAndBuildArgument<StatelessWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<StatelessElement>(boxer: (
      {required StatelessElement vmObject,

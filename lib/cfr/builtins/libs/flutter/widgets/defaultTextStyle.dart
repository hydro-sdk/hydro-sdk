...
class VMManagedDefaultTextStyle extends _36c2.VMManagedBox<_0eb7.DefaultTextStyle> {VMManagedDefaultTextStyle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_0eb7.DefaultTextStyle, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'wrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.wrap(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _0eb7.DefaultTextStyle vmObject;

 }

class RTManagedDefaultTextStyle extends _0eb7.DefaultTextStyle implements _36c2.Box<_0eb7.DefaultTextStyle> {RTManagedDefaultTextStyle({_ab4a.Key? key, _fac9.int? maxLines, required _fe5a.TextOverflow overflow, required _fac9.bool softWrap, _a643.TextAlign? textAlign, _a643.TextHeightBehavior? textHeightBehavior, required _fe5a.TextWidthBasis textWidthBasis, required _e2dc.Widget child, required _74d0.TextStyle style, required this.table, required this.hydroState}) : super(key: key,maxLines: maxLines,overflow: overflow,softWrap: softWrap,textAlign: textAlign,textHeightBehavior: textHeightBehavior,textWidthBasis: textWidthBasis,child: child,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_0eb7.DefaultTextStyle unwrap() => this;
_0eb7.DefaultTextStyle get vmObject => this;
@_fac9.override _fac9.bool updateShouldNotify(oldWidget) { 
_36c2.Closure closure = table["updateShouldNotify"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Widget wrap(context, child) { 
...
void loadDefaultTextStyle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'defaultTextStyle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedDefaultTextStyle(table: luaCallerArguments  [
0
...
'textHeightBehavior'
] : null, parentState: hydroState), textWidthBasis: _36c2.maybeUnBoxEnum(values: _fe5a.TextWidthBasis.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textWidthBasis'
...
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: _0eb7.DefaultTextStyle.merge(key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null, parentState: hydroState), maxLines: luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'textAlign'
] : null), textWidthBasis: _36c2.maybeUnBoxEnum(values: _fe5a.TextWidthBasis.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textWidthBasis'
] : null), child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
table  [
'defaultTextStyleOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_0eb7.DefaultTextStyle>(object: _0eb7.DefaultTextStyle.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_0eb7.DefaultTextStyle>(boxer: ({required _0eb7.DefaultTextStyle vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDefaultTextStyle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

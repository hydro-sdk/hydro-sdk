...
class VMManagedDefaultTextStyle
    extends _36c2.VMManagedBox<_0eb7.DefaultTextStyle> {
  VMManagedDefaultTextStyle(
...
class RTManagedDefaultTextStyle extends _0eb7.DefaultTextStyle
    implements _36c2.Box<_0eb7.DefaultTextStyle> {
  RTManagedDefaultTextStyle(
      {_ab4a.Key? key,
      _fac9.int? maxLines,
...
void loadDefaultTextStyle(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultTextStyle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultTextStyle(
          ...
          textAlign: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          textHeightBehavior:
              _36c2.maybeUnBoxAndBuildArgument<_a643.TextHeightBehavior?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['textHeightBehavior'] : null,
                  parentState: hydroState),
          textWidthBasis: _36c2.maybeUnBoxEnum(
              values: _fe5a.TextWidthBasis.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['textWidthBasis']
                  : null),
  ...
  table['defaultTextStyleMerge'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_e2dc.Widget>(
          object: _0eb7.DefaultTextStyle.merge(
              key: _36c2
  ...
  table['defaultTextStyleOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_0eb7.DefaultTextStyle>(
          object: _0eb7.DefaultTextStyle.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_0eb7.DefaultTextStyle>(boxer: (
      {required _0eb7.DefaultTextStyle vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultTextStyle(

...
import 'package:flutter/src/widgets/navigation_toolbar.dart' as _893c;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedNavigationToolbar extends _36c2.VMManagedBox<_893c.NavigationToolbar> {VMManagedNavigationToolbar({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'centerMiddle'
] = vmObject.centerMiddle;
table  [
'middleSpacing'
] = vmObject.middleSpacing;
table  [
'key'
...
final _893c.NavigationToolbar vmObject;

 }

class RTManagedNavigationToolbar extends _893c.NavigationToolbar implements _36c2.Box<_893c.NavigationToolbar> {RTManagedNavigationToolbar({required _fac9.bool centerMiddle, _ab4a.Key? key, _e2dc.Widget? leading, _e2dc.Widget? middle, required _fac9.double middleSpacing, _e2dc.Widget? trailing, required this.table, required this.hydroState}) : super(centerMiddle: centerMiddle,key: key,leading: leading,middle: middle,middleSpacing: middleSpacing,trailing: trailing) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'centerMiddle'
] = _36c2.maybeBoxObject(object: this.centerMiddle, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'middleSpacing'
] = _36c2.maybeBoxObject(object: this.middleSpacing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_893c.NavigationToolbar unwrap() => this;
_893c.NavigationToolbar get vmObject => this;
...
void loadNavigationToolbar({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'navigationToolbar'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedNavigationToolbar(table: luaCallerArguments  [
0
], hydroState: hydroState, centerMiddle: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'centerMiddle'
...
'middle'
] : null, parentState: hydroState), middleSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'middleSpacing'
] : null?.toDouble(), trailing: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'trailing'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_893c.NavigationToolbar>(boxer: ({required _893c.NavigationToolbar vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedNavigationToolbar(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSelectIntent extends _36c2.VMManagedBox<_c0f4.SelectIntent> {VMManagedSelectIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c0f4.SelectIntent vmObject;

 }

class RTManagedSelectIntent extends _c0f4.SelectIntent implements _36c2.Box<_c0f4.SelectIntent> {RTManagedSelectIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.SelectIntent unwrap() => this;
_c0f4.SelectIntent get vmObject => this;
...
void loadSelectIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'selectIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSelectIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.SelectIntent>(boxer: ({required _c0f4.SelectIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSelectIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

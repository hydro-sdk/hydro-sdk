...
class VMManagedDeleteByLineTextIntent extends _36c2.VMManagedBox<_380d.DeleteByLineTextIntent> {VMManagedDeleteByLineTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.DeleteByLineTextIntent vmObject;

 }

class RTManagedDeleteByLineTextIntent extends _380d.DeleteByLineTextIntent implements _36c2.Box<_380d.DeleteByLineTextIntent> {RTManagedDeleteByLineTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.DeleteByLineTextIntent unwrap() => this;
_380d.DeleteByLineTextIntent get vmObject => this;
...
void loadDeleteByLineTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'deleteByLineTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDeleteByLineTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.DeleteByLineTextIntent>(boxer: ({required _380d.DeleteByLineTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDeleteByLineTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

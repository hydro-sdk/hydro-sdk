...
class VMManagedSliverOverlapInjector extends _36c2.VMManagedBox<_c812.SliverOverlapInjector> {VMManagedSliverOverlapInjector({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_c812.RenderSliverOverlapInjector>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_c812.RenderSliverOverlapInjector, _fac9.dynamic>(luaCallerArguments  [
2
...
final _c812.SliverOverlapInjector vmObject;

 }

class RTManagedSliverOverlapInjector extends _c812.SliverOverlapInjector implements _36c2.Box<_c812.SliverOverlapInjector> {RTManagedSliverOverlapInjector({_ab4a.Key? key, _e2dc.Widget? sliver, required _c812.SliverOverlapAbsorberHandle handle, required this.table, required this.hydroState}) : super(key: key,sliver: sliver,handle: handle) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_c812.RenderSliverOverlapInjector,
...
_c812.SliverOverlapInjector unwrap() => this;
_c812.SliverOverlapInjector get vmObject => this;
@_fac9.override _c812.RenderSliverOverlapInjector createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_c812.RenderSliverOverlapInjector, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverOverlapInjector({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverOverlapInjector'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverOverlapInjector(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_c812.SliverOverlapInjector>(boxer: ({required _c812.SliverOverlapInjector vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverOverlapInjector(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

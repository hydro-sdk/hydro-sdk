...
import 'package:flutter/src/widgets/scroll_notification_observer.dart' as _b166;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedScrollNotificationObserver extends _36c2.VMManagedBox<_b166.ScrollNotificationObserver> {VMManagedScrollNotificationObserver({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b166.ScrollNotificationObserverState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _b166.ScrollNotificationObserver vmObject;

 }

class RTManagedScrollNotificationObserver extends _b166.ScrollNotificationObserver implements _36c2.Box<_b166.ScrollNotificationObserver> {RTManagedScrollNotificationObserver({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_b166.ScrollNotificationObserver unwrap() => this;
_b166.ScrollNotificationObserver get vmObject => this;
@_fac9.override _b166.ScrollNotificationObserverState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_b166.ScrollNotificationObserverState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadScrollNotificationObserver({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollNotificationObserver'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedScrollNotificationObserver(table: luaCallerArguments  [
0
...
table  [
'scrollNotificationObserverOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _b166.ScrollNotificationObserver.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_b166.ScrollNotificationObserverState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_b166.ScrollNotificationObserver>(boxer: ({required _b166.ScrollNotificationObserver vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollNotificationObserver(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

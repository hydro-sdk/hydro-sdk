...
class VMManagedScrollDragController
    extends _36c2.VMManagedBox<_ca8b.ScrollDragController> {
  VMManagedScrollDragController(
    ...
    table['carriedVelocity'] = vmObject.carriedVelocity;
    table['motionStartDistanceThreshold'] =
    ...
    table['getLastDetails'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.lastDetails,
      ];
    });
...
class RTManagedScrollDragController extends _ca8b.ScrollDragController
    implements _36c2.Box<_ca8b.ScrollDragController> {
  RTManagedScrollDragController(
      {_fac9.double? carriedVelocity,
      _fac9.double? motionStartDistanceThreshold,
      void Function()? onDragCanceled,
      required _ca8b.ScrollActivityDelegate delegate,
      required _4bc7.DragStartDetails details,
      required this.table,
    ...
    table['carriedVelocity'] = _36c2.maybeBoxObject(
        object: this.carriedVelocity,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['motionStartDistanceThreshold'] = _36c2.maybeBoxObject(
        object: this.motionStartDistanceThreshold,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getLastDetails'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadScrollDragController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollDragController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonDragCanceled = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onDragCanceled']
        : null;
    ...
    return [
      RTManagedScrollDragController(
          ...
          hydroState: hydroState,
          carriedVelocity: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['carriedVelocity']
              : null?.toDouble(),
          motionStartDistanceThreshold: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['motionStartDistanceThreshold']
              : null?.toDouble(),
          ...
          delegate: _36c2.maybeUnBoxAndBuildArgument<
              ...
              parentState: hydroState),
          details: _36c2
              .maybeUnBoxAndBuildArgument<_4bc7.DragStartDetails, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_ca8b.ScrollDragController>(boxer: (
      {required _ca8b.ScrollDragController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollDragController(

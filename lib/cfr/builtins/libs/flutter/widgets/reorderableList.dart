...
class VMManagedReorderableList extends _36c2.VMManagedBox<_acd7.ReorderableList> {VMManagedReorderableList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'prototypeItem'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.prototypeItem, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
] = _36c2.maybeBoxObject<_ab4a.Key?>(object: vmObject.key, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_acd7.ReorderableListState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
class RTManagedReorderableList extends _acd7.ReorderableList implements _36c2.Box<_acd7.ReorderableList> {RTManagedReorderableList({required _fac9.double anchor, _fac9.double? cacheExtent, required _a643.Clip clipBehavior, _9585.ScrollController? controller, required _02d2.DragStartBehavior dragStartBehavior, _fac9.double? itemExtent, _ab4a.Key? key, required _2b56.ScrollViewKeyboardDismissBehavior keyboardDismissBehavior, _96d1.EdgeInsetsGeometry? padding, _dbad.ScrollPhysics? physics, _fac9.bool? primary, _e2dc.Widget? prototypeItem, _e2dc.Widget Function(_e2dc.Widget child, _fac9.int index, _86ca.Animation<_fac9.double> animation)? proxyDecorator, _fac9.String? restorationId, required _fac9.bool reverse, required _487f.Axis scrollDirection, required _fac9.bool shrinkWrap, required _e2dc.Widget Function(_e2dc.BuildContext context, _fac9.int index) itemBuilder, required _fac9.int itemCount, required void Function(_fac9.int oldIndex, _fac9.int newIndex) onReorder, required this.table, required this.hydroState}) : super(anchor: anchor,cacheExtent: cacheExtent,clipBehavior: clipBehavior,controller: controller,dragStartBehavior: dragStartBehavior,itemExtent: itemExtent,key: key,keyboardDismissBehavior: keyboardDismissBehavior,padding: padding,physics: physics,primary: primary,prototypeItem: prototypeItem,proxyDecorator: proxyDecorator,restorationId: restorationId,reverse: reverse,scrollDirection: scrollDirection,shrinkWrap: shrinkWrap,itemBuilder: itemBuilder,itemCount: itemCount,onReorder: onReorder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'itemCount'
] = _36c2.maybeBoxObject(object: this.itemCount, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'padding'
...
table  [
'prototypeItem'
] = _36c2.maybeBoxObject(object: this.prototypeItem, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
@_fac9.override _acd7.ReorderableListState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_acd7.ReorderableListState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadReorderableList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'reorderableList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedproxyDecorator=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'proxyDecorator'
] : null;
...
_36c2.Closure unpackedonReorder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onReorder'
] : null;
return  [RTManagedReorderableList(table: luaCallerArguments  [
0
...
'cacheExtent'
] : null?.toDouble(), clipBehavior: _36c2.maybeUnBoxEnum(values: _a643.Clip.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipBehavior'
...
'dragStartBehavior'
] : null), itemExtent: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'itemExtent'
...
'primary'
] : null, prototypeItem: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'prototypeItem'
] : null, parentState: hydroState), proxyDecorator: unpackedproxyDecorator != null ? (child, index, animation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedproxyDecorator.dispatch([luaCallerArguments[0],child,index,animation],parentState:hydroState,)[0], parentState: hydroState) : null , restorationId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'restorationId'
...
'shrinkWrap'
] : null, itemBuilder: (context, index) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackeditemBuilder.dispatch([luaCallerArguments[0],context,index],parentState:hydroState,)[0], parentState: hydroState), itemCount: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'itemCount'
] : null, onReorder: (oldIndex, newIndex) => unpackedonReorder.dispatch([luaCallerArguments[0],oldIndex,newIndex],parentState:hydroState,))]; } );
table  [
'reorderableListOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_acd7.ReorderableListState>(object: _acd7.ReorderableList.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'reorderableListMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _acd7.ReorderableList.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_acd7.ReorderableListState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_acd7.ReorderableList>(boxer: ({required _acd7.ReorderableList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedReorderableList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

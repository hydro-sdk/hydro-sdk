...
class VMManagedUnmanagedRestorationScope extends _36c2.VMManagedBox<_487b.UnmanagedRestorationScope> {VMManagedUnmanagedRestorationScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'bucket'
] = _36c2.maybeBoxObject<_6d4f.RestorationBucket?>(object: vmObject.bucket, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_487b.UnmanagedRestorationScope, _fac9.dynamic>(luaCallerArguments  [
1
...
final _487b.UnmanagedRestorationScope vmObject;

 }

class RTManagedUnmanagedRestorationScope extends _487b.UnmanagedRestorationScope implements _36c2.Box<_487b.UnmanagedRestorationScope> {RTManagedUnmanagedRestorationScope({_6d4f.RestorationBucket? bucket, _ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(bucket: bucket,key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'bucket'
] = _36c2.maybeBoxObject(object: this.bucket, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
            _487b.UnmanagedRestorationScope,
...
_487b.UnmanagedRestorationScope unwrap() => this;
_487b.UnmanagedRestorationScope get vmObject => this;
...
void loadUnmanagedRestorationScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'unmanagedRestorationScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedUnmanagedRestorationScope(table: luaCallerArguments  [
0
], hydroState: hydroState, bucket: _36c2.maybeUnBoxAndBuildArgument<_6d4f.RestorationBucket?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bucket'
...
_36c2.registerBoxer<_487b.UnmanagedRestorationScope>(boxer: ({required _487b.UnmanagedRestorationScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedUnmanagedRestorationScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

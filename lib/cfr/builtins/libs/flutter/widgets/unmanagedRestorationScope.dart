...
class VMManagedUnmanagedRestorationScope
    extends _36c2.VMManagedBox<_487b.UnmanagedRestorationScope> {
  VMManagedUnmanagedRestorationScope(
    ...
    table['bucket'] = _36c2.maybeBoxObject<_6d4f.RestorationBucket?>(
        object: vmObject.bucket,
        hydroState: hydroState,
...
class RTManagedUnmanagedRestorationScope extends _487b.UnmanagedRestorationScope
    implements _36c2.Box<_487b.UnmanagedRestorationScope> {
  RTManagedUnmanagedRestorationScope(
      {_6d4f.RestorationBucket? bucket,
      _ab4a.Key? key,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(bucket: bucket, key: key, child: child) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['bucket'] = _36c2.maybeBoxObject(
        object: this.bucket, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadUnmanagedRestorationScope(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['unmanagedRestorationScope'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedUnmanagedRestorationScope(
  ...
  _36c2.registerBoxer<_487b.UnmanagedRestorationScope>(boxer: (
      {required _487b.UnmanagedRestorationScope vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedUnmanagedRestorationScope(

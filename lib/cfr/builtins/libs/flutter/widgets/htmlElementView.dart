...
class VMManagedHtmlElementView extends _36c2.VMManagedBox<_172d.HtmlElementView> {VMManagedHtmlElementView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _172d.HtmlElementView vmObject;

 }

class RTManagedHtmlElementView extends _172d.HtmlElementView implements _36c2.Box<_172d.HtmlElementView> {RTManagedHtmlElementView({_ab4a.Key? key, void Function(_fac9.int id)? onPlatformViewCreated, required _fac9.String viewType, required this.table, required this.hydroState}) : super(key: key,onPlatformViewCreated: onPlatformViewCreated,viewType: viewType) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_172d.HtmlElementView unwrap() => this;
_172d.HtmlElementView get vmObject => this;
...
void loadHtmlElementView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'htmlElementView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedHtmlElementView(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onPlatformViewCreated: unpackedonPlatformViewCreated != null ? (id) => unpackedonPlatformViewCreated.dispatch([luaCallerArguments[0],id],parentState:hydroState,) : null , viewType: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewType'
] : null)]; } );
_36c2.registerBoxer<_172d.HtmlElementView>(boxer: ({required _172d.HtmlElementView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHtmlElementView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

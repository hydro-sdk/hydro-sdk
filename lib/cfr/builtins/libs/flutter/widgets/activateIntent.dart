...
class VMManagedActivateIntent extends _36c2.VMManagedBox<_c0f4.ActivateIntent> {VMManagedActivateIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c0f4.ActivateIntent vmObject;

 }

class RTManagedActivateIntent extends _c0f4.ActivateIntent implements _36c2.Box<_c0f4.ActivateIntent> {RTManagedActivateIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.ActivateIntent unwrap() => this;
_c0f4.ActivateIntent get vmObject => this;
...
void loadActivateIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'activateIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedActivateIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.ActivateIntent>(boxer: ({required _c0f4.ActivateIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedActivateIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

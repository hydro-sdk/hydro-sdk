...
class VMManagedSingleChildRenderObjectWidget
    extends _36c2.VMManagedBox<_e2dc.SingleChildRenderObjectWidget> {
...
class RTManagedSingleChildRenderObjectWidget
    extends _e2dc.SingleChildRenderObjectWidget
    implements _36c2.Box<_e2dc.SingleChildRenderObjectWidget> {
...
void loadSingleChildRenderObjectWidget(
  ...
  table['singleChildRenderObjectWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSingleChildRenderObjectWidget(
  ...
  _36c2.registerBoxer<_e2dc.SingleChildRenderObjectWidget>(boxer: (
      {required _e2dc.SingleChildRenderObjectWidget vmObject,

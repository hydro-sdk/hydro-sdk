...
class VMManagedSingleChildRenderObjectWidget extends _36c2.VMManagedBox<_e2dc.SingleChildRenderObjectWidget> {VMManagedSingleChildRenderObjectWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.SingleChildRenderObjectWidget vmObject;

 }

class RTManagedSingleChildRenderObjectWidget extends _e2dc.SingleChildRenderObjectWidget implements _36c2.Box<_e2dc.SingleChildRenderObjectWidget> {RTManagedSingleChildRenderObjectWidget({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.SingleChildRenderObjectWidget unwrap() => this;
_e2dc.SingleChildRenderObjectWidget get vmObject => this;
...
void loadSingleChildRenderObjectWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'singleChildRenderObjectWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSingleChildRenderObjectWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e2dc.SingleChildRenderObjectWidget>(boxer: ({required _e2dc.SingleChildRenderObjectWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSingleChildRenderObjectWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

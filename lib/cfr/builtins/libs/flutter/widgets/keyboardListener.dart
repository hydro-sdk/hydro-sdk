...
class VMManagedKeyboardListener
    extends _36c2.VMManagedBox<_aac9.KeyboardListener> {
  VMManagedKeyboardListener(
...
class RTManagedKeyboardListener extends _aac9.KeyboardListener
    implements _36c2.Box<_aac9.KeyboardListener> {
  RTManagedKeyboardListener(
      {required _fac9.bool autofocus,
      required _fac9.bool includeSemantics,
      _ab4a.Key? key,
      void Function(_9e29.KeyEvent value)? onKeyEvent,
...
void loadKeyboardListener(
  ...
  table['keyboardListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedKeyboardListener(
          ...
          onKeyEvent: unpackedonKeyEvent != null
              ? (value) => unpackedonKeyEvent.dispatch(
  ...
  _36c2.registerBoxer<_aac9.KeyboardListener>(boxer: (
      {required _aac9.KeyboardListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedKeyboardListener(

...
class VMManagedStatefulBuilder extends _36c2.VMManagedBox<_3960.StatefulBuilder> {VMManagedStatefulBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.StatefulBuilder vmObject;

 }

class RTManagedStatefulBuilder extends _3960.StatefulBuilder implements _36c2.Box<_3960.StatefulBuilder> {RTManagedStatefulBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, void Function(void Function() fn) setState) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.StatefulBuilder unwrap() => this;
_3960.StatefulBuilder get vmObject => this;
@_fac9.override _e2dc.State<_3960.StatefulBuilder> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_3960.StatefulBuilder>, _3960.StatefulBuilder>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadStatefulBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'statefulBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedStatefulBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), builder: (context, setState) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,setState],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_3960.StatefulBuilder>(boxer: ({required _3960.StatefulBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStatefulBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

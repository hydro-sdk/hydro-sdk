...
class VMManagedAnimatedAlign extends _36c2.VMManagedBox<_da7c.AnimatedAlign> {VMManagedAnimatedAlign({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.AnimatedAlign vmObject;

 }

class RTManagedAnimatedAlign extends _da7c.AnimatedAlign implements _36c2.Box<_da7c.AnimatedAlign> {RTManagedAnimatedAlign({_e2dc.Widget? child, required _8c47.Curve curve, _fac9.double? heightFactor, _ab4a.Key? key, void Function()? onEnd, _fac9.double? widthFactor, required _ca85.AlignmentGeometry alignment, required _fac9.Duration duration, required this.table, required this.hydroState}) : super(child: child,curve: curve,heightFactor: heightFactor,key: key,onEnd: onEnd,widthFactor: widthFactor,alignment: alignment,duration: duration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.AnimatedAlign unwrap() => this;
_da7c.AnimatedAlign get vmObject => this;
@_fac9.override _da7c.AnimatedWidgetBaseState<_da7c.AnimatedAlign> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.AnimatedWidgetBaseState<_da7c.AnimatedAlign>, _da7c.AnimatedAlign>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedAlign({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedAlign'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedAlign(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onEnd: unpackedonEnd != null ? () => unpackedonEnd.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , widthFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'widthFactor'
] : null?.toDouble(), alignment: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alignment'
...
_36c2.registerBoxer<_da7c.AnimatedAlign>(boxer: ({required _da7c.AnimatedAlign vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedAlign(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

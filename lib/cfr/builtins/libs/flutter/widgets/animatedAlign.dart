...
class VMManagedAnimatedAlign extends _36c2.VMManagedBox<_da7c.AnimatedAlign> {
  VMManagedAnimatedAlign(
...
class RTManagedAnimatedAlign extends _da7c.AnimatedAlign
    implements _36c2.Box<_da7c.AnimatedAlign> {
  RTManagedAnimatedAlign(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _da7c.AnimatedWidgetBaseState<_da7c.AnimatedAlign> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _da7c.AnimatedWidgetBaseState<_da7c.AnimatedAlign>,
            _da7c.AnimatedAlign>(
...
void loadAnimatedAlign(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedAlign'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedAnimatedAlign(
          ...
          alignment: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['alignment'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_da7c.AnimatedAlign>(boxer: (
      {required _da7c.AnimatedAlign vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedAlign(

...
class VMManagedScaleTransition extends _36c2.VMManagedBox<_d7ad.ScaleTransition> {VMManagedScaleTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getScale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.scale, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.ScaleTransition vmObject;

 }

class RTManagedScaleTransition extends _d7ad.ScaleTransition implements _36c2.Box<_d7ad.ScaleTransition> {RTManagedScaleTransition({required _ca85.Alignment alignment, _e2dc.Widget? child, _a643.FilterQuality? filterQuality, _ab4a.Key? key, required _86ca.Animation<_fac9.double> scale, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,filterQuality: filterQuality,key: key,scale: scale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.ScaleTransition unwrap() => this;
_d7ad.ScaleTransition get vmObject => this;
@_fac9.override _86ca.Animation<_fac9.double> get scale { 
...
void loadScaleTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scaleTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedScaleTransition(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), scale: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scale'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.ScaleTransition>(boxer: ({required _d7ad.ScaleTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScaleTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScaleTransition
    extends _36c2.VMManagedBox<_d7ad.ScaleTransition> {
  VMManagedScaleTransition(
...
class RTManagedScaleTransition extends _d7ad.ScaleTransition
    implements _36c2.Box<_d7ad.ScaleTransition> {
  RTManagedScaleTransition(
      {required _ca85.Alignment alignment,
      _e2dc.Widget? child,
      _a643.FilterQuality? filterQuality,
      _ab4a.Key? key,
      required _86ca.Animation<_fac9.double> scale,
      required this.table,
  ...
  @_fac9.override
  _86ca.Animation<_fac9.double> get scale {
...
void loadScaleTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scaleTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScaleTransition(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          scale: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['scale'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.ScaleTransition>(boxer: (
      {required _d7ad.ScaleTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScaleTransition(

...
class VMManagedAutofillGroup extends _36c2.VMManagedBox<_689d.AutofillGroup> {VMManagedAutofillGroup({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'onDisposeAction'
] = _689d.AutofillContextAction.values.indexWhere((x) { return x == vmObject.onDisposeAction; } );
table  [
'key'
] = _36c2.maybeBoxObject<_ab4a.Key?>(object: vmObject.key, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_689d.AutofillGroupState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _689d.AutofillGroup vmObject;

 }

class RTManagedAutofillGroup extends _689d.AutofillGroup implements _36c2.Box<_689d.AutofillGroup> {RTManagedAutofillGroup({_ab4a.Key? key, required _689d.AutofillContextAction onDisposeAction, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,onDisposeAction: onDisposeAction,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'onDisposeAction'
] = _689d.AutofillContextAction.values.indexWhere((x) { return x == this.onDisposeAction; } );
table  [
'key'
...
_689d.AutofillGroup unwrap() => this;
_689d.AutofillGroup get vmObject => this;
@_fac9.override _689d.AutofillGroupState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_689d.AutofillGroupState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAutofillGroup({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'autofillGroup'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedAutofillGroup(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onDisposeAction: _36c2.maybeUnBoxEnum(values: _689d.AutofillContextAction.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onDisposeAction'
...
table  [
'autofillGroupOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _689d.AutofillGroup.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_689d.AutofillGroupState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_689d.AutofillGroup>(boxer: ({required _689d.AutofillGroup vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutofillGroup(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

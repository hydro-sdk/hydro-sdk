...
class VMManagedNavigatorObserver
    extends _36c2.VMManagedBox<_a37d.NavigatorObserver> {
  VMManagedNavigatorObserver(
...
class RTManagedNavigatorObserver extends _a37d.NavigatorObserver
    implements _36c2.Box<_a37d.NavigatorObserver> {
  RTManagedNavigatorObserver({required this.table, required this.hydroState})
      : super() {
...
void loadNavigatorObserver(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['navigatorObserver'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNavigatorObserver(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_a37d.NavigatorObserver>(boxer: (
      {required _a37d.NavigatorObserver vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNavigatorObserver(

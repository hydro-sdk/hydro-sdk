...
class VMManagedMoveSelectionRightTextIntent extends _36c2.VMManagedBox<_380d.MoveSelectionRightTextIntent> {VMManagedMoveSelectionRightTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.MoveSelectionRightTextIntent vmObject;

 }

class RTManagedMoveSelectionRightTextIntent extends _380d.MoveSelectionRightTextIntent implements _36c2.Box<_380d.MoveSelectionRightTextIntent> {RTManagedMoveSelectionRightTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.MoveSelectionRightTextIntent unwrap() => this;
_380d.MoveSelectionRightTextIntent get vmObject => this;
...
void loadMoveSelectionRightTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'moveSelectionRightTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMoveSelectionRightTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.MoveSelectionRightTextIntent>(boxer: ({required _380d.MoveSelectionRightTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMoveSelectionRightTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

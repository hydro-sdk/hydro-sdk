...
class VMManagedText extends _36c2.VMManagedBox<_0eb7.Text> {VMManagedText({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'textSpan'
] = _36c2.maybeBoxObject<_b761.InlineSpan?>(object: vmObject.textSpan, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'style'
...
class RTManagedText extends _0eb7.Text implements _36c2.Box<_0eb7.Text> {RTManagedText(_fac9.String data$, {_ab4a.Key? key, _a643.Locale? locale, _fac9.int? maxLines, _fe5a.TextOverflow? overflow, _fac9.String? semanticsLabel, _fac9.bool? softWrap, _ced4.StrutStyle? strutStyle, _74d0.TextStyle? style, _a643.TextAlign? textAlign, _a643.TextDirection? textDirection, _a643.TextHeightBehavior? textHeightBehavior, _fac9.double? textScaleFactor, _fe5a.TextWidthBasis? textWidthBasis, required this.table, required this.hydroState}) : super(data$,key: key,locale: locale,maxLines: maxLines,overflow: overflow,semanticsLabel: semanticsLabel,softWrap: softWrap,strutStyle: strutStyle,style: style,textAlign: textAlign,textDirection: textDirection,textHeightBehavior: textHeightBehavior,textScaleFactor: textScaleFactor,textWidthBasis: textWidthBasis) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'textSpan'
] = _36c2.maybeBoxObject(object: textSpan, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'style'
...
void loadText({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'text'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedText(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState, key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'key'
...
'overflow'
] : null), semanticsLabel: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'semanticsLabel'
...
'strutStyle'
] : null, parentState: hydroState), style: _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'style'
...
_36c2.registerBoxer<_0eb7.Text>(boxer: ({required _0eb7.Text vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedText(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

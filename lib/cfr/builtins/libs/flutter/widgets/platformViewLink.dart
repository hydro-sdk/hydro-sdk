...
class VMManagedPlatformViewLink extends _36c2.VMManagedBox<_172d.PlatformViewLink> {VMManagedPlatformViewLink({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _172d.PlatformViewLink vmObject;

 }

class RTManagedPlatformViewLink extends _172d.PlatformViewLink implements _36c2.Box<_172d.PlatformViewLink> {RTManagedPlatformViewLink({_ab4a.Key? key, required _40e3.PlatformViewController Function(_172d.PlatformViewCreationParams params) onCreatePlatformView, required _e2dc.Widget Function(_e2dc.BuildContext context, _40e3.PlatformViewController controller) surfaceFactory, required _fac9.String viewType, required this.table, required this.hydroState}) : super(key: key,onCreatePlatformView: onCreatePlatformView,surfaceFactory: surfaceFactory,viewType: viewType) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_172d.PlatformViewLink unwrap() => this;
_172d.PlatformViewLink get vmObject => this;
...
void loadPlatformViewLink({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'platformViewLink'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure unpackedonCreatePlatformView=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onCreatePlatformView'
] : null;
_36c2.Closure unpackedsurfaceFactory=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'surfaceFactory'
] : null;

return  [RTManagedPlatformViewLink(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onCreatePlatformView: (params) => _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(unpackedonCreatePlatformView.dispatch([luaCallerArguments[0],params],parentState:hydroState,)[0], parentState: hydroState), surfaceFactory: (context, controller) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedsurfaceFactory.dispatch([luaCallerArguments[0],context,controller],parentState:hydroState,)[0], parentState: hydroState), viewType: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewType'
] : null)]; } );
_36c2.registerBoxer<_172d.PlatformViewLink>(boxer: ({required _172d.PlatformViewLink vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformViewLink(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRoute extends _36c2.VMManagedBox<_a37d.Route<_fac9.dynamic>> {VMManagedRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a37d.Route<_fac9.dynamic> vmObject;

 }

class RTManagedRoute extends _a37d.Route implements _36c2.Box<_a37d.Route> {RTManagedRoute({_a37d.RouteSettings? settings, required this.table, required this.hydroState}) : super(settings: settings) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a37d.Route unwrap() => this;
_a37d.Route get vmObject => this;
...
void loadRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'route'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRoute(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a37d.Route>(boxer: ({required _a37d.Route vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRoute extends _36c2.VMManagedBox<_a37d.Route<_fac9.dynamic>> {
  VMManagedRoute(
...
class RTManagedRoute extends _a37d.Route implements _36c2.Box<_a37d.Route> {
  RTManagedRoute(
...
void loadRoute(
  ...
  _36c2.registerBoxer<_a37d.Route>(boxer: (
      {required _a37d.Route vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRoute(

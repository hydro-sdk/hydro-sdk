...
class VMManagedGlobalObjectKey extends _36c2
    .VMManagedBox<_e2dc.GlobalObjectKey<_e2dc.State<_e2dc.StatefulWidget>>> {
...
class RTManagedGlobalObjectKey extends _e2dc.GlobalObjectKey
    implements _36c2.Box<_e2dc.GlobalObjectKey> {
  RTManagedGlobalObjectKey(_fac9.Object value$,
...
void loadGlobalObjectKey(
  ...
  table['globalObjectKey'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.GlobalObjectKey>(boxer: (
      {required _e2dc.GlobalObjectKey vmObject,

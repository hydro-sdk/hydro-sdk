...
class VMManagedMoveSelectionDownTextIntent extends _36c2.VMManagedBox<_380d.MoveSelectionDownTextIntent> {VMManagedMoveSelectionDownTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.MoveSelectionDownTextIntent vmObject;

 }

class RTManagedMoveSelectionDownTextIntent extends _380d.MoveSelectionDownTextIntent implements _36c2.Box<_380d.MoveSelectionDownTextIntent> {RTManagedMoveSelectionDownTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.MoveSelectionDownTextIntent unwrap() => this;
_380d.MoveSelectionDownTextIntent get vmObject => this;
...
void loadMoveSelectionDownTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'moveSelectionDownTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMoveSelectionDownTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.MoveSelectionDownTextIntent>(boxer: ({required _380d.MoveSelectionDownTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMoveSelectionDownTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

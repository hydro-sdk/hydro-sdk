...
class VMManagedSliverChildBuilderDelegate
    extends _36c2.VMManagedBox<_a8eb.SliverChildBuilderDelegate> {
  VMManagedSliverChildBuilderDelegate(
...
class RTManagedSliverChildBuilderDelegate
    extends _a8eb.SliverChildBuilderDelegate
    implements _36c2.Box<_a8eb.SliverChildBuilderDelegate> {
  RTManagedSliverChildBuilderDelegate(builder,
      ...
      _fac9.int? Function(_ab4a.Key key)? findChildIndexCallback,
...
void loadSliverChildBuilderDelegate(
  ...
  table['sliverChildBuilderDelegate'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedbuilder = luaCallerArguments[1];

    _36c2.Closure? unpackedfindChildIndexCallback =
        luaCallerArguments.length >= 3
            ? luaCallerArguments[2]['findChildIndexCallback']
            : null;
    ...
    return [
      RTManagedSliverChildBuilderDelegate(
          (context, index) =>
          ...
          addSemanticIndexes: luaCallerArguments.length >= 3
              ...
              : null,
          childCount: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['childCount']
              : null,
          findChildIndexCallback: unpackedfindChildIndexCallback != null
              ? (key) => ((
                    final _fac9.List<_fac9.dynamic>? val,
                  ) =>
                      val != null && val.length >= 1 ? val[0] : null)(
                    unpackedfindChildIndexCallback.dispatch(
                      [luaCallerArguments[0], key],
                      parentState: hydroState,
                    ),
                  )
              : null,
  ...
  _36c2.registerBoxer<_a8eb.SliverChildBuilderDelegate>(boxer: (
      {required _a8eb.SliverChildBuilderDelegate vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverChildBuilderDelegate(

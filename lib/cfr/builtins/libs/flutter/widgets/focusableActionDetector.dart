...
class VMManagedFocusableActionDetector
    extends _36c2.VMManagedBox<_c0f4.FocusableActionDetector> {
  VMManagedFocusableActionDetector(
...
class RTManagedFocusableActionDetector extends _c0f4.FocusableActionDetector
    implements _36c2.Box<_c0f4.FocusableActionDetector> {
  RTManagedFocusableActionDetector(
      ...
      _ab4a.Key? key,
      required _fd33.MouseCursor mouseCursor,
      void Function(_fac9.bool value)? onFocusChange,
      void Function(_fac9.bool value)? onShowFocusHighlight,
      void Function(_fac9.bool value)? onShowHoverHighlight,
  ...
  @_fac9.override
  _e2dc.State<_c0f4.FocusableActionDetector> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_c0f4.FocusableActionDetector>,
            _c0f4.FocusableActionDetector>(
...
void loadFocusableActionDetector(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['focusableActionDetector'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonFocusChange = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onFocusChange']
        : null;
    _36c2.Closure? unpackedonShowFocusHighlight = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onShowFocusHighlight']
        : null;
    _36c2.Closure? unpackedonShowHoverHighlight = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onShowHoverHighlight']
        : null;
    ...
    return [
      RTManagedFocusableActionDetector(
          ...
          onFocusChange: unpackedonFocusChange != null
              ...
              : null,
          onShowFocusHighlight: unpackedonShowFocusHighlight != null
              ? (value) => unpackedonShowFocusHighlight.dispatch(
                    [luaCallerArguments[0], value],
                    parentState: hydroState,
                  )
              : null,
          onShowHoverHighlight: unpackedonShowHoverHighlight != null
              ? (value) => unpackedonShowHoverHighlight.dispatch(
                    [luaCallerArguments[0], value],
                    parentState: hydroState,
                  )
              : null,
  ...
  _36c2.registerBoxer<_c0f4.FocusableActionDetector>(boxer: (
      {required _c0f4.FocusableActionDetector vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusableActionDetector(

...
class VMManagedSingleChildScrollView
    extends _36c2.VMManagedBox<_597a.SingleChildScrollView> {
  VMManagedSingleChildScrollView(
...
class RTManagedSingleChildScrollView extends _597a.SingleChildScrollView
    implements _36c2.Box<_597a.SingleChildScrollView> {
  RTManagedSingleChildScrollView(
      {_e2dc.Widget? child,
...
void loadSingleChildScrollView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['singleChildScrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSingleChildScrollView(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          controller: _36c2
              .maybeUnBoxAndBuildArgument<_9585.ScrollController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['controller'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_597a.SingleChildScrollView>(boxer: (
      {required _597a.SingleChildScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSingleChildScrollView(

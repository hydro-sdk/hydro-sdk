...
class VMManagedColumn extends _36c2.VMManagedBox<_3960.Column> {VMManagedColumn({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.Column vmObject;

 }

class RTManagedColumn extends _3960.Column implements _36c2.Box<_3960.Column> {RTManagedColumn({required _fac9.List<_e2dc.Widget> children, required _7374.CrossAxisAlignment crossAxisAlignment, _ab4a.Key? key, required _7374.MainAxisAlignment mainAxisAlignment, required _7374.MainAxisSize mainAxisSize, _a643.TextBaseline? textBaseline, _a643.TextDirection? textDirection, required _487f.VerticalDirection verticalDirection, required this.table, required this.hydroState}) : super(children: children,crossAxisAlignment: crossAxisAlignment,key: key,mainAxisAlignment: mainAxisAlignment,mainAxisSize: mainAxisSize,textBaseline: textBaseline,textDirection: textDirection,verticalDirection: verticalDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'direction'
] = _487f.Axis.values.indexWhere((x) { return x == direction; } );
table  [
'mainAxisAlignment'
...
table  [
'clipBehavior'
] = _a643.Clip.values.indexWhere((x) { return x == clipBehavior; } );
table  [
'children'
...
_3960.Column unwrap() => this;
_3960.Column get vmObject => this;
...
void loadColumn({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'column'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedColumn(table: luaCallerArguments  [
0
...
'children'
] : null, parentState: hydroState), crossAxisAlignment: _36c2.maybeUnBoxEnum(values: _7374.CrossAxisAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'crossAxisAlignment'
...
_36c2.registerBoxer<_3960.Column>(boxer: ({required _3960.Column vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedColumn(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

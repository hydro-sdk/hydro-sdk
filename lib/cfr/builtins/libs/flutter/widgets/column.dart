...
class VMManagedColumn extends _36c2.VMManagedBox<_3960.Column> {
  VMManagedColumn(
...
class RTManagedColumn extends _3960.Column implements _36c2.Box<_3960.Column> {
  RTManagedColumn(
...
void loadColumn(
  ...
  _36c2.registerBoxer<_3960.Column>(boxer: (
      {required _3960.Column vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColumn(

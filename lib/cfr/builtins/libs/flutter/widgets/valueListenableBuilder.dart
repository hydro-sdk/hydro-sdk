...
import 'package:flutter/src/widgets/value_listenable_builder.dart' as _2693;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedValueListenableBuilder extends _36c2.VMManagedBox<_2693.ValueListenableBuilder<_fac9.dynamic>> {VMManagedValueListenableBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'valueListenable'
] = _36c2.maybeBoxObject<_e644.ValueListenable>(object: vmObject.valueListenable, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _2693.ValueListenableBuilder<_fac9.dynamic> vmObject;

 }

class RTManagedValueListenableBuilder extends _2693.ValueListenableBuilder implements _36c2.Box<_2693.ValueListenableBuilder> {RTManagedValueListenableBuilder({_e2dc.Widget? child, _ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _fac9.dynamic value, _e2dc.Widget? child) builder, required _e644.ValueListenable<_fac9.dynamic> valueListenable, required this.table, required this.hydroState}) : super(child: child,key: key,builder: builder,valueListenable: valueListenable) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'valueListenable'
] = _36c2.maybeBoxObject(object: this.valueListenable, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_2693.ValueListenableBuilder unwrap() => this;
_2693.ValueListenableBuilder get vmObject => this;
...
void loadValueListenableBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedValueListenableBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), builder: (context, value, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,value,child],parentState:hydroState,)[0], parentState: hydroState), valueListenable: _36c2.maybeUnBoxAndBuildArgument<_e644.ValueListenable<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'valueListenable'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_2693.ValueListenableBuilder>(boxer: ({required _2693.ValueListenableBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedValueListenableBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

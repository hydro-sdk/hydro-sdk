...
class VMManagedExcludeFocus extends _36c2.VMManagedBox<_c024.ExcludeFocus> {
  VMManagedExcludeFocus(
...
class RTManagedExcludeFocus extends _c024.ExcludeFocus
    implements _36c2.Box<_c024.ExcludeFocus> {
  RTManagedExcludeFocus(
      {required _fac9.bool excluding,
      _ab4a.Key? key,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(excluding: excluding, key: key, child: child) {
...
void loadExcludeFocus(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['excludeFocus'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedExcludeFocus(
  ...
  _36c2.registerBoxer<_c024.ExcludeFocus>(boxer: (
      {required _c024.ExcludeFocus vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedExcludeFocus(

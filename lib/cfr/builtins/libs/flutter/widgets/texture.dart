...
import 'package:flutter/src/widgets/texture.dart' as _42b2;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedTexture extends _36c2.VMManagedBox<_42b2.Texture> {VMManagedTexture({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_71dd.TextureBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_71dd.TextureBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _42b2.Texture vmObject;

 }

class RTManagedTexture extends _42b2.Texture implements _36c2.Box<_42b2.Texture> {RTManagedTexture({required _a643.FilterQuality filterQuality, required _fac9.bool freeze, _ab4a.Key? key, required _fac9.int textureId, required this.table, required this.hydroState}) : super(filterQuality: filterQuality,freeze: freeze,key: key,textureId: textureId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'textureId'
] = _36c2.maybeBoxObject(object: this.textureId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'freeze'
] = _36c2.maybeBoxObject(object: this.freeze, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'filterQuality'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_71dd.TextureBox, _fac9.dynamic>(
...
_42b2.Texture unwrap() => this;
_42b2.Texture get vmObject => this;
@_fac9.override _71dd.TextureBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_71dd.TextureBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadTexture({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'texture'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedTexture(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), textureId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textureId'
] : null)]; } );
_36c2.registerBoxer<_42b2.Texture>(boxer: ({required _42b2.Texture vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTexture(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

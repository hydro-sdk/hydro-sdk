...
class VMManagedDesktopTextSelectionToolbarLayoutDelegate extends _36c2
    .VMManagedBox<_4e4e.DesktopTextSelectionToolbarLayoutDelegate> {
  VMManagedDesktopTextSelectionToolbarLayoutDelegate(
    ...
    table['anchor'] = _36c2.maybeBoxObject<_a643.Offset>(
        object: vmObject.anchor,
        hydroState: hydroState,
...
class RTManagedDesktopTextSelectionToolbarLayoutDelegate
    extends _4e4e.DesktopTextSelectionToolbarLayoutDelegate
    implements _36c2.Box<_4e4e.DesktopTextSelectionToolbarLayoutDelegate> {
  RTManagedDesktopTextSelectionToolbarLayoutDelegate(
      {required _a643.Offset anchor,
      required this.table,
...
void loadDesktopTextSelectionToolbarLayoutDelegate(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['desktopTextSelectionToolbarLayoutDelegate'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDesktopTextSelectionToolbarLayoutDelegate(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          anchor: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
  ...
  _36c2.registerBoxer<_4e4e.DesktopTextSelectionToolbarLayoutDelegate>(boxer: (
      {required _4e4e.DesktopTextSelectionToolbarLayoutDelegate vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDesktopTextSelectionToolbarLayoutDelegate(

...
class VMManagedRestorableInt extends _36c2.VMManagedBox<_28c9.RestorableInt> {VMManagedRestorableInt({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableInt vmObject;

 }

class RTManagedRestorableInt extends _28c9.RestorableInt implements _36c2.Box<_28c9.RestorableInt> {RTManagedRestorableInt(_fac9.int defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableInt unwrap() => this;
_28c9.RestorableInt get vmObject => this;
...
void loadRestorableInt({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableInt'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableInt(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableInt>(boxer: ({required _28c9.RestorableInt vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableInt(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

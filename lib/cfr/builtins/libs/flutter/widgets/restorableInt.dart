...
class VMManagedRestorableInt extends _36c2.VMManagedBox<_28c9.RestorableInt> {
  VMManagedRestorableInt(
...
class RTManagedRestorableInt extends _28c9.RestorableInt
    implements _36c2.Box<_28c9.RestorableInt> {
  RTManagedRestorableInt(_fac9.int defaultValue,
  ...
  @_fac9.override
  _fac9.int fromPrimitives(serialized) {
...
void loadRestorableInt(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableInt'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableInt(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableInt>(boxer: (
      {required _28c9.RestorableInt vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableInt(

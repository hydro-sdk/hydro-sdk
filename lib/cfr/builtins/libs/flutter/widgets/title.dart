...
class VMManagedTitle extends _36c2.VMManagedBox<_1218.Title> {
  VMManagedTitle(
...
class RTManagedTitle extends _1218.Title implements _36c2.Box<_1218.Title> {
  RTManagedTitle(
      {_ab4a.Key? key,
      ...
      : super(key: key, title: title, child: child, color: color) {
...
void loadTitle(
  ...
  table['title'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTitle(
  ...
  _36c2.registerBoxer<_1218.Title>(boxer: (
      {required _1218.Title vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTitle(

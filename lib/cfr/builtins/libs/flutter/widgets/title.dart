...
import 'package:flutter/src/widgets/title.dart' as _1218;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedTitle extends _36c2.VMManagedBox<_1218.Title> {VMManagedTitle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _1218.Title vmObject;

 }

class RTManagedTitle extends _1218.Title implements _36c2.Box<_1218.Title> {RTManagedTitle({_ab4a.Key? key, required _fac9.String title, required _e2dc.Widget child, required _a643.Color color, required this.table, required this.hydroState}) : super(key: key,title: title,child: child,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_1218.Title unwrap() => this;
_1218.Title get vmObject => this;
...
void loadTitle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'title'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedTitle(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_1218.Title>(boxer: ({required _1218.Title vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTitle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

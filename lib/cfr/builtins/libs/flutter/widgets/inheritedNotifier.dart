...
class VMManagedInheritedNotifier extends _36c2.VMManagedBox<_25f9.InheritedNotifier<_e644.Listenable>> {VMManagedInheritedNotifier({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_25f9.InheritedNotifier<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
...
final _25f9.InheritedNotifier<_e644.Listenable> vmObject;

 }

class RTManagedInheritedNotifier extends _25f9.InheritedNotifier implements _36c2.Box<_25f9.InheritedNotifier> {RTManagedInheritedNotifier({_ab4a.Key? key, _e644.Listenable? notifier, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,notifier: notifier,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_25f9.InheritedNotifier unwrap() => this;
_25f9.InheritedNotifier get vmObject => this;
...
void loadInheritedNotifier({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedNotifier'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedInheritedNotifier(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), notifier: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'notifier'
...
_36c2.registerBoxer<_25f9.InheritedNotifier>(boxer: ({required _25f9.InheritedNotifier vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedNotifier(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

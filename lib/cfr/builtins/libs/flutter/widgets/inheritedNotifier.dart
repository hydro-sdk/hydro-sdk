...
class VMManagedInheritedNotifier
    extends _36c2.VMManagedBox<_25f9.InheritedNotifier<_e644.Listenable>> {
  VMManagedInheritedNotifier(
...
class RTManagedInheritedNotifier extends _25f9.InheritedNotifier
    implements _36c2.Box<_25f9.InheritedNotifier> {
  RTManagedInheritedNotifier(
      {_ab4a.Key? key,
      _e644.Listenable? notifier,
...
void loadInheritedNotifier(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['inheritedNotifier'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedInheritedNotifier(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          notifier: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['notifier']
              : null,
  ...
  _36c2.registerBoxer<_25f9.InheritedNotifier>(boxer: (
      {required _25f9.InheritedNotifier vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInheritedNotifier(

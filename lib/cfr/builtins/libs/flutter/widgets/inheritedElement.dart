...
class VMManagedInheritedElement extends VMManagedBox<InheritedElement> {
  VMManagedInheritedElement(
    ...
    table['updated'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.updated(maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
    ...
    table['notifyClients'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.notifyClients(
          maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    ...
    table['update'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.update(maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final InheritedElement vmObject;
}

class RTManagedInheritedElement extends InheritedElement
    implements Box<InheritedElement> {
  RTManagedInheritedElement(InheritedWidget widget$,
    ...
    table['_dart_notifyDependent'] =
      ...
      super.notifyDependent(
          maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          maybeUnBoxAndBuildArgument<Element, dynamic>(luaCallerArguments[2],
              parentState: hydroState));
      return [];
    });
    table['_dart_updated'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.updated(maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_notifyClients'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.notifyClients(maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_update'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.update(maybeUnBoxAndBuildArgument<ProxyWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  InheritedElement unwrap() => this;
  InheritedElement get vmObject => this;
  @override
  ...
  @override
  Object? getDependencies(dependent) {
    Closure closure = table["getDependencies"];
  ...
  void setDependencies(dependent, value) {
    Closure closure = table["setDependencies"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void updateDependencies(dependent, aspect) {
    Closure closure = table["updateDependencies"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void notifyDependent(oldWidget, dependent) {
    Closure closure = table["notifyDependent"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadInheritedElement(
    {required HydroState hydroState, required HydroTable table}) {
  table['inheritedElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedInheritedElement(
          maybeUnBoxAndBuildArgument<InheritedWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<InheritedElement>(boxer: (
      {required InheritedElement vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedInheritedElement(

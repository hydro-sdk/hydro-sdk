...
class VMManagedInheritedElement
    extends _36c2.VMManagedBox<_e2dc.InheritedElement> {
...
class RTManagedInheritedElement extends _e2dc.InheritedElement
    implements _36c2.Box<_e2dc.InheritedElement> {
  RTManagedInheritedElement(_e2dc.InheritedWidget widget$,
    ...
    table['_dart_notifyDependent'] = _36c2.makeLuaDartFunc(
      ...
      super.notifyDependent(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(
              luaCallerArguments[2],
              parentState: hydroState));
  ...
  @_fac9.override
  _e2dc.InheritedWidget get widget {
...
void loadInheritedElement(
  ...
  table['inheritedElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.InheritedElement>(boxer: (
      {required _e2dc.InheritedElement vmObject,

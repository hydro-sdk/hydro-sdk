...
class VMManagedInheritedElement extends _36c2.VMManagedBox<_e2dc.InheritedElement> {VMManagedInheritedElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.InheritedWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'debugDeactivated'
...
final _e2dc.InheritedElement vmObject;

 }

class RTManagedInheritedElement extends _e2dc.InheritedElement implements _36c2.Box<_e2dc.InheritedElement> {RTManagedInheritedElement(_e2dc.InheritedWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.InheritedElement unwrap() => this;
_e2dc.InheritedElement get vmObject => this;
@_fac9.override _e2dc.InheritedWidget get widget { 
...
void loadInheritedElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedInheritedElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.InheritedElement>(boxer: ({required _e2dc.InheritedElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedChildBackButtonDispatcher extends _36c2.VMManagedBox<_f6ef.ChildBackButtonDispatcher> {VMManagedChildBackButtonDispatcher({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'parent'
] = _36c2.maybeBoxObject<_f6ef.BackButtonDispatcher>(object: vmObject.parent, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'takePriority'
...
class RTManagedChildBackButtonDispatcher extends _f6ef.ChildBackButtonDispatcher implements _36c2.Box<_f6ef.ChildBackButtonDispatcher> {RTManagedChildBackButtonDispatcher(_f6ef.BackButtonDispatcher parent$, {required this.table, required this.hydroState}) : super(parent$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _7de1.Future<_fac9.bool> notifiedByParent(defaultValue) { 
...
void loadChildBackButtonDispatcher({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'childBackButtonDispatcher'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedChildBackButtonDispatcher(_36c2.maybeUnBoxAndBuildArgument<_f6ef.BackButtonDispatcher, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_f6ef.ChildBackButtonDispatcher>(boxer: ({required _f6ef.ChildBackButtonDispatcher vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedChildBackButtonDispatcher(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

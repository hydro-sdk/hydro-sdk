...
class VMManagedPhysicalModel extends _36c2.VMManagedBox<_3960.PhysicalModel> {
  VMManagedPhysicalModel(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderPhysicalModel>(
...
class RTManagedPhysicalModel extends _3960.PhysicalModel
    implements _36c2.Box<_3960.PhysicalModel> {
  RTManagedPhysicalModel(
  ...
  @_fac9.override
  _bf98.RenderPhysicalModel createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalModel, _fac9.dynamic>(
...
void loadPhysicalModel(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['physicalModel'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPhysicalModel(
  ...
  _36c2.registerBoxer<_3960.PhysicalModel>(boxer: (
      {required _3960.PhysicalModel vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPhysicalModel(

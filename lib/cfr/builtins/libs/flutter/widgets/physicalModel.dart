...
class VMManagedPhysicalModel extends _36c2.VMManagedBox<_3960.PhysicalModel> {VMManagedPhysicalModel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderPhysicalModel>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalModel, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.PhysicalModel vmObject;

 }

class RTManagedPhysicalModel extends _3960.PhysicalModel implements _36c2.Box<_3960.PhysicalModel> {RTManagedPhysicalModel({_9d8a.BorderRadius? borderRadius, _e2dc.Widget? child, required _a643.Clip clipBehavior, required _fac9.double elevation, _ab4a.Key? key, required _a643.Color shadowColor, required _250a.BoxShape shape, required _a643.Color color, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,child: child,clipBehavior: clipBehavior,elevation: elevation,key: key,shadowColor: shadowColor,shape: shape,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalModel,
...
_3960.PhysicalModel unwrap() => this;
_3960.PhysicalModel get vmObject => this;
@_fac9.override _bf98.RenderPhysicalModel createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPhysicalModel, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPhysicalModel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'physicalModel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPhysicalModel(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.PhysicalModel>(boxer: ({required _3960.PhysicalModel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPhysicalModel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollableState extends _36c2.VMManagedBox<_538d.ScrollableState> {VMManagedScrollableState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'saveOffset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.saveOffset(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
table  [
'didUpdateWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<_538d.Scrollable, _fac9.dynamic>(luaCallerArguments  [
1
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.notificationContext;if(returnValue!= null){return [_36c2.maybeBoxObject<_e2dc.BuildContext?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getStorageContext'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.BuildContext>(object: vmObject.storageContext, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_538d.Scrollable>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedScrollableState extends _538d.ScrollableState implements _36c2.Box<_538d.ScrollableState> {RTManagedScrollableState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setSemanticsActions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_setCanDrag'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.setCanDrag(_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
table['_dart_getNotificationContext'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.notificationContext];
});
table['_dart_getStorageContext'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override void saveOffset(offset) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void setSemanticsActions(actions) { 
_36c2.Closure closure = table["setSemanticsActions"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void setCanDrag(value) { 
...
@_fac9.override void setIgnorePointer(value) { 
_36c2.Closure closure = table["setIgnorePointer"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.BuildContext? get notificationContext { 
...
@_fac9.override _e2dc.BuildContext get storageContext { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _538d.Scrollable get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_538d.Scrollable, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadScrollableState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollableState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedScrollableState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_538d.ScrollableState>(boxer: ({required _538d.ScrollableState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollableState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

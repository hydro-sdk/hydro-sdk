...
class VMManagedSizedBox extends _36c2.VMManagedBox<_3960.SizedBox> {
  VMManagedSizedBox(
...
class RTManagedSizedBox extends _3960.SizedBox
    implements _36c2.Box<_3960.SizedBox> {
  RTManagedSizedBox(
      {_e2dc.Widget? child,
      _fac9.double? height,
      _ab4a.Key? key,
      ...
      : super(child: child, height: height, key: key, width: width) {
...
void loadSizedBox(
  ...
  table['sizedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSizedBox(
  ...
  _36c2.registerBoxer<_3960.SizedBox>(boxer: (
      {required _3960.SizedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSizedBox(

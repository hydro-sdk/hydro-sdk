...
class VMManagedSizedBox extends _36c2.VMManagedBox<_3960.SizedBox> {VMManagedSizedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.SizedBox vmObject;

 }

class RTManagedSizedBox extends _3960.SizedBox implements _36c2.Box<_3960.SizedBox> {RTManagedSizedBox({_e2dc.Widget? child, _fac9.double? height, _ab4a.Key? key, _fac9.double? width, required this.table, required this.hydroState}) : super(child: child,height: height,key: key,width: width) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.SizedBox unwrap() => this;
_3960.SizedBox get vmObject => this;
...
void loadSizedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sizedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSizedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.SizedBox>(boxer: ({required _3960.SizedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSizedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

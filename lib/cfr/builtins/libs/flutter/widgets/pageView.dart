...
class VMManagedPageView extends _36c2.VMManagedBox<_4ea2.PageView> {VMManagedPageView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'controller'
] = _36c2.maybeBoxObject<_4ea2.PageController>(object: vmObject.controller, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'physics'
] = _36c2.maybeBoxObject<_dbad.ScrollPhysics?>(object: vmObject.physics, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pageSnapping'
] = vmObject.pageSnapping;
table  [
'childrenDelegate'
...
class RTManagedPageView extends _4ea2.PageView implements _36c2.Box<_4ea2.PageView> {RTManagedPageView({required _fac9.bool allowImplicitScrolling, required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, _4ea2.PageController? controller, required _02d2.DragStartBehavior dragStartBehavior, _ab4a.Key? key, void Function(_fac9.int value)? onPageChanged, required _fac9.bool padEnds, required _fac9.bool pageSnapping, _dbad.ScrollPhysics? physics, _fac9.String? restorationId, required _fac9.bool reverse, _b028.ScrollBehavior? scrollBehavior, required _487f.Axis scrollDirection, required this.table, required this.hydroState}) : super(allowImplicitScrolling: allowImplicitScrolling,children: children,clipBehavior: clipBehavior,controller: controller,dragStartBehavior: dragStartBehavior,key: key,onPageChanged: onPageChanged,padEnds: padEnds,pageSnapping: pageSnapping,physics: physics,restorationId: restorationId,reverse: reverse,scrollBehavior: scrollBehavior,scrollDirection: scrollDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'allowImplicitScrolling'
] = _36c2.maybeBoxObject(object: this.allowImplicitScrolling, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'restorationId'
...
table  [
'pageSnapping'
] = _36c2.maybeBoxObject(object: this.pageSnapping, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'childrenDelegate'
...
table  [
'padEnds'
] = _36c2.maybeBoxObject(object: this.padEnds, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
@_fac9.override _e2dc.State<_4ea2.PageView> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_4ea2.PageView>, _4ea2.PageView>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPageView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pageView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonPageChanged=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPageChanged'
] : null;
...
return  [RTManagedPageView(table: luaCallerArguments  [
0
], hydroState: hydroState, allowImplicitScrolling: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'allowImplicitScrolling'
...
'clipBehavior'
] : null), controller: _36c2.maybeUnBoxAndBuildArgument<_4ea2.PageController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
...
'key'
] : null, parentState: hydroState), onPageChanged: unpackedonPageChanged != null ? (value) => unpackedonPageChanged.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null , padEnds: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'padEnds'
] : null, pageSnapping: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pageSnapping'
...
_36c2.registerBoxer<_4ea2.PageView>(boxer: ({required _4ea2.PageView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPageView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

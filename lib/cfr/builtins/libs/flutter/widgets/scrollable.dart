...
class VMManagedScrollable extends _36c2.VMManagedBox<_538d.Scrollable> {
  VMManagedScrollable(
    ...
    table['createState'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_538d.ScrollableState>(
...
class RTManagedScrollable extends _538d.Scrollable
    implements _36c2.Box<_538d.Scrollable> {
  RTManagedScrollable(
      ...
      _fac9.double Function(_538d.ScrollIncrementDetails details)?
          incrementCalculator,
      _ab4a.Key? key,
      ...
      required _e2dc.Widget Function(
              _e2dc.BuildContext context, _f376.ViewportOffset position)
          viewportBuilder,
      required this.table,
  ...
  @_fac9.override
  _538d.ScrollableState createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_538d.ScrollableState, _fac9.dynamic>(
...
void loadScrollable(
  ...
  table['scrollable'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedincrementCalculator = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['incrementCalculator']
        : null;

    _36c2.Closure unpackedviewportBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['viewportBuilder']
        : null;
    return [
      RTManagedScrollable(
          ...
          excludeFromSemantics: luaCallerArguments.length >= 2
              ...
              : null,
          incrementCalculator: unpackedincrementCalculator != null
              ? (details) => unpackedincrementCalculator.dispatch(
          ...
          viewportBuilder: (context, position) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              unpackedviewportBuilder.dispatch(
                [luaCallerArguments[0], context, position],
                parentState: hydroState,
              )[0],
              parentState: hydroState))
    ];
  });
  table['scrollableOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _538d.Scrollable.of(
  ...
  table['scrollableRecommendDeferredLoadingForContext'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _538d.Scrollable.recommendDeferredLoadingForContext(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState)),
    ];
  });
  table['scrollableEnsureVisible'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_7de1.Future>(
          object: _538d.Scrollable.ensureVisible(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
  ...
  _36c2.registerBoxer<_538d.Scrollable>(boxer: (
      {required _538d.Scrollable vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollable(

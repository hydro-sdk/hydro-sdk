...
class VMManagedCompositedTransformFollower extends _36c2.VMManagedBox<_3960.CompositedTransformFollower> {VMManagedCompositedTransformFollower({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'link'
] = _36c2.maybeBoxObject<_7d70.LayerLink>(object: vmObject.link, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'showWhenUnlinked'
] = vmObject.showWhenUnlinked;
table  [
'targetAnchor'
] = _36c2.maybeBoxObject<_ca85.Alignment>(object: vmObject.targetAnchor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'followerAnchor'
] = _36c2.maybeBoxObject<_ca85.Alignment>(object: vmObject.followerAnchor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'offset'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderFollowerLayer>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFollowerLayer, _fac9.dynamic>(luaCallerArguments  [
2
...
class RTManagedCompositedTransformFollower extends _3960.CompositedTransformFollower implements _36c2.Box<_3960.CompositedTransformFollower> {RTManagedCompositedTransformFollower({_e2dc.Widget? child, required _ca85.Alignment followerAnchor, _ab4a.Key? key, required _a643.Offset offset, required _fac9.bool showWhenUnlinked, required _ca85.Alignment targetAnchor, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(child: child,followerAnchor: followerAnchor,key: key,offset: offset,showWhenUnlinked: showWhenUnlinked,targetAnchor: targetAnchor,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'targetAnchor'
] = _36c2.maybeBoxObject(object: this.targetAnchor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'followerAnchor'
] = _36c2.maybeBoxObject(object: this.followerAnchor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'offset'
...
@_fac9.override _bf98.RenderFollowerLayer createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFollowerLayer, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCompositedTransformFollower({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCompositedTransformFollower(table: luaCallerArguments  [
0
...
'showWhenUnlinked'
] : null, targetAnchor: _36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'targetAnchor'
...
_36c2.registerBoxer<_3960.CompositedTransformFollower>(boxer: ({required _3960.CompositedTransformFollower vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCompositedTransformFollower(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

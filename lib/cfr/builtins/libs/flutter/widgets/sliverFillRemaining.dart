...
import 'package:flutter/src/widgets/sliver_fill.dart' as _3ce7;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSliverFillRemaining extends _36c2.VMManagedBox<_3ce7.SliverFillRemaining> {VMManagedSliverFillRemaining({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'hasScrollBody'
] = vmObject.hasScrollBody;
table  [
'fillOverscroll'
] = vmObject.fillOverscroll;
table  [
'key'
...
final _3ce7.SliverFillRemaining vmObject;

 }

class RTManagedSliverFillRemaining extends _3ce7.SliverFillRemaining implements _36c2.Box<_3ce7.SliverFillRemaining> {RTManagedSliverFillRemaining({_e2dc.Widget? child, required _fac9.bool fillOverscroll, required _fac9.bool hasScrollBody, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,fillOverscroll: fillOverscroll,hasScrollBody: hasScrollBody,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'hasScrollBody'
] = _36c2.maybeBoxObject(object: this.hasScrollBody, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fillOverscroll'
] = _36c2.maybeBoxObject(object: this.fillOverscroll, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_3ce7.SliverFillRemaining unwrap() => this;
_3ce7.SliverFillRemaining get vmObject => this;
...
void loadSliverFillRemaining({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverFillRemaining'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSliverFillRemaining(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), fillOverscroll: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fillOverscroll'
] : null, hasScrollBody: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'hasScrollBody'
...
_36c2.registerBoxer<_3ce7.SliverFillRemaining>(boxer: ({required _3ce7.SliverFillRemaining vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverFillRemaining(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedOpacity extends _36c2.VMManagedBox<_3960.Opacity> {VMManagedOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderOpacity>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOpacity, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Opacity vmObject;

 }

class RTManagedOpacity extends _3960.Opacity implements _36c2.Box<_3960.Opacity> {RTManagedOpacity({required _fac9.bool alwaysIncludeSemantics, _e2dc.Widget? child, _ab4a.Key? key, required _fac9.double opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,child: child,key: key,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOpacity, _fac9.dynamic>(
...
_3960.Opacity unwrap() => this;
_3960.Opacity get vmObject => this;
@_fac9.override _bf98.RenderOpacity createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOpacity, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'opacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedOpacity(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Opacity>(boxer: ({required _3960.Opacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedOpacity extends _36c2.VMManagedBox<_3960.Opacity> {
  VMManagedOpacity(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderOpacity>(
...
class RTManagedOpacity extends _3960.Opacity
    implements _36c2.Box<_3960.Opacity> {
  RTManagedOpacity(
  ...
  @_fac9.override
  _bf98.RenderOpacity createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOpacity, _fac9.dynamic>(
...
void loadOpacity(
  ...
  table['opacity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOpacity(
  ...
  _36c2.registerBoxer<_3960.Opacity>(boxer: (
      {required _3960.Opacity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOpacity(

...
class VMManagedNestedScrollView
    extends _36c2.VMManagedBox<_c812.NestedScrollView> {
  VMManagedNestedScrollView(
    ...
    table['floatHeaderSlivers'] = vmObject.floatHeaderSlivers;
    ...
    table['createState'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_c812.NestedScrollViewState>(
...
class RTManagedNestedScrollView extends _c812.NestedScrollView
    implements _36c2.Box<_c812.NestedScrollView> {
  RTManagedNestedScrollView(
      {required _a643.Clip clipBehavior,
      _9585.ScrollController? controller,
      required _02d2.DragStartBehavior dragStartBehavior,
      required _fac9.bool floatHeaderSlivers,
      _ab4a.Key? key,
      ...
      required _fac9.List<_e2dc.Widget> Function(
              _e2dc.BuildContext context, _fac9.bool innerBoxIsScrolled)
          headerSliverBuilder,
      required this.table,
    ...
    table['floatHeaderSlivers'] = _36c2.maybeBoxObject(
        object: this.floatHeaderSlivers,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['clipBehavior'] = _a643.Clip.values.indexWhere((x) {
  ...
  @_fac9.override
  _c812.NestedScrollViewState createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_c812.NestedScrollViewState, _fac9.dynamic>(
...
void loadNestedScrollView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['nestedScrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedheaderSliverBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['headerSliverBuilder']
        : null;
    return [
      RTManagedNestedScrollView(
          ...
          dragStartBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          floatHeaderSlivers: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['floatHeaderSlivers']
              : null,
          ...
          body: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['body'] : null, parentState: hydroState),
          headerSliverBuilder: (context, innerBoxIsScrolled) => _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
              unpackedheaderSliverBuilder.dispatch(
                [luaCallerArguments[0], context, innerBoxIsScrolled],
                parentState: hydroState,
              )[0],
              parentState: hydroState))
    ];
  });
  table['nestedScrollViewSliverOverlapAbsorberHandleFor'] = _36c2
      .makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_c812.SliverOverlapAbsorberHandle>(
          object: _c812.NestedScrollView.sliverOverlapAbsorberHandleFor(_36c2
  ...
  _36c2.registerBoxer<_c812.NestedScrollView>(boxer: (
      {required _c812.NestedScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNestedScrollView(

...
class VMManagedMetaData extends _36c2.VMManagedBox<_3960.MetaData> {VMManagedMetaData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderMetaData>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderMetaData, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.MetaData vmObject;

 }

class RTManagedMetaData extends _3960.MetaData implements _36c2.Box<_3960.MetaData> {RTManagedMetaData({required _bf98.HitTestBehavior behavior, _e2dc.Widget? child, _ab4a.Key? key, required _fac9.dynamic metaData, required this.table, required this.hydroState}) : super(behavior: behavior,child: child,key: key,metaData: metaData) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderMetaData, _fac9.dynamic>(
...
_3960.MetaData unwrap() => this;
_3960.MetaData get vmObject => this;
@_fac9.override _bf98.RenderMetaData createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderMetaData, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMetaData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'metaData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedMetaData(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), metaData: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'metaData'
] : null)]; } );
_36c2.registerBoxer<_3960.MetaData>(boxer: ({required _3960.MetaData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMetaData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

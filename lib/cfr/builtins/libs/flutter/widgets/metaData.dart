...
class VMManagedMetaData extends _36c2.VMManagedBox<_3960.MetaData> {
  VMManagedMetaData(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderMetaData>(
...
class RTManagedMetaData extends _3960.MetaData
    implements _36c2.Box<_3960.MetaData> {
  RTManagedMetaData(
      {required _bf98.HitTestBehavior behavior,
      _e2dc.Widget? child,
      _ab4a.Key? key,
      required _fac9.dynamic metaData,
      required this.table,
      required this.hydroState})
      : super(behavior: behavior, child: child, key: key, metaData: metaData) {
  ...
  @_fac9.override
  _bf98.RenderMetaData createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderMetaData, _fac9.dynamic>(
...
void loadMetaData(
  ...
  table['metaData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMetaData(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          metaData: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['metaData']
              : null)
    ];
  });
  _36c2.registerBoxer<_3960.MetaData>(boxer: (
      {required _3960.MetaData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMetaData(

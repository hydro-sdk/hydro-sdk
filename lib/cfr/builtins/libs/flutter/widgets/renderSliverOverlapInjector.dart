...
class VMManagedRenderSliverOverlapInjector extends _36c2.VMManagedBox<_c812.RenderSliverOverlapInjector> {VMManagedRenderSliverOverlapInjector({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c812.RenderSliverOverlapInjector vmObject;

 }

class RTManagedRenderSliverOverlapInjector extends _c812.RenderSliverOverlapInjector implements _36c2.Box<_c812.RenderSliverOverlapInjector> {RTManagedRenderSliverOverlapInjector({required _c812.SliverOverlapAbsorberHandle handle, required this.table, required this.hydroState}) : super(handle: handle) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c812.RenderSliverOverlapInjector unwrap() => this;
_c812.RenderSliverOverlapInjector get vmObject => this;
...
void loadRenderSliverOverlapInjector({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverOverlapInjector'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverOverlapInjector(table: luaCallerArguments  [
0
], hydroState: hydroState, handle: _36c2.maybeUnBoxAndBuildArgument<_c812.SliverOverlapAbsorberHandle, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'handle'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_c812.RenderSliverOverlapInjector>(boxer: ({required _c812.RenderSliverOverlapInjector vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverOverlapInjector(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderObjectElement extends _36c2.VMManagedBox<_e2dc.RenderObjectElement> {VMManagedRenderObjectElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.RenderObjectElement vmObject;

 }

class RTManagedRenderObjectElement extends _e2dc.RenderObjectElement implements _36c2.Box<_e2dc.RenderObjectElement> {RTManagedRenderObjectElement(_e2dc.RenderObjectWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.RenderObjectElement unwrap() => this;
_e2dc.RenderObjectElement get vmObject => this;
...
void loadRenderObjectElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderObjectElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderObjectElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.RenderObjectElement>(boxer: ({required _e2dc.RenderObjectElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderObjectElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

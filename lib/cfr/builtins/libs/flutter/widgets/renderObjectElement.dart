...
class VMManagedRenderObjectElement
    extends _36c2.VMManagedBox<_e2dc.RenderObjectElement> {
  VMManagedRenderObjectElement(
...
class RTManagedRenderObjectElement extends _e2dc.RenderObjectElement
    implements _36c2.Box<_e2dc.RenderObjectElement> {
  RTManagedRenderObjectElement(_e2dc.RenderObjectWidget widget$,
...
void loadRenderObjectElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderObjectElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderObjectElement(
  ...
  _36c2.registerBoxer<_e2dc.RenderObjectElement>(boxer: (
      {required _e2dc.RenderObjectElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderObjectElement(

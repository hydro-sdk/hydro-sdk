...
class VMManagedRenderObjectElement extends VMManagedBox<RenderObjectElement> {
  ...
  final RenderObjectElement vmObject;
}

class RTManagedRenderObjectElement extends RenderObjectElement
    implements Box<RenderObjectElement> {
  RTManagedRenderObjectElement(RenderObjectWidget widget$,
  ...
  RenderObjectElement unwrap() => this;
  RenderObjectElement get vmObject => this;
  @override
...
void loadRenderObjectElement(
  ...
  registerBoxer<RenderObjectElement>(boxer: (
      {required RenderObjectElement vmObject,

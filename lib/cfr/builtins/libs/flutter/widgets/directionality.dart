...
class VMManagedDirectionality extends _36c2.VMManagedBox<_3960.Directionality> {VMManagedDirectionality({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_3960.Directionality, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.Directionality vmObject;

 }

class RTManagedDirectionality extends _3960.Directionality implements _36c2.Box<_3960.Directionality> {RTManagedDirectionality({_ab4a.Key? key, required _e2dc.Widget child, required _a643.TextDirection textDirection, required this.table, required this.hydroState}) : super(key: key,child: child,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.Directionality unwrap() => this;
_3960.Directionality get vmObject => this;
...
void loadDirectionality({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'directionality'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDirectionality(table: luaCallerArguments  [
0
...
table  [
'directionalityOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_a643.TextDirection.values.indexWhere((x) { return x == _3960.Directionality.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)); } ),]; } );
table  [
'directionalityMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _3960.Directionality.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_a643.TextDirection.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
_36c2.registerBoxer<_3960.Directionality>(boxer: ({required _3960.Directionality vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDirectionality(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

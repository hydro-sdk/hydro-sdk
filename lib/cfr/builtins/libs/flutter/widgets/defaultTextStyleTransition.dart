...
class VMManagedDefaultTextStyleTransition extends _36c2.VMManagedBox<_d7ad.DefaultTextStyleTransition> {VMManagedDefaultTextStyleTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getStyle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.style, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.DefaultTextStyleTransition vmObject;

 }

class RTManagedDefaultTextStyleTransition extends _d7ad.DefaultTextStyleTransition implements _36c2.Box<_d7ad.DefaultTextStyleTransition> {RTManagedDefaultTextStyleTransition({_ab4a.Key? key, _fac9.int? maxLines, required _fe5a.TextOverflow overflow, required _fac9.bool softWrap, _a643.TextAlign? textAlign, required _e2dc.Widget child, required _86ca.Animation<_74d0.TextStyle> style, required this.table, required this.hydroState}) : super(key: key,maxLines: maxLines,overflow: overflow,softWrap: softWrap,textAlign: textAlign,child: child,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.DefaultTextStyleTransition unwrap() => this;
_d7ad.DefaultTextStyleTransition get vmObject => this;
@_fac9.override _86ca.Animation<_74d0.TextStyle> get style { 
...
void loadDefaultTextStyleTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedDefaultTextStyleTransition(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), style: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_74d0.TextStyle>, _74d0.TextStyle>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'style'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.DefaultTextStyleTransition>(boxer: ({required _d7ad.DefaultTextStyleTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDefaultTextStyleTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

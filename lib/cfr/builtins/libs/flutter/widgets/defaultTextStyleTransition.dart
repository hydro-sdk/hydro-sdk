...
class VMManagedDefaultTextStyleTransition
    extends _36c2.VMManagedBox<_d7ad.DefaultTextStyleTransition> {
  VMManagedDefaultTextStyleTransition(
...
class RTManagedDefaultTextStyleTransition
    extends _d7ad.DefaultTextStyleTransition
    implements _36c2.Box<_d7ad.DefaultTextStyleTransition> {
  RTManagedDefaultTextStyleTransition(
      {_ab4a.Key? key,
      _fac9.int? maxLines,
      ...
      required _86ca.Animation<_74d0.TextStyle> style,
      required this.table,
  ...
  @_fac9.override
  _86ca.Animation<_74d0.TextStyle> get style {
    _36c2.Closure closure = table["getStyle"];
    return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_74d0.TextStyle>,
            _74d0.TextStyle>(
...
void loadDefaultTextStyleTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultTextStyleTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultTextStyleTransition(
          ...
          textAlign: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['textAlign']
                  : null),
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          style: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_74d0.TextStyle>, _74d0.TextStyle>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['style'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.DefaultTextStyleTransition>(boxer: (
      {required _d7ad.DefaultTextStyleTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultTextStyleTransition(

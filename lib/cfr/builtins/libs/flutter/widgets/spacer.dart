...
class VMManagedSpacer extends _36c2.VMManagedBox<_c25c.Spacer> {
  VMManagedSpacer(
...
class RTManagedSpacer extends _c25c.Spacer implements _36c2.Box<_c25c.Spacer> {
  RTManagedSpacer(
      {required _fac9.int flex,
      _ab4a.Key? key,
      required this.table,
      required this.hydroState})
      : super(flex: flex, key: key) {
...
void loadSpacer(
  ...
  table['spacer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSpacer(
  ...
  _36c2.registerBoxer<_c25c.Spacer>(boxer: (
      {required _c25c.Spacer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSpacer(

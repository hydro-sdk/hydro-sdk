...
import 'package:flutter/src/widgets/spacer.dart' as _c25c;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSpacer extends _36c2.VMManagedBox<_c25c.Spacer> {VMManagedSpacer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c25c.Spacer vmObject;

 }

class RTManagedSpacer extends _c25c.Spacer implements _36c2.Box<_c25c.Spacer> {RTManagedSpacer({required _fac9.int flex, _ab4a.Key? key, required this.table, required this.hydroState}) : super(flex: flex,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c25c.Spacer unwrap() => this;
_c25c.Spacer get vmObject => this;
...
void loadSpacer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'spacer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSpacer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_c25c.Spacer>(boxer: ({required _c25c.Spacer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSpacer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

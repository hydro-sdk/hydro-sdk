...
class VMManagedBorderRadiusTween
    extends _36c2.VMManagedBox<_da7c.BorderRadiusTween> {
  VMManagedBorderRadiusTween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_9d8a.BorderRadius?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_9d8a.BorderRadius?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedBorderRadiusTween extends _da7c.BorderRadiusTween
    implements _36c2.Box<_da7c.BorderRadiusTween> {
  RTManagedBorderRadiusTween(
      {_9d8a.BorderRadius? begin,
      _9d8a.BorderRadius? end,
      required this.table,
  ...
  @_fac9.override
  _9d8a.BorderRadius? transform(t) {
  ...
  @_fac9.override
  _9d8a.BorderRadius? evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_9d8a.BorderRadius?> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _86ca.Animation<_9d8a.BorderRadius?>, _9d8a.BorderRadius?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  _e83e.Animatable<_9d8a.BorderRadius?> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e83e.Animatable<_9d8a.BorderRadius?>, _9d8a.BorderRadius?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadBorderRadiusTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['borderRadiusTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBorderRadiusTween(
  ...
  _36c2.registerBoxer<_da7c.BorderRadiusTween>(boxer: (
      {required _da7c.BorderRadiusTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBorderRadiusTween(

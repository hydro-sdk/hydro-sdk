...
class VMManagedFixedExtentScrollPhysics
    extends _36c2.VMManagedBox<_7b25.FixedExtentScrollPhysics> {
  VMManagedFixedExtentScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_7b25.FixedExtentScrollPhysics>(
...
class RTManagedFixedExtentScrollPhysics extends _7b25.FixedExtentScrollPhysics
    implements _36c2.Box<_7b25.FixedExtentScrollPhysics> {
  RTManagedFixedExtentScrollPhysics(
  ...
  @_fac9.override
  _7b25.FixedExtentScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2.maybeUnBoxAndBuildArgument<_7b25.FixedExtentScrollPhysics,
            _fac9.dynamic>(
...
void loadFixedExtentScrollPhysics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['fixedExtentScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFixedExtentScrollPhysics(
  ...
  _36c2.registerBoxer<_7b25.FixedExtentScrollPhysics>(boxer: (
      {required _7b25.FixedExtentScrollPhysics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFixedExtentScrollPhysics(

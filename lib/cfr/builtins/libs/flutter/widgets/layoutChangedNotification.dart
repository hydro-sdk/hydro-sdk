...
class VMManagedLayoutChangedNotification extends _36c2.VMManagedBox<_c8d8.LayoutChangedNotification> {VMManagedLayoutChangedNotification({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLayoutChangedNotification extends _c8d8.LayoutChangedNotification implements _36c2.Box<_c8d8.LayoutChangedNotification> {RTManagedLayoutChangedNotification({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLayoutChangedNotification({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'layoutChangedNotification'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLayoutChangedNotification(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c8d8.LayoutChangedNotification>(boxer: ({required _c8d8.LayoutChangedNotification vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLayoutChangedNotification(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSemanticsDebugger
    extends _36c2.VMManagedBox<_68eb.SemanticsDebugger> {
  VMManagedSemanticsDebugger(
...
class RTManagedSemanticsDebugger extends _68eb.SemanticsDebugger
    implements _36c2.Box<_68eb.SemanticsDebugger> {
  RTManagedSemanticsDebugger(
      {_ab4a.Key? key,
      required _74d0.TextStyle labelStyle,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(key: key, labelStyle: labelStyle, child: child) {
  ...
  @_fac9.override
  _e2dc.State<_68eb.SemanticsDebugger> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_68eb.SemanticsDebugger>, _68eb.SemanticsDebugger>(
...
void loadSemanticsDebugger(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['semanticsDebugger'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSemanticsDebugger(
          ...
          labelStyle:
              _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['labelStyle']
                      : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_68eb.SemanticsDebugger>(boxer: (
      {required _68eb.SemanticsDebugger vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSemanticsDebugger(

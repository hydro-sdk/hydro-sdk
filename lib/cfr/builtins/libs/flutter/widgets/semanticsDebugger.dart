...
import 'package:flutter/src/widgets/semantics_debugger.dart' as _68eb;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSemanticsDebugger extends _36c2.VMManagedBox<_68eb.SemanticsDebugger> {VMManagedSemanticsDebugger({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'labelStyle'
] = _36c2.maybeBoxObject<_74d0.TextStyle>(object: vmObject.labelStyle, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _68eb.SemanticsDebugger vmObject;

 }

class RTManagedSemanticsDebugger extends _68eb.SemanticsDebugger implements _36c2.Box<_68eb.SemanticsDebugger> {RTManagedSemanticsDebugger({_ab4a.Key? key, required _74d0.TextStyle labelStyle, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,labelStyle: labelStyle,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'labelStyle'
] = _36c2.maybeBoxObject(object: this.labelStyle, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_68eb.SemanticsDebugger unwrap() => this;
_68eb.SemanticsDebugger get vmObject => this;
@_fac9.override _e2dc.State<_68eb.SemanticsDebugger> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_68eb.SemanticsDebugger>, _68eb.SemanticsDebugger>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSemanticsDebugger({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsDebugger'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSemanticsDebugger(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), labelStyle: _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'labelStyle'
...
_36c2.registerBoxer<_68eb.SemanticsDebugger>(boxer: ({required _68eb.SemanticsDebugger vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsDebugger(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

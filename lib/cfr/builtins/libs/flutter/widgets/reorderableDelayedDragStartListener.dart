...
class VMManagedReorderableDelayedDragStartListener
    extends _36c2.VMManagedBox<_acd7.ReorderableDelayedDragStartListener> {
  VMManagedReorderableDelayedDragStartListener(
    ...
    table['createRecognizer'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_d5f6.MultiDragGestureRecognizer>(
            object: vmObject.createRecognizer(),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
...
class RTManagedReorderableDelayedDragStartListener
    extends _acd7.ReorderableDelayedDragStartListener
    implements _36c2.Box<_acd7.ReorderableDelayedDragStartListener> {
  RTManagedReorderableDelayedDragStartListener(
      ...
      : super(enabled: enabled, key: key, child: child, index: index) {
  ...
  @_fac9.override
  _d5f6.MultiDragGestureRecognizer createRecognizer() {
...
void loadReorderableDelayedDragStartListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['reorderableDelayedDragStartListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedReorderableDelayedDragStartListener(
  ...
  _36c2.registerBoxer<_acd7.ReorderableDelayedDragStartListener>(boxer: (
      {required _acd7.ReorderableDelayedDragStartListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedReorderableDelayedDragStartListener(

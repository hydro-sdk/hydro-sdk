...
class VMManagedReorderableDelayedDragStartListener extends _36c2.VMManagedBox<_acd7.ReorderableDelayedDragStartListener> {VMManagedReorderableDelayedDragStartListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_d5f6.MultiDragGestureRecognizer>(object: vmObject.createRecognizer(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _acd7.ReorderableDelayedDragStartListener vmObject;

 }

class RTManagedReorderableDelayedDragStartListener extends _acd7.ReorderableDelayedDragStartListener implements _36c2.Box<_acd7.ReorderableDelayedDragStartListener> {RTManagedReorderableDelayedDragStartListener({required _fac9.bool enabled, _ab4a.Key? key, required _e2dc.Widget child, required _fac9.int index, required this.table, required this.hydroState}) : super(enabled: enabled,key: key,child: child,index: index) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_acd7.ReorderableDelayedDragStartListener unwrap() => this;
_acd7.ReorderableDelayedDragStartListener get vmObject => this;
@_fac9.override _d5f6.MultiDragGestureRecognizer createRecognizer() { 
...
void loadReorderableDelayedDragStartListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'reorderableDelayedDragStartListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedReorderableDelayedDragStartListener(table: luaCallerArguments  [
0
], hydroState: hydroState, enabled: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'enabled'
...
_36c2.registerBoxer<_acd7.ReorderableDelayedDragStartListener>(boxer: ({required _acd7.ReorderableDelayedDragStartListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedReorderableDelayedDragStartListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

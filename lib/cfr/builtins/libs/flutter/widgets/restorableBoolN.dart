...
class VMManagedRestorableBoolN extends _36c2.VMManagedBox<_28c9.RestorableBoolN> {VMManagedRestorableBoolN({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _28c9.RestorableBoolN vmObject;

 }

class RTManagedRestorableBoolN extends _28c9.RestorableBoolN implements _36c2.Box<_28c9.RestorableBoolN> {RTManagedRestorableBoolN(_fac9.bool? defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setValue'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.value = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool?, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_28c9.RestorableBoolN unwrap() => this;
_28c9.RestorableBoolN get vmObject => this;
@_fac9.override _fac9.bool? createDefaultValue() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool? fromPrimitives(serialized) { 
...
void loadRestorableBoolN({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableBoolN'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableBoolN(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableBoolN>(boxer: ({required _28c9.RestorableBoolN vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableBoolN(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

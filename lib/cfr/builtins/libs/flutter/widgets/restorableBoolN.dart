...
class VMManagedRestorableBoolN
    extends _36c2.VMManagedBox<_28c9.RestorableBoolN> {
  VMManagedRestorableBoolN(
...
class RTManagedRestorableBoolN extends _28c9.RestorableBoolN
    implements _36c2.Box<_28c9.RestorableBoolN> {
  RTManagedRestorableBoolN(_fac9.bool? defaultValue,
...
void loadRestorableBoolN(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableBoolN'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableBoolN(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableBoolN>(boxer: (
      {required _28c9.RestorableBoolN vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableBoolN(

...
class VMManagedRestorableListenable extends _36c2.VMManagedBox<_28c9.RestorableListenable<_e644.Listenable>> {VMManagedRestorableListenable({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRestorableListenable extends _28c9.RestorableListenable implements _36c2.Box<_28c9.RestorableListenable> {RTManagedRestorableListenable({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _e644.Listenable get value { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e644.Listenable createDefaultValue() { 
_36c2.Closure closure = table["createDefaultValue"];
return _36c2.maybeUnBoxAndBuildArgument<_e644.Listenable, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e644.Listenable fromPrimitives(data) { 
...
void loadRestorableListenable({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableListenable'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableListenable(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableListenable>(boxer: ({required _28c9.RestorableListenable vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableListenable(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

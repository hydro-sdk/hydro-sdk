...
class VMManagedViewport extends _36c2.VMManagedBox<_f1c1.Viewport> {
  VMManagedViewport(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_01f8.RenderViewport>(
...
class RTManagedViewport extends _f1c1.Viewport
    implements _36c2.Box<_f1c1.Viewport> {
  RTManagedViewport(
    ...
    table['cacheExtent'] = _36c2.maybeBoxObject(
        ...
        table: _36c2.HydroTable());
    table['cacheExtentStyle'] = _01f8.CacheExtentStyle.values.indexWhere((x) {
      return x == this.cacheExtentStyle;
    });
    table['clipBehavior'] = _a643.Clip.values.indexWhere((x) {
  ...
  @_fac9.override
  _01f8.RenderViewport createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_01f8.RenderViewport, _fac9.dynamic>(
...
void loadViewport(
  ...
  table['viewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedViewport(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          slivers: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
  ...
  table['viewportGetDefaultCrossAxisDirection'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _487f.AxisDirection.values.indexWhere((x) {
        return x ==
            _f1c1.Viewport.getDefaultCrossAxisDirection(
  ...
  _36c2.registerBoxer<_f1c1.Viewport>(boxer: (
      {required _f1c1.Viewport vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedViewport(

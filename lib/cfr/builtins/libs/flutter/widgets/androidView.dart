...
class VMManagedAndroidView extends _36c2.VMManagedBox<_172d.AndroidView> {VMManagedAndroidView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAndroidView extends _172d.AndroidView implements _36c2.Box<_172d.AndroidView> {RTManagedAndroidView({required _a643.Clip clipBehavior, required _fac9.dynamic creationParams, _7fbb.MessageCodec<_fac9.dynamic>? creationParamsCodec, _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>? gestureRecognizers, required _6ecd.PlatformViewHitTestBehavior hitTestBehavior, _ab4a.Key? key, _a643.TextDirection? layoutDirection, void Function(_fac9.int id)? onPlatformViewCreated, required _fac9.String viewType, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,creationParams: creationParams,creationParamsCodec: creationParamsCodec,gestureRecognizers: gestureRecognizers,hitTestBehavior: hitTestBehavior,key: key,layoutDirection: layoutDirection,onPlatformViewCreated: onPlatformViewCreated,viewType: viewType) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _e2dc.State<_172d.AndroidView> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_172d.AndroidView>, _172d.AndroidView>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAndroidView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'androidView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAndroidView(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), creationParams: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'creationParams'
...
_36c2.registerBoxer<_172d.AndroidView>(boxer: ({required _172d.AndroidView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAndroidView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

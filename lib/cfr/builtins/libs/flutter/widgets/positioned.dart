...
class VMManagedPositioned extends _36c2.VMManagedBox<_3960.Positioned> {VMManagedPositioned({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'applyParentData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.applyParentData(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getDebugTypicalAncestorWidgetClass'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Type>(object: vmObject.debugTypicalAncestorWidgetClass, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'debugFillProperties'
...
table  [
'createElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.ParentDataElement>(object: vmObject.createElement(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'debugIsValidRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugIsValidRenderObject(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'toStringShort'
...
class RTManagedPositioned extends _3960.Positioned implements _36c2.Box<_3960.Positioned> {RTManagedPositioned({_fac9.double? bottom, _fac9.double? height, _ab4a.Key? key, _fac9.double? left, _fac9.double? right, _fac9.double? top, _fac9.double? width, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(bottom: bottom,height: height,key: key,left: left,right: right,top: top,width: width,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_debugIsValidRenderObject'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.debugIsValidRenderObject(
            _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
@_fac9.override void applyParentData(renderObject) { 
_36c2.Closure closure = table["applyParentData"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Type get debugTypicalAncestorWidgetClass { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.ParentDataElement<_b1b6.StackParentData> createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.ParentDataElement<_b1b6.StackParentData>, _b1b6.StackParentData>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool debugIsValidRenderObject(renderObject) { 
_36c2.Closure closure = table["debugIsValidRenderObject"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool debugCanApplyOutOfTurn() { 
...
void loadPositioned({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'positioned'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPositioned(table: luaCallerArguments  [
0
], hydroState: hydroState, bottom: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bottom'
] : null?.toDouble(), height: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'height'
...
'key'
] : null, parentState: hydroState), left: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'left'
...
return [_36c2.maybeBoxObject<_3960.Positioned>(object: _3960.Positioned.directional(bottom: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bottom'
] : null?.toDouble(), end: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'end'
] : null?.toDouble(), height: luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'key'
] : null, parentState: hydroState), start: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'start'
] : null?.toDouble(), top: luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
_36c2.registerBoxer<_3960.Positioned>(boxer: ({required _3960.Positioned vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPositioned(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

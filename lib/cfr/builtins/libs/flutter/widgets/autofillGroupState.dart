...
class VMManagedAutofillGroupState
    extends _36c2.VMManagedBox<_689d.AutofillGroupState> {
  VMManagedAutofillGroupState(
    ...
    table['register'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.register(
    ...
    table['unregister'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.unregister(luaCallerArguments[1]);
      return [];
    });
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_689d.AutofillGroup>(
...
class RTManagedAutofillGroupState extends _689d.AutofillGroupState
    implements _36c2.Box<_689d.AutofillGroupState> {
  RTManagedAutofillGroupState({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_getAutofillClient'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_getAutofillClients'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.autofillClients];
    });
    table['_dart_register'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.register(
          _36c2.maybeUnBoxAndBuildArgument<_7283.AutofillClient, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_unregister'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.unregister(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.String, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _7283.AutofillClient? getAutofillClient(autofillId) {
    _36c2.Closure closure = table["getAutofillClient"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_7283.AutofillClient?, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _fac9.Iterable<_7283.AutofillClient> get autofillClients {
    _36c2.Closure closure = table["getAutofillClients"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _fac9.Iterable<_7283.AutofillClient>, _7283.AutofillClient>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _8577.TextInputConnection attach(trigger, configuration) {
    _36c2.Closure closure = table["attach"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_8577.TextInputConnection, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
  ...
  @_fac9.override
  _689d.AutofillGroup get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_689d.AutofillGroup, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadAutofillGroupState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['autofillGroupState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAutofillGroupState(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_689d.AutofillGroupState>(boxer: (
      {required _689d.AutofillGroupState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAutofillGroupState(

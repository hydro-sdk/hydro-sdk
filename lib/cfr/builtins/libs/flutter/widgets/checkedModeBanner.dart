...
class VMManagedCheckedModeBanner extends _36c2.VMManagedBox<_7c3a.CheckedModeBanner> {VMManagedCheckedModeBanner({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7c3a.CheckedModeBanner vmObject;

 }

class RTManagedCheckedModeBanner extends _7c3a.CheckedModeBanner implements _36c2.Box<_7c3a.CheckedModeBanner> {RTManagedCheckedModeBanner({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7c3a.CheckedModeBanner unwrap() => this;
_7c3a.CheckedModeBanner get vmObject => this;
...
void loadCheckedModeBanner({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'checkedModeBanner'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedCheckedModeBanner(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7c3a.CheckedModeBanner>(boxer: ({required _7c3a.CheckedModeBanner vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCheckedModeBanner(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFocusTrap extends _36c2.VMManagedBox<_8c2a.FocusTrap> {
  VMManagedFocusTrap(
...
class RTManagedFocusTrap extends _8c2a.FocusTrap
    implements _36c2.Box<_8c2a.FocusTrap> {
  RTManagedFocusTrap(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _b485.FocusScopeNode focusScopeNode,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, focusScopeNode: focusScopeNode) {
...
void loadFocusTrap(
  ...
  table['focusTrap'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFocusTrap(
          ...
          focusScopeNode: _36c2.maybeUnBoxAndBuildArgument<_b485.FocusScopeNode, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['focusScopeNode']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_8c2a.FocusTrap>(boxer: (
      {required _8c2a.FocusTrap vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusTrap(

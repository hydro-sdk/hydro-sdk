...
class VMManagedFocusTrap extends _36c2.VMManagedBox<_8c2a.FocusTrap> {VMManagedFocusTrap({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c2a.FocusTrap vmObject;

 }

class RTManagedFocusTrap extends _8c2a.FocusTrap implements _36c2.Box<_8c2a.FocusTrap> {RTManagedFocusTrap({_ab4a.Key? key, required _e2dc.Widget child, required _b485.FocusScopeNode focusScopeNode, required this.table, required this.hydroState}) : super(key: key,child: child,focusScopeNode: focusScopeNode) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'focusScopeNode'
] = _36c2.maybeBoxObject(object: this.focusScopeNode, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_8c2a.FocusTrap unwrap() => this;
_8c2a.FocusTrap get vmObject => this;
...
void loadFocusTrap({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusTrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedFocusTrap(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_8c2a.FocusTrap>(boxer: ({required _8c2a.FocusTrap vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusTrap(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRotationTransition
    extends _36c2.VMManagedBox<_d7ad.RotationTransition> {
  VMManagedRotationTransition(
    ...
    table['alignment'] = _36c2.maybeBoxObject<_ca85.Alignment>(
    ...
    table['key'] = _36c2.maybeBoxObject<_ab4a.Key?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_86ca.Animation>(
            object: vmObject.turns,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
  ...
  final _d7ad.RotationTransition vmObject;
}

class RTManagedRotationTransition extends _d7ad.RotationTransition
    implements _36c2.Box<_d7ad.RotationTransition> {
  RTManagedRotationTransition(
      {required _ca85.Alignment alignment,
      _e2dc.Widget? child,
      _a643.FilterQuality? filterQuality,
      _ab4a.Key? key,
      required _86ca.Animation<_fac9.double> turns,
      required this.table,
    ...
    table['_dart_getTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.turns];
    });
  ...
  _d7ad.RotationTransition unwrap() => this;
  _d7ad.RotationTransition get vmObject => this;
  @_fac9.override
  _86ca.Animation<_fac9.double> get turns {
    _36c2.Closure closure = table["getTurns"];
...
void loadRotationTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rotationTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRotationTransition(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          alignment: _36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          turns: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['turns'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.RotationTransition>(boxer: (
      {required _d7ad.RotationTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRotationTransition(

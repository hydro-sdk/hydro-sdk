...
class VMManagedRotationTransition extends _36c2.VMManagedBox<_d7ad.RotationTransition> {VMManagedRotationTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getTurns'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.turns, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
class RTManagedRotationTransition extends _d7ad.RotationTransition implements _36c2.Box<_d7ad.RotationTransition> {RTManagedRotationTransition({required _ca85.Alignment alignment, _e2dc.Widget? child, _a643.FilterQuality? filterQuality, _ab4a.Key? key, required _86ca.Animation<_fac9.double> turns, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,filterQuality: filterQuality,key: key,turns: turns) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _86ca.Animation<_fac9.double> get turns { 
...
void loadRotationTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rotationTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRotationTransition(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), turns: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'turns'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.RotationTransition>(boxer: ({required _d7ad.RotationTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRotationTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCenter extends _36c2.VMManagedBox<_3960.Center> {
  VMManagedCenter(
...
class RTManagedCenter extends _3960.Center implements _36c2.Box<_3960.Center> {
  RTManagedCenter(
      {_e2dc.Widget? child,
    ...
    table['alignment'] = _36c2.maybeBoxObject(
        object: alignment, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadCenter(
  ...
  table['center'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCenter(
  ...
  _36c2.registerBoxer<_3960.Center>(boxer: (
      {required _3960.Center vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCenter(

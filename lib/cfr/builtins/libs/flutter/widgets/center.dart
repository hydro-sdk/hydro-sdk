...
class VMManagedCenter extends _36c2.VMManagedBox<_3960.Center> {VMManagedCenter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.RenderPositionedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPositionedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Center vmObject;

 }

class RTManagedCenter extends _3960.Center implements _36c2.Box<_3960.Center> {RTManagedCenter({_e2dc.Widget? child, _fac9.double? heightFactor, _ab4a.Key? key, _fac9.double? widthFactor, required this.table, required this.hydroState}) : super(child: child,heightFactor: heightFactor,key: key,widthFactor: widthFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'alignment'
] = _36c2.maybeBoxObject(object: alignment, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'widthFactor'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPositionedBox,
...
_3960.Center unwrap() => this;
_3960.Center get vmObject => this;
@_fac9.override _a9e4.RenderPositionedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderPositionedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCenter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'center'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedCenter(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Center>(boxer: ({required _3960.Center vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCenter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

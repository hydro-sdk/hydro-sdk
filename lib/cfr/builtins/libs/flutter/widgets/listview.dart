...
class VMManagedListView extends _36c2.VMManagedBox<_2b56.ListView> {
  VMManagedListView(
...
class RTManagedListView extends _2b56.ListView
    implements _36c2.Box<_2b56.ListView> {
  RTManagedListView(
...
void loadListView(
  ...
  table['listView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedListView(
  ...
  _36c2.registerBoxer<_2b56.ListView>(boxer: (
      {required _2b56.ListView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedListView(

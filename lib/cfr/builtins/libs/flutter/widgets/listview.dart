...
class VMManagedListView extends _36c2.VMManagedBox<_2b56.ListView> {VMManagedListView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'childrenDelegate'
] = _36c2.maybeBoxObject<_a8eb.SliverChildDelegate>(object: vmObject.childrenDelegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'padding'
...
table  [
'buildChildLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.buildChildLayout(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _2b56.ListView vmObject;

 }

class RTManagedListView extends _2b56.ListView implements _36c2.Box<_2b56.ListView> {RTManagedListView({required _fac9.bool addAutomaticKeepAlives, required _fac9.bool addRepaintBoundaries, required _fac9.bool addSemanticIndexes, _fac9.double? cacheExtent, required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, _9585.ScrollController? controller, required _02d2.DragStartBehavior dragStartBehavior, _fac9.double? itemExtent, _ab4a.Key? key, required _2b56.ScrollViewKeyboardDismissBehavior keyboardDismissBehavior, _96d1.EdgeInsetsGeometry? padding, _dbad.ScrollPhysics? physics, _fac9.bool? primary, _e2dc.Widget? prototypeItem, _fac9.String? restorationId, required _fac9.bool reverse, required _487f.Axis scrollDirection, _fac9.int? semanticChildCount, required _fac9.bool shrinkWrap, required this.table, required this.hydroState}) : super(addAutomaticKeepAlives: addAutomaticKeepAlives,addRepaintBoundaries: addRepaintBoundaries,addSemanticIndexes: addSemanticIndexes,cacheExtent: cacheExtent,children: children,clipBehavior: clipBehavior,controller: controller,dragStartBehavior: dragStartBehavior,itemExtent: itemExtent,key: key,keyboardDismissBehavior: keyboardDismissBehavior,padding: padding,physics: physics,primary: primary,prototypeItem: prototypeItem,restorationId: restorationId,reverse: reverse,scrollDirection: scrollDirection,semanticChildCount: semanticChildCount,shrinkWrap: shrinkWrap) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'childrenDelegate'
] = _36c2.maybeBoxObject(object: childrenDelegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'padding'
...
table  [
'scrollBehavior'
] = _36c2.maybeBoxObject(object: scrollBehavior, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shrinkWrap'
] = _36c2.maybeBoxObject(object: this.shrinkWrap, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'center'
] = _36c2.maybeBoxObject(object: center, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'anchor'
] = _36c2.maybeBoxObject(object: anchor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'cacheExtent'
...
table['_dart_buildChildLayout'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.buildChildLayout(
...
_2b56.ListView unwrap() => this;
_2b56.ListView get vmObject => this;
@_fac9.override _e2dc.Widget buildChildLayout(context) { 
_36c2.Closure closure = table["buildChildLayout"];
...
void loadListView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedListView(table: luaCallerArguments  [
0
], hydroState: hydroState, addAutomaticKeepAlives: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'addAutomaticKeepAlives'
] : null, addRepaintBoundaries: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'addRepaintBoundaries'
] : null, addSemanticIndexes: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'addSemanticIndexes'
...
'cacheExtent'
] : null?.toDouble(), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
_36c2.registerBoxer<_2b56.ListView>(boxer: ({required _2b56.ListView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

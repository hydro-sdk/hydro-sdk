...
import 'package:flutter/src/painting/placeholder_span.dart' as _3579;
...
import 'package:flutter/src/widgets/widget_span.dart' as _da00;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedWidgetSpan extends _36c2.VMManagedBox<_da00.WidgetSpan> {VMManagedWidgetSpan({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.computeSemanticsInformation(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_b761.InlineSpanSemanticsInformation>, _b761.InlineSpanSemanticsInformation>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _da00.WidgetSpan vmObject;

 }

class RTManagedWidgetSpan extends _da00.WidgetSpan implements _36c2.Box<_da00.WidgetSpan> {RTManagedWidgetSpan({required _a643.PlaceholderAlignment alignment, _a643.TextBaseline? baseline, _74d0.TextStyle? style, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(alignment: alignment,baseline: baseline,style: style,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_computeSemanticsInformation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.computeSemanticsInformation(_36c2.maybeUnBoxAndBuildArgument<
...
_da00.WidgetSpan unwrap() => this;
_da00.WidgetSpan get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void computeSemanticsInformation(collector) { 
...
void loadWidgetSpan({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'widgetSpan'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedWidgetSpan(table: luaCallerArguments  [
0
], hydroState: hydroState, alignment: _36c2.maybeUnBoxEnum(values: _a643.PlaceholderAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alignment'
] : null), baseline: _36c2.maybeUnBoxEnum(values: _a643.TextBaseline.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'baseline'
...
_36c2.registerBoxer<_da00.WidgetSpan>(boxer: ({required _da00.WidgetSpan vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWidgetSpan(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

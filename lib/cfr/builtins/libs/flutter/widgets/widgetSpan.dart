...
class VMManagedWidgetSpan extends _36c2.VMManagedBox<_da00.WidgetSpan> {
  VMManagedWidgetSpan(
    ...
    table['alignment'] = _a643.PlaceholderAlignment.values.indexWhere((x) {
      return x == vmObject.alignment;
    });
    table['baseline'] = _a643.TextBaseline.values.indexWhere((x) {
      return x == vmObject.baseline;
    });
    ...
    table['computeSemanticsInformation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.computeSemanticsInformation(_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedWidgetSpan extends _da00.WidgetSpan
    implements _36c2.Box<_da00.WidgetSpan> {
  RTManagedWidgetSpan(
      {required _a643.PlaceholderAlignment alignment,
      _a643.TextBaseline? baseline,
...
void loadWidgetSpan(
  ...
  table['widgetSpan'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedWidgetSpan(
          ...
          alignment: _36c2.maybeUnBoxEnum(
              values: _a643.PlaceholderAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['alignment']
                  : null),
          baseline: _36c2.maybeUnBoxEnum(
  ...
  _36c2.registerBoxer<_da00.WidgetSpan>(boxer: (
      {required _da00.WidgetSpan vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedWidgetSpan(

...
import 'package:flutter/src/widgets/visibility.dart' as _4424;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSliverVisibility extends _36c2.VMManagedBox<_4424.SliverVisibility> {VMManagedSliverVisibility({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'sliver'
] = _36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.sliver, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'replacementSliver'
] = _36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.replacementSliver, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'visible'
] = vmObject.visible;
table  [
...
table  [
'maintainAnimation'
] = vmObject.maintainAnimation;
table  [
'maintainSize'
] = vmObject.maintainSize;
table  [
'maintainSemantics'
] = vmObject.maintainSemantics;
table  [
'maintainInteractivity'
] = vmObject.maintainInteractivity;
table  [
'key'
...
final _4424.SliverVisibility vmObject;

 }

class RTManagedSliverVisibility extends _4424.SliverVisibility implements _36c2.Box<_4424.SliverVisibility> {RTManagedSliverVisibility({_ab4a.Key? key, required _fac9.bool maintainAnimation, required _fac9.bool maintainInteractivity, required _fac9.bool maintainSemantics, required _fac9.bool maintainSize, required _fac9.bool maintainState, required _e2dc.Widget replacementSliver, required _fac9.bool visible, required _e2dc.Widget sliver, required this.table, required this.hydroState}) : super(key: key,maintainAnimation: maintainAnimation,maintainInteractivity: maintainInteractivity,maintainSemantics: maintainSemantics,maintainSize: maintainSize,maintainState: maintainState,replacementSliver: replacementSliver,visible: visible,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'sliver'
] = _36c2.maybeBoxObject(object: this.sliver, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'replacementSliver'
] = _36c2.maybeBoxObject(object: this.replacementSliver, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'visible'
...
table  [
'maintainAnimation'
] = _36c2.maybeBoxObject(object: this.maintainAnimation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maintainSize'
] = _36c2.maybeBoxObject(object: this.maintainSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maintainSemantics'
] = _36c2.maybeBoxObject(object: this.maintainSemantics, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maintainInteractivity'
] = _36c2.maybeBoxObject(object: this.maintainInteractivity, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_4424.SliverVisibility unwrap() => this;
_4424.SliverVisibility get vmObject => this;
...
void loadSliverVisibility({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverVisibility'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSliverVisibility(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), maintainAnimation: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainAnimation'
] : null, maintainInteractivity: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainInteractivity'
] : null, maintainSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainSemantics'
] : null, maintainSize: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainSize'
...
'maintainState'
] : null, replacementSliver: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'replacementSliver'
] : null, parentState: hydroState), visible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'visible'
] : null, sliver: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sliver'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_4424.SliverVisibility>(boxer: ({required _4424.SliverVisibility vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverVisibility(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

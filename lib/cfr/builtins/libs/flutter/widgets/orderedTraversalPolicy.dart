...
class VMManagedOrderedTraversalPolicy
    extends _36c2.VMManagedBox<_65d3.OrderedTraversalPolicy> {
  VMManagedOrderedTraversalPolicy(
    ...
    table['secondary'] = _36c2.maybeBoxObject<_65d3.FocusTraversalPolicy?>(
...
class RTManagedOrderedTraversalPolicy extends _65d3.OrderedTraversalPolicy
    implements _36c2.Box<_65d3.OrderedTraversalPolicy> {
  RTManagedOrderedTraversalPolicy(
      {_65d3.FocusTraversalPolicy? secondary,
      required this.table,
...
void loadOrderedTraversalPolicy(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['orderedTraversalPolicy'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOrderedTraversalPolicy(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          secondary: _36c2.maybeUnBoxAndBuildArgument<
                  _65d3.FocusTraversalPolicy?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['secondary']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_65d3.OrderedTraversalPolicy>(boxer: (
      {required _65d3.OrderedTraversalPolicy vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOrderedTraversalPolicy(

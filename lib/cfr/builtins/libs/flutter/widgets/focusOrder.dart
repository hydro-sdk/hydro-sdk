...
class VMManagedFocusOrder extends _36c2.VMManagedBox<_65d3.FocusOrder> {VMManagedFocusOrder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _65d3.FocusOrder vmObject;

 }

class RTManagedFocusOrder extends _65d3.FocusOrder implements _36c2.Box<_65d3.FocusOrder> {RTManagedFocusOrder({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_65d3.FocusOrder unwrap() => this;
_65d3.FocusOrder get vmObject => this;
...
void loadFocusOrder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusOrder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFocusOrder(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_65d3.FocusOrder>(boxer: ({required _65d3.FocusOrder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusOrder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

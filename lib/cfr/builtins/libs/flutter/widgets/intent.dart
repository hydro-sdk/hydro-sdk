...
class VMManagedIntent extends _36c2.VMManagedBox<_c0f4.Intent> {VMManagedIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c0f4.Intent vmObject;

 }

class RTManagedIntent extends _c0f4.Intent implements _36c2.Box<_c0f4.Intent> {RTManagedIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.Intent unwrap() => this;
_c0f4.Intent get vmObject => this;
...
void loadIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'intentDoNothing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [_36c2.maybeBoxObject<_c0f4.DoNothingIntent>(object: _c0f4.Intent.doNothing, hydroState: hydroState, table: _36c2.HydroTable())]; } );
_36c2.registerBoxer<_c0f4.Intent>(boxer: ({required _c0f4.Intent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFocus extends _36c2.VMManagedBox<_c024.Focus> {VMManagedFocus({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedFocus extends _c024.Focus implements _36c2.Box<_c024.Focus> {RTManagedFocus({required _fac9.bool autofocus, _fac9.bool? canRequestFocus, _fac9.String? debugLabel, _fac9.bool? descendantsAreFocusable, _b485.FocusNode? focusNode, required _fac9.bool includeSemantics, _ab4a.Key? key, void Function(_fac9.bool value)? onFocusChange, _b485.KeyEventResult Function(_b485.FocusNode node, _94e8.RawKeyEvent event)? onKey, _b485.KeyEventResult Function(_b485.FocusNode node, _9e29.KeyEvent event)? onKeyEvent, _fac9.bool? skipTraversal, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(autofocus: autofocus,canRequestFocus: canRequestFocus,debugLabel: debugLabel,descendantsAreFocusable: descendantsAreFocusable,focusNode: focusNode,includeSemantics: includeSemantics,key: key,onFocusChange: onFocusChange,onKey: onKey,onKeyEvent: onKeyEvent,skipTraversal: skipTraversal,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadFocus({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focus'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFocus(table: luaCallerArguments  [
0
...
'focusNode'
] : null, parentState: hydroState), includeSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'includeSemantics'
...
return [_36c2.maybeBoxObject<_c024.Focus>(object: _c024.Focus.withExternalFocusNode(autofocus: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'autofocus'
...
return [_36c2.maybeBoxObject<_b485.FocusNode>(object: _c024.Focus.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), scopeOk: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'scopeOk'
] : null), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
...
final returnValue = _c024.Focus.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), scopeOk: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'scopeOk'
] : null);if(returnValue!= null){return [_36c2.maybeBoxObject<_b485.FocusNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'focusIsAt'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_c024.Focus.isAt(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
_36c2.registerBoxer<_c024.Focus>(boxer: ({required _c024.Focus vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocus(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

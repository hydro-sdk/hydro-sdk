...
class VMManagedSliverMultiBoxAdaptorWidget extends _36c2.VMManagedBox<_a8eb.SliverMultiBoxAdaptorWidget> {VMManagedSliverMultiBoxAdaptorWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a8eb.SliverMultiBoxAdaptorWidget vmObject;

 }

class RTManagedSliverMultiBoxAdaptorWidget extends _a8eb.SliverMultiBoxAdaptorWidget implements _36c2.Box<_a8eb.SliverMultiBoxAdaptorWidget> {RTManagedSliverMultiBoxAdaptorWidget({_ab4a.Key? key, required _a8eb.SliverChildDelegate delegate, required this.table, required this.hydroState}) : super(key: key,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a8eb.SliverMultiBoxAdaptorWidget unwrap() => this;
_a8eb.SliverMultiBoxAdaptorWidget get vmObject => this;
...
void loadSliverMultiBoxAdaptorWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverMultiBoxAdaptorWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSliverMultiBoxAdaptorWidget(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a8eb.SliverMultiBoxAdaptorWidget>(boxer: ({required _a8eb.SliverMultiBoxAdaptorWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverMultiBoxAdaptorWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

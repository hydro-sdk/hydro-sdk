...
class VMManagedReorderableDragStartListener extends _36c2.VMManagedBox<_acd7.ReorderableDragStartListener> {VMManagedReorderableDragStartListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _acd7.ReorderableDragStartListener vmObject;

 }

class RTManagedReorderableDragStartListener extends _acd7.ReorderableDragStartListener implements _36c2.Box<_acd7.ReorderableDragStartListener> {RTManagedReorderableDragStartListener({required _fac9.bool enabled, _ab4a.Key? key, required _e2dc.Widget child, required _fac9.int index, required this.table, required this.hydroState}) : super(enabled: enabled,key: key,child: child,index: index) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_acd7.ReorderableDragStartListener unwrap() => this;
_acd7.ReorderableDragStartListener get vmObject => this;
...
void loadReorderableDragStartListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'reorderableDragStartListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedReorderableDragStartListener(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_acd7.ReorderableDragStartListener>(boxer: ({required _acd7.ReorderableDragStartListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedReorderableDragStartListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

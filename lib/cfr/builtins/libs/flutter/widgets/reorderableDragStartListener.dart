...
class VMManagedReorderableDragStartListener
    extends _36c2.VMManagedBox<_acd7.ReorderableDragStartListener> {
  VMManagedReorderableDragStartListener(
...
class RTManagedReorderableDragStartListener
    extends _acd7.ReorderableDragStartListener
    implements _36c2.Box<_acd7.ReorderableDragStartListener> {
  RTManagedReorderableDragStartListener(
...
void loadReorderableDragStartListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['reorderableDragStartListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedReorderableDragStartListener(
  ...
  _36c2.registerBoxer<_acd7.ReorderableDragStartListener>(boxer: (
      {required _acd7.ReorderableDragStartListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedReorderableDragStartListener(

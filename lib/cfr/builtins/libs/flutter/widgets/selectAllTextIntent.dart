...
class VMManagedSelectAllTextIntent extends _36c2.VMManagedBox<_380d.SelectAllTextIntent> {VMManagedSelectAllTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.SelectAllTextIntent vmObject;

 }

class RTManagedSelectAllTextIntent extends _380d.SelectAllTextIntent implements _36c2.Box<_380d.SelectAllTextIntent> {RTManagedSelectAllTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.SelectAllTextIntent unwrap() => this;
_380d.SelectAllTextIntent get vmObject => this;
...
void loadSelectAllTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'selectAllTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSelectAllTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.SelectAllTextIntent>(boxer: ({required _380d.SelectAllTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSelectAllTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

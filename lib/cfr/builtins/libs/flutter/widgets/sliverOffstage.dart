...
class VMManagedSliverOffstage extends _36c2.VMManagedBox<_a8eb.SliverOffstage> {VMManagedSliverOffstage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_26cc.RenderSliverOffstage>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOffstage, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a8eb.SliverOffstage vmObject;

 }

class RTManagedSliverOffstage extends _a8eb.SliverOffstage implements _36c2.Box<_a8eb.SliverOffstage> {RTManagedSliverOffstage({_ab4a.Key? key, required _fac9.bool offstage, _e2dc.Widget? sliver, required this.table, required this.hydroState}) : super(key: key,offstage: offstage,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'offstage'
] = _36c2.maybeBoxObject(object: this.offstage, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOffstage,
...
_a8eb.SliverOffstage unwrap() => this;
_a8eb.SliverOffstage get vmObject => this;
@_fac9.override _26cc.RenderSliverOffstage createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverOffstage, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverOffstage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverOffstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedSliverOffstage(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), offstage: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'offstage'
...
_36c2.registerBoxer<_a8eb.SliverOffstage>(boxer: ({required _a8eb.SliverOffstage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverOffstage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverOffstage extends _36c2.VMManagedBox<_a8eb.SliverOffstage> {
  VMManagedSliverOffstage(
    ...
    table['offstage'] = vmObject.offstage;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_26cc.RenderSliverOffstage>(
...
class RTManagedSliverOffstage extends _a8eb.SliverOffstage
    implements _36c2.Box<_a8eb.SliverOffstage> {
  RTManagedSliverOffstage(
      {_ab4a.Key? key,
      required _fac9.bool offstage,
      _e2dc.Widget? sliver,
      required this.table,
      required this.hydroState})
      : super(key: key, offstage: offstage, sliver: sliver) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['offstage'] = _36c2.maybeBoxObject(
        object: this.offstage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _26cc.RenderSliverOffstage createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_26cc.RenderSliverOffstage, _fac9.dynamic>(
...
void loadSliverOffstage(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverOffstage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverOffstage(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          offstage: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['offstage']
              : null,
          sliver:
  ...
  _36c2.registerBoxer<_a8eb.SliverOffstage>(boxer: (
      {required _a8eb.SliverOffstage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverOffstage(

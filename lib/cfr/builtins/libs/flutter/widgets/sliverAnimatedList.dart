...
class VMManagedSliverAnimatedList extends _36c2.VMManagedBox<_cd40.SliverAnimatedList> {VMManagedSliverAnimatedList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_cd40.SliverAnimatedListState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _cd40.SliverAnimatedList vmObject;

 }

class RTManagedSliverAnimatedList extends _cd40.SliverAnimatedList implements _36c2.Box<_cd40.SliverAnimatedList> {RTManagedSliverAnimatedList({required _fac9.int initialItemCount, _ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _fac9.int index, _86ca.Animation<_fac9.double> animation) itemBuilder, required this.table, required this.hydroState}) : super(initialItemCount: initialItemCount,key: key,itemBuilder: itemBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_cd40.SliverAnimatedList unwrap() => this;
_cd40.SliverAnimatedList get vmObject => this;
@_fac9.override _cd40.SliverAnimatedListState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_cd40.SliverAnimatedListState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverAnimatedList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverAnimatedList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSliverAnimatedList(table: luaCallerArguments  [
0
], hydroState: hydroState, initialItemCount: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialItemCount'
...
'key'
] : null, parentState: hydroState), itemBuilder: (context, index, animation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackeditemBuilder.dispatch([luaCallerArguments[0],context,index,animation],parentState:hydroState,)[0], parentState: hydroState))]; } );
table  [
'sliverAnimatedListOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_cd40.SliverAnimatedListState>(object: _cd40.SliverAnimatedList.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'sliverAnimatedListMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _cd40.SliverAnimatedList.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_cd40.SliverAnimatedListState?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_cd40.SliverAnimatedList>(boxer: ({required _cd40.SliverAnimatedList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverAnimatedList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

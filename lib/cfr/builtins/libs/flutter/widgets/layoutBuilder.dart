...
class VMManagedLayoutBuilder extends _36c2.VMManagedBox<_d69f.LayoutBuilder> {VMManagedLayoutBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d69f.LayoutBuilder vmObject;

 }

class RTManagedLayoutBuilder extends _d69f.LayoutBuilder implements _36c2.Box<_d69f.LayoutBuilder> {RTManagedLayoutBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _be2e.BoxConstraints constraints) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d69f.LayoutBuilder unwrap() => this;
_d69f.LayoutBuilder get vmObject => this;
...
void loadLayoutBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'layoutBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedLayoutBuilder(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d69f.LayoutBuilder>(boxer: ({required _d69f.LayoutBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLayoutBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

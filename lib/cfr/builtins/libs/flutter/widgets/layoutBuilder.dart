...
class VMManagedLayoutBuilder extends _36c2.VMManagedBox<_d69f.LayoutBuilder> {
  VMManagedLayoutBuilder(
...
class RTManagedLayoutBuilder extends _d69f.LayoutBuilder
    implements _36c2.Box<_d69f.LayoutBuilder> {
  RTManagedLayoutBuilder(
      {_ab4a.Key? key,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context, _be2e.BoxConstraints constraints)
          builder,
      required this.table,
...
void loadLayoutBuilder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['layoutBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_d69f.LayoutBuilder>(boxer: (
      {required _d69f.LayoutBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLayoutBuilder(

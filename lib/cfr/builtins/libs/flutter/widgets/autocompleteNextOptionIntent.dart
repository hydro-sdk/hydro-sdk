...
class VMManagedAutocompleteNextOptionIntent extends _36c2.VMManagedBox<_2a05.AutocompleteNextOptionIntent> {VMManagedAutocompleteNextOptionIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2a05.AutocompleteNextOptionIntent vmObject;

 }

class RTManagedAutocompleteNextOptionIntent extends _2a05.AutocompleteNextOptionIntent implements _36c2.Box<_2a05.AutocompleteNextOptionIntent> {RTManagedAutocompleteNextOptionIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2a05.AutocompleteNextOptionIntent unwrap() => this;
_2a05.AutocompleteNextOptionIntent get vmObject => this;
...
void loadAutocompleteNextOptionIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'autocompleteNextOptionIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAutocompleteNextOptionIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_2a05.AutocompleteNextOptionIntent>(boxer: ({required _2a05.AutocompleteNextOptionIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutocompleteNextOptionIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

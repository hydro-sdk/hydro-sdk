...
class VMManagedRangeMaintainingScrollPhysics
    extends _36c2.VMManagedBox<_dbad.RangeMaintainingScrollPhysics> {
  VMManagedRangeMaintainingScrollPhysics(
    ...
    table['applyTo'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_dbad.RangeMaintainingScrollPhysics>(
...
class RTManagedRangeMaintainingScrollPhysics
    extends _dbad.RangeMaintainingScrollPhysics
    implements _36c2.Box<_dbad.RangeMaintainingScrollPhysics> {
  RTManagedRangeMaintainingScrollPhysics(
  ...
  @_fac9.override
  _dbad.RangeMaintainingScrollPhysics applyTo(ancestor) {
    _36c2.Closure closure = table["applyTo"];
    return _36c2.maybeUnBoxAndBuildArgument<_dbad.RangeMaintainingScrollPhysics,
            _fac9.dynamic>(
...
void loadRangeMaintainingScrollPhysics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rangeMaintainingScrollPhysics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRangeMaintainingScrollPhysics(
  ...
  _36c2.registerBoxer<_dbad.RangeMaintainingScrollPhysics>(boxer: (
      {required _dbad.RangeMaintainingScrollPhysics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRangeMaintainingScrollPhysics(

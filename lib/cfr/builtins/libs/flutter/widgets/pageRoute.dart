...
class VMManagedPageRoute
    extends _36c2.VMManagedBox<_18d3.PageRoute<_fac9.dynamic>> {
  VMManagedPageRoute(
...
class RTManagedPageRoute extends _18d3.PageRoute
    implements _36c2.Box<_18d3.PageRoute> {
  RTManagedPageRoute(
...
void loadPageRoute(
  ...
  table['pageRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPageRoute(
  ...
  _36c2.registerBoxer<_18d3.PageRoute>(boxer: (
      {required _18d3.PageRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPageRoute(

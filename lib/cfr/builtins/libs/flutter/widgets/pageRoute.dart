...
class VMManagedPageRoute extends _36c2.VMManagedBox<_18d3.PageRoute<_fac9.dynamic>> {VMManagedPageRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _18d3.PageRoute<_fac9.dynamic> vmObject;

 }

class RTManagedPageRoute extends _18d3.PageRoute implements _36c2.Box<_18d3.PageRoute> {RTManagedPageRoute({required _fac9.bool fullscreenDialog, _a37d.RouteSettings? settings, required this.table, required this.hydroState}) : super(fullscreenDialog: fullscreenDialog,settings: settings) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_18d3.PageRoute unwrap() => this;
_18d3.PageRoute get vmObject => this;
...
void loadPageRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pageRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedPageRoute(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_18d3.PageRoute>(boxer: ({required _18d3.PageRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPageRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

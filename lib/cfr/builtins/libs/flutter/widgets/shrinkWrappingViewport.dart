...
class VMManagedShrinkWrappingViewport extends _36c2.VMManagedBox<_f1c1.ShrinkWrappingViewport> {VMManagedShrinkWrappingViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_01f8.RenderShrinkWrappingViewport>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderShrinkWrappingViewport, _fac9.dynamic>(luaCallerArguments  [
2
...
final _f1c1.ShrinkWrappingViewport vmObject;

 }

class RTManagedShrinkWrappingViewport extends _f1c1.ShrinkWrappingViewport implements _36c2.Box<_f1c1.ShrinkWrappingViewport> {RTManagedShrinkWrappingViewport({required _487f.AxisDirection axisDirection, required _a643.Clip clipBehavior, _487f.AxisDirection? crossAxisDirection, _ab4a.Key? key, required _fac9.List<_e2dc.Widget> slivers, required _f376.ViewportOffset offset, required this.table, required this.hydroState}) : super(axisDirection: axisDirection,clipBehavior: clipBehavior,crossAxisDirection: crossAxisDirection,key: key,slivers: slivers,offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderShrinkWrappingViewport,
...
_f1c1.ShrinkWrappingViewport unwrap() => this;
_f1c1.ShrinkWrappingViewport get vmObject => this;
@_fac9.override _01f8.RenderShrinkWrappingViewport createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderShrinkWrappingViewport, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadShrinkWrappingViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedShrinkWrappingViewport(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_f1c1.ShrinkWrappingViewport>(boxer: ({required _f1c1.ShrinkWrappingViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShrinkWrappingViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedShrinkWrappingViewport
    extends _36c2.VMManagedBox<_f1c1.ShrinkWrappingViewport> {
  VMManagedShrinkWrappingViewport(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_01f8.RenderShrinkWrappingViewport>(
...
class RTManagedShrinkWrappingViewport extends _f1c1.ShrinkWrappingViewport
    implements _36c2.Box<_f1c1.ShrinkWrappingViewport> {
  RTManagedShrinkWrappingViewport(
  ...
  @_fac9.override
  _01f8.RenderShrinkWrappingViewport createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderShrinkWrappingViewport,
            _fac9.dynamic>(
...
void loadShrinkWrappingViewport(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['shrinkWrappingViewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedShrinkWrappingViewport(
          ...
          slivers: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['slivers']
                      : null,
                  parentState: hydroState),
          offset: _36c2.maybeUnBoxAndBuildArgument<_f376.ViewportOffset, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['offset'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_f1c1.ShrinkWrappingViewport>(boxer: (
      {required _f1c1.ShrinkWrappingViewport vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShrinkWrappingViewport(

...
class VMManagedErrorWidget extends _36c2.VMManagedBox<_e2dc.ErrorWidget> {
...
class RTManagedErrorWidget extends _e2dc.ErrorWidget
    implements _36c2.Box<_e2dc.ErrorWidget> {
  RTManagedErrorWidget(_fac9.Object exception,
...
void loadErrorWidget(
  ...
  table['errorWidget'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_e2dc.ErrorWidget>(boxer: (
      {required _e2dc.ErrorWidget vmObject,

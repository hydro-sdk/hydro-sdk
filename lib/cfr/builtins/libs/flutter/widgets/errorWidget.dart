...
class VMManagedErrorWidget extends _36c2.VMManagedBox<_e2dc.ErrorWidget> {VMManagedErrorWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.ErrorWidget vmObject;

 }

class RTManagedErrorWidget extends _e2dc.ErrorWidget implements _36c2.Box<_e2dc.ErrorWidget> {RTManagedErrorWidget(_fac9.Object exception, {required this.table, required this.hydroState}) : super(exception,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.ErrorWidget unwrap() => this;
_e2dc.ErrorWidget get vmObject => this;
...
void loadErrorWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'errorWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedErrorWidget(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.ErrorWidget>(boxer: ({required _e2dc.ErrorWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedErrorWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

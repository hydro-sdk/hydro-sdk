...
class VMManagedTable extends _36c2.VMManagedBox<_0e67.Table> {
  VMManagedTable(
    ...
    table['children'] = _36c2.maybeBoxObject<_fac9.List<_0e67.TableRow>>(
        object: vmObject.children,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['columnWidths'] = _36c2.maybeBoxObject<_fac9.Map?>(
        object: vmObject.columnWidths,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['defaultColumnWidth'] = _36c2.maybeBoxObject<_31d2.TableColumnWidth>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_31d2.RenderTable>(
...
class RTManagedTable extends _0e67.Table implements _36c2.Box<_0e67.Table> {
  RTManagedTable(
      {_2738.TableBorder? border,
      required _fac9.List<_0e67.TableRow> children,
    ...
    table['children'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['columnWidths'] = _36c2.maybeBoxObject(
        object: this.columnWidths,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['defaultColumnWidth'] = _36c2.maybeBoxObject(
        object: this.defaultColumnWidth,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['textDirection'] = _a643.TextDirection.values.indexWhere((x) {
    ...
    table['defaultVerticalAlignment'] =
        _31d2.TableCellVerticalAlignment.values.indexWhere((x) {
      return x == this.defaultVerticalAlignment;
    });
    table['textBaseline'] = _a643.TextBaseline.values.indexWhere((x) {
  ...
  @_fac9.override
  _31d2.RenderTable createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_31d2.RenderTable, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadTable(
  ...
  table['table'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTable(
          ...
          border: _36c2.maybeUnBoxAndBuildArgument<_2738.TableBorder?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['border'] : null,
              parentState: hydroState),
          children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_0e67.TableRow>, _0e67.TableRow>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
              parentState: hydroState),
          columnWidths: _36c2.maybeUnBoxAndBuildArgument<
                  _fac9.Map<_fac9.int, _31d2.TableColumnWidth>?,
                  _fac9.int>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['columnWidths'] : null,
              parentState: hydroState),
          defaultColumnWidth:
              _36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultColumnWidth'] : null,
                  parentState: hydroState),
          defaultVerticalAlignment: _36c2.maybeUnBoxEnum(
              values: _31d2.TableCellVerticalAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultVerticalAlignment'] : null),
  ...
  _36c2.registerBoxer<_0e67.Table>(boxer: (
      {required _0e67.Table vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTable(

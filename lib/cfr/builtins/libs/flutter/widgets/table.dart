...
class VMManagedTable extends _36c2.VMManagedBox<_0e67.Table> {VMManagedTable({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'children'
] = _36c2.maybeBoxObject<_fac9.List<_0e67.TableRow>>(object: vmObject.children, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'columnWidths'
] = _36c2.maybeBoxObject<_fac9.Map?>(object: vmObject.columnWidths, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'defaultColumnWidth'
] = _36c2.maybeBoxObject<_31d2.TableColumnWidth>(object: vmObject.defaultColumnWidth, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'textDirection'
] = _a643.TextDirection.values.indexWhere((x) { return x == vmObject.textDirection; } );
table  [
'border'
] = _36c2.maybeBoxObject<_2738.TableBorder?>(object: vmObject.border, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'defaultVerticalAlignment'
] = _31d2.TableCellVerticalAlignment.values.indexWhere((x) { return x == vmObject.defaultVerticalAlignment; } );
table  [
'textBaseline'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_31d2.RenderTable>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_31d2.RenderTable, _fac9.dynamic>(luaCallerArguments  [
2
...
final _0e67.Table vmObject;

 }

class RTManagedTable extends _0e67.Table implements _36c2.Box<_0e67.Table> {RTManagedTable({_2738.TableBorder? border, required _fac9.List<_0e67.TableRow> children, _fac9.Map<_fac9.int,_31d2.TableColumnWidth>? columnWidths, required _31d2.TableColumnWidth defaultColumnWidth, required _31d2.TableCellVerticalAlignment defaultVerticalAlignment, _ab4a.Key? key, _a643.TextBaseline? textBaseline, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(border: border,children: children,columnWidths: columnWidths,defaultColumnWidth: defaultColumnWidth,defaultVerticalAlignment: defaultVerticalAlignment,key: key,textBaseline: textBaseline,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'columnWidths'
] = _36c2.maybeBoxObject(object: this.columnWidths, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'defaultColumnWidth'
] = _36c2.maybeBoxObject(object: this.defaultColumnWidth, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'textDirection'
...
table  [
'defaultVerticalAlignment'
] = _31d2.TableCellVerticalAlignment.values.indexWhere((x) { return x == this.defaultVerticalAlignment; } );
table  [
'textBaseline'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_31d2.RenderTable, _fac9.dynamic>(
...
_0e67.Table unwrap() => this;
_0e67.Table get vmObject => this;
@_fac9.override _e2dc.RenderObjectElement createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectElement, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _31d2.RenderTable createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_31d2.RenderTable, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadTable({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'table'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedTable(table: luaCallerArguments  [
0
...
'border'
] : null, parentState: hydroState), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_0e67.TableRow>, _0e67.TableRow>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
_36c2.registerBoxer<_0e67.Table>(boxer: ({required _0e67.Table vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTable(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

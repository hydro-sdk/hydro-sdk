...
class VMManagedRouteObserver extends _36c2.VMManagedBox<_8c2a.RouteObserver<_a37d.Route<_fac9.dynamic>>> {VMManagedRouteObserver({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
vmObject.subscribe(_36c2.maybeUnBoxAndBuildArgument<_8c2a.RouteAware, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'unsubscribe'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.unsubscribe(_36c2.maybeUnBoxAndBuildArgument<_8c2a.RouteAware, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedRouteObserver extends _8c2a.RouteObserver implements _36c2.Box<_8c2a.RouteObserver> {RTManagedRouteObserver({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_subscribe'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.subscribe(
...
@_fac9.override _fac9.bool debugObservingRoute(route) { 
_36c2.Closure closure = table["debugObservingRoute"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void subscribe(routeAware, route) { 
_36c2.Closure closure = table["subscribe"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void unsubscribe(routeAware) { 
...
void loadRouteObserver({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'routeObserver'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRouteObserver(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_8c2a.RouteObserver>(boxer: ({required _8c2a.RouteObserver vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRouteObserver(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

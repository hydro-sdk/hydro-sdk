...
class VMManagedFixedExtentMetrics extends _36c2.VMManagedBox<_7b25.FixedExtentMetrics> {VMManagedFixedExtentMetrics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_7b25.FixedExtentMetrics>(object: vmObject.copyWith(axisDirection: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'axisDirection'
] : null), itemIndex: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'itemIndex'
...
final _7b25.FixedExtentMetrics vmObject;

 }

class RTManagedFixedExtentMetrics extends _7b25.FixedExtentMetrics implements _36c2.Box<_7b25.FixedExtentMetrics> {RTManagedFixedExtentMetrics({required _487f.AxisDirection axisDirection, required _fac9.int itemIndex, _fac9.double? maxScrollExtent, _fac9.double? minScrollExtent, _fac9.double? pixels, _fac9.double? viewportDimension, required this.table, required this.hydroState}) : super(axisDirection: axisDirection,itemIndex: itemIndex,maxScrollExtent: maxScrollExtent,minScrollExtent: minScrollExtent,pixels: pixels,viewportDimension: viewportDimension) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'itemIndex'
] = _36c2.maybeBoxObject(object: this.itemIndex, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'axisDirection'
        ...
        object: super.copyWith(
            axisDirection: _36c2.maybeUnBoxEnum(
                ...
                boxedEnum: luaCallerArguments.length >= 2
                    ...
                    : null),
            itemIndex: _36c2.maybeUnBoxAndBuildArgument<_fac9.int?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['itemIndex'] : null,
            ...
            maxScrollExtent:
                _36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
                    luaCallerArguments.length >= 2
                        ...
                        : null,
                    parentState: hydroState),
            minScrollExtent: _36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
                luaCallerArguments.length >= 2 ? luaCallerArguments[1]['minScrollExtent'] : null,
                parentState: hydroState),
            pixels: _36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['pixels'] : null, parentState: hydroState),
...
_7b25.FixedExtentMetrics unwrap() => this;
_7b25.FixedExtentMetrics get vmObject => this;
@_fac9.override _7b25.FixedExtentMetrics copyWith({_487f.AxisDirection? axisDirection, _fac9.int? itemIndex, _fac9.double? maxScrollExtent, _fac9.double? minScrollExtent, _fac9.double? pixels, _fac9.double? viewportDimension}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_7b25.FixedExtentMetrics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFixedExtentMetrics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fixedExtentMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFixedExtentMetrics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7b25.FixedExtentMetrics>(boxer: ({required _7b25.FixedExtentMetrics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFixedExtentMetrics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

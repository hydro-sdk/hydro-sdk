...
class VMManagedFixedExtentMetrics
    extends _36c2.VMManagedBox<_7b25.FixedExtentMetrics> {
  VMManagedFixedExtentMetrics(
    ...
    table['itemIndex'] = vmObject.itemIndex;
    ...
    table['copyWith'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_7b25.FixedExtentMetrics>(
            object: vmObject.copyWith(
                axisDirection: _36c2.maybeUnBoxEnum(
                    ...
                    boxedEnum: luaCallerArguments.length >= 2
                        ...
                        : null),
                itemIndex: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['itemIndex']
                    : null,
...
class RTManagedFixedExtentMetrics extends _7b25.FixedExtentMetrics
    implements _36c2.Box<_7b25.FixedExtentMetrics> {
  RTManagedFixedExtentMetrics(
      {required _487f.AxisDirection axisDirection,
      required _fac9.int itemIndex,
    ...
    table['itemIndex'] = _36c2.maybeBoxObject(
        object: this.itemIndex,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['axisDirection'] = _487f.AxisDirection.values.indexWhere((x) {
  ...
  @_fac9.override
  _7b25.FixedExtentMetrics copyWith(
    ...
    return _36c2
        .maybeUnBoxAndBuildArgument<_7b25.FixedExtentMetrics, _fac9.dynamic>(
...
void loadFixedExtentMetrics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['fixedExtentMetrics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFixedExtentMetrics(
  ...
  _36c2.registerBoxer<_7b25.FixedExtentMetrics>(boxer: (
      {required _7b25.FixedExtentMetrics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFixedExtentMetrics(

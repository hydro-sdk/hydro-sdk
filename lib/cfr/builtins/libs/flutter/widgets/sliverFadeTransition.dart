...
class VMManagedSliverFadeTransition
    extends _36c2.VMManagedBox<_d7ad.SliverFadeTransition> {
  VMManagedSliverFadeTransition(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_26cc.RenderSliverAnimatedOpacity>(
...
class RTManagedSliverFadeTransition extends _d7ad.SliverFadeTransition
    implements _36c2.Box<_d7ad.SliverFadeTransition> {
  RTManagedSliverFadeTransition(
  ...
  @_fac9.override
  _26cc.RenderSliverAnimatedOpacity createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_26cc.RenderSliverAnimatedOpacity,
            _fac9.dynamic>(
...
void loadSliverFadeTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverFadeTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverFadeTransition(
          ...
          sliver: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          opacity: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['opacity'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.SliverFadeTransition>(boxer: (
      {required _d7ad.SliverFadeTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverFadeTransition(

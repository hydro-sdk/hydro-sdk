...
class VMManagedRenderObjectToWidgetElement extends _36c2
    .VMManagedBox<_3e19.RenderObjectToWidgetElement<_9742.RenderObject>> {
  VMManagedRenderObjectToWidgetElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_3e19.RenderObjectToWidgetAdapter>(
    ...
    table['assignOwner'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.assignOwner(
...
class RTManagedRenderObjectToWidgetElement
    extends _3e19.RenderObjectToWidgetElement
    implements _36c2.Box<_3e19.RenderObjectToWidgetElement> {
  RTManagedRenderObjectToWidgetElement(
      _3e19.RenderObjectToWidgetAdapter<_9742.RenderObject> widget$,
      {required this.table,
    ...
    table['_dart_assignOwner'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.assignOwner(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildOwner, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _3e19.RenderObjectToWidgetAdapter<_9742.RenderObject> get widget {
  ...
  @_fac9.override
  _9742.RenderObjectWithChildMixin<_9742.RenderObject> get renderObject {
...
void loadRenderObjectToWidgetElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderObjectToWidgetElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderObjectToWidgetElement(
  ...
  _36c2.registerBoxer<_3e19.RenderObjectToWidgetElement>(boxer: (
      {required _3e19.RenderObjectToWidgetElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderObjectToWidgetElement(

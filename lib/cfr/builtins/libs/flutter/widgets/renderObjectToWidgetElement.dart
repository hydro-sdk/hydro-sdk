...
class VMManagedRenderObjectToWidgetElement extends _36c2.VMManagedBox<_3e19.RenderObjectToWidgetElement<_9742.RenderObject>> {VMManagedRenderObjectToWidgetElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_3e19.RenderObjectToWidgetAdapter>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'visitChildren'
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetAdapter<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9742.RenderObjectWithChildMixin>(object: vmObject.renderObject, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
...
table  [
'assignOwner'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.assignOwner(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildOwner, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _3e19.RenderObjectToWidgetElement<_9742.RenderObject> vmObject;

 }

class RTManagedRenderObjectToWidgetElement extends _3e19.RenderObjectToWidgetElement implements _36c2.Box<_3e19.RenderObjectToWidgetElement> {RTManagedRenderObjectToWidgetElement(_3e19.RenderObjectToWidgetAdapter<_9742.RenderObject> widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_assignOwner'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.assignOwner(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildOwner, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
...
_3e19.RenderObjectToWidgetElement unwrap() => this;
_3e19.RenderObjectToWidgetElement get vmObject => this;
@_fac9.override _3e19.RenderObjectToWidgetAdapter<_9742.RenderObject> get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetAdapter<_9742.RenderObject>, _9742.RenderObject>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _9742.RenderObjectWithChildMixin<_9742.RenderObject> get renderObject { 
_36c2.Closure closure = table["getRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObjectWithChildMixin<_9742.RenderObject>, _9742.RenderObject>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void assignOwner(owner) { 
_36c2.Closure closure = table["assignOwner"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderObjectToWidgetElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderObjectToWidgetElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderObjectToWidgetElement(_36c2.maybeUnBoxAndBuildArgument<_3e19.RenderObjectToWidgetAdapter<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_3e19.RenderObjectToWidgetElement>(boxer: ({required _3e19.RenderObjectToWidgetElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderObjectToWidgetElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

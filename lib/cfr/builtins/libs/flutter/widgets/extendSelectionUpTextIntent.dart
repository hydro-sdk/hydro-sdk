...
class VMManagedExtendSelectionUpTextIntent extends _36c2.VMManagedBox<_380d.ExtendSelectionUpTextIntent> {VMManagedExtendSelectionUpTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.ExtendSelectionUpTextIntent vmObject;

 }

class RTManagedExtendSelectionUpTextIntent extends _380d.ExtendSelectionUpTextIntent implements _36c2.Box<_380d.ExtendSelectionUpTextIntent> {RTManagedExtendSelectionUpTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.ExtendSelectionUpTextIntent unwrap() => this;
_380d.ExtendSelectionUpTextIntent get vmObject => this;
...
void loadExtendSelectionUpTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'extendSelectionUpTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedExtendSelectionUpTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.ExtendSelectionUpTextIntent>(boxer: ({required _380d.ExtendSelectionUpTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedExtendSelectionUpTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverAnimatedListState extends _36c2.VMManagedBox<_cd40.SliverAnimatedListState> {VMManagedSliverAnimatedListState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
vmObject.insertItem(luaCallerArguments  [
1
], duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'duration'
...
_36c2.Closure unpackedbuilder=luaCallerArguments  [
2
];
vmObject.removeItem(luaCallerArguments  [
1
], (context, animation) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,animation],parentState:hydroState,)[0], parentState: hydroState), duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'duration'
] : null, parentState: hydroState));
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_cd40.SliverAnimatedList>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedSliverAnimatedListState extends _cd40.SliverAnimatedListState implements _36c2.Box<_cd40.SliverAnimatedListState> {RTManagedSliverAnimatedListState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_didUpdateWidget'] =
  ...
  super.didUpdateWidget(
      _36c2.maybeUnBoxAndBuildArgument<_cd40.SliverAnimatedList, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void insertItem(index, {_fac9.Duration duration = const _fac9.Duration(milliseconds:300)}) { 
_36c2.Closure closure = table["insertItem"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeItem(index, builder, {_fac9.Duration duration = const _fac9.Duration(milliseconds:300)}) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _cd40.SliverAnimatedList get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_cd40.SliverAnimatedList, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSliverAnimatedListState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverAnimatedListState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSliverAnimatedListState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_cd40.SliverAnimatedListState>(boxer: ({required _cd40.SliverAnimatedListState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverAnimatedListState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

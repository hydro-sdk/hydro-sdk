...
class VMManagedModalRoute
    extends _36c2.VMManagedBox<_8c2a.ModalRoute<_fac9.dynamic>> {
  VMManagedModalRoute(
...
class RTManagedModalRoute extends _8c2a.ModalRoute
    implements _36c2.Box<_8c2a.ModalRoute> {
  RTManagedModalRoute(
...
void loadModalRoute(
  ...
  table['modalRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedModalRoute(
  ...
  table['modalRouteOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _8c2a.ModalRoute.of(
        _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState));
    if (returnValue != null) {
      return [
        _36c2.maybeBoxObject<_8c2a.ModalRoute?>(
            object: returnValue,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
  ...
  table['modalRouteWithName'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _8c2a.ModalRoute.withName(luaCallerArguments[1]),
    ];
  });
  _36c2.registerBoxer<_8c2a.ModalRoute>(boxer: (
      {required _8c2a.ModalRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedModalRoute(

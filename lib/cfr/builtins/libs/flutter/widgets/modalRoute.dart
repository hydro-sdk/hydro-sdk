...
class VMManagedModalRoute extends _36c2.VMManagedBox<_8c2a.ModalRoute<_fac9.dynamic>> {VMManagedModalRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c2a.ModalRoute<_fac9.dynamic> vmObject;

 }

class RTManagedModalRoute extends _8c2a.ModalRoute implements _36c2.Box<_8c2a.ModalRoute> {RTManagedModalRoute({_a643.ImageFilter? filter, _a37d.RouteSettings? settings, required this.table, required this.hydroState}) : super(filter: filter,settings: settings) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c2a.ModalRoute unwrap() => this;
_8c2a.ModalRoute get vmObject => this;
...
void loadModalRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'modalRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedModalRoute(table: luaCallerArguments  [
0
], hydroState: hydroState, filter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'filter'
...
table  [
'modalRouteOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _8c2a.ModalRoute.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_8c2a.ModalRoute?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'modalRouteWithName'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_8c2a.ModalRoute.withName(luaCallerArguments  [
1
]),]; } );
_36c2.registerBoxer<_8c2a.ModalRoute>(boxer: ({required _8c2a.ModalRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedModalRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

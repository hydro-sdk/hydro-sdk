...
class VMManagedRootRenderObjectElement extends _36c2.VMManagedBox<_e2dc.RootRenderObjectElement> {VMManagedRootRenderObjectElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e2dc.RootRenderObjectElement vmObject;

 }

class RTManagedRootRenderObjectElement extends _e2dc.RootRenderObjectElement implements _36c2.Box<_e2dc.RootRenderObjectElement> {RTManagedRootRenderObjectElement(_e2dc.RenderObjectWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e2dc.RootRenderObjectElement unwrap() => this;
_e2dc.RootRenderObjectElement get vmObject => this;
...
void loadRootRenderObjectElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rootRenderObjectElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRootRenderObjectElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.RootRenderObjectElement>(boxer: ({required _e2dc.RootRenderObjectElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRootRenderObjectElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

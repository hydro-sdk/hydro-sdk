...
class VMManagedRootRenderObjectElement
    extends _36c2.VMManagedBox<_e2dc.RootRenderObjectElement> {
  VMManagedRootRenderObjectElement(
    ...
    table['update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget,
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e2dc.RenderObjectWidget>(
...
class RTManagedRootRenderObjectElement extends _e2dc.RootRenderObjectElement
    implements _36c2.Box<_e2dc.RootRenderObjectElement> {
  RTManagedRootRenderObjectElement(_e2dc.RenderObjectWidget widget$,
    ...
    table['_dart_update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _e2dc.RenderObjectWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadRootRenderObjectElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rootRenderObjectElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRootRenderObjectElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.RenderObjectWidget,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e2dc.RootRenderObjectElement>(boxer: (
      {required _e2dc.RootRenderObjectElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRootRenderObjectElement(

...
class VMManagedRootRenderObjectElement
    extends VMManagedBox<RootRenderObjectElement> {
  VMManagedRootRenderObjectElement(
    ...
    table['assignOwner'] =
      ...
      vmObject.assignOwner(maybeUnBoxAndBuildArgument<BuildOwner, dynamic>(
    ...
    table['update'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.update(maybeUnBoxAndBuildArgument<RenderObjectWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['getWidget'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<RenderObjectWidget>(
  ...
  final RootRenderObjectElement vmObject;
}

class RTManagedRootRenderObjectElement extends RootRenderObjectElement
    implements Box<RootRenderObjectElement> {
  RTManagedRootRenderObjectElement(RenderObjectWidget widget$,
    ...
    table['_dart_assignOwner'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.assignOwner(maybeUnBoxAndBuildArgument<BuildOwner, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_update'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.update(maybeUnBoxAndBuildArgument<RenderObjectWidget, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RootRenderObjectElement unwrap() => this;
  RootRenderObjectElement get vmObject => this;
  @override
  void assignOwner(owner) {
    Closure closure = table["assignOwner"];
  ...
  RenderObjectWidget get widget {
    ...
    return maybeUnBoxAndBuildArgument<RenderObjectWidget, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRootRenderObjectElement(
  ...
  table['rootRenderObjectElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRootRenderObjectElement(
          maybeUnBoxAndBuildArgument<RenderObjectWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<RootRenderObjectElement>(boxer: (
      {required RootRenderObjectElement vmObject,

...
class VMManagedComponentElement extends _36c2.VMManagedBox<_e2dc.ComponentElement> {VMManagedComponentElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _e2dc.ComponentElement vmObject;

 }

class RTManagedComponentElement extends _e2dc.ComponentElement implements _36c2.Box<_e2dc.ComponentElement> {RTManagedComponentElement(_e2dc.Widget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_build'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: build(), hydroState: hydroState, table: _36c2.HydroTable())
  ];
});
...
table['_dart_update'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_e2dc.ComponentElement unwrap() => this;
_e2dc.ComponentElement get vmObject => this;
...
void loadComponentElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'componentElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedComponentElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.ComponentElement>(boxer: ({required _e2dc.ComponentElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedComponentElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

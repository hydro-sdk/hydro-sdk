...
class VMManagedComponentElement
    extends _36c2.VMManagedBox<_e2dc.ComponentElement> {
  VMManagedComponentElement(
...
class RTManagedComponentElement extends _e2dc.ComponentElement
    implements _36c2.Box<_e2dc.ComponentElement> {
  RTManagedComponentElement(_e2dc.Widget widget$,
...
void loadComponentElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['componentElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedComponentElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_e2dc.ComponentElement>(boxer: (
      {required _e2dc.ComponentElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedComponentElement(

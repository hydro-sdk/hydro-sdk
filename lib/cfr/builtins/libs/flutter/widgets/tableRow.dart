...
class VMManagedTableRow extends _36c2.VMManagedBox<_0e67.TableRow> {VMManagedTableRow({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTableRow extends _0e67.TableRow implements _36c2.Box<_0e67.TableRow> {RTManagedTableRow({_fac9.List<_e2dc.Widget>? children, _13a5.Decoration? decoration, _ab4a.LocalKey? key, required this.table, required this.hydroState}) : super(children: children,decoration: decoration,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTableRow({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'tableRow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTableRow(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_0e67.TableRow>(boxer: ({required _0e67.TableRow vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTableRow(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

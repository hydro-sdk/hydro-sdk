...
class VMManagedDraggableDetails
    extends _36c2.VMManagedBox<_0705.DraggableDetails> {
  VMManagedDraggableDetails(
    ...
    table['wasAccepted'] = vmObject.wasAccepted;
...
class RTManagedDraggableDetails extends _0705.DraggableDetails
    implements _36c2.Box<_0705.DraggableDetails> {
  RTManagedDraggableDetails(
      {required _fac9.bool wasAccepted,
      required _a643.Offset offset,
      required _10cb.Velocity velocity,
      required this.table,
      required this.hydroState})
      : super(wasAccepted: wasAccepted, offset: offset, velocity: velocity) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['wasAccepted'] = _36c2.maybeBoxObject(
        object: this.wasAccepted,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadDraggableDetails(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['draggableDetails'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDraggableDetails(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          wasAccepted: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['wasAccepted']
              : null,
  ...
  _36c2.registerBoxer<_0705.DraggableDetails>(boxer: (
      {required _0705.DraggableDetails vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDraggableDetails(

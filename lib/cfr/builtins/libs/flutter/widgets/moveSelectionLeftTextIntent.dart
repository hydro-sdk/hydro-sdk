...
class VMManagedMoveSelectionLeftTextIntent extends _36c2.VMManagedBox<_380d.MoveSelectionLeftTextIntent> {VMManagedMoveSelectionLeftTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.MoveSelectionLeftTextIntent vmObject;

 }

class RTManagedMoveSelectionLeftTextIntent extends _380d.MoveSelectionLeftTextIntent implements _36c2.Box<_380d.MoveSelectionLeftTextIntent> {RTManagedMoveSelectionLeftTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.MoveSelectionLeftTextIntent unwrap() => this;
_380d.MoveSelectionLeftTextIntent get vmObject => this;
...
void loadMoveSelectionLeftTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'moveSelectionLeftTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMoveSelectionLeftTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.MoveSelectionLeftTextIntent>(boxer: ({required _380d.MoveSelectionLeftTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMoveSelectionLeftTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

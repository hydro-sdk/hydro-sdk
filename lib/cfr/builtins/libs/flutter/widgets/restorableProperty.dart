...
class VMManagedRestorableProperty extends _36c2.VMManagedBox<_487b.RestorableProperty<_fac9.dynamic>> {VMManagedRestorableProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRestorableProperty extends _487b.RestorableProperty implements _36c2.Box<_487b.RestorableProperty> {RTManagedRestorableProperty({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRestorableProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableProperty(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_487b.RestorableProperty>(boxer: ({required _487b.RestorableProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollActivityDelegate
    extends _36c2.VMManagedBox<_ca8b.ScrollActivityDelegate> {
  VMManagedScrollActivityDelegate(
...
void loadScrollActivityDelegate(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_ca8b.ScrollActivityDelegate>(boxer: (
      {required _ca8b.ScrollActivityDelegate vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollActivityDelegate(

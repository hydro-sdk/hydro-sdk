...
import 'package:flutter/src/widgets/default_text_editing_shortcuts.dart' as _db1b;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;
import 'package:flutter/src/widgets/shortcuts.dart' as _1710;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedDefaultTextEditingShortcuts extends _36c2.VMManagedBox<_db1b.DefaultTextEditingShortcuts> {VMManagedDefaultTextEditingShortcuts({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _db1b.DefaultTextEditingShortcuts vmObject;

 }

class RTManagedDefaultTextEditingShortcuts extends _db1b.DefaultTextEditingShortcuts implements _36c2.Box<_db1b.DefaultTextEditingShortcuts> {RTManagedDefaultTextEditingShortcuts({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'manager'
] = _36c2.maybeBoxObject(object: manager, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shortcuts'
] = _36c2.maybeBoxObject(object: shortcuts, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_db1b.DefaultTextEditingShortcuts unwrap() => this;
_db1b.DefaultTextEditingShortcuts get vmObject => this;
...
void loadDefaultTextEditingShortcuts({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'defaultTextEditingShortcuts'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedDefaultTextEditingShortcuts(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_db1b.DefaultTextEditingShortcuts>(boxer: ({required _db1b.DefaultTextEditingShortcuts vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDefaultTextEditingShortcuts(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

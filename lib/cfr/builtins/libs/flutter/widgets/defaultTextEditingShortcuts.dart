...
class VMManagedDefaultTextEditingShortcuts
  ...
  VMManagedDefaultTextEditingShortcuts(
...
class RTManagedDefaultTextEditingShortcuts
    extends _db1b.DefaultTextEditingShortcuts
    implements _36c2.Box<_db1b.DefaultTextEditingShortcuts> {
  RTManagedDefaultTextEditingShortcuts(
      {_ab4a.Key? key,
    ...
    table['manager'] = _36c2.maybeBoxObject(
        object: manager, hydroState: hydroState, table: _36c2.HydroTable());
    table['shortcuts'] = _36c2.maybeBoxObject(
        object: shortcuts, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadDefaultTextEditingShortcuts(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultTextEditingShortcuts'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultTextEditingShortcuts(
  ...
  _36c2.registerBoxer<_db1b.DefaultTextEditingShortcuts>(boxer: (
      {required _db1b.DefaultTextEditingShortcuts vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultTextEditingShortcuts(

...
class VMManagedAspectRatio extends _36c2.VMManagedBox<_3960.AspectRatio> {
  VMManagedAspectRatio(
    ...
    table['aspectRatio'] = vmObject.aspectRatio;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderAspectRatio>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAspectRatio,
...
class RTManagedAspectRatio extends _3960.AspectRatio
    implements _36c2.Box<_3960.AspectRatio> {
  RTManagedAspectRatio(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _fac9.double aspectRatio,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, aspectRatio: aspectRatio) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['aspectRatio'] = _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _bf98.RenderAspectRatio createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderAspectRatio, _fac9.dynamic>(
...
void loadAspectRatio(
  ...
  table['aspectRatio'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAspectRatio(
  ...
  _36c2.registerBoxer<_3960.AspectRatio>(boxer: (
      {required _3960.AspectRatio vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAspectRatio(

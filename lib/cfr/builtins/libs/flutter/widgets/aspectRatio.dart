...
class VMManagedAspectRatio extends _36c2.VMManagedBox<_3960.AspectRatio> {VMManagedAspectRatio({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderAspectRatio>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAspectRatio, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.AspectRatio vmObject;

 }

class RTManagedAspectRatio extends _3960.AspectRatio implements _36c2.Box<_3960.AspectRatio> {RTManagedAspectRatio({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.double aspectRatio, required this.table, required this.hydroState}) : super(child: child,key: key,aspectRatio: aspectRatio) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'aspectRatio'
] = _36c2.maybeBoxObject(object: this.aspectRatio, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAspectRatio, _fac9.dynamic>(
...
_3960.AspectRatio unwrap() => this;
_3960.AspectRatio get vmObject => this;
@_fac9.override _bf98.RenderAspectRatio createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAspectRatio, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAspectRatio({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'aspectRatio'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedAspectRatio(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), aspectRatio: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'aspectRatio'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_3960.AspectRatio>(boxer: ({required _3960.AspectRatio vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAspectRatio(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedDraggableScrollableActuator extends _36c2.VMManagedBox<_90c0.DraggableScrollableActuator> {VMManagedDraggableScrollableActuator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _90c0.DraggableScrollableActuator vmObject;

 }

class RTManagedDraggableScrollableActuator extends _90c0.DraggableScrollableActuator implements _36c2.Box<_90c0.DraggableScrollableActuator> {RTManagedDraggableScrollableActuator({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_90c0.DraggableScrollableActuator unwrap() => this;
_90c0.DraggableScrollableActuator get vmObject => this;
...
void loadDraggableScrollableActuator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'draggableScrollableActuator'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedDraggableScrollableActuator(table: luaCallerArguments  [
0
...
table  [
'draggableScrollableActuatorReset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_90c0.DraggableScrollableActuator.reset(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
_36c2.registerBoxer<_90c0.DraggableScrollableActuator>(boxer: ({required _90c0.DraggableScrollableActuator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDraggableScrollableActuator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

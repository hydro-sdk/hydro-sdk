...
import 'package:flutter/src/widgets/scroll_position_with_single_context.dart' as _0550;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedScrollPositionWithSingleContext extends _36c2.VMManagedBox<_0550.ScrollPositionWithSingleContext> {VMManagedScrollPositionWithSingleContext({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'context'
] = _36c2.maybeBoxObject<_3c93.ScrollContext>(object: vmObject.context, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'keepScrollOffset'
...
table  [
'isScrollingNotifier'
] = _36c2.maybeBoxObject<_e644.ValueNotifier>(object: vmObject.isScrollingNotifier, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getAxisDirection'
...
table  [
'absorb'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.absorb(_36c2.maybeUnBoxAndBuildArgument<_6c49.ScrollPosition, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'beginActivity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.beginActivity(_36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivity?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
return []; } );
table  [
'getUserScrollDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_f376.ScrollDirection.values.indexWhere((x) { return x == vmObject.userScrollDirection; } ),]; } );
table  [
'animateTo'
...
table  [
'pointerScroll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.pointerScroll(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'jumpToWithoutSettling'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.jumpToWithoutSettling(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'hold'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedholdCancelCallback=luaCallerArguments  [
1
];return [_36c2.maybeBoxObject<_ca8b.ScrollHoldController>(object: vmObject.hold(() => unpackedholdCancelCallback.dispatch([luaCallerArguments[0],],parentState:hydroState,)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'drag'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure unpackeddragCancelCallback=luaCallerArguments  [
2
];return [_36c2.maybeBoxObject<_d9fd.Drag>(object: vmObject.drag(_36c2.maybeUnBoxAndBuildArgument<_4bc7.DragStartDetails, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), () => unpackeddragCancelCallback.dispatch([luaCallerArguments[0],],parentState:hydroState,)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'dispose'
...
table  [
'correctPixels'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.correctPixels(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'correctBy'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.correctBy(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
vmObject.restoreOffset(luaCallerArguments  [
1
]?.toDouble(), initialRestore: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'initialRestore'
] : null);
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.applyViewportDimension(luaCallerArguments  [
1
]?.toDouble()),]; } );
table  [
'applyContentDimensions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [vmObject.applyContentDimensions(luaCallerArguments  [
1
...
return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.ensureVisible(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
...
'duration'
] : null, parentState: hydroState), targetRenderObject: _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'targetRenderObject'
] : null, parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
...
return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.moveTo(luaCallerArguments  [
1
]?.toDouble(), clamp: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'clamp'
] : null, curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
...
table  [
'didStartScroll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didStartScroll();
return []; } );
table  [
'didUpdateScrollPositionBy'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateScrollPositionBy(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'didEndScroll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didEndScroll();
return []; } );
table  [
'didOverscrollBy'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didOverscrollBy(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'didUpdateScrollDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateScrollDirection(_36c2.maybeUnBoxEnum(values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'didUpdateScrollMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateScrollMetrics();
return []; } );
table  [
'recommendDeferredLoading'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.recommendDeferredLoading(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'notifyListeners'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.notifyListeners();
return []; } );
table  [
'getMinScrollExtent'
...
table  [
'getHaveDimensions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.haveDimensions,]; } );
table  [
'getAllowImplicitScrolling'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.allowImplicitScrolling,]; } );
table  [
'copyWith'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return [_36c2.maybeBoxObject<_96ae.ScrollMetrics>(object: vmObject.copyWith(axisDirection: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'axisDirection'
...
class RTManagedScrollPositionWithSingleContext extends _0550.ScrollPositionWithSingleContext implements _36c2.Box<_0550.ScrollPositionWithSingleContext> {RTManagedScrollPositionWithSingleContext({_fac9.String? debugLabel, _fac9.double? initialPixels, required _fac9.bool keepScrollOffset, _6c49.ScrollPosition? oldPosition, required _3c93.ScrollContext context, required _dbad.ScrollPhysics physics, required this.table, required this.hydroState}) : super(debugLabel: debugLabel,initialPixels: initialPixels,keepScrollOffset: keepScrollOffset,oldPosition: oldPosition,context: context,physics: physics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'keepScrollOffset'
] = _36c2.maybeBoxObject(object: this.keepScrollOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugLabel'
] = _36c2.maybeBoxObject(object: this.debugLabel, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'isScrollingNotifier'
] = _36c2.maybeBoxObject(object: isScrollingNotifier, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_getAxisDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.axisDirection];
});
table['_dart_setPixels'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
table['_dart_beginActivity'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.beginActivity(
      _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivity?, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_applyUserOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_updateUserScrollDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.updateUserScrollDirection(_36c2.maybeUnBoxEnum(
      values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
table['_dart_jumpToWithoutSettling'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_correctBy'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.correctBy(_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_forcePixels'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.forcePixels(
      _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
          luaCallerArguments[1],
...
table['_dart_saveScrollOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.saveScrollOffset();
  return [];
});
table['_dart_restoreScrollOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.restoreScrollOffset();
  return [];
});
table['_dart_restoreOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.restoreOffset(
      _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
          luaCallerArguments[1],
...
table['_dart_saveOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.saveOffset();
  return [];
});
table['_dart_applyBoundaryConditions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_correctForNewDimensions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_didStartScroll'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didStartScroll();
  return [];
});
table['_dart_didUpdateScrollPositionBy'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_didEndScroll'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didEndScroll();
  return [];
});
table['_dart_didOverscrollBy'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_didUpdateScrollDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didUpdateScrollDirection(_36c2.maybeUnBoxEnum(
      values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_didUpdateScrollMetrics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didUpdateScrollMetrics();
  return [];
});
table['_dart_recommendDeferredLoading'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
@_fac9.override _fac9.double setPixels(newPixels) { 
_36c2.Closure closure = table["setPixels"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void absorb(other) { super.absorb(other);
_36c2.Closure closure = table["absorb"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void applyNewDimensions() { super.applyNewDimensions();
_36c2.Closure closure = table["applyNewDimensions"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void beginActivity(newActivity) { 
_36c2.Closure closure = table["beginActivity"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void applyUserOffset(delta) { 
_36c2.Closure closure = table["applyUserOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void goIdle() { 
_36c2.Closure closure = table["goIdle"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void goBallistic(velocity) { 
_36c2.Closure closure = table["goBallistic"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _f376.ScrollDirection get userScrollDirection { 
_36c2.Closure closure = table["getUserScrollDirection"];
return _36c2.maybeUnBoxEnum(values: _f376.ScrollDirection.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void updateUserScrollDirection(value) { 
_36c2.Closure closure = table["updateUserScrollDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7de1.Future<void> animateTo(to, {required _8c47.Curve curve, required _fac9.Duration duration}) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void pointerScroll(delta) { 
_36c2.Closure closure = table["pointerScroll"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void jumpToWithoutSettling(value) { 
_36c2.Closure closure = table["jumpToWithoutSettling"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _ca8b.ScrollHoldController hold(holdCancelCallback) { 
_36c2.Closure closure = table["hold"];
return _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollHoldController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _d9fd.Drag drag(details, dragCancelCallback) { 
_36c2.Closure closure = table["drag"];
return _36c2.maybeUnBoxAndBuildArgument<_d9fd.Drag, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void correctPixels(value) { 
_36c2.Closure closure = table["correctPixels"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void correctBy(correction) { 
_36c2.Closure closure = table["correctBy"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void forcePixels(value) { 
_36c2.Closure closure = table["forcePixels"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void saveScrollOffset() { 
_36c2.Closure closure = table["saveScrollOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void restoreScrollOffset() { 
_36c2.Closure closure = table["restoreScrollOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void restoreOffset(offset, {_fac9.bool initialRestore = false}) { 
_36c2.Closure closure = table["restoreOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void saveOffset() { 
_36c2.Closure closure = table["saveOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double applyBoundaryConditions(value) { 
_36c2.Closure closure = table["applyBoundaryConditions"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.bool applyViewportDimension(viewportDimension) { 
_36c2.Closure closure = table["applyViewportDimension"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool applyContentDimensions(minScrollExtent, maxScrollExtent) { 
_36c2.Closure closure = table["applyContentDimensions"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool correctForNewDimensions(oldPosition, newPosition) { 
_36c2.Closure closure = table["correctForNewDimensions"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7de1.Future<void> ensureVisible(object, {_fac9.double alignment = 0.0, _6c49.ScrollPositionAlignmentPolicy alignmentPolicy = _6c49.ScrollPositionAlignmentPolicy.explicit, _8c47.Curve curve = _8c47.Curves.ease, _fac9.Duration duration = _fac9.Duration.zero, _9742.RenderObject? targetRenderObject}) { 
_36c2.Closure closure = table["ensureVisible"];
return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<void>, void>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _7de1.Future<void> moveTo(to, {_fac9.bool? clamp = true, _8c47.Curve? curve, _fac9.Duration? duration}) { 
_36c2.Closure closure = table["moveTo"];
return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<void>, void>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void didStartScroll() { 
_36c2.Closure closure = table["didStartScroll"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didUpdateScrollPositionBy(delta) { 
_36c2.Closure closure = table["didUpdateScrollPositionBy"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didEndScroll() { 
_36c2.Closure closure = table["didEndScroll"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didOverscrollBy(value) { 
_36c2.Closure closure = table["didOverscrollBy"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didUpdateScrollDirection(direction) { 
_36c2.Closure closure = table["didUpdateScrollDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didUpdateScrollMetrics() { 
_36c2.Closure closure = table["didUpdateScrollMetrics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool recommendDeferredLoading(context) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get haveDimensions { 
_36c2.Closure closure = table["getHaveDimensions"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get allowImplicitScrolling { 
_36c2.Closure closure = table["getAllowImplicitScrolling"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _ca8b.ScrollActivity? get activity { 
_36c2.Closure closure = table["getActivity"];
return _36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivity?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _96ae.ScrollMetrics copyWith({_487f.AxisDirection? axisDirection, _fac9.double? maxScrollExtent, _fac9.double? minScrollExtent, _fac9.double? pixels, _fac9.double? viewportDimension}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_96ae.ScrollMetrics, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadScrollPositionWithSingleContext({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedScrollPositionWithSingleContext(table: luaCallerArguments  [
0
], hydroState: hydroState, debugLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugLabel'
] : null, initialPixels: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialPixels'
] : null?.toDouble(), keepScrollOffset: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'keepScrollOffset'
] : null, oldPosition: _36c2.maybeUnBoxAndBuildArgument<_6c49.ScrollPosition?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'oldPosition'
] : null, parentState: hydroState), context: _36c2.maybeUnBoxAndBuildArgument<_3c93.ScrollContext, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'context'
...
_36c2.registerBoxer<_0550.ScrollPositionWithSingleContext>(boxer: ({required _0550.ScrollPositionWithSingleContext vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollPositionWithSingleContext(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedKeyedSubtree extends _36c2.VMManagedBox<_3960.KeyedSubtree> {VMManagedKeyedSubtree({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.KeyedSubtree vmObject;

 }

class RTManagedKeyedSubtree extends _3960.KeyedSubtree implements _36c2.Box<_3960.KeyedSubtree> {RTManagedKeyedSubtree({_ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.KeyedSubtree unwrap() => this;
_3960.KeyedSubtree get vmObject => this;
...
void loadKeyedSubtree({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keyedSubtree'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedKeyedSubtree(table: luaCallerArguments  [
0
...
return [_36c2.maybeBoxObject<_3960.KeyedSubtree>(object: _3960.KeyedSubtree.wrap(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), luaCallerArguments  [
2
]), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'keyedSubtreeEnsureUniqueKeysForList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: _3960.KeyedSubtree.ensureUniqueKeysForList(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments  [
1
], parentState: hydroState), baseIndex: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'baseIndex'
] : null).map((x) => _36c2.maybeBoxObject<_e2dc.Widget>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_3960.KeyedSubtree>(boxer: ({required _3960.KeyedSubtree vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyedSubtree(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

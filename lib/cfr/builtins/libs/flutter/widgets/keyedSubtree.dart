...
class VMManagedKeyedSubtree extends _36c2.VMManagedBox<_3960.KeyedSubtree> {
  VMManagedKeyedSubtree(
...
class RTManagedKeyedSubtree extends _3960.KeyedSubtree
    implements _36c2.Box<_3960.KeyedSubtree> {
  RTManagedKeyedSubtree(
      {_ab4a.Key? key,
...
void loadKeyedSubtree(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['keyedSubtree'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedKeyedSubtree(
  ...
  table['keyedSubtreeWrap'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_3960.KeyedSubtree>(
          object: _3960.KeyedSubtree.wrap(
  ...
  table['keyedSubtreeEnsureUniqueKeysForList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(
          object: _3960.KeyedSubtree.ensureUniqueKeysForList(
                  _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>,
                          _e2dc.Widget>(luaCallerArguments[1],
                      parentState: hydroState),
                  baseIndex: luaCallerArguments.length >= 3
                      ? luaCallerArguments[2]['baseIndex']
                      : null)
  ...
  _36c2.registerBoxer<_3960.KeyedSubtree>(boxer: (
      {required _3960.KeyedSubtree vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedKeyedSubtree(

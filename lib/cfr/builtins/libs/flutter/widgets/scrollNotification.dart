...
class VMManagedScrollNotification
    extends _36c2.VMManagedBox<_593c.ScrollNotification> {
  VMManagedScrollNotification(
...
class RTManagedScrollNotification extends _593c.ScrollNotification
    implements _36c2.Box<_593c.ScrollNotification> {
  RTManagedScrollNotification(
...
void loadScrollNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollNotification(
  ...
  _36c2.registerBoxer<_593c.ScrollNotification>(boxer: (
      {required _593c.ScrollNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollNotification(

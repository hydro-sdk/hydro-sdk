...
class VMManagedFractionalTranslation extends _36c2.VMManagedBox<_3960.FractionalTranslation> {VMManagedFractionalTranslation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'translation'
] = _36c2.maybeBoxObject<_a643.Offset>(object: vmObject.translation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'transformHitTests'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderFractionalTranslation>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFractionalTranslation, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.FractionalTranslation vmObject;

 }

class RTManagedFractionalTranslation extends _3960.FractionalTranslation implements _36c2.Box<_3960.FractionalTranslation> {RTManagedFractionalTranslation({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.bool transformHitTests, required _a643.Offset translation, required this.table, required this.hydroState}) : super(child: child,key: key,transformHitTests: transformHitTests,translation: translation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'translation'
] = _36c2.maybeBoxObject(object: this.translation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'transformHitTests'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFractionalTranslation,
...
_3960.FractionalTranslation unwrap() => this;
_3960.FractionalTranslation get vmObject => this;
@_fac9.override _bf98.RenderFractionalTranslation createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFractionalTranslation, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFractionalTranslation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fractionalTranslation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFractionalTranslation(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.FractionalTranslation>(boxer: ({required _3960.FractionalTranslation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFractionalTranslation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

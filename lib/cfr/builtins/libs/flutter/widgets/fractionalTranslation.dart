...
class VMManagedFractionalTranslation
    extends _36c2.VMManagedBox<_3960.FractionalTranslation> {
  VMManagedFractionalTranslation(
    ...
    table['translation'] = _36c2.maybeBoxObject<_a643.Offset>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderFractionalTranslation>(
...
class RTManagedFractionalTranslation extends _3960.FractionalTranslation
    implements _36c2.Box<_3960.FractionalTranslation> {
  RTManagedFractionalTranslation(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
    ...
    table['translation'] = _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _bf98.RenderFractionalTranslation createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderFractionalTranslation,
            _fac9.dynamic>(
...
void loadFractionalTranslation(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['fractionalTranslation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFractionalTranslation(
          ...
          translation:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['translation'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3960.FractionalTranslation>(boxer: (
      {required _3960.FractionalTranslation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFractionalTranslation(

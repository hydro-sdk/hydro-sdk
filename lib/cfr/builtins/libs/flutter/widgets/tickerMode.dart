...
class VMManagedTickerMode extends _36c2.VMManagedBox<_3e16.TickerMode> {VMManagedTickerMode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3e16.TickerMode vmObject;

 }

class RTManagedTickerMode extends _3e16.TickerMode implements _36c2.Box<_3e16.TickerMode> {RTManagedTickerMode({_ab4a.Key? key, required _e2dc.Widget child, required _fac9.bool enabled, required this.table, required this.hydroState}) : super(key: key,child: child,enabled: enabled) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3e16.TickerMode unwrap() => this;
_3e16.TickerMode get vmObject => this;
...
void loadTickerMode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'tickerMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTickerMode(table: luaCallerArguments  [
0
...
table  [
'tickerModeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_3e16.TickerMode.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
_36c2.registerBoxer<_3e16.TickerMode>(boxer: ({required _3e16.TickerMode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTickerMode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

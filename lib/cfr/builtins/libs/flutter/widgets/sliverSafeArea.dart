...
class VMManagedSliverSafeArea extends _36c2.VMManagedBox<_a11a.SliverSafeArea> {
  VMManagedSliverSafeArea(
    ...
    table['minimum'] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(
        object: vmObject.minimum,
        hydroState: hydroState,
...
class RTManagedSliverSafeArea extends _a11a.SliverSafeArea
  ...
  RTManagedSliverSafeArea(
      {required _fac9.bool bottom,
      _ab4a.Key? key,
      required _fac9.bool left,
      required _96d1.EdgeInsets minimum,
      required _fac9.bool right,
      required _fac9.bool top,
    ...
    table['minimum'] = _36c2.maybeBoxObject(
        object: this.minimum,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadSliverSafeArea(
  ...
  table['sliverSafeArea'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverSafeArea(
  ...
  _36c2.registerBoxer<_a11a.SliverSafeArea>(boxer: (
      {required _a11a.SliverSafeArea vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverSafeArea(

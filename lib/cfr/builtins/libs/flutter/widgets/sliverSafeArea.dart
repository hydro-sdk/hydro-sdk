...
import 'package:flutter/src/widgets/safe_area.dart' as _a11a;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSliverSafeArea extends _36c2.VMManagedBox<_a11a.SliverSafeArea> {VMManagedSliverSafeArea({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'minimum'
] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(object: vmObject.minimum, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'sliver'
...
final _a11a.SliverSafeArea vmObject;

 }

class RTManagedSliverSafeArea extends _a11a.SliverSafeArea implements _36c2.Box<_a11a.SliverSafeArea> {RTManagedSliverSafeArea({required _fac9.bool bottom, _ab4a.Key? key, required _fac9.bool left, required _96d1.EdgeInsets minimum, required _fac9.bool right, required _fac9.bool top, required _e2dc.Widget sliver, required this.table, required this.hydroState}) : super(bottom: bottom,key: key,left: left,minimum: minimum,right: right,top: top,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'minimum'
] = _36c2.maybeBoxObject(object: this.minimum, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'sliver'
...
_a11a.SliverSafeArea unwrap() => this;
_a11a.SliverSafeArea get vmObject => this;
...
void loadSliverSafeArea({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverSafeArea'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSliverSafeArea(table: luaCallerArguments  [
0
...
'left'
] : null, minimum: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsets, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'minimum'
] : null, parentState: hydroState), right: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'right'
] : null, top: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'top'
...
_36c2.registerBoxer<_a11a.SliverSafeArea>(boxer: ({required _a11a.SliverSafeArea vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverSafeArea(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderNestedScrollViewViewport extends _36c2.VMManagedBox<_c812.RenderNestedScrollViewViewport> {VMManagedRenderNestedScrollViewViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRenderNestedScrollViewViewport extends _c812.RenderNestedScrollViewViewport implements _36c2.Box<_c812.RenderNestedScrollViewViewport> {RTManagedRenderNestedScrollViewViewport({required _fac9.double anchor, required _487f.AxisDirection axisDirection, _021d.RenderSliver? center, _fac9.List<_021d.RenderSliver>? children, required _a643.Clip clipBehavior, required _487f.AxisDirection crossAxisDirection, required _c812.SliverOverlapAbsorberHandle handle, required _f376.ViewportOffset offset, required this.table, required this.hydroState}) : super(anchor: anchor,axisDirection: axisDirection,center: center,children: children,clipBehavior: clipBehavior,crossAxisDirection: crossAxisDirection,handle: handle,offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRenderNestedScrollViewViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderNestedScrollViewViewport(table: luaCallerArguments  [
0
...
'crossAxisDirection'
] : null), handle: _36c2.maybeUnBoxAndBuildArgument<_c812.SliverOverlapAbsorberHandle, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'handle'
...
_36c2.registerBoxer<_c812.RenderNestedScrollViewViewport>(boxer: ({required _c812.RenderNestedScrollViewViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderNestedScrollViewViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

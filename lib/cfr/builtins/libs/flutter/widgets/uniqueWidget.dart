...
import 'package:flutter/src/widgets/unique_widget.dart' as _71d1;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedUniqueWidget extends _36c2.VMManagedBox<_71d1.UniqueWidget<_e2dc.State<_e2dc.StatefulWidget>>> {VMManagedUniqueWidget({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.createState(),]; } );
table  [
'getCurrentState'
...
final _71d1.UniqueWidget<_e2dc.State<_e2dc.StatefulWidget>> vmObject;

 }

class RTManagedUniqueWidget extends _71d1.UniqueWidget implements _36c2.Box<_71d1.UniqueWidget> {RTManagedUniqueWidget({required _e2dc.GlobalKey<_e2dc.State<_e2dc.StatefulWidget>> key, required this.table, required this.hydroState}) : super(key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_71d1.UniqueWidget unwrap() => this;
_71d1.UniqueWidget get vmObject => this;
...
void loadUniqueWidget({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'uniqueWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedUniqueWidget(table: luaCallerArguments  [
0
], hydroState: hydroState, key: _36c2.maybeUnBoxAndBuildArgument<_e2dc.GlobalKey<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_71d1.UniqueWidget>(boxer: ({required _71d1.UniqueWidget vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedUniqueWidget(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRestorableDouble
    extends _36c2.VMManagedBox<_28c9.RestorableDouble> {
  VMManagedRestorableDouble(
...
class RTManagedRestorableDouble extends _28c9.RestorableDouble
    implements _36c2.Box<_28c9.RestorableDouble> {
  RTManagedRestorableDouble(_fac9.double defaultValue,
...
void loadRestorableDouble(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableDouble'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableDouble(luaCallerArguments[1]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_28c9.RestorableDouble>(boxer: (
      {required _28c9.RestorableDouble vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableDouble(

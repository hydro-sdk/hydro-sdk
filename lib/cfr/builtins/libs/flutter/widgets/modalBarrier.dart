...
class VMManagedModalBarrier extends _36c2.VMManagedBox<_7492.ModalBarrier> {VMManagedModalBarrier({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedModalBarrier extends _7492.ModalBarrier implements _36c2.Box<_7492.ModalBarrier> {RTManagedModalBarrier({_fac9.bool? barrierSemanticsDismissible, _a643.Color? color, required _fac9.bool dismissible, _ab4a.Key? key, _fac9.String? semanticsLabel, required this.table, required this.hydroState}) : super(barrierSemanticsDismissible: barrierSemanticsDismissible,color: color,dismissible: dismissible,key: key,semanticsLabel: semanticsLabel) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadModalBarrier({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'modalBarrier'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedModalBarrier(table: luaCallerArguments  [
0
...
'color'
] : null, parentState: hydroState), dismissible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dismissible'
...
_36c2.registerBoxer<_7492.ModalBarrier>(boxer: ({required _7492.ModalBarrier vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedModalBarrier(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

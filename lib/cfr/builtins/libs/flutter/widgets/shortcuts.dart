...
class VMManagedShortcuts extends _36c2.VMManagedBox<_1710.Shortcuts> {
  VMManagedShortcuts(
    ...
    table['manager'] = _36c2.maybeBoxObject<_1710.ShortcutManager?>(
        object: vmObject.manager,
        hydroState: hydroState,
...
class RTManagedShortcuts extends _1710.Shortcuts
    implements _36c2.Box<_1710.Shortcuts> {
  RTManagedShortcuts(
      {_fac9.String? debugLabel,
      _ab4a.Key? key,
      _1710.ShortcutManager? manager,
    ...
    table['manager'] = _36c2.maybeBoxObject(
        object: this.manager,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _e2dc.State<_1710.Shortcuts> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_1710.Shortcuts>,
            _1710.Shortcuts>(
...
void loadShortcuts(
  ...
  table['shortcuts'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedShortcuts(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          manager:
              _36c2.maybeUnBoxAndBuildArgument<_1710.ShortcutManager?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['manager']
                      : null,
                  parentState: hydroState),
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['child'] : null,
              parentState: hydroState),
          shortcuts: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_1710.ShortcutActivator, _c0f4.Intent>, _1710.ShortcutActivator>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shortcuts'] : null,
              parentState: hydroState))
    ];
  });
  table['shortcutsOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_1710.ShortcutManager>(
          object: _1710.Shortcuts.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  table['shortcutsMaybeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _1710.Shortcuts.maybeOf(
  ...
  _36c2.registerBoxer<_1710.Shortcuts>(boxer: (
      {required _1710.Shortcuts vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShortcuts(

...
class VMManagedShortcuts extends _36c2.VMManagedBox<_1710.Shortcuts> {VMManagedShortcuts({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'manager'
] = _36c2.maybeBoxObject<_1710.ShortcutManager?>(object: vmObject.manager, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shortcuts'
...
final _1710.Shortcuts vmObject;

 }

class RTManagedShortcuts extends _1710.Shortcuts implements _36c2.Box<_1710.Shortcuts> {RTManagedShortcuts({_fac9.String? debugLabel, _ab4a.Key? key, _1710.ShortcutManager? manager, required _e2dc.Widget child, required _fac9.Map<_1710.ShortcutActivator,_c0f4.Intent> shortcuts, required this.table, required this.hydroState}) : super(debugLabel: debugLabel,key: key,manager: manager,child: child,shortcuts: shortcuts) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'manager'
] = _36c2.maybeBoxObject(object: this.manager, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'shortcuts'
...
_1710.Shortcuts unwrap() => this;
_1710.Shortcuts get vmObject => this;
@_fac9.override _e2dc.State<_1710.Shortcuts> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_1710.Shortcuts>, _1710.Shortcuts>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadShortcuts({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shortcuts'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedShortcuts(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), manager: _36c2.maybeUnBoxAndBuildArgument<_1710.ShortcutManager?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'manager'
...
table  [
'shortcutsOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_1710.ShortcutManager>(object: _1710.Shortcuts.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'shortcutsMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _1710.Shortcuts.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_1710.ShortcutManager?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_1710.Shortcuts>(boxer: ({required _1710.Shortcuts vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShortcuts(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

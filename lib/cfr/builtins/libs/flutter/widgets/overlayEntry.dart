...
class VMManagedOverlayEntry extends _36c2.VMManagedBox<_0049.OverlayEntry> {VMManagedOverlayEntry({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'setMaintainState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.maintainState=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
class RTManagedOverlayEntry extends _0049.OverlayEntry implements _36c2.Box<_0049.OverlayEntry> {RTManagedOverlayEntry({required _fac9.bool maintainState, required _fac9.bool opaque, required _e2dc.Widget Function(_e2dc.BuildContext context) builder, required this.table, required this.hydroState}) : super(maintainState: maintainState,opaque: opaque,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadOverlayEntry({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'overlayEntry'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedOverlayEntry(table: luaCallerArguments  [
0
], hydroState: hydroState, maintainState: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainState'
...
_36c2.registerBoxer<_0049.OverlayEntry>(boxer: ({required _0049.OverlayEntry vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOverlayEntry(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

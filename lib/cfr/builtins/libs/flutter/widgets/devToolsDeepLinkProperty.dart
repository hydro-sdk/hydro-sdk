...
class VMManagedDevToolsDeepLinkProperty extends _36c2.VMManagedBox<_8c83.DevToolsDeepLinkProperty> {VMManagedDevToolsDeepLinkProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c83.DevToolsDeepLinkProperty vmObject;

 }

class RTManagedDevToolsDeepLinkProperty extends _8c83.DevToolsDeepLinkProperty implements _36c2.Box<_8c83.DevToolsDeepLinkProperty> {RTManagedDevToolsDeepLinkProperty(_fac9.String description, _fac9.String url, {required this.table, required this.hydroState}) : super(description,url,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c83.DevToolsDeepLinkProperty unwrap() => this;
_8c83.DevToolsDeepLinkProperty get vmObject => this;
...
void loadDevToolsDeepLinkProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'devToolsDeepLinkProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedDevToolsDeepLinkProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
_36c2.registerBoxer<_8c83.DevToolsDeepLinkProperty>(boxer: ({required _8c83.DevToolsDeepLinkProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDevToolsDeepLinkProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

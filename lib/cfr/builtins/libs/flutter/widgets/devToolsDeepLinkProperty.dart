...
class VMManagedDevToolsDeepLinkProperty
    extends _36c2.VMManagedBox<_8c83.DevToolsDeepLinkProperty> {
  VMManagedDevToolsDeepLinkProperty(
...
class RTManagedDevToolsDeepLinkProperty extends _8c83.DevToolsDeepLinkProperty
    implements _36c2.Box<_8c83.DevToolsDeepLinkProperty> {
  RTManagedDevToolsDeepLinkProperty(_fac9.String description, _fac9.String url,
...
void loadDevToolsDeepLinkProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['devToolsDeepLinkProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDevToolsDeepLinkProperty(
          luaCallerArguments[1], luaCallerArguments[2],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c83.DevToolsDeepLinkProperty>(boxer: (
      {required _8c83.DevToolsDeepLinkProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDevToolsDeepLinkProperty(

...
class VMManagedSliverOverlapAbsorberHandle extends _36c2.VMManagedBox<_c812.SliverOverlapAbsorberHandle> {VMManagedSliverOverlapAbsorberHandle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getLayoutExtent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.layoutExtent;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getScrollExtent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.scrollExtent;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'toString'
...
class RTManagedSliverOverlapAbsorberHandle extends _c812.SliverOverlapAbsorberHandle implements _36c2.Box<_c812.SliverOverlapAbsorberHandle> {RTManagedSliverOverlapAbsorberHandle({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_getLayoutExtent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.layoutExtent];
});
table['_dart_getScrollExtent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override _fac9.double? get layoutExtent { 
_36c2.Closure closure = table["getLayoutExtent"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double? get scrollExtent { 
...
void loadSliverOverlapAbsorberHandle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverOverlapAbsorberHandle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSliverOverlapAbsorberHandle(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c812.SliverOverlapAbsorberHandle>(boxer: ({required _c812.SliverOverlapAbsorberHandle vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverOverlapAbsorberHandle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

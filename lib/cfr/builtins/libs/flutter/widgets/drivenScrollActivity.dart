...
class VMManagedDrivenScrollActivity
    extends _36c2.VMManagedBox<_ca8b.DrivenScrollActivity> {
  VMManagedDrivenScrollActivity(
    ...
    table['getDone'] = _36c2.makeLuaDartFunc(
...
class RTManagedDrivenScrollActivity extends _ca8b.DrivenScrollActivity
  ...
  RTManagedDrivenScrollActivity(_ca8b.ScrollActivityDelegate delegate$,
      {required _8c47.Curve curve,
      required _fac9.Duration duration,
      required _fac9.double from,
      required _fac9.double to,
    ...
    table['_dart_getDone'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.done];
    });
...
void loadDrivenScrollActivity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['drivenScrollActivity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDrivenScrollActivity(
          ...
          duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
              ...
              parentState: hydroState),
          from: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['from'] : null?.toDouble(),
          to: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['to'] : null?.toDouble(),
          vsync: _36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments[2]['vsync'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_ca8b.DrivenScrollActivity>(boxer: (
      {required _ca8b.DrivenScrollActivity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDrivenScrollActivity(

...
class VMManagedDeleteByWordTextIntent extends _36c2.VMManagedBox<_380d.DeleteByWordTextIntent> {VMManagedDeleteByWordTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.DeleteByWordTextIntent vmObject;

 }

class RTManagedDeleteByWordTextIntent extends _380d.DeleteByWordTextIntent implements _36c2.Box<_380d.DeleteByWordTextIntent> {RTManagedDeleteByWordTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.DeleteByWordTextIntent unwrap() => this;
_380d.DeleteByWordTextIntent get vmObject => this;
...
void loadDeleteByWordTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'deleteByWordTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDeleteByWordTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.DeleteByWordTextIntent>(boxer: ({required _380d.DeleteByWordTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDeleteByWordTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

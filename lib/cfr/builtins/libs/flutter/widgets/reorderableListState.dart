...
class VMManagedReorderableListState
    extends _36c2.VMManagedBox<_acd7.ReorderableListState> {
  VMManagedReorderableListState(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_acd7.ReorderableList>(
...
class RTManagedReorderableListState extends _acd7.ReorderableListState
    implements _36c2.Box<_acd7.ReorderableListState> {
  RTManagedReorderableListState({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _acd7.ReorderableList get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_acd7.ReorderableList, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadReorderableListState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['reorderableListState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedReorderableListState(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_acd7.ReorderableListState>(boxer: (
      {required _acd7.ReorderableListState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedReorderableListState(

...
import 'package:flutter/src/widgets/text_selection_toolbar_layout_delegate.dart' as _5ac3;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedTextSelectionToolbarLayoutDelegate extends _36c2.VMManagedBox<_5ac3.TextSelectionToolbarLayoutDelegate> {VMManagedTextSelectionToolbarLayoutDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRelayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRelayout(_36c2.maybeUnBoxAndBuildArgument<_5ac3.TextSelectionToolbarLayoutDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedTextSelectionToolbarLayoutDelegate extends _5ac3.TextSelectionToolbarLayoutDelegate implements _36c2.Box<_5ac3.TextSelectionToolbarLayoutDelegate> {RTManagedTextSelectionToolbarLayoutDelegate({_fac9.bool? fitsAbove, required _a643.Offset anchorAbove, required _a643.Offset anchorBelow, required this.table, required this.hydroState}) : super(fitsAbove: fitsAbove,anchorAbove: anchorAbove,anchorBelow: anchorBelow) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'fitsAbove'
] = _36c2.maybeBoxObject(object: this.fitsAbove, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadTextSelectionToolbarLayoutDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textSelectionToolbarLayoutDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTextSelectionToolbarLayoutDelegate(table: luaCallerArguments  [
0
], hydroState: hydroState, fitsAbove: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fitsAbove'
] : null, anchorAbove: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'anchorAbove'
...
_36c2.registerBoxer<_5ac3.TextSelectionToolbarLayoutDelegate>(boxer: ({required _5ac3.TextSelectionToolbarLayoutDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextSelectionToolbarLayoutDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

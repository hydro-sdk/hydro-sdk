...
class VMManagedPositionedTransition extends _36c2.VMManagedBox<_d7ad.PositionedTransition> {VMManagedPositionedTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d7ad.PositionedTransition vmObject;

 }

class RTManagedPositionedTransition extends _d7ad.PositionedTransition implements _36c2.Box<_d7ad.PositionedTransition> {RTManagedPositionedTransition({_ab4a.Key? key, required _e2dc.Widget child, required _86ca.Animation<_b1b6.RelativeRect> rect, required this.table, required this.hydroState}) : super(key: key,child: child,rect: rect) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.PositionedTransition unwrap() => this;
_d7ad.PositionedTransition get vmObject => this;
@_fac9.override _86ca.Animation<_b1b6.RelativeRect> get rect { 
...
void loadPositionedTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'positionedTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPositionedTransition(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), rect: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_b1b6.RelativeRect>, _b1b6.RelativeRect>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rect'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.PositionedTransition>(boxer: ({required _d7ad.PositionedTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPositionedTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedPositionedTransition
    extends _36c2.VMManagedBox<_d7ad.PositionedTransition> {
  VMManagedPositionedTransition(
...
class RTManagedPositionedTransition extends _d7ad.PositionedTransition
    implements _36c2.Box<_d7ad.PositionedTransition> {
  RTManagedPositionedTransition(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _86ca.Animation<_b1b6.RelativeRect> rect,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, rect: rect) {
  ...
  @_fac9.override
  _86ca.Animation<_b1b6.RelativeRect> get rect {
...
void loadPositionedTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['positionedTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPositionedTransition(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          rect: _36c2.maybeUnBoxAndBuildArgument<
                  _86ca.Animation<_b1b6.RelativeRect>, _b1b6.RelativeRect>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['rect'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.PositionedTransition>(boxer: (
      {required _d7ad.PositionedTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPositionedTransition(

...
class VMManagedRepaintBoundary
    extends _36c2.VMManagedBox<_3960.RepaintBoundary> {
  VMManagedRepaintBoundary(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderRepaintBoundary>(
...
class RTManagedRepaintBoundary extends _3960.RepaintBoundary
    implements _36c2.Box<_3960.RepaintBoundary> {
  RTManagedRepaintBoundary(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
  ...
  @_fac9.override
  _bf98.RenderRepaintBoundary createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderRepaintBoundary, _fac9.dynamic>(
...
void loadRepaintBoundary(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['repaintBoundary'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRepaintBoundary(
  ...
  table['repaintBoundaryWrap'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_3960.RepaintBoundary>(
          object: _3960.RepaintBoundary.wrap(
  ...
  table['repaintBoundaryWrapAll'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(
          object: _3960.RepaintBoundary.wrapAll(
                  _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>,
                          _e2dc.Widget>(luaCallerArguments[1],
                      parentState: hydroState))
              .map((x) => _36c2.maybeBoxObject<_3960.RepaintBoundary>(
  ...
  _36c2.registerBoxer<_3960.RepaintBoundary>(boxer: (
      {required _3960.RepaintBoundary vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRepaintBoundary(

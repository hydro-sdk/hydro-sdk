...
class VMManagedRepaintBoundary extends _36c2.VMManagedBox<_3960.RepaintBoundary> {VMManagedRepaintBoundary({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderRepaintBoundary>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _3960.RepaintBoundary vmObject;

 }

class RTManagedRepaintBoundary extends _3960.RepaintBoundary implements _36c2.Box<_3960.RepaintBoundary> {RTManagedRepaintBoundary({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.RepaintBoundary unwrap() => this;
_3960.RepaintBoundary get vmObject => this;
@_fac9.override _bf98.RenderRepaintBoundary createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderRepaintBoundary, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRepaintBoundary({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'repaintBoundary'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRepaintBoundary(table: luaCallerArguments  [
0
...
return [_36c2.maybeBoxObject<_3960.RepaintBoundary>(object: _3960.RepaintBoundary.wrap(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), luaCallerArguments  [
2
]), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'repaintBoundaryWrapAll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: _3960.RepaintBoundary.wrapAll(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments  [
1
], parentState: hydroState)).map((x) => _36c2.maybeBoxObject<_3960.RepaintBoundary>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_3960.RepaintBoundary>(boxer: ({required _3960.RepaintBoundary vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRepaintBoundary(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

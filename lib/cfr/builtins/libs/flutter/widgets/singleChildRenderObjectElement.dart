...
class VMManagedSingleChildRenderObjectElement extends _36c2.VMManagedBox<_e2dc.SingleChildRenderObjectElement> {VMManagedSingleChildRenderObjectElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.SingleChildRenderObjectWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'visitChildren'
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.SingleChildRenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9742.RenderObject>(object: vmObject.renderObject, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getDebugDoingBuild'
...
final _e2dc.SingleChildRenderObjectElement vmObject;

 }

class RTManagedSingleChildRenderObjectElement extends _e2dc.SingleChildRenderObjectElement implements _36c2.Box<_e2dc.SingleChildRenderObjectElement> {RTManagedSingleChildRenderObjectElement(_e2dc.SingleChildRenderObjectWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_update'] =
  ...
  super.update(_36c2.maybeUnBoxAndBuildArgument<
      _e2dc.SingleChildRenderObjectWidget,
...
_e2dc.SingleChildRenderObjectElement unwrap() => this;
_e2dc.SingleChildRenderObjectElement get vmObject => this;
@_fac9.override _e2dc.SingleChildRenderObjectWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.SingleChildRenderObjectWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSingleChildRenderObjectElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'singleChildRenderObjectElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSingleChildRenderObjectElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.SingleChildRenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.SingleChildRenderObjectElement>(boxer: ({required _e2dc.SingleChildRenderObjectElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSingleChildRenderObjectElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

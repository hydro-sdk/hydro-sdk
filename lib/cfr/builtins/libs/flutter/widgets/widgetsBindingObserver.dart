...
class VMManagedWidgetsBindingObserver
    extends _36c2.VMManagedBox<_3e19.WidgetsBindingObserver> {
  VMManagedWidgetsBindingObserver(
...
class RTManagedWidgetsBindingObserver extends _3e19.WidgetsBindingObserver
    implements _36c2.Box<_3e19.WidgetsBindingObserver> {
  RTManagedWidgetsBindingObserver(
...
void loadWidgetsBindingObserver(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['widgetsBindingObserver'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedWidgetsBindingObserver(
  ...
  _36c2.registerBoxer<_3e19.WidgetsBindingObserver>(boxer: (
      {required _3e19.WidgetsBindingObserver vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedWidgetsBindingObserver(

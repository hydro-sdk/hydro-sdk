...
class VMManagedCallbackShortcuts extends _36c2.VMManagedBox<_1710.CallbackShortcuts> {VMManagedCallbackShortcuts({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'bindings'
] = _36c2.maybeBoxObject<_fac9.Map>(object: vmObject.bindings, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _1710.CallbackShortcuts vmObject;

 }

class RTManagedCallbackShortcuts extends _1710.CallbackShortcuts implements _36c2.Box<_1710.CallbackShortcuts> {RTManagedCallbackShortcuts({_ab4a.Key? key, required _fac9.Map<_1710.ShortcutActivator,void Function()> bindings, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,bindings: bindings,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'bindings'
] = _36c2.maybeBoxObject(object: this.bindings, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_1710.CallbackShortcuts unwrap() => this;
_1710.CallbackShortcuts get vmObject => this;
...
void loadCallbackShortcuts({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'callbackShortcuts'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCallbackShortcuts(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), bindings: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_1710.ShortcutActivator,void Function()>, _1710.ShortcutActivator>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bindings'
...
_36c2.registerBoxer<_1710.CallbackShortcuts>(boxer: ({required _1710.CallbackShortcuts vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCallbackShortcuts(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

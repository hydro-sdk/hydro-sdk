...
class VMManagedAlign extends _36c2.VMManagedBox<_3960.Align> {VMManagedAlign({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.Align vmObject;

 }

class RTManagedAlign extends _3960.Align implements _36c2.Box<_3960.Align> {RTManagedAlign({required _ca85.AlignmentGeometry alignment, _e2dc.Widget? child, _fac9.double? heightFactor, _ab4a.Key? key, _fac9.double? widthFactor, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,heightFactor: heightFactor,key: key,widthFactor: widthFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.Align unwrap() => this;
_3960.Align get vmObject => this;
...
void loadAlign({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'align'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAlign(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Align>(boxer: ({required _3960.Align vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAlign(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

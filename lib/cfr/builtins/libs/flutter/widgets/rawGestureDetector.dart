...
class VMManagedRawGestureDetector extends _36c2.VMManagedBox<_eed0.RawGestureDetector> {VMManagedRawGestureDetector({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'gestures'
] = _36c2.maybeBoxObject<_fac9.Map>(object: vmObject.gestures, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'behavior'
...
table  [
'semantics'
] = _36c2.maybeBoxObject<_eed0.SemanticsGestureDelegate?>(object: vmObject.semantics, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
] = _36c2.maybeBoxObject<_ab4a.Key?>(object: vmObject.key, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'createState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_eed0.RawGestureDetectorState>(object: vmObject.createState(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createElement'
...
final _eed0.RawGestureDetector vmObject;

 }

class RTManagedRawGestureDetector extends _eed0.RawGestureDetector implements _36c2.Box<_eed0.RawGestureDetector> {RTManagedRawGestureDetector({_bf98.HitTestBehavior? behavior, _e2dc.Widget? child, required _fac9.bool excludeFromSemantics, required _fac9.Map<_fac9.Type,_eed0.GestureRecognizerFactory<_02d2.GestureRecognizer>> gestures, _ab4a.Key? key, _eed0.SemanticsGestureDelegate? semantics, required this.table, required this.hydroState}) : super(behavior: behavior,child: child,excludeFromSemantics: excludeFromSemantics,gestures: gestures,key: key,semantics: semantics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'gestures'
] = _36c2.maybeBoxObject(object: this.gestures, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'behavior'
...
table  [
'semantics'
] = _36c2.maybeBoxObject(object: this.semantics, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_eed0.RawGestureDetector unwrap() => this;
_eed0.RawGestureDetector get vmObject => this;
@_fac9.override _eed0.RawGestureDetectorState createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_eed0.RawGestureDetectorState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRawGestureDetector({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawGestureDetector'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRawGestureDetector(table: luaCallerArguments  [
0
...
'excludeFromSemantics'
] : null, gestures: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.Type,_eed0.GestureRecognizerFactory<_02d2.GestureRecognizer>>, _fac9.Type>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'gestures'
...
'key'
] : null, parentState: hydroState), semantics: _36c2.maybeUnBoxAndBuildArgument<_eed0.SemanticsGestureDelegate?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'semantics'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_eed0.RawGestureDetector>(boxer: ({required _eed0.RawGestureDetector vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawGestureDetector(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

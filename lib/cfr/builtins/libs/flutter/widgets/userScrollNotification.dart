...
class VMManagedUserScrollNotification
    extends _36c2.VMManagedBox<_593c.UserScrollNotification> {
  VMManagedUserScrollNotification(
    ...
    table['direction'] = _f376.ScrollDirection.values.indexWhere((x) {
...
class RTManagedUserScrollNotification extends _593c.UserScrollNotification
    implements _36c2.Box<_593c.UserScrollNotification> {
  RTManagedUserScrollNotification(
      {required _e2dc.BuildContext context,
      required _f376.ScrollDirection direction,
      required _96ae.ScrollMetrics metrics,
      required this.table,
      required this.hydroState})
      : super(context: context, direction: direction, metrics: metrics) {
...
void loadUserScrollNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['userScrollNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedUserScrollNotification(
          ...
          metrics: _36c2
              .maybeUnBoxAndBuildArgument<_96ae.ScrollMetrics, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['metrics']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_593c.UserScrollNotification>(boxer: (
      {required _593c.UserScrollNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedUserScrollNotification(

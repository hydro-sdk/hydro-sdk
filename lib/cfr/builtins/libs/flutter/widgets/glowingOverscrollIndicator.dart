...
class VMManagedGlowingOverscrollIndicator extends _36c2.VMManagedBox<_a0c8.GlowingOverscrollIndicator> {VMManagedGlowingOverscrollIndicator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'showLeading'
] = vmObject.showLeading;
table  [
'showTrailing'
] = vmObject.showTrailing;
table  [
'axisDirection'
...
class RTManagedGlowingOverscrollIndicator extends _a0c8.GlowingOverscrollIndicator implements _36c2.Box<_a0c8.GlowingOverscrollIndicator> {RTManagedGlowingOverscrollIndicator({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.bool Function(_593c.ScrollNotification notification) notificationPredicate, required _fac9.bool showLeading, required _fac9.bool showTrailing, required _487f.AxisDirection axisDirection, required _a643.Color color, required this.table, required this.hydroState}) : super(child: child,key: key,notificationPredicate: notificationPredicate,showLeading: showLeading,showTrailing: showTrailing,axisDirection: axisDirection,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'showLeading'
] = _36c2.maybeBoxObject(object: this.showLeading, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'showTrailing'
] = _36c2.maybeBoxObject(object: this.showTrailing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'axisDirection'
...
@_fac9.override _e2dc.State<_a0c8.GlowingOverscrollIndicator> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_a0c8.GlowingOverscrollIndicator>, _a0c8.GlowingOverscrollIndicator>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadGlowingOverscrollIndicator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedGlowingOverscrollIndicator(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), notificationPredicate: (notification) => unpackednotificationPredicate.dispatch([luaCallerArguments[0],notification],parentState:hydroState,)[0], showLeading: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showLeading'
] : null, showTrailing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showTrailing'
] : null, axisDirection: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'axisDirection'
...
_36c2.registerBoxer<_a0c8.GlowingOverscrollIndicator>(boxer: ({required _a0c8.GlowingOverscrollIndicator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGlowingOverscrollIndicator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

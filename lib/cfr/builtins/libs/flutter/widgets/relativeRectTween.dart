...
class VMManagedRelativeRectTween
    extends _36c2.VMManagedBox<_d7ad.RelativeRectTween> {
  VMManagedRelativeRectTween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_b1b6.RelativeRect?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_b1b6.RelativeRect?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedRelativeRectTween extends _d7ad.RelativeRectTween
    implements _36c2.Box<_d7ad.RelativeRectTween> {
  RTManagedRelativeRectTween(
      {_b1b6.RelativeRect? begin,
      _b1b6.RelativeRect? end,
      required this.table,
  ...
  @_fac9.override
  _b1b6.RelativeRect transform(t) {
  ...
  @_fac9.override
  _b1b6.RelativeRect evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_b1b6.RelativeRect> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_b1b6.RelativeRect>,
            _b1b6.RelativeRect>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _e83e.Animatable<_b1b6.RelativeRect> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e83e.Animatable<_b1b6.RelativeRect>, _b1b6.RelativeRect>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRelativeRectTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['relativeRectTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRelativeRectTween(
          ...
          hydroState: hydroState,
          begin: _36c2
              .maybeUnBoxAndBuildArgument<_b1b6.RelativeRect?, _fac9.dynamic>(
  ...
  _36c2.registerBoxer<_d7ad.RelativeRectTween>(boxer: (
      {required _d7ad.RelativeRectTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRelativeRectTween(

...
class VMManagedFutureBuilder extends _36c2.VMManagedBox<_13d0.FutureBuilder<_fac9.dynamic>> {VMManagedFutureBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'future'
] = _36c2.maybeBoxObject<_7de1.Future?>(object: vmObject.future, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _13d0.FutureBuilder<_fac9.dynamic> vmObject;

 }

class RTManagedFutureBuilder extends _13d0.FutureBuilder implements _36c2.Box<_13d0.FutureBuilder> {RTManagedFutureBuilder({_7de1.Future<_fac9.dynamic>? future, _fac9.dynamic? initialData, _ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _13d0.AsyncSnapshot<_fac9.dynamic> snapshot) builder, required this.table, required this.hydroState}) : super(future: future,initialData: initialData,key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'future'
] = _36c2.maybeBoxObject(object: this.future, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_13d0.FutureBuilder unwrap() => this;
_13d0.FutureBuilder get vmObject => this;
@_fac9.override _e2dc.State<_13d0.FutureBuilder<_fac9.dynamic>> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_13d0.FutureBuilder<_fac9.dynamic>>, _13d0.FutureBuilder<_fac9.dynamic>>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFutureBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'futureBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFutureBuilder(table: luaCallerArguments  [
0
], hydroState: hydroState, future: _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.dynamic>?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'future'
] : null, parentState: hydroState), initialData: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialData'
...
_36c2.registerBoxer<_13d0.FutureBuilder>(boxer: ({required _13d0.FutureBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFutureBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedClipPath extends _36c2.VMManagedBox<_3960.ClipPath> {
  VMManagedClipPath(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderClipPath>(
...
class RTManagedClipPath extends _3960.ClipPath
    implements _36c2.Box<_3960.ClipPath> {
  RTManagedClipPath(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _bf98.RenderClipPath createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderClipPath, _fac9.dynamic>(
...
void loadClipPath(
  ...
  table['clipPath'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipPath(
  ...
  table['clipPathShape'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_e2dc.Widget>(
          object: _3960.ClipPath.shape(
              child: _36c2
  ...
  _36c2.registerBoxer<_3960.ClipPath>(boxer: (
      {required _3960.ClipPath vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipPath(

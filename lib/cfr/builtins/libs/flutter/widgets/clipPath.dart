...
class VMManagedClipPath extends _36c2.VMManagedBox<_3960.ClipPath> {VMManagedClipPath({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderClipPath>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipPath, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
'didUnmountRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipPath, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _3960.ClipPath vmObject;

 }

class RTManagedClipPath extends _3960.ClipPath implements _36c2.Box<_3960.ClipPath> {RTManagedClipPath({_e2dc.Widget? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.Path>? clipper, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,clipper: clipper,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipPath, _fac9.dynamic>(
...
_3960.ClipPath unwrap() => this;
_3960.ClipPath get vmObject => this;
@_fac9.override _bf98.RenderClipPath createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipPath, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadClipPath({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipPath'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedClipPath(table: luaCallerArguments  [
0
...
return [_36c2.maybeBoxObject<_e2dc.Widget>(object: _3960.ClipPath.shape(child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState), clipBehavior: _36c2.maybeUnBoxEnum(values: _a643.Clip.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
_36c2.registerBoxer<_3960.ClipPath>(boxer: ({required _3960.ClipPath vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipPath(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

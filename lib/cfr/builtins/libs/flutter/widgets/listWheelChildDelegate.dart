...
class VMManagedListWheelChildDelegate extends _36c2.VMManagedBox<_7b25.ListWheelChildDelegate> {VMManagedListWheelChildDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRebuild(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelChildDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedListWheelChildDelegate extends _7b25.ListWheelChildDelegate implements _36c2.Box<_7b25.ListWheelChildDelegate> {RTManagedListWheelChildDelegate({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadListWheelChildDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listWheelChildDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedListWheelChildDelegate(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7b25.ListWheelChildDelegate>(boxer: ({required _7b25.ListWheelChildDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListWheelChildDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

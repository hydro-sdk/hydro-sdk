...
class VMManagedListWheelElement extends _36c2.VMManagedBox<_7b25.ListWheelElement> {VMManagedListWheelElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7b25.ListWheelViewport>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_5bcb.RenderListWheelViewport>(object: vmObject.renderObject, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getChildCount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.childCount;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'performRebuild'
...
table  [
'retrieveWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.retrieveWidget(luaCallerArguments  [
1
...
table  [
'childExistsAt'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childExistsAt(luaCallerArguments  [
1
]),]; } );
table  [
'createChild'
...
final _7b25.ListWheelElement vmObject;

 }

class RTManagedListWheelElement extends _7b25.ListWheelElement implements _36c2.Box<_7b25.ListWheelElement> {RTManagedListWheelElement(_7b25.ListWheelViewport widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_update'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.update(
      _36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport, _fac9.dynamic>(
...
table['_dart_retrieveWidget'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.retrieveWidget(
...
table['_dart_childExistsAt'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.childExistsAt(
            _36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
_7b25.ListWheelElement unwrap() => this;
_7b25.ListWheelElement get vmObject => this;
@_fac9.override _7b25.ListWheelViewport get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _5bcb.RenderListWheelViewport get renderObject { 
_36c2.Closure closure = table["getRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_5bcb.RenderListWheelViewport, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Widget? retrieveWidget(index) { 
_36c2.Closure closure = table["retrieveWidget"];
...
@_fac9.override _fac9.bool childExistsAt(index) { 
_36c2.Closure closure = table["childExistsAt"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadListWheelElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listWheelElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedListWheelElement(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7b25.ListWheelElement>(boxer: ({required _7b25.ListWheelElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListWheelElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedListWheelElement
    extends _36c2.VMManagedBox<_7b25.ListWheelElement> {
  VMManagedListWheelElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_7b25.ListWheelViewport>(
    ...
    table['update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport,
    ...
    table['retrieveWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.retrieveWidget(luaCallerArguments[1]);
      if (returnValue != null) {
        return [
...
class RTManagedListWheelElement extends _7b25.ListWheelElement
    implements _36c2.Box<_7b25.ListWheelElement> {
  RTManagedListWheelElement(_7b25.ListWheelViewport widget$,
    ...
    table['_dart_update'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.update(_36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_retrieveWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_childExistsAt'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _7b25.ListWheelViewport get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _5bcb.RenderListWheelViewport get renderObject {
  ...
  @_fac9.override
  _e2dc.Widget? retrieveWidget(index) {
  ...
  @_fac9.override
  _fac9.bool childExistsAt(index) {
...
void loadListWheelElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['listWheelElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedListWheelElement(
          _36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelViewport,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_7b25.ListWheelElement>(boxer: (
      {required _7b25.ListWheelElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedListWheelElement(

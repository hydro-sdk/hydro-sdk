...
class VMManagedFocusTraversalGroup extends _36c2.VMManagedBox<_65d3.FocusTraversalGroup> {VMManagedFocusTraversalGroup({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'policy'
] = _36c2.maybeBoxObject<_65d3.FocusTraversalPolicy>(object: vmObject.policy, hydroState: hydroState, table: _36c2.HydroTable());
table  [
...
final _65d3.FocusTraversalGroup vmObject;

 }

class RTManagedFocusTraversalGroup extends _65d3.FocusTraversalGroup implements _36c2.Box<_65d3.FocusTraversalGroup> {RTManagedFocusTraversalGroup({required _fac9.bool descendantsAreFocusable, _ab4a.Key? key, _65d3.FocusTraversalPolicy? policy, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(descendantsAreFocusable: descendantsAreFocusable,key: key,policy: policy,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'policy'
] = _36c2.maybeBoxObject(object: this.policy, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'descendantsAreFocusable'
...
_65d3.FocusTraversalGroup unwrap() => this;
_65d3.FocusTraversalGroup get vmObject => this;
@_fac9.override _e2dc.State<_65d3.FocusTraversalGroup> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_65d3.FocusTraversalGroup>, _65d3.FocusTraversalGroup>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFocusTraversalGroup({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'focusTraversalGroup'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFocusTraversalGroup(table: luaCallerArguments  [
0
], hydroState: hydroState, descendantsAreFocusable: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'descendantsAreFocusable'
...
'key'
] : null, parentState: hydroState), policy: _36c2.maybeUnBoxAndBuildArgument<_65d3.FocusTraversalPolicy?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'policy'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_65d3.FocusTraversalPolicy>(object: _65d3.FocusTraversalGroup.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'focusTraversalGroupMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _65d3.FocusTraversalGroup.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_65d3.FocusTraversalPolicy?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_65d3.FocusTraversalGroup>(boxer: ({required _65d3.FocusTraversalGroup vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFocusTraversalGroup(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

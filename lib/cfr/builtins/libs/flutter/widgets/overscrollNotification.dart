...
class VMManagedOverscrollNotification
    extends _36c2.VMManagedBox<_593c.OverscrollNotification> {
  VMManagedOverscrollNotification(
    ...
    table['overscroll'] = vmObject.overscroll;
    table['velocity'] = vmObject.velocity;
...
class RTManagedOverscrollNotification extends _593c.OverscrollNotification
    implements _36c2.Box<_593c.OverscrollNotification> {
  RTManagedOverscrollNotification(
      ...
      required _fac9.double overscroll,
      required this.table,
    ...
    table['dragDetails'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['overscroll'] = _36c2.maybeBoxObject(
        object: this.overscroll,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadOverscrollNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['overscrollNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOverscrollNotification(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          dragDetails: _36c2.maybeUnBoxAndBuildArgument<_4bc7.DragUpdateDetails?, _fac9.dynamic>(
          ...
          metrics: _36c2.maybeUnBoxAndBuildArgument<_96ae.ScrollMetrics, _fac9.dynamic>(
              ...
              parentState: hydroState),
          overscroll: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['overscroll'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_593c.OverscrollNotification>(boxer: (
      {required _593c.OverscrollNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOverscrollNotification(

...
class VMManagedShaderMask extends _36c2.VMManagedBox<_3960.ShaderMask> {
  VMManagedShaderMask(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderShaderMask>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderShaderMask,
...
class RTManagedShaderMask extends _3960.ShaderMask
    implements _36c2.Box<_3960.ShaderMask> {
  RTManagedShaderMask(
  ...
  @_fac9.override
  _bf98.RenderShaderMask createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderShaderMask, _fac9.dynamic>(
...
void loadShaderMask(
  ...
  table['shaderMask'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_3960.ShaderMask>(boxer: (
      {required _3960.ShaderMask vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShaderMask(

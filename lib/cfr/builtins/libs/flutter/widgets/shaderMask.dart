...
class VMManagedShaderMask extends _36c2.VMManagedBox<_3960.ShaderMask> {VMManagedShaderMask({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderShaderMask>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderShaderMask, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.ShaderMask vmObject;

 }

class RTManagedShaderMask extends _3960.ShaderMask implements _36c2.Box<_3960.ShaderMask> {RTManagedShaderMask({required _a643.BlendMode blendMode, _e2dc.Widget? child, _ab4a.Key? key, required _a643.Shader Function(_a643.Rect bounds) shaderCallback, required this.table, required this.hydroState}) : super(blendMode: blendMode,child: child,key: key,shaderCallback: shaderCallback) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderShaderMask, _fac9.dynamic>(
...
_3960.ShaderMask unwrap() => this;
_3960.ShaderMask get vmObject => this;
@_fac9.override _bf98.RenderShaderMask createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderShaderMask, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadShaderMask({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shaderMask'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedShaderMask(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.ShaderMask>(boxer: ({required _3960.ShaderMask vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShaderMask(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

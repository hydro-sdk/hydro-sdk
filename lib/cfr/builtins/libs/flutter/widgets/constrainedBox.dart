...
class VMManagedConstrainedBox extends _36c2.VMManagedBox<_3960.ConstrainedBox> {VMManagedConstrainedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderConstrainedBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderConstrainedBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.ConstrainedBox vmObject;

 }

class RTManagedConstrainedBox extends _3960.ConstrainedBox implements _36c2.Box<_3960.ConstrainedBox> {RTManagedConstrainedBox({_e2dc.Widget? child, _ab4a.Key? key, required _be2e.BoxConstraints constraints, required this.table, required this.hydroState}) : super(child: child,key: key,constraints: constraints) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderConstrainedBox,
...
_3960.ConstrainedBox unwrap() => this;
_3960.ConstrainedBox get vmObject => this;
@_fac9.override _bf98.RenderConstrainedBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderConstrainedBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadConstrainedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'constrainedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedConstrainedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.ConstrainedBox>(boxer: ({required _3960.ConstrainedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedConstrainedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

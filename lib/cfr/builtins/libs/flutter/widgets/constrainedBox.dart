...
class VMManagedConstrainedBox extends _36c2.VMManagedBox<_3960.ConstrainedBox> {
  VMManagedConstrainedBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderConstrainedBox>(
...
class RTManagedConstrainedBox extends _3960.ConstrainedBox
    implements _36c2.Box<_3960.ConstrainedBox> {
  RTManagedConstrainedBox(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _be2e.BoxConstraints constraints,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, constraints: constraints) {
  ...
  @_fac9.override
  _bf98.RenderConstrainedBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderConstrainedBox, _fac9.dynamic>(
...
void loadConstrainedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['constrainedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedConstrainedBox(
  ...
  _36c2.registerBoxer<_3960.ConstrainedBox>(boxer: (
      {required _3960.ConstrainedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedConstrainedBox(

...
class VMManagedHeroControllerScope extends _36c2.VMManagedBox<_a37d.HeroControllerScope> {VMManagedHeroControllerScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'controller'
] = _36c2.maybeBoxObject<_1b22.HeroController?>(object: vmObject.controller, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_a37d.HeroControllerScope, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a37d.HeroControllerScope vmObject;

 }

class RTManagedHeroControllerScope extends _a37d.HeroControllerScope implements _36c2.Box<_a37d.HeroControllerScope> {RTManagedHeroControllerScope({_ab4a.Key? key, required _e2dc.Widget child, required _1b22.HeroController controller, required this.table, required this.hydroState}) : super(key: key,child: child,controller: controller) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a37d.HeroControllerScope unwrap() => this;
_a37d.HeroControllerScope get vmObject => this;
...
void loadHeroControllerScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'heroControllerScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedHeroControllerScope(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), controller: _36c2.maybeUnBoxAndBuildArgument<_1b22.HeroController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
] : null, parentState: hydroState))]; } );
table  [
'heroControllerScopeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _a37d.HeroControllerScope.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_1b22.HeroController?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_a37d.HeroControllerScope>(boxer: ({required _a37d.HeroControllerScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHeroControllerScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

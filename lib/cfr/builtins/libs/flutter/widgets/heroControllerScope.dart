...
class VMManagedHeroControllerScope
    extends _36c2.VMManagedBox<_a37d.HeroControllerScope> {
  VMManagedHeroControllerScope(
    ...
    table['controller'] = _36c2.maybeBoxObject<_1b22.HeroController?>(
...
class RTManagedHeroControllerScope extends _a37d.HeroControllerScope
    implements _36c2.Box<_a37d.HeroControllerScope> {
  RTManagedHeroControllerScope(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _1b22.HeroController controller,
      required this.table,
...
void loadHeroControllerScope(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['heroControllerScope'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedHeroControllerScope(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          controller: _36c2.maybeUnBoxAndBuildArgument<_1b22.HeroController, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['heroControllerScopeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _a37d.HeroControllerScope.of(
  ...
  _36c2.registerBoxer<_a37d.HeroControllerScope>(boxer: (
      {required _a37d.HeroControllerScope vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedHeroControllerScope(

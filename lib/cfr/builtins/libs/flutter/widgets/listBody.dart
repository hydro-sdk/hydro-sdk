...
class VMManagedListBody extends _36c2.VMManagedBox<_3960.ListBody> {VMManagedListBody({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'mainAxis'
] = _487f.Axis.values.indexWhere((x) { return x == vmObject.mainAxis; } );
table  [
'reverse'
] = vmObject.reverse;
table  [
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_6874.RenderListBody>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_6874.RenderListBody, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.ListBody vmObject;

 }

class RTManagedListBody extends _3960.ListBody implements _36c2.Box<_3960.ListBody> {RTManagedListBody({required _fac9.List<_e2dc.Widget> children, _ab4a.Key? key, required _487f.Axis mainAxis, required _fac9.bool reverse, required this.table, required this.hydroState}) : super(children: children,key: key,mainAxis: mainAxis,reverse: reverse) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'mainAxis'
] = _487f.Axis.values.indexWhere((x) { return x == this.mainAxis; } );
table  [
'reverse'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_6874.RenderListBody, _fac9.dynamic>(
...
_3960.ListBody unwrap() => this;
_3960.ListBody get vmObject => this;
@_fac9.override _6874.RenderListBody createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_6874.RenderListBody, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadListBody({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listBody'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedListBody(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), mainAxis: _36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'mainAxis'
...
_36c2.registerBoxer<_3960.ListBody>(boxer: ({required _3960.ListBody vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListBody(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

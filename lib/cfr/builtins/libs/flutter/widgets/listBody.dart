...
class VMManagedListBody extends _36c2.VMManagedBox<_3960.ListBody> {
  VMManagedListBody(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_6874.RenderListBody>(
...
class RTManagedListBody extends _3960.ListBody
    implements _36c2.Box<_3960.ListBody> {
  RTManagedListBody(
  ...
  @_fac9.override
  _6874.RenderListBody createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_6874.RenderListBody, _fac9.dynamic>(
...
void loadListBody(
  ...
  table['listBody'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedListBody(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          mainAxis: _36c2.maybeUnBoxEnum(
              values: _487f.Axis.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['mainAxis']
                  : null),
  ...
  _36c2.registerBoxer<_3960.ListBody>(boxer: (
      {required _3960.ListBody vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedListBody(

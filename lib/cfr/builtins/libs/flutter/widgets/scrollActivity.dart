...
class VMManagedScrollActivity extends _36c2.VMManagedBox<_ca8b.ScrollActivity> {VMManagedScrollActivity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedScrollActivity extends _ca8b.ScrollActivity implements _36c2.Box<_ca8b.ScrollActivity> {RTManagedScrollActivity(_ca8b.ScrollActivityDelegate _delegate, {required this.table, required this.hydroState}) : super(_delegate,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadScrollActivity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollActivity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedScrollActivity(_36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivityDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_ca8b.ScrollActivity>(boxer: ({required _ca8b.ScrollActivity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollActivity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

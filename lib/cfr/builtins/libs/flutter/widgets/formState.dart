...
class VMManagedFormState extends _36c2.VMManagedBox<_5dd5.FormState> {
  VMManagedFormState(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_5dd5.Form>(
...
class RTManagedFormState extends _5dd5.FormState
    implements _36c2.Box<_5dd5.FormState> {
  RTManagedFormState({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _5dd5.Form get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_5dd5.Form, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadFormState(
  ...
  table['formState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFormState(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_5dd5.FormState>(boxer: (
      {required _5dd5.FormState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFormState(

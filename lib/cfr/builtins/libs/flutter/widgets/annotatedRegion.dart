...
import 'package:flutter/src/widgets/annotated_region.dart' as _a384;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedAnnotatedRegion extends _36c2.VMManagedBox<_a384.AnnotatedRegion<_fac9.Object>> {VMManagedAnnotatedRegion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAnnotatedRegion<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
2
...
final _a384.AnnotatedRegion<_fac9.Object> vmObject;

 }

class RTManagedAnnotatedRegion extends _a384.AnnotatedRegion implements _36c2.Box<_a384.AnnotatedRegion> {RTManagedAnnotatedRegion({_ab4a.Key? key, required _fac9.bool sized, required _e2dc.Widget child, required _fac9.Object value, required this.table, required this.hydroState}) : super(key: key,sized: sized,child: child,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'sized'
] = _36c2.maybeBoxObject(object: this.sized, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_a384.AnnotatedRegion unwrap() => this;
_a384.AnnotatedRegion get vmObject => this;
...
void loadAnnotatedRegion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'annotatedRegion'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedAnnotatedRegion(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), value: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null)]; } );
_36c2.registerBoxer<_a384.AnnotatedRegion>(boxer: ({required _a384.AnnotatedRegion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnnotatedRegion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

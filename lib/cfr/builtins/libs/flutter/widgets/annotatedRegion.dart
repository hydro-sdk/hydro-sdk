...
class VMManagedAnnotatedRegion
    extends _36c2.VMManagedBox<_a384.AnnotatedRegion<_fac9.Object>> {
  VMManagedAnnotatedRegion(
...
class RTManagedAnnotatedRegion extends _a384.AnnotatedRegion
    implements _36c2.Box<_a384.AnnotatedRegion> {
  RTManagedAnnotatedRegion(
      {_ab4a.Key? key,
      ...
      : super(key: key, sized: sized, child: child, value: value) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['sized'] = _36c2.maybeBoxObject(
        object: this.sized, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadAnnotatedRegion(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['annotatedRegion'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnnotatedRegion(
  ...
  _36c2.registerBoxer<_a384.AnnotatedRegion>(boxer: (
      {required _a384.AnnotatedRegion vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnnotatedRegion(

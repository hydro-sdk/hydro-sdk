...
class VMManagedMultiChildRenderObjectElement
    extends VMManagedBox<MultiChildRenderObjectElement> {
  VMManagedMultiChildRenderObjectElement(
    ...
    table['getWidget'] =
      ...
      return [
        maybeBoxObject<MultiChildRenderObjectWidget>(
    ...
    table['getRenderObject'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<ContainerRenderObjectMixin>(
    ...
    table['insertRenderObjectChild'] =
      ...
      vmObject.insertRenderObjectChild(
          ...
          maybeUnBoxAndBuildArgument<IndexedSlot<Element?>, Element?>(
    ...
    table['update'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.update(
          maybeUnBoxAndBuildArgument<MultiChildRenderObjectWidget, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
  ...
  final MultiChildRenderObjectElement vmObject;
}

class RTManagedMultiChildRenderObjectElement
    extends MultiChildRenderObjectElement
    implements Box<MultiChildRenderObjectElement> {
  RTManagedMultiChildRenderObjectElement(MultiChildRenderObjectWidget widget$,
  ...
  MultiChildRenderObjectElement unwrap() => this;
  MultiChildRenderObjectElement get vmObject => this;
  @override
  MultiChildRenderObjectWidget get widget {
    Closure closure = table["getWidget"];
    return maybeUnBoxAndBuildArgument<MultiChildRenderObjectWidget, dynamic>(
  ...
  ContainerRenderObjectMixin<RenderObject,
    ...
    return maybeUnBoxAndBuildArgument<
            ...
            RenderObject>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Iterable<Element> get children {
    ...
    return maybeUnBoxAndBuildArgument<Iterable<Element>, Element>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void moveRenderObjectChild(
      RenderObject child, IndexedSlot oldSlot, IndexedSlot newSlot) {
...
void loadMultiChildRenderObjectElement(
  ...
  table['multiChildRenderObjectElement'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
  ...
  registerBoxer<MultiChildRenderObjectElement>(boxer: (
      {required MultiChildRenderObjectElement vmObject,

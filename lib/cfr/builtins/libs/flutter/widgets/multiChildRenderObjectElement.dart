...
class VMManagedMultiChildRenderObjectElement
    extends _36c2.VMManagedBox<_e2dc.MultiChildRenderObjectElement> {
  VMManagedMultiChildRenderObjectElement(
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_e2dc.MultiChildRenderObjectWidget>(
    ...
    table['getRenderObject'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_9742.ContainerRenderObjectMixin>(
    ...
    table['inflateWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e2dc.Element>(
            object: vmObject.inflateWidget(
...
class RTManagedMultiChildRenderObjectElement
    extends _e2dc.MultiChildRenderObjectElement
    implements _36c2.Box<_e2dc.MultiChildRenderObjectElement> {
  RTManagedMultiChildRenderObjectElement(
      _e2dc.MultiChildRenderObjectWidget widget$,
      {required this.table,
  ...
  @_fac9.override
  _e2dc.MultiChildRenderObjectWidget get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.MultiChildRenderObjectWidget,
            _fac9.dynamic>(
  ...
  _9742.ContainerRenderObjectMixin<_9742.RenderObject,
      _9742.ContainerParentDataMixin<_9742.RenderObject>> get renderObject {
  ...
  @_fac9.override
  _fac9.Iterable<_e2dc.Element> get children {
    _36c2.Closure closure = table["getChildren"];
    return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_e2dc.Element>,
            _e2dc.Element>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadMultiChildRenderObjectElement(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['multiChildRenderObjectElement'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMultiChildRenderObjectElement(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.MultiChildRenderObjectWidget,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e2dc.MultiChildRenderObjectElement>(boxer: (
      {required _e2dc.MultiChildRenderObjectElement vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMultiChildRenderObjectElement(

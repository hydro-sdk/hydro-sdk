...
class VMManagedMultiChildRenderObjectElement extends _36c2.VMManagedBox<_e2dc.MultiChildRenderObjectElement> {VMManagedMultiChildRenderObjectElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.MultiChildRenderObjectWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9742.ContainerRenderObjectMixin>(object: vmObject.renderObject, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e2dc.IndexedSlot<_e2dc.Element?>, _e2dc.Element?>(luaCallerArguments  [
2
...
return [_36c2.maybeBoxObject<_e2dc.Element>(object: vmObject.inflateWidget(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
2
...
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.MultiChildRenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _e2dc.MultiChildRenderObjectElement vmObject;

 }

class RTManagedMultiChildRenderObjectElement extends _e2dc.MultiChildRenderObjectElement implements _36c2.Box<_e2dc.MultiChildRenderObjectElement> {RTManagedMultiChildRenderObjectElement(_e2dc.MultiChildRenderObjectWidget widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_insertRenderObjectChild'] =
  ...
  super.insertRenderObjectChild(
      _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(
          ...
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.IndexedSlot<_e2dc.Element?>,
          _e2dc.Element?>(luaCallerArguments[2], parentState: hydroState));
  return [];
});
table['_dart_moveRenderObjectChild'] =
  ...
  super.moveRenderObjectChild(
      ...
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.IndexedSlot<_e2dc.Element?>,
          _e2dc.Element?>(luaCallerArguments[2], parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.IndexedSlot<_e2dc.Element?>,
          _e2dc.Element?>(luaCallerArguments[3], parentState: hydroState));
  return [];
});
...
table['_dart_update'] =
  ...
  super.update(_36c2.maybeUnBoxAndBuildArgument<
      _e2dc.MultiChildRenderObjectWidget,
...
_e2dc.MultiChildRenderObjectElement unwrap() => this;
_e2dc.MultiChildRenderObjectElement get vmObject => this;
@_fac9.override _e2dc.MultiChildRenderObjectWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.MultiChildRenderObjectWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _9742.ContainerRenderObjectMixin<_9742.RenderObject,_9742.ContainerParentDataMixin<_9742.RenderObject>> get renderObject { 
_36c2.Closure closure = table["getRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_9742.ContainerRenderObjectMixin<_9742.RenderObject,_9742.ContainerParentDataMixin<_9742.RenderObject>>, _9742.RenderObject>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.Iterable<_e2dc.Element> get children { 
_36c2.Closure closure = table["getChildren"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_e2dc.Element>, _e2dc.Element>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMultiChildRenderObjectElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'multiChildRenderObjectElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMultiChildRenderObjectElement(_36c2.maybeUnBoxAndBuildArgument<_e2dc.MultiChildRenderObjectWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.MultiChildRenderObjectElement>(boxer: ({required _e2dc.MultiChildRenderObjectElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMultiChildRenderObjectElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

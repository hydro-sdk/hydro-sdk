...
class VMManagedRequestFocusIntent extends _36c2.VMManagedBox<_65d3.RequestFocusIntent> {VMManagedRequestFocusIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _65d3.RequestFocusIntent vmObject;

 }

class RTManagedRequestFocusIntent extends _65d3.RequestFocusIntent implements _36c2.Box<_65d3.RequestFocusIntent> {RTManagedRequestFocusIntent(_b485.FocusNode focusNode$, {required this.table, required this.hydroState}) : super(focusNode$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_65d3.RequestFocusIntent unwrap() => this;
_65d3.RequestFocusIntent get vmObject => this;
...
void loadRequestFocusIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'requestFocusIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRequestFocusIntent(_36c2.maybeUnBoxAndBuildArgument<_b485.FocusNode, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_65d3.RequestFocusIntent>(boxer: ({required _65d3.RequestFocusIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRequestFocusIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFormField
    extends _36c2.VMManagedBox<_5dd5.FormField<_fac9.dynamic>> {
  VMManagedFormField(
...
class RTManagedFormField extends _5dd5.FormField
    implements _36c2.Box<_5dd5.FormField> {
  RTManagedFormField(
      ...
      required _e2dc.Widget Function(_5dd5.FormFieldState<_fac9.dynamic> field)
          builder,
      required this.table,
...
void loadFormField(
  ...
  table['formField'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedFormField(
          ...
          enabled: luaCallerArguments.length >= 2
              ...
              : null,
          initialValue: luaCallerArguments.length >= 2
          ...
          builder: (field) =>
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedbuilder.dispatch(
                    [luaCallerArguments[0], field],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_5dd5.FormField>(boxer: (
      {required _5dd5.FormField vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFormField(

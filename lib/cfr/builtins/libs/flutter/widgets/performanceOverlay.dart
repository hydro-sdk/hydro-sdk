...
import 'package:flutter/src/widgets/performance_overlay.dart' as _5af4;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedPerformanceOverlay extends _36c2.VMManagedBox<_5af4.PerformanceOverlay> {VMManagedPerformanceOverlay({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_1976.RenderPerformanceOverlay>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_1976.RenderPerformanceOverlay, _fac9.dynamic>(luaCallerArguments  [
2
...
final _5af4.PerformanceOverlay vmObject;

 }

class RTManagedPerformanceOverlay extends _5af4.PerformanceOverlay implements _36c2.Box<_5af4.PerformanceOverlay> {RTManagedPerformanceOverlay({required _fac9.bool checkerboardOffscreenLayers, required _fac9.bool checkerboardRasterCacheImages, _ab4a.Key? key, required _fac9.int optionsMask, required _fac9.int rasterizerThreshold, required this.table, required this.hydroState}) : super(checkerboardOffscreenLayers: checkerboardOffscreenLayers,checkerboardRasterCacheImages: checkerboardRasterCacheImages,key: key,optionsMask: optionsMask,rasterizerThreshold: rasterizerThreshold) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_1976.RenderPerformanceOverlay,
...
_5af4.PerformanceOverlay unwrap() => this;
_5af4.PerformanceOverlay get vmObject => this;
@_fac9.override _1976.RenderPerformanceOverlay createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_1976.RenderPerformanceOverlay, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadPerformanceOverlay({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'performanceOverlay'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPerformanceOverlay(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), optionsMask: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'optionsMask'
...
_36c2.registerBoxer<_5af4.PerformanceOverlay>(boxer: ({required _5af4.PerformanceOverlay vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPerformanceOverlay(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
import 'package:flutter/src/widgets/color_filter.dart' as _9dce;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedColorFiltered extends _36c2.VMManagedBox<_9dce.ColorFiltered> {VMManagedColorFiltered({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _9dce.ColorFiltered vmObject;

 }

class RTManagedColorFiltered extends _9dce.ColorFiltered implements _36c2.Box<_9dce.ColorFiltered> {RTManagedColorFiltered({_e2dc.Widget? child, _ab4a.Key? key, required _a643.ColorFilter colorFilter, required this.table, required this.hydroState}) : super(child: child,key: key,colorFilter: colorFilter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_9dce.ColorFiltered unwrap() => this;
_9dce.ColorFiltered get vmObject => this;
...
void loadColorFiltered({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'colorFiltered'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedColorFiltered(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_9dce.ColorFiltered>(boxer: ({required _9dce.ColorFiltered vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedColorFiltered(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

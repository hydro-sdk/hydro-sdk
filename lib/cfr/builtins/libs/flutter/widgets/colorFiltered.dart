...
class VMManagedColorFiltered extends _36c2.VMManagedBox<_9dce.ColorFiltered> {
  VMManagedColorFiltered(
...
class RTManagedColorFiltered extends _9dce.ColorFiltered
    implements _36c2.Box<_9dce.ColorFiltered> {
  RTManagedColorFiltered(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _a643.ColorFilter colorFilter,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, colorFilter: colorFilter) {
...
void loadColorFiltered(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['colorFiltered'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColorFiltered(
  ...
  _36c2.registerBoxer<_9dce.ColorFiltered>(boxer: (
      {required _9dce.ColorFiltered vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColorFiltered(

...
class VMManagedAnimatedOpacity extends _36c2.VMManagedBox<_da7c.AnimatedOpacity> {VMManagedAnimatedOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _da7c.AnimatedOpacity vmObject;

 }

class RTManagedAnimatedOpacity extends _da7c.AnimatedOpacity implements _36c2.Box<_da7c.AnimatedOpacity> {RTManagedAnimatedOpacity({required _fac9.bool alwaysIncludeSemantics, _e2dc.Widget? child, required _8c47.Curve curve, _ab4a.Key? key, void Function()? onEnd, required _fac9.Duration duration, required _fac9.double opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,child: child,curve: curve,key: key,onEnd: onEnd,duration: duration,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_da7c.AnimatedOpacity unwrap() => this;
_da7c.AnimatedOpacity get vmObject => this;
@_fac9.override _da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedOpacity> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_da7c.ImplicitlyAnimatedWidgetState<_da7c.AnimatedOpacity>, _da7c.AnimatedOpacity>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAnimatedOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedOpacity(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_da7c.AnimatedOpacity>(boxer: ({required _da7c.AnimatedOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedListWheelViewport extends _36c2.VMManagedBox<_7b25.ListWheelViewport> {VMManagedListWheelViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7b25.ListWheelElement>(object: vmObject.createElement(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_5bcb.RenderListWheelViewport>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_5bcb.RenderListWheelViewport, _fac9.dynamic>(luaCallerArguments  [
2
...
class RTManagedListWheelViewport extends _7b25.ListWheelViewport implements _36c2.Box<_7b25.ListWheelViewport> {RTManagedListWheelViewport({required _a643.Clip clipBehavior, required _fac9.double diameterRatio, _ab4a.Key? key, required _fac9.double magnification, required _fac9.double offAxisFraction, required _fac9.double overAndUnderCenterOpacity, required _fac9.double perspective, required _fac9.bool renderChildrenOutsideViewport, required _fac9.double squeeze, required _fac9.bool useMagnifier, required _7b25.ListWheelChildDelegate childDelegate, required _fac9.double itemExtent, required _f376.ViewportOffset offset, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,diameterRatio: diameterRatio,key: key,magnification: magnification,offAxisFraction: offAxisFraction,overAndUnderCenterOpacity: overAndUnderCenterOpacity,perspective: perspective,renderChildrenOutsideViewport: renderChildrenOutsideViewport,squeeze: squeeze,useMagnifier: useMagnifier,childDelegate: childDelegate,itemExtent: itemExtent,offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'childDelegate'
] = _36c2.maybeBoxObject(object: this.childDelegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'clipBehavior'
...
@_fac9.override _7b25.ListWheelElement createElement() { 
_36c2.Closure closure = table["createElement"];
return _36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelElement, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _5bcb.RenderListWheelViewport createRenderObject(context) { 
...
void loadListWheelViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listWheelViewport'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedListWheelViewport(table: luaCallerArguments  [
0
...
'useMagnifier'
] : null, childDelegate: _36c2.maybeUnBoxAndBuildArgument<_7b25.ListWheelChildDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childDelegate'
...
_36c2.registerBoxer<_7b25.ListWheelViewport>(boxer: ({required _7b25.ListWheelViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListWheelViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRestorableDateTime
    extends _36c2.VMManagedBox<_28c9.RestorableDateTime> {
  VMManagedRestorableDateTime(
...
class RTManagedRestorableDateTime extends _28c9.RestorableDateTime
    implements _36c2.Box<_28c9.RestorableDateTime> {
  RTManagedRestorableDateTime(_fac9.DateTime defaultValue,
...
void loadRestorableDateTime(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorableDateTime'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorableDateTime(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.DateTime, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_28c9.RestorableDateTime>(boxer: (
      {required _28c9.RestorableDateTime vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorableDateTime(

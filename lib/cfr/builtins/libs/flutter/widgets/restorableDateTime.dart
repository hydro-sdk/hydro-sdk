...
class VMManagedRestorableDateTime extends _36c2.VMManagedBox<_28c9.RestorableDateTime> {VMManagedRestorableDateTime({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'createDefaultValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.DateTime>(object: vmObject.createDefaultValue(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'didUpdateValue'
...
table  [
'fromPrimitives'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.DateTime>(object: vmObject.fromPrimitives(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.DateTime>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setValue'
...
final _28c9.RestorableDateTime vmObject;

 }

class RTManagedRestorableDateTime extends _28c9.RestorableDateTime implements _36c2.Box<_28c9.RestorableDateTime> {RTManagedRestorableDateTime(_fac9.DateTime defaultValue, {required this.table, required this.hydroState}) : super(defaultValue,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_28c9.RestorableDateTime unwrap() => this;
_28c9.RestorableDateTime get vmObject => this;
...
void loadRestorableDateTime({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableDateTime'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableDateTime(_36c2.maybeUnBoxAndBuildArgument<_fac9.DateTime, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_28c9.RestorableDateTime>(boxer: ({required _28c9.RestorableDateTime vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableDateTime(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

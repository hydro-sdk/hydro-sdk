...
class VMManagedClipOval extends _36c2.VMManagedBox<_3960.ClipOval> {
  VMManagedClipOval(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderClipOval>(
...
class RTManagedClipOval extends _3960.ClipOval
    implements _36c2.Box<_3960.ClipOval> {
  RTManagedClipOval(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _bf98.RenderClipOval createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderClipOval, _fac9.dynamic>(
...
void loadClipOval(
  ...
  table['clipOval'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipOval(
  ...
  _36c2.registerBoxer<_3960.ClipOval>(boxer: (
      {required _3960.ClipOval vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipOval(

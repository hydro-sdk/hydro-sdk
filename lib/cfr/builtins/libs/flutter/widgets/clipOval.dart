...
class VMManagedClipOval extends _36c2.VMManagedBox<_3960.ClipOval> {VMManagedClipOval({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderClipOval>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipOval, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
'didUnmountRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUnmountRenderObject(_36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipOval, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _3960.ClipOval vmObject;

 }

class RTManagedClipOval extends _3960.ClipOval implements _36c2.Box<_3960.ClipOval> {RTManagedClipOval({_e2dc.Widget? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.Rect>? clipper, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,clipper: clipper,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipOval, _fac9.dynamic>(
...
_3960.ClipOval unwrap() => this;
_3960.ClipOval get vmObject => this;
@_fac9.override _bf98.RenderClipOval createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipOval, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadClipOval({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipOval'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedClipOval(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.ClipOval>(boxer: ({required _3960.ClipOval vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipOval(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedKeepAliveNotification
    extends _36c2.VMManagedBox<_78f9.KeepAliveNotification> {
  VMManagedKeepAliveNotification(
    ...
    table['handle'] = _36c2.maybeBoxObject<_e644.Listenable>(
...
class RTManagedKeepAliveNotification extends _78f9.KeepAliveNotification
    implements _36c2.Box<_78f9.KeepAliveNotification> {
  RTManagedKeepAliveNotification(_e644.Listenable handle$,
...
void loadKeepAliveNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['keepAliveNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedKeepAliveNotification(
  ...
  _36c2.registerBoxer<_78f9.KeepAliveNotification>(boxer: (
      {required _78f9.KeepAliveNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedKeepAliveNotification(

...
class VMManagedMouseRegion extends _36c2.VMManagedBox<_3960.MouseRegion> {VMManagedMouseRegion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.MouseRegion vmObject;

 }

class RTManagedMouseRegion extends _3960.MouseRegion implements _36c2.Box<_3960.MouseRegion> {RTManagedMouseRegion({_e2dc.Widget? child, required _fd33.MouseCursor cursor, _ab4a.Key? key, void Function(_0e77.PointerEnterEvent event)? onEnter, void Function(_0e77.PointerExitEvent event)? onExit, void Function(_0e77.PointerHoverEvent event)? onHover, required _fac9.bool opaque, required this.table, required this.hydroState}) : super(child: child,cursor: cursor,key: key,onEnter: onEnter,onExit: onExit,onHover: onHover,opaque: opaque) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.MouseRegion unwrap() => this;
_3960.MouseRegion get vmObject => this;
@_fac9.override _e2dc.State<_3960.MouseRegion> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_3960.MouseRegion>, _3960.MouseRegion>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMouseRegion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'mouseRegion'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedMouseRegion(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.MouseRegion>(boxer: ({required _3960.MouseRegion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMouseRegion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

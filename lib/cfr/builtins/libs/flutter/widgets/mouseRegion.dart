...
class VMManagedMouseRegion extends _36c2.VMManagedBox<_3960.MouseRegion> {
  VMManagedMouseRegion(
...
class RTManagedMouseRegion extends _3960.MouseRegion
    implements _36c2.Box<_3960.MouseRegion> {
  RTManagedMouseRegion(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _e2dc.State<_3960.MouseRegion> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_3960.MouseRegion>,
            _3960.MouseRegion>(
...
void loadMouseRegion(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['mouseRegion'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedMouseRegion(
          ...
          onHover: unpackedonHover != null
              ...
              : null,
          opaque: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['opaque'] : null)
    ];
  });
  _36c2.registerBoxer<_3960.MouseRegion>(boxer: (
      {required _3960.MouseRegion vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMouseRegion(

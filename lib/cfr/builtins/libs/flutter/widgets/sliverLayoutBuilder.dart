...
import 'package:flutter/src/widgets/sliver_layout_builder.dart' as _f72f;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedSliverLayoutBuilder extends _36c2.VMManagedBox<_f72f.SliverLayoutBuilder> {VMManagedSliverLayoutBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.builder,]; } );
table  [
'createRenderObject'
...
final _f72f.SliverLayoutBuilder vmObject;

 }

class RTManagedSliverLayoutBuilder extends _f72f.SliverLayoutBuilder implements _36c2.Box<_f72f.SliverLayoutBuilder> {RTManagedSliverLayoutBuilder({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _021d.SliverConstraints constraints) builder, required this.table, required this.hydroState}) : super(key: key,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_f72f.SliverLayoutBuilder unwrap() => this;
_f72f.SliverLayoutBuilder get vmObject => this;
...
void loadSliverLayoutBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverLayoutBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSliverLayoutBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), builder: (context, constraints) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,constraints],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_f72f.SliverLayoutBuilder>(boxer: ({required _f72f.SliverLayoutBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverLayoutBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

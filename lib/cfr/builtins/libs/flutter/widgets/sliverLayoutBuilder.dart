...
class VMManagedSliverLayoutBuilder
    extends _36c2.VMManagedBox<_f72f.SliverLayoutBuilder> {
  VMManagedSliverLayoutBuilder(
...
class RTManagedSliverLayoutBuilder extends _f72f.SliverLayoutBuilder
    implements _36c2.Box<_f72f.SliverLayoutBuilder> {
  RTManagedSliverLayoutBuilder(
      {_ab4a.Key? key,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context, _021d.SliverConstraints constraints)
          builder,
      required this.table,
...
void loadSliverLayoutBuilder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliverLayoutBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
          ...
          builder: (context, constraints) =>
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedbuilder.dispatch(
                    [luaCallerArguments[0], context, constraints],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_f72f.SliverLayoutBuilder>(boxer: (
      {required _f72f.SliverLayoutBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliverLayoutBuilder(

...
class VMManagedFocusTraversalPolicy
    extends _36c2.VMManagedBox<_65d3.FocusTraversalPolicy> {
  VMManagedFocusTraversalPolicy(
...
class RTManagedFocusTraversalPolicy extends _65d3.FocusTraversalPolicy
    implements _36c2.Box<_65d3.FocusTraversalPolicy> {
  RTManagedFocusTraversalPolicy({required this.table, required this.hydroState})
      : super() {
...
void loadFocusTraversalPolicy(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['focusTraversalPolicy'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFocusTraversalPolicy(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_65d3.FocusTraversalPolicy>(boxer: (
      {required _65d3.FocusTraversalPolicy vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusTraversalPolicy(

...
class VMManagedScrollStartNotification extends _36c2.VMManagedBox<_593c.ScrollStartNotification> {VMManagedScrollStartNotification({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'dragDetails'
] = _36c2.maybeBoxObject<_4bc7.DragStartDetails?>(object: vmObject.dragDetails, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'metrics'
...
final _593c.ScrollStartNotification vmObject;

 }

class RTManagedScrollStartNotification extends _593c.ScrollStartNotification implements _36c2.Box<_593c.ScrollStartNotification> {RTManagedScrollStartNotification({_4bc7.DragStartDetails? dragDetails, _e2dc.BuildContext? context, required _96ae.ScrollMetrics metrics, required this.table, required this.hydroState}) : super(dragDetails: dragDetails,context: context,metrics: metrics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_593c.ScrollStartNotification unwrap() => this;
_593c.ScrollStartNotification get vmObject => this;
...
void loadScrollStartNotification({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollStartNotification'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedScrollStartNotification(table: luaCallerArguments  [
0
], hydroState: hydroState, dragDetails: _36c2.maybeUnBoxAndBuildArgument<_4bc7.DragStartDetails?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dragDetails'
...
_36c2.registerBoxer<_593c.ScrollStartNotification>(boxer: ({required _593c.ScrollStartNotification vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollStartNotification(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollStartNotification
    extends _36c2.VMManagedBox<_593c.ScrollStartNotification> {
  VMManagedScrollStartNotification(
    ...
    table['dragDetails'] = _36c2.maybeBoxObject<_4bc7.DragStartDetails?>(
...
class RTManagedScrollStartNotification extends _593c.ScrollStartNotification
  ...
  RTManagedScrollStartNotification(
      {_4bc7.DragStartDetails? dragDetails,
      _e2dc.BuildContext? context,
      required _96ae.ScrollMetrics metrics,
      required this.table,
      required this.hydroState})
      : super(dragDetails: dragDetails, context: context, metrics: metrics) {
...
void loadScrollStartNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollStartNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollStartNotification(
  ...
  _36c2.registerBoxer<_593c.ScrollStartNotification>(boxer: (
      {required _593c.ScrollStartNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollStartNotification(

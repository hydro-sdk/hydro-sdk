...
class VMManagedDeleteTextIntent extends _36c2.VMManagedBox<_380d.DeleteTextIntent> {VMManagedDeleteTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.DeleteTextIntent vmObject;

 }

class RTManagedDeleteTextIntent extends _380d.DeleteTextIntent implements _36c2.Box<_380d.DeleteTextIntent> {RTManagedDeleteTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.DeleteTextIntent unwrap() => this;
_380d.DeleteTextIntent get vmObject => this;
...
void loadDeleteTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'deleteTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDeleteTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.DeleteTextIntent>(boxer: ({required _380d.DeleteTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDeleteTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

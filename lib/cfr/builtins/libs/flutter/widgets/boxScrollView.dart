...
class VMManagedBoxScrollView extends _36c2.VMManagedBox<_2b56.BoxScrollView> {VMManagedBoxScrollView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2b56.BoxScrollView vmObject;

 }

class RTManagedBoxScrollView extends _2b56.BoxScrollView implements _36c2.Box<_2b56.BoxScrollView> {RTManagedBoxScrollView({_fac9.double? cacheExtent, required _a643.Clip clipBehavior, _9585.ScrollController? controller, required _02d2.DragStartBehavior dragStartBehavior, _ab4a.Key? key, required _2b56.ScrollViewKeyboardDismissBehavior keyboardDismissBehavior, _96d1.EdgeInsetsGeometry? padding, _dbad.ScrollPhysics? physics, _fac9.bool? primary, _fac9.String? restorationId, required _fac9.bool reverse, required _487f.Axis scrollDirection, _fac9.int? semanticChildCount, required _fac9.bool shrinkWrap, required this.table, required this.hydroState}) : super(cacheExtent: cacheExtent,clipBehavior: clipBehavior,controller: controller,dragStartBehavior: dragStartBehavior,key: key,keyboardDismissBehavior: keyboardDismissBehavior,padding: padding,physics: physics,primary: primary,restorationId: restorationId,reverse: reverse,scrollDirection: scrollDirection,semanticChildCount: semanticChildCount,shrinkWrap: shrinkWrap) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2b56.BoxScrollView unwrap() => this;
_2b56.BoxScrollView get vmObject => this;
...
void loadBoxScrollView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'boxScrollView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedBoxScrollView(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2b56.BoxScrollView>(boxer: ({required _2b56.BoxScrollView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBoxScrollView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

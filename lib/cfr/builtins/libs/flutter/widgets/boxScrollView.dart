...
class VMManagedBoxScrollView extends _36c2.VMManagedBox<_2b56.BoxScrollView> {
  VMManagedBoxScrollView(
...
class RTManagedBoxScrollView extends _2b56.BoxScrollView
    implements _36c2.Box<_2b56.BoxScrollView> {
  RTManagedBoxScrollView(
    ...
    table['_dart_buildChildLayout'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: buildChildLayout(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
...
void loadBoxScrollView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['boxScrollView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBoxScrollView(
  ...
  _36c2.registerBoxer<_2b56.BoxScrollView>(boxer: (
      {required _2b56.BoxScrollView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBoxScrollView(

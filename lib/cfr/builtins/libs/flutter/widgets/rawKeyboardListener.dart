...
import 'package:flutter/src/widgets/raw_keyboard_listener.dart' as _b7c4;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedRawKeyboardListener extends _36c2.VMManagedBox<_b7c4.RawKeyboardListener> {VMManagedRawKeyboardListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _b7c4.RawKeyboardListener vmObject;

 }

class RTManagedRawKeyboardListener extends _b7c4.RawKeyboardListener implements _36c2.Box<_b7c4.RawKeyboardListener> {RTManagedRawKeyboardListener({required _fac9.bool autofocus, required _fac9.bool includeSemantics, _ab4a.Key? key, void Function(_94e8.RawKeyEvent value)? onKey, required _e2dc.Widget child, required _b485.FocusNode focusNode, required this.table, required this.hydroState}) : super(autofocus: autofocus,includeSemantics: includeSemantics,key: key,onKey: onKey,child: child,focusNode: focusNode) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_b7c4.RawKeyboardListener unwrap() => this;
_b7c4.RawKeyboardListener get vmObject => this;
@_fac9.override _e2dc.State<_b7c4.RawKeyboardListener> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_b7c4.RawKeyboardListener>, _b7c4.RawKeyboardListener>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRawKeyboardListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyboardListener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRawKeyboardListener(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onKey: unpackedonKey != null ? (value) => unpackedonKey.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null , child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
...
_36c2.registerBoxer<_b7c4.RawKeyboardListener>(boxer: ({required _b7c4.RawKeyboardListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyboardListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

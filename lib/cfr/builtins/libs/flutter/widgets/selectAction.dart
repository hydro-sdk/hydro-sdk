...
class VMManagedSelectAction extends _36c2.VMManagedBox<_c0f4.SelectAction> {
  VMManagedSelectAction(
...
class RTManagedSelectAction extends _c0f4.SelectAction
    implements _36c2.Box<_c0f4.SelectAction> {
  RTManagedSelectAction({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_invoke'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: invoke(_36c2.maybeUnBoxAndBuildArgument<_c0f4.SelectIntent,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
      ];
  ...
  @_fac9.override
  _c0f4.Action<_c0f4.SelectIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.SelectIntent>?,
            _c0f4.SelectIntent>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadSelectAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['selectAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSelectAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_c0f4.SelectAction>(boxer: (
      {required _c0f4.SelectAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSelectAction(

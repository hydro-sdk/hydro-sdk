...
class VMManagedWrap extends _36c2.VMManagedBox<_3960.Wrap> {VMManagedWrap({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'alignment'
] = _d0b5.WrapAlignment.values.indexWhere((x) { return x == vmObject.alignment; } );
table  [
'spacing'
] = vmObject.spacing;
table  [
'runAlignment'
] = _d0b5.WrapAlignment.values.indexWhere((x) { return x == vmObject.runAlignment; } );
table  [
'runSpacing'
] = vmObject.runSpacing;
table  [
'crossAxisAlignment'
] = _d0b5.WrapCrossAlignment.values.indexWhere((x) { return x == vmObject.crossAxisAlignment; } );
table  [
'textDirection'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_d0b5.RenderWrap>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_d0b5.RenderWrap, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Wrap vmObject;

 }

class RTManagedWrap extends _3960.Wrap implements _36c2.Box<_3960.Wrap> {RTManagedWrap({required _d0b5.WrapAlignment alignment, required _fac9.List<_e2dc.Widget> children, required _a643.Clip clipBehavior, required _d0b5.WrapCrossAlignment crossAxisAlignment, required _487f.Axis direction, _ab4a.Key? key, required _d0b5.WrapAlignment runAlignment, required _fac9.double runSpacing, required _fac9.double spacing, _a643.TextDirection? textDirection, required _487f.VerticalDirection verticalDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,clipBehavior: clipBehavior,crossAxisAlignment: crossAxisAlignment,direction: direction,key: key,runAlignment: runAlignment,runSpacing: runSpacing,spacing: spacing,textDirection: textDirection,verticalDirection: verticalDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'alignment'
] = _d0b5.WrapAlignment.values.indexWhere((x) { return x == this.alignment; } );
table  [
'spacing'
] = _36c2.maybeBoxObject(object: this.spacing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'runAlignment'
] = _d0b5.WrapAlignment.values.indexWhere((x) { return x == this.runAlignment; } );
table  [
'runSpacing'
] = _36c2.maybeBoxObject(object: this.runSpacing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'crossAxisAlignment'
] = _d0b5.WrapCrossAlignment.values.indexWhere((x) { return x == this.crossAxisAlignment; } );
table  [
'textDirection'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_d0b5.RenderWrap, _fac9.dynamic>(
...
_3960.Wrap unwrap() => this;
_3960.Wrap get vmObject => this;
@_fac9.override _d0b5.RenderWrap createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_d0b5.RenderWrap, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadWrap({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'wrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedWrap(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), runAlignment: _36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'runAlignment'
...
_36c2.registerBoxer<_3960.Wrap>(boxer: ({required _3960.Wrap vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWrap(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

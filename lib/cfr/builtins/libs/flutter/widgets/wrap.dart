...
class VMManagedWrap extends _36c2.VMManagedBox<_3960.Wrap> {
  VMManagedWrap(
    ...
    table['alignment'] = _d0b5.WrapAlignment.values.indexWhere((x) {
      return x == vmObject.alignment;
    });
    table['spacing'] = vmObject.spacing;
    table['runAlignment'] = _d0b5.WrapAlignment.values.indexWhere((x) {
      return x == vmObject.runAlignment;
    });
    table['runSpacing'] = vmObject.runSpacing;
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_d0b5.RenderWrap>(
...
class RTManagedWrap extends _3960.Wrap implements _36c2.Box<_3960.Wrap> {
  RTManagedWrap(
    ...
    table['spacing'] = _36c2.maybeBoxObject(
        object: this.spacing,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['runAlignment'] = _d0b5.WrapAlignment.values.indexWhere((x) {
      return x == this.runAlignment;
    });
    table['runSpacing'] = _36c2.maybeBoxObject(
        object: this.runSpacing,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['crossAxisAlignment'] =
        _d0b5.WrapCrossAlignment.values.indexWhere((x) {
  ...
  @_fac9.override
  _d0b5.RenderWrap createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_d0b5.RenderWrap, _fac9.dynamic>(
...
void loadWrap(
      ...
      RTManagedWrap(
          ...
          alignment: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          children: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_3960.Wrap>(boxer: (
      {required _3960.Wrap vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedWrap(

...
class VMManagedFadeTransition extends _36c2.VMManagedBox<_d7ad.FadeTransition> {
  VMManagedFadeTransition(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderAnimatedOpacity>(
...
class RTManagedFadeTransition extends _d7ad.FadeTransition
    implements _36c2.Box<_d7ad.FadeTransition> {
  RTManagedFadeTransition(
  ...
  @_fac9.override
  _bf98.RenderAnimatedOpacity createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderAnimatedOpacity, _fac9.dynamic>(
...
void loadFadeTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['fadeTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFadeTransition(
  ...
  _36c2.registerBoxer<_d7ad.FadeTransition>(boxer: (
      {required _d7ad.FadeTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFadeTransition(

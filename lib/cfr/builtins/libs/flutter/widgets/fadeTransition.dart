...
class VMManagedFadeTransition extends _36c2.VMManagedBox<_d7ad.FadeTransition> {VMManagedFadeTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderAnimatedOpacity>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAnimatedOpacity, _fac9.dynamic>(luaCallerArguments  [
2
...
final _d7ad.FadeTransition vmObject;

 }

class RTManagedFadeTransition extends _d7ad.FadeTransition implements _36c2.Box<_d7ad.FadeTransition> {RTManagedFadeTransition({required _fac9.bool alwaysIncludeSemantics, _e2dc.Widget? child, _ab4a.Key? key, required _86ca.Animation<_fac9.double> opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,child: child,key: key,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAnimatedOpacity,
...
_d7ad.FadeTransition unwrap() => this;
_d7ad.FadeTransition get vmObject => this;
@_fac9.override _bf98.RenderAnimatedOpacity createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderAnimatedOpacity, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFadeTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fadeTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFadeTransition(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d7ad.FadeTransition>(boxer: ({required _d7ad.FadeTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFadeTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedConstraintsTransformBox
    extends _36c2.VMManagedBox<_3960.ConstraintsTransformBox> {
  VMManagedConstraintsTransformBox(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_a9e4.RenderConstraintsTransformBox>(
...
class RTManagedConstraintsTransformBox extends _3960.ConstraintsTransformBox
    implements _36c2.Box<_3960.ConstraintsTransformBox> {
  RTManagedConstraintsTransformBox(
      {required _ca85.AlignmentGeometry alignment,
      _e2dc.Widget? child,
      required _a643.Clip clipBehavior,
      required _fac9.String debugTransformType,
      _ab4a.Key? key,
  ...
  @_fac9.override
  _a9e4.RenderConstraintsTransformBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<_a9e4.RenderConstraintsTransformBox,
            _fac9.dynamic>(
...
void loadConstraintsTransformBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['constraintsTransformBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      ...
      RTManagedConstraintsTransformBox(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          debugTransformType: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['debugTransformType']
              : null,
          ...
          constraintsTransform: (_) => _36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
  ...
  table['constraintsTransformBoxUnmodified'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.unmodified(_36c2
  ...
  table['constraintsTransformBoxUnconstrained'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.unconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['constraintsTransformBoxWidthUnconstrained'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.widthUnconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['constraintsTransformBoxHeightUnconstrained'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.heightUnconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['constraintsTransformBoxMaxHeightUnconstrained'] = _36c2
      .makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.maxHeightUnconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['constraintsTransformBoxMaxWidthUnconstrained'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.maxWidthUnconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['constraintsTransformBoxMaxUnconstrained'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_be2e.BoxConstraints>(
          object: _3960.ConstraintsTransformBox.maxUnconstrained(_36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  _36c2.registerBoxer<_3960.ConstraintsTransformBox>(boxer: (
      {required _3960.ConstraintsTransformBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedConstraintsTransformBox(

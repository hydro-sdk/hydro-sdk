...
import 'package:flutter/src/widgets/primary_scroll_controller.dart' as _4ff3;
import 'package:flutter/src/widgets/scroll_controller.dart' as _9585;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedPrimaryScrollController extends _36c2.VMManagedBox<_4ff3.PrimaryScrollController> {VMManagedPrimaryScrollController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_4ff3.PrimaryScrollController, _fac9.dynamic>(luaCallerArguments  [
1
...
final _4ff3.PrimaryScrollController vmObject;

 }

class RTManagedPrimaryScrollController extends _4ff3.PrimaryScrollController implements _36c2.Box<_4ff3.PrimaryScrollController> {RTManagedPrimaryScrollController({_ab4a.Key? key, required _e2dc.Widget child, required _9585.ScrollController controller, required this.table, required this.hydroState}) : super(key: key,child: child,controller: controller) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_4ff3.PrimaryScrollController unwrap() => this;
_4ff3.PrimaryScrollController get vmObject => this;
...
void loadPrimaryScrollController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'primaryScrollController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPrimaryScrollController(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), controller: _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
] : null, parentState: hydroState))]; } );
table  [
'primaryScrollControllerOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _4ff3.PrimaryScrollController.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_9585.ScrollController?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_4ff3.PrimaryScrollController>(boxer: ({required _4ff3.PrimaryScrollController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPrimaryScrollController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

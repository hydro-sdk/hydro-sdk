...
class VMManagedPrimaryScrollController
    extends _36c2.VMManagedBox<_4ff3.PrimaryScrollController> {
  VMManagedPrimaryScrollController(
...
class RTManagedPrimaryScrollController extends _4ff3.PrimaryScrollController
    implements _36c2.Box<_4ff3.PrimaryScrollController> {
  RTManagedPrimaryScrollController(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _9585.ScrollController controller,
      required this.table,
...
void loadPrimaryScrollController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['primaryScrollController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPrimaryScrollController(
  ...
  table['primaryScrollControllerOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _4ff3.PrimaryScrollController.of(
  ...
  _36c2.registerBoxer<_4ff3.PrimaryScrollController>(boxer: (
      {required _4ff3.PrimaryScrollController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPrimaryScrollController(

...
class VMManagedOffstage extends _36c2.VMManagedBox<_3960.Offstage> {VMManagedOffstage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderOffstage>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOffstage, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Offstage vmObject;

 }

class RTManagedOffstage extends _3960.Offstage implements _36c2.Box<_3960.Offstage> {RTManagedOffstage({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.bool offstage, required this.table, required this.hydroState}) : super(child: child,key: key,offstage: offstage) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOffstage, _fac9.dynamic>(
...
_3960.Offstage unwrap() => this;
_3960.Offstage get vmObject => this;
@_fac9.override _bf98.RenderOffstage createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderOffstage, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadOffstage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'offstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedOffstage(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.Offstage>(boxer: ({required _3960.Offstage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOffstage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

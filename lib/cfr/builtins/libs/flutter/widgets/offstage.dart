...
class VMManagedOffstage extends _36c2.VMManagedBox<_3960.Offstage> {
  VMManagedOffstage(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderOffstage>(
...
class RTManagedOffstage extends _3960.Offstage
    implements _36c2.Box<_3960.Offstage> {
  RTManagedOffstage(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(child: child, key: key, offstage: offstage) {
  ...
  @_fac9.override
  _bf98.RenderOffstage createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderOffstage, _fac9.dynamic>(
...
void loadOffstage(
  ...
  table['offstage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOffstage(
  ...
  _36c2.registerBoxer<_3960.Offstage>(boxer: (
      {required _3960.Offstage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOffstage(

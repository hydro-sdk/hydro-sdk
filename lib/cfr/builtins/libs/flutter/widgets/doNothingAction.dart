...
class VMManagedDoNothingAction extends _36c2.VMManagedBox<_c0f4.DoNothingAction> {VMManagedDoNothingAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'consumesKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.consumesKey(_36c2.maybeUnBoxAndBuildArgument<_c0f4.Intent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'invoke'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.invoke(_36c2.maybeUnBoxAndBuildArgument<_c0f4.Intent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'isEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<_c0f4.Intent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'addActionListener'
...
final _c0f4.DoNothingAction vmObject;

 }

class RTManagedDoNothingAction extends _c0f4.DoNothingAction implements _36c2.Box<_c0f4.DoNothingAction> {RTManagedDoNothingAction({required _fac9.bool consumesKey, required this.table, required this.hydroState}) : super(consumesKey: consumesKey) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_invoke'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.invoke(_36c2.maybeUnBoxAndBuildArgument<_c0f4.Intent, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_c0f4.DoNothingAction unwrap() => this;
_c0f4.DoNothingAction get vmObject => this;
...
void loadDoNothingAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'doNothingAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDoNothingAction(table: luaCallerArguments  [
0
], hydroState: hydroState, consumesKey: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'consumesKey'
] : null)]; } );
_36c2.registerBoxer<_c0f4.DoNothingAction>(boxer: ({required _c0f4.DoNothingAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDoNothingAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

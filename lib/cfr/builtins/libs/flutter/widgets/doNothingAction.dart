...
class VMManagedDoNothingAction
    extends _36c2.VMManagedBox<_c0f4.DoNothingAction> {
  VMManagedDoNothingAction(
...
class RTManagedDoNothingAction extends _c0f4.DoNothingAction
    implements _36c2.Box<_c0f4.DoNothingAction> {
  RTManagedDoNothingAction(
      {required _fac9.bool consumesKey,
      required this.table,
...
void loadDoNothingAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['doNothingAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDoNothingAction(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          consumesKey: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['consumesKey']
              : null)
    ];
  });
  _36c2.registerBoxer<_c0f4.DoNothingAction>(boxer: (
      {required _c0f4.DoNothingAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDoNothingAction(

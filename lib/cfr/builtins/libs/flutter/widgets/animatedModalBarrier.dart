...
class VMManagedAnimatedModalBarrier extends _36c2.VMManagedBox<_7492.AnimatedModalBarrier> {VMManagedAnimatedModalBarrier({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'dismissible'
] = vmObject.dismissible;
table  [
'semanticsLabel'
] = vmObject.semanticsLabel;
table  [
'barrierSemanticsDismissible'
] = vmObject.barrierSemanticsDismissible;
table  [
'listenable'
...
table  [
'getColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.color, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
class RTManagedAnimatedModalBarrier extends _7492.AnimatedModalBarrier implements _36c2.Box<_7492.AnimatedModalBarrier> {RTManagedAnimatedModalBarrier({_fac9.bool? barrierSemanticsDismissible, required _fac9.bool dismissible, _ab4a.Key? key, _fac9.String? semanticsLabel, required _86ca.Animation<_a643.Color?> color, required this.table, required this.hydroState}) : super(barrierSemanticsDismissible: barrierSemanticsDismissible,dismissible: dismissible,key: key,semanticsLabel: semanticsLabel,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'dismissible'
] = _36c2.maybeBoxObject(object: this.dismissible, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'semanticsLabel'
] = _36c2.maybeBoxObject(object: this.semanticsLabel, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'barrierSemanticsDismissible'
] = _36c2.maybeBoxObject(object: this.barrierSemanticsDismissible, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'listenable'
...
@_fac9.override _86ca.Animation<_a643.Color?> get color { 
...
void loadAnimatedModalBarrier({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedAnimatedModalBarrier(table: luaCallerArguments  [
0
], hydroState: hydroState, barrierSemanticsDismissible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'barrierSemanticsDismissible'
] : null, dismissible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dismissible'
...
'semanticsLabel'
] : null, color: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Color?>, _a643.Color?>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'color'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7492.AnimatedModalBarrier>(boxer: ({required _7492.AnimatedModalBarrier vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedModalBarrier(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

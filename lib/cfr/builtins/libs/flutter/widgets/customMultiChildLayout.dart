...
class VMManagedCustomMultiChildLayout extends _36c2.VMManagedBox<_3960.CustomMultiChildLayout> {VMManagedCustomMultiChildLayout({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'delegate'
] = _36c2.maybeBoxObject<_2325.MultiChildLayoutDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'children'
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_2325.RenderCustomMultiChildLayoutBox>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_2325.RenderCustomMultiChildLayoutBox, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.CustomMultiChildLayout vmObject;

 }

class RTManagedCustomMultiChildLayout extends _3960.CustomMultiChildLayout implements _36c2.Box<_3960.CustomMultiChildLayout> {RTManagedCustomMultiChildLayout({required _fac9.List<_e2dc.Widget> children, _ab4a.Key? key, required _2325.MultiChildLayoutDelegate delegate, required this.table, required this.hydroState}) : super(children: children,key: key,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_2325.RenderCustomMultiChildLayoutBox,
...
_3960.CustomMultiChildLayout unwrap() => this;
_3960.CustomMultiChildLayout get vmObject => this;
@_fac9.override _2325.RenderCustomMultiChildLayoutBox createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_2325.RenderCustomMultiChildLayoutBox, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCustomMultiChildLayout({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'customMultiChildLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCustomMultiChildLayout(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.CustomMultiChildLayout>(boxer: ({required _3960.CustomMultiChildLayout vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCustomMultiChildLayout(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCustomMultiChildLayout
    extends _36c2.VMManagedBox<_3960.CustomMultiChildLayout> {
  VMManagedCustomMultiChildLayout(
    ...
    table['delegate'] = _36c2.maybeBoxObject<_2325.MultiChildLayoutDelegate>(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_2325.RenderCustomMultiChildLayoutBox>(
    ...
    table['updateRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.updateRenderObject(
          ...
          _36c2.maybeUnBoxAndBuildArgument<
              _2325.RenderCustomMultiChildLayoutBox,
...
class RTManagedCustomMultiChildLayout extends _3960.CustomMultiChildLayout
    implements _36c2.Box<_3960.CustomMultiChildLayout> {
  RTManagedCustomMultiChildLayout(
      {required _fac9.List<_e2dc.Widget> children,
      _ab4a.Key? key,
      required _2325.MultiChildLayoutDelegate delegate,
      required this.table,
      required this.hydroState})
      : super(children: children, key: key, delegate: delegate) {
  ...
  @_fac9.override
  _2325.RenderCustomMultiChildLayoutBox createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _2325.RenderCustomMultiChildLayoutBox, _fac9.dynamic>(
...
void loadCustomMultiChildLayout(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['customMultiChildLayout'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCustomMultiChildLayout(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          delegate: _36c2
              .maybeUnBoxAndBuildArgument<_2325.MultiChildLayoutDelegate, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['delegate'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3960.CustomMultiChildLayout>(boxer: (
      {required _3960.CustomMultiChildLayout vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCustomMultiChildLayout(

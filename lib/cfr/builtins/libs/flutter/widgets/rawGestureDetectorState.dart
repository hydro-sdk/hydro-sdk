...
class VMManagedRawGestureDetectorState extends _36c2.VMManagedBox<_eed0.RawGestureDetectorState> {VMManagedRawGestureDetectorState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'didUpdateWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<_eed0.RawGestureDetector, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'replaceGestureRecognizers'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.replaceGestureRecognizers(_36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.Type,_eed0.GestureRecognizerFactory<_02d2.GestureRecognizer>>, _fac9.Type>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'replaceSemanticsActions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.replaceSemanticsActions(_36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.SemanticsAction>, _a643.SemanticsAction>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_eed0.RawGestureDetector>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedRawGestureDetectorState extends _eed0.RawGestureDetectorState implements _36c2.Box<_eed0.RawGestureDetectorState> {RTManagedRawGestureDetectorState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_didUpdateWidget'] =
  ...
  super.didUpdateWidget(
      _36c2.maybeUnBoxAndBuildArgument<_eed0.RawGestureDetector, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_replaceGestureRecognizers'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_replaceSemanticsActions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void replaceGestureRecognizers(gestures) { 
_36c2.Closure closure = table["replaceGestureRecognizers"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void replaceSemanticsActions(actions) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _eed0.RawGestureDetector get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_eed0.RawGestureDetector, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRawGestureDetectorState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawGestureDetectorState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRawGestureDetectorState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_eed0.RawGestureDetectorState>(boxer: ({required _eed0.RawGestureDetectorState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawGestureDetectorState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

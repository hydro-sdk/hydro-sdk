...
class VMManagedOverscrollIndicatorNotification
    extends _36c2.VMManagedBox<_a0c8.OverscrollIndicatorNotification> {
  VMManagedOverscrollIndicatorNotification(
    ...
    table['paintOffset'] = vmObject.paintOffset;
    table['disallowGlow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.disallowGlow();
      return [];
    });
    table['disallowIndicator'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.disallowIndicator();
      return [];
    });
...
class RTManagedOverscrollIndicatorNotification
    extends _a0c8.OverscrollIndicatorNotification
    implements _36c2.Box<_a0c8.OverscrollIndicatorNotification> {
  RTManagedOverscrollIndicatorNotification(
      {required _fac9.bool leading,
      required this.table,
    ...
    table['_dart_disallowGlow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.disallowGlow();
      return [];
    });
    table['_dart_disallowIndicator'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadOverscrollIndicatorNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['overscrollIndicatorNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOverscrollIndicatorNotification(
  ...
  _36c2.registerBoxer<_a0c8.OverscrollIndicatorNotification>(boxer: (
      {required _a0c8.OverscrollIndicatorNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOverscrollIndicatorNotification(

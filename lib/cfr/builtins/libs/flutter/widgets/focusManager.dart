...
class VMManagedFocusManager extends _36c2.VMManagedBox<_b485.FocusManager> {
  VMManagedFocusManager(
    ...
    table['rootScope'] = _36c2.maybeBoxObject<_b485.FocusScopeNode>(
        object: vmObject.rootScope,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['registerGlobalHandlers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.registerGlobalHandlers();
      return [];
    });
    ...
    table['getHighlightStrategy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _b485.FocusHighlightStrategy.values.indexWhere((x) {
          return x == vmObject.highlightStrategy;
        }),
      ];
    });
    table['setHighlightStrategy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.highlightStrategy = (_36c2.maybeUnBoxEnum(
    ...
    table['addHighlightModeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
      vmObject.addHighlightModeListener((value) => unpackedlistener.dispatch(
            [luaCallerArguments[0], value],
            parentState: hydroState,
          ));
      return [];
    });
    table['removeHighlightModeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
      vmObject.removeHighlightModeListener((value) => unpackedlistener.dispatch(
            [luaCallerArguments[0], value],
            parentState: hydroState,
          ));
      return [];
    });
    table['getPrimaryFocus'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.primaryFocus;
      if (returnValue != null) {
        return [
...
class RTManagedFocusManager extends _b485.FocusManager
    implements _36c2.Box<_b485.FocusManager> {
  RTManagedFocusManager({required this.table, required this.hydroState})
      : super() {
    ...
    table['rootScope'] = _36c2.maybeBoxObject(
        object: rootScope, hydroState: hydroState, table: _36c2.HydroTable());
    table['_dart_registerGlobalHandlers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getHighlightStrategy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.highlightStrategy];
    });
    table['_dart_setHighlightStrategy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_addHighlightModeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
    ...
    table['_dart_removeHighlightModeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
    ...
    table['_dart_getPrimaryFocus'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _b485.FocusHighlightStrategy get highlightStrategy {
  ...
  @_fac9.override
  void set highlightStrategy(highlightStrategy) {
  ...
  @_fac9.override
  void addHighlightModeListener(listener) {
    _36c2.Closure closure = table["addHighlightModeListener"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void removeHighlightModeListener(listener) {
    _36c2.Closure closure = table["removeHighlightModeListener"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _b485.FocusNode? get primaryFocus {
...
void loadFocusManager(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['focusManager'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFocusManager(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  table['focusManagerInstance'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_b485.FocusManager>(
          object: _b485.FocusManager.instance,
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  _36c2.registerBoxer<_b485.FocusManager>(boxer: (
      {required _b485.FocusManager vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFocusManager(

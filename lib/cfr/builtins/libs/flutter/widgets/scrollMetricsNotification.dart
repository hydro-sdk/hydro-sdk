...
class VMManagedScrollMetricsNotification extends _36c2.VMManagedBox<_6c49.ScrollMetricsNotification> {VMManagedScrollMetricsNotification({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _6c49.ScrollMetricsNotification vmObject;

 }

class RTManagedScrollMetricsNotification extends _6c49.ScrollMetricsNotification implements _36c2.Box<_6c49.ScrollMetricsNotification> {RTManagedScrollMetricsNotification({required _e2dc.BuildContext context, required _96ae.ScrollMetrics metrics, required this.table, required this.hydroState}) : super(context: context,metrics: metrics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_6c49.ScrollMetricsNotification unwrap() => this;
_6c49.ScrollMetricsNotification get vmObject => this;
...
void loadScrollMetricsNotification({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollMetricsNotification'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedScrollMetricsNotification(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_6c49.ScrollMetricsNotification>(boxer: ({required _6c49.ScrollMetricsNotification vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollMetricsNotification(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollMetricsNotification
    extends _36c2.VMManagedBox<_6c49.ScrollMetricsNotification> {
  VMManagedScrollMetricsNotification(
...
class RTManagedScrollMetricsNotification extends _6c49.ScrollMetricsNotification
    implements _36c2.Box<_6c49.ScrollMetricsNotification> {
  RTManagedScrollMetricsNotification(
...
void loadScrollMetricsNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollMetricsNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollMetricsNotification(
  ...
  _36c2.registerBoxer<_6c49.ScrollMetricsNotification>(boxer: (
      {required _6c49.ScrollMetricsNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollMetricsNotification(

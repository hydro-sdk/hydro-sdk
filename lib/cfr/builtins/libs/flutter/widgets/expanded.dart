...
class VMManagedExpanded extends _36c2.VMManagedBox<_3960.Expanded> {VMManagedExpanded({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3960.Expanded vmObject;

 }

class RTManagedExpanded extends _3960.Expanded implements _36c2.Box<_3960.Expanded> {RTManagedExpanded({required _fac9.int flex, _ab4a.Key? key, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(flex: flex,key: key,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3960.Expanded unwrap() => this;
_3960.Expanded get vmObject => this;
...
void loadExpanded({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'expanded'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedExpanded(table: luaCallerArguments  [
0
], hydroState: hydroState, flex: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'flex'
...
_36c2.registerBoxer<_3960.Expanded>(boxer: ({required _3960.Expanded vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedExpanded(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

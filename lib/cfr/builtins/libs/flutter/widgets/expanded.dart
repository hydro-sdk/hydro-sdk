...
class VMManagedExpanded extends _36c2.VMManagedBox<_3960.Expanded> {
  VMManagedExpanded(
...
class RTManagedExpanded extends _3960.Expanded
    implements _36c2.Box<_3960.Expanded> {
  RTManagedExpanded(
      ...
      : super(flex: flex, key: key, child: child) {
...
void loadExpanded(
  ...
  table['expanded'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedExpanded(
  ...
  _36c2.registerBoxer<_3960.Expanded>(boxer: (
      {required _3960.Expanded vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedExpanded(

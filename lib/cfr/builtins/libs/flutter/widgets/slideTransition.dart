...
class VMManagedSlideTransition
    extends _36c2.VMManagedBox<_d7ad.SlideTransition> {
  VMManagedSlideTransition(
...
class RTManagedSlideTransition extends _d7ad.SlideTransition
  ...
  RTManagedSlideTransition(
      ...
      required _86ca.Animation<_a643.Offset> position,
      required this.table,
  ...
  @_fac9.override
  _86ca.Animation<_a643.Offset> get position {
...
void loadSlideTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['slideTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSlideTransition(
          ...
          transformHitTests: luaCallerArguments.length >= 2
              ...
              : null,
          position: _36c2
              .maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Offset>, _a643.Offset>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['position'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d7ad.SlideTransition>(boxer: (
      {required _d7ad.SlideTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSlideTransition(

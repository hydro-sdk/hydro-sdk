...
class VMManagedSlideTransition extends _36c2.VMManagedBox<_d7ad.SlideTransition> {VMManagedSlideTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.position, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'build'
...
final _d7ad.SlideTransition vmObject;

 }

class RTManagedSlideTransition extends _d7ad.SlideTransition implements _36c2.Box<_d7ad.SlideTransition> {RTManagedSlideTransition({_e2dc.Widget? child, _ab4a.Key? key, _a643.TextDirection? textDirection, required _fac9.bool transformHitTests, required _86ca.Animation<_a643.Offset> position, required this.table, required this.hydroState}) : super(child: child,key: key,textDirection: textDirection,transformHitTests: transformHitTests,position: position) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.SlideTransition unwrap() => this;
_d7ad.SlideTransition get vmObject => this;
@_fac9.override _86ca.Animation<_a643.Offset> get position { 
_36c2.Closure closure = table["getPosition"];
return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Offset>, _a643.Offset>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSlideTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'slideTransition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSlideTransition(table: luaCallerArguments  [
0
...
'transformHitTests'
] : null, position: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_a643.Offset>, _a643.Offset>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'position'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.SlideTransition>(boxer: ({required _d7ad.SlideTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSlideTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

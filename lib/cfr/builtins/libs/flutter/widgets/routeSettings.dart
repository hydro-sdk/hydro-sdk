...
class VMManagedRouteSettings extends _36c2.VMManagedBox<_a37d.RouteSettings> {
  VMManagedRouteSettings(
...
class RTManagedRouteSettings extends _a37d.RouteSettings
    implements _36c2.Box<_a37d.RouteSettings> {
  RTManagedRouteSettings(
...
void loadRouteSettings(
  ...
  table['routeSettings'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRouteSettings(
  ...
  _36c2.registerBoxer<_a37d.RouteSettings>(boxer: (
      {required _a37d.RouteSettings vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRouteSettings(

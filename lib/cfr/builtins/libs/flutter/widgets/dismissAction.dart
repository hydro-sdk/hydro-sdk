...
class VMManagedDismissAction extends _36c2.VMManagedBox<_c0f4.DismissAction> {
  VMManagedDismissAction(
    ...
    table['isEnabled'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.isEnabled(_36c2.maybeUnBoxAndBuildArgument<_c0f4.DismissIntent,
...
class RTManagedDismissAction extends _c0f4.DismissAction
    implements _36c2.Box<_c0f4.DismissAction> {
  RTManagedDismissAction({required this.table, required this.hydroState})
      : super() {
  ...
  @_fac9.override
  _c0f4.Action<_c0f4.DismissIntent>? get callingAction {
    _36c2.Closure closure = table["getCallingAction"];
    return _36c2.maybeUnBoxAndBuildArgument<_c0f4.Action<_c0f4.DismissIntent>?,
            _c0f4.DismissIntent>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadDismissAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dismissAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDismissAction(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_c0f4.DismissAction>(boxer: (
      {required _c0f4.DismissAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDismissAction(

...
class VMManagedInheritedModelElement extends _36c2.VMManagedBox<_57c1.InheritedModelElement<_fac9.dynamic>> {VMManagedInheritedModelElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_57c1.InheritedModel>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'updateDependencies'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
vmObject.updateDependencies(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(luaCallerArguments  [
1
...
vmObject.notifyDependent(_36c2.maybeUnBoxAndBuildArgument<_57c1.InheritedModel<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
...
table  [
'updated'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.updated(_36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'notifyClients'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.notifyClients(_36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'build'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.build(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_e2dc.ProxyWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.renderObject;if(returnValue!= null){return [_36c2.maybeBoxObject<_9742.RenderObject?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getSize'
...
class RTManagedInheritedModelElement extends _57c1.InheritedModelElement implements _36c2.Box<_57c1.InheritedModelElement> {RTManagedInheritedModelElement(_57c1.InheritedModel<_fac9.dynamic> widget$, {required this.table, required this.hydroState}) : super(widget$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateDependencies'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_updated'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.updated(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_notifyClients'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.notifyClients(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(
          luaCallerArguments[1],
...
@_fac9.override _57c1.InheritedModel<_fac9.dynamic> get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_57c1.InheritedModel<_fac9.dynamic>, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void updateDependencies(dependent, aspect) { 
_36c2.Closure closure = table["updateDependencies"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void notifyDependent(oldWidget, dependent) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Object? getDependencies(dependent) { 
...
@_fac9.override void setDependencies(dependent, value) { 
_36c2.Closure closure = table["setDependencies"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updated(oldWidget) { 
_36c2.Closure closure = table["updated"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void notifyClients(oldWidget) { 
_36c2.Closure closure = table["notifyClients"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Widget build() { 
...
@_fac9.override _9742.RenderObject? get renderObject { 
...
void loadInheritedModelElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inheritedModelElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedInheritedModelElement(_36c2.maybeUnBoxAndBuildArgument<_57c1.InheritedModel<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_57c1.InheritedModelElement>(boxer: ({required _57c1.InheritedModelElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInheritedModelElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

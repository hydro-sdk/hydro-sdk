...
class VMManagedDismissIntent extends _36c2.VMManagedBox<_c0f4.DismissIntent> {VMManagedDismissIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c0f4.DismissIntent vmObject;

 }

class RTManagedDismissIntent extends _c0f4.DismissIntent implements _36c2.Box<_c0f4.DismissIntent> {RTManagedDismissIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c0f4.DismissIntent unwrap() => this;
_c0f4.DismissIntent get vmObject => this;
...
void loadDismissIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'dismissIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDismissIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c0f4.DismissIntent>(boxer: ({required _c0f4.DismissIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDismissIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

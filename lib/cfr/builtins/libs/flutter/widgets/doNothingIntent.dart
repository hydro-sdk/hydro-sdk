...
class VMManagedDoNothingIntent extends _36c2.VMManagedBox<_c0f4.DoNothingIntent> {VMManagedDoNothingIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadDoNothingIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'doNothingIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [_36c2.maybeBoxObject<_c0f4.DoNothingIntent>(object: _c0f4.DoNothingIntent(), hydroState: hydroState, table: luaCallerArguments  [
0
])]; } );
_36c2.registerBoxer<_c0f4.DoNothingIntent>(boxer: ({required _c0f4.DoNothingIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDoNothingIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

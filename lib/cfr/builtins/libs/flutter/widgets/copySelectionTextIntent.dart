...
class VMManagedCopySelectionTextIntent extends _36c2.VMManagedBox<_380d.CopySelectionTextIntent> {VMManagedCopySelectionTextIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _380d.CopySelectionTextIntent vmObject;

 }

class RTManagedCopySelectionTextIntent extends _380d.CopySelectionTextIntent implements _36c2.Box<_380d.CopySelectionTextIntent> {RTManagedCopySelectionTextIntent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_380d.CopySelectionTextIntent unwrap() => this;
_380d.CopySelectionTextIntent get vmObject => this;
...
void loadCopySelectionTextIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'copySelectionTextIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedCopySelectionTextIntent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_380d.CopySelectionTextIntent>(boxer: ({required _380d.CopySelectionTextIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCopySelectionTextIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

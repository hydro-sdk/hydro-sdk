...
class VMManagedLocalizations extends _36c2.VMManagedBox<_a483.Localizations> {VMManagedLocalizations({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'delegates'
] = _36c2.maybeBoxObject<_fac9.List<_a483.LocalizationsDelegate<_fac9.dynamic>>>(object: vmObject.delegates, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
class RTManagedLocalizations extends _a483.Localizations implements _36c2.Box<_a483.Localizations> {RTManagedLocalizations({_e2dc.Widget? child, _ab4a.Key? key, required _fac9.List<_a483.LocalizationsDelegate<_fac9.dynamic>> delegates, required _a643.Locale locale, required this.table, required this.hydroState}) : super(child: child,key: key,delegates: delegates,locale: locale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'delegates'
] = _36c2.maybeBoxObject(object: this.delegates, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
@_fac9.override _e2dc.State<_a483.Localizations> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_a483.Localizations>, _a483.Localizations>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadLocalizations({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'localizations'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedLocalizations(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), delegates: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a483.LocalizationsDelegate<_fac9.dynamic>>, _a483.LocalizationsDelegate<_fac9.dynamic>>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegates'
...
return [_36c2.maybeBoxObject<_a483.Localizations>(object: _a483.Localizations.override(child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState), delegates: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a483.LocalizationsDelegate<_fac9.dynamic>>?, _a483.LocalizationsDelegate<_fac9.dynamic>>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
table  [
'localizationsLocaleOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Locale>(object: _a483.Localizations.localeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'localizationsMaybeLocaleOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _a483.Localizations.maybeLocaleOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final returnValue = _a483.Localizations.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fac9.Type, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));if(returnValue!= null){return [returnValue,];}return []; } );
_36c2.registerBoxer<_a483.Localizations>(boxer: ({required _a483.Localizations vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLocalizations(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

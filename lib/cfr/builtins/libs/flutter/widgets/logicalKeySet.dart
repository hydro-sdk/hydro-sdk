...
class VMManagedLogicalKeySet extends _36c2.VMManagedBox<_1710.LogicalKeySet> {
  VMManagedLogicalKeySet(
    ...
    table['hashCode'] = vmObject.hashCode;
    ...
    table['getKeys'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_fac9.Set>(
            object: vmObject.keys,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
...
class RTManagedLogicalKeySet extends _1710.LogicalKeySet
    implements _36c2.Box<_1710.LogicalKeySet> {
  RTManagedLogicalKeySet(
      _e468.LogicalKeyboardKey key1,
      _e468.LogicalKeyboardKey? key2,
      _e468.LogicalKeyboardKey? key3,
      _e468.LogicalKeyboardKey? key4,
      {required this.table,
    ...
    table['hashCode'] = _36c2.maybeBoxObject(
        object: hashCode, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['_dart_getKeys'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.keys];
    });
  ...
  @_fac9.override
  _fac9.Set<_e468.LogicalKeyboardKey> get keys {
...
void loadLogicalKeySet(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['logicalKeySet'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLogicalKeySet(
          ...
          _36c2.maybeUnBoxAndBuildArgument<_e468.LogicalKeyboardKey?,
              _fac9.dynamic>(luaCallerArguments[4], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_1710.LogicalKeySet>(boxer: (
      {required _1710.LogicalKeySet vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLogicalKeySet(

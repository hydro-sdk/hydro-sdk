...
class VMManagedClipRect extends _36c2.VMManagedBox<_3960.ClipRect> {
  VMManagedClipRect(
    ...
    table['createRenderObject'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_bf98.RenderClipRect>(
...
class RTManagedClipRect extends _3960.ClipRect
    implements _36c2.Box<_3960.ClipRect> {
  RTManagedClipRect(
      {_e2dc.Widget? child,
  ...
  @_fac9.override
  _bf98.RenderClipRect createRenderObject(context) {
    _36c2.Closure closure = table["createRenderObject"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_bf98.RenderClipRect, _fac9.dynamic>(
...
void loadClipRect(
  ...
  table['clipRect'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipRect(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Rect>?, _a643.Rect>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_3960.ClipRect>(boxer: (
      {required _3960.ClipRect vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipRect(

...
class VMManagedOverflowBar extends _36c2.VMManagedBox<_1d97.OverflowBar> {
  VMManagedOverflowBar(
    ...
    table['overflowSpacing'] = vmObject.overflowSpacing;
...
class RTManagedOverflowBar extends _1d97.OverflowBar
  ...
  RTManagedOverflowBar(
      ...
      required _487f.VerticalDirection overflowDirection,
      required _fac9.double overflowSpacing,
    ...
    table['overflowSpacing'] = _36c2.maybeBoxObject(
        object: this.overflowSpacing,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['overflowAlignment'] =
        _1d97.OverflowBarAlignment.values.indexWhere((x) {
...
void loadOverflowBar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['overflowBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOverflowBar(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          overflowAlignment: _36c2.maybeUnBoxEnum(
              values: _1d97.OverflowBarAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['overflowAlignment']
                  : null),
          overflowDirection: _36c2.maybeUnBoxEnum(
              values: _487f.VerticalDirection.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['overflowDirection']
                  : null),
          overflowSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['overflowSpacing'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_1d97.OverflowBar>(boxer: (
      {required _1d97.OverflowBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOverflowBar(

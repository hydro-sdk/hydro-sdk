...
class VMManagedRestorationScope
    extends _36c2.VMManagedBox<_487b.RestorationScope> {
  VMManagedRestorationScope(
...
class RTManagedRestorationScope extends _487b.RestorationScope
    implements _36c2.Box<_487b.RestorationScope> {
  RTManagedRestorationScope(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      _fac9.String? restorationId,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, restorationId: restorationId) {
  ...
  @_fac9.override
  _e2dc.State<_487b.RestorationScope> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_487b.RestorationScope>,
            _487b.RestorationScope>(
...
void loadRestorationScope(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['restorationScope'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRestorationScope(
  ...
  table['restorationScopeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _487b.RestorationScope.of(
  ...
  _36c2.registerBoxer<_487b.RestorationScope>(boxer: (
      {required _487b.RestorationScope vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRestorationScope(

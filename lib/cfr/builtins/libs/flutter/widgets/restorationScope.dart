...
class VMManagedRestorationScope extends _36c2.VMManagedBox<_487b.RestorationScope> {VMManagedRestorationScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _487b.RestorationScope vmObject;

 }

class RTManagedRestorationScope extends _487b.RestorationScope implements _36c2.Box<_487b.RestorationScope> {RTManagedRestorationScope({_ab4a.Key? key, required _e2dc.Widget child, _fac9.String? restorationId, required this.table, required this.hydroState}) : super(key: key,child: child,restorationId: restorationId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_487b.RestorationScope unwrap() => this;
_487b.RestorationScope get vmObject => this;
@_fac9.override _e2dc.State<_487b.RestorationScope> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_487b.RestorationScope>, _487b.RestorationScope>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRestorationScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorationScope'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRestorationScope(table: luaCallerArguments  [
0
...
table  [
'restorationScopeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _487b.RestorationScope.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_6d4f.RestorationBucket?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_487b.RestorationScope>(boxer: ({required _487b.RestorationScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorationScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

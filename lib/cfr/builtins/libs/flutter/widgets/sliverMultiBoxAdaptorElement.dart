...
class VMManagedSliverMultiBoxAdaptorElement extends _36c2.VMManagedBox<_a8eb.SliverMultiBoxAdaptorElement> {VMManagedSliverMultiBoxAdaptorElement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a8eb.SliverMultiBoxAdaptorWidget>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_35be.RenderSliverMultiBoxAdaptor>(object: vmObject.renderObject, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'update'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.update(_36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverMultiBoxAdaptorWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'performRebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.performRebuild();
return []; } );
table  [
'createChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
vmObject.createChild(luaCallerArguments  [
1
], after: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'after'
...
final returnValue = vmObject.updateChild(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Element?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
3
], parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_e2dc.Element?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'forgetChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.forgetChild(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'removeChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.removeChild(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
return [vmObject.estimateMaxScrollOffset(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverConstraints?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), firstIndex: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'firstIndex'
] : null, lastIndex: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'lastIndex'
] : null, leadingScrollOffset: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'leadingScrollOffset'
] : null?.toDouble(), trailingScrollOffset: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
...
table  [
'didStartLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didStartLayout();
return []; } );
table  [
'didFinishLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didFinishLayout();
return []; } );
table  [
'debugAssertChildListLocked'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugAssertChildListLocked(),]; } );
table  [
'didAdoptChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didAdoptChild(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'setDidUnderflow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.setDidUnderflow(luaCallerArguments  [
1
]);
return []; } );
table  [
...
vmObject.insertRenderObjectChild(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
...
vmObject.moveRenderObjectChild(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), luaCallerArguments  [
2
], luaCallerArguments  [
...
vmObject.removeRenderObjectChild(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), luaCallerArguments  [
2
]);
...
1
];vmObject.visitChildren((element) => unpackedvisitor.dispatch([luaCallerArguments[0],element],parentState:hydroState,));
return []; } );
table  [
'debugVisitOnstageChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedvisitor=luaCallerArguments  [
1
];vmObject.debugVisitOnstageChildren((element) => unpackedvisitor.dispatch([luaCallerArguments[0],element],parentState:hydroState,));
return []; } );
table  [
'mount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
vmObject.mount(_36c2.maybeUnBoxAndBuildArgument<_e2dc.Element?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
...
table  [
'unmount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.unmount();
return []; } );
table  [
'attachRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.attachRenderObject(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'detachRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.detachRenderObject();
return []; } );
table  [
'debugFillProperties'
...
table  [
'debugDeactivated'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.debugDeactivated();
return []; } );
table  [
'findRenderObject'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugGetCreatorChain(luaCallerArguments  [
1
]),]; } );
table  [
'debugGetDiagnosticChain'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.debugGetDiagnosticChain().map((x) => _36c2.maybeBoxObject<_e2dc.Element>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toStringShort'
...
table  [
'markNeedsBuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.markNeedsBuild();
return []; } );
table  [
'rebuild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rebuild();
return []; } );
table  [
'getHashCode'
...
table  [
'getSlot'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.slot;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Object?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getDepth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.depth,]; } );
table  [
'getDebugIsDefunct'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugIsDefunct,]; } );
table  [
'getOwner'
...
table  [
'getDirty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.dirty,]; } );
table  [
'toStringShallow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
class RTManagedSliverMultiBoxAdaptorElement extends _a8eb.SliverMultiBoxAdaptorElement implements _36c2.Box<_a8eb.SliverMultiBoxAdaptorElement> {RTManagedSliverMultiBoxAdaptorElement(_a8eb.SliverMultiBoxAdaptorWidget widget$, {required _fac9.bool replaceMovedChildren, required this.table, required this.hydroState}) : super(widget$,replaceMovedChildren: replaceMovedChildren) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_insertChildRenderObject'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_moveChildRenderObject'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_removeChildRenderObject'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_dependOnInheritedWidgetOfExactType'] =
  ...
  return [
    super.dependOnInheritedWidgetOfExactType(
        aspect: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
            luaCallerArguments.length >= 2
...
table['_dart_visitAncestorElements'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  _36c2.Closure unpackedvisitor = luaCallerArguments[1];
  super.visitAncestorElements(
      (element) => _36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
...
@_fac9.override _a8eb.SliverMultiBoxAdaptorWidget get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverMultiBoxAdaptorWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _35be.RenderSliverMultiBoxAdaptor get renderObject { 
_36c2.Closure closure = table["getRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_35be.RenderSliverMultiBoxAdaptor, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void update(newWidget) { super.update(newWidget);
_36c2.Closure closure = table["update"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void performRebuild() { 
_36c2.Closure closure = table["performRebuild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void createChild(index, {_be2e.RenderBox? after}) { 
_36c2.Closure closure = table["createChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Element? updateChild(child, newWidget, newSlot) { 
...
@_fac9.override void forgetChild(child) { super.forgetChild(child);
_36c2.Closure closure = table["forgetChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeChild(child) { 
_36c2.Closure closure = table["removeChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double estimateMaxScrollOffset(constraints, {_fac9.int? firstIndex, _fac9.int? lastIndex, _fac9.double? leadingScrollOffset, _fac9.double? trailingScrollOffset}) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didStartLayout() { 
_36c2.Closure closure = table["didStartLayout"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didFinishLayout() { 
_36c2.Closure closure = table["didFinishLayout"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool debugAssertChildListLocked() { 
_36c2.Closure closure = table["debugAssertChildListLocked"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didAdoptChild(child) { 
_36c2.Closure closure = table["didAdoptChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void setDidUnderflow(value) { 
_36c2.Closure closure = table["setDidUnderflow"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void insertRenderObjectChild(child, slot) { 
_36c2.Closure closure = table["insertRenderObjectChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void moveRenderObjectChild(child, oldSlot, newSlot) { 
_36c2.Closure closure = table["moveRenderObjectChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeRenderObjectChild(child, slot) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void debugVisitOnstageChildren(visitor) { 
_36c2.Closure closure = table["debugVisitOnstageChildren"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void mount(parent, newSlot) { super.mount(parent, newSlot);
_36c2.Closure closure = table["mount"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.List<_e2dc.Element> updateChildren(oldChildren, newWidgets, {_fac9.Set? forgottenChildren, _fac9.List? slots}) { 
_36c2.Closure closure = table["updateChildren"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Element>, _e2dc.Element>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void deactivate() { super.deactivate();
_36c2.Closure closure = table["deactivate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void unmount() { super.unmount();
_36c2.Closure closure = table["unmount"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void attachRenderObject(newSlot) { 
_36c2.Closure closure = table["attachRenderObject"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void detachRenderObject() { 
_36c2.Closure closure = table["detachRenderObject"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void insertChildRenderObject(child, slot) { super.insertChildRenderObject(child, slot);
_36c2.Closure closure = table["insertChildRenderObject"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void moveChildRenderObject(child, slot) { super.moveChildRenderObject(child, slot);
_36c2.Closure closure = table["moveChildRenderObject"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void removeChildRenderObject(child) { super.removeChildRenderObject(child);
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get debugDoingBuild { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.List<_eaf3.DiagnosticsNode> describeMissingAncestor({required _fac9.Type expectedAncestorType}) { 
...
@_fac9.override _eaf3.DiagnosticsNode describeElement(name, {_eaf3.DiagnosticsTreeStyle style = _eaf3.DiagnosticsTreeStyle.errorProperty}) { 
...
@_fac9.override _eaf3.DiagnosticsNode describeWidget(name, {_eaf3.DiagnosticsTreeStyle style = _eaf3.DiagnosticsTreeStyle.errorProperty}) { 
_36c2.Closure closure = table["describeWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticsNode, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _eaf3.DiagnosticsNode describeOwnershipChain(name) { 
_36c2.Closure closure = table["describeOwnershipChain"];
return _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticsNode, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void visitChildElements(visitor) { 
_36c2.Closure closure = table["visitChildElements"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateSlotForChild(child, newSlot) { 
_36c2.Closure closure = table["updateSlotForChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.Element inflateWidget(newWidget, newSlot) { 
_36c2.Closure closure = table["inflateWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.Element, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void deactivateChild(child) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void debugDeactivated() { super.debugDeactivated();
_36c2.Closure closure = table["debugDeactivated"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _9742.RenderObject? findRenderObject() { 
...
@_fac9.override _e2dc.InheritedWidget dependOnInheritedElement(ancestor, {_fac9.Object? aspect}) { 
_36c2.Closure closure = table["dependOnInheritedElement"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedWidget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override T? dependOnInheritedWidgetOfExactType<T extends _e2dc.InheritedWidget>({_fac9.Object? aspect}) { 
_36c2.Closure closure = table["dependOnInheritedWidgetOfExactType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.InheritedElement? getElementForInheritedWidgetOfExactType<T extends _e2dc.InheritedWidget>() { 
_36c2.Closure closure = table["getElementForInheritedWidgetOfExactType"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.InheritedElement?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override T? findAncestorWidgetOfExactType<T extends _e2dc.Widget>() { 
_36c2.Closure closure = table["findAncestorWidgetOfExactType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override T? findAncestorStateOfType<T extends _e2dc.State<_e2dc.StatefulWidget>>() { 
_36c2.Closure closure = table["findAncestorStateOfType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override T? findRootAncestorStateOfType<T extends _e2dc.State<_e2dc.StatefulWidget>>() { 
_36c2.Closure closure = table["findRootAncestorStateOfType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override T? findAncestorRenderObjectOfType<T extends _9742.RenderObject>() { 
_36c2.Closure closure = table["findAncestorRenderObjectOfType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void visitAncestorElements(visitor) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.String debugGetCreatorChain(limit) { 
_36c2.Closure closure = table["debugGetCreatorChain"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.List<_e2dc.Element> debugGetDiagnosticChain() { 
...
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void markNeedsBuild() { 
_36c2.Closure closure = table["markNeedsBuild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void rebuild() { 
_36c2.Closure closure = table["rebuild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Object? get slot { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get debugIsDefunct { 
_36c2.Closure closure = table["getDebugIsDefunct"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e2dc.BuildOwner? get owner { 
...
@_fac9.override _fac9.bool get dirty { 
...
void loadSliverMultiBoxAdaptorElement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'sliverMultiBoxAdaptorElement'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSliverMultiBoxAdaptorElement(_36c2.maybeUnBoxAndBuildArgument<_a8eb.SliverMultiBoxAdaptorWidget, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, replaceMovedChildren: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'replaceMovedChildren'
] : null)]; } );
_36c2.registerBoxer<_a8eb.SliverMultiBoxAdaptorElement>(boxer: ({required _a8eb.SliverMultiBoxAdaptorElement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSliverMultiBoxAdaptorElement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedPlatformRouteInformationProvider extends _36c2.VMManagedBox<_f6ef.PlatformRouteInformationProvider> {VMManagedPlatformRouteInformationProvider({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
vmObject.routerReportsNewRouteInformation(_36c2.maybeUnBoxAndBuildArgument<_f6ef.RouteInformation, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), type: _36c2.maybeUnBoxEnum(values: _f6ef.RouteInformationReportingType.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'type'
] : null));
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_f6ef.RouteInformation>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'addListener'
...
final _f6ef.PlatformRouteInformationProvider vmObject;

 }

class RTManagedPlatformRouteInformationProvider extends _f6ef.PlatformRouteInformationProvider implements _36c2.Box<_f6ef.PlatformRouteInformationProvider> {RTManagedPlatformRouteInformationProvider({required _f6ef.RouteInformation initialRouteInformation, required this.table, required this.hydroState}) : super(initialRouteInformation: initialRouteInformation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_routerReportsNewRouteInformation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.routerReportsNewRouteInformation(
      _36c2.maybeUnBoxAndBuildArgument<_f6ef.RouteInformation, _fac9.dynamic>(
...
_f6ef.PlatformRouteInformationProvider unwrap() => this;
_f6ef.PlatformRouteInformationProvider get vmObject => this;
@_fac9.override void routerReportsNewRouteInformation(routeInformation, {required _f6ef.RouteInformationReportingType type}) { 
_36c2.Closure closure = table["routerReportsNewRouteInformation"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _f6ef.RouteInformation get value { 
...
void loadPlatformRouteInformationProvider({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'platformRouteInformationProvider'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPlatformRouteInformationProvider(table: luaCallerArguments  [
0
], hydroState: hydroState, initialRouteInformation: _36c2.maybeUnBoxAndBuildArgument<_f6ef.RouteInformation, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialRouteInformation'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_f6ef.PlatformRouteInformationProvider>(boxer: ({required _f6ef.PlatformRouteInformationProvider vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformRouteInformationProvider(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

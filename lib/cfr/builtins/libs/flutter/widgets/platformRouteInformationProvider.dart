...
class VMManagedPlatformRouteInformationProvider
    extends _36c2.VMManagedBox<_f6ef.PlatformRouteInformationProvider> {
  VMManagedPlatformRouteInformationProvider(
...
class RTManagedPlatformRouteInformationProvider
    extends _f6ef.PlatformRouteInformationProvider
    implements _36c2.Box<_f6ef.PlatformRouteInformationProvider> {
  RTManagedPlatformRouteInformationProvider(
      {required _f6ef.RouteInformation initialRouteInformation,
      required this.table,
...
void loadPlatformRouteInformationProvider(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['platformRouteInformationProvider'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlatformRouteInformationProvider(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          initialRouteInformation: _36c2.maybeUnBoxAndBuildArgument<
                  _f6ef.RouteInformation, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['initialRouteInformation']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_f6ef.PlatformRouteInformationProvider>(boxer: (
      {required _f6ef.PlatformRouteInformationProvider vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPlatformRouteInformationProvider(

...
class VMManagedDraggableScrollableSheet extends _36c2.VMManagedBox<_90c0.DraggableScrollableSheet> {VMManagedDraggableScrollableSheet({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'initialChildSize'
] = vmObject.initialChildSize;
table  [
'minChildSize'
] = vmObject.minChildSize;
table  [
'maxChildSize'
] = vmObject.maxChildSize;
table  [
'expand'
] = vmObject.expand;
table  [
...
table  [
'snapSizes'
] = _36c2.maybeBoxObject<_fac9.List<_fac9.double>?>(object: vmObject.snapSizes, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _90c0.DraggableScrollableSheet vmObject;

 }

class RTManagedDraggableScrollableSheet extends _90c0.DraggableScrollableSheet implements _36c2.Box<_90c0.DraggableScrollableSheet> {RTManagedDraggableScrollableSheet({required _fac9.bool expand, required _fac9.double initialChildSize, _ab4a.Key? key, required _fac9.double maxChildSize, required _fac9.double minChildSize, required _fac9.bool snap, _fac9.List<_fac9.double>? snapSizes, required _e2dc.Widget Function(_e2dc.BuildContext context, _9585.ScrollController scrollController) builder, required this.table, required this.hydroState}) : super(expand: expand,initialChildSize: initialChildSize,key: key,maxChildSize: maxChildSize,minChildSize: minChildSize,snap: snap,snapSizes: snapSizes,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'initialChildSize'
] = _36c2.maybeBoxObject(object: this.initialChildSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minChildSize'
] = _36c2.maybeBoxObject(object: this.minChildSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maxChildSize'
] = _36c2.maybeBoxObject(object: this.maxChildSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expand'
] = _36c2.maybeBoxObject(object: this.expand, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'snap'
] = _36c2.maybeBoxObject(object: this.snap, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'snapSizes'
] = _36c2.maybeBoxObject(object: this.snapSizes, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_90c0.DraggableScrollableSheet unwrap() => this;
_90c0.DraggableScrollableSheet get vmObject => this;
@_fac9.override _e2dc.State<_90c0.DraggableScrollableSheet> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_90c0.DraggableScrollableSheet>, _90c0.DraggableScrollableSheet>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDraggableScrollableSheet({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedDraggableScrollableSheet(table: luaCallerArguments  [
0
], hydroState: hydroState, expand: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'expand'
] : null, initialChildSize: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialChildSize'
...
'key'
] : null, parentState: hydroState), maxChildSize: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maxChildSize'
] : null?.toDouble(), minChildSize: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'minChildSize'
] : null?.toDouble(), snap: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'snap'
] : null, snapSizes: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.double>?, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'snapSizes'
] : null, parentState: hydroState), builder: (context, scrollController) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,scrollController],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_90c0.DraggableScrollableSheet>(boxer: ({required _90c0.DraggableScrollableSheet vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDraggableScrollableSheet(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

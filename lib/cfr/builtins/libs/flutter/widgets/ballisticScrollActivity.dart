...
class VMManagedBallisticScrollActivity extends _36c2.VMManagedBox<_ca8b.BallisticScrollActivity> {VMManagedBallisticScrollActivity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedBallisticScrollActivity extends _ca8b.BallisticScrollActivity implements _36c2.Box<_ca8b.BallisticScrollActivity> {RTManagedBallisticScrollActivity(_ca8b.ScrollActivityDelegate delegate$, _5437.Simulation simulation, _e067.TickerProvider vsync, {required this.table, required this.hydroState}) : super(delegate$,simulation,vsync,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool applyMoveTo(value) { 
...
void loadBallisticScrollActivity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'ballisticScrollActivity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedBallisticScrollActivity(_36c2.maybeUnBoxAndBuildArgument<_ca8b.ScrollActivityDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_5437.Simulation, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider, _fac9.dynamic>(luaCallerArguments  [
3
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_ca8b.BallisticScrollActivity>(boxer: ({required _ca8b.BallisticScrollActivity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBallisticScrollActivity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

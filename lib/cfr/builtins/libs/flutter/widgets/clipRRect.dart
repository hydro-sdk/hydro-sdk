...
class VMManagedClipRRect extends _36c2.VMManagedBox<_3960.ClipRRect> {VMManagedClipRRect({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderClipRRect>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipRRect, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.ClipRRect vmObject;

 }

class RTManagedClipRRect extends _3960.ClipRRect implements _36c2.Box<_3960.ClipRRect> {RTManagedClipRRect({_9d8a.BorderRadius? borderRadius, _e2dc.Widget? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.RRect>? clipper, _ab4a.Key? key, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,child: child,clipBehavior: clipBehavior,clipper: clipper,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipRRect, _fac9.dynamic>(
...
_3960.ClipRRect unwrap() => this;
_3960.ClipRRect get vmObject => this;
@_fac9.override _bf98.RenderClipRRect createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderClipRRect, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadClipRRect({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipRRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedClipRRect(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3960.ClipRRect>(boxer: ({required _3960.ClipRRect vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipRRect(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedClampingScrollSimulation
    extends _36c2.VMManagedBox<_567b.ClampingScrollSimulation> {
  VMManagedClampingScrollSimulation(
    ...
    table['position'] = vmObject.position;
    table['velocity'] = vmObject.velocity;
    table['friction'] = vmObject.friction;
...
class RTManagedClampingScrollSimulation extends _567b.ClampingScrollSimulation
    implements _36c2.Box<_567b.ClampingScrollSimulation> {
  RTManagedClampingScrollSimulation(
      {required _fac9.double friction,
    ...
    table['velocity'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['friction'] = _36c2.maybeBoxObject(
        object: this.friction,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadClampingScrollSimulation(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['clampingScrollSimulation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClampingScrollSimulation(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          friction: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['friction']
              : null?.toDouble(),
          tolerance:
  ...
  _36c2.registerBoxer<_567b.ClampingScrollSimulation>(boxer: (
      {required _567b.ClampingScrollSimulation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClampingScrollSimulation(

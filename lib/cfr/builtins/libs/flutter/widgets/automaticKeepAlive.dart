...
class VMManagedAutomaticKeepAlive
    extends _36c2.VMManagedBox<_78f9.AutomaticKeepAlive> {
  VMManagedAutomaticKeepAlive(
...
class RTManagedAutomaticKeepAlive extends _78f9.AutomaticKeepAlive
    implements _36c2.Box<_78f9.AutomaticKeepAlive> {
  RTManagedAutomaticKeepAlive(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required this.table,
  ...
  @_fac9.override
  _e2dc.State<_78f9.AutomaticKeepAlive> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_78f9.AutomaticKeepAlive>, _78f9.AutomaticKeepAlive>(
...
void loadAutomaticKeepAlive(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['automaticKeepAlive'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAutomaticKeepAlive(
  ...
  _36c2.registerBoxer<_78f9.AutomaticKeepAlive>(boxer: (
      {required _78f9.AutomaticKeepAlive vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAutomaticKeepAlive(

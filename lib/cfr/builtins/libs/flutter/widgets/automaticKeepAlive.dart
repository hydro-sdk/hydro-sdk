...
class VMManagedAutomaticKeepAlive extends _36c2.VMManagedBox<_78f9.AutomaticKeepAlive> {VMManagedAutomaticKeepAlive({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _78f9.AutomaticKeepAlive vmObject;

 }

class RTManagedAutomaticKeepAlive extends _78f9.AutomaticKeepAlive implements _36c2.Box<_78f9.AutomaticKeepAlive> {RTManagedAutomaticKeepAlive({_e2dc.Widget? child, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_78f9.AutomaticKeepAlive unwrap() => this;
_78f9.AutomaticKeepAlive get vmObject => this;
@_fac9.override _e2dc.State<_78f9.AutomaticKeepAlive> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_78f9.AutomaticKeepAlive>, _78f9.AutomaticKeepAlive>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadAutomaticKeepAlive({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'automaticKeepAlive'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAutomaticKeepAlive(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_78f9.AutomaticKeepAlive>(boxer: ({required _78f9.AutomaticKeepAlive vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutomaticKeepAlive(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollEndNotification extends _36c2.VMManagedBox<_593c.ScrollEndNotification> {VMManagedScrollEndNotification({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'dragDetails'
] = _36c2.maybeBoxObject<_4bc7.DragEndDetails?>(object: vmObject.dragDetails, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'metrics'
...
final _593c.ScrollEndNotification vmObject;

 }

class RTManagedScrollEndNotification extends _593c.ScrollEndNotification implements _36c2.Box<_593c.ScrollEndNotification> {RTManagedScrollEndNotification({_4bc7.DragEndDetails? dragDetails, required _e2dc.BuildContext context, required _96ae.ScrollMetrics metrics, required this.table, required this.hydroState}) : super(dragDetails: dragDetails,context: context,metrics: metrics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_593c.ScrollEndNotification unwrap() => this;
_593c.ScrollEndNotification get vmObject => this;
...
void loadScrollEndNotification({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollEndNotification'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedScrollEndNotification(table: luaCallerArguments  [
0
], hydroState: hydroState, dragDetails: _36c2.maybeUnBoxAndBuildArgument<_4bc7.DragEndDetails?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'dragDetails'
...
_36c2.registerBoxer<_593c.ScrollEndNotification>(boxer: ({required _593c.ScrollEndNotification vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollEndNotification(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedScrollEndNotification
    extends _36c2.VMManagedBox<_593c.ScrollEndNotification> {
  VMManagedScrollEndNotification(
    ...
    table['dragDetails'] = _36c2.maybeBoxObject<_4bc7.DragEndDetails?>(
...
class RTManagedScrollEndNotification extends _593c.ScrollEndNotification
    implements _36c2.Box<_593c.ScrollEndNotification> {
  RTManagedScrollEndNotification(
      {_4bc7.DragEndDetails? dragDetails,
...
void loadScrollEndNotification(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollEndNotification'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollEndNotification(
          ...
          hydroState: hydroState,
          dragDetails: _36c2
              .maybeUnBoxAndBuildArgument<_4bc7.DragEndDetails?, _fac9.dynamic>(
  ...
  _36c2.registerBoxer<_593c.ScrollEndNotification>(boxer: (
      {required _593c.ScrollEndNotification vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollEndNotification(

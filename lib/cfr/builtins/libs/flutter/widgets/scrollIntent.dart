...
class VMManagedScrollIntent extends _36c2.VMManagedBox<_538d.ScrollIntent> {VMManagedScrollIntent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _538d.ScrollIntent vmObject;

 }

class RTManagedScrollIntent extends _538d.ScrollIntent implements _36c2.Box<_538d.ScrollIntent> {RTManagedScrollIntent({required _538d.ScrollIncrementType type, required _487f.AxisDirection direction, required this.table, required this.hydroState}) : super(type: type,direction: direction) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_538d.ScrollIntent unwrap() => this;
_538d.ScrollIntent get vmObject => this;
...
void loadScrollIntent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scrollIntent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedScrollIntent(table: luaCallerArguments  [
0
], hydroState: hydroState, type: _36c2.maybeUnBoxEnum(values: _538d.ScrollIncrementType.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'type'
] : null), direction: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'direction'
] : null))]; } );
_36c2.registerBoxer<_538d.ScrollIntent>(boxer: ({required _538d.ScrollIntent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScrollIntent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

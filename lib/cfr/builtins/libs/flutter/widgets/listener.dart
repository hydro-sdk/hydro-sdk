...
class VMManagedListener extends _36c2.VMManagedBox<_3960.Listener> {VMManagedListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'createRenderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_bf98.RenderPointerListener>(object: vmObject.createRenderObject(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPointerListener, _fac9.dynamic>(luaCallerArguments  [
2
...
final _3960.Listener vmObject;

 }

class RTManagedListener extends _3960.Listener implements _36c2.Box<_3960.Listener> {RTManagedListener({required _bf98.HitTestBehavior behavior, _e2dc.Widget? child, _ab4a.Key? key, void Function(_0e77.PointerCancelEvent event)? onPointerCancel, void Function(_0e77.PointerDownEvent event)? onPointerDown, void Function(_0e77.PointerHoverEvent event)? onPointerHover, void Function(_0e77.PointerMoveEvent event)? onPointerMove, void Function(_0e77.PointerSignalEvent event)? onPointerSignal, void Function(_0e77.PointerUpEvent event)? onPointerUp, required this.table, required this.hydroState}) : super(behavior: behavior,child: child,key: key,onPointerCancel: onPointerCancel,onPointerDown: onPointerDown,onPointerHover: onPointerHover,onPointerMove: onPointerMove,onPointerSignal: onPointerSignal,onPointerUp: onPointerUp) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_updateRenderObject'] =
  ...
  super.updateRenderObject(
      _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPointerListener,
...
_3960.Listener unwrap() => this;
_3960.Listener get vmObject => this;
@_fac9.override _bf98.RenderPointerListener createRenderObject(context) { 
_36c2.Closure closure = table["createRenderObject"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.RenderPointerListener, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listener'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


_36c2.Closure? unpackedonPointerCancel=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerCancel'
] : null;
_36c2.Closure? unpackedonPointerDown=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerDown'
] : null;
_36c2.Closure? unpackedonPointerHover=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerHover'
] : null;
_36c2.Closure? unpackedonPointerMove=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerMove'
] : null;
_36c2.Closure? unpackedonPointerSignal=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerSignal'
] : null;
_36c2.Closure? unpackedonPointerUp=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPointerUp'
] : null;
return  [RTManagedListener(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onPointerCancel: unpackedonPointerCancel != null ? (event) => unpackedonPointerCancel.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onPointerDown: unpackedonPointerDown != null ? (event) => unpackedonPointerDown.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onPointerHover: unpackedonPointerHover != null ? (event) => unpackedonPointerHover.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onPointerMove: unpackedonPointerMove != null ? (event) => unpackedonPointerMove.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onPointerSignal: unpackedonPointerSignal != null ? (event) => unpackedonPointerSignal.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onPointerUp: unpackedonPointerUp != null ? (event) => unpackedonPointerUp.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null )]; } );
_36c2.registerBoxer<_3960.Listener>(boxer: ({required _3960.Listener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

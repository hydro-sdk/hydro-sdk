...
class VMManagedAnimatedBuilder extends _36c2.VMManagedBox<_d7ad.AnimatedBuilder> {VMManagedAnimatedBuilder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d7ad.AnimatedBuilder vmObject;

 }

class RTManagedAnimatedBuilder extends _d7ad.AnimatedBuilder implements _36c2.Box<_d7ad.AnimatedBuilder> {RTManagedAnimatedBuilder({_e2dc.Widget? child, _ab4a.Key? key, required _e644.Listenable animation, required _e2dc.Widget Function(_e2dc.BuildContext context, _e2dc.Widget? child) builder, required this.table, required this.hydroState}) : super(child: child,key: key,animation: animation,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d7ad.AnimatedBuilder unwrap() => this;
_d7ad.AnimatedBuilder get vmObject => this;
...
void loadAnimatedBuilder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animatedBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimatedBuilder(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), animation: _36c2.maybeUnBoxAndBuildArgument<_e644.Listenable, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animation'
] : null, parentState: hydroState), builder: (context, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context,child],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_d7ad.AnimatedBuilder>(boxer: ({required _d7ad.AnimatedBuilder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimatedBuilder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

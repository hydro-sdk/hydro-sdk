...
class VMManagedAnimatedBuilder
    extends _36c2.VMManagedBox<_d7ad.AnimatedBuilder> {
  VMManagedAnimatedBuilder(
...
class RTManagedAnimatedBuilder extends _d7ad.AnimatedBuilder
    implements _36c2.Box<_d7ad.AnimatedBuilder> {
  RTManagedAnimatedBuilder(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      required _e644.Listenable animation,
      required _e2dc.Widget Function(
              _e2dc.BuildContext context, _e2dc.Widget? child)
          builder,
      required this.table,
      required this.hydroState})
      : super(child: child, key: key, animation: animation, builder: builder) {
...
void loadAnimatedBuilder(
  ...
  table['animatedBuilder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedAnimatedBuilder(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          animation:
              _36c2.maybeUnBoxAndBuildArgument<_e644.Listenable, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['animation'] : null,
                  parentState: hydroState),
          builder: (context, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
  ...
  _36c2.registerBoxer<_d7ad.AnimatedBuilder>(boxer: (
      {required _d7ad.AnimatedBuilder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedBuilder(

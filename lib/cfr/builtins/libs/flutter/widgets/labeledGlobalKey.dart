...
class VMManagedLabeledGlobalKey extends _36c2.VMManagedBox<_e2dc.LabeledGlobalKey<_e2dc.State<_e2dc.StatefulWidget>>> {VMManagedLabeledGlobalKey({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLabeledGlobalKey extends _e2dc.LabeledGlobalKey implements _36c2.Box<_e2dc.LabeledGlobalKey> {RTManagedLabeledGlobalKey(_fac9.String? _debugLabel, {required this.table, required this.hydroState}) : super(_debugLabel,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLabeledGlobalKey({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'labeledGlobalKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLabeledGlobalKey(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e2dc.LabeledGlobalKey>(boxer: ({required _e2dc.LabeledGlobalKey vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLabeledGlobalKey(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

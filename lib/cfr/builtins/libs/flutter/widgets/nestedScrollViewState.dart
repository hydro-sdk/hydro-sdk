...
class VMManagedNestedScrollViewState extends _36c2.VMManagedBox<_c812.NestedScrollViewState> {VMManagedNestedScrollViewState({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getInnerController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9585.ScrollController>(object: vmObject.innerController, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getOuterController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9585.ScrollController>(object: vmObject.outerController, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'initState'
...
table  [
'didUpdateWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<_c812.NestedScrollView, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getWidget'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_c812.NestedScrollView>(object: vmObject.widget, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getContext'
...
class RTManagedNestedScrollViewState extends _c812.NestedScrollViewState implements _36c2.Box<_c812.NestedScrollViewState> {RTManagedNestedScrollViewState({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_getInnerController'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.innerController];
});
table['_dart_getOuterController'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_didUpdateWidget'] =
  ...
  super.didUpdateWidget(
      _36c2.maybeUnBoxAndBuildArgument<_c812.NestedScrollView, _fac9.dynamic>(
...
@_fac9.override _9585.ScrollController get innerController { 
_36c2.Closure closure = table["getInnerController"];
return _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _9585.ScrollController get outerController { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _c812.NestedScrollView get widget { 
_36c2.Closure closure = table["getWidget"];
return _36c2.maybeUnBoxAndBuildArgument<_c812.NestedScrollView, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadNestedScrollViewState({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'nestedScrollViewState'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedNestedScrollViewState(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_c812.NestedScrollViewState>(boxer: ({required _c812.NestedScrollViewState vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedNestedScrollViewState(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

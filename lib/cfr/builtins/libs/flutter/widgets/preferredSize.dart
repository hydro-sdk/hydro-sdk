...
class VMManagedPreferredSize extends _36c2.VMManagedBox<_75de.PreferredSize> {
  VMManagedPreferredSize(
...
void loadPreferredSize(
  ...
  table['preferredSize'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPreferredSize(
          ...
          preferredSize:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['preferredSize']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_75de.PreferredSize>(boxer: (
      {required _75de.PreferredSize vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPreferredSize(

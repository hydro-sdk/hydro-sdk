...
class VMManagedPreferredSize extends _36c2.VMManagedBox<_75de.PreferredSize> {VMManagedPreferredSize({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'preferredSize'
] = _36c2.maybeBoxObject<_a643.Size>(object: vmObject.preferredSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _75de.PreferredSize vmObject;

 }

class RTManagedPreferredSize extends _75de.PreferredSize implements _36c2.Box<_75de.PreferredSize> {RTManagedPreferredSize({_ab4a.Key? key, required _e2dc.Widget child, required _a643.Size preferredSize, required this.table, required this.hydroState}) : super(key: key,child: child,preferredSize: preferredSize) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'preferredSize'
] = _36c2.maybeBoxObject(object: this.preferredSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_75de.PreferredSize unwrap() => this;
_75de.PreferredSize get vmObject => this;
...
void loadPreferredSize({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'preferredSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPreferredSize(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_75de.PreferredSize>(boxer: ({required _75de.PreferredSize vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPreferredSize(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

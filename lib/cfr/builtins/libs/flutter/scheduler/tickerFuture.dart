...
class VMManagedTickerFuture extends _36c2.VMManagedBox<_e067.TickerFuture> {VMManagedTickerFuture({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
1
];vmObject.whenCompleteOrCancel(() => unpackedcallback.dispatch([luaCallerArguments[0],],parentState:hydroState,));
return []; } );
table  [
'getOrCancel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.orCancel, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'asStream'
...
1
], parentState: hydroState), test: unpackedtest != null ? (_) => unpackedtest.dispatch([luaCallerArguments[0],_],parentState:hydroState,)[0] : null ), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'then'
...
1
], parentState: hydroState), onTimeout: unpackedonTimeout != null ? () => _36c2.maybeUnBoxAndBuildArgument<_7de1.FutureOr<void>, void>(unpackedonTimeout.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState) : null ), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'whenComplete'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedaction=luaCallerArguments  [
1
];return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.whenComplete(() => unpackedaction.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0]), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toString'
...
void loadTickerFuture({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_e067.TickerFuture>(boxer: ({required _e067.TickerFuture vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTickerFuture(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedTicker extends _36c2.VMManagedBox<_e067.Ticker> {
  VMManagedTicker(
    ...
    table['getMuted'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.muted,
      ];
    });
    table['setMuted'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.muted = (luaCallerArguments[1]);
      return [];
    });
    table['getIsTicking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isTicking,
      ];
    ...
    table['start'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['absorbTicker'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.absorbTicker(
    ...
    table['toString'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.toString(
            debugIncludeStack: luaCallerArguments.length >= 2
...
class RTManagedTicker extends _e067.Ticker implements _36c2.Box<_e067.Ticker> {
  RTManagedTicker(_onTick,
      {_fac9.String? debugLabel, required this.table, required this.hydroState})
      : super(_onTick, debugLabel: debugLabel) {
    ...
    table['debugLabel'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getMuted'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.muted];
    });
    table['_dart_setMuted'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.muted =
    ...
    table['_dart_getIsTicking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_start'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_getScheduled'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.scheduled];
    });
    table['_dart_getShouldScheduleTick'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.shouldScheduleTick];
    });
    table['_dart_scheduleTick'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.scheduleTick(
          rescheduling:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
    ...
    table['_dart_unscheduleTick'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.unscheduleTick();
      return [];
    });
    table['_dart_absorbTicker'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.absorbTicker(
          _36c2.maybeUnBoxAndBuildArgument<_e067.Ticker, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  void stop({_fac9.bool canceled = false}) {
    _36c2.Closure closure = table["stop"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.bool get scheduled {
    _36c2.Closure closure = table["getScheduled"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.bool get shouldScheduleTick {
    _36c2.Closure closure = table["getShouldScheduleTick"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void scheduleTick({_fac9.bool rescheduling = false}) {
  ...
  @_fac9.override
  void absorbTicker(originalTicker) {
  ...
  @_fac9.override
  _fac9.String toString({_fac9.bool debugIncludeStack = false}) {
...
void loadTicker(
  ...
  table['ticker'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpacked_onTick = luaCallerArguments[1];

    return [
      RTManagedTicker(
          (elapsed) => unpacked_onTick.dispatch(
                [luaCallerArguments[0], elapsed],
                parentState: hydroState,
              ),
          table: luaCallerArguments[0],
          hydroState: hydroState,
          debugLabel: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['debugLabel']
              : null)
    ];
  });
  _36c2.registerBoxer<_e067.Ticker>(boxer: (
      {required _e067.Ticker vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTicker(

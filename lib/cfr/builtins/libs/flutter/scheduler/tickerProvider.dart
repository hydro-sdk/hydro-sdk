...
class VMManagedTickerProvider extends _36c2.VMManagedBox<_e067.TickerProvider> {
  VMManagedTickerProvider(
...
void loadTickerProvider(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_e067.TickerProvider>(boxer: (
      {required _e067.TickerProvider vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTickerProvider(

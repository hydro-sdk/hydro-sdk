...
class VMManagedTapSemanticEvent
    extends _36c2.VMManagedBox<_7afa.TapSemanticEvent> {
  VMManagedTapSemanticEvent(
...
class RTManagedTapSemanticEvent extends _7afa.TapSemanticEvent
    implements _36c2.Box<_7afa.TapSemanticEvent> {
  RTManagedTapSemanticEvent({required this.table, required this.hydroState})
      : super() {
...
void loadTapSemanticEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tapSemanticEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTapSemanticEvent(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_7afa.TapSemanticEvent>(boxer: (
      {required _7afa.TapSemanticEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTapSemanticEvent(

...
class VMManagedLongPressSemanticsEvent
    extends _36c2.VMManagedBox<_7afa.LongPressSemanticsEvent> {
  VMManagedLongPressSemanticsEvent(
...
class RTManagedLongPressSemanticsEvent extends _7afa.LongPressSemanticsEvent
    implements _36c2.Box<_7afa.LongPressSemanticsEvent> {
  RTManagedLongPressSemanticsEvent(
    ...
    table['type'] = _36c2.maybeBoxObject(
        object: type, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadLongPressSemanticsEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['longPressSemanticsEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLongPressSemanticsEvent(
  ...
  _36c2.registerBoxer<_7afa.LongPressSemanticsEvent>(boxer: (
      {required _7afa.LongPressSemanticsEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLongPressSemanticsEvent(

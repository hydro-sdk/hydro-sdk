...
class VMManagedLongPressSemanticsEvent extends _36c2.VMManagedBox<_7afa.LongPressSemanticsEvent> {VMManagedLongPressSemanticsEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7afa.LongPressSemanticsEvent vmObject;

 }

class RTManagedLongPressSemanticsEvent extends _7afa.LongPressSemanticsEvent implements _36c2.Box<_7afa.LongPressSemanticsEvent> {RTManagedLongPressSemanticsEvent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7afa.LongPressSemanticsEvent unwrap() => this;
_7afa.LongPressSemanticsEvent get vmObject => this;
...
void loadLongPressSemanticsEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'longPressSemanticsEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLongPressSemanticsEvent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7afa.LongPressSemanticsEvent>(boxer: ({required _7afa.LongPressSemanticsEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLongPressSemanticsEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

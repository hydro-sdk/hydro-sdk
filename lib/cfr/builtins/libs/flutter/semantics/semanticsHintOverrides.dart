...
class VMManagedSemanticsHintOverrides extends _36c2.VMManagedBox<_4c98.SemanticsHintOverrides> {VMManagedSemanticsHintOverrides({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedSemanticsHintOverrides extends _4c98.SemanticsHintOverrides implements _36c2.Box<_4c98.SemanticsHintOverrides> {RTManagedSemanticsHintOverrides({_fac9.String? onLongPressHint, _fac9.String? onTapHint, required this.table, required this.hydroState}) : super(onLongPressHint: onLongPressHint,onTapHint: onTapHint) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'onTapHint'
] = _36c2.maybeBoxObject(object: this.onTapHint, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'onLongPressHint'
] = _36c2.maybeBoxObject(object: this.onLongPressHint, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadSemanticsHintOverrides({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsHintOverrides'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSemanticsHintOverrides(table: luaCallerArguments  [
0
], hydroState: hydroState, onLongPressHint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onLongPressHint'
] : null, onTapHint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onTapHint'
] : null)]; } );
_36c2.registerBoxer<_4c98.SemanticsHintOverrides>(boxer: ({required _4c98.SemanticsHintOverrides vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsHintOverrides(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

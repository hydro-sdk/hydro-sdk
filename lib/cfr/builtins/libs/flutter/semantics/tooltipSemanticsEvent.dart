...
class VMManagedTooltipSemanticsEvent
    extends _36c2.VMManagedBox<_7afa.TooltipSemanticsEvent> {
  VMManagedTooltipSemanticsEvent(
...
class RTManagedTooltipSemanticsEvent extends _7afa.TooltipSemanticsEvent
    implements _36c2.Box<_7afa.TooltipSemanticsEvent> {
  RTManagedTooltipSemanticsEvent(_fac9.String message$,
...
void loadTooltipSemanticsEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tooltipSemanticsEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTooltipSemanticsEvent(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_7afa.TooltipSemanticsEvent>(boxer: (
      {required _7afa.TooltipSemanticsEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTooltipSemanticsEvent(

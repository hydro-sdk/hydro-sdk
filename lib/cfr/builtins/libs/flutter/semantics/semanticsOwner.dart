...
class VMManagedSemanticsOwner extends _36c2.VMManagedBox<_4c98.SemanticsOwner> {VMManagedSemanticsOwner({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getRootSemanticsNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.rootSemanticsNode;if(returnValue!= null){return [_36c2.maybeBoxObject<_4c98.SemanticsNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'dispose'
...
table  [
'sendSemanticsUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.sendSemanticsUpdate();
return []; } );
table  [
'performAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

vmObject.performAction(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_a643.SemanticsAction, _fac9.dynamic>(luaCallerArguments  [
2
...
vmObject.performActionAt(_36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a643.SemanticsAction, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
3
], parentState: hydroState));
...
class RTManagedSemanticsOwner extends _4c98.SemanticsOwner implements _36c2.Box<_4c98.SemanticsOwner> {RTManagedSemanticsOwner({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_performAction'] =
  ...
  super.performAction(
      _36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
          ...
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_a643.SemanticsAction, _fac9.dynamic>(
...
@_fac9.override _4c98.SemanticsNode? get rootSemanticsNode { 
...
@_fac9.override void sendSemanticsUpdate() { 
_36c2.Closure closure = table["sendSemanticsUpdate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void performAction(id, action, [_fac9.Object? args]) { 
_36c2.Closure closure = table["performAction"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void performActionAt(position, action, [_fac9.Object? args]) { 
...
void loadSemanticsOwner({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsOwner'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSemanticsOwner(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_4c98.SemanticsOwner>(boxer: ({required _4c98.SemanticsOwner vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsOwner(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

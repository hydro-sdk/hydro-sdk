...
class VMManagedSemanticsSortKey extends _36c2.VMManagedBox<_4c98.SemanticsSortKey> {VMManagedSemanticsSortKey({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _4c98.SemanticsSortKey vmObject;

 }

class RTManagedSemanticsSortKey extends _4c98.SemanticsSortKey implements _36c2.Box<_4c98.SemanticsSortKey> {RTManagedSemanticsSortKey({_fac9.String? name, required this.table, required this.hydroState}) : super(name: name) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_doCompare'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: doCompare(_36c2.maybeUnBoxAndBuildArgument<
            _4c98.SemanticsSortKey,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
        hydroState: hydroState,
        table: _36c2.HydroTable())
...
_4c98.SemanticsSortKey unwrap() => this;
_4c98.SemanticsSortKey get vmObject => this;
...
void loadSemanticsSortKey({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsSortKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSemanticsSortKey(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_4c98.SemanticsSortKey>(boxer: ({required _4c98.SemanticsSortKey vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsSortKey(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

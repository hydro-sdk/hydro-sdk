...
class VMManagedAttributedStringProperty
    extends _36c2.VMManagedBox<_4c98.AttributedStringProperty> {
  VMManagedAttributedStringProperty(
    ...
    table['showWhenEmpty'] = vmObject.showWhenEmpty;
...
class RTManagedAttributedStringProperty extends _4c98.AttributedStringProperty
    implements _36c2.Box<_4c98.AttributedStringProperty> {
  RTManagedAttributedStringProperty(
      _fac9.String name$, _4c98.AttributedString? value$,
      {_fac9.Object? defaultValue,
      _fac9.String? description,
      required _eaf3.DiagnosticLevel level,
      required _fac9.bool showName,
      required _fac9.bool showWhenEmpty,
      required this.table,
    ...
    table['showWhenEmpty'] = _36c2.maybeBoxObject(
        object: this.showWhenEmpty,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _4c98.AttributedString? get value {
...
void loadAttributedStringProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['attributedStringProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAttributedStringProperty(
          ...
          showWhenEmpty: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['showWhenEmpty'] : null)
    ];
  });
  _36c2.registerBoxer<_4c98.AttributedStringProperty>(boxer: (
      {required _4c98.AttributedStringProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAttributedStringProperty(

...
class VMManagedAttributedStringProperty extends _36c2.VMManagedBox<_4c98.AttributedStringProperty> {VMManagedAttributedStringProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'showWhenEmpty'
] = vmObject.showWhenEmpty;
table  [
'expandableValue'
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.value;if(returnValue!= null){return [_36c2.maybeBoxObject<_4c98.AttributedString?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getException'
...
final _4c98.AttributedStringProperty vmObject;

 }

class RTManagedAttributedStringProperty extends _4c98.AttributedStringProperty implements _36c2.Box<_4c98.AttributedStringProperty> {RTManagedAttributedStringProperty(_fac9.String name$, _4c98.AttributedString? value$, {_fac9.Object? defaultValue, _fac9.String? description, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _fac9.bool showWhenEmpty, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,description: description,level: level,showName: showName,showWhenEmpty: showWhenEmpty) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'showWhenEmpty'
] = _36c2.maybeBoxObject(object: this.showWhenEmpty, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expandableValue'
...
_4c98.AttributedStringProperty unwrap() => this;
_4c98.AttributedStringProperty get vmObject => this;
...
@_fac9.override _4c98.AttributedString? get value { 
...
void loadAttributedStringProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedAttributedStringProperty(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_4c98.AttributedString?, _fac9.dynamic>(luaCallerArguments  [
2
...
'showName'
] : null, showWhenEmpty: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'showWhenEmpty'
] : null)]; } );
_36c2.registerBoxer<_4c98.AttributedStringProperty>(boxer: ({required _4c98.AttributedStringProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAttributedStringProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

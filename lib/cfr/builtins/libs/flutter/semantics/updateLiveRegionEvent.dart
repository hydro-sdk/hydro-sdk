...
class VMManagedUpdateLiveRegionEvent
    extends _36c2.VMManagedBox<_7afa.UpdateLiveRegionEvent> {
  VMManagedUpdateLiveRegionEvent(
...
class RTManagedUpdateLiveRegionEvent extends _7afa.UpdateLiveRegionEvent
    implements _36c2.Box<_7afa.UpdateLiveRegionEvent> {
  RTManagedUpdateLiveRegionEvent(
...
void loadUpdateLiveRegionEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['updateLiveRegionEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedUpdateLiveRegionEvent(
  ...
  _36c2.registerBoxer<_7afa.UpdateLiveRegionEvent>(boxer: (
      {required _7afa.UpdateLiveRegionEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedUpdateLiveRegionEvent(

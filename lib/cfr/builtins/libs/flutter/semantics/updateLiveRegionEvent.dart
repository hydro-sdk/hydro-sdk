...
class VMManagedUpdateLiveRegionEvent extends _36c2.VMManagedBox<_7afa.UpdateLiveRegionEvent> {VMManagedUpdateLiveRegionEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7afa.UpdateLiveRegionEvent vmObject;

 }

class RTManagedUpdateLiveRegionEvent extends _7afa.UpdateLiveRegionEvent implements _36c2.Box<_7afa.UpdateLiveRegionEvent> {RTManagedUpdateLiveRegionEvent({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7afa.UpdateLiveRegionEvent unwrap() => this;
_7afa.UpdateLiveRegionEvent get vmObject => this;
...
void loadUpdateLiveRegionEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'updateLiveRegionEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedUpdateLiveRegionEvent(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7afa.UpdateLiveRegionEvent>(boxer: ({required _7afa.UpdateLiveRegionEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedUpdateLiveRegionEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

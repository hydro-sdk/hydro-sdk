...
class VMManagedAnnounceSemanticsEvent
    extends _36c2.VMManagedBox<_7afa.AnnounceSemanticsEvent> {
  VMManagedAnnounceSemanticsEvent(
...
class RTManagedAnnounceSemanticsEvent extends _7afa.AnnounceSemanticsEvent
    implements _36c2.Box<_7afa.AnnounceSemanticsEvent> {
  RTManagedAnnounceSemanticsEvent(
      _fac9.String message$, _a643.TextDirection textDirection$,
...
void loadAnnounceSemanticsEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['announceSemanticsEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnnounceSemanticsEvent(
  ...
  _36c2.registerBoxer<_7afa.AnnounceSemanticsEvent>(boxer: (
      {required _7afa.AnnounceSemanticsEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnnounceSemanticsEvent(

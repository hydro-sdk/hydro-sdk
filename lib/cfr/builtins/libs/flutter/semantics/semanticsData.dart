...
class VMManagedSemanticsData extends _36c2.VMManagedBox<_4c98.SemanticsData> {VMManagedSemanticsData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'textSelection'
] = _36c2.maybeBoxObject<_7986.TextSelection?>(object: vmObject.textSelection, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollChildCount'
] = vmObject.scrollChildCount;
table  [
'scrollIndex'
] = vmObject.scrollIndex;
table  [
'scrollPosition'
] = vmObject.scrollPosition;
table  [
'scrollExtentMax'
] = vmObject.scrollExtentMax;
table  [
'scrollExtentMin'
] = vmObject.scrollExtentMin;
table  [
'platformViewId'
] = vmObject.platformViewId;
table  [
'maxValueLength'
...
] = _36c2.maybeBoxObject<_fac9.List<_fac9.int>?>(object: vmObject.customSemanticsActionIds, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getLabel'
...
table  [
'hasAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasAction(_36c2.maybeUnBoxAndBuildArgument<_a643.SemanticsAction, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'toStringShort'
...
class RTManagedSemanticsData extends _4c98.SemanticsData implements _36c2.Box<_4c98.SemanticsData> {RTManagedSemanticsData({_fac9.List<_fac9.int>? customSemanticsActionIds, _fac9.Set<_4c98.SemanticsTag>? tags, _db98.Matrix4? transform, required _fac9.int actions, required _4c98.AttributedString attributedDecreasedValue, required _4c98.AttributedString attributedHint, required _4c98.AttributedString attributedIncreasedValue, required _4c98.AttributedString attributedLabel, required _4c98.AttributedString attributedValue, _fac9.int? currentValueLength, required _fac9.double elevation, required _fac9.int flags, _fac9.int? maxValueLength, _fac9.int? platformViewId, required _a643.Rect rect, _fac9.int? scrollChildCount, _fac9.double? scrollExtentMax, _fac9.double? scrollExtentMin, _fac9.int? scrollIndex, _fac9.double? scrollPosition, _a643.TextDirection? textDirection, _7986.TextSelection? textSelection, required _fac9.double thickness, required this.table, required this.hydroState}) : super(customSemanticsActionIds: customSemanticsActionIds,tags: tags,transform: transform,actions: actions,attributedDecreasedValue: attributedDecreasedValue,attributedHint: attributedHint,attributedIncreasedValue: attributedIncreasedValue,attributedLabel: attributedLabel,attributedValue: attributedValue,currentValueLength: currentValueLength,elevation: elevation,flags: flags,maxValueLength: maxValueLength,platformViewId: platformViewId,rect: rect,scrollChildCount: scrollChildCount,scrollExtentMax: scrollExtentMax,scrollExtentMin: scrollExtentMin,scrollIndex: scrollIndex,scrollPosition: scrollPosition,textDirection: textDirection,textSelection: textSelection,thickness: thickness) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'flags'
] = _36c2.maybeBoxObject(object: this.flags, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'actions'
...
table  [
'textSelection'
] = _36c2.maybeBoxObject(object: this.textSelection, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollChildCount'
] = _36c2.maybeBoxObject(object: this.scrollChildCount, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollIndex'
] = _36c2.maybeBoxObject(object: this.scrollIndex, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollPosition'
] = _36c2.maybeBoxObject(object: this.scrollPosition, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollExtentMax'
] = _36c2.maybeBoxObject(object: this.scrollExtentMax, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollExtentMin'
] = _36c2.maybeBoxObject(object: this.scrollExtentMin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'platformViewId'
] = _36c2.maybeBoxObject(object: this.platformViewId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maxValueLength'
...
table  [
'tags'
] = _36c2.maybeBoxObject(object: this.tags, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'transform'
] = _36c2.maybeBoxObject(object: this.transform, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'elevation'
] = _36c2.maybeBoxObject(object: this.elevation, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'thickness'
] = _36c2.maybeBoxObject(object: this.thickness, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'customSemanticsActionIds'
] = _36c2.maybeBoxObject(object: this.customSemanticsActionIds, hydroState: hydroState, table: _36c2.HydroTable());
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hasAction(action) { 
...
void loadSemanticsData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedSemanticsData(table: luaCallerArguments  [
0
], hydroState: hydroState, customSemanticsActionIds: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.int>?, _fac9.int>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'customSemanticsActionIds'
] : null, parentState: hydroState), tags: _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_4c98.SemanticsTag>?, _4c98.SemanticsTag>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'tags'
...
'transform'
] : null, parentState: hydroState), actions: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'actions'
] : null, attributedDecreasedValue: _36c2.maybeUnBoxAndBuildArgument<_4c98.AttributedString, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'attributedDecreasedValue'
...
'attributedValue'
] : null, parentState: hydroState), currentValueLength: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'currentValueLength'
...
'elevation'
] : null?.toDouble(), flags: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'flags'
...
'maxValueLength'
] : null, platformViewId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'platformViewId'
] : null, rect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rect'
] : null, parentState: hydroState), scrollChildCount: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollChildCount'
] : null, scrollExtentMax: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollExtentMax'
] : null?.toDouble(), scrollExtentMin: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollExtentMin'
] : null?.toDouble(), scrollIndex: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollIndex'
] : null, scrollPosition: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollPosition'
...
'textDirection'
] : null), textSelection: _36c2.maybeUnBoxAndBuildArgument<_7986.TextSelection?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textSelection'
...
_36c2.registerBoxer<_4c98.SemanticsData>(boxer: ({required _4c98.SemanticsData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

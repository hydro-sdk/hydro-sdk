...
class VMManagedSemanticsProperties
    extends _36c2.VMManagedBox<_4c98.SemanticsProperties> {
  VMManagedSemanticsProperties(
    ...
    table['checked'] = vmObject.checked;
    table['toggled'] = vmObject.toggled;
    table['selected'] = vmObject.selected;
    table['button'] = vmObject.button;
    table['link'] = vmObject.link;
    table['header'] = vmObject.header;
    table['textField'] = vmObject.textField;
    table['slider'] = vmObject.slider;
    table['keyboardKey'] = vmObject.keyboardKey;
    table['readOnly'] = vmObject.readOnly;
    table['focusable'] = vmObject.focusable;
    table['focused'] = vmObject.focused;
    table['inMutuallyExclusiveGroup'] = vmObject.inMutuallyExclusiveGroup;
    table['hidden'] = vmObject.hidden;
    table['obscured'] = vmObject.obscured;
    table['multiline'] = vmObject.multiline;
    table['scopesRoute'] = vmObject.scopesRoute;
    table['namesRoute'] = vmObject.namesRoute;
    table['image'] = vmObject.image;
    table['liveRegion'] = vmObject.liveRegion;
    ...
    table['hintOverrides'] =
        _36c2.maybeBoxObject<_4c98.SemanticsHintOverrides?>(
            object: vmObject.hintOverrides,
            hydroState: hydroState,
            table: _36c2.HydroTable());
    table['textDirection'] = _a643.TextDirection.values.indexWhere((x) {
      return x == vmObject.textDirection;
    });
    table['sortKey'] = _36c2.maybeBoxObject<_4c98.SemanticsSortKey?>(
        object: vmObject.sortKey,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['tagForChildren'] = _36c2.maybeBoxObject<_4c98.SemanticsTag?>(
        object: vmObject.tagForChildren,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['customSemanticsActions'] = _36c2.maybeBoxObject<_fac9.Map?>(
...
class RTManagedSemanticsProperties extends _4c98.SemanticsProperties
    implements _36c2.Box<_4c98.SemanticsProperties> {
  RTManagedSemanticsProperties(
    ...
    table['enabled'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['checked'] = _36c2.maybeBoxObject(
        object: this.checked,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['toggled'] = _36c2.maybeBoxObject(
        object: this.toggled,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['textField'] = _36c2.maybeBoxObject(
        object: this.textField,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['slider'] = _36c2.maybeBoxObject(
        object: this.slider, hydroState: hydroState, table: _36c2.HydroTable());
    table['keyboardKey'] = _36c2.maybeBoxObject(
        object: this.keyboardKey,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['readOnly'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['focusable'] = _36c2.maybeBoxObject(
        object: this.focusable,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['focused'] = _36c2.maybeBoxObject(
        object: this.focused,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['inMutuallyExclusiveGroup'] = _36c2.maybeBoxObject(
        object: this.inMutuallyExclusiveGroup,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['hidden'] = _36c2.maybeBoxObject(
        object: this.hidden, hydroState: hydroState, table: _36c2.HydroTable());
    table['obscured'] = _36c2.maybeBoxObject(
        object: this.obscured,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['multiline'] = _36c2.maybeBoxObject(
        object: this.multiline,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['scopesRoute'] = _36c2.maybeBoxObject(
        object: this.scopesRoute,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['namesRoute'] = _36c2.maybeBoxObject(
        object: this.namesRoute,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['image'] = _36c2.maybeBoxObject(
        object: this.image, hydroState: hydroState, table: _36c2.HydroTable());
    table['liveRegion'] = _36c2.maybeBoxObject(
        object: this.liveRegion,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['attributedValue'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['increasedValue'] = _36c2.maybeBoxObject(
        object: this.increasedValue,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['attributedIncreasedValue'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['decreasedValue'] = _36c2.maybeBoxObject(
        object: this.decreasedValue,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['attributedHint'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['hintOverrides'] = _36c2.maybeBoxObject(
        object: this.hintOverrides,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['textDirection'] = _a643.TextDirection.values.indexWhere((x) {
      return x == this.textDirection;
    });
    table['sortKey'] = _36c2.maybeBoxObject(
        object: this.sortKey,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['tagForChildren'] = _36c2.maybeBoxObject(
        object: this.tagForChildren,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['customSemanticsActions'] = _36c2.maybeBoxObject(
        object: this.customSemanticsActions,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadSemanticsProperties(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['semanticsProperties'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_4c98.SemanticsProperties>(boxer: (
      {required _4c98.SemanticsProperties vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSemanticsProperties(

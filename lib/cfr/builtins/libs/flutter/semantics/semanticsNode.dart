...
class VMManagedSemanticsNode extends _36c2.VMManagedBox<_4c98.SemanticsNode> {VMManagedSemanticsNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.maybeBoxObject<_a643.Rect?>(object: vmObject.parentSemanticsClipRect, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentPaintClipRect'
] = _36c2.maybeBoxObject<_a643.Rect?>(object: vmObject.parentPaintClipRect, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'elevationAdjustment'
] = vmObject.elevationAdjustment;
table  [
'indexInParent'
] = vmObject.indexInParent;
table  [
'tags'
] = _36c2.maybeBoxObject<_fac9.Set?>(object: vmObject.tags, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getId'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.id,]; } );
table  [
'getTransform'
...
table  [
'setTransform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.transform=(_36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Rect>(object: vmObject.rect, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rect=(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getIsInvisible'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isInvisible,]; } );
table  [
'getIsMergedIntoParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isMergedIntoParent,]; } );
table  [
'setIsMergedIntoParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.isMergedIntoParent=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getIsPartOfNodeMerging'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isPartOfNodeMerging,]; } );
table  [
'getMergeAllDescendantsIntoThisNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.mergeAllDescendantsIntoThisNode,]; } );
table  [
'getHasChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasChildren,]; } );
table  [
'getChildrenCount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childrenCount,]; } );
table  [
'visitChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedvisitor=luaCallerArguments  [
1
];vmObject.visitChildren((node) => unpackedvisitor.dispatch([luaCallerArguments[0],node],parentState:hydroState,)[0]);
return []; } );
table  [
'getOwner'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.owner;if(returnValue!= null){return [_36c2.maybeBoxObject<_4c98.SemanticsOwner?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.parent;if(returnValue!= null){return [_36c2.maybeBoxObject<_4c98.SemanticsNode?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'redepthChildren'
...
table  [
'attach'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.attach(_36c2.maybeUnBoxAndBuildArgument<_4c98.SemanticsOwner, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'isTagged'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isTagged(_36c2.maybeUnBoxAndBuildArgument<_4c98.SemanticsTag, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'hasFlag'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.hasFlag(_36c2.maybeUnBoxAndBuildArgument<_a643.SemanticsFlag, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'getLabel'
...
table  [
'getIsMultiline'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.isMultiline;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getScrollChildCount'
...
vmObject.updateWith(childrenInInversePaintOrder: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_4c98.SemanticsNode>?, _4c98.SemanticsNode>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childrenInInversePaintOrder'
] : null, parentState: hydroState), config: _36c2.maybeUnBoxAndBuildArgument<_4c98.SemanticsConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'config'
...
table  [
'getSemanticsData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_4c98.SemanticsData>(object: vmObject.getSemanticsData(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'sendEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.sendEvent(_36c2.maybeUnBoxAndBuildArgument<_7afa.SemanticsEvent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
return [vmObject.toStringDeep(childOrder: _36c2.maybeUnBoxEnum(values: _4c98.DebugSemanticsDumpOrder.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childOrder'
...
return [_36c2.maybeBoxObject<_eaf3.DiagnosticsNode>(object: vmObject.toDiagnosticsNode(childOrder: _36c2.maybeUnBoxEnum(values: _4c98.DebugSemanticsDumpOrder.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childOrder'
] : null), name: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'name'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.debugDescribeChildren(childOrder: _36c2.maybeUnBoxEnum(values: _4c98.DebugSemanticsDumpOrder.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childOrder'
] : null)).map((x) => _36c2.maybeBoxObject<_eaf3.DiagnosticsNode>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'debugListChildrenInOrder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.debugListChildrenInOrder(_36c2.maybeUnBoxEnum(values: _4c98.DebugSemanticsDumpOrder.values, boxedEnum: luaCallerArguments  [
1
])).map((x) => _36c2.maybeBoxObject<_4c98.SemanticsNode>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toString'
...
class RTManagedSemanticsNode extends _4c98.SemanticsNode implements _36c2.Box<_4c98.SemanticsNode> {RTManagedSemanticsNode({_ab4a.Key? key, void Function()? showOnScreen, required this.table, required this.hydroState}) : super(key: key,showOnScreen: showOnScreen) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'parentSemanticsClipRect'
] = _36c2.maybeBoxObject(object: parentSemanticsClipRect, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentPaintClipRect'
] = _36c2.maybeBoxObject(object: parentPaintClipRect, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'elevationAdjustment'
] = _36c2.maybeBoxObject(object: elevationAdjustment, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'indexInParent'
] = _36c2.maybeBoxObject(object: indexInParent, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'tags'
] = _36c2.maybeBoxObject(object: tags, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_getId'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.id];
});
  ...
  super.updateWith(
      childrenInInversePaintOrder: _36c2.maybeUnBoxAndBuildArgument<
          ...
          luaCallerArguments.length >= 2
              ...
              : null,
          parentState: hydroState),
      config: _36c2.maybeUnBoxAndBuildArgument<_4c98.SemanticsConfiguration?,
              _fac9.dynamic>(
          luaCallerArguments.length >= 2
        ...
        object: super.toStringDeep(
            ...
            minLevel: _36c2.maybeUnBoxEnum(
                ...
                boxedEnum: luaCallerArguments.length >= 2
                    ...
                    : null),
            prefixLineOne: _36c2.maybeUnBoxAndBuildArgument<_fac9.String, _fac9.dynamic>(
                luaCallerArguments.length >= 2
...
@_fac9.override _fac9.int get id { 
...
@_fac9.override void set transform(value) { 
_36c2.Closure closure = table["setTransform"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Rect get rect { 
...
@_fac9.override void set rect(value) { 
_36c2.Closure closure = table["setRect"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isInvisible { 
_36c2.Closure closure = table["getIsInvisible"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isMergedIntoParent { 
_36c2.Closure closure = table["getIsMergedIntoParent"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set isMergedIntoParent(value) { 
_36c2.Closure closure = table["setIsMergedIntoParent"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isPartOfNodeMerging { 
_36c2.Closure closure = table["getIsPartOfNodeMerging"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get mergeAllDescendantsIntoThisNode { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int get childrenCount { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _4c98.SemanticsOwner? get owner { 
...
@_fac9.override _4c98.SemanticsNode? get parent { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool isTagged(tag) { 
_36c2.Closure closure = table["isTagged"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hasFlag(flag) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateWith({_fac9.List? childrenInInversePaintOrder, _4c98.SemanticsConfiguration? config}) { 
_36c2.Closure closure = table["updateWith"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _4c98.SemanticsData getSemanticsData() { 
_36c2.Closure closure = table["getSemanticsData"];
return _36c2.maybeUnBoxAndBuildArgument<_4c98.SemanticsData, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void sendEvent(event) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.String toStringDeep({_4c98.DebugSemanticsDumpOrder childOrder = _4c98.DebugSemanticsDumpOrder.traversalOrder, _eaf3.DiagnosticLevel minLevel = _eaf3.DiagnosticLevel.debug, _fac9.String prefixLineOne = '', _fac9.String? prefixOtherLines}) { 
_36c2.Closure closure = table["toStringDeep"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _eaf3.DiagnosticsNode toDiagnosticsNode({_4c98.DebugSemanticsDumpOrder childOrder = _4c98.DebugSemanticsDumpOrder.traversalOrder, _fac9.String? name, _eaf3.DiagnosticsTreeStyle? style = _eaf3.DiagnosticsTreeStyle.sparse}) { 
...
@_fac9.override _fac9.List<_eaf3.DiagnosticsNode> debugDescribeChildren({_4c98.DebugSemanticsDumpOrder childOrder = _4c98.DebugSemanticsDumpOrder.inverseHitTest}) { 
...
@_fac9.override _fac9.List<_4c98.SemanticsNode> debugListChildrenInOrder(childOrder) { 
_36c2.Closure closure = table["debugListChildrenInOrder"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_4c98.SemanticsNode>, _4c98.SemanticsNode>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadSemanticsNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'semanticsNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure? unpackedshowOnScreen=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showOnScreen'
] : null;
return  [RTManagedSemanticsNode(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), showOnScreen: unpackedshowOnScreen != null ? () => unpackedshowOnScreen.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null )]; } );
_36c2.registerBoxer<_4c98.SemanticsNode>(boxer: ({required _4c98.SemanticsNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSemanticsNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

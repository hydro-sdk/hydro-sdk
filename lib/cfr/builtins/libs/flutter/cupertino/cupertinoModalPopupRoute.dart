...
class VMManagedCupertinoModalPopupRoute
    extends _36c2.VMManagedBox<_76db.CupertinoModalPopupRoute<_fac9.dynamic>> {
  VMManagedCupertinoModalPopupRoute(
...
class RTManagedCupertinoModalPopupRoute extends _76db.CupertinoModalPopupRoute
    implements _36c2.Box<_76db.CupertinoModalPopupRoute> {
  RTManagedCupertinoModalPopupRoute(
      {_a643.Color? barrierColor,
      required _fac9.bool barrierDismissible,
      required _fac9.String barrierLabel,
      _a643.ImageFilter? filter,
      _fac9.bool? semanticsDismissible,
    ...
    table['filter'] = _36c2.maybeBoxObject(
        object: this.filter, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadCupertinoModalPopupRoute(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoModalPopupRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedCupertinoModalPopupRoute(
          ...
          barrierColor:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['barrierColor']
                      : null,
                  parentState: hydroState),
          ...
          barrierLabel: luaCallerArguments.length >= 2
              ...
              : null,
          filter:
              _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['filter'] : null,
                  parentState: hydroState),
          semanticsDismissible: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['semanticsDismissible']
              : null,
  ...
  _36c2.registerBoxer<_76db.CupertinoModalPopupRoute>(boxer: (
      {required _76db.CupertinoModalPopupRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoModalPopupRoute(

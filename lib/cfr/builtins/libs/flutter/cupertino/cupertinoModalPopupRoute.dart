...
class VMManagedCupertinoModalPopupRoute extends _36c2.VMManagedBox<_76db.CupertinoModalPopupRoute<_fac9.dynamic>> {VMManagedCupertinoModalPopupRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _76db.CupertinoModalPopupRoute<_fac9.dynamic> vmObject;

 }

class RTManagedCupertinoModalPopupRoute extends _76db.CupertinoModalPopupRoute implements _36c2.Box<_76db.CupertinoModalPopupRoute> {RTManagedCupertinoModalPopupRoute({_a643.Color? barrierColor, required _fac9.bool barrierDismissible, required _fac9.String barrierLabel, _a643.ImageFilter? filter, _fac9.bool? semanticsDismissible, _a37d.RouteSettings? settings, required _e2dc.Widget Function(_e2dc.BuildContext context) builder, required this.table, required this.hydroState}) : super(barrierColor: barrierColor,barrierDismissible: barrierDismissible,barrierLabel: barrierLabel,filter: filter,semanticsDismissible: semanticsDismissible,settings: settings,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'filter'
] = _36c2.maybeBoxObject(object: this.filter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'willDisposeAnimationController'
...
_76db.CupertinoModalPopupRoute unwrap() => this;
_76db.CupertinoModalPopupRoute get vmObject => this;
...
void loadCupertinoModalPopupRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoModalPopupRoute(table: luaCallerArguments  [
0
...
'barrierLabel'
] : null, filter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'filter'
] : null, parentState: hydroState), semanticsDismissible: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
...
'settings'
] : null, parentState: hydroState), builder: (context) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_76db.CupertinoModalPopupRoute>(boxer: ({required _76db.CupertinoModalPopupRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoModalPopupRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

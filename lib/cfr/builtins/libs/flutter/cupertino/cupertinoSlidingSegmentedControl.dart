...
import 'package:flutter/src/cupertino/sliding_segmented_control.dart' as _ab7d;
...
class VMManagedCupertinoSlidingSegmentedControl extends _36c2.VMManagedBox<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>> {VMManagedCupertinoSlidingSegmentedControl({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic> vmObject;

 }

class RTManagedCupertinoSlidingSegmentedControl extends _ab7d.CupertinoSlidingSegmentedControl implements _36c2.Box<_ab7d.CupertinoSlidingSegmentedControl> {RTManagedCupertinoSlidingSegmentedControl({required _a643.Color backgroundColor, _fac9.dynamic? groupValue, _ab4a.Key? key, required _96d1.EdgeInsetsGeometry padding, required _a643.Color thumbColor, required _fac9.Map<_fac9.dynamic,_e2dc.Widget> children, required void Function(_fac9.dynamic? value) onValueChanged, required this.table, required this.hydroState}) : super(backgroundColor: backgroundColor,groupValue: groupValue,key: key,padding: padding,thumbColor: thumbColor,children: children,onValueChanged: onValueChanged) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_ab7d.CupertinoSlidingSegmentedControl unwrap() => this;
_ab7d.CupertinoSlidingSegmentedControl get vmObject => this;
@_fac9.override _e2dc.State<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>>, _ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoSlidingSegmentedControl({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoSlidingSegmentedControl(table: luaCallerArguments  [
0
...
'padding'
] : null, parentState: hydroState), thumbColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'thumbColor'
...
_36c2.registerBoxer<_ab7d.CupertinoSlidingSegmentedControl>(boxer: ({required _ab7d.CupertinoSlidingSegmentedControl vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoSlidingSegmentedControl(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

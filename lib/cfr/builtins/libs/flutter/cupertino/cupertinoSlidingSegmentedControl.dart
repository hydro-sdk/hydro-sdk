...
class VMManagedCupertinoSlidingSegmentedControl extends _36c2
    .VMManagedBox<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>> {
  VMManagedCupertinoSlidingSegmentedControl(
...
class RTManagedCupertinoSlidingSegmentedControl
    extends _ab7d.CupertinoSlidingSegmentedControl
    implements _36c2.Box<_ab7d.CupertinoSlidingSegmentedControl> {
  RTManagedCupertinoSlidingSegmentedControl(
      {required _a643.Color backgroundColor,
      _fac9.dynamic? groupValue,
      _ab4a.Key? key,
      required _96d1.EdgeInsetsGeometry padding,
      required _a643.Color thumbColor,
      required _fac9.Map<_fac9.dynamic, _e2dc.Widget> children,
      required void Function(_fac9.dynamic? value) onValueChanged,
      required this.table,
  ...
  @_fac9.override
  _e2dc.State<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>>
      createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>>,
            _ab7d.CupertinoSlidingSegmentedControl<_fac9.dynamic>>(
...
void loadCupertinoSlidingSegmentedControl(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoSlidingSegmentedControl'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedCupertinoSlidingSegmentedControl(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          padding: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['padding'] : null,
              parentState: hydroState),
          thumbColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
  ...
  _36c2.registerBoxer<_ab7d.CupertinoSlidingSegmentedControl>(boxer: (
      {required _ab7d.CupertinoSlidingSegmentedControl vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoSlidingSegmentedControl(

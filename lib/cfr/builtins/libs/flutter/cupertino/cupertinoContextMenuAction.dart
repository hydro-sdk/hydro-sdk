...
import 'package:flutter/src/cupertino/context_menu_action.dart' as _215a;
...
class VMManagedCupertinoContextMenuAction extends _36c2.VMManagedBox<_215a.CupertinoContextMenuAction> {VMManagedCupertinoContextMenuAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'isDefaultAction'
] = vmObject.isDefaultAction;
table  [
'isDestructiveAction'
] = vmObject.isDestructiveAction;
table  [
'trailingIcon'
] = _36c2.maybeBoxObject<_003a.IconData?>(object: vmObject.trailingIcon, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _215a.CupertinoContextMenuAction vmObject;

 }

class RTManagedCupertinoContextMenuAction extends _215a.CupertinoContextMenuAction implements _36c2.Box<_215a.CupertinoContextMenuAction> {RTManagedCupertinoContextMenuAction({required _fac9.bool isDefaultAction, required _fac9.bool isDestructiveAction, _ab4a.Key? key, void Function()? onPressed, _003a.IconData? trailingIcon, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(isDefaultAction: isDefaultAction,isDestructiveAction: isDestructiveAction,key: key,onPressed: onPressed,trailingIcon: trailingIcon,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'isDefaultAction'
] = _36c2.maybeBoxObject(object: this.isDefaultAction, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'isDestructiveAction'
] = _36c2.maybeBoxObject(object: this.isDestructiveAction, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'trailingIcon'
] = _36c2.maybeBoxObject(object: this.trailingIcon, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_215a.CupertinoContextMenuAction unwrap() => this;
_215a.CupertinoContextMenuAction get vmObject => this;
@_fac9.override _e2dc.State<_215a.CupertinoContextMenuAction> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_215a.CupertinoContextMenuAction>, _215a.CupertinoContextMenuAction>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoContextMenuAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoContextMenuAction(table: luaCallerArguments  [
0
], hydroState: hydroState, isDefaultAction: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isDefaultAction'
] : null, isDestructiveAction: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isDestructiveAction'
...
'key'
] : null, parentState: hydroState), onPressed: unpackedonPressed != null ? () => unpackedonPressed.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , trailingIcon: _36c2.maybeUnBoxAndBuildArgument<_003a.IconData?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'trailingIcon'
...
_36c2.registerBoxer<_215a.CupertinoContextMenuAction>(boxer: ({required _215a.CupertinoContextMenuAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoContextMenuAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

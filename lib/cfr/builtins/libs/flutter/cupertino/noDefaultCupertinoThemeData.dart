...
class VMManagedNoDefaultCupertinoThemeData
    extends _36c2.VMManagedBox<_2b5f.NoDefaultCupertinoThemeData> {
  VMManagedNoDefaultCupertinoThemeData(
...
class RTManagedNoDefaultCupertinoThemeData
    extends _2b5f.NoDefaultCupertinoThemeData
    implements _36c2.Box<_2b5f.NoDefaultCupertinoThemeData> {
  RTManagedNoDefaultCupertinoThemeData(
  ...
  @_fac9.override
  _2b5f.NoDefaultCupertinoThemeData resolveFrom(context) {
  ...
  @_fac9.override
  _2b5f.NoDefaultCupertinoThemeData copyWith(
      {_a643.Color? barBackgroundColor,
      _a643.Brightness? brightness,
      _a643.Color? primaryColor,
      _a643.Color? primaryContrastingColor,
...
void loadNoDefaultCupertinoThemeData(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['noDefaultCupertinoThemeData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNoDefaultCupertinoThemeData(
  ...
  _36c2.registerBoxer<_2b5f.NoDefaultCupertinoThemeData>(boxer: (
      {required _2b5f.NoDefaultCupertinoThemeData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNoDefaultCupertinoThemeData(

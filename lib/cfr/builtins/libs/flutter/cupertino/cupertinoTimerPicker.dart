...
class VMManagedCupertinoTimerPicker extends _36c2.VMManagedBox<_5b14.CupertinoTimerPicker> {VMManagedCupertinoTimerPicker({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'mode'
] = _5b14.CupertinoTimerPickerMode.values.indexWhere((x) { return x == vmObject.mode; } );
table  [
'initialTimerDuration'
] = _36c2.maybeBoxObject<_fac9.Duration>(object: vmObject.initialTimerDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minuteInterval'
] = vmObject.minuteInterval;
table  [
'secondInterval'
] = vmObject.secondInterval;
table  [
'alignment'
...
final _5b14.CupertinoTimerPicker vmObject;

 }

class RTManagedCupertinoTimerPicker extends _5b14.CupertinoTimerPicker implements _36c2.Box<_5b14.CupertinoTimerPicker> {RTManagedCupertinoTimerPicker({required _ca85.AlignmentGeometry alignment, _a643.Color? backgroundColor, required _fac9.Duration initialTimerDuration, _ab4a.Key? key, required _fac9.int minuteInterval, required _5b14.CupertinoTimerPickerMode mode, required _fac9.int secondInterval, required void Function(_fac9.Duration value) onTimerDurationChanged, required this.table, required this.hydroState}) : super(alignment: alignment,backgroundColor: backgroundColor,initialTimerDuration: initialTimerDuration,key: key,minuteInterval: minuteInterval,mode: mode,secondInterval: secondInterval,onTimerDurationChanged: onTimerDurationChanged) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'mode'
] = _5b14.CupertinoTimerPickerMode.values.indexWhere((x) { return x == this.mode; } );
table  [
'initialTimerDuration'
] = _36c2.maybeBoxObject(object: this.initialTimerDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minuteInterval'
] = _36c2.maybeBoxObject(object: this.minuteInterval, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'secondInterval'
] = _36c2.maybeBoxObject(object: this.secondInterval, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'alignment'
...
_5b14.CupertinoTimerPicker unwrap() => this;
_5b14.CupertinoTimerPicker get vmObject => this;
...
void loadCupertinoTimerPicker({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
_36c2.Closure unpackedonTimerDurationChanged=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onTimerDurationChanged'
] : null;
return  [RTManagedCupertinoTimerPicker(table: luaCallerArguments  [
0
...
'backgroundColor'
] : null, parentState: hydroState), initialTimerDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'initialTimerDuration'
...
'key'
] : null, parentState: hydroState), minuteInterval: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'minuteInterval'
] : null, mode: _36c2.maybeUnBoxEnum(values: _5b14.CupertinoTimerPickerMode.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'mode'
] : null), secondInterval: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'secondInterval'
] : null, onTimerDurationChanged: (value) => unpackedonTimerDurationChanged.dispatch([luaCallerArguments[0],value],parentState:hydroState,))]; } );
_36c2.registerBoxer<_5b14.CupertinoTimerPicker>(boxer: ({required _5b14.CupertinoTimerPicker vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoTimerPicker(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCupertinoNavigationBar
    extends _36c2.VMManagedBox<_5cb5.CupertinoNavigationBar> {
  VMManagedCupertinoNavigationBar(
    ...
    table['automaticallyImplyMiddle'] = vmObject.automaticallyImplyMiddle;
...
class RTManagedCupertinoNavigationBar extends _5cb5.CupertinoNavigationBar
    implements _36c2.Box<_5cb5.CupertinoNavigationBar> {
  RTManagedCupertinoNavigationBar(
      {required _fac9.bool automaticallyImplyLeading,
      required _fac9.bool automaticallyImplyMiddle,
    ...
    table['automaticallyImplyLeading'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['automaticallyImplyMiddle'] = _36c2.maybeBoxObject(
        object: this.automaticallyImplyMiddle,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_shouldFullyObstruct'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.shouldFullyObstruct(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  _fac9.bool shouldFullyObstruct(context) {
  ...
  @_fac9.override
  _e2dc.State<_5cb5.CupertinoNavigationBar> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_5cb5.CupertinoNavigationBar>,
            _5cb5.CupertinoNavigationBar>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadCupertinoNavigationBar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoNavigationBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoNavigationBar(
          ...
          automaticallyImplyLeading: luaCallerArguments.length >= 2
              ...
              : null,
          automaticallyImplyMiddle: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['automaticallyImplyMiddle']
              : null,
          backgroundColor:
  ...
  _36c2.registerBoxer<_5cb5.CupertinoNavigationBar>(boxer: (
      {required _5cb5.CupertinoNavigationBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoNavigationBar(

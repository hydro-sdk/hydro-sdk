...
class VMManagedCupertinoNavigationBar extends _36c2.VMManagedBox<_5cb5.CupertinoNavigationBar> {VMManagedCupertinoNavigationBar({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = vmObject.automaticallyImplyMiddle;
table  [
'previousPageTitle'
...
table  [
'shouldFullyObstruct'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldFullyObstruct(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _5cb5.CupertinoNavigationBar vmObject;

 }

class RTManagedCupertinoNavigationBar extends _5cb5.CupertinoNavigationBar implements _36c2.Box<_5cb5.CupertinoNavigationBar> {RTManagedCupertinoNavigationBar({required _fac9.bool automaticallyImplyLeading, required _fac9.bool automaticallyImplyMiddle, _a643.Color? backgroundColor, _250a.Border? border, _a643.Brightness? brightness, required _fac9.Object heroTag, _ab4a.Key? key, _e2dc.Widget? leading, _e2dc.Widget? middle, _96d1.EdgeInsetsDirectional? padding, _fac9.String? previousPageTitle, _e2dc.Widget? trailing, required _fac9.bool transitionBetweenRoutes, required this.table, required this.hydroState}) : super(automaticallyImplyLeading: automaticallyImplyLeading,automaticallyImplyMiddle: automaticallyImplyMiddle,backgroundColor: backgroundColor,border: border,brightness: brightness,heroTag: heroTag,key: key,leading: leading,middle: middle,padding: padding,previousPageTitle: previousPageTitle,trailing: trailing,transitionBetweenRoutes: transitionBetweenRoutes) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'automaticallyImplyMiddle'
] = _36c2.maybeBoxObject(object: this.automaticallyImplyMiddle, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'previousPageTitle'
...
table['_dart_shouldFullyObstruct'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.shouldFullyObstruct(
...
_5cb5.CupertinoNavigationBar unwrap() => this;
_5cb5.CupertinoNavigationBar get vmObject => this;
@_fac9.override _fac9.bool shouldFullyObstruct(context) { 
_36c2.Closure closure = table["shouldFullyObstruct"];
...
@_fac9.override _e2dc.State<_5cb5.CupertinoNavigationBar> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_5cb5.CupertinoNavigationBar>, _5cb5.CupertinoNavigationBar>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoNavigationBar({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoNavigationBar(table: luaCallerArguments  [
0
], hydroState: hydroState, automaticallyImplyLeading: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'automaticallyImplyLeading'
] : null, automaticallyImplyMiddle: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'automaticallyImplyMiddle'
...
_36c2.registerBoxer<_5cb5.CupertinoNavigationBar>(boxer: ({required _5cb5.CupertinoNavigationBar vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoNavigationBar(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

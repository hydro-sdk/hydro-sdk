...
class VMManagedCupertinoPageTransition extends _36c2.VMManagedBox<_76db.CupertinoPageTransition> {VMManagedCupertinoPageTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _76db.CupertinoPageTransition vmObject;

 }

class RTManagedCupertinoPageTransition extends _76db.CupertinoPageTransition implements _36c2.Box<_76db.CupertinoPageTransition> {RTManagedCupertinoPageTransition({_ab4a.Key? key, required _e2dc.Widget child, required _fac9.bool linearTransition, required _86ca.Animation<_fac9.double> primaryRouteAnimation, required _86ca.Animation<_fac9.double> secondaryRouteAnimation, required this.table, required this.hydroState}) : super(key: key,child: child,linearTransition: linearTransition,primaryRouteAnimation: primaryRouteAnimation,secondaryRouteAnimation: secondaryRouteAnimation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_76db.CupertinoPageTransition unwrap() => this;
_76db.CupertinoPageTransition get vmObject => this;
...
void loadCupertinoPageTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoPageTransition(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_76db.CupertinoPageTransition>(boxer: ({required _76db.CupertinoPageTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPageTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

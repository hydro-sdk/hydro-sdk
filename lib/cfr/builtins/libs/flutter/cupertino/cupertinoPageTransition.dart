...
class VMManagedCupertinoPageTransition
    extends _36c2.VMManagedBox<_76db.CupertinoPageTransition> {
  VMManagedCupertinoPageTransition(
...
class RTManagedCupertinoPageTransition extends _76db.CupertinoPageTransition
  ...
  RTManagedCupertinoPageTransition(
      {_ab4a.Key? key,
...
void loadCupertinoPageTransition(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoPageTransition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoPageTransition(
  ...
  _36c2.registerBoxer<_76db.CupertinoPageTransition>(boxer: (
      {required _76db.CupertinoPageTransition vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoPageTransition(

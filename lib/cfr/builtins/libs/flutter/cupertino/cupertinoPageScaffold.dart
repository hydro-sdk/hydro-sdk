...
class VMManagedCupertinoPageScaffold
    extends _36c2.VMManagedBox<_130f.CupertinoPageScaffold> {
  VMManagedCupertinoPageScaffold(
    ...
    table['navigationBar'] =
        _36c2.maybeBoxObject<_130f.ObstructingPreferredSizeWidget?>(
            object: vmObject.navigationBar,
            hydroState: hydroState,
...
class RTManagedCupertinoPageScaffold extends _130f.CupertinoPageScaffold
    implements _36c2.Box<_130f.CupertinoPageScaffold> {
  RTManagedCupertinoPageScaffold(
      {_a643.Color? backgroundColor,
      _ab4a.Key? key,
      _130f.ObstructingPreferredSizeWidget? navigationBar,
    ...
    table['navigationBar'] = _36c2.maybeBoxObject(
        object: this.navigationBar,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _e2dc.State<_130f.CupertinoPageScaffold> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_130f.CupertinoPageScaffold>,
            _130f.CupertinoPageScaffold>(
...
void loadCupertinoPageScaffold(
  ...
  table['cupertinoPageScaffold'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoPageScaffold(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          navigationBar:
              _36c2.maybeUnBoxAndBuildArgument<_130f.ObstructingPreferredSizeWidget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['navigationBar'] : null,
                  parentState: hydroState),
          resizeToAvoidBottomInset: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['resizeToAvoidBottomInset']
              : null,
  ...
  _36c2.registerBoxer<_130f.CupertinoPageScaffold>(boxer: (
      {required _130f.CupertinoPageScaffold vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoPageScaffold(

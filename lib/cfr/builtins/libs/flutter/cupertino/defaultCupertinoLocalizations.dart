...
class VMManagedDefaultCupertinoLocalizations
    extends _36c2.VMManagedBox<_d48f.DefaultCupertinoLocalizations> {
  VMManagedDefaultCupertinoLocalizations(
    ...
    table['timerPickerHourLabel'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.timerPickerHourLabel(luaCallerArguments[1]),
      ];
    });
...
class RTManagedDefaultCupertinoLocalizations
    extends _d48f.DefaultCupertinoLocalizations
    implements _36c2.Box<_d48f.DefaultCupertinoLocalizations> {
  RTManagedDefaultCupertinoLocalizations(
...
void loadDefaultCupertinoLocalizations(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultCupertinoLocalizations'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultCupertinoLocalizations(
  ...
  table['defaultCupertinoLocalizationsLoad'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_7de1.Future>(
          object: _d48f.DefaultCupertinoLocalizations.load(
  ...
  _36c2.registerBoxer<_d48f.DefaultCupertinoLocalizations>(boxer: (
      {required _d48f.DefaultCupertinoLocalizations vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultCupertinoLocalizations(

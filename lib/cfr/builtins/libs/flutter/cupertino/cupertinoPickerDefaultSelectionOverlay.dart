...
class VMManagedCupertinoPickerDefaultSelectionOverlay extends _36c2.VMManagedBox<_bc40.CupertinoPickerDefaultSelectionOverlay> {VMManagedCupertinoPickerDefaultSelectionOverlay({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'capLeftEdge'
] = vmObject.capLeftEdge;
table  [
'capRightEdge'
] = vmObject.capRightEdge;
table  [
'background'
] = _36c2.maybeBoxObject<_a643.Color>(object: vmObject.background, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _bc40.CupertinoPickerDefaultSelectionOverlay vmObject;

 }

class RTManagedCupertinoPickerDefaultSelectionOverlay extends _bc40.CupertinoPickerDefaultSelectionOverlay implements _36c2.Box<_bc40.CupertinoPickerDefaultSelectionOverlay> {RTManagedCupertinoPickerDefaultSelectionOverlay({required _a643.Color background, required _fac9.bool capLeftEdge, required _fac9.bool capRightEdge, _ab4a.Key? key, required this.table, required this.hydroState}) : super(background: background,capLeftEdge: capLeftEdge,capRightEdge: capRightEdge,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'capLeftEdge'
] = _36c2.maybeBoxObject(object: this.capLeftEdge, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'capRightEdge'
] = _36c2.maybeBoxObject(object: this.capRightEdge, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'background'
...
_bc40.CupertinoPickerDefaultSelectionOverlay unwrap() => this;
_bc40.CupertinoPickerDefaultSelectionOverlay get vmObject => this;
...
void loadCupertinoPickerDefaultSelectionOverlay({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoPickerDefaultSelectionOverlay'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedCupertinoPickerDefaultSelectionOverlay(table: luaCallerArguments  [
0
], hydroState: hydroState, background: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'background'
] : null, parentState: hydroState), capLeftEdge: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'capLeftEdge'
] : null, capRightEdge: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'capRightEdge'
...
_36c2.registerBoxer<_bc40.CupertinoPickerDefaultSelectionOverlay>(boxer: ({required _bc40.CupertinoPickerDefaultSelectionOverlay vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPickerDefaultSelectionOverlay(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

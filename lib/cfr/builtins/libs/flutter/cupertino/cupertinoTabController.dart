...
class VMManagedCupertinoTabController
    extends _36c2.VMManagedBox<_9550.CupertinoTabController> {
  VMManagedCupertinoTabController(
...
class RTManagedCupertinoTabController extends _9550.CupertinoTabController
    implements _36c2.Box<_9550.CupertinoTabController> {
  RTManagedCupertinoTabController(
...
void loadCupertinoTabController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoTabController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoTabController(
  ...
  _36c2.registerBoxer<_9550.CupertinoTabController>(boxer: (
      {required _9550.CupertinoTabController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTabController(

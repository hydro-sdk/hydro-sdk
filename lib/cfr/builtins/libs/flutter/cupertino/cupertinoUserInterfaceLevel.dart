...
import 'package:flutter/src/cupertino/interface_level.dart' as _90a6;
...
class VMManagedCupertinoUserInterfaceLevel extends _36c2.VMManagedBox<_90a6.CupertinoUserInterfaceLevel> {VMManagedCupertinoUserInterfaceLevel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'updateShouldNotify'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<_90a6.CupertinoUserInterfaceLevel, _fac9.dynamic>(luaCallerArguments  [
1
...
final _90a6.CupertinoUserInterfaceLevel vmObject;

 }

class RTManagedCupertinoUserInterfaceLevel extends _90a6.CupertinoUserInterfaceLevel implements _36c2.Box<_90a6.CupertinoUserInterfaceLevel> {RTManagedCupertinoUserInterfaceLevel({_ab4a.Key? key, required _e2dc.Widget child, required _90a6.CupertinoUserInterfaceLevelData data, required this.table, required this.hydroState}) : super(key: key,child: child,data: data) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
            _90a6.CupertinoUserInterfaceLevel,
...
_90a6.CupertinoUserInterfaceLevel unwrap() => this;
_90a6.CupertinoUserInterfaceLevel get vmObject => this;
...
void loadCupertinoUserInterfaceLevel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoUserInterfaceLevel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCupertinoUserInterfaceLevel(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), data: _36c2.maybeUnBoxEnum(values: _90a6.CupertinoUserInterfaceLevelData.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'data'
] : null))]; } );
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_90a6.CupertinoUserInterfaceLevelData.values.indexWhere((x) { return x == _90a6.CupertinoUserInterfaceLevel.of(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)); } ),]; } );
table  [
'cupertinoUserInterfaceLevelMaybeOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _90a6.CupertinoUserInterfaceLevel.maybeOf(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));if(returnValue!= null){return [_90a6.CupertinoUserInterfaceLevelData.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
_36c2.registerBoxer<_90a6.CupertinoUserInterfaceLevel>(boxer: ({required _90a6.CupertinoUserInterfaceLevel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoUserInterfaceLevel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCupertinoFullscreenDialogTransition extends _36c2.VMManagedBox<_76db.CupertinoFullscreenDialogTransition> {VMManagedCupertinoFullscreenDialogTransition({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _76db.CupertinoFullscreenDialogTransition vmObject;

 }

class RTManagedCupertinoFullscreenDialogTransition extends _76db.CupertinoFullscreenDialogTransition implements _36c2.Box<_76db.CupertinoFullscreenDialogTransition> {RTManagedCupertinoFullscreenDialogTransition({_ab4a.Key? key, required _e2dc.Widget child, required _fac9.bool linearTransition, required _86ca.Animation<_fac9.double> primaryRouteAnimation, required _86ca.Animation<_fac9.double> secondaryRouteAnimation, required this.table, required this.hydroState}) : super(key: key,child: child,linearTransition: linearTransition,primaryRouteAnimation: primaryRouteAnimation,secondaryRouteAnimation: secondaryRouteAnimation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_76db.CupertinoFullscreenDialogTransition unwrap() => this;
_76db.CupertinoFullscreenDialogTransition get vmObject => this;
...
void loadCupertinoFullscreenDialogTransition({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoFullscreenDialogTransition(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), linearTransition: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'linearTransition'
] : null, primaryRouteAnimation: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'primaryRouteAnimation'
] : null, parentState: hydroState), secondaryRouteAnimation: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'secondaryRouteAnimation'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_76db.CupertinoFullscreenDialogTransition>(boxer: ({required _76db.CupertinoFullscreenDialogTransition vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoFullscreenDialogTransition(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

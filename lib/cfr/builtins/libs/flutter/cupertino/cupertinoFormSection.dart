...
class VMManagedCupertinoFormSection extends _36c2.VMManagedBox<_a817.CupertinoFormSection> {VMManagedCupertinoFormSection({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'header'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.header, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'footer'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.footer, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'margin'
...
class RTManagedCupertinoFormSection extends _a817.CupertinoFormSection implements _36c2.Box<_a817.CupertinoFormSection> {RTManagedCupertinoFormSection({required _a643.Color backgroundColor, required _a643.Clip clipBehavior, _51e4.BoxDecoration? decoration, _e2dc.Widget? footer, _e2dc.Widget? header, _ab4a.Key? key, required _96d1.EdgeInsetsGeometry margin, required _fac9.List<_e2dc.Widget> children, required this.table, required this.hydroState}) : super(backgroundColor: backgroundColor,clipBehavior: clipBehavior,decoration: decoration,footer: footer,header: header,key: key,margin: margin,children: children) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadCupertinoFormSection({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoFormSection(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), decoration: _36c2.maybeUnBoxAndBuildArgument<_51e4.BoxDecoration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decoration'
] : null, parentState: hydroState), footer: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'footer'
] : null, parentState: hydroState), header: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'header'
...
_36c2.registerBoxer<_a817.CupertinoFormSection>(boxer: ({required _a817.CupertinoFormSection vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoFormSection(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

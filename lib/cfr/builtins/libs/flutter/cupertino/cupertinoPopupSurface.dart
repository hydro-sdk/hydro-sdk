...
class VMManagedCupertinoPopupSurface extends _36c2.VMManagedBox<_f246.CupertinoPopupSurface> {VMManagedCupertinoPopupSurface({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'isSurfacePainted'
] = vmObject.isSurfacePainted;
table  [
'child'
...
final _f246.CupertinoPopupSurface vmObject;

 }

class RTManagedCupertinoPopupSurface extends _f246.CupertinoPopupSurface implements _36c2.Box<_f246.CupertinoPopupSurface> {RTManagedCupertinoPopupSurface({_e2dc.Widget? child, required _fac9.bool isSurfacePainted, _ab4a.Key? key, required this.table, required this.hydroState}) : super(child: child,isSurfacePainted: isSurfacePainted,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'isSurfacePainted'
] = _36c2.maybeBoxObject(object: this.isSurfacePainted, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_f246.CupertinoPopupSurface unwrap() => this;
_f246.CupertinoPopupSurface get vmObject => this;
...
void loadCupertinoPopupSurface({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoPopupSurface'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCupertinoPopupSurface(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), isSurfacePainted: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isSurfacePainted'
...
_36c2.registerBoxer<_f246.CupertinoPopupSurface>(boxer: ({required _f246.CupertinoPopupSurface vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPopupSurface(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

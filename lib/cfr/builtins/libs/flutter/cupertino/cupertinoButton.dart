...
class VMManagedCupertinoButton extends _36c2.VMManagedBox<_1576.CupertinoButton> {VMManagedCupertinoButton({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'disabledColor'
] = _36c2.maybeBoxObject<_a643.Color>(object: vmObject.disabledColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minSize'
] = vmObject.minSize;
table  [
'pressedOpacity'
] = vmObject.pressedOpacity;
table  [
'borderRadius'
...
class RTManagedCupertinoButton extends _1576.CupertinoButton implements _36c2.Box<_1576.CupertinoButton> {RTManagedCupertinoButton({required _ca85.AlignmentGeometry alignment, _9d8a.BorderRadius? borderRadius, _a643.Color? color, required _a643.Color disabledColor, _ab4a.Key? key, _fac9.double? minSize, _96d1.EdgeInsetsGeometry? padding, _fac9.double? pressedOpacity, required _e2dc.Widget child, void Function()? onPressed, required this.table, required this.hydroState}) : super(alignment: alignment,borderRadius: borderRadius,color: color,disabledColor: disabledColor,key: key,minSize: minSize,padding: padding,pressedOpacity: pressedOpacity,child: child,onPressed: onPressed) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'disabledColor'
] = _36c2.maybeBoxObject(object: this.disabledColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minSize'
] = _36c2.maybeBoxObject(object: this.minSize, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pressedOpacity'
] = _36c2.maybeBoxObject(object: this.pressedOpacity, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'borderRadius'
...
@_fac9.override _e2dc.State<_1576.CupertinoButton> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_1576.CupertinoButton>, _1576.CupertinoButton>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoButton({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoButton'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonPressed=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onPressed'
] : null;
return  [RTManagedCupertinoButton(table: luaCallerArguments  [
0
...
'color'
] : null, parentState: hydroState), disabledColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'disabledColor'
...
'key'
] : null, parentState: hydroState), minSize: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'minSize'
] : null?.toDouble(), padding: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'padding'
] : null, parentState: hydroState), pressedOpacity: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pressedOpacity'
...
'child'
] : null, parentState: hydroState), onPressed: unpackedonPressed != null ? () => unpackedonPressed.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null )]; } );
_36c2.registerBoxer<_1576.CupertinoButton>(boxer: ({required _1576.CupertinoButton vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoButton(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

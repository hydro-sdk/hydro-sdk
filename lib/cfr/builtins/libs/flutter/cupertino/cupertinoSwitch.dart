...
import 'package:flutter/src/cupertino/switch.dart' as _02c2;
...
class VMManagedCupertinoSwitch extends _36c2.VMManagedBox<_02c2.CupertinoSwitch> {VMManagedCupertinoSwitch({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'trackColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.trackColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'thumbColor'
...
final _02c2.CupertinoSwitch vmObject;

 }

class RTManagedCupertinoSwitch extends _02c2.CupertinoSwitch implements _36c2.Box<_02c2.CupertinoSwitch> {RTManagedCupertinoSwitch({_a643.Color? activeColor, required _02d2.DragStartBehavior dragStartBehavior, _ab4a.Key? key, _a643.Color? thumbColor, _a643.Color? trackColor, void Function(_fac9.bool value)? onChanged, required _fac9.bool value, required this.table, required this.hydroState}) : super(activeColor: activeColor,dragStartBehavior: dragStartBehavior,key: key,thumbColor: thumbColor,trackColor: trackColor,onChanged: onChanged,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'trackColor'
] = _36c2.maybeBoxObject(object: this.trackColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'thumbColor'
...
_02c2.CupertinoSwitch unwrap() => this;
_02c2.CupertinoSwitch get vmObject => this;
@_fac9.override _e2dc.State<_02c2.CupertinoSwitch> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_02c2.CupertinoSwitch>, _02c2.CupertinoSwitch>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoSwitch({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoSwitch'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoSwitch(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_02c2.CupertinoSwitch>(boxer: ({required _02c2.CupertinoSwitch vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoSwitch(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCupertinoSwitch
    extends _36c2.VMManagedBox<_02c2.CupertinoSwitch> {
  VMManagedCupertinoSwitch(
    ...
    table['trackColor'] = _36c2.maybeBoxObject<_a643.Color?>(
...
class RTManagedCupertinoSwitch extends _02c2.CupertinoSwitch
  ...
  @_fac9.override
  _e2dc.State<_02c2.CupertinoSwitch> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_02c2.CupertinoSwitch>,
            _02c2.CupertinoSwitch>(
...
void loadCupertinoSwitch(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoSwitch'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedCupertinoSwitch(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          thumbColor:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['thumbColor'] : null,
                  parentState: hydroState),
          trackColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['trackColor'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_02c2.CupertinoSwitch>(boxer: (
      {required _02c2.CupertinoSwitch vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoSwitch(

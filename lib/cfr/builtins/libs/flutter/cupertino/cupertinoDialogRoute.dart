...
class VMManagedCupertinoDialogRoute extends _36c2.VMManagedBox<_76db.CupertinoDialogRoute<_fac9.dynamic>> {VMManagedCupertinoDialogRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _76db.CupertinoDialogRoute<_fac9.dynamic> vmObject;

 }

class RTManagedCupertinoDialogRoute extends _76db.CupertinoDialogRoute implements _36c2.Box<_76db.CupertinoDialogRoute> {RTManagedCupertinoDialogRoute({_a643.Color? barrierColor, required _fac9.bool barrierDismissible, _fac9.String? barrierLabel, _a37d.RouteSettings? settings, _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _86ca.Animation<_fac9.double> secondaryAnimation, _e2dc.Widget child)? transitionBuilder, required _fac9.Duration transitionDuration, required _e2dc.Widget Function(_e2dc.BuildContext context) builder, required _e2dc.BuildContext context, required this.table, required this.hydroState}) : super(barrierColor: barrierColor,barrierDismissible: barrierDismissible,barrierLabel: barrierLabel,settings: settings,transitionBuilder: transitionBuilder,transitionDuration: transitionDuration,builder: builder,context: context) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_76db.CupertinoDialogRoute unwrap() => this;
_76db.CupertinoDialogRoute get vmObject => this;
...
void loadCupertinoDialogRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoDialogRoute(table: luaCallerArguments  [
0
...
'transitionDuration'
] : null, parentState: hydroState), builder: (context) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context],parentState:hydroState,)[0], parentState: hydroState), context: _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'context'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_76db.CupertinoDialogRoute>(boxer: ({required _76db.CupertinoDialogRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoDialogRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

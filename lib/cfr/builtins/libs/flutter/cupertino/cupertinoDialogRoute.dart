...
class VMManagedCupertinoDialogRoute
    extends _36c2.VMManagedBox<_76db.CupertinoDialogRoute<_fac9.dynamic>> {
  VMManagedCupertinoDialogRoute(
...
void loadCupertinoDialogRoute(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoDialogRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_76db.CupertinoDialogRoute>(boxer: (
      {required _76db.CupertinoDialogRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoDialogRoute(

...
class VMManagedCupertinoContextMenu
    extends _36c2.VMManagedBox<_c310.CupertinoContextMenu> {
  VMManagedCupertinoContextMenu(
...
class RTManagedCupertinoContextMenu extends _c310.CupertinoContextMenu
    implements _36c2.Box<_c310.CupertinoContextMenu> {
  RTManagedCupertinoContextMenu(
      {_ab4a.Key? key,
  ...
  @_fac9.override
  _e2dc.State<_c310.CupertinoContextMenu> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_c310.CupertinoContextMenu>,
            _c310.CupertinoContextMenu>(
...
void loadCupertinoContextMenu(
  ...
  table['cupertinoContextMenu'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedpreviewBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['previewBuilder']
        : null;
      ...
      RTManagedCupertinoContextMenu(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          previewBuilder: unpackedpreviewBuilder != null
              ? (context, animation, child) =>
                  _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                      unpackedpreviewBuilder.dispatch(
  ...
  _36c2.registerBoxer<_c310.CupertinoContextMenu>(boxer: (
      {required _c310.CupertinoContextMenu vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoContextMenu(

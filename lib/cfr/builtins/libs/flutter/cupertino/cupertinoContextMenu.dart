...
import 'package:flutter/src/cupertino/context_menu.dart' as _c310;
...
class VMManagedCupertinoContextMenu extends _36c2.VMManagedBox<_c310.CupertinoContextMenu> {VMManagedCupertinoContextMenu({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _c310.CupertinoContextMenu vmObject;

 }

class RTManagedCupertinoContextMenu extends _c310.CupertinoContextMenu implements _36c2.Box<_c310.CupertinoContextMenu> {RTManagedCupertinoContextMenu({_ab4a.Key? key, _e2dc.Widget Function(_e2dc.BuildContext context, _86ca.Animation<_fac9.double> animation, _e2dc.Widget child)? previewBuilder, required _fac9.List<_e2dc.Widget> actions, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,previewBuilder: previewBuilder,actions: actions,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_c310.CupertinoContextMenu unwrap() => this;
_c310.CupertinoContextMenu get vmObject => this;
@_fac9.override _e2dc.State<_c310.CupertinoContextMenu> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_c310.CupertinoContextMenu>, _c310.CupertinoContextMenu>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoContextMenu({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoContextMenu'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure? unpackedpreviewBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'previewBuilder'
] : null;
...
return  [RTManagedCupertinoContextMenu(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), previewBuilder: unpackedpreviewBuilder != null ? (context, animation, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedpreviewBuilder.dispatch([luaCallerArguments[0],context,animation,child],parentState:hydroState,)[0], parentState: hydroState) : null , actions: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'actions'
...
_36c2.registerBoxer<_c310.CupertinoContextMenu>(boxer: ({required _c310.CupertinoContextMenu vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoContextMenu(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCupertinoThumbPainter extends _36c2.VMManagedBox<_7515.CupertinoThumbPainter> {VMManagedCupertinoThumbPainter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedCupertinoThumbPainter extends _7515.CupertinoThumbPainter implements _36c2.Box<_7515.CupertinoThumbPainter> {RTManagedCupertinoThumbPainter({required _a643.Color color, required _fac9.List<_9068.BoxShadow> shadows, required this.table, required this.hydroState}) : super(color: color,shadows: shadows) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override void paint(canvas, rect) { 
_36c2.Closure closure = table["paint"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
 }
void loadCupertinoThumbPainter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoThumbPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedCupertinoThumbPainter(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7515.CupertinoThumbPainter>(boxer: ({required _7515.CupertinoThumbPainter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoThumbPainter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

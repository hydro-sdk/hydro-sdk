...
class VMManagedCupertinoPage extends _36c2.VMManagedBox<_76db.CupertinoPage<_fac9.dynamic>> {VMManagedCupertinoPage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedCupertinoPage extends _76db.CupertinoPage implements _36c2.Box<_76db.CupertinoPage> {RTManagedCupertinoPage({_fac9.Object? arguments, required _fac9.bool fullscreenDialog, _ab4a.LocalKey? key, required _fac9.bool maintainState, _fac9.String? name, _fac9.String? restorationId, _fac9.String? title, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(arguments: arguments,fullscreenDialog: fullscreenDialog,key: key,maintainState: maintainState,name: name,restorationId: restorationId,title: title,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadCupertinoPage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoPage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoPage(table: luaCallerArguments  [
0
...
'arguments'
] : null, parentState: hydroState), fullscreenDialog: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fullscreenDialog'
] : null, key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.LocalKey?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null, parentState: hydroState), maintainState: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maintainState'
...
'restorationId'
] : null, title: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'title'
...
_36c2.registerBoxer<_76db.CupertinoPage>(boxer: ({required _76db.CupertinoPage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

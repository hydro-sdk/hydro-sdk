...
class VMManagedCupertinoThemeData extends _36c2.VMManagedBox<_2b5f.CupertinoThemeData> {VMManagedCupertinoThemeData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getPrimaryColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Color>(object: vmObject.primaryColor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getPrimaryContrastingColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Color>(object: vmObject.primaryContrastingColor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getTextTheme'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_1bc7.CupertinoTextThemeData>(object: vmObject.textTheme, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getBarBackgroundColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Color>(object: vmObject.barBackgroundColor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getScaffoldBackgroundColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Color>(object: vmObject.scaffoldBackgroundColor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'noDefault'
...
table  [
'resolveFrom'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_2b5f.CupertinoThemeData>(object: vmObject.resolveFrom(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
return [_36c2.maybeBoxObject<_2b5f.CupertinoThemeData>(object: vmObject.copyWith(barBackgroundColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'barBackgroundColor'
...
table['_dart_getPrimaryColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.primaryColor];
});
table['_dart_getPrimaryContrastingColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.primaryContrastingColor];
});
table['_dart_getTextTheme'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.textTheme];
});
table['_dart_getBarBackgroundColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.barBackgroundColor];
});
table['_dart_getScaffoldBackgroundColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override _a643.Color get primaryColor { 
...
@_fac9.override _a643.Color get primaryContrastingColor { 
_36c2.Closure closure = table["getPrimaryContrastingColor"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _1bc7.CupertinoTextThemeData get textTheme { 
...
@_fac9.override _a643.Color get barBackgroundColor { 
_36c2.Closure closure = table["getBarBackgroundColor"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _a643.Color get scaffoldBackgroundColor { 
...
@_fac9.override _2b5f.CupertinoThemeData resolveFrom(context) { 
_36c2.Closure closure = table["resolveFrom"];
return _36c2.maybeUnBoxAndBuildArgument<_2b5f.CupertinoThemeData, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _2b5f.CupertinoThemeData copyWith({_a643.Color? barBackgroundColor, _a643.Brightness? brightness, _a643.Color? primaryColor, _a643.Color? primaryContrastingColor, _a643.Color? scaffoldBackgroundColor, _1bc7.CupertinoTextThemeData? textTheme}) { 
...
void loadCupertinoThemeData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoThemeData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoThemeData(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2b5f.CupertinoThemeData>(boxer: ({required _2b5f.CupertinoThemeData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoThemeData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

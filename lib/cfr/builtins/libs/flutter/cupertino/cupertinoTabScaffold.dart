...
class VMManagedCupertinoTabScaffold
    extends _36c2.VMManagedBox<_9550.CupertinoTabScaffold> {
  VMManagedCupertinoTabScaffold(
    ...
    table['tabBar'] = _36c2.maybeBoxObject<_96db.CupertinoTabBar>(
        object: vmObject.tabBar,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['controller'] = _36c2.maybeBoxObject<_9550.CupertinoTabController?>(
...
class RTManagedCupertinoTabScaffold extends _9550.CupertinoTabScaffold
    implements _36c2.Box<_9550.CupertinoTabScaffold> {
  RTManagedCupertinoTabScaffold(
      {_a643.Color? backgroundColor,
      _9550.CupertinoTabController? controller,
      _ab4a.Key? key,
      required _fac9.bool resizeToAvoidBottomInset,
      _fac9.String? restorationId,
      required _96db.CupertinoTabBar tabBar,
    ...
    table['tabBar'] = _36c2.maybeBoxObject(
        object: this.tabBar, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _e2dc.State<_9550.CupertinoTabScaffold> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_9550.CupertinoTabScaffold>,
            _9550.CupertinoTabScaffold>(
...
void loadCupertinoTabScaffold(
  ...
  table['cupertinoTabScaffold'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedtabBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['tabBuilder']
        : null;
    return [
      RTManagedCupertinoTabScaffold(
          ...
          backgroundColor:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
                  ...
                  parentState: hydroState),
          controller:
              _36c2.maybeUnBoxAndBuildArgument<_9550.CupertinoTabController?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
          ...
          tabBar: _36c2.maybeUnBoxAndBuildArgument<_96db.CupertinoTabBar, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['tabBar'] : null, parentState: hydroState),
          tabBuilder: (context, index) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              unpackedtabBuilder.dispatch(
  ...
  _36c2.registerBoxer<_9550.CupertinoTabScaffold>(boxer: (
      {required _9550.CupertinoTabScaffold vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTabScaffold(

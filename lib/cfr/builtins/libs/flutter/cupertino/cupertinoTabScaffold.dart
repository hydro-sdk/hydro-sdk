...
class VMManagedCupertinoTabScaffold extends _36c2.VMManagedBox<_9550.CupertinoTabScaffold> {VMManagedCupertinoTabScaffold({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'tabBar'
] = _36c2.maybeBoxObject<_96db.CupertinoTabBar>(object: vmObject.tabBar, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'controller'
] = _36c2.maybeBoxObject<_9550.CupertinoTabController?>(object: vmObject.controller, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'backgroundColor'
...
final _9550.CupertinoTabScaffold vmObject;

 }

class RTManagedCupertinoTabScaffold extends _9550.CupertinoTabScaffold implements _36c2.Box<_9550.CupertinoTabScaffold> {RTManagedCupertinoTabScaffold({_a643.Color? backgroundColor, _9550.CupertinoTabController? controller, _ab4a.Key? key, required _fac9.bool resizeToAvoidBottomInset, _fac9.String? restorationId, required _96db.CupertinoTabBar tabBar, required _e2dc.Widget Function(_e2dc.BuildContext context, _fac9.int index) tabBuilder, required this.table, required this.hydroState}) : super(backgroundColor: backgroundColor,controller: controller,key: key,resizeToAvoidBottomInset: resizeToAvoidBottomInset,restorationId: restorationId,tabBar: tabBar,tabBuilder: tabBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'tabBar'
] = _36c2.maybeBoxObject(object: this.tabBar, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'controller'
...
_9550.CupertinoTabScaffold unwrap() => this;
_9550.CupertinoTabScaffold get vmObject => this;
@_fac9.override _e2dc.State<_9550.CupertinoTabScaffold> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_9550.CupertinoTabScaffold>, _9550.CupertinoTabScaffold>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoTabScaffold({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
_36c2.Closure unpackedtabBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'tabBuilder'
] : null;
return  [RTManagedCupertinoTabScaffold(table: luaCallerArguments  [
0
...
'backgroundColor'
] : null, parentState: hydroState), controller: _36c2.maybeUnBoxAndBuildArgument<_9550.CupertinoTabController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
...
'restorationId'
] : null, tabBar: _36c2.maybeUnBoxAndBuildArgument<_96db.CupertinoTabBar, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'tabBar'
] : null, parentState: hydroState), tabBuilder: (context, index) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedtabBuilder.dispatch([luaCallerArguments[0],context,index],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_9550.CupertinoTabScaffold>(boxer: ({required _9550.CupertinoTabScaffold vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoTabScaffold(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

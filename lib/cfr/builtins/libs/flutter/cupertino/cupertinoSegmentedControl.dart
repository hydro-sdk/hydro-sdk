...
class VMManagedCupertinoSegmentedControl extends _36c2.VMManagedBox<_ad35.CupertinoSegmentedControl<_fac9.Object>> {VMManagedCupertinoSegmentedControl({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'children'
] = _36c2.maybeBoxObject<_fac9.Map>(object: vmObject.children, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'unselectedColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.unselectedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'selectedColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.selectedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'borderColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.borderColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pressedColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.pressedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'padding'
...
class RTManagedCupertinoSegmentedControl extends _ad35.CupertinoSegmentedControl implements _36c2.Box<_ad35.CupertinoSegmentedControl> {RTManagedCupertinoSegmentedControl({_a643.Color? borderColor, _fac9.Object? groupValue, _ab4a.Key? key, _96d1.EdgeInsetsGeometry? padding, _a643.Color? pressedColor, _a643.Color? selectedColor, _a643.Color? unselectedColor, required _fac9.Map<_fac9.Object,_e2dc.Widget> children, required void Function(_fac9.Object value) onValueChanged, required this.table, required this.hydroState}) : super(borderColor: borderColor,groupValue: groupValue,key: key,padding: padding,pressedColor: pressedColor,selectedColor: selectedColor,unselectedColor: unselectedColor,children: children,onValueChanged: onValueChanged) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'unselectedColor'
] = _36c2.maybeBoxObject(object: this.unselectedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'selectedColor'
] = _36c2.maybeBoxObject(object: this.selectedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'borderColor'
] = _36c2.maybeBoxObject(object: this.borderColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pressedColor'
] = _36c2.maybeBoxObject(object: this.pressedColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'padding'
...
@_fac9.override _e2dc.State<_ad35.CupertinoSegmentedControl<_fac9.Object>> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_ad35.CupertinoSegmentedControl<_fac9.Object>>, _ad35.CupertinoSegmentedControl<_fac9.Object>>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoSegmentedControl({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
_36c2.Closure unpackedonValueChanged=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onValueChanged'
] : null;
return  [RTManagedCupertinoSegmentedControl(table: luaCallerArguments  [
0
], hydroState: hydroState, borderColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderColor'
] : null, parentState: hydroState), groupValue: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'groupValue'
...
'padding'
] : null, parentState: hydroState), pressedColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pressedColor'
] : null, parentState: hydroState), selectedColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'selectedColor'
] : null, parentState: hydroState), unselectedColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'unselectedColor'
] : null, parentState: hydroState), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.dynamic,_e2dc.Widget>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
] : null, parentState: hydroState), onValueChanged: (value) => unpackedonValueChanged.dispatch([luaCallerArguments[0],value],parentState:hydroState,))]; } );
_36c2.registerBoxer<_ad35.CupertinoSegmentedControl>(boxer: ({required _ad35.CupertinoSegmentedControl vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoSegmentedControl(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
import 'package:flutter/src/cupertino/text_selection.dart' as _7a1b;
...
class VMManagedCupertinoTextSelectionControls extends _36c2.VMManagedBox<_7a1b.CupertinoTextSelectionControls> {VMManagedCupertinoTextSelectionControls({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7a1b.CupertinoTextSelectionControls vmObject;

 }

class RTManagedCupertinoTextSelectionControls extends _7a1b.CupertinoTextSelectionControls implements _36c2.Box<_7a1b.CupertinoTextSelectionControls> {RTManagedCupertinoTextSelectionControls({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7a1b.CupertinoTextSelectionControls unwrap() => this;
_7a1b.CupertinoTextSelectionControls get vmObject => this;
...
@_fac9.override _e2dc.Widget buildToolbar(context, globalEditableRegion, textLineHeight, selectionMidpoint, endpoints, delegate, clipboardStatus, lastSecondaryTapDownPosition) { 
...
void loadCupertinoTextSelectionControls({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoTextSelectionControls'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedCupertinoTextSelectionControls(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7a1b.CupertinoTextSelectionControls>(boxer: ({required _7a1b.CupertinoTextSelectionControls vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoTextSelectionControls(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

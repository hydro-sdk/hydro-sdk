...
class VMManagedCupertinoIconThemeData
    extends _36c2.VMManagedBox<_e945.CupertinoIconThemeData> {
  VMManagedCupertinoIconThemeData(
    ...
    table['copyWith'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_e945.CupertinoIconThemeData>(
...
class RTManagedCupertinoIconThemeData extends _e945.CupertinoIconThemeData
    implements _36c2.Box<_e945.CupertinoIconThemeData> {
  RTManagedCupertinoIconThemeData(
      {_a643.Color? color,
  ...
  @_fac9.override
  _e945.CupertinoIconThemeData copyWith(
      {_a643.Color? color, _fac9.double? opacity, _fac9.double? size}) {
    _36c2.Closure closure = table["copyWith"];
    return _36c2.maybeUnBoxAndBuildArgument<_e945.CupertinoIconThemeData,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadCupertinoIconThemeData(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoIconThemeData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoIconThemeData(
  ...
  _36c2.registerBoxer<_e945.CupertinoIconThemeData>(boxer: (
      {required _e945.CupertinoIconThemeData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoIconThemeData(

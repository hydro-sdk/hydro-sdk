...
import 'package:flutter/src/cupertino/form_row.dart' as _ba5a;
...
class VMManagedCupertinoFormRow extends _36c2.VMManagedBox<_ba5a.CupertinoFormRow> {VMManagedCupertinoFormRow({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'helper'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.helper, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'error'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.error, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
final _ba5a.CupertinoFormRow vmObject;

 }

class RTManagedCupertinoFormRow extends _ba5a.CupertinoFormRow implements _36c2.Box<_ba5a.CupertinoFormRow> {RTManagedCupertinoFormRow({_e2dc.Widget? error, _e2dc.Widget? helper, _ab4a.Key? key, _96d1.EdgeInsetsGeometry? padding, _e2dc.Widget? prefix, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(error: error,helper: helper,key: key,padding: padding,prefix: prefix,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'helper'
] = _36c2.maybeBoxObject(object: this.helper, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'error'
] = _36c2.maybeBoxObject(object: this.error, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
_ba5a.CupertinoFormRow unwrap() => this;
_ba5a.CupertinoFormRow get vmObject => this;
...
void loadCupertinoFormRow({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoFormRow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoFormRow(table: luaCallerArguments  [
0
], hydroState: hydroState, error: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'error'
] : null, parentState: hydroState), helper: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'helper'
...
_36c2.registerBoxer<_ba5a.CupertinoFormRow>(boxer: ({required _ba5a.CupertinoFormRow vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoFormRow(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCupertinoNavigationBarBackButton
    extends _36c2.VMManagedBox<_5cb5.CupertinoNavigationBarBackButton> {
  VMManagedCupertinoNavigationBarBackButton(
...
class RTManagedCupertinoNavigationBarBackButton
    extends _5cb5.CupertinoNavigationBarBackButton
    implements _36c2.Box<_5cb5.CupertinoNavigationBarBackButton> {
  RTManagedCupertinoNavigationBarBackButton(
      {_a643.Color? color,
      _ab4a.Key? key,
...
void loadCupertinoNavigationBarBackButton(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoNavigationBarBackButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedCupertinoNavigationBarBackButton(
          ...
          onPressed: unpackedonPressed != null
              ...
              : null,
          previousPageTitle: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['previousPageTitle']
              : null)
    ];
  });
  _36c2.registerBoxer<_5cb5.CupertinoNavigationBarBackButton>(boxer: (
      {required _5cb5.CupertinoNavigationBarBackButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoNavigationBarBackButton(

...
class VMManagedCupertinoNavigationBarBackButton extends _36c2.VMManagedBox<_5cb5.CupertinoNavigationBarBackButton> {VMManagedCupertinoNavigationBarBackButton({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _5cb5.CupertinoNavigationBarBackButton vmObject;

 }

class RTManagedCupertinoNavigationBarBackButton extends _5cb5.CupertinoNavigationBarBackButton implements _36c2.Box<_5cb5.CupertinoNavigationBarBackButton> {RTManagedCupertinoNavigationBarBackButton({_a643.Color? color, _ab4a.Key? key, void Function()? onPressed, _fac9.String? previousPageTitle, required this.table, required this.hydroState}) : super(color: color,key: key,onPressed: onPressed,previousPageTitle: previousPageTitle) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_5cb5.CupertinoNavigationBarBackButton unwrap() => this;
_5cb5.CupertinoNavigationBarBackButton get vmObject => this;
...
void loadCupertinoNavigationBarBackButton({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoNavigationBarBackButton(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onPressed: unpackedonPressed != null ? () => unpackedonPressed.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , previousPageTitle: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'previousPageTitle'
] : null)]; } );
_36c2.registerBoxer<_5cb5.CupertinoNavigationBarBackButton>(boxer: ({required _5cb5.CupertinoNavigationBarBackButton vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoNavigationBarBackButton(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

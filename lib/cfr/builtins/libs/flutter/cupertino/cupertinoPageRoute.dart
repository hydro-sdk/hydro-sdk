...
class VMManagedCupertinoPageRoute extends _36c2.VMManagedBox<_76db.CupertinoPageRoute<_fac9.dynamic>> {VMManagedCupertinoPageRoute({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'buildContent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e2dc.Widget>(object: vmObject.buildContent(_36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getTitle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.title;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getPreviousTitle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e644.ValueListenable>(object: vmObject.previousTitle, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
...
table  [
'getPopGestureInProgress'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.popGestureInProgress,]; } );
table  [
'getPopGestureEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.popGestureEnabled,]; } );
table  [
'canTransitionFrom'
...
class RTManagedCupertinoPageRoute extends _76db.CupertinoPageRoute implements _36c2.Box<_76db.CupertinoPageRoute> {RTManagedCupertinoPageRoute({required _fac9.bool fullscreenDialog, required _fac9.bool maintainState, _a37d.RouteSettings? settings, _fac9.String? title, required _e2dc.Widget Function(_e2dc.BuildContext context) builder, required this.table, required this.hydroState}) : super(fullscreenDialog: fullscreenDialog,maintainState: maintainState,settings: settings,title: title,builder: builder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_buildContent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.buildContent(
...
table['_dart_getTitle'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [title];
});
table['_dart_getPreviousTitle'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getPopGestureInProgress'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.popGestureInProgress];
});
table['_dart_getPopGestureEnabled'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override _e2dc.Widget buildContent(context) { 
...
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.String? get title { 
_36c2.Closure closure = table["getTitle"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _e644.ValueListenable<_fac9.String?> get previousTitle { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get popGestureInProgress { 
_36c2.Closure closure = table["getPopGestureInProgress"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get popGestureEnabled { 
...
void loadCupertinoPageRoute({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoPageRoute'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoPageRoute(table: luaCallerArguments  [
0
], hydroState: hydroState, fullscreenDialog: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fullscreenDialog'
...
'maintainState'
] : null, settings: _36c2.maybeUnBoxAndBuildArgument<_a37d.RouteSettings?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'settings'
...
'title'
] : null, builder: (context) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedbuilder.dispatch([luaCallerArguments[0],context],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_76db.CupertinoPageRoute>(boxer: ({required _76db.CupertinoPageRoute vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPageRoute(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

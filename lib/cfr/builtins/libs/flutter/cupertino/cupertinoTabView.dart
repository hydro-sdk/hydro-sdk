...
class VMManagedCupertinoTabView
    extends _36c2.VMManagedBox<_13c4.CupertinoTabView> {
  VMManagedCupertinoTabView(
    ...
    table['defaultTitle'] = vmObject.defaultTitle;
...
class RTManagedCupertinoTabView extends _13c4.CupertinoTabView
    implements _36c2.Box<_13c4.CupertinoTabView> {
  RTManagedCupertinoTabView(
      {_e2dc.Widget Function(_e2dc.BuildContext context)? builder,
      _fac9.String? defaultTitle,
      _ab4a.Key? key,
    ...
    table['navigatorKey'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['defaultTitle'] = _36c2.maybeBoxObject(
        object: this.defaultTitle,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _e2dc.State<_13c4.CupertinoTabView> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_13c4.CupertinoTabView>,
            _13c4.CupertinoTabView>(
...
void loadCupertinoTabView(
  ...
  table['cupertinoTabView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
          ...
          builder: unpackedbuilder != null
              ? (context) =>
                  _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                      ...
                      parentState: hydroState)
              : null,
          defaultTitle: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['defaultTitle']
              : null,
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          navigatorKey: _36c2
              .maybeUnBoxAndBuildArgument<_e2dc.GlobalKey<_a37d.NavigatorState>?, _a37d.NavigatorState>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['navigatorKey']
                      : null,
                  parentState: hydroState),
          navigatorObservers: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_a37d.NavigatorObserver>, _a37d.NavigatorObserver>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['navigatorObservers'] : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_13c4.CupertinoTabView>(boxer: (
      {required _13c4.CupertinoTabView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTabView(

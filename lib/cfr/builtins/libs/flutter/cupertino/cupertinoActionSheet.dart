...
class VMManagedCupertinoActionSheet extends _36c2.VMManagedBox<_f246.CupertinoActionSheet> {VMManagedCupertinoActionSheet({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'message'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.message, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'actions'
] = _36c2.maybeBoxObject<_fac9.List<_e2dc.Widget>?>(object: vmObject.actions, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'messageScrollController'
] = _36c2.maybeBoxObject<_9585.ScrollController?>(object: vmObject.messageScrollController, hydroState: hydroState, table: _36c2.HydroTable());
table  [
...
table  [
'cancelButton'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.cancelButton, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
final _f246.CupertinoActionSheet vmObject;

 }

class RTManagedCupertinoActionSheet extends _f246.CupertinoActionSheet implements _36c2.Box<_f246.CupertinoActionSheet> {RTManagedCupertinoActionSheet({_9585.ScrollController? actionScrollController, _fac9.List<_e2dc.Widget>? actions, _e2dc.Widget? cancelButton, _ab4a.Key? key, _e2dc.Widget? message, _9585.ScrollController? messageScrollController, _e2dc.Widget? title, required this.table, required this.hydroState}) : super(actionScrollController: actionScrollController,actions: actions,cancelButton: cancelButton,key: key,message: message,messageScrollController: messageScrollController,title: title) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'messageScrollController'
] = _36c2.maybeBoxObject(object: this.messageScrollController, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'actionScrollController'
] = _36c2.maybeBoxObject(object: this.actionScrollController, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'cancelButton'
] = _36c2.maybeBoxObject(object: this.cancelButton, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_f246.CupertinoActionSheet unwrap() => this;
_f246.CupertinoActionSheet get vmObject => this;
...
void loadCupertinoActionSheet({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoActionSheet(table: luaCallerArguments  [
0
...
'actions'
] : null, parentState: hydroState), cancelButton: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'cancelButton'
...
'key'
] : null, parentState: hydroState), message: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'message'
] : null, parentState: hydroState), messageScrollController: _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'messageScrollController'
...
_36c2.registerBoxer<_f246.CupertinoActionSheet>(boxer: ({required _f246.CupertinoActionSheet vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoActionSheet(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

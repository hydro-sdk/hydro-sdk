...
import 'package:flutter/src/cupertino/slider.dart' as _d833;
...
class VMManagedCupertinoSlider extends _36c2.VMManagedBox<_d833.CupertinoSlider> {VMManagedCupertinoSlider({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d833.CupertinoSlider vmObject;

 }

class RTManagedCupertinoSlider extends _d833.CupertinoSlider implements _36c2.Box<_d833.CupertinoSlider> {RTManagedCupertinoSlider({_a643.Color? activeColor, _fac9.int? divisions, _ab4a.Key? key, required _fac9.double max, required _fac9.double min, void Function(_fac9.double value)? onChangeEnd, void Function(_fac9.double value)? onChangeStart, required _a643.Color thumbColor, void Function(_fac9.double value)? onChanged, required _fac9.double value, required this.table, required this.hydroState}) : super(activeColor: activeColor,divisions: divisions,key: key,max: max,min: min,onChangeEnd: onChangeEnd,onChangeStart: onChangeStart,thumbColor: thumbColor,onChanged: onChanged,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'min'
] = _36c2.maybeBoxObject(object: this.min, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'max'
] = _36c2.maybeBoxObject(object: this.max, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'divisions'
] = _36c2.maybeBoxObject(object: this.divisions, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'activeColor'
...
_d833.CupertinoSlider unwrap() => this;
_d833.CupertinoSlider get vmObject => this;
@_fac9.override _e2dc.State<_d833.CupertinoSlider> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_d833.CupertinoSlider>, _d833.CupertinoSlider>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoSlider({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoSlider'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonChangeEnd=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onChangeEnd'
] : null;
_36c2.Closure? unpackedonChangeStart=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onChangeStart'
] : null;
...
return  [RTManagedCupertinoSlider(table: luaCallerArguments  [
0
...
'activeColor'
] : null, parentState: hydroState), divisions: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'divisions'
...
'key'
] : null, parentState: hydroState), max: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'max'
...
'min'
] : null?.toDouble(), onChangeEnd: unpackedonChangeEnd != null ? (value) => unpackedonChangeEnd.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null , onChangeStart: unpackedonChangeStart != null ? (value) => unpackedonChangeStart.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null , thumbColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'thumbColor'
] : null, parentState: hydroState), onChanged: unpackedonChanged != null ? (value) => unpackedonChanged.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null , value: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_d833.CupertinoSlider>(boxer: ({required _d833.CupertinoSlider vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoSlider(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

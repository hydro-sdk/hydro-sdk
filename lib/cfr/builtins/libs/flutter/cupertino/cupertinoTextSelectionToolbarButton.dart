...
import 'package:flutter/src/cupertino/text_selection_toolbar_button.dart' as _dd56;
...
class VMManagedCupertinoTextSelectionToolbarButton extends _36c2.VMManagedBox<_dd56.CupertinoTextSelectionToolbarButton> {VMManagedCupertinoTextSelectionToolbarButton({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _dd56.CupertinoTextSelectionToolbarButton vmObject;

 }

class RTManagedCupertinoTextSelectionToolbarButton extends _dd56.CupertinoTextSelectionToolbarButton implements _36c2.Box<_dd56.CupertinoTextSelectionToolbarButton> {RTManagedCupertinoTextSelectionToolbarButton({_ab4a.Key? key, void Function()? onPressed, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(key: key,onPressed: onPressed,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_dd56.CupertinoTextSelectionToolbarButton unwrap() => this;
_dd56.CupertinoTextSelectionToolbarButton get vmObject => this;
...
void loadCupertinoTextSelectionToolbarButton({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoTextSelectionToolbarButton(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), onPressed: unpackedonPressed != null ? () => unpackedonPressed.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_dd56.CupertinoTextSelectionToolbarButton>(boxer: ({required _dd56.CupertinoTextSelectionToolbarButton vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoTextSelectionToolbarButton(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

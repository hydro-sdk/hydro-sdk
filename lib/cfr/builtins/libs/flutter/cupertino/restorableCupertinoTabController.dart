...
class VMManagedRestorableCupertinoTabController extends _36c2.VMManagedBox<_9550.RestorableCupertinoTabController> {VMManagedRestorableCupertinoTabController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'createDefaultValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9550.CupertinoTabController>(object: vmObject.createDefaultValue(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'fromPrimitives'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9550.CupertinoTabController>(object: vmObject.fromPrimitives(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'initWithValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.initWithValue(_36c2.maybeUnBoxAndBuildArgument<_9550.CupertinoTabController, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9550.CupertinoTabController>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getEnabled'
...
final _9550.RestorableCupertinoTabController vmObject;

 }

class RTManagedRestorableCupertinoTabController extends _9550.RestorableCupertinoTabController implements _36c2.Box<_9550.RestorableCupertinoTabController> {RTManagedRestorableCupertinoTabController({required _fac9.int initialIndex, required this.table, required this.hydroState}) : super(initialIndex: initialIndex) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_initWithValue'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.initWithValue(_36c2.maybeUnBoxAndBuildArgument<
      _9550.CupertinoTabController,
...
_9550.RestorableCupertinoTabController unwrap() => this;
_9550.RestorableCupertinoTabController get vmObject => this;
@_fac9.override _9550.CupertinoTabController createDefaultValue() { 
_36c2.Closure closure = table["createDefaultValue"];
return _36c2.maybeUnBoxAndBuildArgument<_9550.CupertinoTabController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _9550.CupertinoTabController fromPrimitives(data) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _9550.CupertinoTabController get value { 
...
void loadRestorableCupertinoTabController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'restorableCupertinoTabController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRestorableCupertinoTabController(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_9550.RestorableCupertinoTabController>(boxer: ({required _9550.RestorableCupertinoTabController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRestorableCupertinoTabController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

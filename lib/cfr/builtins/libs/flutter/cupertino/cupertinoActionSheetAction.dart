...
class VMManagedCupertinoActionSheetAction extends _36c2.VMManagedBox<_f246.CupertinoActionSheetAction> {VMManagedCupertinoActionSheetAction({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _f246.CupertinoActionSheetAction vmObject;

 }

class RTManagedCupertinoActionSheetAction extends _f246.CupertinoActionSheetAction implements _36c2.Box<_f246.CupertinoActionSheetAction> {RTManagedCupertinoActionSheetAction({required _fac9.bool isDefaultAction, required _fac9.bool isDestructiveAction, _ab4a.Key? key, required _e2dc.Widget child, required void Function() onPressed, required this.table, required this.hydroState}) : super(isDefaultAction: isDefaultAction,isDestructiveAction: isDestructiveAction,key: key,child: child,onPressed: onPressed) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_f246.CupertinoActionSheetAction unwrap() => this;
_f246.CupertinoActionSheetAction get vmObject => this;
...
void loadCupertinoActionSheetAction({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedCupertinoActionSheetAction(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), onPressed: () => unpackedonPressed.dispatch([luaCallerArguments[0],],parentState:hydroState,))]; } );
_36c2.registerBoxer<_f246.CupertinoActionSheetAction>(boxer: ({required _f246.CupertinoActionSheetAction vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoActionSheetAction(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

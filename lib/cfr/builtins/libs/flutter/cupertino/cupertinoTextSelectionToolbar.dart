...
import 'package:flutter/src/cupertino/text_selection_toolbar.dart' as _3e6c;
...
class VMManagedCupertinoTextSelectionToolbar extends _36c2.VMManagedBox<_3e6c.CupertinoTextSelectionToolbar> {VMManagedCupertinoTextSelectionToolbar({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'anchorAbove'
] = _36c2.maybeBoxObject<_a643.Offset>(object: vmObject.anchorAbove, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'anchorBelow'
] = _36c2.maybeBoxObject<_a643.Offset>(object: vmObject.anchorBelow, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'children'
...
final _3e6c.CupertinoTextSelectionToolbar vmObject;

 }

class RTManagedCupertinoTextSelectionToolbar extends _3e6c.CupertinoTextSelectionToolbar implements _36c2.Box<_3e6c.CupertinoTextSelectionToolbar> {RTManagedCupertinoTextSelectionToolbar({_ab4a.Key? key, required _e2dc.Widget Function(_e2dc.BuildContext context, _a643.Offset anchor, _fac9.bool isAbove, _e2dc.Widget child) toolbarBuilder, required _a643.Offset anchorAbove, required _a643.Offset anchorBelow, required _fac9.List<_e2dc.Widget> children, required this.table, required this.hydroState}) : super(key: key,toolbarBuilder: toolbarBuilder,anchorAbove: anchorAbove,anchorBelow: anchorBelow,children: children) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'anchorAbove'
] = _36c2.maybeBoxObject(object: this.anchorAbove, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'anchorBelow'
] = _36c2.maybeBoxObject(object: this.anchorBelow, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'children'
...
_3e6c.CupertinoTextSelectionToolbar unwrap() => this;
_3e6c.CupertinoTextSelectionToolbar get vmObject => this;
...
void loadCupertinoTextSelectionToolbar({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoTextSelectionToolbar'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure unpackedtoolbarBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'toolbarBuilder'
] : null;
...
return  [RTManagedCupertinoTextSelectionToolbar(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), toolbarBuilder: (context, anchor, isAbove, child) => _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(unpackedtoolbarBuilder.dispatch([luaCallerArguments[0],context,anchor,isAbove,child],parentState:hydroState,)[0], parentState: hydroState), anchorAbove: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'anchorAbove'
] : null, parentState: hydroState), anchorBelow: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'anchorBelow'
] : null, parentState: hydroState), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_3e6c.CupertinoTextSelectionToolbar>(boxer: ({required _3e6c.CupertinoTextSelectionToolbar vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoTextSelectionToolbar(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

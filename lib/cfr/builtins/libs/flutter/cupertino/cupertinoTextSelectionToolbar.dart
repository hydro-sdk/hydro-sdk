...
class VMManagedCupertinoTextSelectionToolbar
    extends _36c2.VMManagedBox<_3e6c.CupertinoTextSelectionToolbar> {
  VMManagedCupertinoTextSelectionToolbar(
...
class RTManagedCupertinoTextSelectionToolbar
    extends _3e6c.CupertinoTextSelectionToolbar
    implements _36c2.Box<_3e6c.CupertinoTextSelectionToolbar> {
  RTManagedCupertinoTextSelectionToolbar(
      {_ab4a.Key? key,
      required _e2dc.Widget Function(_e2dc.BuildContext context,
              _a643.Offset anchor, _fac9.bool isAbove, _e2dc.Widget child)
          toolbarBuilder,
...
void loadCupertinoTextSelectionToolbar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoTextSelectionToolbar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedtoolbarBuilder = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['toolbarBuilder']
        : null;
    ...
    return [
      RTManagedCupertinoTextSelectionToolbar(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          toolbarBuilder: (context, anchor, isAbove, child) =>
              _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
                  unpackedtoolbarBuilder.dispatch(
                    [luaCallerArguments[0], context, anchor, isAbove, child],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState),
          anchorAbove: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['anchorAbove']
                  : null,
              parentState: hydroState),
          anchorBelow:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['anchorBelow'] : null,
                  parentState: hydroState),
          children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3e6c.CupertinoTextSelectionToolbar>(boxer: (
      {required _3e6c.CupertinoTextSelectionToolbar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTextSelectionToolbar(

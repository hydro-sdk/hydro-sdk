...
import 'package:flutter/src/cupertino/activity_indicator.dart' as _5e4f;
...
class VMManagedCupertinoActivityIndicator extends _36c2.VMManagedBox<_5e4f.CupertinoActivityIndicator> {VMManagedCupertinoActivityIndicator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _5e4f.CupertinoActivityIndicator vmObject;

 }

class RTManagedCupertinoActivityIndicator extends _5e4f.CupertinoActivityIndicator implements _36c2.Box<_5e4f.CupertinoActivityIndicator> {RTManagedCupertinoActivityIndicator({required _fac9.bool animating, _ab4a.Key? key, required _fac9.double radius, required this.table, required this.hydroState}) : super(animating: animating,key: key,radius: radius) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'animating'
] = _36c2.maybeBoxObject(object: this.animating, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'radius'
] = _36c2.maybeBoxObject(object: this.radius, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'progress'
] = _36c2.maybeBoxObject(object: progress, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
_5e4f.CupertinoActivityIndicator unwrap() => this;
_5e4f.CupertinoActivityIndicator get vmObject => this;
@_fac9.override _e2dc.State<_5e4f.CupertinoActivityIndicator> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_5e4f.CupertinoActivityIndicator>, _5e4f.CupertinoActivityIndicator>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoActivityIndicator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoActivityIndicator'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCupertinoActivityIndicator(table: luaCallerArguments  [
0
], hydroState: hydroState, animating: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animating'
...
'key'
] : null, parentState: hydroState), radius: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'radius'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_5e4f.CupertinoActivityIndicator>(boxer: ({required _5e4f.CupertinoActivityIndicator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoActivityIndicator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

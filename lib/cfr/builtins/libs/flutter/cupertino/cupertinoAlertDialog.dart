...
class VMManagedCupertinoAlertDialog
    extends _36c2.VMManagedBox<_f246.CupertinoAlertDialog> {
  VMManagedCupertinoAlertDialog(
    ...
    table['scrollController'] = _36c2.maybeBoxObject<_9585.ScrollController?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['actionScrollController'] =
        _36c2.maybeBoxObject<_9585.ScrollController?>(
            object: vmObject.actionScrollController,
            hydroState: hydroState,
            table: _36c2.HydroTable());
    table['insetAnimationDuration'] = _36c2.maybeBoxObject<_fac9.Duration>(
        object: vmObject.insetAnimationDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['insetAnimationCurve'] = _36c2.maybeBoxObject<_8c47.Curve>(
        object: vmObject.insetAnimationCurve,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedCupertinoAlertDialog extends _f246.CupertinoAlertDialog
    implements _36c2.Box<_f246.CupertinoAlertDialog> {
  RTManagedCupertinoAlertDialog(
      {_9585.ScrollController? actionScrollController,
      required _fac9.List<_e2dc.Widget> actions,
      _e2dc.Widget? content,
      required _8c47.Curve insetAnimationCurve,
      required _fac9.Duration insetAnimationDuration,
      _ab4a.Key? key,
    ...
    table['scrollController'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['actionScrollController'] = _36c2.maybeBoxObject(
        object: this.actionScrollController,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['insetAnimationDuration'] = _36c2.maybeBoxObject(
        object: this.insetAnimationDuration,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['insetAnimationCurve'] = _36c2.maybeBoxObject(
        object: this.insetAnimationCurve,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadCupertinoAlertDialog(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoAlertDialog'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoAlertDialog(
          ...
          actionScrollController:
              _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['actionScrollController']
                      : null,
                  parentState: hydroState),
          actions: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          content: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['content'] : null,
              parentState: hydroState),
          insetAnimationCurve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['insetAnimationCurve'] : null, parentState: hydroState),
          insetAnimationDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['insetAnimationDuration'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_f246.CupertinoAlertDialog>(boxer: (
      {required _f246.CupertinoAlertDialog vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoAlertDialog(

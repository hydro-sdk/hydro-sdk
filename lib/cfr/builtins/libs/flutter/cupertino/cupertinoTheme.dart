...
class VMManagedCupertinoTheme extends _36c2.VMManagedBox<_2b5f.CupertinoTheme> {
  VMManagedCupertinoTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_2b5f.CupertinoThemeData>(
...
class RTManagedCupertinoTheme extends _2b5f.CupertinoTheme
    implements _36c2.Box<_2b5f.CupertinoTheme> {
  RTManagedCupertinoTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _2b5f.CupertinoThemeData data,
      required this.table,
...
void loadCupertinoTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cupertinoTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCupertinoTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_2b5f.CupertinoThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['cupertinoThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_2b5f.CupertinoThemeData>(
          object: _2b5f.CupertinoTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  table['cupertinoThemeBrightnessOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _a643.Brightness.values.indexWhere((x) {
        return x ==
            _2b5f.CupertinoTheme.brightnessOf(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      }),
    ];
  });
  table['cupertinoThemeMaybeBrightnessOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _2b5f.CupertinoTheme.maybeBrightnessOf(
  ...
  _36c2.registerBoxer<_2b5f.CupertinoTheme>(boxer: (
      {required _2b5f.CupertinoTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTheme(

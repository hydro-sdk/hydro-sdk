...
class VMManagedCupertinoScrollbar extends _36c2.VMManagedBox<_d0f4.CupertinoScrollbar> {VMManagedCupertinoScrollbar({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'thicknessWhileDragging'
] = vmObject.thicknessWhileDragging;
table  [
'radiusWhileDragging'
] = _36c2.maybeBoxObject<_a643.Radius>(object: vmObject.radiusWhileDragging, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
class RTManagedCupertinoScrollbar extends _d0f4.CupertinoScrollbar implements _36c2.Box<_d0f4.CupertinoScrollbar> {RTManagedCupertinoScrollbar({_9585.ScrollController? controller, required _fac9.bool isAlwaysShown, _ab4a.Key? key, _fac9.bool Function(_593c.ScrollNotification notification)? notificationPredicate, required _a643.Radius radius, required _a643.Radius radiusWhileDragging, _1c5f.ScrollbarOrientation? scrollbarOrientation, required _fac9.double thickness, required _fac9.double thicknessWhileDragging, required _e2dc.Widget child, required this.table, required this.hydroState}) : super(controller: controller,isAlwaysShown: isAlwaysShown,key: key,notificationPredicate: notificationPredicate,radius: radius,radiusWhileDragging: radiusWhileDragging,scrollbarOrientation: scrollbarOrientation,thickness: thickness,thicknessWhileDragging: thicknessWhileDragging,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'thicknessWhileDragging'
] = _36c2.maybeBoxObject(object: this.thicknessWhileDragging, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'radiusWhileDragging'
] = _36c2.maybeBoxObject(object: this.radiusWhileDragging, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'child'
...
table  [
'shape'
] = _36c2.maybeBoxObject(object: shape, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'radius'
...
table  [
'thumbColor'
] = _36c2.maybeBoxObject(object: thumbColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minThumbLength'
] = _36c2.maybeBoxObject(object: minThumbLength, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minOverscrollLength'
] = _36c2.maybeBoxObject(object: minOverscrollLength, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fadeDuration'
] = _36c2.maybeBoxObject(object: fadeDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'timeToFade'
] = _36c2.maybeBoxObject(object: timeToFade, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'pressDuration'
] = _36c2.maybeBoxObject(object: pressDuration, hydroState: hydroState, table: _36c2.HydroTable());

table  [
'interactive'
] = _36c2.maybeBoxObject(object: interactive, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scrollbarOrientation'
] = _1c5f.ScrollbarOrientation.values.indexWhere((x) { return x == this.scrollbarOrientation; } );
table  [
'mainAxisMargin'
] = _36c2.maybeBoxObject(object: mainAxisMargin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'crossAxisMargin'
] = _36c2.maybeBoxObject(object: crossAxisMargin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
@_fac9.override _1c5f.RawScrollbarState<_d0f4.CupertinoScrollbar> createState() { 
_36c2.Closure closure = table["createState"];
return _36c2.maybeUnBoxAndBuildArgument<_1c5f.RawScrollbarState<_d0f4.CupertinoScrollbar>, _d0f4.CupertinoScrollbar>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCupertinoScrollbar({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoScrollbar'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoScrollbar(table: luaCallerArguments  [
0
...
'controller'
] : null, parentState: hydroState), isAlwaysShown: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isAlwaysShown'
...
'key'
] : null, parentState: hydroState), notificationPredicate: unpackednotificationPredicate != null ? (notification) => unpackednotificationPredicate.dispatch([luaCallerArguments[0],notification],parentState:hydroState,)[0] : null , radius: _36c2.maybeUnBoxAndBuildArgument<_a643.Radius, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'radius'
] : null, parentState: hydroState), radiusWhileDragging: _36c2.maybeUnBoxAndBuildArgument<_a643.Radius, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'radiusWhileDragging'
...
'thickness'
] : null?.toDouble(), thicknessWhileDragging: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'thicknessWhileDragging'
] : null?.toDouble(), child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_d0f4.CupertinoScrollbar>(boxer: ({required _d0f4.CupertinoScrollbar vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoScrollbar(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

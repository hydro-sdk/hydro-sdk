...
class VMManagedCupertinoPicker extends _36c2.VMManagedBox<_bc40.CupertinoPicker> {VMManagedCupertinoPicker({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'scrollController'
] = _36c2.maybeBoxObject<_7b25.FixedExtentScrollController?>(object: vmObject.scrollController, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'itemExtent'
] = vmObject.itemExtent;
table  [
...
table  [
'selectionOverlay'
] = _36c2.maybeBoxObject<_e2dc.Widget?>(object: vmObject.selectionOverlay, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
class RTManagedCupertinoPicker extends _bc40.CupertinoPicker implements _36c2.Box<_bc40.CupertinoPicker> {RTManagedCupertinoPicker({_a643.Color? backgroundColor, required _fac9.double diameterRatio, _ab4a.Key? key, required _fac9.bool looping, required _fac9.double magnification, required _fac9.double offAxisFraction, _7b25.FixedExtentScrollController? scrollController, _e2dc.Widget? selectionOverlay, required _fac9.double squeeze, required _fac9.bool useMagnifier, required _fac9.List<_e2dc.Widget> children, required _fac9.double itemExtent, void Function(_fac9.int value)? onSelectedItemChanged, required this.table, required this.hydroState}) : super(backgroundColor: backgroundColor,diameterRatio: diameterRatio,key: key,looping: looping,magnification: magnification,offAxisFraction: offAxisFraction,scrollController: scrollController,selectionOverlay: selectionOverlay,squeeze: squeeze,useMagnifier: useMagnifier,children: children,itemExtent: itemExtent,onSelectedItemChanged: onSelectedItemChanged) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'selectionOverlay'
] = _36c2.maybeBoxObject(object: this.selectionOverlay, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'key'
...
void loadCupertinoPicker({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cupertinoPicker'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedCupertinoPicker(table: luaCallerArguments  [
0
...
'key'
] : null, parentState: hydroState), looping: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'looping'
] : null, magnification: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'magnification'
...
'offAxisFraction'
] : null?.toDouble(), scrollController: _36c2.maybeUnBoxAndBuildArgument<_7b25.FixedExtentScrollController?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollController'
] : null, parentState: hydroState), selectionOverlay: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'selectionOverlay'
...
'itemExtent'
] : null?.toDouble(), onSelectedItemChanged: unpackedonSelectedItemChanged != null ? (value) => unpackedonSelectedItemChanged.dispatch([luaCallerArguments[0],value],parentState:hydroState,) : null )]; } );
_36c2.registerBoxer<_bc40.CupertinoPicker>(boxer: ({required _bc40.CupertinoPicker vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCupertinoPicker(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

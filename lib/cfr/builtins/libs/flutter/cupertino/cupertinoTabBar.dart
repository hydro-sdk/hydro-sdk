...
class VMManagedCupertinoTabBar
    extends _36c2.VMManagedBox<_96db.CupertinoTabBar> {
  VMManagedCupertinoTabBar(
    ...
    table['opaque'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.opaque(
    ...
    table['copyWith'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedonTap = luaCallerArguments.length >= 2
          ? luaCallerArguments[1]['onTap']
          : null;
      return [
        _36c2.maybeBoxObject<_96db.CupertinoTabBar>(
            object: vmObject.copyWith(
                ...
                border: _36c2.maybeUnBoxAndBuildArgument<_250a.Border?, _fac9.dynamic>(
                    ...
                    parentState: hydroState),
                currentIndex: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['currentIndex'] : null,
...
class RTManagedCupertinoTabBar extends _96db.CupertinoTabBar
    implements _36c2.Box<_96db.CupertinoTabBar> {
  RTManagedCupertinoTabBar(
      {_a643.Color? activeColor,
      _a643.Color? backgroundColor,
      _250a.Border? border,
      required _fac9.int currentIndex,
      required _fac9.double iconSize,
      required _a643.Color inactiveColor,
      _ab4a.Key? key,
    ...
    table['_dart_opaque'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.opaque(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  _96db.CupertinoTabBar copyWith(
      {_a643.Color? activeColor,
      _a643.Color? backgroundColor,
      _250a.Border? border,
    ...
    return _36c2
        .maybeUnBoxAndBuildArgument<_96db.CupertinoTabBar, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadCupertinoTabBar(
  ...
  table['cupertinoTabBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_96db.CupertinoTabBar>(boxer: (
      {required _96db.CupertinoTabBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCupertinoTabBar(

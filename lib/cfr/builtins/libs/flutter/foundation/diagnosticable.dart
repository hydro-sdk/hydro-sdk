...
class VMManagedDiagnosticable extends _36c2.VMManagedBox<_eaf3.Diagnosticable> {VMManagedDiagnosticable({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.Diagnosticable vmObject;

 }

void loadDiagnosticable({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_eaf3.Diagnosticable>(boxer: ({required _eaf3.Diagnosticable vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticable(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

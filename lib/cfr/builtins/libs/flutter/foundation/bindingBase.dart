...
class VMManagedBindingBase extends _36c2.VMManagedBox<_8f1c.BindingBase> {
  VMManagedBindingBase(
...
class RTManagedBindingBase extends _8f1c.BindingBase
    implements _36c2.Box<_8f1c.BindingBase> {
  RTManagedBindingBase({required this.table, required this.hydroState})
      : super() {
...
void loadBindingBase(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['bindingBase'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBindingBase(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8f1c.BindingBase>(boxer: (
      {required _8f1c.BindingBase vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBindingBase(

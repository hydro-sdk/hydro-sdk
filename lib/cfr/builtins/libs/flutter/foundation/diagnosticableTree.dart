...
class VMManagedDiagnosticableTree extends _36c2.VMManagedBox<_eaf3.DiagnosticableTree> {VMManagedDiagnosticableTree({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.DiagnosticableTree vmObject;

 }

class RTManagedDiagnosticableTree extends _eaf3.DiagnosticableTree implements _36c2.Box<_eaf3.DiagnosticableTree> {RTManagedDiagnosticableTree({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadDiagnosticableTree({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticableTree'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDiagnosticableTree(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_eaf3.DiagnosticableTree>(boxer: ({required _eaf3.DiagnosticableTree vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticableTree(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

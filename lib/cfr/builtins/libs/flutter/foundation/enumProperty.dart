...
class VMManagedEnumProperty extends _36c2.VMManagedBox<_eaf3.EnumProperty<_fac9.dynamic>> {VMManagedEnumProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.EnumProperty<_fac9.dynamic> vmObject;

 }

class RTManagedEnumProperty extends _eaf3.EnumProperty implements _36c2.Box<_eaf3.EnumProperty> {RTManagedEnumProperty(_fac9.String name$, _fac9.dynamic? value$, {_fac9.Object? defaultValue, required _eaf3.DiagnosticLevel level, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,level: level) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_eaf3.EnumProperty unwrap() => this;
_eaf3.EnumProperty get vmObject => this;
...
void loadEnumProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'enumProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedEnumProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
_36c2.registerBoxer<_eaf3.EnumProperty>(boxer: ({required _eaf3.EnumProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedEnumProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedEnumProperty
    extends _36c2.VMManagedBox<_eaf3.EnumProperty<_fac9.dynamic>> {
  VMManagedEnumProperty(
...
class RTManagedEnumProperty extends _eaf3.EnumProperty
    implements _36c2.Box<_eaf3.EnumProperty> {
  RTManagedEnumProperty(_fac9.String name$, _fac9.dynamic? value$,
      {_fac9.Object? defaultValue,
      required _eaf3.DiagnosticLevel level,
      required this.table,
      required this.hydroState})
      : super(name$, value$, defaultValue: defaultValue, level: level) {
...
void loadEnumProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['enumProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedEnumProperty(luaCallerArguments[1], luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_eaf3.EnumProperty>(boxer: (
      {required _eaf3.EnumProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedEnumProperty(

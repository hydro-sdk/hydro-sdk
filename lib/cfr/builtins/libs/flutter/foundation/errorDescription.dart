...
class VMManagedErrorDescription
    extends _36c2.VMManagedBox<_5dcc.ErrorDescription> {
  VMManagedErrorDescription(
...
class RTManagedErrorDescription extends _5dcc.ErrorDescription
    implements _36c2.Box<_5dcc.ErrorDescription> {
  RTManagedErrorDescription(_fac9.String message,
...
void loadErrorDescription(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['errorDescription'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedErrorDescription(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_5dcc.ErrorDescription>(boxer: (
      {required _5dcc.ErrorDescription vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedErrorDescription(

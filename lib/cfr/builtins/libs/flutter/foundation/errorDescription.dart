...
class VMManagedErrorDescription extends _36c2.VMManagedBox<_5dcc.ErrorDescription> {VMManagedErrorDescription({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.value.map((x) => _36c2.maybeBoxObject<_fac9.Object>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toJsonMap'
...
final _5dcc.ErrorDescription vmObject;

 }

class RTManagedErrorDescription extends _5dcc.ErrorDescription implements _36c2.Box<_5dcc.ErrorDescription> {RTManagedErrorDescription(_fac9.String message, {required this.table, required this.hydroState}) : super(message,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'name'
] = _36c2.maybeBoxObject(object: name, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'showSeparator'
...
_5dcc.ErrorDescription unwrap() => this;
_5dcc.ErrorDescription get vmObject => this;
...
@_fac9.override _fac9.List<_fac9.Object> get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.Object>, _fac9.Object>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadErrorDescription({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'errorDescription'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedErrorDescription(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_5dcc.ErrorDescription>(boxer: ({required _5dcc.ErrorDescription vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedErrorDescription(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

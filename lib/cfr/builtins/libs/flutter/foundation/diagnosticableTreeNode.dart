...
class VMManagedDiagnosticableTreeNode
    extends _36c2.VMManagedBox<_eaf3.DiagnosticableTreeNode> {
  VMManagedDiagnosticableTreeNode(
    ...
    table['value'] = _36c2.maybeBoxObject<_eaf3.DiagnosticableTree>(
    ...
    table['getValue'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_eaf3.DiagnosticableTree>(
            object: vmObject.value,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
...
class RTManagedDiagnosticableTreeNode extends _eaf3.DiagnosticableTreeNode
    implements _36c2.Box<_eaf3.DiagnosticableTreeNode> {
  RTManagedDiagnosticableTreeNode(
      {_fac9.String? name,
      _eaf3.DiagnosticsTreeStyle? style,
      required _eaf3.DiagnosticableTree value,
      required this.table,
  ...
  @_fac9.override
  _eaf3.DiagnosticableTree get value {
    _36c2.Closure closure = table["getValue"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_eaf3.DiagnosticableTree, _fac9.dynamic>(
...
void loadDiagnosticableTreeNode(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['diagnosticableTreeNode'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDiagnosticableTreeNode(
          ...
          style: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          value: _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticableTree,
                  _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_eaf3.DiagnosticableTreeNode>(boxer: (
      {required _eaf3.DiagnosticableTreeNode vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDiagnosticableTreeNode(

...
class VMManagedDiagnosticableTreeNode extends _36c2.VMManagedBox<_eaf3.DiagnosticableTreeNode> {VMManagedDiagnosticableTreeNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'value'
] = _36c2.maybeBoxObject<_eaf3.DiagnosticableTree>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'name'
] = vmObject.name;
table  [
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_eaf3.DiagnosticableTree>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getChildren'
...
table  [
'getBuilder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.builder;if(returnValue!= null){return [_36c2.maybeBoxObject<_eaf3.DiagnosticPropertiesBuilder?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getStyle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_eaf3.DiagnosticsTreeStyle.values.indexWhere((x) { return x == vmObject.style; } ),]; } );
table  [
...
final _eaf3.DiagnosticableTreeNode vmObject;

 }

class RTManagedDiagnosticableTreeNode extends _eaf3.DiagnosticableTreeNode implements _36c2.Box<_eaf3.DiagnosticableTreeNode> {RTManagedDiagnosticableTreeNode({_fac9.String? name, _eaf3.DiagnosticsTreeStyle? style, required _eaf3.DiagnosticableTree value, required this.table, required this.hydroState}) : super(name: name,style: style,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_eaf3.DiagnosticableTreeNode unwrap() => this;
_eaf3.DiagnosticableTreeNode get vmObject => this;
@_fac9.override _eaf3.DiagnosticableTree get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticableTree, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
@_fac9.override _eaf3.DiagnosticPropertiesBuilder? get builder { 
_36c2.Closure closure = table["getBuilder"];
return _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticPropertiesBuilder?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _eaf3.DiagnosticsTreeStyle get style { 
_36c2.Closure closure = table["getStyle"];
return _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticsTreeStyle.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
...
void loadDiagnosticableTreeNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticableTreeNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDiagnosticableTreeNode(table: luaCallerArguments  [
0
], hydroState: hydroState, name: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'name'
...
'style'
] : null), value: _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticableTree, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_eaf3.DiagnosticableTreeNode>(boxer: ({required _eaf3.DiagnosticableTreeNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticableTreeNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

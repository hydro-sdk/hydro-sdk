...
class VMManagedLicenseEntry extends _36c2.VMManagedBox<_7782.LicenseEntry> {
  VMManagedLicenseEntry(
...
void loadLicenseEntry(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_7782.LicenseEntry>(boxer: (
      {required _7782.LicenseEntry vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLicenseEntry(

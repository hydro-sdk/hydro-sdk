...
class VMManagedValueNotifier
    extends _36c2.VMManagedBox<_e644.ValueNotifier<_fac9.dynamic>> {
  VMManagedValueNotifier(
...
class RTManagedValueNotifier extends _e644.ValueNotifier
    implements _36c2.Box<_e644.ValueNotifier> {
  RTManagedValueNotifier(_fac9.dynamic _value,
...
void loadValueNotifier(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['valueNotifier'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedValueNotifier(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e644.ValueNotifier>(boxer: (
      {required _e644.ValueNotifier vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedValueNotifier(

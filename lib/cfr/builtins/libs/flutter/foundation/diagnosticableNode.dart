...
class VMManagedDiagnosticableNode extends _36c2.VMManagedBox<_eaf3.DiagnosticableNode<_eaf3.Diagnosticable>> {VMManagedDiagnosticableNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_eaf3.Diagnosticable>(object: vmObject.value, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getBuilder'
...
class RTManagedDiagnosticableNode extends _eaf3.DiagnosticableNode implements _36c2.Box<_eaf3.DiagnosticableNode> {RTManagedDiagnosticableNode({_fac9.String? name, _eaf3.DiagnosticsTreeStyle? style, required _eaf3.Diagnosticable value, required this.table, required this.hydroState}) : super(name: name,style: style,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _eaf3.Diagnosticable get value { 
_36c2.Closure closure = table["getValue"];
return _36c2.maybeUnBoxAndBuildArgument<_eaf3.Diagnosticable, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDiagnosticableNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticableNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDiagnosticableNode(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_eaf3.DiagnosticableNode>(boxer: ({required _eaf3.DiagnosticableNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticableNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

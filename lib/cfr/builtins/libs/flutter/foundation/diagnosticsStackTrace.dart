...
class VMManagedDiagnosticsStackTrace
    extends _36c2.VMManagedBox<_5dcc.DiagnosticsStackTrace> {
  VMManagedDiagnosticsStackTrace(
...
class RTManagedDiagnosticsStackTrace extends _5dcc.DiagnosticsStackTrace
    implements _36c2.Box<_5dcc.DiagnosticsStackTrace> {
  RTManagedDiagnosticsStackTrace(_fac9.String name$, _fac9.StackTrace? stack,
      ...
      : super(name$, stack,
            showSeparator: showSeparator, stackFilter: stackFilter) {
...
void loadDiagnosticsStackTrace(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['diagnosticsStackTrace'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedstackFilter = luaCallerArguments.length >= 4
        ? luaCallerArguments[3]['stackFilter']
        : null;
    return [
      RTManagedDiagnosticsStackTrace(
          ...
          stackFilter: unpackedstackFilter != null
              ? (input) => _36c2.maybeUnBoxAndBuildArgument<
  ...
  _36c2.registerBoxer<_5dcc.DiagnosticsStackTrace>(boxer: (
      {required _5dcc.DiagnosticsStackTrace vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDiagnosticsStackTrace(

...
class VMManagedDoubleProperty extends _36c2.VMManagedBox<_eaf3.DoubleProperty> {VMManagedDoubleProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.DoubleProperty vmObject;

 }

class RTManagedDoubleProperty extends _eaf3.DoubleProperty implements _36c2.Box<_eaf3.DoubleProperty> {RTManagedDoubleProperty(_fac9.String name$, _fac9.double? value$, {_fac9.Object? defaultValue, _fac9.String? ifNull, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _eaf3.DiagnosticsTreeStyle style, _fac9.String? tooltip, _fac9.String? unit, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,ifNull: ifNull,level: level,showName: showName,style: style,tooltip: tooltip,unit: unit) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_eaf3.DoubleProperty unwrap() => this;
_eaf3.DoubleProperty get vmObject => this;
...
void loadDoubleProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'doubleProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedDoubleProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
'defaultValue'
] : null, parentState: hydroState), ifNull: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'ifNull'
...
_36c2.registerBoxer<_eaf3.DoubleProperty>(boxer: ({required _eaf3.DoubleProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDoubleProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

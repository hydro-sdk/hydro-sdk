...
class VMManagedDoubleProperty extends _36c2.VMManagedBox<_eaf3.DoubleProperty> {
  VMManagedDoubleProperty(
...
class RTManagedDoubleProperty extends _eaf3.DoubleProperty
    implements _36c2.Box<_eaf3.DoubleProperty> {
  RTManagedDoubleProperty(_fac9.String name$, _fac9.double? value$,
...
void loadDoubleProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['doubleProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDoubleProperty(
          ...
          tooltip: luaCallerArguments.length >= 4
              ...
              : null,
          unit: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['unit'] : null)
    ];
  });
  _36c2.registerBoxer<_eaf3.DoubleProperty>(boxer: (
      {required _eaf3.DoubleProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDoubleProperty(

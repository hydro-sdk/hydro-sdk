...
class VMManagedHashedObserverList
    extends _36c2.VMManagedBox<_1fed.HashedObserverList<_fac9.dynamic>> {
  VMManagedHashedObserverList(
...
class RTManagedHashedObserverList extends _1fed.HashedObserverList
    implements _36c2.Box<_1fed.HashedObserverList> {
  RTManagedHashedObserverList({required this.table, required this.hydroState})
      : super() {
...
void loadHashedObserverList(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['hashedObserverList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedHashedObserverList(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_1fed.HashedObserverList>(boxer: (
      {required _1fed.HashedObserverList vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedHashedObserverList(

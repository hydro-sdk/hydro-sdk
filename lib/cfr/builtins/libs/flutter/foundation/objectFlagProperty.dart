...
class VMManagedObjectFlagProperty
    extends _36c2.VMManagedBox<_eaf3.ObjectFlagProperty<_fac9.dynamic>> {
  VMManagedObjectFlagProperty(
    ...
    table['ifPresent'] = vmObject.ifPresent;
...
class RTManagedObjectFlagProperty extends _eaf3.ObjectFlagProperty
    implements _36c2.Box<_eaf3.ObjectFlagProperty> {
  RTManagedObjectFlagProperty(_fac9.String name$, _fac9.dynamic? value$,
      {_fac9.String? ifNull,
      _fac9.String? ifPresent,
    ...
    table['ifPresent'] = _36c2.maybeBoxObject(
        object: this.ifPresent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadObjectFlagProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['objectFlagProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedObjectFlagProperty(luaCallerArguments[1], luaCallerArguments[2],
          table: luaCallerArguments[0],
          hydroState: hydroState,
          ifNull: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['ifNull']
              : null,
          ifPresent: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['ifPresent']
              : null,
  ...
  _36c2.registerBoxer<_eaf3.ObjectFlagProperty>(boxer: (
      {required _eaf3.ObjectFlagProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedObjectFlagProperty(

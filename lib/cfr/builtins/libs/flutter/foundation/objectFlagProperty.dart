...
class VMManagedObjectFlagProperty extends _36c2.VMManagedBox<_eaf3.ObjectFlagProperty<_fac9.dynamic>> {VMManagedObjectFlagProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.ObjectFlagProperty<_fac9.dynamic> vmObject;

 }

class RTManagedObjectFlagProperty extends _eaf3.ObjectFlagProperty implements _36c2.Box<_eaf3.ObjectFlagProperty> {RTManagedObjectFlagProperty(_fac9.String name$, _fac9.dynamic? value$, {_fac9.String? ifNull, _fac9.String? ifPresent, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required this.table, required this.hydroState}) : super(name$,value$,ifNull: ifNull,ifPresent: ifPresent,level: level,showName: showName) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'ifPresent'
] = _36c2.maybeBoxObject(object: this.ifPresent, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expandableValue'
...
_eaf3.ObjectFlagProperty unwrap() => this;
_eaf3.ObjectFlagProperty get vmObject => this;
...
void loadObjectFlagProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'objectFlagProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedObjectFlagProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
'ifNull'
] : null, ifPresent: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'ifPresent'
...
_36c2.registerBoxer<_eaf3.ObjectFlagProperty>(boxer: ({required _eaf3.ObjectFlagProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedObjectFlagProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedErrorHint extends _36c2.VMManagedBox<_5dcc.ErrorHint> {VMManagedErrorHint({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _5dcc.ErrorHint vmObject;

 }

class RTManagedErrorHint extends _5dcc.ErrorHint implements _36c2.Box<_5dcc.ErrorHint> {RTManagedErrorHint(_fac9.String message, {required this.table, required this.hydroState}) : super(message,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_5dcc.ErrorHint unwrap() => this;
_5dcc.ErrorHint get vmObject => this;
...
void loadErrorHint({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'errorHint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedErrorHint(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_5dcc.ErrorHint>(boxer: ({required _5dcc.ErrorHint vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedErrorHint(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

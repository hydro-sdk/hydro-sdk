...
class VMManagedErrorHint extends _36c2.VMManagedBox<_5dcc.ErrorHint> {
  VMManagedErrorHint(
...
class RTManagedErrorHint extends _5dcc.ErrorHint
    implements _36c2.Box<_5dcc.ErrorHint> {
  RTManagedErrorHint(_fac9.String message,
...
void loadErrorHint(
  ...
  table['errorHint'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedErrorHint(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_5dcc.ErrorHint>(boxer: (
      {required _5dcc.ErrorHint vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedErrorHint(

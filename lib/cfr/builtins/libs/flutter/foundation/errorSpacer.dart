...
class VMManagedErrorSpacer extends _36c2.VMManagedBox<_5dcc.ErrorSpacer> {
  VMManagedErrorSpacer(
...
class RTManagedErrorSpacer extends _5dcc.ErrorSpacer
    implements _36c2.Box<_5dcc.ErrorSpacer> {
  RTManagedErrorSpacer({required this.table, required this.hydroState})
      : super() {
...
void loadErrorSpacer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['errorSpacer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedErrorSpacer(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_5dcc.ErrorSpacer>(boxer: (
      {required _5dcc.ErrorSpacer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedErrorSpacer(

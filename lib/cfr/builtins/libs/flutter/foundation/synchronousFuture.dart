...
class VMManagedSynchronousFuture
    extends _36c2.VMManagedBox<_6f38.SynchronousFuture<_fac9.dynamic>> {
  VMManagedSynchronousFuture(
...
class RTManagedSynchronousFuture extends _6f38.SynchronousFuture
    implements _36c2.Box<_6f38.SynchronousFuture> {
  RTManagedSynchronousFuture(_fac9.dynamic _value,
    ...
    table['_dart_asStream'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_catchError'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedtest =
          luaCallerArguments.length >= 3 ? luaCallerArguments[2]['test'] : null;
      return [
    ...
    table['_dart_then'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedonValue = luaCallerArguments[1];
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_timeout'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedonTimeout = luaCallerArguments.length >= 3
          ? luaCallerArguments[2]['onTimeout']
          : null;
    ...
    table['_dart_whenComplete'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedaction = luaCallerArguments[1];
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _7de1.Stream<_fac9.dynamic> asStream() {
  ...
  @_fac9.override
  _7de1.Future<_fac9.dynamic> catchError(onError,
      {_fac9.bool Function(_fac9.Object error)? test}) {
  ...
  @_fac9.override
  _7de1.Future<R> then<R>(onValue, {_fac9.Function? onError}) {
    _36c2.Closure closure = table["then"];
    return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<R>, R>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  _7de1.Future<_fac9.dynamic> timeout(timeLimit,
      {_7de1.FutureOr<_fac9.dynamic> Function()? onTimeout}) {
  ...
  @_fac9.override
  _7de1.Future<_fac9.dynamic> whenComplete(action) {
...
void loadSynchronousFuture(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['synchronousFuture'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSynchronousFuture(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_6f38.SynchronousFuture>(boxer: (
      {required _6f38.SynchronousFuture vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSynchronousFuture(

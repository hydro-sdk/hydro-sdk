...
class VMManagedIntProperty extends _36c2.VMManagedBox<_eaf3.IntProperty> {VMManagedIntProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedIntProperty extends _eaf3.IntProperty implements _36c2.Box<_eaf3.IntProperty> {RTManagedIntProperty(_fac9.String name$, _fac9.int? value$, {_fac9.Object? defaultValue, _fac9.String? ifNull, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _eaf3.DiagnosticsTreeStyle style, _fac9.String? unit, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,ifNull: ifNull,level: level,showName: showName,style: style,unit: unit) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadIntProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedIntProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
_36c2.registerBoxer<_eaf3.IntProperty>(boxer: ({required _eaf3.IntProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

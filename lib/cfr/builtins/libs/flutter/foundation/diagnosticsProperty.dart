...
class VMManagedDiagnosticsProperty
    extends _36c2.VMManagedBox<_eaf3.DiagnosticsProperty<_fac9.dynamic>> {
  VMManagedDiagnosticsProperty(
...
class RTManagedDiagnosticsProperty extends _eaf3.DiagnosticsProperty
  ...
  RTManagedDiagnosticsProperty(_fac9.String? name$, _fac9.dynamic? value$,
      {required _fac9.bool allowNameWrap,
      required _fac9.bool allowWrap,
      _fac9.Object? defaultValue,
      _fac9.String? description,
      required _fac9.bool expandableValue,
      _fac9.String? ifEmpty,
      _fac9.String? ifNull,
      required _eaf3.DiagnosticLevel level,
      _fac9.String? linePrefix,
      required _fac9.bool missingIfNull,
...
void loadDiagnosticsProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['diagnosticsProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDiagnosticsProperty(luaCallerArguments[1], luaCallerArguments[2],
          table: luaCallerArguments[0],
          hydroState: hydroState,
          allowNameWrap: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['allowNameWrap']
              : null,
          allowWrap: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['allowWrap']
              : null,
          defaultValue: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments[3]['defaultValue'] : null,
              parentState: hydroState),
          description: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['description']
              : null,
          expandableValue: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['expandableValue']
              : null,
          ifEmpty: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['ifEmpty']
              : null,
          ...
          level: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 4
                  ...
                  : null),
          linePrefix: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['linePrefix']
              : null,
          missingIfNull: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['missingIfNull']
              : null,
          showName: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['showName']
              : null,
          showSeparator: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['showSeparator']
              : null,
          style: _36c2.maybeUnBoxEnum(
              values: _eaf3.DiagnosticsTreeStyle.values,
              boxedEnum: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['style'] : null),
          tooltip: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['tooltip'] : null)
    ];
  });
  _36c2.registerBoxer<_eaf3.DiagnosticsProperty>(boxer: (
      {required _eaf3.DiagnosticsProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDiagnosticsProperty(

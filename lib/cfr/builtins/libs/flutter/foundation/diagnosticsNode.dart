...
class VMManagedDiagnosticsNode extends _36c2.VMManagedBox<_eaf3.DiagnosticsNode> {VMManagedDiagnosticsNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedDiagnosticsNode extends _eaf3.DiagnosticsNode implements _36c2.Box<_eaf3.DiagnosticsNode> {RTManagedDiagnosticsNode({_fac9.String? linePrefix, required _fac9.bool showName, required _fac9.bool showSeparator, _eaf3.DiagnosticsTreeStyle? style, _fac9.String? name, required this.table, required this.hydroState}) : super(linePrefix: linePrefix,showName: showName,showSeparator: showSeparator,style: style,name: name) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadDiagnosticsNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticsNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedDiagnosticsNode(table: luaCallerArguments  [
0
], hydroState: hydroState, linePrefix: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'linePrefix'
] : null, showName: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showName'
...
return [_36c2.maybeBoxObject<_eaf3.DiagnosticsNode>(object: _eaf3.DiagnosticsNode.message(luaCallerArguments  [
1
], allowWrap: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'allowWrap'
] : null, level: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticLevel.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'level'
] : null), style: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticsTreeStyle.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'style'
...
return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: _eaf3.DiagnosticsNode.toJsonList(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>?, _eaf3.DiagnosticsNode>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticsNode?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_eaf3.DiagnosticsSerializationDelegate, _fac9.dynamic>(luaCallerArguments  [
3
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_eaf3.DiagnosticsNode>(boxer: ({required _eaf3.DiagnosticsNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticsNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFlagsSummary
    extends _36c2.VMManagedBox<_eaf3.FlagsSummary<_fac9.dynamic>> {
  VMManagedFlagsSummary(
...
void loadFlagsSummary(
  ...
  table['flagsSummary'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFlagsSummary(
  ...
  _36c2.registerBoxer<_eaf3.FlagsSummary>(boxer: (
      {required _eaf3.FlagsSummary vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFlagsSummary(

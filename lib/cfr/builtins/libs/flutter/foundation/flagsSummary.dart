...
class VMManagedFlagsSummary extends _36c2.VMManagedBox<_eaf3.FlagsSummary<_fac9.dynamic>> {VMManagedFlagsSummary({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.FlagsSummary<_fac9.dynamic> vmObject;

 }

class RTManagedFlagsSummary extends _eaf3.FlagsSummary implements _36c2.Box<_eaf3.FlagsSummary> {RTManagedFlagsSummary(_fac9.String name$, _fac9.Map<_fac9.String,_fac9.dynamic?> value$, {_fac9.String? ifEmpty, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _fac9.bool showSeparator, required this.table, required this.hydroState}) : super(name$,value$,ifEmpty: ifEmpty,level: level,showName: showName,showSeparator: showSeparator) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _fac9.Map<_fac9.String,_fac9.dynamic?> get value { 
...
void loadFlagsSummary({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flagsSummary'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFlagsSummary(luaCallerArguments  [
1
...
0
], hydroState: hydroState, ifEmpty: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'ifEmpty'
...
_36c2.registerBoxer<_eaf3.FlagsSummary>(boxer: ({required _eaf3.FlagsSummary vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlagsSummary(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

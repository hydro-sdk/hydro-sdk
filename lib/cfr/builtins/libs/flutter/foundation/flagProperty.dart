...
class VMManagedFlagProperty extends _36c2.VMManagedBox<_eaf3.FlagProperty> {
  VMManagedFlagProperty(
    ...
    table['ifTrue'] = vmObject.ifTrue;
    table['ifFalse'] = vmObject.ifFalse;
    ...
    table['getShowName'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.showName,
      ];
...
class RTManagedFlagProperty extends _eaf3.FlagProperty
  ...
  RTManagedFlagProperty(_fac9.String name$,
      {_fac9.Object? defaultValue,
      _fac9.String? ifFalse,
      _fac9.String? ifTrue,
    ...
    table['ifTrue'] = _36c2.maybeBoxObject(
        object: this.ifTrue, hydroState: hydroState, table: _36c2.HydroTable());
    table['ifFalse'] = _36c2.maybeBoxObject(
        object: this.ifFalse,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getShowName'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadFlagProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['flagProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFlagProperty(luaCallerArguments[1],
          table: luaCallerArguments[0],
          hydroState: hydroState,
          defaultValue:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
                  luaCallerArguments.length >= 3
                      ? luaCallerArguments[2]['defaultValue']
                      : null,
                  parentState: hydroState),
          ifFalse: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['ifFalse']
              : null,
          ifTrue: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['ifTrue']
              : null,
          level: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 3
                  ...
                  : null),
          showName: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['showName']
              : null,
          value: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['value']
              : null)
    ];
  });
  _36c2.registerBoxer<_eaf3.FlagProperty>(boxer: (
      {required _eaf3.FlagProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFlagProperty(

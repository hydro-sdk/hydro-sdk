...
class VMManagedFlagProperty extends _36c2.VMManagedBox<_eaf3.FlagProperty> {VMManagedFlagProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getShowName'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.showName,]; } );
table  [
'getLevel'
...
final _eaf3.FlagProperty vmObject;

 }

class RTManagedFlagProperty extends _eaf3.FlagProperty implements _36c2.Box<_eaf3.FlagProperty> {RTManagedFlagProperty(_fac9.String name$, {_fac9.Object? defaultValue, _fac9.String? ifFalse, _fac9.String? ifTrue, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, _fac9.bool? value, required this.table, required this.hydroState}) : super(name$,defaultValue: defaultValue,ifFalse: ifFalse,ifTrue: ifTrue,level: level,showName: showName,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'ifTrue'
] = _36c2.maybeBoxObject(object: this.ifTrue, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'ifFalse'
] = _36c2.maybeBoxObject(object: this.ifFalse, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expandableValue'
...
_eaf3.FlagProperty unwrap() => this;
_eaf3.FlagProperty get vmObject => this;
...
@_fac9.override _fac9.bool get showName { 
_36c2.Closure closure = table["getShowName"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
@_fac9.override _fac9.bool? get value { 
...
void loadFlagProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flagProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedFlagProperty(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState, defaultValue: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'defaultValue'
] : null, parentState: hydroState), ifFalse: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'ifFalse'
] : null, ifTrue: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'ifTrue'
...
'level'
] : null), showName: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'showName'
] : null, value: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'value'
] : null)]; } );
_36c2.registerBoxer<_eaf3.FlagProperty>(boxer: ({required _eaf3.FlagProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlagProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedDiagnosticsBlock extends _36c2.VMManagedBox<_eaf3.DiagnosticsBlock> {VMManagedDiagnosticsBlock({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.DiagnosticsBlock vmObject;

 }

class RTManagedDiagnosticsBlock extends _eaf3.DiagnosticsBlock implements _36c2.Box<_eaf3.DiagnosticsBlock> {RTManagedDiagnosticsBlock({required _fac9.bool allowTruncate, required _fac9.List<_eaf3.DiagnosticsNode> children, _fac9.String? description, required _eaf3.DiagnosticLevel level, _fac9.String? linePrefix, _fac9.String? name, required _fac9.List<_eaf3.DiagnosticsNode> properties, required _fac9.bool showName, required _fac9.bool showSeparator, required _eaf3.DiagnosticsTreeStyle style, _fac9.Object? value, required this.table, required this.hydroState}) : super(allowTruncate: allowTruncate,children: children,description: description,level: level,linePrefix: linePrefix,name: name,properties: properties,showName: showName,showSeparator: showSeparator,style: style,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'level'
] = _eaf3.DiagnosticLevel.values.indexWhere((x) { return x == this.level; } );
table  [
'value'
] = _36c2.maybeBoxObject(object: this.value, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'allowTruncate'
] = _36c2.maybeBoxObject(object: this.allowTruncate, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'name'
...
_eaf3.DiagnosticsBlock unwrap() => this;
_eaf3.DiagnosticsBlock get vmObject => this;
...
void loadDiagnosticsBlock({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticsBlock'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedDiagnosticsBlock(table: luaCallerArguments  [
0
], hydroState: hydroState, allowTruncate: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'allowTruncate'
] : null, children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
] : null, parentState: hydroState), description: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'description'
] : null, level: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticLevel.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'level'
] : null), linePrefix: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'linePrefix'
...
'name'
] : null, properties: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'properties'
] : null, parentState: hydroState), showName: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showName'
] : null, showSeparator: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showSeparator'
...
'style'
] : null), value: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_eaf3.DiagnosticsBlock>(boxer: ({required _eaf3.DiagnosticsBlock vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticsBlock(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

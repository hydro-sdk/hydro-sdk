...
class VMManagedDiagnosticsBlock
    extends _36c2.VMManagedBox<_eaf3.DiagnosticsBlock> {
  VMManagedDiagnosticsBlock(
    ...
    table['level'] = _eaf3.DiagnosticLevel.values.indexWhere((x) {
    ...
    table['allowTruncate'] = vmObject.allowTruncate;
...
class RTManagedDiagnosticsBlock extends _eaf3.DiagnosticsBlock
  ...
  RTManagedDiagnosticsBlock(
      {required _fac9.bool allowTruncate,
      required _fac9.List<_eaf3.DiagnosticsNode> children,
      _fac9.String? description,
      required _eaf3.DiagnosticLevel level,
      _fac9.String? linePrefix,
      _fac9.String? name,
      required _fac9.List<_eaf3.DiagnosticsNode> properties,
    ...
    table['allowTruncate'] = _36c2.maybeBoxObject(
        object: this.allowTruncate,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadDiagnosticsBlock(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['diagnosticsBlock'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDiagnosticsBlock(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          allowTruncate: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['allowTruncate']
              : null,
          children: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['children']
                      : null,
                  parentState: hydroState),
          description: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['description']
              : null,
          level: _36c2.maybeUnBoxEnum(
              values: _eaf3.DiagnosticLevel.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['level']
                  : null),
          ...
          properties: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(
                  ...
                  parentState: hydroState),
          showName: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['showName'] : null,
          showSeparator: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['showSeparator'] : null,
          style: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticsTreeStyle.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['style'] : null),
          value: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['value'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_eaf3.DiagnosticsBlock>(boxer: (
      {required _eaf3.DiagnosticsBlock vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDiagnosticsBlock(

...
class VMManagedAbstractNode extends _36c2.VMManagedBox<_b05e.AbstractNode> {VMManagedAbstractNode({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAbstractNode extends _b05e.AbstractNode implements _36c2.Box<_b05e.AbstractNode> {RTManagedAbstractNode({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAbstractNode({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'abstractNode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAbstractNode(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_b05e.AbstractNode>(boxer: ({required _b05e.AbstractNode vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAbstractNode(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

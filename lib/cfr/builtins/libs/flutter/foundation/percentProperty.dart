...
class VMManagedPercentProperty
    extends _36c2.VMManagedBox<_eaf3.PercentProperty> {
  VMManagedPercentProperty(
...
class RTManagedPercentProperty extends _eaf3.PercentProperty
    implements _36c2.Box<_eaf3.PercentProperty> {
  RTManagedPercentProperty(_fac9.String name$, _fac9.double? fraction,
      {_fac9.String? ifNull,
...
void loadPercentProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['percentProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPercentProperty(
  ...
  _36c2.registerBoxer<_eaf3.PercentProperty>(boxer: (
      {required _eaf3.PercentProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPercentProperty(

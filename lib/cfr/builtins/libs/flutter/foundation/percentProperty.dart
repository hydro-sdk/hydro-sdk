...
class VMManagedPercentProperty extends _36c2.VMManagedBox<_eaf3.PercentProperty> {VMManagedPercentProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'numberToString'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.numberToString(),]; } );
table  [
'toJsonMap'
...
final _eaf3.PercentProperty vmObject;

 }

class RTManagedPercentProperty extends _eaf3.PercentProperty implements _36c2.Box<_eaf3.PercentProperty> {RTManagedPercentProperty(_fac9.String name$, _fac9.double? fraction, {_fac9.String? ifNull, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, _fac9.String? tooltip, _fac9.String? unit, required this.table, required this.hydroState}) : super(name$,fraction,ifNull: ifNull,level: level,showName: showName,tooltip: tooltip,unit: unit) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'unit'
] = _36c2.maybeBoxObject(object: this.unit, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expandableValue'
...
_eaf3.PercentProperty unwrap() => this;
_eaf3.PercentProperty get vmObject => this;
...
@_fac9.override _fac9.String numberToString() { 
...
void loadPercentProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'percentProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPercentProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
'tooltip'
] : null, unit: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'unit'
] : null)]; } );
_36c2.registerBoxer<_eaf3.PercentProperty>(boxer: ({required _eaf3.PercentProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPercentProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

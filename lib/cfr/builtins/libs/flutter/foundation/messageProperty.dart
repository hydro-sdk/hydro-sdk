...
class VMManagedMessageProperty extends _36c2.VMManagedBox<_eaf3.MessageProperty> {VMManagedMessageProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.value;
return []; } );
table  [
'getException'
...
final _eaf3.MessageProperty vmObject;

 }

class RTManagedMessageProperty extends _eaf3.MessageProperty implements _36c2.Box<_eaf3.MessageProperty> {RTManagedMessageProperty(_fac9.String name$, _fac9.String message, {required _eaf3.DiagnosticLevel level, required _eaf3.DiagnosticsTreeStyle style, required this.table, required this.hydroState}) : super(name$,message,level: level,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_eaf3.MessageProperty unwrap() => this;
_eaf3.MessageProperty get vmObject => this;
...
void loadMessageProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'messageProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedMessageProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
], table: luaCallerArguments  [
0
], hydroState: hydroState, level: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticLevel.values, boxedEnum: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'level'
...
_36c2.registerBoxer<_eaf3.MessageProperty>(boxer: ({required _eaf3.MessageProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMessageProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

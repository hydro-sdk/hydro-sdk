...
class VMManagedMessageProperty
    extends _36c2.VMManagedBox<_eaf3.MessageProperty> {
  VMManagedMessageProperty(
...
class RTManagedMessageProperty extends _eaf3.MessageProperty
    implements _36c2.Box<_eaf3.MessageProperty> {
  RTManagedMessageProperty(_fac9.String name$, _fac9.String message,
      {required _eaf3.DiagnosticLevel level,
      required _eaf3.DiagnosticsTreeStyle style,
      required this.table,
      required this.hydroState})
      : super(name$, message, level: level, style: style) {
...
void loadMessageProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['messageProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMessageProperty(luaCallerArguments[1], luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_eaf3.MessageProperty>(boxer: (
      {required _eaf3.MessageProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMessageProperty(

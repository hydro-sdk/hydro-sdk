...
class VMManagedErrorSummary extends _36c2.VMManagedBox<_5dcc.ErrorSummary> {VMManagedErrorSummary({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedErrorSummary extends _5dcc.ErrorSummary implements _36c2.Box<_5dcc.ErrorSummary> {RTManagedErrorSummary(_fac9.String message, {required this.table, required this.hydroState}) : super(message,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadErrorSummary({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'errorSummary'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedErrorSummary(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_5dcc.ErrorSummary>(boxer: ({required _5dcc.ErrorSummary vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedErrorSummary(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedStringProperty extends _36c2.VMManagedBox<_eaf3.StringProperty> {
  VMManagedStringProperty(
...
class RTManagedStringProperty extends _eaf3.StringProperty
    implements _36c2.Box<_eaf3.StringProperty> {
  RTManagedStringProperty(_fac9.String name$, _fac9.String? value$,
      {_fac9.Object? defaultValue,
      _fac9.String? description,
      _fac9.String? ifEmpty,
      required _eaf3.DiagnosticLevel level,
      required _fac9.bool quoted,
    ...
    table['quoted'] = _36c2.maybeBoxObject(
        object: this.quoted, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadStringProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['stringProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStringProperty(luaCallerArguments[1], luaCallerArguments[2],
          ...
          level: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 4
                  ...
                  : null),
          quoted: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['quoted']
              : null,
          ...
          style: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 4
                  ...
                  : null),
          tooltip: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['tooltip']
              : null)
    ];
  });
  _36c2.registerBoxer<_eaf3.StringProperty>(boxer: (
      {required _eaf3.StringProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedStringProperty(

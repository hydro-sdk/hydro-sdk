...
class VMManagedStringProperty extends _36c2.VMManagedBox<_eaf3.StringProperty> {VMManagedStringProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _eaf3.StringProperty vmObject;

 }

class RTManagedStringProperty extends _eaf3.StringProperty implements _36c2.Box<_eaf3.StringProperty> {RTManagedStringProperty(_fac9.String name$, _fac9.String? value$, {_fac9.Object? defaultValue, _fac9.String? description, _fac9.String? ifEmpty, required _eaf3.DiagnosticLevel level, required _fac9.bool quoted, required _fac9.bool showName, required _eaf3.DiagnosticsTreeStyle style, _fac9.String? tooltip, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,description: description,ifEmpty: ifEmpty,level: level,quoted: quoted,showName: showName,style: style,tooltip: tooltip) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'quoted'
] = _36c2.maybeBoxObject(object: this.quoted, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'expandableValue'
...
_eaf3.StringProperty unwrap() => this;
_eaf3.StringProperty get vmObject => this;
...
void loadStringProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'stringProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedStringProperty(luaCallerArguments  [
1
], luaCallerArguments  [
2
...
'level'
] : null), quoted: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'quoted'
...
_36c2.registerBoxer<_eaf3.StringProperty>(boxer: ({required _eaf3.StringProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStringProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

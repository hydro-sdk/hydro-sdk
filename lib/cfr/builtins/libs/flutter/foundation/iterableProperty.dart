...
class VMManagedIterableProperty
    extends _36c2.VMManagedBox<_eaf3.IterableProperty<_fac9.dynamic>> {
  VMManagedIterableProperty(
...
class RTManagedIterableProperty extends _eaf3.IterableProperty
  ...
  @_fac9.override
  _fac9.Iterable<_fac9.dynamic>? get value {
...
void loadIterableProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['iterableProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIterableProperty(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_fac9.dynamic>?, _fac9.dynamic>(
              luaCallerArguments[2],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState,
          defaultValue: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
          ...
          level: _36c2.maybeUnBoxEnum(
              values: _eaf3.DiagnosticLevel.values,
              boxedEnum: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['level'] : null),
          showName: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['showName'] : null,
          showSeparator: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['showSeparator'] : null,
          style: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticsTreeStyle.values, boxedEnum: luaCallerArguments.length >= 4 ? luaCallerArguments[3]['style'] : null))
    ];
  });
  _36c2.registerBoxer<_eaf3.IterableProperty>(boxer: (
      {required _eaf3.IterableProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIterableProperty(

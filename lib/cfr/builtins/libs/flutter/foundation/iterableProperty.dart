...
class VMManagedIterableProperty extends _36c2.VMManagedBox<_eaf3.IterableProperty<_fac9.dynamic>> {VMManagedIterableProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.value;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Iterable?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getException'
...
final _eaf3.IterableProperty<_fac9.dynamic> vmObject;

 }

class RTManagedIterableProperty extends _eaf3.IterableProperty implements _36c2.Box<_eaf3.IterableProperty> {RTManagedIterableProperty(_fac9.String name$, _fac9.Iterable<_fac9.dynamic>? value$, {_fac9.Object? defaultValue, _fac9.String? ifEmpty, _fac9.String? ifNull, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _fac9.bool showSeparator, required _eaf3.DiagnosticsTreeStyle style, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,ifEmpty: ifEmpty,ifNull: ifNull,level: level,showName: showName,showSeparator: showSeparator,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_eaf3.IterableProperty unwrap() => this;
_eaf3.IterableProperty get vmObject => this;
...
@_fac9.override _fac9.Iterable<_fac9.dynamic>? get value { 
...
void loadIterableProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'iterableProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedIterableProperty(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_fac9.dynamic>?, _fac9.dynamic>(luaCallerArguments  [
2
...
'defaultValue'
] : null, parentState: hydroState), ifEmpty: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'ifEmpty'
...
_36c2.registerBoxer<_eaf3.IterableProperty>(boxer: ({required _eaf3.IterableProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIterableProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

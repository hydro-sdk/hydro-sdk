...
class VMManagedAnimationMax
    extends _36c2.VMManagedBox<_77a7.AnimationMax<_fac9.num>> {
  VMManagedAnimationMax(
...
class RTManagedAnimationMax extends _77a7.AnimationMax
    implements _36c2.Box<_77a7.AnimationMax> {
  RTManagedAnimationMax(
...
void loadAnimationMax(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animationMax'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnimationMax(
  ...
  _36c2.registerBoxer<_77a7.AnimationMax>(boxer: (
      {required _77a7.AnimationMax vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimationMax(

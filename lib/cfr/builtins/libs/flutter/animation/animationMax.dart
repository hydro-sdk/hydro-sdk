...
class VMManagedAnimationMax extends _36c2.VMManagedBox<_77a7.AnimationMax<_fac9.num>> {VMManagedAnimationMax({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _77a7.AnimationMax<_fac9.num> vmObject;

 }

class RTManagedAnimationMax extends _77a7.AnimationMax implements _36c2.Box<_77a7.AnimationMax> {RTManagedAnimationMax(_86ca.Animation<_fac9.num> first$, _86ca.Animation<_fac9.num> next$, {required this.table, required this.hydroState}) : super(first$,next$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_77a7.AnimationMax unwrap() => this;
_77a7.AnimationMax get vmObject => this;
...
void loadAnimationMax({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animationMax'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAnimationMax(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_77a7.AnimationMax>(boxer: ({required _77a7.AnimationMax vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimationMax(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFlippedCurve extends _36c2.VMManagedBox<_8c47.FlippedCurve> {VMManagedFlippedCurve({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedFlippedCurve extends _8c47.FlippedCurve implements _36c2.Box<_8c47.FlippedCurve> {RTManagedFlippedCurve(_8c47.Curve curve$, {required this.table, required this.hydroState}) : super(curve$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadFlippedCurve({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flippedCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFlippedCurve(_36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_8c47.FlippedCurve>(boxer: ({required _8c47.FlippedCurve vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlippedCurve(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

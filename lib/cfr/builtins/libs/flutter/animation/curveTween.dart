...
class VMManagedCurveTween extends _36c2.VMManagedBox<_e83e.CurveTween> {VMManagedCurveTween({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedCurveTween extends _e83e.CurveTween implements _36c2.Box<_e83e.CurveTween> {RTManagedCurveTween({required _8c47.Curve curve, required this.table, required this.hydroState}) : super(curve: curve) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadCurveTween({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'curveTween'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedCurveTween(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e83e.CurveTween>(boxer: ({required _e83e.CurveTween vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCurveTween(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

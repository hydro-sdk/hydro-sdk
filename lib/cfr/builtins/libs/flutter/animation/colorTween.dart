...
class VMManagedColorTween extends _36c2.VMManagedBox<_e83e.ColorTween> {
  VMManagedColorTween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_a643.Color?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_a643.Color?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
class RTManagedColorTween extends _e83e.ColorTween
    implements _36c2.Box<_e83e.ColorTween> {
  RTManagedColorTween(
      {_a643.Color? begin,
      _a643.Color? end,
      required this.table,
  ...
  @_fac9.override
  _a643.Color? evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_a643.Color?> animate(parent) {
  ...
  @_fac9.override
  _e83e.Animatable<_a643.Color?> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<_e83e.Animatable<_a643.Color?>,
            _a643.Color?>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadColorTween(
  ...
  table['colorTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColorTween(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          begin: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['begin']
                  : null,
              parentState: hydroState),
          end: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_e83e.ColorTween>(boxer: (
      {required _e83e.ColorTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColorTween(

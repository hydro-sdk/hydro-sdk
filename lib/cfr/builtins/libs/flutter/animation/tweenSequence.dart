...
class VMManagedTweenSequence extends _36c2.VMManagedBox<_fb3c.TweenSequence<_fac9.dynamic>> {VMManagedTweenSequence({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTweenSequence extends _fb3c.TweenSequence implements _36c2.Box<_fb3c.TweenSequence> {RTManagedTweenSequence(_fac9.List<_fb3c.TweenSequenceItem<_fac9.dynamic>> items, {required this.table, required this.hydroState}) : super(items,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTweenSequence({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'tweenSequence'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedTweenSequence(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fb3c.TweenSequenceItem<_fac9.dynamic>>, _fb3c.TweenSequenceItem<_fac9.dynamic>>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_fb3c.TweenSequence>(boxer: ({required _fb3c.TweenSequence vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTweenSequence(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedTrainHoppingAnimation extends _36c2.VMManagedBox<_77a7.TrainHoppingAnimation> {VMManagedTrainHoppingAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getCurrentTrain'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.currentTrain;if(returnValue!= null){return [_36c2.maybeBoxObject<_86ca.Animation?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getStatus'
...
class RTManagedTrainHoppingAnimation extends _77a7.TrainHoppingAnimation implements _36c2.Box<_77a7.TrainHoppingAnimation> {RTManagedTrainHoppingAnimation(_86ca.Animation<_fac9.double> _currentTrain, _86ca.Animation<_fac9.double>? _nextTrain, {void Function()? onSwitchedTrain, required this.table, required this.hydroState}) : super(_currentTrain,_nextTrain,onSwitchedTrain: onSwitchedTrain) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_getCurrentTrain'] =
...
@_fac9.override _86ca.Animation<_fac9.double>? get currentTrain { 
...
void loadTrainHoppingAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'trainHoppingAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

_36c2.Closure? unpackedonSwitchedTrain=luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'onSwitchedTrain'
] : null;
return  [RTManagedTrainHoppingAnimation(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
1
...
0
], hydroState: hydroState, onSwitchedTrain: unpackedonSwitchedTrain != null ? () => unpackedonSwitchedTrain.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null )]; } );
_36c2.registerBoxer<_77a7.TrainHoppingAnimation>(boxer: ({required _77a7.TrainHoppingAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTrainHoppingAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAlwaysStoppedAnimation extends _36c2.VMManagedBox<_77a7.AlwaysStoppedAnimation<_fac9.dynamic>> {VMManagedAlwaysStoppedAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAlwaysStoppedAnimation extends _77a7.AlwaysStoppedAnimation implements _36c2.Box<_77a7.AlwaysStoppedAnimation> {RTManagedAlwaysStoppedAnimation(_fac9.dynamic value$, {required this.table, required this.hydroState}) : super(value$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAlwaysStoppedAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'alwaysStoppedAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAlwaysStoppedAnimation(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_77a7.AlwaysStoppedAnimation>(boxer: ({required _77a7.AlwaysStoppedAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAlwaysStoppedAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAnimationController extends _36c2.VMManagedBox<_c169.AnimationController> {VMManagedAnimationController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'animationBehavior'
] = _c169.AnimationBehavior.values.indexWhere((x) { return x == vmObject.animationBehavior; } );
table  [
'duration'
] = _36c2.maybeBoxObject<_fac9.Duration?>(object: vmObject.duration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'reverseDuration'
] = _36c2.maybeBoxObject<_fac9.Duration?>(object: vmObject.reverseDuration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.view, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'resync'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.resync(_36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'reset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.reset();
return []; } );
table  [
'getVelocity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.velocity,]; } );
table  [
'getLastElapsedDuration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.lastElapsedDuration;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Duration?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getIsAnimating'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isAnimating,]; } );
table  [
'getStatus'
...
table  [
'forward'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.forward(from: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'from'
...
table  [
'reverse'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.reverse(from: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'from'
] : null?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
...
return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.animateTo(luaCallerArguments  [
1
...
return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.animateBack(luaCallerArguments  [
1
]?.toDouble(), curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
...
return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.repeat(max: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'max'
] : null?.toDouble(), min: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'min'
] : null?.toDouble(), period: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'period'
] : null, parentState: hydroState), reverse: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverse'
...
return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.fling(animationBehavior: _36c2.maybeUnBoxEnum(values: _c169.AnimationBehavior.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animationBehavior'
] : null), springDescription: _36c2.maybeUnBoxAndBuildArgument<_5917.SpringDescription?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'springDescription'
...
table  [
'animateWith'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e067.TickerFuture>(object: vmObject.animateWith(_36c2.maybeUnBoxAndBuildArgument<_5437.Simulation, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedAnimationController extends _c169.AnimationController implements _36c2.Box<_c169.AnimationController> {RTManagedAnimationController({required _c169.AnimationBehavior animationBehavior, _fac9.String? debugLabel, _fac9.Duration? duration, required _fac9.double lowerBound, _fac9.Duration? reverseDuration, required _fac9.double upperBound, _fac9.double? value, required _e067.TickerProvider vsync, required this.table, required this.hydroState}) : super(animationBehavior: animationBehavior,debugLabel: debugLabel,duration: duration,lowerBound: lowerBound,reverseDuration: reverseDuration,upperBound: upperBound,value: value,vsync: vsync) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'lowerBound'
] = _36c2.maybeBoxObject(object: this.lowerBound, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'upperBound'
] = _36c2.maybeBoxObject(object: this.upperBound, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugLabel'
] = _36c2.maybeBoxObject(object: this.debugLabel, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'animationBehavior'
] = _c169.AnimationBehavior.values.indexWhere((x) { return x == this.animationBehavior; } );
table  [
'duration'
] = _36c2.maybeBoxObject(object: this.duration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'reverseDuration'
] = _36c2.maybeBoxObject(object: this.reverseDuration, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_getView'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.view];
});
...
table['_dart_getLastElapsedDuration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.lastElapsedDuration];
});
table['_dart_getIsAnimating'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_animateWith'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.animateWith(
...
table['_dart_didRegisterListener'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didRegisterListener();
  return [];
});
table['_dart_didUnregisterListener'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_clearStatusListeners'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.clearStatusListeners();
  return [];
});
table['_dart_notifyStatusListeners'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.notifyStatusListeners(_36c2.maybeUnBoxEnum(
      values: _86ca.AnimationStatus.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_drive'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
@_fac9.override _86ca.Animation<_fac9.double> get view { 
...
@_fac9.override void resync(vsync) { 
...
@_fac9.override _fac9.bool get isAnimating { 
...
@_fac9.override _e067.TickerFuture forward({_fac9.double? from}) { 
...
@_fac9.override _e067.TickerFuture reverse({_fac9.double? from}) { 
_36c2.Closure closure = table["reverse"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e067.TickerFuture animateTo(target, {_8c47.Curve curve = _8c47.Curves.linear, _fac9.Duration? duration}) { 
_36c2.Closure closure = table["animateTo"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e067.TickerFuture animateBack(target, {_8c47.Curve curve = _8c47.Curves.linear, _fac9.Duration? duration}) { 
_36c2.Closure closure = table["animateBack"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e067.TickerFuture repeat({_fac9.double? max, _fac9.double? min, _fac9.Duration? period, _fac9.bool reverse = false}) { 
_36c2.Closure closure = table["repeat"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e067.TickerFuture fling({_c169.AnimationBehavior? animationBehavior, _5917.SpringDescription? springDescription, _fac9.double velocity = 1.0}) { 
_36c2.Closure closure = table["fling"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _e067.TickerFuture animateWith(simulation) { 
_36c2.Closure closure = table["animateWith"];
return _36c2.maybeUnBoxAndBuildArgument<_e067.TickerFuture, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void stop({_fac9.bool canceled = true}) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didRegisterListener() { 
_36c2.Closure closure = table["didRegisterListener"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didUnregisterListener() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void clearListeners() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void clearStatusListeners() { 
_36c2.Closure closure = table["clearStatusListeners"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void notifyStatusListeners(status) { 
...
void loadAnimationController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animationController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedAnimationController(table: luaCallerArguments  [
0
], hydroState: hydroState, animationBehavior: _36c2.maybeUnBoxEnum(values: _c169.AnimationBehavior.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'animationBehavior'
...
'debugLabel'
] : null, duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'duration'
] : null, parentState: hydroState), lowerBound: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'lowerBound'
] : null?.toDouble(), reverseDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverseDuration'
] : null, parentState: hydroState), upperBound: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'upperBound'
] : null?.toDouble(), value: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'value'
] : null?.toDouble(), vsync: _36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'vsync'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_c169.AnimationController>(boxer: ({required _c169.AnimationController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimationController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

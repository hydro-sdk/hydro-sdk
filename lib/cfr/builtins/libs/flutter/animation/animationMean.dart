...
class VMManagedAnimationMean extends _36c2.VMManagedBox<_77a7.AnimationMean> {VMManagedAnimationMean({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAnimationMean extends _77a7.AnimationMean implements _36c2.Box<_77a7.AnimationMean> {RTManagedAnimationMean({required _86ca.Animation<_fac9.double> left, required _86ca.Animation<_fac9.double> right, required this.table, required this.hydroState}) : super(left: left,right: right) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'first'
] = _36c2.maybeBoxObject(object: first, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'next'
] = _36c2.maybeBoxObject(object: next, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadAnimationMean({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animationMean'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAnimationMean(table: luaCallerArguments  [
0
], hydroState: hydroState, left: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'left'
] : null, parentState: hydroState), right: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'right'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_77a7.AnimationMean>(boxer: ({required _77a7.AnimationMean vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimationMean(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

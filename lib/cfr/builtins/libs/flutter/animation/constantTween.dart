...
class VMManagedConstantTween extends _36c2.VMManagedBox<_e83e.ConstantTween<_fac9.dynamic>> {VMManagedConstantTween({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e83e.ConstantTween<_fac9.dynamic> vmObject;

 }

class RTManagedConstantTween extends _e83e.ConstantTween implements _36c2.Box<_e83e.ConstantTween> {RTManagedConstantTween(_fac9.dynamic value, {required this.table, required this.hydroState}) : super(value,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e83e.ConstantTween unwrap() => this;
_e83e.ConstantTween get vmObject => this;
@_fac9.override _fac9.dynamic lerp(t) { 
...
void loadConstantTween({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'constantTween'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedConstantTween(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e83e.ConstantTween>(boxer: ({required _e83e.ConstantTween vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedConstantTween(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedConstantTween
    extends _36c2.VMManagedBox<_e83e.ConstantTween<_fac9.dynamic>> {
  VMManagedConstantTween(
...
class RTManagedConstantTween extends _e83e.ConstantTween
    implements _36c2.Box<_e83e.ConstantTween> {
  RTManagedConstantTween(_fac9.dynamic value,
...
void loadConstantTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['constantTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedConstantTween(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e83e.ConstantTween>(boxer: (
      {required _e83e.ConstantTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedConstantTween(

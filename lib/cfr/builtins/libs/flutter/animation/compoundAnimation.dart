...
class VMManagedCompoundAnimation extends _36c2.VMManagedBox<_77a7.CompoundAnimation<_fac9.dynamic>> {VMManagedCompoundAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'first'
] = _36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.first, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'next'
] = _36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.next, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'didStartListening'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didStartListening();
return []; } );
table  [
'didStopListening'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.didStopListening();
return []; } );
table  [
'getStatus'
...
table  [
'getIsListening'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isListening,]; } );
table  [
'addListener'
...
final _77a7.CompoundAnimation<_fac9.dynamic> vmObject;

 }

class RTManagedCompoundAnimation extends _77a7.CompoundAnimation implements _36c2.Box<_77a7.CompoundAnimation> {RTManagedCompoundAnimation({required _86ca.Animation<_fac9.dynamic> first, required _86ca.Animation<_fac9.dynamic> next, required this.table, required this.hydroState}) : super(first: first,next: next) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'first'
] = _36c2.maybeBoxObject(object: this.first, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'next'
] = _36c2.maybeBoxObject(object: this.next, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_didStartListening'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.didStartListening();
  return [];
});
table['_dart_didStopListening'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
_77a7.CompoundAnimation unwrap() => this;
_77a7.CompoundAnimation get vmObject => this;
@_fac9.override void didStartListening() { 
_36c2.Closure closure = table["didStartListening"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void didStopListening() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isListening { 
...
void loadCompoundAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'compoundAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedCompoundAnimation(table: luaCallerArguments  [
0
], hydroState: hydroState, first: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'first'
] : null, parentState: hydroState), next: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'next'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_77a7.CompoundAnimation>(boxer: ({required _77a7.CompoundAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCompoundAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

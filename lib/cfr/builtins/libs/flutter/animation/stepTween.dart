...
class VMManagedStepTween extends _36c2.VMManagedBox<_e83e.StepTween> {
  VMManagedStepTween(
...
class RTManagedStepTween extends _e83e.StepTween
    implements _36c2.Box<_e83e.StepTween> {
  RTManagedStepTween(
      {_fac9.int? begin,
      _fac9.int? end,
      required this.table,
...
void loadStepTween(
  ...
  table['stepTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStepTween(
  ...
  _36c2.registerBoxer<_e83e.StepTween>(boxer: (
      {required _e83e.StepTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedStepTween(

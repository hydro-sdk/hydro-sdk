...
class VMManagedTween extends _36c2.VMManagedBox<_e83e.Tween<_fac9.Object?>> {
  VMManagedTween(
...
void loadTween(
  ...
  table['tween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTween(
  ...
  _36c2.registerBoxer<_e83e.Tween>(boxer: (
      {required _e83e.Tween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTween(

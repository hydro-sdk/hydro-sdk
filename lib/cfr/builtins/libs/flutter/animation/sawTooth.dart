...
class VMManagedSawTooth extends _36c2.VMManagedBox<_8c47.SawTooth> {
  VMManagedSawTooth(
...
class RTManagedSawTooth extends _8c47.SawTooth
    implements _36c2.Box<_8c47.SawTooth> {
  RTManagedSawTooth(_fac9.int count$,
...
void loadSawTooth(
  ...
  table['sawTooth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSawTooth(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.SawTooth>(boxer: (
      {required _8c47.SawTooth vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSawTooth(

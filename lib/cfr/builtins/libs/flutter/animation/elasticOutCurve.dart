...
class VMManagedElasticOutCurve
    extends _36c2.VMManagedBox<_8c47.ElasticOutCurve> {
  VMManagedElasticOutCurve(
...
class RTManagedElasticOutCurve extends _8c47.ElasticOutCurve
    implements _36c2.Box<_8c47.ElasticOutCurve> {
  RTManagedElasticOutCurve(_fac9.double period$,
...
void loadElasticOutCurve(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['elasticOutCurve'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedElasticOutCurve(luaCallerArguments[1]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.ElasticOutCurve>(boxer: (
      {required _8c47.ElasticOutCurve vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedElasticOutCurve(

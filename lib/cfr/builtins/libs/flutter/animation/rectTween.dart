...
class VMManagedRectTween extends _36c2.VMManagedBox<_e83e.RectTween> {
  VMManagedRectTween(
...
class RTManagedRectTween extends _e83e.RectTween
    implements _36c2.Box<_e83e.RectTween> {
  RTManagedRectTween(
      {_a643.Rect? begin,
      _a643.Rect? end,
      required this.table,
...
void loadRectTween(
  ...
  table['rectTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRectTween(
  ...
  _36c2.registerBoxer<_e83e.RectTween>(boxer: (
      {required _e83e.RectTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRectTween(

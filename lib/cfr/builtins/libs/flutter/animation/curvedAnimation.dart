...
class VMManagedCurvedAnimation extends _36c2.VMManagedBox<_77a7.CurvedAnimation> {VMManagedCurvedAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'reverseCurve'
] = _36c2.maybeBoxObject<_8c47.Curve?>(object: vmObject.reverseCurve, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'isDisposed'
] = vmObject.isDisposed;
table  [
...
table  [
'getParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.parent, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getStatus'
...
class RTManagedCurvedAnimation extends _77a7.CurvedAnimation implements _36c2.Box<_77a7.CurvedAnimation> {RTManagedCurvedAnimation({_8c47.Curve? reverseCurve, required _8c47.Curve curve, required _86ca.Animation<_fac9.double> parent, required this.table, required this.hydroState}) : super(reverseCurve: reverseCurve,curve: curve,parent: parent) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'reverseCurve'
] = _36c2.maybeBoxObject(object: this.reverseCurve, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'isDisposed'
] = _36c2.maybeBoxObject(object: isDisposed, hydroState: hydroState, table: _36c2.HydroTable());
table['_dart_dispose'] =
...
void loadCurvedAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'curvedAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedCurvedAnimation(table: luaCallerArguments  [
0
], hydroState: hydroState, reverseCurve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverseCurve'
...
'curve'
] : null, parentState: hydroState), parent: _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'parent'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_77a7.CurvedAnimation>(boxer: ({required _77a7.CurvedAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCurvedAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedCurve extends _36c2.VMManagedBox<_8c47.Curve> {
  VMManagedCurve(
...
class RTManagedCurve extends _8c47.Curve implements _36c2.Box<_8c47.Curve> {
...
void loadCurve(
  ...
  table['curve'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCurve(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.Curve>(boxer: (
      {required _8c47.Curve vmObject,

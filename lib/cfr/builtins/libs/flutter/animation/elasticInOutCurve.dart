...
class VMManagedElasticInOutCurve
    extends _36c2.VMManagedBox<_8c47.ElasticInOutCurve> {
  VMManagedElasticInOutCurve(
...
class RTManagedElasticInOutCurve extends _8c47.ElasticInOutCurve
    implements _36c2.Box<_8c47.ElasticInOutCurve> {
  RTManagedElasticInOutCurve(_fac9.double period$,
    ...
    table['period'] = _36c2.maybeBoxObject(
        object: period, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadElasticInOutCurve(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['elasticInOutCurve'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedElasticInOutCurve(luaCallerArguments[1]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.ElasticInOutCurve>(boxer: (
      {required _8c47.ElasticInOutCurve vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedElasticInOutCurve(

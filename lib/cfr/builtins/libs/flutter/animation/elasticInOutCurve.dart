...
class VMManagedElasticInOutCurve extends _36c2.VMManagedBox<_8c47.ElasticInOutCurve> {VMManagedElasticInOutCurve({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c47.ElasticInOutCurve vmObject;

 }

class RTManagedElasticInOutCurve extends _8c47.ElasticInOutCurve implements _36c2.Box<_8c47.ElasticInOutCurve> {RTManagedElasticInOutCurve(_fac9.double period$, {required this.table, required this.hydroState}) : super(period$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c47.ElasticInOutCurve unwrap() => this;
_8c47.ElasticInOutCurve get vmObject => this;
...
void loadElasticInOutCurve({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'elasticInOutCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedElasticInOutCurve(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_8c47.ElasticInOutCurve>(boxer: ({required _8c47.ElasticInOutCurve vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedElasticInOutCurve(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

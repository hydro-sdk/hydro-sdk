...
class VMManagedCubic extends _36c2.VMManagedBox<_8c47.Cubic> {VMManagedCubic({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedCubic extends _8c47.Cubic implements _36c2.Box<_8c47.Cubic> {RTManagedCubic(_fac9.double a$, _fac9.double b$, _fac9.double c$, _fac9.double d$, {required this.table, required this.hydroState}) : super(a$,b$,c$,d$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'c'
] = _36c2.maybeBoxObject(object: this.c, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'd'
] = _36c2.maybeBoxObject(object: this.d, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadCubic({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'cubic'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedCubic(luaCallerArguments  [
1
...
_36c2.registerBoxer<_8c47.Cubic>(boxer: ({required _8c47.Cubic vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCubic(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

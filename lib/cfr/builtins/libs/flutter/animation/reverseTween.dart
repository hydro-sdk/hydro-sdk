...
class VMManagedReverseTween extends _36c2.VMManagedBox<_e83e.ReverseTween<_fac9.Object?>> {VMManagedReverseTween({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'parent'
] = _36c2.maybeBoxObject<_e83e.Tween>(object: vmObject.parent, hydroState: hydroState, table: _36c2.HydroTable());
...
class RTManagedReverseTween extends _e83e.ReverseTween implements _36c2.Box<_e83e.ReverseTween> {RTManagedReverseTween(_e83e.Tween<_fac9.Object?> parent$, {required this.table, required this.hydroState}) : super(parent$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadReverseTween({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'reverseTween'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedReverseTween(_36c2.maybeUnBoxAndBuildArgument<_e83e.Tween<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e83e.ReverseTween>(boxer: ({required _e83e.ReverseTween vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedReverseTween(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

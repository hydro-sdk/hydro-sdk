...
class VMManagedReverseAnimation extends _36c2.VMManagedBox<_77a7.ReverseAnimation> {VMManagedReverseAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'parent'
] = _36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.parent, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'addListener'
...
class RTManagedReverseAnimation extends _77a7.ReverseAnimation implements _36c2.Box<_77a7.ReverseAnimation> {RTManagedReverseAnimation(_86ca.Animation<_fac9.double> parent$, {required this.table, required this.hydroState}) : super(parent$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadReverseAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'reverseAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedReverseAnimation(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>, _fac9.double>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_77a7.ReverseAnimation>(boxer: ({required _77a7.ReverseAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedReverseAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

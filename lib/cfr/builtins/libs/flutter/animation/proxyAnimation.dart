...
class VMManagedProxyAnimation extends _36c2.VMManagedBox<_77a7.ProxyAnimation> {VMManagedProxyAnimation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.parent;if(returnValue!= null){return [_36c2.maybeBoxObject<_86ca.Animation?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setParent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.parent=(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>?, _fac9.double>(luaCallerArguments  [
1
...
class RTManagedProxyAnimation extends _77a7.ProxyAnimation implements _36c2.Box<_77a7.ProxyAnimation> {RTManagedProxyAnimation(_86ca.Animation<_fac9.double>? animation, {required this.table, required this.hydroState}) : super(animation,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _86ca.Animation<_fac9.double>? get parent { 
...
@_fac9.override void set parent(value) { 
...
void loadProxyAnimation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'proxyAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedProxyAnimation(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>?, _fac9.double>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_77a7.ProxyAnimation>(boxer: ({required _77a7.ProxyAnimation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedProxyAnimation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

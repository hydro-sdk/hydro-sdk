...
class VMManagedThreshold extends _36c2.VMManagedBox<_8c47.Threshold> {
  VMManagedThreshold(
    ...
    table['threshold'] = vmObject.threshold;
...
class RTManagedThreshold extends _8c47.Threshold
    implements _36c2.Box<_8c47.Threshold> {
  RTManagedThreshold(_fac9.double threshold$,
    ...
    table['threshold'] = _36c2.maybeBoxObject(
        object: this.threshold,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadThreshold(
  ...
  table['threshold'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedThreshold(luaCallerArguments[1]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.Threshold>(boxer: (
      {required _8c47.Threshold vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedThreshold(

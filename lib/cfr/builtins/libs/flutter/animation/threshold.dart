...
class VMManagedThreshold extends _36c2.VMManagedBox<_8c47.Threshold> {VMManagedThreshold({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c47.Threshold vmObject;

 }

class RTManagedThreshold extends _8c47.Threshold implements _36c2.Box<_8c47.Threshold> {RTManagedThreshold(_fac9.double threshold$, {required this.table, required this.hydroState}) : super(threshold$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'threshold'
] = _36c2.maybeBoxObject(object: this.threshold, hydroState: hydroState, table: _36c2.HydroTable());
...
_8c47.Threshold unwrap() => this;
_8c47.Threshold get vmObject => this;
...
void loadThreshold({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'threshold'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedThreshold(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_8c47.Threshold>(boxer: ({required _8c47.Threshold vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedThreshold(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

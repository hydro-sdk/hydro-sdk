...
class VMManagedInterval extends _36c2.VMManagedBox<_8c47.Interval> {
  VMManagedInterval(
...
class RTManagedInterval extends _8c47.Interval
    implements _36c2.Box<_8c47.Interval> {
  RTManagedInterval(_fac9.double begin$, _fac9.double end$,
...
void loadInterval(
  ...
  table['interval'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedInterval(
          ...
          curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
              luaCallerArguments.length >= 4
                  ? luaCallerArguments[3]['curve']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_8c47.Interval>(boxer: (
      {required _8c47.Interval vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInterval(

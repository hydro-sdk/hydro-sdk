...
class VMManagedInterval extends _36c2.VMManagedBox<_8c47.Interval> {VMManagedInterval({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c47.Interval vmObject;

 }

class RTManagedInterval extends _8c47.Interval implements _36c2.Box<_8c47.Interval> {RTManagedInterval(_fac9.double begin$, _fac9.double end$, {required _8c47.Curve curve, required this.table, required this.hydroState}) : super(begin$,end$,curve: curve) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c47.Interval unwrap() => this;
_8c47.Interval get vmObject => this;
...
void loadInterval({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'interval'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedInterval(luaCallerArguments  [
1
]?.toDouble(), luaCallerArguments  [
2
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState, curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'curve'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_8c47.Interval>(boxer: ({required _8c47.Interval vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInterval(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAnimationMin extends _36c2.VMManagedBox<_77a7.AnimationMin<_fac9.num>> {VMManagedAnimationMin({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _77a7.AnimationMin<_fac9.num> vmObject;

 }

class RTManagedAnimationMin extends _77a7.AnimationMin implements _36c2.Box<_77a7.AnimationMin> {RTManagedAnimationMin(_86ca.Animation<_fac9.num> first$, _86ca.Animation<_fac9.num> next$, {required this.table, required this.hydroState}) : super(first$,next$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_77a7.AnimationMin unwrap() => this;
_77a7.AnimationMin get vmObject => this;
...
void loadAnimationMin({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'animationMin'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAnimationMin(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.dynamic>, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_77a7.AnimationMin>(boxer: ({required _77a7.AnimationMin vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnimationMin(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAnimation
    extends _36c2.VMManagedBox<_86ca.Animation<_fac9.dynamic>> {
  VMManagedAnimation(
...
class RTManagedAnimation extends _86ca.Animation
    implements _36c2.Box<_86ca.Animation> {
  RTManagedAnimation({required this.table, required this.hydroState})
      : super() {
...
void loadAnimation(
  ...
  table['animation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnimation(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_86ca.Animation>(boxer: (
      {required _86ca.Animation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimation(

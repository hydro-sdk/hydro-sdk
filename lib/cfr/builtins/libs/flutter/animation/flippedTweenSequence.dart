...
class VMManagedFlippedTweenSequence
    extends _36c2.VMManagedBox<_fb3c.FlippedTweenSequence> {
  VMManagedFlippedTweenSequence(
...
class RTManagedFlippedTweenSequence extends _fb3c.FlippedTweenSequence
    implements _36c2.Box<_fb3c.FlippedTweenSequence> {
  RTManagedFlippedTweenSequence(
      _fac9.List<_fb3c.TweenSequenceItem<_fac9.double>> items,
      {required this.table,
...
void loadFlippedTweenSequence(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['flippedTweenSequence'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFlippedTweenSequence(
          _36c2.maybeUnBoxAndBuildArgument<
                  _fac9.List<_fb3c.TweenSequenceItem<_fac9.double>>,
                  _fb3c.TweenSequenceItem<_fac9.double>>(luaCallerArguments[1],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_fb3c.FlippedTweenSequence>(boxer: (
      {required _fb3c.FlippedTweenSequence vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFlippedTweenSequence(

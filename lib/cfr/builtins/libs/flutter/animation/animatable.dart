...
class VMManagedAnimatable
    extends _36c2.VMManagedBox<_e83e.Animatable<_fac9.dynamic>> {
  VMManagedAnimatable(
...
class RTManagedAnimatable extends _e83e.Animatable
    implements _36c2.Box<_e83e.Animatable> {
  RTManagedAnimatable({required this.table, required this.hydroState})
      : super() {
...
void loadAnimatable(
  ...
  table['animatable'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAnimatable(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_e83e.Animatable>(boxer: (
      {required _e83e.Animatable vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatable(

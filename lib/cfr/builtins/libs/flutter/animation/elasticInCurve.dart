...
class VMManagedElasticInCurve extends _36c2.VMManagedBox<_8c47.ElasticInCurve> {VMManagedElasticInCurve({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _8c47.ElasticInCurve vmObject;

 }

class RTManagedElasticInCurve extends _8c47.ElasticInCurve implements _36c2.Box<_8c47.ElasticInCurve> {RTManagedElasticInCurve(_fac9.double period$, {required this.table, required this.hydroState}) : super(period$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_8c47.ElasticInCurve unwrap() => this;
_8c47.ElasticInCurve get vmObject => this;
...
void loadElasticInCurve({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'elasticInCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedElasticInCurve(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_8c47.ElasticInCurve>(boxer: ({required _8c47.ElasticInCurve vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedElasticInCurve(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

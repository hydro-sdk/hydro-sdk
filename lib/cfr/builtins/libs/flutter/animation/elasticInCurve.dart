...
class VMManagedElasticInCurve extends _36c2.VMManagedBox<_8c47.ElasticInCurve> {
  VMManagedElasticInCurve(
...
class RTManagedElasticInCurve extends _8c47.ElasticInCurve
    implements _36c2.Box<_8c47.ElasticInCurve> {
  RTManagedElasticInCurve(_fac9.double period$,
...
void loadElasticInCurve(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['elasticInCurve'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedElasticInCurve(luaCallerArguments[1]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_8c47.ElasticInCurve>(boxer: (
      {required _8c47.ElasticInCurve vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedElasticInCurve(

...
class VMManagedIntTween extends _36c2.VMManagedBox<_e83e.IntTween> {
  VMManagedIntTween(
...
class RTManagedIntTween extends _e83e.IntTween
    implements _36c2.Box<_e83e.IntTween> {
  RTManagedIntTween(
      {_fac9.int? begin,
      _fac9.int? end,
      required this.table,
  ...
  @_fac9.override
  _fac9.int evaluate(animation) {
    _36c2.Closure closure = table["evaluate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _86ca.Animation<_fac9.int> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.int>, _fac9.int>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _e83e.Animatable<_fac9.int> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_e83e.Animatable<_fac9.int>, _fac9.int>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadIntTween(
  ...
  table['intTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIntTween(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          begin: luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_e83e.IntTween>(boxer: (
      {required _e83e.IntTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedIntTween(

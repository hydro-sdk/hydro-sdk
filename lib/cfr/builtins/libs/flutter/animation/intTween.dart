...
class VMManagedIntTween extends _36c2.VMManagedBox<_e83e.IntTween> {VMManagedIntTween({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e83e.IntTween vmObject;

 }

class RTManagedIntTween extends _e83e.IntTween implements _36c2.Box<_e83e.IntTween> {RTManagedIntTween({_fac9.int? begin, _fac9.int? end, required this.table, required this.hydroState}) : super(begin: begin,end: end) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e83e.IntTween unwrap() => this;
_e83e.IntTween get vmObject => this;
...
void loadIntTween({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intTween'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedIntTween(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_e83e.IntTween>(boxer: ({required _e83e.IntTween vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntTween(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

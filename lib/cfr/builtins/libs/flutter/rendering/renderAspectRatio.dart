...
class VMManagedRenderAspectRatio extends VMManagedBox<RenderAspectRatio> {
  ...
  final RenderAspectRatio vmObject;
}

class RTManagedRenderAspectRatio extends RenderAspectRatio
    implements Box<RenderAspectRatio> {
  RTManagedRenderAspectRatio(
    ...
    table['_dart_setAspectRatio'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.aspectRatio = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  RenderAspectRatio unwrap() => this;
  RenderAspectRatio get vmObject => this;
  @override
  ...
  void set aspectRatio(value) {
    Closure closure = table["setAspectRatio"];
...
void loadRenderAspectRatio(
  ...
  registerBoxer<RenderAspectRatio>(boxer: (
      {required RenderAspectRatio vmObject,

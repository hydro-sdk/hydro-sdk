...
class VMManagedRenderAspectRatio extends _36c2.VMManagedBox<_bf98.RenderAspectRatio> {VMManagedRenderAspectRatio({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getAspectRatio'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.aspectRatio,]; } );
table  [
'setAspectRatio'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.aspectRatio=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
final _bf98.RenderAspectRatio vmObject;

 }

class RTManagedRenderAspectRatio extends _bf98.RenderAspectRatio implements _36c2.Box<_bf98.RenderAspectRatio> {RTManagedRenderAspectRatio({_be2e.RenderBox? child, required _fac9.double aspectRatio, required this.table, required this.hydroState}) : super(child: child,aspectRatio: aspectRatio) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderAspectRatio unwrap() => this;
_bf98.RenderAspectRatio get vmObject => this;
@_fac9.override _fac9.double get aspectRatio { 
_36c2.Closure closure = table["getAspectRatio"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set aspectRatio(value) { 
_36c2.Closure closure = table["setAspectRatio"];
...
void loadRenderAspectRatio({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAspectRatio'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderAspectRatio(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderAspectRatio>(boxer: ({required _bf98.RenderAspectRatio vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAspectRatio(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

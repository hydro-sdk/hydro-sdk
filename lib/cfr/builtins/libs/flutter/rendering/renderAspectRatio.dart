...
class VMManagedRenderAspectRatio
    extends _36c2.VMManagedBox<_bf98.RenderAspectRatio> {
  VMManagedRenderAspectRatio(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getAspectRatio'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.aspectRatio,
      ];
    });
    table['setAspectRatio'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.aspectRatio = (luaCallerArguments[1]?.toDouble());
      return [];
    });
...
class RTManagedRenderAspectRatio extends _bf98.RenderAspectRatio
    implements _36c2.Box<_bf98.RenderAspectRatio> {
  RTManagedRenderAspectRatio(
      {_be2e.RenderBox? child,
      required _fac9.double aspectRatio,
      required this.table,
      required this.hydroState})
      : super(child: child, aspectRatio: aspectRatio) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getAspectRatio'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.aspectRatio];
    });
    table['_dart_setAspectRatio'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.aspectRatio =
  ...
  @_fac9.override
  _fac9.double get aspectRatio {
    _36c2.Closure closure = table["getAspectRatio"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @_fac9.override
  void set aspectRatio(value) {
...
void loadRenderAspectRatio(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAspectRatio'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAspectRatio(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          aspectRatio: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['aspectRatio']
              : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_bf98.RenderAspectRatio>(boxer: (
      {required _bf98.RenderAspectRatio vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAspectRatio(

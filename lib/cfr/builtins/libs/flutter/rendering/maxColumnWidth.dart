...
class VMManagedMaxColumnWidth extends _36c2.VMManagedBox<_31d2.MaxColumnWidth> {VMManagedMaxColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedMaxColumnWidth extends _31d2.MaxColumnWidth implements _36c2.Box<_31d2.MaxColumnWidth> {RTManagedMaxColumnWidth(_31d2.TableColumnWidth a$, _31d2.TableColumnWidth b$, {required this.table, required this.hydroState}) : super(a$,b$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadMaxColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'maxColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedMaxColumnWidth(_36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_31d2.MaxColumnWidth>(boxer: ({required _31d2.MaxColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMaxColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedViewportOffset extends _36c2.VMManagedBox<_f376.ViewportOffset> {VMManagedViewportOffset({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedViewportOffset extends _f376.ViewportOffset implements _36c2.Box<_f376.ViewportOffset> {RTManagedViewportOffset({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void jumpTo(pixels) { 
...
@_fac9.override _7de1.Future<void> moveTo(to, {_fac9.bool? clamp, _8c47.Curve? curve, _fac9.Duration? duration}) { 
...
void loadViewportOffset({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'viewportOffset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedViewportOffset(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'viewportOffsetFixed'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_f376.ViewportOffset>(object: _f376.ViewportOffset.fixed(luaCallerArguments  [
1
]?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'viewportOffsetZero'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_f376.ViewportOffset>(object: _f376.ViewportOffset.zero(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_f376.ViewportOffset>(boxer: ({required _f376.ViewportOffset vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedViewportOffset(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

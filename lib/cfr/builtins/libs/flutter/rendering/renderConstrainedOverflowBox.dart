...
class VMManagedRenderConstrainedOverflowBox
    extends _36c2.VMManagedBox<_a9e4.RenderConstrainedOverflowBox> {
  VMManagedRenderConstrainedOverflowBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getMinWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.minWidth;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setMinWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.minWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getMaxWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.maxWidth;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setMaxWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.maxWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getMinHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.minHeight;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setMinHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.minHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getMaxHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.maxHeight;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setMaxHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.maxHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
...
class RTManagedRenderConstrainedOverflowBox
    extends _a9e4.RenderConstrainedOverflowBox
    implements _36c2.Box<_a9e4.RenderConstrainedOverflowBox> {
  RTManagedRenderConstrainedOverflowBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getMinWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.minWidth];
    });
    table['_dart_setMinWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.minWidth =
    ...
    table['_dart_getMaxWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.maxWidth];
    });
    table['_dart_setMaxWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.maxWidth =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getMinHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.minHeight];
    });
    table['_dart_setMinHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.minHeight =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getMaxHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.maxHeight];
    });
    table['_dart_setMaxHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.maxHeight =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_alignChild'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.alignChild();
      return [];
    });
...
void loadRenderConstrainedOverflowBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderConstrainedOverflowBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderConstrainedOverflowBox(
  ...
  _36c2.registerBoxer<_a9e4.RenderConstrainedOverflowBox>(boxer: (
      {required _a9e4.RenderConstrainedOverflowBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderConstrainedOverflowBox(

...
class VMManagedRenderConstrainedOverflowBox
    extends VMManagedBox<RenderConstrainedOverflowBox> {
  ...
  final RenderConstrainedOverflowBox vmObject;
}

class RTManagedRenderConstrainedOverflowBox extends RenderConstrainedOverflowBox
    implements Box<RenderConstrainedOverflowBox> {
  RTManagedRenderConstrainedOverflowBox(
    ...
    table['_dart_setMinWidth'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.minWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setMaxWidth'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.maxWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setMinHeight'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.minHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setMaxHeight'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.maxHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  RenderConstrainedOverflowBox unwrap() => this;
  RenderConstrainedOverflowBox get vmObject => this;
  @override
  double? get minWidth {
    Closure closure = table["getMinWidth"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set minWidth(double? value) {
    Closure closure = table["setMinWidth"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double? get maxWidth {
    Closure closure = table["getMaxWidth"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set maxWidth(double? value) {
    Closure closure = table["setMaxWidth"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double? get minHeight {
    Closure closure = table["getMinHeight"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set minHeight(double? value) {
    Closure closure = table["setMinHeight"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double? get maxHeight {
    Closure closure = table["getMaxHeight"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set maxHeight(double? value) {
    Closure closure = table["setMaxHeight"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderConstrainedOverflowBox(
  ...
  table['renderConstrainedOverflowBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderConstrainedOverflowBox(
  ...
  registerBoxer<RenderConstrainedOverflowBox>(boxer: (
      {required RenderConstrainedOverflowBox vmObject,

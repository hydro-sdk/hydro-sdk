...
class VMManagedRenderSliverFixedExtentBoxAdaptor
    extends VMManagedBox<RenderSliverFixedExtentBoxAdaptor> {
  ...
  final RenderSliverFixedExtentBoxAdaptor vmObject;
}

class RTManagedRenderSliverFixedExtentBoxAdaptor
    extends RenderSliverFixedExtentBoxAdaptor
    implements Box<RenderSliverFixedExtentBoxAdaptor> {
  ...
  RenderSliverFixedExtentBoxAdaptor unwrap() => this;
  RenderSliverFixedExtentBoxAdaptor get vmObject => this;
  @override
...
void loadRenderSliverFixedExtentBoxAdaptor(
  ...
  table['renderSliverFixedExtentBoxAdaptor'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFixedExtentBoxAdaptor(
  ...
  registerBoxer<RenderSliverFixedExtentBoxAdaptor>(boxer: (
      {required RenderSliverFixedExtentBoxAdaptor vmObject,

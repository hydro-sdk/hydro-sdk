...
class VMManagedRenderSliverFixedExtentBoxAdaptor extends _36c2.VMManagedBox<_f4e0.RenderSliverFixedExtentBoxAdaptor> {VMManagedRenderSliverFixedExtentBoxAdaptor({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRenderSliverFixedExtentBoxAdaptor extends _f4e0.RenderSliverFixedExtentBoxAdaptor implements _36c2.Box<_f4e0.RenderSliverFixedExtentBoxAdaptor> {RTManagedRenderSliverFixedExtentBoxAdaptor({required _35be.RenderSliverBoxChildManager childManager, required this.table, required this.hydroState}) : super(childManager: childManager) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRenderSliverFixedExtentBoxAdaptor({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFixedExtentBoxAdaptor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverFixedExtentBoxAdaptor(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_f4e0.RenderSliverFixedExtentBoxAdaptor>(boxer: ({required _f4e0.RenderSliverFixedExtentBoxAdaptor vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFixedExtentBoxAdaptor(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

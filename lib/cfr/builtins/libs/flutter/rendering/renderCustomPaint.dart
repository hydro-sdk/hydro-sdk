...
class VMManagedRenderCustomPaint extends VMManagedBox<RenderCustomPaint> {
  VMManagedRenderCustomPaint(
    ...
    table['setPainter'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.painter = (maybeUnBoxAndBuildArgument<CustomPainter?, dynamic>(
    ...
    table['setPreferredSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.preferredSize = (maybeUnBoxAndBuildArgument<Size, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final RenderCustomPaint vmObject;
}

class RTManagedRenderCustomPaint extends RenderCustomPaint
    implements Box<RenderCustomPaint> {
  RTManagedRenderCustomPaint(
    ...
    table['isComplex'] = this.isComplex;
    table['willChange'] = this.willChange;
    table['parentData'] = maybeBoxObject<ParentData?>(
    ...
    table['_dart_setPainter'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.painter = (maybeUnBoxAndBuildArgument<CustomPainter?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setPreferredSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.preferredSize = (maybeUnBoxAndBuildArgument<Size, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderCustomPaint unwrap() => this;
  RenderCustomPaint get vmObject => this;
  @override
  CustomPainter? get painter {
    Closure closure = table["getPainter"];
    return maybeUnBoxAndBuildArgument<CustomPainter?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set painter(CustomPainter? value) {
  ...
  @override
  void set foregroundPainter(CustomPainter? value) {
  ...
  Size get preferredSize {
    Closure closure = table["getPreferredSize"];
  ...
  @override
  void set preferredSize(Size value) {
    Closure closure = table["setPreferredSize"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
    ...
    return [
      RTManagedRenderCustomPaint(
          ...
          isComplex: luaCallerArguments.length >= 2
              ...
              : null,
          painter: maybeUnBoxAndBuildArgument<CustomPainter?, dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['painter'] : null,
              parentState: hydroState),
          preferredSize: maybeUnBoxAndBuildArgument<Size, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['preferredSize'] : null, parentState: hydroState),
          willChange: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['willChange'] : null)
    ];
  });
  registerBoxer<RenderCustomPaint>(boxer: (
      {required RenderCustomPaint vmObject,

...
class VMManagedRenderCustomPaint extends _36c2.VMManagedBox<_93cf.RenderCustomPaint> {VMManagedRenderCustomPaint({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.painter;if(returnValue!= null){return [_36c2.maybeBoxObject<_93cf.CustomPainter?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.painter=(_36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getForegroundPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.foregroundPainter;if(returnValue!= null){return [_36c2.maybeBoxObject<_93cf.CustomPainter?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setForegroundPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.foregroundPainter=(_36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'setPreferredSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.preferredSize=(_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _93cf.RenderCustomPaint vmObject;

 }

class RTManagedRenderCustomPaint extends _93cf.RenderCustomPaint implements _36c2.Box<_93cf.RenderCustomPaint> {RTManagedRenderCustomPaint({_be2e.RenderBox? child, _93cf.CustomPainter? foregroundPainter, required _fac9.bool isComplex, _93cf.CustomPainter? painter, required _a643.Size preferredSize, required _fac9.bool willChange, required this.table, required this.hydroState}) : super(child: child,foregroundPainter: foregroundPainter,isComplex: isComplex,painter: painter,preferredSize: preferredSize,willChange: willChange) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'isComplex'
] = _36c2.maybeBoxObject(object: this.isComplex, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'willChange'
] = _36c2.maybeBoxObject(object: this.willChange, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table['_dart_setPainter'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.painter =
      (_36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(
...
_93cf.RenderCustomPaint unwrap() => this;
_93cf.RenderCustomPaint get vmObject => this;
@_fac9.override _93cf.CustomPainter? get painter { 
_36c2.Closure closure = table["getPainter"];
return _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set painter(value) { 
_36c2.Closure closure = table["setPainter"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _93cf.CustomPainter? get foregroundPainter { 
_36c2.Closure closure = table["getForegroundPainter"];
return _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set foregroundPainter(value) { 
...
@_fac9.override void set preferredSize(value) { 
_36c2.Closure closure = table["setPreferredSize"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderCustomPaint({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderCustomPaint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderCustomPaint(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), foregroundPainter: _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'foregroundPainter'
] : null, parentState: hydroState), isComplex: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isComplex'
] : null, painter: _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'painter'
] : null, parentState: hydroState), preferredSize: _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'preferredSize'
] : null, parentState: hydroState), willChange: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'willChange'
] : null)]; } );
_36c2.registerBoxer<_93cf.RenderCustomPaint>(boxer: ({required _93cf.RenderCustomPaint vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderCustomPaint(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderCustomPaint
    extends _36c2.VMManagedBox<_93cf.RenderCustomPaint> {
  VMManagedRenderCustomPaint(
    ...
    table['isComplex'] = vmObject.isComplex;
    table['willChange'] = vmObject.willChange;
    ...
    table['getPainter'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_93cf.CustomPainter?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setPainter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.painter = (_36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?,
    ...
    table['setPreferredSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.preferredSize =
...
class RTManagedRenderCustomPaint extends _93cf.RenderCustomPaint
    implements _36c2.Box<_93cf.RenderCustomPaint> {
  RTManagedRenderCustomPaint(
      {_be2e.RenderBox? child,
      _93cf.CustomPainter? foregroundPainter,
      required _fac9.bool isComplex,
      _93cf.CustomPainter? painter,
      required _a643.Size preferredSize,
      required _fac9.bool willChange,
      required this.table,
    ...
    table['isComplex'] = _36c2.maybeBoxObject(
        object: this.isComplex,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['willChange'] = _36c2.maybeBoxObject(
        object: this.willChange,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_setPainter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.painter = (_36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setPreferredSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.preferredSize =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _93cf.CustomPainter? get painter {
  ...
  @_fac9.override
  _93cf.CustomPainter? get foregroundPainter {
  ...
  @_fac9.override
  void set foregroundPainter(value) {
...
void loadRenderCustomPaint(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderCustomPaint'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderCustomPaint(
          ...
          foregroundPainter:
              _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['foregroundPainter']
                      : null,
                  parentState: hydroState),
          isComplex: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['isComplex']
              : null,
          painter: _36c2.maybeUnBoxAndBuildArgument<_93cf.CustomPainter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['painter'] : null,
              parentState: hydroState),
          preferredSize: _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['preferredSize'] : null,
              parentState: hydroState),
          willChange: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['willChange'] : null)
    ];
  });
  _36c2.registerBoxer<_93cf.RenderCustomPaint>(boxer: (
      {required _93cf.RenderCustomPaint vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderCustomPaint(

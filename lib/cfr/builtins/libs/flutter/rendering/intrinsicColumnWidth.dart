...
class VMManagedIntrinsicColumnWidth extends _36c2.VMManagedBox<_31d2.IntrinsicColumnWidth> {VMManagedIntrinsicColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _31d2.IntrinsicColumnWidth vmObject;

 }

class RTManagedIntrinsicColumnWidth extends _31d2.IntrinsicColumnWidth implements _36c2.Box<_31d2.IntrinsicColumnWidth> {RTManagedIntrinsicColumnWidth({_fac9.double? flex, required this.table, required this.hydroState}) : super(flex: flex) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_31d2.IntrinsicColumnWidth unwrap() => this;
_31d2.IntrinsicColumnWidth get vmObject => this;
...
void loadIntrinsicColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'intrinsicColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedIntrinsicColumnWidth(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_31d2.IntrinsicColumnWidth>(boxer: ({required _31d2.IntrinsicColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedIntrinsicColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

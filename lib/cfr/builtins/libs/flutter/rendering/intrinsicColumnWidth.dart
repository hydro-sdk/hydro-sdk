...
class VMManagedIntrinsicColumnWidth
    extends _36c2.VMManagedBox<_31d2.IntrinsicColumnWidth> {
...
class RTManagedIntrinsicColumnWidth extends _31d2.IntrinsicColumnWidth
    implements _36c2.Box<_31d2.IntrinsicColumnWidth> {
  RTManagedIntrinsicColumnWidth(
      {_fac9.double? flex, required this.table, required this.hydroState})
      : super(flex: flex) {
...
void loadIntrinsicColumnWidth(
  ...
  table['intrinsicColumnWidth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedIntrinsicColumnWidth(
  ...
  _36c2.registerBoxer<_31d2.IntrinsicColumnWidth>(boxer: (
      {required _31d2.IntrinsicColumnWidth vmObject,

...
class VMManagedRenderSliverGrid extends VMManagedBox<RenderSliverGrid> {
  VMManagedRenderSliverGrid(
    ...
    table['getGridDelegate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<SliverGridDelegate>(
            object: vmObject.gridDelegate,
            hydroState: hydroState,
            table: HydroTable()),
      ];
    });
    table['setGridDelegate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.gridDelegate =
  ...
  final RenderSliverGrid vmObject;
}

class RTManagedRenderSliverGrid extends RenderSliverGrid
    implements Box<RenderSliverGrid> {
  ...
  RenderSliverGrid unwrap() => this;
  RenderSliverGrid get vmObject => this;
  @override
  ...
  SliverGridDelegate get gridDelegate {
    Closure closure = table["getGridDelegate"];
    return maybeUnBoxAndBuildArgument<SliverGridDelegate, dynamic>(
  ...
  void set gridDelegate(value) {
    Closure closure = table["setGridDelegate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderSliverGrid(
          ...
          childManager:
              maybeUnBoxAndBuildArgument<RenderSliverBoxChildManager, dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          gridDelegate: maybeUnBoxAndBuildArgument<SliverGridDelegate, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverGrid>(boxer: (
      {required RenderSliverGrid vmObject,

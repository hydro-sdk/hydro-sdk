...
class VMManagedRenderSliverGrid extends _36c2.VMManagedBox<_a3c0.RenderSliverGrid> {VMManagedRenderSliverGrid({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getGridDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a3c0.SliverGridDelegate>(object: vmObject.gridDelegate, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setGridDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.gridDelegate=(_36c2.maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'childCrossAxisPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childCrossAxisPosition(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'performLayout'
...
final _a3c0.RenderSliverGrid vmObject;

 }

class RTManagedRenderSliverGrid extends _a3c0.RenderSliverGrid implements _36c2.Box<_a3c0.RenderSliverGrid> {RTManagedRenderSliverGrid({required _35be.RenderSliverBoxChildManager childManager, required _a3c0.SliverGridDelegate gridDelegate, required this.table, required this.hydroState}) : super(childManager: childManager,gridDelegate: gridDelegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getGridDelegate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.gridDelegate];
});
table['_dart_setGridDelegate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.gridDelegate = (_36c2.maybeUnBoxAndBuildArgument<
      _a3c0.SliverGridDelegate,
...
_a3c0.RenderSliverGrid unwrap() => this;
_a3c0.RenderSliverGrid get vmObject => this;
@_fac9.override void setupParentData(child) { 
_36c2.Closure closure = table["setupParentData"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a3c0.SliverGridDelegate get gridDelegate { 
_36c2.Closure closure = table["getGridDelegate"];
return _36c2.maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set gridDelegate(value) { 
_36c2.Closure closure = table["setGridDelegate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderSliverGrid({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverGrid'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverGrid(table: luaCallerArguments  [
0
], hydroState: hydroState, childManager: _36c2.maybeUnBoxAndBuildArgument<_35be.RenderSliverBoxChildManager, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childManager'
] : null, parentState: hydroState), gridDelegate: _36c2.maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'gridDelegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_a3c0.RenderSliverGrid>(boxer: ({required _a3c0.RenderSliverGrid vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverGrid(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

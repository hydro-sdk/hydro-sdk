...
class VMManagedRenderSliverGrid
    extends _36c2.VMManagedBox<_a3c0.RenderSliverGrid> {
  VMManagedRenderSliverGrid(
    ...
    table['getGridDelegate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a3c0.SliverGridDelegate>(
            object: vmObject.gridDelegate,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setGridDelegate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.gridDelegate = (_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedRenderSliverGrid extends _a3c0.RenderSliverGrid
    implements _36c2.Box<_a3c0.RenderSliverGrid> {
  RTManagedRenderSliverGrid(
    ...
    table['_dart_getGridDelegate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.gridDelegate];
    });
    table['_dart_setGridDelegate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _a3c0.SliverGridDelegate get gridDelegate {
    _36c2.Closure closure = table["getGridDelegate"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_a3c0.SliverGridDelegate, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  void set gridDelegate(value) {
  ...
  _be2e.RenderBox? insertAndLayoutChild(childConstraints,
      {_fac9.bool parentUsesSize = false, _be2e.RenderBox? after}) {
...
void loadRenderSliverGrid(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverGrid'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverGrid(
          ...
          childManager: _36c2.maybeUnBoxAndBuildArgument<
              ...
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          gridDelegate: _36c2.maybeUnBoxAndBuildArgument<
                  _a3c0.SliverGridDelegate, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['gridDelegate']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_a3c0.RenderSliverGrid>(boxer: (
      {required _a3c0.RenderSliverGrid vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverGrid(

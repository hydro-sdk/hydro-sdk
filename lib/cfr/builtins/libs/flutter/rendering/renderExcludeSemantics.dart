...
class VMManagedRenderExcludeSemantics
    extends VMManagedBox<RenderExcludeSemantics> {
  ...
  final RenderExcludeSemantics vmObject;
}

class RTManagedRenderExcludeSemantics extends RenderExcludeSemantics
    implements Box<RenderExcludeSemantics> {
  RTManagedRenderExcludeSemantics(
    ...
    table['_dart_setExcluding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.excluding = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderExcludeSemantics unwrap() => this;
  RenderExcludeSemantics get vmObject => this;
  @override
  bool get excluding {
    Closure closure = table["getExcluding"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set excluding(bool value) {
    Closure closure = table["setExcluding"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderExcludeSemantics(
  ...
  registerBoxer<RenderExcludeSemantics>(boxer: (
      {required RenderExcludeSemantics vmObject,

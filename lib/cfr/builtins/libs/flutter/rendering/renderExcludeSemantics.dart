...
class VMManagedRenderExcludeSemantics
    extends _36c2.VMManagedBox<_bf98.RenderExcludeSemantics> {
  VMManagedRenderExcludeSemantics(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getExcluding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.excluding,
      ];
    });
    table['setExcluding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.excluding = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderExcludeSemantics extends _bf98.RenderExcludeSemantics
    implements _36c2.Box<_bf98.RenderExcludeSemantics> {
  RTManagedRenderExcludeSemantics(
      {_be2e.RenderBox? child,
      required _fac9.bool excluding,
      required this.table,
      required this.hydroState})
      : super(child: child, excluding: excluding) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getExcluding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.excluding];
    });
    table['_dart_setExcluding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.excluding =
...
void loadRenderExcludeSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderExcludeSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderExcludeSemantics(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          excluding: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['excluding']
              : null)
    ];
  });
  _36c2.registerBoxer<_bf98.RenderExcludeSemantics>(boxer: (
      {required _bf98.RenderExcludeSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderExcludeSemantics(

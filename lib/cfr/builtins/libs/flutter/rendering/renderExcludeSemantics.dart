...
class VMManagedRenderExcludeSemantics extends _36c2.VMManagedBox<_bf98.RenderExcludeSemantics> {VMManagedRenderExcludeSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getExcluding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.excluding,]; } );
table  [
'setExcluding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.excluding=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _bf98.RenderExcludeSemantics vmObject;

 }

class RTManagedRenderExcludeSemantics extends _bf98.RenderExcludeSemantics implements _36c2.Box<_bf98.RenderExcludeSemantics> {RTManagedRenderExcludeSemantics({_be2e.RenderBox? child, required _fac9.bool excluding, required this.table, required this.hydroState}) : super(child: child,excluding: excluding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getExcluding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.excluding];
});
table['_dart_setExcluding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.excluding =
...
_bf98.RenderExcludeSemantics unwrap() => this;
_bf98.RenderExcludeSemantics get vmObject => this;
@_fac9.override _fac9.bool get excluding { 
_36c2.Closure closure = table["getExcluding"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set excluding(value) { 
_36c2.Closure closure = table["setExcluding"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderExcludeSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderExcludeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderExcludeSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderExcludeSemantics>(boxer: ({required _bf98.RenderExcludeSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderExcludeSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

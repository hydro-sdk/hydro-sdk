...
class VMManagedMinColumnWidth extends _36c2.VMManagedBox<_31d2.MinColumnWidth> {VMManagedMinColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'a'
] = _36c2.maybeBoxObject<_31d2.TableColumnWidth>(object: vmObject.a, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'b'
] = _36c2.maybeBoxObject<_31d2.TableColumnWidth>(object: vmObject.b, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minIntrinsicWidth'
...
class RTManagedMinColumnWidth extends _31d2.MinColumnWidth implements _36c2.Box<_31d2.MinColumnWidth> {RTManagedMinColumnWidth(_31d2.TableColumnWidth a$, _31d2.TableColumnWidth b$, {required this.table, required this.hydroState}) : super(a$,b$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'a'
] = _36c2.maybeBoxObject(object: this.a, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'b'
] = _36c2.maybeBoxObject(object: this.b, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadMinColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'minColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedMinColumnWidth(_36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_31d2.MinColumnWidth>(boxer: ({required _31d2.MinColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMinColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

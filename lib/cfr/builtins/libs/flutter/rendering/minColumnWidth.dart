...
class VMManagedMinColumnWidth extends VMManagedBox<MinColumnWidth> {
  ...
  final MinColumnWidth vmObject;
}

class RTManagedMinColumnWidth extends MinColumnWidth
    implements Box<MinColumnWidth> {
  RTManagedMinColumnWidth(TableColumnWidth a$, TableColumnWidth b$,
  ...
  MinColumnWidth unwrap() => this;
  MinColumnWidth get vmObject => this;
  @override
...
void loadMinColumnWidth(
  ...
  registerBoxer<MinColumnWidth>(boxer: (
      {required MinColumnWidth vmObject,

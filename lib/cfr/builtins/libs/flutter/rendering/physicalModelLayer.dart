...
class VMManagedPhysicalModelLayer extends VMManagedBox<PhysicalModelLayer> {
  ...
  final PhysicalModelLayer vmObject;
}

class RTManagedPhysicalModelLayer extends PhysicalModelLayer
    implements Box<PhysicalModelLayer> {
  ...
  PhysicalModelLayer unwrap() => this;
  PhysicalModelLayer get vmObject => this;
  @override
  Path? get clipPath {
...
void loadPhysicalModelLayer(
  ...
  registerBoxer<PhysicalModelLayer>(boxer: (
      {required PhysicalModelLayer vmObject,

...
class VMManagedPhysicalModelLayer extends _36c2.VMManagedBox<_7d70.PhysicalModelLayer> {VMManagedPhysicalModelLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getClipPath'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.clipPath;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Path?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setClipPath'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.clipPath=(_36c2.maybeUnBoxAndBuildArgument<_a643.Path?, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getElevation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.elevation;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setElevation'
...
table  [
'getShadowColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.shadowColor;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Color?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setShadowColor'
...
final _7d70.PhysicalModelLayer vmObject;

 }

class RTManagedPhysicalModelLayer extends _7d70.PhysicalModelLayer implements _36c2.Box<_7d70.PhysicalModelLayer> {RTManagedPhysicalModelLayer({required _a643.Clip clipBehavior, _a643.Path? clipPath, _a643.Color? color, _fac9.double? elevation, _a643.Color? shadowColor, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,clipPath: clipPath,color: color,elevation: elevation,shadowColor: shadowColor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7d70.PhysicalModelLayer unwrap() => this;
_7d70.PhysicalModelLayer get vmObject => this;
@_fac9.override _a643.Path? get clipPath { 
...
@_fac9.override void set clipPath(value) { 
_36c2.Closure closure = table["setClipPath"];
...
void loadPhysicalModelLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'physicalModelLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedPhysicalModelLayer(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), clipPath: _36c2.maybeUnBoxAndBuildArgument<_a643.Path?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipPath'
...
'color'
] : null, parentState: hydroState), elevation: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'elevation'
...
_36c2.registerBoxer<_7d70.PhysicalModelLayer>(boxer: ({required _7d70.PhysicalModelLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPhysicalModelLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

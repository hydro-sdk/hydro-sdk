...
class VMManagedRenderAnimatedSize extends VMManagedBox<RenderAnimatedSize> {
  VMManagedRenderAnimatedSize(
    ...
    table['setDuration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.duration = (maybeUnBoxAndBuildArgument<Duration, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['getReverseDuration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['setCurve'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.curve = (maybeUnBoxAndBuildArgument<Curve, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final RenderAnimatedSize vmObject;
}

class RTManagedRenderAnimatedSize extends RenderAnimatedSize
    implements Box<RenderAnimatedSize> {
  RTManagedRenderAnimatedSize(
    ...
    table['_dart_setDuration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.duration = (maybeUnBoxAndBuildArgument<Duration, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setReverseDuration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.reverseDuration = (maybeUnBoxAndBuildArgument<Duration?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setCurve'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.curve = (maybeUnBoxAndBuildArgument<Curve, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderAnimatedSize unwrap() => this;
  RenderAnimatedSize get vmObject => this;
  @override
  RenderAnimatedSizeState get state {
    Closure closure = table["getState"];
    return maybeUnBoxEnum(
        values: RenderAnimatedSizeState.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }

  @override
  Duration get duration {
    Closure closure = table["getDuration"];
  ...
  void set duration(value) {
    Closure closure = table["setDuration"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  Duration? get reverseDuration {
    Closure closure = table["getReverseDuration"];
    return maybeUnBoxAndBuildArgument<Duration?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void set reverseDuration(value) {
    Closure closure = table["setReverseDuration"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  Curve get curve {
    Closure closure = table["getCurve"];
  ...
  void set curve(value) {
    Closure closure = table["setCurve"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  bool get isAnimating {
    Closure closure = table["getIsAnimating"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
    ...
    return [
      RTManagedRenderAnimatedSize(
          ...
          curve: maybeUnBoxAndBuildArgument<Curve, dynamic>(
              ...
              parentState: hydroState),
          reverseDuration: maybeUnBoxAndBuildArgument<Duration?, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['reverseDuration'] : null, parentState: hydroState),
          ...
          duration: maybeUnBoxAndBuildArgument<Duration, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['duration'] : null, parentState: hydroState),
          vsync: maybeUnBoxAndBuildArgument<TickerProvider, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['vsync'] : null, parentState: hydroState))
    ];
  });
  registerBoxer<RenderAnimatedSize>(boxer: (
      {required RenderAnimatedSize vmObject,

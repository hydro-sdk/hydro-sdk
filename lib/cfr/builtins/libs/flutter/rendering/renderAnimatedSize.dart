...
import 'package:flutter/src/rendering/animated_size.dart' as _8a1e;
...
class VMManagedRenderAnimatedSize extends _36c2.VMManagedBox<_8a1e.RenderAnimatedSize> {VMManagedRenderAnimatedSize({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDuration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.Duration>(object: vmObject.duration, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setDuration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.duration=(_36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getReverseDuration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.reverseDuration;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Duration?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setReverseDuration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.reverseDuration=(_36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_8c47.Curve>(object: vmObject.curve, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setCurve'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.curve=(_36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getVsync'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_e067.TickerProvider>(object: vmObject.vsync, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setVsync'
...
final _8a1e.RenderAnimatedSize vmObject;

 }

class RTManagedRenderAnimatedSize extends _8a1e.RenderAnimatedSize implements _36c2.Box<_8a1e.RenderAnimatedSize> {RTManagedRenderAnimatedSize({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, required _a643.Clip clipBehavior, required _8c47.Curve curve, _fac9.Duration? reverseDuration, _a643.TextDirection? textDirection, required _fac9.Duration duration, required _e067.TickerProvider vsync, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,curve: curve,reverseDuration: reverseDuration,textDirection: textDirection,duration: duration,vsync: vsync) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getDuration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.duration];
});
table['_dart_setDuration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.duration =
...
table['_dart_getReverseDuration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.reverseDuration];
});
table['_dart_setReverseDuration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getCurve'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.curve];
});
table['_dart_setCurve'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.curve = (_36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_8a1e.RenderAnimatedSize unwrap() => this;
_8a1e.RenderAnimatedSize get vmObject => this;
@_fac9.override _8a1e.RenderAnimatedSizeState get state { 
_36c2.Closure closure = table["getState"];
return _36c2.maybeUnBoxEnum(values: _8a1e.RenderAnimatedSizeState.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override _fac9.Duration get duration { 
...
@_fac9.override void set duration(value) { 
_36c2.Closure closure = table["setDuration"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.Duration? get reverseDuration { 
_36c2.Closure closure = table["getReverseDuration"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set reverseDuration(value) { 
_36c2.Closure closure = table["setReverseDuration"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _8c47.Curve get curve { 
_36c2.Closure closure = table["getCurve"];
...
@_fac9.override void set curve(value) { 
_36c2.Closure closure = table["setCurve"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void alignChild() { 
_36c2.Closure closure = table["alignChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderAnimatedSize({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAnimatedSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderAnimatedSize(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'curve'
] : null, parentState: hydroState), reverseDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'reverseDuration'
...
_36c2.registerBoxer<_8a1e.RenderAnimatedSize>(boxer: ({required _8a1e.RenderAnimatedSize vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAnimatedSize(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

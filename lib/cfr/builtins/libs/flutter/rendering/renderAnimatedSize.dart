...
class VMManagedRenderAnimatedSize
    extends _36c2.VMManagedBox<_8a1e.RenderAnimatedSize> {
  VMManagedRenderAnimatedSize(
    ...
    table['setDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.duration =
    ...
    table['getReverseDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.reverseDuration;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_fac9.Duration?>(
              object: returnValue,
    ...
    table['setReverseDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.reverseDuration =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    table['getCurve'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['setCurve'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.curve =
...
class RTManagedRenderAnimatedSize extends _8a1e.RenderAnimatedSize
  ...
  RTManagedRenderAnimatedSize(
    ...
    table['_dart_setDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.duration =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getReverseDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.reverseDuration];
    });
    table['_dart_setReverseDuration'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getCurve'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.curve];
    });
    table['_dart_setCurve'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.curve =
          (_36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _8a1e.RenderAnimatedSizeState get state {
    _36c2.Closure closure = table["getState"];
    return _36c2.maybeUnBoxEnum(
        values: _8a1e.RenderAnimatedSizeState.values,
  ...
  @_fac9.override
  _fac9.Duration? get reverseDuration {
  ...
  @_fac9.override
  void set reverseDuration(value) {
    _36c2.Closure closure = table["setReverseDuration"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _8c47.Curve get curve {
...
void loadRenderAnimatedSize(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAnimatedSize'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAnimatedSize(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['curve'] : null,
              parentState: hydroState),
          reverseDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['reverseDuration'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_8a1e.RenderAnimatedSize>(boxer: (
      {required _8a1e.RenderAnimatedSize vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAnimatedSize(

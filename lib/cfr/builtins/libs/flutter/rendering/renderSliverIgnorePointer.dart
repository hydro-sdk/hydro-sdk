...
class VMManagedRenderSliverIgnorePointer extends _36c2.VMManagedBox<_26cc.RenderSliverIgnorePointer> {VMManagedRenderSliverIgnorePointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getIgnoring'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.ignoring,]; } );
table  [
'setIgnoring'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.ignoring=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getIgnoringSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.ignoringSemantics;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setIgnoringSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.ignoringSemantics=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _26cc.RenderSliverIgnorePointer vmObject;

 }

class RTManagedRenderSliverIgnorePointer extends _26cc.RenderSliverIgnorePointer implements _36c2.Box<_26cc.RenderSliverIgnorePointer> {RTManagedRenderSliverIgnorePointer({required _fac9.bool ignoring, _fac9.bool? ignoringSemantics, _021d.RenderSliver? sliver, required this.table, required this.hydroState}) : super(ignoring: ignoring,ignoringSemantics: ignoringSemantics,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getIgnoring'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.ignoring];
});
table['_dart_setIgnoring'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.ignoring = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_getIgnoringSemantics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.ignoringSemantics];
});
table['_dart_setIgnoringSemantics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
_26cc.RenderSliverIgnorePointer unwrap() => this;
_26cc.RenderSliverIgnorePointer get vmObject => this;
@_fac9.override _fac9.bool get ignoring { 
_36c2.Closure closure = table["getIgnoring"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set ignoring(value) { 
_36c2.Closure closure = table["setIgnoring"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool? get ignoringSemantics { 
_36c2.Closure closure = table["getIgnoringSemantics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set ignoringSemantics(value) { 
_36c2.Closure closure = table["setIgnoringSemantics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderSliverIgnorePointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverIgnorePointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderSliverIgnorePointer(table: luaCallerArguments  [
0
], hydroState: hydroState, ignoring: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ignoring'
] : null, ignoringSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ignoringSemantics'
...
_36c2.registerBoxer<_26cc.RenderSliverIgnorePointer>(boxer: ({required _26cc.RenderSliverIgnorePointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverIgnorePointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

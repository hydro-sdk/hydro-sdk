...
class VMManagedRenderSliverIgnorePointer
    extends _36c2.VMManagedBox<_26cc.RenderSliverIgnorePointer> {
  VMManagedRenderSliverIgnorePointer(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getIgnoring'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.ignoring,
      ];
    });
    table['setIgnoring'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.ignoring = (luaCallerArguments[1]);
      return [];
    });
    table['getIgnoringSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.ignoringSemantics;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setIgnoringSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.ignoringSemantics = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderSliverIgnorePointer extends _26cc.RenderSliverIgnorePointer
    implements _36c2.Box<_26cc.RenderSliverIgnorePointer> {
  RTManagedRenderSliverIgnorePointer(
      {required _fac9.bool ignoring,
      _fac9.bool? ignoringSemantics,
      _021d.RenderSliver? sliver,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getIgnoring'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.ignoring];
    });
    table['_dart_setIgnoring'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.ignoring =
    ...
    table['_dart_getIgnoringSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.ignoringSemantics];
    });
    table['_dart_setIgnoringSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _fac9.bool? get ignoringSemantics {
...
void loadRenderSliverIgnorePointer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverIgnorePointer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverIgnorePointer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          ignoring: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['ignoring']
              : null,
          ignoringSemantics: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['ignoringSemantics']
              : null,
          sliver: _36c2
              .maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['sliver']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_26cc.RenderSliverIgnorePointer>(boxer: (
      {required _26cc.RenderSliverIgnorePointer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverIgnorePointer(

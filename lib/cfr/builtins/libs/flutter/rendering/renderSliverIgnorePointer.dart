...
class VMManagedRenderSliverIgnorePointer
    extends VMManagedBox<RenderSliverIgnorePointer> {
  ...
  final RenderSliverIgnorePointer vmObject;
}

class RTManagedRenderSliverIgnorePointer extends RenderSliverIgnorePointer
    implements Box<RenderSliverIgnorePointer> {
  RTManagedRenderSliverIgnorePointer(
    ...
    table['_dart_setIgnoring'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.ignoring = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setIgnoringSemantics'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.ignoringSemantics = (luaCallerArguments[1]);
      return [];
    });
    table['_dart_hitTest'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  RenderSliverIgnorePointer unwrap() => this;
  RenderSliverIgnorePointer get vmObject => this;
  @override
  bool get ignoring {
    Closure closure = table["getIgnoring"];
  ...
  bool? get ignoringSemantics {
    Closure closure = table["getIgnoringSemantics"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderSliverIgnorePointer(
  ...
  table['renderSliverIgnorePointer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverIgnorePointer(
          ...
          ignoringSemantics: luaCallerArguments.length >= 2
              ...
              : null,
          sliver: maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverIgnorePointer>(boxer: (
      {required RenderSliverIgnorePointer vmObject,

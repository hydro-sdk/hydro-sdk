...
class VMManagedRenderAnnotatedRegion extends _36c2.VMManagedBox<_bf98.RenderAnnotatedRegion<_fac9.Object>> {VMManagedRenderAnnotatedRegion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getSized'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.sized,]; } );
table  [
'setSized'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.sized=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _bf98.RenderAnnotatedRegion<_fac9.Object> vmObject;

 }

class RTManagedRenderAnnotatedRegion extends _bf98.RenderAnnotatedRegion implements _36c2.Box<_bf98.RenderAnnotatedRegion> {RTManagedRenderAnnotatedRegion({_be2e.RenderBox? child, required _fac9.bool sized, required _fac9.Object value, required this.table, required this.hydroState}) : super(child: child,sized: sized,value: value) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'alwaysNeedsCompositing'
] = _36c2.maybeBoxObject(object: alwaysNeedsCompositing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table['_dart_getSized'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.sized];
});
table['_dart_setSized'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.sized = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
...
_bf98.RenderAnnotatedRegion unwrap() => this;
_bf98.RenderAnnotatedRegion get vmObject => this;
...
@_fac9.override _fac9.bool get sized { 
_36c2.Closure closure = table["getSized"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set sized(value) { 
_36c2.Closure closure = table["setSized"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderAnnotatedRegion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAnnotatedRegion'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderAnnotatedRegion(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), sized: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sized'
...
_36c2.registerBoxer<_bf98.RenderAnnotatedRegion>(boxer: ({required _bf98.RenderAnnotatedRegion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAnnotatedRegion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderAnnotatedRegion
    extends _36c2.VMManagedBox<_bf98.RenderAnnotatedRegion<_fac9.Object>> {
  VMManagedRenderAnnotatedRegion(
    ...
    table['alwaysNeedsCompositing'] = vmObject.alwaysNeedsCompositing;
    ...
    table['getSized'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.sized,
      ];
    });
    table['setSized'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.sized = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderAnnotatedRegion extends _bf98.RenderAnnotatedRegion
    implements _36c2.Box<_bf98.RenderAnnotatedRegion> {
  RTManagedRenderAnnotatedRegion(
    ...
    table['alwaysNeedsCompositing'] = _36c2.maybeBoxObject(
        object: alwaysNeedsCompositing,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getSized'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.sized];
    });
    table['_dart_setSized'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.sized =
...
void loadRenderAnnotatedRegion(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAnnotatedRegion'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAnnotatedRegion(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          sized: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['sized']
              : null,
  ...
  _36c2.registerBoxer<_bf98.RenderAnnotatedRegion>(boxer: (
      {required _bf98.RenderAnnotatedRegion vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAnnotatedRegion(

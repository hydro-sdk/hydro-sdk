...
class VMManagedRenderAnnotatedRegion
    extends VMManagedBox<RenderAnnotatedRegion<Object>> {
  ...
  final RenderAnnotatedRegion<Object> vmObject;
}

class RTManagedRenderAnnotatedRegion extends RenderAnnotatedRegion
    implements Box<RenderAnnotatedRegion> {
  RTManagedRenderAnnotatedRegion(
    ...
    table['alwaysNeedsCompositing'] = alwaysNeedsCompositing;
    table['parentData'] = maybeBoxObject<ParentData?>(
    ...
    table['_dart_setSized'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.sized = (luaCallerArguments[1]);
      return [];
    });
    table['_dart_paint'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  RenderAnnotatedRegion unwrap() => this;
  RenderAnnotatedRegion get vmObject => this;
  @override
  Object get value {
  ...
  @override
  bool get sized {
    Closure closure = table["getSized"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set sized(bool value) {
    Closure closure = table["setSized"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderAnnotatedRegion(
  ...
  registerBoxer<RenderAnnotatedRegion>(boxer: (
      {required RenderAnnotatedRegion vmObject,

...
class VMManagedRenderOpacity extends _36c2.VMManagedBox<_bf98.RenderOpacity> {
  VMManagedRenderOpacity(
...
class RTManagedRenderOpacity extends _bf98.RenderOpacity
    implements _36c2.Box<_bf98.RenderOpacity> {
  RTManagedRenderOpacity(
...
void loadRenderOpacity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderOpacity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderOpacity(
  ...
  _36c2.registerBoxer<_bf98.RenderOpacity>(boxer: (
      {required _bf98.RenderOpacity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderOpacity(

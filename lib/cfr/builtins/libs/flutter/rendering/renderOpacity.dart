...
class VMManagedRenderOpacity extends VMManagedBox<RenderOpacity> {
  ...
  final RenderOpacity vmObject;
}

class RTManagedRenderOpacity extends RenderOpacity
    implements Box<RenderOpacity> {
  ...
  RenderOpacity unwrap() => this;
  RenderOpacity get vmObject => this;
  @override
...
void loadRenderOpacity(
  ...
  registerBoxer<RenderOpacity>(boxer: (
      {required RenderOpacity vmObject,

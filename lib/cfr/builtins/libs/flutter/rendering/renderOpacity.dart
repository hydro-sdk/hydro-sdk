...
class VMManagedRenderOpacity extends _36c2.VMManagedBox<_bf98.RenderOpacity> {VMManagedRenderOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderOpacity vmObject;

 }

class RTManagedRenderOpacity extends _bf98.RenderOpacity implements _36c2.Box<_bf98.RenderOpacity> {RTManagedRenderOpacity({required _fac9.bool alwaysIncludeSemantics, _be2e.RenderBox? child, required _fac9.double opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,child: child,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderOpacity unwrap() => this;
_bf98.RenderOpacity get vmObject => this;
...
void loadRenderOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderOpacity(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderOpacity>(boxer: ({required _bf98.RenderOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

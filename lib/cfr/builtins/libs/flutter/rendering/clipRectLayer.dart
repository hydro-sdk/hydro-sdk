...
class VMManagedClipRectLayer extends _36c2.VMManagedBox<_7d70.ClipRectLayer> {
  VMManagedClipRectLayer(
    ...
    table['getClipRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.clipRect;
      if (returnValue != null) {
        return [
    ...
    table['setClipRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.clipRect =
  ...
  final _7d70.ClipRectLayer vmObject;
}

class RTManagedClipRectLayer extends _7d70.ClipRectLayer
    implements _36c2.Box<_7d70.ClipRectLayer> {
  RTManagedClipRectLayer(
      {required _a643.Clip clipBehavior,
      _a643.Rect? clipRect,
      required this.table,
      required this.hydroState})
      : super(clipBehavior: clipBehavior, clipRect: clipRect) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getClipRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.clipRect];
    });
    table['_dart_setClipRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.clipRect =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  _7d70.ClipRectLayer unwrap() => this;
  _7d70.ClipRectLayer get vmObject => this;
  @_fac9.override
  _a643.Rect? get clipRect {
    _36c2.Closure closure = table["getClipRect"];
  ...
  @_fac9.override
  void set clipRect(value) {
    _36c2.Closure closure = table["setClipRect"];
...
void loadClipRectLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['clipRectLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipRectLayer(
          ...
          clipRect:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['clipRect']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.ClipRectLayer>(boxer: (
      {required _7d70.ClipRectLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipRectLayer(

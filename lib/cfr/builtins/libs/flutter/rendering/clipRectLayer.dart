...
class VMManagedClipRectLayer extends VMManagedBox<ClipRectLayer> {
  VMManagedClipRectLayer(
    ...
    table['setClipRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.clipRect = (maybeUnBoxAndBuildArgument<Rect?, dynamic>(
  ...
  final ClipRectLayer vmObject;
}

class RTManagedClipRectLayer extends ClipRectLayer
    implements Box<ClipRectLayer> {
  RTManagedClipRectLayer(
    ...
    table['_dart_setClipRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.clipRect = (maybeUnBoxAndBuildArgument<Rect?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  ClipRectLayer unwrap() => this;
  ClipRectLayer get vmObject => this;
  @override
  Rect? get clipRect {
    Closure closure = table["getClipRect"];
  ...
  @override
  void set clipRect(Rect? value) {
    Closure closure = table["setClipRect"];
...
void loadClipRectLayer(
      ...
      RTManagedClipRectLayer(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipRect: maybeUnBoxAndBuildArgument<Rect?, dynamic>(
  ...
  registerBoxer<ClipRectLayer>(boxer: (
      {required ClipRectLayer vmObject,

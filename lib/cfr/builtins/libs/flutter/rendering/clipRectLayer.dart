...
class VMManagedClipRectLayer extends _36c2.VMManagedBox<_7d70.ClipRectLayer> {VMManagedClipRectLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getClipRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.clipRect;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Rect?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setClipRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.clipRect=(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedClipRectLayer extends _7d70.ClipRectLayer implements _36c2.Box<_7d70.ClipRectLayer> {RTManagedClipRectLayer({required _a643.Clip clipBehavior, _a643.Rect? clipRect, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,clipRect: clipRect) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getClipRect'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.clipRect];
});
table['_dart_setClipRect'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.clipRect =
...
@_fac9.override _a643.Rect? get clipRect { 
...
@_fac9.override void set clipRect(value) { 
...
void loadClipRectLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipRectLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedClipRectLayer(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), clipRect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipRect'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.ClipRectLayer>(boxer: ({required _7d70.ClipRectLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipRectLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

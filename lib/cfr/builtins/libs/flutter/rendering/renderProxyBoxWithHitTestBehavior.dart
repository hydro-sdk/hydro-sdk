...
class VMManagedRenderProxyBoxWithHitTestBehavior
    extends _36c2.VMManagedBox<_bf98.RenderProxyBoxWithHitTestBehavior> {
  VMManagedRenderProxyBoxWithHitTestBehavior(
...
class RTManagedRenderProxyBoxWithHitTestBehavior
    ...
    implements _36c2.Box<_bf98.RenderProxyBoxWithHitTestBehavior> {
  RTManagedRenderProxyBoxWithHitTestBehavior(
...
void loadRenderProxyBoxWithHitTestBehavior(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderProxyBoxWithHitTestBehavior'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderProxyBoxWithHitTestBehavior(
  ...
  _36c2.registerBoxer<_bf98.RenderProxyBoxWithHitTestBehavior>(boxer: (
      {required _bf98.RenderProxyBoxWithHitTestBehavior vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderProxyBoxWithHitTestBehavior(

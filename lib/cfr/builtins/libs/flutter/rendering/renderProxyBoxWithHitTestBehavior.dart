...
class VMManagedRenderProxyBoxWithHitTestBehavior extends _36c2.VMManagedBox<_bf98.RenderProxyBoxWithHitTestBehavior> {VMManagedRenderProxyBoxWithHitTestBehavior({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderProxyBoxWithHitTestBehavior vmObject;

 }

class RTManagedRenderProxyBoxWithHitTestBehavior extends _bf98.RenderProxyBoxWithHitTestBehavior implements _36c2.Box<_bf98.RenderProxyBoxWithHitTestBehavior> {RTManagedRenderProxyBoxWithHitTestBehavior({required _bf98.HitTestBehavior behavior, _be2e.RenderBox? child, required this.table, required this.hydroState}) : super(behavior: behavior,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderProxyBoxWithHitTestBehavior unwrap() => this;
_bf98.RenderProxyBoxWithHitTestBehavior get vmObject => this;
...
void loadRenderProxyBoxWithHitTestBehavior({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderProxyBoxWithHitTestBehavior'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderProxyBoxWithHitTestBehavior(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderProxyBoxWithHitTestBehavior>(boxer: ({required _bf98.RenderProxyBoxWithHitTestBehavior vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderProxyBoxWithHitTestBehavior(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

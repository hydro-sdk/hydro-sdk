...
class VMManagedRenderProxyBoxWithHitTestBehavior
    extends VMManagedBox<RenderProxyBoxWithHitTestBehavior> {
  ...
  final RenderProxyBoxWithHitTestBehavior vmObject;
}

class RTManagedRenderProxyBoxWithHitTestBehavior
    extends RenderProxyBoxWithHitTestBehavior
    implements Box<RenderProxyBoxWithHitTestBehavior> {
  ...
  RenderProxyBoxWithHitTestBehavior unwrap() => this;
  RenderProxyBoxWithHitTestBehavior get vmObject => this;
  @override
...
void loadRenderProxyBoxWithHitTestBehavior(
  ...
  table['renderProxyBoxWithHitTestBehavior'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderProxyBoxWithHitTestBehavior(
  ...
  registerBoxer<RenderProxyBoxWithHitTestBehavior>(boxer: (
      {required RenderProxyBoxWithHitTestBehavior vmObject,

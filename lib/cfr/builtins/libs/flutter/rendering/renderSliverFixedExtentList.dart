...
class VMManagedRenderSliverFixedExtentList extends _36c2.VMManagedBox<_f4e0.RenderSliverFixedExtentList> {VMManagedRenderSliverFixedExtentList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'setItemExtent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.itemExtent=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
final _f4e0.RenderSliverFixedExtentList vmObject;

 }

class RTManagedRenderSliverFixedExtentList extends _f4e0.RenderSliverFixedExtentList implements _36c2.Box<_f4e0.RenderSliverFixedExtentList> {RTManagedRenderSliverFixedExtentList({required _35be.RenderSliverBoxChildManager childManager, required _fac9.double itemExtent, required this.table, required this.hydroState}) : super(childManager: childManager,itemExtent: itemExtent) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_f4e0.RenderSliverFixedExtentList unwrap() => this;
_f4e0.RenderSliverFixedExtentList get vmObject => this;
@_fac9.override _fac9.double get itemExtent { 
_36c2.Closure closure = table["getItemExtent"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set itemExtent(value) { 
...
void loadRenderSliverFixedExtentList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFixedExtentList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverFixedExtentList(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_f4e0.RenderSliverFixedExtentList>(boxer: ({required _f4e0.RenderSliverFixedExtentList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFixedExtentList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

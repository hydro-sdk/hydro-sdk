...
class VMManagedRenderSliverFixedExtentList
    extends VMManagedBox<RenderSliverFixedExtentList> {
  VMManagedRenderSliverFixedExtentList(
  ...
  final RenderSliverFixedExtentList vmObject;
}

class RTManagedRenderSliverFixedExtentList extends RenderSliverFixedExtentList
    implements Box<RenderSliverFixedExtentList> {
  RTManagedRenderSliverFixedExtentList(
  ...
  RenderSliverFixedExtentList unwrap() => this;
  RenderSliverFixedExtentList get vmObject => this;
  @override
...
void loadRenderSliverFixedExtentList(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderSliverFixedExtentList'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFixedExtentList(
  ...
  registerBoxer<RenderSliverFixedExtentList>(boxer: (
      {required RenderSliverFixedExtentList vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderSliverFixedExtentList(

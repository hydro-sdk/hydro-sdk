...
class VMManagedRenderSliverFixedExtentList
    extends _36c2.VMManagedBox<_f4e0.RenderSliverFixedExtentList> {
...
class RTManagedRenderSliverFixedExtentList
    extends _f4e0.RenderSliverFixedExtentList
    implements _36c2.Box<_f4e0.RenderSliverFixedExtentList> {
...
void loadRenderSliverFixedExtentList(
  ...
  table['renderSliverFixedExtentList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFixedExtentList(
  ...
  _36c2.registerBoxer<_f4e0.RenderSliverFixedExtentList>(boxer: (
      {required _f4e0.RenderSliverFixedExtentList vmObject,

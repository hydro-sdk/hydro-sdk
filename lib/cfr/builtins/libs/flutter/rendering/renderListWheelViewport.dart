...
class VMManagedRenderListWheelViewport
    extends VMManagedBox<RenderListWheelViewport> {
  VMManagedRenderListWheelViewport(
    ...
    table['childManager'] = maybeBoxObject<ListWheelChildManager>(
    ...
    table['getRenderChildrenOutsideViewport'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.renderChildrenOutsideViewport,
      ];
    });
    table['setRenderChildrenOutsideViewport'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  final RenderListWheelViewport vmObject;
}

class RTManagedRenderListWheelViewport extends RenderListWheelViewport
    implements Box<RenderListWheelViewport> {
  RTManagedRenderListWheelViewport(
    ...
    table['childManager'] = maybeBoxObject<ListWheelChildManager>(
        object: this.childManager, hydroState: hydroState, table: HydroTable());
    table['parentData'] = maybeBoxObject<ParentData?>(
    ...
    table['_dart_setDiameterRatio'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.diameterRatio = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setPerspective'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.perspective = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setOffAxisFraction'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.offAxisFraction = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setUseMagnifier'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.useMagnifier = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setMagnification'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.magnification = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setOverAndUnderCenterOpacity'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.overAndUnderCenterOpacity = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setItemExtent'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.itemExtent = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setSqueeze'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.squeeze = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setRenderChildrenOutsideViewport'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.renderChildrenOutsideViewport = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_scrollOffsetToIndex'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [super.scrollOffsetToIndex(luaCallerArguments[1]?.toDouble())];
    });
    table['_dart_indexToScrollOffset'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [super.indexToScrollOffset(luaCallerArguments[1])];
    });
  ...
  RenderListWheelViewport unwrap() => this;
  RenderListWheelViewport get vmObject => this;
  @override
  ...
  double get diameterRatio {
    Closure closure = table["getDiameterRatio"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set diameterRatio(double value) {
    Closure closure = table["setDiameterRatio"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get perspective {
    Closure closure = table["getPerspective"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set perspective(double value) {
    Closure closure = table["setPerspective"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get offAxisFraction {
    Closure closure = table["getOffAxisFraction"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set offAxisFraction(double value) {
    Closure closure = table["setOffAxisFraction"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  bool get useMagnifier {
    Closure closure = table["getUseMagnifier"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set useMagnifier(bool value) {
    Closure closure = table["setUseMagnifier"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get magnification {
    Closure closure = table["getMagnification"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set magnification(double value) {
    Closure closure = table["setMagnification"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get overAndUnderCenterOpacity {
    Closure closure = table["getOverAndUnderCenterOpacity"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set overAndUnderCenterOpacity(double value) {
    Closure closure = table["setOverAndUnderCenterOpacity"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get itemExtent {
    Closure closure = table["getItemExtent"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set itemExtent(double value) {
    Closure closure = table["setItemExtent"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get squeeze {
    Closure closure = table["getSqueeze"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set squeeze(double value) {
    Closure closure = table["setSqueeze"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  bool get renderChildrenOutsideViewport {
    Closure closure = table["getRenderChildrenOutsideViewport"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set renderChildrenOutsideViewport(bool value) {
    Closure closure = table["setRenderChildrenOutsideViewport"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  int scrollOffsetToIndex(double scrollOffset) {
    Closure closure = table["scrollOffsetToIndex"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double indexToScrollOffset(int index) {
    Closure closure = table["indexToScrollOffset"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }
...
void loadRenderListWheelViewport(
  ...
  table['renderListWheelViewport'] =
    ...
    return [
      RTManagedRenderListWheelViewport(
          ...
          hydroState: hydroState,
          children:
              maybeUnBoxAndBuildArgument<List<RenderBox>?, RenderBox>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
                  parentState: hydroState),
          ...
          useMagnifier: luaCallerArguments.length >= 2
              ...
              : null,
          childManager:
              maybeUnBoxAndBuildArgument<ListWheelChildManager, dynamic>(
                  luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderListWheelViewport>(boxer: (
      {required RenderListWheelViewport vmObject,

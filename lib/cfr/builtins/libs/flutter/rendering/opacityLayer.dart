...
class VMManagedOpacityLayer extends _36c2.VMManagedBox<_7d70.OpacityLayer> {
  VMManagedOpacityLayer(
    ...
    table['setAlpha'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedOpacityLayer extends _7d70.OpacityLayer
    implements _36c2.Box<_7d70.OpacityLayer> {
  RTManagedOpacityLayer(
    ...
    table['_dart_setAlpha'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.alpha =
...
void loadOpacityLayer(
  ...
  table['opacityLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOpacityLayer(
  ...
  _36c2.registerBoxer<_7d70.OpacityLayer>(boxer: (
      {required _7d70.OpacityLayer vmObject,

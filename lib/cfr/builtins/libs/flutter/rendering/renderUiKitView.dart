...
class VMManagedRenderUiKitView
    extends _36c2.VMManagedBox<_6ecd.RenderUiKitView> {
  VMManagedRenderUiKitView(
    ...
    table['hitTestBehavior'] =
        _6ecd.PlatformViewHitTestBehavior.values.indexWhere((x) {
    ...
    table['getViewController'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_40e3.UiKitViewController>(
...
class RTManagedRenderUiKitView extends _6ecd.RenderUiKitView
    implements _36c2.Box<_6ecd.RenderUiKitView> {
  RTManagedRenderUiKitView(
      ...
      required _40e3.UiKitViewController viewController,
      required this.table,
  ...
  @_fac9.override
  _40e3.UiKitViewController get viewController {
    _36c2.Closure closure = table["getViewController"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_40e3.UiKitViewController, _fac9.dynamic>(
  ...
  @_fac9.override
  _fac9.bool hitTest(result, {_a643.Offset? position}) {
...
void loadRenderUiKitView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderUiKitView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderUiKitView(
          ...
          hitTestBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          viewController:
              _36c2.maybeUnBoxAndBuildArgument<_40e3.UiKitViewController, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['viewController']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_6ecd.RenderUiKitView>(boxer: (
      {required _6ecd.RenderUiKitView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderUiKitView(

...
class VMManagedRenderUiKitView extends _36c2.VMManagedBox<_6ecd.RenderUiKitView> {VMManagedRenderUiKitView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getViewController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_40e3.UiKitViewController>(object: vmObject.viewController, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setViewController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.viewController=(_36c2.maybeUnBoxAndBuildArgument<_40e3.UiKitViewController, _fac9.dynamic>(luaCallerArguments  [
1
...
final _6ecd.RenderUiKitView vmObject;

 }

class RTManagedRenderUiKitView extends _6ecd.RenderUiKitView implements _36c2.Box<_6ecd.RenderUiKitView> {RTManagedRenderUiKitView({required _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>> gestureRecognizers, required _6ecd.PlatformViewHitTestBehavior hitTestBehavior, required _40e3.UiKitViewController viewController, required this.table, required this.hydroState}) : super(gestureRecognizers: gestureRecognizers,hitTestBehavior: hitTestBehavior,viewController: viewController) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_6ecd.RenderUiKitView unwrap() => this;
_6ecd.RenderUiKitView get vmObject => this;
@_fac9.override _40e3.UiKitViewController get viewController { 
_36c2.Closure closure = table["getViewController"];
return _36c2.maybeUnBoxAndBuildArgument<_40e3.UiKitViewController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hitTest(result, {_a643.Offset? position}) { 
...
void loadRenderUiKitView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderUiKitView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderUiKitView(table: luaCallerArguments  [
0
], hydroState: hydroState, gestureRecognizers: _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>, _288a.Factory<_02d2.OneSequenceGestureRecognizer>>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'gestureRecognizers'
...
'hitTestBehavior'
] : null), viewController: _36c2.maybeUnBoxAndBuildArgument<_40e3.UiKitViewController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewController'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_6ecd.RenderUiKitView>(boxer: ({required _6ecd.RenderUiKitView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderUiKitView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

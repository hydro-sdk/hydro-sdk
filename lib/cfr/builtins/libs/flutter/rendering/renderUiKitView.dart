...
class VMManagedRenderUiKitView extends VMManagedBox<RenderUiKitView> {
  VMManagedRenderUiKitView(
    ...
    table['hitTestBehavior'] =
        PlatformViewHitTestBehavior.values.indexWhere((x) {
    ...
    table['getViewController'] =
      ...
      return [
        maybeBoxObject<UiKitViewController>(
    ...
    table['setViewController'] =
      ...
      vmObject.viewController =
          (maybeUnBoxAndBuildArgument<UiKitViewController, dynamic>(
  ...
  final RenderUiKitView vmObject;
}

class RTManagedRenderUiKitView extends RenderUiKitView
    implements Box<RenderUiKitView> {
  ...
  RenderUiKitView unwrap() => this;
  RenderUiKitView get vmObject => this;
  @override
  UiKitViewController get viewController {
    Closure closure = table["getViewController"];
    return maybeUnBoxAndBuildArgument<UiKitViewController, dynamic>(
  ...
  @override
  bool hitTest(result, {Offset? position}) {
...
void loadRenderUiKitView(
  ...
  registerBoxer<RenderUiKitView>(boxer: (
      {required RenderUiKitView vmObject,

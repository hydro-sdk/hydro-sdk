...
class VMManagedRenderPositionedBox
    extends _36c2.VMManagedBox<_a9e4.RenderPositionedBox> {
...
class RTManagedRenderPositionedBox extends _a9e4.RenderPositionedBox
    implements _36c2.Box<_a9e4.RenderPositionedBox> {
...
void loadRenderPositionedBox(
  ...
  table['renderPositionedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPositionedBox(
  ...
  _36c2.registerBoxer<_a9e4.RenderPositionedBox>(boxer: (
      {required _a9e4.RenderPositionedBox vmObject,

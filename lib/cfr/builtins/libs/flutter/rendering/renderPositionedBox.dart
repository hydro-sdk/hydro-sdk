...
class VMManagedRenderPositionedBox extends _36c2.VMManagedBox<_a9e4.RenderPositionedBox> {VMManagedRenderPositionedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a9e4.RenderPositionedBox vmObject;

 }

class RTManagedRenderPositionedBox extends _a9e4.RenderPositionedBox implements _36c2.Box<_a9e4.RenderPositionedBox> {RTManagedRenderPositionedBox({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, _fac9.double? heightFactor, _a643.TextDirection? textDirection, _fac9.double? widthFactor, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,heightFactor: heightFactor,textDirection: textDirection,widthFactor: widthFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderPositionedBox unwrap() => this;
_a9e4.RenderPositionedBox get vmObject => this;
...
void loadRenderPositionedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderPositionedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderPositionedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a9e4.RenderPositionedBox>(boxer: ({required _a9e4.RenderPositionedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPositionedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderFractionallySizedOverflowBox extends _36c2.VMManagedBox<_a9e4.RenderFractionallySizedOverflowBox> {VMManagedRenderFractionallySizedOverflowBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getWidthFactor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.widthFactor;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setWidthFactor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.widthFactor=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getHeightFactor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.heightFactor;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setHeightFactor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.heightFactor=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
final _a9e4.RenderFractionallySizedOverflowBox vmObject;

 }

class RTManagedRenderFractionallySizedOverflowBox extends _a9e4.RenderFractionallySizedOverflowBox implements _36c2.Box<_a9e4.RenderFractionallySizedOverflowBox> {RTManagedRenderFractionallySizedOverflowBox({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, _fac9.double? heightFactor, _a643.TextDirection? textDirection, _fac9.double? widthFactor, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,heightFactor: heightFactor,textDirection: textDirection,widthFactor: widthFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderFractionallySizedOverflowBox unwrap() => this;
_a9e4.RenderFractionallySizedOverflowBox get vmObject => this;
@_fac9.override _fac9.double? get widthFactor { 
_36c2.Closure closure = table["getWidthFactor"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set widthFactor(value) { 
_36c2.Closure closure = table["setWidthFactor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double? get heightFactor { 
_36c2.Closure closure = table["getHeightFactor"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set heightFactor(value) { 
_36c2.Closure closure = table["setHeightFactor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderFractionallySizedOverflowBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderFractionallySizedOverflowBox(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), heightFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'heightFactor'
...
'textDirection'
] : null), widthFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'widthFactor'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_a9e4.RenderFractionallySizedOverflowBox>(boxer: ({required _a9e4.RenderFractionallySizedOverflowBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFractionallySizedOverflowBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

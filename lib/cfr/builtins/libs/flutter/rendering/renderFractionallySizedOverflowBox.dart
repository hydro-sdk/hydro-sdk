...
class VMManagedRenderFractionallySizedOverflowBox
    extends VMManagedBox<RenderFractionallySizedOverflowBox> {
  ...
  final RenderFractionallySizedOverflowBox vmObject;
}

class RTManagedRenderFractionallySizedOverflowBox
    extends RenderFractionallySizedOverflowBox
    implements Box<RenderFractionallySizedOverflowBox> {
  ...
  RenderFractionallySizedOverflowBox unwrap() => this;
  RenderFractionallySizedOverflowBox get vmObject => this;
  @override
...
void loadRenderFractionallySizedOverflowBox(
  ...
  table['renderFractionallySizedOverflowBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFractionallySizedOverflowBox(
  ...
  registerBoxer<RenderFractionallySizedOverflowBox>(boxer: (
      {required RenderFractionallySizedOverflowBox vmObject,

...
class VMManagedRenderFractionallySizedOverflowBox
    extends _36c2.VMManagedBox<_a9e4.RenderFractionallySizedOverflowBox> {
  VMManagedRenderFractionallySizedOverflowBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getWidthFactor'] = _36c2.makeLuaDartFunc(
    ...
    table['setWidthFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.widthFactor = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getHeightFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['setHeightFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedRenderFractionallySizedOverflowBox
    extends _a9e4.RenderFractionallySizedOverflowBox
    implements _36c2.Box<_a9e4.RenderFractionallySizedOverflowBox> {
  RTManagedRenderFractionallySizedOverflowBox(
      {required _ca85.AlignmentGeometry alignment,
      _be2e.RenderBox? child,
      _fac9.double? heightFactor,
      _a643.TextDirection? textDirection,
      _fac9.double? widthFactor,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getWidthFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.widthFactor];
    });
    table['_dart_setWidthFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.widthFactor =
    ...
    table['_dart_getHeightFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.heightFactor];
    });
    table['_dart_setHeightFactor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.heightFactor =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadRenderFractionallySizedOverflowBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderFractionallySizedOverflowBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFractionallySizedOverflowBox(
          ...
          widthFactor: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['widthFactor'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_a9e4.RenderFractionallySizedOverflowBox>(boxer: (
      {required _a9e4.RenderFractionallySizedOverflowBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderFractionallySizedOverflowBox(

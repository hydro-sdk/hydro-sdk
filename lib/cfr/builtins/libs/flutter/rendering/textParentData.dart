...
class VMManagedTextParentData extends _36c2.VMManagedBox<_105e.TextParentData> {
...
class RTManagedTextParentData extends _105e.TextParentData
    implements _36c2.Box<_105e.TextParentData> {
  RTManagedTextParentData({required this.table, required this.hydroState})
    ...
    table['scale'] = _36c2.maybeBoxObject(
        object: scale, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadTextParentData(
  ...
  table['textParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_105e.TextParentData>(boxer: (
      {required _105e.TextParentData vmObject,

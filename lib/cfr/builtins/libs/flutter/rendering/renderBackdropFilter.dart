...
class VMManagedRenderBackdropFilter extends VMManagedBox<RenderBackdropFilter> {
  VMManagedRenderBackdropFilter(
    ...
    table['getLayer'] =
      ...
      if (returnValue != null) {
        return [
          maybeBoxObject<BackdropFilterLayer?>(
  ...
  final RenderBackdropFilter vmObject;
}
...
class RTManagedRenderBackdropFilter extends RenderBackdropFilter
  ...
  RenderBackdropFilter unwrap() => this;
  RenderBackdropFilter get vmObject => this;
  @override
  BackdropFilterLayer? get layer {
    Closure closure = table["getLayer"];
    return maybeUnBoxAndBuildArgument<BackdropFilterLayer?, dynamic>(
...
void loadRenderBackdropFilter(
  ...
  registerBoxer<RenderBackdropFilter>(boxer: (
      {required RenderBackdropFilter vmObject,

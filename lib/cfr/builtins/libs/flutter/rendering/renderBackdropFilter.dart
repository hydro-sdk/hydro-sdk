...
class VMManagedRenderBackdropFilter extends _36c2.VMManagedBox<_bf98.RenderBackdropFilter> {VMManagedRenderBackdropFilter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.layer;if(returnValue!= null){return [_36c2.maybeBoxObject<_7d70.BackdropFilterLayer?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.ImageFilter>(object: vmObject.filter, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.filter=(_36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getBlendMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_a643.BlendMode.values.indexWhere((x) { return x == vmObject.blendMode; } ),]; } );
table  [
'setBlendMode'
...
final _bf98.RenderBackdropFilter vmObject;

 }

class RTManagedRenderBackdropFilter extends _bf98.RenderBackdropFilter implements _36c2.Box<_bf98.RenderBackdropFilter> {RTManagedRenderBackdropFilter({required _a643.BlendMode blendMode, _be2e.RenderBox? child, required _a643.ImageFilter filter, required this.table, required this.hydroState}) : super(blendMode: blendMode,child: child,filter: filter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setFilter'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.filter =
      (_36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(
...
_bf98.RenderBackdropFilter unwrap() => this;
_bf98.RenderBackdropFilter get vmObject => this;
@_fac9.override _7d70.BackdropFilterLayer? get layer { 
_36c2.Closure closure = table["getLayer"];
return _36c2.maybeUnBoxAndBuildArgument<_7d70.BackdropFilterLayer?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _a643.ImageFilter get filter { 
_36c2.Closure closure = table["getFilter"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set filter(value) { 
_36c2.Closure closure = table["setFilter"];
...
void loadRenderBackdropFilter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderBackdropFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderBackdropFilter(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), filter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'filter'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderBackdropFilter>(boxer: ({required _bf98.RenderBackdropFilter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderBackdropFilter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

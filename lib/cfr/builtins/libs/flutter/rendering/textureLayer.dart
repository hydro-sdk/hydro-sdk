...
class VMManagedTextureLayer extends _36c2.VMManagedBox<_7d70.TextureLayer> {VMManagedTextureLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7d70.TextureLayer vmObject;

 }

class RTManagedTextureLayer extends _7d70.TextureLayer implements _36c2.Box<_7d70.TextureLayer> {RTManagedTextureLayer({required _a643.FilterQuality filterQuality, required _fac9.bool freeze, required _a643.Rect rect, required _fac9.int textureId, required this.table, required this.hydroState}) : super(filterQuality: filterQuality,freeze: freeze,rect: rect,textureId: textureId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7d70.TextureLayer unwrap() => this;
_7d70.TextureLayer get vmObject => this;
...
void loadTextureLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textureLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedTextureLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.TextureLayer>(boxer: ({required _7d70.TextureLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextureLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

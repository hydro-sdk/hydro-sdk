...
class VMManagedTableBorder extends _36c2.VMManagedBox<_2738.TableBorder> {
  VMManagedTableBorder(
    ...
    table['left'] = _36c2.maybeBoxObject<_6be9.BorderSide>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['horizontalInside'] = _36c2.maybeBoxObject<_6be9.BorderSide>(
        object: vmObject.horizontalInside,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['verticalInside'] = _36c2.maybeBoxObject<_6be9.BorderSide>(
...
class RTManagedTableBorder extends _2738.TableBorder
  ...
  RTManagedTableBorder(
    ...
    table['horizontalInside'] = _36c2.maybeBoxObject(
        object: this.horizontalInside,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['verticalInside'] = _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _96d1.EdgeInsets get dimensions {
  ...
  void paint(canvas, rect,
      {required _fac9.Iterable columns, required _fac9.Iterable rows}) {
...
void loadTableBorder(
  ...
  table['tableBorder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTableBorder(
          ...
          borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          bottom: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          horizontalInside:
              _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['horizontalInside'] : null,
                  parentState: hydroState),
          left: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['left'] : null, parentState: hydroState),
          right: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['right'] : null, parentState: hydroState),
          ...
          verticalInside: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['verticalInside'] : null, parentState: hydroState))
    ];
  });
  table['tableBorderAll'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_2738.TableBorder>(
          object: _2738.TableBorder.all(
              borderRadius:
  ...
  table['tableBorderSymmetric'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_2738.TableBorder>(
          object: _2738.TableBorder.symmetric(
              inside: _36c2
  ...
  table['tableBorderLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _2738.TableBorder.lerp(
  ...
  _36c2.registerBoxer<_2738.TableBorder>(boxer: (
      {required _2738.TableBorder vmObject,

...
class VMManagedMouseTracker extends _36c2.VMManagedBox<_1668.MouseTracker> {VMManagedMouseTracker({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getMouseIsConnected'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.mouseIsConnected,]; } );
table  [
'updateWithEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure unpackedgetResult=luaCallerArguments  [
2
];vmObject.updateWithEvent(_36c2.maybeUnBoxAndBuildArgument<_0e77.PointerEvent, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), () => _36c2.maybeUnBoxAndBuildArgument<_baac.HitTestResult, _fac9.dynamic>(unpackedgetResult.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState));
return []; } );
table  [
'updateAllDevices'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure unpackedhitTest=luaCallerArguments  [
1
];vmObject.updateAllDevices((offset) => _36c2.maybeUnBoxAndBuildArgument<_baac.HitTestResult, _fac9.dynamic>(unpackedhitTest.dispatch([luaCallerArguments[0],offset],parentState:hydroState,)[0], parentState: hydroState));
return []; } );
table  [
'addListener'
...
class RTManagedMouseTracker extends _1668.MouseTracker implements _36c2.Box<_1668.MouseTracker> {RTManagedMouseTracker({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _fac9.bool get mouseIsConnected { 
_36c2.Closure closure = table["getMouseIsConnected"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateWithEvent(event, getResult) { 
_36c2.Closure closure = table["updateWithEvent"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateAllDevices(hitTest) { 
...
void loadMouseTracker({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'mouseTracker'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMouseTracker(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_1668.MouseTracker>(boxer: ({required _1668.MouseTracker vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMouseTracker(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverToBoxAdapter
    extends _36c2.VMManagedBox<_021d.RenderSliverToBoxAdapter> {
  VMManagedRenderSliverToBoxAdapter(
...
class RTManagedRenderSliverToBoxAdapter extends _021d.RenderSliverToBoxAdapter
    implements _36c2.Box<_021d.RenderSliverToBoxAdapter> {
  RTManagedRenderSliverToBoxAdapter(
...
void loadRenderSliverToBoxAdapter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverToBoxAdapter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverToBoxAdapter(
  ...
  _36c2.registerBoxer<_021d.RenderSliverToBoxAdapter>(boxer: (
      {required _021d.RenderSliverToBoxAdapter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverToBoxAdapter(

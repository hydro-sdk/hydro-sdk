...
class VMManagedRenderSliverToBoxAdapter
    extends VMManagedBox<RenderSliverToBoxAdapter> {
  ...
  final RenderSliverToBoxAdapter vmObject;
}

class RTManagedRenderSliverToBoxAdapter extends RenderSliverToBoxAdapter
    implements Box<RenderSliverToBoxAdapter> {
  ...
  RenderSliverToBoxAdapter unwrap() => this;
  RenderSliverToBoxAdapter get vmObject => this;
  @override
  void performLayout() {
...
void loadRenderSliverToBoxAdapter(
  ...
  table['renderSliverToBoxAdapter'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverToBoxAdapter(
  ...
  registerBoxer<RenderSliverToBoxAdapter>(boxer: (
      {required RenderSliverToBoxAdapter vmObject,

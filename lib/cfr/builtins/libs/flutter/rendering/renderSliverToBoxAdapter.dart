...
class VMManagedRenderSliverToBoxAdapter extends _36c2.VMManagedBox<_021d.RenderSliverToBoxAdapter> {VMManagedRenderSliverToBoxAdapter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _021d.RenderSliverToBoxAdapter vmObject;

 }

class RTManagedRenderSliverToBoxAdapter extends _021d.RenderSliverToBoxAdapter implements _36c2.Box<_021d.RenderSliverToBoxAdapter> {RTManagedRenderSliverToBoxAdapter({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_021d.RenderSliverToBoxAdapter unwrap() => this;
_021d.RenderSliverToBoxAdapter get vmObject => this;
...
void loadRenderSliverToBoxAdapter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverToBoxAdapter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverToBoxAdapter(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_021d.RenderSliverToBoxAdapter>(boxer: ({required _021d.RenderSliverToBoxAdapter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverToBoxAdapter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSliverConstraints
    extends _36c2.VMManagedBox<_021d.SliverConstraints> {
  VMManagedSliverConstraints(
    ...
    table['growthDirection'] = _021d.GrowthDirection.values.indexWhere((x) {
      return x == vmObject.growthDirection;
    });
    table['userScrollDirection'] = _f376.ScrollDirection.values.indexWhere((x) {
    ...
    table['crossAxisDirection'] = _487f.AxisDirection.values.indexWhere((x) {
        ...
        _36c2.maybeBoxObject<_021d.SliverConstraints>(
            object: vmObject.copyWith(
                ...
                scrollOffset: luaCallerArguments.length >= 2
                    ...
                    : null?.toDouble(),
                userScrollDirection: _36c2.maybeUnBoxEnum(
                    values: _f376.ScrollDirection.values,
                    boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['userScrollDirection'] : null),
                viewportMainAxisExtent: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['viewportMainAxisExtent'] : null?.toDouble()),
            hydroState: hydroState,
    ...
    table['getNormalizedGrowthDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _021d.GrowthDirection.values.indexWhere((x) {
    ...
    table['asBoxConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
...
class RTManagedSliverConstraints extends _021d.SliverConstraints
    implements _36c2.Box<_021d.SliverConstraints> {
  RTManagedSliverConstraints(
      ...
      required _fac9.double precedingScrollExtent,
      required _fac9.double remainingCacheExtent,
      required _fac9.double remainingPaintExtent,
      required _fac9.double scrollOffset,
      required _f376.ScrollDirection userScrollDirection,
      required _fac9.double viewportMainAxisExtent,
      required this.table,
    ...
    table['scrollOffset'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['precedingScrollExtent'] = _36c2.maybeBoxObject(
        object: this.precedingScrollExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['overlap'] = _36c2.maybeBoxObject(
        object: this.overlap,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['remainingPaintExtent'] = _36c2.maybeBoxObject(
        object: this.remainingPaintExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['viewportMainAxisExtent'] = _36c2.maybeBoxObject(
        object: this.viewportMainAxisExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['cacheOrigin'] = _36c2.maybeBoxObject(
        object: this.cacheOrigin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['remainingCacheExtent'] = _36c2.maybeBoxObject(
        object: this.remainingCacheExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getNormalizedGrowthDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_asBoxConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _021d.SliverConstraints copyWith(
      {_487f.AxisDirection? axisDirection,
      _fac9.double? cacheOrigin,
      _487f.AxisDirection? crossAxisDirection,
      _fac9.double? crossAxisExtent,
      _021d.GrowthDirection? growthDirection,
      _fac9.double? overlap,
      _fac9.double? precedingScrollExtent,
      _fac9.double? remainingCacheExtent,
      _fac9.double? remainingPaintExtent,
      _fac9.double? scrollOffset,
      _f376.ScrollDirection? userScrollDirection,
      _fac9.double? viewportMainAxisExtent}) {
  ...
  @_fac9.override
  _021d.GrowthDirection get normalizedGrowthDirection {
  ...
  @_fac9.override
  _be2e.BoxConstraints asBoxConstraints(
      {_fac9.double? crossAxisExtent,
      _fac9.double maxExtent = _fac9.double.infinity,
      _fac9.double minExtent = 0.0}) {
...
void loadSliverConstraints(
  ...
  table['sliverConstraints'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverConstraints(
  ...
  _36c2.registerBoxer<_021d.SliverConstraints>(boxer: (
      {required _021d.SliverConstraints vmObject,

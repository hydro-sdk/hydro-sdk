...
class VMManagedImageFilterLayer
    extends _36c2.VMManagedBox<_7d70.ImageFilterLayer> {
  VMManagedImageFilterLayer(
    ...
    table['getImageFilter'] = _36c2.makeLuaDartFunc(
    ...
    table['setImageFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.imageFilter =
  ...
  final _7d70.ImageFilterLayer vmObject;
}

class RTManagedImageFilterLayer extends _7d70.ImageFilterLayer
    implements _36c2.Box<_7d70.ImageFilterLayer> {
  RTManagedImageFilterLayer(
      {_a643.ImageFilter? imageFilter,
      required this.table,
      required this.hydroState})
      : super(imageFilter: imageFilter) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getImageFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.imageFilter];
    });
    table['_dart_setImageFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.imageFilter =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  _7d70.ImageFilterLayer unwrap() => this;
  _7d70.ImageFilterLayer get vmObject => this;
  @_fac9.override
  _a643.ImageFilter? get imageFilter {
    _36c2.Closure closure = table["getImageFilter"];
  ...
  @_fac9.override
  void set imageFilter(value) {
    _36c2.Closure closure = table["setImageFilter"];
...
void loadImageFilterLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['imageFilterLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImageFilterLayer(
          ...
          imageFilter: _36c2
              .maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['imageFilter']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.ImageFilterLayer>(boxer: (
      {required _7d70.ImageFilterLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImageFilterLayer(

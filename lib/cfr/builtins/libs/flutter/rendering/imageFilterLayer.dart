...
class VMManagedImageFilterLayer extends _36c2.VMManagedBox<_7d70.ImageFilterLayer> {VMManagedImageFilterLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getImageFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.imageFilter;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.ImageFilter?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setImageFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.imageFilter=(_36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedImageFilterLayer extends _7d70.ImageFilterLayer implements _36c2.Box<_7d70.ImageFilterLayer> {RTManagedImageFilterLayer({_a643.ImageFilter? imageFilter, required this.table, required this.hydroState}) : super(imageFilter: imageFilter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _a643.ImageFilter? get imageFilter { 
...
@_fac9.override void set imageFilter(value) { 
...
void loadImageFilterLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'imageFilterLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedImageFilterLayer(table: luaCallerArguments  [
0
], hydroState: hydroState, imageFilter: _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'imageFilter'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.ImageFilterLayer>(boxer: ({required _7d70.ImageFilterLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImageFilterLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

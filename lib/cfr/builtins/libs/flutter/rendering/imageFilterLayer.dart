...
class VMManagedImageFilterLayer extends VMManagedBox<ImageFilterLayer> {
  ...
  final ImageFilterLayer vmObject;
}

class RTManagedImageFilterLayer extends ImageFilterLayer
    implements Box<ImageFilterLayer> {
  RTManagedImageFilterLayer(
      {ImageFilter? imageFilter, required this.table, required this.hydroState})
  ...
  ImageFilterLayer unwrap() => this;
  ImageFilterLayer get vmObject => this;
  @override
...
void loadImageFilterLayer(
  ...
  table['imageFilterLayer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedImageFilterLayer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          imageFilter: maybeUnBoxAndBuildArgument<ImageFilter?, dynamic>(
  ...
  registerBoxer<ImageFilterLayer>(boxer: (
      {required ImageFilterLayer vmObject,

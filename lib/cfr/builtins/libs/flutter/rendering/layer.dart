...
class VMManagedLayer extends _36c2.VMManagedBox<_7d70.Layer> {VMManagedLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLayer extends _7d70.Layer implements _36c2.Box<_7d70.Layer> {RTManagedLayer({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'layer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedLayer(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7d70.Layer>(boxer: ({required _7d70.Layer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

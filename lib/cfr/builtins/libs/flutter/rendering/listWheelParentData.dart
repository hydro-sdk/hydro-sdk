...
class VMManagedListWheelParentData extends _36c2.VMManagedBox<_5bcb.ListWheelParentData> {VMManagedListWheelParentData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedListWheelParentData extends _5bcb.ListWheelParentData implements _36c2.Box<_5bcb.ListWheelParentData> {RTManagedListWheelParentData({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadListWheelParentData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'listWheelParentData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedListWheelParentData(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_5bcb.ListWheelParentData>(boxer: ({required _5bcb.ListWheelParentData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedListWheelParentData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderLimitedBox
    extends _36c2.VMManagedBox<_bf98.RenderLimitedBox> {
  VMManagedRenderLimitedBox(
...
class RTManagedRenderLimitedBox extends _bf98.RenderLimitedBox
    implements _36c2.Box<_bf98.RenderLimitedBox> {
  RTManagedRenderLimitedBox(
      {_be2e.RenderBox? child,
      required _fac9.double maxHeight,
      required _fac9.double maxWidth,
      required this.table,
      required this.hydroState})
      : super(child: child, maxHeight: maxHeight, maxWidth: maxWidth) {
...
void loadRenderLimitedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderLimitedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderLimitedBox(
  ...
  _36c2.registerBoxer<_bf98.RenderLimitedBox>(boxer: (
      {required _bf98.RenderLimitedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderLimitedBox(

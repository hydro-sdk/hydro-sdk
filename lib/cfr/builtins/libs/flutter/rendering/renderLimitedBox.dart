...
class VMManagedRenderLimitedBox extends VMManagedBox<RenderLimitedBox> {
  ...
  final RenderLimitedBox vmObject;
}

class RTManagedRenderLimitedBox extends RenderLimitedBox
    implements Box<RenderLimitedBox> {
  ...
  RenderLimitedBox unwrap() => this;
  RenderLimitedBox get vmObject => this;
  @override
  double get maxWidth {
...
void loadRenderLimitedBox(
  ...
  registerBoxer<RenderLimitedBox>(boxer: (
      {required RenderLimitedBox vmObject,

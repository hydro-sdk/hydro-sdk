...
class VMManagedRenderLimitedBox extends _36c2.VMManagedBox<_bf98.RenderLimitedBox> {VMManagedRenderLimitedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getMaxWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.maxWidth,]; } );
table  [
'setMaxWidth'
...
table  [
'getMaxHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.maxHeight,]; } );
table  [
'setMaxHeight'
...
final _bf98.RenderLimitedBox vmObject;

 }

class RTManagedRenderLimitedBox extends _bf98.RenderLimitedBox implements _36c2.Box<_bf98.RenderLimitedBox> {RTManagedRenderLimitedBox({_be2e.RenderBox? child, required _fac9.double maxHeight, required _fac9.double maxWidth, required this.table, required this.hydroState}) : super(child: child,maxHeight: maxHeight,maxWidth: maxWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderLimitedBox unwrap() => this;
_bf98.RenderLimitedBox get vmObject => this;
...
void loadRenderLimitedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderLimitedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderLimitedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderLimitedBox>(boxer: ({required _bf98.RenderLimitedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderLimitedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

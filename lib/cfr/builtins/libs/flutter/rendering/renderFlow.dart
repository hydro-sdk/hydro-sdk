...
class VMManagedRenderFlow extends _36c2.VMManagedBox<_43b9.RenderFlow> {
  VMManagedRenderFlow(
    ...
    table['getDelegate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_43b9.FlowDelegate>(
...
class RTManagedRenderFlow extends _43b9.RenderFlow
    implements _36c2.Box<_43b9.RenderFlow> {
  RTManagedRenderFlow(
      {_fac9.List<_be2e.RenderBox>? children,
      required _a643.Clip clipBehavior,
      required _43b9.FlowDelegate delegate,
      required this.table,
    ...
    table['_dart_getChildSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _43b9.FlowDelegate get delegate {
    _36c2.Closure closure = table["getDelegate"];
    return _36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(
  ...
  @_fac9.override
  void paintChild(i, {_fac9.double opacity = 1.0, _db98.Matrix4? transform}) {
...
void loadRenderFlow(
  ...
  table['renderFlow'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFlow(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          delegate: _36c2
              .maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_43b9.RenderFlow>(boxer: (
      {required _43b9.RenderFlow vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderFlow(

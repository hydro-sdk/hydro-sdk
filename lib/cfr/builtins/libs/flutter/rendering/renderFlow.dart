...
class VMManagedRenderFlow extends _36c2.VMManagedBox<_43b9.RenderFlow> {VMManagedRenderFlow({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_43b9.FlowDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.delegate=(_36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getChildSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getChildSize(luaCallerArguments  [
1
]);if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Size?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'paintChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

vmObject.paintChild(luaCallerArguments  [
1
], opacity: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'opacity'
] : null?.toDouble(), transform: _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'transform'
...
final _43b9.RenderFlow vmObject;

 }

class RTManagedRenderFlow extends _43b9.RenderFlow implements _36c2.Box<_43b9.RenderFlow> {RTManagedRenderFlow({_fac9.List<_be2e.RenderBox>? children, required _a643.Clip clipBehavior, required _43b9.FlowDelegate delegate, required this.table, required this.hydroState}) : super(children: children,clipBehavior: clipBehavior,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getChildSize'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.getChildSize(
...
table['_dart_paintChild'] =
  ...
  super.paintChild(
      _36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      opacity: _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
...
_43b9.RenderFlow unwrap() => this;
_43b9.RenderFlow get vmObject => this;
@_fac9.override void setupParentData(child) { 
_36c2.Closure closure = table["setupParentData"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _43b9.FlowDelegate get delegate { 
_36c2.Closure closure = table["getDelegate"];
return _36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set delegate(newDelegate) { 
_36c2.Closure closure = table["setDelegate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Size? getChildSize(i) { 
_36c2.Closure closure = table["getChildSize"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Size?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void paintChild(i, {_fac9.double opacity = 1.0, _db98.Matrix4? transform}) { 
...
void loadRenderFlow({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderFlow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderFlow(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), delegate: _36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_43b9.RenderFlow>(boxer: ({required _43b9.RenderFlow vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFlow(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderFlow extends VMManagedBox<RenderFlow> {
  VMManagedRenderFlow(
    ...
    table['setDelegate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.delegate = (maybeUnBoxAndBuildArgument<FlowDelegate, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final RenderFlow vmObject;
}

class RTManagedRenderFlow extends RenderFlow implements Box<RenderFlow> {
  RTManagedRenderFlow(
    ...
    table['_dart_setDelegate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.delegate = (maybeUnBoxAndBuildArgument<FlowDelegate, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_getChildSize'] =
      ...
      return [
        maybeBoxObject<Size?>(
            object: super.getChildSize(luaCallerArguments[1]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    table['_dart_paintChild'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.paintChild(luaCallerArguments[1],
          opacity: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['opacity']
              : null?.toDouble(),
          transform: maybeUnBoxAndBuildArgument<Matrix4?, dynamic>(
  ...
  RenderFlow unwrap() => this;
  RenderFlow get vmObject => this;
  @override
  ...
  FlowDelegate get delegate {
    ...
    return maybeUnBoxAndBuildArgument<FlowDelegate, dynamic>(
  ...
  @override
  Size? getChildSize(i) {
    Closure closure = table["getChildSize"];
    return maybeUnBoxAndBuildArgument<Size?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  void paintChild(i, {double opacity = 1.0, Matrix4? transform}) {
...
void loadRenderFlow(
      ...
      RTManagedRenderFlow(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          delegate: maybeUnBoxAndBuildArgument<FlowDelegate, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderFlow>(boxer: (
      {required RenderFlow vmObject,

...
class VMManagedFollowerLayer extends _36c2.VMManagedBox<_7d70.FollowerLayer> {
  VMManagedFollowerLayer(
    ...
    table['unlinkedOffset'] = _36c2.maybeBoxObject<_a643.Offset?>(
        object: vmObject.unlinkedOffset,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['linkedOffset'] = _36c2.maybeBoxObject<_a643.Offset?>(
    ...
    table['getLastTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['getAlwaysNeedsAddToScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
...
class RTManagedFollowerLayer extends _7d70.FollowerLayer
    implements _36c2.Box<_7d70.FollowerLayer> {
  RTManagedFollowerLayer(
      {_a643.Offset? linkedOffset,
      _fac9.bool? showWhenUnlinked,
      _a643.Offset? unlinkedOffset,
    ...
    table['showWhenUnlinked'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['unlinkedOffset'] = _36c2.maybeBoxObject(
        object: this.unlinkedOffset,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['linkedOffset'] = _36c2.maybeBoxObject(
        object: this.linkedOffset,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getLastTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _db98.Matrix4? getLastTransform() {
...
void loadFollowerLayer(
  ...
  table['followerLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFollowerLayer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          linkedOffset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          showWhenUnlinked: luaCallerArguments.length >= 2
              ...
              : null,
          unlinkedOffset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['unlinkedOffset']
                  : null,
              parentState: hydroState),
          link: _36c2.maybeUnBoxAndBuildArgument<_7d70.LayerLink, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['link'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.FollowerLayer>(boxer: (
      {required _7d70.FollowerLayer vmObject,

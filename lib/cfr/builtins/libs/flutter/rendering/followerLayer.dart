...
class VMManagedFollowerLayer extends _36c2.VMManagedBox<_7d70.FollowerLayer> {VMManagedFollowerLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'showWhenUnlinked'
] = vmObject.showWhenUnlinked;
table  [
'unlinkedOffset'
] = _36c2.maybeBoxObject<_a643.Offset?>(object: vmObject.unlinkedOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'linkedOffset'
] = _36c2.maybeBoxObject<_a643.Offset?>(object: vmObject.linkedOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugCreator'
...
table  [
'getLastTransform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getLastTransform();if(returnValue!= null){return [_36c2.maybeBoxObject<_db98.Matrix4?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getAlwaysNeedsAddToScene'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.alwaysNeedsAddToScene,]; } );
table  [
'addToScene'
...
final _7d70.FollowerLayer vmObject;

 }

class RTManagedFollowerLayer extends _7d70.FollowerLayer implements _36c2.Box<_7d70.FollowerLayer> {RTManagedFollowerLayer({_a643.Offset? linkedOffset, _fac9.bool? showWhenUnlinked, _a643.Offset? unlinkedOffset, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(linkedOffset: linkedOffset,showWhenUnlinked: showWhenUnlinked,unlinkedOffset: unlinkedOffset,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'showWhenUnlinked'
] = _36c2.maybeBoxObject(object: this.showWhenUnlinked, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'unlinkedOffset'
] = _36c2.maybeBoxObject(object: this.unlinkedOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'linkedOffset'
] = _36c2.maybeBoxObject(object: this.linkedOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugCreator'
...
_7d70.FollowerLayer unwrap() => this;
_7d70.FollowerLayer get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _db98.Matrix4? getLastTransform() { 
_36c2.Closure closure = table["getLastTransform"];
...
void loadFollowerLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'followerLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedFollowerLayer(table: luaCallerArguments  [
0
], hydroState: hydroState, linkedOffset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'linkedOffset'
...
'showWhenUnlinked'
] : null, unlinkedOffset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'unlinkedOffset'
] : null, parentState: hydroState), link: _36c2.maybeUnBoxAndBuildArgument<_7d70.LayerLink, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'link'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.FollowerLayer>(boxer: ({required _7d70.FollowerLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFollowerLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

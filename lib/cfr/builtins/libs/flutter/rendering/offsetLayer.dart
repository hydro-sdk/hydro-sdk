...
class VMManagedOffsetLayer extends _36c2.VMManagedBox<_7d70.OffsetLayer> {VMManagedOffsetLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedOffsetLayer extends _7d70.OffsetLayer implements _36c2.Box<_7d70.OffsetLayer> {RTManagedOffsetLayer({required _a643.Offset offset, required this.table, required this.hydroState}) : super(offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadOffsetLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'offsetLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedOffsetLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.OffsetLayer>(boxer: ({required _7d70.OffsetLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOffsetLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

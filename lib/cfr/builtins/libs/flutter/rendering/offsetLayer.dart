...
class VMManagedOffsetLayer extends VMManagedBox<OffsetLayer> {
  ...
  final OffsetLayer vmObject;
}

class RTManagedOffsetLayer extends OffsetLayer implements Box<OffsetLayer> {
  RTManagedOffsetLayer(
      {required Offset offset, required this.table, required this.hydroState})
      : super(offset: offset) {
  ...
  OffsetLayer unwrap() => this;
  OffsetLayer get vmObject => this;
  @override
  Offset get offset {
...
void loadOffsetLayer(
  ...
  registerBoxer<OffsetLayer>(boxer: (
      {required OffsetLayer vmObject,

...
class VMManagedRenderMetaData extends _36c2.VMManagedBox<_bf98.RenderMetaData> {
  VMManagedRenderMetaData(
...
class RTManagedRenderMetaData extends _bf98.RenderMetaData
    implements _36c2.Box<_bf98.RenderMetaData> {
  RTManagedRenderMetaData(
      {required _bf98.HitTestBehavior behavior,
      _be2e.RenderBox? child,
      required _fac9.dynamic metaData,
      required this.table,
      required this.hydroState})
      : super(behavior: behavior, child: child, metaData: metaData) {
...
void loadRenderMetaData(
  ...
  table['renderMetaData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderMetaData(
  ...
  _36c2.registerBoxer<_bf98.RenderMetaData>(boxer: (
      {required _bf98.RenderMetaData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderMetaData(

...
class VMManagedRenderMetaData extends VMManagedBox<RenderMetaData> {
  ...
  final RenderMetaData vmObject;
}

class RTManagedRenderMetaData extends RenderMetaData
    implements Box<RenderMetaData> {
  ...
  RenderMetaData unwrap() => this;
  RenderMetaData get vmObject => this;
  @override
...
void loadRenderMetaData(
  ...
  registerBoxer<RenderMetaData>(boxer: (
      {required RenderMetaData vmObject,

...
class VMManagedRenderConstrainedBox extends VMManagedBox<RenderConstrainedBox> {
  VMManagedRenderConstrainedBox(
    ...
    table['debugCreator'] = maybeBoxObject<Object?>(
        ...
        hydroState: hydroState,
        table: HydroTable());
    table['getAdditionalConstraints'] =
    ...
    table['setAdditionalConstraints'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.additionalConstraints =
  ...
  final RenderConstrainedBox vmObject;
}

class RTManagedRenderConstrainedBox extends RenderConstrainedBox
    implements Box<RenderConstrainedBox> {
  ...
  RenderConstrainedBox unwrap() => this;
  RenderConstrainedBox get vmObject => this;
  @override
  BoxConstraints get additionalConstraints {
    Closure closure = table["getAdditionalConstraints"];
  ...
  void set additionalConstraints(value) {
    Closure closure = table["setAdditionalConstraints"];
...
void loadRenderConstrainedBox(
  ...
  registerBoxer<RenderConstrainedBox>(boxer: (
      {required RenderConstrainedBox vmObject,

...
class VMManagedRenderConstrainedBox
    extends _36c2.VMManagedBox<_bf98.RenderConstrainedBox> {
  VMManagedRenderConstrainedBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getAdditionalConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_be2e.BoxConstraints>(
            object: vmObject.additionalConstraints,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setAdditionalConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.additionalConstraints = (_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedRenderConstrainedBox extends _bf98.RenderConstrainedBox
    implements _36c2.Box<_bf98.RenderConstrainedBox> {
  RTManagedRenderConstrainedBox(
      {_be2e.RenderBox? child,
      required _be2e.BoxConstraints additionalConstraints,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getAdditionalConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.additionalConstraints];
    });
    table['_dart_setAdditionalConstraints'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.additionalConstraints = (_36c2.maybeUnBoxAndBuildArgument<
          _be2e.BoxConstraints,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  _be2e.BoxConstraints get additionalConstraints {
  ...
  @_fac9.override
  void set additionalConstraints(value) {
...
void loadRenderConstrainedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderConstrainedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderConstrainedBox(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          additionalConstraints: _36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['additionalConstraints']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_bf98.RenderConstrainedBox>(boxer: (
      {required _bf98.RenderConstrainedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderConstrainedBox(

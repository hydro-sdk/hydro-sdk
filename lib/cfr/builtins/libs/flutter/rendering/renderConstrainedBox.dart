...
class VMManagedRenderConstrainedBox extends _36c2.VMManagedBox<_bf98.RenderConstrainedBox> {VMManagedRenderConstrainedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_be2e.BoxConstraints>(object: vmObject.additionalConstraints, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setAdditionalConstraints'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.additionalConstraints=(_36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(luaCallerArguments  [
1
...
final _bf98.RenderConstrainedBox vmObject;

 }

class RTManagedRenderConstrainedBox extends _bf98.RenderConstrainedBox implements _36c2.Box<_bf98.RenderConstrainedBox> {RTManagedRenderConstrainedBox({_be2e.RenderBox? child, required _be2e.BoxConstraints additionalConstraints, required this.table, required this.hydroState}) : super(child: child,additionalConstraints: additionalConstraints) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getAdditionalConstraints'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.additionalConstraints];
});
table['_dart_setAdditionalConstraints'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.additionalConstraints =
...
_bf98.RenderConstrainedBox unwrap() => this;
_bf98.RenderConstrainedBox get vmObject => this;
@_fac9.override _be2e.BoxConstraints get additionalConstraints { 
_36c2.Closure closure = table["getAdditionalConstraints"];
...
@_fac9.override void set additionalConstraints(value) { 
_36c2.Closure closure = table["setAdditionalConstraints"];
...
void loadRenderConstrainedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderConstrainedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderConstrainedBox(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), additionalConstraints: _36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'additionalConstraints'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderConstrainedBox>(boxer: ({required _bf98.RenderConstrainedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderConstrainedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

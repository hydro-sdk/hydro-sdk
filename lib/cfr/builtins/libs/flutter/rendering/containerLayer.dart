...
class VMManagedContainerLayer extends _36c2.VMManagedBox<_7d70.ContainerLayer> {VMManagedContainerLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedContainerLayer extends _7d70.ContainerLayer implements _36c2.Box<_7d70.ContainerLayer> {RTManagedContainerLayer({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadContainerLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'containerLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedContainerLayer(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7d70.ContainerLayer>(boxer: ({required _7d70.ContainerLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedContainerLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

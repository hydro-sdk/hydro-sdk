...
class VMManagedContainerLayer extends VMManagedBox<ContainerLayer> {
  ...
  final ContainerLayer vmObject;
}

class RTManagedContainerLayer extends ContainerLayer
    implements Box<ContainerLayer> {
  ...
  ContainerLayer unwrap() => this;
  ContainerLayer get vmObject => this;
  @override
...
void loadContainerLayer(
  ...
  registerBoxer<ContainerLayer>(boxer: (
      {required ContainerLayer vmObject,

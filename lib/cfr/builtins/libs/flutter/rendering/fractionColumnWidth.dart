...
class VMManagedFractionColumnWidth extends _36c2.VMManagedBox<_31d2.FractionColumnWidth> {VMManagedFractionColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _31d2.FractionColumnWidth vmObject;

 }

class RTManagedFractionColumnWidth extends _31d2.FractionColumnWidth implements _36c2.Box<_31d2.FractionColumnWidth> {RTManagedFractionColumnWidth(_fac9.double value$, {required this.table, required this.hydroState}) : super(value$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_31d2.FractionColumnWidth unwrap() => this;
_31d2.FractionColumnWidth get vmObject => this;
...
void loadFractionColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fractionColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFractionColumnWidth(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_31d2.FractionColumnWidth>(boxer: ({required _31d2.FractionColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFractionColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedFractionColumnWidth
    extends _36c2.VMManagedBox<_31d2.FractionColumnWidth> {
...
class RTManagedFractionColumnWidth extends _31d2.FractionColumnWidth
    implements _36c2.Box<_31d2.FractionColumnWidth> {
  RTManagedFractionColumnWidth(_fac9.double value$,
...
void loadFractionColumnWidth(
  ...
  table['fractionColumnWidth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_31d2.FractionColumnWidth>(boxer: (
      {required _31d2.FractionColumnWidth vmObject,

...
class VMManagedRenderIgnorePointer extends VMManagedBox<RenderIgnorePointer> {
  ...
  final RenderIgnorePointer vmObject;
}

class RTManagedRenderIgnorePointer extends RenderIgnorePointer
    implements Box<RenderIgnorePointer> {
  ...
  RenderIgnorePointer unwrap() => this;
  RenderIgnorePointer get vmObject => this;
  @override
  bool get ignoring {
...
void loadRenderIgnorePointer(
  ...
  registerBoxer<RenderIgnorePointer>(boxer: (
      {required RenderIgnorePointer vmObject,

...
class VMManagedRenderIgnorePointer extends _36c2.VMManagedBox<_bf98.RenderIgnorePointer> {VMManagedRenderIgnorePointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderIgnorePointer vmObject;

 }

class RTManagedRenderIgnorePointer extends _bf98.RenderIgnorePointer implements _36c2.Box<_bf98.RenderIgnorePointer> {RTManagedRenderIgnorePointer({_be2e.RenderBox? child, required _fac9.bool ignoring, _fac9.bool? ignoringSemantics, required this.table, required this.hydroState}) : super(child: child,ignoring: ignoring,ignoringSemantics: ignoringSemantics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderIgnorePointer unwrap() => this;
_bf98.RenderIgnorePointer get vmObject => this;
...
void loadRenderIgnorePointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderIgnorePointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderIgnorePointer(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), ignoring: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ignoring'
...
_36c2.registerBoxer<_bf98.RenderIgnorePointer>(boxer: ({required _bf98.RenderIgnorePointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderIgnorePointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

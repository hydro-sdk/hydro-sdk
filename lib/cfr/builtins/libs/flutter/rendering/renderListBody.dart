...
class VMManagedRenderListBody extends VMManagedBox<RenderListBody> {
  ...
  final RenderListBody vmObject;
}

class RTManagedRenderListBody extends RenderListBody
    implements Box<RenderListBody> {
  ...
  RenderListBody unwrap() => this;
  RenderListBody get vmObject => this;
  @override
  ...
  @override
  Axis get mainAxis {
    Closure closure = table["getMainAxis"];
    return maybeUnBoxEnum(
        values: Axis.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }
...
void loadRenderListBody(
  ...
  registerBoxer<RenderListBody>(boxer: (
      {required RenderListBody vmObject,

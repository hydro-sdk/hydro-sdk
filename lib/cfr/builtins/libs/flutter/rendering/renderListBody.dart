...
class VMManagedRenderListBody extends _36c2.VMManagedBox<_6874.RenderListBody> {VMManagedRenderListBody({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getMainAxis'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_487f.Axis.values.indexWhere((x) { return x == vmObject.mainAxis; } ),]; } );
table  [
'computeDryLayout'
...
class RTManagedRenderListBody extends _6874.RenderListBody implements _36c2.Box<_6874.RenderListBody> {RTManagedRenderListBody({required _487f.AxisDirection axisDirection, _fac9.List<_be2e.RenderBox>? children, required this.table, required this.hydroState}) : super(axisDirection: axisDirection,children: children) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _487f.Axis get mainAxis { 
...
void loadRenderListBody({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderListBody'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderListBody(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_6874.RenderListBody>(boxer: ({required _6874.RenderListBody vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderListBody(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

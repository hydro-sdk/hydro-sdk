...
import 'package:flutter/src/rendering/sliver_padding.dart' as _fb1e;
...
class VMManagedRenderSliverPadding extends _36c2.VMManagedBox<_fb1e.RenderSliverPadding> {VMManagedRenderSliverPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getResolvedPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.resolvedPadding;if(returnValue!= null){return [_36c2.maybeBoxObject<_96d1.EdgeInsets?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getPadding'
...
table  [
'setPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.padding=(_36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry, _fac9.dynamic>(luaCallerArguments  [
1
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childMainAxisPosition(_36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'childCrossAxisPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childCrossAxisPosition(_36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'childScrollOffset'
...
table  [
'getBeforePadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.beforePadding,]; } );
table  [
'getAfterPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.afterPadding,]; } );
table  [
'getMainAxisPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.mainAxisPadding,]; } );
table  [
'getCrossAxisPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.crossAxisPadding,]; } );
table  [
'debugValidateChild'
...
table  [
'getChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.child;if(returnValue!= null){return [_36c2.maybeBoxObject<_021d.RenderSliver?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.child=(_36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _fb1e.RenderSliverPadding vmObject;

 }

class RTManagedRenderSliverPadding extends _fb1e.RenderSliverPadding implements _36c2.Box<_fb1e.RenderSliverPadding> {RTManagedRenderSliverPadding({_021d.RenderSliver? child, _a643.TextDirection? textDirection, required _96d1.EdgeInsetsGeometry padding, required this.table, required this.hydroState}) : super(child: child,textDirection: textDirection,padding: padding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getResolvedPadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.resolvedPadding];
});
...
table['_dart_setPadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.padding = (_36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry,
...
table['_dart_getBeforePadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.beforePadding];
});
table['_dart_getAfterPadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.afterPadding];
});
table['_dart_getMainAxisPadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.mainAxisPadding];
});
table['_dart_getCrossAxisPadding'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.crossAxisPadding];
});
...
_fb1e.RenderSliverPadding unwrap() => this;
_fb1e.RenderSliverPadding get vmObject => this;
@_fac9.override _96d1.EdgeInsets? get resolvedPadding { 
_36c2.Closure closure = table["getResolvedPadding"];
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double get beforePadding { 
_36c2.Closure closure = table["getBeforePadding"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get afterPadding { 
_36c2.Closure closure = table["getAfterPadding"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get mainAxisPadding { 
_36c2.Closure closure = table["getMainAxisPadding"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get crossAxisPadding { 
_36c2.Closure closure = table["getCrossAxisPadding"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
...
@_fac9.override _021d.RenderSliver? get child { 
...
void loadRenderSliverPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderSliverPadding(table: luaCallerArguments  [
0
], hydroState: hydroState, child: _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
...
_36c2.registerBoxer<_fb1e.RenderSliverPadding>(boxer: ({required _fb1e.RenderSliverPadding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

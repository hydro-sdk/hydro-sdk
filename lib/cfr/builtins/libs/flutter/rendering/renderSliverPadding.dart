...
class VMManagedRenderSliverPadding extends VMManagedBox<RenderSliverPadding> {
  VMManagedRenderSliverPadding(
    ...
    table['getPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<EdgeInsetsGeometry>(
    ...
    table['setPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.padding =
          (maybeUnBoxAndBuildArgument<EdgeInsetsGeometry, dynamic>(
    ...
    table['getBeforePadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.beforePadding,
      ];
    });
    table['getAfterPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.afterPadding,
      ];
    });
    table['getMainAxisPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.mainAxisPadding,
      ];
    });
    table['getCrossAxisPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
    ...
    table['setChild'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.child = (maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final RenderSliverPadding vmObject;
}

class RTManagedRenderSliverPadding extends RenderSliverPadding
    implements Box<RenderSliverPadding> {
  RTManagedRenderSliverPadding(
    ...
    table['_dart_setPadding'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.padding = (maybeUnBoxAndBuildArgument<EdgeInsetsGeometry, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setChild'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.child = (maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderSliverPadding unwrap() => this;
  RenderSliverPadding get vmObject => this;
  @override
  EdgeInsets? get resolvedPadding {
    Closure closure = table["getResolvedPadding"];
  ...
  EdgeInsetsGeometry get padding {
    Closure closure = table["getPadding"];
    return maybeUnBoxAndBuildArgument<EdgeInsetsGeometry, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set padding(EdgeInsetsGeometry value) {
    Closure closure = table["setPadding"];
  ...
  double get beforePadding {
    Closure closure = table["getBeforePadding"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double get afterPadding {
    Closure closure = table["getAfterPadding"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double get mainAxisPadding {
    Closure closure = table["getMainAxisPadding"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double get crossAxisPadding {
    Closure closure = table["getCrossAxisPadding"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }
...
void loadRenderSliverPadding(
      ...
      RTManagedRenderSliverPadding(
          ...
          textDirection: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          padding: maybeUnBoxAndBuildArgument<EdgeInsetsGeometry, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverPadding>(boxer: (
      {required RenderSliverPadding vmObject,

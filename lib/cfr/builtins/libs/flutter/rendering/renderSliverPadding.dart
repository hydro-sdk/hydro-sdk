...
class VMManagedRenderSliverPadding
    extends _36c2.VMManagedBox<_fb1e.RenderSliverPadding> {
  VMManagedRenderSliverPadding(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getResolvedPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.resolvedPadding;
      if (returnValue != null) {
        return [
    ...
    table['setPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.padding = (_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['childCrossAxisPosition'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.childCrossAxisPosition(
            _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
      ];
    ...
    table['getBeforePadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.beforePadding,
      ];
    });
    table['getAfterPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.afterPadding,
      ];
    });
    table['getMainAxisPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.mainAxisPadding,
      ];
    });
    table['getCrossAxisPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.crossAxisPadding,
      ];
    });
...
class RTManagedRenderSliverPadding extends _fb1e.RenderSliverPadding
    implements _36c2.Box<_fb1e.RenderSliverPadding> {
  RTManagedRenderSliverPadding(
      {_021d.RenderSliver? child,
      _a643.TextDirection? textDirection,
      required _96d1.EdgeInsetsGeometry padding,
      required this.table,
      required this.hydroState})
      : super(child: child, textDirection: textDirection, padding: padding) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getResolvedPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.padding = (_36c2.maybeUnBoxAndBuildArgument<
          _96d1.EdgeInsetsGeometry,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_getBeforePadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.beforePadding];
    });
    table['_dart_getAfterPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.afterPadding];
    });
    table['_dart_getMainAxisPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.mainAxisPadding];
    });
    table['_dart_getCrossAxisPadding'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _96d1.EdgeInsets? get resolvedPadding {
...
void loadRenderSliverPadding(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverPadding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverPadding(
          ...
          textDirection: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          padding: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry,
                  _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_fb1e.RenderSliverPadding>(boxer: (
      {required _fb1e.RenderSliverPadding vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverPadding(

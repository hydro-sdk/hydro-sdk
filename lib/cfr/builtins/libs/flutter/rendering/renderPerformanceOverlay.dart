...
class VMManagedRenderPerformanceOverlay
    extends _36c2.VMManagedBox<_1976.RenderPerformanceOverlay> {
  VMManagedRenderPerformanceOverlay(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getOptionsMask'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.optionsMask,
      ];
    });
    table['setOptionsMask'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.optionsMask = (luaCallerArguments[1]);
      return [];
    });
    table['getRasterizerThreshold'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.rasterizerThreshold,
      ];
    });
    table['setRasterizerThreshold'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rasterizerThreshold = (luaCallerArguments[1]);
      return [];
    });
    table['getCheckerboardRasterCacheImages'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.checkerboardRasterCacheImages,
      ];
    });
    table['setCheckerboardRasterCacheImages'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.checkerboardRasterCacheImages = (luaCallerArguments[1]);
      return [];
    });
    table['getCheckerboardOffscreenLayers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.checkerboardOffscreenLayers,
      ];
    });
    table['setCheckerboardOffscreenLayers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.checkerboardOffscreenLayers = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderPerformanceOverlay extends _1976.RenderPerformanceOverlay
  ...
  RTManagedRenderPerformanceOverlay(
      {required _fac9.bool checkerboardOffscreenLayers,
      required _fac9.bool checkerboardRasterCacheImages,
      required _fac9.int optionsMask,
      required _fac9.int rasterizerThreshold,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getOptionsMask'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.optionsMask];
    });
    table['_dart_setOptionsMask'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.optionsMask =
    ...
    table['_dart_getRasterizerThreshold'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.rasterizerThreshold];
    });
    table['_dart_setRasterizerThreshold'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getCheckerboardRasterCacheImages'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.checkerboardRasterCacheImages];
    });
    table['_dart_setCheckerboardRasterCacheImages'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getCheckerboardOffscreenLayers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.checkerboardOffscreenLayers];
    });
    table['_dart_setCheckerboardOffscreenLayers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadRenderPerformanceOverlay(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderPerformanceOverlay'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPerformanceOverlay(
          ...
          checkerboardRasterCacheImages: luaCallerArguments.length >= 2
              ...
              : null,
          optionsMask: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['optionsMask']
              : null,
          rasterizerThreshold: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['rasterizerThreshold']
              : null)
    ];
  });
  _36c2.registerBoxer<_1976.RenderPerformanceOverlay>(boxer: (
      {required _1976.RenderPerformanceOverlay vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderPerformanceOverlay(

...
class VMManagedRenderPerformanceOverlay
    extends VMManagedBox<RenderPerformanceOverlay> {
  VMManagedRenderPerformanceOverlay(
    ...
    table['getCheckerboardOffscreenLayers'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
  ...
  final RenderPerformanceOverlay vmObject;
}

class RTManagedRenderPerformanceOverlay extends RenderPerformanceOverlay
    implements Box<RenderPerformanceOverlay> {
  RTManagedRenderPerformanceOverlay(
    ...
    table['_dart_setOptionsMask'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.optionsMask = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setRasterizerThreshold'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.rasterizerThreshold = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setCheckerboardRasterCacheImages'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.checkerboardRasterCacheImages = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setCheckerboardOffscreenLayers'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.checkerboardOffscreenLayers = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderPerformanceOverlay unwrap() => this;
  RenderPerformanceOverlay get vmObject => this;
  @override
  int get optionsMask {
    Closure closure = table["getOptionsMask"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set optionsMask(int value) {
    Closure closure = table["setOptionsMask"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  int get rasterizerThreshold {
    Closure closure = table["getRasterizerThreshold"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set rasterizerThreshold(int value) {
    Closure closure = table["setRasterizerThreshold"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  bool get checkerboardRasterCacheImages {
    Closure closure = table["getCheckerboardRasterCacheImages"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set checkerboardRasterCacheImages(bool value) {
  ...
  bool get checkerboardOffscreenLayers {
    Closure closure = table["getCheckerboardOffscreenLayers"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set checkerboardOffscreenLayers(bool value) {
...
void loadRenderPerformanceOverlay(
  ...
  table['renderPerformanceOverlay'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPerformanceOverlay(
  ...
  registerBoxer<RenderPerformanceOverlay>(boxer: (
      {required RenderPerformanceOverlay vmObject,

...
import 'package:flutter/src/rendering/performance_overlay.dart' as _1976;
...
class VMManagedRenderPerformanceOverlay extends _36c2.VMManagedBox<_1976.RenderPerformanceOverlay> {VMManagedRenderPerformanceOverlay({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getOptionsMask'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.optionsMask,]; } );
table  [
'setOptionsMask'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.optionsMask=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getRasterizerThreshold'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.rasterizerThreshold,]; } );
table  [
'setRasterizerThreshold'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rasterizerThreshold=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getCheckerboardRasterCacheImages'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.checkerboardRasterCacheImages,]; } );
table  [
'setCheckerboardRasterCacheImages'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.checkerboardRasterCacheImages=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getCheckerboardOffscreenLayers'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.checkerboardOffscreenLayers,]; } );
table  [
'setCheckerboardOffscreenLayers'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.checkerboardOffscreenLayers=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _1976.RenderPerformanceOverlay vmObject;

 }

class RTManagedRenderPerformanceOverlay extends _1976.RenderPerformanceOverlay implements _36c2.Box<_1976.RenderPerformanceOverlay> {RTManagedRenderPerformanceOverlay({required _fac9.bool checkerboardOffscreenLayers, required _fac9.bool checkerboardRasterCacheImages, required _fac9.int optionsMask, required _fac9.int rasterizerThreshold, required this.table, required this.hydroState}) : super(checkerboardOffscreenLayers: checkerboardOffscreenLayers,checkerboardRasterCacheImages: checkerboardRasterCacheImages,optionsMask: optionsMask,rasterizerThreshold: rasterizerThreshold) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getOptionsMask'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.optionsMask];
});
table['_dart_setOptionsMask'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.optionsMask =
...
table['_dart_getRasterizerThreshold'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.rasterizerThreshold];
});
table['_dart_setRasterizerThreshold'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getCheckerboardRasterCacheImages'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.checkerboardRasterCacheImages];
});
...
table['_dart_getCheckerboardOffscreenLayers'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.checkerboardOffscreenLayers];
});
...
_1976.RenderPerformanceOverlay unwrap() => this;
_1976.RenderPerformanceOverlay get vmObject => this;
@_fac9.override _fac9.int get optionsMask { 
_36c2.Closure closure = table["getOptionsMask"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set optionsMask(value) { 
_36c2.Closure closure = table["setOptionsMask"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int get rasterizerThreshold { 
_36c2.Closure closure = table["getRasterizerThreshold"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set rasterizerThreshold(value) { 
_36c2.Closure closure = table["setRasterizerThreshold"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get checkerboardRasterCacheImages { 
_36c2.Closure closure = table["getCheckerboardRasterCacheImages"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set checkerboardRasterCacheImages(value) { 
_36c2.Closure closure = table["setCheckerboardRasterCacheImages"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get checkerboardOffscreenLayers { 
_36c2.Closure closure = table["getCheckerboardOffscreenLayers"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set checkerboardOffscreenLayers(value) { 
_36c2.Closure closure = table["setCheckerboardOffscreenLayers"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderPerformanceOverlay({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderPerformanceOverlay'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderPerformanceOverlay(table: luaCallerArguments  [
0
], hydroState: hydroState, checkerboardOffscreenLayers: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
...
] : null, optionsMask: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'optionsMask'
] : null, rasterizerThreshold: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rasterizerThreshold'
] : null)]; } );
_36c2.registerBoxer<_1976.RenderPerformanceOverlay>(boxer: ({required _1976.RenderPerformanceOverlay vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPerformanceOverlay(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

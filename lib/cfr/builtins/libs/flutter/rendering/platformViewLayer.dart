...
class VMManagedPlatformViewLayer extends _36c2.VMManagedBox<_7d70.PlatformViewLayer> {VMManagedPlatformViewLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7d70.PlatformViewLayer vmObject;

 }

class RTManagedPlatformViewLayer extends _7d70.PlatformViewLayer implements _36c2.Box<_7d70.PlatformViewLayer> {RTManagedPlatformViewLayer({required _a643.Rect rect, required _fac9.int viewId, required this.table, required this.hydroState}) : super(rect: rect,viewId: viewId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'viewId'
] = _36c2.maybeBoxObject(object: this.viewId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugCreator'
...
_7d70.PlatformViewLayer unwrap() => this;
_7d70.PlatformViewLayer get vmObject => this;
...
void loadPlatformViewLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'platformViewLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedPlatformViewLayer(table: luaCallerArguments  [
0
], hydroState: hydroState, rect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rect'
] : null, parentState: hydroState), viewId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewId'
] : null)]; } );
_36c2.registerBoxer<_7d70.PlatformViewLayer>(boxer: ({required _7d70.PlatformViewLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformViewLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

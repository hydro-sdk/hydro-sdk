...
class VMManagedPlatformViewLayer
    extends _36c2.VMManagedBox<_7d70.PlatformViewLayer> {
...
class RTManagedPlatformViewLayer extends _7d70.PlatformViewLayer
    implements _36c2.Box<_7d70.PlatformViewLayer> {
  RTManagedPlatformViewLayer(
      {required _a643.Rect rect,
      required _fac9.int viewId,
      required this.table,
    ...
    table['viewId'] = _36c2.maybeBoxObject(
        object: this.viewId, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadPlatformViewLayer(
  ...
  table['platformViewLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlatformViewLayer(
  ...
  _36c2.registerBoxer<_7d70.PlatformViewLayer>(boxer: (
      {required _7d70.PlatformViewLayer vmObject,

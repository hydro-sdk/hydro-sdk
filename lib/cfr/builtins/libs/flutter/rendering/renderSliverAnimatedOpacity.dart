...
class VMManagedRenderSliverAnimatedOpacity
    extends VMManagedBox<RenderSliverAnimatedOpacity> {
  VMManagedRenderSliverAnimatedOpacity(
    ...
    table['setOpacity'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.opacity = (maybeUnBoxAndBuildArgument<Animation<double>, double>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['getAlwaysIncludeSemantics'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.alwaysIncludeSemantics,
      ];
    });
    table['setAlwaysIncludeSemantics'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  final RenderSliverAnimatedOpacity vmObject;
}

class RTManagedRenderSliverAnimatedOpacity extends RenderSliverAnimatedOpacity
    implements Box<RenderSliverAnimatedOpacity> {
  RTManagedRenderSliverAnimatedOpacity(
    ...
    table['_dart_setAlwaysIncludeSemantics'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.alwaysIncludeSemantics = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderSliverAnimatedOpacity unwrap() => this;
  RenderSliverAnimatedOpacity get vmObject => this;
  @override
  ...
  bool get alwaysIncludeSemantics {
    Closure closure = table["getAlwaysIncludeSemantics"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set alwaysIncludeSemantics(bool value) {
    Closure closure = table["setAlwaysIncludeSemantics"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderSliverAnimatedOpacity(
  ...
  table['renderSliverAnimatedOpacity'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverAnimatedOpacity(
          ...
          sliver: maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          opacity: maybeUnBoxAndBuildArgument<Animation<double>, double>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverAnimatedOpacity>(boxer: (
      {required RenderSliverAnimatedOpacity vmObject,

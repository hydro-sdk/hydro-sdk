...
class VMManagedRenderSliverAnimatedOpacity extends _36c2.VMManagedBox<_26cc.RenderSliverAnimatedOpacity> {VMManagedRenderSliverAnimatedOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return []; } );
table  [
'getAlwaysNeedsCompositing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.alwaysNeedsCompositing,]; } );
table  [
'getOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_86ca.Animation>(object: vmObject.opacity, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setOpacity'
...
return []; } );
table  [
'getAlwaysIncludeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.alwaysIncludeSemantics,]; } );
table  [
'setAlwaysIncludeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.alwaysIncludeSemantics=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _26cc.RenderSliverAnimatedOpacity vmObject;

 }

class RTManagedRenderSliverAnimatedOpacity extends _26cc.RenderSliverAnimatedOpacity implements _36c2.Box<_26cc.RenderSliverAnimatedOpacity> {RTManagedRenderSliverAnimatedOpacity({required _fac9.bool alwaysIncludeSemantics, _021d.RenderSliver? sliver, required _86ca.Animation<_fac9.double> opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,sliver: sliver,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getAlwaysIncludeSemantics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.alwaysIncludeSemantics];
});
table['_dart_setAlwaysIncludeSemantics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
_26cc.RenderSliverAnimatedOpacity unwrap() => this;
_26cc.RenderSliverAnimatedOpacity get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get alwaysIncludeSemantics { 
_36c2.Closure closure = table["getAlwaysIncludeSemantics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set alwaysIncludeSemantics(value) { 
_36c2.Closure closure = table["setAlwaysIncludeSemantics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderSliverAnimatedOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverAnimatedOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderSliverAnimatedOpacity(table: luaCallerArguments  [
0
], hydroState: hydroState, alwaysIncludeSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alwaysIncludeSemantics'
] : null, sliver: _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sliver'
...
_36c2.registerBoxer<_26cc.RenderSliverAnimatedOpacity>(boxer: ({required _26cc.RenderSliverAnimatedOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverAnimatedOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverAnimatedOpacity
    extends _36c2.VMManagedBox<_26cc.RenderSliverAnimatedOpacity> {
  VMManagedRenderSliverAnimatedOpacity(
...
class RTManagedRenderSliverAnimatedOpacity
    extends _26cc.RenderSliverAnimatedOpacity
    implements _36c2.Box<_26cc.RenderSliverAnimatedOpacity> {
  RTManagedRenderSliverAnimatedOpacity(
      {required _fac9.bool alwaysIncludeSemantics,
      _021d.RenderSliver? sliver,
      required _86ca.Animation<_fac9.double> opacity,
      required this.table,
    ...
    table['_dart_getAlwaysIncludeSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.alwaysIncludeSemantics];
    });
    table['_dart_setAlwaysIncludeSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _fac9.bool get alwaysIncludeSemantics {
    _36c2.Closure closure = table["getAlwaysIncludeSemantics"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void set alwaysIncludeSemantics(value) {
...
void loadRenderSliverAnimatedOpacity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverAnimatedOpacity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverAnimatedOpacity(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          alwaysIncludeSemantics: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['alwaysIncludeSemantics']
              : null,
          sliver: _36c2
              .maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          opacity: _36c2.maybeUnBoxAndBuildArgument<
  ...
  _36c2.registerBoxer<_26cc.RenderSliverAnimatedOpacity>(boxer: (
      {required _26cc.RenderSliverAnimatedOpacity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverAnimatedOpacity(

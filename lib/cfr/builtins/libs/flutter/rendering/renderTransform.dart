...
class VMManagedRenderTransform extends _36c2.VMManagedBox<_bf98.RenderTransform> {VMManagedRenderTransform({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'transformHitTests'
] = vmObject.transformHitTests;
table  [
'parentData'
...
table  [
'getOrigin'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.origin;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Offset?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setOrigin'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.origin=(_36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.alignment;if(returnValue!= null){return [_36c2.maybeBoxObject<_ca85.AlignmentGeometry?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setAlignment'
...
table  [
'getFilterQuality'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.filterQuality;if(returnValue!= null){return [_a643.FilterQuality.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'setFilterQuality'
...
table  [
'setIdentity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.setIdentity();
return []; } );
table  [
'rotateX'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rotateX(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'rotateY'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rotateY(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'rotateZ'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.rotateZ(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
vmObject.translate(luaCallerArguments  [
1
...
vmObject.scale(luaCallerArguments  [
1
]?.toDouble(), luaCallerArguments  [
2
]?.toDouble(), luaCallerArguments  [
...
final _bf98.RenderTransform vmObject;

 }

class RTManagedRenderTransform extends _bf98.RenderTransform implements _36c2.Box<_bf98.RenderTransform> {RTManagedRenderTransform({_ca85.AlignmentGeometry? alignment, _be2e.RenderBox? child, _a643.FilterQuality? filterQuality, _a643.Offset? origin, _a643.TextDirection? textDirection, required _fac9.bool transformHitTests, required _db98.Matrix4 transform, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,filterQuality: filterQuality,origin: origin,textDirection: textDirection,transformHitTests: transformHitTests,transform: transform) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'transformHitTests'
] = _36c2.maybeBoxObject(object: this.transformHitTests, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table['_dart_getOrigin'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.origin];
});
table['_dart_setOrigin'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.origin =
...
table['_dart_setAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.alignment = (_36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry?,
...
table['_dart_rotateX'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.rotateX(_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_rotateY'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.rotateY(_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_rotateZ'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.rotateZ(_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_bf98.RenderTransform unwrap() => this;
_bf98.RenderTransform get vmObject => this;
@_fac9.override _a643.Offset? get origin { 
_36c2.Closure closure = table["getOrigin"];
...
@_fac9.override void set origin(value) { 
_36c2.Closure closure = table["setOrigin"];
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void setIdentity() { 
_36c2.Closure closure = table["setIdentity"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void rotateX(radians) { 
_36c2.Closure closure = table["rotateX"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void rotateY(radians) { 
_36c2.Closure closure = table["rotateY"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void rotateZ(radians) { 
_36c2.Closure closure = table["rotateZ"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void translate(x, [_fac9.double y = 0.0, _fac9.double z = 0.0]) { 
_36c2.Closure closure = table["translate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void scale(x, [_fac9.double? y, _fac9.double? z]) { 
...
void loadRenderTransform({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderTransform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderTransform(table: luaCallerArguments  [
0
...
'filterQuality'
] : null), origin: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'origin'
...
'textDirection'
] : null), transformHitTests: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transformHitTests'
] : null, transform: _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'transform'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderTransform>(boxer: ({required _bf98.RenderTransform vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderTransform(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderTransform extends VMManagedBox<RenderTransform> {
  VMManagedRenderTransform(
    ...
    table['setOrigin'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.origin = (maybeUnBoxAndBuildArgument<Offset?, dynamic>(
  ...
  final RenderTransform vmObject;
}

class RTManagedRenderTransform extends RenderTransform
    implements Box<RenderTransform> {
  RTManagedRenderTransform(
    ...
    table['transformHitTests'] = this.transformHitTests;
    table['parentData'] = maybeBoxObject<ParentData?>(
    ...
    table['_dart_setOrigin'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.origin = (maybeUnBoxAndBuildArgument<Offset?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_rotateX'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.rotateX(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_rotateY'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.rotateY(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_rotateZ'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.rotateZ(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_translate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.translate(luaCallerArguments[1]?.toDouble(),
          luaCallerArguments[2]?.toDouble(), luaCallerArguments[3]?.toDouble());
      return [];
    });
    table['_dart_scale'] =
  ...
  RenderTransform unwrap() => this;
  RenderTransform get vmObject => this;
  @override
  Offset? get origin {
    Closure closure = table["getOrigin"];
  ...
  void set origin(value) {
    Closure closure = table["setOrigin"];
  ...
  @override
  void setIdentity() {
    Closure closure = table["setIdentity"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void rotateX(radians) {
    Closure closure = table["rotateX"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void rotateY(radians) {
    Closure closure = table["rotateY"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void rotateZ(radians) {
    Closure closure = table["rotateZ"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderTransform(
  ...
  registerBoxer<RenderTransform>(boxer: (
      {required RenderTransform vmObject,

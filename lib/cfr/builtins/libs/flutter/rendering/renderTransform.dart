...
class VMManagedRenderTransform
    extends _36c2.VMManagedBox<_bf98.RenderTransform> {
  VMManagedRenderTransform(
    ...
    table['transformHitTests'] = vmObject.transformHitTests;
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getOrigin'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.origin;
      if (returnValue != null) {
        return [
    ...
    table['setOrigin'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.origin =
    ...
    table['getAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.alignment;
      if (returnValue != null) {
        return [
    ...
    table['setIdentity'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.setIdentity();
      return [];
    });
    table['rotateX'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rotateX(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['rotateY'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rotateY(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['rotateZ'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rotateZ(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['translate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.translate(luaCallerArguments[1]?.toDouble(),
...
class RTManagedRenderTransform extends _bf98.RenderTransform
    implements _36c2.Box<_bf98.RenderTransform> {
  RTManagedRenderTransform(
      {_ca85.AlignmentGeometry? alignment,
      _be2e.RenderBox? child,
      _a643.FilterQuality? filterQuality,
      _a643.Offset? origin,
      _a643.TextDirection? textDirection,
      required _fac9.bool transformHitTests,
    ...
    table['transformHitTests'] = _36c2.maybeBoxObject(
        object: this.transformHitTests,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getOrigin'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.origin];
    });
    table['_dart_setOrigin'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.origin =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_setIdentity'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.setIdentity();
      return [];
    });
    table['_dart_rotateX'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.rotateX(
    ...
    table['_dart_rotateY'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.rotateY(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_rotateZ'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.rotateZ(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_translate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.translate(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  void rotateX(radians) {
    _36c2.Closure closure = table["rotateX"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void rotateY(radians) {
    _36c2.Closure closure = table["rotateY"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void rotateZ(radians) {
    _36c2.Closure closure = table["rotateZ"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void translate(x, [_fac9.double y = 0.0, _fac9.double z = 0.0]) {
    _36c2.Closure closure = table["translate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void scale(x, [_fac9.double? y, _fac9.double? z]) {
...
void loadRenderTransform(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderTransform'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderTransform(
          ...
          alignment: _36c2
              .maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          child: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['child'] : null,
              parentState: hydroState),
          filterQuality: _36c2.maybeUnBoxEnum(
              values: _a643.FilterQuality.values,
              boxedEnum: luaCallerArguments.length >= 2
          ...
          transformHitTests: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['transformHitTests'] : null,
  ...
  _36c2.registerBoxer<_bf98.RenderTransform>(boxer: (
      {required _bf98.RenderTransform vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderTransform(

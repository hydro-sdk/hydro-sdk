...
class VMManagedRenderSizedOverflowBox
    extends VMManagedBox<RenderSizedOverflowBox> {
  VMManagedRenderSizedOverflowBox(
    ...
    table['setRequestedSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.requestedSize = (maybeUnBoxAndBuildArgument<Size, dynamic>(
  ...
  final RenderSizedOverflowBox vmObject;
}

class RTManagedRenderSizedOverflowBox extends RenderSizedOverflowBox
    implements Box<RenderSizedOverflowBox> {
  RTManagedRenderSizedOverflowBox(
    ...
    table['_dart_setRequestedSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.requestedSize = (maybeUnBoxAndBuildArgument<Size, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderSizedOverflowBox unwrap() => this;
  RenderSizedOverflowBox get vmObject => this;
  @override
  Size get requestedSize {
    Closure closure = table["getRequestedSize"];
  ...
  void set requestedSize(value) {
    Closure closure = table["setRequestedSize"];
      ...
      RTManagedRenderSizedOverflowBox(
          ...
          textDirection: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          requestedSize: maybeUnBoxAndBuildArgument<Size, dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['requestedSize']
                  : null,
              parentState: hydroState))
    ];
  });
  registerBoxer<RenderSizedOverflowBox>(boxer: (
      {required RenderSizedOverflowBox vmObject,

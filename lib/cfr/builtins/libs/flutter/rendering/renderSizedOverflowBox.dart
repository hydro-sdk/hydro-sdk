...
class VMManagedRenderSizedOverflowBox extends _36c2.VMManagedBox<_a9e4.RenderSizedOverflowBox> {VMManagedRenderSizedOverflowBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getRequestedSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Size>(object: vmObject.requestedSize, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setRequestedSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.requestedSize=(_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a9e4.RenderSizedOverflowBox vmObject;

 }

class RTManagedRenderSizedOverflowBox extends _a9e4.RenderSizedOverflowBox implements _36c2.Box<_a9e4.RenderSizedOverflowBox> {RTManagedRenderSizedOverflowBox({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, _a643.TextDirection? textDirection, required _a643.Size requestedSize, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,textDirection: textDirection,requestedSize: requestedSize) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getRequestedSize'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.requestedSize];
});
table['_dart_setRequestedSize'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.requestedSize =
...
_a9e4.RenderSizedOverflowBox unwrap() => this;
_a9e4.RenderSizedOverflowBox get vmObject => this;
@_fac9.override _a643.Size get requestedSize { 
_36c2.Closure closure = table["getRequestedSize"];
...
@_fac9.override void set requestedSize(value) { 
_36c2.Closure closure = table["setRequestedSize"];
...
void loadRenderSizedOverflowBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSizedOverflowBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderSizedOverflowBox(table: luaCallerArguments  [
0
...
'textDirection'
] : null), requestedSize: _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'requestedSize'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_a9e4.RenderSizedOverflowBox>(boxer: ({required _a9e4.RenderSizedOverflowBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSizedOverflowBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

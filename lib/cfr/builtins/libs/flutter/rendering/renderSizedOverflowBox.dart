...
class VMManagedRenderSizedOverflowBox
    extends _36c2.VMManagedBox<_a9e4.RenderSizedOverflowBox> {
  VMManagedRenderSizedOverflowBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getRequestedSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Size>(
            object: vmObject.requestedSize,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setRequestedSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.requestedSize =
...
class RTManagedRenderSizedOverflowBox extends _a9e4.RenderSizedOverflowBox
    implements _36c2.Box<_a9e4.RenderSizedOverflowBox> {
  RTManagedRenderSizedOverflowBox(
      {required _ca85.AlignmentGeometry alignment,
      _be2e.RenderBox? child,
      _a643.TextDirection? textDirection,
      required _a643.Size requestedSize,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getRequestedSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.requestedSize];
    });
    table['_dart_setRequestedSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.requestedSize =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadRenderSizedOverflowBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSizedOverflowBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSizedOverflowBox(
          ...
          textDirection: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          requestedSize: _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['requestedSize'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_a9e4.RenderSizedOverflowBox>(boxer: (
      {required _a9e4.RenderSizedOverflowBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSizedOverflowBox(

...
class VMManagedRenderWrap extends _36c2.VMManagedBox<_d0b5.RenderWrap> {
  VMManagedRenderWrap(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getDirection'] = _36c2.makeLuaDartFunc(
    ...
    table['setDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.direction = (_36c2.maybeUnBoxEnum(
    ...
    table['getAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _d0b5.WrapAlignment.values.indexWhere((x) {
    ...
    table['setAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.alignment = (_36c2.maybeUnBoxEnum(
          values: _d0b5.WrapAlignment.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.spacing,
      ];
    });
    table['setSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.spacing = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getRunAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _d0b5.WrapAlignment.values.indexWhere((x) {
          return x == vmObject.runAlignment;
        }),
      ];
    });
    table['setRunAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.runAlignment = (_36c2.maybeUnBoxEnum(
          values: _d0b5.WrapAlignment.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getRunSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.runSpacing,
      ];
    });
    table['setRunSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.runSpacing = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getCrossAxisAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _d0b5.WrapCrossAlignment.values.indexWhere((x) {
          return x == vmObject.crossAxisAlignment;
        }),
      ];
    });
    table['setCrossAxisAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.crossAxisAlignment = (_36c2.maybeUnBoxEnum(
    ...
    table['getVerticalDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['setVerticalDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.verticalDirection = (_36c2.maybeUnBoxEnum(
...
class RTManagedRenderWrap extends _d0b5.RenderWrap
  ...
  RTManagedRenderWrap(
      {required _d0b5.WrapAlignment alignment,
      _fac9.List<_be2e.RenderBox>? children,
      required _a643.Clip clipBehavior,
      required _d0b5.WrapCrossAlignment crossAxisAlignment,
      required _487f.Axis direction,
      required _d0b5.WrapAlignment runAlignment,
      required _fac9.double runSpacing,
      required _fac9.double spacing,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.direction];
    });
    table['_dart_setDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.spacing];
    });
    table['_dart_setSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.spacing =
    ...
    table['_dart_getRunAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.runAlignment];
    });
    table['_dart_setRunAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getRunSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.runSpacing];
    });
    table['_dart_setRunSpacing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.runSpacing =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getCrossAxisAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.crossAxisAlignment];
    });
    table['_dart_setCrossAxisAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getVerticalDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.verticalDirection];
    });
    table['_dart_setVerticalDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _d0b5.WrapAlignment get alignment {
  ...
  @_fac9.override
  void set runAlignment(value) {
    _36c2.Closure closure = table["setRunAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.double get runSpacing {
    _36c2.Closure closure = table["getRunSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @_fac9.override
  void set runSpacing(value) {
    _36c2.Closure closure = table["setRunSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _d0b5.WrapCrossAlignment get crossAxisAlignment {
  ...
  @_fac9.override
  void set crossAxisAlignment(value) {
  ...
  @_fac9.override
  _487f.VerticalDirection get verticalDirection {
...
void loadRenderWrap(
  ...
  table['renderWrap'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderWrap(
          ...
          alignment: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox>?, _be2e.RenderBox>(
              luaCallerArguments.length >= 2
          ...
          direction: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          runAlignment: _36c2.maybeUnBoxEnum(
              values: _d0b5.WrapAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['runAlignment'] : null),
          runSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['runSpacing'] : null?.toDouble(),
          spacing: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['spacing'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_d0b5.RenderWrap>(boxer: (
      {required _d0b5.RenderWrap vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderWrap(

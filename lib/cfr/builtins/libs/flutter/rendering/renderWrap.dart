...
class VMManagedRenderWrap extends VMManagedBox<RenderWrap> {
  VMManagedRenderWrap(
    ...
    table['getAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        WrapAlignment.values.indexWhere((x) {
    ...
    table['setAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.alignment = (maybeUnBoxEnum(
          values: WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getSpacing'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['setRunAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.runAlignment = (maybeUnBoxEnum(
          values: WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getRunSpacing'] =
    ...
    table['getCrossAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        WrapCrossAlignment.values.indexWhere((x) {
    ...
    table['setCrossAxisAlignment'] =
      ...
      vmObject.crossAxisAlignment = (maybeUnBoxEnum(
          values: WrapCrossAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  final RenderWrap vmObject;
}

class RTManagedRenderWrap extends RenderWrap implements Box<RenderWrap> {
  RTManagedRenderWrap(
    ...
    table['_dart_setAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.alignment = (maybeUnBoxEnum(
          values: WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setSpacing'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.spacing = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setRunAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.runAlignment = (maybeUnBoxEnum(
          values: WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setRunSpacing'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.runSpacing = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  RenderWrap unwrap() => this;
  RenderWrap get vmObject => this;
  @override
  Axis get direction {
  ...
  @override
  void set alignment(WrapAlignment value) {
  ...
  @override
  double get spacing {
    Closure closure = table["getSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set spacing(double value) {
    Closure closure = table["setSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  WrapAlignment get runAlignment {
    Closure closure = table["getRunAlignment"];
    return maybeUnBoxEnum(
        values: WrapAlignment.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }
  ...
  @override
  void set runAlignment(WrapAlignment value) {
    Closure closure = table["setRunAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double get runSpacing {
    Closure closure = table["getRunSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set runSpacing(double value) {
    Closure closure = table["setRunSpacing"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  void set crossAxisAlignment(WrapCrossAlignment value) {
...
void loadRenderWrap(
      ...
      RTManagedRenderWrap(
          ...
          direction: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          runAlignment: maybeUnBoxEnum(
              values: WrapAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['runAlignment']
                  : null),
          runSpacing: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['runSpacing']
              : null?.toDouble(),
          spacing: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['spacing']
              : null?.toDouble(),
  ...
  registerBoxer<RenderWrap>(boxer: (
      {required RenderWrap vmObject,

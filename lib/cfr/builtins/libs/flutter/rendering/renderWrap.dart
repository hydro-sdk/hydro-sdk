...
class VMManagedRenderWrap extends _36c2.VMManagedBox<_d0b5.RenderWrap> {VMManagedRenderWrap({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_d0b5.WrapAlignment.values.indexWhere((x) { return x == vmObject.alignment; } ),]; } );
table  [
'setAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.alignment=(_36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getSpacing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.spacing,]; } );
table  [
'setSpacing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.spacing=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getRunAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_d0b5.WrapAlignment.values.indexWhere((x) { return x == vmObject.runAlignment; } ),]; } );
table  [
'setRunAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.runAlignment=(_36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getRunSpacing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.runSpacing,]; } );
table  [
'setRunSpacing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.runSpacing=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getCrossAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_d0b5.WrapCrossAlignment.values.indexWhere((x) { return x == vmObject.crossAxisAlignment; } ),]; } );
table  [
'setCrossAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.crossAxisAlignment=(_36c2.maybeUnBoxEnum(values: _d0b5.WrapCrossAlignment.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
final _d0b5.RenderWrap vmObject;

 }

class RTManagedRenderWrap extends _d0b5.RenderWrap implements _36c2.Box<_d0b5.RenderWrap> {RTManagedRenderWrap({required _d0b5.WrapAlignment alignment, _fac9.List<_be2e.RenderBox>? children, required _a643.Clip clipBehavior, required _d0b5.WrapCrossAlignment crossAxisAlignment, required _487f.Axis direction, required _d0b5.WrapAlignment runAlignment, required _fac9.double runSpacing, required _fac9.double spacing, _a643.TextDirection? textDirection, required _487f.VerticalDirection verticalDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,clipBehavior: clipBehavior,crossAxisAlignment: crossAxisAlignment,direction: direction,runAlignment: runAlignment,runSpacing: runSpacing,spacing: spacing,textDirection: textDirection,verticalDirection: verticalDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.alignment = (_36c2.maybeUnBoxEnum(
      values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getSpacing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.spacing];
});
table['_dart_setSpacing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.spacing =
...
table['_dart_getRunAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.runAlignment];
});
table['_dart_setRunAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.runAlignment = (_36c2.maybeUnBoxEnum(
      values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getRunSpacing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.runSpacing];
});
table['_dart_setRunSpacing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.runSpacing =
      (_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
          luaCallerArguments[1],
...
table['_dart_setCrossAxisAlignment'] =
  ...
  super.crossAxisAlignment = (_36c2.maybeUnBoxEnum(
      values: _d0b5.WrapCrossAlignment.values,
...
_d0b5.RenderWrap unwrap() => this;
_d0b5.RenderWrap get vmObject => this;
...
@_fac9.override _d0b5.WrapAlignment get alignment { 
_36c2.Closure closure = table["getAlignment"];
return _36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set alignment(value) { 
_36c2.Closure closure = table["setAlignment"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double get spacing { 
_36c2.Closure closure = table["getSpacing"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set spacing(value) { 
_36c2.Closure closure = table["setSpacing"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _d0b5.WrapAlignment get runAlignment { 
_36c2.Closure closure = table["getRunAlignment"];
return _36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set runAlignment(value) { 
_36c2.Closure closure = table["setRunAlignment"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double get runSpacing { 
_36c2.Closure closure = table["getRunSpacing"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set runSpacing(value) { 
_36c2.Closure closure = table["setRunSpacing"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _d0b5.WrapCrossAlignment get crossAxisAlignment { 
_36c2.Closure closure = table["getCrossAxisAlignment"];
return _36c2.maybeUnBoxEnum(values: _d0b5.WrapCrossAlignment.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
...
void loadRenderWrap({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderWrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderWrap(table: luaCallerArguments  [
0
], hydroState: hydroState, alignment: _36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alignment'
] : null), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox>?, _be2e.RenderBox>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
'clipBehavior'
] : null), crossAxisAlignment: _36c2.maybeUnBoxEnum(values: _d0b5.WrapCrossAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'crossAxisAlignment'
...
'direction'
] : null), runAlignment: _36c2.maybeUnBoxEnum(values: _d0b5.WrapAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'runAlignment'
] : null), runSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'runSpacing'
...
_36c2.registerBoxer<_d0b5.RenderWrap>(boxer: ({required _d0b5.RenderWrap vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderWrap(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

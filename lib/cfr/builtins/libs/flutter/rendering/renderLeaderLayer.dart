...
class VMManagedRenderLeaderLayer extends VMManagedBox<RenderLeaderLayer> {
  ...
  final RenderLeaderLayer vmObject;
}

class RTManagedRenderLeaderLayer extends RenderLeaderLayer
    implements Box<RenderLeaderLayer> {
  ...
  RenderLeaderLayer unwrap() => this;
  RenderLeaderLayer get vmObject => this;
  @override
  LayerLink get link {
...
void loadRenderLeaderLayer(
  ...
  registerBoxer<RenderLeaderLayer>(boxer: (
      {required RenderLeaderLayer vmObject,

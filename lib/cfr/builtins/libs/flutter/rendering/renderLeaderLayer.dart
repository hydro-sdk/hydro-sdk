...
class VMManagedRenderLeaderLayer extends _36c2.VMManagedBox<_bf98.RenderLeaderLayer> {VMManagedRenderLeaderLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderLeaderLayer vmObject;

 }

class RTManagedRenderLeaderLayer extends _bf98.RenderLeaderLayer implements _36c2.Box<_bf98.RenderLeaderLayer> {RTManagedRenderLeaderLayer({_be2e.RenderBox? child, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(child: child,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderLeaderLayer unwrap() => this;
_bf98.RenderLeaderLayer get vmObject => this;
...
void loadRenderLeaderLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderLeaderLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderLeaderLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderLeaderLayer>(boxer: ({required _bf98.RenderLeaderLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderLeaderLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderShrinkWrappingViewport extends _36c2.VMManagedBox<_01f8.RenderShrinkWrappingViewport> {VMManagedRenderShrinkWrappingViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugThrowIfNotCheckingIntrinsics(),]; } );
table  [
'performLayout'
...
void loadRenderShrinkWrappingViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderShrinkWrappingViewport'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderShrinkWrappingViewport(table: luaCallerArguments  [
0
...
'axisDirection'
] : null), children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_021d.RenderSliver>?, _021d.RenderSliver>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
_36c2.registerBoxer<_01f8.RenderShrinkWrappingViewport>(boxer: ({required _01f8.RenderShrinkWrappingViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderShrinkWrappingViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

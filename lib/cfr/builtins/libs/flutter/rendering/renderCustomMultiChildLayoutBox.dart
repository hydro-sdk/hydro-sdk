...
class VMManagedRenderCustomMultiChildLayoutBox
    extends VMManagedBox<RenderCustomMultiChildLayoutBox> {
  VMManagedRenderCustomMultiChildLayoutBox(
    ...
    table['getDelegate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<MultiChildLayoutDelegate>(
  ...
  final RenderCustomMultiChildLayoutBox vmObject;
}

class RTManagedRenderCustomMultiChildLayoutBox
    extends RenderCustomMultiChildLayoutBox
    implements Box<RenderCustomMultiChildLayoutBox> {
  ...
  RenderCustomMultiChildLayoutBox unwrap() => this;
  RenderCustomMultiChildLayoutBox get vmObject => this;
  @override
  ...
  MultiChildLayoutDelegate get delegate {
    ...
    return maybeUnBoxAndBuildArgument<MultiChildLayoutDelegate, dynamic>(
...
void loadRenderCustomMultiChildLayoutBox(
  ...
  table['renderCustomMultiChildLayoutBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderCustomMultiChildLayoutBox(
  ...
  registerBoxer<RenderCustomMultiChildLayoutBox>(boxer: (
      {required RenderCustomMultiChildLayoutBox vmObject,

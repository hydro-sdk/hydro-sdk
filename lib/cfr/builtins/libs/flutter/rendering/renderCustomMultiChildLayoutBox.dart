...
class VMManagedRenderCustomMultiChildLayoutBox extends _36c2.VMManagedBox<_2325.RenderCustomMultiChildLayoutBox> {VMManagedRenderCustomMultiChildLayoutBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_2325.MultiChildLayoutDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.delegate=(_36c2.maybeUnBoxAndBuildArgument<_2325.MultiChildLayoutDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _2325.RenderCustomMultiChildLayoutBox vmObject;

 }

class RTManagedRenderCustomMultiChildLayoutBox extends _2325.RenderCustomMultiChildLayoutBox implements _36c2.Box<_2325.RenderCustomMultiChildLayoutBox> {RTManagedRenderCustomMultiChildLayoutBox({_fac9.List<_be2e.RenderBox>? children, required _2325.MultiChildLayoutDelegate delegate, required this.table, required this.hydroState}) : super(children: children,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setDelegate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.delegate = (_36c2.maybeUnBoxAndBuildArgument<
...
_2325.RenderCustomMultiChildLayoutBox unwrap() => this;
_2325.RenderCustomMultiChildLayoutBox get vmObject => this;
@_fac9.override void setupParentData(child) { 
_36c2.Closure closure = table["setupParentData"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _2325.MultiChildLayoutDelegate get delegate { 
_36c2.Closure closure = table["getDelegate"];
return _36c2.maybeUnBoxAndBuildArgument<_2325.MultiChildLayoutDelegate, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderCustomMultiChildLayoutBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderCustomMultiChildLayoutBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderCustomMultiChildLayoutBox(table: luaCallerArguments  [
0
...
'children'
] : null, parentState: hydroState), delegate: _36c2.maybeUnBoxAndBuildArgument<_2325.MultiChildLayoutDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_2325.RenderCustomMultiChildLayoutBox>(boxer: ({required _2325.RenderCustomMultiChildLayoutBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderCustomMultiChildLayoutBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

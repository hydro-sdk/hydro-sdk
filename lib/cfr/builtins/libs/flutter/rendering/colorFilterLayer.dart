...
class VMManagedColorFilterLayer extends _36c2.VMManagedBox<_7d70.ColorFilterLayer> {VMManagedColorFilterLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getColorFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.colorFilter;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.ColorFilter?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setColorFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.colorFilter=(_36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedColorFilterLayer extends _7d70.ColorFilterLayer implements _36c2.Box<_7d70.ColorFilterLayer> {RTManagedColorFilterLayer({_a643.ColorFilter? colorFilter, required this.table, required this.hydroState}) : super(colorFilter: colorFilter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _a643.ColorFilter? get colorFilter { 
_36c2.Closure closure = table["getColorFilter"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set colorFilter(value) { 
...
void loadColorFilterLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'colorFilterLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedColorFilterLayer(table: luaCallerArguments  [
0
], hydroState: hydroState, colorFilter: _36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'colorFilter'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.ColorFilterLayer>(boxer: ({required _7d70.ColorFilterLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedColorFilterLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedColorFilterLayer
    extends _36c2.VMManagedBox<_7d70.ColorFilterLayer> {
  VMManagedColorFilterLayer(
    ...
    table['getColorFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.colorFilter;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_a643.ColorFilter?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setColorFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.colorFilter =
  ...
  final _7d70.ColorFilterLayer vmObject;
}

class RTManagedColorFilterLayer extends _7d70.ColorFilterLayer
    implements _36c2.Box<_7d70.ColorFilterLayer> {
  RTManagedColorFilterLayer(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getColorFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.colorFilter];
    });
    table['_dart_setColorFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.colorFilter =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  _7d70.ColorFilterLayer unwrap() => this;
  _7d70.ColorFilterLayer get vmObject => this;
  @_fac9.override
  _a643.ColorFilter? get colorFilter {
    _36c2.Closure closure = table["getColorFilter"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  void set colorFilter(value) {
    _36c2.Closure closure = table["setColorFilter"];
...
void loadColorFilterLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['colorFilterLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColorFilterLayer(
          ...
          hydroState: hydroState,
          colorFilter: _36c2
              .maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['colorFilter']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.ColorFilterLayer>(boxer: (
      {required _7d70.ColorFilterLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColorFilterLayer(

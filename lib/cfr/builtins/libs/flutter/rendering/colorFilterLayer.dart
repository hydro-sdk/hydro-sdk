...
class VMManagedColorFilterLayer extends VMManagedBox<ColorFilterLayer> {
  ...
  final ColorFilterLayer vmObject;
}

class RTManagedColorFilterLayer extends ColorFilterLayer
    implements Box<ColorFilterLayer> {
  RTManagedColorFilterLayer(
      {ColorFilter? colorFilter, required this.table, required this.hydroState})
  ...
  ColorFilterLayer unwrap() => this;
  ColorFilterLayer get vmObject => this;
  @override
...
void loadColorFilterLayer(
  ...
  table['colorFilterLayer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedColorFilterLayer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          colorFilter: maybeUnBoxAndBuildArgument<ColorFilter?, dynamic>(
  ...
  registerBoxer<ColorFilterLayer>(boxer: (
      {required ColorFilterLayer vmObject,

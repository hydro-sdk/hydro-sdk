...
class VMManagedTransformLayer extends _36c2.VMManagedBox<_7d70.TransformLayer> {VMManagedTransformLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTransformLayer extends _7d70.TransformLayer implements _36c2.Box<_7d70.TransformLayer> {RTManagedTransformLayer({required _a643.Offset offset, _db98.Matrix4? transform, required this.table, required this.hydroState}) : super(offset: offset,transform: transform) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTransformLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'transformLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedTransformLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.TransformLayer>(boxer: ({required _7d70.TransformLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTransformLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

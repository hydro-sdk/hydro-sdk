...
class VMManagedTransformLayer extends VMManagedBox<TransformLayer> {
  ...
  final TransformLayer vmObject;
}

class RTManagedTransformLayer extends TransformLayer
    implements Box<TransformLayer> {
  ...
  TransformLayer unwrap() => this;
  TransformLayer get vmObject => this;
  @override
...
void loadTransformLayer(
  ...
  registerBoxer<TransformLayer>(boxer: (
      {required TransformLayer vmObject,

...
class VMManagedTransformLayer extends _36c2.VMManagedBox<_7d70.TransformLayer> {
  VMManagedTransformLayer(
    ...
    table['toImage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
  ...
  final _7d70.TransformLayer vmObject;
}

class RTManagedTransformLayer extends _7d70.TransformLayer
    implements _36c2.Box<_7d70.TransformLayer> {
  RTManagedTransformLayer(
      {required _a643.Offset offset,
      _db98.Matrix4? transform,
      required this.table,
      required this.hydroState})
      : super(offset: offset, transform: transform) {
    ...
    table['_dart_toImage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  _7d70.TransformLayer unwrap() => this;
  _7d70.TransformLayer get vmObject => this;
  @_fac9.override
  ...
  @_fac9.override
  _7de1.Future<_a643.Image> toImage(bounds, {_fac9.double pixelRatio = 1.0}) {
    _36c2.Closure closure = table["toImage"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_7de1.Future<_a643.Image>, _a643.Image>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadTransformLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['transformLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTransformLayer(
  ...
  _36c2.registerBoxer<_7d70.TransformLayer>(boxer: (
      {required _7d70.TransformLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTransformLayer(

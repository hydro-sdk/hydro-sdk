...
import 'package:flutter/src/rendering/texture.dart' as _71dd;
...
class VMManagedTextureBox extends _36c2.VMManagedBox<_71dd.TextureBox> {VMManagedTextureBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getTextureId'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.textureId,]; } );
table  [
'setTextureId'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.textureId=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getFreeze'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.freeze,]; } );
table  [
'setFreeze'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.freeze=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _71dd.TextureBox vmObject;

 }

class RTManagedTextureBox extends _71dd.TextureBox implements _36c2.Box<_71dd.TextureBox> {RTManagedTextureBox({required _a643.FilterQuality filterQuality, required _fac9.bool freeze, required _fac9.int textureId, required this.table, required this.hydroState}) : super(filterQuality: filterQuality,freeze: freeze,textureId: textureId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setTextureId'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.textureId = (_36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
...
table['_dart_setFreeze'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.freeze = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_71dd.TextureBox unwrap() => this;
_71dd.TextureBox get vmObject => this;
@_fac9.override _fac9.int get textureId { 
_36c2.Closure closure = table["getTextureId"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set textureId(value) { 
_36c2.Closure closure = table["setTextureId"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get freeze { 
_36c2.Closure closure = table["getFreeze"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set freeze(value) { 
_36c2.Closure closure = table["setFreeze"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadTextureBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textureBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTextureBox(table: luaCallerArguments  [
0
], hydroState: hydroState, filterQuality: _36c2.maybeUnBoxEnum(values: _a643.FilterQuality.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'filterQuality'
] : null), freeze: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'freeze'
] : null, textureId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textureId'
] : null)]; } );
_36c2.registerBoxer<_71dd.TextureBox>(boxer: ({required _71dd.TextureBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextureBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

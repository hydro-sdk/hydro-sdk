...
class VMManagedTextureBox extends _36c2.VMManagedBox<_71dd.TextureBox> {
  VMManagedTextureBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getTextureId'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.textureId,
      ];
    });
    table['setTextureId'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.textureId = (luaCallerArguments[1]);
      return [];
    });
    table['getFreeze'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.freeze,
      ];
    });
    table['setFreeze'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedTextureBox extends _71dd.TextureBox
    implements _36c2.Box<_71dd.TextureBox> {
  RTManagedTextureBox(
      {required _a643.FilterQuality filterQuality,
      required _fac9.bool freeze,
      required _fac9.int textureId,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getTextureId'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.textureId];
    });
    table['_dart_setTextureId'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.textureId =
    ...
    table['_dart_getFreeze'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.freeze];
    });
    table['_dart_setFreeze'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.freeze =
...
void loadTextureBox(
  ...
  table['textureBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTextureBox(
  ...
  _36c2.registerBoxer<_71dd.TextureBox>(boxer: (
      {required _71dd.TextureBox vmObject,

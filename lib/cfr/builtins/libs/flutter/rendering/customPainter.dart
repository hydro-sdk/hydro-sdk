...
class VMManagedCustomPainter extends _36c2.VMManagedBox<_93cf.CustomPainter> {
...
class RTManagedCustomPainter extends _93cf.CustomPainter
    implements _36c2.Box<_93cf.CustomPainter> {
...
void loadCustomPainter(
  ...
  table['customPainter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCustomPainter(
  ...
  _36c2.registerBoxer<_93cf.CustomPainter>(boxer: (
      {required _93cf.CustomPainter vmObject,

...
class VMManagedRenderProxySliver extends VMManagedBox<RenderProxySliver> {
  VMManagedRenderProxySliver(
  ...
  final RenderProxySliver vmObject;
}

class RTManagedRenderProxySliver extends RenderProxySliver
    implements Box<RenderProxySliver> {
  RTManagedRenderProxySliver(RenderSliver? child$,
  ...
  RenderProxySliver unwrap() => this;
  RenderProxySliver get vmObject => this;
  @override
...
void loadRenderProxySliver(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderProxySliver'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderProxySliver(
          maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<RenderProxySliver>(boxer: (
      {required RenderProxySliver vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderProxySliver(

...
class VMManagedRenderProxySliver extends _36c2.VMManagedBox<_26cc.RenderProxySliver> {VMManagedRenderProxySliver({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _26cc.RenderProxySliver vmObject;

 }

class RTManagedRenderProxySliver extends _26cc.RenderProxySliver implements _36c2.Box<_26cc.RenderProxySliver> {RTManagedRenderProxySliver(_021d.RenderSliver? child$, {required this.table, required this.hydroState}) : super(child$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_26cc.RenderProxySliver unwrap() => this;
_26cc.RenderProxySliver get vmObject => this;
...
void loadRenderProxySliver({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderProxySliver'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderProxySliver(_36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_26cc.RenderProxySliver>(boxer: ({required _26cc.RenderProxySliver vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderProxySliver(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

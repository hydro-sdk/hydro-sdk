...
class VMManagedRenderPointerListener
    extends _36c2.VMManagedBox<_bf98.RenderPointerListener> {
  VMManagedRenderPointerListener(
...
class RTManagedRenderPointerListener extends _bf98.RenderPointerListener
  ...
  RTManagedRenderPointerListener(
      {required _bf98.HitTestBehavior behavior,
      _be2e.RenderBox? child,
      void Function(_0e77.PointerCancelEvent event)? onPointerCancel,
      void Function(_0e77.PointerDownEvent event)? onPointerDown,
      void Function(_0e77.PointerHoverEvent event)? onPointerHover,
      void Function(_0e77.PointerMoveEvent event)? onPointerMove,
      void Function(_0e77.PointerSignalEvent event)? onPointerSignal,
      void Function(_0e77.PointerUpEvent event)? onPointerUp,
      required this.table,
...
void loadRenderPointerListener(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderPointerListener'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonPointerCancel = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerCancel']
        : null;
    _36c2.Closure? unpackedonPointerDown = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerDown']
        : null;
    _36c2.Closure? unpackedonPointerHover = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerHover']
        : null;
    _36c2.Closure? unpackedonPointerMove = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerMove']
        : null;
    _36c2.Closure? unpackedonPointerSignal = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerSignal']
        : null;
    _36c2.Closure? unpackedonPointerUp = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerUp']
        : null;
    return [
      RTManagedRenderPointerListener(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          onPointerCancel: unpackedonPointerCancel != null
              ? (event) => unpackedonPointerCancel.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null,
          onPointerDown: unpackedonPointerDown != null
              ? (event) => unpackedonPointerDown.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null,
          onPointerHover: unpackedonPointerHover != null
              ? (event) => unpackedonPointerHover.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null,
          onPointerMove: unpackedonPointerMove != null
              ? (event) => unpackedonPointerMove.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null,
          onPointerSignal: unpackedonPointerSignal != null
              ? (event) => unpackedonPointerSignal.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null,
          onPointerUp: unpackedonPointerUp != null
              ? (event) => unpackedonPointerUp.dispatch(
                    [luaCallerArguments[0], event],
                    parentState: hydroState,
                  )
              : null)
  ...
  _36c2.registerBoxer<_bf98.RenderPointerListener>(boxer: (
      {required _bf98.RenderPointerListener vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderPointerListener(

...
class VMManagedRenderPointerListener
    extends VMManagedBox<RenderPointerListener> {
  ...
  final RenderPointerListener vmObject;
}

class RTManagedRenderPointerListener extends RenderPointerListener
    implements Box<RenderPointerListener> {
  ...
  RenderPointerListener unwrap() => this;
  RenderPointerListener get vmObject => this;
  @override
...
void loadRenderPointerListener(
  ...
  table['renderPointerListener'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    Closure? unpackedonPointerCancel = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerCancel']
        : null;
    Closure? unpackedonPointerDown = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerDown']
        : null;
    Closure? unpackedonPointerHover = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerHover']
        : null;
    Closure? unpackedonPointerMove = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerMove']
        : null;
    Closure? unpackedonPointerSignal = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onPointerSignal']
        : null;
    Closure? unpackedonPointerUp = luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderPointerListener>(boxer: (
      {required RenderPointerListener vmObject,

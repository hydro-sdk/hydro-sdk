...
class VMManagedRenderPointerListener extends _36c2.VMManagedBox<_bf98.RenderPointerListener> {VMManagedRenderPointerListener({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderPointerListener vmObject;

 }

class RTManagedRenderPointerListener extends _bf98.RenderPointerListener implements _36c2.Box<_bf98.RenderPointerListener> {RTManagedRenderPointerListener({required _bf98.HitTestBehavior behavior, _be2e.RenderBox? child, void Function(_0e77.PointerCancelEvent event)? onPointerCancel, void Function(_0e77.PointerDownEvent event)? onPointerDown, void Function(_0e77.PointerHoverEvent event)? onPointerHover, void Function(_0e77.PointerMoveEvent event)? onPointerMove, void Function(_0e77.PointerSignalEvent event)? onPointerSignal, void Function(_0e77.PointerUpEvent event)? onPointerUp, required this.table, required this.hydroState}) : super(behavior: behavior,child: child,onPointerCancel: onPointerCancel,onPointerDown: onPointerDown,onPointerHover: onPointerHover,onPointerMove: onPointerMove,onPointerSignal: onPointerSignal,onPointerUp: onPointerUp) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderPointerListener unwrap() => this;
_bf98.RenderPointerListener get vmObject => this;
...
void loadRenderPointerListener({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderPointerListener(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderPointerListener>(boxer: ({required _bf98.RenderPointerListener vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPointerListener(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

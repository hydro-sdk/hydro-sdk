...
class VMManagedRenderSliverFillRemainingAndOverscroll extends _36c2.VMManagedBox<_793f.RenderSliverFillRemainingAndOverscroll> {VMManagedRenderSliverFillRemainingAndOverscroll({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _793f.RenderSliverFillRemainingAndOverscroll vmObject;

 }

class RTManagedRenderSliverFillRemainingAndOverscroll extends _793f.RenderSliverFillRemainingAndOverscroll implements _36c2.Box<_793f.RenderSliverFillRemainingAndOverscroll> {RTManagedRenderSliverFillRemainingAndOverscroll({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_793f.RenderSliverFillRemainingAndOverscroll unwrap() => this;
_793f.RenderSliverFillRemainingAndOverscroll get vmObject => this;
...
void loadRenderSliverFillRemainingAndOverscroll({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFillRemainingAndOverscroll'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverFillRemainingAndOverscroll(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_793f.RenderSliverFillRemainingAndOverscroll>(boxer: ({required _793f.RenderSliverFillRemainingAndOverscroll vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFillRemainingAndOverscroll(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverFillRemainingAndOverscroll
    extends VMManagedBox<RenderSliverFillRemainingAndOverscroll> {
  ...
  final RenderSliverFillRemainingAndOverscroll vmObject;
}

class RTManagedRenderSliverFillRemainingAndOverscroll
    extends RenderSliverFillRemainingAndOverscroll
    implements Box<RenderSliverFillRemainingAndOverscroll> {
  ...
  RenderSliverFillRemainingAndOverscroll unwrap() => this;
  RenderSliverFillRemainingAndOverscroll get vmObject => this;
  @override
  void performLayout() {
...
void loadRenderSliverFillRemainingAndOverscroll(
  ...
  table['renderSliverFillRemainingAndOverscroll'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillRemainingAndOverscroll(
  ...
  registerBoxer<RenderSliverFillRemainingAndOverscroll>(boxer: (
      {required RenderSliverFillRemainingAndOverscroll vmObject,

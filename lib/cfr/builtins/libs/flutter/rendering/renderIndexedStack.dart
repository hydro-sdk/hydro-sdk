...
class VMManagedRenderIndexedStack extends _36c2.VMManagedBox<_b1b6.RenderIndexedStack> {VMManagedRenderIndexedStack({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getIndex'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.index;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setIndex'
...
vmObject.paintStack(_36c2.maybeUnBoxAndBuildArgument<_9742.PaintingContext, _fac9.dynamic>(luaCallerArguments  [
1
...
final _b1b6.RenderIndexedStack vmObject;

 }

class RTManagedRenderIndexedStack extends _b1b6.RenderIndexedStack implements _36c2.Box<_b1b6.RenderIndexedStack> {RTManagedRenderIndexedStack({required _ca85.AlignmentGeometry alignment, _fac9.List<_be2e.RenderBox>? children, _fac9.int? index, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,index: index,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_b1b6.RenderIndexedStack unwrap() => this;
_b1b6.RenderIndexedStack get vmObject => this;
...
void loadRenderIndexedStack({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderIndexedStack'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderIndexedStack(table: luaCallerArguments  [
0
...
'children'
] : null, parentState: hydroState), index: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'index'
...
_36c2.registerBoxer<_b1b6.RenderIndexedStack>(boxer: ({required _b1b6.RenderIndexedStack vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderIndexedStack(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderIndexedStack
    extends _36c2.VMManagedBox<_b1b6.RenderIndexedStack> {
  VMManagedRenderIndexedStack(
    ...
    table['getIndex'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.index;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['paintStack'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.paintStack(
...
class RTManagedRenderIndexedStack extends _b1b6.RenderIndexedStack
    implements _36c2.Box<_b1b6.RenderIndexedStack> {
  RTManagedRenderIndexedStack(
...
void loadRenderIndexedStack(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderIndexedStack'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderIndexedStack(
  ...
  _36c2.registerBoxer<_b1b6.RenderIndexedStack>(boxer: (
      {required _b1b6.RenderIndexedStack vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderIndexedStack(

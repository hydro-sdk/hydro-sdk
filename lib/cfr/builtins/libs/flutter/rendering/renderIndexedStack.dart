...
class VMManagedRenderIndexedStack extends VMManagedBox<RenderIndexedStack> {
  ...
  final RenderIndexedStack vmObject;
}

class RTManagedRenderIndexedStack extends RenderIndexedStack
    implements Box<RenderIndexedStack> {
  ...
  RenderIndexedStack unwrap() => this;
  RenderIndexedStack get vmObject => this;
  @override
...
void loadRenderIndexedStack(
  ...
  registerBoxer<RenderIndexedStack>(boxer: (
      {required RenderIndexedStack vmObject,

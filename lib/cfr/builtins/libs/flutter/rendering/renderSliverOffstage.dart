...
class VMManagedRenderSliverOffstage extends _36c2.VMManagedBox<_26cc.RenderSliverOffstage> {VMManagedRenderSliverOffstage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _26cc.RenderSliverOffstage vmObject;

 }

class RTManagedRenderSliverOffstage extends _26cc.RenderSliverOffstage implements _36c2.Box<_26cc.RenderSliverOffstage> {RTManagedRenderSliverOffstage({required _fac9.bool offstage, _021d.RenderSliver? sliver, required this.table, required this.hydroState}) : super(offstage: offstage,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_26cc.RenderSliverOffstage unwrap() => this;
_26cc.RenderSliverOffstage get vmObject => this;
...
void loadRenderSliverOffstage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverOffstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverOffstage(table: luaCallerArguments  [
0
], hydroState: hydroState, offstage: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'offstage'
...
_36c2.registerBoxer<_26cc.RenderSliverOffstage>(boxer: ({required _26cc.RenderSliverOffstage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverOffstage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverOffstage extends VMManagedBox<RenderSliverOffstage> {
  VMManagedRenderSliverOffstage(
  ...
  final RenderSliverOffstage vmObject;
}

class RTManagedRenderSliverOffstage extends RenderSliverOffstage
    implements Box<RenderSliverOffstage> {
  RTManagedRenderSliverOffstage(
      {required bool offstage,
      RenderSliver? sliver,
      required this.table,
      required this.hydroState})
      : super(offstage: offstage, sliver: sliver) {
    ...
    table['_dart_setOffstage'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.offstage = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderSliverOffstage unwrap() => this;
  RenderSliverOffstage get vmObject => this;
  @override
  bool get offstage {
    Closure closure = table["getOffstage"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set offstage(value) {
    Closure closure = table["setOffstage"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderSliverOffstage(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderSliverOffstage'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverOffstage(
  ...
  registerBoxer<RenderSliverOffstage>(boxer: (
      {required RenderSliverOffstage vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderSliverOffstage(

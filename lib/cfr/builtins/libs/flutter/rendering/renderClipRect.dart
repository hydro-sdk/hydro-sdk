...
class VMManagedRenderClipRect extends _36c2.VMManagedBox<_bf98.RenderClipRect> {VMManagedRenderClipRect({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderClipRect vmObject;

 }

class RTManagedRenderClipRect extends _bf98.RenderClipRect implements _36c2.Box<_bf98.RenderClipRect> {RTManagedRenderClipRect({_be2e.RenderBox? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.Rect>? clipper, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,clipper: clipper) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderClipRect unwrap() => this;
_bf98.RenderClipRect get vmObject => this;
...
void loadRenderClipRect({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderClipRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderClipRect(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderClipRect>(boxer: ({required _bf98.RenderClipRect vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderClipRect(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

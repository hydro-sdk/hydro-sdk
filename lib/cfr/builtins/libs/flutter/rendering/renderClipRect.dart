...
class VMManagedRenderClipRect extends VMManagedBox<RenderClipRect> {
  ...
  final RenderClipRect vmObject;
}

class RTManagedRenderClipRect extends RenderClipRect
    implements Box<RenderClipRect> {
  ...
  RenderClipRect unwrap() => this;
  RenderClipRect get vmObject => this;
  @override
...
void loadRenderClipRect(
  ...
  registerBoxer<RenderClipRect>(boxer: (
      {required RenderClipRect vmObject,

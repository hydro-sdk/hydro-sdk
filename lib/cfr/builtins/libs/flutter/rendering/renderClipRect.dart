...
class VMManagedRenderClipRect extends _36c2.VMManagedBox<_bf98.RenderClipRect> {
  VMManagedRenderClipRect(
...
class RTManagedRenderClipRect extends _bf98.RenderClipRect
    implements _36c2.Box<_bf98.RenderClipRect> {
  RTManagedRenderClipRect(
...
void loadRenderClipRect(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderClipRect'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderClipRect(
  ...
  _36c2.registerBoxer<_bf98.RenderClipRect>(boxer: (
      {required _bf98.RenderClipRect vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderClipRect(

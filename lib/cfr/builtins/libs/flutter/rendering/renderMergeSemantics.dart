...
class VMManagedRenderMergeSemantics extends _36c2.VMManagedBox<_bf98.RenderMergeSemantics> {VMManagedRenderMergeSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderMergeSemantics vmObject;

 }

class RTManagedRenderMergeSemantics extends _bf98.RenderMergeSemantics implements _36c2.Box<_bf98.RenderMergeSemantics> {RTManagedRenderMergeSemantics({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderMergeSemantics unwrap() => this;
_bf98.RenderMergeSemantics get vmObject => this;
...
void loadRenderMergeSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderMergeSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderMergeSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderMergeSemantics>(boxer: ({required _bf98.RenderMergeSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderMergeSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

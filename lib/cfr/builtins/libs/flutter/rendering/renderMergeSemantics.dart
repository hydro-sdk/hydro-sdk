...
class VMManagedRenderMergeSemantics
    extends _36c2.VMManagedBox<_bf98.RenderMergeSemantics> {
  VMManagedRenderMergeSemantics(
...
class RTManagedRenderMergeSemantics extends _bf98.RenderMergeSemantics
    implements _36c2.Box<_bf98.RenderMergeSemantics> {
  RTManagedRenderMergeSemantics(
...
void loadRenderMergeSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderMergeSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderMergeSemantics(
  ...
  _36c2.registerBoxer<_bf98.RenderMergeSemantics>(boxer: (
      {required _bf98.RenderMergeSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderMergeSemantics(

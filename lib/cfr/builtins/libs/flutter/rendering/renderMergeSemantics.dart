...
class VMManagedRenderMergeSemantics extends VMManagedBox<RenderMergeSemantics> {
  ...
  final RenderMergeSemantics vmObject;
}

class RTManagedRenderMergeSemantics extends RenderMergeSemantics
    implements Box<RenderMergeSemantics> {
  ...
  RenderMergeSemantics unwrap() => this;
  RenderMergeSemantics get vmObject => this;
  @override
...
void loadRenderMergeSemantics(
  ...
  registerBoxer<RenderMergeSemantics>(boxer: (
      {required RenderMergeSemantics vmObject,

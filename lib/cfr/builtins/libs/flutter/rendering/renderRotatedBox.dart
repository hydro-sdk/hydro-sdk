...
class VMManagedRenderRotatedBox extends VMManagedBox<RenderRotatedBox> {
  VMManagedRenderRotatedBox(
    ...
    table['debugCreator'] = maybeBoxObject<Object?>(
        ...
        hydroState: hydroState,
        table: HydroTable());
    table['getQuarterTurns'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.quarterTurns,
      ];
    });
    table['setQuarterTurns'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  final RenderRotatedBox vmObject;
}

class RTManagedRenderRotatedBox extends RenderRotatedBox
    implements Box<RenderRotatedBox> {
  RTManagedRenderRotatedBox(
    ...
    table['_dart_setQuarterTurns'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.quarterTurns = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderRotatedBox unwrap() => this;
  RenderRotatedBox get vmObject => this;
  @override
  int get quarterTurns {
    Closure closure = table["getQuarterTurns"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set quarterTurns(value) {
    Closure closure = table["setQuarterTurns"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderRotatedBox(
  ...
  registerBoxer<RenderRotatedBox>(boxer: (
      {required RenderRotatedBox vmObject,

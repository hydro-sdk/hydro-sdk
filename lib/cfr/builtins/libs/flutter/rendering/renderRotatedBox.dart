...
import 'package:flutter/src/rendering/rotated_box.dart' as _9789;
...
class VMManagedRenderRotatedBox extends _36c2.VMManagedBox<_9789.RenderRotatedBox> {VMManagedRenderRotatedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getQuarterTurns'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.quarterTurns,]; } );
table  [
'setQuarterTurns'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.quarterTurns=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _9789.RenderRotatedBox vmObject;

 }

class RTManagedRenderRotatedBox extends _9789.RenderRotatedBox implements _36c2.Box<_9789.RenderRotatedBox> {RTManagedRenderRotatedBox({_be2e.RenderBox? child, required _fac9.int quarterTurns, required this.table, required this.hydroState}) : super(child: child,quarterTurns: quarterTurns) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getQuarterTurns'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.quarterTurns];
});
table['_dart_setQuarterTurns'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.quarterTurns =
...
_9789.RenderRotatedBox unwrap() => this;
_9789.RenderRotatedBox get vmObject => this;
@_fac9.override _fac9.int get quarterTurns { 
_36c2.Closure closure = table["getQuarterTurns"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set quarterTurns(value) { 
_36c2.Closure closure = table["setQuarterTurns"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderRotatedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderRotatedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderRotatedBox(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), quarterTurns: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'quarterTurns'
] : null)]; } );
_36c2.registerBoxer<_9789.RenderRotatedBox>(boxer: ({required _9789.RenderRotatedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderRotatedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderRotatedBox
    extends _36c2.VMManagedBox<_9789.RenderRotatedBox> {
  VMManagedRenderRotatedBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getQuarterTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.quarterTurns,
      ];
    });
    table['setQuarterTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.quarterTurns = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderRotatedBox extends _9789.RenderRotatedBox
    implements _36c2.Box<_9789.RenderRotatedBox> {
  RTManagedRenderRotatedBox(
      {_be2e.RenderBox? child,
      required _fac9.int quarterTurns,
      required this.table,
      required this.hydroState})
      : super(child: child, quarterTurns: quarterTurns) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getQuarterTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.quarterTurns];
    });
    table['_dart_setQuarterTurns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.quarterTurns =
  ...
  @_fac9.override
  _fac9.int get quarterTurns {
    _36c2.Closure closure = table["getQuarterTurns"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void set quarterTurns(value) {
...
void loadRenderRotatedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderRotatedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderRotatedBox(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          quarterTurns: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['quarterTurns']
              : null)
    ];
  });
  _36c2.registerBoxer<_9789.RenderRotatedBox>(boxer: (
      {required _9789.RenderRotatedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderRotatedBox(

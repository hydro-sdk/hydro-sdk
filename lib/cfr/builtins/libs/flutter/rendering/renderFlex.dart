...
class VMManagedRenderFlex extends _36c2.VMManagedBox<_7374.RenderFlex> {VMManagedRenderFlex({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_487f.Axis.values.indexWhere((x) { return x == vmObject.direction; } ),]; } );
table  [
'setDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.direction=(_36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getMainAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_7374.MainAxisAlignment.values.indexWhere((x) { return x == vmObject.mainAxisAlignment; } ),]; } );
table  [
'setMainAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.mainAxisAlignment=(_36c2.maybeUnBoxEnum(values: _7374.MainAxisAlignment.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getMainAxisSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_7374.MainAxisSize.values.indexWhere((x) { return x == vmObject.mainAxisSize; } ),]; } );
table  [
'setMainAxisSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.mainAxisSize=(_36c2.maybeUnBoxEnum(values: _7374.MainAxisSize.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getCrossAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_7374.CrossAxisAlignment.values.indexWhere((x) { return x == vmObject.crossAxisAlignment; } ),]; } );
table  [
'setCrossAxisAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.crossAxisAlignment=(_36c2.maybeUnBoxEnum(values: _7374.CrossAxisAlignment.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_487f.VerticalDirection.values.indexWhere((x) { return x == vmObject.verticalDirection; } ),]; } );
table  [
'setVerticalDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.verticalDirection=(_36c2.maybeUnBoxEnum(values: _487f.VerticalDirection.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
vmObject.paintOverflowIndicator(_36c2.maybeUnBoxAndBuildArgument<_9742.PaintingContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments  [
2
...
4
], parentState: hydroState), overflowHints: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_eaf3.DiagnosticsNode>?, _eaf3.DiagnosticsNode>(luaCallerArguments.length >= 6 ? luaCallerArguments  [
5
]  [
'overflowHints'
] : null, parentState: hydroState));
...
final _7374.RenderFlex vmObject;

 }

class RTManagedRenderFlex extends _7374.RenderFlex implements _36c2.Box<_7374.RenderFlex> {RTManagedRenderFlex({_fac9.List<_be2e.RenderBox>? children, required _a643.Clip clipBehavior, required _7374.CrossAxisAlignment crossAxisAlignment, required _487f.Axis direction, required _7374.MainAxisAlignment mainAxisAlignment, required _7374.MainAxisSize mainAxisSize, _a643.TextBaseline? textBaseline, _a643.TextDirection? textDirection, required _487f.VerticalDirection verticalDirection, required this.table, required this.hydroState}) : super(children: children,clipBehavior: clipBehavior,crossAxisAlignment: crossAxisAlignment,direction: direction,mainAxisAlignment: mainAxisAlignment,mainAxisSize: mainAxisSize,textBaseline: textBaseline,textDirection: textDirection,verticalDirection: verticalDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.direction = (_36c2.maybeUnBoxEnum(
      values: _487f.Axis.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getMainAxisAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.mainAxisAlignment];
});
table['_dart_setMainAxisAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.mainAxisAlignment = (_36c2.maybeUnBoxEnum(
      values: _7374.MainAxisAlignment.values,
      boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getMainAxisSize'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.mainAxisSize];
});
table['_dart_setMainAxisSize'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.mainAxisSize = (_36c2.maybeUnBoxEnum(
      values: _7374.MainAxisSize.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getCrossAxisAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.crossAxisAlignment];
});
table['_dart_setCrossAxisAlignment'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.crossAxisAlignment = (_36c2.maybeUnBoxEnum(
...
table['_dart_getVerticalDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.verticalDirection];
});
table['_dart_setVerticalDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.verticalDirection = (_36c2.maybeUnBoxEnum(
...
_7374.RenderFlex unwrap() => this;
_7374.RenderFlex get vmObject => this;
@_fac9.override _487f.Axis get direction { 
...
@_fac9.override void set direction(value) { 
_36c2.Closure closure = table["setDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7374.MainAxisAlignment get mainAxisAlignment { 
_36c2.Closure closure = table["getMainAxisAlignment"];
return _36c2.maybeUnBoxEnum(values: _7374.MainAxisAlignment.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set mainAxisAlignment(value) { 
_36c2.Closure closure = table["setMainAxisAlignment"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7374.MainAxisSize get mainAxisSize { 
_36c2.Closure closure = table["getMainAxisSize"];
return _36c2.maybeUnBoxEnum(values: _7374.MainAxisSize.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set mainAxisSize(value) { 
_36c2.Closure closure = table["setMainAxisSize"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7374.CrossAxisAlignment get crossAxisAlignment { 
_36c2.Closure closure = table["getCrossAxisAlignment"];
return _36c2.maybeUnBoxEnum(values: _7374.CrossAxisAlignment.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set crossAxisAlignment(value) { 
_36c2.Closure closure = table["setCrossAxisAlignment"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _487f.VerticalDirection get verticalDirection { 
_36c2.Closure closure = table["getVerticalDirection"];
return _36c2.maybeUnBoxEnum(values: _487f.VerticalDirection.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set verticalDirection(value) { 
_36c2.Closure closure = table["setVerticalDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
@_fac9.override void paintOverflowIndicator(context, offset, containerRect, childRect, {_fac9.List? overflowHints}) { 
_36c2.Closure closure = table["paintOverflowIndicator"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderFlex({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderFlex'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderFlex(table: luaCallerArguments  [
0
], hydroState: hydroState, children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox>?, _be2e.RenderBox>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'children'
...
'clipBehavior'
] : null), crossAxisAlignment: _36c2.maybeUnBoxEnum(values: _7374.CrossAxisAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'crossAxisAlignment'
] : null), direction: _36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'direction'
] : null), mainAxisAlignment: _36c2.maybeUnBoxEnum(values: _7374.MainAxisAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'mainAxisAlignment'
] : null), mainAxisSize: _36c2.maybeUnBoxEnum(values: _7374.MainAxisSize.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'mainAxisSize'
...
'textDirection'
] : null), verticalDirection: _36c2.maybeUnBoxEnum(values: _487f.VerticalDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'verticalDirection'
] : null))]; } );
_36c2.registerBoxer<_7374.RenderFlex>(boxer: ({required _7374.RenderFlex vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFlex(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

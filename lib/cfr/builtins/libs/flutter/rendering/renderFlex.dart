...
class VMManagedRenderFlex extends VMManagedBox<RenderFlex> {
  VMManagedRenderFlex(
    ...
    table['setDirection'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.direction = (maybeUnBoxEnum(
          values: Axis.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getMainAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        MainAxisAlignment.values.indexWhere((x) {
          return x == vmObject.mainAxisAlignment;
        }),
      ];
    });
    table['setMainAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.mainAxisAlignment = (maybeUnBoxEnum(
          values: MainAxisAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getMainAxisSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        MainAxisSize.values.indexWhere((x) {
          return x == vmObject.mainAxisSize;
        }),
      ];
    });
    table['setMainAxisSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.mainAxisSize = (maybeUnBoxEnum(
          values: MainAxisSize.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getCrossAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        CrossAxisAlignment.values.indexWhere((x) {
          return x == vmObject.crossAxisAlignment;
        }),
      ];
    });
    table['setCrossAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.crossAxisAlignment = (maybeUnBoxEnum(
          values: CrossAxisAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['getVerticalDirection'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        VerticalDirection.values.indexWhere((x) {
          return x == vmObject.verticalDirection;
        }),
      ];
    });
    table['setVerticalDirection'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.verticalDirection = (maybeUnBoxEnum(
          values: VerticalDirection.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['paintOverflowIndicator'] =
      ...
      vmObject.paintOverflowIndicator(
          ...
          maybeUnBoxAndBuildArgument<Rect, dynamic>(luaCallerArguments[3],
              parentState: hydroState),
          maybeUnBoxAndBuildArgument<Rect, dynamic>(luaCallerArguments[4],
              parentState: hydroState),
          overflowHints: maybeUnBoxAndBuildArgument<List<DiagnosticsNode>?,
                  DiagnosticsNode>(
              luaCallerArguments.length >= 6
                  ? luaCallerArguments[5]['overflowHints']
                  : null,
              parentState: hydroState));
      return [];
    });
  ...
  final RenderFlex vmObject;
}

class RTManagedRenderFlex extends RenderFlex implements Box<RenderFlex> {
  RTManagedRenderFlex(
    ...
    table['_dart_setDirection'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.direction = (maybeUnBoxEnum(
          values: Axis.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setMainAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.mainAxisAlignment = (maybeUnBoxEnum(
          values: MainAxisAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setMainAxisSize'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.mainAxisSize = (maybeUnBoxEnum(
          values: MainAxisSize.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setCrossAxisAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.crossAxisAlignment = (maybeUnBoxEnum(
          values: CrossAxisAlignment.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setVerticalDirection'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.verticalDirection = (maybeUnBoxEnum(
          values: VerticalDirection.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  RenderFlex unwrap() => this;
  RenderFlex get vmObject => this;
  @override
  Axis get direction {
  ...
  void set direction(Axis value) {
    Closure closure = table["setDirection"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  MainAxisAlignment get mainAxisAlignment {
    Closure closure = table["getMainAxisAlignment"];
    return maybeUnBoxEnum(
  ...
  void set mainAxisAlignment(MainAxisAlignment value) {
    Closure closure = table["setMainAxisAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  MainAxisSize get mainAxisSize {
    Closure closure = table["getMainAxisSize"];
    return maybeUnBoxEnum(
  ...
  @override
  void set mainAxisSize(MainAxisSize value) {
    Closure closure = table["setMainAxisSize"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  CrossAxisAlignment get crossAxisAlignment {
    Closure closure = table["getCrossAxisAlignment"];
    return maybeUnBoxEnum(
  ...
  void set crossAxisAlignment(CrossAxisAlignment value) {
    Closure closure = table["setCrossAxisAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  VerticalDirection get verticalDirection {
    Closure closure = table["getVerticalDirection"];
    return maybeUnBoxEnum(
  ...
  @override
  void set verticalDirection(VerticalDirection value) {
    Closure closure = table["setVerticalDirection"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  void paintOverflowIndicator(PaintingContext context, Offset offset,
      Rect containerRect, Rect childRect,
      {List? overflowHints}) {
    Closure closure = table["paintOverflowIndicator"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
      ...
      RTManagedRenderFlex(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          crossAxisAlignment: maybeUnBoxEnum(
              values: CrossAxisAlignment.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['crossAxisAlignment']
                  : null),
          direction: maybeUnBoxEnum(
              values: Axis.values,
              boxedEnum: luaCallerArguments.length >= 2
          ...
          textBaseline: maybeUnBoxEnum(
              values: TextBaseline.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['textBaseline']
                  : null),
          textDirection: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          verticalDirection: maybeUnBoxEnum(
              values: VerticalDirection.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['verticalDirection']
                  : null))
    ];
  });
  registerBoxer<RenderFlex>(boxer: (
      {required RenderFlex vmObject,

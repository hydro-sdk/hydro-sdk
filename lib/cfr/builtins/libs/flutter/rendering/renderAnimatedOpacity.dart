...
class VMManagedRenderAnimatedOpacity extends _36c2.VMManagedBox<_bf98.RenderAnimatedOpacity> {VMManagedRenderAnimatedOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderAnimatedOpacity vmObject;

 }

class RTManagedRenderAnimatedOpacity extends _bf98.RenderAnimatedOpacity implements _36c2.Box<_bf98.RenderAnimatedOpacity> {RTManagedRenderAnimatedOpacity({required _fac9.bool alwaysIncludeSemantics, _be2e.RenderBox? child, required _86ca.Animation<_fac9.double> opacity, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,child: child,opacity: opacity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderAnimatedOpacity unwrap() => this;
_bf98.RenderAnimatedOpacity get vmObject => this;
...
void loadRenderAnimatedOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAnimatedOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderAnimatedOpacity(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderAnimatedOpacity>(boxer: ({required _bf98.RenderAnimatedOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAnimatedOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderAnimatedOpacity
    extends VMManagedBox<RenderAnimatedOpacity> {
  ...
  final RenderAnimatedOpacity vmObject;
}

class RTManagedRenderAnimatedOpacity extends RenderAnimatedOpacity
    implements Box<RenderAnimatedOpacity> {
  ...
  RenderAnimatedOpacity unwrap() => this;
  RenderAnimatedOpacity get vmObject => this;
  @override
...
void loadRenderAnimatedOpacity(
  ...
  registerBoxer<RenderAnimatedOpacity>(boxer: (
      {required RenderAnimatedOpacity vmObject,

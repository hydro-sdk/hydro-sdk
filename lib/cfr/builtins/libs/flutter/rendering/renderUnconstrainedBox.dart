...
class VMManagedRenderUnconstrainedBox
    extends VMManagedBox<RenderUnconstrainedBox> {
  VMManagedRenderUnconstrainedBox(
    ...
    table['setConstrainedAxis'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.constrainedAxis = (maybeUnBoxEnum(
  ...
  final RenderUnconstrainedBox vmObject;
}

class RTManagedRenderUnconstrainedBox extends RenderUnconstrainedBox
    implements Box<RenderUnconstrainedBox> {
  RTManagedRenderUnconstrainedBox(
    ...
    table['_dart_setConstrainedAxis'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.constrainedAxis = (maybeUnBoxEnum(
          values: Axis.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  RenderUnconstrainedBox unwrap() => this;
  RenderUnconstrainedBox get vmObject => this;
  @override
  Axis? get constrainedAxis {
    Closure closure = table["getConstrainedAxis"];
  ...
  @override
  void set constrainedAxis(Axis? value) {
    Closure closure = table["setConstrainedAxis"];
...
void loadRenderUnconstrainedBox(
      ...
      RTManagedRenderUnconstrainedBox(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          constrainedAxis: maybeUnBoxEnum(
              values: Axis.values,
              boxedEnum: luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderUnconstrainedBox>(boxer: (
      {required RenderUnconstrainedBox vmObject,

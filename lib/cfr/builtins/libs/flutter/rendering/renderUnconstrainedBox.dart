...
class VMManagedRenderUnconstrainedBox
    extends _36c2.VMManagedBox<_a9e4.RenderUnconstrainedBox> {
  VMManagedRenderUnconstrainedBox(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getConstrainedAxis'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.constrainedAxis;
      if (returnValue != null) {
        return [
    ...
    table['setConstrainedAxis'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.constrainedAxis = (_36c2.maybeUnBoxEnum(
    ...
    table['getConstraintsTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.constraintsTransform,
      ];
    });
    table['setConstraintsTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedvalue = luaCallerArguments[1];
      vmObject.constraintsTransform = ((_) =>
...
class RTManagedRenderUnconstrainedBox extends _a9e4.RenderUnconstrainedBox
    implements _36c2.Box<_a9e4.RenderUnconstrainedBox> {
  RTManagedRenderUnconstrainedBox(
      {_be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      _487f.Axis? constrainedAxis,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getConstrainedAxis'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.constrainedAxis];
    });
    table['_dart_setConstrainedAxis'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setConstraintsTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedvalue = luaCallerArguments[1];
  ...
  @_fac9.override
  _487f.Axis? get constrainedAxis {
  ...
  @_fac9.override
  void set constrainedAxis(value) {
...
void loadRenderUnconstrainedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderUnconstrainedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderUnconstrainedBox(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          constrainedAxis: _36c2.maybeUnBoxEnum(
              values: _487f.Axis.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['constrainedAxis']
                  : null),
  ...
  _36c2.registerBoxer<_a9e4.RenderUnconstrainedBox>(boxer: (
      {required _a9e4.RenderUnconstrainedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderUnconstrainedBox(

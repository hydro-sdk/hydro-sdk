...
class VMManagedRenderUnconstrainedBox extends _36c2.VMManagedBox<_a9e4.RenderUnconstrainedBox> {VMManagedRenderUnconstrainedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getConstrainedAxis'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.constrainedAxis;if(returnValue!= null){return [_487f.Axis.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'setConstrainedAxis'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.constrainedAxis=(_36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
table  [
'getConstraintsTransform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.constraintsTransform,]; } );
table  [
...
1
];vmObject.constraintsTransform=((_) => _36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(unpackedvalue.dispatch([luaCallerArguments[0],_],parentState:hydroState,)[0], parentState: hydroState));
return []; } );
table  [
'getClipBehavior'
...
final _a9e4.RenderUnconstrainedBox vmObject;

 }

class RTManagedRenderUnconstrainedBox extends _a9e4.RenderUnconstrainedBox implements _36c2.Box<_a9e4.RenderUnconstrainedBox> {RTManagedRenderUnconstrainedBox({_be2e.RenderBox? child, required _a643.Clip clipBehavior, _487f.Axis? constrainedAxis, required _ca85.AlignmentGeometry alignment, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,constrainedAxis: constrainedAxis,alignment: alignment,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getConstrainedAxis'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.constrainedAxis];
});
table['_dart_setConstrainedAxis'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.constrainedAxis = (_36c2.maybeUnBoxEnum(
...
_a9e4.RenderUnconstrainedBox unwrap() => this;
_a9e4.RenderUnconstrainedBox get vmObject => this;
@_fac9.override _487f.Axis? get constrainedAxis { 
_36c2.Closure closure = table["getConstrainedAxis"];
return _36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set constrainedAxis(value) { 
_36c2.Closure closure = table["setConstrainedAxis"];
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set constraintsTransform(value) { 
_36c2.Closure closure = table["setConstraintsTransform"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderUnconstrainedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderUnconstrainedBox(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), constrainedAxis: _36c2.maybeUnBoxEnum(values: _487f.Axis.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'constrainedAxis'
] : null), alignment: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alignment'
...
_36c2.registerBoxer<_a9e4.RenderUnconstrainedBox>(boxer: ({required _a9e4.RenderUnconstrainedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderUnconstrainedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

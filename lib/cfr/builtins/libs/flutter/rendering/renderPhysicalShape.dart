...
class VMManagedRenderPhysicalShape extends VMManagedBox<RenderPhysicalShape> {
  ...
  final RenderPhysicalShape vmObject;
}

class RTManagedRenderPhysicalShape extends RenderPhysicalShape
    implements Box<RenderPhysicalShape> {
  RTManagedRenderPhysicalShape(
    ...
    table['_dart_setClipper'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.clipper = (maybeUnBoxAndBuildArgument<CustomClipper<Path>?, Path>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderPhysicalShape unwrap() => this;
  RenderPhysicalShape get vmObject => this;
  @override
  ...
  CustomClipper<Path>? get clipper {
    ...
    return maybeUnBoxAndBuildArgument<CustomClipper<Path>?, Path>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderPhysicalShape(
      ...
      RTManagedRenderPhysicalShape(
          ...
          shadowColor: maybeUnBoxAndBuildArgument<Color, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          clipper: maybeUnBoxAndBuildArgument<CustomClipper<Path>, Path>(
  ...
  registerBoxer<RenderPhysicalShape>(boxer: (
      {required RenderPhysicalShape vmObject,

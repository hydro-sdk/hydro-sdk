...
class VMManagedRenderPhysicalShape extends _36c2.VMManagedBox<_bf98.RenderPhysicalShape> {VMManagedRenderPhysicalShape({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'setClipper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.clipper=(_36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>?, _a643.Path>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _bf98.RenderPhysicalShape vmObject;

 }

class RTManagedRenderPhysicalShape extends _bf98.RenderPhysicalShape implements _36c2.Box<_bf98.RenderPhysicalShape> {RTManagedRenderPhysicalShape({_be2e.RenderBox? child, required _a643.Clip clipBehavior, required _fac9.double elevation, required _a643.Color shadowColor, required _bf98.CustomClipper<_a643.Path> clipper, required _a643.Color color, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,elevation: elevation,shadowColor: shadowColor,clipper: clipper,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderPhysicalShape unwrap() => this;
_bf98.RenderPhysicalShape get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _bf98.CustomClipper<_a643.Path>? get clipper { 
_36c2.Closure closure = table["getClipper"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>?, _a643.Path>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderPhysicalShape({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderPhysicalShape'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderPhysicalShape(table: luaCallerArguments  [
0
...
'shadowColor'
] : null, parentState: hydroState), clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>, _a643.Path>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipper'
...
_36c2.registerBoxer<_bf98.RenderPhysicalShape>(boxer: ({required _bf98.RenderPhysicalShape vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPhysicalShape(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

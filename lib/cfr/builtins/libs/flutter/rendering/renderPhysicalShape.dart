...
class VMManagedRenderPhysicalShape
    extends _36c2.VMManagedBox<_bf98.RenderPhysicalShape> {
  VMManagedRenderPhysicalShape(
...
class RTManagedRenderPhysicalShape extends _bf98.RenderPhysicalShape
    implements _36c2.Box<_bf98.RenderPhysicalShape> {
  RTManagedRenderPhysicalShape(
      {_be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      required _fac9.double elevation,
      required _a643.Color shadowColor,
      required _bf98.CustomClipper<_a643.Path> clipper,
  ...
  @_fac9.override
  _bf98.CustomClipper<_a643.Path>? get clipper {
    _36c2.Closure closure = table["getClipper"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>?,
            _a643.Path>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderPhysicalShape(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderPhysicalShape'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPhysicalShape(
          ...
          shadowColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>, _a643.Path>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['clipper'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_bf98.RenderPhysicalShape>(boxer: (
      {required _bf98.RenderPhysicalShape vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderPhysicalShape(

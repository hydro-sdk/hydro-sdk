...
class VMManagedRenderSliverPersistentHeader
    extends VMManagedBox<RenderSliverPersistentHeader> {
  ...
  final RenderSliverPersistentHeader vmObject;
}

class RTManagedRenderSliverPersistentHeader extends RenderSliverPersistentHeader
    implements Box<RenderSliverPersistentHeader> {
  ...
  RenderSliverPersistentHeader unwrap() => this;
  RenderSliverPersistentHeader get vmObject => this;
  @override
...
void loadRenderSliverPersistentHeader(
  ...
  table['renderSliverPersistentHeader'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverPersistentHeader(
  ...
  registerBoxer<RenderSliverPersistentHeader>(boxer: (
      {required RenderSliverPersistentHeader vmObject,

...
class VMManagedRenderSliverPersistentHeader extends _36c2.VMManagedBox<_2805.RenderSliverPersistentHeader> {VMManagedRenderSliverPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childMainAxisPosition(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
...
final _2805.RenderSliverPersistentHeader vmObject;

 }

class RTManagedRenderSliverPersistentHeader extends _2805.RenderSliverPersistentHeader implements _36c2.Box<_2805.RenderSliverPersistentHeader> {RTManagedRenderSliverPersistentHeader({_be2e.RenderBox? child, _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration, required this.table, required this.hydroState}) : super(child: child,stretchConfiguration: stretchConfiguration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2805.RenderSliverPersistentHeader unwrap() => this;
_2805.RenderSliverPersistentHeader get vmObject => this;
...
void loadRenderSliverPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverPersistentHeader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverPersistentHeader(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2805.RenderSliverPersistentHeader>(boxer: ({required _2805.RenderSliverPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

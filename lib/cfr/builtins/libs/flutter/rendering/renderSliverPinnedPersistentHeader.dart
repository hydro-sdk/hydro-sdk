...
class VMManagedRenderSliverPinnedPersistentHeader extends _36c2.VMManagedBox<_2805.RenderSliverPinnedPersistentHeader> {VMManagedRenderSliverPinnedPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRenderSliverPinnedPersistentHeader extends _2805.RenderSliverPinnedPersistentHeader implements _36c2.Box<_2805.RenderSliverPinnedPersistentHeader> {RTManagedRenderSliverPinnedPersistentHeader({_be2e.RenderBox? child, _2805.PersistentHeaderShowOnScreenConfiguration? showOnScreenConfiguration, _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration, required this.table, required this.hydroState}) : super(child: child,showOnScreenConfiguration: showOnScreenConfiguration,stretchConfiguration: stretchConfiguration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRenderSliverPinnedPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverPinnedPersistentHeader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderSliverPinnedPersistentHeader(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2805.RenderSliverPinnedPersistentHeader>(boxer: ({required _2805.RenderSliverPinnedPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverPinnedPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

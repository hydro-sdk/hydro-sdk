...
class VMManagedRenderSliverPinnedPersistentHeader
    extends VMManagedBox<RenderSliverPinnedPersistentHeader> {
  ...
  final RenderSliverPinnedPersistentHeader vmObject;
}

class RTManagedRenderSliverPinnedPersistentHeader
    extends RenderSliverPinnedPersistentHeader
    implements Box<RenderSliverPinnedPersistentHeader> {
  ...
  RenderSliverPinnedPersistentHeader unwrap() => this;
  RenderSliverPinnedPersistentHeader get vmObject => this;
  @override
  void performLayout() {
...
void loadRenderSliverPinnedPersistentHeader(
  ...
  table['renderSliverPinnedPersistentHeader'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverPinnedPersistentHeader(
          ...
          child: maybeUnBoxAndBuildArgument<RenderBox?, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          showOnScreenConfiguration: maybeUnBoxAndBuildArgument<
                  PersistentHeaderShowOnScreenConfiguration?, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverPinnedPersistentHeader>(boxer: (
      {required RenderSliverPinnedPersistentHeader vmObject,

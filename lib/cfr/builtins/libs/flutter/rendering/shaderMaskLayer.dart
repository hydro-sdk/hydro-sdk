...
class VMManagedShaderMaskLayer extends VMManagedBox<ShaderMaskLayer> {
  VMManagedShaderMaskLayer(
    ...
    table['setMaskRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.maskRect = (maybeUnBoxAndBuildArgument<Rect?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final ShaderMaskLayer vmObject;
}

class RTManagedShaderMaskLayer extends ShaderMaskLayer
    implements Box<ShaderMaskLayer> {
  RTManagedShaderMaskLayer(
    ...
    table['_dart_setMaskRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.maskRect = (maybeUnBoxAndBuildArgument<Rect?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  ShaderMaskLayer unwrap() => this;
  ShaderMaskLayer get vmObject => this;
  @override
  Shader? get shader {
  ...
  @override
  Rect? get maskRect {
    Closure closure = table["getMaskRect"];
...
void loadShaderMaskLayer(
      ...
      RTManagedShaderMaskLayer(
          ...
          blendMode: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          maskRect: maybeUnBoxAndBuildArgument<Rect?, dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['maskRect']
                  : null,
              parentState: hydroState),
          shader: maybeUnBoxAndBuildArgument<Shader?, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<ShaderMaskLayer>(boxer: (
      {required ShaderMaskLayer vmObject,

...
class VMManagedShaderMaskLayer
    extends _36c2.VMManagedBox<_7d70.ShaderMaskLayer> {
  VMManagedShaderMaskLayer(
    ...
    table['getShader'] = _36c2.makeLuaDartFunc(
    ...
    table['setShader'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.shader =
    ...
    table['getMaskRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.maskRect;
      if (returnValue != null) {
        return [
    ...
    table['setMaskRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.maskRect =
    ...
    table['getBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.blendMode;
      if (returnValue != null) {
        return [
    ...
    table['setBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.blendMode = (_36c2.maybeUnBoxEnum(
          values: _a643.BlendMode.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['addToScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.addToScene(
    ...
    table['buildScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Scene>(
            object: vmObject.buildScene(_36c2.maybeUnBoxAndBuildArgument<
                _a643.SceneBuilder,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
    ...
    table['updateSubtreeNeedsAddToScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.updateSubtreeNeedsAddToScene();
      return [];
    });
    table['findAnnotations'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['append'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.append(
    ...
    table['removeAllChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.removeAllChildren();
      return [];
    });
    table['addChildrenToScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['applyTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedShaderMaskLayer extends _7d70.ShaderMaskLayer
    implements _36c2.Box<_7d70.ShaderMaskLayer> {
  RTManagedShaderMaskLayer(
      {_a643.BlendMode? blendMode,
      _a643.Rect? maskRect,
      _a643.Shader? shader,
      required this.table,
      required this.hydroState})
      : super(blendMode: blendMode, maskRect: maskRect, shader: shader) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getShader'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.shader];
    });
    table['_dart_setShader'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.shader =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Shader?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getMaskRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.maskRect];
    });
    table['_dart_setMaskRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.maskRect =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.blendMode];
    });
    table['_dart_setBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_buildScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.buildScene(_36c2.maybeUnBoxAndBuildArgument<
                _a643.SceneBuilder,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
    ...
    table['_dart_append'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_removeAllChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.removeAllChildren();
      return [];
    });
    table['_dart_addChildrenToScene'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_applyTransform'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _a643.Scene buildScene(builder) {
    _36c2.Closure closure = table["buildScene"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.Scene, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _fac9.List<_7d70.Layer> depthFirstIterateChildren() {
    _36c2.Closure closure = table["depthFirstIterateChildren"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_fac9.List<_7d70.Layer>, _7d70.Layer>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadShaderMaskLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['shaderMaskLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedShaderMaskLayer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          blendMode: _36c2.maybeUnBoxEnum(
              values: _a643.BlendMode.values,
              boxedEnum: luaCallerArguments.length >= 2
          ...
          maskRect:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['maskRect']
                      : null,
                  parentState: hydroState),
          shader:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Shader?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['shader']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.ShaderMaskLayer>(boxer: (
      {required _7d70.ShaderMaskLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShaderMaskLayer(

...
class VMManagedShaderMaskLayer extends _36c2.VMManagedBox<_7d70.ShaderMaskLayer> {VMManagedShaderMaskLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getShader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.shader;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Shader?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setShader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.shader=(_36c2.maybeUnBoxAndBuildArgument<_a643.Shader?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getMaskRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.maskRect;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Rect?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setMaskRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.maskRect=(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getBlendMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.blendMode;if(returnValue!= null){return [_a643.BlendMode.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'setBlendMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.blendMode=(_36c2.maybeUnBoxEnum(values: _a643.BlendMode.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
final _7d70.ShaderMaskLayer vmObject;

 }

class RTManagedShaderMaskLayer extends _7d70.ShaderMaskLayer implements _36c2.Box<_7d70.ShaderMaskLayer> {RTManagedShaderMaskLayer({_a643.BlendMode? blendMode, _a643.Rect? maskRect, _a643.Shader? shader, required this.table, required this.hydroState}) : super(blendMode: blendMode,maskRect: maskRect,shader: shader) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setShader'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.shader =
      (_36c2.maybeUnBoxAndBuildArgument<_a643.Shader?, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_getMaskRect'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.maskRect];
});
table['_dart_setMaskRect'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.maskRect =
...
table['_dart_setBlendMode'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.blendMode = (_36c2.maybeUnBoxEnum(
...
_7d70.ShaderMaskLayer unwrap() => this;
_7d70.ShaderMaskLayer get vmObject => this;
@_fac9.override _a643.Shader? get shader { 
_36c2.Closure closure = table["getShader"];
...
@_fac9.override void set shader(value) { 
_36c2.Closure closure = table["setShader"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Rect? get maskRect { 
_36c2.Closure closure = table["getMaskRect"];
...
@_fac9.override void set maskRect(value) { 
_36c2.Closure closure = table["setMaskRect"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.BlendMode? get blendMode { 
_36c2.Closure closure = table["getBlendMode"];
return _36c2.maybeUnBoxEnum(values: _a643.BlendMode.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set blendMode(value) { 
_36c2.Closure closure = table["setBlendMode"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadShaderMaskLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shaderMaskLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedShaderMaskLayer(table: luaCallerArguments  [
0
], hydroState: hydroState, blendMode: _36c2.maybeUnBoxEnum(values: _a643.BlendMode.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'blendMode'
] : null), maskRect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maskRect'
] : null, parentState: hydroState), shader: _36c2.maybeUnBoxAndBuildArgument<_a643.Shader?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shader'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.ShaderMaskLayer>(boxer: ({required _7d70.ShaderMaskLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShaderMaskLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

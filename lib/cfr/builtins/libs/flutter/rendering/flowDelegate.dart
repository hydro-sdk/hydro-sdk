...
class VMManagedFlowDelegate extends _36c2.VMManagedBox<_43b9.FlowDelegate> {VMManagedFlowDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_be2e.BoxConstraints>(object: vmObject.getConstraintsForChild(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'paintChildren'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.paintChildren(_36c2.maybeUnBoxAndBuildArgument<_43b9.FlowPaintingContext, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'shouldRelayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRelayout(_36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'shouldRepaint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRepaint(_36c2.maybeUnBoxAndBuildArgument<_43b9.FlowDelegate, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'toString'
...
class RTManagedFlowDelegate extends _43b9.FlowDelegate implements _36c2.Box<_43b9.FlowDelegate> {RTManagedFlowDelegate({_e644.Listenable? repaint, required this.table, required this.hydroState}) : super(repaint: repaint) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _be2e.BoxConstraints getConstraintsForChild(i, constraints) { 
...
@_fac9.override void paintChildren(context) { 
...
void loadFlowDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flowDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFlowDelegate(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_43b9.FlowDelegate>(boxer: ({required _43b9.FlowDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlowDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderImage extends _36c2.VMManagedBox<_3e84.RenderImage> {
  VMManagedRenderImage(
    ...
    table['getImage'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_a643.Image?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setImage'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.image =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Image?, _fac9.dynamic>(
    ...
    table['setWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['setHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['setScale'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['getFilterQuality'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _a643.FilterQuality.values.indexWhere((x) {
          return x == vmObject.filterQuality;
        }),
      ];
    });
    table['setFilterQuality'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.filterQuality = (_36c2.maybeUnBoxEnum(
          values: _a643.FilterQuality.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getColorBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.colorBlendMode;
      if (returnValue != null) {
        return [
          _a643.BlendMode.values.indexWhere((x) {
    ...
    table['setColorBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.colorBlendMode = (_36c2.maybeUnBoxEnum(
          values: _a643.BlendMode.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getFit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.fit;
      if (returnValue != null) {
        return [
          _fb77.BoxFit.values.indexWhere((x) {
            return x == returnValue;
          }),
        ];
      }
    ...
    table['setFit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.fit = (_36c2.maybeUnBoxEnum(
          values: _fb77.BoxFit.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['setAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.alignment = (_36c2.maybeUnBoxAndBuildArgument<
          _ca85.AlignmentGeometry,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    table['getRepeat'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _48c4.ImageRepeat.values.indexWhere((x) {
          return x == vmObject.repeat;
        }),
      ];
    });
    table['setRepeat'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.repeat = (_36c2.maybeUnBoxEnum(
          values: _48c4.ImageRepeat.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getCenterSlice'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['setCenterSlice'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.centerSlice =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    table['getInvertColors'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.invertColors,
      ];
    });
    table['setInvertColors'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['setMatchTextDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['getIsAntiAlias'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isAntiAlias,
      ];
    });
    table['setIsAntiAlias'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedRenderImage extends _3e84.RenderImage
  ...
  RTManagedRenderImage(
    ...
    table['_dart_setWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.width =
    ...
    table['_dart_setHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.height =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getScale'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.scale];
    });
    table['_dart_setScale'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.scale =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_setOpacity'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getFilterQuality'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.filterQuality];
    });
    table['_dart_setFilterQuality'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getColorBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.colorBlendMode];
    });
    table['_dart_setColorBlendMode'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.colorBlendMode = (_36c2.maybeUnBoxEnum(
          values: _a643.BlendMode.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['_dart_getFit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.fit];
    });
    table['_dart_setFit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.fit = (_36c2.maybeUnBoxEnum(
          values: _fb77.BoxFit.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['_dart_getAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.alignment];
    });
    table['_dart_setAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.alignment = (_36c2.maybeUnBoxAndBuildArgument<
          _ca85.AlignmentGeometry,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    table['_dart_getRepeat'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.repeat];
    });
    table['_dart_setRepeat'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.repeat = (_36c2.maybeUnBoxEnum(
          values: _48c4.ImageRepeat.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['_dart_getCenterSlice'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.centerSlice];
    });
    table['_dart_setCenterSlice'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.centerSlice =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getInvertColors'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.invertColors];
    });
    table['_dart_setInvertColors'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.invertColors =
    ...
    table['_dart_getMatchTextDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.matchTextDirection];
    });
    table['_dart_setMatchTextDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getIsAntiAlias'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.isAntiAlias];
    });
    table['_dart_setIsAntiAlias'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.isAntiAlias =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _a643.Image? get image {
    _36c2.Closure closure = table["getImage"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.Image?, _fac9.dynamic>(
  ...
  @_fac9.override
  _86ca.Animation<_fac9.double>? get opacity {
  ...
  @_fac9.override
  _a643.FilterQuality get filterQuality {
  ...
  @_fac9.override
  _a643.BlendMode? get colorBlendMode {
  ...
  @_fac9.override
  _fb77.BoxFit? get fit {
    _36c2.Closure closure = table["getFit"];
    return _36c2.maybeUnBoxEnum(
        values: _fb77.BoxFit.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }
  ...
  @_fac9.override
  _ca85.AlignmentGeometry get alignment {
  ...
  @_fac9.override
  _48c4.ImageRepeat get repeat {
    _36c2.Closure closure = table["getRepeat"];
    return _36c2.maybeUnBoxEnum(
        values: _48c4.ImageRepeat.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }
  ...
  @_fac9.override
  _fac9.bool get matchTextDirection {
...
void loadRenderImage(
  ...
  table['renderImage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderImage(
  ...
  _36c2.registerBoxer<_3e84.RenderImage>(boxer: (
      {required _3e84.RenderImage vmObject,

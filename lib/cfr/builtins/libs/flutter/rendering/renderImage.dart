...
class VMManagedRenderImage extends _36c2.VMManagedBox<_3e84.RenderImage> {VMManagedRenderImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'debugImageLabel'
] = vmObject.debugImageLabel;
table  [
'parentData'
...
table  [
'getImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.image;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Image?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.image=(_36c2.maybeUnBoxAndBuildArgument<_a643.Image?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.width;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.width=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.height;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.height=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getScale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.scale,]; } );
table  [
'setScale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.scale=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.color;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Color?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.color=(_36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.opacity;if(returnValue!= null){return [_36c2.maybeBoxObject<_86ca.Animation?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.opacity=(_36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_fac9.double>?, _fac9.double>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getFilterQuality'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_a643.FilterQuality.values.indexWhere((x) { return x == vmObject.filterQuality; } ),]; } );
table  [
'setFilterQuality'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.filterQuality=(_36c2.maybeUnBoxEnum(values: _a643.FilterQuality.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getColorBlendMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.colorBlendMode;if(returnValue!= null){return [_a643.BlendMode.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'setColorBlendMode'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.colorBlendMode=(_36c2.maybeUnBoxEnum(values: _a643.BlendMode.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getFit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.fit;if(returnValue!= null){return [_fb77.BoxFit.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'setFit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.fit=(_36c2.maybeUnBoxEnum(values: _fb77.BoxFit.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_ca85.AlignmentGeometry>(object: vmObject.alignment, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setAlignment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.alignment=(_36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getRepeat'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_48c4.ImageRepeat.values.indexWhere((x) { return x == vmObject.repeat; } ),]; } );
table  [
'setRepeat'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.repeat=(_36c2.maybeUnBoxEnum(values: _48c4.ImageRepeat.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getCenterSlice'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.centerSlice;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Rect?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setCenterSlice'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.centerSlice=(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getInvertColors'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.invertColors,]; } );
table  [
'setInvertColors'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.invertColors=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getMatchTextDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.matchTextDirection,]; } );
table  [
'setMatchTextDirection'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.matchTextDirection=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'getIsAntiAlias'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isAntiAlias,]; } );
table  [
'setIsAntiAlias'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.isAntiAlias=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _3e84.RenderImage vmObject;

 }

class RTManagedRenderImage extends _3e84.RenderImage implements _36c2.Box<_3e84.RenderImage> {RTManagedRenderImage({required _ca85.AlignmentGeometry alignment, _a643.Rect? centerSlice, _a643.Color? color, _a643.BlendMode? colorBlendMode, _fac9.String? debugImageLabel, required _a643.FilterQuality filterQuality, _fb77.BoxFit? fit, _fac9.double? height, _a643.Image? image, required _fac9.bool invertColors, required _fac9.bool isAntiAlias, required _fac9.bool matchTextDirection, _86ca.Animation<_fac9.double>? opacity, required _48c4.ImageRepeat repeat, required _fac9.double scale, _a643.TextDirection? textDirection, _fac9.double? width, required this.table, required this.hydroState}) : super(alignment: alignment,centerSlice: centerSlice,color: color,colorBlendMode: colorBlendMode,debugImageLabel: debugImageLabel,filterQuality: filterQuality,fit: fit,height: height,image: image,invertColors: invertColors,isAntiAlias: isAntiAlias,matchTextDirection: matchTextDirection,opacity: opacity,repeat: repeat,scale: scale,textDirection: textDirection,width: width) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'debugImageLabel'
] = _36c2.maybeBoxObject(object: this.debugImageLabel, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table['_dart_setImage'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.image = (_36c2.maybeUnBoxAndBuildArgument<_a643.Image?, _fac9.dynamic>(
...
table['_dart_setWidth'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.width = (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
table['_dart_setScale'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.scale = (_36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
table['_dart_setColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.color = (_36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
table['_dart_setOpacity'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.opacity = (_36c2.maybeUnBoxAndBuildArgument<
...
table['_dart_setFilterQuality'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.filterQuality = (_36c2.maybeUnBoxEnum(
      values: _a643.FilterQuality.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
table['_dart_setColorBlendMode'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.colorBlendMode = (_36c2.maybeUnBoxEnum(
      values: _a643.BlendMode.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getFit'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_setFit'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.fit = (_36c2.maybeUnBoxEnum(
      values: _fb77.BoxFit.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
table['_dart_setRepeat'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.repeat = (_36c2.maybeUnBoxEnum(
      values: _48c4.ImageRepeat.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
_3e84.RenderImage unwrap() => this;
_3e84.RenderImage get vmObject => this;
@_fac9.override _a643.Image? get image { 
_36c2.Closure closure = table["getImage"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Image?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set image(value) { 
_36c2.Closure closure = table["setImage"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double? get width { 
_36c2.Closure closure = table["getWidth"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set width(value) { 
_36c2.Closure closure = table["setWidth"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double? get height { 
_36c2.Closure closure = table["getHeight"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set height(value) { 
_36c2.Closure closure = table["setHeight"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double get scale { 
_36c2.Closure closure = table["getScale"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set scale(value) { 
_36c2.Closure closure = table["setScale"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Color? get color { 
...
@_fac9.override void set color(value) { 
_36c2.Closure closure = table["setColor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _86ca.Animation<_fac9.double>? get opacity { 
...
@_fac9.override void set opacity(value) { 
_36c2.Closure closure = table["setOpacity"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.FilterQuality get filterQuality { 
_36c2.Closure closure = table["getFilterQuality"];
return _36c2.maybeUnBoxEnum(values: _a643.FilterQuality.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set filterQuality(value) { 
_36c2.Closure closure = table["setFilterQuality"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.BlendMode? get colorBlendMode { 
_36c2.Closure closure = table["getColorBlendMode"];
return _36c2.maybeUnBoxEnum(values: _a643.BlendMode.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set colorBlendMode(value) { 
_36c2.Closure closure = table["setColorBlendMode"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fb77.BoxFit? get fit { 
_36c2.Closure closure = table["getFit"];
return _36c2.maybeUnBoxEnum(values: _fb77.BoxFit.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set fit(value) { 
_36c2.Closure closure = table["setFit"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _ca85.AlignmentGeometry get alignment { 
_36c2.Closure closure = table["getAlignment"];
...
@_fac9.override void set alignment(value) { 
_36c2.Closure closure = table["setAlignment"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _48c4.ImageRepeat get repeat { 
_36c2.Closure closure = table["getRepeat"];
return _36c2.maybeUnBoxEnum(values: _48c4.ImageRepeat.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set repeat(value) { 
_36c2.Closure closure = table["setRepeat"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Rect? get centerSlice { 
_36c2.Closure closure = table["getCenterSlice"];
...
@_fac9.override void set centerSlice(value) { 
_36c2.Closure closure = table["setCenterSlice"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get invertColors { 
_36c2.Closure closure = table["getInvertColors"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set invertColors(value) { 
_36c2.Closure closure = table["setInvertColors"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get matchTextDirection { 
_36c2.Closure closure = table["getMatchTextDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set matchTextDirection(value) { 
_36c2.Closure closure = table["setMatchTextDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isAntiAlias { 
_36c2.Closure closure = table["getIsAntiAlias"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set isAntiAlias(value) { 
_36c2.Closure closure = table["setIsAntiAlias"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderImage(table: luaCallerArguments  [
0
...
'colorBlendMode'
] : null), debugImageLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugImageLabel'
...
'image'
] : null, parentState: hydroState), invertColors: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'invertColors'
] : null, isAntiAlias: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'isAntiAlias'
] : null, matchTextDirection: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'matchTextDirection'
...
_36c2.registerBoxer<_3e84.RenderImage>(boxer: ({required _3e84.RenderImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

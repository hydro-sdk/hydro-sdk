...
class VMManagedRenderErrorBox extends VMManagedBox<RenderErrorBox> {
  ...
  final RenderErrorBox vmObject;
}

class RTManagedRenderErrorBox extends RenderErrorBox
    implements Box<RenderErrorBox> {
  RTManagedRenderErrorBox(String message$,
  ...
  RenderErrorBox unwrap() => this;
  RenderErrorBox get vmObject => this;
  @override
...
void loadRenderErrorBox(
  ...
  registerBoxer<RenderErrorBox>(boxer: (
      {required RenderErrorBox vmObject,

...
class VMManagedRenderErrorBox extends _36c2.VMManagedBox<_5ed1.RenderErrorBox> {
  VMManagedRenderErrorBox(
...
class RTManagedRenderErrorBox extends _5ed1.RenderErrorBox
    implements _36c2.Box<_5ed1.RenderErrorBox> {
  RTManagedRenderErrorBox(_fac9.String message$,
    ...
    table['message'] = _36c2.maybeBoxObject(
        object: message, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadRenderErrorBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderErrorBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderErrorBox(luaCallerArguments[1],
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_5ed1.RenderErrorBox>(boxer: (
      {required _5ed1.RenderErrorBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderErrorBox(

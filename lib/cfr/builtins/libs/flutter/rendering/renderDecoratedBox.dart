...
class VMManagedRenderDecoratedBox
    extends _36c2.VMManagedBox<_bf98.RenderDecoratedBox> {
  VMManagedRenderDecoratedBox(
    ...
    table['getPosition'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _bf98.DecorationPosition.values.indexWhere((x) {
    ...
    table['setPosition'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.position = (_36c2.maybeUnBoxEnum(
...
class RTManagedRenderDecoratedBox extends _bf98.RenderDecoratedBox
    implements _36c2.Box<_bf98.RenderDecoratedBox> {
  RTManagedRenderDecoratedBox(
      ...
      required _13a5.Decoration decoration,
      required this.table,
  ...
  @_fac9.override
  _bf98.DecorationPosition get position {
...
void loadRenderDecoratedBox(
  ...
  table['renderDecoratedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderDecoratedBox(
  ...
  _36c2.registerBoxer<_bf98.RenderDecoratedBox>(boxer: (
      {required _bf98.RenderDecoratedBox vmObject,

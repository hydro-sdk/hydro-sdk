...
class VMManagedRenderDecoratedBox extends _36c2.VMManagedBox<_bf98.RenderDecoratedBox> {VMManagedRenderDecoratedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDecoration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_13a5.Decoration>(object: vmObject.decoration, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setDecoration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.decoration=(_36c2.maybeUnBoxAndBuildArgument<_13a5.Decoration, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_bf98.DecorationPosition.values.indexWhere((x) { return x == vmObject.position; } ),]; } );
table  [
'setPosition'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.position=(_36c2.maybeUnBoxEnum(values: _bf98.DecorationPosition.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
final _bf98.RenderDecoratedBox vmObject;

 }

class RTManagedRenderDecoratedBox extends _bf98.RenderDecoratedBox implements _36c2.Box<_bf98.RenderDecoratedBox> {RTManagedRenderDecoratedBox({_be2e.RenderBox? child, required _61fa.ImageConfiguration configuration, required _bf98.DecorationPosition position, required _13a5.Decoration decoration, required this.table, required this.hydroState}) : super(child: child,configuration: configuration,position: position,decoration: decoration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getDecoration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.decoration];
});
table['_dart_setDecoration'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.decoration =
...
table['_dart_setPosition'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.position = (_36c2.maybeUnBoxEnum(
      values: _bf98.DecorationPosition.values,
...
_bf98.RenderDecoratedBox unwrap() => this;
_bf98.RenderDecoratedBox get vmObject => this;
@_fac9.override _13a5.Decoration get decoration { 
_36c2.Closure closure = table["getDecoration"];
return _36c2.maybeUnBoxAndBuildArgument<_13a5.Decoration, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set decoration(value) { 
_36c2.Closure closure = table["setDecoration"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _bf98.DecorationPosition get position { 
_36c2.Closure closure = table["getPosition"];
return _36c2.maybeUnBoxEnum(values: _bf98.DecorationPosition.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set position(value) { 
...
void loadRenderDecoratedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderDecoratedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderDecoratedBox(table: luaCallerArguments  [
0
...
'configuration'
] : null, parentState: hydroState), position: _36c2.maybeUnBoxEnum(values: _bf98.DecorationPosition.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'position'
] : null), decoration: _36c2.maybeUnBoxAndBuildArgument<_13a5.Decoration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decoration'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderDecoratedBox>(boxer: ({required _bf98.RenderDecoratedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderDecoratedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderDecoratedBox extends VMManagedBox<RenderDecoratedBox> {
  VMManagedRenderDecoratedBox(
    ...
    table['setDecoration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.decoration = (maybeUnBoxAndBuildArgument<Decoration, dynamic>(
    ...
    table['getPosition'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        DecorationPosition.values.indexWhere((x) {
          return x == vmObject.position;
        }),
      ];
    });
    table['setPosition'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.position = (maybeUnBoxEnum(
          values: DecorationPosition.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  final RenderDecoratedBox vmObject;
}

class RTManagedRenderDecoratedBox extends RenderDecoratedBox
    implements Box<RenderDecoratedBox> {
  RTManagedRenderDecoratedBox(
      {RenderBox? child,
    ...
    table['_dart_setDecoration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.decoration = (maybeUnBoxAndBuildArgument<Decoration, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderDecoratedBox unwrap() => this;
  RenderDecoratedBox get vmObject => this;
  @override
  Decoration get decoration {
    Closure closure = table["getDecoration"];
    return maybeUnBoxAndBuildArgument<Decoration, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set decoration(Decoration value) {
    Closure closure = table["setDecoration"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  DecorationPosition get position {
    Closure closure = table["getPosition"];
  ...
  @override
  void set position(DecorationPosition value) {
    Closure closure = table["setPosition"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderDecoratedBox(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderDecoratedBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderDecoratedBox(
          ...
          configuration:
              maybeUnBoxAndBuildArgument<ImageConfiguration, dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          position: maybeUnBoxEnum(
              values: DecorationPosition.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['position']
                  : null),
          decoration: maybeUnBoxAndBuildArgument<Decoration, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderDecoratedBox>(boxer: (
      {required RenderDecoratedBox vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderDecoratedBox(

...
class VMManagedRenderTable extends VMManagedBox<RenderTable> {
  VMManagedRenderTable(
    ...
    table['setColumnWidths'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.columnWidths =
          (maybeUnBoxAndBuildArgument<Map<int, TableColumnWidth>?, int>(
    ...
    table['getDefaultColumnWidth'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<TableColumnWidth>(
    ...
    table['setBorder'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.border = (maybeUnBoxAndBuildArgument<TableBorder?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['getRowDecorations'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<List<dynamic>>(
            object: vmObject.rowDecorations
                .map((x) => maybeBoxObject<Decoration>(
    ...
    table['setRowDecorations'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.rowDecorations =
          (maybeUnBoxAndBuildArgument<List<Decoration?>?, Decoration?>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    table['getConfiguration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<ImageConfiguration>(
            object: vmObject.configuration,
            hydroState: hydroState,
            table: HydroTable()),
      ];
    });
    table['setConfiguration'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.configuration =
          (maybeUnBoxAndBuildArgument<ImageConfiguration, dynamic>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    table['getDefaultVerticalAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
    ...
    table['setDefaultVerticalAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.defaultVerticalAlignment = (maybeUnBoxEnum(
          values: TableCellVerticalAlignment.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getTextBaseline'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      final returnValue = vmObject.textBaseline;
      if (returnValue != null) {
        return [
          TextBaseline.values.indexWhere((x) {
    ...
    table['setTextBaseline'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.textBaseline = (maybeUnBoxEnum(
    ...
    table['setFlatChildren'] =
      ...
      vmObject.setFlatChildren(
          luaCallerArguments[1],
          maybeUnBoxAndBuildArgument<List<RenderBox?>, RenderBox?>(
              luaCallerArguments[2],
              parentState: hydroState));
      return [];
    });
    table['setChildren'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.setChildren(
          maybeUnBoxAndBuildArgument<List<List<RenderBox>>?, List<RenderBox>>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
    table['addRow'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.addRow(maybeUnBoxAndBuildArgument<List<RenderBox?>, RenderBox?>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['setChild'] =
      ...
      vmObject.setChild(
          luaCallerArguments[1],
          luaCallerArguments[2],
          maybeUnBoxAndBuildArgument<RenderBox?, dynamic>(luaCallerArguments[3],
              parentState: hydroState));
      return [];
    });
    ...
    table['column'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
    ...
    table['row'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<Iterable>(
  ...
  final RenderTable vmObject;
}

class RTManagedRenderTable extends RenderTable implements Box<RenderTable> {
  RTManagedRenderTable(
    ...
    table['_dart_setColumns'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.columns = (luaCallerArguments[1]);
      return [];
    });
    table['_dart_getRows'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['_dart_setRows'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.rows = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setBorder'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.border = (maybeUnBoxAndBuildArgument<TableBorder?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setDefaultVerticalAlignment'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.defaultVerticalAlignment = (maybeUnBoxEnum(
          values: TableCellVerticalAlignment.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_setTextBaseline'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.textBaseline = (maybeUnBoxEnum(
          values: TextBaseline.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['_dart_addRow'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.addRow(maybeUnBoxAndBuildArgument<List<RenderBox?>, RenderBox?>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_column'] =
      ...
      return [
        maybeBoxObject<Iterable>(
            object: super.column(luaCallerArguments[1]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    table['_dart_row'] =
      ...
      return [
        maybeBoxObject<Iterable>(
            object: super.row(luaCallerArguments[1]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    table['_dart_getRowBox'] =
      ...
      return [
        maybeBoxObject<Rect>(
            object: super.getRowBox(luaCallerArguments[1]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
  ...
  RenderTable unwrap() => this;
  RenderTable get vmObject => this;
  @override
  int get columns {
    Closure closure = table["getColumns"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set columns(value) {
    Closure closure = table["setColumns"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  int get rows {
    Closure closure = table["getRows"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set rows(value) {
    Closure closure = table["setRows"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  Map<int, TableColumnWidth>? get columnWidths {
    Closure closure = table["getColumnWidths"];
    return maybeUnBoxAndBuildArgument<Map<int, TableColumnWidth>?, int>(
  ...
  void set columnWidths(value) {
    Closure closure = table["setColumnWidths"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void setColumnWidth(column, value) {
    Closure closure = table["setColumnWidth"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  TableColumnWidth get defaultColumnWidth {
    Closure closure = table["getDefaultColumnWidth"];
    return maybeUnBoxAndBuildArgument<TableColumnWidth, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void set defaultColumnWidth(value) {
    Closure closure = table["setDefaultColumnWidth"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  TableBorder? get border {
    Closure closure = table["getBorder"];
  ...
  void set border(value) {
    Closure closure = table["setBorder"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  List<Decoration> get rowDecorations {
    Closure closure = table["getRowDecorations"];
    return maybeUnBoxAndBuildArgument<List<Decoration>, Decoration>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void set rowDecorations(value) {
    Closure closure = table["setRowDecorations"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  ImageConfiguration get configuration {
    Closure closure = table["getConfiguration"];
    return maybeUnBoxAndBuildArgument<ImageConfiguration, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void set configuration(value) {
    Closure closure = table["setConfiguration"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  TableCellVerticalAlignment get defaultVerticalAlignment {
    Closure closure = table["getDefaultVerticalAlignment"];
    return maybeUnBoxEnum(
        values: TableCellVerticalAlignment.values,
        boxedEnum: closure.dispatch([table], parentState: hydroState)[0]);
  }
  ...
  void set defaultVerticalAlignment(value) {
    Closure closure = table["setDefaultVerticalAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  TextBaseline? get textBaseline {
    Closure closure = table["getTextBaseline"];
    return maybeUnBoxEnum(
  ...
  void set textBaseline(value) {
    Closure closure = table["setTextBaseline"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  void setFlatChildren(columns, cells) {
    Closure closure = table["setFlatChildren"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void setChildren(cells) {
    Closure closure = table["setChildren"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void addRow(cells) {
    Closure closure = table["addRow"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  Iterable<RenderBox> column(x) {
    Closure closure = table["column"];
    return maybeUnBoxAndBuildArgument<Iterable<RenderBox>, RenderBox>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  Iterable<RenderBox> row(y) {
    Closure closure = table["row"];
    return maybeUnBoxAndBuildArgument<Iterable<RenderBox>, RenderBox>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  Rect getRowBox(row) {
    Closure closure = table["getRowBox"];
...
void loadRenderTable(
  ...
  table['renderTable'] =
    ...
    return [
      RTManagedRenderTable(
          ...
          hydroState: hydroState,
          border: maybeUnBoxAndBuildArgument<TableBorder?, dynamic>(
              luaCallerArguments.length >= 2
          ...
          children:
              maybeUnBoxAndBuildArgument<List<List<RenderBox>>?, List<RenderBox>>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          columnWidths: maybeUnBoxAndBuildArgument<Map<int, TableColumnWidth>?, int>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['columnWidths']
                  : null,
              parentState: hydroState),
          columns: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['columns'] : null,
          configuration: maybeUnBoxAndBuildArgument<ImageConfiguration, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['configuration'] : null, parentState: hydroState),
          defaultColumnWidth: maybeUnBoxAndBuildArgument<TableColumnWidth, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultColumnWidth'] : null, parentState: hydroState),
          defaultVerticalAlignment: maybeUnBoxEnum(values: TableCellVerticalAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultVerticalAlignment'] : null),
          rowDecorations: maybeUnBoxAndBuildArgument<List<Decoration?>?, Decoration?>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['rowDecorations'] : null, parentState: hydroState),
  ...
  registerBoxer<RenderTable>(boxer: (
      {required RenderTable vmObject,

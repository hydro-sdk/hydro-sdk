...
class VMManagedRenderTable extends _36c2.VMManagedBox<_31d2.RenderTable> {
  VMManagedRenderTable(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getColumns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.columns,
      ];
    });
    table['setColumns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.columns = (luaCallerArguments[1]);
      return [];
    });
    table['getRows'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.rows,
      ];
    });
    table['setRows'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rows = (luaCallerArguments[1]);
      return [];
    });
    table['getColumnWidths'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.columnWidths;
      if (returnValue != null) {
        return [
    ...
    table['setColumnWidths'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.columnWidths = (_36c2.maybeUnBoxAndBuildArgument<
          _fac9.Map<_fac9.int, _31d2.TableColumnWidth>?,
          _fac9.int>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    table['setColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.setColumnWidth(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth,
              _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState));
      return [];
    });
    table['getDefaultColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_31d2.TableColumnWidth>(
            object: vmObject.defaultColumnWidth,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setDefaultColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.defaultColumnWidth = (_36c2.maybeUnBoxAndBuildArgument<
          _31d2.TableColumnWidth,
    ...
    table['getBorder'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.border;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_2738.TableBorder?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setBorder'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.border =
    ...
    table['getRowDecorations'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(
            object: vmObject.rowDecorations
                .map((x) => _36c2.maybeBoxObject<_13a5.Decoration>(
                    object: x,
                    hydroState: hydroState,
                    table: _36c2.HydroTable()))
                .toList(),
    ...
    table['setRowDecorations'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.rowDecorations = (_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['getDefaultVerticalAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _31d2.TableCellVerticalAlignment.values.indexWhere((x) {
          return x == vmObject.defaultVerticalAlignment;
        }),
      ];
    });
    table['setDefaultVerticalAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.defaultVerticalAlignment = (_36c2.maybeUnBoxEnum(
          values: _31d2.TableCellVerticalAlignment.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getTextBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.textBaseline;
      if (returnValue != null) {
        return [
          _a643.TextBaseline.values.indexWhere((x) {
    ...
    table['setTextBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.textBaseline = (_36c2.maybeUnBoxEnum(
    ...
    table['setFlatChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.setFlatChildren(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox?>,
                  _be2e.RenderBox?>(luaCallerArguments[2],
              parentState: hydroState));
      return [];
    });
    table['setChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.setChildren(_36c2.maybeUnBoxAndBuildArgument<
              _fac9.List<_fac9.List<_be2e.RenderBox>>?,
              _fac9.List<_be2e.RenderBox>>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['addRow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.addRow(_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['column'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_fac9.Iterable>(
            object: vmObject.column(luaCallerArguments[1]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['row'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_fac9.Iterable>(
            object: vmObject.row(luaCallerArguments[1]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['getRowBox'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Rect>(
            object: vmObject.getRowBox(luaCallerArguments[1]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
...
class RTManagedRenderTable extends _31d2.RenderTable
    implements _36c2.Box<_31d2.RenderTable> {
  RTManagedRenderTable(
      {_2738.TableBorder? border,
      _fac9.List<_fac9.List<_be2e.RenderBox>>? children,
      _fac9.Map<_fac9.int, _31d2.TableColumnWidth>? columnWidths,
      _fac9.int? columns,
      required _61fa.ImageConfiguration configuration,
      required _31d2.TableColumnWidth defaultColumnWidth,
      required _31d2.TableCellVerticalAlignment defaultVerticalAlignment,
      _fac9.List<_13a5.Decoration?>? rowDecorations,
      _fac9.int? rows,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getColumns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.columns];
    });
    table['_dart_setColumns'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.columns =
    ...
    table['_dart_getRows'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.rows];
    });
    table['_dart_setRows'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getColumnWidths'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.columnWidths];
    });
    table['_dart_setColumnWidths'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getDefaultColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.defaultColumnWidth];
    });
    table['_dart_setDefaultColumnWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.defaultColumnWidth = (_36c2.maybeUnBoxAndBuildArgument<
          _31d2.TableColumnWidth,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_getBorder'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.border];
    });
    table['_dart_setBorder'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.border =
          (_36c2.maybeUnBoxAndBuildArgument<_2738.TableBorder?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getRowDecorations'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.rowDecorations];
    });
    table['_dart_setRowDecorations'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getDefaultVerticalAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.defaultVerticalAlignment];
    });
    table['_dart_setDefaultVerticalAlignment'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getTextBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.textBaseline];
    });
    table['_dart_setTextBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setFlatChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setChildren'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_addRow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.addRow(_36c2.maybeUnBoxAndBuildArgument<
          _fac9.List<_be2e.RenderBox?>,
          _be2e.RenderBox?>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_column'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.column(
    ...
    table['_dart_row'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.row(
    ...
    table['_dart_getRowBox'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _fac9.Map<_fac9.int, _31d2.TableColumnWidth>? get columnWidths {
    _36c2.Closure closure = table["getColumnWidths"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _fac9.Map<_fac9.int, _31d2.TableColumnWidth>?,
            _fac9.int>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  void set columnWidths(value) {
  ...
  @_fac9.override
  _31d2.TableColumnWidth get defaultColumnWidth {
    _36c2.Closure closure = table["getDefaultColumnWidth"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  void set defaultColumnWidth(value) {
  ...
  @_fac9.override
  _2738.TableBorder? get border {
    _36c2.Closure closure = table["getBorder"];
    return _36c2.maybeUnBoxAndBuildArgument<_2738.TableBorder?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _fac9.List<_13a5.Decoration> get rowDecorations {
    _36c2.Closure closure = table["getRowDecorations"];
    return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_13a5.Decoration>,
            _13a5.Decoration>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _31d2.TableCellVerticalAlignment get defaultVerticalAlignment {
  ...
  @_fac9.override
  void set defaultVerticalAlignment(value) {
    _36c2.Closure closure = table["setDefaultVerticalAlignment"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _a643.TextBaseline? get textBaseline {
  ...
  @_fac9.override
  void setFlatChildren(columns, cells) {
    _36c2.Closure closure = table["setFlatChildren"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void setChildren(cells) {
  ...
  @_fac9.override
  _fac9.Iterable<_be2e.RenderBox> column(x) {
    _36c2.Closure closure = table["column"];
    return _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_be2e.RenderBox>,
            _be2e.RenderBox>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _fac9.Iterable<_be2e.RenderBox> row(y) {
...
void loadRenderTable(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderTable'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderTable(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          border: _36c2.maybeUnBoxAndBuildArgument<_2738.TableBorder?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['border']
                  : null,
              parentState: hydroState),
          children: _36c2.maybeUnBoxAndBuildArgument<
                  _fac9.List<_fac9.List<_be2e.RenderBox>>?,
                  _fac9.List<_be2e.RenderBox>>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
              parentState: hydroState),
          columnWidths:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.int, _31d2.TableColumnWidth>?, _fac9.int>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['columnWidths'] : null,
                  parentState: hydroState),
          columns: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['columns'] : null,
          configuration: _36c2.maybeUnBoxAndBuildArgument<_61fa.ImageConfiguration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['configuration'] : null, parentState: hydroState),
          defaultColumnWidth: _36c2.maybeUnBoxAndBuildArgument<_31d2.TableColumnWidth, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultColumnWidth'] : null, parentState: hydroState),
          defaultVerticalAlignment: _36c2.maybeUnBoxEnum(values: _31d2.TableCellVerticalAlignment.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['defaultVerticalAlignment'] : null),
          rowDecorations: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_13a5.Decoration?>?, _13a5.Decoration?>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['rowDecorations'] : null, parentState: hydroState),
          rows: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['rows'] : null,
  ...
  _36c2.registerBoxer<_31d2.RenderTable>(boxer: (
      {required _31d2.RenderTable vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderTable(

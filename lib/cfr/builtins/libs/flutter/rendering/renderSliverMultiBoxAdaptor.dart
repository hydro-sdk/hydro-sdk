...
class VMManagedRenderSliverMultiBoxAdaptor extends _36c2.VMManagedBox<_35be.RenderSliverMultiBoxAdaptor> {VMManagedRenderSliverMultiBoxAdaptor({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _35be.RenderSliverMultiBoxAdaptor vmObject;

 }

class RTManagedRenderSliverMultiBoxAdaptor extends _35be.RenderSliverMultiBoxAdaptor implements _36c2.Box<_35be.RenderSliverMultiBoxAdaptor> {RTManagedRenderSliverMultiBoxAdaptor({required _35be.RenderSliverBoxChildManager childManager, required this.table, required this.hydroState}) : super(childManager: childManager) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_35be.RenderSliverMultiBoxAdaptor unwrap() => this;
_35be.RenderSliverMultiBoxAdaptor get vmObject => this;
...
void loadRenderSliverMultiBoxAdaptor({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverMultiBoxAdaptor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverMultiBoxAdaptor(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_35be.RenderSliverMultiBoxAdaptor>(boxer: ({required _35be.RenderSliverMultiBoxAdaptor vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverMultiBoxAdaptor(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

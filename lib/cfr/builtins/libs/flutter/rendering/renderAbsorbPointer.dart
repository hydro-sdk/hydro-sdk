...
class VMManagedRenderAbsorbPointer extends VMManagedBox<RenderAbsorbPointer> {
  ...
  final RenderAbsorbPointer vmObject;
}

class RTManagedRenderAbsorbPointer extends RenderAbsorbPointer
    implements Box<RenderAbsorbPointer> {
  RTManagedRenderAbsorbPointer(
    ...
    table['_dart_setAbsorbing'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.absorbing = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderAbsorbPointer unwrap() => this;
  RenderAbsorbPointer get vmObject => this;
  @override
  bool get absorbing {
    Closure closure = table["getAbsorbing"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set absorbing(bool value) {
    Closure closure = table["setAbsorbing"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderAbsorbPointer(
  ...
  registerBoxer<RenderAbsorbPointer>(boxer: (
      {required RenderAbsorbPointer vmObject,

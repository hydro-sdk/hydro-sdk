...
class VMManagedRenderAbsorbPointer
    extends _36c2.VMManagedBox<_bf98.RenderAbsorbPointer> {
  VMManagedRenderAbsorbPointer(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getAbsorbing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.absorbing,
      ];
    });
    table['setAbsorbing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.absorbing = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderAbsorbPointer extends _bf98.RenderAbsorbPointer
    implements _36c2.Box<_bf98.RenderAbsorbPointer> {
  RTManagedRenderAbsorbPointer(
      {required _fac9.bool absorbing,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getAbsorbing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.absorbing];
    });
    table['_dart_setAbsorbing'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.absorbing =
...
void loadRenderAbsorbPointer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAbsorbPointer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAbsorbPointer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          absorbing: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['absorbing']
              : null,
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_bf98.RenderAbsorbPointer>(boxer: (
      {required _bf98.RenderAbsorbPointer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAbsorbPointer(

...
class VMManagedRenderAbsorbPointer extends _36c2.VMManagedBox<_bf98.RenderAbsorbPointer> {VMManagedRenderAbsorbPointer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getAbsorbing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.absorbing,]; } );
table  [
'setAbsorbing'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.absorbing=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _bf98.RenderAbsorbPointer vmObject;

 }

class RTManagedRenderAbsorbPointer extends _bf98.RenderAbsorbPointer implements _36c2.Box<_bf98.RenderAbsorbPointer> {RTManagedRenderAbsorbPointer({required _fac9.bool absorbing, _be2e.RenderBox? child, _fac9.bool? ignoringSemantics, required this.table, required this.hydroState}) : super(absorbing: absorbing,child: child,ignoringSemantics: ignoringSemantics) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getAbsorbing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.absorbing];
});
table['_dart_setAbsorbing'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.absorbing =
...
_bf98.RenderAbsorbPointer unwrap() => this;
_bf98.RenderAbsorbPointer get vmObject => this;
@_fac9.override _fac9.bool get absorbing { 
_36c2.Closure closure = table["getAbsorbing"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set absorbing(value) { 
_36c2.Closure closure = table["setAbsorbing"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderAbsorbPointer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAbsorbPointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderAbsorbPointer(table: luaCallerArguments  [
0
], hydroState: hydroState, absorbing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'absorbing'
...
'child'
] : null, parentState: hydroState), ignoringSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ignoringSemantics'
] : null)]; } );
_36c2.registerBoxer<_bf98.RenderAbsorbPointer>(boxer: ({required _bf98.RenderAbsorbPointer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAbsorbPointer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

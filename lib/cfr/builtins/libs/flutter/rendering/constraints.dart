...
class VMManagedConstraints extends _36c2.VMManagedBox<_9742.Constraints> {VMManagedConstraints({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedConstraints extends _9742.Constraints implements _36c2.Box<_9742.Constraints> {RTManagedConstraints({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadConstraints({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'constraints'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedConstraints(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_9742.Constraints>(boxer: ({required _9742.Constraints vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedConstraints(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedLeaderLayer extends VMManagedBox<LeaderLayer> {
  ...
  final LeaderLayer vmObject;
}

class RTManagedLeaderLayer extends LeaderLayer implements Box<LeaderLayer> {
  ...
  LeaderLayer unwrap() => this;
  LeaderLayer get vmObject => this;
  @override
  LayerLink get link {
...
void loadLeaderLayer(
  ...
  registerBoxer<LeaderLayer>(boxer: (
      {required LeaderLayer vmObject,

...
class VMManagedLeaderLayer extends _36c2.VMManagedBox<_7d70.LeaderLayer> {VMManagedLeaderLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLeaderLayer extends _7d70.LeaderLayer implements _36c2.Box<_7d70.LeaderLayer> {RTManagedLeaderLayer({required _a643.Offset offset, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(offset: offset,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLeaderLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'leaderLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedLeaderLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.LeaderLayer>(boxer: ({required _7d70.LeaderLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLeaderLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

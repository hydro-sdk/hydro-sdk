...
class VMManagedFixedColumnWidth extends _36c2.VMManagedBox<_31d2.FixedColumnWidth> {VMManagedFixedColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedFixedColumnWidth extends _31d2.FixedColumnWidth implements _36c2.Box<_31d2.FixedColumnWidth> {RTManagedFixedColumnWidth(_fac9.double value$, {required this.table, required this.hydroState}) : super(value$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadFixedColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fixedColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFixedColumnWidth(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_31d2.FixedColumnWidth>(boxer: ({required _31d2.FixedColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFixedColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

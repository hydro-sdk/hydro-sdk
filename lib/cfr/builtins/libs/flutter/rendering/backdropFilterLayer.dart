...
class VMManagedBackdropFilterLayer
    extends _36c2.VMManagedBox<_7d70.BackdropFilterLayer> {
  VMManagedBackdropFilterLayer(
    ...
    table['getFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.filter;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_a643.ImageFilter?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.filter =
...
class RTManagedBackdropFilterLayer extends _7d70.BackdropFilterLayer
  ...
  RTManagedBackdropFilterLayer(
      {required _a643.BlendMode blendMode,
      _a643.ImageFilter? filter,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.filter];
    });
    table['_dart_setFilter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.filter =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  @_fac9.override
  _a643.ImageFilter? get filter {
    _36c2.Closure closure = table["getFilter"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(
...
void loadBackdropFilterLayer(
  ...
  table['backdropFilterLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBackdropFilterLayer(
          ...
          blendMode: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          filter: _36c2
              .maybeUnBoxAndBuildArgument<_a643.ImageFilter?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_7d70.BackdropFilterLayer>(boxer: (
      {required _7d70.BackdropFilterLayer vmObject,

...
class VMManagedBackdropFilterLayer extends _36c2.VMManagedBox<_7d70.BackdropFilterLayer> {VMManagedBackdropFilterLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getFilter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.filter;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.ImageFilter?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setFilter'
...
final _7d70.BackdropFilterLayer vmObject;

 }

class RTManagedBackdropFilterLayer extends _7d70.BackdropFilterLayer implements _36c2.Box<_7d70.BackdropFilterLayer> {RTManagedBackdropFilterLayer({required _a643.BlendMode blendMode, _a643.ImageFilter? filter, required this.table, required this.hydroState}) : super(blendMode: blendMode,filter: filter) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadBackdropFilterLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'backdropFilterLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedBackdropFilterLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.BackdropFilterLayer>(boxer: ({required _7d70.BackdropFilterLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBackdropFilterLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

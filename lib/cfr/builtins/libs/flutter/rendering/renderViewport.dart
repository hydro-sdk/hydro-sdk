...
class VMManagedRenderViewport extends VMManagedBox<RenderViewport> {
  VMManagedRenderViewport(
    ...
    table['setCenter'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.center = (maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  final RenderViewport vmObject;
}

class RTManagedRenderViewport extends RenderViewport
    implements Box<RenderViewport> {
  RTManagedRenderViewport(
    ...
    table['_dart_setAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.anchor = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setCenter'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.center = (maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderViewport unwrap() => this;
  RenderViewport get vmObject => this;
  @override
  ...
  @override
  double get anchor {
    Closure closure = table["getAnchor"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set anchor(value) {
    Closure closure = table["setAnchor"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  RenderSliver? get center {
    Closure closure = table["getCenter"];
  ...
  void set center(value) {
    Closure closure = table["setCenter"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  double scrollOffsetOf(child, scrollOffsetWithinChild) {
    Closure closure = table["scrollOffsetOf"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double maxScrollObstructionExtentBefore(child) {
  ...
  @override
  double computeChildMainAxisPosition(child, parentMainAxisPosition) {
  ...
  @override
  Offset computeAbsolutePaintOffset(child, layoutOffset, growthDirection) {
  ...
  @override
  void insert(child, {RenderSliver? after}) {
  ...
  @override
  void move(child, {RenderSliver? after}) {
  ...
  @override
  RenderSliver? childBefore(child) {
...
void loadRenderViewport(
    ...
    return [
      RTManagedRenderViewport(
          ...
          cacheExtent: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          cacheExtentStyle: maybeUnBoxEnum(
              values: CacheExtentStyle.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['cacheExtentStyle']
                  : null),
          center: maybeUnBoxAndBuildArgument<RenderSliver?, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['center'] : null,
              parentState: hydroState),
          children:
              maybeUnBoxAndBuildArgument<List<RenderSliver>?, RenderSliver>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['children'] : null,
                  parentState: hydroState),
  ...
  registerBoxer<RenderViewport>(boxer: (
      {required RenderViewport vmObject,

...
class VMManagedRenderViewport extends _36c2.VMManagedBox<_01f8.RenderViewport> {
  VMManagedRenderViewport(
...
void loadRenderViewport(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderViewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderViewport(
          ...
          cacheExtent: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          cacheExtentStyle: _36c2.maybeUnBoxEnum(
              values: _01f8.CacheExtentStyle.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['cacheExtentStyle']
                  : null),
          center: _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          crossAxisDirection: _36c2.maybeUnBoxEnum(values: _487f.AxisDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['crossAxisDirection'] : null),
  ...
  _36c2.registerBoxer<_01f8.RenderViewport>(boxer: (
      {required _01f8.RenderViewport vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderViewport(

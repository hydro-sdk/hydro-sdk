...
class VMManagedRenderStack extends _36c2.VMManagedBox<_b1b6.RenderStack> {VMManagedRenderStack({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getFit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_b1b6.StackFit.values.indexWhere((x) { return x == vmObject.fit; } ),]; } );
table  [
'setFit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.fit=(_36c2.maybeUnBoxEnum(values: _b1b6.StackFit.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
final _b1b6.RenderStack vmObject;

 }

class RTManagedRenderStack extends _b1b6.RenderStack implements _36c2.Box<_b1b6.RenderStack> {RTManagedRenderStack({required _ca85.AlignmentGeometry alignment, _fac9.List<_be2e.RenderBox>? children, required _a643.Clip clipBehavior, required _b1b6.StackFit fit, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,children: children,clipBehavior: clipBehavior,fit: fit,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setFit'] =
  ...
  super.fit = (_36c2.maybeUnBoxEnum(
      values: _b1b6.StackFit.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
_b1b6.RenderStack unwrap() => this;
_b1b6.RenderStack get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _b1b6.StackFit get fit { 
_36c2.Closure closure = table["getFit"];
return _36c2.maybeUnBoxEnum(values: _b1b6.StackFit.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void paintStack(context, offset) { 
_36c2.Closure closure = table["paintStack"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderStack({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderStack'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderStack(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), fit: _36c2.maybeUnBoxEnum(values: _b1b6.StackFit.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fit'
...
_36c2.Closure unpackedmainChildSizeGetter=luaCallerArguments  [
2
];return [_b1b6.RenderStack.getIntrinsicDimension(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), (child) => unpackedmainChildSizeGetter.dispatch([luaCallerArguments[0],child],parentState:hydroState,)[0]?.toDouble()),]; } );
table  [
'renderStackLayoutPositionedChild'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return [_b1b6.RenderStack.layoutPositionedChild(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_b1b6.StackParentData, _fac9.dynamic>(luaCallerArguments  [
2
...
_36c2.registerBoxer<_b1b6.RenderStack>(boxer: ({required _b1b6.RenderStack vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderStack(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

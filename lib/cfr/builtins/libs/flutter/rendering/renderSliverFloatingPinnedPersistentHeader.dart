...
class VMManagedRenderSliverFloatingPinnedPersistentHeader
    extends VMManagedBox<RenderSliverFloatingPinnedPersistentHeader> {
  ...
  final RenderSliverFloatingPinnedPersistentHeader vmObject;
}

class RTManagedRenderSliverFloatingPinnedPersistentHeader
    extends RenderSliverFloatingPinnedPersistentHeader
    implements Box<RenderSliverFloatingPinnedPersistentHeader> {
  ...
  RenderSliverFloatingPinnedPersistentHeader unwrap() => this;
  RenderSliverFloatingPinnedPersistentHeader get vmObject => this;
  @override
  ...
  @override
  void layoutChild(scrollOffset, maxExtent, {bool overlapsContent = false}) {
...
void loadRenderSliverFloatingPinnedPersistentHeader(
  ...
  table['renderSliverFloatingPinnedPersistentHeader'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFloatingPinnedPersistentHeader(
          ...
          showOnScreenConfiguration:
              maybeUnBoxAndBuildArgument<PersistentHeaderShowOnScreenConfiguration?, dynamic>(
                  luaCallerArguments.length >= 2
          ...
          snapConfiguration: maybeUnBoxAndBuildArgument<FloatingHeaderSnapConfiguration?, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          stretchConfiguration: maybeUnBoxAndBuildArgument<OverScrollHeaderStretchConfiguration?, dynamic>(
  ...
  registerBoxer<RenderSliverFloatingPinnedPersistentHeader>(boxer: (
      {required RenderSliverFloatingPinnedPersistentHeader vmObject,

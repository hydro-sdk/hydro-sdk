...
class VMManagedRenderSliverFloatingPinnedPersistentHeader extends _36c2
    .VMManagedBox<_2805.RenderSliverFloatingPinnedPersistentHeader> {
  VMManagedRenderSliverFloatingPinnedPersistentHeader(
    ...
    table['snapConfiguration'] =
        _36c2.maybeBoxObject<_2805.FloatingHeaderSnapConfiguration?>(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['updateGeometry'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.updateGeometry(),
      ];
    });
    ...
    table['updateScrollStartDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.updateScrollStartDirection(_36c2.maybeUnBoxEnum(
          values: _f376.ScrollDirection.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['maybeStartSnapAnimation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.maybeStartSnapAnimation(_36c2.maybeUnBoxEnum(
          values: _f376.ScrollDirection.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['maybeStopSnapAnimation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.maybeStopSnapAnimation(_36c2.maybeUnBoxEnum(
          values: _f376.ScrollDirection.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    ...
    table['setVsync'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.vsync = (_36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider?,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
...
class RTManagedRenderSliverFloatingPinnedPersistentHeader
    extends _2805.RenderSliverFloatingPinnedPersistentHeader
    implements _36c2.Box<_2805.RenderSliverFloatingPinnedPersistentHeader> {
  RTManagedRenderSliverFloatingPinnedPersistentHeader(
      {_be2e.RenderBox? child,
      _2805.PersistentHeaderShowOnScreenConfiguration?
          showOnScreenConfiguration,
      _2805.FloatingHeaderSnapConfiguration? snapConfiguration,
      _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration,
      _e067.TickerProvider? vsync,
      required this.table,
    ...
    table['snapConfiguration'] = _36c2.maybeBoxObject(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_updateGeometry'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_updateScrollStartDirection'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_maybeStartSnapAnimation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_maybeStopSnapAnimation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setVsync'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.vsync = (_36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider?,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  @_fac9.override
  void updateScrollStartDirection(direction) {
    _36c2.Closure closure = table["updateScrollStartDirection"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void maybeStartSnapAnimation(direction) {
    _36c2.Closure closure = table["maybeStartSnapAnimation"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void maybeStopSnapAnimation(direction) {
...
void loadRenderSliverFloatingPinnedPersistentHeader(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverFloatingPinnedPersistentHeader'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFloatingPinnedPersistentHeader(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          showOnScreenConfiguration:
              _36c2.maybeUnBoxAndBuildArgument<_2805.PersistentHeaderShowOnScreenConfiguration?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['showOnScreenConfiguration']
                      : null,
                  parentState: hydroState),
          snapConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.FloatingHeaderSnapConfiguration?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['snapConfiguration'] : null,
              parentState: hydroState),
          stretchConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.OverScrollHeaderStretchConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['stretchConfiguration'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_2805.RenderSliverFloatingPinnedPersistentHeader>(boxer: (
      {required _2805.RenderSliverFloatingPinnedPersistentHeader vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverFloatingPinnedPersistentHeader(

...
class VMManagedRenderSliverFloatingPinnedPersistentHeader extends _36c2.VMManagedBox<_2805.RenderSliverFloatingPinnedPersistentHeader> {VMManagedRenderSliverFloatingPinnedPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'snapConfiguration'
] = _36c2.maybeBoxObject<_2805.FloatingHeaderSnapConfiguration?>(object: vmObject.snapConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'showOnScreenConfiguration'
] = _36c2.maybeBoxObject<_2805.PersistentHeaderShowOnScreenConfiguration?>(object: vmObject.showOnScreenConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'stretchConfiguration'
] = _36c2.maybeBoxObject<_2805.OverScrollHeaderStretchConfiguration?>(object: vmObject.stretchConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table  [
'updateGeometry'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.updateGeometry(),]; } );
table  [
'detach'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.updateScrollStartDirection(_36c2.maybeUnBoxEnum(values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'maybeStartSnapAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.maybeStartSnapAnimation(_36c2.maybeUnBoxEnum(values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'maybeStopSnapAnimation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.maybeStopSnapAnimation(_36c2.maybeUnBoxEnum(values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.childMainAxisPosition(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'setVsync'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.vsync=(_36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
return [vmObject.hitTestChildren(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverHitTestResult, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), crossAxisPosition: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'crossAxisPosition'
...
return [vmObject.hitTest(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverHitTestResult, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), crossAxisPosition: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
...
return [vmObject.calculatePaintOffset(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverConstraints, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), from: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'from'
...
return [vmObject.calculateCacheOffset(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverConstraints, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), from: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
...
table  [
'childScrollOffset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.childScrollOffset(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
...
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_021d.SliverHitTestEntry, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState));
return []; } );
table  [
'getConstraints'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_021d.SliverConstraints>(object: vmObject.constraints, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getGeometry'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.geometry;if(returnValue!= null){return [_36c2.maybeBoxObject<_021d.SliverGeometry?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setGeometry'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.geometry=(_36c2.maybeUnBoxAndBuildArgument<_021d.SliverGeometry?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getCenterOffsetAdjustment'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.centerOffsetAdjustment,]; } );
table  [
'reassemble'
...
final _2805.RenderSliverFloatingPinnedPersistentHeader vmObject;

 }

class RTManagedRenderSliverFloatingPinnedPersistentHeader extends _2805.RenderSliverFloatingPinnedPersistentHeader implements _36c2.Box<_2805.RenderSliverFloatingPinnedPersistentHeader> {RTManagedRenderSliverFloatingPinnedPersistentHeader({_be2e.RenderBox? child, _2805.PersistentHeaderShowOnScreenConfiguration? showOnScreenConfiguration, _2805.FloatingHeaderSnapConfiguration? snapConfiguration, _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration, _e067.TickerProvider? vsync, required this.table, required this.hydroState}) : super(child: child,showOnScreenConfiguration: showOnScreenConfiguration,snapConfiguration: snapConfiguration,stretchConfiguration: stretchConfiguration,vsync: vsync) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'snapConfiguration'
] = _36c2.maybeBoxObject(object: this.snapConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'showOnScreenConfiguration'
] = _36c2.maybeBoxObject(object: this.showOnScreenConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'stretchConfiguration'
] = _36c2.maybeBoxObject(object: this.stretchConfiguration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'parentData'
...
table['_dart_updateScrollStartDirection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.updateScrollStartDirection(_36c2.maybeUnBoxEnum(
      values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_maybeStartSnapAnimation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.maybeStartSnapAnimation(_36c2.maybeUnBoxEnum(
      values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_maybeStopSnapAnimation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.maybeStopSnapAnimation(_36c2.maybeUnBoxEnum(
      values: _f376.ScrollDirection.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
table['_dart_childMainAxisPosition'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.childMainAxisPosition(
...
table['_dart_childCrossAxisPosition'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.childCrossAxisPosition(
            _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
table['_dart_childScrollOffset'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.childScrollOffset(
            _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
table['_dart_handleEvent'] =
  ...
  super.handleEvent(
      _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerEvent, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_021d.SliverHitTestEntry, _fac9.dynamic>(
          luaCallerArguments[2],
          parentState: hydroState));
  return [];
});
...
_2805.RenderSliverFloatingPinnedPersistentHeader unwrap() => this;
_2805.RenderSliverFloatingPinnedPersistentHeader get vmObject => this;
@_fac9.override _fac9.double updateGeometry() { 
_36c2.Closure closure = table["updateGeometry"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void detach() { super.detach();
_36c2.Closure closure = table["detach"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateScrollStartDirection(direction) { 
_36c2.Closure closure = table["updateScrollStartDirection"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void maybeStartSnapAnimation(direction) { 
_36c2.Closure closure = table["maybeStartSnapAnimation"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void maybeStopSnapAnimation(direction) { 
_36c2.Closure closure = table["maybeStopSnapAnimation"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double childMainAxisPosition(child) { 
...
@_fac9.override void set vsync(value) { 
_36c2.Closure closure = table["setVsync"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateChild(shrinkOffset, overlapsContent) { 
_36c2.Closure closure = table["updateChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void markNeedsLayout() { 
_36c2.Closure closure = table["markNeedsLayout"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void layoutChild(scrollOffset, maxExtent, {_fac9.bool overlapsContent = false}) { 
_36c2.Closure closure = table["layoutChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hitTestChildren(result, {required _fac9.double crossAxisPosition, required _fac9.double mainAxisPosition}) { 
...
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get childExtent { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hitTestBoxChild(result, child, {required _fac9.double crossAxisPosition, required _fac9.double mainAxisPosition}) { 
_36c2.Closure closure = table["hitTestBoxChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void applyPaintTransformForBoxChild(child, transform) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hitTest(result, {required _fac9.double crossAxisPosition, required _fac9.double mainAxisPosition}) { 
_36c2.Closure closure = table["hitTest"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool hitTestSelf({required _fac9.double crossAxisPosition, required _fac9.double mainAxisPosition}) { 
_36c2.Closure closure = table["hitTestSelf"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double calculatePaintOffset(constraints, {required _fac9.double from, required _fac9.double to}) { 
_36c2.Closure closure = table["calculatePaintOffset"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double calculateCacheOffset(constraints, {required _fac9.double from, required _fac9.double to}) { 
_36c2.Closure closure = table["calculateCacheOffset"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double childCrossAxisPosition(child) { 
_36c2.Closure closure = table["childCrossAxisPosition"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double? childScrollOffset(child) { 
_36c2.Closure closure = table["childScrollOffset"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _a643.Size getAbsoluteSizeRelativeToOrigin() { 
...
@_fac9.override _a643.Size getAbsoluteSize() { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _021d.SliverConstraints get constraints { 
...
@_fac9.override _021d.SliverGeometry? get geometry { 
_36c2.Closure closure = table["getGeometry"];
return _36c2.maybeUnBoxAndBuildArgument<_021d.SliverGeometry?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set geometry(value) { 
...
return _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.double get centerOffsetAdjustment { 
...
void loadRenderSliverFloatingPinnedPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderSliverFloatingPinnedPersistentHeader(table: luaCallerArguments  [
0
], hydroState: hydroState, child: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
] : null, parentState: hydroState), showOnScreenConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.PersistentHeaderShowOnScreenConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showOnScreenConfiguration'
] : null, parentState: hydroState), snapConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.FloatingHeaderSnapConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'snapConfiguration'
] : null, parentState: hydroState), stretchConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.OverScrollHeaderStretchConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'stretchConfiguration'
] : null, parentState: hydroState), vsync: _36c2.maybeUnBoxAndBuildArgument<_e067.TickerProvider?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'vsync'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_2805.RenderSliverFloatingPinnedPersistentHeader>(boxer: ({required _2805.RenderSliverFloatingPinnedPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFloatingPinnedPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

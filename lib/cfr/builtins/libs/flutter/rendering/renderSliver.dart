...
class VMManagedRenderSliver extends _36c2.VMManagedBox<_021d.RenderSliver> {
  VMManagedRenderSliver(
...
class RTManagedRenderSliver extends _021d.RenderSliver
    implements _36c2.Box<_021d.RenderSliver> {
  RTManagedRenderSliver({required this.table, required this.hydroState})
      : super() {
...
void loadRenderSliver(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliver'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliver(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_021d.RenderSliver>(boxer: (
      {required _021d.RenderSliver vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliver(

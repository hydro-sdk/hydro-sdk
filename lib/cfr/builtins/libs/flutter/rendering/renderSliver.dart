...
class VMManagedRenderSliver extends VMManagedBox<RenderSliver> {
  ...
  final RenderSliver vmObject;
}

class RTManagedRenderSliver extends RenderSliver implements Box<RenderSliver> {
  ...
  RenderSliver unwrap() => this;
  RenderSliver get vmObject => this;
  @override
...
void loadRenderSliver(
  ...
  registerBoxer<RenderSliver>(boxer: (
      {required RenderSliver vmObject,

...
class VMManagedRenderFittedBox
    extends _36c2.VMManagedBox<_bf98.RenderFittedBox> {
  VMManagedRenderFittedBox(
...
class RTManagedRenderFittedBox extends _bf98.RenderFittedBox
    implements _36c2.Box<_bf98.RenderFittedBox> {
  RTManagedRenderFittedBox(
      {required _ca85.AlignmentGeometry alignment,
      _be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      required _fb77.BoxFit fit,
...
void loadRenderFittedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderFittedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFittedBox(
  ...
  _36c2.registerBoxer<_bf98.RenderFittedBox>(boxer: (
      {required _bf98.RenderFittedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderFittedBox(

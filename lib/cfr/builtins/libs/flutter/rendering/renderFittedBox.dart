...
class VMManagedRenderFittedBox extends VMManagedBox<RenderFittedBox> {
  ...
  final RenderFittedBox vmObject;
}

class RTManagedRenderFittedBox extends RenderFittedBox
    implements Box<RenderFittedBox> {
  ...
  RenderFittedBox unwrap() => this;
  RenderFittedBox get vmObject => this;
  @override
  BoxFit get fit {
...
void loadRenderFittedBox(
  ...
  registerBoxer<RenderFittedBox>(boxer: (
      {required RenderFittedBox vmObject,

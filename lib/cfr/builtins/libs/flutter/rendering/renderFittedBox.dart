...
class VMManagedRenderFittedBox extends _36c2.VMManagedBox<_bf98.RenderFittedBox> {VMManagedRenderFittedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getFit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_fb77.BoxFit.values.indexWhere((x) { return x == vmObject.fit; } ),]; } );
table  [
'setFit'
...
final _bf98.RenderFittedBox vmObject;

 }

class RTManagedRenderFittedBox extends _bf98.RenderFittedBox implements _36c2.Box<_bf98.RenderFittedBox> {RTManagedRenderFittedBox({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, required _a643.Clip clipBehavior, required _fb77.BoxFit fit, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,clipBehavior: clipBehavior,fit: fit,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderFittedBox unwrap() => this;
_bf98.RenderFittedBox get vmObject => this;
...
void loadRenderFittedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderFittedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderFittedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderFittedBox>(boxer: ({required _bf98.RenderFittedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFittedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderConstraintsTransformBox
    extends _36c2.VMManagedBox<_a9e4.RenderConstraintsTransformBox> {
  VMManagedRenderConstraintsTransformBox(
...
void loadRenderConstraintsTransformBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderConstraintsTransformBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedconstraintsTransform = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['constraintsTransform']
        : null;
          ...
          alignment: _36c2
              .maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          constraintsTransform: (_) => _36c2
              .maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(
                  unpackedconstraintsTransform.dispatch(
                    [luaCallerArguments[0], _],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_a9e4.RenderConstraintsTransformBox>(boxer: (
      {required _a9e4.RenderConstraintsTransformBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderConstraintsTransformBox(

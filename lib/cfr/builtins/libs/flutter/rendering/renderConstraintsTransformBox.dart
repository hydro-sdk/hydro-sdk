...
class VMManagedRenderConstraintsTransformBox extends _36c2.VMManagedBox<_a9e4.RenderConstraintsTransformBox> {VMManagedRenderConstraintsTransformBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a9e4.RenderConstraintsTransformBox vmObject;

 }

class RTManagedRenderConstraintsTransformBox extends _a9e4.RenderConstraintsTransformBox implements _36c2.Box<_a9e4.RenderConstraintsTransformBox> {RTManagedRenderConstraintsTransformBox({_be2e.RenderBox? child, required _a643.Clip clipBehavior, required _ca85.AlignmentGeometry alignment, required _be2e.BoxConstraints Function(_be2e.BoxConstraints ) constraintsTransform, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,alignment: alignment,constraintsTransform: constraintsTransform,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderConstraintsTransformBox unwrap() => this;
_a9e4.RenderConstraintsTransformBox get vmObject => this;
...
void loadRenderConstraintsTransformBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderConstraintsTransformBox(table: luaCallerArguments  [
0
...
'alignment'
] : null, parentState: hydroState), constraintsTransform: (_) => _36c2.maybeUnBoxAndBuildArgument<_be2e.BoxConstraints, _fac9.dynamic>(unpackedconstraintsTransform.dispatch([luaCallerArguments[0],_],parentState:hydroState,)[0], parentState: hydroState), textDirection: _36c2.maybeUnBoxEnum(values: _a643.TextDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textDirection'
] : null))]; } );
_36c2.registerBoxer<_a9e4.RenderConstraintsTransformBox>(boxer: ({required _a9e4.RenderConstraintsTransformBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderConstraintsTransformBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

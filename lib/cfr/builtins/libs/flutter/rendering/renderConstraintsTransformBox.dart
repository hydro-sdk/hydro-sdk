...
class VMManagedRenderConstraintsTransformBox
    extends VMManagedBox<RenderConstraintsTransformBox> {
  ...
  final RenderConstraintsTransformBox vmObject;
}

class RTManagedRenderConstraintsTransformBox
    extends RenderConstraintsTransformBox
    implements Box<RenderConstraintsTransformBox> {
  RTManagedRenderConstraintsTransformBox(
      {RenderBox? child,
      required Clip clipBehavior,
      required AlignmentGeometry alignment,
      required constraintsTransform,
  ...
  RenderConstraintsTransformBox unwrap() => this;
  RenderConstraintsTransformBox get vmObject => this;
  @override
...
void loadRenderConstraintsTransformBox(
  ...
  table['renderConstraintsTransformBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    Closure unpackedconstraintsTransform = luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderConstraintsTransformBox>(boxer: (
      {required RenderConstraintsTransformBox vmObject,

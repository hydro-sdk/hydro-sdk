...
class VMManagedRenderFollowerLayer extends VMManagedBox<RenderFollowerLayer> {
  VMManagedRenderFollowerLayer(
    ...
    table['getShowWhenUnlinked'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.showWhenUnlinked,
      ];
    });
    table['setShowWhenUnlinked'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['setLeaderAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.leaderAnchor = (maybeUnBoxAndBuildArgument<Alignment, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['getFollowerAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<Alignment>(
    ...
    table['setFollowerAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.followerAnchor = (maybeUnBoxAndBuildArgument<Alignment, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['getLayer'] =
      ...
      if (returnValue != null) {
        return [
          maybeBoxObject<FollowerLayer?>(
              object: returnValue, hydroState: hydroState, table: HydroTable()),
        ];
      }
      return [];
    });
    table['getCurrentTransform'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
  ...
  final RenderFollowerLayer vmObject;
}

class RTManagedRenderFollowerLayer extends RenderFollowerLayer
    implements Box<RenderFollowerLayer> {
  RTManagedRenderFollowerLayer(
    ...
    table['_dart_setShowWhenUnlinked'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.showWhenUnlinked = (luaCallerArguments[1]);
      return [];
    });
    ...
    table['_dart_setLeaderAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.leaderAnchor = (maybeUnBoxAndBuildArgument<Alignment, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setFollowerAnchor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.followerAnchor = (maybeUnBoxAndBuildArgument<Alignment, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderFollowerLayer unwrap() => this;
  RenderFollowerLayer get vmObject => this;
  @override
  LayerLink get link {
  ...
  bool get showWhenUnlinked {
    Closure closure = table["getShowWhenUnlinked"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set showWhenUnlinked(bool value) {
    Closure closure = table["setShowWhenUnlinked"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  Alignment get leaderAnchor {
    Closure closure = table["getLeaderAnchor"];
  ...
  @override
  void set leaderAnchor(Alignment value) {
    Closure closure = table["setLeaderAnchor"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  Alignment get followerAnchor {
    Closure closure = table["getFollowerAnchor"];
    return maybeUnBoxAndBuildArgument<Alignment, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  void set followerAnchor(Alignment value) {
    Closure closure = table["setFollowerAnchor"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  FollowerLayer? get layer {
    ...
    return maybeUnBoxAndBuildArgument<FollowerLayer?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Matrix4 getCurrentTransform() {
    Closure closure = table["getCurrentTransform"];
  ...
  table['renderFollowerLayer'] =
    ...
    return [
      RTManagedRenderFollowerLayer(
          ...
          hydroState: hydroState,
          child:
              maybeUnBoxAndBuildArgument<RenderBox?, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['child'] : null,
                  parentState: hydroState),
          followerAnchor: maybeUnBoxAndBuildArgument<Alignment, dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['followerAnchor']
                  : null,
              parentState: hydroState),
          leaderAnchor: maybeUnBoxAndBuildArgument<Alignment, dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['leaderAnchor']
                  : null,
              parentState: hydroState),
          ...
          link: maybeUnBoxAndBuildArgument<LayerLink, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['link'] : null, parentState: hydroState))
    ];
  });
  registerBoxer<RenderFollowerLayer>(boxer: (
      {required RenderFollowerLayer vmObject,

...
class VMManagedRenderFollowerLayer extends _36c2.VMManagedBox<_bf98.RenderFollowerLayer> {VMManagedRenderFollowerLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getLink'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7d70.LayerLink>(object: vmObject.link, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setLink'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.link=(_36c2.maybeUnBoxAndBuildArgument<_7d70.LayerLink, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getShowWhenUnlinked'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.showWhenUnlinked,]; } );
table  [
'setShowWhenUnlinked'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.showWhenUnlinked=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'getLeaderAnchor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_ca85.Alignment>(object: vmObject.leaderAnchor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setLeaderAnchor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.leaderAnchor=(_36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getFollowerAnchor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_ca85.Alignment>(object: vmObject.followerAnchor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setFollowerAnchor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.followerAnchor=(_36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'getLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.layer;if(returnValue!= null){return [_36c2.maybeBoxObject<_7d70.FollowerLayer?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getCurrentTransform'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_db98.Matrix4>(object: vmObject.getCurrentTransform(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'hitTest'
...
final _bf98.RenderFollowerLayer vmObject;

 }

class RTManagedRenderFollowerLayer extends _bf98.RenderFollowerLayer implements _36c2.Box<_bf98.RenderFollowerLayer> {RTManagedRenderFollowerLayer({_be2e.RenderBox? child, required _ca85.Alignment followerAnchor, required _ca85.Alignment leaderAnchor, required _a643.Offset offset, required _fac9.bool showWhenUnlinked, required _7d70.LayerLink link, required this.table, required this.hydroState}) : super(child: child,followerAnchor: followerAnchor,leaderAnchor: leaderAnchor,offset: offset,showWhenUnlinked: showWhenUnlinked,link: link) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getShowWhenUnlinked'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.showWhenUnlinked];
});
table['_dart_setShowWhenUnlinked'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getLeaderAnchor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.leaderAnchor];
});
table['_dart_setLeaderAnchor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.leaderAnchor =
...
table['_dart_getFollowerAnchor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.followerAnchor];
});
table['_dart_setFollowerAnchor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getCurrentTransform'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.getCurrentTransform(),
        hydroState: hydroState,
...
_bf98.RenderFollowerLayer unwrap() => this;
_bf98.RenderFollowerLayer get vmObject => this;
@_fac9.override _7d70.LayerLink get link { 
...
@_fac9.override _fac9.bool get showWhenUnlinked { 
_36c2.Closure closure = table["getShowWhenUnlinked"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set showWhenUnlinked(value) { 
_36c2.Closure closure = table["setShowWhenUnlinked"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _ca85.Alignment get leaderAnchor { 
_36c2.Closure closure = table["getLeaderAnchor"];
...
@_fac9.override void set leaderAnchor(value) { 
_36c2.Closure closure = table["setLeaderAnchor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _ca85.Alignment get followerAnchor { 
_36c2.Closure closure = table["getFollowerAnchor"];
return _36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set followerAnchor(value) { 
_36c2.Closure closure = table["setFollowerAnchor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7d70.FollowerLayer? get layer { 
_36c2.Closure closure = table["getLayer"];
return _36c2.maybeUnBoxAndBuildArgument<_7d70.FollowerLayer?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _db98.Matrix4 getCurrentTransform() { 
_36c2.Closure closure = table["getCurrentTransform"];
...
void loadRenderFollowerLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderFollowerLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderFollowerLayer(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), followerAnchor: _36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'followerAnchor'
] : null, parentState: hydroState), leaderAnchor: _36c2.maybeUnBoxAndBuildArgument<_ca85.Alignment, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'leaderAnchor'
...
'offset'
] : null, parentState: hydroState), showWhenUnlinked: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'showWhenUnlinked'
] : null, link: _36c2.maybeUnBoxAndBuildArgument<_7d70.LayerLink, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'link'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderFollowerLayer>(boxer: ({required _bf98.RenderFollowerLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFollowerLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderObject extends _36c2.VMManagedBox<_9742.RenderObject> {
...
class RTManagedRenderObject extends _9742.RenderObject
    implements _36c2.Box<_9742.RenderObject> {
  ...
  @_fac9.override
  _9742.Constraints get constraints {
    _36c2.Closure closure = table["getConstraints"];
    return _36c2.maybeUnBoxAndBuildArgument<_9742.Constraints, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderObject(
  ...
  table['renderObject'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  table['renderObjectDebugActiveLayout'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _9742.RenderObject.debugActiveLayout;
    if (returnValue != null) {
      return [
  ...
  table['renderObjectDebugActivePaint'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _9742.RenderObject.debugActivePaint;
    if (returnValue != null) {
      return [
        _36c2.maybeBoxObject<_9742.RenderObject?>(
            object: returnValue,
  ...
  _36c2.registerBoxer<_9742.RenderObject>(boxer: (
      {required _9742.RenderObject vmObject,

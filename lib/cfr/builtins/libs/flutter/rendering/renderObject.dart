...
class VMManagedRenderObject extends _36c2.VMManagedBox<_9742.RenderObject> {VMManagedRenderObject({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _9742.RenderObject vmObject;

 }

class RTManagedRenderObject extends _9742.RenderObject implements _36c2.Box<_9742.RenderObject> {RTManagedRenderObject({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_9742.RenderObject unwrap() => this;
_9742.RenderObject get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _9742.Constraints get constraints { 
_36c2.Closure closure = table["getConstraints"];
return _36c2.maybeUnBoxAndBuildArgument<_9742.Constraints, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderObject({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderObject'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderObject(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'renderObjectDebugActiveLayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _9742.RenderObject.debugActiveLayout;if(returnValue!= null){return [_36c2.maybeBoxObject<_9742.RenderObject?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'renderObjectDebugActivePaint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = _9742.RenderObject.debugActivePaint;if(returnValue!= null){return [_36c2.maybeBoxObject<_9742.RenderObject?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_9742.RenderObject>(boxer: ({required _9742.RenderObject vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderObject(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

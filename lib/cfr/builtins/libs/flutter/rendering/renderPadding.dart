...
class VMManagedRenderPadding extends VMManagedBox<RenderPadding> {
  VMManagedRenderPadding(
  ...
  final RenderPadding vmObject;
}

class RTManagedRenderPadding extends RenderPadding
    implements Box<RenderPadding> {
  RTManagedRenderPadding(
      {RenderBox? child,
  ...
  RenderPadding unwrap() => this;
  RenderPadding get vmObject => this;
  @override
...
void loadRenderPadding(
  ...
  registerBoxer<RenderPadding>(boxer: (
      {required RenderPadding vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderPadding(

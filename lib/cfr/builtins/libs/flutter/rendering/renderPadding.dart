...
class VMManagedRenderPadding extends _36c2.VMManagedBox<_a9e4.RenderPadding> {
...
class RTManagedRenderPadding extends _a9e4.RenderPadding
    implements _36c2.Box<_a9e4.RenderPadding> {
...
void loadRenderPadding(
  ...
  table['renderPadding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPadding(
  ...
  _36c2.registerBoxer<_a9e4.RenderPadding>(boxer: (
      {required _a9e4.RenderPadding vmObject,

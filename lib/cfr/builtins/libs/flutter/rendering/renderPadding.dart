...
class VMManagedRenderPadding extends _36c2.VMManagedBox<_a9e4.RenderPadding> {VMManagedRenderPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a9e4.RenderPadding vmObject;

 }

class RTManagedRenderPadding extends _a9e4.RenderPadding implements _36c2.Box<_a9e4.RenderPadding> {RTManagedRenderPadding({_be2e.RenderBox? child, _a643.TextDirection? textDirection, required _96d1.EdgeInsetsGeometry padding, required this.table, required this.hydroState}) : super(child: child,textDirection: textDirection,padding: padding) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderPadding unwrap() => this;
_a9e4.RenderPadding get vmObject => this;
...
void loadRenderPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderPadding(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a9e4.RenderPadding>(boxer: ({required _a9e4.RenderPadding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

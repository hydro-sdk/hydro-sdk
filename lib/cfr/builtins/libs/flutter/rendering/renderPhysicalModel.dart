...
class VMManagedRenderPhysicalModel extends _36c2.VMManagedBox<_bf98.RenderPhysicalModel> {VMManagedRenderPhysicalModel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.layer;if(returnValue!= null){return [_36c2.maybeBoxObject<_7d70.PhysicalModelLayer?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getShape'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_250a.BoxShape.values.indexWhere((x) { return x == vmObject.shape; } ),]; } );
table  [
'setShape'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.shape=(_36c2.maybeUnBoxEnum(values: _250a.BoxShape.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getBorderRadius'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.borderRadius;if(returnValue!= null){return [_36c2.maybeBoxObject<_9d8a.BorderRadius?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setBorderRadius'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.borderRadius=(_36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius?, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getShadowColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Color>(object: vmObject.shadowColor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setShadowColor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.shadowColor=(_36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Rect>(object: vmObject.describeApproximatePaintClip(_36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getClipper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.clipper;if(returnValue!= null){return [_36c2.maybeBoxObject<_bf98.CustomClipper?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setClipper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.clipper=(_36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.RRect>?, _a643.RRect>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _bf98.RenderPhysicalModel vmObject;

 }

class RTManagedRenderPhysicalModel extends _bf98.RenderPhysicalModel implements _36c2.Box<_bf98.RenderPhysicalModel> {RTManagedRenderPhysicalModel({_9d8a.BorderRadius? borderRadius, _be2e.RenderBox? child, required _a643.Clip clipBehavior, required _fac9.double elevation, required _a643.Color shadowColor, required _250a.BoxShape shape, required _a643.Color color, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,child: child,clipBehavior: clipBehavior,elevation: elevation,shadowColor: shadowColor,shape: shape,color: color) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setShape'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.shape = (_36c2.maybeUnBoxEnum(
      values: _250a.BoxShape.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
table['_dart_getBorderRadius'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.borderRadius];
});
table['_dart_setBorderRadius'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.borderRadius =
...
table['_dart_getShadowColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.shadowColor];
});
table['_dart_setShadowColor'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.shadowColor =
...
table['_dart_getClipper'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.clipper];
});
table['_dart_setClipper'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.clipper = (_36c2.maybeUnBoxAndBuildArgument<
      _bf98.CustomClipper<_a643.RRect>?,
      _a643.RRect>(luaCallerArguments[1], parentState: hydroState));
  return [];
});
...
_bf98.RenderPhysicalModel unwrap() => this;
_bf98.RenderPhysicalModel get vmObject => this;
@_fac9.override _7d70.PhysicalModelLayer? get layer { 
_36c2.Closure closure = table["getLayer"];
return _36c2.maybeUnBoxAndBuildArgument<_7d70.PhysicalModelLayer?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _250a.BoxShape get shape { 
_36c2.Closure closure = table["getShape"];
return _36c2.maybeUnBoxEnum(values: _250a.BoxShape.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set shape(value) { 
_36c2.Closure closure = table["setShape"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _9d8a.BorderRadius? get borderRadius { 
_36c2.Closure closure = table["getBorderRadius"];
return _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set borderRadius(value) { 
_36c2.Closure closure = table["setBorderRadius"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Color get shadowColor { 
...
@_fac9.override void set shadowColor(value) { 
_36c2.Closure closure = table["setShadowColor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _bf98.CustomClipper<_a643.RRect>? get clipper { 
_36c2.Closure closure = table["getClipper"];
return _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.RRect>?, _a643.RRect>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set clipper(newClipper) { 
_36c2.Closure closure = table["setClipper"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderPhysicalModel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderPhysicalModel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderPhysicalModel(table: luaCallerArguments  [
0
...
'borderRadius'
] : null, parentState: hydroState), child: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'child'
...
'clipBehavior'
] : null), elevation: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'elevation'
] : null?.toDouble(), shadowColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shadowColor'
...
_36c2.registerBoxer<_bf98.RenderPhysicalModel>(boxer: ({required _bf98.RenderPhysicalModel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderPhysicalModel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

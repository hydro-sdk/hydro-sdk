...
class VMManagedRenderPhysicalModel extends VMManagedBox<RenderPhysicalModel> {
  VMManagedRenderPhysicalModel(
    ...
    table['getLayer'] =
      ...
      if (returnValue != null) {
        return [
          maybeBoxObject<PhysicalModelLayer?>(
    ...
    table['setShape'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.shape = (maybeUnBoxEnum(
          values: BoxShape.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getBorderRadius'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      final returnValue = vmObject.borderRadius;
      if (returnValue != null) {
        return [
          maybeBoxObject<BorderRadius?>(
              object: returnValue, hydroState: hydroState, table: HydroTable()),
        ];
      }
      return [];
    });
    table['setBorderRadius'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.borderRadius =
          (maybeUnBoxAndBuildArgument<BorderRadius?, dynamic>(
    ...
    table['setShadowColor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.shadowColor = (maybeUnBoxAndBuildArgument<Color, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['setClipper'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.clipper =
          (maybeUnBoxAndBuildArgument<CustomClipper<RRect>?, RRect>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
  ...
  final RenderPhysicalModel vmObject;
}

class RTManagedRenderPhysicalModel extends RenderPhysicalModel
    implements Box<RenderPhysicalModel> {
  RTManagedRenderPhysicalModel(
    ...
    table['_dart_setBorderRadius'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.borderRadius = (maybeUnBoxAndBuildArgument<BorderRadius?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setShadowColor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.shadowColor = (maybeUnBoxAndBuildArgument<Color, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setClipper'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.clipper = (maybeUnBoxAndBuildArgument<CustomClipper<RRect>?, RRect>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderPhysicalModel unwrap() => this;
  RenderPhysicalModel get vmObject => this;
  @override
  PhysicalModelLayer? get layer {
    Closure closure = table["getLayer"];
    return maybeUnBoxAndBuildArgument<PhysicalModelLayer?, dynamic>(
  ...
  @override
  BoxShape get shape {
    Closure closure = table["getShape"];
  ...
  @override
  void set shape(BoxShape value) {
    Closure closure = table["setShape"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  BorderRadius? get borderRadius {
    Closure closure = table["getBorderRadius"];
    return maybeUnBoxAndBuildArgument<BorderRadius?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  void set borderRadius(BorderRadius? value) {
    Closure closure = table["setBorderRadius"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  Color get shadowColor {
    Closure closure = table["getShadowColor"];
  ...
  CustomClipper<RRect>? get clipper {
    Closure closure = table["getClipper"];
    return maybeUnBoxAndBuildArgument<CustomClipper<RRect>?, RRect>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set clipper(CustomClipper? newClipper) {
    Closure closure = table["setClipper"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
    ...
    return [
      RTManagedRenderPhysicalModel(
          ...
          shadowColor: maybeUnBoxAndBuildArgument<Color, dynamic>(
              ...
              parentState: hydroState),
          shape: maybeUnBoxEnum(values: BoxShape.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shape'] : null),
          color: maybeUnBoxAndBuildArgument<Color, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['color'] : null, parentState: hydroState))
    ];
  });
  registerBoxer<RenderPhysicalModel>(boxer: (
      {required RenderPhysicalModel vmObject,

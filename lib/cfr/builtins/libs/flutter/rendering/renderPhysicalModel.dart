...
class VMManagedRenderPhysicalModel
    extends _36c2.VMManagedBox<_bf98.RenderPhysicalModel> {
  VMManagedRenderPhysicalModel(
    ...
    table['getLayer'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_7d70.PhysicalModelLayer?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['getShape'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _250a.BoxShape.values.indexWhere((x) {
          return x == vmObject.shape;
        }),
      ];
    });
    table['setShape'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.shape = (_36c2.maybeUnBoxEnum(
          values: _250a.BoxShape.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getBorderRadius'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.borderRadius;
      if (returnValue != null) {
        return [
    ...
    table['setBorderRadius'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.borderRadius =
    ...
    table['setShadowColor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.shadowColor =
    ...
    table['getClipper'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.clipper;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_bf98.CustomClipper?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setClipper'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.clipper = (_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedRenderPhysicalModel extends _bf98.RenderPhysicalModel
    implements _36c2.Box<_bf98.RenderPhysicalModel> {
  RTManagedRenderPhysicalModel(
      {_9d8a.BorderRadius? borderRadius,
      _be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      required _fac9.double elevation,
      required _a643.Color shadowColor,
    ...
    table['_dart_getBorderRadius'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.borderRadius];
    });
    table['_dart_setBorderRadius'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.borderRadius =
          (_36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_setShadowColor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.shadowColor =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getClipper'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.clipper];
    });
    table['_dart_setClipper'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _7d70.PhysicalModelLayer? get layer {
    _36c2.Closure closure = table["getLayer"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_7d70.PhysicalModelLayer?, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _250a.BoxShape get shape {
  ...
  @_fac9.override
  _9d8a.BorderRadius? get borderRadius {
    _36c2.Closure closure = table["getBorderRadius"];
    return _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  void set borderRadius(value) {
  ...
  @_fac9.override
  _bf98.CustomClipper<_a643.RRect>? get clipper {
    _36c2.Closure closure = table["getClipper"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.RRect>?,
            _a643.RRect>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  void set clipper(newClipper) {
...
void loadRenderPhysicalModel(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderPhysicalModel'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderPhysicalModel(
          ...
          elevation: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          shadowColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shadowColor'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_bf98.RenderPhysicalModel>(boxer: (
      {required _bf98.RenderPhysicalModel vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderPhysicalModel(

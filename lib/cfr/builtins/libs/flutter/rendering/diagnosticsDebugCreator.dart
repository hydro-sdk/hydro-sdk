...
class VMManagedDiagnosticsDebugCreator extends _36c2.VMManagedBox<_9742.DiagnosticsDebugCreator> {VMManagedDiagnosticsDebugCreator({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _9742.DiagnosticsDebugCreator vmObject;

 }

class RTManagedDiagnosticsDebugCreator extends _9742.DiagnosticsDebugCreator implements _36c2.Box<_9742.DiagnosticsDebugCreator> {RTManagedDiagnosticsDebugCreator(_fac9.Object value$, {required this.table, required this.hydroState}) : super(value$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_9742.DiagnosticsDebugCreator unwrap() => this;
_9742.DiagnosticsDebugCreator get vmObject => this;
...
void loadDiagnosticsDebugCreator({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'diagnosticsDebugCreator'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDiagnosticsDebugCreator(_36c2.maybeUnBoxAndBuildArgument<_fac9.Object, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_9742.DiagnosticsDebugCreator>(boxer: ({required _9742.DiagnosticsDebugCreator vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDiagnosticsDebugCreator(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

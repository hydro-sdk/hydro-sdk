...
class VMManagedDiagnosticsDebugCreator
    extends _36c2.VMManagedBox<_9742.DiagnosticsDebugCreator> {
...
class RTManagedDiagnosticsDebugCreator extends _9742.DiagnosticsDebugCreator
    implements _36c2.Box<_9742.DiagnosticsDebugCreator> {
  RTManagedDiagnosticsDebugCreator(_fac9.Object value$,
...
void loadDiagnosticsDebugCreator(
  ...
  table['diagnosticsDebugCreator'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_9742.DiagnosticsDebugCreator>(boxer: (
      {required _9742.DiagnosticsDebugCreator vmObject,

...
class VMManagedRenderCustomSingleChildLayoutBox
    extends VMManagedBox<RenderCustomSingleChildLayoutBox> {
  VMManagedRenderCustomSingleChildLayoutBox(
    ...
    table['getDelegate'] =
      ...
      return [
        maybeBoxObject<SingleChildLayoutDelegate>(
  ...
  final RenderCustomSingleChildLayoutBox vmObject;
}

class RTManagedRenderCustomSingleChildLayoutBox
    extends RenderCustomSingleChildLayoutBox
    implements Box<RenderCustomSingleChildLayoutBox> {
  ...
  RenderCustomSingleChildLayoutBox unwrap() => this;
  RenderCustomSingleChildLayoutBox get vmObject => this;
  @override
  SingleChildLayoutDelegate get delegate {
    Closure closure = table["getDelegate"];
    return maybeUnBoxAndBuildArgument<SingleChildLayoutDelegate, dynamic>(
  ...
  void set delegate(newDelegate) {
    Closure closure = table["setDelegate"];
...
void loadRenderCustomSingleChildLayoutBox(
  ...
  table['renderCustomSingleChildLayoutBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderCustomSingleChildLayoutBox(
  ...
  registerBoxer<RenderCustomSingleChildLayoutBox>(boxer: (
      {required RenderCustomSingleChildLayoutBox vmObject,

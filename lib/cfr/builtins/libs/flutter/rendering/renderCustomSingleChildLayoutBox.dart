...
class VMManagedRenderCustomSingleChildLayoutBox extends _36c2.VMManagedBox<_a9e4.RenderCustomSingleChildLayoutBox> {VMManagedRenderCustomSingleChildLayoutBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a9e4.SingleChildLayoutDelegate>(object: vmObject.delegate, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.delegate=(_36c2.maybeUnBoxAndBuildArgument<_a9e4.SingleChildLayoutDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
final _a9e4.RenderCustomSingleChildLayoutBox vmObject;

 }

class RTManagedRenderCustomSingleChildLayoutBox extends _a9e4.RenderCustomSingleChildLayoutBox implements _36c2.Box<_a9e4.RenderCustomSingleChildLayoutBox> {RTManagedRenderCustomSingleChildLayoutBox({_be2e.RenderBox? child, required _a9e4.SingleChildLayoutDelegate delegate, required this.table, required this.hydroState}) : super(child: child,delegate: delegate) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderCustomSingleChildLayoutBox unwrap() => this;
_a9e4.RenderCustomSingleChildLayoutBox get vmObject => this;
@_fac9.override _a9e4.SingleChildLayoutDelegate get delegate { 
_36c2.Closure closure = table["getDelegate"];
return _36c2.maybeUnBoxAndBuildArgument<_a9e4.SingleChildLayoutDelegate, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderCustomSingleChildLayoutBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderCustomSingleChildLayoutBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderCustomSingleChildLayoutBox(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), delegate: _36c2.maybeUnBoxAndBuildArgument<_a9e4.SingleChildLayoutDelegate, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delegate'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_a9e4.RenderCustomSingleChildLayoutBox>(boxer: ({required _a9e4.RenderCustomSingleChildLayoutBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderCustomSingleChildLayoutBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

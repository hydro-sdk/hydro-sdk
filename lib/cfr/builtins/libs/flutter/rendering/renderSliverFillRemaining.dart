...
class VMManagedRenderSliverFillRemaining extends _36c2.VMManagedBox<_793f.RenderSliverFillRemaining> {VMManagedRenderSliverFillRemaining({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _793f.RenderSliverFillRemaining vmObject;

 }

class RTManagedRenderSliverFillRemaining extends _793f.RenderSliverFillRemaining implements _36c2.Box<_793f.RenderSliverFillRemaining> {RTManagedRenderSliverFillRemaining({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_793f.RenderSliverFillRemaining unwrap() => this;
_793f.RenderSliverFillRemaining get vmObject => this;
...
void loadRenderSliverFillRemaining({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFillRemaining'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverFillRemaining(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_793f.RenderSliverFillRemaining>(boxer: ({required _793f.RenderSliverFillRemaining vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFillRemaining(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

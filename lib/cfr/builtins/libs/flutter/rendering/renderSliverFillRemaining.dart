...
class VMManagedRenderSliverFillRemaining
    extends VMManagedBox<RenderSliverFillRemaining> {
  ...
  final RenderSliverFillRemaining vmObject;
}

class RTManagedRenderSliverFillRemaining extends RenderSliverFillRemaining
    implements Box<RenderSliverFillRemaining> {
  ...
  RenderSliverFillRemaining unwrap() => this;
  RenderSliverFillRemaining get vmObject => this;
  @override
  void performLayout() {
...
void loadRenderSliverFillRemaining(
  ...
  table['renderSliverFillRemaining'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillRemaining(
  ...
  registerBoxer<RenderSliverFillRemaining>(boxer: (
      {required RenderSliverFillRemaining vmObject,

...
class VMManagedRenderSliverFillRemaining
    extends _36c2.VMManagedBox<_793f.RenderSliverFillRemaining> {
  VMManagedRenderSliverFillRemaining(
...
class RTManagedRenderSliverFillRemaining extends _793f.RenderSliverFillRemaining
    implements _36c2.Box<_793f.RenderSliverFillRemaining> {
  RTManagedRenderSliverFillRemaining(
...
void loadRenderSliverFillRemaining(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverFillRemaining'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillRemaining(
  ...
  _36c2.registerBoxer<_793f.RenderSliverFillRemaining>(boxer: (
      {required _793f.RenderSliverFillRemaining vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverFillRemaining(

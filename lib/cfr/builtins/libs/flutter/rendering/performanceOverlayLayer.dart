...
class VMManagedPerformanceOverlayLayer
    extends VMManagedBox<PerformanceOverlayLayer> {
  VMManagedPerformanceOverlayLayer(
    ...
    table['setOverlayRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.overlayRect = (maybeUnBoxAndBuildArgument<Rect, dynamic>(
  ...
  final PerformanceOverlayLayer vmObject;
}

class RTManagedPerformanceOverlayLayer extends PerformanceOverlayLayer
    implements Box<PerformanceOverlayLayer> {
  RTManagedPerformanceOverlayLayer(
    ...
    table['optionsMask'] = this.optionsMask;
    ...
    table['_dart_setOverlayRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.overlayRect = (maybeUnBoxAndBuildArgument<Rect, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  PerformanceOverlayLayer unwrap() => this;
  PerformanceOverlayLayer get vmObject => this;
  @override
  Rect get overlayRect {
    Closure closure = table["getOverlayRect"];
...
void loadPerformanceOverlayLayer(
    ...
    return [
      RTManagedPerformanceOverlayLayer(
          ...
          optionsMask: luaCallerArguments.length >= 2
              ...
              : null,
          overlayRect: maybeUnBoxAndBuildArgument<Rect, dynamic>(
  ...
  registerBoxer<PerformanceOverlayLayer>(boxer: (
      {required PerformanceOverlayLayer vmObject,

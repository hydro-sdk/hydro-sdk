...
class VMManagedPerformanceOverlayLayer extends _36c2.VMManagedBox<_7d70.PerformanceOverlayLayer> {VMManagedPerformanceOverlayLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getOverlayRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Rect>(object: vmObject.overlayRect, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setOverlayRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.overlayRect=(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments  [
1
...
final _7d70.PerformanceOverlayLayer vmObject;

 }

class RTManagedPerformanceOverlayLayer extends _7d70.PerformanceOverlayLayer implements _36c2.Box<_7d70.PerformanceOverlayLayer> {RTManagedPerformanceOverlayLayer({required _fac9.bool checkerboardOffscreenLayers, required _fac9.bool checkerboardRasterCacheImages, required _fac9.int optionsMask, required _a643.Rect overlayRect, required _fac9.int rasterizerThreshold, required this.table, required this.hydroState}) : super(checkerboardOffscreenLayers: checkerboardOffscreenLayers,checkerboardRasterCacheImages: checkerboardRasterCacheImages,optionsMask: optionsMask,overlayRect: overlayRect,rasterizerThreshold: rasterizerThreshold) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'optionsMask'
] = _36c2.maybeBoxObject(object: this.optionsMask, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'rasterizerThreshold'
] = _36c2.maybeBoxObject(object: this.rasterizerThreshold, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'checkerboardRasterCacheImages'
...
_7d70.PerformanceOverlayLayer unwrap() => this;
_7d70.PerformanceOverlayLayer get vmObject => this;
@_fac9.override _a643.Rect get overlayRect { 
_36c2.Closure closure = table["getOverlayRect"];
...
@_fac9.override void set overlayRect(value) { 
_36c2.Closure closure = table["setOverlayRect"];
...
void loadPerformanceOverlayLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedPerformanceOverlayLayer(table: luaCallerArguments  [
0
...
'optionsMask'
] : null, overlayRect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'overlayRect'
] : null, parentState: hydroState), rasterizerThreshold: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'rasterizerThreshold'
] : null)]; } );
_36c2.registerBoxer<_7d70.PerformanceOverlayLayer>(boxer: ({required _7d70.PerformanceOverlayLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPerformanceOverlayLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

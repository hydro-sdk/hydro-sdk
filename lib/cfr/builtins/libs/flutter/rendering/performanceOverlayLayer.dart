...
class VMManagedPerformanceOverlayLayer
    extends _36c2.VMManagedBox<_7d70.PerformanceOverlayLayer> {
  VMManagedPerformanceOverlayLayer(
    ...
    table['optionsMask'] = vmObject.optionsMask;
    table['rasterizerThreshold'] = vmObject.rasterizerThreshold;
    ...
    table['getOverlayRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Rect>(
            object: vmObject.overlayRect,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setOverlayRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.overlayRect =
...
class RTManagedPerformanceOverlayLayer extends _7d70.PerformanceOverlayLayer
    implements _36c2.Box<_7d70.PerformanceOverlayLayer> {
  RTManagedPerformanceOverlayLayer(
      ...
      required _a643.Rect overlayRect,
    ...
    table['optionsMask'] = _36c2.maybeBoxObject(
        object: this.optionsMask,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['rasterizerThreshold'] = _36c2.maybeBoxObject(
        object: this.rasterizerThreshold,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getOverlayRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.overlayRect];
    });
    table['_dart_setOverlayRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.overlayRect =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadPerformanceOverlayLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['performanceOverlayLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPerformanceOverlayLayer(
          ...
          overlayRect:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['overlayRect']
                      : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_7d70.PerformanceOverlayLayer>(boxer: (
      {required _7d70.PerformanceOverlayLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPerformanceOverlayLayer(

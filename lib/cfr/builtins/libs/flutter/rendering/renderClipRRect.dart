...
class VMManagedRenderClipRRect extends _36c2.VMManagedBox<_bf98.RenderClipRRect> {VMManagedRenderClipRRect({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getBorderRadius'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_9d8a.BorderRadius>(object: vmObject.borderRadius, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setBorderRadius'
...
final _bf98.RenderClipRRect vmObject;

 }

class RTManagedRenderClipRRect extends _bf98.RenderClipRRect implements _36c2.Box<_bf98.RenderClipRRect> {RTManagedRenderClipRRect({required _9d8a.BorderRadius borderRadius, _be2e.RenderBox? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.RRect>? clipper, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,child: child,clipBehavior: clipBehavior,clipper: clipper) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderClipRRect unwrap() => this;
_bf98.RenderClipRRect get vmObject => this;
...
void loadRenderClipRRect({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderClipRRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderClipRRect(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.RRect>?, _a643.RRect>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipper'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderClipRRect>(boxer: ({required _bf98.RenderClipRRect vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderClipRRect(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

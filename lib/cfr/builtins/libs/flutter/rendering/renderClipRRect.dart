...
class VMManagedRenderClipRRect
    extends _36c2.VMManagedBox<_bf98.RenderClipRRect> {
  VMManagedRenderClipRRect(
...
class RTManagedRenderClipRRect extends _bf98.RenderClipRRect
    implements _36c2.Box<_bf98.RenderClipRRect> {
  RTManagedRenderClipRRect(
      {required _9d8a.BorderRadius borderRadius,
      _be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      _bf98.CustomClipper<_a643.RRect>? clipper,
      required this.table,
...
void loadRenderClipRRect(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderClipRRect'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderClipRRect(
          ...
          borderRadius:
              _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadius, _fac9.dynamic>(
                  ...
                  parentState: hydroState),
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['child'] : null,
                  parentState: hydroState),
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.RRect>?, _a643.RRect>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['clipper'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_bf98.RenderClipRRect>(boxer: (
      {required _bf98.RenderClipRRect vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderClipRRect(

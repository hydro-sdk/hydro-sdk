...
class VMManagedRenderClipRRect extends VMManagedBox<RenderClipRRect> {
  ...
  final RenderClipRRect vmObject;
}

class RTManagedRenderClipRRect extends RenderClipRRect
    implements Box<RenderClipRRect> {
  ...
  RenderClipRRect unwrap() => this;
  RenderClipRRect get vmObject => this;
  @override
...
void loadRenderClipRRect(
      ...
      RTManagedRenderClipRRect(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipper: maybeUnBoxAndBuildArgument<CustomClipper<RRect>?, RRect>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderClipRRect>(boxer: (
      {required RenderClipRRect vmObject,

...
class VMManagedRenderSliverSingleBoxAdapter
    extends VMManagedBox<RenderSliverSingleBoxAdapter> {
  ...
  final RenderSliverSingleBoxAdapter vmObject;
}

class RTManagedRenderSliverSingleBoxAdapter extends RenderSliverSingleBoxAdapter
    implements Box<RenderSliverSingleBoxAdapter> {
...
void loadRenderSliverSingleBoxAdapter(
  ...
  table['renderSliverSingleBoxAdapter'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverSingleBoxAdapter(
  ...
  registerBoxer<RenderSliverSingleBoxAdapter>(boxer: (
      {required RenderSliverSingleBoxAdapter vmObject,

...
class VMManagedRenderSemanticsGestureHandler
    extends _36c2.VMManagedBox<_bf98.RenderSemanticsGestureHandler> {
  VMManagedRenderSemanticsGestureHandler(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getValidActions'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.validActions;
      if (returnValue != null) {
        return [
    ...
    table['setValidActions'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.validActions = (_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['getOnHorizontalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.onHorizontalDragUpdate;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setOnHorizontalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedvalue = luaCallerArguments[1];
      vmObject.onHorizontalDragUpdate = (unpackedvalue != null
    ...
    table['getOnVerticalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.onVerticalDragUpdate;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setOnVerticalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedvalue = luaCallerArguments[1];
      vmObject.onVerticalDragUpdate = (unpackedvalue != null
          ? (details) => unpackedvalue.dispatch(
                [luaCallerArguments[0], details],
                parentState: hydroState,
              )
...
class RTManagedRenderSemanticsGestureHandler
    extends _bf98.RenderSemanticsGestureHandler
    implements _36c2.Box<_bf98.RenderSemanticsGestureHandler> {
  RTManagedRenderSemanticsGestureHandler(
      ...
      required _fac9.double scrollFactor,
      required this.table,
    ...
    table['scrollFactor'] = _36c2.maybeBoxObject(
        object: this.scrollFactor,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['behavior'] = _bf98.HitTestBehavior.values.indexWhere((x) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getValidActions'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.validActions];
    });
    table['_dart_setValidActions'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setOnHorizontalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedvalue = luaCallerArguments[1];
    ...
    table['_dart_setOnVerticalDragUpdate'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedvalue = luaCallerArguments[1];
  ...
  @_fac9.override
  _fac9.Set<_a643.SemanticsAction>? get validActions {
    _36c2.Closure closure = table["getValidActions"];
    return _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.SemanticsAction>?,
  ...
  @_fac9.override
  void set onHorizontalDragUpdate(value) {
    _36c2.Closure closure = table["setOnHorizontalDragUpdate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void set onVerticalDragUpdate(value) {
...
void loadRenderSemanticsGestureHandler(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSemanticsGestureHandler'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedRenderSemanticsGestureHandler(
          ...
          onVerticalDragUpdate: unpackedonVerticalDragUpdate != null
              ...
              : null,
          scrollFactor: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['scrollFactor']
              : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_bf98.RenderSemanticsGestureHandler>(boxer: (
      {required _bf98.RenderSemanticsGestureHandler vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSemanticsGestureHandler(

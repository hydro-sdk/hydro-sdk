...
class VMManagedRenderSemanticsGestureHandler extends _36c2.VMManagedBox<_bf98.RenderSemanticsGestureHandler> {VMManagedRenderSemanticsGestureHandler({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'scrollFactor'
] = vmObject.scrollFactor;
table  [
'behavior'
...
table  [
'getValidActions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.validActions;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Set?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setValidActions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.validActions=(_36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.SemanticsAction>?, _a643.SemanticsAction>(luaCallerArguments  [
1
...
return []; } );
table  [
'getOnHorizontalDragUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.onHorizontalDragUpdate;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setOnHorizontalDragUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure? unpackedvalue=luaCallerArguments  [
1
];vmObject.onHorizontalDragUpdate=(unpackedvalue != null ? (details) => unpackedvalue.dispatch([luaCallerArguments[0],details],parentState:hydroState,) : null );
return []; } );
table  [
'getOnVerticalDragUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.onVerticalDragUpdate;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setOnVerticalDragUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { _36c2.Closure? unpackedvalue=luaCallerArguments  [
1
];vmObject.onVerticalDragUpdate=(unpackedvalue != null ? (details) => unpackedvalue.dispatch([luaCallerArguments[0],details],parentState:hydroState,) : null );
return []; } );
table  [
...
final _bf98.RenderSemanticsGestureHandler vmObject;

 }

class RTManagedRenderSemanticsGestureHandler extends _bf98.RenderSemanticsGestureHandler implements _36c2.Box<_bf98.RenderSemanticsGestureHandler> {RTManagedRenderSemanticsGestureHandler({required _bf98.HitTestBehavior behavior, _be2e.RenderBox? child, void Function(_4bc7.DragUpdateDetails details)? onHorizontalDragUpdate, void Function()? onLongPress, void Function()? onTap, void Function(_4bc7.DragUpdateDetails details)? onVerticalDragUpdate, required _fac9.double scrollFactor, required this.table, required this.hydroState}) : super(behavior: behavior,child: child,onHorizontalDragUpdate: onHorizontalDragUpdate,onLongPress: onLongPress,onTap: onTap,onVerticalDragUpdate: onVerticalDragUpdate,scrollFactor: scrollFactor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'scrollFactor'
] = _36c2.maybeBoxObject(object: this.scrollFactor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'behavior'
...
table['_dart_getValidActions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.validActions];
});
table['_dart_setValidActions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.validActions = (_36c2.maybeUnBoxAndBuildArgument<
      _fac9.Set<_a643.SemanticsAction>?,
      _a643.SemanticsAction>(luaCallerArguments[1], parentState: hydroState));
  return [];
});
...
table['_dart_setOnHorizontalDragUpdate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  _36c2.Closure? unpackedvalue = luaCallerArguments[1];
  super.onHorizontalDragUpdate = (unpackedvalue != null
      ? (details) => unpackedvalue.dispatch(
...
table['_dart_setOnVerticalDragUpdate'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  _36c2.Closure? unpackedvalue = luaCallerArguments[1];
  super.onVerticalDragUpdate = (unpackedvalue != null
      ? (details) => unpackedvalue.dispatch(
            [luaCallerArguments[0], details],
            parentState: hydroState,
          )
...
_bf98.RenderSemanticsGestureHandler unwrap() => this;
_bf98.RenderSemanticsGestureHandler get vmObject => this;
@_fac9.override _fac9.Set<_a643.SemanticsAction>? get validActions { 
_36c2.Closure closure = table["getValidActions"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.SemanticsAction>?, _a643.SemanticsAction>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set validActions(value) { 
_36c2.Closure closure = table["setValidActions"];
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set onHorizontalDragUpdate(value) { 
_36c2.Closure closure = table["setOnHorizontalDragUpdate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set onVerticalDragUpdate(value) { 
_36c2.Closure closure = table["setOnVerticalDragUpdate"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderSemanticsGestureHandler({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderSemanticsGestureHandler(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), onHorizontalDragUpdate: unpackedonHorizontalDragUpdate != null ? (details) => unpackedonHorizontalDragUpdate.dispatch([luaCallerArguments[0],details],parentState:hydroState,) : null , onLongPress: unpackedonLongPress != null ? () => unpackedonLongPress.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , onTap: unpackedonTap != null ? () => unpackedonTap.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , onVerticalDragUpdate: unpackedonVerticalDragUpdate != null ? (details) => unpackedonVerticalDragUpdate.dispatch([luaCallerArguments[0],details],parentState:hydroState,) : null , scrollFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scrollFactor'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_bf98.RenderSemanticsGestureHandler>(boxer: ({required _bf98.RenderSemanticsGestureHandler vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSemanticsGestureHandler(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

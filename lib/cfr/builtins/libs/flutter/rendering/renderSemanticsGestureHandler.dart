...
class VMManagedRenderSemanticsGestureHandler
    extends VMManagedBox<RenderSemanticsGestureHandler> {
  VMManagedRenderSemanticsGestureHandler(
    ...
    table['setValidActions'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.validActions =
          (maybeUnBoxAndBuildArgument<Set<SemanticsAction>?, SemanticsAction>(
    ...
    table['getOnHorizontalDragUpdate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['setOnHorizontalDragUpdate'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      Closure? unpackedvalue = luaCallerArguments[1];
  ...
  final RenderSemanticsGestureHandler vmObject;
}
...
class RTManagedRenderSemanticsGestureHandler
  ...
  RenderSemanticsGestureHandler unwrap() => this;
  RenderSemanticsGestureHandler get vmObject => this;
  @override
  Set<SemanticsAction>? get validActions {
    Closure closure = table["getValidActions"];
    return maybeUnBoxAndBuildArgument<Set<SemanticsAction>?, SemanticsAction>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set validActions(Set? value) {
    Closure closure = table["setValidActions"];
  ...
  void set onHorizontalDragUpdate(value) {
    Closure closure = table["setOnHorizontalDragUpdate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set onVerticalDragUpdate(value) {
    Closure closure = table["setOnVerticalDragUpdate"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderSemanticsGestureHandler(
  ...
  table['renderSemanticsGestureHandler'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    Closure? unpackedonHorizontalDragUpdate = luaCallerArguments.length >= 2
    ...
    Closure? unpackedonVerticalDragUpdate = luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSemanticsGestureHandler>(boxer: (
      {required RenderSemanticsGestureHandler vmObject,

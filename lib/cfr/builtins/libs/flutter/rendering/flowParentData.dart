...
class VMManagedFlowParentData extends _36c2.VMManagedBox<_43b9.FlowParentData> {
...
class RTManagedFlowParentData extends _43b9.FlowParentData
    implements _36c2.Box<_43b9.FlowParentData> {
...
void loadFlowParentData(
  ...
  table['flowParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_43b9.FlowParentData>(boxer: (
      {required _43b9.FlowParentData vmObject,

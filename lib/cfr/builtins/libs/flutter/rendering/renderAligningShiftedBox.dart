...
class VMManagedRenderAligningShiftedBox extends _36c2.VMManagedBox<_a9e4.RenderAligningShiftedBox> {VMManagedRenderAligningShiftedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _a9e4.RenderAligningShiftedBox vmObject;

 }

class RTManagedRenderAligningShiftedBox extends _a9e4.RenderAligningShiftedBox implements _36c2.Box<_a9e4.RenderAligningShiftedBox> {RTManagedRenderAligningShiftedBox({required _ca85.AlignmentGeometry alignment, _be2e.RenderBox? child, _a643.TextDirection? textDirection, required this.table, required this.hydroState}) : super(alignment: alignment,child: child,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_a9e4.RenderAligningShiftedBox unwrap() => this;
_a9e4.RenderAligningShiftedBox get vmObject => this;
...
void loadRenderAligningShiftedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAligningShiftedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderAligningShiftedBox(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a9e4.RenderAligningShiftedBox>(boxer: ({required _a9e4.RenderAligningShiftedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAligningShiftedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

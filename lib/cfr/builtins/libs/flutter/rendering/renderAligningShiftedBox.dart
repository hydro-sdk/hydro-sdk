...
class VMManagedRenderAligningShiftedBox
    extends _36c2.VMManagedBox<_a9e4.RenderAligningShiftedBox> {
  VMManagedRenderAligningShiftedBox(
...
class RTManagedRenderAligningShiftedBox extends _a9e4.RenderAligningShiftedBox
    implements _36c2.Box<_a9e4.RenderAligningShiftedBox> {
  RTManagedRenderAligningShiftedBox(
      ...
      : super(
            alignment: alignment, child: child, textDirection: textDirection) {
...
void loadRenderAligningShiftedBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAligningShiftedBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAligningShiftedBox(
  ...
  _36c2.registerBoxer<_a9e4.RenderAligningShiftedBox>(boxer: (
      {required _a9e4.RenderAligningShiftedBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAligningShiftedBox(

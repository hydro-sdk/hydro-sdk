...
class VMManagedRenderAligningShiftedBox
    extends VMManagedBox<RenderAligningShiftedBox> {
  ...
  final RenderAligningShiftedBox vmObject;
}

class RTManagedRenderAligningShiftedBox extends RenderAligningShiftedBox
    implements Box<RenderAligningShiftedBox> {
  ...
  RenderAligningShiftedBox unwrap() => this;
  RenderAligningShiftedBox get vmObject => this;
  @override
...
void loadRenderAligningShiftedBox(
  ...
  table['renderAligningShiftedBox'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAligningShiftedBox(
  ...
  registerBoxer<RenderAligningShiftedBox>(boxer: (
      {required RenderAligningShiftedBox vmObject,

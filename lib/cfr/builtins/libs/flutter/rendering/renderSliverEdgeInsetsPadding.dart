...
class VMManagedRenderSliverEdgeInsetsPadding extends _36c2.VMManagedBox<_fb1e.RenderSliverEdgeInsetsPadding> {VMManagedRenderSliverEdgeInsetsPadding({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _fb1e.RenderSliverEdgeInsetsPadding vmObject;

 }

class RTManagedRenderSliverEdgeInsetsPadding extends _fb1e.RenderSliverEdgeInsetsPadding implements _36c2.Box<_fb1e.RenderSliverEdgeInsetsPadding> {RTManagedRenderSliverEdgeInsetsPadding({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_fb1e.RenderSliverEdgeInsetsPadding unwrap() => this;
_fb1e.RenderSliverEdgeInsetsPadding get vmObject => this;
...
void loadRenderSliverEdgeInsetsPadding({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverEdgeInsetsPadding'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverEdgeInsetsPadding(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_fb1e.RenderSliverEdgeInsetsPadding>(boxer: ({required _fb1e.RenderSliverEdgeInsetsPadding vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverEdgeInsetsPadding(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

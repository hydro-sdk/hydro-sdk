...
class VMManagedRenderSliverEdgeInsetsPadding
    extends VMManagedBox<RenderSliverEdgeInsetsPadding> {
  ...
  final RenderSliverEdgeInsetsPadding vmObject;
}

class RTManagedRenderSliverEdgeInsetsPadding
    extends RenderSliverEdgeInsetsPadding
    implements Box<RenderSliverEdgeInsetsPadding> {
  ...
  RenderSliverEdgeInsetsPadding unwrap() => this;
  RenderSliverEdgeInsetsPadding get vmObject => this;
  @override
...
void loadRenderSliverEdgeInsetsPadding(
  ...
  table['renderSliverEdgeInsetsPadding'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverEdgeInsetsPadding(
  ...
  registerBoxer<RenderSliverEdgeInsetsPadding>(boxer: (
      {required RenderSliverEdgeInsetsPadding vmObject,

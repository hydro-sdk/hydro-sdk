...
class VMManagedRenderSliverEdgeInsetsPadding
    extends _36c2.VMManagedBox<_fb1e.RenderSliverEdgeInsetsPadding> {
  VMManagedRenderSliverEdgeInsetsPadding(
...
class RTManagedRenderSliverEdgeInsetsPadding
    extends _fb1e.RenderSliverEdgeInsetsPadding
    implements _36c2.Box<_fb1e.RenderSliverEdgeInsetsPadding> {
  RTManagedRenderSliverEdgeInsetsPadding(
...
void loadRenderSliverEdgeInsetsPadding(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverEdgeInsetsPadding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverEdgeInsetsPadding(
  ...
  _36c2.registerBoxer<_fb1e.RenderSliverEdgeInsetsPadding>(boxer: (
      {required _fb1e.RenderSliverEdgeInsetsPadding vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverEdgeInsetsPadding(

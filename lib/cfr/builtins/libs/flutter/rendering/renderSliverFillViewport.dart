...
import 'package:flutter/src/rendering/sliver_fill.dart' as _793f;
...
class VMManagedRenderSliverFillViewport extends _36c2.VMManagedBox<_793f.RenderSliverFillViewport> {VMManagedRenderSliverFillViewport({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getItemExtent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.itemExtent,]; } );
table  [
'getViewportFraction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.viewportFraction,]; } );
table  [
'setViewportFraction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.viewportFraction=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
table  [
'indexOf'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.indexOf(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)),]; } );
table  [
'hitTestChildren'
...
vmObject.applyPaintTransform(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox, _fac9.dynamic>(luaCallerArguments  [
1
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugAssertChildListIsNonEmptyAndContiguous(),]; } );
table  [
...
table  [
'getDebugChildIntegrityEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugChildIntegrityEnabled,]; } );
table  [
'setDebugChildIntegrityEnabled'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.debugChildIntegrityEnabled=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _793f.RenderSliverFillViewport vmObject;

 }

class RTManagedRenderSliverFillViewport extends _793f.RenderSliverFillViewport implements _36c2.Box<_793f.RenderSliverFillViewport> {RTManagedRenderSliverFillViewport({required _fac9.double viewportFraction, required _35be.RenderSliverBoxChildManager childManager, required this.table, required this.hydroState}) : super(viewportFraction: viewportFraction,childManager: childManager) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getItemExtent'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.itemExtent];
});
table['_dart_getViewportFraction'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.viewportFraction];
});
table['_dart_setViewportFraction'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_indexToLayoutOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
_793f.RenderSliverFillViewport unwrap() => this;
_793f.RenderSliverFillViewport get vmObject => this;
@_fac9.override _fac9.double get itemExtent { 
_36c2.Closure closure = table["getItemExtent"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get viewportFraction { 
_36c2.Closure closure = table["getViewportFraction"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set viewportFraction(value) { 
_36c2.Closure closure = table["setViewportFraction"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double indexToLayoutOffset(itemExtent, index) { 
_36c2.Closure closure = table["indexToLayoutOffset"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.int getMinChildIndexForScrollOffset(scrollOffset, itemExtent) { 
_36c2.Closure closure = table["getMinChildIndexForScrollOffset"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int getMaxChildIndexForScrollOffset(scrollOffset, itemExtent) { 
...
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double computeMaxScrollOffset(constraints, itemExtent) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool addInitialChild({_fac9.int index = 0, _fac9.double layoutOffset = 0.0}) { 
_36c2.Closure closure = table["addInitialChild"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _be2e.RenderBox? insertAndLayoutLeadingChild(childConstraints, {_fac9.bool parentUsesSize = false}) { 
...
@_fac9.override _be2e.RenderBox? insertAndLayoutChild(childConstraints, {_fac9.bool parentUsesSize = false, _be2e.RenderBox? after}) { 
_36c2.Closure closure = table["insertAndLayoutChild"];
return _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void collectGarbage(leadingGarbage, trailingGarbage) { 
_36c2.Closure closure = table["collectGarbage"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int indexOf(child) { 
_36c2.Closure closure = table["indexOf"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double paintExtentOf(child) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool debugAssertChildListIsNonEmptyAndContiguous() { 
_36c2.Closure closure = table["debugAssertChildListIsNonEmptyAndContiguous"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
@_fac9.override _35be.RenderSliverBoxChildManager get childManager { 
_36c2.Closure closure = table["getChildManager"];
return _36c2.maybeUnBoxAndBuildArgument<_35be.RenderSliverBoxChildManager, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.bool get debugChildIntegrityEnabled { 
_36c2.Closure closure = table["getDebugChildIntegrityEnabled"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set debugChildIntegrityEnabled(enabled) { 
...
void loadRenderSliverFillViewport({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFillViewport'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverFillViewport(table: luaCallerArguments  [
0
], hydroState: hydroState, viewportFraction: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewportFraction'
] : null?.toDouble(), childManager: _36c2.maybeUnBoxAndBuildArgument<_35be.RenderSliverBoxChildManager, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'childManager'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_793f.RenderSliverFillViewport>(boxer: ({required _793f.RenderSliverFillViewport vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFillViewport(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

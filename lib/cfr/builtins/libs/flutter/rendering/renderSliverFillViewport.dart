...
class VMManagedRenderSliverFillViewport
    extends VMManagedBox<RenderSliverFillViewport> {
  VMManagedRenderSliverFillViewport(
    ...
    table['getViewportFraction'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.viewportFraction,
      ];
    });
    table['setViewportFraction'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.viewportFraction = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['performLayout'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  final RenderSliverFillViewport vmObject;
}

class RTManagedRenderSliverFillViewport extends RenderSliverFillViewport
    implements Box<RenderSliverFillViewport> {
  RTManagedRenderSliverFillViewport(
      {required double viewportFraction,
      required RenderSliverBoxChildManager childManager,
      required this.table,
      required this.hydroState})
      : super(viewportFraction: viewportFraction, childManager: childManager) {
    ...
    table['_dart_setViewportFraction'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.viewportFraction = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_indexToLayoutOffset'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        super.indexToLayoutOffset(
  ...
  RenderSliverFillViewport unwrap() => this;
  RenderSliverFillViewport get vmObject => this;
  @override
  ...
  double get viewportFraction {
    Closure closure = table["getViewportFraction"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set viewportFraction(value) {
    Closure closure = table["setViewportFraction"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double indexToLayoutOffset(itemExtent, index) {
    Closure closure = table["indexToLayoutOffset"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  int getMinChildIndexForScrollOffset(scrollOffset, itemExtent) {
    Closure closure = table["getMinChildIndexForScrollOffset"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  int getMaxChildIndexForScrollOffset(scrollOffset, itemExtent) {
  ...
  @override
  double computeMaxScrollOffset(constraints, itemExtent) {
  ...
  @override
  RenderBox? insertAndLayoutLeadingChild(childConstraints,
  ...
  @override
  RenderBox? insertAndLayoutChild(childConstraints,
...
void loadRenderSliverFillViewport(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderSliverFillViewport'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillViewport(
  ...
  registerBoxer<RenderSliverFillViewport>(boxer: (
      {required RenderSliverFillViewport vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderSliverFillViewport(

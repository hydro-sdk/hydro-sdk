...
class VMManagedRenderSliverFillViewport
    extends _36c2.VMManagedBox<_793f.RenderSliverFillViewport> {
  VMManagedRenderSliverFillViewport(
    ...
    table['getViewportFraction'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.viewportFraction,
      ];
    });
    table['setViewportFraction'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedRenderSliverFillViewport extends _793f.RenderSliverFillViewport
    implements _36c2.Box<_793f.RenderSliverFillViewport> {
  RTManagedRenderSliverFillViewport(
    ...
    table['_dart_getViewportFraction'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.viewportFraction];
    });
    table['_dart_setViewportFraction'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _fac9.double get viewportFraction {
...
void loadRenderSliverFillViewport(
  ...
  table['renderSliverFillViewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillViewport(
  ...
  _36c2.registerBoxer<_793f.RenderSliverFillViewport>(boxer: (
      {required _793f.RenderSliverFillViewport vmObject,

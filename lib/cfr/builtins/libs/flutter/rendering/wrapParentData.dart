...
class VMManagedWrapParentData extends _36c2.VMManagedBox<_d0b5.WrapParentData> {VMManagedWrapParentData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedWrapParentData extends _d0b5.WrapParentData implements _36c2.Box<_d0b5.WrapParentData> {RTManagedWrapParentData({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadWrapParentData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'wrapParentData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedWrapParentData(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_d0b5.WrapParentData>(boxer: ({required _d0b5.WrapParentData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedWrapParentData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

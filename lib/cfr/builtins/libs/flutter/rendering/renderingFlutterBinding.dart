...
class VMManagedRenderingFlutterBinding
    extends _36c2.VMManagedBox<_5551.RenderingFlutterBinding> {
...
class RTManagedRenderingFlutterBinding extends _5551.RenderingFlutterBinding
    implements _36c2.Box<_5551.RenderingFlutterBinding> {
  RTManagedRenderingFlutterBinding(
      {_be2e.RenderBox? root, required this.table, required this.hydroState})
      : super(root: root) {
...
void loadRenderingFlutterBinding(
  ...
  table['renderingFlutterBinding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderingFlutterBinding(
  ...
  _36c2.registerBoxer<_5551.RenderingFlutterBinding>(boxer: (
      {required _5551.RenderingFlutterBinding vmObject,

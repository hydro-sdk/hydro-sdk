...
class VMManagedAnnotatedRegionLayer
    extends VMManagedBox<AnnotatedRegionLayer<Object>> {
  VMManagedAnnotatedRegionLayer(
    ...
    table['size'] = maybeBoxObject<Size?>(
  ...
  final AnnotatedRegionLayer<Object> vmObject;
}

class RTManagedAnnotatedRegionLayer extends AnnotatedRegionLayer
    implements Box<AnnotatedRegionLayer> {
  RTManagedAnnotatedRegionLayer(dynamic value,
      {Offset? offset,
    ...
    table['size'] = maybeBoxObject<Size?>(
        object: this.size, hydroState: hydroState, table: HydroTable());
    table['offset'] = maybeBoxObject<Offset>(
        object: this.offset, hydroState: hydroState, table: HydroTable());
    table['opaque'] = this.opaque;
    table['debugCreator'] = maybeBoxObject<Object?>(
...
void loadAnnotatedRegionLayer(
    ...
    return [
      RTManagedAnnotatedRegionLayer(luaCallerArguments[1],
          ...
          opaque: luaCallerArguments.length >= 3
              ...
              : null,
          size: maybeUnBoxAndBuildArgument<Size?, dynamic>(
              luaCallerArguments.length >= 3
  ...
  registerBoxer<AnnotatedRegionLayer>(boxer: (
      {required AnnotatedRegionLayer vmObject,

...
class VMManagedAnnotatedRegionLayer extends _36c2.VMManagedBox<_7d70.AnnotatedRegionLayer<_fac9.Object>> {VMManagedAnnotatedRegionLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAnnotatedRegionLayer extends _7d70.AnnotatedRegionLayer implements _36c2.Box<_7d70.AnnotatedRegionLayer> {RTManagedAnnotatedRegionLayer(_fac9.Object value, {_a643.Offset? offset, required _fac9.bool opaque, _a643.Size? size, required this.table, required this.hydroState}) : super(value,offset: offset,opaque: opaque,size: size) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAnnotatedRegionLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'annotatedRegionLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedAnnotatedRegionLayer(luaCallerArguments  [
1
], table: luaCallerArguments  [
0
], hydroState: hydroState, offset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'offset'
] : null, parentState: hydroState), opaque: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'opaque'
] : null, size: _36c2.maybeUnBoxAndBuildArgument<_a643.Size?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'size'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.AnnotatedRegionLayer>(boxer: ({required _7d70.AnnotatedRegionLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAnnotatedRegionLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderBox extends _36c2.VMManagedBox<_be2e.RenderBox> {VMManagedRenderBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _be2e.RenderBox vmObject;

 }

class RTManagedRenderBox extends _be2e.RenderBox implements _36c2.Box<_be2e.RenderBox> {RTManagedRenderBox({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_be2e.RenderBox unwrap() => this;
_be2e.RenderBox get vmObject => this;
...
void loadRenderBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderBox(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_be2e.RenderBox>(boxer: ({required _be2e.RenderBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

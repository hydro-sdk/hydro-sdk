...
class VMManagedRenderBox extends VMManagedBox<RenderBox> {
  VMManagedRenderBox(
  ...
  final RenderBox vmObject;
}

class RTManagedRenderBox extends RenderBox implements Box<RenderBox> {
  ...
  RenderBox unwrap() => this;
  RenderBox get vmObject => this;
  @override
...
void loadRenderBox(
  ...
  registerBoxer<RenderBox>(boxer: (
      {required RenderBox vmObject,

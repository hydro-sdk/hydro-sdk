...
class VMManagedRenderBox extends _36c2.VMManagedBox<_be2e.RenderBox> {
  VMManagedRenderBox(
...
class RTManagedRenderBox extends _be2e.RenderBox
    implements _36c2.Box<_be2e.RenderBox> {
  RTManagedRenderBox({required this.table, required this.hydroState})
      : super() {
...
void loadRenderBox(
  ...
  table['renderBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderBox(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_be2e.RenderBox>(boxer: (
      {required _be2e.RenderBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderBox(

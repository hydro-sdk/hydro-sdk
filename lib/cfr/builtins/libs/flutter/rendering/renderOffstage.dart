...
class VMManagedRenderOffstage extends _36c2.VMManagedBox<_bf98.RenderOffstage> {VMManagedRenderOffstage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderOffstage vmObject;

 }

class RTManagedRenderOffstage extends _bf98.RenderOffstage implements _36c2.Box<_bf98.RenderOffstage> {RTManagedRenderOffstage({_be2e.RenderBox? child, required _fac9.bool offstage, required this.table, required this.hydroState}) : super(child: child,offstage: offstage) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderOffstage unwrap() => this;
_bf98.RenderOffstage get vmObject => this;
...
void loadRenderOffstage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderOffstage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderOffstage(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderOffstage>(boxer: ({required _bf98.RenderOffstage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderOffstage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

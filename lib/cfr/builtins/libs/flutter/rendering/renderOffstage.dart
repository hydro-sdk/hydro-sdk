...
class VMManagedRenderOffstage extends VMManagedBox<RenderOffstage> {
  VMManagedRenderOffstage(
  ...
  final RenderOffstage vmObject;
}

class RTManagedRenderOffstage extends RenderOffstage
    implements Box<RenderOffstage> {
  RTManagedRenderOffstage(
      {RenderBox? child,
      required bool offstage,
      required this.table,
      required this.hydroState})
      : super(child: child, offstage: offstage) {
  ...
  RenderOffstage unwrap() => this;
  RenderOffstage get vmObject => this;
  @override
  bool get offstage {
...
void loadRenderOffstage(
    {required HydroState hydroState, required HydroTable table}) {
  table['renderOffstage'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderOffstage(
  ...
  registerBoxer<RenderOffstage>(boxer: (
      {required RenderOffstage vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedRenderOffstage(

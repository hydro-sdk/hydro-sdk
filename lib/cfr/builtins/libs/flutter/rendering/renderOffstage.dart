...
class VMManagedRenderOffstage extends _36c2.VMManagedBox<_bf98.RenderOffstage> {
...
class RTManagedRenderOffstage extends _bf98.RenderOffstage
    implements _36c2.Box<_bf98.RenderOffstage> {
...
void loadRenderOffstage(
  ...
  table['renderOffstage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderOffstage(
  ...
  _36c2.registerBoxer<_bf98.RenderOffstage>(boxer: (
      {required _bf98.RenderOffstage vmObject,

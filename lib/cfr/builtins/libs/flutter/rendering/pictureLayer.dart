...
class VMManagedPictureLayer extends _36c2.VMManagedBox<_7d70.PictureLayer> {
  VMManagedPictureLayer(
    ...
    table['canvasBounds'] = _36c2.maybeBoxObject<_a643.Rect>(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getPicture'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.picture;
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_a643.Picture?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['setPicture'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.picture =
    ...
    table['getIsComplexHint'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isComplexHint,
      ];
    });
    table['setIsComplexHint'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.isComplexHint = (luaCallerArguments[1]);
      return [];
    });
    table['getWillChangeHint'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.willChangeHint,
      ];
    });
...
class RTManagedPictureLayer extends _7d70.PictureLayer
    implements _36c2.Box<_7d70.PictureLayer> {
  RTManagedPictureLayer(_a643.Rect canvasBounds$,
    ...
    table['canvasBounds'] = _36c2.maybeBoxObject(
        object: this.canvasBounds,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getPicture'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.picture];
    });
    table['_dart_setPicture'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.picture =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Picture?, _fac9.dynamic>(
              luaCallerArguments[1],
    ...
    table['_dart_getIsComplexHint'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getWillChangeHint'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _a643.Picture? get picture {
    _36c2.Closure closure = table["getPicture"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.Picture?, _fac9.dynamic>(
...
void loadPictureLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pictureLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPictureLayer(
  ...
  _36c2.registerBoxer<_7d70.PictureLayer>(boxer: (
      {required _7d70.PictureLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPictureLayer(

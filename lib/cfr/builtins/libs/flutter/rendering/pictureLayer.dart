...
class VMManagedPictureLayer extends _36c2.VMManagedBox<_7d70.PictureLayer> {VMManagedPictureLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'canvasBounds'
] = _36c2.maybeBoxObject<_a643.Rect>(object: vmObject.canvasBounds, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugCreator'
] = _36c2.maybeBoxObject<_fac9.Object?>(object: vmObject.debugCreator, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'getPicture'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.picture;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Picture?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setPicture'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.picture=(_36c2.maybeUnBoxAndBuildArgument<_a643.Picture?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
'getIsComplexHint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isComplexHint,]; } );
table  [
'setIsComplexHint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.isComplexHint=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getWillChangeHint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.willChangeHint,]; } );
table  [
'setWillChangeHint'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.willChangeHint=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _7d70.PictureLayer vmObject;

 }

class RTManagedPictureLayer extends _7d70.PictureLayer implements _36c2.Box<_7d70.PictureLayer> {RTManagedPictureLayer(_a643.Rect canvasBounds$, {required this.table, required this.hydroState}) : super(canvasBounds$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'canvasBounds'
] = _36c2.maybeBoxObject(object: this.canvasBounds, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugCreator'
...
table['_dart_setPicture'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.picture =
      (_36c2.maybeUnBoxAndBuildArgument<_a643.Picture?, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
});
table['_dart_getIsComplexHint'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.isComplexHint];
});
...
table['_dart_getWillChangeHint'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.willChangeHint];
});
table['_dart_setWillChangeHint'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.willChangeHint =
      (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
  return [];
...
_7d70.PictureLayer unwrap() => this;
_7d70.PictureLayer get vmObject => this;
@_fac9.override _a643.Picture? get picture { 
_36c2.Closure closure = table["getPicture"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Picture?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set picture(picture) { 
_36c2.Closure closure = table["setPicture"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get isComplexHint { 
_36c2.Closure closure = table["getIsComplexHint"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set isComplexHint(value) { 
_36c2.Closure closure = table["setIsComplexHint"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get willChangeHint { 
_36c2.Closure closure = table["getWillChangeHint"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set willChangeHint(value) { 
...
void loadPictureLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'pictureLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPictureLayer(_36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_7d70.PictureLayer>(boxer: ({required _7d70.PictureLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPictureLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

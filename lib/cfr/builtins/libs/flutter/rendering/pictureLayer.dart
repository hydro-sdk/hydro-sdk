...
class VMManagedPictureLayer extends VMManagedBox<PictureLayer> {
  VMManagedPictureLayer(
    ...
    table['setPicture'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.picture = (maybeUnBoxAndBuildArgument<Picture?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['getIsComplexHint'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
  ...
  final PictureLayer vmObject;
}

class RTManagedPictureLayer extends PictureLayer implements Box<PictureLayer> {
  RTManagedPictureLayer(Rect canvasBounds$,
    ...
    table['_dart_setPicture'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.picture = (maybeUnBoxAndBuildArgument<Picture?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setIsComplexHint'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.isComplexHint = (luaCallerArguments[1]);
      return [];
    });
  ...
  PictureLayer unwrap() => this;
  PictureLayer get vmObject => this;
  @override
  Picture? get picture {
    Closure closure = table["getPicture"];
  ...
  bool get isComplexHint {
    Closure closure = table["getIsComplexHint"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  bool get willChangeHint {
    Closure closure = table["getWillChangeHint"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadPictureLayer(
  ...
  registerBoxer<PictureLayer>(boxer: (
      {required PictureLayer vmObject,

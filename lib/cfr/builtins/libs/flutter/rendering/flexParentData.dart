...
class VMManagedFlexParentData extends _36c2.VMManagedBox<_7374.FlexParentData> {
...
class RTManagedFlexParentData extends _7374.FlexParentData
    implements _36c2.Box<_7374.FlexParentData> {
  RTManagedFlexParentData({required this.table, required this.hydroState})
    ...
    table['flex'] = _36c2.maybeBoxObject(
        object: flex, hydroState: hydroState, table: _36c2.HydroTable());
    table['fit'] = _7374.FlexFit.values.indexWhere((x) {
      return x == fit;
    });
...
void loadFlexParentData(
  ...
  table['flexParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_7374.FlexParentData>(boxer: (
      {required _7374.FlexParentData vmObject,

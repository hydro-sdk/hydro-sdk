...
class VMManagedShapeBorderClipper extends _36c2.VMManagedBox<_bf98.ShapeBorderClipper> {VMManagedShapeBorderClipper({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getClip'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Path>(object: vmObject.getClip(_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'shouldReclip'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldReclip(_36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>, _a643.Path>(luaCallerArguments  [
1
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Rect>(object: vmObject.getApproximateClipRect(_36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'toString'
...
class RTManagedShapeBorderClipper extends _bf98.ShapeBorderClipper implements _36c2.Box<_bf98.ShapeBorderClipper> {RTManagedShapeBorderClipper({_a643.TextDirection? textDirection, required _6be9.ShapeBorder shape, required this.table, required this.hydroState}) : super(textDirection: textDirection,shape: shape) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _a643.Path getClip(size) { 
...
@_fac9.override _fac9.bool shouldReclip(oldClipper) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Rect getApproximateClipRect(size) { 
...
void loadShapeBorderClipper({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shapeBorderClipper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedShapeBorderClipper(table: luaCallerArguments  [
0
], hydroState: hydroState, textDirection: _36c2.maybeUnBoxEnum(values: _a643.TextDirection.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textDirection'
] : null), shape: _36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shape'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.ShapeBorderClipper>(boxer: ({required _bf98.ShapeBorderClipper vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShapeBorderClipper(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

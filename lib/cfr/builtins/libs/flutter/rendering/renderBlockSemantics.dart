...
class VMManagedRenderBlockSemantics extends VMManagedBox<RenderBlockSemantics> {
  ...
  final RenderBlockSemantics vmObject;
}

class RTManagedRenderBlockSemantics extends RenderBlockSemantics
    implements Box<RenderBlockSemantics> {
  RTManagedRenderBlockSemantics(
    ...
    table['_dart_setBlocking'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.blocking = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderBlockSemantics unwrap() => this;
  RenderBlockSemantics get vmObject => this;
  @override
  bool get blocking {
    Closure closure = table["getBlocking"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set blocking(bool value) {
    Closure closure = table["setBlocking"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderBlockSemantics(
  ...
  registerBoxer<RenderBlockSemantics>(boxer: (
      {required RenderBlockSemantics vmObject,

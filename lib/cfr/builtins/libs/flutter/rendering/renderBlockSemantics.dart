...
class VMManagedRenderBlockSemantics
    extends _36c2.VMManagedBox<_bf98.RenderBlockSemantics> {
  VMManagedRenderBlockSemantics(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getBlocking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.blocking,
      ];
    });
    table['setBlocking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.blocking = (luaCallerArguments[1]);
      return [];
    });
...
class RTManagedRenderBlockSemantics extends _bf98.RenderBlockSemantics
    implements _36c2.Box<_bf98.RenderBlockSemantics> {
  RTManagedRenderBlockSemantics(
      {required _fac9.bool blocking,
      _be2e.RenderBox? child,
      required this.table,
      required this.hydroState})
      : super(blocking: blocking, child: child) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getBlocking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.blocking];
    });
    table['_dart_setBlocking'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.blocking =
...
void loadRenderBlockSemantics(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderBlockSemantics'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderBlockSemantics(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          blocking: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['blocking']
              : null,
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_bf98.RenderBlockSemantics>(boxer: (
      {required _bf98.RenderBlockSemantics vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderBlockSemantics(

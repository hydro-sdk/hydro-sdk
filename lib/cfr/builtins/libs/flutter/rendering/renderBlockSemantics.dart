...
class VMManagedRenderBlockSemantics extends _36c2.VMManagedBox<_bf98.RenderBlockSemantics> {VMManagedRenderBlockSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getBlocking'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.blocking,]; } );
table  [
'setBlocking'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.blocking=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
final _bf98.RenderBlockSemantics vmObject;

 }

class RTManagedRenderBlockSemantics extends _bf98.RenderBlockSemantics implements _36c2.Box<_bf98.RenderBlockSemantics> {RTManagedRenderBlockSemantics({required _fac9.bool blocking, _be2e.RenderBox? child, required this.table, required this.hydroState}) : super(blocking: blocking,child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getBlocking'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.blocking];
});
table['_dart_setBlocking'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.blocking = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
...
_bf98.RenderBlockSemantics unwrap() => this;
_bf98.RenderBlockSemantics get vmObject => this;
@_fac9.override _fac9.bool get blocking { 
_36c2.Closure closure = table["getBlocking"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set blocking(value) { 
_36c2.Closure closure = table["setBlocking"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderBlockSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderBlockSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderBlockSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderBlockSemantics>(boxer: ({required _bf98.RenderBlockSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderBlockSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

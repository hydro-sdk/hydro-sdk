...
class VMManagedFlexColumnWidth
    extends _36c2.VMManagedBox<_31d2.FlexColumnWidth> {
  VMManagedFlexColumnWidth(
    ...
    table['flex'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.flex(_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedFlexColumnWidth extends _31d2.FlexColumnWidth
    implements _36c2.Box<_31d2.FlexColumnWidth> {
  RTManagedFlexColumnWidth(_fac9.double value$,
...
void loadFlexColumnWidth(
  ...
  table['flexColumnWidth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_31d2.FlexColumnWidth>(boxer: (
      {required _31d2.FlexColumnWidth vmObject,

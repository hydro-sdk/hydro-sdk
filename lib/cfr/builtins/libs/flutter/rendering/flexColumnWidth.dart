...
class VMManagedFlexColumnWidth extends _36c2.VMManagedBox<_31d2.FlexColumnWidth> {VMManagedFlexColumnWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'flex'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.flex(_36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_be2e.RenderBox>, _be2e.RenderBox>(luaCallerArguments  [
1
...
final _31d2.FlexColumnWidth vmObject;

 }

class RTManagedFlexColumnWidth extends _31d2.FlexColumnWidth implements _36c2.Box<_31d2.FlexColumnWidth> {RTManagedFlexColumnWidth(_fac9.double value$, {required this.table, required this.hydroState}) : super(value$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_31d2.FlexColumnWidth unwrap() => this;
_31d2.FlexColumnWidth get vmObject => this;
...
void loadFlexColumnWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flexColumnWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedFlexColumnWidth(luaCallerArguments  [
1
]?.toDouble(), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_31d2.FlexColumnWidth>(boxer: ({required _31d2.FlexColumnWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlexColumnWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

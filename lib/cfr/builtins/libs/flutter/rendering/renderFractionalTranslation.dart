...
class VMManagedRenderFractionalTranslation
    extends _36c2.VMManagedBox<_bf98.RenderFractionalTranslation> {
  VMManagedRenderFractionalTranslation(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getTranslation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Offset>(
            object: vmObject.translation,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setTranslation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.translation =
...
class RTManagedRenderFractionalTranslation
    extends _bf98.RenderFractionalTranslation
    implements _36c2.Box<_bf98.RenderFractionalTranslation> {
  RTManagedRenderFractionalTranslation(
      {_be2e.RenderBox? child,
      required _fac9.bool transformHitTests,
      required _a643.Offset translation,
      required this.table,
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getTranslation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.translation];
    });
    table['_dart_setTranslation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.translation =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadRenderFractionalTranslation(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderFractionalTranslation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFractionalTranslation(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          transformHitTests: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['transformHitTests']
              : null,
          translation:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['translation']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_bf98.RenderFractionalTranslation>(boxer: (
      {required _bf98.RenderFractionalTranslation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderFractionalTranslation(

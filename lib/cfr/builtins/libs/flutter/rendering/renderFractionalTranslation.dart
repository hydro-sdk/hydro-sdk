...
class VMManagedRenderFractionalTranslation
    extends VMManagedBox<RenderFractionalTranslation> {
  VMManagedRenderFractionalTranslation(
    ...
    table['setTranslation'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.translation = (maybeUnBoxAndBuildArgument<Offset, dynamic>(
  ...
  final RenderFractionalTranslation vmObject;
}

class RTManagedRenderFractionalTranslation extends RenderFractionalTranslation
    implements Box<RenderFractionalTranslation> {
  RTManagedRenderFractionalTranslation(
    ...
    table['_dart_setTranslation'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.translation = (maybeUnBoxAndBuildArgument<Offset, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderFractionalTranslation unwrap() => this;
  RenderFractionalTranslation get vmObject => this;
  @override
  Offset get translation {
    Closure closure = table["getTranslation"];
  ...
  @override
  void set translation(Offset value) {
    Closure closure = table["setTranslation"];
...
void loadRenderFractionalTranslation(
  ...
  table['renderFractionalTranslation'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderFractionalTranslation(
          ...
          transformHitTests: luaCallerArguments.length >= 2
              ...
              : null,
          translation: maybeUnBoxAndBuildArgument<Offset, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderFractionalTranslation>(boxer: (
      {required RenderFractionalTranslation vmObject,

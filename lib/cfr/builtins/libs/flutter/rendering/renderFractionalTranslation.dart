...
class VMManagedRenderFractionalTranslation extends _36c2.VMManagedBox<_bf98.RenderFractionalTranslation> {VMManagedRenderFractionalTranslation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getTranslation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Offset>(object: vmObject.translation, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setTranslation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.translation=(_36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments  [
1
...
final _bf98.RenderFractionalTranslation vmObject;

 }

class RTManagedRenderFractionalTranslation extends _bf98.RenderFractionalTranslation implements _36c2.Box<_bf98.RenderFractionalTranslation> {RTManagedRenderFractionalTranslation({_be2e.RenderBox? child, required _fac9.bool transformHitTests, required _a643.Offset translation, required this.table, required this.hydroState}) : super(child: child,transformHitTests: transformHitTests,translation: translation) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getTranslation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.translation];
});
table['_dart_setTranslation'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.translation =
...
_bf98.RenderFractionalTranslation unwrap() => this;
_bf98.RenderFractionalTranslation get vmObject => this;
@_fac9.override _a643.Offset get translation { 
_36c2.Closure closure = table["getTranslation"];
...
@_fac9.override void set translation(value) { 
_36c2.Closure closure = table["setTranslation"];
...
void loadRenderFractionalTranslation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderFractionalTranslation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderFractionalTranslation(table: luaCallerArguments  [
0
...
'transformHitTests'
] : null, translation: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'translation'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderFractionalTranslation>(boxer: ({required _bf98.RenderFractionalTranslation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderFractionalTranslation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

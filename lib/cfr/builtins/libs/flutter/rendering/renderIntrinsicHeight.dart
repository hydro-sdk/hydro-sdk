...
class VMManagedRenderIntrinsicHeight extends _36c2.VMManagedBox<_bf98.RenderIntrinsicHeight> {VMManagedRenderIntrinsicHeight({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRenderIntrinsicHeight extends _bf98.RenderIntrinsicHeight implements _36c2.Box<_bf98.RenderIntrinsicHeight> {RTManagedRenderIntrinsicHeight({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRenderIntrinsicHeight({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderIntrinsicHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderIntrinsicHeight(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderIntrinsicHeight>(boxer: ({required _bf98.RenderIntrinsicHeight vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderIntrinsicHeight(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

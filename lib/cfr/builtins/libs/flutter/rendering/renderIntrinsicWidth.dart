...
class VMManagedRenderIntrinsicWidth
    extends _36c2.VMManagedBox<_bf98.RenderIntrinsicWidth> {
  VMManagedRenderIntrinsicWidth(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getStepWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.stepWidth;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setStepWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.stepWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getStepHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.stepHeight;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setStepHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.stepHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
...
class RTManagedRenderIntrinsicWidth extends _bf98.RenderIntrinsicWidth
    implements _36c2.Box<_bf98.RenderIntrinsicWidth> {
  RTManagedRenderIntrinsicWidth(
      {_be2e.RenderBox? child,
      _fac9.double? stepHeight,
      _fac9.double? stepWidth,
      required this.table,
      required this.hydroState})
      : super(child: child, stepHeight: stepHeight, stepWidth: stepWidth) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getStepWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.stepWidth];
    });
    table['_dart_setStepWidth'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.stepWidth =
    ...
    table['_dart_getStepHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.stepHeight];
    });
    table['_dart_setStepHeight'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.stepHeight =
          (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadRenderIntrinsicWidth(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderIntrinsicWidth'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderIntrinsicWidth(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          stepHeight: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['stepHeight']
              : null?.toDouble(),
          stepWidth: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['stepWidth']
              : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_bf98.RenderIntrinsicWidth>(boxer: (
      {required _bf98.RenderIntrinsicWidth vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderIntrinsicWidth(

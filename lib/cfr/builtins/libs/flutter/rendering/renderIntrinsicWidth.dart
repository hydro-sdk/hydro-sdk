...
class VMManagedRenderIntrinsicWidth extends _36c2.VMManagedBox<_bf98.RenderIntrinsicWidth> {VMManagedRenderIntrinsicWidth({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getStepWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.stepWidth;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setStepWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.stepWidth=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getStepHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.stepHeight;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setStepHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.stepHeight=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
final _bf98.RenderIntrinsicWidth vmObject;

 }

class RTManagedRenderIntrinsicWidth extends _bf98.RenderIntrinsicWidth implements _36c2.Box<_bf98.RenderIntrinsicWidth> {RTManagedRenderIntrinsicWidth({_be2e.RenderBox? child, _fac9.double? stepHeight, _fac9.double? stepWidth, required this.table, required this.hydroState}) : super(child: child,stepHeight: stepHeight,stepWidth: stepWidth) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getStepWidth'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.stepWidth];
});
table['_dart_setStepWidth'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.stepWidth =
...
table['_dart_getStepHeight'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.stepHeight];
});
table['_dart_setStepHeight'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.stepHeight =
      (_36c2.maybeUnBoxAndBuildArgument<_fac9.double?, _fac9.dynamic>(
          luaCallerArguments[1],
...
_bf98.RenderIntrinsicWidth unwrap() => this;
_bf98.RenderIntrinsicWidth get vmObject => this;
@_fac9.override _fac9.double? get stepWidth { 
_36c2.Closure closure = table["getStepWidth"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set stepWidth(value) { 
_36c2.Closure closure = table["setStepWidth"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.double? get stepHeight { 
_36c2.Closure closure = table["getStepHeight"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set stepHeight(value) { 
_36c2.Closure closure = table["setStepHeight"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderIntrinsicWidth({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderIntrinsicWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderIntrinsicWidth(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), stepHeight: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'stepHeight'
] : null?.toDouble(), stepWidth: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'stepWidth'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_bf98.RenderIntrinsicWidth>(boxer: ({required _bf98.RenderIntrinsicWidth vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderIntrinsicWidth(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

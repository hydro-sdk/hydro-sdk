...
class VMManagedRenderIntrinsicWidth extends VMManagedBox<RenderIntrinsicWidth> {
  ...
  final RenderIntrinsicWidth vmObject;
}

class RTManagedRenderIntrinsicWidth extends RenderIntrinsicWidth
    implements Box<RenderIntrinsicWidth> {
  RTManagedRenderIntrinsicWidth(
    ...
    table['_dart_setStepWidth'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.stepWidth = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setStepHeight'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.stepHeight = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  RenderIntrinsicWidth unwrap() => this;
  RenderIntrinsicWidth get vmObject => this;
  @override
  double? get stepWidth {
    Closure closure = table["getStepWidth"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set stepWidth(value) {
    Closure closure = table["setStepWidth"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  double? get stepHeight {
    Closure closure = table["getStepHeight"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set stepHeight(value) {
    Closure closure = table["setStepHeight"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderIntrinsicWidth(
  ...
  registerBoxer<RenderIntrinsicWidth>(boxer: (
      {required RenderIntrinsicWidth vmObject,

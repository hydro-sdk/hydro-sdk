...
class VMManagedRenderIndexedSemantics extends _36c2.VMManagedBox<_bf98.RenderIndexedSemantics> {VMManagedRenderIndexedSemantics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderIndexedSemantics vmObject;

 }

class RTManagedRenderIndexedSemantics extends _bf98.RenderIndexedSemantics implements _36c2.Box<_bf98.RenderIndexedSemantics> {RTManagedRenderIndexedSemantics({_be2e.RenderBox? child, required _fac9.int index, required this.table, required this.hydroState}) : super(child: child,index: index) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderIndexedSemantics unwrap() => this;
_bf98.RenderIndexedSemantics get vmObject => this;
...
void loadRenderIndexedSemantics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderIndexedSemantics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderIndexedSemantics(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderIndexedSemantics>(boxer: ({required _bf98.RenderIndexedSemantics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderIndexedSemantics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderIndexedSemantics
    extends VMManagedBox<RenderIndexedSemantics> {
  ...
  final RenderIndexedSemantics vmObject;
}

class RTManagedRenderIndexedSemantics extends RenderIndexedSemantics
    implements Box<RenderIndexedSemantics> {
  RTManagedRenderIndexedSemantics(
    ...
    table['_dart_setIndex'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.index = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderIndexedSemantics unwrap() => this;
  RenderIndexedSemantics get vmObject => this;
  @override
  int get index {
    Closure closure = table["getIndex"];
...
void loadRenderIndexedSemantics(
  ...
  registerBoxer<RenderIndexedSemantics>(boxer: (
      {required RenderIndexedSemantics vmObject,

...
class VMManagedSliverGridDelegateWithMaxCrossAxisExtent
    extends _36c2.VMManagedBox<_a3c0.SliverGridDelegateWithMaxCrossAxisExtent> {
...
class RTManagedSliverGridDelegateWithMaxCrossAxisExtent
    extends _a3c0.SliverGridDelegateWithMaxCrossAxisExtent
    implements _36c2.Box<_a3c0.SliverGridDelegateWithMaxCrossAxisExtent> {
  RTManagedSliverGridDelegateWithMaxCrossAxisExtent(
      ...
      required _fac9.double maxCrossAxisExtent,
      required this.table,
    ...
    table['maxCrossAxisExtent'] = _36c2.maybeBoxObject(
        object: this.maxCrossAxisExtent,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadSliverGridDelegateWithMaxCrossAxisExtent(
  ...
  table['sliverGridDelegateWithMaxCrossAxisExtent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliverGridDelegateWithMaxCrossAxisExtent(
  ...
  _36c2.registerBoxer<_a3c0.SliverGridDelegateWithMaxCrossAxisExtent>(boxer: (
      {required _a3c0.SliverGridDelegateWithMaxCrossAxisExtent vmObject,

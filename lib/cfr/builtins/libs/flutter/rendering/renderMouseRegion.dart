...
class VMManagedRenderMouseRegion
    extends _36c2.VMManagedBox<_bf98.RenderMouseRegion> {
  VMManagedRenderMouseRegion(
    ...
    table['setCursor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.cursor =
...
class RTManagedRenderMouseRegion extends _bf98.RenderMouseRegion
    implements _36c2.Box<_bf98.RenderMouseRegion> {
  RTManagedRenderMouseRegion(
      ...
      void Function(_0e77.PointerHoverEvent event)? onHover,
    ...
    table['_dart_setCursor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.cursor =
          (_36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursor, _fac9.dynamic>(
              luaCallerArguments[1],
...
void loadRenderMouseRegion(
  ...
  table['renderMouseRegion'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_bf98.RenderMouseRegion>(boxer: (
      {required _bf98.RenderMouseRegion vmObject,

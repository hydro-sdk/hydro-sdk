...
class VMManagedRenderMouseRegion extends _36c2.VMManagedBox<_bf98.RenderMouseRegion> {VMManagedRenderMouseRegion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'setOpaque'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.opaque=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
table  [
'setCursor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.cursor=(_36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursor, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
final _bf98.RenderMouseRegion vmObject;

 }

class RTManagedRenderMouseRegion extends _bf98.RenderMouseRegion implements _36c2.Box<_bf98.RenderMouseRegion> {RTManagedRenderMouseRegion({_be2e.RenderBox? child, required _fd33.MouseCursor cursor, void Function(_0e77.PointerEnterEvent event)? onEnter, void Function(_0e77.PointerExitEvent event)? onExit, void Function(_0e77.PointerHoverEvent event)? onHover, required _fac9.bool opaque, required _fac9.bool validForMouseTracker, required this.table, required this.hydroState}) : super(child: child,cursor: cursor,onEnter: onEnter,onExit: onExit,onHover: onHover,opaque: opaque,validForMouseTracker: validForMouseTracker) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'cursor'
] = _36c2.maybeBoxObject(object: this.cursor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'validForMouseTracker'
] = _36c2.maybeBoxObject(object: this.validForMouseTracker, hydroState: hydroState, table: _36c2.HydroTable());
...
table['_dart_setOpaque'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.opaque = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_bf98.RenderMouseRegion unwrap() => this;
_bf98.RenderMouseRegion get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set opaque(value) { 
...
@_fac9.override void set cursor(value) { 
_36c2.Closure closure = table["setCursor"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderMouseRegion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderMouseRegion'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonHover=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onHover'
] : null;
...
return  [RTManagedRenderMouseRegion(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), cursor: _36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursor, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'cursor'
] : null, parentState: hydroState), onEnter: unpackedonEnter != null ? (event) => unpackedonEnter.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onExit: unpackedonExit != null ? (event) => unpackedonExit.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onHover: unpackedonHover != null ? (event) => unpackedonHover.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , opaque: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'opaque'
] : null, validForMouseTracker: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'validForMouseTracker'
] : null)]; } );
_36c2.registerBoxer<_bf98.RenderMouseRegion>(boxer: ({required _bf98.RenderMouseRegion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderMouseRegion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

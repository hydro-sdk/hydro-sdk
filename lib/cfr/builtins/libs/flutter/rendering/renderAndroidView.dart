...
class VMManagedRenderAndroidView extends VMManagedBox<RenderAndroidView> {
  VMManagedRenderAndroidView(
    ...
    table['setViewController'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.viewController =
          (maybeUnBoxAndBuildArgument<AndroidViewController, dynamic>(
    ...
    table['updateGestureRecognizers'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.updateGestureRecognizers(maybeUnBoxAndBuildArgument<
              Set<Factory<OneSequenceGestureRecognizer>>,
              Factory<OneSequenceGestureRecognizer>>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['setHitTestBehavior'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.hitTestBehavior = (maybeUnBoxEnum(
    ...
    table['getCursor'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<MouseCursor>(
            object: vmObject.cursor,
            hydroState: hydroState,
            table: HydroTable()),
      ];
    });
    table['getValidForMouseTracker'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
  ...
  final RenderAndroidView vmObject;
}

class RTManagedRenderAndroidView extends RenderAndroidView
    implements Box<RenderAndroidView> {
  RTManagedRenderAndroidView(
    ...
    table['_dart_updateGestureRecognizers'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.updateGestureRecognizers(maybeUnBoxAndBuildArgument<
              Set<Factory<OneSequenceGestureRecognizer>>,
              Factory<OneSequenceGestureRecognizer>>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    ...
    table['_dart_setHitTestBehavior'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.hitTestBehavior = (maybeUnBoxEnum(
          values: PlatformViewHitTestBehavior.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  @override
  void set viewController(AndroidViewController viewController) {
    Closure closure = table["setViewController"];
  ...
  void updateGestureRecognizers(Set gestureRecognizers) {
    Closure closure = table["updateGestureRecognizers"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  void set hitTestBehavior(PlatformViewHitTestBehavior value) {
    Closure closure = table["setHitTestBehavior"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  MouseCursor get cursor {
    Closure closure = table["getCursor"];
  ...
  bool get validForMouseTracker {
    Closure closure = table["getValidForMouseTracker"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderAndroidView(
      ...
      RTManagedRenderAndroidView(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          gestureRecognizers: maybeUnBoxAndBuildArgument<
                  Set<Factory<OneSequenceGestureRecognizer>>,
              ...
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          hitTestBehavior: maybeUnBoxEnum(
              values: PlatformViewHitTestBehavior.values,
              boxedEnum: luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderAndroidView>(boxer: (
      {required RenderAndroidView vmObject,

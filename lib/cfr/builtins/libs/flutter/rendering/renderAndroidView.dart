...
class VMManagedRenderAndroidView
    extends _36c2.VMManagedBox<_6ecd.RenderAndroidView> {
  VMManagedRenderAndroidView(
    ...
    table['getViewController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_40e3.AndroidViewController>(
            object: vmObject.viewController,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setViewController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.viewController = (_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['updateGestureRecognizers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.updateGestureRecognizers(_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['setHitTestBehavior'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.hitTestBehavior = (_36c2.maybeUnBoxEnum(
          values: _6ecd.PlatformViewHitTestBehavior.values,
          boxedEnum: luaCallerArguments[1]));
      return [];
    });
    table['getOnEnter'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.onEnter;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['getOnExit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.onExit;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['getCursor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['getValidForMouseTracker'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
...
class RTManagedRenderAndroidView extends _6ecd.RenderAndroidView
    implements _36c2.Box<_6ecd.RenderAndroidView> {
  RTManagedRenderAndroidView(
      {required _a643.Clip clipBehavior,
      required _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>
          gestureRecognizers,
      required _6ecd.PlatformViewHitTestBehavior hitTestBehavior,
      required _40e3.AndroidViewController viewController,
      required this.table,
    ...
    table['cursor'] = _36c2.maybeBoxObject(
        object: cursor, hydroState: hydroState, table: _36c2.HydroTable());
    table['validForMouseTracker'] = _36c2.maybeBoxObject(
        object: validForMouseTracker,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getViewController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.viewController];
    });
    table['_dart_setViewController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_updateGestureRecognizers'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_setHitTestBehavior'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getCursor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.cursor];
    });
    table['_dart_getValidForMouseTracker'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _40e3.AndroidViewController get viewController {
    _36c2.Closure closure = table["getViewController"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  void set viewController(viewController) {
  ...
  @_fac9.override
  void updateGestureRecognizers(gestureRecognizers) {
  ...
  @_fac9.override
  void set hitTestBehavior(value) {
    _36c2.Closure closure = table["setHitTestBehavior"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fd33.MouseCursor get cursor {
  ...
  @_fac9.override
  _fac9.bool get validForMouseTracker {
...
void loadRenderAndroidView(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderAndroidView'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderAndroidView(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          gestureRecognizers: _36c2.maybeUnBoxAndBuildArgument<
                  _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>,
                  _288a.Factory<_02d2.OneSequenceGestureRecognizer>>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['gestureRecognizers']
                  : null,
              parentState: hydroState),
          hitTestBehavior: _36c2.maybeUnBoxEnum(
              values: _6ecd.PlatformViewHitTestBehavior.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['hitTestBehavior']
                  : null),
          viewController:
              _36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['viewController'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_6ecd.RenderAndroidView>(boxer: (
      {required _6ecd.RenderAndroidView vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderAndroidView(

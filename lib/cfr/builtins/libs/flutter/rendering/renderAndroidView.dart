...
class VMManagedRenderAndroidView extends _36c2.VMManagedBox<_6ecd.RenderAndroidView> {VMManagedRenderAndroidView({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getViewController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_40e3.AndroidViewController>(object: vmObject.viewController, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setViewController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.viewController=(_36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(luaCallerArguments  [
1
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.updateGestureRecognizers(_36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>, _288a.Factory<_02d2.OneSequenceGestureRecognizer>>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
table  [
'setHitTestBehavior'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.hitTestBehavior=(_36c2.maybeUnBoxEnum(values: _6ecd.PlatformViewHitTestBehavior.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
'getOnEnter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.onEnter;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getOnExit'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.onExit;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getCursor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fd33.MouseCursor>(object: vmObject.cursor, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
...
final _6ecd.RenderAndroidView vmObject;

 }

class RTManagedRenderAndroidView extends _6ecd.RenderAndroidView implements _36c2.Box<_6ecd.RenderAndroidView> {RTManagedRenderAndroidView({required _a643.Clip clipBehavior, required _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>> gestureRecognizers, required _6ecd.PlatformViewHitTestBehavior hitTestBehavior, required _40e3.AndroidViewController viewController, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,gestureRecognizers: gestureRecognizers,hitTestBehavior: hitTestBehavior,viewController: viewController) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setViewController'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.viewController = (_36c2.maybeUnBoxAndBuildArgument<
      _40e3.AndroidViewController,
...
table['_dart_updateGestureRecognizers'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.updateGestureRecognizers(_36c2.maybeUnBoxAndBuildArgument<
          _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>,
          _288a.Factory<_02d2.OneSequenceGestureRecognizer>>(
...
table['_dart_setHitTestBehavior'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.hitTestBehavior = (_36c2.maybeUnBoxEnum(
      values: _6ecd.PlatformViewHitTestBehavior.values,
...
_6ecd.RenderAndroidView unwrap() => this;
_6ecd.RenderAndroidView get vmObject => this;
@_fac9.override _40e3.AndroidViewController get viewController { 
_36c2.Closure closure = table["getViewController"];
return _36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set viewController(viewController) { 
_36c2.Closure closure = table["setViewController"];
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void updateGestureRecognizers(gestureRecognizers) { 
_36c2.Closure closure = table["updateGestureRecognizers"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set hitTestBehavior(value) { 
_36c2.Closure closure = table["setHitTestBehavior"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderAndroidView({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderAndroidView'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRenderAndroidView(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), gestureRecognizers: _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>>, _288a.Factory<_02d2.OneSequenceGestureRecognizer>>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'gestureRecognizers'
...
'hitTestBehavior'
] : null), viewController: _36c2.maybeUnBoxAndBuildArgument<_40e3.AndroidViewController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewController'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_6ecd.RenderAndroidView>(boxer: ({required _6ecd.RenderAndroidView vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderAndroidView(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

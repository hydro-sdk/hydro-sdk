...
class VMManagedRevealedOffset extends _36c2.VMManagedBox<_01f8.RevealedOffset> {
...
class RTManagedRevealedOffset extends _01f8.RevealedOffset
    implements _36c2.Box<_01f8.RevealedOffset> {
  RTManagedRevealedOffset(
      {required _fac9.double offset,
...
void loadRevealedOffset(
  ...
  table['revealedOffset'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRevealedOffset(
  ...
  _36c2.registerBoxer<_01f8.RevealedOffset>(boxer: (
      {required _01f8.RevealedOffset vmObject,

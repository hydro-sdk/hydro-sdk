...
class VMManagedRenderParagraph extends _36c2.VMManagedBox<_105e.RenderParagraph> {VMManagedRenderParagraph({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getText'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_b761.InlineSpan>(object: vmObject.text, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setText'
...
table  [
'getSoftWrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.softWrap,]; } );
table  [
'setSoftWrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.softWrap=(luaCallerArguments  [
1
]);
return []; } );
table  [
'getOverflow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_fe5a.TextOverflow.values.indexWhere((x) { return x == vmObject.overflow; } ),]; } );
table  [
'setOverflow'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.overflow=(_36c2.maybeUnBoxEnum(values: _fe5a.TextOverflow.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getFullHeightForCaret(_36c2.maybeUnBoxAndBuildArgument<_a643.TextPosition, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'getTextSize'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.Size>(object: vmObject.textSize, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
...
final _105e.RenderParagraph vmObject;

 }

class RTManagedRenderParagraph extends _105e.RenderParagraph implements _36c2.Box<_105e.RenderParagraph> {RTManagedRenderParagraph(_b761.InlineSpan text$, {_fac9.List<_be2e.RenderBox>? children, _a643.Locale? locale, _fac9.int? maxLines, required _fe5a.TextOverflow overflow, required _fac9.bool softWrap, _ced4.StrutStyle? strutStyle, required _a643.TextAlign textAlign, _a643.TextHeightBehavior? textHeightBehavior, required _fac9.double textScaleFactor, required _fe5a.TextWidthBasis textWidthBasis, required _a643.TextDirection textDirection, required this.table, required this.hydroState}) : super(text$,children: children,locale: locale,maxLines: maxLines,overflow: overflow,softWrap: softWrap,strutStyle: strutStyle,textAlign: textAlign,textHeightBehavior: textHeightBehavior,textScaleFactor: textScaleFactor,textWidthBasis: textWidthBasis,textDirection: textDirection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getSoftWrap'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.softWrap];
});
table['_dart_setSoftWrap'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.softWrap = (_36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_getOverflow'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.overflow];
});
table['_dart_setOverflow'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.overflow = (_36c2.maybeUnBoxEnum(
      values: _fe5a.TextOverflow.values, boxedEnum: luaCallerArguments[1]));
  return [];
});
...
_105e.RenderParagraph unwrap() => this;
_105e.RenderParagraph get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get softWrap { 
_36c2.Closure closure = table["getSoftWrap"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set softWrap(value) { 
_36c2.Closure closure = table["setSoftWrap"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fe5a.TextOverflow get overflow { 
_36c2.Closure closure = table["getOverflow"];
return _36c2.maybeUnBoxEnum(values: _fe5a.TextOverflow.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set overflow(value) { 
_36c2.Closure closure = table["setOverflow"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.bool get debugHasOverflowShader { 
_36c2.Closure closure = table["getDebugHasOverflowShader"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
@_fac9.override _fac9.double? getFullHeightForCaret(position) { 
...
@_fac9.override _a643.Size get textSize { 
_36c2.Closure closure = table["getTextSize"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRenderParagraph({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderParagraph'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderParagraph(_36c2.maybeUnBoxAndBuildArgument<_b761.InlineSpan, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox>?, _be2e.RenderBox>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'children'
] : null, parentState: hydroState), locale: _36c2.maybeUnBoxAndBuildArgument<_a643.Locale?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'locale'
] : null, parentState: hydroState), maxLines: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'maxLines'
] : null, overflow: _36c2.maybeUnBoxEnum(values: _fe5a.TextOverflow.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'overflow'
] : null), softWrap: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'softWrap'
] : null, strutStyle: _36c2.maybeUnBoxAndBuildArgument<_ced4.StrutStyle?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'strutStyle'
] : null, parentState: hydroState), textAlign: _36c2.maybeUnBoxEnum(values: _a643.TextAlign.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'textAlign'
] : null), textHeightBehavior: _36c2.maybeUnBoxAndBuildArgument<_a643.TextHeightBehavior?, _fac9.dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'textHeightBehavior'
...
'textScaleFactor'
] : null?.toDouble(), textWidthBasis: _36c2.maybeUnBoxEnum(values: _fe5a.TextWidthBasis.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'textWidthBasis'
] : null), textDirection: _36c2.maybeUnBoxEnum(values: _a643.TextDirection.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'textDirection'
] : null))]; } );
_36c2.registerBoxer<_105e.RenderParagraph>(boxer: ({required _105e.RenderParagraph vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderParagraph(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

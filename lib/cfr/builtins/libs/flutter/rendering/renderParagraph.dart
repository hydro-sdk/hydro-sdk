...
class VMManagedRenderParagraph
    extends _36c2.VMManagedBox<_105e.RenderParagraph> {
  VMManagedRenderParagraph(
    ...
    table['getSoftWrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.softWrap,
      ];
    });
    table['setSoftWrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.softWrap = (luaCallerArguments[1]);
      return [];
    });
    table['getOverflow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _fe5a.TextOverflow.values.indexWhere((x) {
          return x == vmObject.overflow;
        }),
      ];
    });
    table['setOverflow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.overflow = (_36c2.maybeUnBoxEnum(
    ...
    table['getTextSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Size>(
            object: vmObject.textSize,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
...
class RTManagedRenderParagraph extends _105e.RenderParagraph
    implements _36c2.Box<_105e.RenderParagraph> {
  RTManagedRenderParagraph(_b761.InlineSpan text$,
    ...
    table['_dart_getSoftWrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.softWrap];
    });
    table['_dart_setSoftWrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.softWrap =
    ...
    table['_dart_getOverflow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.overflow];
    });
    table['_dart_setOverflow'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_getFullHeightForCaret'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: super.getFullHeightForCaret(_36c2
    ...
    table['_dart_getTextSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _fac9.bool get debugHasOverflowShader {
  ...
  @_fac9.override
  _fac9.double? getFullHeightForCaret(position) {
...
void loadRenderParagraph(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderParagraph'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderParagraph(_36c2.maybeUnBoxAndBuildArgument<_b761.InlineSpan, _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState,
          children: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_be2e.RenderBox>?, _be2e.RenderBox>(
              luaCallerArguments.length >= 3
                  ? luaCallerArguments[2]['children']
                  : null,
              parentState: hydroState),
          ...
          overflow: _36c2.maybeUnBoxEnum(
              values: _fe5a.TextOverflow.values,
              boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['overflow'] : null),
  ...
  _36c2.registerBoxer<_105e.RenderParagraph>(boxer: (
      {required _105e.RenderParagraph vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderParagraph(

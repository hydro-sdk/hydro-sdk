...
class VMManagedRenderParagraph extends VMManagedBox<RenderParagraph> {
  VMManagedRenderParagraph(
    ...
    table['getText'] =
      ...
      return [
        maybeBoxObject<InlineSpan>(
            object: vmObject.text, hydroState: hydroState, table: HydroTable()),
      ];
    });
    table['setText'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    ...
    table['getOverflow'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        TextOverflow.values.indexWhere((x) {
    ...
    table['setOverflow'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.overflow = (maybeUnBoxEnum(
          values: TextOverflow.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  final RenderParagraph vmObject;
}

class RTManagedRenderParagraph extends RenderParagraph
    implements Box<RenderParagraph> {
  RTManagedRenderParagraph(InlineSpan text$,
    ...
    table['_dart_setSoftWrap'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.softWrap = (luaCallerArguments[1]);
      return [];
    });
  ...
  RenderParagraph unwrap() => this;
  RenderParagraph get vmObject => this;
  @override
  ...
  @override
  bool get softWrap {
    Closure closure = table["getSoftWrap"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void set softWrap(value) {
    Closure closure = table["setSoftWrap"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  TextOverflow get overflow {
    Closure closure = table["getOverflow"];
    return maybeUnBoxEnum(
  ...
  void set overflow(value) {
    Closure closure = table["setOverflow"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @override
  Offset getOffsetForCaret(position, caretPrototype) {
    Closure closure = table["getOffsetForCaret"];
  ...
  @override
  double? getFullHeightForCaret(position) {
    Closure closure = table["getFullHeightForCaret"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  List<TextBox> getBoxesForSelection(selection,
  ...
  @override
  TextPosition getPositionForOffset(offset) {
    Closure closure = table["getPositionForOffset"];
  ...
  @override
  Size get textSize {
    Closure closure = table["getTextSize"];
    return maybeUnBoxAndBuildArgument<Size, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderParagraph(
  ...
  table['renderParagraph'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderParagraph(maybeUnBoxAndBuildArgument<InlineSpan, dynamic>(luaCallerArguments[1], parentState: hydroState),
          ...
          children: maybeUnBoxAndBuildArgument<List<RenderBox>?, RenderBox>(
              ...
              parentState: hydroState),
          locale:
              maybeUnBoxAndBuildArgument<Locale?, dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments[2]['locale'] : null,
                  parentState: hydroState),
          maxLines: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['maxLines']
              : null,
          overflow: maybeUnBoxEnum(
              values: TextOverflow.values,
              boxedEnum: luaCallerArguments.length >= 3
                  ? luaCallerArguments[2]['overflow']
                  : null),
          softWrap: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['softWrap']
              : null,
          strutStyle: maybeUnBoxAndBuildArgument<StrutStyle?, dynamic>(
              luaCallerArguments.length >= 3 ? luaCallerArguments[2]['strutStyle'] : null,
              parentState: hydroState),
          textAlign: maybeUnBoxEnum(values: TextAlign.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['textAlign'] : null),
          textHeightBehavior: maybeUnBoxAndBuildArgument<TextHeightBehavior?, dynamic>(luaCallerArguments.length >= 3 ? luaCallerArguments[2]['textHeightBehavior'] : null, parentState: hydroState),
          textScaleFactor: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['textScaleFactor'] : null?.toDouble(),
          textWidthBasis: maybeUnBoxEnum(values: TextWidthBasis.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['textWidthBasis'] : null),
          textDirection: maybeUnBoxEnum(values: TextDirection.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments[2]['textDirection'] : null))
    ];
  });
  registerBoxer<RenderParagraph>(boxer: (
      {required RenderParagraph vmObject,

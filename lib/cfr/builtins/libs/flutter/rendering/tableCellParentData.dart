...
class VMManagedTableCellParentData
    extends _36c2.VMManagedBox<_31d2.TableCellParentData> {
...
class RTManagedTableCellParentData extends _31d2.TableCellParentData
    implements _36c2.Box<_31d2.TableCellParentData> {
...
void loadTableCellParentData(
  ...
  table['tableCellParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_31d2.TableCellParentData>(boxer: (
      {required _31d2.TableCellParentData vmObject,

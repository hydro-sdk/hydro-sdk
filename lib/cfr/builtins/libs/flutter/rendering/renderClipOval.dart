...
class VMManagedRenderClipOval extends _36c2.VMManagedBox<_bf98.RenderClipOval> {
  VMManagedRenderClipOval(
...
class RTManagedRenderClipOval extends _bf98.RenderClipOval
    implements _36c2.Box<_bf98.RenderClipOval> {
  RTManagedRenderClipOval(
      {_be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      _bf98.CustomClipper<_a643.Rect>? clipper,
      required this.table,
  ...
  @_fac9.override
  _bf98.CustomClipper<_a643.Rect>? get clipper {
    _36c2.Closure closure = table["getClipper"];
    return _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Rect>?,
            _a643.Rect>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderClipOval(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderClipOval'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderClipOval(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipper: _36c2.maybeUnBoxAndBuildArgument<
                  _bf98.CustomClipper<_a643.Rect>?, _a643.Rect>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['clipper']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_bf98.RenderClipOval>(boxer: (
      {required _bf98.RenderClipOval vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderClipOval(

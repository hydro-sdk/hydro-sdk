...
class VMManagedRenderClipOval extends VMManagedBox<RenderClipOval> {
  VMManagedRenderClipOval(
    ...
    table['setClipper'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.clipper =
          (maybeUnBoxAndBuildArgument<CustomClipper<Rect>?, Rect>(
              luaCallerArguments[1],
              parentState: hydroState));
      return [];
    });
  ...
  final RenderClipOval vmObject;
}

class RTManagedRenderClipOval extends RenderClipOval
    implements Box<RenderClipOval> {
  RTManagedRenderClipOval(
    ...
    table['_dart_setClipper'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.clipper = (maybeUnBoxAndBuildArgument<CustomClipper<Rect>?, Rect>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  RenderClipOval unwrap() => this;
  RenderClipOval get vmObject => this;
  @override
  ...
  CustomClipper<Rect>? get clipper {
    ...
    return maybeUnBoxAndBuildArgument<CustomClipper<Rect>?, Rect>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadRenderClipOval(
      ...
      RTManagedRenderClipOval(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipper: maybeUnBoxAndBuildArgument<CustomClipper<Rect>?, Rect>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderClipOval>(boxer: (
      {required RenderClipOval vmObject,

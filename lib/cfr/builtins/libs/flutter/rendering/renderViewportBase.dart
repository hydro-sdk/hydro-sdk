...
class VMManagedRenderViewportBase extends _36c2.VMManagedBox<_01f8.RenderViewportBase<_9742.ContainerParentDataMixin<_021d.RenderSliver>>> {VMManagedRenderViewportBase({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _01f8.RenderViewportBase<_9742.ContainerParentDataMixin<_021d.RenderSliver>> vmObject;

 }

class RTManagedRenderViewportBase extends _01f8.RenderViewportBase implements _36c2.Box<_01f8.RenderViewportBase> {RTManagedRenderViewportBase({required _487f.AxisDirection axisDirection, _fac9.double? cacheExtent, required _01f8.CacheExtentStyle cacheExtentStyle, required _a643.Clip clipBehavior, required _487f.AxisDirection crossAxisDirection, required _f376.ViewportOffset offset, required this.table, required this.hydroState}) : super(axisDirection: axisDirection,cacheExtent: cacheExtent,cacheExtentStyle: cacheExtentStyle,clipBehavior: clipBehavior,crossAxisDirection: crossAxisDirection,offset: offset) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_maxScrollObstructionExtentBefore'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: maxScrollObstructionExtentBefore(
            _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
void loadRenderViewportBase({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderViewportBase'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRenderViewportBase(table: luaCallerArguments  [
0
...
table  [
'renderViewportBaseShowInViewport'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 




final returnValue = _01f8.RenderViewportBase.showInViewport(curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'curve'
] : null, parentState: hydroState), descendant: _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'offset'
] : null, parentState: hydroState), viewport: _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderAbstractViewport, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'viewport'
] : null, parentState: hydroState));if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Rect?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_01f8.RenderViewportBase>(boxer: ({required _01f8.RenderViewportBase vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderViewportBase(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

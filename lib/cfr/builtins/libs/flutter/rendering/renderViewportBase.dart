...
class VMManagedRenderViewportBase extends VMManagedBox<
  ...
  final RenderViewportBase<ContainerParentDataMixin<RenderSliver>> vmObject;
}

class RTManagedRenderViewportBase extends RenderViewportBase
    implements Box<RenderViewportBase> {
  RTManagedRenderViewportBase(
    ...
    table['_dart_labelForChild'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [labelForChild(luaCallerArguments[1])];
    });
  ...
  RenderViewportBase unwrap() => this;
  RenderViewportBase get vmObject => this;
  @override
...
void loadRenderViewportBase(
  ...
  table['renderViewportBaseShowInViewport'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    final returnValue = RenderViewportBase.showInViewport(
        ...
        viewport: maybeUnBoxAndBuildArgument<RenderAbstractViewport, dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['viewport'] : null, parentState: hydroState));
    if (returnValue != null) {
      return [
        maybeBoxObject<Rect?>(
            object: returnValue, hydroState: hydroState, table: HydroTable()),
  ...
  registerBoxer<RenderViewportBase>(boxer: (
      {required RenderViewportBase vmObject,

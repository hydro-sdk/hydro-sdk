...
class VMManagedRenderViewportBase extends _36c2.VMManagedBox<
    _01f8.RenderViewportBase<
        _9742.ContainerParentDataMixin<_021d.RenderSliver>>> {
  VMManagedRenderViewportBase(
  ...
  final _01f8.RenderViewportBase<
      _9742.ContainerParentDataMixin<_021d.RenderSliver>> vmObject;
}

class RTManagedRenderViewportBase extends _01f8.RenderViewportBase
    implements _36c2.Box<_01f8.RenderViewportBase> {
  RTManagedRenderViewportBase(
    ...
    table['_dart_paintOffsetOf'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: paintOffsetOf(_36c2.maybeUnBoxAndBuildArgument<
                _021d.RenderSliver,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
    ...
    table['_dart_maxScrollObstructionExtentBefore'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: maxScrollObstructionExtentBefore(_36c2
                .maybeUnBoxAndBuildArgument<_021d.RenderSliver, _fac9.dynamic>(
                    luaCallerArguments[1],
                    parentState: hydroState)),
            hydroState: hydroState,
    ...
    table['_dart_computeChildMainAxisPosition'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: computeChildMainAxisPosition(
                _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver,
                        _fac9.dynamic>(luaCallerArguments[1],
                    parentState: hydroState),
                _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
  ...
  _01f8.RenderViewportBase unwrap() => this;
  _01f8.RenderViewportBase get vmObject => this;
  @_fac9.override
...
void loadRenderViewportBase(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderViewportBase'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderViewportBase(
  ...
  table['renderViewportBaseShowInViewport'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _01f8.RenderViewportBase.showInViewport(
        curve: _36c2.maybeUnBoxAndBuildArgument<_8c47.Curve, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['curve'] : null,
            parentState: hydroState),
        descendant: _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject?, _fac9.dynamic>(
            luaCallerArguments.length >= 2
                ? luaCallerArguments[1]['descendant']
                : null,
            parentState: hydroState),
        duration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['duration'] : null,
            parentState: hydroState),
        rect: _36c2.maybeUnBoxAndBuildArgument<_a643.Rect?, _fac9.dynamic>(
        ...
        viewport: _36c2.maybeUnBoxAndBuildArgument<_01f8.RenderAbstractViewport, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['viewport'] : null, parentState: hydroState));
    if (returnValue != null) {
      return [
        _36c2.maybeBoxObject<_a643.Rect?>(
            object: returnValue,
  ...
  _36c2.registerBoxer<_01f8.RenderViewportBase>(boxer: (
      {required _01f8.RenderViewportBase vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderViewportBase(

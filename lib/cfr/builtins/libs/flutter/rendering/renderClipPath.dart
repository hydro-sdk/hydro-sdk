...
class VMManagedRenderClipPath extends _36c2.VMManagedBox<_bf98.RenderClipPath> {VMManagedRenderClipPath({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderClipPath vmObject;

 }

class RTManagedRenderClipPath extends _bf98.RenderClipPath implements _36c2.Box<_bf98.RenderClipPath> {RTManagedRenderClipPath({_be2e.RenderBox? child, required _a643.Clip clipBehavior, _bf98.CustomClipper<_a643.Path>? clipper, required this.table, required this.hydroState}) : super(child: child,clipBehavior: clipBehavior,clipper: clipper) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderClipPath unwrap() => this;
_bf98.RenderClipPath get vmObject => this;
...
void loadRenderClipPath({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderClipPath'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderClipPath(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), clipper: _36c2.maybeUnBoxAndBuildArgument<_bf98.CustomClipper<_a643.Path>?, _a643.Path>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipper'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_bf98.RenderClipPath>(boxer: ({required _bf98.RenderClipPath vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderClipPath(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderClipPath extends _36c2.VMManagedBox<_bf98.RenderClipPath> {
  VMManagedRenderClipPath(
...
class RTManagedRenderClipPath extends _bf98.RenderClipPath
    implements _36c2.Box<_bf98.RenderClipPath> {
  RTManagedRenderClipPath(
      {_be2e.RenderBox? child,
      required _a643.Clip clipBehavior,
      _bf98.CustomClipper<_a643.Path>? clipper,
      required this.table,
...
void loadRenderClipPath(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderClipPath'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderClipPath(
          ...
          clipper: _36c2.maybeUnBoxAndBuildArgument<
                  _bf98.CustomClipper<_a643.Path>?, _a643.Path>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_bf98.RenderClipPath>(boxer: (
      {required _bf98.RenderClipPath vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderClipPath(

...
class VMManagedRenderClipPath extends VMManagedBox<RenderClipPath> {
  ...
  final RenderClipPath vmObject;
}

class RTManagedRenderClipPath extends RenderClipPath
    implements Box<RenderClipPath> {
  ...
  RenderClipPath unwrap() => this;
  RenderClipPath get vmObject => this;
  @override
...
void loadRenderClipPath(
  ...
  registerBoxer<RenderClipPath>(boxer: (
      {required RenderClipPath vmObject,

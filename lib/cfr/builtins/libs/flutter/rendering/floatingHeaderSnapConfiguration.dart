...
class VMManagedFloatingHeaderSnapConfiguration extends _36c2.VMManagedBox<_2805.FloatingHeaderSnapConfiguration> {VMManagedFloatingHeaderSnapConfiguration({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadFloatingHeaderSnapConfiguration({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'floatingHeaderSnapConfiguration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedFloatingHeaderSnapConfiguration(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2805.FloatingHeaderSnapConfiguration>(boxer: ({required _2805.FloatingHeaderSnapConfiguration vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFloatingHeaderSnapConfiguration(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

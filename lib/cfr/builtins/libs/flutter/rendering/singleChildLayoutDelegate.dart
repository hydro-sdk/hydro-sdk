...
class VMManagedSingleChildLayoutDelegate extends _36c2.VMManagedBox<_a9e4.SingleChildLayoutDelegate> {VMManagedSingleChildLayoutDelegate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'shouldRelayout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.shouldRelayout(_36c2.maybeUnBoxAndBuildArgument<_a9e4.SingleChildLayoutDelegate, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedSingleChildLayoutDelegate extends _a9e4.SingleChildLayoutDelegate implements _36c2.Box<_a9e4.SingleChildLayoutDelegate> {RTManagedSingleChildLayoutDelegate({_e644.Listenable? relayout, required this.table, required this.hydroState}) : super(relayout: relayout) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadSingleChildLayoutDelegate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'singleChildLayoutDelegate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedSingleChildLayoutDelegate(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_a9e4.SingleChildLayoutDelegate>(boxer: ({required _a9e4.SingleChildLayoutDelegate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSingleChildLayoutDelegate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

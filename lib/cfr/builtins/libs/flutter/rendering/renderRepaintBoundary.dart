...
class VMManagedRenderRepaintBoundary
    extends VMManagedBox<RenderRepaintBoundary> {
  VMManagedRenderRepaintBoundary(
    ...
    table['getDebugSymmetricPaintCount'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.debugSymmetricPaintCount,
      ];
    });
    table['getDebugAsymmetricPaintCount'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.debugAsymmetricPaintCount,
      ];
    });
    table['debugResetMetrics'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  final RenderRepaintBoundary vmObject;
}

class RTManagedRenderRepaintBoundary extends RenderRepaintBoundary
    implements Box<RenderRepaintBoundary> {
  ...
  RenderRepaintBoundary unwrap() => this;
  RenderRepaintBoundary get vmObject => this;
  @override
  ...
  int get debugSymmetricPaintCount {
    Closure closure = table["getDebugSymmetricPaintCount"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  int get debugAsymmetricPaintCount {
    Closure closure = table["getDebugAsymmetricPaintCount"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  void debugResetMetrics() {
    Closure closure = table["debugResetMetrics"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderRepaintBoundary(
  ...
  registerBoxer<RenderRepaintBoundary>(boxer: (
      {required RenderRepaintBoundary vmObject,

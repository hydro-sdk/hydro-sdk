...
class VMManagedRenderRepaintBoundary
    extends _36c2.VMManagedBox<_bf98.RenderRepaintBoundary> {
  VMManagedRenderRepaintBoundary(
      ...
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.toImage(
                pixelRatio: luaCallerArguments.length >= 2
    ...
    table['getDebugSymmetricPaintCount'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.debugSymmetricPaintCount,
      ];
    });
    table['getDebugAsymmetricPaintCount'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.debugAsymmetricPaintCount,
      ];
    });
    table['debugResetMetrics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.debugResetMetrics();
      return [];
    });
...
class RTManagedRenderRepaintBoundary extends _bf98.RenderRepaintBoundary
    implements _36c2.Box<_bf98.RenderRepaintBoundary> {
  RTManagedRenderRepaintBoundary(
    ...
    table['_dart_getDebugSymmetricPaintCount'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.debugSymmetricPaintCount];
    });
    table['_dart_getDebugAsymmetricPaintCount'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.debugAsymmetricPaintCount];
    });
    table['_dart_debugResetMetrics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _7de1.Future<_a643.Image> toImage({_fac9.double pixelRatio = 1.0}) {
  ...
  @_fac9.override
  _fac9.int get debugSymmetricPaintCount {
    _36c2.Closure closure = table["getDebugSymmetricPaintCount"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.int get debugAsymmetricPaintCount {
...
void loadRenderRepaintBoundary(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderRepaintBoundary'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderRepaintBoundary(
  ...
  _36c2.registerBoxer<_bf98.RenderRepaintBoundary>(boxer: (
      {required _bf98.RenderRepaintBoundary vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderRepaintBoundary(

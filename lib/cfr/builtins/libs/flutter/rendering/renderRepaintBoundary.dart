...
class VMManagedRenderRepaintBoundary extends _36c2.VMManagedBox<_bf98.RenderRepaintBoundary> {VMManagedRenderRepaintBoundary({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'toImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7de1.Future>(object: vmObject.toImage(pixelRatio: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'pixelRatio'
] : null?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getDebugSymmetricPaintCount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugSymmetricPaintCount,]; } );
table  [
'getDebugAsymmetricPaintCount'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.debugAsymmetricPaintCount,]; } );
table  [
'debugResetMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.debugResetMetrics();
return []; } );
table  [
...
final _bf98.RenderRepaintBoundary vmObject;

 }

class RTManagedRenderRepaintBoundary extends _bf98.RenderRepaintBoundary implements _36c2.Box<_bf98.RenderRepaintBoundary> {RTManagedRenderRepaintBoundary({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
            ...
            pixelRatio:
                _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
                    luaCallerArguments.length >= 2
                        ? luaCallerArguments[1]['pixelRatio']
                        : null,
                    parentState: hydroState)),
        hydroState: hydroState,
...
table['_dart_getDebugSymmetricPaintCount'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.debugSymmetricPaintCount];
});
table['_dart_getDebugAsymmetricPaintCount'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.debugAsymmetricPaintCount];
});
table['_dart_debugResetMetrics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.debugResetMetrics();
  return [];
});
...
_bf98.RenderRepaintBoundary unwrap() => this;
_bf98.RenderRepaintBoundary get vmObject => this;
@_fac9.override _fac9.bool get isRepaintBoundary { 
_36c2.Closure closure = table["getIsRepaintBoundary"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _7de1.Future<_a643.Image> toImage({_fac9.double pixelRatio = 1.0}) { 
...
@_fac9.override _fac9.int get debugSymmetricPaintCount { 
_36c2.Closure closure = table["getDebugSymmetricPaintCount"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int get debugAsymmetricPaintCount { 
_36c2.Closure closure = table["getDebugAsymmetricPaintCount"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void debugResetMetrics() { 
_36c2.Closure closure = table["debugResetMetrics"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderRepaintBoundary({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderRepaintBoundary'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderRepaintBoundary(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bf98.RenderRepaintBoundary>(boxer: ({required _bf98.RenderRepaintBoundary vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderRepaintBoundary(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverScrollingPersistentHeader
    extends _36c2.VMManagedBox<_2805.RenderSliverScrollingPersistentHeader> {
  VMManagedRenderSliverScrollingPersistentHeader(
...
class RTManagedRenderSliverScrollingPersistentHeader
    extends _2805.RenderSliverScrollingPersistentHeader
    implements _36c2.Box<_2805.RenderSliverScrollingPersistentHeader> {
  RTManagedRenderSliverScrollingPersistentHeader(
...
void loadRenderSliverScrollingPersistentHeader(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverScrollingPersistentHeader'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverScrollingPersistentHeader(
          ...
          child:
              _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          stretchConfiguration: _36c2.maybeUnBoxAndBuildArgument<
  ...
  _36c2.registerBoxer<_2805.RenderSliverScrollingPersistentHeader>(boxer: (
      {required _2805.RenderSliverScrollingPersistentHeader vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverScrollingPersistentHeader(

...
class VMManagedRenderSliverScrollingPersistentHeader
    extends VMManagedBox<RenderSliverScrollingPersistentHeader> {
  ...
  final RenderSliverScrollingPersistentHeader vmObject;
}

class RTManagedRenderSliverScrollingPersistentHeader
    extends RenderSliverScrollingPersistentHeader
    implements Box<RenderSliverScrollingPersistentHeader> {
  ...
  RenderSliverScrollingPersistentHeader unwrap() => this;
  RenderSliverScrollingPersistentHeader get vmObject => this;
  @override
...
void loadRenderSliverScrollingPersistentHeader(
  ...
  table['renderSliverScrollingPersistentHeader'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverScrollingPersistentHeader(
          ...
          child: maybeUnBoxAndBuildArgument<RenderBox?, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          stretchConfiguration: maybeUnBoxAndBuildArgument<
                  OverScrollHeaderStretchConfiguration?, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<RenderSliverScrollingPersistentHeader>(boxer: (
      {required RenderSliverScrollingPersistentHeader vmObject,

...
class VMManagedRenderSliverScrollingPersistentHeader extends _36c2.VMManagedBox<_2805.RenderSliverScrollingPersistentHeader> {VMManagedRenderSliverScrollingPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2805.RenderSliverScrollingPersistentHeader vmObject;

 }

class RTManagedRenderSliverScrollingPersistentHeader extends _2805.RenderSliverScrollingPersistentHeader implements _36c2.Box<_2805.RenderSliverScrollingPersistentHeader> {RTManagedRenderSliverScrollingPersistentHeader({_be2e.RenderBox? child, _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration, required this.table, required this.hydroState}) : super(child: child,stretchConfiguration: stretchConfiguration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2805.RenderSliverScrollingPersistentHeader unwrap() => this;
_2805.RenderSliverScrollingPersistentHeader get vmObject => this;
...
void loadRenderSliverScrollingPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverScrollingPersistentHeader'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRenderSliverScrollingPersistentHeader(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2805.RenderSliverScrollingPersistentHeader>(boxer: ({required _2805.RenderSliverScrollingPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverScrollingPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

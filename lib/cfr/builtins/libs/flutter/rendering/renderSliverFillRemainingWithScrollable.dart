...
class VMManagedRenderSliverFillRemainingWithScrollable
    extends VMManagedBox<RenderSliverFillRemainingWithScrollable> {
  ...
  final RenderSliverFillRemainingWithScrollable vmObject;
}

class RTManagedRenderSliverFillRemainingWithScrollable
    extends RenderSliverFillRemainingWithScrollable
    implements Box<RenderSliverFillRemainingWithScrollable> {
  ...
  RenderSliverFillRemainingWithScrollable unwrap() => this;
  RenderSliverFillRemainingWithScrollable get vmObject => this;
  @override
  void performLayout() {
...
void loadRenderSliverFillRemainingWithScrollable(
  ...
  table['renderSliverFillRemainingWithScrollable'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFillRemainingWithScrollable(
  ...
  registerBoxer<RenderSliverFillRemainingWithScrollable>(boxer: (
      {required RenderSliverFillRemainingWithScrollable vmObject,

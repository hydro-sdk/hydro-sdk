...
class VMManagedRenderSliverFillRemainingWithScrollable extends _36c2.VMManagedBox<_793f.RenderSliverFillRemainingWithScrollable> {VMManagedRenderSliverFillRemainingWithScrollable({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _793f.RenderSliverFillRemainingWithScrollable vmObject;

 }

class RTManagedRenderSliverFillRemainingWithScrollable extends _793f.RenderSliverFillRemainingWithScrollable implements _36c2.Box<_793f.RenderSliverFillRemainingWithScrollable> {RTManagedRenderSliverFillRemainingWithScrollable({_be2e.RenderBox? child, required this.table, required this.hydroState}) : super(child: child) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setChildParentData'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.setChildParentData(
      _36c2.maybeUnBoxAndBuildArgument<_9742.RenderObject, _fac9.dynamic>(
          luaCallerArguments[1],
          parentState: hydroState),
...
_793f.RenderSliverFillRemainingWithScrollable unwrap() => this;
_793f.RenderSliverFillRemainingWithScrollable get vmObject => this;
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void setChildParentData(child, constraints, geometry) { 
_36c2.Closure closure = table["setChildParentData"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderSliverFillRemainingWithScrollable({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverFillRemainingWithScrollable'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverFillRemainingWithScrollable(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_793f.RenderSliverFillRemainingWithScrollable>(boxer: ({required _793f.RenderSliverFillRemainingWithScrollable vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFillRemainingWithScrollable(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

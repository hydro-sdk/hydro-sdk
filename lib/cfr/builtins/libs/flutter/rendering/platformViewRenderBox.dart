...
class VMManagedPlatformViewRenderBox
    extends VMManagedBox<PlatformViewRenderBox> {
  VMManagedPlatformViewRenderBox(
    ...
    table['setController'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.controller =
          (maybeUnBoxAndBuildArgument<PlatformViewController, dynamic>(
  ...
  final PlatformViewRenderBox vmObject;
}

class RTManagedPlatformViewRenderBox extends PlatformViewRenderBox
    implements Box<PlatformViewRenderBox> {
...
void loadPlatformViewRenderBox(
  ...
  registerBoxer<PlatformViewRenderBox>(boxer: (
      {required PlatformViewRenderBox vmObject,

...
class VMManagedPlatformViewRenderBox extends _36c2.VMManagedBox<_6ecd.PlatformViewRenderBox> {VMManagedPlatformViewRenderBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_40e3.PlatformViewController>(object: vmObject.controller, hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'setController'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.controller=(_36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(luaCallerArguments  [
1
...
final _6ecd.PlatformViewRenderBox vmObject;

 }

class RTManagedPlatformViewRenderBox extends _6ecd.PlatformViewRenderBox implements _36c2.Box<_6ecd.PlatformViewRenderBox> {RTManagedPlatformViewRenderBox({required _40e3.PlatformViewController controller, required _fac9.Set<_288a.Factory<_02d2.OneSequenceGestureRecognizer>> gestureRecognizers, required _6ecd.PlatformViewHitTestBehavior hitTestBehavior, required this.table, required this.hydroState}) : super(controller: controller,gestureRecognizers: gestureRecognizers,hitTestBehavior: hitTestBehavior) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_setController'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.controller = (_36c2.maybeUnBoxAndBuildArgument<
      _40e3.PlatformViewController,
...
_6ecd.PlatformViewRenderBox unwrap() => this;
_6ecd.PlatformViewRenderBox get vmObject => this;
@_fac9.override _40e3.PlatformViewController get controller { 
_36c2.Closure closure = table["getController"];
return _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set controller(controller) { 
_36c2.Closure closure = table["setController"];
...
void loadPlatformViewRenderBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'platformViewRenderBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPlatformViewRenderBox(table: luaCallerArguments  [
0
], hydroState: hydroState, controller: _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'controller'
...
_36c2.registerBoxer<_6ecd.PlatformViewRenderBox>(boxer: ({required _6ecd.PlatformViewRenderBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformViewRenderBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

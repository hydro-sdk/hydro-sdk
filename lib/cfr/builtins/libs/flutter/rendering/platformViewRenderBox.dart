...
class VMManagedPlatformViewRenderBox
    extends _36c2.VMManagedBox<_6ecd.PlatformViewRenderBox> {
  VMManagedPlatformViewRenderBox(
    ...
    table['getController'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_40e3.PlatformViewController>(
            object: vmObject.controller,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.controller = (_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedPlatformViewRenderBox extends _6ecd.PlatformViewRenderBox
    implements _36c2.Box<_6ecd.PlatformViewRenderBox> {
  RTManagedPlatformViewRenderBox(
      {required _40e3.PlatformViewController controller,
    ...
    table['_dart_setController'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _40e3.PlatformViewController get controller {
    _36c2.Closure closure = table["getController"];
    return _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController,
            _fac9.dynamic>(
...
void loadPlatformViewRenderBox(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['platformViewRenderBox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlatformViewRenderBox(
          ...
          hydroState: hydroState,
          controller:
              _36c2.maybeUnBoxAndBuildArgument<_40e3.PlatformViewController, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_6ecd.PlatformViewRenderBox>(boxer: (
      {required _6ecd.PlatformViewRenderBox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPlatformViewRenderBox(

...
class VMManagedRenderBaseline extends _36c2.VMManagedBox<_a9e4.RenderBaseline> {VMManagedRenderBaseline({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getBaseline'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.baseline,]; } );
table  [
'setBaseline'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.baseline=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
'getBaselineType'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_a643.TextBaseline.values.indexWhere((x) { return x == vmObject.baselineType; } ),]; } );
table  [
'setBaselineType'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.baselineType=(_36c2.maybeUnBoxEnum(values: _a643.TextBaseline.values, boxedEnum: luaCallerArguments  [
1
]));
return []; } );
table  [
...
final _a9e4.RenderBaseline vmObject;

 }

class RTManagedRenderBaseline extends _a9e4.RenderBaseline implements _36c2.Box<_a9e4.RenderBaseline> {RTManagedRenderBaseline({_be2e.RenderBox? child, required _fac9.double baseline, required _a643.TextBaseline baselineType, required this.table, required this.hydroState}) : super(child: child,baseline: baseline,baselineType: baselineType) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getBaseline'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.baseline];
});
table['_dart_setBaseline'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.baseline =
...
table['_dart_getBaselineType'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.baselineType];
});
table['_dart_setBaselineType'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.baselineType = (_36c2.maybeUnBoxEnum(
...
_a9e4.RenderBaseline unwrap() => this;
_a9e4.RenderBaseline get vmObject => this;
@_fac9.override _fac9.double get baseline { 
_36c2.Closure closure = table["getBaseline"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override void set baseline(value) { 
_36c2.Closure closure = table["setBaseline"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.TextBaseline get baselineType { 
_36c2.Closure closure = table["getBaselineType"];
return _36c2.maybeUnBoxEnum(values: _a643.TextBaseline.values, boxedEnum: closure.dispatch([table],parentState: hydroState)[0]); } 
@_fac9.override void set baselineType(value) { 
_36c2.Closure closure = table["setBaselineType"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
...
void loadRenderBaseline({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderBaseline'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderBaseline(table: luaCallerArguments  [
0
...
'child'
] : null, parentState: hydroState), baseline: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'baseline'
] : null?.toDouble(), baselineType: _36c2.maybeUnBoxEnum(values: _a643.TextBaseline.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'baselineType'
] : null))]; } );
_36c2.registerBoxer<_a9e4.RenderBaseline>(boxer: ({required _a9e4.RenderBaseline vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderBaseline(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

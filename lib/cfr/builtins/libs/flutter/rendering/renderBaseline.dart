...
class VMManagedRenderBaseline extends _36c2.VMManagedBox<_a9e4.RenderBaseline> {
  VMManagedRenderBaseline(
    ...
    table['debugCreator'] = _36c2.maybeBoxObject<_fac9.Object?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.baseline,
      ];
    });
    table['setBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.baseline = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['getBaselineType'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _a643.TextBaseline.values.indexWhere((x) {
          return x == vmObject.baselineType;
        }),
      ];
    });
    table['setBaselineType'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.baselineType = (_36c2.maybeUnBoxEnum(
...
class RTManagedRenderBaseline extends _a9e4.RenderBaseline
    implements _36c2.Box<_a9e4.RenderBaseline> {
  RTManagedRenderBaseline(
      {_be2e.RenderBox? child,
      required _fac9.double baseline,
      required _a643.TextBaseline baselineType,
      required this.table,
      required this.hydroState})
      : super(child: child, baseline: baseline, baselineType: baselineType) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.baseline];
    });
    table['_dart_setBaseline'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.baseline =
    ...
    table['_dart_getBaselineType'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.baselineType];
    });
    table['_dart_setBaselineType'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadRenderBaseline(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderBaseline'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderBaseline(
          ...
          baseline: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          baselineType: _36c2.maybeUnBoxEnum(
              values: _a643.TextBaseline.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['baselineType']
                  : null))
    ];
  });
  _36c2.registerBoxer<_a9e4.RenderBaseline>(boxer: (
      {required _a9e4.RenderBaseline vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderBaseline(

...
class VMManagedRenderBaseline extends VMManagedBox<RenderBaseline> {
  VMManagedRenderBaseline(
    ...
    table['setBaselineType'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.baselineType = (maybeUnBoxEnum(
  ...
  final RenderBaseline vmObject;
}

class RTManagedRenderBaseline extends RenderBaseline
    implements Box<RenderBaseline> {
  RTManagedRenderBaseline(
    ...
    table['_dart_setBaseline'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.baseline = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    ...
    table['_dart_setBaselineType'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.baselineType = (maybeUnBoxEnum(
          values: TextBaseline.values, boxedEnum: luaCallerArguments[1]));
      return [];
    });
  ...
  RenderBaseline unwrap() => this;
  RenderBaseline get vmObject => this;
  @override
  double get baseline {
    Closure closure = table["getBaseline"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  void set baseline(value) {
    Closure closure = table["setBaseline"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  TextBaseline get baselineType {
    Closure closure = table["getBaselineType"];
  ...
  void set baselineType(value) {
    Closure closure = table["setBaselineType"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadRenderBaseline(
  ...
  registerBoxer<RenderBaseline>(boxer: (
      {required RenderBaseline vmObject,

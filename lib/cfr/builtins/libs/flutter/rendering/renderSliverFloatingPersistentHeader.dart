...
class VMManagedRenderSliverFloatingPersistentHeader
    extends _36c2.VMManagedBox<_2805.RenderSliverFloatingPersistentHeader> {
...
void loadRenderSliverFloatingPersistentHeader(
  ...
  table['renderSliverFloatingPersistentHeader'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverFloatingPersistentHeader(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          snapConfiguration: _36c2.maybeUnBoxAndBuildArgument<
                  _2805.FloatingHeaderSnapConfiguration?,
                  _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['snapConfiguration'] : null,
              parentState: hydroState),
          ...
          showOnScreenConfiguration: _36c2.maybeUnBoxAndBuildArgument<_2805.PersistentHeaderShowOnScreenConfiguration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['showOnScreenConfiguration'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_2805.RenderSliverFloatingPersistentHeader>(boxer: (
      {required _2805.RenderSliverFloatingPersistentHeader vmObject,

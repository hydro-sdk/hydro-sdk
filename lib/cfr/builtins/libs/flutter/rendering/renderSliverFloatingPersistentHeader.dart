...
class VMManagedRenderSliverFloatingPersistentHeader extends _36c2.VMManagedBox<_2805.RenderSliverFloatingPersistentHeader> {VMManagedRenderSliverFloatingPersistentHeader({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2805.RenderSliverFloatingPersistentHeader vmObject;

 }

class RTManagedRenderSliverFloatingPersistentHeader extends _2805.RenderSliverFloatingPersistentHeader implements _36c2.Box<_2805.RenderSliverFloatingPersistentHeader> {RTManagedRenderSliverFloatingPersistentHeader({_be2e.RenderBox? child, _2805.FloatingHeaderSnapConfiguration? snapConfiguration, _2805.OverScrollHeaderStretchConfiguration? stretchConfiguration, _e067.TickerProvider? vsync, _2805.PersistentHeaderShowOnScreenConfiguration? showOnScreenConfiguration, required this.table, required this.hydroState}) : super(child: child,snapConfiguration: snapConfiguration,stretchConfiguration: stretchConfiguration,vsync: vsync,showOnScreenConfiguration: showOnScreenConfiguration) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_2805.RenderSliverFloatingPersistentHeader unwrap() => this;
_2805.RenderSliverFloatingPersistentHeader get vmObject => this;
...
void loadRenderSliverFloatingPersistentHeader({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRenderSliverFloatingPersistentHeader(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2805.RenderSliverFloatingPersistentHeader>(boxer: ({required _2805.RenderSliverFloatingPersistentHeader vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverFloatingPersistentHeader(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedListBodyParentData extends VMManagedBox<ListBodyParentData> {
  VMManagedListBodyParentData(
  ...
  final ListBodyParentData vmObject;
}

class RTManagedListBodyParentData extends ListBodyParentData
    implements Box<ListBodyParentData> {
  RTManagedListBodyParentData({required this.table, required this.hydroState})
      : super() {
  ...
  ListBodyParentData unwrap() => this;
  ListBodyParentData get vmObject => this;
  @override
  void detach() {
    super.detach();
...
void loadListBodyParentData(
    {required HydroState hydroState, required HydroTable table}) {
  table['listBodyParentData'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedListBodyParentData(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  registerBoxer<ListBodyParentData>(boxer: (
      {required ListBodyParentData vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedListBodyParentData(

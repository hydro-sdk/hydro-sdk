...
class VMManagedListBodyParentData
    extends _36c2.VMManagedBox<_6874.ListBodyParentData> {
...
class RTManagedListBodyParentData extends _6874.ListBodyParentData
    implements _36c2.Box<_6874.ListBodyParentData> {
...
void loadListBodyParentData(
  ...
  table['listBodyParentData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_6874.ListBodyParentData>(boxer: (
      {required _6874.ListBodyParentData vmObject,

...
class VMManagedRenderProxyBox extends VMManagedBox<RenderProxyBox> {
  ...
  final RenderProxyBox vmObject;
}

class RTManagedRenderProxyBox extends RenderProxyBox
    implements Box<RenderProxyBox> {
  RTManagedRenderProxyBox(RenderBox? child$,
  ...
  RenderProxyBox unwrap() => this;
  RenderProxyBox get vmObject => this;
  @override
...
void loadRenderProxyBox(
  ...
  registerBoxer<RenderProxyBox>(boxer: (
      {required RenderProxyBox vmObject,

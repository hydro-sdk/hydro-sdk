...
class VMManagedRenderProxyBox extends _36c2.VMManagedBox<_bf98.RenderProxyBox> {VMManagedRenderProxyBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _bf98.RenderProxyBox vmObject;

 }

class RTManagedRenderProxyBox extends _bf98.RenderProxyBox implements _36c2.Box<_bf98.RenderProxyBox> {RTManagedRenderProxyBox(_be2e.RenderBox? child$, {required this.table, required this.hydroState}) : super(child$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_bf98.RenderProxyBox unwrap() => this;
_bf98.RenderProxyBox get vmObject => this;
...
void loadRenderProxyBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderProxyBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderProxyBox(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_bf98.RenderProxyBox>(boxer: ({required _bf98.RenderProxyBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderProxyBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

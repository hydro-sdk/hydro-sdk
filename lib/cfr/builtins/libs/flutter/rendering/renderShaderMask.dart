...
class VMManagedRenderShaderMask
    extends _36c2.VMManagedBox<_bf98.RenderShaderMask> {
  VMManagedRenderShaderMask(
    ...
    table['getLayer'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_7d70.ShaderMaskLayer?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
    ...
    table['getShaderCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.shaderCallback,
      ];
    });
    table['setShaderCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedvalue = luaCallerArguments[1];
      vmObject.shaderCallback = ((bounds) =>
...
class RTManagedRenderShaderMask extends _bf98.RenderShaderMask
    implements _36c2.Box<_bf98.RenderShaderMask> {
  RTManagedRenderShaderMask(
      {required _a643.BlendMode blendMode,
      _be2e.RenderBox? child,
      required _a643.Shader Function(_a643.Rect bounds) shaderCallback,
      required this.table,
    ...
    table['_dart_setShaderCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedvalue = luaCallerArguments[1];
  ...
  @_fac9.override
  _7d70.ShaderMaskLayer? get layer {
    _36c2.Closure closure = table["getLayer"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_7d70.ShaderMaskLayer?, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  void set shaderCallback(value) {
...
void loadRenderShaderMask(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderShaderMask'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedshaderCallback = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['shaderCallback']
        : null;
    return [
      RTManagedRenderShaderMask(
          ...
          shaderCallback: (bounds) =>
              _36c2.maybeUnBoxAndBuildArgument<_a643.Shader, _fac9.dynamic>(
                  unpackedshaderCallback.dispatch(
                    [luaCallerArguments[0], bounds],
                    parentState: hydroState,
                  )[0],
                  parentState: hydroState))
  ...
  _36c2.registerBoxer<_bf98.RenderShaderMask>(boxer: (
      {required _bf98.RenderShaderMask vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderShaderMask(

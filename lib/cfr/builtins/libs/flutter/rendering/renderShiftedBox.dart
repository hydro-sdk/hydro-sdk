...
class VMManagedRenderShiftedBox extends _36c2.VMManagedBox<_a9e4.RenderShiftedBox> {VMManagedRenderShiftedBox({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRenderShiftedBox extends _a9e4.RenderShiftedBox implements _36c2.Box<_a9e4.RenderShiftedBox> {RTManagedRenderShiftedBox(_be2e.RenderBox? child$, {required this.table, required this.hydroState}) : super(child$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRenderShiftedBox({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderShiftedBox'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderShiftedBox(_36c2.maybeUnBoxAndBuildArgument<_be2e.RenderBox?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_a9e4.RenderShiftedBox>(boxer: ({required _a9e4.RenderShiftedBox vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderShiftedBox(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderShiftedBox extends VMManagedBox<RenderShiftedBox> {
  ...
  final RenderShiftedBox vmObject;
}

class RTManagedRenderShiftedBox extends RenderShiftedBox
    implements Box<RenderShiftedBox> {
  RTManagedRenderShiftedBox(RenderBox? child$,
  ...
  RenderShiftedBox unwrap() => this;
  RenderShiftedBox get vmObject => this;
  @override
...
void loadRenderShiftedBox(
  ...
  registerBoxer<RenderShiftedBox>(boxer: (
      {required RenderShiftedBox vmObject,

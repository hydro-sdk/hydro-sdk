...
class VMManagedClipRRectLayer extends VMManagedBox<ClipRRectLayer> {
  VMManagedClipRRectLayer(
    ...
    table['setClipRRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.clipRRect = (maybeUnBoxAndBuildArgument<RRect?, dynamic>(
  ...
  final ClipRRectLayer vmObject;
}

class RTManagedClipRRectLayer extends ClipRRectLayer
    implements Box<ClipRRectLayer> {
  RTManagedClipRRectLayer(
    ...
    table['_dart_setClipRRect'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.clipRRect = (maybeUnBoxAndBuildArgument<RRect?, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  ClipRRectLayer unwrap() => this;
  ClipRRectLayer get vmObject => this;
  @override
  RRect? get clipRRect {
    Closure closure = table["getClipRRect"];
    return maybeUnBoxAndBuildArgument<RRect?, dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @override
  void set clipRRect(RRect? value) {
    Closure closure = table["setClipRRect"];
...
void loadClipRRectLayer(
      ...
      RTManagedClipRRectLayer(
          ...
          clipBehavior: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          clipRRect: maybeUnBoxAndBuildArgument<RRect?, dynamic>(
  ...
  registerBoxer<ClipRRectLayer>(boxer: (
      {required ClipRRectLayer vmObject,

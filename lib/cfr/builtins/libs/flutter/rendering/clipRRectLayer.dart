...
class VMManagedClipRRectLayer extends _36c2.VMManagedBox<_7d70.ClipRRectLayer> {VMManagedClipRRectLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getClipRRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.clipRRect;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.RRect?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setClipRRect'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.clipRRect=(_36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedClipRRectLayer extends _7d70.ClipRRectLayer implements _36c2.Box<_7d70.ClipRRectLayer> {RTManagedClipRRectLayer({required _a643.Clip clipBehavior, _a643.RRect? clipRRect, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,clipRRect: clipRRect) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _a643.RRect? get clipRRect { 
_36c2.Closure closure = table["getClipRRect"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void set clipRRect(value) { 
...
void loadClipRRectLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipRRectLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedClipRRectLayer(table: luaCallerArguments  [
0
...
'clipBehavior'
] : null), clipRRect: _36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'clipRRect'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_7d70.ClipRRectLayer>(boxer: ({required _7d70.ClipRRectLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipRRectLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedClipRRectLayer extends _36c2.VMManagedBox<_7d70.ClipRRectLayer> {
  VMManagedClipRRectLayer(
    ...
    table['getClipRRect'] = _36c2.makeLuaDartFunc(
    ...
    table['setClipRRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.clipRRect =
  ...
  final _7d70.ClipRRectLayer vmObject;
}

class RTManagedClipRRectLayer extends _7d70.ClipRRectLayer
    implements _36c2.Box<_7d70.ClipRRectLayer> {
  RTManagedClipRRectLayer(
      {required _a643.Clip clipBehavior,
      _a643.RRect? clipRRect,
      required this.table,
      required this.hydroState})
      : super(clipBehavior: clipBehavior, clipRRect: clipRRect) {
    ...
    table['debugCreator'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_getClipRRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.clipRRect];
    });
    table['_dart_setClipRRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.clipRRect =
          (_36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(
              luaCallerArguments[1],
  ...
  _7d70.ClipRRectLayer unwrap() => this;
  _7d70.ClipRRectLayer get vmObject => this;
  @_fac9.override
  _a643.RRect? get clipRRect {
    _36c2.Closure closure = table["getClipRRect"];
    return _36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  void set clipRRect(value) {
    _36c2.Closure closure = table["setClipRRect"];
...
void loadClipRRectLayer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['clipRRectLayer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipRRectLayer(
          ...
          clipRRect:
              _36c2.maybeUnBoxAndBuildArgument<_a643.RRect?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['clipRRect']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_7d70.ClipRRectLayer>(boxer: (
      {required _7d70.ClipRRectLayer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipRRectLayer(

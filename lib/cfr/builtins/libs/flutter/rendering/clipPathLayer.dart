...
class VMManagedClipPathLayer extends _36c2.VMManagedBox<_7d70.ClipPathLayer> {VMManagedClipPathLayer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _7d70.ClipPathLayer vmObject;

 }

class RTManagedClipPathLayer extends _7d70.ClipPathLayer implements _36c2.Box<_7d70.ClipPathLayer> {RTManagedClipPathLayer({required _a643.Clip clipBehavior, _a643.Path? clipPath, required this.table, required this.hydroState}) : super(clipBehavior: clipBehavior,clipPath: clipPath) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_7d70.ClipPathLayer unwrap() => this;
_7d70.ClipPathLayer get vmObject => this;
...
void loadClipPathLayer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'clipPathLayer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedClipPathLayer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d70.ClipPathLayer>(boxer: ({required _7d70.ClipPathLayer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedClipPathLayer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

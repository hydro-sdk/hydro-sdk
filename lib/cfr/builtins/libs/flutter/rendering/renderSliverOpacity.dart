...
class VMManagedRenderSliverOpacity extends _36c2.VMManagedBox<_26cc.RenderSliverOpacity> {VMManagedRenderSliverOpacity({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'setOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.opacity=(luaCallerArguments  [
1
]?.toDouble());
return []; } );
table  [
...
final _26cc.RenderSliverOpacity vmObject;

 }

class RTManagedRenderSliverOpacity extends _26cc.RenderSliverOpacity implements _36c2.Box<_26cc.RenderSliverOpacity> {RTManagedRenderSliverOpacity({required _fac9.bool alwaysIncludeSemantics, required _fac9.double opacity, _021d.RenderSliver? sliver, required this.table, required this.hydroState}) : super(alwaysIncludeSemantics: alwaysIncludeSemantics,opacity: opacity,sliver: sliver) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_26cc.RenderSliverOpacity unwrap() => this;
_26cc.RenderSliverOpacity get vmObject => this;
...
void loadRenderSliverOpacity({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverOpacity'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRenderSliverOpacity(table: luaCallerArguments  [
0
], hydroState: hydroState, alwaysIncludeSemantics: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'alwaysIncludeSemantics'
] : null, opacity: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'opacity'
] : null?.toDouble(), sliver: _36c2.maybeUnBoxAndBuildArgument<_021d.RenderSliver?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'sliver'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_26cc.RenderSliverOpacity>(boxer: ({required _26cc.RenderSliverOpacity vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverOpacity(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRenderSliverOpacity
    extends _36c2.VMManagedBox<_26cc.RenderSliverOpacity> {
  VMManagedRenderSliverOpacity(
    ...
    table['setOpacity'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.opacity = (luaCallerArguments[1]?.toDouble());
      return [];
    });
...
class RTManagedRenderSliverOpacity extends _26cc.RenderSliverOpacity
    implements _36c2.Box<_26cc.RenderSliverOpacity> {
  RTManagedRenderSliverOpacity(
...
void loadRenderSliverOpacity(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['renderSliverOpacity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverOpacity(
  ...
  _36c2.registerBoxer<_26cc.RenderSliverOpacity>(boxer: (
      {required _26cc.RenderSliverOpacity vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRenderSliverOpacity(

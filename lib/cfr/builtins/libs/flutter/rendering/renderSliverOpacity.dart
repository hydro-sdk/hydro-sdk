...
class VMManagedRenderSliverOpacity extends VMManagedBox<RenderSliverOpacity> {
  ...
  final RenderSliverOpacity vmObject;
}

class RTManagedRenderSliverOpacity extends RenderSliverOpacity
    implements Box<RenderSliverOpacity> {
  RTManagedRenderSliverOpacity(
    ...
    table['_dart_setOpacity'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.opacity = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  RenderSliverOpacity unwrap() => this;
  RenderSliverOpacity get vmObject => this;
  @override
...
void loadRenderSliverOpacity(
  ...
  registerBoxer<RenderSliverOpacity>(boxer: (
      {required RenderSliverOpacity vmObject,

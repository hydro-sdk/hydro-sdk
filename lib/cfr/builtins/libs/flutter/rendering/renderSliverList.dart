...
class VMManagedRenderSliverList extends _36c2.VMManagedBox<_13cd.RenderSliverList> {VMManagedRenderSliverList({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _13cd.RenderSliverList vmObject;

 }

class RTManagedRenderSliverList extends _13cd.RenderSliverList implements _36c2.Box<_13cd.RenderSliverList> {RTManagedRenderSliverList({required _35be.RenderSliverBoxChildManager childManager, required this.table, required this.hydroState}) : super(childManager: childManager) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_13cd.RenderSliverList unwrap() => this;
_13cd.RenderSliverList get vmObject => this;
...
void loadRenderSliverList({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'renderSliverList'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRenderSliverList(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_13cd.RenderSliverList>(boxer: ({required _13cd.RenderSliverList vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRenderSliverList(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

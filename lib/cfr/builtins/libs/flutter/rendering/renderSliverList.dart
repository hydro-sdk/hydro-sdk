...
class VMManagedRenderSliverList
    extends _36c2.VMManagedBox<_13cd.RenderSliverList> {
...
class RTManagedRenderSliverList extends _13cd.RenderSliverList
    implements _36c2.Box<_13cd.RenderSliverList> {
...
void loadRenderSliverList(
  ...
  table['renderSliverList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRenderSliverList(
  ...
  _36c2.registerBoxer<_13cd.RenderSliverList>(boxer: (
      {required _13cd.RenderSliverList vmObject,

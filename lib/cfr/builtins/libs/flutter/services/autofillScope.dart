...
class VMManagedAutofillScope extends _36c2.VMManagedBox<_7283.AutofillScope> {VMManagedAutofillScope({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadAutofillScope({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_7283.AutofillScope>(boxer: ({required _7283.AutofillScope vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAutofillScope(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

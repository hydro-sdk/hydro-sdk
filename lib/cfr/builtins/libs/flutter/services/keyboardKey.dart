...
class VMManagedKeyboardKey extends _36c2.VMManagedBox<_e468.KeyboardKey> {VMManagedKeyboardKey({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _e468.KeyboardKey vmObject;

 }

class RTManagedKeyboardKey extends _e468.KeyboardKey implements _36c2.Box<_e468.KeyboardKey> {RTManagedKeyboardKey({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_e468.KeyboardKey unwrap() => this;
_e468.KeyboardKey get vmObject => this;
...
void loadKeyboardKey({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keyboardKey'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedKeyboardKey(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_e468.KeyboardKey>(boxer: ({required _e468.KeyboardKey vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyboardKey(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

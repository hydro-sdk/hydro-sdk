...
class VMManagedMessageCodec
    extends _36c2.VMManagedBox<_7fbb.MessageCodec<_fac9.dynamic>> {
  VMManagedMessageCodec(
...
void loadMessageCodec(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_7fbb.MessageCodec>(boxer: (
      {required _7fbb.MessageCodec vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMessageCodec(

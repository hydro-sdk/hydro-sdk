...
class VMManagedTextEditingDelta
    extends _36c2.VMManagedBox<_99ef.TextEditingDelta> {
  VMManagedTextEditingDelta(
...
class RTManagedTextEditingDelta extends _99ef.TextEditingDelta
    implements _36c2.Box<_99ef.TextEditingDelta> {
  RTManagedTextEditingDelta(
    ...
    table['_dart_apply'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: apply(_36c2.maybeUnBoxAndBuildArgument<
                _8577.TextEditingValue,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
...
void loadTextEditingDelta(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['textEditingDelta'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTextEditingDelta(
  ...
  table['textEditingDeltaFromJSON'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_99ef.TextEditingDelta>(
          object: _99ef.TextEditingDelta.fromJSON(
  ...
  _36c2.registerBoxer<_99ef.TextEditingDelta>(boxer: (
      {required _99ef.TextEditingDelta vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTextEditingDelta(

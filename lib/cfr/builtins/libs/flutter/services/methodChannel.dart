...
class VMManagedMethodChannel extends _36c2.VMManagedBox<_aebe.MethodChannel> {
  VMManagedMethodChannel(
...
class RTManagedMethodChannel extends _aebe.MethodChannel
    implements _36c2.Box<_aebe.MethodChannel> {
  RTManagedMethodChannel(_fac9.String name$, _7fbb.MethodCodec codec$,
...
void loadMethodChannel(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['methodChannel'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMethodChannel(
          luaCallerArguments[1],
  ...
  _36c2.registerBoxer<_aebe.MethodChannel>(boxer: (
      {required _aebe.MethodChannel vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMethodChannel(

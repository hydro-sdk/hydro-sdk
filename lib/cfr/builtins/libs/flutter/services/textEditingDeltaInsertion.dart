...
class VMManagedTextEditingDeltaInsertion extends _36c2.VMManagedBox<_99ef.TextEditingDeltaInsertion> {VMManagedTextEditingDeltaInsertion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'textInserted'
] = vmObject.textInserted;
table  [
'insertionOffset'
] = vmObject.insertionOffset;
table  [
'oldText'
] = vmObject.oldText;
table  [
...
class RTManagedTextEditingDeltaInsertion extends _99ef.TextEditingDeltaInsertion implements _36c2.Box<_99ef.TextEditingDeltaInsertion> {RTManagedTextEditingDeltaInsertion({required _a643.TextRange composing, required _fac9.int insertionOffset, required _fac9.String oldText, required _7986.TextSelection selection, required _fac9.String textInserted, required this.table, required this.hydroState}) : super(composing: composing,insertionOffset: insertionOffset,oldText: oldText,selection: selection,textInserted: textInserted) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'textInserted'
] = _36c2.maybeBoxObject(object: this.textInserted, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'insertionOffset'
] = _36c2.maybeBoxObject(object: this.insertionOffset, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'oldText'
...
void loadTextEditingDeltaInsertion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedTextEditingDeltaInsertion(table: luaCallerArguments  [
0
...
'composing'
] : null, parentState: hydroState), insertionOffset: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'insertionOffset'
] : null, oldText: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'oldText'
...
'selection'
] : null, parentState: hydroState), textInserted: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textInserted'
] : null)]; } );
_36c2.registerBoxer<_99ef.TextEditingDeltaInsertion>(boxer: ({required _99ef.TextEditingDeltaInsertion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextEditingDeltaInsertion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

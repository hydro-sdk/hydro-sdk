...
class VMManagedKeyHelper extends _36c2.VMManagedBox<_a336.KeyHelper> {VMManagedKeyHelper({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadKeyHelper({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_a336.KeyHelper>(boxer: ({required _a336.KeyHelper vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyHelper(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

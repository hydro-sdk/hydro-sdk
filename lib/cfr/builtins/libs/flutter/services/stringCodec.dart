...
class VMManagedStringCodec extends _36c2.VMManagedBox<_860d.StringCodec> {VMManagedStringCodec({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedStringCodec extends _860d.StringCodec implements _36c2.Box<_860d.StringCodec> {RTManagedStringCodec({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _fac9.String? decodeMessage(message) { 
...
void loadStringCodec({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'stringCodec'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedStringCodec(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_860d.StringCodec>(boxer: ({required _860d.StringCodec vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedStringCodec(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

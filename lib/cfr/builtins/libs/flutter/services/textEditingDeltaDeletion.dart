...
class VMManagedTextEditingDeltaDeletion extends _36c2.VMManagedBox<_99ef.TextEditingDeltaDeletion> {VMManagedTextEditingDeltaDeletion({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'deletedRange'
] = _36c2.maybeBoxObject<_a643.TextRange>(object: vmObject.deletedRange, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'oldText'
] = vmObject.oldText;
table  [
...
table  [
'getTextDeleted'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.textDeleted,]; } );
table  [
'apply'
...
class RTManagedTextEditingDeltaDeletion extends _99ef.TextEditingDeltaDeletion implements _36c2.Box<_99ef.TextEditingDeltaDeletion> {RTManagedTextEditingDeltaDeletion({required _a643.TextRange composing, required _a643.TextRange deletedRange, required _fac9.String oldText, required _7986.TextSelection selection, required this.table, required this.hydroState}) : super(composing: composing,deletedRange: deletedRange,oldText: oldText,selection: selection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'deletedRange'
] = _36c2.maybeBoxObject(object: this.deletedRange, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'oldText'
...
@_fac9.override _fac9.String get textDeleted { 
...
void loadTextEditingDeltaDeletion({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textEditingDeltaDeletion'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedTextEditingDeltaDeletion(table: luaCallerArguments  [
0
...
'composing'
] : null, parentState: hydroState), deletedRange: _36c2.maybeUnBoxAndBuildArgument<_a643.TextRange, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'deletedRange'
...
_36c2.registerBoxer<_99ef.TextEditingDeltaDeletion>(boxer: ({required _99ef.TextEditingDeltaDeletion vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextEditingDeltaDeletion(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

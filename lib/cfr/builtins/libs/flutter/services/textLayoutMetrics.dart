...
class VMManagedTextLayoutMetrics extends _36c2.VMManagedBox<_0f57.TextLayoutMetrics> {VMManagedTextLayoutMetrics({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTextLayoutMetrics extends _0f57.TextLayoutMetrics implements _36c2.Box<_0f57.TextLayoutMetrics> {RTManagedTextLayoutMetrics({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTextLayoutMetrics({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textLayoutMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedTextLayoutMetrics(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'textLayoutMetricsIsWhitespace'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_0f57.TextLayoutMetrics.isWhitespace(luaCallerArguments  [
1
]),]; } );
_36c2.registerBoxer<_0f57.TextLayoutMetrics>(boxer: ({required _0f57.TextLayoutMetrics vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextLayoutMetrics(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

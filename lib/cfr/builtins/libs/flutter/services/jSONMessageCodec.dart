...
class VMManagedJSONMessageCodec
    extends _36c2.VMManagedBox<_860d.JSONMessageCodec> {
  VMManagedJSONMessageCodec(
...
class RTManagedJSONMessageCodec extends _860d.JSONMessageCodec
    implements _36c2.Box<_860d.JSONMessageCodec> {
  RTManagedJSONMessageCodec({required this.table, required this.hydroState})
      : super() {
...
void loadJSONMessageCodec(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['jSONMessageCodec'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedJSONMessageCodec(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_860d.JSONMessageCodec>(boxer: (
      {required _860d.JSONMessageCodec vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedJSONMessageCodec(

...
class VMManagedRawKeyboard extends _36c2.VMManagedBox<_94e8.RawKeyboard> {
  VMManagedRawKeyboard(
    ...
    table['addListener'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.addListener((value) => unpackedlistener.dispatch(
    ...
    table['removeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedlistener = luaCallerArguments[1];
      vmObject.removeListener((value) => unpackedlistener.dispatch(
            [luaCallerArguments[0], value],
            parentState: hydroState,
          ));
      return [];
    });
    table['getKeyEventHandler'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.keyEventHandler;
      if (returnValue != null) {
        return [
          returnValue,
        ];
    ...
    table['setKeyEventHandler'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedhandler = luaCallerArguments[1];
      vmObject.keyEventHandler = (unpackedhandler != null
          ? (event) => unpackedhandler.dispatch(
    ...
    table['handleRawKeyEvent'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.handleRawKeyEvent(
            _36c2.maybeUnBoxAndBuildArgument<_94e8.RawKeyEvent, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
      ];
    });
    table['getKeysPressed'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_fac9.Set>(
            object: vmObject.keysPressed,
            hydroState: hydroState,
...
void loadRawKeyboard(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_94e8.RawKeyboard>(boxer: (
      {required _94e8.RawKeyboard vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyboard(

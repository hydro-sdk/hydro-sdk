...
class VMManagedGLFWKeyHelper extends _36c2.VMManagedBox<_a336.GLFWKeyHelper> {
  VMManagedGLFWKeyHelper(
...
class RTManagedGLFWKeyHelper extends _a336.GLFWKeyHelper
    implements _36c2.Box<_a336.GLFWKeyHelper> {
  RTManagedGLFWKeyHelper({required this.table, required this.hydroState})
      : super() {
...
void loadGLFWKeyHelper(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['gLFWKeyHelper'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGLFWKeyHelper(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_a336.GLFWKeyHelper>(boxer: (
      {required _a336.GLFWKeyHelper vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGLFWKeyHelper(

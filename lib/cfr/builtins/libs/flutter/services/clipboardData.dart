...
class VMManagedClipboardData extends _36c2.VMManagedBox<_2668.ClipboardData> {
  VMManagedClipboardData(
...
class RTManagedClipboardData extends _2668.ClipboardData
    implements _36c2.Box<_2668.ClipboardData> {
  RTManagedClipboardData(
...
void loadClipboardData(
  ...
  table['clipboardData'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedClipboardData(
  ...
  _36c2.registerBoxer<_2668.ClipboardData>(boxer: (
      {required _2668.ClipboardData vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedClipboardData(

...
class VMManagedBinaryCodec extends _36c2.VMManagedBox<_860d.BinaryCodec> {
  VMManagedBinaryCodec(
...
class RTManagedBinaryCodec extends _860d.BinaryCodec
    implements _36c2.Box<_860d.BinaryCodec> {
  RTManagedBinaryCodec({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_encodeMessage'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: super.encodeMessage(_36c2.maybeUnBoxAndBuildArgument<
                _7537.ByteData?,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  _7537.ByteData? decodeMessage(message) {
...
void loadBinaryCodec(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['binaryCodec'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBinaryCodec(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_860d.BinaryCodec>(boxer: (
      {required _860d.BinaryCodec vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBinaryCodec(

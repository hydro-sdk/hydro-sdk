...
class VMManagedRawKeyEventDataIos extends _36c2.VMManagedBox<_7d32.RawKeyEventDataIos> {VMManagedRawKeyEventDataIos({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRawKeyEventDataIos extends _7d32.RawKeyEventDataIos implements _36c2.Box<_7d32.RawKeyEventDataIos> {RTManagedRawKeyEventDataIos({required _fac9.String characters, required _fac9.String charactersIgnoringModifiers, required _fac9.int keyCode, required _fac9.int modifiers, required this.table, required this.hydroState}) : super(characters: characters,charactersIgnoringModifiers: charactersIgnoringModifiers,keyCode: keyCode,modifiers: modifiers) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRawKeyEventDataIos({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventDataIos'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRawKeyEventDataIos(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_7d32.RawKeyEventDataIos>(boxer: ({required _7d32.RawKeyEventDataIos vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataIos(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

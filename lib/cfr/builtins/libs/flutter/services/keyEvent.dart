...
class VMManagedKeyEvent extends _36c2.VMManagedBox<_9e29.KeyEvent> {VMManagedKeyEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedKeyEvent extends _9e29.KeyEvent implements _36c2.Box<_9e29.KeyEvent> {RTManagedKeyEvent({_fac9.String? character, required _fac9.bool synthesized, required _e468.LogicalKeyboardKey logicalKey, required _e468.PhysicalKeyboardKey physicalKey, required _fac9.Duration timeStamp, required this.table, required this.hydroState}) : super(character: character,synthesized: synthesized,logicalKey: logicalKey,physicalKey: physicalKey,timeStamp: timeStamp) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadKeyEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keyEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedKeyEvent(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_9e29.KeyEvent>(boxer: ({required _9e29.KeyEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedKeyDownEvent extends _36c2.VMManagedBox<_9e29.KeyDownEvent> {VMManagedKeyDownEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedKeyDownEvent extends _9e29.KeyDownEvent implements _36c2.Box<_9e29.KeyDownEvent> {RTManagedKeyDownEvent({_fac9.String? character, required _fac9.bool synthesized, required _e468.LogicalKeyboardKey logicalKey, required _e468.PhysicalKeyboardKey physicalKey, required _fac9.Duration timeStamp, required this.table, required this.hydroState}) : super(character: character,synthesized: synthesized,logicalKey: logicalKey,physicalKey: physicalKey,timeStamp: timeStamp) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadKeyDownEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keyDownEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedKeyDownEvent(table: luaCallerArguments  [
0
], hydroState: hydroState, character: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'character'
] : null, synthesized: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'synthesized'
...
_36c2.registerBoxer<_9e29.KeyDownEvent>(boxer: ({required _9e29.KeyDownEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyDownEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

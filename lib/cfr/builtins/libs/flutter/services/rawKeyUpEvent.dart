...
class VMManagedRawKeyUpEvent extends _36c2.VMManagedBox<_94e8.RawKeyUpEvent> {
  VMManagedRawKeyUpEvent(
...
class RTManagedRawKeyUpEvent extends _94e8.RawKeyUpEvent
    implements _36c2.Box<_94e8.RawKeyUpEvent> {
  RTManagedRawKeyUpEvent(
...
void loadRawKeyUpEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyUpEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyUpEvent(
  ...
  _36c2.registerBoxer<_94e8.RawKeyUpEvent>(boxer: (
      {required _94e8.RawKeyUpEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyUpEvent(

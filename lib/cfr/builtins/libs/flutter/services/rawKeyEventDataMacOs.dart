...
import 'package:flutter/src/services/raw_keyboard_macos.dart' as _00df;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedRawKeyEventDataMacOs extends _36c2.VMManagedBox<_00df.RawKeyEventDataMacOs> {VMManagedRawKeyEventDataMacOs({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = vmObject.charactersIgnoringModifiers;
table  [
'keyCode'
] = vmObject.keyCode;
table  [
...
final _00df.RawKeyEventDataMacOs vmObject;

 }

class RTManagedRawKeyEventDataMacOs extends _00df.RawKeyEventDataMacOs implements _36c2.Box<_00df.RawKeyEventDataMacOs> {RTManagedRawKeyEventDataMacOs({required _fac9.String characters, required _fac9.String charactersIgnoringModifiers, required _fac9.int keyCode, required _fac9.int modifiers, required this.table, required this.hydroState}) : super(characters: characters,charactersIgnoringModifiers: charactersIgnoringModifiers,keyCode: keyCode,modifiers: modifiers) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'characters'
] = _36c2.maybeBoxObject(object: this.characters, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'charactersIgnoringModifiers'
] = _36c2.maybeBoxObject(object: this.charactersIgnoringModifiers, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'keyCode'
...
_00df.RawKeyEventDataMacOs unwrap() => this;
_00df.RawKeyEventDataMacOs get vmObject => this;
...
void loadRawKeyEventDataMacOs({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventDataMacOs'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRawKeyEventDataMacOs(table: luaCallerArguments  [
0
], hydroState: hydroState, characters: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'characters'
] : null, charactersIgnoringModifiers: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'charactersIgnoringModifiers'
...
_36c2.registerBoxer<_00df.RawKeyEventDataMacOs>(boxer: ({required _00df.RawKeyEventDataMacOs vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataMacOs(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

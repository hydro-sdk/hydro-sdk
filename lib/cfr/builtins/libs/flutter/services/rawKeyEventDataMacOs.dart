...
class VMManagedRawKeyEventDataMacOs
    extends _36c2.VMManagedBox<_00df.RawKeyEventDataMacOs> {
  VMManagedRawKeyEventDataMacOs(
...
class RTManagedRawKeyEventDataMacOs extends _00df.RawKeyEventDataMacOs
    implements _36c2.Box<_00df.RawKeyEventDataMacOs> {
  RTManagedRawKeyEventDataMacOs(
...
void loadRawKeyEventDataMacOs(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyEventDataMacOs'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyEventDataMacOs(
  ...
  _36c2.registerBoxer<_00df.RawKeyEventDataMacOs>(boxer: (
      {required _00df.RawKeyEventDataMacOs vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyEventDataMacOs(

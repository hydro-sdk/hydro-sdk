...
class VMManagedTextEditingDeltaNonTextUpdate extends _36c2.VMManagedBox<_99ef.TextEditingDeltaNonTextUpdate> {VMManagedTextEditingDeltaNonTextUpdate({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTextEditingDeltaNonTextUpdate extends _99ef.TextEditingDeltaNonTextUpdate implements _36c2.Box<_99ef.TextEditingDeltaNonTextUpdate> {RTManagedTextEditingDeltaNonTextUpdate({required _a643.TextRange composing, required _fac9.String oldText, required _7986.TextSelection selection, required this.table, required this.hydroState}) : super(composing: composing,oldText: oldText,selection: selection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTextEditingDeltaNonTextUpdate({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textEditingDeltaNonTextUpdate'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTextEditingDeltaNonTextUpdate(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_99ef.TextEditingDeltaNonTextUpdate>(boxer: ({required _99ef.TextEditingDeltaNonTextUpdate vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextEditingDeltaNonTextUpdate(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

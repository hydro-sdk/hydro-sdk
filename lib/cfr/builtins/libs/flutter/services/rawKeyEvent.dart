...
class VMManagedRawKeyEvent extends _36c2.VMManagedBox<_94e8.RawKeyEvent> {
  VMManagedRawKeyEvent(
    ...
    table['data'] = _36c2.maybeBoxObject<_94e8.RawKeyEventData>(
        object: vmObject.data,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['isKeyPressed'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isKeyPressed(_36c2.maybeUnBoxAndBuildArgument<
...
class RTManagedRawKeyEvent extends _94e8.RawKeyEvent
    implements _36c2.Box<_94e8.RawKeyEvent> {
  RTManagedRawKeyEvent(
      {_fac9.String? character,
      required _94e8.RawKeyEventData data,
      required this.table,
      required this.hydroState})
      : super(character: character, data: data) {
    ...
    table['_dart_isKeyPressed'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
...
void loadRawKeyEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyEvent(
          ...
          character: luaCallerArguments.length >= 2
              ...
              : null,
          data: _36c2
              .maybeUnBoxAndBuildArgument<_94e8.RawKeyEventData, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  table['rawKeyEventFromMessage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_94e8.RawKeyEvent>(
          object: _94e8.RawKeyEvent.fromMessage(
  ...
  _36c2.registerBoxer<_94e8.RawKeyEvent>(boxer: (
      {required _94e8.RawKeyEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyEvent(

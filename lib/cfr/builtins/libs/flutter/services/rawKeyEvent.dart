...
class VMManagedRawKeyEvent extends _36c2.VMManagedBox<_94e8.RawKeyEvent> {VMManagedRawKeyEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _94e8.RawKeyEvent vmObject;

 }

class RTManagedRawKeyEvent extends _94e8.RawKeyEvent implements _36c2.Box<_94e8.RawKeyEvent> {RTManagedRawKeyEvent({_fac9.String? character, required _94e8.RawKeyEventData data, required this.table, required this.hydroState}) : super(character: character,data: data) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_94e8.RawKeyEvent unwrap() => this;
_94e8.RawKeyEvent get vmObject => this;
...
void loadRawKeyEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRawKeyEvent(table: luaCallerArguments  [
0
...
table  [
'rawKeyEventFromMessage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_94e8.RawKeyEvent>(object: _94e8.RawKeyEvent.fromMessage(_36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.String,_fac9.dynamic>, _fac9.String>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
_36c2.registerBoxer<_94e8.RawKeyEvent>(boxer: ({required _94e8.RawKeyEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

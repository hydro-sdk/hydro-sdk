...
class VMManagedAndroidViewController extends _36c2.VMManagedBox<_40e3.AndroidViewController> {VMManagedAndroidViewController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadAndroidViewController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
table  [
'androidViewControllerPointerAction'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_40e3.AndroidViewController.pointerAction(luaCallerArguments  [
1
], luaCallerArguments  [
2
]),]; } );
_36c2.registerBoxer<_40e3.AndroidViewController>(boxer: ({required _40e3.AndroidViewController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAndroidViewController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedEventChannel extends _36c2.VMManagedBox<_aebe.EventChannel> {VMManagedEventChannel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_7de1.Stream>(object: vmObject.receiveBroadcastStream(luaCallerArguments  [
1
...
class RTManagedEventChannel extends _aebe.EventChannel implements _36c2.Box<_aebe.EventChannel> {RTManagedEventChannel(_fac9.String name$, _7fbb.MethodCodec codec$, _71d1.BinaryMessenger? binaryMessenger$, {required this.table, required this.hydroState}) : super(name$,codec$,binaryMessenger$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_receiveBroadcastStream'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
@_fac9.override _7de1.Stream<_fac9.dynamic> receiveBroadcastStream([_fac9.dynamic? arguments]) { 
...
void loadEventChannel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'eventChannel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedEventChannel(luaCallerArguments  [
1
...
_36c2.registerBoxer<_aebe.EventChannel>(boxer: ({required _aebe.EventChannel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedEventChannel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

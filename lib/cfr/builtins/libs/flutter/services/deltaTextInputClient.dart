...
class VMManagedDeltaTextInputClient
    extends _36c2.VMManagedBox<_8577.DeltaTextInputClient> {
  VMManagedDeltaTextInputClient(
    ...
    table['updateEditingValueWithDeltas'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.updateEditingValueWithDeltas(_36c2.maybeUnBoxAndBuildArgument<
              _fac9.List<_99ef.TextEditingDelta>,
              _99ef.TextEditingDelta>(luaCallerArguments[1],
    ...
    table['getCurrentTextEditingValue'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.currentTextEditingValue;
      if (returnValue != null) {
        return [
...
void loadDeltaTextInputClient(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_8577.DeltaTextInputClient>(boxer: (
      {required _8577.DeltaTextInputClient vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDeltaTextInputClient(

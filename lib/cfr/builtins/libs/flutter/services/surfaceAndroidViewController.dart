...
class VMManagedSurfaceAndroidViewController extends _36c2.VMManagedBox<_40e3.SurfaceAndroidViewController> {VMManagedSurfaceAndroidViewController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadSurfaceAndroidViewController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_40e3.SurfaceAndroidViewController>(boxer: ({required _40e3.SurfaceAndroidViewController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSurfaceAndroidViewController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

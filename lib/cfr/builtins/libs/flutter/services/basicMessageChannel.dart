...
class VMManagedBasicMessageChannel
    extends _36c2.VMManagedBox<_aebe.BasicMessageChannel<_fac9.dynamic>> {
  VMManagedBasicMessageChannel(
    ...
    table['codec'] = _36c2.maybeBoxObject<_7fbb.MessageCodec>(
    ...
    table['send'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.send(luaCallerArguments[1]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setMessageHandler'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.setMessageHandler(unpackedhandler != null
...
class RTManagedBasicMessageChannel extends _aebe.BasicMessageChannel
    implements _36c2.Box<_aebe.BasicMessageChannel> {
  RTManagedBasicMessageChannel(
      _fac9.String name$, _7fbb.MessageCodec<_fac9.dynamic> codec$,
    ...
    table['codec'] = _36c2.maybeBoxObject(
        object: this.codec, hydroState: hydroState, table: _36c2.HydroTable());
    table['_dart_getBinaryMessenger'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.binaryMessenger];
    });
    table['_dart_send'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_setMessageHandler'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedhandler = luaCallerArguments[1];
  ...
  @_fac9.override
  _7de1.Future<_fac9.dynamic?> send(message) {
  ...
  @_fac9.override
  void setMessageHandler(handler) {
    _36c2.Closure closure = table["setMessageHandler"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
}

void loadBasicMessageChannel(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['basicMessageChannel'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBasicMessageChannel(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_7fbb.MessageCodec<_fac9.dynamic>,
              _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState,
          binaryMessenger: _36c2.maybeUnBoxAndBuildArgument<
                  _71d1.BinaryMessenger?, _fac9.dynamic>(
              luaCallerArguments.length >= 4
                  ? luaCallerArguments[3]['binaryMessenger']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_aebe.BasicMessageChannel>(boxer: (
      {required _aebe.BasicMessageChannel vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBasicMessageChannel(

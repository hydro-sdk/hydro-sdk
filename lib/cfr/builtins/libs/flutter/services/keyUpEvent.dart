...
class VMManagedKeyUpEvent extends _36c2.VMManagedBox<_9e29.KeyUpEvent> {VMManagedKeyUpEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedKeyUpEvent extends _9e29.KeyUpEvent implements _36c2.Box<_9e29.KeyUpEvent> {RTManagedKeyUpEvent({required _fac9.bool synthesized, required _e468.LogicalKeyboardKey logicalKey, required _e468.PhysicalKeyboardKey physicalKey, required _fac9.Duration timeStamp, required this.table, required this.hydroState}) : super(synthesized: synthesized,logicalKey: logicalKey,physicalKey: physicalKey,timeStamp: timeStamp) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'character'
] = _36c2.maybeBoxObject(object: character, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'timeStamp'
...
void loadKeyUpEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'keyUpEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedKeyUpEvent(table: luaCallerArguments  [
0
], hydroState: hydroState, synthesized: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'synthesized'
...
_36c2.registerBoxer<_9e29.KeyUpEvent>(boxer: ({required _9e29.KeyUpEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedKeyUpEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

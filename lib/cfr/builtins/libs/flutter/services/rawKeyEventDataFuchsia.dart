...
class VMManagedRawKeyEventDataFuchsia extends _36c2.VMManagedBox<_078a.RawKeyEventDataFuchsia> {VMManagedRawKeyEventDataFuchsia({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRawKeyEventDataFuchsia extends _078a.RawKeyEventDataFuchsia implements _36c2.Box<_078a.RawKeyEventDataFuchsia> {RTManagedRawKeyEventDataFuchsia({required _fac9.int codePoint, required _fac9.int hidUsage, required _fac9.int modifiers, required this.table, required this.hydroState}) : super(codePoint: codePoint,hidUsage: hidUsage,modifiers: modifiers) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'hidUsage'
] = _36c2.maybeBoxObject(object: this.hidUsage, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'codePoint'
...
void loadRawKeyEventDataFuchsia({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventDataFuchsia'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedRawKeyEventDataFuchsia(table: luaCallerArguments  [
0
], hydroState: hydroState, codePoint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'codePoint'
] : null, hidUsage: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'hidUsage'
...
_36c2.registerBoxer<_078a.RawKeyEventDataFuchsia>(boxer: ({required _078a.RawKeyEventDataFuchsia vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataFuchsia(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

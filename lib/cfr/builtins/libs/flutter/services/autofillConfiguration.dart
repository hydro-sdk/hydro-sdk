...
class VMManagedAutofillConfiguration
    extends _36c2.VMManagedBox<_7283.AutofillConfiguration> {
  VMManagedAutofillConfiguration(
    ...
    table['uniqueIdentifier'] = vmObject.uniqueIdentifier;
    table['autofillHints'] = _36c2.maybeBoxObject<_fac9.List<_fac9.String>>(
        object: vmObject.autofillHints,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['currentEditingValue'] = _36c2.maybeBoxObject<_8577.TextEditingValue>(
        object: vmObject.currentEditingValue,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['hintText'] = vmObject.hintText;
    table['toJson'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.toJson();
      if (returnValue != null) {
        return [
...
class RTManagedAutofillConfiguration extends _7283.AutofillConfiguration
  ...
  RTManagedAutofillConfiguration(
      {_fac9.String? hintText,
      required _fac9.List<_fac9.String> autofillHints,
      required _8577.TextEditingValue currentEditingValue,
      required _fac9.String uniqueIdentifier,
      required this.table,
    ...
    table['uniqueIdentifier'] = _36c2.maybeBoxObject(
        object: this.uniqueIdentifier,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['autofillHints'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['currentEditingValue'] = _36c2.maybeBoxObject(
        object: this.currentEditingValue,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadAutofillConfiguration(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['autofillConfiguration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAutofillConfiguration(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          hintText: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['hintText']
              : null,
          autofillHints: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_fac9.String>, _fac9.String>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          currentEditingValue: _36c2
              .maybeUnBoxAndBuildArgument<_8577.TextEditingValue, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['currentEditingValue']
                      : null,
                  parentState: hydroState),
          uniqueIdentifier: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['uniqueIdentifier']
              : null)
    ];
  });
  table['autofillConfigurationDisabled'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_7283.AutofillConfiguration>(
          object: _7283.AutofillConfiguration.disabled,
          hydroState: hydroState,
          table: _36c2.HydroTable())
    ];
  });
  _36c2.registerBoxer<_7283.AutofillConfiguration>(boxer: (
      {required _7283.AutofillConfiguration vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAutofillConfiguration(

...
class VMManagedPlatformViewController extends _36c2.VMManagedBox<_40e3.PlatformViewController> {VMManagedPlatformViewController({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadPlatformViewController({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { 
_36c2.registerBoxer<_40e3.PlatformViewController>(boxer: ({required _40e3.PlatformViewController vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlatformViewController(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedRawKeyEventDataLinux
    extends _36c2.VMManagedBox<_a336.RawKeyEventDataLinux> {
  VMManagedRawKeyEventDataLinux(
    ...
    table['keyHelper'] = _36c2.maybeBoxObject<_a336.KeyHelper>(
        object: vmObject.keyHelper,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['unicodeScalarValues'] = vmObject.unicodeScalarValues;
    table['scanCode'] = vmObject.scanCode;
    table['keyCode'] = vmObject.keyCode;
    table['modifiers'] = vmObject.modifiers;
    table['isDown'] = vmObject.isDown;
...
class RTManagedRawKeyEventDataLinux extends _a336.RawKeyEventDataLinux
    implements _36c2.Box<_a336.RawKeyEventDataLinux> {
  RTManagedRawKeyEventDataLinux(
      {required _fac9.int keyCode,
      required _fac9.int modifiers,
      required _fac9.int scanCode,
      required _fac9.int unicodeScalarValues,
      required _fac9.bool isDown,
      required _a336.KeyHelper keyHelper,
      required this.table,
    ...
    table['keyHelper'] = _36c2.maybeBoxObject(
        object: this.keyHelper,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['unicodeScalarValues'] = _36c2.maybeBoxObject(
        object: this.unicodeScalarValues,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['modifiers'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['isDown'] = _36c2.maybeBoxObject(
        object: this.isDown, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadRawKeyEventDataLinux(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyEventDataLinux'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyEventDataLinux(
          ...
          scanCode: luaCallerArguments.length >= 2
              ...
              : null,
          unicodeScalarValues: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['unicodeScalarValues']
              : null,
          isDown: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['isDown']
              : null,
          keyHelper:
              _36c2.maybeUnBoxAndBuildArgument<_a336.KeyHelper, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['keyHelper']
                      : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_a336.RawKeyEventDataLinux>(boxer: (
      {required _a336.RawKeyEventDataLinux vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyEventDataLinux(

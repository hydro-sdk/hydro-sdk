...
class VMManagedMouseCursor extends _36c2.VMManagedBox<_fd33.MouseCursor> {VMManagedMouseCursor({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _fd33.MouseCursor vmObject;

 }

class RTManagedMouseCursor extends _fd33.MouseCursor implements _36c2.Box<_fd33.MouseCursor> {RTManagedMouseCursor({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return  [unwrap()]; } );
table['_dart_createSession'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
...
_fd33.MouseCursor unwrap() => this;
_fd33.MouseCursor get vmObject => this;
@_fac9.override _fd33.MouseCursorSession createSession(device) { 
_36c2.Closure closure = table["createSession"];
return _36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursorSession, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMouseCursor({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'mouseCursor'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedMouseCursor(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_fd33.MouseCursor>(boxer: ({required _fd33.MouseCursor vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMouseCursor(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

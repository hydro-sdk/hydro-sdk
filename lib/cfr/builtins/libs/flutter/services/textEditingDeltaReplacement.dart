...
class VMManagedTextEditingDeltaReplacement extends _36c2.VMManagedBox<_99ef.TextEditingDeltaReplacement> {VMManagedTextEditingDeltaReplacement({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'replacementText'
] = vmObject.replacementText;
table  [
'replacedRange'
] = _36c2.maybeBoxObject<_a643.TextRange>(object: vmObject.replacedRange, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'oldText'
] = vmObject.oldText;
table  [
...
table  [
'getTextReplaced'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.textReplaced,]; } );
table  [
'apply'
...
class RTManagedTextEditingDeltaReplacement extends _99ef.TextEditingDeltaReplacement implements _36c2.Box<_99ef.TextEditingDeltaReplacement> {RTManagedTextEditingDeltaReplacement({required _a643.TextRange composing, required _fac9.String oldText, required _a643.TextRange replacedRange, required _fac9.String replacementText, required _7986.TextSelection selection, required this.table, required this.hydroState}) : super(composing: composing,oldText: oldText,replacedRange: replacedRange,replacementText: replacementText,selection: selection) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'replacementText'
] = _36c2.maybeBoxObject(object: this.replacementText, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'replacedRange'
] = _36c2.maybeBoxObject(object: this.replacedRange, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'oldText'
...
@_fac9.override _fac9.String get textReplaced { 
...
void loadTextEditingDeltaReplacement({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedTextEditingDeltaReplacement(table: luaCallerArguments  [
0
...
'oldText'
] : null, replacedRange: _36c2.maybeUnBoxAndBuildArgument<_a643.TextRange, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'replacedRange'
] : null, parentState: hydroState), replacementText: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'replacementText'
...
_36c2.registerBoxer<_99ef.TextEditingDeltaReplacement>(boxer: ({required _99ef.TextEditingDeltaReplacement vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextEditingDeltaReplacement(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

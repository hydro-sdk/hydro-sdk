...
class VMManagedLengthLimitingTextInputFormatter
    extends _36c2.VMManagedBox<_86aa.LengthLimitingTextInputFormatter> {
  VMManagedLengthLimitingTextInputFormatter(
...
class RTManagedLengthLimitingTextInputFormatter
    extends _86aa.LengthLimitingTextInputFormatter
    implements _36c2.Box<_86aa.LengthLimitingTextInputFormatter> {
  RTManagedLengthLimitingTextInputFormatter(_fac9.int? maxLength$,
...
void loadLengthLimitingTextInputFormatter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['lengthLimitingTextInputFormatter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLengthLimitingTextInputFormatter(luaCallerArguments[1],
          table: luaCallerArguments[0],
          hydroState: hydroState,
          maxLengthEnforcement: _36c2.maybeUnBoxEnum(
              values: _86aa.MaxLengthEnforcement.values,
              boxedEnum: luaCallerArguments.length >= 3
                  ? luaCallerArguments[2]['maxLengthEnforcement']
                  : null))
    ];
  });
  table['lengthLimitingTextInputFormatterGetDefaultMaxLengthEnforcement'] =
      _36c2.makeLuaDartFunc(
          func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _86aa.MaxLengthEnforcement.values.indexWhere((x) {
        return x ==
            _86aa.LengthLimitingTextInputFormatter
                .getDefaultMaxLengthEnforcement(_36c2.maybeUnBoxEnum(
                    values: _9164.TargetPlatform.values,
                    boxedEnum: luaCallerArguments[1]));
      }),
    ];
  });
  table['lengthLimitingTextInputFormatterTruncate'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_8577.TextEditingValue>(
          object: _86aa.LengthLimitingTextInputFormatter.truncate(
              _36c2.maybeUnBoxAndBuildArgument<_8577.TextEditingValue,
                      _fac9.dynamic>(luaCallerArguments[1],
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_86aa.LengthLimitingTextInputFormatter>(boxer: (
      {required _86aa.LengthLimitingTextInputFormatter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLengthLimitingTextInputFormatter(

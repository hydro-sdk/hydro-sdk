...
class VMManagedRawKeyEventData extends _36c2.VMManagedBox<_94e8.RawKeyEventData> {VMManagedRawKeyEventData({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRawKeyEventData extends _94e8.RawKeyEventData implements _36c2.Box<_94e8.RawKeyEventData> {RTManagedRawKeyEventData({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRawKeyEventData({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventData'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedRawKeyEventData(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_94e8.RawKeyEventData>(boxer: ({required _94e8.RawKeyEventData vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventData(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

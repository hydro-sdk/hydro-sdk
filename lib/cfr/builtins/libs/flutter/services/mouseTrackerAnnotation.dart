...
class VMManagedMouseTrackerAnnotation extends _36c2.VMManagedBox<_23ad.MouseTrackerAnnotation> {VMManagedMouseTrackerAnnotation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedMouseTrackerAnnotation extends _23ad.MouseTrackerAnnotation implements _36c2.Box<_23ad.MouseTrackerAnnotation> {RTManagedMouseTrackerAnnotation({required _fd33.MouseCursor cursor, void Function(_0e77.PointerEnterEvent event)? onEnter, void Function(_0e77.PointerExitEvent event)? onExit, required _fac9.bool validForMouseTracker, required this.table, required this.hydroState}) : super(cursor: cursor,onEnter: onEnter,onExit: onExit,validForMouseTracker: validForMouseTracker) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadMouseTrackerAnnotation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedMouseTrackerAnnotation(table: luaCallerArguments  [
0
], hydroState: hydroState, cursor: _36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursor, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'cursor'
] : null, parentState: hydroState), onEnter: unpackedonEnter != null ? (event) => unpackedonEnter.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , onExit: unpackedonExit != null ? (event) => unpackedonExit.dispatch([luaCallerArguments[0],event],parentState:hydroState,) : null , validForMouseTracker: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'validForMouseTracker'
] : null)]; } );
_36c2.registerBoxer<_23ad.MouseTrackerAnnotation>(boxer: ({required _23ad.MouseTrackerAnnotation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMouseTrackerAnnotation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

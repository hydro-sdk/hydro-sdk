...
class VMManagedPlatformAssetBundle
    extends _36c2.VMManagedBox<_136d.PlatformAssetBundle> {
  VMManagedPlatformAssetBundle(
...
class RTManagedPlatformAssetBundle extends _136d.PlatformAssetBundle
    implements _36c2.Box<_136d.PlatformAssetBundle> {
  RTManagedPlatformAssetBundle({required this.table, required this.hydroState})
      : super() {
...
void loadPlatformAssetBundle(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['platformAssetBundle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlatformAssetBundle(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_136d.PlatformAssetBundle>(boxer: (
      {required _136d.PlatformAssetBundle vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPlatformAssetBundle(

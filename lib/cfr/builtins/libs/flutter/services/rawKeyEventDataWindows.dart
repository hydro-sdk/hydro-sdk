...
class VMManagedRawKeyEventDataWindows
    extends _36c2.VMManagedBox<_87b4.RawKeyEventDataWindows> {
  VMManagedRawKeyEventDataWindows(
    ...
    table['characterCodePoint'] = vmObject.characterCodePoint;
...
class RTManagedRawKeyEventDataWindows extends _87b4.RawKeyEventDataWindows
  ...
  RTManagedRawKeyEventDataWindows(
      {required _fac9.int characterCodePoint,
    ...
    table['scanCode'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['characterCodePoint'] = _36c2.maybeBoxObject(
        object: this.characterCodePoint,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadRawKeyEventDataWindows(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyEventDataWindows'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyEventDataWindows(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          characterCodePoint: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['characterCodePoint']
              : null,
  ...
  _36c2.registerBoxer<_87b4.RawKeyEventDataWindows>(boxer: (
      {required _87b4.RawKeyEventDataWindows vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyEventDataWindows(

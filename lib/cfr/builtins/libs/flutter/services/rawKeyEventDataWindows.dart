...
import 'package:flutter/src/services/raw_keyboard_windows.dart' as _87b4;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedRawKeyEventDataWindows extends _36c2.VMManagedBox<_87b4.RawKeyEventDataWindows> {VMManagedRawKeyEventDataWindows({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _87b4.RawKeyEventDataWindows vmObject;

 }

class RTManagedRawKeyEventDataWindows extends _87b4.RawKeyEventDataWindows implements _36c2.Box<_87b4.RawKeyEventDataWindows> {RTManagedRawKeyEventDataWindows({required _fac9.int characterCodePoint, required _fac9.int keyCode, required _fac9.int modifiers, required _fac9.int scanCode, required this.table, required this.hydroState}) : super(characterCodePoint: characterCodePoint,keyCode: keyCode,modifiers: modifiers,scanCode: scanCode) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'characterCodePoint'
] = _36c2.maybeBoxObject(object: this.characterCodePoint, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'modifiers'
...
_87b4.RawKeyEventDataWindows unwrap() => this;
_87b4.RawKeyEventDataWindows get vmObject => this;
...
void loadRawKeyEventDataWindows({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventDataWindows'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRawKeyEventDataWindows(table: luaCallerArguments  [
0
], hydroState: hydroState, characterCodePoint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'characterCodePoint'
...
_36c2.registerBoxer<_87b4.RawKeyEventDataWindows>(boxer: ({required _87b4.RawKeyEventDataWindows vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataWindows(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

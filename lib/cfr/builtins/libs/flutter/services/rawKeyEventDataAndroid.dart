...
class VMManagedRawKeyEventDataAndroid extends _36c2.VMManagedBox<_b68a.RawKeyEventDataAndroid> {VMManagedRawKeyEventDataAndroid({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getModifierSide'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getModifierSide(_36c2.maybeUnBoxEnum(values: _94e8.ModifierKey.values, boxedEnum: luaCallerArguments  [
1
]));if(returnValue!= null){return [_94e8.KeyboardSide.values.indexWhere((x) { return x == returnValue; } ),];}return []; } );
table  [
'debugFillProperties'
...
class RTManagedRawKeyEventDataAndroid extends _b68a.RawKeyEventDataAndroid implements _36c2.Box<_b68a.RawKeyEventDataAndroid> {RTManagedRawKeyEventDataAndroid({required _fac9.int codePoint, required _fac9.int deviceId, required _fac9.int eventSource, required _fac9.int flags, required _fac9.int keyCode, required _fac9.int metaState, required _fac9.int plainCodePoint, required _fac9.int productId, required _fac9.int repeatCount, required _fac9.int scanCode, required _fac9.int vendorId, required this.table, required this.hydroState}) : super(codePoint: codePoint,deviceId: deviceId,eventSource: eventSource,flags: flags,keyCode: keyCode,metaState: metaState,plainCodePoint: plainCodePoint,productId: productId,repeatCount: repeatCount,scanCode: scanCode,vendorId: vendorId) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'codePoint'
] = _36c2.maybeBoxObject(object: this.codePoint, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'plainCodePoint'
] = _36c2.maybeBoxObject(object: this.plainCodePoint, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'keyCode'
...
table  [
'eventSource'
] = _36c2.maybeBoxObject(object: this.eventSource, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'vendorId'
] = _36c2.maybeBoxObject(object: this.vendorId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'productId'
] = _36c2.maybeBoxObject(object: this.productId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'deviceId'
] = _36c2.maybeBoxObject(object: this.deviceId, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'repeatCount'
] = _36c2.maybeBoxObject(object: this.repeatCount, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadRawKeyEventDataAndroid({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedRawKeyEventDataAndroid(table: luaCallerArguments  [
0
], hydroState: hydroState, codePoint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'codePoint'
...
'deviceId'
] : null, eventSource: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'eventSource'
...
'flags'
] : null, keyCode: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'keyCode'
...
'metaState'
] : null, plainCodePoint: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'plainCodePoint'
] : null, productId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'productId'
] : null, repeatCount: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'repeatCount'
...
'scanCode'
] : null, vendorId: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'vendorId'
] : null)]; } );
_36c2.registerBoxer<_b68a.RawKeyEventDataAndroid>(boxer: ({required _b68a.RawKeyEventDataAndroid vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataAndroid(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

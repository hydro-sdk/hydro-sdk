...
class VMManagedCachingAssetBundle
    extends _36c2.VMManagedBox<_136d.CachingAssetBundle> {
  VMManagedCachingAssetBundle(
...
class RTManagedCachingAssetBundle extends _136d.CachingAssetBundle
    implements _36c2.Box<_136d.CachingAssetBundle> {
  RTManagedCachingAssetBundle({required this.table, required this.hydroState})
      : super() {
...
void loadCachingAssetBundle(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['cachingAssetBundle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCachingAssetBundle(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_136d.CachingAssetBundle>(boxer: (
      {required _136d.CachingAssetBundle vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCachingAssetBundle(

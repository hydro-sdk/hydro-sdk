...
class VMManagedRawKeyEventDataWeb extends _36c2.VMManagedBox<_fba7.RawKeyEventDataWeb> {VMManagedRawKeyEventDataWeb({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRawKeyEventDataWeb extends _fba7.RawKeyEventDataWeb implements _36c2.Box<_fba7.RawKeyEventDataWeb> {RTManagedRawKeyEventDataWeb({required _fac9.int location, required _fac9.int metaState, required _fac9.String code, required _fac9.String key, required this.table, required this.hydroState}) : super(location: location,metaState: metaState,code: code,key: key) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRawKeyEventDataWeb({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyEventDataWeb'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedRawKeyEventDataWeb(table: luaCallerArguments  [
0
...
'code'
] : null, key: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'key'
] : null)]; } );
_36c2.registerBoxer<_fba7.RawKeyEventDataWeb>(boxer: ({required _fba7.RawKeyEventDataWeb vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyEventDataWeb(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedTextEditingValue
    extends _36c2.VMManagedBox<_8577.TextEditingValue> {
  VMManagedTextEditingValue(
    ...
    table['getIsComposingRangeValid'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isComposingRangeValid,
      ];
    });
...
class RTManagedTextEditingValue extends _8577.TextEditingValue
    implements _36c2.Box<_8577.TextEditingValue> {
  RTManagedTextEditingValue(
      {required _a643.TextRange composing,
      required _7986.TextSelection selection,
      required _fac9.String text,
      required this.table,
      required this.hydroState})
      : super(composing: composing, selection: selection, text: text) {
    ...
    table['_dart_getIsComposingRangeValid'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _8577.TextEditingValue copyWith(
      {_a643.TextRange? composing,
  ...
  @_fac9.override
  _fac9.bool get isComposingRangeValid {
...
void loadTextEditingValue(
  ...
  table['textEditingValue'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTextEditingValue(
  ...
  table['textEditingValueFromJSON'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_8577.TextEditingValue>(
          object: _8577.TextEditingValue.fromJSON(
  ...
  _36c2.registerBoxer<_8577.TextEditingValue>(boxer: (
      {required _8577.TextEditingValue vmObject,

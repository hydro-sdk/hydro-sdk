...
class VMManagedRawKeyDownEvent extends _36c2.VMManagedBox<_94e8.RawKeyDownEvent> {VMManagedRawKeyDownEvent({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedRawKeyDownEvent extends _94e8.RawKeyDownEvent implements _36c2.Box<_94e8.RawKeyDownEvent> {RTManagedRawKeyDownEvent({_fac9.String? character, required _94e8.RawKeyEventData data, required this.table, required this.hydroState}) : super(character: character,data: data) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadRawKeyDownEvent({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'rawKeyDownEvent'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRawKeyDownEvent(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_94e8.RawKeyDownEvent>(boxer: ({required _94e8.RawKeyDownEvent vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRawKeyDownEvent(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

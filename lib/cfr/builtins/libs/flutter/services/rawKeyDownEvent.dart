...
class VMManagedRawKeyDownEvent
    extends _36c2.VMManagedBox<_94e8.RawKeyDownEvent> {
  VMManagedRawKeyDownEvent(
  ...
  final _94e8.RawKeyDownEvent vmObject;
}

class RTManagedRawKeyDownEvent extends _94e8.RawKeyDownEvent
    implements _36c2.Box<_94e8.RawKeyDownEvent> {
  RTManagedRawKeyDownEvent(
  ...
  _94e8.RawKeyDownEvent unwrap() => this;
  _94e8.RawKeyDownEvent get vmObject => this;
  @_fac9.override
...
void loadRawKeyDownEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['rawKeyDownEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRawKeyDownEvent(
  ...
  _36c2.registerBoxer<_94e8.RawKeyDownEvent>(boxer: (
      {required _94e8.RawKeyDownEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRawKeyDownEvent(

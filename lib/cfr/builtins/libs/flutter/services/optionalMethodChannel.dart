...
class VMManagedOptionalMethodChannel extends _36c2.VMManagedBox<_aebe.OptionalMethodChannel> {VMManagedOptionalMethodChannel({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedOptionalMethodChannel extends _aebe.OptionalMethodChannel implements _36c2.Box<_aebe.OptionalMethodChannel> {RTManagedOptionalMethodChannel(_fac9.String name$, _7fbb.MethodCodec codec$, _71d1.BinaryMessenger? binaryMessenger$, {required this.table, required this.hydroState}) : super(name$,codec$,binaryMessenger$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadOptionalMethodChannel({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'optionalMethodChannel'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedOptionalMethodChannel(luaCallerArguments  [
1
...
_36c2.registerBoxer<_aebe.OptionalMethodChannel>(boxer: ({required _aebe.OptionalMethodChannel vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOptionalMethodChannel(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedOptionalMethodChannel
    extends _36c2.VMManagedBox<_aebe.OptionalMethodChannel> {
  VMManagedOptionalMethodChannel(
    ...
    table['invokeMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.invokeMethod(
                luaCallerArguments[1], luaCallerArguments[2]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['invokeListMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.invokeListMethod(
                luaCallerArguments[1], luaCallerArguments[2]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['invokeMapMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.invokeMapMethod(
                luaCallerArguments[1], luaCallerArguments[2]),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['setMethodCallHandler'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedhandler = luaCallerArguments[1];
      vmObject.setMethodCallHandler(unpackedhandler != null
          ? (call) => _36c2.maybeUnBoxAndBuildArgument<
  ...
  final _aebe.OptionalMethodChannel vmObject;
}

class RTManagedOptionalMethodChannel extends _aebe.OptionalMethodChannel
    implements _36c2.Box<_aebe.OptionalMethodChannel> {
  RTManagedOptionalMethodChannel(_fac9.String name$, _7fbb.MethodCodec codec$,
    ...
    table['_dart_invokeMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_invokeListMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_invokeMapMethod'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_setMethodCallHandler'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedhandler = luaCallerArguments[1];
  ...
  _aebe.OptionalMethodChannel unwrap() => this;
  _aebe.OptionalMethodChannel get vmObject => this;
  @_fac9.override
  _7de1.Future<T?> invokeMethod<T>(method, [_fac9.dynamic? arguments]) {
  ...
  @_fac9.override
  _7de1.Future<_fac9.List<T>?> invokeListMethod<T>(method,
      [_fac9.dynamic? arguments]) {
    _36c2.Closure closure = table["invokeListMethod"];
    return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.List<T>?>,
            _fac9.List<T>?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _7de1.Future<_fac9.Map<K, V>?> invokeMapMethod<K, V>(method,
      [_fac9.dynamic? arguments]) {
    _36c2.Closure closure = table["invokeMapMethod"];
    return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_fac9.Map<K, V>?>,
            _fac9.Map<K, V>?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  void setMethodCallHandler(handler) {
...
void loadOptionalMethodChannel(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['optionalMethodChannel'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOptionalMethodChannel(
          luaCallerArguments[1],
  ...
  _36c2.registerBoxer<_aebe.OptionalMethodChannel>(boxer: (
      {required _aebe.OptionalMethodChannel vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOptionalMethodChannel(

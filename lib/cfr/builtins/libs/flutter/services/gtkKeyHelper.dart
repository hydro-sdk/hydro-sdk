...
class VMManagedGtkKeyHelper extends _36c2.VMManagedBox<_a336.GtkKeyHelper> {VMManagedGtkKeyHelper({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedGtkKeyHelper extends _a336.GtkKeyHelper implements _36c2.Box<_a336.GtkKeyHelper> {RTManagedGtkKeyHelper({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadGtkKeyHelper({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'gtkKeyHelper'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedGtkKeyHelper(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_a336.GtkKeyHelper>(boxer: ({required _a336.GtkKeyHelper vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGtkKeyHelper(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

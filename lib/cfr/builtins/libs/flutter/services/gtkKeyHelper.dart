...
class VMManagedGtkKeyHelper extends _36c2.VMManagedBox<_a336.GtkKeyHelper> {
  VMManagedGtkKeyHelper(
  ...
  final _a336.GtkKeyHelper vmObject;
}

class RTManagedGtkKeyHelper extends _a336.GtkKeyHelper
    implements _36c2.Box<_a336.GtkKeyHelper> {
  RTManagedGtkKeyHelper({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_getDebugToolkit'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_numpadKey'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_logicalKey'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_getPlatformPlane'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _a336.GtkKeyHelper unwrap() => this;
  _a336.GtkKeyHelper get vmObject => this;
  @_fac9.override
  _fac9.String get debugToolkit {
    _36c2.Closure closure = table["getDebugToolkit"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.bool isModifierPressed(key, modifiers,
  ...
  @_fac9.override
  _e468.LogicalKeyboardKey? numpadKey(keyCode) {
  ...
  @_fac9.override
  _e468.LogicalKeyboardKey? logicalKey(keyCode) {
  ...
  @_fac9.override
  _fac9.int get platformPlane {
    _36c2.Closure closure = table["getPlatformPlane"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
}

void loadGtkKeyHelper(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['gtkKeyHelper'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGtkKeyHelper(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_a336.GtkKeyHelper>(boxer: (
      {required _a336.GtkKeyHelper vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGtkKeyHelper(

...
class VMManagedAutofillScopeMixin
    extends _36c2.VMManagedBox<_7283.AutofillScopeMixin> {
  VMManagedAutofillScopeMixin(
  ...
  final _7283.AutofillScopeMixin vmObject;
}

void loadAutofillScopeMixin(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_7283.AutofillScopeMixin>(boxer: (
      {required _7283.AutofillScopeMixin vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAutofillScopeMixin(

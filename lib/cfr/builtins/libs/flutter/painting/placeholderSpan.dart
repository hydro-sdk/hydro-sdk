...
class VMManagedPlaceholderSpan
    extends _36c2.VMManagedBox<_3579.PlaceholderSpan> {
  VMManagedPlaceholderSpan(
...
class RTManagedPlaceholderSpan extends _3579.PlaceholderSpan
    implements _36c2.Box<_3579.PlaceholderSpan> {
  RTManagedPlaceholderSpan(
      {required _a643.PlaceholderAlignment alignment,
      _a643.TextBaseline? baseline,
      _74d0.TextStyle? style,
      required this.table,
      required this.hydroState})
      : super(alignment: alignment, baseline: baseline, style: style) {
...
void loadPlaceholderSpan(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['placeholderSpan'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPlaceholderSpan(
  ...
  _36c2.registerBoxer<_3579.PlaceholderSpan>(boxer: (
      {required _3579.PlaceholderSpan vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPlaceholderSpan(

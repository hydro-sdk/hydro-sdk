...
class VMManagedPlaceholderSpan extends _36c2.VMManagedBox<_3579.PlaceholderSpan> {VMManagedPlaceholderSpan({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _3579.PlaceholderSpan vmObject;

 }

class RTManagedPlaceholderSpan extends _3579.PlaceholderSpan implements _36c2.Box<_3579.PlaceholderSpan> {RTManagedPlaceholderSpan({required _a643.PlaceholderAlignment alignment, _a643.TextBaseline? baseline, _74d0.TextStyle? style, required this.table, required this.hydroState}) : super(alignment: alignment,baseline: baseline,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3579.PlaceholderSpan unwrap() => this;
_3579.PlaceholderSpan get vmObject => this;
...
void loadPlaceholderSpan({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'placeholderSpan'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedPlaceholderSpan(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3579.PlaceholderSpan>(boxer: ({required _3579.PlaceholderSpan vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPlaceholderSpan(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

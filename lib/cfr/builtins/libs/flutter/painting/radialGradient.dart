...
class VMManagedRadialGradient extends _36c2.VMManagedBox<_8a60.RadialGradient> {VMManagedRadialGradient({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'focal'
] = _36c2.maybeBoxObject<_ca85.AlignmentGeometry?>(object: vmObject.focal, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'focalRadius'
] = vmObject.focalRadius;
table  [
'colors'
...
table  [
'scale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_8a60.RadialGradient>(object: vmObject.scale(luaCallerArguments  [
1
...
class RTManagedRadialGradient extends _8a60.RadialGradient implements _36c2.Box<_8a60.RadialGradient> {RTManagedRadialGradient({required _ca85.AlignmentGeometry center, _ca85.AlignmentGeometry? focal, required _fac9.double focalRadius, required _fac9.double radius, _fac9.List<_fac9.double>? stops, required _a643.TileMode tileMode, _8a60.GradientTransform? transform, required _fac9.List<_a643.Color> colors, required this.table, required this.hydroState}) : super(center: center,focal: focal,focalRadius: focalRadius,radius: radius,stops: stops,tileMode: tileMode,transform: transform,colors: colors) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'focal'
] = _36c2.maybeBoxObject(object: this.focal, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'focalRadius'
] = _36c2.maybeBoxObject(object: this.focalRadius, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'colors'
...
@_fac9.override _8a60.RadialGradient scale(factor) { 
_36c2.Closure closure = table["scale"];
return _36c2.maybeUnBoxAndBuildArgument<_8a60.RadialGradient, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRadialGradient({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'radialGradient'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedRadialGradient(table: luaCallerArguments  [
0
...
'center'
] : null, parentState: hydroState), focal: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'focal'
] : null, parentState: hydroState), focalRadius: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'focalRadius'
...
final returnValue = _8a60.RadialGradient.lerp(_36c2.maybeUnBoxAndBuildArgument<_8a60.RadialGradient?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_8a60.RadialGradient?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_8a60.RadialGradient?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_8a60.RadialGradient>(boxer: ({required _8a60.RadialGradient vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRadialGradient(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

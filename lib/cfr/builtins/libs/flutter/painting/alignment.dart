...
class VMManagedAlignment extends _36c2.VMManagedBox<_ca85.Alignment> {
  VMManagedAlignment(
...
class RTManagedAlignment extends _ca85.Alignment
    implements _36c2.Box<_ca85.Alignment> {
  RTManagedAlignment(_fac9.double x$, _fac9.double y$,
...
void loadAlignment(
  ...
  table['alignment'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAlignment(
  ...
  table['alignmentLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _ca85.Alignment.lerp(
  ...
  _36c2.registerBoxer<_ca85.Alignment>(boxer: (
      {required _ca85.Alignment vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAlignment(

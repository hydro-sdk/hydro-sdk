...
class VMManagedAlignmentGeometry
    extends _36c2.VMManagedBox<_ca85.AlignmentGeometry> {
  VMManagedAlignmentGeometry(
...
void loadAlignmentGeometry(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['alignmentGeometryLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _ca85.AlignmentGeometry.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry?,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry?,
  ...
  _36c2.registerBoxer<_ca85.AlignmentGeometry>(boxer: (
      {required _ca85.AlignmentGeometry vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAlignmentGeometry(

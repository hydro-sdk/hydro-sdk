...
class VMManagedBoxPainter extends _36c2.VMManagedBox<_13a5.BoxPainter> {VMManagedBoxPainter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedBoxPainter extends _13a5.BoxPainter implements _36c2.Box<_13a5.BoxPainter> {RTManagedBoxPainter(void Function()? onChanged, {required this.table, required this.hydroState}) : super(onChanged,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override void paint(canvas, offset, configuration) { 
...
void loadBoxPainter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'boxPainter'
...
return  [RTManagedBoxPainter(unpackedonChanged != null ? () => unpackedonChanged.dispatch([luaCallerArguments[0],],parentState:hydroState,) : null , table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_13a5.BoxPainter>(boxer: ({required _13a5.BoxPainter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBoxPainter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

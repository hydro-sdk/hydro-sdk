...
class VMManagedFlutterLogoDecoration extends _36c2.VMManagedBox<_2ef8.FlutterLogoDecoration> {VMManagedFlutterLogoDecoration({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'textColor'
] = _36c2.maybeBoxObject<_a643.Color>(object: vmObject.textColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'style'
] = _2ef8.FlutterLogoStyle.values.indexWhere((x) { return x == vmObject.style; } );
table  [
'margin'
] = _36c2.maybeBoxObject<_96d1.EdgeInsets>(object: vmObject.margin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugAssertIsValid'
...
2
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_2ef8.FlutterLogoDecoration?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'lerpTo'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
class RTManagedFlutterLogoDecoration extends _2ef8.FlutterLogoDecoration implements _36c2.Box<_2ef8.FlutterLogoDecoration> {RTManagedFlutterLogoDecoration({required _96d1.EdgeInsets margin, required _2ef8.FlutterLogoStyle style, required _a643.Color textColor, required this.table, required this.hydroState}) : super(margin: margin,style: style,textColor: textColor) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'textColor'
] = _36c2.maybeBoxObject(object: this.textColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'style'
] = _2ef8.FlutterLogoStyle.values.indexWhere((x) { return x == this.style; } );
table  [
'margin'
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _2ef8.FlutterLogoDecoration? lerpFrom(a, t) { 
_36c2.Closure closure = table["lerpFrom"];
return _36c2.maybeUnBoxAndBuildArgument<_2ef8.FlutterLogoDecoration?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _2ef8.FlutterLogoDecoration? lerpTo(b, t) { 
...
void loadFlutterLogoDecoration({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'flutterLogoDecoration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedFlutterLogoDecoration(table: luaCallerArguments  [
0
], hydroState: hydroState, margin: _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsets, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'margin'
] : null, parentState: hydroState), style: _36c2.maybeUnBoxEnum(values: _2ef8.FlutterLogoStyle.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'style'
] : null), textColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textColor'
...
final returnValue = _2ef8.FlutterLogoDecoration.lerp(_36c2.maybeUnBoxAndBuildArgument<_2ef8.FlutterLogoDecoration?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_2ef8.FlutterLogoDecoration?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_2ef8.FlutterLogoDecoration?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_2ef8.FlutterLogoDecoration>(boxer: ({required _2ef8.FlutterLogoDecoration vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFlutterLogoDecoration(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedAlignmentDirectional extends _36c2.VMManagedBox<_ca85.AlignmentDirectional> {VMManagedAlignmentDirectional({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAlignmentDirectional extends _ca85.AlignmentDirectional implements _36c2.Box<_ca85.AlignmentDirectional> {RTManagedAlignmentDirectional(_fac9.double start$, _fac9.double y$, {required this.table, required this.hydroState}) : super(start$,y$,) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAlignmentDirectional({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'alignmentDirectional'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedAlignmentDirectional(luaCallerArguments  [
1
...
final returnValue = _ca85.AlignmentDirectional.lerp(_36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentDirectional?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentDirectional?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_ca85.AlignmentDirectional?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_ca85.AlignmentDirectional>(boxer: ({required _ca85.AlignmentDirectional vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAlignmentDirectional(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

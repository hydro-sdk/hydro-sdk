...
import 'package:flutter/src/painting/image_resolution.dart' as _ed02;
...
class VMManagedAssetImage extends _36c2.VMManagedBox<_ed02.AssetImage> {
  VMManagedAssetImage(
    ...
    table['assetName'] = vmObject.assetName;
    table['bundle'] = _36c2.maybeBoxObject<_136d.AssetBundle?>(
        object: vmObject.bundle,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['package'] = vmObject.package;
    table['getKeyName'] = _36c2.makeLuaDartFunc(
  ...
  final _ed02.AssetImage vmObject;
}

class RTManagedAssetImage extends _ed02.AssetImage
    implements _36c2.Box<_ed02.AssetImage> {
  RTManagedAssetImage(_fac9.String assetName$,
      {_136d.AssetBundle? bundle,
    ...
    table['assetName'] = _36c2.maybeBoxObject(
        object: this.assetName,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['bundle'] = _36c2.maybeBoxObject(
        object: this.bundle, hydroState: hydroState, table: _36c2.HydroTable());
    table['package'] = _36c2.maybeBoxObject(
        object: this.package,
        hydroState: hydroState,
        table: _36c2.HydroTable());

    table['_dart_getKeyName'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _ed02.AssetImage unwrap() => this;
  _ed02.AssetImage get vmObject => this;
  @_fac9.override
  _fac9.String get keyName {
...
void loadAssetImage(
  ...
  table['assetImage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedAssetImage(luaCallerArguments[1],
          table: luaCallerArguments[0],
          hydroState: hydroState,
          bundle: _36c2
              .maybeUnBoxAndBuildArgument<_136d.AssetBundle?, _fac9.dynamic>(
                  luaCallerArguments.length >= 3
                      ? luaCallerArguments[2]['bundle']
                      : null,
                  parentState: hydroState),
          package: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['package']
              : null)
    ];
  });
  _36c2.registerBoxer<_ed02.AssetImage>(boxer: (
      {required _ed02.AssetImage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAssetImage(

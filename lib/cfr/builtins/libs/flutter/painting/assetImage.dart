...
class VMManagedAssetImage extends _36c2.VMManagedBox<_ed02.AssetImage> {VMManagedAssetImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAssetImage extends _ed02.AssetImage implements _36c2.Box<_ed02.AssetImage> {RTManagedAssetImage(_fac9.String assetName$, {_136d.AssetBundle? bundle, _fac9.String? package, required this.table, required this.hydroState}) : super(assetName$,bundle: bundle,package: package) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAssetImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'assetImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedAssetImage(luaCallerArguments  [
1
...
_36c2.registerBoxer<_ed02.AssetImage>(boxer: ({required _ed02.AssetImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAssetImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedContinuousRectangleBorder
    extends _36c2.VMManagedBox<_78fc.ContinuousRectangleBorder> {
  VMManagedContinuousRectangleBorder(
    ...
    table['copyWith'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_78fc.ContinuousRectangleBorder>(
...
class RTManagedContinuousRectangleBorder extends _78fc.ContinuousRectangleBorder
    implements _36c2.Box<_78fc.ContinuousRectangleBorder> {
  RTManagedContinuousRectangleBorder(
  ...
  @_fac9.override
  _78fc.ContinuousRectangleBorder copyWith(
      {_9d8a.BorderRadiusGeometry? borderRadius, _6be9.BorderSide? side}) {
    _36c2.Closure closure = table["copyWith"];
    return _36c2.maybeUnBoxAndBuildArgument<_78fc.ContinuousRectangleBorder,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadContinuousRectangleBorder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['continuousRectangleBorder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedContinuousRectangleBorder(
  ...
  _36c2.registerBoxer<_78fc.ContinuousRectangleBorder>(boxer: (
      {required _78fc.ContinuousRectangleBorder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedContinuousRectangleBorder(

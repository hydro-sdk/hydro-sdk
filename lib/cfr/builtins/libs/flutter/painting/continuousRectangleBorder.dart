...
import 'package:flutter/src/painting/continuous_rectangle_border.dart' as _78fc;
import 'package:flutter/src/painting/edge_insets.dart' as _96d1;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedContinuousRectangleBorder extends _36c2.VMManagedBox<_78fc.ContinuousRectangleBorder> {VMManagedContinuousRectangleBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_78fc.ContinuousRectangleBorder>(object: vmObject.copyWith(borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadiusGeometry?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderRadius'
] : null, parentState: hydroState), side: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'side'
...
final _78fc.ContinuousRectangleBorder vmObject;

 }

class RTManagedContinuousRectangleBorder extends _78fc.ContinuousRectangleBorder implements _36c2.Box<_78fc.ContinuousRectangleBorder> {RTManagedContinuousRectangleBorder({required _9d8a.BorderRadiusGeometry borderRadius, required _6be9.BorderSide side, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,side: side) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_78fc.ContinuousRectangleBorder unwrap() => this;
_78fc.ContinuousRectangleBorder get vmObject => this;
...
return _36c2.maybeUnBoxAndBuildArgument<_a643.Path, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _78fc.ContinuousRectangleBorder copyWith({_9d8a.BorderRadiusGeometry? borderRadius, _6be9.BorderSide? side}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_78fc.ContinuousRectangleBorder, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadContinuousRectangleBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'continuousRectangleBorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedContinuousRectangleBorder(table: luaCallerArguments  [
0
], hydroState: hydroState, borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadiusGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderRadius'
] : null, parentState: hydroState), side: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
_36c2.registerBoxer<_78fc.ContinuousRectangleBorder>(boxer: ({required _78fc.ContinuousRectangleBorder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedContinuousRectangleBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedResizeImage extends _36c2.VMManagedBox<_61fa.ResizeImage> {
  VMManagedResizeImage(
    ...
    table['imageProvider'] = _36c2.maybeBoxObject<_61fa.ImageProvider>(
        object: vmObject.imageProvider,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['width'] = vmObject.width;
    table['height'] = vmObject.height;
    table['allowUpscaling'] = vmObject.allowUpscaling;
...
class RTManagedResizeImage extends _61fa.ResizeImage
    implements _36c2.Box<_61fa.ResizeImage> {
  RTManagedResizeImage(_61fa.ImageProvider<_fac9.Object> imageProvider$,
      {required _fac9.bool allowUpscaling,
      _fac9.int? height,
      _fac9.int? width,
      required this.table,
      required this.hydroState})
      : super(imageProvider$,
            allowUpscaling: allowUpscaling, height: height, width: width) {
    table['vmObject'] = vmObject;
    table['unwrap'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [unwrap()];
    });
    table['imageProvider'] = _36c2.maybeBoxObject(
        object: this.imageProvider,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['allowUpscaling'] = _36c2.maybeBoxObject(
        object: this.allowUpscaling,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  @_fac9.override
  _7de1.Future<_61fa.ResizeImageKey> obtainKey(configuration) {
    _36c2.Closure closure = table["obtainKey"];
    return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_61fa.ResizeImageKey>,
            _61fa.ResizeImageKey>(
...
void loadResizeImage(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['resizeImage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedResizeImage(
          _36c2.maybeUnBoxAndBuildArgument<_61fa.ImageProvider<_fac9.Object>,
  ...
  table['resizeImageResizeIfNeeded'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_61fa.ImageProvider>(
          object: _61fa.ResizeImage.resizeIfNeeded(
              luaCallerArguments[1],
              luaCallerArguments[2],
              _36c2.maybeUnBoxAndBuildArgument<
                      _61fa.ImageProvider<_fac9.Object>,
                      _fac9.Object>(luaCallerArguments[3],
                  parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  _36c2.registerBoxer<_61fa.ResizeImage>(boxer: (
      {required _61fa.ResizeImage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedResizeImage(

...
class VMManagedNetworkImage extends _36c2.VMManagedBox<_61fa.NetworkImage> {VMManagedNetworkImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'getUrl'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.url,]; } );
table  [
'getScale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.scale,]; } );
table  [
'getHeaders'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.headers;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.Map?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'resolve'
...
void loadNetworkImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'networkImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [_36c2.maybeBoxObject<_61fa.NetworkImage>(object: _61fa.NetworkImage(luaCallerArguments  [
1
], headers: _36c2.maybeUnBoxAndBuildArgument<_fac9.Map<_fac9.String,_fac9.String>?, _fac9.String>(luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'headers'
] : null, parentState: hydroState), scale: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'scale'
] : null?.toDouble()), hydroState: hydroState, table: luaCallerArguments  [
0
])]; } );
_36c2.registerBoxer<_61fa.NetworkImage>(boxer: ({required _61fa.NetworkImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedNetworkImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

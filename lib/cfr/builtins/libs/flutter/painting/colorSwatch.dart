...
class VMManagedColorSwatch
    extends _36c2.VMManagedBox<_898f.ColorSwatch<_fac9.dynamic>> {
  VMManagedColorSwatch(
...
void loadColorSwatch(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['colorSwatch'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColorSwatch(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<
              _fac9.Map<_fac9.dynamic, _a643.Color>,
              _fac9.dynamic>(luaCallerArguments[2], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_898f.ColorSwatch>(boxer: (
      {required _898f.ColorSwatch vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColorSwatch(

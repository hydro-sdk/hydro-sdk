...
class VMManagedAssetBundleImageProvider extends _36c2.VMManagedBox<_61fa.AssetBundleImageProvider> {VMManagedAssetBundleImageProvider({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedAssetBundleImageProvider extends _61fa.AssetBundleImageProvider implements _36c2.Box<_61fa.AssetBundleImageProvider> {RTManagedAssetBundleImageProvider({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadAssetBundleImageProvider({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'assetBundleImageProvider'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedAssetBundleImageProvider(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_61fa.AssetBundleImageProvider>(boxer: ({required _61fa.AssetBundleImageProvider vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedAssetBundleImageProvider(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedImageInfo extends _36c2.VMManagedBox<_f25c.ImageInfo> {
  VMManagedImageInfo(
    ...
    table['clone'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_f25c.ImageInfo>(
            object: vmObject.clone(),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['isCloneOf'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.isCloneOf(
    ...
    table['getSizeBytes'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.sizeBytes,
      ];
...
class RTManagedImageInfo extends _f25c.ImageInfo
    implements _36c2.Box<_f25c.ImageInfo> {
  RTManagedImageInfo(
      {_fac9.String? debugLabel,
      required _fac9.double scale,
      required _a643.Image image,
      required this.table,
      required this.hydroState})
      : super(debugLabel: debugLabel, scale: scale, image: image) {
    ...
    table['debugLabel'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_clone'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_isCloneOf'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.isCloneOf(_36c2.maybeUnBoxAndBuildArgument<
                _f25c.ImageInfo,
    ...
    table['_dart_getSizeBytes'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _f25c.ImageInfo clone() {
    _36c2.Closure closure = table["clone"];
    return _36c2.maybeUnBoxAndBuildArgument<_f25c.ImageInfo, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  _fac9.bool isCloneOf(other) {
    _36c2.Closure closure = table["isCloneOf"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  _fac9.int get sizeBytes {
...
void loadImageInfo(
  ...
  table['imageInfo'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImageInfo(
          ...
          scale: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          image: _36c2.maybeUnBoxAndBuildArgument<_a643.Image, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['image']
                  : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_f25c.ImageInfo>(boxer: (
      {required _f25c.ImageInfo vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImageInfo(

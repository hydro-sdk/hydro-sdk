...
class VMManagedCircleBorder extends _36c2.VMManagedBox<_15d3.CircleBorder> {VMManagedCircleBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'copyWith'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_15d3.CircleBorder>(object: vmObject.copyWith(side: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'side'
...
class RTManagedCircleBorder extends _15d3.CircleBorder implements _36c2.Box<_15d3.CircleBorder> {RTManagedCircleBorder({required _6be9.BorderSide side, required this.table, required this.hydroState}) : super(side: side) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return _36c2.maybeUnBoxAndBuildArgument<_a643.Path, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _15d3.CircleBorder copyWith({_6be9.BorderSide? side}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_15d3.CircleBorder, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadCircleBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'circleBorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedCircleBorder(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_15d3.CircleBorder>(boxer: ({required _15d3.CircleBorder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedCircleBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

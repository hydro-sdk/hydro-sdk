...
class VMManagedOutlinedBorder extends _36c2.VMManagedBox<_6be9.OutlinedBorder> {
  VMManagedOutlinedBorder(
...
void loadOutlinedBorder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  _36c2.registerBoxer<_6be9.OutlinedBorder>(boxer: (
      {required _6be9.OutlinedBorder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOutlinedBorder(

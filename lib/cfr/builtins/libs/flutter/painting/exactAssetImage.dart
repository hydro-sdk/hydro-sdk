...
class VMManagedExactAssetImage
    extends _36c2.VMManagedBox<_61fa.ExactAssetImage> {
  VMManagedExactAssetImage(
...
class RTManagedExactAssetImage extends _61fa.ExactAssetImage
    implements _36c2.Box<_61fa.ExactAssetImage> {
  RTManagedExactAssetImage(_fac9.String assetName$,
...
void loadExactAssetImage(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['exactAssetImage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedExactAssetImage(luaCallerArguments[1],
  ...
  _36c2.registerBoxer<_61fa.ExactAssetImage>(boxer: (
      {required _61fa.ExactAssetImage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedExactAssetImage(

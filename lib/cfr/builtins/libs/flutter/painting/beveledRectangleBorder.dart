...
class VMManagedBeveledRectangleBorder extends _36c2.VMManagedBox<_0b2b.BeveledRectangleBorder> {VMManagedBeveledRectangleBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_0b2b.BeveledRectangleBorder>(object: vmObject.copyWith(borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadiusGeometry?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderRadius'
...
class RTManagedBeveledRectangleBorder extends _0b2b.BeveledRectangleBorder implements _36c2.Box<_0b2b.BeveledRectangleBorder> {RTManagedBeveledRectangleBorder({required _9d8a.BorderRadiusGeometry borderRadius, required _6be9.BorderSide side, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,side: side) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return _36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _0b2b.BeveledRectangleBorder copyWith({_9d8a.BorderRadiusGeometry? borderRadius, _6be9.BorderSide? side}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_0b2b.BeveledRectangleBorder, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadBeveledRectangleBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'beveledRectangleBorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedBeveledRectangleBorder(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_0b2b.BeveledRectangleBorder>(boxer: ({required _0b2b.BeveledRectangleBorder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBeveledRectangleBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

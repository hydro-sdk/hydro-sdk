...
class VMManagedBoxShadow extends _36c2.VMManagedBox<_9068.BoxShadow> {
  VMManagedBoxShadow(
    ...
    table['spreadRadius'] = vmObject.spreadRadius;
    table['blurStyle'] = _a643.BlurStyle.values.indexWhere((x) {
      return x == vmObject.blurStyle;
    });
    ...
    table['scale'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_9068.BoxShadow>(
    ...
    table['getBlurSigma'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.blurSigma,
      ];
...
class RTManagedBoxShadow extends _9068.BoxShadow
  ...
  RTManagedBoxShadow(
      ...
      required _a643.BlurStyle blurStyle,
      required _a643.Color color,
      required _a643.Offset offset,
      required _fac9.double spreadRadius,
      required this.table,
    ...
    table['spreadRadius'] = _36c2.maybeBoxObject(
        object: this.spreadRadius,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['blurStyle'] = _a643.BlurStyle.values.indexWhere((x) {
      return x == this.blurStyle;
    });
    ...
    table['blurRadius'] = _36c2.maybeBoxObject(
        object: this.blurRadius,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_getBlurSigma'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  @_fac9.override
  _9068.BoxShadow scale(factor) {
    _36c2.Closure closure = table["scale"];
    return _36c2.maybeUnBoxAndBuildArgument<_9068.BoxShadow, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadBoxShadow(
  ...
  table['boxShadow'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBoxShadow(
          ...
          blurRadius: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          blurStyle: _36c2.maybeUnBoxEnum(
              values: _a643.BlurStyle.values,
              boxedEnum: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['blurStyle']
                  : null),
          ...
          offset: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          spreadRadius: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['spreadRadius']
              : null?.toDouble())
    ];
  });
  table['boxShadowLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _9068.BoxShadow.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_9068.BoxShadow?, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_9068.BoxShadow?, _fac9.dynamic>(
  ...
  table['boxShadowLerpList'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _9068.BoxShadow.lerpList(
        _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_9068.BoxShadow>?,
            _9068.BoxShadow>(luaCallerArguments[1], parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_9068.BoxShadow>?,
            _9068.BoxShadow>(luaCallerArguments[2], parentState: hydroState),
        luaCallerArguments[3]?.toDouble());
    if (returnValue != null) {
      return [
        _36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(
            object: returnValue
                .map((x) => _36c2.maybeBoxObject<_9068.BoxShadow>(
                    object: x,
                    hydroState: hydroState,
                    table: _36c2.HydroTable()))
                .toList(),
  ...
  _36c2.registerBoxer<_9068.BoxShadow>(boxer: (
      {required _9068.BoxShadow vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBoxShadow(

...
class VMManagedTextPainter extends _36c2.VMManagedBox<_fe5a.TextPainter> {VMManagedTextPainter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getEllipsis'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.ellipsis;if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'setEllipsis'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.ellipsis=(luaCallerArguments  [
1
]);
return []; } );
table  [
...
return []; } );
table  [
'getInlinePlaceholderBoxes'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.inlinePlaceholderBoxes;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: returnValue.map((x) => _36c2.maybeBoxObject<_a643.TextBox>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getInlinePlaceholderScales'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.inlinePlaceholderScales;if(returnValue!= null){return [_36c2.maybeBoxObject<_fac9.List<_fac9.double>?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'setPlaceholderDimensions'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { vmObject.setPlaceholderDimensions(_36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fe5a.PlaceholderDimensions>?, _fe5a.PlaceholderDimensions>(luaCallerArguments  [
1
], parentState: hydroState));
return []; } );
table  [
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.minIntrinsicWidth,]; } );
table  [
'getMaxIntrinsicWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.maxIntrinsicWidth,]; } );
table  [
'getWidth'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.width,]; } );
table  [
'getHeight'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.height,]; } );
table  [
'getSize'
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.didExceedMaxLines,]; } );
table  [
'layout'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
vmObject.layout(maxWidth: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'maxWidth'
...
table  [
'getOffsetAfter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getOffsetAfter(luaCallerArguments  [
1
]);if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getOffsetBefore'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.getOffsetBefore(luaCallerArguments  [
1
]);if(returnValue!= null){return [returnValue,];}return []; } );
table  [
'getOffsetForCaret'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_a643.Offset>(object: vmObject.getOffsetForCaret(_36c2.maybeUnBoxAndBuildArgument<_a643.TextPosition, _fac9.dynamic>(luaCallerArguments  [
1
...
final returnValue = vmObject.getFullHeightForCaret(_36c2.maybeUnBoxAndBuildArgument<_a643.TextPosition, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(luaCallerArguments  [
2
...
return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.getBoxesForSelection(_36c2.maybeUnBoxAndBuildArgument<_7986.TextSelection, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), boxHeightStyle: _36c2.maybeUnBoxEnum(values: _a643.BoxHeightStyle.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'boxHeightStyle'
] : null), boxWidthStyle: _36c2.maybeUnBoxEnum(values: _a643.BoxWidthStyle.values, boxedEnum: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'boxWidthStyle'
] : null)).map((x) => _36c2.maybeBoxObject<_a643.TextBox>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getPositionForOffset'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.TextPosition>(object: vmObject.getPositionForOffset(_36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getWordBoundary'
...
table  [
'getLineBoundary'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.TextRange>(object: vmObject.getLineBoundary(_36c2.maybeUnBoxAndBuildArgument<_a643.TextPosition, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'computeLineMetrics'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_fac9.List<_fac9.dynamic>>(object: vmObject.computeLineMetrics().map((x) => _36c2.maybeBoxObject<_a643.LineMetrics>(object: x, hydroState: hydroState, table: _36c2.HydroTable())).toList(), hydroState: hydroState, table: _36c2.HydroTable()),]; } ); }
...
class RTManagedTextPainter extends _fe5a.TextPainter implements _36c2.Box<_fe5a.TextPainter> {RTManagedTextPainter({_fac9.String? ellipsis, _a643.Locale? locale, _fac9.int? maxLines, _ced4.StrutStyle? strutStyle, _b761.InlineSpan? text, required _a643.TextAlign textAlign, _a643.TextDirection? textDirection, _a643.TextHeightBehavior? textHeightBehavior, required _fac9.double textScaleFactor, required _fe5a.TextWidthBasis textWidthBasis, required this.table, required this.hydroState}) : super(ellipsis: ellipsis,locale: locale,maxLines: maxLines,strutStyle: strutStyle,text: text,textAlign: textAlign,textDirection: textDirection,textHeightBehavior: textHeightBehavior,textScaleFactor: textScaleFactor,textWidthBasis: textWidthBasis) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getEllipsis'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.ellipsis];
});
table['_dart_setEllipsis'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.ellipsis =
...
table['_dart_getInlinePlaceholderBoxes'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.inlinePlaceholderBoxes];
});
table['_dart_getInlinePlaceholderScales'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.inlinePlaceholderScales];
});
table['_dart_setPlaceholderDimensions'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_getDidExceedMaxLines'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
table['_dart_layout'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.layout(
      maxWidth: _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(
...
table['_dart_getFullHeightForCaret'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_getBoxesForSelection'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_getPositionForOffset'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
table['_dart_getLineBoundary'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: super.getLineBoundary(
            _36c2.maybeUnBoxAndBuildArgument<_a643.TextPosition, _fac9.dynamic>(
                luaCallerArguments[1],
                parentState: hydroState)),
        hydroState: hydroState,
...
table['_dart_computeLineMetrics'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.String? get ellipsis { 
_36c2.Closure closure = table["getEllipsis"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void set ellipsis(value) { 
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.List<_a643.TextBox>? get inlinePlaceholderBoxes { 
_36c2.Closure closure = table["getInlinePlaceholderBoxes"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.TextBox>?, _a643.TextBox>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.List<_fac9.double>? get inlinePlaceholderScales { 
_36c2.Closure closure = table["getInlinePlaceholderScales"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.double>?, _fac9.double>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override void setPlaceholderDimensions(value) { 
...
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get minIntrinsicWidth { 
_36c2.Closure closure = table["getMinIntrinsicWidth"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.double get maxIntrinsicWidth { 
...
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.bool get didExceedMaxLines { 
_36c2.Closure closure = table["getDidExceedMaxLines"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void layout({_fac9.double maxWidth = _fac9.double.infinity, _fac9.double minWidth = 0.0}) { 
_36c2.Closure closure = table["layout"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override void paint(canvas, offset) { 
_36c2.Closure closure = table["paint"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int? getOffsetAfter(offset) { 
_36c2.Closure closure = table["getOffsetAfter"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _fac9.int? getOffsetBefore(offset) { 
_36c2.Closure closure = table["getOffsetBefore"];
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _a643.Offset getOffsetForCaret(position, caretPrototype) { 
...
@_fac9.override _fac9.double? getFullHeightForCaret(position, caretPrototype) { 
_36c2.Closure closure = table["getFullHeightForCaret"];
return closure.dispatch([table],parentState: hydroState)[0]?.toDouble(); } 
@_fac9.override _fac9.List<_a643.TextBox> getBoxesForSelection(selection, {_a643.BoxHeightStyle boxHeightStyle = _a643.BoxHeightStyle.tight, _a643.BoxWidthStyle boxWidthStyle = _a643.BoxWidthStyle.tight}) { 
_36c2.Closure closure = table["getBoxesForSelection"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.TextBox>, _a643.TextBox>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _a643.TextPosition getPositionForOffset(offset) { 
...
@_fac9.override _a643.TextRange getLineBoundary(position) { 
_36c2.Closure closure = table["getLineBoundary"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.TextRange, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _fac9.List<_a643.LineMetrics> computeLineMetrics() { 
_36c2.Closure closure = table["computeLineMetrics"];
return _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.LineMetrics>, _a643.LineMetrics>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
 }
void loadTextPainter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textPainter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedTextPainter(table: luaCallerArguments  [
0
], hydroState: hydroState, ellipsis: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ellipsis'
...
_36c2.registerBoxer<_fe5a.TextPainter>(boxer: ({required _fe5a.TextPainter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextPainter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

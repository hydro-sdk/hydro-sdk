...
class VMManagedOneFrameImageStreamCompleter
    extends _36c2.VMManagedBox<_f25c.OneFrameImageStreamCompleter> {
  VMManagedOneFrameImageStreamCompleter(
...
class RTManagedOneFrameImageStreamCompleter
    extends _f25c.OneFrameImageStreamCompleter
    implements _36c2.Box<_f25c.OneFrameImageStreamCompleter> {
  RTManagedOneFrameImageStreamCompleter(_7de1.Future<_f25c.ImageInfo> image,
      {_fac9.Iterable<_eaf3.DiagnosticsNode> Function()? informationCollector,
      required this.table,
      required this.hydroState})
      : super(image, informationCollector: informationCollector) {
    ...
    table['debugLabel'] = _36c2.maybeBoxObject(
        object: debugLabel, hydroState: hydroState, table: _36c2.HydroTable());
...
void loadOneFrameImageStreamCompleter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['oneFrameImageStreamCompleter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedinformationCollector = luaCallerArguments.length >= 3
        ? luaCallerArguments[2]['informationCollector']
        : null;
    return [
      RTManagedOneFrameImageStreamCompleter(
          _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_f25c.ImageInfo>,
              _f25c.ImageInfo>(luaCallerArguments[1], parentState: hydroState),
  ...
  _36c2.registerBoxer<_f25c.OneFrameImageStreamCompleter>(boxer: (
      {required _f25c.OneFrameImageStreamCompleter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOneFrameImageStreamCompleter(

...
class VMManagedTextSpan extends _36c2.VMManagedBox<_1584.TextSpan> {
  VMManagedTextSpan(
    ...
    table['children'] = _36c2.maybeBoxObject<_fac9.List<_b761.InlineSpan>?>(
        object: vmObject.children,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['recognizer'] = _36c2.maybeBoxObject<_02d2.GestureRecognizer?>(
        object: vmObject.recognizer,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['locale'] = _36c2.maybeBoxObject<_a643.Locale?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['spellOut'] = vmObject.spellOut;
    ...
    table['getSpanForPositionVisitor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.getSpanForPositionVisitor(
    ...
    table['computeToPlainText'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.computeToPlainText(
          _36c2.maybeUnBoxAndBuildArgument<_fac9.StringBuffer, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
          includePlaceholders: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['includePlaceholders']
              : null,
          includeSemanticsLabels: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['includeSemanticsLabels']
              : null);
      return [];
    });
    table['computeSemanticsInformation'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.computeSemanticsInformation(
          ...
          inheritedLocale:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Locale?, _fac9.dynamic>(
                  luaCallerArguments.length >= 3
                      ...
                      : null,
                  parentState: hydroState),
          inheritedSpellOut: luaCallerArguments.length >= 3
              ? luaCallerArguments[2]['inheritedSpellOut']
              : null);
      return [];
    });
    table['codeUnitAtVisitor'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.codeUnitAtVisitor(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_b761.Accumulator, _fac9.dynamic>(
              luaCallerArguments[2],
              parentState: hydroState));
    ...
    table['describeSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.describeSemantics(
          _36c2.maybeUnBoxAndBuildArgument<_b761.Accumulator, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState),
...
class RTManagedTextSpan extends _1584.TextSpan
    implements _36c2.Box<_1584.TextSpan> {
  RTManagedTextSpan(
      {_fac9.List<_b761.InlineSpan>? children,
      _a643.Locale? locale,
      ...
      _02d2.GestureRecognizer? recognizer,
    ...
    table['children'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['recognizer'] = _36c2.maybeBoxObject(
        object: this.recognizer,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['spellOut'] = _36c2.maybeBoxObject(
        object: this.spellOut,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_describeSemantics'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  void computeSemanticsInformation(collector,
      {_a643.Locale? inheritedLocale, _fac9.bool inheritedSpellOut = false}) {
  ...
  @_fac9.override
  void describeSemantics(offset, semanticsOffsets, semanticsElements) {
...
void loadTextSpan(
  ...
  table['textSpan'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedTextSpan(
          ...
          hydroState: hydroState,
          children:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_b761.InlineSpan>?, _b761.InlineSpan>(
                  luaCallerArguments.length >= 2
          ...
          locale: _36c2.maybeUnBoxAndBuildArgument<_a643.Locale?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          mouseCursor: _36c2.maybeUnBoxAndBuildArgument<_fd33.MouseCursor?, _fac9.dynamic>(
          ...
          onExit: unpackedonExit != null
              ...
              : null,
          recognizer: _36c2.maybeUnBoxAndBuildArgument<_02d2.GestureRecognizer?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['recognizer'] : null, parentState: hydroState),
          semanticsLabel: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['semanticsLabel'] : null,
          spellOut: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['spellOut'] : null,
          ...
          text: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['text'] : null)
    ];
  });
  _36c2.registerBoxer<_1584.TextSpan>(boxer: (
      {required _1584.TextSpan vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTextSpan(

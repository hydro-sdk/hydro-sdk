...
class VMManagedInlineSpan extends _36c2.VMManagedBox<_b761.InlineSpan> {VMManagedInlineSpan({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedInlineSpan extends _b761.InlineSpan implements _36c2.Box<_b761.InlineSpan> {RTManagedInlineSpan({_74d0.TextStyle? style, required this.table, required this.hydroState}) : super(style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadInlineSpan({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'inlineSpan'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedInlineSpan(table: luaCallerArguments  [
0
], hydroState: hydroState, style: _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'style'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_b761.InlineSpan>(boxer: ({required _b761.InlineSpan vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedInlineSpan(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

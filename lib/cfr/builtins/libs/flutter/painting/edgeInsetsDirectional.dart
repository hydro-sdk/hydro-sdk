...
class VMManagedEdgeInsetsDirectional
    extends _36c2.VMManagedBox<_96d1.EdgeInsetsDirectional> {
  VMManagedEdgeInsetsDirectional(
    ...
    table['getFlipped'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_96d1.EdgeInsetsDirectional>(
...
void loadEdgeInsetsDirectional(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['edgeInsetsDirectionalLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _96d1.EdgeInsetsDirectional.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsDirectional?,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsDirectional?,
  ...
  _36c2.registerBoxer<_96d1.EdgeInsetsDirectional>(boxer: (
      {required _96d1.EdgeInsetsDirectional vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedEdgeInsetsDirectional(

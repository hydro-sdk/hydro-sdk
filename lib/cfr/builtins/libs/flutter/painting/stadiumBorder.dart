...
class VMManagedStadiumBorder extends _36c2.VMManagedBox<_5909.StadiumBorder> {
  VMManagedStadiumBorder(
    ...
    table['copyWith'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_5909.StadiumBorder>(
...
class RTManagedStadiumBorder extends _5909.StadiumBorder
    implements _36c2.Box<_5909.StadiumBorder> {
  RTManagedStadiumBorder(
  ...
  @_fac9.override
  _5909.StadiumBorder copyWith({_6be9.BorderSide? side}) {
    _36c2.Closure closure = table["copyWith"];
    return _36c2.maybeUnBoxAndBuildArgument<_5909.StadiumBorder, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadStadiumBorder(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['stadiumBorder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStadiumBorder(
  ...
  _36c2.registerBoxer<_5909.StadiumBorder>(boxer: (
      {required _5909.StadiumBorder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedStadiumBorder(

...
class VMManagedTextStyle extends _36c2.VMManagedBox<_74d0.TextStyle> {VMManagedTextStyle({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'letterSpacing'
] = vmObject.letterSpacing;
table  [
'wordSpacing'
] = vmObject.wordSpacing;
table  [
'textBaseline'
] = _a643.TextBaseline.values.indexWhere((x) { return x == vmObject.textBaseline; } );
table  [
'height'
] = vmObject.height;
table  [
...
table  [
'foreground'
] = _36c2.maybeBoxObject<_a643.Paint?>(object: vmObject.foreground, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'background'
] = _36c2.maybeBoxObject<_a643.Paint?>(object: vmObject.background, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decoration'
] = _36c2.maybeBoxObject<_a643.TextDecoration?>(object: vmObject.decoration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decorationColor'
] = _36c2.maybeBoxObject<_a643.Color?>(object: vmObject.decorationColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decorationStyle'
] = _a643.TextDecorationStyle.values.indexWhere((x) { return x == vmObject.decorationStyle; } );
table  [
'decorationThickness'
] = vmObject.decorationThickness;
table  [
'debugLabel'
] = vmObject.debugLabel;
table  [
'shadows'
] = _36c2.maybeBoxObject<_fac9.List<_a643.Shadow>?>(object: vmObject.shadows, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fontFeatures'
] = _36c2.maybeBoxObject<_fac9.List<_a643.FontFeature>?>(object: vmObject.fontFeatures, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'overflow'
...
return [_36c2.maybeBoxObject<_74d0.TextStyle>(object: vmObject.copyWith(background: _36c2.maybeUnBoxAndBuildArgument<_a643.Paint?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'background'
...
'color'
] : null, parentState: hydroState), debugLabel: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'debugLabel'
] : null, decoration: _36c2.maybeUnBoxAndBuildArgument<_a643.TextDecoration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decoration'
] : null, parentState: hydroState), decorationColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decorationColor'
] : null, parentState: hydroState), decorationStyle: _36c2.maybeUnBoxEnum(values: _a643.TextDecorationStyle.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decorationStyle'
] : null), decorationThickness: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decorationThickness'
] : null?.toDouble(), fontFamily: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fontFamily'
...
'fontFamilyFallback'
] : null, parentState: hydroState), fontFeatures: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.FontFeature>?, _a643.FontFeature>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fontFeatures'
...
'fontWeight'
] : null, parentState: hydroState), foreground: _36c2.maybeUnBoxAndBuildArgument<_a643.Paint?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'foreground'
...
'height'
] : null?.toDouble(), inherit: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'inherit'
] : null, leadingDistribution: _36c2.maybeUnBoxEnum(values: _a643.TextLeadingDistribution.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'leadingDistribution'
] : null), letterSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'letterSpacing'
...
'locale'
] : null, parentState: hydroState), overflow: _36c2.maybeUnBoxEnum(values: _fe5a.TextOverflow.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'overflow'
...
'package'
] : null, shadows: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.Shadow>?, _a643.Shadow>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'shadows'
] : null, parentState: hydroState), textBaseline: _36c2.maybeUnBoxEnum(values: _a643.TextBaseline.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textBaseline'
] : null), wordSpacing: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'wordSpacing'
...
return [_36c2.maybeBoxObject<_74d0.TextStyle>(object: vmObject.apply(backgroundColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'backgroundColor'
] : null, parentState: hydroState), color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'color'
] : null, parentState: hydroState), decoration: _36c2.maybeUnBoxAndBuildArgument<_a643.TextDecoration?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decoration'
] : null, parentState: hydroState), decorationColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'decorationStyle'
] : null), decorationThicknessDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'decorationThicknessDelta'
] : null?.toDouble(), decorationThicknessFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
...
'fontFeatures'
] : null, parentState: hydroState), fontSizeDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fontSizeDelta'
] : null?.toDouble(), fontSizeFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fontSizeFactor'
] : null?.toDouble(), fontStyle: _36c2.maybeUnBoxEnum(values: _a643.FontStyle.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'fontStyle'
] : null), fontWeightDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'fontWeightDelta'
] : null, heightDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'heightDelta'
] : null?.toDouble(), heightFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'heightFactor'
...
'leadingDistribution'
] : null), letterSpacingDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'letterSpacingDelta'
] : null?.toDouble(), letterSpacingFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'letterSpacingFactor'
] : null?.toDouble(), locale: _36c2.maybeUnBoxAndBuildArgument<_a643.Locale?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
'textBaseline'
] : null), wordSpacingDelta: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'wordSpacingDelta'
] : null?.toDouble(), wordSpacingFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'wordSpacingFactor'
] : null?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'merge'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_74d0.TextStyle>(object: vmObject.merge(_36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getTextStyle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_a643.TextStyle>(object: vmObject.getTextStyle(textScaleFactor: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'textScaleFactor'
] : null?.toDouble()), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
...
return [_36c2.maybeBoxObject<_a643.ParagraphStyle>(object: vmObject.getParagraphStyle(ellipsis: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'ellipsis'
...
table  [
'compareTo'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_487f.RenderComparison.values.indexWhere((x) { return x == vmObject.compareTo(_36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(luaCallerArguments  [
1
...
class RTManagedTextStyle extends _74d0.TextStyle implements _36c2.Box<_74d0.TextStyle> {RTManagedTextStyle({_a643.Paint? background, _a643.Color? backgroundColor, _a643.Color? color, _fac9.String? debugLabel, _a643.TextDecoration? decoration, _a643.Color? decorationColor, _a643.TextDecorationStyle? decorationStyle, _fac9.double? decorationThickness, _fac9.String? fontFamily, _fac9.List<_fac9.String>? fontFamilyFallback, _fac9.List<_a643.FontFeature>? fontFeatures, _fac9.double? fontSize, _a643.FontStyle? fontStyle, _a643.FontWeight? fontWeight, _a643.Paint? foreground, _fac9.double? height, required _fac9.bool inherit, _a643.TextLeadingDistribution? leadingDistribution, _fac9.double? letterSpacing, _a643.Locale? locale, _fe5a.TextOverflow? overflow, _fac9.String? package, _fac9.List<_a643.Shadow>? shadows, _a643.TextBaseline? textBaseline, _fac9.double? wordSpacing, required this.table, required this.hydroState}) : super(background: background,backgroundColor: backgroundColor,color: color,debugLabel: debugLabel,decoration: decoration,decorationColor: decorationColor,decorationStyle: decorationStyle,decorationThickness: decorationThickness,fontFamily: fontFamily,fontFamilyFallback: fontFamilyFallback,fontFeatures: fontFeatures,fontSize: fontSize,fontStyle: fontStyle,fontWeight: fontWeight,foreground: foreground,height: height,inherit: inherit,leadingDistribution: leadingDistribution,letterSpacing: letterSpacing,locale: locale,overflow: overflow,package: package,shadows: shadows,textBaseline: textBaseline,wordSpacing: wordSpacing) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'inherit'
] = _36c2.maybeBoxObject(object: this.inherit, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'color'
...
table  [
'letterSpacing'
] = _36c2.maybeBoxObject(object: this.letterSpacing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'wordSpacing'
] = _36c2.maybeBoxObject(object: this.wordSpacing, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'textBaseline'
] = _a643.TextBaseline.values.indexWhere((x) { return x == this.textBaseline; } );
table  [
'height'
...
table  [
'foreground'
] = _36c2.maybeBoxObject(object: this.foreground, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'background'
] = _36c2.maybeBoxObject(object: this.background, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decoration'
] = _36c2.maybeBoxObject(object: this.decoration, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decorationColor'
] = _36c2.maybeBoxObject(object: this.decorationColor, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'decorationStyle'
] = _a643.TextDecorationStyle.values.indexWhere((x) { return x == this.decorationStyle; } );
table  [
'decorationThickness'
] = _36c2.maybeBoxObject(object: this.decorationThickness, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugLabel'
...
table  [
'fontFeatures'
] = _36c2.maybeBoxObject(object: this.fontFeatures, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'overflow'
...
@_fac9.override _74d0.TextStyle copyWith({_a643.Paint? background, _a643.Color? backgroundColor, _a643.Color? color, _fac9.String? debugLabel, _a643.TextDecoration? decoration, _a643.Color? decorationColor, _a643.TextDecorationStyle? decorationStyle, _fac9.double? decorationThickness, _fac9.String? fontFamily, _fac9.List? fontFamilyFallback, _fac9.List? fontFeatures, _fac9.double? fontSize, _a643.FontStyle? fontStyle, _a643.FontWeight? fontWeight, _a643.Paint? foreground, _fac9.double? height, _fac9.bool? inherit, _a643.TextLeadingDistribution? leadingDistribution, _fac9.double? letterSpacing, _a643.Locale? locale, _fe5a.TextOverflow? overflow, _fac9.String? package, _fac9.List? shadows, _a643.TextBaseline? textBaseline, _fac9.double? wordSpacing}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _74d0.TextStyle apply({_a643.Color? backgroundColor, _a643.Color? color, _a643.TextDecoration? decoration, _a643.Color? decorationColor, _a643.TextDecorationStyle? decorationStyle, _fac9.double decorationThicknessDelta = 0.0, _fac9.double decorationThicknessFactor = 1.0, _fac9.String? fontFamily, _fac9.List? fontFamilyFallback, _fac9.List? fontFeatures, _fac9.double fontSizeDelta = 0.0, _fac9.double fontSizeFactor = 1.0, _a643.FontStyle? fontStyle, _fac9.int fontWeightDelta = 0, _fac9.double heightDelta = 0.0, _fac9.double heightFactor = 1.0, _a643.TextLeadingDistribution? leadingDistribution, _fac9.double letterSpacingDelta = 0.0, _fac9.double letterSpacingFactor = 1.0, _a643.Locale? locale, _fe5a.TextOverflow? overflow, _fac9.String? package, _fac9.List? shadows, _a643.TextBaseline? textBaseline, _fac9.double wordSpacingDelta = 0.0, _fac9.double wordSpacingFactor = 1.0}) { 
_36c2.Closure closure = table["apply"];
return _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _74d0.TextStyle merge(other) { 
_36c2.Closure closure = table["merge"];
return _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _a643.TextStyle getTextStyle({_fac9.double textScaleFactor = 1.0}) { 
_36c2.Closure closure = table["getTextStyle"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.TextStyle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _a643.ParagraphStyle getParagraphStyle({_fac9.String? ellipsis, _fac9.String? fontFamily, _fac9.double? fontSize, _a643.FontStyle? fontStyle, _a643.FontWeight? fontWeight, _fac9.double? height, _a643.Locale? locale, _fac9.int? maxLines, _ced4.StrutStyle? strutStyle, _a643.TextAlign? textAlign, _a643.TextDirection? textDirection, _a643.TextHeightBehavior? textHeightBehavior, _fac9.double textScaleFactor = 1.0}) { 
_36c2.Closure closure = table["getParagraphStyle"];
return _36c2.maybeUnBoxAndBuildArgument<_a643.ParagraphStyle, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadTextStyle({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'textStyle'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedTextStyle(table: luaCallerArguments  [
0
], hydroState: hydroState, background: _36c2.maybeUnBoxAndBuildArgument<_a643.Paint?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'background'
] : null, parentState: hydroState), backgroundColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
...
final returnValue = _74d0.TextStyle.lerp(_36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_74d0.TextStyle?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_74d0.TextStyle?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_74d0.TextStyle>(boxer: ({required _74d0.TextStyle vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTextStyle(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

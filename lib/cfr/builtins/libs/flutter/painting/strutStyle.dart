...
class VMManagedStrutStyle extends _36c2.VMManagedBox<_ced4.StrutStyle> {
  VMManagedStrutStyle(
    ...
    table['leading'] = vmObject.leading;
    table['forceStrutHeight'] = vmObject.forceStrutHeight;
    ...
    table['inheritFromTextStyle'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_ced4.StrutStyle>(
            object: vmObject.inheritFromTextStyle(_36c2
...
class RTManagedStrutStyle extends _ced4.StrutStyle
    implements _36c2.Box<_ced4.StrutStyle> {
  RTManagedStrutStyle(
      ...
      _fac9.bool? forceStrutHeight,
      _fac9.double? height,
      _fac9.double? leading,
    ...
    table['leading'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['forceStrutHeight'] = _36c2.maybeBoxObject(
        object: this.forceStrutHeight,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['_dart_inheritFromTextStyle'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.inheritFromTextStyle(_36c2.maybeUnBoxAndBuildArgument<
                _74d0.TextStyle?,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  @_fac9.override
  _ced4.StrutStyle inheritFromTextStyle(other) {
...
void loadStrutStyle(
  ...
  table['strutStyle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedStrutStyle(
          ...
          fontWeight: _36c2
              .maybeUnBoxAndBuildArgument<_a643.FontWeight?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['fontWeight'] : null,
                  parentState: hydroState),
          forceStrutHeight: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['forceStrutHeight'] : null,
          height: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['height'] : null?.toDouble(),
          leading: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['leading'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_ced4.StrutStyle>(boxer: (
      {required _ced4.StrutStyle vmObject,

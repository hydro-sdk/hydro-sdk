...
class VMManagedGradient extends _36c2.VMManagedBox<_8a60.Gradient> {
  VMManagedGradient(
...
class RTManagedGradient extends _8a60.Gradient
    implements _36c2.Box<_8a60.Gradient> {
  RTManagedGradient(
      ...
      : super(stops: stops, transform: transform, colors: colors) {
...
void loadGradient(
  ...
  table['gradient'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGradient(
          ...
          stops: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.List<_fac9.double>?, _fac9.double>(
                  ...
                  parentState: hydroState),
          transform: _36c2
              .maybeUnBoxAndBuildArgument<_8a60.GradientTransform?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['transform']
                      : null,
                  parentState: hydroState),
          colors: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_a643.Color>, _a643.Color>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['colors'] : null,
              parentState: hydroState))
    ];
  });
  table['gradientLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _8a60.Gradient.lerp(
  ...
  _36c2.registerBoxer<_8a60.Gradient>(boxer: (
      {required _8a60.Gradient vmObject,

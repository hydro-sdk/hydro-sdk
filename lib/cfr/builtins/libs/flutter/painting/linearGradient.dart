...
class VMManagedLinearGradient extends _36c2.VMManagedBox<_8a60.LinearGradient> {VMManagedLinearGradient({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'begin'
] = _36c2.maybeBoxObject<_ca85.AlignmentGeometry>(object: vmObject.begin, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'end'
] = _36c2.maybeBoxObject<_ca85.AlignmentGeometry>(object: vmObject.end, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'tileMode'
...
table  [
'scale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_8a60.LinearGradient>(object: vmObject.scale(luaCallerArguments  [
1
...
class RTManagedLinearGradient extends _8a60.LinearGradient implements _36c2.Box<_8a60.LinearGradient> {RTManagedLinearGradient({required _ca85.AlignmentGeometry begin, required _ca85.AlignmentGeometry end, _fac9.List<_fac9.double>? stops, required _a643.TileMode tileMode, _8a60.GradientTransform? transform, required _fac9.List<_a643.Color> colors, required this.table, required this.hydroState}) : super(begin: begin,end: end,stops: stops,tileMode: tileMode,transform: transform,colors: colors) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _8a60.LinearGradient scale(factor) { 
_36c2.Closure closure = table["scale"];
return _36c2.maybeUnBoxAndBuildArgument<_8a60.LinearGradient, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadLinearGradient({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'linearGradient'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedLinearGradient(table: luaCallerArguments  [
0
], hydroState: hydroState, begin: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'begin'
] : null, parentState: hydroState), end: _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'end'
] : null, parentState: hydroState), stops: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.double>?, _fac9.double>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'stops'
...
final returnValue = _8a60.LinearGradient.lerp(_36c2.maybeUnBoxAndBuildArgument<_8a60.LinearGradient?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_8a60.LinearGradient?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_8a60.LinearGradient?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_8a60.LinearGradient>(boxer: ({required _8a60.LinearGradient vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLinearGradient(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

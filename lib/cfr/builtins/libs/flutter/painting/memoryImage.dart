...
class VMManagedMemoryImage extends _36c2.VMManagedBox<_61fa.MemoryImage> {VMManagedMemoryImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'bytes'
] = _36c2.maybeBoxObject<_7537.Uint8List>(object: vmObject.bytes, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scale'
] = vmObject.scale;
table  [
...
final _61fa.MemoryImage vmObject;

 }

class RTManagedMemoryImage extends _61fa.MemoryImage implements _36c2.Box<_61fa.MemoryImage> {RTManagedMemoryImage(_7537.Uint8List bytes$, {required _fac9.double scale, required this.table, required this.hydroState}) : super(bytes$,scale: scale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'bytes'
] = _36c2.maybeBoxObject(object: this.bytes, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scale'
...
table['_dart_resolveStreamForKey'] =
  ...
  super.resolveStreamForKey(
      ...
      _36c2.maybeUnBoxAndBuildArgument<_f25c.ImageStream, _fac9.dynamic>(
          ...
          parentState: hydroState),
      _36c2.maybeUnBoxAndBuildArgument<_61fa.MemoryImage, _fac9.dynamic>(
...
_61fa.MemoryImage unwrap() => this;
_61fa.MemoryImage get vmObject => this;
@_fac9.override _7de1.Future<_61fa.MemoryImage> obtainKey(configuration) { 
_36c2.Closure closure = table["obtainKey"];
return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_61fa.MemoryImage>, _61fa.MemoryImage>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadMemoryImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'memoryImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedMemoryImage(_36c2.maybeUnBoxAndBuildArgument<_7537.Uint8List, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), table: luaCallerArguments  [
0
], hydroState: hydroState, scale: luaCallerArguments.length >= 3 ? luaCallerArguments  [
2
]  [
'scale'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_61fa.MemoryImage>(boxer: ({required _61fa.MemoryImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMemoryImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

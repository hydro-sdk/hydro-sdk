...
class VMManagedMemoryImage extends _36c2.VMManagedBox<_61fa.MemoryImage> {
  VMManagedMemoryImage(
    ...
    table['bytes'] = _36c2.maybeBoxObject<_7537.Uint8List>(
        object: vmObject.bytes,
        hydroState: hydroState,
...
class RTManagedMemoryImage extends _61fa.MemoryImage
    implements _36c2.Box<_61fa.MemoryImage> {
  RTManagedMemoryImage(_7537.Uint8List bytes$,
    ...
    table['bytes'] = _36c2.maybeBoxObject(
        object: this.bytes, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _7de1.Future<_61fa.MemoryImage> obtainKey(configuration) {
    _36c2.Closure closure = table["obtainKey"];
    return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_61fa.MemoryImage>,
            _61fa.MemoryImage>(
...
void loadMemoryImage(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['memoryImage'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMemoryImage(
  ...
  _36c2.registerBoxer<_61fa.MemoryImage>(boxer: (
      {required _61fa.MemoryImage vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMemoryImage(

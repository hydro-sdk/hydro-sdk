...
class VMManagedImageStreamCompleter extends _36c2.VMManagedBox<_f25c.ImageStreamCompleter> {VMManagedImageStreamCompleter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedImageStreamCompleter extends _f25c.ImageStreamCompleter implements _36c2.Box<_f25c.ImageStreamCompleter> {RTManagedImageStreamCompleter({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadImageStreamCompleter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'imageStreamCompleter'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedImageStreamCompleter(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_f25c.ImageStreamCompleter>(boxer: ({required _f25c.ImageStreamCompleter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImageStreamCompleter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

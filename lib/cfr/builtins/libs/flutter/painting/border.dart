...
class VMManagedBorder extends _36c2.VMManagedBox<_250a.Border> {VMManagedBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
'reversed'
] : null);if(returnValue!= null){return [_36c2.maybeBoxObject<_250a.Border?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'scale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_250a.Border>(object: vmObject.scale(luaCallerArguments  [
1
...
class RTManagedBorder extends _250a.Border implements _36c2.Box<_250a.Border> {RTManagedBorder({required _6be9.BorderSide bottom, required _6be9.BorderSide left, required _6be9.BorderSide right, required _6be9.BorderSide top, required this.table, required this.hydroState}) : super(bottom: bottom,left: left,right: right,top: top) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _250a.Border? add(other, {_fac9.bool reversed = false}) { 
...
@_fac9.override _250a.Border scale(t) { 
...
void loadBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'border'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedBorder(table: luaCallerArguments  [
0
...
return [_36c2.maybeBoxObject<_250a.Border>(object: _250a.Border.all(color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'color'
...
return [_36c2.maybeBoxObject<_250a.Border>(object: _250a.Border.merge(_36c2.maybeUnBoxAndBuildArgument<_250a.Border, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_250a.Border, _fac9.dynamic>(luaCallerArguments  [
2
...
final returnValue = _250a.Border.lerp(_36c2.maybeUnBoxAndBuildArgument<_250a.Border?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_250a.Border?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
...
_36c2.registerBoxer<_250a.Border>(boxer: ({required _250a.Border vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

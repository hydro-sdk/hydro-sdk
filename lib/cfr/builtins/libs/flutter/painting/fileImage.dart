...
class VMManagedFileImage extends _36c2.VMManagedBox<_61fa.FileImage> {VMManagedFileImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'file'
] = _36c2.maybeBoxObject<_81fb.File>(object: vmObject.file, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scale'
] = vmObject.scale;
table  [
...
class RTManagedFileImage extends _61fa.FileImage implements _36c2.Box<_61fa.FileImage> {RTManagedFileImage(_81fb.File file$, {required _fac9.double scale, required this.table, required this.hydroState}) : super(file$,scale: scale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'file'
] = _36c2.maybeBoxObject(object: this.file, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'scale'
...
@_fac9.override _7de1.Future<_61fa.FileImage> obtainKey(configuration) { 
_36c2.Closure closure = table["obtainKey"];
return _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_61fa.FileImage>, _61fa.FileImage>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadFileImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'fileImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedFileImage(_36c2.maybeUnBoxAndBuildArgument<_81fb.File, _fac9.dynamic>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_61fa.FileImage>(boxer: ({required _61fa.FileImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedFileImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

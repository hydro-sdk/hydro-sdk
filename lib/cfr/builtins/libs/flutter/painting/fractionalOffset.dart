...
class VMManagedFractionalOffset
    extends _36c2.VMManagedBox<_791e.FractionalOffset> {
  VMManagedFractionalOffset(
    ...
    table['x'] = vmObject.x;
    table['y'] = vmObject.y;
    table['getDx'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.dx,
      ];
    });
    table['getDy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        vmObject.dy,
      ];
    ...
    table['alongOffset'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Offset>(
            object: vmObject.alongOffset(
    ...
    table['alongSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Offset>(
            object: vmObject.alongSize(
    ...
    table['withinRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Offset>(
            object: vmObject.withinRect(
    ...
    table['inscribe'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_a643.Rect>(
            object: vmObject.inscribe(
                _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
                    luaCallerArguments[1],
                    parentState: hydroState),
                _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(
...
class RTManagedFractionalOffset extends _791e.FractionalOffset
    implements _36c2.Box<_791e.FractionalOffset> {
  RTManagedFractionalOffset(_fac9.double dx$, _fac9.double dy$,
    ...
    table['x'] = _36c2.maybeBoxObject(
        object: x, hydroState: hydroState, table: _36c2.HydroTable());
    table['y'] = _36c2.maybeBoxObject(
        object: y, hydroState: hydroState, table: _36c2.HydroTable());
    table['_dart_getDx'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.dx];
    });
    table['_dart_getDy'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.dy];
    });
    ...
    table['_dart_alongOffset'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_alongSize'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_withinRect'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
    ...
    table['_dart_inscribe'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
  ...
  @_fac9.override
  _a643.Offset alongOffset(other) {
...
void loadFractionalOffset(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['fractionalOffset'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedFractionalOffset(
          luaCallerArguments[1]?.toDouble(), luaCallerArguments[2]?.toDouble(),
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  table['fractionalOffsetFromOffsetAndSize'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_791e.FractionalOffset>(
          object: _791e.FractionalOffset.fromOffsetAndSize(
              _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState),
              _36c2.maybeUnBoxAndBuildArgument<_a643.Size, _fac9.dynamic>(
  ...
  table['fractionalOffsetFromOffsetAndRect'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_791e.FractionalOffset>(
          object: _791e.FractionalOffset.fromOffsetAndRect(
              _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState),
              _36c2.maybeUnBoxAndBuildArgument<_a643.Rect, _fac9.dynamic>(
  ...
  table['fractionalOffsetLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _791e.FractionalOffset.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_791e.FractionalOffset?,
            _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_791e.FractionalOffset?,
  ...
  _36c2.registerBoxer<_791e.FractionalOffset>(boxer: (
      {required _791e.FractionalOffset vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFractionalOffset(

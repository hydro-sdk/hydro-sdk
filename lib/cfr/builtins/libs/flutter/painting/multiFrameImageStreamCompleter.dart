...
class VMManagedMultiFrameImageStreamCompleter extends _36c2.VMManagedBox<_f25c.MultiFrameImageStreamCompleter> {VMManagedMultiFrameImageStreamCompleter({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedMultiFrameImageStreamCompleter extends _f25c.MultiFrameImageStreamCompleter implements _36c2.Box<_f25c.MultiFrameImageStreamCompleter> {RTManagedMultiFrameImageStreamCompleter({_7de1.Stream<_f25c.ImageChunkEvent>? chunkEvents, _fac9.String? debugLabel, _fac9.Iterable<_eaf3.DiagnosticsNode> Function()? informationCollector, required _7de1.Future<_a643.Codec> codec, required _fac9.double scale, required this.table, required this.hydroState}) : super(chunkEvents: chunkEvents,debugLabel: debugLabel,informationCollector: informationCollector,codec: codec,scale: scale) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadMultiFrameImageStreamCompleter({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
...
return  [RTManagedMultiFrameImageStreamCompleter(table: luaCallerArguments  [
0
], hydroState: hydroState, chunkEvents: _36c2.maybeUnBoxAndBuildArgument<_7de1.Stream<_f25c.ImageChunkEvent>?, _f25c.ImageChunkEvent>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'chunkEvents'
...
'debugLabel'
] : null, informationCollector: unpackedinformationCollector != null ? () => _36c2.maybeUnBoxAndBuildArgument<_fac9.Iterable<_eaf3.DiagnosticsNode>, _eaf3.DiagnosticsNode>(unpackedinformationCollector.dispatch([luaCallerArguments[0],],parentState:hydroState,)[0], parentState: hydroState) : null , codec: _36c2.maybeUnBoxAndBuildArgument<_7de1.Future<_a643.Codec>, _a643.Codec>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'codec'
] : null, parentState: hydroState), scale: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'scale'
] : null?.toDouble())]; } );
_36c2.registerBoxer<_f25c.MultiFrameImageStreamCompleter>(boxer: ({required _f25c.MultiFrameImageStreamCompleter vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMultiFrameImageStreamCompleter(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedMultiFrameImageStreamCompleter
    extends _36c2.VMManagedBox<_f25c.MultiFrameImageStreamCompleter> {
  VMManagedMultiFrameImageStreamCompleter(
    ...
    table['addListener'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.addListener(_36c2.maybeUnBoxAndBuildArgument<
    ...
    table['removeListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.removeListener(_36c2.maybeUnBoxAndBuildArgument<
          _f25c.ImageStreamListener,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    table['keepAlive'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_f25c.ImageStreamCompleterHandle>(
            object: vmObject.keepAlive(),
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
    });
    table['addOnLastListenerRemovedCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['removeOnLastListenerRemovedCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedcallback = luaCallerArguments[1];
      vmObject
    ...
    table['reportError'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      ...
      vmObject.reportError(
          ...
          silent: luaCallerArguments.length >= 2
              ...
              : null,
          stack: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.StackTrace?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['stack'] : null,
                  parentState: hydroState),
  ...
  final _f25c.MultiFrameImageStreamCompleter vmObject;
}

class RTManagedMultiFrameImageStreamCompleter
    extends _f25c.MultiFrameImageStreamCompleter
    implements _36c2.Box<_f25c.MultiFrameImageStreamCompleter> {
  RTManagedMultiFrameImageStreamCompleter(
      {_7de1.Stream<_f25c.ImageChunkEvent>? chunkEvents,
      _fac9.String? debugLabel,
      _fac9.Iterable<_eaf3.DiagnosticsNode> Function()? informationCollector,
      required _7de1.Future<_a643.Codec> codec,
    ...
    table['_dart_addListener'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.addListener(_36c2.maybeUnBoxAndBuildArgument<
          _f25c.ImageStreamListener,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    ...
    table['_dart_keepAlive'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
    ...
    table['_dart_addOnLastListenerRemovedCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedcallback = luaCallerArguments[1];
    ...
    table['_dart_removeOnLastListenerRemovedCallback'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure unpackedcallback = luaCallerArguments[1];
    ...
    table['_dart_reportError'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      _36c2.Closure? unpackedinformationCollector =
          luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['informationCollector']
    ...
    table['_dart_reportImageChunkEvent'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.reportImageChunkEvent(_36c2.maybeUnBoxAndBuildArgument<
          _f25c.ImageChunkEvent,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  _f25c.MultiFrameImageStreamCompleter unwrap() => this;
  _f25c.MultiFrameImageStreamCompleter get vmObject => this;
  @_fac9.override
  ...
  @_fac9.override
  _f25c.ImageStreamCompleterHandle keepAlive() {
    _36c2.Closure closure = table["keepAlive"];
    return _36c2.maybeUnBoxAndBuildArgument<_f25c.ImageStreamCompleterHandle,
            _fac9.dynamic>(
  ...
  @_fac9.override
  void addOnLastListenerRemovedCallback(callback) {
    _36c2.Closure closure = table["addOnLastListenerRemovedCallback"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @_fac9.override
  void removeOnLastListenerRemovedCallback(callback) {
  ...
  @_fac9.override
  void reportImageChunkEvent(event) {
...
void loadMultiFrameImageStreamCompleter(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['multiFrameImageStreamCompleter'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedMultiFrameImageStreamCompleter(
          ...
          hydroState: hydroState,
          chunkEvents: _36c2.maybeUnBoxAndBuildArgument<
                  _7de1.Stream<_f25c.ImageChunkEvent>?, _f25c.ImageChunkEvent>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['chunkEvents']
                  : null,
              parentState: hydroState),
          ...
          codec: _36c2
              .maybeUnBoxAndBuildArgument<_7de1.Future<_a643.Codec>, _a643.Codec>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['codec'] : null,
                  parentState: hydroState),
          scale: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['scale'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_f25c.MultiFrameImageStreamCompleter>(boxer: (
      {required _f25c.MultiFrameImageStreamCompleter vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMultiFrameImageStreamCompleter(

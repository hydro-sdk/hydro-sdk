...
class VMManagedShapeBorder extends _36c2.VMManagedBox<_6be9.ShapeBorder> {VMManagedShapeBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedShapeBorder extends _6be9.ShapeBorder implements _36c2.Box<_6be9.ShapeBorder> {RTManagedShapeBorder({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadShapeBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'shapeBorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedShapeBorder(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'shapeBorderLerp'
...
final returnValue = _6be9.ShapeBorder.lerp(_36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder?, _fac9.dynamic>(luaCallerArguments  [
1
...
_36c2.registerBoxer<_6be9.ShapeBorder>(boxer: ({required _6be9.ShapeBorder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedShapeBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

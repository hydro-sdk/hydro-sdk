...
class VMManagedColorProperty extends _36c2.VMManagedBox<_898f.ColorProperty> {VMManagedColorProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.value;if(returnValue!= null){return [_36c2.maybeBoxObject<_a643.Color?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getException'
...
final _898f.ColorProperty vmObject;

 }

class RTManagedColorProperty extends _898f.ColorProperty implements _36c2.Box<_898f.ColorProperty> {RTManagedColorProperty(_fac9.String name$, _a643.Color? value$, {_fac9.Object? defaultValue, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required _eaf3.DiagnosticsTreeStyle style, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,level: level,showName: showName,style: style) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_898f.ColorProperty unwrap() => this;
_898f.ColorProperty get vmObject => this;
...
@_fac9.override _a643.Color? get value { 
...
void loadColorProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'colorProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedColorProperty(luaCallerArguments  [
1
...
'defaultValue'
] : null, parentState: hydroState), level: _36c2.maybeUnBoxEnum(values: _eaf3.DiagnosticLevel.values, boxedEnum: luaCallerArguments.length >= 4 ? luaCallerArguments  [
3
]  [
'level'
...
_36c2.registerBoxer<_898f.ColorProperty>(boxer: ({required _898f.ColorProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedColorProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

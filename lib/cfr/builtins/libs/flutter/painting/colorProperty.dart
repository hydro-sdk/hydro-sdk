...
class VMManagedColorProperty extends _36c2.VMManagedBox<_898f.ColorProperty> {
  VMManagedColorProperty(
...
class RTManagedColorProperty extends _898f.ColorProperty
    implements _36c2.Box<_898f.ColorProperty> {
  RTManagedColorProperty(_fac9.String name$, _a643.Color? value$,
...
void loadColorProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['colorProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedColorProperty(
          luaCallerArguments[1],
          _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments[2],
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_898f.ColorProperty>(boxer: (
      {required _898f.ColorProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedColorProperty(

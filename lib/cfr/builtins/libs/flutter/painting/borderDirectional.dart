...
class VMManagedBorderDirectional extends _36c2.VMManagedBox<_250a.BorderDirectional> {VMManagedBorderDirectional({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'start'
] = _36c2.maybeBoxObject<_6be9.BorderSide>(object: vmObject.start, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'end'
] = _36c2.maybeBoxObject<_6be9.BorderSide>(object: vmObject.end, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'bottom'
...
table  [
'scale'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_250a.BorderDirectional>(object: vmObject.scale(luaCallerArguments  [
1
...
class RTManagedBorderDirectional extends _250a.BorderDirectional implements _36c2.Box<_250a.BorderDirectional> {RTManagedBorderDirectional({required _6be9.BorderSide bottom, required _6be9.BorderSide end, required _6be9.BorderSide start, required _6be9.BorderSide top, required this.table, required this.hydroState}) : super(bottom: bottom,end: end,start: start,top: top) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'start'
] = _36c2.maybeBoxObject(object: this.start, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'end'
...
table['_dart_paint'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  super.paint(_36c2.maybeUnBoxAndBuildArgument<_a643.Canvas, _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState),
...
@_fac9.override _250a.BorderDirectional scale(t) { 
_36c2.Closure closure = table["scale"];
return _36c2.maybeUnBoxAndBuildArgument<_250a.BorderDirectional, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadBorderDirectional({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'borderDirectional'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedBorderDirectional(table: luaCallerArguments  [
0
], hydroState: hydroState, bottom: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'bottom'
] : null, parentState: hydroState), end: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'end'
] : null, parentState: hydroState), start: _36c2.maybeUnBoxAndBuildArgument<_6be9.BorderSide, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'start'
...
table  [
'borderDirectionalMerge'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return [_36c2.maybeBoxObject<_250a.BorderDirectional>(object: _250a.BorderDirectional.merge(_36c2.maybeUnBoxAndBuildArgument<_250a.BorderDirectional, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_250a.BorderDirectional, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'borderDirectionalLerp'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

final returnValue = _250a.BorderDirectional.lerp(_36c2.maybeUnBoxAndBuildArgument<_250a.BorderDirectional?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_250a.BorderDirectional?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_250a.BorderDirectional?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_250a.BorderDirectional>(boxer: ({required _250a.BorderDirectional vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedBorderDirectional(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

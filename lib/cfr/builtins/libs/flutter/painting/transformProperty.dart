...
class VMManagedTransformProperty extends _36c2.VMManagedBox<_681c.TransformProperty> {VMManagedTransformProperty({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getValue'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { final returnValue = vmObject.value;if(returnValue!= null){return [_36c2.maybeBoxObject<_db98.Matrix4?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
table  [
'getException'
...
final _681c.TransformProperty vmObject;

 }

class RTManagedTransformProperty extends _681c.TransformProperty implements _36c2.Box<_681c.TransformProperty> {RTManagedTransformProperty(_fac9.String name$, _db98.Matrix4? value$, {_fac9.Object? defaultValue, required _eaf3.DiagnosticLevel level, required _fac9.bool showName, required this.table, required this.hydroState}) : super(name$,value$,defaultValue: defaultValue,level: level,showName: showName) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_681c.TransformProperty unwrap() => this;
_681c.TransformProperty get vmObject => this;
...
void loadTransformProperty({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'transformProperty'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
return  [RTManagedTransformProperty(luaCallerArguments  [
1
], _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(luaCallerArguments  [
2
...
_36c2.registerBoxer<_681c.TransformProperty>(boxer: ({required _681c.TransformProperty vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTransformProperty(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedTransformProperty
    extends _36c2.VMManagedBox<_681c.TransformProperty> {
  VMManagedTransformProperty(
...
class RTManagedTransformProperty extends _681c.TransformProperty
    implements _36c2.Box<_681c.TransformProperty> {
  RTManagedTransformProperty(_fac9.String name$, _db98.Matrix4? value$,
      ...
      : super(name$, value$,
            defaultValue: defaultValue, level: level, showName: showName) {
...
void loadTransformProperty(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['transformProperty'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTransformProperty(
  ...
  _36c2.registerBoxer<_681c.TransformProperty>(boxer: (
      {required _681c.TransformProperty vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTransformProperty(

...
import 'package:flutter/src/painting/rounded_rectangle_border.dart' as _3af5;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedRoundedRectangleBorder extends _36c2.VMManagedBox<_3af5.RoundedRectangleBorder> {VMManagedRoundedRectangleBorder({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [_36c2.maybeBoxObject<_3af5.RoundedRectangleBorder>(object: vmObject.copyWith(borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadiusGeometry?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'borderRadius'
...
final _3af5.RoundedRectangleBorder vmObject;

 }

class RTManagedRoundedRectangleBorder extends _3af5.RoundedRectangleBorder implements _36c2.Box<_3af5.RoundedRectangleBorder> {RTManagedRoundedRectangleBorder({required _9d8a.BorderRadiusGeometry borderRadius, required _6be9.BorderSide side, required this.table, required this.hydroState}) : super(borderRadius: borderRadius,side: side) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_3af5.RoundedRectangleBorder unwrap() => this;
_3af5.RoundedRectangleBorder get vmObject => this;
...
return _36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder?, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
@_fac9.override _3af5.RoundedRectangleBorder copyWith({_9d8a.BorderRadiusGeometry? borderRadius, _6be9.BorderSide? side}) { 
_36c2.Closure closure = table["copyWith"];
return _36c2.maybeUnBoxAndBuildArgument<_3af5.RoundedRectangleBorder, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadRoundedRectangleBorder({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'roundedRectangleBorder'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedRoundedRectangleBorder(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_3af5.RoundedRectangleBorder>(boxer: ({required _3af5.RoundedRectangleBorder vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedRoundedRectangleBorder(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedDecorationImage extends _36c2.VMManagedBox<_48c4.DecorationImage> {VMManagedDecorationImage({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'colorFilter'
] = _36c2.maybeBoxObject<_a643.ColorFilter?>(object: vmObject.colorFilter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fit'
...
1
];return [_36c2.maybeBoxObject<_48c4.DecorationImagePainter>(object: vmObject.createPainter(() => unpackedonChanged.dispatch([luaCallerArguments[0],],parentState:hydroState,)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getHashCode'
...
class RTManagedDecorationImage extends _48c4.DecorationImage implements _36c2.Box<_48c4.DecorationImage> {RTManagedDecorationImage({required _ca85.AlignmentGeometry alignment, _a643.Rect? centerSlice, _a643.ColorFilter? colorFilter, required _a643.FilterQuality filterQuality, _fb77.BoxFit? fit, required _fac9.bool invertColors, required _fac9.bool isAntiAlias, required _fac9.bool matchTextDirection, void Function(_fac9.Object exception, _fac9.StackTrace? stackTrace)? onError, required _fac9.double opacity, required _48c4.ImageRepeat repeat, required _fac9.double scale, required _61fa.ImageProvider<_fac9.Object> image, required this.table, required this.hydroState}) : super(alignment: alignment,centerSlice: centerSlice,colorFilter: colorFilter,filterQuality: filterQuality,fit: fit,invertColors: invertColors,isAntiAlias: isAntiAlias,matchTextDirection: matchTextDirection,onError: onError,opacity: opacity,repeat: repeat,scale: scale,image: image) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'colorFilter'
] = _36c2.maybeBoxObject(object: this.colorFilter, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'fit'
...
@_fac9.override _48c4.DecorationImagePainter createPainter(onChanged) { 
_36c2.Closure closure = table["createPainter"];
return _36c2.maybeUnBoxAndBuildArgument<_48c4.DecorationImagePainter, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDecorationImage({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'decorationImage'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
_36c2.Closure? unpackedonError=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'onError'
] : null;
...
return  [RTManagedDecorationImage(table: luaCallerArguments  [
0
...
'centerSlice'
] : null, parentState: hydroState), colorFilter: _36c2.maybeUnBoxAndBuildArgument<_a643.ColorFilter?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'colorFilter'
...
'matchTextDirection'
] : null, onError: unpackedonError != null ? (exception, stackTrace) => unpackedonError.dispatch([luaCallerArguments[0],exception,stackTrace],parentState:hydroState,) : null , opacity: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'opacity'
] : null?.toDouble(), repeat: _36c2.maybeUnBoxEnum(values: _48c4.ImageRepeat.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'repeat'
...
_36c2.registerBoxer<_48c4.DecorationImage>(boxer: ({required _48c4.DecorationImage vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDecorationImage(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

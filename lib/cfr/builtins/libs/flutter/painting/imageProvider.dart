...
class VMManagedImageProvider extends _36c2.VMManagedBox<_61fa.ImageProvider<_fac9.Object>> {VMManagedImageProvider({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedImageProvider extends _61fa.ImageProvider implements _36c2.Box<_61fa.ImageProvider> {RTManagedImageProvider({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
@_fac9.override _f25c.ImageStreamCompleter load(key, decode) { 
...
void loadImageProvider({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'imageProvider'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedImageProvider(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_61fa.ImageProvider>(boxer: ({required _61fa.ImageProvider vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImageProvider(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

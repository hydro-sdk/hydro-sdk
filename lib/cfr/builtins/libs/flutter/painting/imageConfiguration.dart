...
class VMManagedImageConfiguration
    extends _36c2.VMManagedBox<_61fa.ImageConfiguration> {
  VMManagedImageConfiguration(
      ...
      return [
        _36c2.maybeBoxObject<_61fa.ImageConfiguration>(
            object: vmObject.copyWith(
                bundle: _36c2.maybeUnBoxAndBuildArgument<_136d.AssetBundle?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['bundle'] : null,
                    parentState: hydroState),
                devicePixelRatio: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['devicePixelRatio']
                    : null?.toDouble(),
                locale:
                    _36c2.maybeUnBoxAndBuildArgument<_a643.Locale?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['locale'] : null,
                        parentState: hydroState),
                platform: _36c2.maybeUnBoxEnum(
                    values: _9164.TargetPlatform.values,
                    boxedEnum: luaCallerArguments.length >= 2
                        ? luaCallerArguments[1]['platform']
                        : null),
...
class RTManagedImageConfiguration extends _61fa.ImageConfiguration
  ...
  @_fac9.override
  _61fa.ImageConfiguration copyWith(
      {_136d.AssetBundle? bundle,
      _fac9.double? devicePixelRatio,
      _a643.Locale? locale,
      _9164.TargetPlatform? platform,
...
void loadImageConfiguration(
  ...
  table['imageConfiguration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImageConfiguration(
  ...
  _36c2.registerBoxer<_61fa.ImageConfiguration>(boxer: (
      {required _61fa.ImageConfiguration vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImageConfiguration(

...
class VMManagedBoxDecoration extends _36c2.VMManagedBox<_51e4.BoxDecoration> {
  VMManagedBoxDecoration(
    ...
    table['image'] = _36c2.maybeBoxObject<_48c4.DecorationImage?>(
        object: vmObject.image,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['border'] = _36c2.maybeBoxObject<_250a.BoxBorder?>(
    ...
    table['borderRadius'] = _36c2.maybeBoxObject<_9d8a.BorderRadiusGeometry?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['boxShadow'] = _36c2.maybeBoxObject<_fac9.List<_9068.BoxShadow>?>(
        object: vmObject.boxShadow,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['gradient'] = _36c2.maybeBoxObject<_8a60.Gradient?>(
        object: vmObject.gradient,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['backgroundBlendMode'] = _a643.BlendMode.values.indexWhere((x) {
      return x == vmObject.backgroundBlendMode;
    });
    table['shape'] = _250a.BoxShape.values.indexWhere((x) {
      return x == vmObject.shape;
    });
    table['copyWith'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_51e4.BoxDecoration>(
...
class RTManagedBoxDecoration extends _51e4.BoxDecoration
    implements _36c2.Box<_51e4.BoxDecoration> {
  RTManagedBoxDecoration(
      {_a643.BlendMode? backgroundBlendMode,
      _250a.BoxBorder? border,
      _9d8a.BorderRadiusGeometry? borderRadius,
      _fac9.List<_9068.BoxShadow>? boxShadow,
      _a643.Color? color,
      _8a60.Gradient? gradient,
      _48c4.DecorationImage? image,
    ...
    table['borderRadius'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['boxShadow'] = _36c2.maybeBoxObject(
        object: this.boxShadow,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['gradient'] = _36c2.maybeBoxObject(
        object: this.gradient,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['backgroundBlendMode'] = _a643.BlendMode.values.indexWhere((x) {
      return x == this.backgroundBlendMode;
    });
    table['shape'] = _250a.BoxShape.values.indexWhere((x) {
      return x == this.shape;
    });
  ...
  @_fac9.override
  _51e4.BoxDecoration copyWith(
      {_a643.BlendMode? backgroundBlendMode,
      _250a.BoxBorder? border,
      _9d8a.BorderRadiusGeometry? borderRadius,
      _fac9.List? boxShadow,
      _a643.Color? color,
      _8a60.Gradient? gradient,
      _48c4.DecorationImage? image,
      _250a.BoxShape? shape}) {
    _36c2.Closure closure = table["copyWith"];
    return _36c2.maybeUnBoxAndBuildArgument<_51e4.BoxDecoration, _fac9.dynamic>(
  ...
  @_fac9.override
  _51e4.BoxDecoration scale(factor) {
  ...
  @_fac9.override
  _51e4.BoxDecoration? lerpFrom(a, t) {
    _36c2.Closure closure = table["lerpFrom"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_51e4.BoxDecoration?, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _51e4.BoxDecoration? lerpTo(b, t) {
...
void loadBoxDecoration(
  ...
  table['boxDecoration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBoxDecoration(
          ...
          borderRadius: _36c2.maybeUnBoxAndBuildArgument<_9d8a.BorderRadiusGeometry?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          boxShadow: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_9068.BoxShadow>?, _9068.BoxShadow>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['boxShadow'] : null,
              parentState: hydroState),
  ...
  table['boxDecorationLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _51e4.BoxDecoration.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_51e4.BoxDecoration?, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_51e4.BoxDecoration?, _fac9.dynamic>(
            luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_51e4.BoxDecoration>(boxer: (
      {required _51e4.BoxDecoration vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBoxDecoration(

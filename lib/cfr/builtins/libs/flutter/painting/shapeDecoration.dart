...
class VMManagedShapeDecoration
    extends _36c2.VMManagedBox<_0bf8.ShapeDecoration> {
  VMManagedShapeDecoration(
    ...
    table['lerpFrom'] = _36c2.makeLuaDartFunc(
      ...
      if (returnValue != null) {
        return [
          _36c2.maybeBoxObject<_0bf8.ShapeDecoration?>(
              object: returnValue,
              hydroState: hydroState,
              table: _36c2.HydroTable()),
        ];
...
class RTManagedShapeDecoration extends _0bf8.ShapeDecoration
    implements _36c2.Box<_0bf8.ShapeDecoration> {
  RTManagedShapeDecoration(
      {_a643.Color? color,
      _8a60.Gradient? gradient,
      _48c4.DecorationImage? image,
      _fac9.List<_9068.BoxShadow>? shadows,
  ...
  @_fac9.override
  _0bf8.ShapeDecoration? lerpFrom(a, t) {
    _36c2.Closure closure = table["lerpFrom"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0bf8.ShapeDecoration?, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }

  @_fac9.override
  _0bf8.ShapeDecoration? lerpTo(b, t) {
...
void loadShapeDecoration(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['shapeDecoration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedShapeDecoration(
          ...
          gradient:
              _36c2.maybeUnBoxAndBuildArgument<_8a60.Gradient?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['gradient']
                      : null,
                  parentState: hydroState),
          image: _36c2.maybeUnBoxAndBuildArgument<_48c4.DecorationImage?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['image'] : null,
              parentState: hydroState),
          shadows: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_9068.BoxShadow>?, _9068.BoxShadow>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shadows'] : null, parentState: hydroState),
  ...
  table['shapeDecorationFromBoxDecoration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_0bf8.ShapeDecoration>(
          object: _0bf8.ShapeDecoration.fromBoxDecoration(_36c2
  ...
  table['shapeDecorationLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _0bf8.ShapeDecoration.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_0bf8.ShapeDecoration?, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_0bf8.ShapeDecoration?, _fac9.dynamic>(
            luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_0bf8.ShapeDecoration>(boxer: (
      {required _0bf8.ShapeDecoration vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShapeDecoration(

...
class VMManagedBoxBorder extends _36c2.VMManagedBox<_250a.BoxBorder> {
  VMManagedBoxBorder(
...
class RTManagedBoxBorder extends _250a.BoxBorder
    implements _36c2.Box<_250a.BoxBorder> {
  RTManagedBoxBorder({required this.table, required this.hydroState})
      : super() {
...
void loadBoxBorder(
  ...
  table['boxBorder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBoxBorder(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  table['boxBorderLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _250a.BoxBorder.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_250a.BoxBorder?, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_250a.BoxBorder?, _fac9.dynamic>(
            luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_250a.BoxBorder>(boxer: (
      {required _250a.BoxBorder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBoxBorder(

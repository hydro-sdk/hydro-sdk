...
class VMManagedSweepGradient extends _36c2.VMManagedBox<_8a60.SweepGradient> {
  VMManagedSweepGradient(
    ...
    table['startAngle'] = vmObject.startAngle;
    table['endAngle'] = vmObject.endAngle;
    ...
    table['scale'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_8a60.SweepGradient>(
...
class RTManagedSweepGradient extends _8a60.SweepGradient
    implements _36c2.Box<_8a60.SweepGradient> {
  RTManagedSweepGradient(
      {required _ca85.AlignmentGeometry center,
      required _fac9.double endAngle,
      required _fac9.double startAngle,
    ...
    table['startAngle'] = _36c2.maybeBoxObject(
        object: this.startAngle,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['endAngle'] = _36c2.maybeBoxObject(
        object: this.endAngle,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['tileMode'] = _a643.TileMode.values.indexWhere((x) {
  ...
  @_fac9.override
  _8a60.SweepGradient scale(factor) {
    _36c2.Closure closure = table["scale"];
    return _36c2.maybeUnBoxAndBuildArgument<_8a60.SweepGradient, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadSweepGradient(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sweepGradient'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSweepGradient(
          ...
          center:
              _36c2.maybeUnBoxAndBuildArgument<_ca85.AlignmentGeometry, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          endAngle: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['endAngle']
              : null?.toDouble(),
          startAngle: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['startAngle']
              : null?.toDouble(),
          stops: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_fac9.double>?, _fac9.double>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['stops']
                  : null,
              parentState: hydroState),
          tileMode: _36c2.maybeUnBoxEnum(
              values: _a643.TileMode.values,
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['tileMode'] : null),
  ...
  table['sweepGradientLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _8a60.SweepGradient.lerp(
        _36c2.maybeUnBoxAndBuildArgument<_8a60.SweepGradient?, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState),
        _36c2.maybeUnBoxAndBuildArgument<_8a60.SweepGradient?, _fac9.dynamic>(
            luaCallerArguments[2],
  ...
  _36c2.registerBoxer<_8a60.SweepGradient>(boxer: (
      {required _8a60.SweepGradient vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSweepGradient(

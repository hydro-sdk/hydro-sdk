...
class VMManagedDecoration extends _36c2.VMManagedBox<_13a5.Decoration> {
  VMManagedDecoration(
...
class RTManagedDecoration extends _13a5.Decoration
  ...
  RTManagedDecoration({required this.table, required this.hydroState})
      : super() {
...
void loadDecoration(
  ...
  table['decoration'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDecoration(table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  table['decorationLerp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _13a5.Decoration.lerp(
  ...
  _36c2.registerBoxer<_13a5.Decoration>(boxer: (
      {required _13a5.Decoration vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDecoration(

...
class VMManagedDecoration extends _36c2.VMManagedBox<_13a5.Decoration> {VMManagedDecoration({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
1
];return [_36c2.maybeBoxObject<_13a5.BoxPainter>(object: vmObject.createBoxPainter(() => unpackedonChanged.dispatch([luaCallerArguments[0],],parentState:hydroState,)), hydroState: hydroState, table: _36c2.HydroTable()),]; } );
table  [
'getClipPath'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
...
final _13a5.Decoration vmObject;

 }

class RTManagedDecoration extends _13a5.Decoration implements _36c2.Box<_13a5.Decoration> {RTManagedDecoration({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
return closure.dispatch([table],parentState: hydroState)[0]; } 
@_fac9.override _13a5.Decoration? lerpFrom(a, t) { 
...
@_fac9.override _13a5.Decoration? lerpTo(b, t) { 
...
void loadDecoration({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'decoration'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDecoration(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
table  [
'decorationLerp'
...
final returnValue = _13a5.Decoration.lerp(_36c2.maybeUnBoxAndBuildArgument<_13a5.Decoration?, _fac9.dynamic>(luaCallerArguments  [
1
], parentState: hydroState), _36c2.maybeUnBoxAndBuildArgument<_13a5.Decoration?, _fac9.dynamic>(luaCallerArguments  [
2
], parentState: hydroState), luaCallerArguments  [
3
]?.toDouble());if(returnValue!= null){return [_36c2.maybeBoxObject<_13a5.Decoration?>(object: returnValue, hydroState: hydroState, table: _36c2.HydroTable()),];}return []; } );
_36c2.registerBoxer<_13a5.Decoration>(boxer: ({required _13a5.Decoration vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDecoration(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

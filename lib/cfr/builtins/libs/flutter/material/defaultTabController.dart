...
class VMManagedDefaultTabController
    extends _36c2.VMManagedBox<_f3b5.DefaultTabController> {
  VMManagedDefaultTabController(
    ...
    table['initialIndex'] = vmObject.initialIndex;
  ...
  final _f3b5.DefaultTabController vmObject;
}

class RTManagedDefaultTabController extends _f3b5.DefaultTabController
    implements _36c2.Box<_f3b5.DefaultTabController> {
  RTManagedDefaultTabController(
    ...
    table['initialIndex'] = _36c2.maybeBoxObject(
        object: this.initialIndex,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _f3b5.DefaultTabController unwrap() => this;
  _f3b5.DefaultTabController get vmObject => this;
  @_fac9.override
  _e2dc.State<_f3b5.DefaultTabController> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_f3b5.DefaultTabController>,
            _f3b5.DefaultTabController>(
...
void loadDefaultTabController(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['defaultTabController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDefaultTabController(
  ...
  table['defaultTabControllerOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _f3b5.DefaultTabController.of(
        _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
            luaCallerArguments[1],
            parentState: hydroState));
    if (returnValue != null) {
      return [
        _36c2.maybeBoxObject<_f3b5.TabController?>(
            object: returnValue,
            hydroState: hydroState,
            table: _36c2.HydroTable()),
      ];
  ...
  _36c2.registerBoxer<_f3b5.DefaultTabController>(boxer: (
      {required _f3b5.DefaultTabController vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDefaultTabController(

...
class VMManagedShapeBorderTween
    extends _36c2.VMManagedBox<_e5b9.ShapeBorderTween> {
  VMManagedShapeBorderTween(
    ...
    table['begin'] = _36c2.maybeBoxObject<_6be9.ShapeBorder?>(
        object: vmObject.begin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['end'] = _36c2.maybeBoxObject<_6be9.ShapeBorder?>(
        object: vmObject.end,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  final _e5b9.ShapeBorderTween vmObject;
}

class RTManagedShapeBorderTween extends _e5b9.ShapeBorderTween
    implements _36c2.Box<_e5b9.ShapeBorderTween> {
  RTManagedShapeBorderTween(
      {_6be9.ShapeBorder? begin,
      _6be9.ShapeBorder? end,
      required this.table,
  ...
  _e5b9.ShapeBorderTween unwrap() => this;
  _e5b9.ShapeBorderTween get vmObject => this;
  @_fac9.override
  _6be9.ShapeBorder? lerp(t) {
  ...
  @_fac9.override
  _6be9.ShapeBorder? evaluate(animation) {
  ...
  @_fac9.override
  _86ca.Animation<_6be9.ShapeBorder?> animate(parent) {
    _36c2.Closure closure = table["animate"];
    return _36c2.maybeUnBoxAndBuildArgument<_86ca.Animation<_6be9.ShapeBorder?>,
            _6be9.ShapeBorder?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @_fac9.override
  _e83e.Animatable<_6be9.ShapeBorder?> chain(parent) {
    _36c2.Closure closure = table["chain"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e83e.Animatable<_6be9.ShapeBorder?>, _6be9.ShapeBorder?>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadShapeBorderTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['shapeBorderTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedShapeBorderTween(
  ...
  _36c2.registerBoxer<_e5b9.ShapeBorderTween>(boxer: (
      {required _e5b9.ShapeBorderTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedShapeBorderTween(

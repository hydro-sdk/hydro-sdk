...
class VMManagedRefreshIndicatorState
    extends _36c2.VMManagedBox<_530f.RefreshIndicatorState> {
  VMManagedRefreshIndicatorState(
    ...
    table['show'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_7de1.Future>(
            object: vmObject.show(
                atTop: luaCallerArguments.length >= 2
                    ? luaCallerArguments[1]['atTop']
                    : null),
            hydroState: hydroState,
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_530f.RefreshIndicator>(
  ...
  final _530f.RefreshIndicatorState vmObject;
}

class RTManagedRefreshIndicatorState extends _530f.RefreshIndicatorState
    implements _36c2.Box<_530f.RefreshIndicatorState> {
  RTManagedRefreshIndicatorState(
    ...
    table['_dart_show'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
  ...
  _530f.RefreshIndicatorState unwrap() => this;
  _530f.RefreshIndicatorState get vmObject => this;
  @_fac9.override
  void initState() {
    super.initState();
  ...
  @_fac9.override
  _7de1.Future<void> show({_fac9.bool atTop = true}) {
    _36c2.Closure closure = table["show"];
  ...
  @_fac9.override
  _530f.RefreshIndicator get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_530f.RefreshIndicator, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadRefreshIndicatorState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['refreshIndicatorState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRefreshIndicatorState(
  ...
  _36c2.registerBoxer<_530f.RefreshIndicatorState>(boxer: (
      {required _530f.RefreshIndicatorState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRefreshIndicatorState(

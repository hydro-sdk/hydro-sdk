...
class VMManagedMaterialStateTextStyle
    extends _36c2.VMManagedBox<_da12.MaterialStateTextStyle> {
  VMManagedMaterialStateTextStyle(
  ...
  final _da12.MaterialStateTextStyle vmObject;
}

class RTManagedMaterialStateTextStyle extends _da12.MaterialStateTextStyle
    implements _36c2.Box<_da12.MaterialStateTextStyle> {
  RTManagedMaterialStateTextStyle(
    ...
    table['inherit'] = _36c2.maybeBoxObject(
        object: inherit, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['fontFamily'] = _36c2.maybeBoxObject(
        object: fontFamily, hydroState: hydroState, table: _36c2.HydroTable());
    table['fontSize'] = _36c2.maybeBoxObject(
        object: fontSize, hydroState: hydroState, table: _36c2.HydroTable());
    table['fontWeight'] = _36c2.maybeBoxObject(
        object: fontWeight, hydroState: hydroState, table: _36c2.HydroTable());
    table['fontStyle'] = _a643.FontStyle.values.indexWhere((x) {
      return x == fontStyle;
    });
    ...
    table['wordSpacing'] = _36c2.maybeBoxObject(
        object: wordSpacing, hydroState: hydroState, table: _36c2.HydroTable());
    table['textBaseline'] = _a643.TextBaseline.values.indexWhere((x) {
      return x == textBaseline;
    });
    table['height'] = _36c2.maybeBoxObject(
        object: height, hydroState: hydroState, table: _36c2.HydroTable());
    table['leadingDistribution'] =
        _a643.TextLeadingDistribution.values.indexWhere((x) {
      return x == leadingDistribution;
    });
    table['locale'] = _36c2.maybeBoxObject(
        object: locale, hydroState: hydroState, table: _36c2.HydroTable());
    table['foreground'] = _36c2.maybeBoxObject(
        object: foreground, hydroState: hydroState, table: _36c2.HydroTable());
    table['background'] = _36c2.maybeBoxObject(
        object: background, hydroState: hydroState, table: _36c2.HydroTable());
    table['decoration'] = _36c2.maybeBoxObject(
        object: decoration, hydroState: hydroState, table: _36c2.HydroTable());
    table['decorationColor'] = _36c2.maybeBoxObject(
        object: decorationColor,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['decorationStyle'] = _a643.TextDecorationStyle.values.indexWhere((x) {
      return x == decorationStyle;
    });
    ...
    table['shadows'] = _36c2.maybeBoxObject(
        object: shadows, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  _da12.MaterialStateTextStyle unwrap() => this;
  _da12.MaterialStateTextStyle get vmObject => this;
  @_fac9.override
  _74d0.TextStyle resolve(states) {
...
void loadMaterialStateTextStyle(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['materialStateTextStyle'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterialStateTextStyle(
  ...
  table['materialStateTextStyleResolveWith'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedcallback = luaCallerArguments[1];
    return [
      _36c2.maybeBoxObject<_da12.MaterialStateTextStyle>(
          object: _da12.MaterialStateTextStyle.resolveWith((states) =>
  ...
  _36c2.registerBoxer<_da12.MaterialStateTextStyle>(boxer: (
      {required _da12.MaterialStateTextStyle vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialStateTextStyle(

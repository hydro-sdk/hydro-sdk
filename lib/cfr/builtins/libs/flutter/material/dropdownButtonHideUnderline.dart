...
class VMManagedDropdownButtonHideUnderline
    extends _36c2.VMManagedBox<_9b55.DropdownButtonHideUnderline> {
  VMManagedDropdownButtonHideUnderline(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
            _9b55.DropdownButtonHideUnderline,
  ...
  final _9b55.DropdownButtonHideUnderline vmObject;
}

class RTManagedDropdownButtonHideUnderline
    extends _9b55.DropdownButtonHideUnderline
    implements _36c2.Box<_9b55.DropdownButtonHideUnderline> {
  RTManagedDropdownButtonHideUnderline(
      {_ab4a.Key? key,
  ...
  _9b55.DropdownButtonHideUnderline unwrap() => this;
  _9b55.DropdownButtonHideUnderline get vmObject => this;
  @_fac9.override
...
void loadDropdownButtonHideUnderline(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dropdownButtonHideUnderline'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDropdownButtonHideUnderline(
  ...
  table['dropdownButtonHideUnderlineAt'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _9b55.DropdownButtonHideUnderline.at(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState)),
    ];
  });
  _36c2.registerBoxer<_9b55.DropdownButtonHideUnderline>(boxer: (
      {required _9b55.DropdownButtonHideUnderline vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDropdownButtonHideUnderline(

...
import 'package:flutter/src/material/scrollbar.dart' as _f0d1;
...
class VMManagedScrollbar extends _36c2.VMManagedBox<_f0d1.Scrollbar> {
  VMManagedScrollbar(
    ...
    table['hoverThickness'] = vmObject.hoverThickness;
  ...
  final _f0d1.Scrollbar vmObject;
}

class RTManagedScrollbar extends _f0d1.Scrollbar
    implements _36c2.Box<_f0d1.Scrollbar> {
  RTManagedScrollbar(
      {_9585.ScrollController? controller,
      _fac9.double? hoverThickness,
    ...
    table['showTrackOnHover'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['hoverThickness'] = _36c2.maybeBoxObject(
        object: this.hoverThickness,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _f0d1.Scrollbar unwrap() => this;
  _f0d1.Scrollbar get vmObject => this;
  @_fac9.override
...
void loadScrollbar(
  ...
  table['scrollbar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedScrollbar(
          ...
          controller:
              _36c2.maybeUnBoxAndBuildArgument<_9585.ScrollController?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          hoverThickness: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['hoverThickness']
              : null?.toDouble(),
          ...
          showTrackOnHover: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['showTrackOnHover'] : null,
  ...
  _36c2.registerBoxer<_f0d1.Scrollbar>(boxer: (
      {required _f0d1.Scrollbar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollbar(

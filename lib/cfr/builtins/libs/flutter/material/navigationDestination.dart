...
class VMManagedNavigationDestination
    extends _36c2.VMManagedBox<_84a5.NavigationDestination> {
  VMManagedNavigationDestination(
  ...
  final _84a5.NavigationDestination vmObject;
}

class RTManagedNavigationDestination extends _84a5.NavigationDestination
    implements _36c2.Box<_84a5.NavigationDestination> {
  RTManagedNavigationDestination(
      {_ab4a.Key? key,
  ...
  _84a5.NavigationDestination unwrap() => this;
  _84a5.NavigationDestination get vmObject => this;
  @_fac9.override
...
void loadNavigationDestination(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['navigationDestination'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNavigationDestination(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          selectedIcon: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_84a5.NavigationDestination>(boxer: (
      {required _84a5.NavigationDestination vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNavigationDestination(

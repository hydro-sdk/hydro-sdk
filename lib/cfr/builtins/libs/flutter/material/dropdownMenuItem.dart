...
class VMManagedDropdownMenuItem
    extends _36c2.VMManagedBox<_9b55.DropdownMenuItem<_fac9.dynamic>> {
  VMManagedDropdownMenuItem(
  ...
  final _9b55.DropdownMenuItem<_fac9.dynamic> vmObject;
}

class RTManagedDropdownMenuItem extends _9b55.DropdownMenuItem
    implements _36c2.Box<_9b55.DropdownMenuItem> {
  RTManagedDropdownMenuItem(
  ...
  _9b55.DropdownMenuItem unwrap() => this;
  _9b55.DropdownMenuItem get vmObject => this;
  @_fac9.override
...
void loadDropdownMenuItem(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dropdownMenuItem'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_9b55.DropdownMenuItem>(boxer: (
      {required _9b55.DropdownMenuItem vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDropdownMenuItem(

...
class VMManagedBottomNavigationBarTheme
    extends _36c2.VMManagedBox<_f261.BottomNavigationBarTheme> {
  VMManagedBottomNavigationBarTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_f261.BottomNavigationBarThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(_36c2.maybeUnBoxAndBuildArgument<
            _f261.BottomNavigationBarTheme,
  ...
  final _f261.BottomNavigationBarTheme vmObject;
}

class RTManagedBottomNavigationBarTheme extends _f261.BottomNavigationBarTheme
    implements _36c2.Box<_f261.BottomNavigationBarTheme> {
  RTManagedBottomNavigationBarTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _f261.BottomNavigationBarThemeData data,
      required this.table,
  ...
  _f261.BottomNavigationBarTheme unwrap() => this;
  _f261.BottomNavigationBarTheme get vmObject => this;
  @_fac9.override
...
void loadBottomNavigationBarTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['bottomNavigationBarTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBottomNavigationBarTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<
                  _f261.BottomNavigationBarThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['data'] : null,
              parentState: hydroState))
    ];
  });
  table['bottomNavigationBarThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_f261.BottomNavigationBarThemeData>(
          object: _f261.BottomNavigationBarTheme.of(_36c2
  ...
  _36c2.registerBoxer<_f261.BottomNavigationBarTheme>(boxer: (
      {required _f261.BottomNavigationBarTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBottomNavigationBarTheme(

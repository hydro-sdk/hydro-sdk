...
class VMManagedDivider extends _36c2.VMManagedBox<_d9dc.Divider> {
  VMManagedDivider(
  ...
  final _d9dc.Divider vmObject;
}

class RTManagedDivider extends _d9dc.Divider
    implements _36c2.Box<_d9dc.Divider> {
  RTManagedDivider(
      {_a643.Color? color,
  ...
  _d9dc.Divider unwrap() => this;
  _d9dc.Divider get vmObject => this;
  @_fac9.override
...
void loadDivider(
  ...
  table['divider'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDivider(
  ...
  table['dividerCreateBorderSide'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_6be9.BorderSide>(
          object: _d9dc.Divider.createBorderSide(
  ...
  _36c2.registerBoxer<_d9dc.Divider>(boxer: (
      {required _d9dc.Divider vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDivider(

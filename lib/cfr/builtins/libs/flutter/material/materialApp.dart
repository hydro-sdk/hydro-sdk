...
import 'package:flutter/src/material/app.dart' as _cb66;
...
class VMManagedMaterialApp extends _36c2.VMManagedBox<_cb66.MaterialApp> {
  VMManagedMaterialApp(
    ...
    table['scaffoldMessengerKey'] = _36c2.maybeBoxObject<_e2dc.GlobalKey?>(
        object: vmObject.scaffoldMessengerKey,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['theme'] = _36c2.maybeBoxObject<_9716.ThemeData?>(
        object: vmObject.theme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['darkTheme'] = _36c2.maybeBoxObject<_9716.ThemeData?>(
        object: vmObject.darkTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highContrastTheme'] = _36c2.maybeBoxObject<_9716.ThemeData?>(
        object: vmObject.highContrastTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highContrastDarkTheme'] = _36c2.maybeBoxObject<_9716.ThemeData?>(
        object: vmObject.highContrastDarkTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['themeMode'] = _cb66.ThemeMode.values.indexWhere((x) {
      return x == vmObject.themeMode;
    });
    ...
    table['scrollBehavior'] = _36c2.maybeBoxObject<_b028.ScrollBehavior?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['debugShowMaterialGrid'] = vmObject.debugShowMaterialGrid;
  ...
  final _cb66.MaterialApp vmObject;
}

class RTManagedMaterialApp extends _cb66.MaterialApp
    implements _36c2.Box<_cb66.MaterialApp> {
  RTManagedMaterialApp(
      ...
      _a643.Color? color,
      _9716.ThemeData? darkTheme,
      required _fac9.bool debugShowCheckedModeBanner,
      required _fac9.bool debugShowMaterialGrid,
      _9716.ThemeData? highContrastDarkTheme,
      _9716.ThemeData? highContrastTheme,
      _e2dc.Widget? home,
      _fac9.String? initialRoute,
      _ab4a.Key? key,
      _a643.Locale? locale,
      _a643.Locale? Function(_fac9.List<_a643.Locale>? locales,
              _fac9.Iterable<_a643.Locale> supportedLocales)?
          localeListResolutionCallback,
      _a643.Locale? Function(_a643.Locale? locale,
              _fac9.Iterable<_a643.Locale> supportedLocales)?
      ...
      _fac9.List<_a37d.Route<_fac9.dynamic>> Function(
              _fac9.String initialRoute)?
      ...
      required _fac9.Map<_fac9.String,
              _e2dc.Widget Function(_e2dc.BuildContext context)>
          routes,
      _e2dc.GlobalKey<_ece7.ScaffoldMessengerState>? scaffoldMessengerKey,
      ...
      _9716.ThemeData? theme,
      _cb66.ThemeMode? themeMode,
    ...
    table['navigatorKey'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['scaffoldMessengerKey'] = _36c2.maybeBoxObject(
        object: this.scaffoldMessengerKey,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['theme'] = _36c2.maybeBoxObject(
        object: this.theme, hydroState: hydroState, table: _36c2.HydroTable());
    table['darkTheme'] = _36c2.maybeBoxObject(
        object: this.darkTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highContrastTheme'] = _36c2.maybeBoxObject(
        object: this.highContrastTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highContrastDarkTheme'] = _36c2.maybeBoxObject(
        object: this.highContrastDarkTheme,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['themeMode'] = _cb66.ThemeMode.values.indexWhere((x) {
      return x == this.themeMode;
    });
    ...
    table['scrollBehavior'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['debugShowMaterialGrid'] = _36c2.maybeBoxObject(
        object: this.debugShowMaterialGrid,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _cb66.MaterialApp unwrap() => this;
  _cb66.MaterialApp get vmObject => this;
  @_fac9.override
  _e2dc.State<_cb66.MaterialApp> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_cb66.MaterialApp>,
            _cb66.MaterialApp>(
...
void loadMaterialApp(
  ...
  table['materialApp'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      ...
      RTManagedMaterialApp(
          ...
          darkTheme:
              _36c2.maybeUnBoxAndBuildArgument<_9716.ThemeData?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['darkTheme'] : null,
                  parentState: hydroState),
          debugShowCheckedModeBanner: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['debugShowCheckedModeBanner'] : null,
          debugShowMaterialGrid: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['debugShowMaterialGrid'] : null,
          highContrastDarkTheme: _36c2.maybeUnBoxAndBuildArgument<_9716.ThemeData?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['highContrastDarkTheme'] : null, parentState: hydroState),
          highContrastTheme: _36c2.maybeUnBoxAndBuildArgument<_9716.ThemeData?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['highContrastTheme'] : null, parentState: hydroState),
          home: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['home'] : null, parentState: hydroState),
          initialRoute: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['initialRoute'] : null,
          ...
          scaffoldMessengerKey: _36c2.maybeUnBoxAndBuildArgument<_e2dc.GlobalKey<_ece7.ScaffoldMessengerState>?, _ece7.ScaffoldMessengerState>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['scaffoldMessengerKey'] : null, parentState: hydroState),
          ...
          theme: _36c2.maybeUnBoxAndBuildArgument<_9716.ThemeData?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['theme'] : null, parentState: hydroState),
          themeMode: _36c2.maybeUnBoxEnum(values: _cb66.ThemeMode.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['themeMode'] : null),
  ...
  table['materialAppCreateMaterialHeroController'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_1b22.HeroController>(
          object: _cb66.MaterialApp.createMaterialHeroController(),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  _36c2.registerBoxer<_cb66.MaterialApp>(boxer: (
      {required _cb66.MaterialApp vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialApp(

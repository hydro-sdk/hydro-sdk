...
class VMManagedBackButton extends _36c2.VMManagedBox<_c2ef.BackButton> {
  VMManagedBackButton(
  ...
  final _c2ef.BackButton vmObject;
}

class RTManagedBackButton extends _c2ef.BackButton
    implements _36c2.Box<_c2ef.BackButton> {
  RTManagedBackButton(
      {_a643.Color? color,
      _ab4a.Key? key,
  ...
  _c2ef.BackButton unwrap() => this;
  _c2ef.BackButton get vmObject => this;
  @_fac9.override
...
void loadBackButton(
  ...
  table['backButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_c2ef.BackButton>(boxer: (
      {required _c2ef.BackButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBackButton(

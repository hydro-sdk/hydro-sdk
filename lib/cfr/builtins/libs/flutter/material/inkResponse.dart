...
class VMManagedInkResponse extends _36c2.VMManagedBox<_cd32.InkResponse> {
  VMManagedInkResponse(
  ...
  final _cd32.InkResponse vmObject;
}

class RTManagedInkResponse extends _cd32.InkResponse
    implements _36c2.Box<_cd32.InkResponse> {
  RTManagedInkResponse(
      {required _fac9.bool autofocus,
      _9d8a.BorderRadius? borderRadius,
      required _fac9.bool canRequestFocus,
      _e2dc.Widget? child,
      required _fac9.bool containedInkWell,
      ...
      required _250a.BoxShape highlightShape,
    ...
    table['containedInkWell'] = _36c2.maybeBoxObject(
        object: this.containedInkWell,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['highlightShape'] = _250a.BoxShape.values.indexWhere((x) {
      return x == this.highlightShape;
    });
  ...
  _cd32.InkResponse unwrap() => this;
  _cd32.InkResponse get vmObject => this;
  @_fac9.override
...
void loadInkResponse(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['inkResponse'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedInkResponse(
          ...
          highlightShape: _36c2.maybeUnBoxEnum(values: _250a.BoxShape.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['highlightShape'] : null),
  ...
  _36c2.registerBoxer<_cd32.InkResponse>(boxer: (
      {required _cd32.InkResponse vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInkResponse(

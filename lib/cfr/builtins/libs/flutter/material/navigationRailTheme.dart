...
class VMManagedNavigationRailTheme
    extends _36c2.VMManagedBox<_fcbb.NavigationRailTheme> {
  VMManagedNavigationRailTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_fcbb.NavigationRailThemeData>(
  ...
  final _fcbb.NavigationRailTheme vmObject;
}

class RTManagedNavigationRailTheme extends _fcbb.NavigationRailTheme
    implements _36c2.Box<_fcbb.NavigationRailTheme> {
  RTManagedNavigationRailTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _fcbb.NavigationRailThemeData data,
      required this.table,
  ...
  _fcbb.NavigationRailTheme unwrap() => this;
  _fcbb.NavigationRailTheme get vmObject => this;
  @_fac9.override
...
void loadNavigationRailTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['navigationRailTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedNavigationRailTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_fcbb.NavigationRailThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['navigationRailThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_fcbb.NavigationRailThemeData>(
          object: _fcbb.NavigationRailTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_fcbb.NavigationRailTheme>(boxer: (
      {required _fcbb.NavigationRailTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNavigationRailTheme(

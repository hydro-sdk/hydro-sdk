...
import 'package:flutter/src/material/divider.dart' as _d9dc;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedVerticalDivider
    extends _36c2.VMManagedBox<_d9dc.VerticalDivider> {
  VMManagedVerticalDivider(
  ...
  final _d9dc.VerticalDivider vmObject;
}

class RTManagedVerticalDivider extends _d9dc.VerticalDivider
    implements _36c2.Box<_d9dc.VerticalDivider> {
  RTManagedVerticalDivider(
      {_a643.Color? color,
  ...
  _d9dc.VerticalDivider unwrap() => this;
  _d9dc.VerticalDivider get vmObject => this;
  @_fac9.override
...
void loadVerticalDivider(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['verticalDivider'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedVerticalDivider(
  ...
  _36c2.registerBoxer<_d9dc.VerticalDivider>(boxer: (
      {required _d9dc.VerticalDivider vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedVerticalDivider(

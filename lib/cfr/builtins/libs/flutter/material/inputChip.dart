...
class VMManagedInputChip extends _36c2.VMManagedBox<_8acc.InputChip> {
  VMManagedInputChip(
  ...
  final _8acc.InputChip vmObject;
}

class RTManagedInputChip extends _8acc.InputChip
    implements _36c2.Box<_8acc.InputChip> {
  RTManagedInputChip(
  ...
  _8acc.InputChip unwrap() => this;
  _8acc.InputChip get vmObject => this;
  @_fac9.override
...
void loadInputChip(
  ...
  table['inputChip'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_8acc.InputChip>(boxer: (
      {required _8acc.InputChip vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInputChip(

...
class VMManagedCheckboxTheme extends _36c2.VMManagedBox<_0ff4.CheckboxTheme> {
  VMManagedCheckboxTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_0ff4.CheckboxThemeData>(
  ...
  final _0ff4.CheckboxTheme vmObject;
}

class RTManagedCheckboxTheme extends _0ff4.CheckboxTheme
    implements _36c2.Box<_0ff4.CheckboxTheme> {
  RTManagedCheckboxTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _0ff4.CheckboxThemeData data,
      required this.table,
  ...
  _0ff4.CheckboxTheme unwrap() => this;
  _0ff4.CheckboxTheme get vmObject => this;
  @_fac9.override
...
void loadCheckboxTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['checkboxTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCheckboxTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_0ff4.CheckboxThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['checkboxThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_0ff4.CheckboxThemeData>(
          object: _0ff4.CheckboxTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_0ff4.CheckboxTheme>(boxer: (
      {required _0ff4.CheckboxTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCheckboxTheme(

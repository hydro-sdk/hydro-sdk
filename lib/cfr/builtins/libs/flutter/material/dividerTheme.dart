...
class VMManagedDividerTheme extends _36c2.VMManagedBox<_bcda.DividerTheme> {
  VMManagedDividerTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_bcda.DividerThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_bcda.DividerTheme, _fac9.dynamic>(
  ...
  final _bcda.DividerTheme vmObject;
}

class RTManagedDividerTheme extends _bcda.DividerTheme
    implements _36c2.Box<_bcda.DividerTheme> {
  RTManagedDividerTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _bcda.DividerThemeData data,
      required this.table,
  ...
  _bcda.DividerTheme unwrap() => this;
  _bcda.DividerTheme get vmObject => this;
  @_fac9.override
...
void loadDividerTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dividerTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDividerTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_bcda.DividerThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['dividerThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_bcda.DividerThemeData>(
          object: _bcda.DividerTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_bcda.DividerTheme>(boxer: (
      {required _bcda.DividerTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDividerTheme(

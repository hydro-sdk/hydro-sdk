...
import 'package:flutter/src/material/grid_tile.dart' as _0453;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedGridTile extends _36c2.VMManagedBox<_0453.GridTile> {
  VMManagedGridTile(
  ...
  final _0453.GridTile vmObject;
}

class RTManagedGridTile extends _0453.GridTile
    implements _36c2.Box<_0453.GridTile> {
  RTManagedGridTile(
      {_e2dc.Widget? footer,
      _e2dc.Widget? header,
      _ab4a.Key? key,
      ...
      : super(footer: footer, header: header, key: key, child: child) {
  ...
  _0453.GridTile unwrap() => this;
  _0453.GridTile get vmObject => this;
  @_fac9.override
...
void loadGridTile(
  ...
  table['gridTile'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGridTile(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          footer: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_0453.GridTile>(boxer: (
      {required _0453.GridTile vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGridTile(

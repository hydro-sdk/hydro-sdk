...
class VMManagedButtonBarTheme extends _36c2.VMManagedBox<_ba38.ButtonBarTheme> {
  VMManagedButtonBarTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_ba38.ButtonBarThemeData>(
  ...
  final _ba38.ButtonBarTheme vmObject;
}

class RTManagedButtonBarTheme extends _ba38.ButtonBarTheme
    implements _36c2.Box<_ba38.ButtonBarTheme> {
  RTManagedButtonBarTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _ba38.ButtonBarThemeData data,
      required this.table,
  ...
  _ba38.ButtonBarTheme unwrap() => this;
  _ba38.ButtonBarTheme get vmObject => this;
  @_fac9.override
...
void loadButtonBarTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['buttonBarTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedButtonBarTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_ba38.ButtonBarThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['buttonBarThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_ba38.ButtonBarThemeData>(
          object: _ba38.ButtonBarTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_ba38.ButtonBarTheme>(boxer: (
      {required _ba38.ButtonBarTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedButtonBarTheme(

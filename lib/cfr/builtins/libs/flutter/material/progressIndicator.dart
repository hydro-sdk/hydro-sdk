...
class VMManagedProgressIndicator
    extends _36c2.VMManagedBox<_afa4.ProgressIndicator> {
  VMManagedProgressIndicator(
  ...
  final _afa4.ProgressIndicator vmObject;
}

class RTManagedProgressIndicator extends _afa4.ProgressIndicator
    implements _36c2.Box<_afa4.ProgressIndicator> {
  RTManagedProgressIndicator(
  ...
  _afa4.ProgressIndicator unwrap() => this;
  _afa4.ProgressIndicator get vmObject => this;
  @_fac9.override
...
void loadProgressIndicator(
  ...
  table['progressIndicator'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedProgressIndicator(
  ...
  _36c2.registerBoxer<_afa4.ProgressIndicator>(boxer: (
      {required _afa4.ProgressIndicator vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedProgressIndicator(

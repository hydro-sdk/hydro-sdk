...
import 'package:flutter/src/material/ink_ripple.dart' as _9f3a;
...
class VMManagedInkRipple extends _36c2.VMManagedBox<_9f3a.InkRipple> {
  VMManagedInkRipple(
  ...
  final _9f3a.InkRipple vmObject;
}

class RTManagedInkRipple extends _9f3a.InkRipple
    implements _36c2.Box<_9f3a.InkRipple> {
  RTManagedInkRipple(
  ...
  _9f3a.InkRipple unwrap() => this;
  _9f3a.InkRipple get vmObject => this;
  @_fac9.override
  void confirm() {
...
void loadInkRipple(
  ...
  table['inkRipple'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_9f3a.InkRipple>(boxer: (
      {required _9f3a.InkRipple vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInkRipple(

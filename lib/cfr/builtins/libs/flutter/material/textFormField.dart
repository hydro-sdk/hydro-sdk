    ...
    return [
      TextFormField(
          ...
          style: maybeUnBoxAndBuildArgument<TextStyle,dynamic>(args[0]["style"],
              parentState: luaState),
          strutStyle: maybeUnBoxAndBuildArgument<StrutStyle,dynamic>(args[0]["strutStyle"],
              parentState: luaState),
          ...
          textAlignVertical: maybeUnBoxAndBuildArgument<TextAlignVertical,dynamic>(
              args[0]["textAlignVertical"],
              parentState: luaState),
          autofocus: args[0]["autofocus"],
          readOnly: args[0]["readOnly"],
          toolbarOptions: maybeUnBoxAndBuildArgument<ToolbarOptions,dynamic>(

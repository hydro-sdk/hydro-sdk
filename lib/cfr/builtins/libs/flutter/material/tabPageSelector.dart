...
class VMManagedTabPageSelector
    extends _36c2.VMManagedBox<_d82b.TabPageSelector> {
  VMManagedTabPageSelector(
    ...
    table['indicatorSize'] = vmObject.indicatorSize;
  ...
  final _d82b.TabPageSelector vmObject;
}

class RTManagedTabPageSelector extends _d82b.TabPageSelector
    implements _36c2.Box<_d82b.TabPageSelector> {
  RTManagedTabPageSelector(
      {_a643.Color? color,
      _f3b5.TabController? controller,
      required _fac9.double indicatorSize,
      _ab4a.Key? key,
    ...
    table['controller'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['indicatorSize'] = _36c2.maybeBoxObject(
        object: this.indicatorSize,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _d82b.TabPageSelector unwrap() => this;
  _d82b.TabPageSelector get vmObject => this;
  @_fac9.override
...
void loadTabPageSelector(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tabPageSelector'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTabPageSelector(
          ...
          controller:
              _36c2.maybeUnBoxAndBuildArgument<_f3b5.TabController?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          indicatorSize: luaCallerArguments.length >= 2
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['key'] : null,
              parentState: hydroState),
          selectedColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['selectedColor'] : null,
              parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_d82b.TabPageSelector>(boxer: (
      {required _d82b.TabPageSelector vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTabPageSelector(

...
class VMManagedPopupMenuButtonState
    extends _36c2.VMManagedBox<_2891.PopupMenuButtonState<_fac9.dynamic>> {
  VMManagedPopupMenuButtonState(
    ...
    table['showButtonMenu'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.showButtonMenu();
      return [];
    });
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_2891.PopupMenuButton>(
  ...
  final _2891.PopupMenuButtonState<_fac9.dynamic> vmObject;
}

class RTManagedPopupMenuButtonState extends _2891.PopupMenuButtonState
    implements _36c2.Box<_2891.PopupMenuButtonState> {
  RTManagedPopupMenuButtonState({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_showButtonMenu'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_didUpdateWidget'] = _36c2.makeLuaDartFunc(
      ...
      super.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<
          _2891.PopupMenuButton<_fac9.dynamic>,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  ...
  _2891.PopupMenuButtonState unwrap() => this;
  _2891.PopupMenuButtonState get vmObject => this;
  @_fac9.override
  void showButtonMenu() {
    _36c2.Closure closure = table["showButtonMenu"];
  ...
  @_fac9.override
  _2891.PopupMenuButton<_fac9.dynamic> get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _2891.PopupMenuButton<_fac9.dynamic>, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadPopupMenuButtonState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['popupMenuButtonState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPopupMenuButtonState(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_2891.PopupMenuButtonState>(boxer: (
      {required _2891.PopupMenuButtonState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPopupMenuButtonState(

...
class VMManagedSimpleDialogOption
    extends _36c2.VMManagedBox<_1e08.SimpleDialogOption> {
  VMManagedSimpleDialogOption(
  ...
  final _1e08.SimpleDialogOption vmObject;
}

class RTManagedSimpleDialogOption extends _1e08.SimpleDialogOption
    implements _36c2.Box<_1e08.SimpleDialogOption> {
  RTManagedSimpleDialogOption(
      {_e2dc.Widget? child,
      _ab4a.Key? key,
      ...
      : super(child: child, key: key, onPressed: onPressed, padding: padding) {
  ...
  _1e08.SimpleDialogOption unwrap() => this;
  _1e08.SimpleDialogOption get vmObject => this;
  @_fac9.override
...
void loadSimpleDialogOption(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['simpleDialogOption'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_1e08.SimpleDialogOption>(boxer: (
      {required _1e08.SimpleDialogOption vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSimpleDialogOption(

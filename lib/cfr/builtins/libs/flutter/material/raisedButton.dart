...
import 'package:flutter/src/material/raised_button.dart' as _75f8;
...
class VMManagedRaisedButton extends _36c2.VMManagedBox<_75f8.RaisedButton> {
  VMManagedRaisedButton(
  ...
  final _75f8.RaisedButton vmObject;
}

class RTManagedRaisedButton extends _75f8.RaisedButton
    implements _36c2.Box<_75f8.RaisedButton> {
  RTManagedRaisedButton(
  ...
  _75f8.RaisedButton unwrap() => this;
  _75f8.RaisedButton get vmObject => this;
  @_fac9.override
...
void loadRaisedButton(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['raisedButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedRaisedButton(
          ...
          color: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          colorBrightness: _36c2.maybeUnBoxEnum(values: _a643.Brightness.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['colorBrightness'] : null),
  ...
  table['raisedButtonIcon'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonHighlightChanged = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onHighlightChanged']
        : null;
    ...
    _36c2.Closure? unpackedonPressed = luaCallerArguments.length >= 2
        ...
        : null;
    return [
      _36c2.maybeBoxObject<_75f8.RaisedButton>(
          object: _75f8.RaisedButton.icon(
              animationDuration: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['animationDuration']
                      : null,
              ...
              colorBrightness: _36c2.maybeUnBoxEnum(
                  ...
                  boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['colorBrightness'] : null),
              disabledColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledColor'] : null, parentState: hydroState),
              disabledElevation: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledElevation'] : null?.toDouble(),
              disabledTextColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledTextColor'] : null, parentState: hydroState),
              elevation: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['elevation'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_75f8.RaisedButton>(boxer: (
      {required _75f8.RaisedButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRaisedButton(

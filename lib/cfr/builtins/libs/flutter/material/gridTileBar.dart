...
import 'package:flutter/src/material/grid_tile_bar.dart' as _3e71;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedGridTileBar extends _36c2.VMManagedBox<_3e71.GridTileBar> {
  VMManagedGridTileBar(
  ...
  final _3e71.GridTileBar vmObject;
}

class RTManagedGridTileBar extends _3e71.GridTileBar
    implements _36c2.Box<_3e71.GridTileBar> {
  RTManagedGridTileBar(
  ...
  _3e71.GridTileBar unwrap() => this;
  _3e71.GridTileBar get vmObject => this;
  @_fac9.override
...
void loadGridTileBar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['gridTileBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGridTileBar(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          leading: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['leading'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_3e71.GridTileBar>(boxer: (
      {required _3e71.GridTileBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGridTileBar(

...
class VMManagedTextButtonTheme
    extends _36c2.VMManagedBox<_85f3.TextButtonTheme> {
  VMManagedTextButtonTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_85f3.TextButtonThemeData>(
  ...
  final _85f3.TextButtonTheme vmObject;
}

class RTManagedTextButtonTheme extends _85f3.TextButtonTheme
    implements _36c2.Box<_85f3.TextButtonTheme> {
  RTManagedTextButtonTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _85f3.TextButtonThemeData data,
      required this.table,
  ...
  _85f3.TextButtonTheme unwrap() => this;
  _85f3.TextButtonTheme get vmObject => this;
  @_fac9.override
...
void loadTextButtonTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['textButtonTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTextButtonTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_85f3.TextButtonThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['textButtonThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_85f3.TextButtonThemeData>(
          object: _85f3.TextButtonTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_85f3.TextButtonTheme>(boxer: (
      {required _85f3.TextButtonTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTextButtonTheme(

...
class VMManagedOutlineInputBorder
    extends _36c2.VMManagedBox<_d817.OutlineInputBorder> {
  VMManagedOutlineInputBorder(
  ...
  final _d817.OutlineInputBorder vmObject;
}

class RTManagedOutlineInputBorder extends _d817.OutlineInputBorder
    implements _36c2.Box<_d817.OutlineInputBorder> {
  RTManagedOutlineInputBorder(
      {required _9d8a.BorderRadius borderRadius,
      required _6be9.BorderSide borderSide,
      required _fac9.double gapPadding,
      required this.table,
  ...
  _d817.OutlineInputBorder unwrap() => this;
  _d817.OutlineInputBorder get vmObject => this;
  @_fac9.override
...
void loadOutlineInputBorder(
  ...
  table['outlineInputBorder'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOutlineInputBorder(
  ...
  _36c2.registerBoxer<_d817.OutlineInputBorder>(boxer: (
      {required _d817.OutlineInputBorder vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOutlineInputBorder(

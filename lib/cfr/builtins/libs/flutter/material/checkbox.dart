...
import 'package:flutter/src/material/checkbox.dart' as _6ddb;
...
class VMManagedCheckbox extends _36c2.VMManagedBox<_6ddb.Checkbox> {
  VMManagedCheckbox(
  ...
  final _6ddb.Checkbox vmObject;
}

class RTManagedCheckbox extends _6ddb.Checkbox
    implements _36c2.Box<_6ddb.Checkbox> {
  RTManagedCheckbox(
  ...
  _6ddb.Checkbox unwrap() => this;
  _6ddb.Checkbox get vmObject => this;
  @_fac9.override
  _e2dc.State<_6ddb.Checkbox> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_6ddb.Checkbox>,
            _6ddb.Checkbox>(
...
void loadCheckbox(
  ...
  table['checkbox'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_6ddb.Checkbox>(boxer: (
      {required _6ddb.Checkbox vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCheckbox(

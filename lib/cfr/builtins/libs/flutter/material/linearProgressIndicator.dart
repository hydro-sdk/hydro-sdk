...
class VMManagedLinearProgressIndicator
    extends _36c2.VMManagedBox<_afa4.LinearProgressIndicator> {
  VMManagedLinearProgressIndicator(
  ...
  final _afa4.LinearProgressIndicator vmObject;
}

class RTManagedLinearProgressIndicator extends _afa4.LinearProgressIndicator
    implements _36c2.Box<_afa4.LinearProgressIndicator> {
  RTManagedLinearProgressIndicator(
  ...
  _afa4.LinearProgressIndicator unwrap() => this;
  _afa4.LinearProgressIndicator get vmObject => this;
  @_fac9.override
  ...
  @_fac9.override
  _e2dc.State<_afa4.LinearProgressIndicator> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _e2dc.State<_afa4.LinearProgressIndicator>,
            _afa4.LinearProgressIndicator>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadLinearProgressIndicator(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['linearProgressIndicator'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLinearProgressIndicator(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          minHeight: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['minHeight'] : null?.toDouble(),
  ...
  _36c2.registerBoxer<_afa4.LinearProgressIndicator>(boxer: (
      {required _afa4.LinearProgressIndicator vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLinearProgressIndicator(

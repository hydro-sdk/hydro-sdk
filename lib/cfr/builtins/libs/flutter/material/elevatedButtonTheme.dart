...
class VMManagedElevatedButtonTheme
    extends _36c2.VMManagedBox<_8227.ElevatedButtonTheme> {
  VMManagedElevatedButtonTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_8227.ElevatedButtonThemeData>(
  ...
  final _8227.ElevatedButtonTheme vmObject;
}

class RTManagedElevatedButtonTheme extends _8227.ElevatedButtonTheme
    implements _36c2.Box<_8227.ElevatedButtonTheme> {
  RTManagedElevatedButtonTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _8227.ElevatedButtonThemeData data,
      required this.table,
  ...
  _8227.ElevatedButtonTheme unwrap() => this;
  _8227.ElevatedButtonTheme get vmObject => this;
  @_fac9.override
...
void loadElevatedButtonTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['elevatedButtonTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedElevatedButtonTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_8227.ElevatedButtonThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['elevatedButtonThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_8227.ElevatedButtonThemeData>(
          object: _8227.ElevatedButtonTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_8227.ElevatedButtonTheme>(boxer: (
      {required _8227.ElevatedButtonTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedElevatedButtonTheme(

...
class VMManagedSimpleDialog extends _36c2.VMManagedBox<_1e08.SimpleDialog> {
  VMManagedSimpleDialog(
  ...
  final _1e08.SimpleDialog vmObject;
}

class RTManagedSimpleDialog extends _1e08.SimpleDialog
    implements _36c2.Box<_1e08.SimpleDialog> {
  RTManagedSimpleDialog(
      ...
      _e2dc.Widget? title,
      required _96d1.EdgeInsetsGeometry titlePadding,
  ...
  _1e08.SimpleDialog unwrap() => this;
  _1e08.SimpleDialog get vmObject => this;
  @_fac9.override
...
void loadSimpleDialog(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['simpleDialog'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSimpleDialog(
  ...
  _36c2.registerBoxer<_1e08.SimpleDialog>(boxer: (
      {required _1e08.SimpleDialog vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSimpleDialog(

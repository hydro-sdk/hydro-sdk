...
import 'package:flutter/src/material/bottom_app_bar.dart' as _3826;
import 'package:flutter/src/painting/notched_shapes.dart' as _2316;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedBottomAppBar extends _36c2.VMManagedBox<_3826.BottomAppBar> {
  VMManagedBottomAppBar(
    ...
    table['notchMargin'] = vmObject.notchMargin;
  ...
  final _3826.BottomAppBar vmObject;
}

class RTManagedBottomAppBar extends _3826.BottomAppBar
    implements _36c2.Box<_3826.BottomAppBar> {
  RTManagedBottomAppBar(
      {_e2dc.Widget? child,
      required _a643.Clip clipBehavior,
      _a643.Color? color,
      _fac9.double? elevation,
      _ab4a.Key? key,
      required _fac9.double notchMargin,
    ...
    table['notchMargin'] = _36c2.maybeBoxObject(
        object: this.notchMargin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _3826.BottomAppBar unwrap() => this;
  _3826.BottomAppBar get vmObject => this;
  @_fac9.override
...
void loadBottomAppBar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['bottomAppBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBottomAppBar(
          ...
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              ...
              parentState: hydroState),
          notchMargin: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['notchMargin'] : null?.toDouble(),
          shape: _36c2.maybeUnBoxAndBuildArgument<_2316.NotchedShape?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['shape'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_3826.BottomAppBar>(boxer: (
      {required _3826.BottomAppBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedBottomAppBar(

...
class VMManagedTabPageSelectorIndicator
    extends _36c2.VMManagedBox<_d82b.TabPageSelectorIndicator> {
  VMManagedTabPageSelectorIndicator(
  ...
  final _d82b.TabPageSelectorIndicator vmObject;
}

class RTManagedTabPageSelectorIndicator extends _d82b.TabPageSelectorIndicator
    implements _36c2.Box<_d82b.TabPageSelectorIndicator> {
  RTManagedTabPageSelectorIndicator(
      {_ab4a.Key? key,
      required _a643.Color backgroundColor,
      required _a643.Color borderColor,
  ...
  _d82b.TabPageSelectorIndicator unwrap() => this;
  _d82b.TabPageSelectorIndicator get vmObject => this;
  @_fac9.override
...
void loadTabPageSelectorIndicator(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tabPageSelectorIndicator'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTabPageSelectorIndicator(
          ...
          borderColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['borderColor'] : null,
              parentState: hydroState),
          size: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['size'] : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_d82b.TabPageSelectorIndicator>(boxer: (
      {required _d82b.TabPageSelectorIndicator vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTabPageSelectorIndicator(

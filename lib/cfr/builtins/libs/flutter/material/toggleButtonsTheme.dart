...
class VMManagedToggleButtonsTheme
    extends _36c2.VMManagedBox<_3a57.ToggleButtonsTheme> {
  VMManagedToggleButtonsTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_3a57.ToggleButtonsThemeData>(
  ...
  final _3a57.ToggleButtonsTheme vmObject;
}

class RTManagedToggleButtonsTheme extends _3a57.ToggleButtonsTheme
    implements _36c2.Box<_3a57.ToggleButtonsTheme> {
  RTManagedToggleButtonsTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _3a57.ToggleButtonsThemeData data,
      required this.table,
  ...
  _3a57.ToggleButtonsTheme unwrap() => this;
  _3a57.ToggleButtonsTheme get vmObject => this;
  @_fac9.override
...
void loadToggleButtonsTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['toggleButtonsTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedToggleButtonsTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_3a57.ToggleButtonsThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['toggleButtonsThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_3a57.ToggleButtonsThemeData>(
          object: _3a57.ToggleButtonsTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_3a57.ToggleButtonsTheme>(boxer: (
      {required _3a57.ToggleButtonsTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedToggleButtonsTheme(

...
class VMManagedDialog extends _36c2.VMManagedBox<_1e08.Dialog> {
  VMManagedDialog(
  ...
  final _1e08.Dialog vmObject;
}

class RTManagedDialog extends _1e08.Dialog implements _36c2.Box<_1e08.Dialog> {
  RTManagedDialog(
  ...
  _1e08.Dialog unwrap() => this;
  _1e08.Dialog get vmObject => this;
  @_fac9.override
...
void loadDialog(
  ...
  table['dialog'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDialog(
  ...
  _36c2.registerBoxer<_1e08.Dialog>(boxer: (
      {required _1e08.Dialog vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDialog(

...
import 'package:flutter/src/material/circle_avatar.dart' as _035e;
import 'package:flutter/src/painting/image_provider.dart' as _61fa;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedCircleAvatar extends _36c2.VMManagedBox<_035e.CircleAvatar> {
  VMManagedCircleAvatar(
    ...
    table['foregroundColor'] = _36c2.maybeBoxObject<_a643.Color?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['backgroundImage'] = _36c2.maybeBoxObject<_61fa.ImageProvider?>(
        object: vmObject.backgroundImage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['foregroundImage'] = _36c2.maybeBoxObject<_61fa.ImageProvider?>(
        object: vmObject.foregroundImage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['radius'] = vmObject.radius;
    table['minRadius'] = vmObject.minRadius;
    table['maxRadius'] = vmObject.maxRadius;
  ...
  final _035e.CircleAvatar vmObject;
}

class RTManagedCircleAvatar extends _035e.CircleAvatar
    implements _36c2.Box<_035e.CircleAvatar> {
  RTManagedCircleAvatar(
      {_a643.Color? backgroundColor,
      _61fa.ImageProvider<_fac9.Object>? backgroundImage,
      _e2dc.Widget? child,
      _a643.Color? foregroundColor,
      _61fa.ImageProvider<_fac9.Object>? foregroundImage,
      _ab4a.Key? key,
      _fac9.double? maxRadius,
      _fac9.double? minRadius,
    ...
    table['foregroundColor'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['backgroundImage'] = _36c2.maybeBoxObject(
        object: this.backgroundImage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['foregroundImage'] = _36c2.maybeBoxObject(
        object: this.foregroundImage,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['radius'] = _36c2.maybeBoxObject(
        object: this.radius, hydroState: hydroState, table: _36c2.HydroTable());
    table['minRadius'] = _36c2.maybeBoxObject(
        object: this.minRadius,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['maxRadius'] = _36c2.maybeBoxObject(
        object: this.maxRadius,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _035e.CircleAvatar unwrap() => this;
  _035e.CircleAvatar get vmObject => this;
  @_fac9.override
...
void loadCircleAvatar(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['circleAvatar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonBackgroundImageError =
        luaCallerArguments.length >= 2
            ? luaCallerArguments[1]['onBackgroundImageError']
            : null;
    _36c2.Closure? unpackedonForegroundImageError =
        luaCallerArguments.length >= 2
            ? luaCallerArguments[1]['onForegroundImageError']
            : null;
      ...
      RTManagedCircleAvatar(
          ...
          backgroundImage:
              _36c2.maybeUnBoxAndBuildArgument<_61fa.ImageProvider<_fac9.Object>?, _fac9.Object>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['backgroundImage']
                      : null,
                  parentState: hydroState),
          ...
          foregroundImage: _36c2.maybeUnBoxAndBuildArgument<_61fa.ImageProvider<_fac9.Object>?, _fac9.Object>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['foregroundImage'] : null, parentState: hydroState),
          ...
          maxRadius: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['maxRadius'] : null?.toDouble(),
          minRadius: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['minRadius'] : null?.toDouble(),
          onBackgroundImageError: unpackedonBackgroundImageError != null
              ? (exception, stackTrace) => unpackedonBackgroundImageError.dispatch(
                    [luaCallerArguments[0], exception, stackTrace],
                    parentState: hydroState,
                  )
              : null,
          onForegroundImageError: unpackedonForegroundImageError != null
              ? (exception, stackTrace) => unpackedonForegroundImageError.dispatch(
                    [luaCallerArguments[0], exception, stackTrace],
                    parentState: hydroState,
                  )
              : null,
  ...
  _36c2.registerBoxer<_035e.CircleAvatar>(boxer: (
      {required _035e.CircleAvatar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCircleAvatar(

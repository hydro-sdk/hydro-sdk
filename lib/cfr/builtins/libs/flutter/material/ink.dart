...
class VMManagedInk extends _36c2.VMManagedBox<_8e1e.Ink> {
  VMManagedInk(
  ...
  final _8e1e.Ink vmObject;
}

class RTManagedInk extends _8e1e.Ink implements _36c2.Box<_8e1e.Ink> {
  RTManagedInk(
      {_e2dc.Widget? child,
      _a643.Color? color,
  ...
  _8e1e.Ink unwrap() => this;
  _8e1e.Ink get vmObject => this;
  @_fac9.override
  ...
  @_fac9.override
  _e2dc.State<_8e1e.Ink> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_8e1e.Ink>, _8e1e.Ink>(
...
void loadInk(
  ...
  table['ink'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedInk(
  ...
  _36c2.registerBoxer<_8e1e.Ink>(boxer: (
      {required _8e1e.Ink vmObject,

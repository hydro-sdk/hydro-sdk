...
class VMManagedPopupMenuItemState extends _36c2.VMManagedBox<
  ...
  final _2891
          .PopupMenuItemState<_fac9.dynamic, _2891.PopupMenuItem<_fac9.dynamic>>
      vmObject;
}

class RTManagedPopupMenuItemState extends _2891.PopupMenuItemState
    implements _36c2.Box<_2891.PopupMenuItemState> {
  RTManagedPopupMenuItemState({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_buildChild'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject(
            object: super.buildChild(),
            hydroState: hydroState,
            table: _36c2.HydroTable())
      ];
    });
  ...
  _2891.PopupMenuItemState unwrap() => this;
  _2891.PopupMenuItemState get vmObject => this;
  @_fac9.override
  _e2dc.Widget? buildChild() {
    _36c2.Closure closure = table["buildChild"];
  ...
  @_fac9.override
  _2891.PopupMenuItem<_fac9.dynamic> get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2.maybeUnBoxAndBuildArgument<_2891.PopupMenuItem<_fac9.dynamic>,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadPopupMenuItemState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['popupMenuItemState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPopupMenuItemState(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_2891.PopupMenuItemState>(boxer: (
      {required _2891.PopupMenuItemState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPopupMenuItemState(

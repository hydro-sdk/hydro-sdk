...
class VMManagedTab extends _36c2.VMManagedBox<_d82b.Tab> {
  VMManagedTab(
    ...
    table['icon'] = _36c2.maybeBoxObject<_e2dc.Widget?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['iconMargin'] = _36c2.maybeBoxObject<_96d1.EdgeInsetsGeometry>(
        object: vmObject.iconMargin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  final _d82b.Tab vmObject;
}

class RTManagedTab extends _d82b.Tab implements _36c2.Box<_d82b.Tab> {
  RTManagedTab(
      {_e2dc.Widget? child,
      _fac9.double? height,
      _e2dc.Widget? icon,
      required _96d1.EdgeInsetsGeometry iconMargin,
      _ab4a.Key? key,
      _fac9.String? text,
      required this.table,
    ...
    table['iconMargin'] = _36c2.maybeBoxObject(
        object: this.iconMargin,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _d82b.Tab unwrap() => this;
  _d82b.Tab get vmObject => this;
  @_fac9.override
...
void loadTab(
  ...
  table['tab'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTab(
          ...
          height: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          icon: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['icon'] : null,
              parentState: hydroState),
          iconMargin:
              _36c2.maybeUnBoxAndBuildArgument<_96d1.EdgeInsetsGeometry, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['iconMargin']
                      : null,
                  parentState: hydroState),
  ...
  _36c2.registerBoxer<_d82b.Tab>(boxer: (
      {required _d82b.Tab vmObject,

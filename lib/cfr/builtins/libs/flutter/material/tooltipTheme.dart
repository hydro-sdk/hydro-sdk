...
class VMManagedTooltipTheme extends _36c2.VMManagedBox<_f870.TooltipTheme> {
  VMManagedTooltipTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_f870.TooltipThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_f870.TooltipTheme, _fac9.dynamic>(
  ...
  final _f870.TooltipTheme vmObject;
}

class RTManagedTooltipTheme extends _f870.TooltipTheme
    implements _36c2.Box<_f870.TooltipTheme> {
  RTManagedTooltipTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _f870.TooltipThemeData data,
      required this.table,
  ...
  _f870.TooltipTheme unwrap() => this;
  _f870.TooltipTheme get vmObject => this;
  @_fac9.override
...
void loadTooltipTheme(
  ...
  table['tooltipTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTooltipTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_f870.TooltipThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['tooltipThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_f870.TooltipThemeData>(
          object: _f870.TooltipTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_f870.TooltipTheme>(boxer: (
      {required _f870.TooltipTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTooltipTheme(

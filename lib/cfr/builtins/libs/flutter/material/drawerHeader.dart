...
import 'package:flutter/src/material/drawer_header.dart' as _c9d8;
...
class VMManagedDrawerHeader extends _36c2.VMManagedBox<_c9d8.DrawerHeader> {
  VMManagedDrawerHeader(
  ...
  final _c9d8.DrawerHeader vmObject;
}

class RTManagedDrawerHeader extends _c9d8.DrawerHeader
    implements _36c2.Box<_c9d8.DrawerHeader> {
  RTManagedDrawerHeader(
  ...
  _c9d8.DrawerHeader unwrap() => this;
  _c9d8.DrawerHeader get vmObject => this;
  @_fac9.override
...
void loadDrawerHeader(
  ...
  table['drawerHeader'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDrawerHeader(
  ...
  _36c2.registerBoxer<_c9d8.DrawerHeader>(boxer: (
      {required _c9d8.DrawerHeader vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDrawerHeader(

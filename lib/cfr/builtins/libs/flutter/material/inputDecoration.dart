  ...
  table["inputDecoration"] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      InputDecoration(
        ...
        hintStyle: maybeUnBoxAndBuildArgument<TextStyle,dynamic>(args[0]["hintStyle"],
            parentState: luaState),
        hintMaxLines: args[0]["hintMaxLines"],
        errorText: args[0]["errorText"],
        errorStyle: maybeUnBoxAndBuildArgument<TextStyle,dynamic>(args[0]["errorStyle"],
            parentState: luaState),
        ...
        contentPadding: maybeUnBoxAndBuildArgument<EdgeInsets,dynamic>(
            ...
            parentState: luaState),
        prefixIcon: maybeUnBoxAndBuildArgument<Widget,dynamic>(args[0]["prefixIcon"],
            parentState: luaState),
        prefixIconConstraints: maybeUnBoxAndBuildArgument<BoxConstraints,dynamic>(
        ...
        prefixStyle: maybeUnBoxAndBuildArgument<TextStyle,dynamic>(
            args[0]["prefixStyle"],
            parentState: luaState),
        suffixIcon: maybeUnBoxAndBuildArgument<Widget,dynamic>(args[0]["suffixIcon"],
            parentState: luaState),
        ...
        suffixStyle: maybeUnBoxAndBuildArgument<TextStyle,dynamic>(
            args[0]["suffixStyle"],
            parentState: luaState),
        suffixIconConstraints: maybeUnBoxAndBuildArgument<BoxConstraints,dynamic>(
        ...
        fillColor: maybeUnBoxAndBuildArgument<Color,dynamic>(args[0]["filledColor"],
            parentState: luaState),
        focusColor: maybeUnBoxAndBuildArgument<Color,dynamic>(args[0]["focusColor"],
            parentState: luaState),
        hoverColor: maybeUnBoxAndBuildArgument<Color,dynamic>(args[0]["hoverColor"],
            parentState: luaState),
        ...
        enabledBorder: maybeUnBoxAndBuildArgument<InputBorder,dynamic>(
            ...
            parentState: luaState),
        border: maybeUnBoxAndBuildArgument<InputBorder,dynamic>(args[0]["border"],
            parentState: luaState),

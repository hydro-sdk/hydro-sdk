...
class VMManagedSwitchTheme extends _36c2.VMManagedBox<_6ec8.SwitchTheme> {
  VMManagedSwitchTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_6ec8.SwitchThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_6ec8.SwitchTheme, _fac9.dynamic>(
  ...
  final _6ec8.SwitchTheme vmObject;
}

class RTManagedSwitchTheme extends _6ec8.SwitchTheme
    implements _36c2.Box<_6ec8.SwitchTheme> {
  RTManagedSwitchTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _6ec8.SwitchThemeData data,
      required this.table,
  ...
  _6ec8.SwitchTheme unwrap() => this;
  _6ec8.SwitchTheme get vmObject => this;
  @_fac9.override
...
void loadSwitchTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['switchTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSwitchTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_6ec8.SwitchThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['switchThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_6ec8.SwitchThemeData>(
          object: _6ec8.SwitchTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_6ec8.SwitchTheme>(boxer: (
      {required _6ec8.SwitchTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSwitchTheme(

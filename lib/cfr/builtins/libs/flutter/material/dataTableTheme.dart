...
class VMManagedDataTableTheme extends _36c2.VMManagedBox<_8f52.DataTableTheme> {
  VMManagedDataTableTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_8f52.DataTableThemeData>(
  ...
  final _8f52.DataTableTheme vmObject;
}

class RTManagedDataTableTheme extends _8f52.DataTableTheme
    implements _36c2.Box<_8f52.DataTableTheme> {
  RTManagedDataTableTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _8f52.DataTableThemeData data,
      required this.table,
  ...
  _8f52.DataTableTheme unwrap() => this;
  _8f52.DataTableTheme get vmObject => this;
  @_fac9.override
...
void loadDataTableTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dataTableTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDataTableTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_8f52.DataTableThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['dataTableThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_8f52.DataTableThemeData>(
          object: _8f52.DataTableTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_8f52.DataTableTheme>(boxer: (
      {required _8f52.DataTableTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDataTableTheme(

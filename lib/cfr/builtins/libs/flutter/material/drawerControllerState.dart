...
import 'package:flutter/src/material/drawer.dart' as _365d;
...
class VMManagedDrawerControllerState
    extends _36c2.VMManagedBox<_365d.DrawerControllerState> {
  VMManagedDrawerControllerState(
    ...
    table['didUpdateWidget'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.didUpdateWidget(_36c2.maybeUnBoxAndBuildArgument<
          _365d.DrawerController,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
    table['open'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      vmObject.open();
      return [];
    });
    ...
    table['getWidget'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_365d.DrawerController>(
  ...
  final _365d.DrawerControllerState vmObject;
}

class RTManagedDrawerControllerState extends _365d.DrawerControllerState
    implements _36c2.Box<_365d.DrawerControllerState> {
  RTManagedDrawerControllerState(
    ...
    table['_dart_open'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.open();
      return [];
    });
  ...
  _365d.DrawerControllerState unwrap() => this;
  _365d.DrawerControllerState get vmObject => this;
  @_fac9.override
  void initState() {
    super.initState();
  ...
  @_fac9.override
  void open() {
    _36c2.Closure closure = table["open"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
  ...
  @_fac9.override
  _365d.DrawerController get widget {
    _36c2.Closure closure = table["getWidget"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_365d.DrawerController, _fac9.dynamic>(
            closure.dispatch([table], parentState: hydroState)[0],
            parentState: hydroState);
  }
...
void loadDrawerControllerState(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['drawerControllerState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDrawerControllerState(
  ...
  _36c2.registerBoxer<_365d.DrawerControllerState>(boxer: (
      {required _365d.DrawerControllerState vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDrawerControllerState(

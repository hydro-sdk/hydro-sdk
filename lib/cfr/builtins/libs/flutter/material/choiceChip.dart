...
class VMManagedChoiceChip extends _36c2.VMManagedBox<_8acc.ChoiceChip> {
  VMManagedChoiceChip(
  ...
  final _8acc.ChoiceChip vmObject;
}

class RTManagedChoiceChip extends _8acc.ChoiceChip
    implements _36c2.Box<_8acc.ChoiceChip> {
  RTManagedChoiceChip(
  ...
  _8acc.ChoiceChip unwrap() => this;
  _8acc.ChoiceChip get vmObject => this;
  @_fac9.override
...
void loadChoiceChip(
  ...
  table['choiceChip'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedChoiceChip(
          ...
          avatar: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['avatar'] : null,
              parentState: hydroState),
          avatarBorder: _36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['avatarBorder'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_8acc.ChoiceChip>(boxer: (
      {required _8acc.ChoiceChip vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedChoiceChip(

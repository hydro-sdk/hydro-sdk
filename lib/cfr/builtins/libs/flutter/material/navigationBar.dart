...
class VMManagedNavigationBar extends _36c2.VMManagedBox<_84a5.NavigationBar> {
  VMManagedNavigationBar(
    ...
    table['destinations'] = _36c2.maybeBoxObject<_fac9.List<_e2dc.Widget>>(
  ...
  final _84a5.NavigationBar vmObject;
}

class RTManagedNavigationBar extends _84a5.NavigationBar
    implements _36c2.Box<_84a5.NavigationBar> {
  RTManagedNavigationBar(
      ...
      required _fac9.List<_e2dc.Widget> destinations,
      required this.table,
  ...
  _84a5.NavigationBar unwrap() => this;
  _84a5.NavigationBar get vmObject => this;
  @_fac9.override
...
void loadNavigationBar(
  ...
  table['navigationBar'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedNavigationBar(
          ...
          labelBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['labelBehavior'] : null),
          ...
          destinations: _36c2.maybeUnBoxAndBuildArgument<_fac9.List<_e2dc.Widget>, _e2dc.Widget>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['destinations'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_84a5.NavigationBar>(boxer: (
      {required _84a5.NavigationBar vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedNavigationBar(

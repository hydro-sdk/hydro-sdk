...
class VMManagedDrawerTheme extends _36c2.VMManagedBox<_e0d9.DrawerTheme> {
  VMManagedDrawerTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_e0d9.DrawerThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_e0d9.DrawerTheme, _fac9.dynamic>(
  ...
  final _e0d9.DrawerTheme vmObject;
}

class RTManagedDrawerTheme extends _e0d9.DrawerTheme
    implements _36c2.Box<_e0d9.DrawerTheme> {
  RTManagedDrawerTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _e0d9.DrawerThemeData data,
      required this.table,
  ...
  _e0d9.DrawerTheme unwrap() => this;
  _e0d9.DrawerTheme get vmObject => this;
  @_fac9.override
...
void loadDrawerTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['drawerTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDrawerTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_e0d9.DrawerThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['drawerThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_e0d9.DrawerThemeData>(
          object: _e0d9.DrawerTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_e0d9.DrawerTheme>(boxer: (
      {required _e0d9.DrawerTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDrawerTheme(

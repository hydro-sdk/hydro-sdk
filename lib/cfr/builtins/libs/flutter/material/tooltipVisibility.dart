...
import 'package:flutter/src/material/tooltip_visibility.dart' as _7c37;
import 'package:flutter/src/widgets/framework.dart' as _e2dc;

import 'package:hydro_sdk/cfr/runtimeSupport.dart' as _36c2;

class VMManagedTooltipVisibility
    extends _36c2.VMManagedBox<_7c37.TooltipVisibility> {
  VMManagedTooltipVisibility(
  ...
  final _7c37.TooltipVisibility vmObject;
}

class RTManagedTooltipVisibility extends _7c37.TooltipVisibility
    implements _36c2.Box<_7c37.TooltipVisibility> {
  RTManagedTooltipVisibility(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _fac9.bool visible,
      required this.table,
      required this.hydroState})
      : super(key: key, child: child, visible: visible) {
  ...
  _7c37.TooltipVisibility unwrap() => this;
  _7c37.TooltipVisibility get vmObject => this;
  @_fac9.override
...
void loadTooltipVisibility(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['tooltipVisibility'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTooltipVisibility(
  ...
  table['tooltipVisibilityOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _7c37.TooltipVisibility.of(
          _36c2.maybeUnBoxAndBuildArgument<_e2dc.BuildContext, _fac9.dynamic>(
              luaCallerArguments[1],
              parentState: hydroState)),
    ];
  });
  _36c2.registerBoxer<_7c37.TooltipVisibility>(boxer: (
      {required _7c37.TooltipVisibility vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTooltipVisibility(

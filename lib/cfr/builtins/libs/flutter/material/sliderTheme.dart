...
class VMManagedSliderTheme extends _36c2.VMManagedBox<_4581.SliderTheme> {
  VMManagedSliderTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_4581.SliderThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_4581.SliderTheme, _fac9.dynamic>(
  ...
  final _4581.SliderTheme vmObject;
}

class RTManagedSliderTheme extends _4581.SliderTheme
    implements _36c2.Box<_4581.SliderTheme> {
  RTManagedSliderTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _4581.SliderThemeData data,
      required this.table,
  ...
  _4581.SliderTheme unwrap() => this;
  _4581.SliderTheme get vmObject => this;
  @_fac9.override
...
void loadSliderTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['sliderTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedSliderTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_4581.SliderThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['sliderThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_4581.SliderThemeData>(
          object: _4581.SliderTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_4581.SliderTheme>(boxer: (
      {required _4581.SliderTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSliderTheme(

...
class VMManagedButtonStyleButton
    extends _36c2.VMManagedBox<_5ee4.ButtonStyleButton> {
  VMManagedButtonStyleButton(
  ...
  final _5ee4.ButtonStyleButton vmObject;
}

class RTManagedButtonStyleButton extends _5ee4.ButtonStyleButton
    implements _36c2.Box<_5ee4.ButtonStyleButton> {
  RTManagedButtonStyleButton(
      {_ab4a.Key? key,
    ...
    table['_dart_defaultStyleOf'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: defaultStyleOf(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
    ...
    table['_dart_themeStyleOf'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: themeStyleOf(_36c2.maybeUnBoxAndBuildArgument<
                _e2dc.BuildContext,
                _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
            hydroState: hydroState,
            table: _36c2.HydroTable())
  ...
  _5ee4.ButtonStyleButton unwrap() => this;
  _5ee4.ButtonStyleButton get vmObject => this;
  @_fac9.override
...
void loadButtonStyleButton(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['buttonStyleButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedButtonStyleButton(
          ...
          onPressed: unpackedonPressed != null
              ...
              : null,
          style: _36c2.maybeUnBoxAndBuildArgument<_9bb8.ButtonStyle?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['style'] : null, parentState: hydroState))
    ];
  });
  table['buttonStyleButtonAllOrNull'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue =
        _5ee4.ButtonStyleButton.allOrNull(luaCallerArguments[1]);
    if (returnValue != null) {
      return [
  ...
  table['buttonStyleButtonScaledPadding'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_96d1.EdgeInsetsGeometry>(
          object: _5ee4.ButtonStyleButton.scaledPadding(
  ...
  _36c2.registerBoxer<_5ee4.ButtonStyleButton>(boxer: (
      {required _5ee4.ButtonStyleButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedButtonStyleButton(

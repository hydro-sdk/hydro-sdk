...
class VMManagedRoundedRectRangeSliderTrackShape
    extends _36c2.VMManagedBox<_4581.RoundedRectRangeSliderTrackShape> {
  VMManagedRoundedRectRangeSliderTrackShape(
    ...
    table['paint'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.paint(
          ...
          _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
              ...
              parentState: hydroState),
          additionalActiveTrackHeight: luaCallerArguments.length >= 4
              ? luaCallerArguments[3]['additionalActiveTrackHeight']
              : null?.toDouble(),
  ...
  final _4581.RoundedRectRangeSliderTrackShape vmObject;
}

class RTManagedRoundedRectRangeSliderTrackShape
    extends _4581.RoundedRectRangeSliderTrackShape
    implements _36c2.Box<_4581.RoundedRectRangeSliderTrackShape> {
  RTManagedRoundedRectRangeSliderTrackShape(
    ...
    table['_dart_paint'] = _36c2.makeLuaDartFunc(
      ...
      super.paint(
          ...
          additionalActiveTrackHeight:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.double, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments[3]['additionalActiveTrackHeight'] : null,
                  parentState: hydroState),
          isDiscrete: _36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(
              luaCallerArguments.length >= 4 ? luaCallerArguments[3]['isDiscrete'] : null,
              parentState: hydroState),
          isEnabled: _36c2.maybeUnBoxAndBuildArgument<_fac9.bool, _fac9.dynamic>(luaCallerArguments.length >= 4 ? luaCallerArguments[3]['isEnabled'] : null, parentState: hydroState),
  ...
  _4581.RoundedRectRangeSliderTrackShape unwrap() => this;
  _4581.RoundedRectRangeSliderTrackShape get vmObject => this;
  @_fac9.override
  ...
  void paint(context, offset,
      {_fac9.double additionalActiveTrackHeight = 2,
      _fac9.bool isDiscrete = false,
      _fac9.bool isEnabled = false,
...
void loadRoundedRectRangeSliderTrackShape(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['roundedRectRangeSliderTrackShape'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRoundedRectRangeSliderTrackShape(
  ...
  _36c2.registerBoxer<_4581.RoundedRectRangeSliderTrackShape>(boxer: (
      {required _4581.RoundedRectRangeSliderTrackShape vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRoundedRectRangeSliderTrackShape(

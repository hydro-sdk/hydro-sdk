...
class VMManagedTheme extends _36c2.VMManagedBox<_a012.Theme> {
  VMManagedTheme(
  ...
  final _a012.Theme vmObject;
}

class RTManagedTheme extends _a012.Theme implements _36c2.Box<_a012.Theme> {
  RTManagedTheme(
      {_ab4a.Key? key,
  ...
  _a012.Theme unwrap() => this;
  _a012.Theme get vmObject => this;
  @_fac9.override
...
void loadTheme(
  ...
  table['theme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTheme(
  ...
  table['themeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_9716.ThemeData>(
          object: _a012.Theme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_a012.Theme>(boxer: (
      {required _a012.Theme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTheme(

...
class VMManagedMaterialButton extends _36c2.VMManagedBox<_1e7a.MaterialButton> {
  VMManagedMaterialButton(
  ...
  final _1e7a.MaterialButton vmObject;
}

class RTManagedMaterialButton extends _1e7a.MaterialButton
    implements _36c2.Box<_1e7a.MaterialButton> {
  RTManagedMaterialButton(
  ...
  _1e7a.MaterialButton unwrap() => this;
  _1e7a.MaterialButton get vmObject => this;
  @_fac9.override
...
void loadMaterialButton(
  ...
  table['materialButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_1e7a.MaterialButton>(boxer: (
      {required _1e7a.MaterialButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialButton(

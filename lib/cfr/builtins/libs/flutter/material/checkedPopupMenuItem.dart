...
class VMManagedCheckedPopupMenuItem
    extends _36c2.VMManagedBox<_2891.CheckedPopupMenuItem<_fac9.dynamic>> {
  VMManagedCheckedPopupMenuItem(
  ...
  final _2891.CheckedPopupMenuItem<_fac9.dynamic> vmObject;
}

class RTManagedCheckedPopupMenuItem extends _2891.CheckedPopupMenuItem
    implements _36c2.Box<_2891.CheckedPopupMenuItem> {
  RTManagedCheckedPopupMenuItem(
      {required _fac9.bool checked,
      _e2dc.Widget? child,
    ...
    table['textStyle'] = _36c2.maybeBoxObject(
        object: textStyle, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  _2891.CheckedPopupMenuItem unwrap() => this;
  _2891.CheckedPopupMenuItem get vmObject => this;
  @_fac9.override
  _e2dc.Widget? get child {
  ...
  _2891.PopupMenuItemState<_fac9.dynamic,
      _2891.CheckedPopupMenuItem<_fac9.dynamic>> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _2891.PopupMenuItemState<_fac9.dynamic,
                _2891.CheckedPopupMenuItem<_fac9.dynamic>>,
            _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadCheckedPopupMenuItem(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['checkedPopupMenuItem'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCheckedPopupMenuItem(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          checked: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['checked']
              : null,
  ...
  _36c2.registerBoxer<_2891.CheckedPopupMenuItem>(boxer: (
      {required _2891.CheckedPopupMenuItem vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCheckedPopupMenuItem(

...
import 'package:flutter/src/material/card.dart' as _bd0f;
...
class VMManagedCard extends _36c2.VMManagedBox<_bd0f.Card> {
  VMManagedCard(
    ...
    table['shape'] = _36c2.maybeBoxObject<_6be9.ShapeBorder?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['borderOnForeground'] = vmObject.borderOnForeground;
    ...
    table['margin'] = _36c2.maybeBoxObject<_96d1.EdgeInsetsGeometry?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['semanticContainer'] = vmObject.semanticContainer;
  ...
  final _bd0f.Card vmObject;
}

class RTManagedCard extends _bd0f.Card implements _36c2.Box<_bd0f.Card> {
  RTManagedCard(
      {required _fac9.bool borderOnForeground,
      _e2dc.Widget? child,
      ...
      required _fac9.bool semanticContainer,
    ...
    table['borderOnForeground'] = _36c2.maybeBoxObject(
        object: this.borderOnForeground,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['clipBehavior'] = _a643.Clip.values.indexWhere((x) {
    ...
    table['semanticContainer'] = _36c2.maybeBoxObject(
        object: this.semanticContainer,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _bd0f.Card unwrap() => this;
  _bd0f.Card get vmObject => this;
  @_fac9.override
...
void loadCard(
  ...
  table['card'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedCard(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          borderOnForeground: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['borderOnForeground']
              : null,
          ...
          semanticContainer: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['semanticContainer'] : null,
  ...
  _36c2.registerBoxer<_bd0f.Card>(boxer: (
      {required _bd0f.Card vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCard(

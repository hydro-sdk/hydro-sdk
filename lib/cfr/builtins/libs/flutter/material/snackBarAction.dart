...
class VMManagedSnackBarAction extends _36c2.VMManagedBox<_ed7b.SnackBarAction> {
  VMManagedSnackBarAction(
  ...
  final _ed7b.SnackBarAction vmObject;
}

class RTManagedSnackBarAction extends _ed7b.SnackBarAction
    implements _36c2.Box<_ed7b.SnackBarAction> {
  RTManagedSnackBarAction(
  ...
  _ed7b.SnackBarAction unwrap() => this;
  _ed7b.SnackBarAction get vmObject => this;
  @_fac9.override
  _e2dc.State<_ed7b.SnackBarAction> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_ed7b.SnackBarAction>,
            _ed7b.SnackBarAction>(
...
void loadSnackBarAction(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['snackBarAction'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      ...
      RTManagedSnackBarAction(
          ...
          disabledTextColor:
              _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['disabledTextColor']
                      : null,
                  parentState: hydroState),
          key: _36c2.maybeUnBoxAndBuildArgument<_ab4a.Key?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          textColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['textColor'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_ed7b.SnackBarAction>(boxer: (
      {required _ed7b.SnackBarAction vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedSnackBarAction(

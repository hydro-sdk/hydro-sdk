...
class VMManagedRadioTheme extends _36c2.VMManagedBox<_f4b1.RadioTheme> {
  VMManagedRadioTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_f4b1.RadioThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_f4b1.RadioTheme, _fac9.dynamic>(
  ...
  final _f4b1.RadioTheme vmObject;
}

class RTManagedRadioTheme extends _f4b1.RadioTheme
    implements _36c2.Box<_f4b1.RadioTheme> {
  RTManagedRadioTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _f4b1.RadioThemeData data,
      required this.table,
  ...
  _f4b1.RadioTheme unwrap() => this;
  _f4b1.RadioTheme get vmObject => this;
  @_fac9.override
...
void loadRadioTheme(
  ...
  table['radioTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRadioTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_f4b1.RadioThemeData,
                  _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['data'] : null,
              parentState: hydroState))
    ];
  });
  table['radioThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_f4b1.RadioThemeData>(
          object: _f4b1.RadioTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_f4b1.RadioTheme>(boxer: (
      {required _f4b1.RadioTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRadioTheme(

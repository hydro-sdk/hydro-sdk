...
class VMManagedAnimatedTheme extends _36c2.VMManagedBox<_a012.AnimatedTheme> {
  VMManagedAnimatedTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_9716.ThemeData>(
  ...
  final _a012.AnimatedTheme vmObject;
}

class RTManagedAnimatedTheme extends _a012.AnimatedTheme
    implements _36c2.Box<_a012.AnimatedTheme> {
  RTManagedAnimatedTheme(
      {required _8c47.Curve curve,
      required _fac9.Duration duration,
      _ab4a.Key? key,
      void Function()? onEnd,
      required _e2dc.Widget child,
      required _9716.ThemeData data,
      required this.table,
  ...
  _a012.AnimatedTheme unwrap() => this;
  _a012.AnimatedTheme get vmObject => this;
  @_fac9.override
  _da7c.AnimatedWidgetBaseState<_a012.AnimatedTheme> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<
            _da7c.AnimatedWidgetBaseState<_a012.AnimatedTheme>,
            _a012.AnimatedTheme>(
...
void loadAnimatedTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['animatedTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedAnimatedTheme(
          ...
          data: _36c2.maybeUnBoxAndBuildArgument<_9716.ThemeData, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['data'] : null, parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_a012.AnimatedTheme>(boxer: (
      {required _a012.AnimatedTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedAnimatedTheme(

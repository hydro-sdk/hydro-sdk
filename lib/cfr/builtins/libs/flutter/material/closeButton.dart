...
class VMManagedCloseButton extends _36c2.VMManagedBox<_c2ef.CloseButton> {
  VMManagedCloseButton(
  ...
  final _c2ef.CloseButton vmObject;
}

class RTManagedCloseButton extends _c2ef.CloseButton
    implements _36c2.Box<_c2ef.CloseButton> {
  RTManagedCloseButton(
      {_a643.Color? color,
      _ab4a.Key? key,
      void Function()? onPressed,
      required this.table,
      required this.hydroState})
      : super(color: color, key: key, onPressed: onPressed) {
  ...
  _c2ef.CloseButton unwrap() => this;
  _c2ef.CloseButton get vmObject => this;
  @_fac9.override
...
void loadCloseButton(
  ...
  table['closeButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_c2ef.CloseButton>(boxer: (
      {required _c2ef.CloseButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedCloseButton(

...
class VMManagedMaterialScrollBehavior
    extends _36c2.VMManagedBox<_cb66.MaterialScrollBehavior> {
  VMManagedMaterialScrollBehavior(
  ...
  final _cb66.MaterialScrollBehavior vmObject;
}

class RTManagedMaterialScrollBehavior extends _cb66.MaterialScrollBehavior
    implements _36c2.Box<_cb66.MaterialScrollBehavior> {
  RTManagedMaterialScrollBehavior(
  ...
  _cb66.MaterialScrollBehavior unwrap() => this;
  _cb66.MaterialScrollBehavior get vmObject => this;
  @_fac9.override
...
void loadMaterialScrollBehavior(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['materialScrollBehavior'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterialScrollBehavior(
  ...
  _36c2.registerBoxer<_cb66.MaterialScrollBehavior>(boxer: (
      {required _cb66.MaterialScrollBehavior vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialScrollBehavior(

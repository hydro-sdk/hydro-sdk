...
class VMManagedButtonTheme extends _36c2.VMManagedBox<_c547.ButtonTheme> {
  VMManagedButtonTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_c547.ButtonThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_c547.ButtonTheme, _fac9.dynamic>(
  ...
  final _c547.ButtonTheme vmObject;
}

class RTManagedButtonTheme extends _c547.ButtonTheme
    implements _36c2.Box<_c547.ButtonTheme> {
  RTManagedButtonTheme(
    ...
    table['data'] = _36c2.maybeBoxObject(
        object: data, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  _c547.ButtonTheme unwrap() => this;
  _c547.ButtonTheme get vmObject => this;
  @_fac9.override
...
void loadButtonTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['buttonTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedButtonTheme(
  ...
  table['buttonThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_c547.ButtonThemeData>(
          object: _c547.ButtonTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_c547.ButtonTheme>(boxer: (
      {required _c547.ButtonTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedButtonTheme(

...
class VMManagedDialogRoute
    extends _36c2.VMManagedBox<_1e08.DialogRoute<_fac9.dynamic>> {
  VMManagedDialogRoute(
  ...
  final _1e08.DialogRoute<_fac9.dynamic> vmObject;
}

class RTManagedDialogRoute extends _1e08.DialogRoute
    implements _36c2.Box<_1e08.DialogRoute> {
  RTManagedDialogRoute(
      {_a643.Color? barrierColor,
      required _fac9.bool barrierDismissible,
      _fac9.String? barrierLabel,
      _a37d.RouteSettings? settings,
      _ac47.CapturedThemes? themes,
      required _fac9.bool useSafeArea,
  ...
  _1e08.DialogRoute unwrap() => this;
  _1e08.DialogRoute get vmObject => this;
  @_fac9.override
...
void loadDialogRoute(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dialogRoute'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedDialogRoute(
          ...
          hydroState: hydroState,
          barrierColor: _36c2
              .maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['barrierColor'] : null,
                  parentState: hydroState),
          ...
          settings: _36c2
              .maybeUnBoxAndBuildArgument<_a37d.RouteSettings?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          themes: _36c2.maybeUnBoxAndBuildArgument<_ac47.CapturedThemes?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['themes'] : null,
              parentState: hydroState),
          useSafeArea: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['useSafeArea'] : null,
  ...
  _36c2.registerBoxer<_1e08.DialogRoute>(boxer: (
      {required _1e08.DialogRoute vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDialogRoute(

...
class VMManagedMaterialRectCenterArcTween
    extends _36c2.VMManagedBox<_6355.MaterialRectCenterArcTween> {
  VMManagedMaterialRectCenterArcTween(
    ...
    table['end'] = _36c2.maybeBoxObject<_a643.Rect?>(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['getCenterArc'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      final returnValue = vmObject.centerArc;
      if (returnValue != null) {
        return [
  ...
  final _6355.MaterialRectCenterArcTween vmObject;
}

class RTManagedMaterialRectCenterArcTween
    extends _6355.MaterialRectCenterArcTween
    implements _36c2.Box<_6355.MaterialRectCenterArcTween> {
  RTManagedMaterialRectCenterArcTween(
      {_a643.Rect? begin,
      _a643.Rect? end,
      required this.table,
    ...
    table['_dart_getCenterArc'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [super.centerArc];
    });
  ...
  _6355.MaterialRectCenterArcTween unwrap() => this;
  _6355.MaterialRectCenterArcTween get vmObject => this;
  @_fac9.override
  _6355.MaterialPointArcTween? get centerArc {
    _36c2.Closure closure = table["getCenterArc"];
...
void loadMaterialRectCenterArcTween(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['materialRectCenterArcTween'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterialRectCenterArcTween(
  ...
  _36c2.registerBoxer<_6355.MaterialRectCenterArcTween>(boxer: (
      {required _6355.MaterialRectCenterArcTween vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialRectCenterArcTween(

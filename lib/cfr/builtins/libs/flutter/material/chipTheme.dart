...
class VMManagedChipTheme extends _36c2.VMManagedBox<_c6ff.ChipTheme> {
  VMManagedChipTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_c6ff.ChipThemeData>(
    ...
    table['updateShouldNotify'] = _36c2.makeLuaDartFunc(
      ...
      return [
        vmObject.updateShouldNotify(
            _36c2.maybeUnBoxAndBuildArgument<_c6ff.ChipTheme, _fac9.dynamic>(
  ...
  final _c6ff.ChipTheme vmObject;
}

class RTManagedChipTheme extends _c6ff.ChipTheme
    implements _36c2.Box<_c6ff.ChipTheme> {
  RTManagedChipTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _c6ff.ChipThemeData data,
      required this.table,
  ...
  _c6ff.ChipTheme unwrap() => this;
  _c6ff.ChipTheme get vmObject => this;
  @_fac9.override
...
void loadChipTheme(
  ...
  table['chipTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedChipTheme(
  ...
  table['chipThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_c6ff.ChipThemeData>(
          object: _c6ff.ChipTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_c6ff.ChipTheme>(boxer: (
      {required _c6ff.ChipTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedChipTheme(

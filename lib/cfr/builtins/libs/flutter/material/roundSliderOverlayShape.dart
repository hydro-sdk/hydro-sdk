...
class VMManagedRoundSliderOverlayShape
    extends _36c2.VMManagedBox<_4581.RoundSliderOverlayShape> {
  VMManagedRoundSliderOverlayShape(
    ...
    table['overlayRadius'] = vmObject.overlayRadius;
  ...
  final _4581.RoundSliderOverlayShape vmObject;
}

class RTManagedRoundSliderOverlayShape extends _4581.RoundSliderOverlayShape
    implements _36c2.Box<_4581.RoundSliderOverlayShape> {
  RTManagedRoundSliderOverlayShape(
      {required _fac9.double overlayRadius,
      required this.table,
    ...
    table['overlayRadius'] = _36c2.maybeBoxObject(
        object: this.overlayRadius,
        hydroState: hydroState,
        table: _36c2.HydroTable());
  ...
  _4581.RoundSliderOverlayShape unwrap() => this;
  _4581.RoundSliderOverlayShape get vmObject => this;
  @_fac9.override
...
void loadRoundSliderOverlayShape(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['roundSliderOverlayShape'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedRoundSliderOverlayShape(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          overlayRadius: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['overlayRadius']
              : null?.toDouble())
    ];
  });
  _36c2.registerBoxer<_4581.RoundSliderOverlayShape>(boxer: (
      {required _4581.RoundSliderOverlayShape vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedRoundSliderOverlayShape(

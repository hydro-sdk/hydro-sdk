...
import 'package:flutter/src/material/ink_splash.dart' as _a756;
...
class VMManagedInkSplash extends _36c2.VMManagedBox<_a756.InkSplash> {
  VMManagedInkSplash(
  ...
  final _a756.InkSplash vmObject;
}

class RTManagedInkSplash extends _a756.InkSplash
    implements _36c2.Box<_a756.InkSplash> {
  RTManagedInkSplash(
  ...
  _a756.InkSplash unwrap() => this;
  _a756.InkSplash get vmObject => this;
  @_fac9.override
  void confirm() {
...
void loadInkSplash(
  ...
  table['inkSplash'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedInkSplash(
          ...
          containedInkWell: luaCallerArguments.length >= 2
              ...
              : null,
          customBorder: _36c2.maybeUnBoxAndBuildArgument<_6be9.ShapeBorder?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['customBorder']
                  : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_a756.InkSplash>(boxer: (
      {required _a756.InkSplash vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedInkSplash(

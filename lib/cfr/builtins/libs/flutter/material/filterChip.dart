...
class VMManagedFilterChip extends _36c2.VMManagedBox<_8acc.FilterChip> {
  VMManagedFilterChip(
  ...
  final _8acc.FilterChip vmObject;
}

class RTManagedFilterChip extends _8acc.FilterChip
    implements _36c2.Box<_8acc.FilterChip> {
  RTManagedFilterChip(
  ...
  _8acc.FilterChip unwrap() => this;
  _8acc.FilterChip get vmObject => this;
  @_fac9.override
...
void loadFilterChip(
  ...
  table['filterChip'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  _36c2.registerBoxer<_8acc.FilterChip>(boxer: (
      {required _8acc.FilterChip vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedFilterChip(

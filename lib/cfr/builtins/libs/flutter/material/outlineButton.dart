...
import 'package:flutter/src/material/outline_button.dart' as _156c;
...
class VMManagedOutlineButton extends _36c2.VMManagedBox<_156c.OutlineButton> {
  VMManagedOutlineButton(
    ...
    table['highlightedBorderColor'] = _36c2.maybeBoxObject<_a643.Color?>(
        object: vmObject.highlightedBorderColor,
        hydroState: hydroState,
  ...
  final _156c.OutlineButton vmObject;
}

class RTManagedOutlineButton extends _156c.OutlineButton
    implements _36c2.Box<_156c.OutlineButton> {
  RTManagedOutlineButton(
      ...
      _a643.Color? highlightedBorderColor,
    ...
    table['highlightedBorderColor'] = _36c2.maybeBoxObject(
        object: this.highlightedBorderColor,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    ...
    table['minWidth'] = _36c2.maybeBoxObject(
        object: minWidth, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  _156c.OutlineButton unwrap() => this;
  _156c.OutlineButton get vmObject => this;
  @_fac9.override
...
void loadOutlineButton(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['outlineButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    return [
      RTManagedOutlineButton(
          ...
          disabledTextColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledTextColor'] : null, parentState: hydroState),
          ...
          highlightedBorderColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['highlightedBorderColor'] : null, parentState: hydroState),
  ...
  table['outlineButtonIcon'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonLongPress = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onLongPress']
        : null;
    ...
    _36c2.Closure? unpackedonPressed = luaCallerArguments.length >= 2
        ...
        : null;
    return [
      _36c2.maybeBoxObject<_156c.OutlineButton>(
          object: _156c.OutlineButton.icon(
              autofocus: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['autofocus']
                  : null,
              borderSide:
              ...
              disabledBorderColor:
                  _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(
                      luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledBorderColor'] : null,
                      parentState: hydroState),
              disabledTextColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['disabledTextColor'] : null, parentState: hydroState),
              focusColor: _36c2.maybeUnBoxAndBuildArgument<_a643.Color?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['focusColor'] : null, parentState: hydroState),
              focusNode: _36c2.maybeUnBoxAndBuildArgument<_b485.FocusNode?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['focusNode'] : null, parentState: hydroState),
  ...
  _36c2.registerBoxer<_156c.OutlineButton>(boxer: (
      {required _156c.OutlineButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOutlineButton(

...
class VMManagedMaterial extends _36c2.VMManagedBox<_e5b9.Material> {
  VMManagedMaterial(
    ...
    table['type'] = _e5b9.MaterialType.values.indexWhere((x) {
  ...
  final _e5b9.Material vmObject;
}

class RTManagedMaterial extends _e5b9.Material
    implements _36c2.Box<_e5b9.Material> {
  RTManagedMaterial(
      ...
      required _e5b9.MaterialType type,
      required this.table,
  ...
  _e5b9.Material unwrap() => this;
  _e5b9.Material get vmObject => this;
  @_fac9.override
  _e2dc.State<_e5b9.Material> createState() {
    _36c2.Closure closure = table["createState"];
    return _36c2.maybeUnBoxAndBuildArgument<_e2dc.State<_e5b9.Material>,
            _e5b9.Material>(
...
void loadMaterial(
  ...
  table['material'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterial(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          animationDuration: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['animationDuration'] : null,
                  parentState: hydroState),
          ...
          type: _36c2.maybeUnBoxEnum(values: _e5b9.MaterialType.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['type'] : null))
    ];
  });
  table['materialOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    final returnValue = _e5b9.Material.of(
  ...
  _36c2.registerBoxer<_e5b9.Material>(boxer: (
      {required _e5b9.Material vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterial(

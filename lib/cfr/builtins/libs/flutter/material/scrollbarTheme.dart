...
class VMManagedScrollbarTheme extends _36c2.VMManagedBox<_ea69.ScrollbarTheme> {
  VMManagedScrollbarTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_ea69.ScrollbarThemeData>(
  ...
  final _ea69.ScrollbarTheme vmObject;
}

class RTManagedScrollbarTheme extends _ea69.ScrollbarTheme
    implements _36c2.Box<_ea69.ScrollbarTheme> {
  RTManagedScrollbarTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _ea69.ScrollbarThemeData data,
      required this.table,
  ...
  _ea69.ScrollbarTheme unwrap() => this;
  _ea69.ScrollbarTheme get vmObject => this;
  @_fac9.override
...
void loadScrollbarTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollbarTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollbarTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_ea69.ScrollbarThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['scrollbarThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_ea69.ScrollbarThemeData>(
          object: _ea69.ScrollbarTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_ea69.ScrollbarTheme>(boxer: (
      {required _ea69.ScrollbarTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollbarTheme(

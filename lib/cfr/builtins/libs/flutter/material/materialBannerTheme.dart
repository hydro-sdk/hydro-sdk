...
class VMManagedMaterialBannerTheme
    extends _36c2.VMManagedBox<_4761.MaterialBannerTheme> {
  VMManagedMaterialBannerTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_4761.MaterialBannerThemeData?>(
  ...
  final _4761.MaterialBannerTheme vmObject;
}

class RTManagedMaterialBannerTheme extends _4761.MaterialBannerTheme
    implements _36c2.Box<_4761.MaterialBannerTheme> {
  RTManagedMaterialBannerTheme(
      {_4761.MaterialBannerThemeData? data,
      _ab4a.Key? key,
      required _e2dc.Widget child,
      required this.table,
      required this.hydroState})
      : super(data: data, key: key, child: child) {
  ...
  _4761.MaterialBannerTheme unwrap() => this;
  _4761.MaterialBannerTheme get vmObject => this;
  @_fac9.override
...
void loadMaterialBannerTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['materialBannerTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterialBannerTheme(
          ...
          hydroState: hydroState,
          data: _36c2
              .maybeUnBoxAndBuildArgument<_4761.MaterialBannerThemeData?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  table['materialBannerThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_4761.MaterialBannerThemeData>(
          object: _4761.MaterialBannerTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_4761.MaterialBannerTheme>(boxer: (
      {required _4761.MaterialBannerTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialBannerTheme(

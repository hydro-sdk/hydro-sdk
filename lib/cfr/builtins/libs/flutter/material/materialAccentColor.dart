...
class VMManagedMaterialAccentColor
    extends _36c2.VMManagedBox<_4450.MaterialAccentColor> {
  ...
  final _4450.MaterialAccentColor vmObject;
}

class RTManagedMaterialAccentColor extends _4450.MaterialAccentColor
    implements _36c2.Box<_4450.MaterialAccentColor> {
  RTManagedMaterialAccentColor(
  ...
  _4450.MaterialAccentColor unwrap() => this;
  _4450.MaterialAccentColor get vmObject => this;
  @_fac9.override
...
void loadMaterialAccentColor(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['materialAccentColor'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMaterialAccentColor(
          luaCallerArguments[1],
  ...
  _36c2.registerBoxer<_4450.MaterialAccentColor>(boxer: (
      {required _4450.MaterialAccentColor vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMaterialAccentColor(

...
class VMManagedDrawer extends _36c2.VMManagedBox<_365d.Drawer> {
  VMManagedDrawer(
  ...
  final _365d.Drawer vmObject;
}

class RTManagedDrawer extends _365d.Drawer implements _36c2.Box<_365d.Drawer> {
  RTManagedDrawer(
  ...
  _365d.Drawer unwrap() => this;
  _365d.Drawer get vmObject => this;
  @_fac9.override
...
void loadDrawer(
  ...
  table['drawer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDrawer(
  ...
  _36c2.registerBoxer<_365d.Drawer>(boxer: (
      {required _365d.Drawer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDrawer(

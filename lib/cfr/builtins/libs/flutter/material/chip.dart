...
class VMManagedChip extends _36c2.VMManagedBox<_8acc.Chip> {
  VMManagedChip(
  ...
  final _8acc.Chip vmObject;
}

class RTManagedChip extends _8acc.Chip implements _36c2.Box<_8acc.Chip> {
  RTManagedChip(
  ...
  _8acc.Chip unwrap() => this;
  _8acc.Chip get vmObject => this;
  @_fac9.override
...
void loadChip(
  ...
  table['chip'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      ...
      RTManagedChip(
          ...
          clipBehavior: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          deleteButtonTooltipMessage: luaCallerArguments.length >= 2
              ? luaCallerArguments[1]['deleteButtonTooltipMessage']
              : null,
          deleteIcon: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget?, _fac9.dynamic>(
              luaCallerArguments.length >= 2 ? luaCallerArguments[1]['deleteIcon'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_8acc.Chip>(boxer: (
      {required _8acc.Chip vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedChip(

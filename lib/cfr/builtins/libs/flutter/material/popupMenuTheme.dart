...
class VMManagedPopupMenuTheme extends _36c2.VMManagedBox<_2271.PopupMenuTheme> {
  VMManagedPopupMenuTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_2271.PopupMenuThemeData>(
  ...
  final _2271.PopupMenuTheme vmObject;
}

class RTManagedPopupMenuTheme extends _2271.PopupMenuTheme
    implements _36c2.Box<_2271.PopupMenuTheme> {
  RTManagedPopupMenuTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _2271.PopupMenuThemeData data,
      required this.table,
  ...
  _2271.PopupMenuTheme unwrap() => this;
  _2271.PopupMenuTheme get vmObject => this;
  @_fac9.override
...
void loadPopupMenuTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['popupMenuTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPopupMenuTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_2271.PopupMenuThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['popupMenuThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_2271.PopupMenuThemeData>(
          object: _2271.PopupMenuTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_2271.PopupMenuTheme>(boxer: (
      {required _2271.PopupMenuTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPopupMenuTheme(

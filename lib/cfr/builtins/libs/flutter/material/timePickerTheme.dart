...
class VMManagedTimePickerTheme
    extends _36c2.VMManagedBox<_f792.TimePickerTheme> {
  VMManagedTimePickerTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_f792.TimePickerThemeData>(
  ...
  final _f792.TimePickerTheme vmObject;
}

class RTManagedTimePickerTheme extends _f792.TimePickerTheme
    implements _36c2.Box<_f792.TimePickerTheme> {
  RTManagedTimePickerTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _f792.TimePickerThemeData data,
      required this.table,
  ...
  _f792.TimePickerTheme unwrap() => this;
  _f792.TimePickerTheme get vmObject => this;
  @_fac9.override
...
void loadTimePickerTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['timePickerTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedTimePickerTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_f792.TimePickerThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['timePickerThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_f792.TimePickerThemeData>(
          object: _f792.TimePickerTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_f792.TimePickerTheme>(boxer: (
      {required _f792.TimePickerTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTimePickerTheme(

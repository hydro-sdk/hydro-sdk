...
import 'package:flutter/src/material/text_button.dart' as _4290;
...
class VMManagedTextButton extends _36c2.VMManagedBox<_4290.TextButton> {
  VMManagedTextButton(
  ...
  final _4290.TextButton vmObject;
}

class RTManagedTextButton extends _4290.TextButton
    implements _36c2.Box<_4290.TextButton> {
  RTManagedTextButton(
  ...
  _4290.TextButton unwrap() => this;
  _4290.TextButton get vmObject => this;
  @_fac9.override
...
void loadTextButton(
  ...
  table['textButton'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  ...
  table['textButtonIcon'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure? unpackedonFocusChange = luaCallerArguments.length >= 2
        ? luaCallerArguments[1]['onFocusChange']
        : null;
    ...
    _36c2.Closure? unpackedonPressed = luaCallerArguments.length >= 2
        ...
        : null;
    return [
      _36c2.maybeBoxObject<_4290.TextButton>(
          object: _4290.TextButton.icon(
              autofocus: luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['autofocus']
                  : null,
              clipBehavior: _36c2.maybeUnBoxEnum(
  ...
  table['textButtonStyleFrom'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_9bb8.ButtonStyle>(
          object: _4290.TextButton.styleFrom(
  ...
  _36c2.registerBoxer<_4290.TextButton>(boxer: (
      {required _4290.TextButton vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedTextButton(

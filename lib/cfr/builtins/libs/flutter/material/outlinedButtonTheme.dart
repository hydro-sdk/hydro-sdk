...
class VMManagedOutlinedButtonTheme
    extends _36c2.VMManagedBox<_915c.OutlinedButtonTheme> {
  VMManagedOutlinedButtonTheme(
    ...
    table['data'] = _36c2.maybeBoxObject<_915c.OutlinedButtonThemeData>(
  ...
  final _915c.OutlinedButtonTheme vmObject;
}

class RTManagedOutlinedButtonTheme extends _915c.OutlinedButtonTheme
    implements _36c2.Box<_915c.OutlinedButtonTheme> {
  RTManagedOutlinedButtonTheme(
      {_ab4a.Key? key,
      required _e2dc.Widget child,
      required _915c.OutlinedButtonThemeData data,
      required this.table,
  ...
  _915c.OutlinedButtonTheme unwrap() => this;
  _915c.OutlinedButtonTheme get vmObject => this;
  @_fac9.override
...
void loadOutlinedButtonTheme(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['outlinedButtonTheme'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOutlinedButtonTheme(
          ...
          child: _36c2.maybeUnBoxAndBuildArgument<_e2dc.Widget, _fac9.dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          data: _36c2.maybeUnBoxAndBuildArgument<_915c.OutlinedButtonThemeData, _fac9.dynamic>(
              luaCallerArguments.length >= 2
  ...
  table['outlinedButtonThemeOf'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_915c.OutlinedButtonThemeData>(
          object: _915c.OutlinedButtonTheme.of(_36c2.maybeUnBoxAndBuildArgument<
              _e2dc.BuildContext,
              _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
  ...
  _36c2.registerBoxer<_915c.OutlinedButtonTheme>(boxer: (
      {required _915c.OutlinedButtonTheme vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedOutlinedButtonTheme(

...
class VMManagedGravitySimulation extends _36c2.VMManagedBox<_a4aa.GravitySimulation> {VMManagedGravitySimulation({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
void loadGravitySimulation({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'gravitySimulation'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedGravitySimulation(luaCallerArguments  [
1
...
_36c2.registerBoxer<_a4aa.GravitySimulation>(boxer: ({required _a4aa.GravitySimulation vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGravitySimulation(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

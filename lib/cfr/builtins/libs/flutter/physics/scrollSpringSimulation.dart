...
class VMManagedScrollSpringSimulation
    extends _36c2.VMManagedBox<_5917.ScrollSpringSimulation> {
  VMManagedScrollSpringSimulation(
...
class RTManagedScrollSpringSimulation extends _5917.ScrollSpringSimulation
    implements _36c2.Box<_5917.ScrollSpringSimulation> {
  RTManagedScrollSpringSimulation(_5917.SpringDescription spring,
      _fac9.double start, _fac9.double end, _fac9.double velocity,
...
void loadScrollSpringSimulation(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['scrollSpringSimulation'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScrollSpringSimulation(
  ...
  _36c2.registerBoxer<_5917.ScrollSpringSimulation>(boxer: (
      {required _5917.ScrollSpringSimulation vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedScrollSpringSimulation(

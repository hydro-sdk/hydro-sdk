...
class VMManagedDragDownDetails
    extends _36c2.VMManagedBox<_4bc7.DragDownDetails> {
...
class RTManagedDragDownDetails extends _4bc7.DragDownDetails
    implements _36c2.Box<_4bc7.DragDownDetails> {
...
void loadDragDownDetails(
  ...
  table['dragDownDetails'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDragDownDetails(
  ...
  _36c2.registerBoxer<_4bc7.DragDownDetails>(boxer: (
      {required _4bc7.DragDownDetails vmObject,

...
class VMManagedDragGestureRecognizer
    extends VMManagedBox<DragGestureRecognizer> {
  VMManagedDragGestureRecognizer(
    ...
    table['dragStartBehavior'] = DragStartBehavior.values.indexWhere((x) {
    ...
    table['gestureSettings'] = maybeBoxObject<DeviceGestureSettings?>(
        ...
        hydroState: hydroState,
        table: HydroTable());
    table['isFlingGesture'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        vmObject.isFlingGesture(
            maybeUnBoxAndBuildArgument<VelocityEstimate, dynamic>(
  ...
  final DragGestureRecognizer vmObject;
}

class RTManagedDragGestureRecognizer extends DragGestureRecognizer
    implements Box<DragGestureRecognizer> {
  RTManagedDragGestureRecognizer(
      {Object? debugOwner,
      required DragStartBehavior dragStartBehavior,
      PointerDeviceKind? kind,
      Set<PointerDeviceKind>? supportedDevices,
      required velocityTrackerBuilder,
      required this.table,
    ...
    table['minFlingDistance'] = minFlingDistance;
    table['minFlingVelocity'] = minFlingVelocity;
    table['maxFlingVelocity'] = maxFlingVelocity;
    table['debugOwner'] = maybeBoxObject<Object?>(
  ...
  DragGestureRecognizer unwrap() => this;
  DragGestureRecognizer get vmObject => this;
  @override
  bool isFlingGesture(estimate, kind) {
    Closure closure = table["isFlingGesture"];
...
void loadDragGestureRecognizer(
  ...
  table['dragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    Closure unpackedvelocityTrackerBuilder = luaCallerArguments.length >= 2
    ...
    return [
      RTManagedDragGestureRecognizer(
          ...
          velocityTrackerBuilder: (event) =>
              maybeUnBoxAndBuildArgument<VelocityTracker, dynamic>(
  ...
  registerBoxer<DragGestureRecognizer>(boxer: (
      {required DragGestureRecognizer vmObject,

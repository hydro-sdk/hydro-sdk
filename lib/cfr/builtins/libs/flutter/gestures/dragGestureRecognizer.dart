...
class VMManagedDragGestureRecognizer
    extends _36c2.VMManagedBox<_deb0.DragGestureRecognizer> {
  VMManagedDragGestureRecognizer(
...
class RTManagedDragGestureRecognizer extends _deb0.DragGestureRecognizer
  ...
  RTManagedDragGestureRecognizer(
      ...
      required _10cb.VelocityTracker Function(_0e77.PointerEvent event)
...
void loadDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['dragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    _36c2.Closure unpackedvelocityTrackerBuilder =
        luaCallerArguments.length >= 2
            ? luaCallerArguments[1]['velocityTrackerBuilder']
            : null;
    return [
      RTManagedDragGestureRecognizer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          debugOwner: _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
              luaCallerArguments.length >= 2
          ...
          velocityTrackerBuilder: (event) =>
              _36c2.maybeUnBoxAndBuildArgument<_10cb.VelocityTracker, _fac9.dynamic>(
                  unpackedvelocityTrackerBuilder.dispatch(
  ...
  _36c2.registerBoxer<_deb0.DragGestureRecognizer>(boxer: (
      {required _deb0.DragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDragGestureRecognizer(

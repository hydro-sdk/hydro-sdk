...
import 'package:flutter/src/gestures/monodrag.dart' as _deb0;
...
class VMManagedDragGestureRecognizer extends _36c2.VMManagedBox<_deb0.DragGestureRecognizer> {VMManagedDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
return [vmObject.isFlingGesture(_36c2.maybeUnBoxAndBuildArgument<_10cb.VelocityEstimate, _fac9.dynamic>(luaCallerArguments  [
1
...
table  [
'isPointerAllowed'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isPointerAllowed(_36c2.maybeUnBoxAndBuildArgument<_0e77.PointerEvent, _fac9.dynamic>(luaCallerArguments  [
1
...
final _deb0.DragGestureRecognizer vmObject;

 }

class RTManagedDragGestureRecognizer extends _deb0.DragGestureRecognizer implements _36c2.Box<_deb0.DragGestureRecognizer> {RTManagedDragGestureRecognizer({_fac9.Object? debugOwner, required _02d2.DragStartBehavior dragStartBehavior, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required _10cb.VelocityTracker Function(_0e77.PointerEvent event) velocityTrackerBuilder, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,dragStartBehavior: dragStartBehavior,kind: kind,supportedDevices: supportedDevices,velocityTrackerBuilder: velocityTrackerBuilder) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'minFlingDistance'
] = _36c2.maybeBoxObject(object: minFlingDistance, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'minFlingVelocity'
] = _36c2.maybeBoxObject(object: minFlingVelocity, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'maxFlingVelocity'
] = _36c2.maybeBoxObject(object: maxFlingVelocity, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugOwner'
...
table['_dart_isFlingGesture'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [
    _36c2.maybeBoxObject(
        object: isFlingGesture(
            _36c2.maybeUnBoxAndBuildArgument<_10cb.VelocityEstimate,
...
@_fac9.override _fac9.bool isFlingGesture(estimate, kind) { 
_36c2.Closure closure = table["isFlingGesture"];
...
void loadDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'dragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



_36c2.Closure unpackedvelocityTrackerBuilder=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'velocityTrackerBuilder'
] : null;
return  [RTManagedDragGestureRecognizer(table: luaCallerArguments  [
0
...
'kind'
] : null), supportedDevices: _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.PointerDeviceKind>?, _a643.PointerDeviceKind>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'supportedDevices'
] : null, parentState: hydroState), velocityTrackerBuilder: (event) => _36c2.maybeUnBoxAndBuildArgument<_10cb.VelocityTracker, _fac9.dynamic>(unpackedvelocityTrackerBuilder.dispatch([luaCallerArguments[0],event],parentState:hydroState,)[0], parentState: hydroState))]; } );
_36c2.registerBoxer<_deb0.DragGestureRecognizer>(boxer: ({required _deb0.DragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

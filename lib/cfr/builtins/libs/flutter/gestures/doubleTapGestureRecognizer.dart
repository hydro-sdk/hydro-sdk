...
class VMManagedDoubleTapGestureRecognizer
    extends _36c2.VMManagedBox<_2713.DoubleTapGestureRecognizer> {
...
void loadDoubleTapGestureRecognizer(
  ...
  table['doubleTapGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDoubleTapGestureRecognizer(
  ...
  _36c2.registerBoxer<_2713.DoubleTapGestureRecognizer>(boxer: (
      {required _2713.DoubleTapGestureRecognizer vmObject,

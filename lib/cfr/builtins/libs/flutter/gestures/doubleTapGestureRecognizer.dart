...
class VMManagedDoubleTapGestureRecognizer extends _36c2.VMManagedBox<_2713.DoubleTapGestureRecognizer> {VMManagedDoubleTapGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _2713.DoubleTapGestureRecognizer vmObject;

 }

class RTManagedDoubleTapGestureRecognizer extends _2713.DoubleTapGestureRecognizer implements _36c2.Box<_2713.DoubleTapGestureRecognizer> {RTManagedDoubleTapGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadDoubleTapGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'doubleTapGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedDoubleTapGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2713.DoubleTapGestureRecognizer>(boxer: ({required _2713.DoubleTapGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDoubleTapGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

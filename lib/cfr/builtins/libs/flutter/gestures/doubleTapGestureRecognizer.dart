...
class VMManagedDoubleTapGestureRecognizer
    extends VMManagedBox<DoubleTapGestureRecognizer> {
  VMManagedDoubleTapGestureRecognizer(
  ...
  final DoubleTapGestureRecognizer vmObject;
}

class RTManagedDoubleTapGestureRecognizer extends DoubleTapGestureRecognizer
    implements Box<DoubleTapGestureRecognizer> {
  ...
  DoubleTapGestureRecognizer unwrap() => this;
  DoubleTapGestureRecognizer get vmObject => this;
  @override
...
void loadDoubleTapGestureRecognizer(
    {required HydroState hydroState, required HydroTable table}) {
  table['doubleTapGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedDoubleTapGestureRecognizer(
  ...
  registerBoxer<DoubleTapGestureRecognizer>(boxer: (
      {required DoubleTapGestureRecognizer vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedDoubleTapGestureRecognizer(

...
class VMManagedPointerCancelEvent
    extends _36c2.VMManagedBox<_0e77.PointerCancelEvent> {
  VMManagedPointerCancelEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerCancelEvent>(
...
class RTManagedPointerCancelEvent extends _0e77.PointerCancelEvent
  ...
  @_fac9.override
  _0e77.PointerCancelEvent transformed(transform) {
  ...
  @_fac9.override
  _0e77.PointerCancelEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerCancelEvent(
  ...
  table['pointerCancelEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerCancelEvent(
  ...
  _36c2.registerBoxer<_0e77.PointerCancelEvent>(boxer: (
      {required _0e77.PointerCancelEvent vmObject,

...
class VMManagedPointerMoveEvent
    extends _36c2.VMManagedBox<_0e77.PointerMoveEvent> {
  VMManagedPointerMoveEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerMoveEvent>(
...
class RTManagedPointerMoveEvent extends _0e77.PointerMoveEvent
    implements _36c2.Box<_0e77.PointerMoveEvent> {
  RTManagedPointerMoveEvent(
  ...
  @_fac9.override
  _0e77.PointerMoveEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerMoveEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerMoveEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerMoveEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pointerMoveEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerMoveEvent(
  ...
  _36c2.registerBoxer<_0e77.PointerMoveEvent>(boxer: (
      {required _0e77.PointerMoveEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPointerMoveEvent(

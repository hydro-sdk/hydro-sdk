...
class VMManagedPointerMoveEvent extends VMManagedBox<PointerMoveEvent> {
  VMManagedPointerMoveEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerMoveEvent>(
  ...
  final PointerMoveEvent vmObject;
}

class RTManagedPointerMoveEvent extends PointerMoveEvent
    implements Box<PointerMoveEvent> {
  ...
  PointerMoveEvent unwrap() => this;
  PointerMoveEvent get vmObject => this;
  @override
  PointerMoveEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerMoveEvent, dynamic>(
...
void loadPointerMoveEvent(
  ...
  registerBoxer<PointerMoveEvent>(boxer: (
      {required PointerMoveEvent vmObject,

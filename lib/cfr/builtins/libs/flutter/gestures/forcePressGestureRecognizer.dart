...
class VMManagedForcePressGestureRecognizer extends _36c2.VMManagedBox<_6dde.ForcePressGestureRecognizer> {VMManagedForcePressGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'startPressure'
] = vmObject.startPressure;
table  [
'peakPressure'
] = vmObject.peakPressure;
table  [
'debugOwner'
...
final _6dde.ForcePressGestureRecognizer vmObject;

 }

class RTManagedForcePressGestureRecognizer extends _6dde.ForcePressGestureRecognizer implements _36c2.Box<_6dde.ForcePressGestureRecognizer> {RTManagedForcePressGestureRecognizer({_fac9.Object? debugOwner, required _fac9.double Function(_fac9.double pressureMin, _fac9.double pressureMax, _fac9.double pressure) interpolation, _a643.PointerDeviceKind? kind, required _fac9.double peakPressure, required _fac9.double startPressure, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,interpolation: interpolation,kind: kind,peakPressure: peakPressure,startPressure: startPressure,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'startPressure'
] = _36c2.maybeBoxObject(object: this.startPressure, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'peakPressure'
] = _36c2.maybeBoxObject(object: this.peakPressure, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugOwner'
...
_6dde.ForcePressGestureRecognizer unwrap() => this;
_6dde.ForcePressGestureRecognizer get vmObject => this;
...
void loadForcePressGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'forcePressGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
_36c2.Closure unpackedinterpolation=luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'interpolation'
] : null;
...
return  [RTManagedForcePressGestureRecognizer(table: luaCallerArguments  [
0
...
'debugOwner'
] : null, parentState: hydroState), interpolation: (pressureMin, pressureMax, pressure) => unpackedinterpolation.dispatch([luaCallerArguments[0],pressureMin,pressureMax,pressure],parentState:hydroState,)[0]?.toDouble(), kind: _36c2.maybeUnBoxEnum(values: _a643.PointerDeviceKind.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'kind'
] : null), peakPressure: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'peakPressure'
] : null?.toDouble(), startPressure: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'startPressure'
...
_36c2.registerBoxer<_6dde.ForcePressGestureRecognizer>(boxer: ({required _6dde.ForcePressGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedForcePressGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

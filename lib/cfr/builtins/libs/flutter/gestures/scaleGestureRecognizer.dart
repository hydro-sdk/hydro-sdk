...
class VMManagedScaleGestureRecognizer
    extends VMManagedBox<ScaleGestureRecognizer> {
  ...
  final ScaleGestureRecognizer vmObject;
}

class RTManagedScaleGestureRecognizer extends ScaleGestureRecognizer
    implements Box<ScaleGestureRecognizer> {
  ...
  ScaleGestureRecognizer unwrap() => this;
  ScaleGestureRecognizer get vmObject => this;
  @override
...
void loadScaleGestureRecognizer(
  ...
  registerBoxer<ScaleGestureRecognizer>(boxer: (
      {required ScaleGestureRecognizer vmObject,

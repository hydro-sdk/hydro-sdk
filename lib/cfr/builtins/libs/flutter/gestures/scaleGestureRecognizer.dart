...
class VMManagedScaleGestureRecognizer extends _36c2.VMManagedBox<_bb2d.ScaleGestureRecognizer> {VMManagedScaleGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedScaleGestureRecognizer extends _bb2d.ScaleGestureRecognizer implements _36c2.Box<_bb2d.ScaleGestureRecognizer> {RTManagedScaleGestureRecognizer({_fac9.Object? debugOwner, required _02d2.DragStartBehavior dragStartBehavior, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,dragStartBehavior: dragStartBehavior,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadScaleGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'scaleGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedScaleGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_bb2d.ScaleGestureRecognizer>(boxer: ({required _bb2d.ScaleGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedScaleGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

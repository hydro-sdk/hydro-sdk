...
class VMManagedVerticalMultiDragGestureRecognizer
    extends VMManagedBox<VerticalMultiDragGestureRecognizer> {
  ...
  final VerticalMultiDragGestureRecognizer vmObject;
}

class RTManagedVerticalMultiDragGestureRecognizer
    extends VerticalMultiDragGestureRecognizer
    implements Box<VerticalMultiDragGestureRecognizer> {
  ...
  VerticalMultiDragGestureRecognizer unwrap() => this;
  VerticalMultiDragGestureRecognizer get vmObject => this;
  @override
...
void loadVerticalMultiDragGestureRecognizer(
  ...
  table['verticalMultiDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedVerticalMultiDragGestureRecognizer(
  ...
  registerBoxer<VerticalMultiDragGestureRecognizer>(boxer: (
      {required VerticalMultiDragGestureRecognizer vmObject,

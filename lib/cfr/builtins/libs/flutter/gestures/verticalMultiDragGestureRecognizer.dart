...
class VMManagedVerticalMultiDragGestureRecognizer extends _36c2.VMManagedBox<_d5f6.VerticalMultiDragGestureRecognizer> {VMManagedVerticalMultiDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d5f6.VerticalMultiDragGestureRecognizer vmObject;

 }

class RTManagedVerticalMultiDragGestureRecognizer extends _d5f6.VerticalMultiDragGestureRecognizer implements _36c2.Box<_d5f6.VerticalMultiDragGestureRecognizer> {RTManagedVerticalMultiDragGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d5f6.VerticalMultiDragGestureRecognizer unwrap() => this;
_d5f6.VerticalMultiDragGestureRecognizer get vmObject => this;
...
void loadVerticalMultiDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'verticalMultiDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedVerticalMultiDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d5f6.VerticalMultiDragGestureRecognizer>(boxer: ({required _d5f6.VerticalMultiDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedVerticalMultiDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedVerticalMultiDragGestureRecognizer
    extends _36c2.VMManagedBox<_d5f6.VerticalMultiDragGestureRecognizer> {
  VMManagedVerticalMultiDragGestureRecognizer(
...
void loadVerticalMultiDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['verticalMultiDragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedVerticalMultiDragGestureRecognizer(
  ...
  _36c2.registerBoxer<_d5f6.VerticalMultiDragGestureRecognizer>(boxer: (
      {required _d5f6.VerticalMultiDragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedVerticalMultiDragGestureRecognizer(

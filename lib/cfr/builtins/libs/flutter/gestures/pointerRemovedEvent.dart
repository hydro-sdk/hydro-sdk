...
class VMManagedPointerRemovedEvent
    extends _36c2.VMManagedBox<_0e77.PointerRemovedEvent> {
  VMManagedPointerRemovedEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerRemovedEvent>(
...
class RTManagedPointerRemovedEvent extends _0e77.PointerRemovedEvent
    implements _36c2.Box<_0e77.PointerRemovedEvent> {
  RTManagedPointerRemovedEvent(
      ...
      _0e77.PointerRemovedEvent? original,
  ...
  @_fac9.override
  _0e77.PointerRemovedEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerRemovedEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerRemovedEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerRemovedEvent(
  ...
  table['pointerRemovedEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerRemovedEvent(
          ...
          obscured: luaCallerArguments.length >= 2
              ...
              : null,
          original:
              _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerRemovedEvent?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
  ...
  _36c2.registerBoxer<_0e77.PointerRemovedEvent>(boxer: (
      {required _0e77.PointerRemovedEvent vmObject,

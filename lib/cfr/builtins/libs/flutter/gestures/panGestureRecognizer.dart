...
class VMManagedPanGestureRecognizer
    extends _36c2.VMManagedBox<_deb0.PanGestureRecognizer> {
  VMManagedPanGestureRecognizer(
...
class RTManagedPanGestureRecognizer extends _deb0.PanGestureRecognizer
    implements _36c2.Box<_deb0.PanGestureRecognizer> {
  RTManagedPanGestureRecognizer(
...
void loadPanGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['panGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPanGestureRecognizer(
  ...
  _36c2.registerBoxer<_deb0.PanGestureRecognizer>(boxer: (
      {required _deb0.PanGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPanGestureRecognizer(

...
class VMManagedPanGestureRecognizer extends VMManagedBox<PanGestureRecognizer> {
  ...
  final PanGestureRecognizer vmObject;
}

class RTManagedPanGestureRecognizer extends PanGestureRecognizer
    implements Box<PanGestureRecognizer> {
  ...
  PanGestureRecognizer unwrap() => this;
  PanGestureRecognizer get vmObject => this;
  @override
...
void loadPanGestureRecognizer(
  ...
  registerBoxer<PanGestureRecognizer>(boxer: (
      {required PanGestureRecognizer vmObject,

...
class VMManagedPanGestureRecognizer extends _36c2.VMManagedBox<_deb0.PanGestureRecognizer> {VMManagedPanGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _deb0.PanGestureRecognizer vmObject;

 }

class RTManagedPanGestureRecognizer extends _deb0.PanGestureRecognizer implements _36c2.Box<_deb0.PanGestureRecognizer> {RTManagedPanGestureRecognizer({_fac9.Object? debugOwner, required this.table, required this.hydroState}) : super(debugOwner: debugOwner) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_deb0.PanGestureRecognizer unwrap() => this;
_deb0.PanGestureRecognizer get vmObject => this;
...
void loadPanGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'panGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedPanGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_deb0.PanGestureRecognizer>(boxer: ({required _deb0.PanGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedPanGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

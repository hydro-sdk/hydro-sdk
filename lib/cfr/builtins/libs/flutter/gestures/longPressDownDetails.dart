...
class VMManagedLongPressDownDetails extends _36c2.VMManagedBox<_0586.LongPressDownDetails> {VMManagedLongPressDownDetails({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLongPressDownDetails extends _0586.LongPressDownDetails implements _36c2.Box<_0586.LongPressDownDetails> {RTManagedLongPressDownDetails({required _a643.Offset globalPosition, _a643.PointerDeviceKind? kind, _a643.Offset? localPosition, required this.table, required this.hydroState}) : super(globalPosition: globalPosition,kind: kind,localPosition: localPosition) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLongPressDownDetails({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'longPressDownDetails'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedLongPressDownDetails(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_0586.LongPressDownDetails>(boxer: ({required _0586.LongPressDownDetails vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLongPressDownDetails(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

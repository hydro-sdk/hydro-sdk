...
class VMManagedPointerEvent extends _36c2.VMManagedBox<_0e77.PointerEvent> {
  VMManagedPointerEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_0e77.PointerEvent>(
...
class RTManagedPointerEvent extends _0e77.PointerEvent
    implements _36c2.Box<_0e77.PointerEvent> {
  RTManagedPointerEvent(
      ...
      _0e77.PointerEvent? original,
      required _fac9.int platformData,
    ...
    table['down'] = _36c2.maybeBoxObject(
        object: this.down, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _0e77.PointerEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerEvent, _fac9.dynamic>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

  @_fac9.override
  _0e77.PointerEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerEvent(
  ...
  table['pointerEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerEvent(
          ...
          original:
              _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerEvent?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['original'] : null,
                  parentState: hydroState),
          platformData: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['platformData'] : null,
          pointer: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['pointer'] : null,
          position: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['position'] : null, parentState: hydroState),
          pressure: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['pressure'] : null?.toDouble(),
          pressureMax: luaCallerArguments.length >= 2 ? luaCallerArguments[1]['pressureMax'] : null?.toDouble(),
  ...
  table['pointerEventTransformPosition'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_a643.Offset>(
          object: _0e77.PointerEvent.transformPosition(
              _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState),
  ...
  table['pointerEventTransformDeltaViaPositions'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_a643.Offset>(
          object: _0e77.PointerEvent.transformDeltaViaPositions(
              transformedEndPosition:
                  _36c2.maybeUnBoxAndBuildArgument<_a643.Offset?, _fac9.dynamic>(
                      luaCallerArguments.length >= 2
                          ...
                          : null,
                      parentState: hydroState),
              transform: _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['transform'] : null,
                  parentState: hydroState),
              untransformedDelta:
                  _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(
                      luaCallerArguments.length >= 2 ? luaCallerArguments[1]['untransformedDelta'] : null,
                      parentState: hydroState),
              untransformedEndPosition: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['untransformedEndPosition'] : null, parentState: hydroState)),
          hydroState: hydroState,
          table: _36c2.HydroTable()),
    ];
  });
  table['pointerEventRemovePerspectiveTransform'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_db98.Matrix4>(
          object: _0e77.PointerEvent.removePerspectiveTransform(
              _36c2.maybeUnBoxAndBuildArgument<_db98.Matrix4, _fac9.dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  _36c2.registerBoxer<_0e77.PointerEvent>(boxer: (
      {required _0e77.PointerEvent vmObject,

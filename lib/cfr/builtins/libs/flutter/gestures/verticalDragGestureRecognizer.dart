...
class VMManagedVerticalDragGestureRecognizer
    extends VMManagedBox<VerticalDragGestureRecognizer> {
  ...
  final VerticalDragGestureRecognizer vmObject;
}

class RTManagedVerticalDragGestureRecognizer
    extends VerticalDragGestureRecognizer
    implements Box<VerticalDragGestureRecognizer> {
  ...
  VerticalDragGestureRecognizer unwrap() => this;
  VerticalDragGestureRecognizer get vmObject => this;
  @override
...
void loadVerticalDragGestureRecognizer(
  ...
  table['verticalDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedVerticalDragGestureRecognizer(
  ...
  registerBoxer<VerticalDragGestureRecognizer>(boxer: (
      {required VerticalDragGestureRecognizer vmObject,

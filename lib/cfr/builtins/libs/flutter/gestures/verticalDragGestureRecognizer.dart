...
class VMManagedVerticalDragGestureRecognizer extends _36c2.VMManagedBox<_deb0.VerticalDragGestureRecognizer> {VMManagedVerticalDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _deb0.VerticalDragGestureRecognizer vmObject;

 }

class RTManagedVerticalDragGestureRecognizer extends _deb0.VerticalDragGestureRecognizer implements _36c2.Box<_deb0.VerticalDragGestureRecognizer> {RTManagedVerticalDragGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_deb0.VerticalDragGestureRecognizer unwrap() => this;
_deb0.VerticalDragGestureRecognizer get vmObject => this;
...
void loadVerticalDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'verticalDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedVerticalDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_deb0.VerticalDragGestureRecognizer>(boxer: ({required _deb0.VerticalDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedVerticalDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

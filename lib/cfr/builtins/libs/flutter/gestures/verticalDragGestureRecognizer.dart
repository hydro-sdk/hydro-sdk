...
class VMManagedVerticalDragGestureRecognizer
    extends _36c2.VMManagedBox<_deb0.VerticalDragGestureRecognizer> {
  VMManagedVerticalDragGestureRecognizer(
...
class RTManagedVerticalDragGestureRecognizer
    extends _deb0.VerticalDragGestureRecognizer
    implements _36c2.Box<_deb0.VerticalDragGestureRecognizer> {
  RTManagedVerticalDragGestureRecognizer(
...
void loadVerticalDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['verticalDragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedVerticalDragGestureRecognizer(
  ...
  _36c2.registerBoxer<_deb0.VerticalDragGestureRecognizer>(boxer: (
      {required _deb0.VerticalDragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedVerticalDragGestureRecognizer(

...
class VMManagedLongPressEndDetails extends _36c2.VMManagedBox<_0586.LongPressEndDetails> {VMManagedLongPressEndDetails({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLongPressEndDetails extends _0586.LongPressEndDetails implements _36c2.Box<_0586.LongPressEndDetails> {RTManagedLongPressEndDetails({required _a643.Offset globalPosition, _a643.Offset? localPosition, required _10cb.Velocity velocity, required this.table, required this.hydroState}) : super(globalPosition: globalPosition,localPosition: localPosition,velocity: velocity) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLongPressEndDetails({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'longPressEndDetails'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedLongPressEndDetails(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_0586.LongPressEndDetails>(boxer: ({required _0586.LongPressEndDetails vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLongPressEndDetails(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

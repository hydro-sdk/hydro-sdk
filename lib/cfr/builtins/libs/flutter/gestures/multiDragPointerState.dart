...
class VMManagedMultiDragPointerState
    extends _36c2.VMManagedBox<_d5f6.MultiDragPointerState> {
  VMManagedMultiDragPointerState(
    ...
    table['initialPosition'] = _36c2.maybeBoxObject<_a643.Offset>(
    ...
    table['getPendingDelta'] = _36c2.makeLuaDartFunc(
...
class RTManagedMultiDragPointerState extends _d5f6.MultiDragPointerState
    implements _36c2.Box<_d5f6.MultiDragPointerState> {
  RTManagedMultiDragPointerState(
      _a643.Offset initialPosition$,
    ...
    table['gestureSettings'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['initialPosition'] = _36c2.maybeBoxObject(
    ...
    table['_dart_getPendingDelta'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_checkForResolutionAfterMove'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.checkForResolutionAfterMove();
      return [];
    });
    table['_dart_accepted'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_rejected'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.rejected();
      return [];
    });
...
void loadMultiDragPointerState(
  ...
  table['multiDragPointerState'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMultiDragPointerState(
          ...
          _36c2.maybeUnBoxAndBuildArgument<_352d.DeviceGestureSettings?,
              _fac9.dynamic>(luaCallerArguments[3], parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  _36c2.registerBoxer<_d5f6.MultiDragPointerState>(boxer: (
      {required _d5f6.MultiDragPointerState vmObject,

...
class VMManagedPointerSignalEvent
    extends _36c2.VMManagedBox<_0e77.PointerSignalEvent> {
...
class RTManagedPointerSignalEvent extends _0e77.PointerSignalEvent
    implements _36c2.Box<_0e77.PointerSignalEvent> {
...
void loadPointerSignalEvent(
  ...
  table['pointerSignalEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerSignalEvent(
  ...
  _36c2.registerBoxer<_0e77.PointerSignalEvent>(boxer: (
      {required _0e77.PointerSignalEvent vmObject,

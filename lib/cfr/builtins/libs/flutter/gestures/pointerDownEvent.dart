...
class VMManagedPointerDownEvent extends VMManagedBox<PointerDownEvent> {
  VMManagedPointerDownEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerDownEvent>(
  ...
  final PointerDownEvent vmObject;
}

class RTManagedPointerDownEvent extends PointerDownEvent
    implements Box<PointerDownEvent> {
  ...
  PointerDownEvent unwrap() => this;
  PointerDownEvent get vmObject => this;
  @override
  PointerDownEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerDownEvent, dynamic>(
...
void loadPointerDownEvent(
  ...
  registerBoxer<PointerDownEvent>(boxer: (
      {required PointerDownEvent vmObject,

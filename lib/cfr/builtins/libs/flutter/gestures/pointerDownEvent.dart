...
class VMManagedPointerDownEvent
    extends _36c2.VMManagedBox<_0e77.PointerDownEvent> {
  VMManagedPointerDownEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerDownEvent>(
...
class RTManagedPointerDownEvent extends _0e77.PointerDownEvent
    implements _36c2.Box<_0e77.PointerDownEvent> {
  RTManagedPointerDownEvent(
  ...
  @_fac9.override
  _0e77.PointerDownEvent transformed(transform) {
  ...
  @_fac9.override
  _0e77.PointerDownEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerDownEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pointerDownEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerDownEvent(
          ...
          pointer: luaCallerArguments.length >= 2
              ...
              : null,
          position: _36c2.maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['position'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_0e77.PointerDownEvent>(boxer: (
      {required _0e77.PointerDownEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPointerDownEvent(

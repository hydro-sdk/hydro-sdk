...
class VMManagedPointerEnterEvent
    extends _36c2.VMManagedBox<_0e77.PointerEnterEvent> {
  VMManagedPointerEnterEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerEnterEvent>(
...
class RTManagedPointerEnterEvent extends _0e77.PointerEnterEvent
    implements _36c2.Box<_0e77.PointerEnterEvent> {
  RTManagedPointerEnterEvent(
  ...
  @_fac9.override
  _0e77.PointerEnterEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerEnterEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerEnterEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerEnterEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pointerEnterEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerEnterEvent(
  ...
  table['pointerEnterEventFromMouseEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_0e77.PointerEnterEvent>(
          object: _0e77.PointerEnterEvent.fromMouseEvent(_36c2
  ...
  _36c2.registerBoxer<_0e77.PointerEnterEvent>(boxer: (
      {required _0e77.PointerEnterEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPointerEnterEvent(

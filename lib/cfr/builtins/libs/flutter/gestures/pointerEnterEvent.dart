...
class VMManagedPointerEnterEvent extends VMManagedBox<PointerEnterEvent> {
  VMManagedPointerEnterEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerEnterEvent>(
  ...
  final PointerEnterEvent vmObject;
}

class RTManagedPointerEnterEvent extends PointerEnterEvent
    implements Box<PointerEnterEvent> {
  ...
  PointerEnterEvent unwrap() => this;
  PointerEnterEvent get vmObject => this;
  @override
  PointerEnterEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerEnterEvent, dynamic>(
...
void loadPointerEnterEvent(
  ...
  table['pointerEnterEventFromMouseEvent'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<PointerEnterEvent>(
          object: PointerEnterEvent.fromMouseEvent(
  ...
  registerBoxer<PointerEnterEvent>(boxer: (
      {required PointerEnterEvent vmObject,

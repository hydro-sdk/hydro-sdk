...
class VMManagedEagerGestureRecognizer extends _36c2.VMManagedBox<_c2bb.EagerGestureRecognizer> {VMManagedEagerGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedEagerGestureRecognizer extends _c2bb.EagerGestureRecognizer implements _36c2.Box<_c2bb.EagerGestureRecognizer> {RTManagedEagerGestureRecognizer({_a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'debugOwner'
] = _36c2.maybeBoxObject(object: debugOwner, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'gestureSettings'
...
void loadEagerGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'eagerGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedEagerGestureRecognizer(table: luaCallerArguments  [
0
], hydroState: hydroState, kind: _36c2.maybeUnBoxEnum(values: _a643.PointerDeviceKind.values, boxedEnum: luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'kind'
...
_36c2.registerBoxer<_c2bb.EagerGestureRecognizer>(boxer: ({required _c2bb.EagerGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedEagerGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedBaseTapGestureRecognizer
    extends _36c2.VMManagedBox<_1275.BaseTapGestureRecognizer> {
...
class RTManagedBaseTapGestureRecognizer extends _1275.BaseTapGestureRecognizer
    implements _36c2.Box<_1275.BaseTapGestureRecognizer> {
...
void loadBaseTapGestureRecognizer(
  ...
  table['baseTapGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedBaseTapGestureRecognizer(
  ...
  _36c2.registerBoxer<_1275.BaseTapGestureRecognizer>(boxer: (
      {required _1275.BaseTapGestureRecognizer vmObject,

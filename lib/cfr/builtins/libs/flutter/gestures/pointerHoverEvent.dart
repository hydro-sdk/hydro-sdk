...
class VMManagedPointerHoverEvent extends VMManagedBox<PointerHoverEvent> {
  VMManagedPointerHoverEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerHoverEvent>(
  ...
  final PointerHoverEvent vmObject;
}

class RTManagedPointerHoverEvent extends PointerHoverEvent
    implements Box<PointerHoverEvent> {
  ...
  PointerHoverEvent unwrap() => this;
  PointerHoverEvent get vmObject => this;
  @override
  PointerHoverEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerHoverEvent, dynamic>(
...
void loadPointerHoverEvent(
  ...
  registerBoxer<PointerHoverEvent>(boxer: (
      {required PointerHoverEvent vmObject,

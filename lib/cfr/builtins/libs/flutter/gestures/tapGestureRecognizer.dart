...
class VMManagedTapGestureRecognizer extends VMManagedBox<TapGestureRecognizer> {
  ...
  final TapGestureRecognizer vmObject;
}

class RTManagedTapGestureRecognizer extends TapGestureRecognizer
    implements Box<TapGestureRecognizer> {
  ...
  TapGestureRecognizer unwrap() => this;
  TapGestureRecognizer get vmObject => this;
  @override
...
void loadTapGestureRecognizer(
  ...
  registerBoxer<TapGestureRecognizer>(boxer: (
      {required TapGestureRecognizer vmObject,

...
class VMManagedPointerSignalResolver
    extends _36c2.VMManagedBox<_cfcd.PointerSignalResolver> {
  VMManagedPointerSignalResolver(
    ...
    table['register'] = _36c2.makeLuaDartFunc(
      ...
      vmObject.register(
          _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerSignalEvent,
...
class RTManagedPointerSignalResolver extends _cfcd.PointerSignalResolver
    implements _36c2.Box<_cfcd.PointerSignalResolver> {
  RTManagedPointerSignalResolver(
    ...
    table['_dart_resolve'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      super.resolve(_36c2.maybeUnBoxAndBuildArgument<_0e77.PointerSignalEvent,
          _fac9.dynamic>(luaCallerArguments[1], parentState: hydroState));
      return [];
    });
  }
...
void loadPointerSignalResolver(
  ...
  table['pointerSignalResolver'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerSignalResolver(
  ...
  _36c2.registerBoxer<_cfcd.PointerSignalResolver>(boxer: (
      {required _cfcd.PointerSignalResolver vmObject,

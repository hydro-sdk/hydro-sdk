...
class VMManagedGestureRecognizer
    extends _36c2.VMManagedBox<_02d2.GestureRecognizer> {
  VMManagedGestureRecognizer(
...
class RTManagedGestureRecognizer extends _02d2.GestureRecognizer
    implements _36c2.Box<_02d2.GestureRecognizer> {
  RTManagedGestureRecognizer(
...
void loadGestureRecognizer(
  ...
  table['gestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedGestureRecognizer(
  ...
  _36c2.registerBoxer<_02d2.GestureRecognizer>(boxer: (
      {required _02d2.GestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedGestureRecognizer(

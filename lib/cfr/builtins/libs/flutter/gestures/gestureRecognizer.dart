...
class VMManagedGestureRecognizer extends VMManagedBox<GestureRecognizer> {
  ...
  final GestureRecognizer vmObject;
}

class RTManagedGestureRecognizer extends GestureRecognizer
    implements Box<GestureRecognizer> {
  RTManagedGestureRecognizer(
    ...
    table['_dart_acceptGesture'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      acceptGesture(luaCallerArguments[1]);
      return [];
    });
    table['_dart_rejectGesture'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      rejectGesture(luaCallerArguments[1]);
      return [];
    });
  ...
  GestureRecognizer unwrap() => this;
  GestureRecognizer get vmObject => this;
  @override
...
void loadGestureRecognizer(
  ...
  registerBoxer<GestureRecognizer>(boxer: (
      {required GestureRecognizer vmObject,

...
class VMManagedGestureRecognizer extends _36c2.VMManagedBox<_02d2.GestureRecognizer> {VMManagedGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _02d2.GestureRecognizer vmObject;

 }

class RTManagedGestureRecognizer extends _02d2.GestureRecognizer implements _36c2.Box<_02d2.GestureRecognizer> {RTManagedGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_acceptGesture'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  acceptGesture(_36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
table['_dart_rejectGesture'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  rejectGesture(_36c2.maybeUnBoxAndBuildArgument<_fac9.int, _fac9.dynamic>(
      luaCallerArguments[1],
      parentState: hydroState));
  return [];
});
...
_02d2.GestureRecognizer unwrap() => this;
_02d2.GestureRecognizer get vmObject => this;
...
void loadGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'gestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_02d2.GestureRecognizer>(boxer: ({required _02d2.GestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

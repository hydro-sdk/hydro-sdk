...
class VMManagedHorizontalMultiDragGestureRecognizer
    extends VMManagedBox<HorizontalMultiDragGestureRecognizer> {
  ...
  final HorizontalMultiDragGestureRecognizer vmObject;
}

class RTManagedHorizontalMultiDragGestureRecognizer
    extends HorizontalMultiDragGestureRecognizer
    implements Box<HorizontalMultiDragGestureRecognizer> {
  ...
  HorizontalMultiDragGestureRecognizer unwrap() => this;
  HorizontalMultiDragGestureRecognizer get vmObject => this;
  @override
...
void loadHorizontalMultiDragGestureRecognizer(
  ...
  table['horizontalMultiDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedHorizontalMultiDragGestureRecognizer(
  ...
  registerBoxer<HorizontalMultiDragGestureRecognizer>(boxer: (
      {required HorizontalMultiDragGestureRecognizer vmObject,

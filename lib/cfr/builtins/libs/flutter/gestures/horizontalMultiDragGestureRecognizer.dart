...
class VMManagedHorizontalMultiDragGestureRecognizer extends _36c2.VMManagedBox<_d5f6.HorizontalMultiDragGestureRecognizer> {VMManagedHorizontalMultiDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d5f6.HorizontalMultiDragGestureRecognizer vmObject;

 }

class RTManagedHorizontalMultiDragGestureRecognizer extends _d5f6.HorizontalMultiDragGestureRecognizer implements _36c2.Box<_d5f6.HorizontalMultiDragGestureRecognizer> {RTManagedHorizontalMultiDragGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d5f6.HorizontalMultiDragGestureRecognizer unwrap() => this;
_d5f6.HorizontalMultiDragGestureRecognizer get vmObject => this;
...
void loadHorizontalMultiDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'horizontalMultiDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedHorizontalMultiDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d5f6.HorizontalMultiDragGestureRecognizer>(boxer: ({required _d5f6.HorizontalMultiDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHorizontalMultiDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

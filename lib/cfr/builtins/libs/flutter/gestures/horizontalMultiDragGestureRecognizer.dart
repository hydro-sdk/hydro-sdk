...
class VMManagedHorizontalMultiDragGestureRecognizer
    extends _36c2.VMManagedBox<_d5f6.HorizontalMultiDragGestureRecognizer> {
  VMManagedHorizontalMultiDragGestureRecognizer(
...
class RTManagedHorizontalMultiDragGestureRecognizer
    extends _d5f6.HorizontalMultiDragGestureRecognizer
    implements _36c2.Box<_d5f6.HorizontalMultiDragGestureRecognizer> {
  RTManagedHorizontalMultiDragGestureRecognizer(
...
void loadHorizontalMultiDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['horizontalMultiDragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedHorizontalMultiDragGestureRecognizer(
  ...
  _36c2.registerBoxer<_d5f6.HorizontalMultiDragGestureRecognizer>(boxer: (
      {required _d5f6.HorizontalMultiDragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedHorizontalMultiDragGestureRecognizer(

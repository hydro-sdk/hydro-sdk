...
class VMManagedSerialTapGestureRecognizer extends _36c2.VMManagedBox<_2713.SerialTapGestureRecognizer> {VMManagedSerialTapGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
table  [
'getIsTrackingPointer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [vmObject.isTrackingPointer,]; } );
table  [
'isPointerAllowed'
...
final _2713.SerialTapGestureRecognizer vmObject;

 }

class RTManagedSerialTapGestureRecognizer extends _2713.SerialTapGestureRecognizer implements _36c2.Box<_2713.SerialTapGestureRecognizer> {RTManagedSerialTapGestureRecognizer({_fac9.Object? debugOwner, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_getIsTrackingPointer'] =
    _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
  return [super.isTrackingPointer];
});
...
_2713.SerialTapGestureRecognizer unwrap() => this;
_2713.SerialTapGestureRecognizer get vmObject => this;
@_fac9.override _fac9.bool get isTrackingPointer { 
_36c2.Closure closure = table["getIsTrackingPointer"];
...
void loadSerialTapGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'serialTapGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedSerialTapGestureRecognizer(table: luaCallerArguments  [
0
...
'debugOwner'
] : null, parentState: hydroState), supportedDevices: _36c2.maybeUnBoxAndBuildArgument<_fac9.Set<_a643.PointerDeviceKind>?, _a643.PointerDeviceKind>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'supportedDevices'
] : null, parentState: hydroState))]; } );
_36c2.registerBoxer<_2713.SerialTapGestureRecognizer>(boxer: ({required _2713.SerialTapGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSerialTapGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedSerialTapGestureRecognizer
    extends VMManagedBox<SerialTapGestureRecognizer> {
  ...
  final SerialTapGestureRecognizer vmObject;
}

class RTManagedSerialTapGestureRecognizer extends SerialTapGestureRecognizer
    implements Box<SerialTapGestureRecognizer> {
  ...
  SerialTapGestureRecognizer unwrap() => this;
  SerialTapGestureRecognizer get vmObject => this;
  @override
  bool get isTrackingPointer {
    Closure closure = table["getIsTrackingPointer"];
...
void loadSerialTapGestureRecognizer(
  ...
  table['serialTapGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedSerialTapGestureRecognizer(
  ...
  registerBoxer<SerialTapGestureRecognizer>(boxer: (
      {required SerialTapGestureRecognizer vmObject,

...
class VMManagedVelocity extends _36c2.VMManagedBox<_10cb.Velocity> {
  VMManagedVelocity(
    ...
    table['clampMagnitude'] = _36c2.makeLuaDartFunc(
...
class RTManagedVelocity extends _10cb.Velocity
    implements _36c2.Box<_10cb.Velocity> {
  RTManagedVelocity(
    ...
    table['pixelsPerSecond'] = _36c2.maybeBoxObject(
        ...
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['_dart_clampMagnitude'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
  ...
  @_fac9.override
  _10cb.Velocity clampMagnitude(minValue, maxValue) {
...
void loadVelocity(
  ...
  table['velocity'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedVelocity(
  ...
  _36c2.registerBoxer<_10cb.Velocity>(boxer: (
      {required _10cb.Velocity vmObject,

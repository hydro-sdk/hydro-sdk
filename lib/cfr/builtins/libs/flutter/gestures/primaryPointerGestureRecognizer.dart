...
class VMManagedPrimaryPointerGestureRecognizer
    extends VMManagedBox<PrimaryPointerGestureRecognizer> {
  ...
  final PrimaryPointerGestureRecognizer vmObject;
}

class RTManagedPrimaryPointerGestureRecognizer
    extends PrimaryPointerGestureRecognizer
    implements Box<PrimaryPointerGestureRecognizer> {
  RTManagedPrimaryPointerGestureRecognizer(
    ...
    table['deadline'] = maybeBoxObject<Duration?>(
        object: this.deadline, hydroState: hydroState, table: HydroTable());
    table['preAcceptSlopTolerance'] = this.preAcceptSlopTolerance;
    ...
    table['_dart_handlePrimaryPointer'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      handlePrimaryPointer(maybeUnBoxAndBuildArgument<PointerEvent, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  PrimaryPointerGestureRecognizer unwrap() => this;
  PrimaryPointerGestureRecognizer get vmObject => this;
  @override
...
void loadPrimaryPointerGestureRecognizer(
  ...
  table['primaryPointerGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedPrimaryPointerGestureRecognizer(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          deadline: maybeUnBoxAndBuildArgument<Duration?, dynamic>(
              luaCallerArguments.length >= 2
                  ? luaCallerArguments[1]['deadline']
                  : null,
              parentState: hydroState),
  ...
  registerBoxer<PrimaryPointerGestureRecognizer>(boxer: (
      {required PrimaryPointerGestureRecognizer vmObject,

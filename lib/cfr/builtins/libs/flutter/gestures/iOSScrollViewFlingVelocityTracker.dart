...
class VMManagedIOSScrollViewFlingVelocityTracker
    extends _36c2.VMManagedBox<_10cb.IOSScrollViewFlingVelocityTracker> {
...
class RTManagedIOSScrollViewFlingVelocityTracker
    extends _10cb.IOSScrollViewFlingVelocityTracker
    implements _36c2.Box<_10cb.IOSScrollViewFlingVelocityTracker> {
  RTManagedIOSScrollViewFlingVelocityTracker(_a643.PointerDeviceKind kind$,
...
void loadIOSScrollViewFlingVelocityTracker(
  ...
  table['iOSScrollViewFlingVelocityTracker'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_10cb.IOSScrollViewFlingVelocityTracker>(boxer: (
      {required _10cb.IOSScrollViewFlingVelocityTracker vmObject,

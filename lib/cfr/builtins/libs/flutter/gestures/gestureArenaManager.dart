...
class VMManagedGestureArenaManager
    extends _36c2.VMManagedBox<_be6e.GestureArenaManager> {
  VMManagedGestureArenaManager(
    ...
    table['sweep'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['release'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
class RTManagedGestureArenaManager extends _be6e.GestureArenaManager
    implements _36c2.Box<_be6e.GestureArenaManager> {
  RTManagedGestureArenaManager({required this.table, required this.hydroState})
    ...
    table['_dart_sweep'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    ...
    table['_dart_release'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
...
void loadGestureArenaManager(
  ...
  table['gestureArenaManager'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_be6e.GestureArenaManager>(boxer: (
      {required _be6e.GestureArenaManager vmObject,

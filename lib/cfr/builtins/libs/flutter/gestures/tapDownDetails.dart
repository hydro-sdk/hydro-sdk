...
class VMManagedTapDownDetails extends _36c2.VMManagedBox<_1275.TapDownDetails> {VMManagedTapDownDetails({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedTapDownDetails extends _1275.TapDownDetails implements _36c2.Box<_1275.TapDownDetails> {RTManagedTapDownDetails({required _a643.Offset globalPosition, _a643.PointerDeviceKind? kind, _a643.Offset? localPosition, required this.table, required this.hydroState}) : super(globalPosition: globalPosition,kind: kind,localPosition: localPosition) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadTapDownDetails({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'tapDownDetails'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedTapDownDetails(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_1275.TapDownDetails>(boxer: ({required _1275.TapDownDetails vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedTapDownDetails(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

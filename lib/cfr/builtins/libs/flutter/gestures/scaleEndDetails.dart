...
class VMManagedScaleEndDetails
    extends _36c2.VMManagedBox<_bb2d.ScaleEndDetails> {
...
class RTManagedScaleEndDetails extends _bb2d.ScaleEndDetails
    implements _36c2.Box<_bb2d.ScaleEndDetails> {
...
void loadScaleEndDetails(
  ...
  table['scaleEndDetails'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedScaleEndDetails(
  ...
  _36c2.registerBoxer<_bb2d.ScaleEndDetails>(boxer: (
      {required _bb2d.ScaleEndDetails vmObject,

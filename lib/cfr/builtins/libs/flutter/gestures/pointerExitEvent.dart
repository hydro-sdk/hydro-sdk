...
class VMManagedPointerExitEvent extends VMManagedBox<PointerExitEvent> {
  VMManagedPointerExitEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerExitEvent>(
  ...
  final PointerExitEvent vmObject;
}

class RTManagedPointerExitEvent extends PointerExitEvent
    implements Box<PointerExitEvent> {
  ...
  PointerExitEvent unwrap() => this;
  PointerExitEvent get vmObject => this;
  @override
  PointerExitEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerExitEvent, dynamic>(
...
void loadPointerExitEvent(
  ...
  table['pointerExitEventFromMouseEvent'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<PointerExitEvent>(
          object: PointerExitEvent.fromMouseEvent(
  ...
  registerBoxer<PointerExitEvent>(boxer: (
      {required PointerExitEvent vmObject,

...
class VMManagedPointerExitEvent
    extends _36c2.VMManagedBox<_0e77.PointerExitEvent> {
  VMManagedPointerExitEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerExitEvent>(
...
class RTManagedPointerExitEvent extends _0e77.PointerExitEvent
    implements _36c2.Box<_0e77.PointerExitEvent> {
  RTManagedPointerExitEvent(
  ...
  @_fac9.override
  _0e77.PointerExitEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerExitEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerExitEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerExitEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pointerExitEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerExitEvent(
  ...
  table['pointerExitEventFromMouseEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_0e77.PointerExitEvent>(
          object: _0e77.PointerExitEvent.fromMouseEvent(_36c2
  ...
  _36c2.registerBoxer<_0e77.PointerExitEvent>(boxer: (
      {required _0e77.PointerExitEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPointerExitEvent(

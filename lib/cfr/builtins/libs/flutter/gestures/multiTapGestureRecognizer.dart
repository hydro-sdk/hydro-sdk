...
class VMManagedMultiTapGestureRecognizer extends _36c2.VMManagedBox<_2713.MultiTapGestureRecognizer> {VMManagedMultiTapGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
          hydroState: hydroState,
        ) { table  [
'longTapDelay'
] = _36c2.maybeBoxObject<_fac9.Duration>(object: vmObject.longTapDelay, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugOwner'
...
final _2713.MultiTapGestureRecognizer vmObject;

 }

class RTManagedMultiTapGestureRecognizer extends _2713.MultiTapGestureRecognizer implements _36c2.Box<_2713.MultiTapGestureRecognizer> {RTManagedMultiTapGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, required _fac9.Duration longTapDelay, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,longTapDelay: longTapDelay,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'longTapDelay'
] = _36c2.maybeBoxObject(object: this.longTapDelay, hydroState: hydroState, table: _36c2.HydroTable());
table  [
'debugOwner'
...
_2713.MultiTapGestureRecognizer unwrap() => this;
_2713.MultiTapGestureRecognizer get vmObject => this;
...
void loadMultiTapGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'multiTapGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedMultiTapGestureRecognizer(table: luaCallerArguments  [
0
...
'kind'
] : null), longTapDelay: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'longTapDelay'
...
_36c2.registerBoxer<_2713.MultiTapGestureRecognizer>(boxer: ({required _2713.MultiTapGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMultiTapGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

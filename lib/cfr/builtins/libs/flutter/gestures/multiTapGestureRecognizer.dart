...
class VMManagedMultiTapGestureRecognizer
    extends VMManagedBox<MultiTapGestureRecognizer> {
  VMManagedMultiTapGestureRecognizer(
    ...
    table['longTapDelay'] = maybeBoxObject<Duration>(
  ...
  final MultiTapGestureRecognizer vmObject;
}

class RTManagedMultiTapGestureRecognizer extends MultiTapGestureRecognizer
    implements Box<MultiTapGestureRecognizer> {
  RTManagedMultiTapGestureRecognizer(
    ...
    table['longTapDelay'] = maybeBoxObject<Duration>(
        object: this.longTapDelay, hydroState: hydroState, table: HydroTable());
    table['debugOwner'] = maybeBoxObject<Object?>(
  ...
  MultiTapGestureRecognizer unwrap() => this;
  MultiTapGestureRecognizer get vmObject => this;
  @override
...
void loadMultiTapGestureRecognizer(
  ...
  table['multiTapGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedMultiTapGestureRecognizer(
          ...
          kind: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          longTapDelay: maybeUnBoxAndBuildArgument<Duration, dynamic>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<MultiTapGestureRecognizer>(boxer: (
      {required MultiTapGestureRecognizer vmObject,

...
class VMManagedMultiTapGestureRecognizer
    extends _36c2.VMManagedBox<_2713.MultiTapGestureRecognizer> {
  VMManagedMultiTapGestureRecognizer(
    ...
    table['longTapDelay'] = _36c2.maybeBoxObject<_fac9.Duration>(
        object: vmObject.longTapDelay,
        hydroState: hydroState,
...
class RTManagedMultiTapGestureRecognizer extends _2713.MultiTapGestureRecognizer
  ...
  RTManagedMultiTapGestureRecognizer(
      ...
      required _fac9.Duration longTapDelay,
    ...
    table['longTapDelay'] = _36c2.maybeBoxObject(
        object: this.longTapDelay,
        hydroState: hydroState,
        table: _36c2.HydroTable());
...
void loadMultiTapGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['multiTapGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedMultiTapGestureRecognizer(
          ...
          hydroState: hydroState,
          debugOwner: _36c2
              .maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['debugOwner'] : null,
                  parentState: hydroState),
          ...
          longTapDelay:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ? luaCallerArguments[1]['longTapDelay']
                      : null,
                  parentState: hydroState),
          supportedDevices:
  ...
  _36c2.registerBoxer<_2713.MultiTapGestureRecognizer>(boxer: (
      {required _2713.MultiTapGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedMultiTapGestureRecognizer(

...
class VMManagedPointerScrollEvent
    extends _36c2.VMManagedBox<_0e77.PointerScrollEvent> {
  VMManagedPointerScrollEvent(
    ...
    table['scrollDelta'] = _36c2.maybeBoxObject<_a643.Offset>(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerScrollEvent>(
    ...
    table['getScrollDelta'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
...
class RTManagedPointerScrollEvent extends _0e77.PointerScrollEvent
  ...
  RTManagedPointerScrollEvent(
      ...
      required _a643.Offset scrollDelta,
    ...
    table['pointer'] = _36c2.maybeBoxObject(
        object: pointer, hydroState: hydroState, table: _36c2.HydroTable());
    table['kind'] = _a643.PointerDeviceKind.values.indexWhere((x) {
      return x == this.kind;
    });
    ...
    table['buttons'] = _36c2.maybeBoxObject(
        object: buttons, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['obscured'] = _36c2.maybeBoxObject(
        object: obscured, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['pressureMin'] = _36c2.maybeBoxObject(
        object: pressureMin, hydroState: hydroState, table: _36c2.HydroTable());
    table['pressureMax'] = _36c2.maybeBoxObject(
        object: pressureMax, hydroState: hydroState, table: _36c2.HydroTable());
    table['distance'] = _36c2.maybeBoxObject(
        object: distance, hydroState: hydroState, table: _36c2.HydroTable());
    table['distanceMax'] = _36c2.maybeBoxObject(
        object: distanceMax, hydroState: hydroState, table: _36c2.HydroTable());
    table['size'] = _36c2.maybeBoxObject(
        object: size, hydroState: hydroState, table: _36c2.HydroTable());
    table['radiusMajor'] = _36c2.maybeBoxObject(
        object: radiusMajor, hydroState: hydroState, table: _36c2.HydroTable());
    table['radiusMinor'] = _36c2.maybeBoxObject(
        object: radiusMinor, hydroState: hydroState, table: _36c2.HydroTable());
    table['radiusMin'] = _36c2.maybeBoxObject(
        object: radiusMin, hydroState: hydroState, table: _36c2.HydroTable());
    table['radiusMax'] = _36c2.maybeBoxObject(
        object: radiusMax, hydroState: hydroState, table: _36c2.HydroTable());
    table['orientation'] = _36c2.maybeBoxObject(
        object: orientation, hydroState: hydroState, table: _36c2.HydroTable());
    table['tilt'] = _36c2.maybeBoxObject(
        object: tilt, hydroState: hydroState, table: _36c2.HydroTable());
    ...
    table['_dart_getScrollDelta'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [scrollDelta];
    });
  ...
  @_fac9.override
  _0e77.PointerScrollEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerScrollEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerScrollEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerScrollEvent(
  ...
  table['pointerScrollEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerScrollEvent(
          ...
          kind: _36c2.maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          position: _36c2
              .maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['position'] : null,
                  parentState: hydroState),
          scrollDelta:
          ...
          timeStamp:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['timeStamp'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_0e77.PointerScrollEvent>(boxer: (
      {required _0e77.PointerScrollEvent vmObject,

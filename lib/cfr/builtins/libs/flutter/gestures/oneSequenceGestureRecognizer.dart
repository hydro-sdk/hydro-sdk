...
class VMManagedOneSequenceGestureRecognizer
    extends _36c2.VMManagedBox<_02d2.OneSequenceGestureRecognizer> {
...
class RTManagedOneSequenceGestureRecognizer
    extends _02d2.OneSequenceGestureRecognizer
    implements _36c2.Box<_02d2.OneSequenceGestureRecognizer> {
...
void loadOneSequenceGestureRecognizer(
  ...
  table['oneSequenceGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedOneSequenceGestureRecognizer(
  ...
  _36c2.registerBoxer<_02d2.OneSequenceGestureRecognizer>(boxer: (
      {required _02d2.OneSequenceGestureRecognizer vmObject,

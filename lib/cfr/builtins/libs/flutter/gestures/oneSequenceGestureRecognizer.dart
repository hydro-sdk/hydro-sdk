...
class VMManagedOneSequenceGestureRecognizer extends _36c2.VMManagedBox<_02d2.OneSequenceGestureRecognizer> {VMManagedOneSequenceGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _02d2.OneSequenceGestureRecognizer vmObject;

 }

class RTManagedOneSequenceGestureRecognizer extends _02d2.OneSequenceGestureRecognizer implements _36c2.Box<_02d2.OneSequenceGestureRecognizer> {RTManagedOneSequenceGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_02d2.OneSequenceGestureRecognizer unwrap() => this;
_02d2.OneSequenceGestureRecognizer get vmObject => this;
...
void loadOneSequenceGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'oneSequenceGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedOneSequenceGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_02d2.OneSequenceGestureRecognizer>(boxer: ({required _02d2.OneSequenceGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedOneSequenceGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

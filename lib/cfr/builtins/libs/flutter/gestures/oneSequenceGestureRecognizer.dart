...
class VMManagedOneSequenceGestureRecognizer
    extends VMManagedBox<OneSequenceGestureRecognizer> {
  VMManagedOneSequenceGestureRecognizer(
  ...
  final OneSequenceGestureRecognizer vmObject;
}

class RTManagedOneSequenceGestureRecognizer extends OneSequenceGestureRecognizer
    implements Box<OneSequenceGestureRecognizer> {
  RTManagedOneSequenceGestureRecognizer(
      {Object? debugOwner,
    ...
    table['_dart_handleEvent'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      handleEvent(maybeUnBoxAndBuildArgument<PointerEvent, dynamic>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_didStopTrackingLastPointer'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      didStopTrackingLastPointer(luaCallerArguments[1]);
      return [];
    });
    table['_dart_resolve'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  OneSequenceGestureRecognizer unwrap() => this;
  OneSequenceGestureRecognizer get vmObject => this;
  @override
...
void loadOneSequenceGestureRecognizer(
    {required HydroState hydroState, required HydroTable table}) {
  table['oneSequenceGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedOneSequenceGestureRecognizer(
  ...
  registerBoxer<OneSequenceGestureRecognizer>(boxer: (
      {required OneSequenceGestureRecognizer vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedOneSequenceGestureRecognizer(

...
class VMManagedDrag extends _36c2.VMManagedBox<_d9fd.Drag> {VMManagedDrag({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedDrag extends _d9fd.Drag implements _36c2.Box<_d9fd.Drag> {RTManagedDrag({required this.table, required this.hydroState}) : super() { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadDrag({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'drag'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 
return  [RTManagedDrag(table: luaCallerArguments  [
0
], hydroState: hydroState)]; } );
_36c2.registerBoxer<_d9fd.Drag>(boxer: ({required _d9fd.Drag vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDrag(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

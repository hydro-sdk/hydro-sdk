...
class VMManagedHitTestTarget extends _36c2.VMManagedBox<_baac.HitTestTarget> {
...
void loadHitTestTarget(
  ...
  _36c2.registerBoxer<_baac.HitTestTarget>(boxer: (
      {required _baac.HitTestTarget vmObject,

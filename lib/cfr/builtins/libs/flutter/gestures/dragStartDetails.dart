...
class VMManagedDragStartDetails
    extends _36c2.VMManagedBox<_4bc7.DragStartDetails> {
...
class RTManagedDragStartDetails extends _4bc7.DragStartDetails
    implements _36c2.Box<_4bc7.DragStartDetails> {
...
void loadDragStartDetails(
  ...
  table['dragStartDetails'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDragStartDetails(
          table: luaCallerArguments[0],
          hydroState: hydroState,
          globalPosition: _36c2
              .maybeUnBoxAndBuildArgument<_a643.Offset, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['globalPosition'] : null,
          ...
          sourceTimeStamp:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2 ? luaCallerArguments[1]['sourceTimeStamp'] : null,
                  parentState: hydroState))
    ];
  });
  _36c2.registerBoxer<_4bc7.DragStartDetails>(boxer: (
      {required _4bc7.DragStartDetails vmObject,

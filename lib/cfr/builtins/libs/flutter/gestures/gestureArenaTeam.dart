...
class VMManagedGestureArenaTeam
    extends _36c2.VMManagedBox<_c0ad.GestureArenaTeam> {
  VMManagedGestureArenaTeam(
    ...
    table['captain'] = _36c2.maybeBoxObject<_be6e.GestureArenaMember?>(
        object: vmObject.captain,
        hydroState: hydroState,
        table: _36c2.HydroTable());
    table['add'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_be6e.GestureArenaEntry>(
            object: vmObject.add(
...
class RTManagedGestureArenaTeam extends _c0ad.GestureArenaTeam
    implements _36c2.Box<_c0ad.GestureArenaTeam> {
  RTManagedGestureArenaTeam({required this.table, required this.hydroState})
    ...
    table['captain'] = _36c2.maybeBoxObject(
        object: captain, hydroState: hydroState, table: _36c2.HydroTable());
  ...
  @_fac9.override
  _be6e.GestureArenaEntry add(pointer, member) {
    _36c2.Closure closure = table["add"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_be6e.GestureArenaEntry, _fac9.dynamic>(
...
void loadGestureArenaTeam(
  ...
  table['gestureArenaTeam'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
  ...
  _36c2.registerBoxer<_c0ad.GestureArenaTeam>(boxer: (
      {required _c0ad.GestureArenaTeam vmObject,

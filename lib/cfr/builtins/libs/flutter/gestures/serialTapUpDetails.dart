...
class VMManagedSerialTapUpDetails extends _36c2.VMManagedBox<_2713.SerialTapUpDetails> {VMManagedSerialTapUpDetails({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedSerialTapUpDetails extends _2713.SerialTapUpDetails implements _36c2.Box<_2713.SerialTapUpDetails> {RTManagedSerialTapUpDetails({required _fac9.int count, required _a643.Offset globalPosition, _a643.PointerDeviceKind? kind, _a643.Offset? localPosition, required this.table, required this.hydroState}) : super(count: count,globalPosition: globalPosition,kind: kind,localPosition: localPosition) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadSerialTapUpDetails({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'serialTapUpDetails'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedSerialTapUpDetails(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_2713.SerialTapUpDetails>(boxer: ({required _2713.SerialTapUpDetails vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedSerialTapUpDetails(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedLongPressStartDetails extends _36c2.VMManagedBox<_0586.LongPressStartDetails> {VMManagedLongPressStartDetails({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedLongPressStartDetails extends _0586.LongPressStartDetails implements _36c2.Box<_0586.LongPressStartDetails> {RTManagedLongPressStartDetails({required _a643.Offset globalPosition, _a643.Offset? localPosition, required this.table, required this.hydroState}) : super(globalPosition: globalPosition,localPosition: localPosition) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadLongPressStartDetails({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'longPressStartDetails'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 

return  [RTManagedLongPressStartDetails(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_0586.LongPressStartDetails>(boxer: ({required _0586.LongPressStartDetails vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedLongPressStartDetails(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

...
class VMManagedPointerEventConverter
    extends _36c2.VMManagedBox<_8af3.PointerEventConverter> {
...
void loadPointerEventConverter(
  ...
  table['pointerEventConverterExpand'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      _36c2.maybeBoxObject<_fac9.Iterable>(
          object: _8af3.PointerEventConverter.expand(
              _36c2.maybeUnBoxAndBuildArgument<
                      _fac9.Iterable<_a643.PointerData>,
                      _a643.PointerData>(luaCallerArguments[1],
  ...
  _36c2.registerBoxer<_8af3.PointerEventConverter>(boxer: (
      {required _8af3.PointerEventConverter vmObject,

...
class VMManagedHorizontalDragGestureRecognizer
    extends VMManagedBox<HorizontalDragGestureRecognizer> {
  ...
  final HorizontalDragGestureRecognizer vmObject;
}

class RTManagedHorizontalDragGestureRecognizer
    extends HorizontalDragGestureRecognizer
    implements Box<HorizontalDragGestureRecognizer> {
  ...
  HorizontalDragGestureRecognizer unwrap() => this;
  HorizontalDragGestureRecognizer get vmObject => this;
  @override
...
void loadHorizontalDragGestureRecognizer(
  ...
  table['horizontalDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedHorizontalDragGestureRecognizer(
  ...
  registerBoxer<HorizontalDragGestureRecognizer>(boxer: (
      {required HorizontalDragGestureRecognizer vmObject,

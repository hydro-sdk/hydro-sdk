...
class VMManagedHorizontalDragGestureRecognizer extends _36c2.VMManagedBox<_deb0.HorizontalDragGestureRecognizer> {VMManagedHorizontalDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _deb0.HorizontalDragGestureRecognizer vmObject;

 }

class RTManagedHorizontalDragGestureRecognizer extends _deb0.HorizontalDragGestureRecognizer implements _36c2.Box<_deb0.HorizontalDragGestureRecognizer> {RTManagedHorizontalDragGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table  [
'dragStartBehavior'
] = _02d2.DragStartBehavior.values.indexWhere((x) { return x == dragStartBehavior; } );
...
_deb0.HorizontalDragGestureRecognizer unwrap() => this;
_deb0.HorizontalDragGestureRecognizer get vmObject => this;
...
void loadHorizontalDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'horizontalDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedHorizontalDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_deb0.HorizontalDragGestureRecognizer>(boxer: ({required _deb0.HorizontalDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedHorizontalDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

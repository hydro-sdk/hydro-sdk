...
class VMManagedLongPressGestureRecognizer
    extends _36c2.VMManagedBox<_0586.LongPressGestureRecognizer> {
  VMManagedLongPressGestureRecognizer(
...
class RTManagedLongPressGestureRecognizer
    extends _0586.LongPressGestureRecognizer
    implements _36c2.Box<_0586.LongPressGestureRecognizer> {
  RTManagedLongPressGestureRecognizer(
...
void loadLongPressGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['longPressGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedLongPressGestureRecognizer(
  ...
  _36c2.registerBoxer<_0586.LongPressGestureRecognizer>(boxer: (
      {required _0586.LongPressGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedLongPressGestureRecognizer(

...
class VMManagedLongPressGestureRecognizer
    extends VMManagedBox<LongPressGestureRecognizer> {
  ...
  final LongPressGestureRecognizer vmObject;
}

class RTManagedLongPressGestureRecognizer extends LongPressGestureRecognizer
    implements Box<LongPressGestureRecognizer> {
  RTManagedLongPressGestureRecognizer(
    ...
    table['postAcceptSlopTolerance'] = this.postAcceptSlopTolerance;
    table['debugOwner'] = maybeBoxObject<Object?>(
  ...
  LongPressGestureRecognizer unwrap() => this;
  LongPressGestureRecognizer get vmObject => this;
  @override
...
void loadLongPressGestureRecognizer(
  ...
  table['longPressGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedLongPressGestureRecognizer(
          ...
          postAcceptSlopTolerance: luaCallerArguments.length >= 2
              ...
              : null?.toDouble(),
          supportedDevices: maybeUnBoxAndBuildArgument<Set<PointerDeviceKind>?, PointerDeviceKind>(
              luaCallerArguments.length >= 2
  ...
  registerBoxer<LongPressGestureRecognizer>(boxer: (
      {required LongPressGestureRecognizer vmObject,

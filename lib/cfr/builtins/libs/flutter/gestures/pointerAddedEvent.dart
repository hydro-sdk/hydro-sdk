...
class VMManagedPointerAddedEvent extends VMManagedBox<PointerAddedEvent> {
  VMManagedPointerAddedEvent(
    ...
    table['transformed'] =
      ...
      return [
        maybeBoxObject<PointerAddedEvent>(
  ...
  final PointerAddedEvent vmObject;
}

class RTManagedPointerAddedEvent extends PointerAddedEvent
    implements Box<PointerAddedEvent> {
  ...
  PointerAddedEvent unwrap() => this;
  PointerAddedEvent get vmObject => this;
  @override
  PointerAddedEvent transformed(transform) {
    Closure closure = table["transformed"];
    return maybeUnBoxAndBuildArgument<PointerAddedEvent, dynamic>(
...
void loadPointerAddedEvent(
  ...
  registerBoxer<PointerAddedEvent>(boxer: (
      {required PointerAddedEvent vmObject,

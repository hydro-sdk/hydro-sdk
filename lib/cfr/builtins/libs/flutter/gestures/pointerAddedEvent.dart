...
class VMManagedPointerAddedEvent
    extends _36c2.VMManagedBox<_0e77.PointerAddedEvent> {
  VMManagedPointerAddedEvent(
    ...
    table['transformed'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject<_0e77.PointerAddedEvent>(
...
class RTManagedPointerAddedEvent extends _0e77.PointerAddedEvent
  ...
  @_fac9.override
  _0e77.PointerAddedEvent transformed(transform) {
    _36c2.Closure closure = table["transformed"];
    return _36c2
        .maybeUnBoxAndBuildArgument<_0e77.PointerAddedEvent, _fac9.dynamic>(
  ...
  @_fac9.override
  _0e77.PointerAddedEvent copyWith(
      {_fac9.int? buttons,
      _a643.Offset? delta,
      _fac9.int? device,
...
void loadPointerAddedEvent(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['pointerAddedEvent'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedPointerAddedEvent(
  ...
  _36c2.registerBoxer<_0e77.PointerAddedEvent>(boxer: (
      {required _0e77.PointerAddedEvent vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedPointerAddedEvent(

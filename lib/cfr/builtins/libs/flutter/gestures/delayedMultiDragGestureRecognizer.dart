...
class VMManagedDelayedMultiDragGestureRecognizer
    extends _36c2.VMManagedBox<_d5f6.DelayedMultiDragGestureRecognizer> {
  VMManagedDelayedMultiDragGestureRecognizer(
    ...
    table['gestureSettings'] =
        _36c2.maybeBoxObject<_352d.DeviceGestureSettings?>(
            ...
            hydroState: hydroState,
            table: _36c2.HydroTable());
    table['createNewPointerState'] = _36c2.makeLuaDartFunc(
        func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
      return [
        _36c2.maybeBoxObject<_d5f6.MultiDragPointerState>(
            object: vmObject.createNewPointerState(
                _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerDownEvent,
...
class RTManagedDelayedMultiDragGestureRecognizer
    extends _d5f6.DelayedMultiDragGestureRecognizer
    implements _36c2.Box<_d5f6.DelayedMultiDragGestureRecognizer> {
  RTManagedDelayedMultiDragGestureRecognizer(
    ...
    table['_dart_createNewPointerState'] = _36c2.makeLuaDartFunc(
      ...
      return [
        _36c2.maybeBoxObject(
            object: super.createNewPointerState(
                _36c2.maybeUnBoxAndBuildArgument<_0e77.PointerDownEvent,
                        _fac9.dynamic>(luaCallerArguments[1],
                    parentState: hydroState)),
            hydroState: hydroState,
...
void loadDelayedMultiDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['delayedMultiDragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedDelayedMultiDragGestureRecognizer(
          ...
          debugOwner:
              _36c2.maybeUnBoxAndBuildArgument<_fac9.Object?, _fac9.dynamic>(
                  luaCallerArguments.length >= 2
                      ...
                      : null,
                  parentState: hydroState),
          delay: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments[1]['delay'] : null,
              parentState: hydroState),
  ...
  _36c2.registerBoxer<_d5f6.DelayedMultiDragGestureRecognizer>(boxer: (
      {required _d5f6.DelayedMultiDragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedDelayedMultiDragGestureRecognizer(

...
class VMManagedDelayedMultiDragGestureRecognizer extends _36c2.VMManagedBox<_d5f6.DelayedMultiDragGestureRecognizer> {VMManagedDelayedMultiDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { return [_36c2.maybeBoxObject<_d5f6.MultiDragPointerState>(object: vmObject.createNewPointerState(_36c2.maybeUnBoxAndBuildArgument<_0e77.PointerDownEvent, _fac9.dynamic>(luaCallerArguments  [
1
...
final _d5f6.DelayedMultiDragGestureRecognizer vmObject;

 }

class RTManagedDelayedMultiDragGestureRecognizer extends _d5f6.DelayedMultiDragGestureRecognizer implements _36c2.Box<_d5f6.DelayedMultiDragGestureRecognizer> {RTManagedDelayedMultiDragGestureRecognizer({_fac9.Object? debugOwner, required _fac9.Duration delay, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,delay: delay,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
table['_dart_createNewPointerState'] =
  ...
  return [
    _36c2.maybeBoxObject(
        object: super.createNewPointerState(_36c2.maybeUnBoxAndBuildArgument<
...
_d5f6.DelayedMultiDragGestureRecognizer unwrap() => this;
_d5f6.DelayedMultiDragGestureRecognizer get vmObject => this;
@_fac9.override _d5f6.MultiDragPointerState createNewPointerState(event) { 
_36c2.Closure closure = table["createNewPointerState"];
return _36c2.maybeUnBoxAndBuildArgument<_d5f6.MultiDragPointerState, _fac9.dynamic>(closure.dispatch([table],parentState: hydroState)[0], parentState: hydroState); } 
...
void loadDelayedMultiDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'delayedMultiDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 



return  [RTManagedDelayedMultiDragGestureRecognizer(table: luaCallerArguments  [
0
...
'debugOwner'
] : null, parentState: hydroState), delay: _36c2.maybeUnBoxAndBuildArgument<_fac9.Duration, _fac9.dynamic>(luaCallerArguments.length >= 2 ? luaCallerArguments  [
1
]  [
'delay'
...
_36c2.registerBoxer<_d5f6.DelayedMultiDragGestureRecognizer>(boxer: ({required _d5f6.DelayedMultiDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedDelayedMultiDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

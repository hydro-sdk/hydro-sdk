...
class VMManagedDelayedMultiDragGestureRecognizer
    extends VMManagedBox<DelayedMultiDragGestureRecognizer> {
  VMManagedDelayedMultiDragGestureRecognizer(
    ...
    table['delay'] = maybeBoxObject<Duration>(
        object: vmObject.delay, hydroState: hydroState, table: HydroTable());
  ...
  final DelayedMultiDragGestureRecognizer vmObject;
}

class RTManagedDelayedMultiDragGestureRecognizer
    extends DelayedMultiDragGestureRecognizer
    implements Box<DelayedMultiDragGestureRecognizer> {
  RTManagedDelayedMultiDragGestureRecognizer(
    ...
    table['delay'] = maybeBoxObject<Duration>(
        object: this.delay, hydroState: hydroState, table: HydroTable());
  ...
  DelayedMultiDragGestureRecognizer unwrap() => this;
  DelayedMultiDragGestureRecognizer get vmObject => this;
  @override
...
void loadDelayedMultiDragGestureRecognizer(
  ...
  table['delayedMultiDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedDelayedMultiDragGestureRecognizer(
          ...
          debugOwner: maybeUnBoxAndBuildArgument<Object?, dynamic>(
              luaCallerArguments.length >= 2
                  ...
                  : null,
              parentState: hydroState),
          delay: maybeUnBoxAndBuildArgument<Duration, dynamic>(
              luaCallerArguments.length >= 2
          ...
          kind: maybeUnBoxEnum(
              ...
              boxedEnum: luaCallerArguments.length >= 2
                  ...
                  : null),
          supportedDevices:
              maybeUnBoxAndBuildArgument<Set<PointerDeviceKind>?, PointerDeviceKind>(
                  luaCallerArguments.length >= 2
  ...
  registerBoxer<DelayedMultiDragGestureRecognizer>(boxer: (
      {required DelayedMultiDragGestureRecognizer vmObject,

...
class VMManagedMultiDragGestureRecognizer extends _36c2.VMManagedBox<_d5f6.MultiDragGestureRecognizer> {VMManagedMultiDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
class RTManagedMultiDragGestureRecognizer extends _d5f6.MultiDragGestureRecognizer implements _36c2.Box<_d5f6.MultiDragGestureRecognizer> {RTManagedMultiDragGestureRecognizer({_a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, _fac9.Object? debugOwner, required this.table, required this.hydroState}) : super(kind: kind,supportedDevices: supportedDevices,debugOwner: debugOwner) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
void loadMultiDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'multiDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedMultiDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d5f6.MultiDragGestureRecognizer>(boxer: ({required _d5f6.MultiDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedMultiDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

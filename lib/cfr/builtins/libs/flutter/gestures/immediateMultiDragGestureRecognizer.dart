...
class VMManagedImmediateMultiDragGestureRecognizer extends _36c2.VMManagedBox<_d5f6.ImmediateMultiDragGestureRecognizer> {VMManagedImmediateMultiDragGestureRecognizer({required this.table, required this.vmObject, required this.hydroState}) : super(
          table: table,
          vmObject: vmObject,
...
final _d5f6.ImmediateMultiDragGestureRecognizer vmObject;

 }

class RTManagedImmediateMultiDragGestureRecognizer extends _d5f6.ImmediateMultiDragGestureRecognizer implements _36c2.Box<_d5f6.ImmediateMultiDragGestureRecognizer> {RTManagedImmediateMultiDragGestureRecognizer({_fac9.Object? debugOwner, _a643.PointerDeviceKind? kind, _fac9.Set<_a643.PointerDeviceKind>? supportedDevices, required this.table, required this.hydroState}) : super(debugOwner: debugOwner,kind: kind,supportedDevices: supportedDevices) { table  [
'vmObject'
] = vmObject;
table  [
'unwrap'
...
_d5f6.ImmediateMultiDragGestureRecognizer unwrap() => this;
_d5f6.ImmediateMultiDragGestureRecognizer get vmObject => this;
...
void loadImmediateMultiDragGestureRecognizer({required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { table  [
'immediateMultiDragGestureRecognizer'
] = _36c2.makeLuaDartFunc(func: (_fac9.List<_fac9.dynamic> luaCallerArguments) { 


return  [RTManagedImmediateMultiDragGestureRecognizer(table: luaCallerArguments  [
0
...
_36c2.registerBoxer<_d5f6.ImmediateMultiDragGestureRecognizer>(boxer: ({required _d5f6.ImmediateMultiDragGestureRecognizer vmObject, required _36c2.HydroState hydroState, required _36c2.HydroTable table}) { return  VMManagedImmediateMultiDragGestureRecognizer(vmObject: vmObject, hydroState: hydroState, table: table); } ); } 

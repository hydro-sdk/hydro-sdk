...
class VMManagedImmediateMultiDragGestureRecognizer
    extends VMManagedBox<ImmediateMultiDragGestureRecognizer> {
  ...
  final ImmediateMultiDragGestureRecognizer vmObject;
}

class RTManagedImmediateMultiDragGestureRecognizer
    extends ImmediateMultiDragGestureRecognizer
    implements Box<ImmediateMultiDragGestureRecognizer> {
  ...
  ImmediateMultiDragGestureRecognizer unwrap() => this;
  ImmediateMultiDragGestureRecognizer get vmObject => this;
  @override
...
void loadImmediateMultiDragGestureRecognizer(
  ...
  table['immediateMultiDragGestureRecognizer'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedImmediateMultiDragGestureRecognizer(
  ...
  registerBoxer<ImmediateMultiDragGestureRecognizer>(boxer: (
      {required ImmediateMultiDragGestureRecognizer vmObject,

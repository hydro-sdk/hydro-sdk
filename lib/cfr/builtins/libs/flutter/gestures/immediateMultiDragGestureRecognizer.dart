...
class VMManagedImmediateMultiDragGestureRecognizer
    extends _36c2.VMManagedBox<_d5f6.ImmediateMultiDragGestureRecognizer> {
  VMManagedImmediateMultiDragGestureRecognizer(
...
class RTManagedImmediateMultiDragGestureRecognizer
    extends _d5f6.ImmediateMultiDragGestureRecognizer
    implements _36c2.Box<_d5f6.ImmediateMultiDragGestureRecognizer> {
  RTManagedImmediateMultiDragGestureRecognizer(
...
void loadImmediateMultiDragGestureRecognizer(
    {required _36c2.HydroState hydroState, required _36c2.HydroTable table}) {
  table['immediateMultiDragGestureRecognizer'] = _36c2.makeLuaDartFunc(
      func: (_fac9.List<_fac9.dynamic> luaCallerArguments) {
    return [
      RTManagedImmediateMultiDragGestureRecognizer(
  ...
  _36c2.registerBoxer<_d5f6.ImmediateMultiDragGestureRecognizer>(boxer: (
      {required _d5f6.ImmediateMultiDragGestureRecognizer vmObject,
      required _36c2.HydroState hydroState,
      required _36c2.HydroTable table}) {
    return VMManagedImmediateMultiDragGestureRecognizer(

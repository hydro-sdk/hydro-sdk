...
class VMManagedUnmodifiableUint8ListView
    extends VMManagedBox<UnmodifiableUint8ListView> {
  VMManagedUnmodifiableUint8ListView(
  ...
  final UnmodifiableUint8ListView vmObject;
}

class RTManagedUnmodifiableUint8ListView extends UnmodifiableUint8ListView
    implements Box<UnmodifiableUint8ListView> {
  RTManagedUnmodifiableUint8ListView(Uint8List list,
  ...
  UnmodifiableUint8ListView unwrap() => this;
  UnmodifiableUint8ListView get vmObject => this;
  @override
...
void loadUnmodifiableUint8ListView(
    {required HydroState hydroState, required HydroTable table}) {
  table['unmodifiableUint8ListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableUint8ListView(
          maybeUnBoxAndBuildArgument<Uint8List, dynamic>(luaCallerArguments[1],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  registerBoxer<UnmodifiableUint8ListView>(boxer: (
      {required UnmodifiableUint8ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableUint8ListView(

...
void loadInt64List(
  ...
  table['int64List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int64List>(
          object: Int64List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['int64ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int64List>(
  ...
  table['int64ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int64List>(
  ...
  table['int64ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int64List>(

...
void loadInt32List(
  ...
  table['int32List'] =
    ...
    return [
      maybeBoxObject<Int32List>(
          object: Int32List(luaCallerArguments[1]),
          hydroState: hydroState,
          table: luaCallerArguments[0])
    ];
  });
  table['int32ListFromList'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<Int32List>(
          object: Int32List.fromList(maybeUnBoxAndBuildArgument<List<int>, int>(
              luaCallerArguments[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable()),

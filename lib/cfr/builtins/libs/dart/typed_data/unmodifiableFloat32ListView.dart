...
class VMManagedUnmodifiableFloat32ListView
    extends VMManagedBox<UnmodifiableFloat32ListView> {
  VMManagedUnmodifiableFloat32ListView(
      ...
      return [
        maybeBoxObject<Float32List>(
            object: vmObject.sublist(
                args[1],
                maybeUnBoxAndBuildArgument<int?>(args[2],
                    parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
      ];
...
class RTManagedUnmodifiableFloat32ListView extends UnmodifiableFloat32ListView
    implements Box<UnmodifiableFloat32ListView> {
  RTManagedUnmodifiableFloat32ListView(Float32List list,
    ...
    table['_dart_shuffle'] = makeLuaDartFunc(func: (List<dynamic> args) {
      super.shuffle(maybeUnBoxAndBuildArgument<Random?>(args[1],
          parentState: hydroState));
      return [];
    });
  ...
  UnmodifiableFloat32ListView unwrap() => this;
  UnmodifiableFloat32ListView get vmObject => this;
  @override
...
void loadUnmodifiableFloat32ListView(
  ...
  table['unmodifiableFloat32ListView'] =
      makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      RTManagedUnmodifiableFloat32ListView(
          maybeUnBoxAndBuildArgument<Float32List>(args[1],
              parentState: hydroState),
          table: args[0],
          hydroState: hydroState)
    ];
  ...
  registerBoxer<UnmodifiableFloat32ListView>(boxer: (
      {required UnmodifiableFloat32ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableFloat32ListView(

...
class VMManagedUnmodifiableFloat32ListView
  ...
  VMManagedUnmodifiableFloat32ListView(
    ...
    table['addAll'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      vmObject.addAll(maybeUnBoxAndBuildArgument<Iterable<double>>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['insertAll'] =
      ...
      vmObject.insertAll(
          luaCallerArguments[1],
          maybeUnBoxAndBuildArgument<Iterable<double>>(luaCallerArguments[2],
              parentState: hydroState));
      return [];
    });
    ...
    table['setRange'] =
      ...
      vmObject.setRange(
          luaCallerArguments[1],
          luaCallerArguments[2],
          maybeUnBoxAndBuildArgument<Iterable<double>>(luaCallerArguments[3],
              parentState: hydroState),
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject.followedBy(
                maybeUnBoxAndBuildArgument<Iterable<double>>(
                    luaCallerArguments[1],
                    parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable()),
...
class RTManagedUnmodifiableFloat32ListView extends UnmodifiableFloat32ListView
  ...
  RTManagedUnmodifiableFloat32ListView(Float32List list,
    ...
    table['_dart_shuffle'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      super.shuffle(maybeUnBoxAndBuildArgument<Random?>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_cast'] =
    ...
    table['_dart_add'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      add(luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_addAll'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<double>>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_sort'] =
    ...
    table['_dart_insert'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      insert(luaCallerArguments[1], luaCallerArguments[2]?.toDouble());
      return [];
    });
    ...
    table['_dart_fillRange'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      fillRange(luaCallerArguments[1], luaCallerArguments[2],
          luaCallerArguments[3]?.toDouble());
      return [];
    });
    ...
    table['_dart_setFirst'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      first = (luaCallerArguments[1]?.toDouble());
      return [];
    });
    table['_dart_setLast'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      last = (luaCallerArguments[1]?.toDouble());
      return [];
    });
  ...
  table['unmodifiableFloat32ListView'] =
    ...
    return [
      RTManagedUnmodifiableFloat32ListView(
          maybeUnBoxAndBuildArgument<Float32List>(luaCallerArguments[1],
              parentState: hydroState),

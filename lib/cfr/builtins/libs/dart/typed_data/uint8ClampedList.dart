...
class VMManagedUint8ClampedList extends VMManagedBox<Uint8ClampedList?> {
  VMManagedUint8ClampedList(
      {required this.table,
  ...
  final Uint8ClampedList? vmObject;
}

void loadUint8ClampedList(
    {required HydroState hydroState, required HydroTable table}) {
  table['uint8ClampedList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint8ClampedList>(
          object: Uint8ClampedList(args[1]),
          hydroState: hydroState,
          table: args[0])
    ];
  });
  table['uint8ClampedListFromList'] =
      makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint8ClampedList>(
          object: Uint8ClampedList.fromList(
              maybeUnBoxAndBuildArgument<List<int>>(args[1],
                  parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
    ];
  });
  table['uint8ClampedListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint8ClampedList>(
          object: Uint8ClampedList.view(
  ...
  table['uint8ClampedListSublistView'] =
    ...
    return [
      maybeBoxObject<Uint8ClampedList>(
          object: Uint8ClampedList.sublistView(
  ...
  registerBoxer<Uint8ClampedList>(boxer: (
      {required Uint8ClampedList? vmObject,
      required HydroState? hydroState,
      required HydroTable? table}) {
    return VMManagedUint8ClampedList(

...
class VMManagedUint16List extends VMManagedBox<Uint16List?> {
  VMManagedUint16List(
      {required this.table,
        ...
        maybeBoxObject<Iterable>(
            object: vmObject!.expand(f != null
                ? ((element) => maybeUnBoxAndBuildArgument<Iterable<dynamic>>(
                    ...
                    parentState: hydroState!)) as Iterable<dynamic> Function(int)
                : null),
            hydroState: hydroState!,
            table: HydroTable())
      ];
  ...
  final Uint16List? vmObject;
}

void loadUint16List(
    {required HydroState hydroState, required HydroTable table}) {
  table['uint16List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint16List>(
          object: Uint16List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['uint16ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint16List>(
          object: Uint16List.fromList(maybeUnBoxAndBuildArgument<List<int>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
  ...
  table['uint16ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint16List>(
          object: Uint16List.view(
  ...
  table['uint16ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint16List>(
          object: Uint16List.sublistView(
  ...
  registerBoxer<Uint16List>(boxer: (
      {required Uint16List? vmObject,
      required HydroState? hydroState,
      required HydroTable? table}) {
    return VMManagedUint16List(

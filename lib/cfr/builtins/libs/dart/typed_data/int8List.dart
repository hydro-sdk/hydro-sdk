...
class VMManagedInt8List extends VMManagedBox<Int8List?> {
  VMManagedInt8List(
  ...
  final Int8List? vmObject;
}

void loadInt8List({required HydroState hydroState, required HydroTable table}) {
  table['int8List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int8List>(
          object: Int8List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['int8ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int8List>(
          object: Int8List.fromList(maybeUnBoxAndBuildArgument<List<int>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
  ...
  table['int8ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int8List>(
          object: Int8List.view(
  ...
  table['int8ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int8List>(
          object: Int8List.sublistView(
  ...
  registerBoxer<Int8List>(boxer: (
      {required Int8List? vmObject,
      required HydroState? hydroState,
      required HydroTable? table}) {
    return VMManagedInt8List(

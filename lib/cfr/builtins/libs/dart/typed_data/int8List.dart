...
class VMManagedInt8List extends VMManagedBox<Int8List> {
  VMManagedInt8List(
    ...
    table['indexOf'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [vmObject.indexOf(luaCallerArguments[1], luaCallerArguments[2])];
    });
    table['indexWhere'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
...
void loadInt8List({required HydroState hydroState, required HydroTable table}) {
  table['int8List'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<Int8List>(
          object: Int8List(luaCallerArguments[1]),
          hydroState: hydroState,
          table: luaCallerArguments[0])
    ];
  });
  table['int8ListFromList'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<Int8List>(

...
class VMManagedInt16List extends VMManagedBox<Int16List?> {
  VMManagedInt16List(
      {required this.table,
  ...
  final Int16List? vmObject;
}

void loadInt16List(
    {required HydroState hydroState, required HydroTable table}) {
  table['int16List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int16List>(
          object: Int16List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['int16ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int16List>(
          object: Int16List.fromList(maybeUnBoxAndBuildArgument<List<int>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
  ...
  table['int16ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int16List>(
          object: Int16List.view(
  ...
  table['int16ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Int16List>(
          object: Int16List.sublistView(
  ...
  registerBoxer<Int16List>(boxer: (
      {required Int16List? vmObject,
      required HydroState? hydroState,
      required HydroTable? table}) {
    return VMManagedInt16List(

...
class VMManagedUnmodifiableInt8ListView
    extends VMManagedBox<UnmodifiableInt8ListView> {
  VMManagedUnmodifiableInt8ListView(
  ...
  final UnmodifiableInt8ListView vmObject;
}

class RTManagedUnmodifiableInt8ListView extends UnmodifiableInt8ListView
    implements Box<UnmodifiableInt8ListView> {
  RTManagedUnmodifiableInt8ListView(Int8List list,
  ...
  UnmodifiableInt8ListView unwrap() => this;
  UnmodifiableInt8ListView get vmObject => this;
  @override
...
void loadUnmodifiableInt8ListView(
    {required HydroState hydroState, required HydroTable table}) {
  table['unmodifiableInt8ListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableInt8ListView(
          maybeUnBoxAndBuildArgument<Int8List, dynamic>(luaCallerArguments[1],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  registerBoxer<UnmodifiableInt8ListView>(boxer: (
      {required UnmodifiableInt8ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableInt8ListView(

...
class VMManagedUnmodifiableInt32x4ListView
  ...
  VMManagedUnmodifiableInt32x4ListView(
    ...
    table['add'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.add(maybeUnBoxAndBuildArgument<Int32x4>(args[1],
    ...
    table['insert'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.insert(
          args[1],
          maybeUnBoxAndBuildArgument<Int32x4>(args[2],
              parentState: hydroState));
      return [];
    });
    ...
    table['fillRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.fillRange(
          args[1],
          args[2],
          maybeUnBoxAndBuildArgument<Int32x4>(args[3],
              parentState: hydroState));
      return [];
    });
    ...
    table['setFirst'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.first = (maybeUnBoxAndBuildArgument<Int32x4>(args[1],
          parentState: hydroState));
      return [];
    });
    table['setLast'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.last = (maybeUnBoxAndBuildArgument<Int32x4>(args[1],
          parentState: hydroState));
      return [];
    });
      ...
      return [
        maybeBoxObject<Int32x4>(
            object: vmObject.firstWhere(
                ...
                orElse: () => maybeUnBoxAndBuildArgument<Int32x4>(
                    orElse.dispatch(
                      [
                        args[0],
                      ],
...
class RTManagedUnmodifiableInt32x4ListView extends UnmodifiableInt32x4ListView
  ...
  RTManagedUnmodifiableInt32x4ListView(Int32x4List list,
    ...
    table['_dart_add'] = makeLuaDartFunc(func: (List<dynamic> args) {
      add(maybeUnBoxAndBuildArgument<Int32x4>(args[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_addAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<Int32x4>>(args[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setFirst'] = makeLuaDartFunc(func: (List<dynamic> args) {
      first = (maybeUnBoxAndBuildArgument<Int32x4>(args[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_setLast'] = makeLuaDartFunc(func: (List<dynamic> args) {
      last = (maybeUnBoxAndBuildArgument<Int32x4>(args[1],
          parentState: hydroState));
      return [];
    });
  ...
  @override
  void addAll(Iterable<Int32x4> iterable) {
  ...
  @override
  void insertAll(int index, Iterable<Int32x4> iterable) {
  ...
  @override
  void replaceRange(int start, int end, Iterable<Int32x4> replacement) {
  ...
  table['unmodifiableInt32x4ListView'] =
    ...
    return [
      RTManagedUnmodifiableInt32x4ListView(
          maybeUnBoxAndBuildArgument<Int32x4List>(args[1],
              parentState: hydroState),
          table: args[0],
          hydroState: hydroState)
    ];

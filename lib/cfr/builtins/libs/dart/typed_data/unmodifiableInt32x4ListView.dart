...
class RTManagedUnmodifiableInt32x4ListView extends UnmodifiableInt32x4ListView
  ...
  RTManagedUnmodifiableInt32x4ListView(Int32x4List list,
    ...
    table['_dart_addAll'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<Int32x4>, Int32x4>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  Iterable<Int32x4> getRange(int start, int end) {
    ...
    return maybeUnBoxAndBuildArgument<Iterable<Int32x4>, Int32x4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Map<int, Int32x4> asMap() {
    ...
    return maybeUnBoxAndBuildArgument<Map<int, Int32x4>, int>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  List<Int32x4> toList({bool growable = true}) {
    ...
    return maybeUnBoxAndBuildArgument<List<Int32x4>, Int32x4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Set<Int32x4> toSet() {
    ...
    return maybeUnBoxAndBuildArgument<Set<Int32x4>, Int32x4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Iterator<Int32x4> get iterator {
    ...
    return maybeUnBoxAndBuildArgument<Iterator<Int32x4>, Int32x4>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }

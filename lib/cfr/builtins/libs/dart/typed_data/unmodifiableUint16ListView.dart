...
class VMManagedUnmodifiableUint16ListView
    extends VMManagedBox<UnmodifiableUint16ListView> {
  VMManagedUnmodifiableUint16ListView(
...
class RTManagedUnmodifiableUint16ListView extends UnmodifiableUint16ListView
    implements Box<UnmodifiableUint16ListView> {
  RTManagedUnmodifiableUint16ListView(Uint16List list,
  ...
  UnmodifiableUint16ListView unwrap() => this;
  UnmodifiableUint16ListView get vmObject => this;
  @override
...
void loadUnmodifiableUint16ListView(
  ...
  table['unmodifiableUint16ListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableUint16ListView(
          maybeUnBoxAndBuildArgument<Uint16List, dynamic>(luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<UnmodifiableUint16ListView>(boxer: (
      {required UnmodifiableUint16ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableUint16ListView(

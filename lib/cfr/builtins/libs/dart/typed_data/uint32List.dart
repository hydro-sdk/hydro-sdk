...
class VMManagedUint32List extends VMManagedBox<Uint32List?> {
  VMManagedUint32List(
      {required this.table,
  ...
  final Uint32List? vmObject;
}

void loadUint32List(
    {required HydroState hydroState, required HydroTable table}) {
  table['uint32List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint32List>(
          object: Uint32List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['uint32ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint32List>(
          object: Uint32List.fromList(maybeUnBoxAndBuildArgument<List<int>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
  ...
  table['uint32ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint32List>(
          object: Uint32List.view(
  ...
  table['uint32ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Uint32List>(
          object: Uint32List.sublistView(
  ...
  registerBoxer<Uint32List>(boxer: (
      {required Uint32List? vmObject,
      required HydroState? hydroState,
      required HydroTable? table}) {
    return VMManagedUint32List(

...
class VMManagedUnmodifiableFloat64x2ListView
  ...
  VMManagedUnmodifiableFloat64x2ListView(
    ...
    table['add'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.add(maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
    table['addAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.addAll(maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(args[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['insertAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.insertAll(
          args[1],
          maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(args[2],
              parentState: hydroState));
      return [];
    });
    ...
    table['setRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.setRange(
          args[1],
          args[2],
          maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(args[3],
              parentState: hydroState),
          args[4]);
      return [];
    });
    ...
    table['fillRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.fillRange(
          args[1],
          args[2],
          maybeUnBoxAndBuildArgument<Float64x2>(args[3],
              parentState: hydroState));
      return [];
    });
    ...
    table['setFirst'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.first = (maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
    table['setLast'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.last = (maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject.followedBy(
                maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(args[1],
                    parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
      ];
...
class RTManagedUnmodifiableFloat64x2ListView
  ...
  RTManagedUnmodifiableFloat64x2ListView(Float64x2List list,
    ...
    table['_dart_add'] = makeLuaDartFunc(func: (List<dynamic> args) {
      add(maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_addAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(args[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setFirst'] = makeLuaDartFunc(func: (List<dynamic> args) {
      first = (maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_setLast'] = makeLuaDartFunc(func: (List<dynamic> args) {
      last = (maybeUnBoxAndBuildArgument<Float64x2>(args[1],
          parentState: hydroState));
      return [];
    });
  ...
  @override
  void addAll(Iterable<Float64x2> iterable) {
  ...
  @override
  void insertAll(int index, Iterable<Float64x2> iterable) {
  ...
  Float64x2 removeAt(int index) {
    ...
    return maybeUnBoxAndBuildArgument<Float64x2>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Iterable<Float64x2> getRange(int start, int end) {
    ...
    return maybeUnBoxAndBuildArgument<Iterable<Float64x2>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  void replaceRange(int start, int end, Iterable<Float64x2> replacement) {
  ...
  Map<int, Float64x2> asMap() {
    ...
    return maybeUnBoxAndBuildArgument<Map<int, Float64x2>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  List<Float64x2> toList({bool growable = true}) {
    ...
    return maybeUnBoxAndBuildArgument<List<Float64x2>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Set<Float64x2> toSet() {
    ...
    return maybeUnBoxAndBuildArgument<Set<Float64x2>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Iterator<Float64x2> get iterator {
    ...
    return maybeUnBoxAndBuildArgument<Iterator<Float64x2>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  table['unmodifiableFloat64x2ListView'] =
    ...
    return [
      RTManagedUnmodifiableFloat64x2ListView(
          maybeUnBoxAndBuildArgument<Float64x2List>(args[1],
              parentState: hydroState),
          table: args[0],
          hydroState: hydroState)
    ];

...
class RTManagedUnmodifiableFloat32x4ListView
  ...
  RTManagedUnmodifiableFloat32x4ListView(Float32x4List list,
    ...
    table['_dart_add'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      add(maybeUnBoxAndBuildArgument<Float32x4>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_addAll'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<Float32x4>>(
          luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_setFirst'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      first = (maybeUnBoxAndBuildArgument<Float32x4>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
    table['_dart_setLast'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      last = (maybeUnBoxAndBuildArgument<Float32x4>(luaCallerArguments[1],
          parentState: hydroState));
      return [];
    });
  ...
  table['unmodifiableFloat32x4ListView'] =
    ...
    return [
      RTManagedUnmodifiableFloat32x4ListView(
          maybeUnBoxAndBuildArgument<Float32x4List>(luaCallerArguments[1],
              parentState: hydroState),

...
class VMManagedUnmodifiableFloat64ListView
    extends VMManagedBox<UnmodifiableFloat64ListView> {
  VMManagedUnmodifiableFloat64ListView(
    ...
    table['add'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.add(args[1]?.toDouble());
      return [];
    });
    table['addAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.addAll(maybeUnBoxAndBuildArgument<Iterable<double>>(args[1],
    ...
    table['indexOf'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [vmObject.indexOf(args[1]?.toDouble(), args[2])];
    });
    ...
    table['lastIndexOf'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [vmObject.lastIndexOf(args[1]?.toDouble(), args[2])];
    });
    ...
    table['insert'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.insert(args[1], args[2]?.toDouble());
      return [];
    });
    table['insertAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.insertAll(
          args[1],
          maybeUnBoxAndBuildArgument<Iterable<double>>(args[2],
              parentState: hydroState));
      return [];
    });
    ...
    table['setRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.setRange(
          args[1],
          args[2],
          maybeUnBoxAndBuildArgument<Iterable<double>>(args[3],
              parentState: hydroState),
          args[4]);
      return [];
    });
    ...
    table['fillRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.fillRange(args[1], args[2], args[3]?.toDouble());
      return [];
    });
    ...
    table['setFirst'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.first = (args[1]?.toDouble());
      return [];
    });
    table['setLast'] = makeLuaDartFunc(func: (List<dynamic> args) {
      vmObject.last = (args[1]?.toDouble());
      return [];
    });
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject.followedBy(
                maybeUnBoxAndBuildArgument<Iterable<double>>(args[1],
                    parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
      ];
  ...
  final UnmodifiableFloat64ListView vmObject;
}

class RTManagedUnmodifiableFloat64ListView extends UnmodifiableFloat64ListView
    implements Box<UnmodifiableFloat64ListView> {
  RTManagedUnmodifiableFloat64ListView(Float64List list,
    ...
    table['_dart_addAll'] = makeLuaDartFunc(func: (List<dynamic> args) {
      addAll(maybeUnBoxAndBuildArgument<Iterable<double>>(args[1],
          parentState: hydroState));
      return [];
    });
    ...
    table['_dart_indexOf'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [indexOf(args[1]?.toDouble(), args[2])];
    });
    ...
    table['_dart_lastIndexOf'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [lastIndexOf(args[1]?.toDouble(), args[2])];
    });
    ...
    table['_dart_fillRange'] = makeLuaDartFunc(func: (List<dynamic> args) {
      fillRange(args[1], args[2], args[3]?.toDouble());
      return [];
    });
  ...
  UnmodifiableFloat64ListView unwrap() => this;
  UnmodifiableFloat64ListView get vmObject => this;
  @override
  ...
  Iterable<double> getRange(int start, int end) {
    ...
    return maybeUnBoxAndBuildArgument<Iterable<double>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Map<int, double> asMap() {
    ...
    return maybeUnBoxAndBuildArgument<Map<int, double>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Set<double> toSet() {
    ...
    return maybeUnBoxAndBuildArgument<Set<double>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  double firstWhere(test, {orElse}) {
    Closure closure = table["firstWhere"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double lastWhere(test, {orElse}) {
    Closure closure = table["lastWhere"];
    return closure.dispatch([table], parentState: hydroState)[0]?.toDouble();
  }

  @override
  double singleWhere(test, {orElse}) {
  ...
  Iterator<double> get iterator {
    ...
    return maybeUnBoxAndBuildArgument<Iterator<double>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadUnmodifiableFloat64ListView(
    {required HydroState hydroState, required HydroTable table}) {
  table['unmodifiableFloat64ListView'] =
      makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      RTManagedUnmodifiableFloat64ListView(
  ...
  registerBoxer<UnmodifiableFloat64ListView>(boxer: (
      {required UnmodifiableFloat64ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableFloat64ListView(

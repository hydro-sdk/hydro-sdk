...
class VMManagedUnmodifiableUint8ClampedListView
    extends VMManagedBox<UnmodifiableUint8ClampedListView> {
  VMManagedUnmodifiableUint8ClampedListView(
...
class RTManagedUnmodifiableUint8ClampedListView
    extends UnmodifiableUint8ClampedListView
    implements Box<UnmodifiableUint8ClampedListView> {
  RTManagedUnmodifiableUint8ClampedListView(Uint8ClampedList list,
  ...
  UnmodifiableUint8ClampedListView unwrap() => this;
  UnmodifiableUint8ClampedListView get vmObject => this;
  @override
...
void loadUnmodifiableUint8ClampedListView(
  ...
  table['unmodifiableUint8ClampedListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableUint8ClampedListView(
          maybeUnBoxAndBuildArgument<Uint8ClampedList>(luaCallerArguments[1],
              parentState: hydroState),
  ...
  registerBoxer<UnmodifiableUint8ClampedListView>(boxer: (
      {required UnmodifiableUint8ClampedListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableUint8ClampedListView(

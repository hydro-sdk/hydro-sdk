...
class VMManagedUnmodifiableInt64ListView
    extends VMManagedBox<UnmodifiableInt64ListView> {
  VMManagedUnmodifiableInt64ListView(
  ...
  final UnmodifiableInt64ListView vmObject;
}

class RTManagedUnmodifiableInt64ListView extends UnmodifiableInt64ListView
    implements Box<UnmodifiableInt64ListView> {
  RTManagedUnmodifiableInt64ListView(Int64List list,
  ...
  UnmodifiableInt64ListView unwrap() => this;
  UnmodifiableInt64ListView get vmObject => this;
  @override
...
void loadUnmodifiableInt64ListView(
    {required HydroState hydroState, required HydroTable table}) {
  table['unmodifiableInt64ListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableInt64ListView(
          maybeUnBoxAndBuildArgument<Int64List, dynamic>(luaCallerArguments[1],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  registerBoxer<UnmodifiableInt64ListView>(boxer: (
      {required UnmodifiableInt64ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableInt64ListView(

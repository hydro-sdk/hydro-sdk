...
void loadFloat64List(
  ...
  table['float64List'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Float64List>(
          object: Float64List(args[1]), hydroState: hydroState, table: args[0])
    ];
  });
  table['float64ListFromList'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Float64List>(
          object: Float64List.fromList(maybeUnBoxAndBuildArgument<List<double>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())
  ...
  table['float64ListView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Float64List>(
  ...
  table['float64ListSublistView'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Float64List>(

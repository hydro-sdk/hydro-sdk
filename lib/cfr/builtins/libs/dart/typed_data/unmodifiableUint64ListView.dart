...
class VMManagedUnmodifiableUint64ListView
    extends VMManagedBox<UnmodifiableUint64ListView> {
  VMManagedUnmodifiableUint64ListView(
  ...
  final UnmodifiableUint64ListView vmObject;
}

class RTManagedUnmodifiableUint64ListView extends UnmodifiableUint64ListView
    implements Box<UnmodifiableUint64ListView> {
  RTManagedUnmodifiableUint64ListView(Uint64List list,
  ...
  UnmodifiableUint64ListView unwrap() => this;
  UnmodifiableUint64ListView get vmObject => this;
  @override
...
void loadUnmodifiableUint64ListView(
    {required HydroState hydroState, required HydroTable table}) {
  table['unmodifiableUint64ListView'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedUnmodifiableUint64ListView(
          maybeUnBoxAndBuildArgument<Uint64List, dynamic>(luaCallerArguments[1],
              parentState: hydroState),
          table: luaCallerArguments[0],
          hydroState: hydroState)
    ];
  });
  registerBoxer<UnmodifiableUint64ListView>(boxer: (
      {required UnmodifiableUint64ListView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedUnmodifiableUint64ListView(

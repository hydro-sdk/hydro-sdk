...
class VMManagedStreamView extends VMManagedBox<StreamView<dynamic>> {
  VMManagedStreamView(
  ...
  final StreamView vmObject;
}

class RTManagedStreamView extends StreamView implements Box<StreamView> {
  RTManagedStreamView(Stream<dynamic> stream,
  ...
  StreamView unwrap() => this;
  StreamView get vmObject => this;
  @override
...
void loadStreamView(
  ...
  registerBoxer<StreamView>(boxer: (
      {required StreamView vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedStreamView(

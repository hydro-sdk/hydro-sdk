...
class RTManagedStream extends Stream implements Box<Stream> {
  RTManagedStream({required this.table, required this.hydroState}) : super() {
    ...
    table['_dart_contains'] =
      ...
      return [
        maybeBoxObject<Future>(
            object: super.contains(maybeUnBoxAndBuildArgument<Object?>(
                luaCallerArguments[1],
                parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
  ...
  StreamSubscription<dynamic> listen(onData,
    ...
    return maybeUnBoxAndBuildArgument<StreamSubscription<dynamic>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Stream<S> map<S>(convert) {
    ...
    return maybeUnBoxAndBuildArgument<Stream<S>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Stream<E> asyncMap<E>(convert) {
    ...
    return maybeUnBoxAndBuildArgument<Stream<E>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<dynamic> pipe(StreamConsumer streamConsumer) {
    ...
    return maybeUnBoxAndBuildArgument<Future<dynamic>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<S> fold<S>(S initialValue, combine) {
    ...
    return maybeUnBoxAndBuildArgument<Future<S>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<bool> contains(Object? needle) {
    ...
    return maybeUnBoxAndBuildArgument<Future<bool>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<int> get length {
    ...
    return maybeUnBoxAndBuildArgument<Future<int>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Stream<R> cast<R>() {
    ...
    return maybeUnBoxAndBuildArgument<Stream<R>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<List<dynamic>> toList() {
    ...
    return maybeUnBoxAndBuildArgument<Future<List<dynamic>>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<Set<dynamic>> toSet() {
    ...
    return maybeUnBoxAndBuildArgument<Future<Set<dynamic>>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Future<E> drain<E>([E? futureValue]) {
    ...
    return maybeUnBoxAndBuildArgument<Future<E>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
...
void loadStream({required HydroState hydroState, required HydroTable table}) {
  ...
  table['streamFromFuture'] =
    ...
    return [
      maybeBoxObject<Stream>(
          object: Stream.fromFuture(maybeUnBoxAndBuildArgument<Future<dynamic>>(
              luaCallerArguments[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable()),
    ...
    return [
      maybeBoxObject<Stream>(
          object: Stream.eventTransformed(
              maybeUnBoxAndBuildArgument<Stream<dynamic>>(luaCallerArguments[1],
                  parentState: hydroState),
              (sink) => maybeUnBoxAndBuildArgument<EventSink<dynamic>>(
  ...
  table['streamCastFrom'] =
    ...
    return [
      maybeBoxObject<Stream>(
          object: Stream.castFrom(maybeUnBoxAndBuildArgument<Stream<dynamic>>(
              luaCallerArguments[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable()),

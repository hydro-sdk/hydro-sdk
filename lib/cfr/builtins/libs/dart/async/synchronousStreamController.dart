...
class VMManagedSynchronousStreamController
    extends VMManagedBox<SynchronousStreamController<dynamic>> {
  VMManagedSynchronousStreamController(
  ...
  final SynchronousStreamController vmObject;
}

void loadSynchronousStreamController(
    {required HydroState hydroState, required HydroTable table}) {
  registerBoxer<SynchronousStreamController>(boxer: (
      {required SynchronousStreamController vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedSynchronousStreamController(

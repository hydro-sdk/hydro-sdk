...
class VMManagedDoubleLinkedQueue
    extends VMManagedBox<DoubleLinkedQueue<dynamic>> {
  VMManagedDoubleLinkedQueue(
    ...
    table['firstEntry'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      final returnValue = vmObject.firstEntry();
      if (returnValue != null) {
        return [
    ...
    table['lastEntry'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      final returnValue = vmObject.lastEntry();
      if (returnValue != null) {
        return [
          maybeBoxObject<DoubleLinkedQueueEntry?>(
              object: returnValue, hydroState: hydroState, table: HydroTable()),
    ...
    table['forEachEntry'] =
      ...
      vmObject.forEachEntry((element) => unpackedaction.dispatch(
            [luaCallerArguments[0], element],
            parentState: hydroState,
          ));
      return [];
  ...
  final DoubleLinkedQueue vmObject;
}

class RTManagedDoubleLinkedQueue extends DoubleLinkedQueue
    implements Box<DoubleLinkedQueue> {
  RTManagedDoubleLinkedQueue({required this.table, required this.hydroState})
      : super() {
    ...
    table['_dart_firstEntry'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<DoubleLinkedQueueEntry?>(
            object: super.firstEntry(),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    table['_dart_lastEntry'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      return [
        maybeBoxObject<DoubleLinkedQueueEntry?>(
            object: super.lastEntry(),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    ...
    table['_dart_forEachEntry'] =
        makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
      Closure unpackedaction = luaCallerArguments[1];
      super.forEachEntry((element) => unpackedaction.dispatch(
            [luaCallerArguments[0], element],
            parentState: hydroState,
          ));
      return [];
  ...
  DoubleLinkedQueue unwrap() => this;
  DoubleLinkedQueue get vmObject => this;
  @override
  Queue<R> cast<R>() {
  ...
  @override
  DoubleLinkedQueueEntry<dynamic>? firstEntry() {
    Closure closure = table["firstEntry"];
  ...
  @override
  DoubleLinkedQueueEntry<dynamic>? lastEntry() {
    Closure closure = table["lastEntry"];
    return maybeUnBoxAndBuildArgument<DoubleLinkedQueueEntry<dynamic>?,
            dynamic>(closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  void forEachEntry(action) {
    Closure closure = table["forEachEntry"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }
...
void loadDoubleLinkedQueue(
    {required HydroState hydroState, required HydroTable table}) {
  table['doubleLinkedQueue'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      RTManagedDoubleLinkedQueue(
          table: luaCallerArguments[0], hydroState: hydroState)
    ];
  });
  table['doubleLinkedQueueFrom'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<DoubleLinkedQueue>(
          object: DoubleLinkedQueue.from(
              maybeUnBoxAndBuildArgument<Iterable<dynamic>, dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  table['doubleLinkedQueueOf'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<DoubleLinkedQueue>(
          object: DoubleLinkedQueue.of(
              maybeUnBoxAndBuildArgument<Iterable<dynamic>, dynamic>(
                  luaCallerArguments[1],
                  parentState: hydroState)),
          hydroState: hydroState,
  ...
  registerBoxer<DoubleLinkedQueue>(boxer: (
      {required DoubleLinkedQueue vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedDoubleLinkedQueue(

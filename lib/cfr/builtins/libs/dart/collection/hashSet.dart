...
class VMManagedHashSet extends VMManagedBox<HashSet<dynamic>> {
  VMManagedHashSet(
  ...
  final HashSet vmObject;
}

void loadHashSet({required HydroState hydroState, required HydroTable table}) {
  table['hashSet'] = makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
  ...
  table['hashSetIdentity'] =
      makeLuaDartFunc(func: (List<dynamic> luaCallerArguments) {
    return [
      maybeBoxObject<HashSet>(
          object: HashSet.identity(),
          hydroState: hydroState,
          table: HydroTable()),
    ];
  });
  ...
  registerBoxer<HashSet>(boxer: (
      {required HashSet vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedHashSet(

...
class VMManagedIterableMixin extends VMManagedBox<IterableMixin<dynamic>> {
  VMManagedIterableMixin(
  ...
  final IterableMixin vmObject;
}

void loadIterableMixin(
    {required HydroState hydroState, required HydroTable table}) {
  registerBoxer<IterableMixin>(boxer: (
      {required IterableMixin vmObject,
      required HydroState hydroState,
      required HydroTable table}) {
    return VMManagedIterableMixin(

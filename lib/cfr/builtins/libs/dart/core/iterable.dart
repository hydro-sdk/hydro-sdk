...
class VMManagedIterable extends VMManagedBox<Iterable<E>> {
  VMManagedIterable(
      {@required this.table,
    ...
    table['followedBy'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [
        maybeBoxObject<Iterable>(
            object: vmObject.followedBy(maybeUnBoxAndBuildArgument<Iterable<E>>(
                args[1],
    ...
    table['where'] = makeLuaDartFunc(func: (List<dynamic> args) {
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject
                .where((element) => test.dispatch([args[0], element])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject.expand((element) =>
                maybeUnBoxAndBuildArgument<Iterable<T>>(
                    f.dispatch([args[0], element])[0],
                    parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
      ];
    ...
    table['forEach'] = makeLuaDartFunc(func: (List<dynamic> args) {
      Closure f = args[1];
      vmObject.forEach((element) => f.dispatch([args[0], element])[0]);
      return [];
    });
      ...
      return [
        vmObject.fold(
            ...
            (previousValue, element) =>
                combine.dispatch([args[0], previousValue, element])[0])
      ];
    });
    table['every'] = makeLuaDartFunc(func: (List<dynamic> args) {
      Closure test = args[1];
      return [
        vmObject.every((element) => test.dispatch([args[0], element])[0])
      ];
    });
    ...
    table['any'] = makeLuaDartFunc(func: (List<dynamic> args) {
      Closure test = args[1];
      return [
        vmObject.any((element) => test.dispatch([args[0], element])[0])
      ];
    });
    ...
    table['takeWhile'] = makeLuaDartFunc(func: (List<dynamic> args) {
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject
                .takeWhile((value) => test.dispatch([args[0], value])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    ...
    table['skipWhile'] = makeLuaDartFunc(func: (List<dynamic> args) {
      ...
      return [
        maybeBoxObject<Iterable>(
            object: vmObject
                .skipWhile((value) => test.dispatch([args[0], value])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    ...
    table['lastWhere'] = makeLuaDartFunc(func: (List<dynamic> args) {
      ...
      Closure orElse = args[2]['orElse'];
      return [
        vmObject.lastWhere((element) => test.dispatch([args[0], element])[0],
            orElse: () => orElse.dispatch([
                  args[0],
                ])[0])
      ];
    ...
    table['singleWhere'] = makeLuaDartFunc(func: (List<dynamic> args) {
      ...
      Closure orElse = args[2]['orElse'];
      return [
        vmObject.singleWhere((element) => test.dispatch([args[0], element])[0],
            orElse: () => orElse.dispatch([
                  args[0],
                ])[0])
      ];
...
class RTManagedIterable extends Iterable implements Box<Iterable> {
  RTManagedIterable({@required this.table, @required this.hydroState})
    ...
    table['_dart_followedBy'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [
        maybeBoxObject<Iterable>(
            object: super.followedBy(maybeUnBoxAndBuildArgument<Iterable<E>>(
                args[1],
                parentState: hydroState)),
            hydroState: hydroState,
            table: HydroTable())
    ...
    table['_dart_where'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [
        maybeBoxObject<Iterable>(
            object:
                super.where((element) => test.dispatch([args[0], element])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    ...
    table['_dart_takeWhile'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [
        maybeBoxObject<Iterable>(
            object:
                super.takeWhile((value) => test.dispatch([args[0], value])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
    ...
    table['_dart_skipWhile'] = makeLuaDartFunc(func: (List<dynamic> args) {
      return [
        maybeBoxObject<Iterable>(
            object:
                super.skipWhile((value) => test.dispatch([args[0], value])[0]),
            hydroState: hydroState,
            table: HydroTable())
      ];
    });
  ...
  Iterator<E> get iterator {
    ...
    return maybeUnBoxAndBuildArgument<Iterator<E>>(
  ...
  Iterable<E> followedBy(Iterable<E> other) {
    ...
    return maybeUnBoxAndBuildArgument<Iterable<E>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  List<E> toList({bool growable = true}) {
    ...
    return maybeUnBoxAndBuildArgument<List<E>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  Set<E> toSet() {
    ...
    return maybeUnBoxAndBuildArgument<Set<E>>(
        closure.dispatch([table], parentState: hydroState)[0],
        parentState: hydroState);
  }
  ...
  @override
  E firstWhere(test, {orElse}) {
    Closure closure = table["firstWhere"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  E lastWhere(test, {orElse}) {
    Closure closure = table["lastWhere"];
    return closure.dispatch([table], parentState: hydroState)[0];
  }

  @override
  E singleWhere(test, {orElse}) {
...
void loadIterable(
  ...
  table['iterableCastFrom'] = makeLuaDartFunc(func: (List<dynamic> args) {
    return [
      maybeBoxObject<Iterable>(
          object: Iterable.castFrom(maybeUnBoxAndBuildArgument<Iterable<S>>(
              args[1],
              parentState: hydroState)),
          hydroState: hydroState,
          table: HydroTable())

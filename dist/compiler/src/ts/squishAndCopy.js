...
function squishAndCopy(config) {
    ...
    cp.execSync("./../../compiler/res/" + platform + "/lua52 ./../../compiler/res/squish.lua", { cwd: "./.hydroc/" + configHash_1.configHash(config), });
    ...
    cp.execSync("./../../compiler/res/darwin/luac52 " + (config.profile == "release" ? "-s" : "") + " -o " + config.modName + ".hc " + config.modName, { cwd: "./.hydroc/" + configHash_1.configHash(config) });

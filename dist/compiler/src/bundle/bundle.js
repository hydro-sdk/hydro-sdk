...
function bundle(bundleInfo) {
    ...
    if (entry) {
        ...
        (_a = res.debugSymbols).push.apply(_a, __spreadArrays(bundleEntries
            .map(function (x) { return x.debugSymbols; })
            .reduce(function (a, b) { return a.concat(b); }), entry.debugSymbols));
        ...
        mainChunkSymbols = mainChunkSymbols
            ...
            return a.findIndex(function (k) {
                return k.lineStart == x.lineStart && x.lineEnd == k.lineEnd;
            }) == i;
        });
